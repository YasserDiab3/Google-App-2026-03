...
const BehaviorMonitoring = {
    ...
    openPublicQrModal() {
        ...
        const factories = this.getFactoryOptions ? this.getFactoryOptions() : [];
                ...
                <div class="modal-body" style="padding: 24px; background: #f8fafc;">
                    ...
                    <div style="margin-bottom: 18px;">
                        ...
                        <select id="qr-factory-select" class="form-select" style="width: 100%; padding: 10px 12px; border-radius: 8px; border: 1.5px solid #cbd5e1; font-size: 0.95rem;">
                            ...
                            ${(factories || []).map(f => `<option value="${Utils.escapeHTML(f.name || f)}">${Utils.escapeHTML(f.name || f)}</option>`).join('')}
                        </select>
                    </div>
        ...
        const updateUrl = () => {
            ...
            qrText.textContent = fac ? `نموذج الإبلاغ المباشر لمصنع: ${fac}` : 'امسح الرمز بكاميرا الهاتف لفتح نموذج الملاحظات فوراً';
        };
                ...
                <body>
                    <div class="poster-card">
                        ...
                        <div class="steps">
                            ...
                            4. اضغط «إرسال الملاحظة» لتصل مباشرة إلى فريق السلامة.
                        </div>
