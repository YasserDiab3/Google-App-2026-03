...
const CONTRACTOR_EVALUATION_DEFAULT_ITEMS = [
    ...
    'ØªÙˆÙØ± Ø§Ù„Ø¹Ù…Ø§Ù„Ø© Ø§Ù„Ù…Ø¯Ø±Ø¨Ø© ÙˆØ§Ù„Ù…Ø¤Ù‡Ù„Ø©',
    'ØªÙˆÙØ± Ù…Ø´Ø±Ù Ù…Ø¤Ù‡Ù„ Ø·ÙˆØ§Ù„ ÙØªØ±Ø© ØªÙ†ÙÙŠØ° Ø§Ù„Ù…Ø´Ø±ÙˆØ¹ (Ù„Ù„Ø£Ø¹Ù…Ø§Ù„ Ø§Ù„ØªÙŠ ØªØªØ¬Ø§ÙˆØ² Ø£Ø³Ø¨ÙˆØ¹ Ø¹Ù…Ù„)',
    'ØªÙˆÙØ± Ù…Ù‡Ù…Ø§Øª Ø§Ù„ÙˆÙ‚Ø§ÙŠØ© Ø§Ù„Ø´Ø®ØµÙŠØ© Ø§Ù„Ø®Ø§ØµØ© Ø¨Ø§Ù„Ø¹Ø§Ù…Ù„ÙŠÙ† Ø¨Ø­Ø§Ù„Ø© Ø¬ÙŠØ¯Ø©',
    'ØªÙˆÙØ± Ø§Ù„Ù…Ø¹Ø¯Ø§Øª Ø§Ù„Ù…Ù†Ø§Ø³Ø¨Ø© Ù„Ø£Ø¯Ø§Ø¡ Ø§Ù„Ø¹Ù…Ù„ ÙˆØªØ­Ù‚Ù‚ Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø§Ù„Ø³Ù„Ø§Ù…Ø©',
    'ØªÙˆÙØ± Ø£Ø¬Ù‡Ø²Ø© Ø§Ù„Ø¥Ø·ÙØ§Ø¡ Ø§Ù„Ù…Ù†Ø§Ø³Ø¨Ø© (Ù†ÙˆØ¹Ù‹Ø§ ÙˆØ­Ø¬Ù…Ù‹Ø§) Ø·Ø¨Ù‚Ù‹Ø§ Ù„Ù„ØªØ¹Ø§Ù‚Ø¯',
    ...
    'Ø§Ù„Ø§Ù„ØªØ²Ø§Ù… Ø¨Ù‚ÙˆØ§Ø¹Ø¯ Ø§Ù„ØªØ®Ø²ÙŠÙ† Ø§Ù„Ø¢Ù…Ù† ÙˆØªØ®Ø²ÙŠÙ† Ø§Ù„Ù…ÙˆØ§Ø¯ ÙˆØ§Ù„Ù…Ø¹Ø¯Ø§Øª ÙÙŠ Ø§Ù„Ø£Ù…Ø§ÙƒÙ† Ø§Ù„Ù…Ø®ØµØµØ©',
    'Ø§Ù„Ø­ÙØ§Ø¸ Ø¹Ù„Ù‰ Ø§Ù„Ù†Ø¸Ø§ÙØ© ÙˆØ§Ù„ØªØ®Ù„Øµ Ø§Ù„Ø¢Ù…Ù† Ù…Ù† Ø§Ù„Ù…Ø®Ù„ÙØ§Øª',
    'Ø§Ù„Ø¥Ø¨Ù„Ø§Øº Ø§Ù„ÙÙˆØ±ÙŠ Ø¹Ù† Ø£ÙŠ Ø­Ø§Ø¯Ø« ÙˆØ§ØªØ®Ø§Ø° Ø§Ù„Ø¥Ø¬Ø±Ø§Ø¡Ø§Øª Ù„Ù…Ù†Ø¹ ØªÙƒØ±Ø§Ø±Ù‡',
    'Ø§Ù„Ø§Ù„ØªØ²Ø§Ù… Ø¨ØªÙ†ÙÙŠØ° Ø§Ù„Ù…Ø´Ø±ÙˆØ¹ Ø·Ø¨Ù‚Ù‹Ø§ Ù„Ù„Ù…Ø®Ø·Ø· Ø§Ù„Ø²Ù…Ù†ÙŠ Ø§Ù„Ù…Ø¹ØªÙ…Ø¯',
...
const REQUIREMENT_CATEGORIES = {
    ...
    training: { id: 'training', label: 'Ø§Ù„ØªØ¯Ø±ÙŠØ¨ ÙˆØ§Ù„ÙƒÙØ§Ø¡Ø§Øª', icon: 'fa-graduation-cap', color: '#10b981' },
...
const REQUIREMENT_PRIORITIES = {
    ...
    low: { id: 'low', label: 'Ù…Ù†Ø®ÙØ¶', color: '#6b7280', order: 4 }
};
...
const CONTRACTOR_APPROVAL_REQUIREMENTS_DEFAULT = [
    ...
    },
    {
        ...
        priority: 'critical',
        hasExpiry: false,
        description: 'Ø³Ø¬Ù„ Ø§Ù„Ø­ÙˆØ§Ø¯Ø« ÙˆØ§Ù„Ø¥ØµØ§Ø¨Ø§Øª Ù„Ù„ÙØªØ±Ø© Ø§Ù„Ù…Ø§Ø¶ÙŠØ©',
    ...
    {
        id: 'req_7',
        label: 'ØªÙˆÙÙŠØ± Ù…Ø³Ø¤ÙˆÙ„ Ø³Ù„Ø§Ù…Ø© Ù…Ø¹ØªÙ…Ø¯ Ù„Ù„Ù…Ø´Ø±ÙˆØ¹',
        type: 'text',
        required: true,
        order: 7,
        category: 'safety',
    ...
    },
    {
        ...
        priority: 'high',
        hasExpiry: false,
        description: 'Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† ØªÙˆÙØ± ÙˆØ§Ø³ØªØ®Ø¯Ø§Ù… Ù…Ø¹Ø¯Ø§Øª Ø§Ù„ÙˆÙ‚Ø§ÙŠØ© Ø§Ù„Ø´Ø®ØµÙŠØ©',
        applicableTypes: ['contractor']
    },
    {
        id: 'req_9',
        label: 'ØªÙˆÙÙŠØ± Ø´Ù‡Ø§Ø¯Ø§Øª Ù…Ø¹Ø§ÙŠØ±Ø© Ù„Ù„Ù…Ø¹Ø¯Ø§Øª Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…Ø© Ø¥Ø°Ø§ ÙƒØ§Ù†Øª Ù…Ø·Ù„ÙˆØ¨Ø©',
        type: 'document',
        required: false,
        order: 9,
        category: 'equipment',
...
const Contractors = {
    ...
    _abortController: null, // âœ… Ù„Ù„ØªØ­ÙƒÙ… ÙÙŠ Ø¥Ù„ØºØ§Ø¡ Ø¬Ù…ÙŠØ¹ event listeners
    _eventListeners: [], // âœ… ØªØªØ¨Ø¹ Ø¬Ù…ÙŠØ¹ event listeners Ø§Ù„Ù…ÙØ¶Ø§ÙØ©
    
    /**
     * âœ… Ø¯Ø§Ù„Ø© ØªÙ†Ø¸ÙŠÙ Ø´Ø§Ù…Ù„Ø© Ù„Ø¥Ø²Ø§Ù„Ø© Ø¬Ù…ÙŠØ¹ event listeners
     * ØªÙØ³ØªØ¯Ø¹Ù‰ Ù‚Ø¨Ù„ ØªØºÙŠÙŠØ± Ø§Ù„ØªØ¨ÙˆÙŠØ¨Ø§Øª Ø£Ùˆ Ø¥Ø¹Ø§Ø¯Ø© Ø±Ø³Ù… Ø§Ù„Ù…Ø­ØªÙˆÙ‰
     */
    cleanup() {
        try {
            ...
            if (this._broadcastListener && typeof RealtimeSyncManager !== 'undefined' && 
                ...
                try {
                    ...
                    Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ Ø¥Ø²Ø§Ù„Ø© broadcast listener:', e);
                }
            }
            ...
            Utils.safeError('âŒ Ø®Ø·Ø£ ÙÙŠ cleanup:', error);
        }
    },
    
    /**
     * âœ… Ø¯Ø§Ù„Ø© Ù…Ø³Ø§Ø¹Ø¯Ø© Ø¢Ù…Ù†Ø© Ù„Ù„ÙˆØµÙˆÙ„ Ø¥Ù„Ù‰ Ø¹Ù†Ø§ØµØ± DOM
     * ØªØªØ­Ù‚Ù‚ Ù…Ù† ÙˆØ¬ÙˆØ¯ Ø§Ù„Ø¹Ù†ØµØ± ÙÙŠ DOM Ù‚Ø¨Ù„ Ø§Ù„ÙˆØµÙˆÙ„ Ø¥Ù„ÙŠÙ‡
     */
     ...
     * ØªØªØ­Ù‚Ù‚ Ù…Ù† ÙˆØ¬ÙˆØ¯ Ø§Ù„Ø¹Ù†ØµØ± ÙÙŠ DOM Ù‚Ø¨Ù„ Ø§Ù„ØªØ­Ø¯ÙŠØ«
     */
    safeSetInnerHTML(element, html) {
        try {
            ...
            Utils.safeError('âŒ safeSetInnerHTML error:', error);
            return false;
        }
    },
     ...
     * ØªØªØ­Ù‚Ù‚ Ù…Ù† ÙˆØ¬ÙˆØ¯ container ÙÙŠ DOM Ù‚Ø¨Ù„ Ø§Ù„Ø¨Ø­Ø«
     */
    ...
    async load(preserveCurrentTab = false) {
        // âœ… CRITICAL: Ù…Ù†Ø¹ Ø§Ø³ØªØ¯Ø¹Ø§Ø¡ load() Ø£ÙƒØ«Ø± Ù…Ù† Ù…Ø±Ø© ÙÙŠ Ù†ÙØ³ Ø§Ù„ÙˆÙ‚Øª
        if (this._isLoading) {
            Utils.safeLog('âš ï¸ load() Ù‚ÙŠØ¯ Ø§Ù„ØªÙ†ÙÙŠØ° Ø¨Ø§Ù„ÙØ¹Ù„ - ØªÙ… ØªØ¬Ø§Ù‡Ù„ Ø§Ù„Ø§Ø³ØªØ¯Ø¹Ø§Ø¡');
            return;
        }
        ...
        try {
            ...
            // âœ… Ø¥ØµÙ„Ø§Ø­ Ù†Ù‡Ø§Ø¦ÙŠ: Ø­ÙØ¸ Ø§Ù„ØªØ¨ÙˆÙŠØ¨ Ø§Ù„Ø­Ø§Ù„ÙŠ Ù‚Ø¨Ù„ Ø¥Ø¹Ø§Ø¯Ø© Ø§Ù„ØªØ­Ù…ÙŠÙ„
            ...
            const handleError = (sectionName, error) => {
                if (typeof Utils !== 'undefined' && Utils.safeError) {
                    Utils.safeError(`Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ ${sectionName}:`, error);
                } else {
                    console.error(`Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ ${sectionName}:`, error);
                }
                return `
                    <div class="content-card">
                        <div class="card-body">
                            <div class="empty-state">
                                ...
                                <p class="text-gray-500">Ø­Ø¯Ø« Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ ${sectionName}</p>
            ...
            // Ù‡ÙŠÙƒÙ„ Ø§Ù„Ù…Ø¯ÙŠÙˆÙ„ Ø£ÙˆÙ„Ø§Ù‹ (Ø¹Ù†ÙˆØ§Ù† + ØªØ¨ÙˆÙŠØ¨Ø§Øª)ØŒ Ø«Ù… Ù…Ù„Ø¡ Ø§Ù„Ø£Ù‚Ø³Ø§Ù… Ø¨Ø¹Ø¯ Ø§Ù„Ø¬Ø§Ù‡Ø²ÙŠØ© â€” Ø¯ÙˆÙ† Ø´Ø§Ø´Ø© ØªØ­Ù…ÙŠÙ„ ÙƒØ§Ù…Ù„Ø©
                    ...
                    <div class="card-body">
                        <div class="flex items-center justify-center py-8">
                            <div class="text-center">
                                ...
                                <p class="text-gray-500 text-sm">Ø¬Ø§Ø±ÙŠ ØªØ¬Ù‡ÙŠØ² Ø§Ù„Ù‚Ø³Ù…...</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        `;
            ...
            // ✅ تحسين: استخدام البيانات المحملة مسبقاً بدلاً من إعادة التحميل
            // البيانات تم تحميلها مسبقاً في app-bootstrap.js
                ...
                try {
                    ...
                    if (contractorsResult?.success && Array.isArray(contractorsResult.data)) {
                        ...
                        if (typeof Utils !== 'undefined' && Utils.safeLog) {
                            Utils.safeLog(`✅ تم تحميل ${contractorsResult.data.length} مقاول معتمد`);
                        }
                    }
                } catch (error) {
                    if (typeof Utils !== 'undefined' && Utils.safeWarn) {
                        Utils.safeWarn('⚠️ خطأ في تحميل بيانات المقاولين:', error);
                    }
                }
            } else if (hasPreloadedContractors) {
                if (typeof Utils !== 'undefined' && Utils.safeLog) {
                    Utils.safeLog(`✅ تم استخدام ${AppState.appData.approvedContractors.length} مقاول من البيانات المحملة (توفير 2-5 ثواني)`);
                }
            }
            ...
            this._isLoading = false; // âœ… ØªÙ†Ø¸ÙŠÙ ÙÙŠ Ø­Ø§Ù„Ø© Ø§Ù„Ø®Ø·Ø£
            
            const section = document.getElementById('contractors-section');
            if (typeof Utils !== 'undefined' && Utils.safeError) {
                Utils.safeError('Ø®Ø·Ø£ ÙØ§Ø¯Ø­ ÙÙŠ ØªØ­Ù…ÙŠÙ„ Ù…ÙˆØ¯ÙŠÙˆÙ„ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†:', error);
            } else {
                console.error('Ø®Ø·Ø£ ÙØ§Ø¯Ø­ ÙÙŠ ØªØ­Ù…ÙŠÙ„ Ù…ÙˆØ¯ÙŠÙˆÙ„ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†:', error);
            }
                    ...
                    <div class="content-card">
                        <div class="card-body">
                            <div class="empty-state">
                                ...
                                <h3 class="text-lg font-semibold text-gray-800 mb-2">Ø­Ø¯Ø« Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ù…ÙˆØ¯ÙŠÙˆÙ„</h3>
    ...
    /**
     * ØªØ­Ø¯ÙŠØ« Ø§Ù„Ù…Ø¯ÙŠÙˆÙ„ (Ø¥Ø¹Ø§Ø¯Ø© ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ù…Ø¹ Ø§Ù„Ø­ÙØ§Ø¸ Ø¹Ù„Ù‰ Ø§Ù„ØªØ¨ÙˆÙŠØ¨ Ø§Ù„Ø­Ø§Ù„ÙŠ)
     */
    refreshModule() {
    ...
    switchTab(tab) {
        ...
        // âœ… Ù…Ù†Ø¹ Ø§Ù„ØªØ¨Ø¯ÙŠÙ„ Ø§Ù„Ù…ØªÙƒØ±Ø± Ù„Ù†ÙØ³ Ø§Ù„ØªØ¨ÙˆÙŠØ¨
        if (this.currentTab === tab) return;
        
        // âœ… Ø­ÙØ¸ Ø§Ù„ØªØ¨ÙˆÙŠØ¨
        this.currentTab = tab;
        ...
        // âœ… Ø¥Ø®ÙØ§Ø¡ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ù…Ø­ØªÙˆÙŠØ§Øª ÙˆØ¥Ø¸Ù‡Ø§Ø± Ø§Ù„Ù…Ø·Ù„ÙˆØ¨ ÙÙ‚Ø·
    ...
    /**
     * âœ… Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† ØªØ­Ù…ÙŠÙ„ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ø¹Ù†Ø¯ ÙØªØ­ Ø§Ù„ØªØ¨ÙˆÙŠØ¨ (Ù…Ø²Ø§Ù…Ù†Ø© Ù…Ù† Backend Ø¥Ù† ÙƒØ§Ù†Øª Ø§Ù„Ù‚Ø§Ø¦Ù…Ø© ÙØ§Ø±ØºØ©)
     */
    ...
    loadApprovalRequestTab(container, skipIfExists = false) {
        try {
            ...
            // Ø¥Ø°Ø§ ÙƒØ§Ù† Ø§Ù„Ù…Ø­ØªÙˆÙ‰ Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ Ø¨Ø§Ù„ÙØ¹Ù„ØŒ Ù„Ø§ Ù†ÙØ¹Ù„ Ø´ÙŠØ¦Ø§Ù‹
            ...
            Utils.safeError('Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ ØªØ¨ÙˆÙŠØ¨ Ø·Ù„Ø¨Ø§Øª Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯:', error);
                ...
                const errorHTML = `
                    <div class="content-card">
                        <div class="card-body">
                            <div class="empty-state">
                                <i class="fas fa-exclamation-triangle text-4xl text-yellow-400 mb-3"></i>
                                <p class="text-gray-500">Ø­Ø¯Ø« Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª</p>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-lg font-semibold text-purple-600">
                                ${stats.requirements.met} Ù…Ø³ØªÙˆÙÙŠ
                            </p>
                            <p class="text-xs text-gray-500">
                                ${stats.requirements.partial} Ø¬Ø²Ø¦ÙŠ / ${stats.requirements.notMet} ØºÙŠØ± Ù…Ø³ØªÙˆÙÙŠ
                            </p>
                        </div>
    ...
    generateContractorCode() {
        ...
        // Ø§Ù„Ø¨Ø­Ø« Ø¹Ù† Ø£ÙƒØ¨Ø± Ø±Ù‚Ù… ÙÙŠ Ø§Ù„Ø£ÙƒÙˆØ§Ø¯ Ø§Ù„Ù…ÙˆØ¬ÙˆØ¯Ø©
    ...
    sortByContractorCode(a, b) {
        ...
        // Ø¥Ø°Ø§ ÙƒØ§Ù† Ø£Ø­Ø¯Ù‡Ù…Ø§ ÙÙ‚Ø· Ù„Ø¯ÙŠÙ‡ Ø±Ù‚Ù…ØŒ Ø§Ù„Ø°ÙŠ Ù„Ø¯ÙŠÙ‡ Ø±Ù‚Ù… ÙŠØ£ØªÙŠ Ø£ÙˆÙ„Ø§Ù‹
        if (numA > 0) return -1;
        if (numB > 0) return 1;
    ...
    normalizeApprovedStatus(value) {
        ...
        if (['rejected', 'Ù…Ø±ÙÙˆØ¶', 'Ø±ÙØ¶', 'cancelled', 'canceled', 'denied', 'invalid', 'expired'].includes(normalized)) {
            return 'rejected';
        }
        return 'under_review';
    },
    ...
    isApprovalActive(record, includeExpired = false) {
        ...
        // Ø¯Ø¹Ù… Ø§Ù„Ù‚ÙŠÙ…: 'approved', 'Ù…Ø¹ØªÙ…Ø¯', 'Ù†Ø´Ø·', 'active', Ø£Ùˆ Ø£ÙŠ Ø³Ø¬Ù„ Ø¨Ø¯ÙˆÙ† status (Ù„Ù„ØªÙˆØ§ÙÙ‚ Ù…Ø¹ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù‚Ø¯ÙŠÙ…Ø©)
        const status = (record.status || '').toString().toLowerCase().trim();
        const approvedStatuses = ['approved', 'Ù…Ø¹ØªÙ…Ø¯', 'Ù†Ø´Ø·', 'active', ''];
        
        // Ø¥Ø°Ø§ ÙƒØ§Ù† status Ù…ÙˆØ¬ÙˆØ¯ ÙˆÙ„ÙƒÙ† Ù„ÙŠØ³ Ù…Ù† Ø§Ù„Ù‚ÙŠÙ… Ø§Ù„Ù…Ù‚Ø¨ÙˆÙ„Ø©ØŒ Ø§Ø±ÙØ¶ Ø§Ù„Ø³Ø¬Ù„
    ...
    /**
     * âœ… Ø¯Ø§Ù„Ø© ØªØ´Ø®ÙŠØµÙŠØ©: ÙØ­Øµ Ø­Ø§Ù„Ø© Ù…Ù‚Ø§ÙˆÙ„ Ù…Ø¹ÙŠÙ†
    ...
    debugContractorVisibility(codeOrName) {
        console.log('ðŸ” ÙØ­Øµ Ø­Ø§Ù„Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„:', codeOrName);
        
        // Ø§Ù„Ø¨Ø­Ø« ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†
        ...
        if (!approved) {
            console.error('âŒ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† (AppState.appData.approvedContractors)');
            return {
                found: false,
                message: 'Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†'
            };
        }
        
        console.log('âœ… Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ù…ÙˆØ¬ÙˆØ¯ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†:', approved);
        
        // ÙØ­Øµ Ø§Ù„Ø­Ø§Ù„Ø© - ØªØ­Ø¯ÙŠØ« Ù„Ù„Ù‚ÙŠÙ… Ø§Ù„Ù…Ù‚Ø¨ÙˆÙ„Ø©
        const status = (approved.status || '').toString().toLowerCase().trim();
        const approvedStatuses = ['approved', 'Ù…Ø¹ØªÙ…Ø¯', 'Ù†Ø´Ø·', 'active', ''];
        const isApproved = approvedStatuses.includes(status);
        console.log(`ðŸ“Š Ø§Ù„Ø­Ø§Ù„Ø© (status): "${approved.status}"`, isApproved ? 'âœ… Ù…Ø¹ØªÙ…Ø¯' : 'âŒ ØºÙŠØ± Ù…Ø¹ØªÙ…Ø¯');
        
        // ÙØ­Øµ Ø§Ù„ØµÙ„Ø§Ø­ÙŠØ©
        const isExpired = this.isApprovalExpired(approved);
        console.log(`ðŸ“… ØªØ§Ø±ÙŠØ® Ø§Ù„Ø§Ù†ØªÙ‡Ø§Ø¡ (expiryDate): ${approved.expiryDate || 'ØºÙŠØ± Ù…Ø­Ø¯Ø¯'}`, isExpired ? 'âŒ Ù…Ù†ØªÙ‡ÙŠ' : 'âœ… Ø³Ø§Ø±ÙŠ');
        
        // ÙØ­Øµ Ù†Ø´Ø§Ø· Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯
        const isActive = this.isApprovalActive(approved, false);
        console.log(`ðŸ”„ Ù†Ø´Ø· (isApprovalActive): ${isActive}`, isActive ? 'âœ…' : 'âŒ');
        
        // ÙØ­Øµ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª (Ø¥Ø°Ø§ ÙƒØ§Ù† Ù„Ù‡ contractorId)
        let requirementsMet = true;
        if (approved.contractorId) {
            requirementsMet = this.checkAllRequirementsMet(approved.contractorId);
            console.log(`ðŸ“‹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª (checkAllRequirementsMet): ${requirementsMet}`, requirementsMet ? 'âœ… Ù…Ø³ØªÙˆÙØ§Ø©' : 'âŒ ØºÙŠØ± Ù…Ø³ØªÙˆÙØ§Ø©');
        } else {
            console.log('â„¹ï¸ Ù„Ø§ ÙŠÙˆØ¬Ø¯ contractorId - Ù„Ø§ Ø­Ø§Ø¬Ø© Ù„ÙØ­Øµ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª');
        }
        
        // Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„Ø¸Ù‡ÙˆØ± ÙÙŠ getAllContractorsForModules
        ...
        console.log(`ðŸ“‹ ÙŠØ¸Ù‡Ø± ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¯ÙŠÙˆÙ„Ø§Øª (getAllContractorsForModules): ${appearsInList}`, appearsInList ? 'âœ…' : 'âŒ');

        // Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„Ø¸Ù‡ÙˆØ± ÙÙŠ getContractorOptionsForModules
        ...
        console.log(`ðŸ“ ÙŠØ¸Ù‡Ø± ÙÙŠ Ø§Ù„Ù†Ù…Ø§Ø°Ø¬ (getContractorOptionsForModules): ${appearsInForms}`, appearsInForms ? 'âœ…' : 'âŒ');
        ...
        return {
            ...
            message: isActive ? 'ÙŠØ¬Ø¨ Ø£Ù† ÙŠØ¸Ù‡Ø± Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Ø§Ù„Ù†Ù…Ø§Ø°Ø¬' : 'Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ù„Ø§ ÙŠØ³ØªÙˆÙÙŠ Ù…Ø¹Ø§ÙŠÙŠØ± Ø§Ù„Ø¸Ù‡ÙˆØ±'
        };
    },

    /**
     * âœ… Ø¯Ø§Ù„Ø© ØªØ´Ø®ÙŠØµÙŠØ© Ø´Ø§Ù…Ù„Ø©: ÙØ­Øµ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†
     * ØªØ¹Ø±Ø¶ Ø£Ø³Ø¨Ø§Ø¨ Ø¹Ø¯Ù… Ø¸Ù‡ÙˆØ± ÙƒÙ„ Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Ø§Ù„Ù†Ù…Ø§Ø°Ø¬
     */
    debugAllContractorsVisibility() {
        console.log('â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•');
        console.log('ðŸ” ÙØ­Øµ Ø´Ø§Ù…Ù„ Ù„Ø¬Ù…ÙŠØ¹ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†');
        console.log('â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•');
        ...
        console.log(`ðŸ“Š Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø³Ø¬Ù„Ø§Øª Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†: ${approvedList.length}`);
        console.log(`ðŸ“Š Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† ÙÙŠ getAllContractorsForModules: ${allFromModules.length}`);
        console.log(`ðŸ“Š Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† ÙÙŠ getContractorOptionsForModules (Ù„Ù„Ù†Ù…Ø§Ø°Ø¬): ${forForms.length}`);
        console.log('â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•');
        ...
        approvedList.forEach((record, index) => {
            ...
            if (appearsInForms) {
                ...
                if (!reason) {
                    reason = 'Ø³Ø¨Ø¨ ØºÙŠØ± Ù…Ø¹Ø±ÙˆÙ - ÙŠØ­ØªØ§Ø¬ ÙØ­Øµ ÙŠØ¯ÙˆÙŠ';
                    results.reasons.notInForms.push({ name, code, record });
                }
                
                console.log(`âŒ ${index + 1}. ${code} - ${name} [status: "${status}"] â†’ ${reason}`);
            }
        });
        
        console.log('â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•');
        console.log(`ðŸ“Š Ø§Ù„Ù…Ù„Ø®Øµ: ${results.visible} ÙŠØ¸Ù‡Ø± âœ… | ${results.hidden} Ù„Ø§ ÙŠØ¸Ù‡Ø± âŒ`);
        console.log('â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•');
    ...
    ensureApprovedSetup() {
        ...
        AppState.appData.approvedContractors = collection.map((item) => {
            ...
            // Ù‚Ø±Ø§Ø¡Ø© ÙƒÙˆØ¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ù…Ù† Ù‚Ø§Ø¹Ø¯Ø© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª (Ø¯Ø¹Ù… Ø£Ø³Ù…Ø§Ø¡ Ø§Ù„Ø­Ù‚ÙˆÙ„ Ø§Ù„Ù…Ø®ØªÙ„ÙØ©)
            ...
            // Ø¥Ø°Ø§ ÙƒØ§Ù† Ù‡Ù†Ø§Ùƒ contractorIdØŒ Ø§Ù„Ø¨Ø­Ø« Ø¹Ù† ÙƒÙˆØ¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†
            ...
            // ØªÙˆÙ„ÙŠØ¯ ÙƒÙˆØ¯ ØªÙ„Ù‚Ø§Ø¦ÙŠ Ø¥Ø°Ø§ Ù„Ù… ÙŠÙƒÙ† Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ - Ø§Ø³ØªØ®Ø¯Ø§Ù… CON-xxx ÙÙ‚Ø·
            if (!contractorCode) {
                // Ø§Ù„Ø¨Ø­Ø« Ø¹Ù† Ø£ÙƒØ¨Ø± Ø±Ù‚Ù… ÙÙŠ Ø§Ù„Ø£ÙƒÙˆØ§Ø¯ Ø§Ù„Ù…ÙˆØ¬ÙˆØ¯Ø© (CON-xxx Ùˆ APP-xxx Ø§Ù„Ù‚Ø¯ÙŠÙ…Ø©)
                const contractors = AppState.appData.contractors || [];
                let maxNumber = 0;

                // Ø§Ù„Ø¨Ø­Ø« ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†
                contractors.forEach(contractor => {
                    if (contractor.code) {
                        const match = contractor.code.match(/CON-(\d+)/);
                        if (match) {
        ...
        if (mutated) {
            // Ø­ÙØ¸ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø¨Ø§Ø³ØªØ®Ø¯Ø§Ù… window.DataManager
            if (typeof window.DataManager !== 'undefined' && window.DataManager.save) {
                window.DataManager.save();
            } else {
                Utils.safeWarn('âš ï¸ DataManager ØºÙŠØ± Ù…ØªØ§Ø­ - Ù„Ù… ÙŠØªÙ… Ø­ÙØ¸ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª');
            }
        }
    },
    ...
    getFilteredApprovedEntities() {
        ...
        // ØªØ­ÙˆÙŠÙ„ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ø¹Ø§Ø¯ÙŠÙŠÙ† Ø¥Ù„Ù‰ Ù†ÙØ³ ØªÙ†Ø³ÙŠÙ‚ Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† Ù„Ù„ØªÙˆØ­ÙŠØ¯
        ...
        // Ø¯Ù…Ø¬ Ø§Ù„Ù‚ÙˆØ§Ø¦Ù… Ù…Ø¹ ØªØ¬Ù†Ø¨ Ø§Ù„ØªÙƒØ±Ø§Ø± (Ø¥Ø°Ø§ ÙƒØ§Ù† Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ù…ÙˆØ¬ÙˆØ¯ ÙÙŠ Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†ØŒ Ù†Ø³ØªØ®Ø¯Ù… Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†)
        ...
        convertedContractors.forEach(converted => {
            ...
            if (converted.contractorId && addedIds.has(converted.contractorId)) {
                return; // Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ù…ÙˆØ¬ÙˆØ¯ Ø¨Ø§Ù„ÙØ¹Ù„ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†
            }
            ...
            if (convertedCode) {
                ...
                if (existsByCode) {
                    return; // Ø§Ù„ÙƒÙˆØ¯ Ù…ÙˆØ¬ÙˆØ¯ Ø¨Ø§Ù„ÙØ¹Ù„
                }
            }
            ...
            if (convertedName) {
                ...
                if (existsByName) {
                    return; // Ø§Ù„Ø§Ø³Ù… Ù…ÙˆØ¬ÙˆØ¯ Ø¨Ø§Ù„ÙØ¹Ù„
                }
            }

            // Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ø¥Ø°Ø§ Ù„Ù… ÙŠÙƒÙ† Ù…ÙƒØ±Ø±Ø§Ù‹
    ...
    /**
     * Ø­Ø³Ø§Ø¨ Ø¥Ø­ØµØ§Ø¦ÙŠØ§Øª Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† (Ø¨Ù…Ø§ ÙÙŠ Ø°Ù„Ùƒ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ø¹Ø§Ø¯ÙŠÙŠÙ†)
     */
    getApprovedEntitiesStats() {
        ...
        // Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ø¹Ø§Ø¯ÙŠÙŠÙ† (Ø§Ù„Ø°ÙŠÙ† Ù„ÙŠØ³ÙˆØ§ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†)
        ...
        // Ø­Ø³Ø§Ø¨ Ø§Ù„ÙØªØ±Ø© Ø§Ù„Ù…Ø³ØªØºØ±Ù‚Ø© Ù„Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ (Ù…ØªÙˆØ³Ø·)
        ...
        return {
            ...
            avgApprovalTime,
            approvedCount: approvedEntities.length, // عدد المعتمدين الإجمالي
            existingCount: contractorsCount + suppliersCount // عدد الموجودين الإجمالي
        };
    },
        ...
        return `
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div class="content-card">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">Ø¹Ø¯Ø¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ù…ÙˆØ¬ÙˆØ¯ÙŠÙ†</p>
                            <p class="text-2xl font-bold text-blue-600">${stats.contractorsCount}</p>
                            <p class="text-xs text-gray-500">Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†: ${stats.contractorsCount}</p>
                        </div>
                        <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                            <i class="fas fa-users-cog text-blue-600 text-xl"></i>
                        </div>
                ...
                <div class="content-card">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">Ø¹Ø¯Ø¯ Ø§Ù„Ù…ÙˆØ±Ø¯ÙŠÙ† Ø§Ù„Ù…ÙˆØ¬ÙˆØ¯ÙŠÙ†</p>
                            <p class="text-2xl font-bold text-green-600">${stats.suppliersCount}</p>
                            <p class="text-xs text-gray-500">Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†: ${stats.suppliersCount}</p>
                        </div>
                        <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                ...
                <div class="content-card">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">Ø§Ù„Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ù…Ø¹ØªÙ…Ø¯</p>
                            <p class="text-2xl font-bold text-purple-600">${stats.approvedCount}</p>
                            <p class="text-xs text-gray-500">Ù…Ù† Ø§Ù„Ù…ÙˆØ¬ÙˆØ¯ÙŠÙ†: ${stats.existingCount}</p>
                        </div>
                        <div class="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                ...
                <div class="content-card">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">Ø§Ù„ÙØªØ±Ø© Ø§Ù„Ù…Ø³ØªØºØ±Ù‚Ø© Ù„Ù„Ø§Ø¹ØªÙ…Ø§Ø¯</p>
                ...
                <div class="card-header">
                    <div class="flex items-center justify-between flex-wrap gap-4">
                        ...
                        <div class="flex items-center gap-2 flex-wrap">
                            ...
                            <button type="button" id="import-approved-contractors-excel-btn" class="btn-secondary" title="Ø§Ø³ØªÙŠØ±Ø§Ø¯ Ù…Ù† Ù…Ù„Ù Excel (Ù†ÙØ³ Ø£Ø¹Ù…Ø¯Ø© Ø§Ù„ØªØµØ¯ÙŠØ±)">
        ...
        const rowsHtml = records.map((record) => {
            ...
            if (contractorCode && contractorCode.match(/^APP-(\d+)$/)) {
                ...
                if (match) {
                    ...
                    // ØªØ­Ø¯ÙŠØ« Ø§Ù„Ø³Ø¬Ù„ ÙÙŠ AppState
                    const approvedEntities = AppState.appData.approvedContractors || [];
            ...
            // ØªÙˆÙ„ÙŠØ¯ ÙƒÙˆØ¯ ØªÙ„Ù‚Ø§Ø¦ÙŠ Ø¥Ø°Ø§ Ù„Ù… ÙŠÙƒÙ† Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ (ÙŠØªÙ… ØªÙ„Ù‚Ø§Ø¦ÙŠØ§Ù‹ Ø¨Ø¹Ø¯ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯) - Ø§Ø³ØªØ®Ø¯Ø§Ù… CON-xxx ÙÙ‚Ø·
            if (!contractorCode && record.status === 'approved') {
                ...
                const newNumber = maxNumber + 1;
                contractorCode = `CON-${String(newNumber).padStart(3, '0')}`;
                // Ø­ÙØ¸ Ø§Ù„ÙƒÙˆØ¯ ÙÙŠ Ø§Ù„Ø³Ø¬Ù„ ÙˆÙÙŠ AppState
                record.code = contractorCode;
                record.isoCode = contractorCode;
                // ØªØ­Ø¯ÙŠØ« Ø§Ù„Ø³Ø¬Ù„ ÙÙŠ AppState
                const approvedIndex = approvedEntities.findIndex(e => e.id === record.id);
                if (approvedIndex !== -1) {
                    ...
                    if (typeof GoogleIntegration !== 'undefined' && GoogleIntegration.sendRequest) {
                        GoogleIntegration.sendRequest({
                            ...
                            data: record
                        }).catch(err => Utils.safeWarn('Ø®Ø·Ø£ ÙÙŠ Ø­ÙØ¸ ÙƒÙˆØ¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„:', err));
                    }
                }
            }
            ...
            if (record.isRegularContractor && record.requirementsStatus) {
                ...
                requirementsBadge = reqStatus.allMet
                    ? '<span class="badge badge-success ml-2">Ù…Ø³ØªÙˆÙÙŠ</span>'
            ...
            const actionsHtml = isRegular ? `
                <div class="flex items-center gap-2">
                    ...
                    <button class="btn-icon btn-icon-success" title="Ø¥Ø¶Ø§ÙØ© ØªÙ‚ÙŠÙŠÙ…" onclick="Contractors.showEvaluationForm('${contractorId}')">
            ...
            ` : `
                <div class="flex items-center gap-2">
                    <button class="btn-icon btn-icon-info" title="Ø¹Ø±Ø¶ Ø§Ù„ØªÙØ§ØµÙŠÙ„" onclick="Contractors.viewApprovedEntity('${record.id}')">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="btn-icon btn-icon-primary" title="ØªØ¹Ø¯ÙŠÙ„" onclick="Contractors.showApprovedEntityForm('${record.id}')">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="btn-icon btn-icon-success" title="Ø¥Ø¶Ø§ÙØ© ØªÙ‚ÙŠÙŠÙ…" onclick="Contractors.showEvaluationFormForApproved('${record.id}')">
                        <i class="fas fa-clipboard-check"></i>
                    </button>
    ...
    getActiveApprovedEntities(options = {}) {
        ...
        const checkRequirements = options.checkRequirements === true; // âœ… Ø¥Ø¶Ø§ÙØ© Ø®ÙŠØ§Ø± Ù„Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª
        
        let list = (AppState.appData.approvedContractors || []).filter((record) => this.isApprovalActive(record, includeExpired));

        // âœ… Ø¥ØµÙ„Ø§Ø­: ØªØµÙÙŠØ© Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø§Ø®ØªÙŠØ§Ø±ÙŠØ© ÙÙ‚Ø·
        // âœ… Ø§Ù„Ù…Ù†Ø·Ù‚ Ø§Ù„ØµØ­ÙŠØ­: Ø¥Ø°Ø§ ÙƒØ§Ù† Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† Ø¨Ø­Ø§Ù„Ø© 'approved'ØŒ ÙŠØ¬Ø¨ Ø£Ù† ÙŠØ¸Ù‡Ø±
        // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª ÙŠÙƒÙˆÙ† ÙÙ‚Ø· Ø¹Ù†Ø¯ Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„ØµØ±ÙŠØ­ (checkRequirements = true)
        if (checkRequirements) {
            list = list.filter(record => {
                ...
                // Ø¥Ø°Ø§ Ù„Ù… ÙŠÙƒÙ† Ù‡Ù†Ø§Ùƒ Ù…Ø¹Ø±Ù Ù…Ù‚Ø§ÙˆÙ„ØŒ Ù†Ø¹ØªØ¨Ø±Ù‡ Ù…Ø¹ØªÙ…Ø¯Ø§Ù‹ (Ù„Ù„ØªÙˆØ§ÙÙ‚ Ù…Ø¹ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù‚Ø¯ÙŠÙ…Ø©)
                return true;
            });
        }
    ...
    getApprovedOptions(includeExpired = false) {
        return this.getActiveApprovedEntities({ includeExpired }).map((record) => ({
            ...
            contractorId: record.contractorId || null // Ø¥Ø¶Ø§ÙØ© contractorId Ù„Ù„Ø±Ø¨Ø·
        }));
    },
    ...
    getContractorById(contractorId) {
        ...
        // Ø§Ù„Ø¨Ø­Ø« ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø£ÙˆÙ„Ø§Ù‹
        const contractors = AppState.appData.contractors || [];
        ...
        // Ø¥Ø°Ø§ Ù„Ù… ÙŠÙˆØ¬Ø¯ØŒ Ø§Ù„Ø¨Ø­Ø« ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†
        this.ensureApprovedSetup();
        const approvedContractors = AppState.appData.approvedContractors || [];
     ...
     * âœ… ØªÙ… Ø§Ù„ØªØ¹Ø¯ÙŠÙ„: Ø§Ø³ØªØ®Ø¯Ø§Ù… getActiveApprovedEntities() Ù„Ø¶Ù…Ø§Ù† Ø¹Ø±Ø¶ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† ÙÙ‚Ø·
     */
    getAllContractorsForModules() {
        ...
        if (!AppState || !AppState.appData) {
            if (typeof window !== 'undefined') {
                ...
                return []; // Ø¥Ø±Ø¬Ø§Ø¹ Ù…ØµÙÙˆÙØ© ÙØ§Ø±ØºØ© Ø¥Ø°Ø§ Ù„Ù… ÙŠÙƒÙ† AppState Ù…ØªØ§Ø­Ø§Ù‹
            }
        }
        ...
        const computeIdentityKey = (record) => {
            // Ø§Ù„Ø£ÙØ¶Ù„ÙŠØ©: code (CON-xxx) â†’ licenseNumber â†’ contractorId/id â†’ name
        ...
        const chooseBetter = (current, incoming) => {
            ...
            // âœ… Ø¥ØµÙ„Ø§Ø­: Ø¯Ù…Ø¬ Ø§Ù„Ø³Ø¬Ù„Ø§Øª Ù…Ø¹ Ø§Ù„Ø­ÙØ§Ø¸ Ø¹Ù„Ù‰ approvedEntityId
            // Ø§Ù„Ø£Ù‡Ù…: Ø¥Ø°Ø§ Ø£Ø­Ø¯Ù‡Ù…Ø§ Ù„Ù‡ approvedEntityIdØŒ ÙŠØ¬Ø¨ Ø§Ù„Ø­ÙØ§Ø¸ Ø¹Ù„ÙŠÙ‡
            const merged = { ...current, ...incoming };
            
            // âœ… Ø­ÙØ¸ approvedEntityId Ù…Ù† Ø£ÙŠ Ù…Ù† Ø§Ù„Ø³Ø¬Ù„ÙŠÙ†
            ...
            // ØªÙØ¶ÙŠÙ„ Ø§Ù„Ø§Ø³Ù… Ø§Ù„Ø­Ù‚ÙŠÙ‚ÙŠ
            ...
            // ØªÙØ¶ÙŠÙ„ ÙˆØ¬ÙˆØ¯ code / license
        ...
        // âœ… Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ù…Ù† Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† (Ø¨Ø¯ÙˆÙ† Ø§Ø´ØªØ±Ø§Ø· contractor.name ÙÙ‚Ø·)
        ...
        // âœ… Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ù…Ù† Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†
        // âœ… Ù…Ù‡Ù… Ù„Ù„Ù†Ù…Ø§Ø°Ø¬: Ù†ÙØ¸Ù‡Ø± Ø¬Ù…ÙŠØ¹ "approved" Ø­ØªÙ‰ Ù„Ùˆ Ù…Ù†ØªÙ‡ÙŠØ© Ø§Ù„ØµÙ„Ø§Ø­ÙŠØ© (Ù„Ù„ØªØ³Ø¬ÙŠÙ„/Ø§Ù„ØªÙˆØ«ÙŠÙ‚ Ø§Ù„ØªØ§Ø±ÙŠØ®ÙŠ)
        this.ensureApprovedSetup();
    ...
    /**
     * âœ… Ù…ØµØ¯Ø± Ù…ÙˆØ­Ù‘Ø¯ Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† ÙÙŠ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ù†Ù…Ø§Ø°Ø¬
     * ÙŠØ¹ÙŠØ¯ Ù‚Ø§Ø¦Ù…Ø© Ù…Ø±ØªÙ‘Ø¨Ø© ÙˆÙ…Ø²Ø§Ù„Ø© Ø§Ù„ØªÙƒØ±Ø§Ø± Ù„Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù… ÙÙŠ select/datalist.
     *
    ...
    getContractorOptionsForModules(options = {}) {
        ...
        const approvedOnly = options.approvedOnly !== false; // âœ… Ø§ÙØªØ±Ø§Ø¶ÙŠ: Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†/Ø§Ù„Ù…ÙˆØ±Ø¯ÙŠÙ† Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† ÙÙ‚Ø·
    ...
    /**
     * âœ… ØªÙˆØ­ÙŠØ¯ ØªØ¹Ø¨Ø¦Ø© select Ø§Ù„Ø®Ø§Øµ Ø¨Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† ÙÙŠ ÙƒÙ„ Ø§Ù„Ù…ÙˆØ¯ÙŠÙˆÙ„Ø§Øª
     *
    ...
    populateContractorSelect(selectElement, options = {}) {
        ...
        const includeSuppliers = options.includeSuppliers === true;
        const approvedOnly = options.approvedOnly !== false; // âœ… Ø§ÙØªØ±Ø§Ø¶ÙŠ: true Ù„Ù„Ø­ÙØ§Ø¸ Ø¹Ù„Ù‰ Ø§Ù„ØªÙˆØ§ÙÙ‚
        ...
        contractors.forEach((contractor) => {
            ...
            if (selectedContractorId && contractor.id === selectedContractorId) {
                ...
                // Ø¯Ø¹Ù… Ø§Ù„Ø­ÙØ¸ Ø§Ù„Ù‚Ø¯ÙŠÙ… Ø¨Ø§Ù„Ø§Ø³Ù…
    ...
    showApprovedEntityForm(id = null) {
            ...
            <div class="modal-content" style="max-width: 720px;">
                <div class="modal-header">
                    <h2 class="modal-title">
                        <i class="fas fa-check-circle ml-2"></i>
                        ${existing ? 'ØªØ¹Ø¯ÙŠÙ„ Ø¬Ù‡Ø© Ù…Ø¹ØªÙ…Ø¯Ø©' : 'Ø¥Ø¶Ø§ÙØ© Ø¬Ù‡Ø© Ù…Ø¹ØªÙ…Ø¯Ø©'}
                    </h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="approved-status" class="form-input" required>
                                ...
                                <option value="rejected" ${existing?.status === 'rejected' ? 'selected' : ''}>Ù…Ø±ÙÙˆØ¶</option>
                            </select>
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Ù…Ù„Ø§Ø­Ø¸Ø§Øª</label>
                        <textarea id="approved-notes" class="form-input" rows="3" placeholder="Ù…Ù„Ø§Ø­Ø¸Ø§Øª Ø¥Ø¶Ø§ÙÙŠØ©">${Utils.escapeHTML(existing?.notes || '')}</textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn-secondary" onclick="this.closest('.modal-overlay').remove()">Ø¥Ù„ØºØ§Ø¡</button>
                        <button type="submit" class="btn-primary">
                            <i class="fas fa-save ml-2"></i>
                            ${existing ? 'ØªØ­Ø¯ÙŠØ«' : 'Ø­ÙØ¸'}
                        </button>
                    </div>
                </form>
            </div>
        ...
        form?.addEventListener('submit', (event) => {
            ...
            // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø£Ù† modal Ù„Ø§ ÙŠØ²Ø§Ù„ Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ ÙÙŠ DOM
            if (!modal || !document.contains(modal)) {
                Utils.safeWarn('âš ï¸ submit approved-contractor-form: modal ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯ Ø£Ùˆ ØªÙ… Ø­Ø°ÙÙ‡');
                return;
            }
            
            // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø£Ù† form Ù„Ø§ ÙŠØ²Ø§Ù„ Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ ÙÙŠ DOM
            if (!form || !document.contains(form)) {
                Utils.safeWarn('âš ï¸ submit approved-contractor-form: form ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯ Ø£Ùˆ ØªÙ… Ø­Ø°ÙÙ‡');
                return;
            }
            
            try {
                // âœ… Ø­ÙØ¸ Ù…Ø±Ø§Ø¬Ø¹ Ø§Ù„Ø¹Ù†Ø§ØµØ± Ù‚Ø¨Ù„ Ø£ÙŠ Ø¹Ù…Ù„ÙŠØ§Øª async
                ...
                // Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø¹Ø¯Ù… ÙˆØ¬ÙˆØ¯ ØªÙƒØ±Ø§Ø± Ù‚Ø¨Ù„ Ø§Ù„Ø­ÙØ¸ (Ù„Ù„Ø­Ø§Ù„Ø§Øª Ø§Ù„Ø¬Ø¯ÙŠØ¯Ø© ÙÙ‚Ø·)
                if (!existing) {
                    const approvedEntities = AppState.appData.approvedContractors || [];
                    ...
                    // ÙØ­Øµ Ø§Ù„ØªÙƒØ±Ø§Ø± Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰ Ø§Ø³Ù… Ø§Ù„Ø´Ø±ÙƒØ© + Ù†ÙˆØ¹ Ø§Ù„Ø¬Ù‡Ø©
                    ...
                    if (duplicateByName) {
                        Notification.error(`ÙŠÙˆØ¬Ø¯ Ø¨Ø§Ù„ÙØ¹Ù„ Ù…Ù‚Ø§ÙˆÙ„/Ù…ÙˆØ±Ø¯ Ù…Ø¹ØªÙ…Ø¯ Ø¨Ù†ÙØ³ Ø§Ù„Ø§Ø³Ù… (${companyName}) ÙˆÙ†ÙˆØ¹ Ø§Ù„Ø¬Ù‡Ø©. ÙŠØ±Ø¬Ù‰ Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„Ù‚Ø§Ø¦Ù…Ø©.`);
                        return;
                    }

                    // ÙØ­Øµ Ø§Ù„ØªÙƒØ±Ø§Ø± Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰ Ø§Ù„Ø³Ø¬Ù„ Ø§Ù„ØªØ¬Ø§Ø±ÙŠ (Ø¥Ø°Ø§ ÙƒØ§Ù† Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹)
                    if (normalizedLicenseNumber) {
                        ...
                        if (duplicateByLicense) {
                            Notification.error(`ÙŠÙˆØ¬Ø¯ Ø¨Ø§Ù„ÙØ¹Ù„ Ù…Ù‚Ø§ÙˆÙ„/Ù…ÙˆØ±Ø¯ Ù…Ø¹ØªÙ…Ø¯ Ø¨Ù†ÙØ³ Ø§Ù„Ø³Ø¬Ù„ Ø§Ù„ØªØ¬Ø§Ø±ÙŠ (${licenseNumber}). ÙŠØ±Ø¬Ù‰ Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„Ù‚Ø§Ø¦Ù…Ø©.`);
                            return;
                        }
                    }
                }

                // ØªÙˆÙ„ÙŠØ¯ ÙƒÙˆØ¯ ØªÙ„Ù‚Ø§Ø¦ÙŠ Ù„Ù„ÙƒÙŠØ§Ù†Ø§Øª Ø§Ù„Ø¬Ø¯ÙŠØ¯Ø© - Ø§Ø³ØªØ®Ø¯Ø§Ù… CON-xxx ÙÙ‚Ø·
                ...
                if (!entityCode) {
                    ...
                    // Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø¹Ø¯Ù… ØªÙƒØ±Ø§Ø± Ø§Ù„ÙƒÙˆØ¯ (Ù„Ù„Ø­Ø§Ù„Ø§Øª Ø§Ù„Ø¬Ø¯ÙŠØ¯Ø© ÙÙ‚Ø·)
                    if (!existing) {
                        const approvedEntities = AppState.appData.approvedContractors || [];
                        ...
                        if (duplicateByCode) {
                            Notification.error(`ÙŠÙˆØ¬Ø¯ Ø¨Ø§Ù„ÙØ¹Ù„ Ù…Ù‚Ø§ÙˆÙ„/Ù…ÙˆØ±Ø¯ Ù…Ø¹ØªÙ…Ø¯ Ø¨Ù†ÙØ³ Ø§Ù„ÙƒÙˆØ¯ (${entityCode}). Ø³ÙŠØªÙ… ØªÙˆÙ„ÙŠØ¯ ÙƒÙˆØ¯ Ø¬Ø¯ÙŠØ¯ ØªÙ„Ù‚Ø§Ø¦ÙŠØ§Ù‹.`);
                            // ØªÙˆÙ„ÙŠØ¯ ÙƒÙˆØ¯ Ø¬Ø¯ÙŠØ¯ CON-xxx
                            const contractors = AppState.appData.contractors || [];
                            let maxNumber = 0;
                ...
                Notification.success(existing ? 'ØªÙ… ØªØ­Ø¯ÙŠØ« Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø¬Ù‡Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©' : 'ØªÙ… Ø­ÙØ¸ Ø§Ù„Ø¬Ù‡Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø© Ø¨Ù†Ø¬Ø§Ø­');
                ...
                // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø£Ù† modal Ù„Ø§ ÙŠØ²Ø§Ù„ Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ ÙÙŠ DOM Ù‚Ø¨Ù„ Ø§Ù„Ø¥Ø²Ø§Ù„Ø©
                if (modal && document.contains(modal)) {
                    try {
                modal.remove();
                    } catch (removeError) {
                        Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ Ø¥Ø²Ø§Ù„Ø© modal:', removeError);
                        ...
                        if (modalParent) {
                            try {
                                ...
                                Utils.safeWarn('âš ï¸ ÙØ´Ù„Øª Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø© Ø§Ù„Ø¨Ø¯ÙŠÙ„Ø© Ù„Ø¥Ø²Ø§Ù„Ø© modal:', e);
                            }
                        }
                    }
                }
            } catch (error) {
                Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ø­ÙØ¸ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø¬Ù‡Ø§Øª Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©:', error);
                Notification.error('ØªØ¹Ø°Ø± Ø­ÙØ¸ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø¬Ù‡Ø©: ' + error.message);
            }
        });
    ...
    viewApprovedEntity(id) {
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width: 680px;">
                <div class="modal-header">
                    <h2 class="modal-title"><i class="fas fa-id-card ml-2"></i>ØªÙØ§ØµÙŠÙ„ Ø§Ù„Ø¬Ù‡Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©</h2>
                    <button class="modal-close" onclick="this.closest('.modal-overlay').remove()">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
    ...
    persistApprovedEntity(record, existing = null) {
        ...
        if (!Array.isArray(collection) || collection.length === 0) {
            ...
            try {
                if (typeof GoogleIntegration !== 'undefined' && GoogleIntegration.syncData) {
                    // Ø³Ù†Ù‚ÙˆÙ… Ø¨Ù…Ø²Ø§Ù…Ù†Ø© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª ÙÙŠ Ø§Ù„Ø®Ù„ÙÙŠØ© ÙˆÙ„ÙƒÙ† Ù„Ø§ Ù†Ù†ØªØ¸Ø±Ù‡Ø§
                    GoogleIntegration.syncData({
                        silent: true,
                        showLoader: false,
                        notifyOnSuccess: false,
                        ...
                        if (Array.isArray(collection) && collection.length > 0) {
                            // Ø¥Ø¹Ø§Ø¯Ø© Ù…Ø­Ø§ÙˆÙ„Ø© Ø§Ù„Ø­ÙØ¸ Ø¨Ø¹Ø¯ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©
                            this.persistApprovedEntity(record, existing);
                        }
                    }).catch(() => {
                        // ÙÙŠ Ø­Ø§Ù„Ø© ÙØ´Ù„ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©ØŒ Ù†ØªØ§Ø¨Ø¹ Ø¨Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø­Ø§Ù„ÙŠØ©
                    });
                }
            } catch (error) {
                Utils.safeWarn('ÙØ´Ù„ Ù…Ø­Ø§ÙˆÙ„Ø© Ù…Ø²Ø§Ù…Ù†Ø© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª:', error);
            }
        }

        // Ø¥Ù†Ø´Ø§Ø¡ Ù†Ø³Ø®Ø© Ù…Ù† Ø§Ù„Ù…ØµÙÙˆÙØ© Ù„ØªØ¬Ù†Ø¨ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„Ù…Ø¨Ø§Ø´Ø±
        ...
        if (existing) {
            ...
            // Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø¹Ø¯Ù… ÙˆØ¬ÙˆØ¯ Ø³Ø¬Ù„ Ù…ÙƒØ±Ø± Ù‚Ø¨Ù„ Ø§Ù„Ø¥Ø¶Ø§ÙØ©
            // ÙØ­Øµ Ø§Ù„ØªÙƒØ±Ø§Ø± Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰: Ø§Ù„Ù…Ø¹Ø±ÙØŒ Ø§Ù„ÙƒÙˆØ¯ØŒ Ø§Ø³Ù… Ø§Ù„Ø´Ø±ÙƒØ© + Ù†ÙˆØ¹ Ø§Ù„Ø¬Ù‡Ø©ØŒ Ø§Ù„Ø³Ø¬Ù„ Ø§Ù„ØªØ¬Ø§Ø±ÙŠ
            const duplicateIndex = collection.findIndex((item) => {
                // ÙØ­Øµ Ø§Ù„ØªÙƒØ±Ø§Ø± Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰ Ø§Ù„Ù…Ø¹Ø±Ù
                if (item.id === record.id) return true;

                // ÙØ­Øµ Ø§Ù„ØªÙƒØ±Ø§Ø± Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰ Ø§Ù„ÙƒÙˆØ¯ (Ø¥Ø°Ø§ ÙƒØ§Ù† Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹)
                if (record.isoCode || record.code) {
            ...
            if (duplicateIndex !== -1) {
                // ØªØ­Ø¯ÙŠØ« Ø§Ù„Ø³Ø¬Ù„ Ø§Ù„Ù…ÙˆØ¬ÙˆØ¯ Ø¨Ø¯Ù„Ø§Ù‹ Ù…Ù† Ø¥Ø¶Ø§ÙØ© Ø¬Ø¯ÙŠØ¯
                const existing = collection[duplicateIndex];
                // Ø§Ù„Ø­ÙØ§Ø¸ Ø¹Ù„Ù‰ Ø§Ù„Ù…Ø¹Ø±Ù Ø§Ù„Ø£ØµÙ„ÙŠ ÙˆØªØ§Ø±ÙŠØ® Ø§Ù„Ø¥Ù†Ø´Ø§Ø¡
                collection[duplicateIndex] = {
                    ...record,
                    id: existing.id,
                    createdAt: existing.createdAt || record.createdAt
                };
                Utils.safeWarn(`âš ï¸ ØªÙ… Ø§ÙƒØªØ´Ø§Ù ØªÙƒØ±Ø§Ø± Ù„Ù„Ù…Ù‚Ø§ÙˆÙ„/Ø§Ù„Ù…ÙˆØ±Ø¯: ${record.companyName} - ØªÙ… Ø§Ù„ØªØ­Ø¯ÙŠØ« Ø¨Ø¯Ù„Ø§Ù‹ Ù…Ù† Ø§Ù„Ø¥Ø¶Ø§ÙØ©`);
            } else {
                collection.push({ ...record });
            }
        }
        ...
        try {
            // Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„ÙƒØ§Ù…Ù„Ø© ÙˆÙ„ÙŠØ³ ÙÙ‚Ø· Ø§Ù„Ø³Ø¬Ù„ Ø§Ù„Ø¬Ø¯ÙŠØ¯
            GoogleIntegration.autoSave?.('ApprovedContractors', AppState.appData.approvedContractors).catch(error => {
                Utils.safeWarn('ÙØ´Ù„ Ø§Ù„Ø­ÙØ¸ Ø§Ù„ØªÙ„Ù‚Ø§Ø¦ÙŠ Ù„Ø¬Ù‡Ø§Øª Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯:', error);
            });
        } catch (error) {
            Utils.safeWarn('ÙØ´Ù„ Ø§Ù„Ø­ÙØ¸ Ø§Ù„ØªÙ„Ù‚Ø§Ø¦ÙŠ Ù„Ø¬Ù‡Ø§Øª Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯:', error);
        }
    ...
    async requestDeleteApprovedEntity(id) {
        ...
        // Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„ØµÙ„Ø§Ø­ÙŠØ§Øª - ÙÙ‚Ø· Ø§Ù„Ù…Ø¯ÙŠØ± ÙŠÙ…ÙƒÙ†Ù‡ Ø­Ø°Ù Ù…Ø¨Ø§Ø´Ø±Ø©
        ...
        if (!confirm('Ø³ÙŠØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø­Ø°Ù Ù‡Ø°Ù‡ Ø§Ù„Ø¬Ù‡Ø© Ø¥Ù„Ù‰ Ù…Ø¯ÙŠØ± Ø§Ù„Ù†Ø¸Ø§Ù… Ù„Ù„Ù…ÙˆØ§ÙÙ‚Ø©. Ù‡Ù„ ØªØ±ÙŠØ¯ Ø§Ù„Ù…ØªØ§Ø¨Ø¹Ø©ØŸ')) {
            return;
        }
    ...
    async deleteApprovedEntity(id) {
        ...
        if (!confirm('Ù‡Ù„ Ø£Ù†Øª Ù…ØªØ£ÙƒØ¯ Ù…Ù† Ø­Ø°Ù Ù‡Ø°Ù‡ Ø§Ù„Ø¬Ù‡Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©ØŸ Ø³ÙŠØªÙ… Ø­Ø°ÙÙ‡Ø§ Ù…Ù† Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† ÙˆØ§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†.')) {
            return;
        }
        ...
        try {
            ...
            Loading.hide();
            // Utils.safeError('ÙØ´Ù„ Ø­Ø°Ù Ø§Ù„Ø¬Ù‡Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©:', error); // safeError might not exist or be needed
            console.error('ÙØ´Ù„ Ø­Ø°Ù Ø§Ù„Ø¬Ù‡Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©:', error);
            Notification.error('ÙØ´Ù„ Ø­Ø°Ù Ø§Ù„Ø¬Ù‡Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©: ' + error.message);
    ...
    exportApprovedEntitiesExcel() {
        ...
        if (typeof XLSX === 'undefined') {
            Notification.error('Ù…ÙƒØªØ¨Ø© SheetJS ØºÙŠØ± Ù…Ø­Ù…Ù‘Ù„Ø©. ÙŠØ±Ø¬Ù‰ ØªØ­Ø¯ÙŠØ« Ø§Ù„ØµÙØ­Ø© Ø£Ùˆ ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ù…ÙƒØªØ¨Ø©.');
            return;
        }
        ...
        const data = records.map((record) => ({
            ...
            'ØªØ§Ø±ÙŠØ® Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯': record.approvalDate && typeof Utils.formatDateForInput === 'function'
                ? Utils.formatDateForInput(record.approvalDate)
                : (record.approvalDate ? Utils.formatDate(record.approvalDate) : ''),
            'ØªØ§Ø±ÙŠØ® Ø§Ù†ØªÙ‡Ø§Ø¡ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯': record.expiryDate && typeof Utils.formatDateForInput === 'function'
    ...
    /**
     * ØªØ­ÙˆÙŠÙ„ Ù‚ÙŠÙ…Ø© ØªØ§Ø±ÙŠØ® Ù…Ù† Excel (Ù†ØµØŒ Ø±Ù‚Ù… ØªØ³Ù„Ø³Ù„ÙŠØŒ Ø£Ùˆ Date) Ø¥Ù„Ù‰ ISO
     */
    ...
    async importApprovedEntitiesFromExcelFile(file) {
        this.ensureApprovedSetup();
        if (!Permissions.isAdmin()) {
            Notification.warning('ÙŠÙØ³Ù…Ø­ Ù„Ù„Ù…Ø¯ÙŠØ± ÙÙ‚Ø· Ø¨Ø§Ø³ØªÙŠØ±Ø§Ø¯ Ø§Ù„Ù‚Ø§Ø¦Ù…Ø©.');
            return;
        }
        if (!file) return;
        if (typeof XLSX === 'undefined') {
            Notification.error('Ù…ÙƒØªØ¨Ø© SheetJS ØºÙŠØ± Ù…Ø­Ù…Ù‘Ù„Ø©. ÙŠØ±Ø¬Ù‰ ØªØ­Ø¯ÙŠØ« Ø§Ù„ØµÙØ­Ø©.');
            return;
        }
        ...
        try {
            ...
            Notification.error('ØªØ¹Ø°Ø± Ù‚Ø±Ø§Ø¡Ø© Ù…Ù„Ù Excel.');
            return;
        }
        ...
        if (!sheet) {
            Notification.error('Ø§Ù„Ù…Ù„Ù Ù„Ø§ ÙŠØ­ØªÙˆÙŠ Ø¹Ù„Ù‰ ÙˆØ±Ù‚Ø© Ø¨ÙŠØ§Ù†Ø§Øª.');
            return;
        }

        const rows = XLSX.utils.sheet_to_json(sheet, { defval: '', raw: true });
        if (!Array.isArray(rows) || rows.length === 0) {
            Notification.warning('Ù„Ø§ ØªÙˆØ¬Ø¯ ØµÙÙˆÙ ÙÙŠ Ø§Ù„Ù…Ù„Ù.');
            return;
        }
        ...
        try {
            for (let r = 0; r < rows.length; r++) {
                ...
                const companyName = String(this.getApprovedImportCell(row,
                    'Ø§Ø³Ù… Ø§Ù„Ø´Ø±ÙƒØ© / Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„', 'Ø§Ø³Ù… Ø§Ù„Ø´Ø±ÙƒØ©', 'companyName')).trim();
                if (!companyName) {
                    skipped++;
                    continue;
                }

                const typeLabel = String(this.getApprovedImportCell(row, 'Ù†ÙˆØ¹ Ø§Ù„Ø¬Ù‡Ø©', 'entityType')).trim();
                const serviceType = String(this.getApprovedImportCell(row,
                    'Ø§Ù„Ù†Ø´Ø§Ø· / Ù†ÙˆØ¹ Ø§Ù„Ø®Ø¯Ù…Ø©', 'Ø§Ù„Ù†Ø´Ø§Ø·', 'serviceType')).trim();
                const licenseNumber = String(this.getApprovedImportCell(row,
                    'Ø§Ù„Ø³Ø¬Ù„ Ø§Ù„ØªØ¬Ø§Ø±ÙŠ / Ø§Ù„ØªØ±Ø®ÙŠØµ', 'Ø§Ù„Ø³Ø¬Ù„ Ø§Ù„ØªØ¬Ø§Ø±ÙŠ', 'licenseNumber')).trim();

                const approvalISO = this.parseApprovedImportDate(this.getApprovedImportCell(row,
                    'ØªØ§Ø±ÙŠØ® Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯', 'approvalDate'));
                const expiryISO = this.parseApprovedImportDate(this.getApprovedImportCell(row,
                    'ØªØ§Ø±ÙŠØ® Ø§Ù†ØªÙ‡Ø§Ø¡ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯', 'expiryDate'));
                ...
                const safetyReviewer = String(this.getApprovedImportCell(row,
                    'Ù…Ø³Ø¤ÙˆÙ„ Ø§Ù„Ø³Ù„Ø§Ù…Ø©', 'safetyReviewer')).trim();
                const statusLabel = String(this.getApprovedImportCell(row, 'Ø§Ù„Ø­Ø§Ù„Ø©', 'status')).trim();
                const notes = String(this.getApprovedImportCell(row, 'Ù…Ù„Ø§Ø­Ø¸Ø§Øª', 'notes')).trim();

                const entityType = this.normalizeApprovedEntityType(typeLabel || 'Ù…Ù‚Ø§ÙˆÙ„');
                const status = this.normalizeApprovedStatus(statusLabel || 'Ù…Ø¹ØªÙ…Ø¯');
            ...
            Notification.success(`Ø§ÙƒØªÙ…Ù„ Ø§Ù„Ø§Ø³ØªÙŠØ±Ø§Ø¯: ØµÙÙˆÙ Ø¬Ø¯ÙŠØ¯Ø© ${added}ØŒ ØªØ­Ø¯ÙŠØ« ${updated}ØŒ ØªØ®Ø·ÙŠ ${skipped}.`);
            if (this.currentTab === 'approved') {
                this.refreshApprovedEntitiesList();
            }
        } catch (err) {
            Utils.safeError('ÙØ´Ù„ Ø§Ø³ØªÙŠØ±Ø§Ø¯ Ø§Ù„Ø¬Ù‡Ø§Øª Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©:', err);
            Notification.error('ÙØ´Ù„ Ø§Ù„Ø§Ø³ØªÙŠØ±Ø§Ø¯: ' + (err.message || 'Ø®Ø·Ø£ ØºÙŠØ± Ù…Ø¹Ø±ÙˆÙ'));
        } finally {
            Loading.hide();
        }
    },
    ...
    exportApprovedEntitiesPDF(id = null) {
        ...
        try {
            ...
            if (printWindow) {
                ...
                Loading.hide();
                Notification.error('ÙŠØ±Ø¬Ù‰ Ø§Ù„Ø³Ù…Ø§Ø­ Ø¨Ù†ÙˆØ§ÙØ° Ù…Ù†Ø¨Ø«Ù‚Ø© Ù„Ù„Ø·Ø¨Ø§Ø¹Ø©');
            }
        } catch (error) {
            Loading.hide();
            Utils.safeError('Ø®Ø·Ø£ ÙÙŠ ØªØµØ¯ÙŠØ± Ø§Ù„Ø¬Ù‡Ø§Øª Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©:', error);
            Notification.error('ÙØ´Ù„ ÙÙŠ ØªØµØ¯ÙŠØ± Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ø¬Ù‡Ø§Øª Ø§Ù„Ù…Ø¹ØªÙ…Ø¯Ø©: ' + error.message);
        }
    },
    ...
    renderEvaluationsTable(contractorId = '') {
        // âœ… Ø¥ØµÙ„Ø§Ø­: ØªØ¬Ù…ÙŠØ¹ Ø§Ù„Ø¨Ù†ÙˆØ¯ Ù…Ù† ØµÙÙˆÙ Ù…Ù†ÙØµÙ„Ø©
        ...
        allRecords.forEach(record => {
            ...
            // ØªØµÙÙŠØ© Ø­Ø³Ø¨ contractorId Ø¥Ø°Ø§ ÙƒØ§Ù† Ù…Ø­Ø¯Ø¯Ø§Ù‹
            ...
            // Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ø¨Ù†Ø¯ Ø¥Ù„Ù‰ Ø§Ù„Ù…ØµÙÙˆÙØ©
                    ...
                    <tbody>
                        ${records.map(record => `
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center gap-2">
                                        <button class="btn-icon btn-icon-info" title="Ø¹Ø±Ø¶ Ø§Ù„ØªÙØ§ØµÙŠÙ„" onclick="Contractors.viewEvaluation('${record.id}')">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        ${Permissions.isAdmin() ? `
    ...
    async renderRequirementsManagementSection() {
                ...
                <div class="content-card">
                    <div class="card-body">
                        <div class="empty-state">
                            ...
                            <p class="text-gray-500">Ù‡Ø°Ù‡ Ø§Ù„ØµÙØ­Ø© Ù…ØªØ§Ø­Ø© Ù„Ù„Ù…Ø¯ÙŠØ± ÙÙ‚Ø·</p>
                        </div>
                    </div>
                </div>
            `;
        ...
        // ØªØ¬Ù…ÙŠØ¹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø­Ø³Ø¨ Ø§Ù„ÙØ¦Ø©
        ...
        return `
            <div class="content-card">
                ...
                <div class="card-body">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-blue-700">
                                    ÙŠÙ…ÙƒÙ†Ùƒ Ø¥Ø¯Ø§Ø±Ø© Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø¨Ø´ÙƒÙ„ Ù…ØªØ·ÙˆØ± Ù…Ø¹ Ø¯Ø¹Ù… Ø§Ù„ØªØµÙ†ÙŠÙØ§ØªØŒ Ø§Ù„Ø£ÙˆÙ„ÙˆÙŠØ§ØªØŒ ÙˆØªÙˆØ§Ø±ÙŠØ® Ø§Ù„Ø§Ù†ØªÙ‡Ø§Ø¡. 
                                    Ø§Ø³ØªØ®Ø¯Ù… Ø§Ù„Ø³Ø­Ø¨ ÙˆØ§Ù„Ø¥ÙÙ„Ø§Øª Ù„Ø¥Ø¹Ø§Ø¯Ø© ØªØ±ØªÙŠØ¨ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª.
                                </p>
                            </div>
                        </div>
                    </div>

                    <!-- ÙÙ„ØªØ± Ø­Ø³Ø¨ Ø§Ù„ÙØ¦Ø© -->
                    <div class="mb-4 flex items-center gap-3 flex-wrap">
                        <label class="text-sm font-semibold text-gray-700">ÙÙ„ØªØ± Ø­Ø³Ø¨ Ø§Ù„ÙØ¦Ø©:</label>
                    ...
                    <!-- Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ù…Ø¹ Ø§Ù„ØªØµÙ†ÙŠÙØ§Øª -->
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                                                <select class="form-input text-sm" data-field="type">
                                                                    <option value="document" ${req.type === 'document' ? 'selected' : ''}>ðŸ“„ Ù…Ø³ØªÙ†Ø¯</option>
                                                                    <option value="checkbox" ${req.type === 'checkbox' ? 'selected' : ''}>â˜‘ï¸ Ù…Ø±Ø¨Ø¹ Ø§Ø®ØªÙŠØ§Ø±</option>
                                                                    <option value="text" ${req.type === 'text' ? 'selected' : ''}>ðŸ“ Ù†Øµ</option>
                                                                </select>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t">
                        ...
                        <button onclick="Contractors.saveRequirements()" class="btn-primary">
                            <i class="fas fa-save ml-2"></i>
                            Ø­ÙØ¸ Ø¬Ù…ÙŠØ¹ Ø§Ù„ØªØºÙŠÙŠØ±Ø§Øª
                        </button>
                    </div>
                </div>
            </div>
    ...
    ensureEvaluationsEventListeners() {
        // âœ… Ø±Ø¨Ø· Ø²Ø± Ø¥Ø¶Ø§ÙØ© ØªÙ‚ÙŠÙŠÙ…
        const addEvaluationBtn = document.getElementById('add-contractor-evaluation-btn');
        ...
        // âœ… Ø±Ø¨Ø· ÙÙ„ØªØ± Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†
        const filterSelect = document.getElementById('contractor-evaluation-filter');
    ...
    handleAddEvaluationClick() {
        // âœ… Ø§Ø³ØªØ®Ø¯Ø§Ù… Ù†ÙØ³ Ø§Ù„Ù…Ù†Ø·Ù‚ Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù… ÙÙŠ renderEvaluationsSection
        const approvedOptions = this.getApprovedOptions(true);
        const legacyContractors = AppState.appData.contractors || [];
        const filterOptions = approvedOptions.length > 0 ? approvedOptions : legacyContractors.map(contractor => ({
            id: contractor.id,
        ...
        if (filterOptions.length === 0) {
            Notification.warning('Ù„Ø§ ØªÙˆØ¬Ø¯ Ø´Ø±ÙƒØ§Øª Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ù…Ø³Ø¬Ù„Ø©. ÙŠØ±Ø¬Ù‰ Ø¥Ø¶Ø§ÙØ© Ù…Ù‚Ø§ÙˆÙ„ Ø£ÙˆÙ„Ø§Ù‹.');
            return;
        }
    ...
    collectEvaluationItems(container) {
        ...
        return Array.from(container.querySelectorAll('tbody tr[data-criteria-id]')).map(row => {
                // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø£Ù† Ø§Ù„ØµÙ Ù„Ø§ ÙŠØ²Ø§Ù„ Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ ÙÙŠ DOM
            ...
            Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ collectEvaluationItems:', error);
            return [];
        }
    },
    ...
    bindEvaluationFormInteractions(modal) {
        ...
        const updateSummary = () => {
            // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø£Ù† modal Ù„Ø§ ÙŠØ²Ø§Ù„ Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ ÙÙŠ DOM
            if (!modal || !document.contains(modal)) {
                Utils.safeLog('âš ï¸ updateSummary: modal ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯ Ø£Ùˆ ØªÙ… Ø­Ø°ÙÙ‡');
                return;
            }
        ...
        const updateRadioButtonStyles = () => {
            ...
            modal.querySelectorAll('input[type="radio"][name^="criteria-"]').forEach(input => {
                    if (!document.contains(input)) return; // âœ… ØªØ®Ø·ÙŠ Ø§Ù„Ø¹Ù†Ø§ØµØ± Ø§Ù„Ù…Ø­Ø°ÙˆÙØ©
                ...
                Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ updateRadioButtonStyles:', error);
            }
        };
        ...
        modal.querySelectorAll('input[type="radio"][name^="criteria-"]').forEach(input => {
            ...
            Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ Ø¥Ø¹Ø¯Ø§Ø¯ event listeners Ù„Ø±Ø§Ø¯ÙŠÙˆ buttons:', error);
        }
        ...
        modal.querySelectorAll('label').forEach(label => {
            ...
            Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ Ø¥Ø¹Ø¯Ø§Ø¯ hover effects:', error);
        }
        ...
        modal.querySelectorAll('.form-input').forEach(input => {
            ...
            Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ Ø¥Ø¹Ø¯Ø§Ø¯ focus styles:', error);
        }
    ...
    showEvaluationForm(contractorId, existing = null, contractorNameOverride = null) {
        ...
        // Ø¥Ø°Ø§ Ù„Ù… Ù†Ø¬Ø¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†ØŒ Ù†Ø¨Ø­Ø« ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†
        if (!contractor) {
            this.ensureApprovedSetup();
            const approvedEntities = AppState.appData.approvedContractors || [];
        ...
        if (!contractor && existing) {
            ...
            if (existingContractorId) {
                ...
                // Ø¥Ø°Ø§ Ù„Ù… Ù†Ø¬Ø¯ØŒ Ø§Ù„Ø¨Ø­Ø« ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†
                if (!contractor) {
                    this.ensureApprovedSetup();
                    const approvedEntities = AppState.appData.approvedContractors || [];
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­: Ø¥Ø°Ø§ ÙƒØ§Ù† existing Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ØŒ Ù†Ø­ØµÙ„ Ø¹Ù„Ù‰ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ù…Ù† Ø§Ù„ØµÙÙˆÙ Ø§Ù„Ù…Ù†ÙØµÙ„Ø©
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­: Ø§Ø³ØªØ®Ø¯Ø§Ù… contractorNameOverride Ø¥Ø°Ø§ ÙƒØ§Ù† Ù…ØªÙˆÙØ±Ø§Ù‹ØŒ ÙˆØ¥Ù„Ø§ Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø§Ù„Ù‚ÙŠÙ… Ø§Ù„Ø§ÙØªØ±Ø§Ø¶ÙŠØ© Ù…Ø¹ Ø£ÙˆÙ„ÙˆÙŠØ© evaluationData.contractorName
                    ...
                    <form id="contractor-evaluation-form" class="space-y-6">
                        <div style="background: #ffffff; border-radius: 12px; padding: 1.75rem; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08); border: 1px solid #e2e8f0;">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-800 mb-2" style="color: #334155; font-weight: 600;">Ø§Ù„Ù…ÙˆÙ‚Ø¹ Ø§Ù„ØªÙØµÙŠÙ„ÙŠ</label>
                        ...
                        <div class="modal-footer" style="background: #f8fafc; border-top: 2px solid #e2e8f0; padding: 1.5rem 2rem; margin: 0 -2rem -2rem -2rem; border-radius: 0 0 12px 12px;">
                            ...
                            <button type="submit" class="btn-primary" style="background: linear-gradient(135deg, #2563eb 0%, #1e40af 100%); color: #ffffff; border: none; padding: 0.75rem 2rem; border-radius: 8px; font-weight: 700; box-shadow: 0 4px 6px rgba(37, 99, 235, 0.3); transition: all 0.3s ease;">
                                <i class="fas fa-save ml-2"></i>
                                ${existing ? 'ØªØ­Ø¯ÙŠØ« Ø§Ù„ØªÙ‚ÙŠÙŠÙ…' : 'Ø­ÙØ¸ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…'}
                            </button>
                        </div>
                    </form>
                </div>
        ...
        form?.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                // Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„ØµÙ„Ø§Ø­ÙŠØ§Øª - ÙÙ‚Ø· Ø§Ù„Ù…Ø¯ÙŠØ± ÙŠÙ…ÙƒÙ†Ù‡ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ù…Ø¨Ø§Ø´Ø±Ø©
                const isAdmin = Permissions.isAdmin();

                if (evaluationData) {
                    // Ø§Ù„ØªØ¹Ø¯ÙŠÙ„ - ÙÙ‚Ø· Ø§Ù„Ù…Ø¯ÙŠØ±
                    if (!isAdmin) {
                    ...
                    // Ø¥Ø¶Ø§ÙØ© ØªÙ‚ÙŠÙŠÙ… Ø¬Ø¯ÙŠØ¯ - Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø§Ø¹ØªÙ…Ø§Ø¯
                    // âœ… Ø¥Ø²Ø§Ù„Ø© ØªÙˆÙ„ÙŠØ¯ ID Ù…Ù† Frontend - Backend Ø³ÙŠØªÙˆÙ„Ù‰ ØªÙˆÙ„ÙŠØ¯Ù‡ Ø¨Ø´ÙƒÙ„ ØªØ³Ù„Ø³Ù„ÙŠ (CAR_1, CAR_2, ...)
                    const approvalRequest = {
                        // id Ø³ÙŠØªÙ… ØªÙˆÙ„ÙŠØ¯Ù‡ ÙÙŠ Backend Ø¨Ø§Ø³ØªØ®Ø¯Ø§Ù… generateSequentialId('CAR', ...)
                    ...
                    // âœ… Ù‡Ø°Ø§ ÙŠØ¶Ù…Ù† Ø¹Ø¯Ù… Ø­Ø°Ù Ø§Ù„Ø·Ù„Ø¨Ø§Øª Ø§Ù„Ù…ÙˆØ¬ÙˆØ¯Ø© ÙÙŠ Google Sheets
                    try {
                        ...
                        if (backendResult && backendResult.success) {
                            // âœ… Ø¨Ø¹Ø¯ Ù†Ø¬Ø§Ø­ Ø§Ù„Ø­ÙØ¸ ÙÙŠ BackendØŒ Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ø·Ù„Ø¨ Ø¥Ù„Ù‰ AppState Ù…Ø­Ù„ÙŠØ§Ù‹
                            AppState.appData.contractorApprovalRequests.push(approvalRequest);
                            
                            // Ø­ÙØ¸ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ù…Ø­Ù„ÙŠØ§Ù‹
                            if (typeof window.DataManager !== 'undefined' && window.DataManager.save) {
                                window.DataManager.save();
                            } else {
                                Utils.safeWarn('âš ï¸ DataManager ØºÙŠØ± Ù…ØªØ§Ø­ - Ù„Ù… ÙŠØªÙ… Ø­ÙØ¸ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª');
                            ...
                            Utils.safeLog('âœ… ØªÙ… Ø­ÙØ¸ Ø·Ù„Ø¨ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„ØªÙ‚ÙŠÙŠÙ… ÙÙŠ Google Sheets Ø¨Ù†Ø¬Ø§Ø­');
                        } else {
                            // Ø¥Ø°Ø§ ÙØ´Ù„ Ø§Ù„Ø­ÙØ¸ ÙÙŠ BackendØŒ Ù†Ø¶ÙŠÙ Ù…Ø­Ù„ÙŠØ§Ù‹ ÙÙ‚Ø·
                            AppState.appData.contractorApprovalRequests.push(approvalRequest);
                            ...
                            Utils.safeWarn('âš ï¸ ÙØ´Ù„ Ø­ÙØ¸ Ø·Ù„Ø¨ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„ØªÙ‚ÙŠÙŠÙ… ÙÙŠ Google SheetsØŒ ØªÙ… Ø§Ù„Ø­ÙØ¸ Ù…Ø­Ù„ÙŠØ§Ù‹ ÙÙ‚Ø·');
                        }
                    } catch (error) {
                        // ÙÙŠ Ø­Ø§Ù„Ø© Ø§Ù„Ø®Ø·Ø£ØŒ Ù†Ø¶ÙŠÙ Ù…Ø­Ù„ÙŠØ§Ù‹ ÙÙ‚Ø·
                        AppState.appData.contractorApprovalRequests.push(approvalRequest);
                        ...
                        Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ Ø­ÙØ¸ Ø·Ù„Ø¨ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„ØªÙ‚ÙŠÙŠÙ… ÙÙŠ Google Sheets:', error);
                    }
                ...
                Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ø­ÙØ¸ ØªÙ‚ÙŠÙŠÙ… Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†:', error);
                Notification.error('ØªØ¹Ø°Ø± Ø­ÙØ¸ ØªÙ‚ÙŠÙŠÙ… Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„: ' + error.message);
            }
        });
    ...
    persistEvaluation(record, existing = null) {
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­: Ø­ÙØ¸ ÙƒÙ„ Ø¨Ù†Ø¯ ÙƒØ³Ø¬Ù„ Ù…Ù†ÙØµÙ„ ÙÙŠ Ø§Ù„Ø¬Ø¯ÙˆÙ„
        ...
        // âœ… Ø­Ø°Ù Ø§Ù„Ø¨Ù†ÙˆØ¯ Ø§Ù„Ù‚Ø¯ÙŠÙ…Ø© Ù„Ù„ØªÙ‚ÙŠÙŠÙ… Ø¥Ø°Ø§ ÙƒØ§Ù† ØªØ¹Ø¯ÙŠÙ„
        if (existing) {
        ...
        // âœ… Ø­ÙØ¸ ÙƒÙ„ Ø¨Ù†Ø¯ ÙƒØ³Ø¬Ù„ Ù…Ù†ÙØµÙ„
        ...
        items.forEach((item, index) => {
            const evaluationRecord = {
                ...evaluationBaseData,
                // âœ… Ø¥Ø¶Ø§ÙØ© Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ø¨Ù†Ø¯
        ...
        try {
            ...
            Utils.safeWarn('ÙØ´Ù„ Ø§Ù„Ø­ÙØ¸ Ø§Ù„ØªÙ„Ù‚Ø§Ø¦ÙŠ Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†:', error);
        }
    ...
    openEvaluationHistory(contractorId) {
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­: Ù…Ù†Ø¹ scrollIntoView Ù…Ù† Ø§Ù„ØªØ³Ø¨Ø¨ ÙÙŠ scroll jumps
        ...
        if (evaluationCard) {
            ...
            requestAnimationFrame(() => {
                // âœ… Ø­ÙØ¸ Ù…ÙˆØ¶Ø¹ Ø§Ù„ØªÙ…Ø±ÙŠØ± Ø§Ù„Ø­Ø§Ù„ÙŠ
                ...
                requestAnimationFrame(() => {
                    ...
                    // Ø¥Ø°Ø§ ÙƒØ§Ù† Ø§Ù„ÙØ±Ù‚ ÙƒØ¨ÙŠØ± Ø¬Ø¯Ø§Ù‹ØŒ Ø¥Ù„ØºØ§Ø¡ scroll
    ...
    /**
     * Ø¥Ø¶Ø§ÙØ© ØªÙ‚ÙŠÙŠÙ… Ù„Ø¬Ù‡Ø© Ù…Ø¹ØªÙ…Ø¯Ø© (Ù…Ù† Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†)
     */
    showEvaluationFormForApproved(approvedEntityId) {
        ...
        if (!contractorId) {
            ...
            if (contractor) {
                ...
                // contractorName Ù…Ø­Ø¯Ø¯ Ø¨Ø§Ù„ÙØ¹Ù„ Ù…Ù† approvedEntity.companyName
            }
        } else {
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­: ÙØªØ­ Ù†Ù…ÙˆØ°Ø¬ Ø§Ù„ØªÙ‚ÙŠÙŠÙ… Ù…Ø¹ ØªÙ…Ø±ÙŠØ± Ø§Ø³Ù… Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ù„Ø¶Ù…Ø§Ù† Ø¸Ù‡ÙˆØ±Ù‡ ÙÙŠ Ø§Ù„Ù†Ù…ÙˆØ°Ø¬
        // Ø¥Ø°Ø§ ÙƒØ§Ù† Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†ØŒ Ù†Ø³ØªØ®Ø¯Ù… Ù…Ø¹Ø±Ù Ø§Ù„Ù…Ø¹ØªÙ…Ø¯
        this.showEvaluationForm(contractorId, null, contractorName);
    },

    /**
     * ÙØªØ­ Ø³Ø¬Ù„ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ù„Ø¬Ù‡Ø© Ù…Ø¹ØªÙ…Ø¯Ø© (Ù…Ù† Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†)
     */
    openEvaluationHistoryForApproved(approvedEntityId) {
        ...
        // ÙØªØ­ Ø³Ø¬Ù„ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª
        this.openEvaluationHistory(contractorId);

        // Ø§Ù„ØªØ¨Ø¯ÙŠÙ„ Ø¥Ù„Ù‰ ØªØ¨ÙˆÙŠØ¨ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ø¥Ø°Ø§ Ù„Ù… ÙŠÙƒÙ† Ù…ÙØªÙˆØ­Ø§Ù‹
    ...
    renderEvaluationDetails(evaluation) {
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­: Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø£Ù† items Ù‡ÙŠ Ù…ØµÙÙˆÙØ© ÙˆÙ…Ø¹Ø§Ù„Ø¬Ø© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø¨Ø´ÙƒÙ„ ØµØ­ÙŠØ­
        let items = [];
        if (Array.isArray(evaluation.items)) {
            items = evaluation.items;
        } else if (evaluation.items && typeof evaluation.items === 'object') {
            // Ø¥Ø°Ø§ ÙƒØ§Ù† ÙƒØ§Ø¦Ù†ØŒ Ù†Ø­ÙˆÙ„Ù‡ Ø¥Ù„Ù‰ Ù…ØµÙÙˆÙØ©
            items = Object.values(evaluation.items);
        }
        
        // âœ… ØªØµÙÙŠØ© Ø§Ù„Ø¨Ù†ÙˆØ¯ Ø§Ù„ÙØ§Ø±ØºØ© ÙˆØ¥Ø¸Ù‡Ø§Ø± ÙÙ‚Ø· Ø§Ù„Ø¨Ù†ÙˆØ¯ Ø§Ù„ØªÙŠ Ù„Ù‡Ø§ Ø¹Ù†ÙˆØ§Ù† Ø£Ùˆ Ø­Ø§Ù„Ø©
        // Ù†Ø¹Ø±Ø¶ Ø§Ù„Ø¨Ù†Ø¯ Ø¥Ø°Ø§ ÙƒØ§Ù† Ù„Ù‡ Ø¹Ù†ÙˆØ§Ù† Ø£Ùˆ Ø¥Ø°Ø§ ÙƒØ§Ù† Ù„Ù‡ Ø­Ø§Ù„Ø© (Ø­ØªÙ‰ Ù„Ùˆ Ø§Ù„Ø¹Ù†ÙˆØ§Ù† ÙØ§Ø±Øº)
    ...
    /**
     * âœ… ØªØ¬Ù…ÙŠØ¹ Ø¨Ù†ÙˆØ¯ Ø§Ù„ØªÙ‚ÙŠÙŠÙ… Ù…Ù† Ø§Ù„ØµÙÙˆÙ Ø§Ù„Ù…Ù†ÙØµÙ„Ø©
     */
    ...
    viewEvaluation(evaluationId) {
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width: 900px;">
                <div class="modal-header">
                    <h2 class="modal-title"><i class="fas fa-clipboard-check ml-2"></i>ØªÙØ§ØµÙŠÙ„ ØªÙ‚ÙŠÙŠÙ… Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„</h2>
                    <button class="modal-close" onclick="this.closest('.modal-overlay').remove()">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
        ...
        try {
            ...
            const summaryTable = `
                <table>
                    ...
                    <tr><th>Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ø¨Ù†ÙˆØ¯ Ø§Ù„ÙØ¹Ù„ÙŠØ©</th><td>${evaluation.totalItems ?? (Array.isArray(evaluation.items) ? evaluation.items.length : (evaluation.items ? Object.keys(evaluation.items).length : 0))}</td></tr>
            ...
            const itemsTable = items.length > 0 ? `
                <div class="section-title">ØªÙØ§ØµÙŠÙ„ Ø¨Ù†ÙˆØ¯ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…</div>
                <table>
                    <thead>
                        <tr>
                            <th style="width: 50px;">#</th>
            ...
            ` : '<div class="section-title">ØªÙØ§ØµÙŠÙ„ Ø¨Ù†ÙˆØ¯ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…</div><p class="text-gray-500 text-center py-4">Ù„Ø§ ØªÙˆØ¬Ø¯ Ø¨Ù†ÙˆØ¯ Ù…Ø³Ø¬Ù„Ø©</p>';
            ...
            if (printWindow) {
                ...
                Loading.hide();
                Notification.error('ÙŠØ±Ø¬Ù‰ Ø§Ù„Ø³Ù…Ø§Ø­ Ø¨Ø§Ù„Ù†ÙˆØ§ÙØ° Ø§Ù„Ù…Ù†Ø¨Ø«Ù‚Ø© Ù„Ù„Ø·Ø¨Ø§Ø¹Ø©');
            }
        } catch (error) {
            Loading.hide();
            Utils.safeError('Ø®Ø·Ø£ ÙÙŠ ØªØµØ¯ÙŠØ± ØªÙ‚ÙŠÙŠÙ… Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†:', error);
            Notification.error('ÙØ´Ù„ ÙÙŠ ØªØµØ¯ÙŠØ± ØªÙ‚Ø±ÙŠØ± Ø§Ù„ØªÙ‚ÙŠÙŠÙ…: ' + error.message);
        }
    },
    ...
    async requestDeleteEvaluation(evaluationId) {
        ...
        // Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙˆÙ† Ø§Ù„Ø¹Ø§Ø¯ÙŠÙˆÙ† Ù„Ø§ ÙŠÙ…ÙƒÙ†Ù‡Ù… Ø­Ø°Ù Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª - ÙÙ‚Ø· Ø§Ù„Ù…Ø¯ÙŠØ±
    ...
    deleteEvaluation(evaluationId) {
        ...
        // Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„ØµÙ„Ø§Ø­ÙŠØ§Øª - ÙÙ‚Ø· Ø§Ù„Ù…Ø¯ÙŠØ± ÙŠÙ…ÙƒÙ†Ù‡ Ø­Ø°Ù Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª
        if (!Permissions.isAdmin()) {
            Notification.error('Ù„ÙŠØ³ Ù„Ø¯ÙŠÙƒ ØµÙ„Ø§Ø­ÙŠØ© Ù„Ø­Ø°Ù Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª. ÙŠØ±Ø¬Ù‰ Ø§Ù„ØªÙˆØ§ØµÙ„ Ù…Ø¹ Ù…Ø¯ÙŠØ± Ø§Ù„Ù†Ø¸Ø§Ù….');
            return;
        }
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­: Ø§Ù„Ø¨Ø­Ø« Ø¹Ù† Ø¬Ù…ÙŠØ¹ Ø§Ù„ØµÙÙˆÙ Ø§Ù„Ù…Ø±ØªØ¨Ø·Ø© Ø¨Ø§Ù„ØªÙ‚ÙŠÙŠÙ… (Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª ØªÙØ®Ø²Ù† ÙƒØµÙÙˆÙ Ù…ØªØ¹Ø¯Ø¯Ø©)
        ...
        // âœ… Ø­Ø°Ù Ø¬Ù…ÙŠØ¹ Ø§Ù„ØµÙÙˆÙ Ø§Ù„Ù…Ø±ØªØ¨Ø·Ø© Ø¨Ø§Ù„ØªÙ‚ÙŠÙŠÙ…
        ...
        try {
            ...
            Utils.safeWarn('ÙØ´Ù„ ØªØ­Ø¯ÙŠØ« ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† ÙÙŠ Ø§Ù„Ø­ÙØ¸ Ø§Ù„Ø³Ø­Ø§Ø¨ÙŠ:', error);
        }
    ...
    openEvaluationSettings() {
        ...
        if (!currentUser || currentUser.role !== 'admin') {
            Notification.error('Ù‡Ø°Ù‡ Ø§Ù„Ù…ÙŠØ²Ø© Ù…ØªØ§Ø­Ø© Ù„Ù…Ø¯ÙŠØ± Ø§Ù„Ù†Ø¸Ø§Ù… ÙÙ‚Ø·.');
            return;
        }
                    ...
                    <form id="contractor-evaluation-settings-form" class="space-y-4">
                        <div class="bg-blue-50 border border-blue-200 text-blue-800 rounded p-3 text-sm">
                            ...
                            <ul class="list-disc mr-6 space-y-1">
                                <li>Ø£Ø¯Ø®Ù„ ÙƒÙ„ Ø¨Ù†Ø¯ ØªÙ‚ÙŠÙŠÙ… ÙÙŠ Ø³Ø·Ø± Ù…Ù†ÙØµÙ„.</li>
                                <li>Ø³ÙŠØªÙ… ØªØ·Ø¨ÙŠÙ‚ Ø§Ù„ØªØºÙŠÙŠØ±Ø§Øª Ø¹Ù„Ù‰ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ø§Ù„Ø¬Ø¯ÙŠØ¯Ø© ÙÙ‚Ø·. Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ø§Ù„Ø³Ø§Ø¨Ù‚Ø© Ø³ØªØ¸Ù„ Ù…Ø­ÙÙˆØ¸Ø© ÙƒÙ…Ø§ Ù‡ÙŠ.</li>
                        ...
                        <div>
                            ...
                            <textarea id="contractor-evaluation-settings-textarea" class="form-input" rows="12" placeholder="Ø£Ø¯Ø®Ù„ ÙƒÙ„ Ø¨Ù†Ø¯ ÙÙŠ Ø³Ø·Ø± Ø¬Ø¯ÙŠØ¯">${criteria.map(item => item.label).join('\\n')}</textarea>
                        </div>
                        <div class="flex items-center justify-end gap-3">
                            <button type="button" class="btn-secondary" onclick="this.closest('.modal-overlay').remove()">Ø¥Ù„ØºØ§Ø¡</button>
                            <button type="submit" class="btn-primary">
                                <i class="fas fa-save ml-2"></i>Ø­ÙØ¸ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„Ø§Øª
                            </button>
                        </div>
                    </form>
                </div>
    ...
    saveEvaluationCriteriaFromInput(rawInput) {
        ...
        if (lines.length === 0) {
            Notification.error('Ù„Ø§ ÙŠÙ…ÙƒÙ† Ø­ÙØ¸ Ù‚Ø§Ø¦Ù…Ø© ÙØ§Ø±ØºØ©. ÙŠØ±Ø¬Ù‰ Ø¥Ø¶Ø§ÙØ© Ø¨Ù†Ø¯ ÙˆØ§Ø­Ø¯ Ø¹Ù„Ù‰ Ø§Ù„Ø£Ù‚Ù„.');
            return false;
        }
    ...
    async showContractorForm(contractorData = null) {
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width: 800px;">
                <div class="modal-header">
                    <h2 class="modal-title">${isEdit ? 'ØªØ¹Ø¯ÙŠÙ„ Ù…Ù‚Ø§ÙˆÙ„' : 'Ø¥Ø¶Ø§ÙØ© Ù…Ù‚Ø§ÙˆÙ„ Ø¬Ø¯ÙŠØ¯'}</h2>
                    <button class="modal-close" onclick="this.closest('.modal-overlay').remove()">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="contractor-form" class="space-y-4">
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t">
                            <button type="button" class="btn-secondary" onclick="this.closest('.modal-overlay').remove()">Ø¥Ù„ØºØ§Ø¡</button>
                            <button type="submit" class="btn-primary">
                                <i class="fas fa-save ml-2"></i>${isEdit ? 'Ø­ÙØ¸ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„Ø§Øª' : 'Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„'}
                            </button>
                        </div>
                    </form>
                </div>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            if (submitBtn) {
                ...
                submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin ml-2"></i> Ø¬Ø§Ø±ÙŠ Ø§Ù„Ø­ÙØ¸...';
            }
            ...
            // ÙØ­Øµ Ø§Ù„Ø¹Ù†Ø§ØµØ± Ù‚Ø¨Ù„ Ø§Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù…
            ...
            if (!nameEl || !serviceTypeEl || !contractNumberEl || !startDateEl || !endDateEl || !statusEl || !contactPersonEl || !phoneEl || !emailEl) {
                Notification.error('Ø¨Ø¹Ø¶ Ø§Ù„Ø­Ù‚ÙˆÙ„ Ø§Ù„Ù…Ø·Ù„ÙˆØ¨Ø© ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯Ø©. ÙŠØ±Ø¬Ù‰ ØªØ­Ø¯ÙŠØ« Ø§Ù„ØµÙØ­Ø© ÙˆØ§Ù„Ù…Ø­Ø§ÙˆÙ„Ø© Ù…Ø±Ø© Ø£Ø®Ø±Ù‰.');
                if (submitBtn) {
            ...
            // Ø§Ù„Ø­ÙØ§Ø¸ Ø¹Ù„Ù‰ approvalRequirements Ø¥Ø°Ø§ ÙƒØ§Ù†Øª Ù…ÙˆØ¬ÙˆØ¯Ø©
            ...
            try {
                if (isEdit) {
                    ...
                    if (index !== -1) {
                        // Ø§Ù„Ø­ÙØ§Ø¸ Ø¹Ù„Ù‰ approvalRequirements Ø¹Ù†Ø¯ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„
                    ...
                    // Ø­ÙØ¸ ØªÙ„Ù‚Ø§Ø¦ÙŠ ÙÙŠ Google Sheets
                    await GoogleIntegration.autoSave('Contractors', AppState.appData.contractors);

                    // ØªØ­Ø¯ÙŠØ« Ø­Ø§Ù„Ø© Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ Ø¨Ø¹Ø¯ Ø§Ù„Ø­ÙØ¸
                    ...
                    // Ø¥Ø¶Ø§ÙØ© Ù…Ù‚Ø§ÙˆÙ„ Ø¬Ø¯ÙŠØ¯ - Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø§Ø¹ØªÙ…Ø§Ø¯
                    // âœ… Ø¥Ø²Ø§Ù„Ø© ØªÙˆÙ„ÙŠØ¯ ID Ù…Ù† Frontend - Backend Ø³ÙŠØªÙˆÙ„Ù‰ ØªÙˆÙ„ÙŠØ¯Ù‡ Ø¨Ø´ÙƒÙ„ ØªØ³Ù„Ø³Ù„ÙŠ (CAR_1, CAR_2, ...)
                    const approvalRequest = {
                        // id Ø³ÙŠØªÙ… ØªÙˆÙ„ÙŠØ¯Ù‡ ÙÙŠ Backend Ø¨Ø§Ø³ØªØ®Ø¯Ø§Ù… generateSequentialId('CAR', ...)
                        ...
                        status: 'pending',
                        contractorData: formData, // Ø­ÙØ¸ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ù…Ø¹ Ø§Ù„Ø·Ù„Ø¨
                        createdAt: new Date().toISOString(),
                        createdBy: AppState.currentUser?.id || '',
                        createdByName: AppState.currentUser?.name || ''
                    };
                    ...
                    try {
                        ...
                        if (backendResult && backendResult.success) {
                            ...
                            Utils.safeLog('âœ… ØªÙ… Ø­ÙØ¸ Ø·Ù„Ø¨ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Google Sheets Ø¨Ù†Ø¬Ø§Ø­');
                        } else {
                            // Ø¥Ø°Ø§ ÙØ´Ù„ Ø§Ù„Ø­ÙØ¸ ÙÙŠ BackendØŒ Ù†Ø¶ÙŠÙ Ù…Ø­Ù„ÙŠØ§Ù‹ ÙÙ‚Ø·
                            AppState.appData.contractorApprovalRequests.push(approvalRequest);
                            ...
                            Utils.safeWarn('âš ï¸ ÙØ´Ù„ Ø­ÙØ¸ Ø·Ù„Ø¨ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Google SheetsØŒ ØªÙ… Ø§Ù„Ø­ÙØ¸ Ù…Ø­Ù„ÙŠØ§Ù‹ ÙÙ‚Ø·');
                        }
                    } catch (error) {
                        // ÙÙŠ Ø­Ø§Ù„Ø© Ø§Ù„Ø®Ø·Ø£ØŒ Ù†Ø¶ÙŠÙ Ù…Ø­Ù„ÙŠØ§Ù‹ ÙÙ‚Ø·
                        AppState.appData.contractorApprovalRequests.push(approvalRequest);
                        ...
                        Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ Ø­ÙØ¸ Ø·Ù„Ø¨ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Google Sheets:', error);
                    }
                ...
                // Ø§Ø³ØªØ¹Ø§Ø¯Ø© Ø§Ù„Ø²Ø± ÙÙŠ Ø­Ø§Ù„Ø© Ø§Ù„Ø®Ø·Ø£
                if (submitBtn) {
                    submitBtn.disabled = false;
                    submitBtn.innerHTML = originalText;
                }
    ...
    async viewContractor(id) {
        ...
        // Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† ÙˆØ¬ÙˆØ¯ ÙƒÙˆØ¯ Ù„Ù„Ù…Ù‚Ø§ÙˆÙ„ØŒ ÙˆØ¥Ø¶Ø§ÙØªÙ‡ Ø¥Ø°Ø§ Ù„Ù… ÙŠÙƒÙ† Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹
        if (!contractor.code) {
            contractor.code = this.generateContractorCode();
            // Ø­ÙØ¸ Ø§Ù„ØªØºÙŠÙŠØ±
            if (typeof window.DataManager !== 'undefined' && window.DataManager.save) {
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width: 700px;">
                <div class="modal-header">
                    <h2 class="modal-title">ØªÙØ§ØµÙŠÙ„ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„</h2>
                    <button class="modal-close" onclick="this.closest('.modal-overlay').remove()">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
    ...
    async requestDeleteContractor(id) {
        ...
        // Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ù„ØµÙ„Ø§Ø­ÙŠØ§Øª - ÙÙ‚Ø· Ø§Ù„Ù…Ø¯ÙŠØ± ÙŠÙ…ÙƒÙ†Ù‡ Ø­Ø°Ù Ù…Ø¨Ø§Ø´Ø±Ø©
        if (Permissions.isAdmin()) {
            if (!confirm('Ù‡Ù„ Ø£Ù†Øª Ù…ØªØ£ÙƒØ¯ Ù…Ù† Ø­Ø°Ù Ù‡Ø°Ø§ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ØŸ Ø³ÙŠØªÙ… Ø­Ø°ÙÙ‡ Ù…Ù† Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† ÙˆÙ‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†. Ù„Ø§ ÙŠÙ…ÙƒÙ† Ø§Ù„ØªØ±Ø§Ø¬Ø¹ Ø¹Ù† Ù‡Ø°Ù‡ Ø§Ù„Ø¹Ù…Ù„ÙŠØ©.')) {
                return;
            }
            // Ø§Ù„Ù…Ø¯ÙŠØ± ÙŠÙ…ÙƒÙ†Ù‡ Ø§Ù„Ø­Ø°Ù Ù…Ø¨Ø§Ø´Ø±Ø©
        ...
        // Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙˆÙ† Ø§Ù„Ø¹Ø§Ø¯ÙŠÙˆÙ† ÙŠØ±Ø³Ù„ÙˆÙ† Ø·Ù„Ø¨ Ø­Ø°Ù
        if (!confirm('Ø³ÙŠØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø­Ø°Ù Ù‡Ø°Ø§ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ø¥Ù„Ù‰ Ù…Ø¯ÙŠØ± Ø§Ù„Ù†Ø¸Ø§Ù… Ù„Ù„Ù…ÙˆØ§ÙÙ‚Ø©. Ù‡Ù„ ØªØ±ÙŠØ¯ Ø§Ù„Ù…ØªØ§Ø¨Ø¹Ø©ØŸ')) {
            return;
        }
    ...
    async deleteContractor(id) {
        ...
        if (!confirm('Ù‡Ù„ Ø£Ù†Øª Ù…ØªØ£ÙƒØ¯ Ù…Ù† Ø­Ø°Ù Ù‡Ø°Ø§ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ØŸ Ø³ÙŠØªÙ… Ø­Ø°ÙÙ‡ Ù…Ù† Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† ÙˆÙ‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†.')) {
            return;
        }
        ...
        try {
            ...
            Loading.hide();
            console.error('ÙØ´Ù„ Ø­Ø°Ù Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„:', error);
            Notification.error('ÙØ´Ù„ Ø­Ø°Ù Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„: ' + error.message);
    ...
    getApprovalRequirements(contractorType = null) {
        ...
        // ØªØµÙÙŠØ© Ø­Ø³Ø¨ Ù†ÙˆØ¹ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ø¥Ø°Ø§ ØªÙ… ØªØ­Ø¯ÙŠØ¯Ù‡
        if (contractorType) {
    ...
    /**
     * Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø§Ø³ØªÙŠÙØ§Ø¡ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø§Ù„Ù…Ø·Ù„ÙˆØ¨Ø©
     */
    checkAllRequirementsMet(contractorId) {
        ...
        if (!contractor) {
            // Ø¥Ø°Ø§ Ù„Ù… Ù†Ø¬Ø¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ØŒ Ù†Ø¹ØªØ¨Ø± Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ù…Ø³ØªÙˆÙØ§Ø© (Ù„Ù„ØªÙˆØ§ÙÙ‚ Ù…Ø¹ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù‚Ø¯ÙŠÙ…Ø©)
            Utils.safeWarn(`âš ï¸ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ø¨Ø§Ù„Ù…Ø¹Ø±Ù ${contractorId} ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†`);
            return true; // Ù†Ø¹ØªØ¨Ø±Ù‡ Ù…Ø¹ØªÙ…Ø¯Ø§Ù‹ Ù„Ù„ØªÙˆØ§ÙÙ‚ Ù…Ø¹ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù‚Ø¯ÙŠÙ…Ø©
        }
        ...
        for (const req of requirements) {
            ...
            if (req.type === 'document') {
                // ÙŠØ¬Ø¨ Ø£Ù† ÙŠÙƒÙˆÙ† Ù‡Ù†Ø§Ùƒ Ù…Ø³ØªÙ†Ø¯ Ù…Ø±ÙÙˆØ¹
    ...
    renderRequirementsSummary(contractorId) {
        ...
        const statusText = status.allMet ? 'âœ… Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ù…Ø³ØªÙˆÙØ§Ø©' : 'âš ï¸ Ø§Ø´ØªØ±Ø§Ø·Ø§Øª ØºÙŠØ± Ù…ÙƒØªÙ…Ù„Ø©';
    ...
    /**
     * Ø¹Ø±Ø¶ Ù‚Ø³Ù… Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª ÙÙŠ Ø§Ù„Ù†Ù…ÙˆØ°Ø¬ (Ù…Ø­Ø³Ù‘Ù† Ù…Ø¹ Ø§Ù„ØªØµÙ†ÙŠÙØ§Øª ÙˆØ§Ù„Ø£ÙˆÙ„ÙˆÙŠØ§Øª)
     */
    renderRequirementsSection(contractorId) {
        ...
        return `
            ...
            <div class="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg">
                ...
                ${status.allMet ? `
                    <div class="flex items-center gap-2 text-green-700">
                        ...
                        <span class="text-sm font-semibold">Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ù…Ø³ØªÙˆÙØ§Ø© - Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ø¬Ø§Ù‡Ø² Ù„Ù„Ø§Ø¹ØªÙ…Ø§Ø¯</span>
                    </div>
                ` : `
            ...
            <!-- Ø¹Ø±Ø¶ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø­Ø³Ø¨ Ø§Ù„ÙØ¦Ø© -->
            <div class="space-y-6">
                ${Object.keys(requirementsByCategory).map(categoryId => {
                    const category = REQUIREMENT_CATEGORIES[categoryId] || REQUIREMENT_CATEGORIES.other;
                    const categoryReqs = requirementsByCategory[categoryId];
                                                    ...
                                                    <div class="flex items-center gap-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                                                        ...
                                                        <a href="${reqData.documentLink}" target="_blank" 
                                                           class="flex-1 text-sm text-green-700 hover:underline font-medium">
                                                            ...
                                                            ${reqData.fileName || 'Ø§Ù„Ù…Ø³ØªÙ†Ø¯ Ø§Ù„Ù…Ø±ÙÙˆØ¹'}
                                                        </a>
                                                        ${reqData.uploadedAt ? `
                                        ...
                                        inputHTML = `
                                            <label class="flex items-center gap-2 p-2 border rounded cursor-pointer hover:bg-gray-50">
                                                <input type="checkbox" 
                                                    ...
                                                    class="cursor-pointer">
                                                <span class="text-sm text-gray-700">ØªÙ… Ø§Ù„Ø§Ø³ØªÙŠÙØ§Ø¡</span>
                                            </label>
                                        `;
                                    } else if (req.type === 'text') {
                                        inputHTML = `
    ...
    /**
     * Ù…Ø¹Ø§Ù„Ø¬Ø© Ø±ÙØ¹ Ù…Ù„Ù Ø§Ø´ØªØ±Ø§Ø·
     */
        ...
        try {
            ...
            reader.onload = async (e) => {
                try {
                    ...
                    // Ø±ÙØ¹ Ø§Ù„Ù…Ù„Ù Ø¥Ù„Ù‰ Google Drive
                    ...
                    if (uploadResult && uploadResult.success) {
                        // Ø­ÙØ¸ Ø±Ø§Ø¨Ø· Ø§Ù„Ù…Ø³ØªÙ†Ø¯ ÙÙŠ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„
                        const contractor = (AppState.appData.contractors || []).find(c => c.id === contractorId);
                        if (contractor) {
                            ...
                            Notification.success('ØªÙ… Ø±ÙØ¹ Ø§Ù„Ù…Ø³ØªÙ†Ø¯ Ø¨Ù†Ø¬Ø§Ø­');
                        } else {
                            Notification.error('Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯');
                        }
                    } else {
                        Notification.error('ÙØ´Ù„ Ø±ÙØ¹ Ø§Ù„Ù…Ø³ØªÙ†Ø¯: ' + (uploadResult?.message || 'Ø®Ø·Ø£ ØºÙŠØ± Ù…Ø¹Ø±ÙˆÙ'));
                    }
                } catch (error) {
                    Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ù…Ø¹Ø§Ù„Ø¬Ø© Ø§Ù„Ù…Ù„Ù:', error);
                    Notification.error('Ø­Ø¯Ø« Ø®Ø·Ø£ Ø£Ø«Ù†Ø§Ø¡ Ø±ÙØ¹ Ø§Ù„Ù…Ø³ØªÙ†Ø¯: ' + (error.message || 'Ø®Ø·Ø£ ØºÙŠØ± Ù…Ø¹Ø±ÙˆÙ'));
                } finally {
                    Loading.hide();
                }
            };
            reader.onerror = () => {
                Loading.hide();
                Notification.error('ÙØ´Ù„ Ù‚Ø±Ø§Ø¡Ø© Ø§Ù„Ù…Ù„Ù');
            };
            reader.readAsDataURL(file);
        } catch (error) {
            Loading.hide();
            Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ù‚Ø±Ø§Ø¡Ø© Ø§Ù„Ù…Ù„Ù:', error);
    ...
    async handleRequirementCheckboxChange(contractorId, requirementId, checked) {
        ...
        if (contractor) {
            ...
            try {
                ...
                Utils.safeWarn('ÙØ´Ù„ Ø§Ù„Ø­ÙØ¸ Ø§Ù„ØªÙ„Ù‚Ø§Ø¦ÙŠ:', error);
            }
    ...
    updateContractorApprovalStatus(contractorId) {
        ...
        if (allMet && contractor.approvalStatus !== 'approved') {
            ...
            // Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ØªÙ„Ù‚Ø§Ø¦ÙŠØ§Ù‹ Ø¥Ù„Ù‰ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† Ø¥Ø°Ø§ Ù„Ù… ÙŠÙƒÙ† Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹
            this.ensureApprovedSetup();
            const approvedContractors = AppState.appData.approvedContractors || [];
            ...
            // ÙØ­Øµ Ø§Ù„ØªÙƒØ±Ø§Ø± Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰: contractorIdØŒ Ø§Ø³Ù… Ø§Ù„Ø´Ø±ÙƒØ© + Ù†ÙˆØ¹ Ø§Ù„Ø¬Ù‡Ø©ØŒ Ø§Ù„Ø³Ø¬Ù„ Ø§Ù„ØªØ¬Ø§Ø±ÙŠ
            const existingApproved = approvedContractors.find(ac => {
                // ÙØ­Øµ Ø§Ù„ØªÙƒØ±Ø§Ø± Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰ contractorId
            ...
            if (!existingApproved) {
                ...
                const approvedRecord = {
                    ...
                    status: 'approved',
                    notes: 'ØªÙ… Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ ØªÙ„Ù‚Ø§Ø¦ÙŠØ§Ù‹ Ø¨Ø¹Ø¯ Ø§Ø³ØªÙŠÙØ§Ø¡ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª',
    ...
    /**
     * ÙØªØ­ ÙˆØ§Ø¬Ù‡Ø© Ø¥Ø¯Ø§Ø±Ø© Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª (Ù„Ù„Ù…Ø¯ÙŠØ± ÙÙ‚Ø·)
     */
    openRequirementsManagement() {
        const isAdmin = (AppState.currentUser && AppState.currentUser.role === 'admin');
        if (!isAdmin) {
            Notification.error('Ù‡Ø°Ù‡ Ø§Ù„ØµÙØ­Ø© Ù…ØªØ§Ø­Ø© Ù„Ù„Ù…Ø¯ÙŠØ± ÙÙ‚Ø·');
            return;
        }
                ...
                <div class="modal-body">
                    <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded">
                        <p class="text-sm text-blue-800">
                            ...
                            ÙŠÙ…ÙƒÙ†Ùƒ Ø¥Ø¶Ø§ÙØ© Ø£Ùˆ ØªØ¹Ø¯ÙŠÙ„ Ø£Ùˆ Ø­Ø°Ù Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø§Ù„Ù…Ø·Ù„ÙˆØ¨Ø© Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†. 
                            Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙˆÙ† Ù„Ù† ÙŠØ¸Ù‡Ø±ÙˆÙ† ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† Ø¥Ù„Ø§ Ø¨Ø¹Ø¯ Ø§Ø³ØªÙŠÙØ§Ø¡ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø§Ù„Ù…Ø·Ù„ÙˆØ¨Ø©.
                        </p>
                    </div>
    ...
    addNewRequirement() {
        ...
        // Ø¥ÙŠØ¬Ø§Ø¯ Ø£ÙˆÙ„ ÙØ¦Ø© (Ø£Ùˆ Ø¥Ù†Ø´Ø§Ø¡ ÙØ¦Ø© "Ø£Ø®Ø±Ù‰" Ø¥Ø°Ø§ Ù„Ù… ØªÙƒÙ† Ù…ÙˆØ¬ÙˆØ¯Ø©)
        let targetCategory = list.querySelector('.requirement-category-group');
        if (!targetCategory) {
            // Ø¥Ù†Ø´Ø§Ø¡ ÙØ¦Ø© "Ø£Ø®Ø±Ù‰" Ø¥Ø°Ø§ Ù„Ù… ØªÙƒÙ† Ù…ÙˆØ¬ÙˆØ¯Ø©
            ...
            <div class="requirement-item p-4 border-2 rounded-lg bg-white shadow-sm hover:shadow-md transition-all cursor-move" 
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <select class="form-input text-sm" data-field="type">
                                <option value="document" selected>ðŸ“„ Ù…Ø³ØªÙ†Ø¯</option>
                                <option value="checkbox">â˜‘ï¸ Ù…Ø±Ø¨Ø¹ Ø§Ø®ØªÙŠØ§Ø±</option>
                                <option value="text">ðŸ“ Ù†Øµ</option>
                            </select>
                            <select class="form-input text-sm" data-field="category">
                                ${Object.values(REQUIREMENT_CATEGORIES).map(cat => `
        ...
        // ØªØ­Ø¯ÙŠØ« Ø¹Ø¯Ø¯ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª ÙÙŠ Ø§Ù„ÙØ¦Ø©
        ...
        // Ø¥Ø¹Ø¯Ø§Ø¯ Ø§Ù„Ø³Ø­Ø¨ ÙˆØ§Ù„Ø¥ÙÙ„Ø§Øª Ù„Ù„Ø¹Ù†ØµØ± Ø§Ù„Ø¬Ø¯ÙŠØ¯
        this.setupDragAndDropForItem(categoryContainer.querySelector(`[data-requirement-id="${newId}"]`));
    },

    /**
     * Ø¥Ø¹Ø¯Ø§Ø¯ Ø§Ù„Ø³Ø­Ø¨ ÙˆØ§Ù„Ø¥ÙÙ„Ø§Øª Ù„Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª
     */
    setupDragAndDrop() {
        const list = document.getElementById('requirements-list');
        if (!list) return;
    ...
    /**
     * Ø¥Ø¹Ø¯Ø§Ø¯ Ø§Ù„Ø³Ø­Ø¨ ÙˆØ§Ù„Ø¥ÙÙ„Ø§Øª Ù„Ø¹Ù†ØµØ± ÙˆØ§Ø­Ø¯
     */
    setupDragAndDropForItem(item) {
        ...
        item.addEventListener('drop', (e) => {
            e.preventDefault();
            this.saveRequirements(); // Ø­ÙØ¸ Ø§Ù„ØªØ±ØªÙŠØ¨ Ø§Ù„Ø¬Ø¯ÙŠØ¯
        });
    },
    ...
    /**
     * Ø­ÙØ¸ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª (Ù…Ø­Ø¯Ø« Ù„Ø¯Ø¹Ù… Ø§Ù„Ø­Ù‚ÙˆÙ„ Ø§Ù„Ø¬Ø¯ÙŠØ¯Ø©)
     */
    saveRequirements() {
        const list = document.getElementById('requirements-list');
        if (!list) return;

        // Ø¬Ù…Ø¹ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ù…Ù† Ø¬Ù…ÙŠØ¹ Ø§Ù„ÙØ¦Ø§Øª
        const allItems = [];
        ...
        const requirements = allItems.map((item, index) => {
            ...
            const requirement = {
                ...
                applicableTypes: ['contractor', 'supplier'] // Ø§ÙØªØ±Ø§Ø¶ÙŠ Ù„Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø£Ù†ÙˆØ§Ø¹
            };
        ...
        if (requirements.length === 0) {
            Notification.warning('ÙŠØ¬Ø¨ Ø¥Ø¶Ø§ÙØ© Ø§Ø´ØªØ±Ø§Ø· ÙˆØ§Ø­Ø¯ Ø¹Ù„Ù‰ Ø§Ù„Ø£Ù‚Ù„');
            return;
        }
        ...
        Notification.success(`ØªÙ… Ø­ÙØ¸ ${requirements.length} Ø§Ø´ØªØ±Ø§Ø· Ø¨Ù†Ø¬Ø§Ø­`);

        // ØªØ­Ø¯ÙŠØ« Ù…Ø­ØªÙˆÙ‰ ØªØ¨ÙˆÙŠØ¨ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø¥Ø°Ø§ ÙƒØ§Ù† Ù…ÙØªÙˆØ­Ø§Ù‹
        ...
        if (requirementsContent && this.currentTab === 'requirements') {
            this.renderRequirementsManagementSection().then(html => {
                ...
                if (this.safeSetInnerHTML(requirementsContent, html)) {
                    this.setupDragAndDrop(); // Ø¥Ø¹Ø§Ø¯Ø© Ø¥Ø¹Ø¯Ø§Ø¯ Ø§Ù„Ø³Ø­Ø¨ ÙˆØ§Ù„Ø¥ÙÙ„Ø§Øª
                }
            });
        }

        // Ø¥ØºÙ„Ø§Ù‚ Ø§Ù„Ù†Ø§ÙØ°Ø© Ø¥Ø°Ø§ ÙƒØ§Ù†Øª Ù…ÙØªÙˆØ­Ø©
    ...
    /**
     * ÙÙ„ØªØ±Ø© Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø­Ø³Ø¨ Ø§Ù„ÙØ¦Ø©
     */
    filterRequirementsByCategory(categoryId) {
        ...
        // Ø¥Ø¸Ù‡Ø§Ø±/Ø¥Ø®ÙØ§Ø¡ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª
    ...
    importRequirementsTemplate() {
        ...
        input.onchange = async (e) => {
            ...
            try {
                ...
                this.ensureRequirementsSetup();
                // ØªØ­Ø¯ÙŠØ« Ø§Ù„Ù…Ø¹Ø±ÙØ§Øª ÙˆØ§Ù„ØªØ±ØªÙŠØ¨
                template.requirements.forEach((req, index) => {
                    req.id = req.id || `req_${Date.now()}_${index}`;
                    req.order = index + 1;
                    // ØªØ¹ÙŠÙŠÙ† Ù‚ÙŠÙ… Ø§ÙØªØ±Ø§Ø¶ÙŠØ© Ù„Ù„Ø­Ù‚ÙˆÙ„ Ø§Ù„Ù…ÙÙ‚ÙˆØ¯Ø©
                ...
                Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ø§Ø³ØªÙŠØ±Ø§Ø¯ Ø§Ù„Ù‚Ø§Ù„Ø¨:', error);
                Notification.error('ÙØ´Ù„ Ø§Ø³ØªÙŠØ±Ø§Ø¯ Ø§Ù„Ù‚Ø§Ù„Ø¨: ' + error.message);
            }
        };
        input.click();
    },
    ...
    bulkEditRequirements() {
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width: 600px;">
                ...
                <div class="modal-body">
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">ØªØºÙŠÙŠØ± Ø§Ù„ÙØ¦Ø© Ù„Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª Ø§Ù„Ù…Ø­Ø¯Ø¯Ø©:</label>
                        ...
                        <div>
                            <label class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-gray-700">Ø¥Ø¶Ø§ÙØ© ØªØ§Ø±ÙŠØ® Ø§Ù†ØªÙ‡Ø§Ø¡ Ù„Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø§Ø´ØªØ±Ø§Ø·Ø§Øª</span>
                            </label>
                        </div>
        ...
        // Ø¥Ø¶Ø§ÙØ© Ù…Ø³ØªÙ…Ø¹ Ù„ØªØºÙŠÙŠØ± checkbox ØªØ§Ø±ÙŠØ® Ø§Ù„Ø§Ù†ØªÙ‡Ø§Ø¡
        setTimeout(() => {
     ...
     */
    /**
     * âœ… Ø¥ØµÙ„Ø§Ø­ Ø´Ø§Ù…Ù„: Ø¯Ø§Ù„Ø© ensureData Ù…Ø«Ù„ Ø§Ù„Ø¹ÙŠØ§Ø¯Ø© Ø§Ù„Ø·Ø¨ÙŠØ© - ØªØ­ÙØ¸ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª ÙÙŠ localStorage
     * ØªØ£ÙƒØ¯ Ù…Ù† ÙˆØ¬ÙˆØ¯ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª ÙˆØ­ÙØ¸Ù‡Ø§ Ø¨Ø´ÙƒÙ„ Ø«Ø§Ø¨Øª
     */
    ensureData() {
        if (!AppState) {
            if (typeof Utils !== 'undefined' && Utils.safeWarn) {
        ...
        // âœ… Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† ÙˆØ¬ÙˆØ¯ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ù…ØµÙÙˆÙØ§Øª (Ù…Ø«Ù„ Ø§Ù„Ø¹ÙŠØ§Ø¯Ø© Ø§Ù„Ø·Ø¨ÙŠØ©)
        ...
        // âœ… Ø­ÙØ¸ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª ÙÙŠ AppState Ù…Ø¨Ø§Ø´Ø±Ø©
        AppState.appData = data;
        
        // âœ… Ø­ÙØ¸ ÙÙŠ localStorage ÙÙ‚Ø· Ø¹Ù†Ø¯ ØªØºÙŠÙŠØ± Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª (Ù…Ù†Ø¹ Ø§Ø³ØªØ¯Ø¹Ø§Ø¡ Ø§Ù„Ø­ÙØ¸ Ø¹Ù†Ø¯ ÙƒÙ„ Ø¯Ø®ÙˆÙ„ Ù„Ù„Ù…ÙˆØ¯ÙŠÙˆÙ„)
        if (mutated && typeof window.DataManager !== 'undefined' && window.DataManager.save) {
            try {
                window.DataManager.save();
            } catch (saveErr) {
                Utils.safeWarn('âš ï¸ ÙØ´Ù„ Ø­ÙØ¸ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ø­Ù„ÙŠØ© Ø¹Ù†Ø¯ ØªÙ‡ÙŠØ¦Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†:', saveErr);
            }
        }
    },
    ...
    /**
     * Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø­Ø°Ù (ÙˆØ¸ÙŠÙØ© Ù…Ø³Ø§Ø¹Ø¯Ø©)
     */
    async submitDeletionRequest(deletionRequest) {
        ...
        try {
            ...
            if (result && result.success) {
                ...
                Notification.warning('ØªÙ… Ø­ÙØ¸ Ø§Ù„Ø·Ù„Ø¨ Ù…Ø­Ù„ÙŠØ§Ù‹. Ø³ÙŠØªÙ… Ù…Ø²Ø§Ù…Ù†ØªÙ‡ Ø¹Ù†Ø¯ Ø§Ù„Ø§ØªØµØ§Ù„ Ø¨Ø§Ù„Ø¥Ù†ØªØ±Ù†Øª.');
                return false;
            }
        } catch (error) {
            Utils.safeWarn('ÙØ´Ù„ Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°Ù:', error);
            Notification.warning('ØªÙ… Ø­ÙØ¸ Ø§Ù„Ø·Ù„Ø¨ Ù…Ø­Ù„ÙŠØ§Ù‹. Ø³ÙŠØªÙ… Ù…Ø²Ø§Ù…Ù†ØªÙ‡ Ø¹Ù†Ø¯ Ø§Ù„Ø§ØªØµØ§Ù„ Ø¨Ø§Ù„Ø¥Ù†ØªØ±Ù†Øª.');
            return false;
        }
    },
     ...
     * âœ… Ø¥ØµÙ„Ø§Ø­: Ø¬Ø¹Ù„Ù‡Ø§ synchronous Ù„Ø¶Ù…Ø§Ù† Ø§Ù„ØªØ­Ù…ÙŠÙ„ Ø§Ù„ÙÙˆØ±ÙŠ
     * âœ… Ù…Ø­Ø³Ù‘Ù†: Ø§Ø³ØªØ®Ø¯Ø§Ù… cache ÙˆØªØ­Ø³ÙŠÙ† Ø§Ù„ÙˆØµÙˆÙ„ Ù„Ù„Ø¨ÙŠØ§Ù†Ø§Øª
     */
    renderApprovalRequestSection() {
        // âœ… Ø¥ØµÙ„Ø§Ø­: Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø§Ù„Ø¥Ø¹Ø¯Ø§Ø¯ Ù…Ø±Ø© ÙˆØ§Ø­Ø¯Ø© ÙÙ‚Ø·
        this.ensureApprovalRequestsSetup();
        this.ensureDeletionRequestsSetup();
        ...
        try {
            ...
            Utils.safeWarn('Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ Ø·Ù„Ø¨Ø§ØªÙŠ:', error);
            myRequests = [];
        }
        ...
        if (isAdmin) {
            try {
                ...
                Utils.safeWarn('Ø®Ø·Ø£ ÙÙŠ ØªØ­Ù…ÙŠÙ„ Ø·Ù„Ø¨Ø§Øª Ø§Ù„Ù…Ø±Ø§Ø¬Ø¹Ø©:', error);
                pendingRequests = [];
            }
        }
            ...
            <div class="content-card">
                ...
                <div class="card-body space-y-6">
                    <div class="bg-blue-50 border border-blue-200 rounded p-4">
                        <p class="text-sm text-blue-800">
                            <i class="fas fa-info-circle ml-2"></i>
                            ÙŠÙ…ÙƒÙ†Ùƒ Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø§Ø¹ØªÙ…Ø§Ø¯ Ù…Ù‚Ø§ÙˆÙ„ Ø£Ùˆ Ù…Ù‚Ø¯Ù… Ø®Ø¯Ù…Ø© Ø¬Ø¯ÙŠØ¯. Ø³ÙŠØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø·Ù„Ø¨ Ø¥Ù„Ù‰ Ù…Ø¯ÙŠØ± Ø§Ù„Ù†Ø¸Ø§Ù… Ù„Ù„Ù…Ø±Ø§Ø¬Ø¹Ø© ÙˆØ§Ù„Ù…ÙˆØ§ÙÙ‚Ø©.
                        </p>
                    </div>
                    ...
                    ${circuitOpen ? `
                        <div class="bg-yellow-50 border border-yellow-200 rounded p-4">
                            <p class="text-sm text-yellow-800">
                                ...
                                ØªØ¹Ø°Ø± Ø§Ù„Ø§ØªØµØ§Ù„ Ø¨Ø§Ù„Ø®Ø§Ø¯Ù… Ù…Ø¤Ù‚ØªØ§Ù‹ (Circuit Breaker Ù…ÙØªÙˆØ­)
    ...
    renderApprovalRequestsTable(requests, isAdminView = false) {
        ...
        return `
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th>Ø§Ù„Ø­Ø§Ù„Ø©</th>
                            ${isAdminView ? '<th>Ø§Ù„Ø¥Ø¬Ø±Ø§Ø¡Ø§Øª</th>' : '<th>Ø§Ù„ØªÙØ§ØµÙŠÙ„</th>'}
                        </tr>
                    </thead>
                    <tbody>
            ...
            if (request._isPendingSync) {
                ...
                syncStatusBadge = '<span class="badge badge-warning" title="' + (request._syncErrorMessage || 'ÙØ´Ù„ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©') + '"><i class="fas fa-exclamation-triangle ml-1"></i> Ø®Ø·Ø£ ÙÙŠ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©</span>';
            }
            ...
            return `
                                <tr ${request._isPendingSync ? 'style="opacity: 0.8;"' : ''}>
                                    ...
                                    <td>
                                        ${isAdminView ? `
                                            <div class="flex items-center gap-2">
                                                <button class="btn-icon btn-icon-info" title="Ø¹Ø±Ø¶ Ø§Ù„ØªÙØ§ØµÙŠÙ„" onclick="Contractors.viewApprovalRequest('${request.id}', '${isDeletionRequest ? 'deletion' : 'approval'}')">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                ${(request.status === 'pending' || request.status === 'under_review') ? `
                                                    ...
                                                    <button class="btn-icon btn-icon-danger" title="Ø±ÙØ¶" onclick="Contractors.rejectRequest('${request.id}', '${isDeletionRequest ? 'deletion' : 'approval'}')">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                ` : ''}
                                            </div>
    ...
    getMyApprovalRequests() {
        // âœ… ØªØ­Ø³ÙŠÙ†: Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø§Ù„Ø¥Ø¹Ø¯Ø§Ø¯ Ù…Ø±Ø© ÙˆØ§Ø­Ø¯Ø© ÙÙ‚Ø·
        if (!Array.isArray(AppState.appData.contractorApprovalRequests)) {
        ...
        // âœ… ØªØ­Ø³ÙŠÙ†: Ø§Ø³ØªØ®Ø¯Ø§Ù… filter Ùˆ map Ø¨Ø´ÙƒÙ„ Ø£ÙƒØ«Ø± ÙƒÙØ§Ø¡Ø©
        ...
        // âœ… ØªØ­Ø³ÙŠÙ†: Ø¯Ù…Ø¬ ÙˆØªØ±ØªÙŠØ¨ ÙÙŠ Ø®Ø·ÙˆØ© ÙˆØ§Ø­Ø¯Ø©
     ...
     * âœ… Ø¥ØµÙ„Ø§Ø­: Ø§Ø³ØªØ«Ù†Ø§Ø¡ Ø§Ù„Ø·Ù„Ø¨Ø§Øª Ø§Ù„ØªÙŠ Ø£Ù†Ø´Ø£Ù‡Ø§ Ø§Ù„Ù…Ø¯ÙŠØ± Ù†ÙØ³Ù‡ Ù„Ù…Ù†Ø¹ Ø§Ù„ØªÙƒØ±Ø§Ø±
     */
    getPendingApprovalRequests() {
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­: ÙÙ„ØªØ±Ø© Ø§Ù„Ø·Ù„Ø¨Ø§Øª Ù‚ÙŠØ¯ Ø§Ù„Ù…Ø±Ø§Ø¬Ø¹Ø© Ù…Ø¹ Ø§Ø³ØªØ«Ù†Ø§Ø¡ Ø·Ù„Ø¨Ø§Øª Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù… Ù†ÙØ³Ù‡
        const approvalRequests = AppState.appData.contractorApprovalRequests
            .filter(req => req && 
                (req.status === 'pending' || req.status === 'under_review') &&
                req.createdBy !== currentUserId) // âœ… Ø§Ø³ØªØ«Ù†Ø§Ø¡ Ø·Ù„Ø¨Ø§Øª Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù… Ù†ÙØ³Ù‡
            .map(req => ({ ...req, requestCategory: 'approval' }));
    ...
    getApprovalRequestStatusBadge(status) {
        ...
        const statusMap = {
            ...
            'rejected': { label: 'Ù…Ø±ÙÙˆØ¶', class: 'badge-danger' }
        };
    ...
    showApprovalRequestForm() {
            ...
            <div class="modal-content" style="max-width: 800px;">
                ...
                <div class="modal-body">
                    <form id="approval-request-form" class="space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Ù…Ù„Ø§Ø­Ø¸Ø§Øª Ø¥Ø¶Ø§ÙÙŠØ©</label>
                            <textarea id="approval-request-notes" class="form-input" rows="4" placeholder="Ø£ÙŠ Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø¥Ø¶Ø§ÙÙŠØ© Ù‚Ø¯ ØªØ³Ø§Ø¹Ø¯ ÙÙŠ Ù…Ø±Ø§Ø¬Ø¹Ø© Ø§Ù„Ø·Ù„Ø¨"></textarea>
                        </div>
                        <div class="border-t pt-4">
                            ...
                            <p class="text-xs text-gray-500 mt-1">ÙŠÙ…ÙƒÙ†Ùƒ Ø±ÙØ¹ Ù…Ù„ÙØ§Øª Ù…ØªØ¹Ø¯Ø¯Ø© (PDF, Word, Excel, ØµÙˆØ±). Ø§Ù„Ø­Ø¯ Ø§Ù„Ø£Ù‚ØµÙ‰ Ù„Ø­Ø¬Ù… ÙƒÙ„ Ù…Ù„Ù 5MB.</p>
                        ...
                        <div class="border-t pt-4">
                            <div class="flex items-center justify-between mb-2">
                                <label class="block text-sm font-semibold text-gray-700">
                                    <i class="fas fa-cog ml-2"></i>
                                    Ø§Ù„Ø¨Ù†ÙˆØ¯ Ø§Ù„Ù…Ø·Ù„ÙˆØ¨Ø© Ø§Ù„Ø¥Ø¶Ø§ÙÙŠØ© (Ù„Ù„Ù…Ø¯ÙŠØ± ÙÙ‚Ø·)
                                </label>
        ...
        // Ø¥Ø¹Ø¯Ø§Ø¯ Ù…Ø¹Ø§Ù„Ø¬Ø© Ø§Ù„Ù…Ø±ÙÙ‚Ø§Øª
        ...
        // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† ÙˆØ¬ÙˆØ¯ form Ù‚Ø¨Ù„ Ø¥Ø¶Ø§ÙØ© event listener
        if (!form) {
        ...
        form.addEventListener('submit', (e) => {
            ...
            // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø£Ù† modal Ù„Ø§ ÙŠØ²Ø§Ù„ Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹ ÙÙŠ DOM
            if (!modal || !document.contains(modal)) {
                Utils.safeWarn('âš ï¸ submit: modal ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯ Ø£Ùˆ ØªÙ… Ø­Ø°ÙÙ‡');
                return;
            }
            ...
            this.submitApprovalRequest(modal, attachments, () => {
                ...
                // âœ… Callback Ù„Ø¥Ø¹Ø§Ø¯Ø© ØªÙØ¹ÙŠÙ„ Ø§Ù„Ø²Ø± (ÙÙŠ Ø­Ø§Ù„Ø© Ø§Ù„Ø®Ø·Ø£) - Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† ÙˆØ¬ÙˆØ¯ Ø§Ù„Ø¹Ù†Ø§ØµØ± Ø£ÙˆÙ„Ø§Ù‹
                isSubmitting = false;
                if (submitBtn && document.contains(submitBtn)) {
                    submitBtn.disabled = false;
                    const submitText = submitBtn.querySelector('.submit-text');
     ...
     * âœ… Ù…Ø­Ø³Ù‘Ù†: Ø§Ø³ØªØ¬Ø§Ø¨Ø© Ø³Ø±ÙŠØ¹Ø©ØŒ Ø­ÙØ¸ Ù…Ø­Ù„ÙŠ Ø£ÙˆÙ„Ø§Ù‹ØŒ Ø¥ØºÙ„Ø§Ù‚ Ø³Ø±ÙŠØ¹ØŒ Ù…Ø²Ø§Ù…Ù†Ø© ÙÙŠ Ø§Ù„Ø®Ù„ÙÙŠØ©
     */
    async submitApprovalRequest(modal, attachments = [], onStart = null, onError = null) {
        try {
            ...
            if (!modal || !modal.parentNode) {
                Utils.safeWarn('âš ï¸ submitApprovalRequest: modal ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯ Ø£Ùˆ ØªÙ… Ø­Ø°ÙÙ‡');
                if (onError) onError();
                return;
            }
            ...
            if (!typeSelect || !companyInput || !serviceInput) {
                ...
                Loading.hide();
                Notification.warning('Ø­Ø¯Ø« Ø®Ø·Ø£ ÙÙŠ Ø§Ù„Ù†Ù…ÙˆØ°Ø¬. ÙŠØ±Ø¬Ù‰ ØªØ­Ø¯ÙŠØ« Ø§Ù„ØµÙØ­Ø© ÙˆØ¥Ø¹Ø§Ø¯Ø© Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø©.');
                if (onError) onError();
                return;
            }
            ...
            const requestData = {
                ...
                attachments: [], // âœ… Ø³ÙŠØªÙ… Ù…Ù„Ø¡ Ø§Ù„Ù…Ø±ÙÙ‚Ø§Øª Ù„Ø§Ø­Ù‚Ø§Ù‹ ÙÙŠ Ø§Ù„Ø®Ù„ÙÙŠØ©
                attachmentFiles: attachments, // âœ… Ø­ÙØ¸ Ø§Ù„Ù…Ù„ÙØ§Øª Ù„Ù„Ø±ÙØ¹ Ù„Ø§Ø­Ù‚Ø§Ù‹
            ...
            // âœ… Ø­ÙØ¸ Ù…Ø­Ù„ÙŠØ§Ù‹ Ø£ÙˆÙ„Ø§Ù‹ Ù„Ù„Ø§Ø³ØªØ¬Ø§Ø¨Ø© Ø§Ù„Ø³Ø±ÙŠØ¹Ø©
            ...
            Utils.safeLog('âœ… ØªÙ… Ø­ÙØ¸ Ø§Ù„Ø·Ù„Ø¨ Ù…Ø­Ù„ÙŠØ§Ù‹. ID Ù…Ø¤Ù‚Øª: ' + tempId);
            
            // âœ… Ø§Ù„Ø¥ØºÙ„Ø§Ù‚ Ø§Ù„ÙÙˆØ±ÙŠ Ù„Ù„Ù†Ù…ÙˆØ°Ø¬ Ø¨Ø¹Ø¯ Ø§Ù„Ø­ÙØ¸ Ø§Ù„Ù…Ø­Ù„ÙŠ â€” Ù„Ø§ Ø§Ù†ØªØ¸Ø§Ø± Ù„Ù„Ù…Ø²Ø§Ù…Ù†Ø©
            Loading.hide();
            Notification.success('ØªÙ… Ø­ÙØ¸ Ø§Ù„Ø·Ù„Ø¨ Ø¨Ù†Ø¬Ø§Ø­. Ø¬Ø§Ø±ÙŠ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø© Ù…Ø¹ Ø§Ù„Ø®Ø§Ø¯Ù…...');
            ...
            try {
                ...
                Utils.safeWarn('âš ï¸ Ø®Ø·Ø£ ÙÙŠ Ø¥Ø²Ø§Ù„Ø© Ø§Ù„Ù†Ù…ÙˆØ°Ø¬:', removeError);
                if (modal.parentNode) {
                    modal.parentNode.removeChild(modal);
                }
            }
            
            // âœ… ØªØ­Ø¯ÙŠØ« Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ø·Ù„Ø¨Ø§Øª Ù…Ø¨Ø§Ø´Ø±Ø© Ø¨Ø¹Ø¯ Ø§Ù„Ø­ÙØ¸ Ø§Ù„Ù…Ø­Ù„ÙŠ
            this.refreshApprovalRequestsSection();
            
            // âœ… Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø© Ù…Ø¹ Backend ÙÙŠ Ø§Ù„Ø®Ù„ÙÙŠØ© ÙÙ‚Ø· (Ù„Ø§ await â€” Ù„Ø§ ØªØºÙŠÙŠØ± ÙÙŠ Ø¨Ù†ÙŠØ© Ø§Ù„ØªØ·Ø¨ÙŠÙ‚)
            this.syncApprovalRequestToBackend(requestData, attachments, tempId).then(() => {
                ...
                Utils.safeError('âŒ Ø®Ø·Ø£ ÙÙŠ Ù…Ø²Ø§Ù…Ù†Ø© Ø§Ù„Ø·Ù„Ø¨ Ù…Ø¹ Backend:', error);
                // Ø¥Ø¸Ù‡Ø§Ø± ØªÙ†Ø¨ÙŠÙ‡ Ø®ÙÙŠÙ Ù„Ù„Ù…Ø³ØªØ®Ø¯Ù…
                Notification.warning('ØªÙ… Ø­ÙØ¸ Ø§Ù„Ø·Ù„Ø¨ Ù…Ø­Ù„ÙŠØ§Ù‹. Ø³ÙŠØªÙ… Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø© ØªÙ„Ù‚Ø§Ø¦ÙŠØ§Ù‹ Ù„Ø§Ø­Ù‚Ø§Ù‹.');
            });
            
        } catch (error) {
            Loading.hide();
            Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯:', error);
    ...
    /**
     * âœ… Ø¬Ø¯ÙŠØ¯: Ù…Ø²Ø§Ù…Ù†Ø© Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ Ù…Ø¹ Backend ÙÙŠ Ø§Ù„Ø®Ù„ÙÙŠØ©
     */
    async syncApprovalRequestToBackend(requestData, attachments = [], tempId) {
        // âœ… Ø¥Ø¶Ø§ÙØ© Ø­Ù…Ø§ÙŠØ© Ù…Ù† Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø© Ø§Ù„Ù…ØªÙƒØ±Ø±Ø© Ù„Ù†ÙØ³ Ø§Ù„Ø·Ù„Ø¨
        const syncKey = `sync_${tempId || requestData.id || Date.now()}`;
        if (this._activeSyncs && this._activeSyncs[syncKey]) {
            Utils.safeLog('âš ï¸ syncApprovalRequestToBackend: Ù…Ø²Ø§Ù…Ù†Ø© Ù‚ÙŠØ¯ Ø§Ù„Ù…Ø¹Ø§Ù„Ø¬Ø© Ù„Ù†ÙØ³ Ø§Ù„Ø·Ù„Ø¨ - ØªÙ… ØªØ¬Ø§Ù‡Ù„ Ø§Ù„Ø§Ø³ØªØ¯Ø¹Ø§Ø¡ Ø§Ù„Ù…ÙƒØ±Ø±');
            return;
        }
        ...
        try {
            // âœ… Ø±ÙØ¹ Ø§Ù„Ù…Ø±ÙÙ‚Ø§Øª ÙÙŠ Ø§Ù„Ø®Ù„ÙÙŠØ© (Ù…ØªÙˆØ§Ø²ÙŠ Ø¥Ø°Ø§ Ø£Ù…ÙƒÙ†)
            let attachmentUrls = [];
            if (attachments && attachments.length > 0) {
                try {
                    // âœ… Ø±ÙØ¹ Ø§Ù„Ù…Ù„ÙØ§Øª Ø¨Ø´ÙƒÙ„ Ù…ØªÙˆØ§Ø²ÙŠ Ù„ØªØ­Ø³ÙŠÙ† Ø§Ù„Ø£Ø¯Ø§Ø¡
                    const uploadPromises = attachments.map(async (file) => {
                        ...
                        if (uploadResult && uploadResult.url) {
                            ...
                            Utils.safeWarn('ÙØ´Ù„ Ø±ÙØ¹ Ø§Ù„Ù…Ù„Ù ' + file.name + ':', error);
                            return null;
                        }
                    });
                    ...
                    if (attachmentUrls.length < attachments.length) {
                        Utils.safeWarn('âš ï¸ ÙØ´Ù„ Ø±ÙØ¹ Ø¨Ø¹Ø¶ Ø§Ù„Ù…Ø±ÙÙ‚Ø§Øª. ØªÙ… Ø±ÙØ¹ ' + attachmentUrls.length + ' Ù…Ù† ' + attachments.length);
                    }
                } catch (error) {
                    Utils.safeWarn('ÙØ´Ù„ Ø±ÙØ¹ Ø¨Ø¹Ø¶ Ø§Ù„Ù…Ø±ÙÙ‚Ø§Øª:', error);
                }
            }
            
            // âœ… ØªØ­Ø¯ÙŠØ« requestData Ø¨Ø§Ù„Ù…Ø±ÙÙ‚Ø§Øª Ø§Ù„Ù…Ø±ÙÙˆØ¹Ø©
            requestData.attachments = attachmentUrls;
            delete requestData.attachmentFiles; // âœ… Ø­Ø°Ù Ø§Ù„Ù…Ù„ÙØ§Øª Ø§Ù„Ø£ØµÙ„ÙŠØ© Ø¨Ø¹Ø¯ Ø§Ù„Ø±ÙØ¹
            ...
            const tempIdToReplace = requestData.id; // Ø­ÙØ¸ tempId Ù„Ù„Ø§Ø³ØªØ¨Ø¯Ø§Ù„ Ù„Ø§Ø­Ù‚Ø§Ù‹ (ÙŠØ¬Ø¨ Ø£Ù† ÙŠÙƒÙˆÙ† tempId Ø§Ù„Ø°ÙŠ ØªÙ… Ø¥Ù†Ø´Ø§Ø¤Ù‡ ÙÙŠ submitApprovalRequest)
            
            // âœ… ØªØ­Ø¯ÙŠØ¯ actualTempId Ù„Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù… ÙÙŠ Ø¬Ù…ÙŠØ¹ Ø£Ù†Ø­Ø§Ø¡ Ø§Ù„Ø¯Ø§Ù„Ø©
            ...
            Utils.safeLog('ðŸ”„ Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø·Ù„Ø¨ Ø¥Ù„Ù‰ Backend Ø¨Ø¯ÙˆÙ† ID (tempId=' + actualTempId + ' Ø³ÙŠØªÙ… Ø§Ø³ØªØ¨Ø¯Ø§Ù„Ù‡ Ø¨Ù€ CAR_... Ù…Ù† Backend)');
            ...
            // âœ… Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø·Ù„Ø¨ Ø¥Ù„Ù‰ Backend
                ...
                if (backendResult && backendResult.success) {
                // âœ… Ø¨Ø¹Ø¯ Ù†Ø¬Ø§Ø­ Ø§Ù„Ø­ÙØ¸ ÙÙŠ BackendØŒ Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ù…Ù† Backend Ù…Ø¹ ID Ø§Ù„Ù…ÙˆÙ„Ø¯
                const savedRequest = backendResult.data || requestData;
                    
                // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø£Ù† Backend Ù‚Ø§Ù… Ø¨ØªÙˆÙ„ÙŠØ¯ ID Ø¬Ø¯ÙŠØ¯ (CAR_1, CAR_2, ...)
                if (!savedRequest.id || savedRequest.id.startsWith('TEMP_')) {
                    Utils.safeError('âŒ Ø®Ø·Ø£: Backend Ù„Ù… ÙŠÙˆÙ„Ø¯ ID Ø¬Ø¯ÙŠØ¯. savedRequest.id=' + (savedRequest.id || 'undefined'));
                    // Ù…Ø­Ø§ÙˆÙ„Ø© ØªÙˆÙ„ÙŠØ¯ ID ÙŠØ¯ÙˆÙŠØ§Ù‹ ÙƒØ­Ù„ Ø¨Ø¯ÙŠÙ„ (Ù„Ø§ ÙŠÙ†Ø¨ØºÙŠ Ø£Ù† ÙŠØ­Ø¯Ø«)
                    savedRequest.id = 'CAR_' + Date.now();
                }
                
                // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø£Ù† ID Ø§Ù„Ø¬Ø¯ÙŠØ¯ ÙŠØ¨Ø¯Ø£ Ø¨Ù€ "CAR_"
                if (!savedRequest.id || !savedRequest.id.startsWith('CAR_')) {
                    Utils.safeWarn('âš ï¸ ØªØ­Ø°ÙŠØ±: ID Ø§Ù„Ù…ÙÙˆÙ„Ø¯ Ù„Ø§ ÙŠØ¨Ø¯Ø£ Ø¨Ù€ CAR_. ID=' + (savedRequest.id || 'undefined'));
                    }
                    
                // âœ… actualTempId ØªÙ… ØªØ¹Ø±ÙŠÙÙ‡ Ø³Ø§Ø¨Ù‚Ø§Ù‹ ÙÙŠ Ø¨Ø¯Ø§ÙŠØ© Ø§Ù„Ø¯Ø§Ù„Ø© (Ø§Ù„Ø³Ø·Ø± 7639)
                // âœ… Ø§Ø³ØªØ®Ø¯Ø§Ù…Ù‡ Ù„Ù„Ø¨Ø­Ø« Ø¹Ù† Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„Ù…Ø¤Ù‚Øª ÙˆØ§Ø³ØªØ¨Ø¯Ø§Ù„Ù‡
                
                Utils.safeLog('âœ… ØªÙ… Ø§Ø³ØªØ¨Ø¯Ø§Ù„ tempId=' + actualTempId + ' Ø¨Ø§Ù„Ù€ ID Ø§Ù„ÙØ¹Ù„ÙŠ=' + savedRequest.id);
                
                // âœ… Ø¥ÙŠØ¬Ø§Ø¯ Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„Ù…Ø¤Ù‚Øª ÙˆØ§Ø³ØªØ¨Ø¯Ø§Ù„Ù‡ Ø¨Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„ÙØ¹Ù„ÙŠ (Ø§Ù„Ø¨Ø­Ø« Ø¨ÙƒÙ„ Ø§Ù„Ø§Ø­ØªÙ…Ø§Ù„Ø§Øª)
                ...
                if (tempIndex !== -1) {
                    // âœ… ØªØ­Ø¯ÙŠØ« Ø§Ù„Ø·Ù„Ø¨ Ø¨Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„ÙØ¹Ù„ÙŠØ© Ù…Ù† Backend (Ù…Ø¹ ID Ø§Ù„Ø¬Ø¯ÙŠØ¯)
                    // âœ… Ø§Ø³ØªØ¨Ø¯Ø§Ù„ ÙƒØ§Ù…Ù„ Ù„Ù„Ø·Ù„Ø¨ Ø§Ù„Ù…Ø¤Ù‚Øª Ø¨Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„ÙØ¹Ù„ÙŠ
                    ...
                    Utils.safeLog('âœ… ØªÙ… Ø§Ø³ØªØ¨Ø¯Ø§Ù„ Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„Ù…Ø¤Ù‚Øª ÙÙŠ AppState. oldID=' + oldId + ' -> newID=' + savedRequest.id + ', tempIndex=' + tempIndex);
                } else {
                    // âœ… Ø¥Ø°Ø§ Ù„Ù… ÙŠÙˆØ¬Ø¯ Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„Ù…Ø¤Ù‚ØªØŒ Ø¥Ø¶Ø§ÙØªÙ‡ Ù…Ø¨Ø§Ø´Ø±Ø©
                    Utils.safeWarn('âš ï¸ ØªØ­Ø°ÙŠØ±: Ù„Ù… ÙŠØªÙ… Ø§Ù„Ø¹Ø«ÙˆØ± Ø¹Ù„Ù‰ Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„Ù…Ø¤Ù‚Øª ÙÙŠ AppState. tempId=' + actualTempId);
                    // âœ… Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† ÙˆØ¬ÙˆØ¯ ID ØµØ­ÙŠØ­
                    if (!savedRequest.id || savedRequest.id.startsWith('TEMP_')) {
                        Utils.safeError('âŒ Ø®Ø·Ø£: savedRequest.id ØºÙŠØ± ØµØ­ÙŠØ­. savedRequest.id=' + (savedRequest.id || 'undefined'));
                        savedRequest.id = 'CAR_' + Date.now();
                    }
                    savedRequest._isPendingSync = false;
                    AppState.appData.contractorApprovalRequests.push(savedRequest);
                    Utils.safeLog('âœ… ØªÙ… Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„Ø¬Ø¯ÙŠØ¯ Ù…Ø¨Ø§Ø´Ø±Ø© Ø¥Ù„Ù‰ AppState. newID=' + savedRequest.id);
                }
                ...
                // Ø­ÙØ¸ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ø­Ù„ÙŠØ© Ø§Ù„Ù…Ø­Ø¯Ø«Ø©
                if (typeof window.DataManager !== 'undefined' && window.DataManager.save) {
                    window.DataManager.save();
                }
            ...
            try {
                ...
                // ØªØ­Ø¯ÙŠØ« Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø¹Ø¨Ø± BroadcastChannel Ù„Ù„ØªØ¨ÙˆÙŠØ¨Ø§Øª Ø§Ù„Ù…ÙØªÙˆØ­Ø©
                if (typeof RealtimeSyncManager !== 'undefined' && RealtimeSyncManager.state && RealtimeSyncManager.state.broadcastChannel) {
                    ...
                    Utils.safeLog('âœ… ØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø¥Ø´Ø¹Ø§Ø± Broadcast Ù„Ù„ØªØ¨ÙˆÙŠØ¨Ø§Øª Ø§Ù„Ù…ÙØªÙˆØ­Ø©');
                }
            } catch (notifyError) {
                Utils.safeWarn('âš ï¸ ÙØ´Ù„ Ø¥Ø±Ø³Ø§Ù„ Ø¥Ø´Ø¹Ø§Ø±Ø§Øª Real-time:', notifyError);
            }
                
                // âœ… Ø¥Ø±Ø³Ø§Ù„ Ø¥Ø´Ø¹Ø§Ø±Ø§Øª Ù„Ù„Ù…Ø¯ÙŠØ±ÙŠÙ† ÙÙŠ Ø§Ù„Ø®Ù„ÙÙŠØ©
                this.notifyAdminsAboutApprovalRequest(requestData).catch(error => {
                    Utils.safeWarn('âš ï¸ ÙØ´Ù„ Ø¥Ø±Ø³Ø§Ù„ Ø¥Ø´Ø¹Ø§Ø±Ø§Øª Ù„Ù„Ù…Ø¯ÙŠØ±ÙŠÙ†:', error);
                });
            ...
            if (typeof AppUI !== 'undefined' && AppUI.updateNotificationsBadge) {
                ...
                // âœ… ÙÙŠ Ø­Ø§Ù„Ø© ÙØ´Ù„ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©ØŒ Ø§Ù„Ø­ÙØ§Ø¸ Ø¹Ù„Ù‰ Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„Ù…Ø­Ù„ÙŠ
                Utils.safeWarn('âš ï¸ ÙØ´Ù„ Ù…Ø²Ø§Ù…Ù†Ø© Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ Ù…Ø¹ BackendØŒ ØªÙ… Ø§Ù„Ø­ÙØ¸ Ù…Ø­Ù„ÙŠØ§Ù‹ ÙÙ‚Ø·');
                ...
                if (tempIndex !== -1) {
                    ...
                    AppState.appData.contractorApprovalRequests[tempIndex]._syncErrorMessage = backendResult?.message || 'ÙØ´Ù„ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©';
                }
            ...
            // âœ… ÙÙŠ Ø­Ø§Ù„Ø© Ø§Ù„Ø®Ø·Ø£ØŒ Ø§Ù„Ø­ÙØ§Ø¸ Ø¹Ù„Ù‰ Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„Ù…Ø­Ù„ÙŠ
            Utils.safeError('âŒ Ø®Ø·Ø£ ÙÙŠ Ù…Ø²Ø§Ù…Ù†Ø© Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ Ù…Ø¹ Backend:', error);
            const tempIndex = AppState.appData.contractorApprovalRequests.findIndex(r => r.id === tempId);
            if (tempIndex !== -1) {
                AppState.appData.contractorApprovalRequests[tempIndex]._syncError = true;
                AppState.appData.contractorApprovalRequests[tempIndex]._syncErrorMessage = error.message || 'Ø®Ø·Ø£ ÙÙŠ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©';
            }
        ...
        try {
            ...
            if (admins.length === 0) {
                ...
                try {
                    ...
                    Utils.safeWarn('ÙØ´Ù„ Ù‚Ø±Ø§Ø¡Ø© Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙŠÙ† Ù…Ù† Google Sheets:', error);
                }
            }
                ...
                if (admin.id || admin.email) {
                    try {
                        await GoogleIntegration.sendRequest({
                            ...
                            Utils.safeWarn('ÙØ´Ù„ Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø¥Ø´Ø¹Ø§Ø± Ù„Ù„Ù…Ø¯ÙŠØ±:', error);
                        });
                    } catch (error) {
                        Utils.safeWarn('Ø®Ø·Ø£ ÙÙŠ Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø¥Ø´Ø¹Ø§Ø± Ù„Ù„Ù…Ø¯ÙŠØ±:', error);
                    }
                }
            }
        } catch (error) {
            Utils.safeWarn('Ø®Ø·Ø£ ÙÙŠ Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø¥Ø´Ø¹Ø§Ø±Ø§Øª Ù„Ù„Ù…Ø¯ÙŠØ±ÙŠÙ†:', error);
        }
    },
    ...
    refreshApprovalRequestsSection() {
        ...
        try {
            ...
            Utils.safeError('Ø®Ø·Ø£ ÙÙŠ ØªØ­Ø¯ÙŠØ« Ù‚Ø³Ù… Ø·Ù„Ø¨Ø§Øª Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯:', error);
        } finally {
            this._isRefreshingApprovalRequests = false;
        }
    },
    ...
    /**
     * Ø¹Ø±Ø¶ ØªÙØ§ØµÙŠÙ„ Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ Ø£Ùˆ Ø§Ù„Ø­Ø°Ù
     */
    viewApprovalRequest(requestId, requestCategory = 'approval') {
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­: Ø§Ù„Ø¨Ø­Ø« Ø¹Ù† Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„ØªÙ‚ÙŠÙŠÙ… ÙÙŠ Ø¹Ø¯Ø© Ø£Ù…Ø§ÙƒÙ†
        ...
        if (isEvaluationRequest) {
            ...
            // âœ… ØªØ­Ù„ÙŠÙ„ evaluationData Ø¥Ø°Ø§ ÙƒØ§Ù† Ù†ØµØ§Ù‹ (JSON string) - Ù…Ø¹Ø§Ù„Ø¬Ø© Ø§Ù„ØªØ´ÙÙŠØ± Ø§Ù„Ù…Ø²Ø¯ÙˆØ¬
            let parseAttempts = 0;
            while (evaluationData && typeof evaluationData === 'string' && parseAttempts < 3) {
                try {
                    ...
                    Utils.safeWarn('âš ï¸ ÙØ´Ù„ ØªØ­Ù„ÙŠÙ„ evaluationData Ù…Ù† Ø§Ù„Ù†Øµ (Ù…Ø­Ø§ÙˆÙ„Ø© ' + parseAttempts + '):', error);
                    break;
                }
            }
            ...
            // âœ… Ø¥Ø°Ø§ Ù„Ù… ÙŠÙˆØ¬Ø¯ evaluationData Ø£Ùˆ ÙƒØ§Ù† ÙØ§Ø±ØºØ§Ù‹ØŒ Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø·Ù„Ø¨ Ù…Ø¨Ø§Ø´Ø±Ø©
            ...
            if (!hasValidData) {
                Utils.safeLog('ðŸ“‹ evaluationData ÙØ§Ø±Øº Ø£Ùˆ ØºÙŠØ± ØµØ§Ù„Ø­ØŒ Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø·Ù„Ø¨ Ù…Ø¨Ø§Ø´Ø±Ø©');
                evaluationData = {
            ...
            // âœ… ØªØ­Ù„ÙŠÙ„ items Ø¥Ø°Ø§ ÙƒØ§Ù†Øª Ù†ØµØ§Ù‹ - Ù…Ø¹Ø§Ù„Ø¬Ø© Ø§Ù„ØªØ´ÙÙŠØ± Ø§Ù„Ù…Ø²Ø¯ÙˆØ¬
            ...
            while (evaluationData?.items && typeof evaluationData.items === 'string' && itemsParseAttempts < 3) {
                try {
                    ...
                    Utils.safeWarn('âš ï¸ ÙØ´Ù„ ØªØ­Ù„ÙŠÙ„ Ø¨Ù†ÙˆØ¯ Ø§Ù„ØªÙ‚ÙŠÙŠÙ… Ù…Ù† Ø§Ù„Ù†Øµ:', error);
                    evaluationData.items = [];
                    break;
                }
            }
            
            Utils.safeLog('ðŸ“‹ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„ØªÙ‚ÙŠÙŠÙ… Ø§Ù„Ù…Ø³ØªØ®Ø±Ø¬Ø©:', evaluationData);
            Utils.safeLog('ðŸ“‹ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø·Ù„Ø¨ Ø§Ù„Ø£ØµÙ„ÙŠØ©:', request);
        }
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width: 800px;">
                <div class="modal-header">
                    <h2 class="modal-title">${isDeletionRequest ? 'ØªÙØ§ØµÙŠÙ„ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°Ù' : 'ØªÙØ§ØµÙŠÙ„ Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯'}</h2>
                    <button class="modal-close" onclick="this.closest('.modal-overlay').remove()">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                    ...
                    ${canEdit ? `
                        <div class="bg-blue-50 border border-blue-200 rounded p-3 mb-4">
                            <div class="flex items-center justify-between">
                                <p class="text-sm text-blue-800">
                                    <i class="fas fa-info-circle ml-2"></i>
                                    ÙŠÙ…ÙƒÙ†Ùƒ ØªØ¹Ø¯ÙŠÙ„ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø·Ù„Ø¨ Ù‚Ø¨Ù„ Ø§Ù„Ù…ÙˆØ§ÙÙ‚Ø© Ø¹Ù„ÙŠÙ‡
                                </p>
                    ...
                    <form id="request-details-form">
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="text-sm font-semibold text-gray-600">${isDeletionRequest ? 'Ø§Ø³Ù… Ø§Ù„Ø¹Ù†ØµØ± Ø§Ù„Ù…Ø±Ø§Ø¯ Ø­Ø°ÙÙ‡' : isEvaluationRequest ? 'Ø§Ø³Ù… Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„' : 'Ø§Ø³Ù… Ø§Ù„Ø´Ø±ÙƒØ© / Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„'}</label>
                                    ${!isEvaluationRequest ? `
                            ...
                            ${isEvaluationRequest && evaluationItems.length > 0 ? `
                                <div class="bg-gray-50 border border-gray-200 rounded p-3">
                                    <label class="text-sm font-semibold text-gray-600 block mb-3">
                                        <i class="fas fa-clipboard-list ml-2"></i>
                                        ØªÙØ§ØµÙŠÙ„ Ø¨Ù†ÙˆØ¯ Ø§Ù„ØªÙ‚ÙŠÙŠÙ… (${evaluationItems.length} Ø¨Ù†Ø¯)
                                    </label>
                    ...
                    ${!isDeletionRequest && request.attachments && request.attachments.length > 0 ? `
                            <div class="bg-blue-50 border border-blue-200 rounded p-3">
                                <label class="text-sm font-semibold text-blue-800 block mb-2">
                                    <i class="fas fa-paperclip ml-2"></i>
                                    Ø§Ù„Ù…Ø±ÙÙ‚Ø§Øª (${request.attachments.length})
                                </label>
                                <div class="space-y-2">
                        ...
                        ${!isDeletionRequest && request.customFields && request.customFields.length > 0 ? `
                            <div class="bg-purple-50 border border-purple-200 rounded p-3">
                                <label class="text-sm font-semibold text-purple-800 block mb-2">
                                    ...
                                    Ø§Ù„Ø¨Ù†ÙˆØ¯ Ø§Ù„Ù…Ø·Ù„ÙˆØ¨Ø© Ø§Ù„Ø¥Ø¶Ø§ÙÙŠØ© (${request.customFields.length})
                                </label>
                                <div class="space-y-2">
                        ...
                        ${request.rejectedAt ? `
                            <div class="bg-red-50 border border-red-200 rounded p-3">
                                <label class="text-sm font-semibold text-red-800 block mb-2">ØªØ§Ø±ÙŠØ® Ø§Ù„Ø±ÙØ¶</label>
                                <p class="text-red-700">${Utils.formatDate(request.rejectedAt)}</p>
                                ${request.rejectionReason ? `
                                    <label class="text-sm font-semibold text-red-800 block mb-2 mt-2">Ø³Ø¨Ø¨ Ø§Ù„Ø±ÙØ¶</label>
                ...
                <div class="modal-footer" style="margin-top: auto; flex-shrink: 0; width: 100%;">
                    ...
                    ${isAdmin && (request.status === 'pending' || request.status === 'under_review') ? `
                        ...
                        <button class="btn-danger" onclick="Contractors.rejectRequest('${request.id}', '${requestCategory}'); this.closest('.modal-overlay').remove();">
                            <i class="fas fa-times ml-2"></i>Ø±ÙØ¶
                        </button>
                    ` : ''}
                </div>
            </div>
        ...
        // âœ… Ø¥Ø¶Ø§ÙØ© event listener Ù„Ø²Ø± Ø­ÙØ¸ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„Ø§Øª
    ...
    toggleEditMode() {
        ...
        if (toggleBtn) {
            if (isEditMode) {
                toggleBtn.innerHTML = '<i class="fas fa-edit ml-1"></i> ØªÙØ¹ÙŠÙ„ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„';
            } else {
    ...
    /**
     * âœ… Ø­ÙØ¸ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„Ø§Øª Ø¹Ù„Ù‰ Ø§Ù„Ø·Ù„Ø¨
     */
    async saveRequestChanges(requestId, requestCategory = 'approval') {
        ...
        try {
            ...
            if (result && result.success) {
                Notification.success('ØªÙ… Ø­ÙØ¸ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„Ø§Øª Ø¨Ù†Ø¬Ø§Ø­');
                const modal = document.querySelector('.modal-overlay');
                if (modal) modal.remove();
                this.refreshApprovalRequestsSection();
            } else {
                throw new Error(result?.message || 'ÙØ´Ù„ Ø­ÙØ¸ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„Ø§Øª');
            }
        } catch (error) {
            Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ø­ÙØ¸ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„Ø§Øª:', error);
            Notification.error('Ø­Ø¯Ø« Ø®Ø·Ø£ Ø£Ø«Ù†Ø§Ø¡ Ø­ÙØ¸ Ø§Ù„ØªØ¹Ø¯ÙŠÙ„Ø§Øª: ' + error.message);
        } finally {
            Loading.hide();
        }
    },
    ...
    async approveRequest(requestId, requestCategory = 'approval') {
        ...
        if (requestCategory === 'deletion') {
            ...
            if (!confirm('Ù‡Ù„ Ø£Ù†Øª Ù…ØªØ£ÙƒØ¯ Ù…Ù† Ø§Ø¹ØªÙ…Ø§Ø¯ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°ÙØŸ Ø³ÙŠØªÙ… Ø­Ø°Ù Ø§Ù„Ø¹Ù†ØµØ± Ù†Ù‡Ø§Ø¦ÙŠØ§Ù‹.')) {
                return;
            }
            ...
            try {
                ...
                if (result && result.success) {
                    ...
                    Loading.hide();
                    Notification.error('ÙØ´Ù„ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°Ù: ' + (result?.message || 'Ø®Ø·Ø£ ØºÙŠØ± Ù…Ø¹Ø±ÙˆÙ'));
                }
            } catch (error) {
                Loading.hide();
                Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°Ù:', error);
                Notification.error('ØªØ¹Ø°Ø± Ø§Ø¹ØªÙ…Ø§Ø¯ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°Ù: ' + error.message);
            }
            return;
        }

        if (!confirm('Ù‡Ù„ Ø£Ù†Øª Ù…ØªØ£ÙƒØ¯ Ù…Ù† Ø§Ø¹ØªÙ…Ø§Ø¯ Ù‡Ø°Ø§ Ø§Ù„Ø·Ù„Ø¨ØŸ Ø³ÙŠØªÙ… Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„/Ø§Ù„Ù…ÙˆØ±Ø¯ Ø¥Ù„Ù‰ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†.')) {
            return;
        }
        ...
        try {
            ...
            if (!request && requestId.startsWith('TEMP_')) {
                ...
                Utils.safeWarn('âš ï¸ Ù…Ø­Ø§ÙˆÙ„Ø© Ø§Ø¹ØªÙ…Ø§Ø¯ Ø·Ù„Ø¨ Ø¨Ù…ÙØ¹Ø±Ù Ù…Ø¤Ù‚Øª (tempId=' + requestId + ') - ÙŠØ¬Ø¨ Ø§Ù„Ø§Ù†ØªØ¸Ø§Ø± Ø­ØªÙ‰ Ø§ÙƒØªÙ…Ø§Ù„ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©');
                return;
            }
            ...
            if (request && request.id && request.id.startsWith('TEMP_')) {
                ...
                if (request._isPendingSync) {
                    ...
                    Notification.error('ÙØ´Ù„Øª Ù…Ø²Ø§Ù…Ù†Ø© Ø§Ù„Ø·Ù„Ø¨ Ù…Ø¹ Ø§Ù„Ø®Ø§Ø¯Ù…. ÙŠØ±Ø¬Ù‰ Ø¥Ø¹Ø§Ø¯Ø© Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø·Ù„Ø¨ Ø£ÙˆÙ„Ø§Ù‹.');
                } else {
                ...
                Utils.safeWarn('âš ï¸ Ù…Ø­Ø§ÙˆÙ„Ø© Ø§Ø¹ØªÙ…Ø§Ø¯ Ø·Ù„Ø¨ Ø¨Ù…ÙØ¹Ø±Ù Ù…Ø¤Ù‚Øª (tempId=' + request.id + ') - ÙŠØ¬Ø¨ Ø§Ù„Ø§Ù†ØªØ¸Ø§Ø± Ø­ØªÙ‰ Ø§ÙƒØªÙ…Ø§Ù„ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø© Ø£Ùˆ Ø¥Ø¹Ø§Ø¯Ø© Ø§Ù„Ø¥Ø±Ø³Ø§Ù„');
                return;
            }
            
            // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† ÙˆØ¬ÙˆØ¯ Ø§Ù„Ø·Ù„Ø¨ (Ù†Ù‚Ø¨Ù„ Ø£ÙŠ Ù…Ø¹Ø±Ù Ù…Ø­ÙÙˆØ¸: CAR_ Ø£Ùˆ UUID Ù…Ù† Supabase)
            if (!request) {
                Loading.hide();
                Notification.error('Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯');
                Utils.safeError('âŒ Ø®Ø·Ø£: Ù„Ù… ÙŠØªÙ… Ø§Ù„Ø¹Ø«ÙˆØ± Ø¹Ù„Ù‰ Ø§Ù„Ø·Ù„Ø¨. requestId=' + requestId);
                return;
            }
            // Ù†Ø±ÙØ¶ ÙÙ‚Ø· Ø§Ù„Ù…ÙØ¹Ø±Ù Ø§Ù„Ù…Ø¤Ù‚Øª TEMP_ (Ø·Ù„Ø¨ Ù„Ù… ÙŠÙØ²Ø§Ù…ÙŽÙ† Ø¨Ø¹Ø¯)
            ...
            if (!backendResult || !backendResult.success) {
                Loading.hide();
                Notification.error('ÙØ´Ù„ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ø·Ù„Ø¨ ÙÙŠ Backend: ' + (backendResult?.message || 'Ø®Ø·Ø£ ØºÙŠØ± Ù…Ø¹Ø±ÙˆÙ'));
                return;
            }
            ...
            if (backendResult.approvedEntity) {
                ...
                // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† ÙˆØ¬ÙˆØ¯ ID Ù‚Ø¨Ù„ Ø§Ù„Ø¥Ø¶Ø§ÙØ©
                ...
                // âœ… Ø§Ù„ØªØ­Ù‚Ù‚ Ø§Ù„Ù†Ù‡Ø§Ø¦ÙŠ: Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø£Ù† Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª ØªÙ…Øª Ø¥Ø¶Ø§ÙØªÙ‡Ø§ Ø¨Ø´ÙƒÙ„ ØµØ­ÙŠØ­
                ...
                if (verifyAdded) {
                    ...
                    Utils.safeError('âŒ Error: Failed to add approved contractor to AppState.approvedContractors');
                }
            } else {
                ...
                // âœ… Ø¥Ø°Ø§ ÙƒØ§Ù† Ø§Ù„Ø·Ù„Ø¨ Ù…Ù† Ù†ÙˆØ¹ contractor Ø£Ùˆ supplierØŒ ÙŠØ¬Ø¨ Ø£Ù† ÙŠÙƒÙˆÙ† approvedEntity Ù…ÙˆØ¬ÙˆØ¯Ø§Ù‹
                if (request.requestType === 'contractor' || request.requestType === 'supplier') {
                    Utils.safeError('âŒ Error: approvedEntity should not be null for contractor/supplier requests');
                }
            }
            ...
            // Ø¥Ø°Ø§ ÙƒØ§Ù† Ø§Ù„Ø·Ù„Ø¨ Ù„ØªÙ‚ÙŠÙŠÙ…ØŒ Ø¥Ø¶Ø§ÙØ© Ø§Ù„ØªÙ‚ÙŠÙŠÙ… Ø¥Ù„Ù‰ Ø§Ù„Ù‚Ø§Ø¦Ù…Ø©
            if (request.requestType === 'evaluation' && request.evaluationData) {
                ...
                // Ø­ÙØ¸ ØªÙ„Ù‚Ø§Ø¦ÙŠ Ø¨Ø¯ÙˆÙ† await
                GoogleIntegration.autoSave?.('ContractorEvaluations', AppState.appData.contractorEvaluations).catch(error => {
                    Utils.safeWarn('ÙØ´Ù„ Ø§Ù„Ø­ÙØ¸ Ø§Ù„ØªÙ„Ù‚Ø§Ø¦ÙŠ Ù„Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª:', error);
                });
            }
            ...
            // âœ… Ø¥ØµÙ„Ø§Ø­: Backend Ù‚Ø§Ù… Ø¨Ø§Ù„ÙØ¹Ù„ Ø¨Ø§Ù„Ø­ÙØ¸ Ø¨Ø§Ø³ØªØ®Ø¯Ø§Ù… updateSingleRowInSheet (Ø¢Ù…Ù†Ø©)
            // âœ… Ù„Ø§ Ø­Ø§Ø¬Ø© Ù„Ù€ autoSave Ù‡Ù†Ø§ Ù„Ø£Ù†Ù‡Ø§ Ù‚Ø¯ ØªØ­Ø°Ù Ø§Ù„Ø·Ù„Ø¨Ø§Øª Ø§Ù„Ø£Ø®Ø±Ù‰
            // âœ… Ù†Ø³ØªØ®Ø¯Ù… Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø© ÙÙ‚Ø· Ù„Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø§Ù„ØªØ·Ø§Ø¨Ù‚

            // Ù…Ø²Ø§Ù…Ù†Ø© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ù…Ù† Backend Ù„Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø§Ù„ØªØ·Ø§Ø¨Ù‚
            // âœ… ØªØ­Ø³ÙŠÙ†: Ù…Ø²Ø§Ù…Ù†Ø© ÙÙ‚Ø· Ø§Ù„Ø£ÙˆØ±Ø§Ù‚ Ø§Ù„Ù…ØªØ¹Ù„Ù‚Ø© Ø¨Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ù„ØªØ¬Ù†Ø¨ Ø¥Ø¸Ù‡Ø§Ø± Ø´Ø§Ø´Ø© Database loaded Ø§Ù„ÙƒØ§Ù…Ù„Ø©
            try {
                Utils.safeLog('ðŸ”„ Ø¨Ø¯Ø¡ Ù…Ø²Ø§Ù…Ù†Ø© Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ù…Ù† Backend...');
                await GoogleIntegration.syncData({
                    ...
                    notifyOnSuccess: false,
                    notifyOnError: true,  // âœ… Ø¥Ø¸Ù‡Ø§Ø± Ø§Ù„Ø£Ø®Ø·Ø§Ø¡ ÙÙ‚Ø·
                    sheets: ['ContractorApprovalRequests', 'ApprovedContractors', 'Contractors'] // âœ… Ù…Ø²Ø§Ù…Ù†Ø© ÙÙ‚Ø· Ø£ÙˆØ±Ø§Ù‚ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†
                });
                ...
                if (verifyApproved) {
                    Utils.safeLog(`âœ… ØªÙ… Ø§Ù„ØªØ­Ù‚Ù‚: Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ "${verifyApproved.companyName}" Ù…ÙˆØ¬ÙˆØ¯ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† (ID: ${verifyApproved.id}, Code: ${verifyApproved.code || verifyApproved.isoCode})`);
                } else {
                    Utils.safeWarn(`âš ï¸ ØªØ­Ø°ÙŠØ±: Ù„Ù… ÙŠØªÙ… Ø§Ù„Ø¹Ø«ÙˆØ± Ø¹Ù„Ù‰ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ "${request.companyName}" ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† Ø¨Ø¹Ø¯ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©`);
                }
            } catch (syncError) {
                Utils.safeError('âŒ Ø®Ø·Ø£: ÙØ´Ù„Øª Ù…Ø²Ø§Ù…Ù†Ø© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ù…Ù† Backend:', syncError);
                // Ø¥Ø¸Ù‡Ø§Ø± ØªÙ†Ø¨ÙŠÙ‡ Ù„Ù„Ù…Ø³ØªØ®Ø¯Ù…
                Notification.warning('ØªÙ… Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ø·Ù„Ø¨ Ø¨Ù†Ø¬Ø§Ø­ ÙÙŠ BackendØŒ Ù„ÙƒÙ† Ø­Ø¯Ø« Ø®Ø·Ø£ ÙÙŠ Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø©. ÙŠØ±Ø¬Ù‰ ØªØ­Ø¯ÙŠØ« Ø§Ù„ØµÙØ­Ø© Ù„Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø¸Ù‡ÙˆØ± Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª.');
            }

            Loading.hide();

            // Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø£Ù† Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ØªÙ… Ø¥Ø¶Ø§ÙØªÙ‡ Ø¨Ù†Ø¬Ø§Ø­ ÙˆØ§Ù„Ø±Ø¨Ø· Ù…ÙˆØ¬ÙˆØ¯
            if (request.requestType === 'contractor' || request.requestType === 'supplier') {
                ...
                if (addedContractor && linkedApproved) {
                    ...
                    if (linkedApproved.contractorId === addedContractor.id || addedContractor.approvedEntityId === linkedApproved.id) {
                        Utils.safeLog(`âœ… ØªÙ… Ø¥Ø¶Ø§ÙØ© ${request.requestType === 'supplier' ? 'Ø§Ù„Ù…ÙˆØ±Ø¯' : 'Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„'} "${addedContractor.name}" Ø¨Ù†Ø¬Ø§Ø­ ÙˆØ§Ù„Ø±Ø¨Ø· Ù…ÙˆØ¬ÙˆØ¯ (Contractor ID: ${addedContractor.id}, Approved ID: ${linkedApproved.id})`);
                    } else {
                        Utils.safeWarn('âš ï¸ ØªØ­Ø°ÙŠØ±: Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ ÙˆØ§Ù„Ù…Ø¹ØªÙ…Ø¯ Ù…ÙˆØ¬ÙˆØ¯Ø§Ù† Ù„ÙƒÙ† Ø§Ù„Ø±Ø¨Ø· ØºÙŠØ± Ù…ÙƒØªÙ…Ù„');
                    }
                } else {
                    Utils.safeWarn('âš ï¸ ØªØ­Ø°ÙŠØ±: Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ø£Ùˆ Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ Ù„Ù… ÙŠØ¸Ù‡Ø± ÙÙŠ Ø§Ù„Ù‚ÙˆØ§Ø¦Ù… Ø¨Ø¹Ø¯ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯');
                }
            }

            Notification.success('ØªÙ… Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ø·Ù„Ø¨ Ø¨Ù†Ø¬Ø§Ø­. ØªÙ… Ø¥Ø¶Ø§ÙØ© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„/Ø§Ù„Ù…ÙˆØ±Ø¯ Ø¥Ù„Ù‰ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† ÙˆØ§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†.');

            // ØªØ­Ø¯ÙŠØ« Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø£Ù‚Ø³Ø§Ù… Ø°Ø§Øª Ø§Ù„ØµÙ„Ø©
            this.refreshApprovalRequestsSection();

            // ØªØ­Ø¯ÙŠØ« Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† Ø¥Ø°Ø§ ÙƒØ§Ù† Ø§Ù„ØªØ¨ÙˆÙŠØ¨ Ù…ÙØªÙˆØ­Ø§Ù‹
            if (this.currentTab === 'approved') {
                this.refreshApprovedEntitiesList();
            }
            ...
            Loading.hide();
            Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ø·Ù„Ø¨:', error);
            Notification.error('ØªØ¹Ø°Ø± Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ø·Ù„Ø¨: ' + error.message);
        }
    },

    /**
     * Ø±ÙØ¶ Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯
     */
    async rejectRequest(requestId, requestCategory = 'approval') {
        if (!Permissions.isAdmin()) {
            Notification.error('Ù„ÙŠØ³ Ù„Ø¯ÙŠÙƒ ØµÙ„Ø§Ø­ÙŠØ© Ù„Ø±ÙØ¶ Ø§Ù„Ø·Ù„Ø¨Ø§Øª');
            return;
        }
        ...
        if (requestCategory === 'deletion') {
            ...
            const reason = prompt('ÙŠØ±Ø¬Ù‰ Ø¥Ø¯Ø®Ø§Ù„ Ø³Ø¨Ø¨ Ø§Ù„Ø±ÙØ¶:') || 'ØªÙ… Ø§Ù„Ø±ÙØ¶ Ù…Ù† Ù‚Ø¨Ù„ Ø§Ù„Ù…Ø¯ÙŠØ±';
            ...
            try {
                ...
                if (result && result.success) {
                    ...
                    Loading.hide();
                    Notification.success('ØªÙ… Ø±ÙØ¶ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°Ù Ø¨Ù†Ø¬Ø§Ø­');
                    this.refreshApprovalRequestsSection();
                    if (typeof AppUI !== 'undefined' && AppUI.updateNotificationsBadge) {
                        AppUI.updateNotificationsBadge();
                    }
                    ...
                    Loading.hide();
                    Notification.error('ÙØ´Ù„ Ø±ÙØ¶ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°Ù: ' + (result?.message || 'Ø®Ø·Ø£ ØºÙŠØ± Ù…Ø¹Ø±ÙˆÙ'));
                }
            } catch (error) {
                Loading.hide();
                Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ø±ÙØ¶ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°Ù:', error);
                Notification.error('ØªØ¹Ø°Ø± Ø±ÙØ¶ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø°Ù: ' + error.message);
            }
            return;
        }

        const reason = prompt('ÙŠØ±Ø¬Ù‰ Ø¥Ø¯Ø®Ø§Ù„ Ø³Ø¨Ø¨ Ø§Ù„Ø±ÙØ¶ (Ø§Ø®ØªÙŠØ§Ø±ÙŠ):');
        if (reason === null) return; // Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù… Ø£Ù„ØºÙ‰
        ...
        try {
            ...
            // âœ… Ø¥ØµÙ„Ø§Ø­: Ø§Ø³ØªØ®Ø¯Ø§Ù… rejectContractorApprovalRequest ÙÙŠ Backend Ù…Ø¨Ø§Ø´Ø±Ø©
            // âœ… Ù‡Ø°Ø§ ÙŠØ¶Ù…Ù† Ø¹Ø¯Ù… Ø­Ø°Ù Ø§Ù„Ø·Ù„Ø¨Ø§Øª Ø§Ù„Ù…ÙˆØ¬ÙˆØ¯Ø© ÙÙŠ Google Sheets
            const backendResult = await GoogleIntegration.sendRequest({
            ...
            if (backendResult && backendResult.success) {
                // âœ… Ø¨Ø¹Ø¯ Ù†Ø¬Ø§Ø­ Ø§Ù„Ø­ÙØ¸ ÙÙŠ BackendØŒ ØªØ­Ø¯ÙŠØ« Ø§Ù„Ø·Ù„Ø¨ Ù…Ø­Ù„ÙŠØ§Ù‹
                request.status = 'rejected';
                request.rejectedAt = new Date().toISOString();
                request.rejectedBy = AppState.currentUser?.id || '';
                request.rejectedByName = AppState.currentUser?.name || '';
                ...
                Loading.hide();
                Utils.safeLog('âœ… ØªÙ… Ø±ÙØ¶ Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ ÙÙŠ Google Sheets Ø¨Ù†Ø¬Ø§Ø­');
            } else {
                // Ø¥Ø°Ø§ ÙØ´Ù„ Ø§Ù„Ø­ÙØ¸ ÙÙŠ BackendØŒ Ù†Ø­Ø¯Ø« Ù…Ø­Ù„ÙŠØ§Ù‹ ÙÙ‚Ø·
                request.status = 'rejected';
                request.rejectedAt = new Date().toISOString();
                request.rejectedBy = AppState.currentUser?.id || '';
                request.rejectedByName = AppState.currentUser?.name || '';
                ...
                Loading.hide();
                Utils.safeWarn('âš ï¸ ÙØ´Ù„ Ø±ÙØ¶ Ø·Ù„Ø¨ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ ÙÙŠ Google SheetsØŒ ØªÙ… Ø§Ù„ØªØ­Ø¯ÙŠØ« Ù…Ø­Ù„ÙŠØ§Ù‹ ÙÙ‚Ø·');
                Notification.warning('ØªÙ… ØªØ­Ø¯ÙŠØ« Ø§Ù„Ø·Ù„Ø¨ Ù…Ø­Ù„ÙŠØ§Ù‹. Ø³ÙŠØªÙ… Ø§Ù„Ù…Ø²Ø§Ù…Ù†Ø© Ù„Ø§Ø­Ù‚Ø§Ù‹.');
            }

            Notification.success('ØªÙ… Ø±ÙØ¶ Ø§Ù„Ø·Ù„Ø¨ Ø¨Ù†Ø¬Ø§Ø­.');
            this.refreshApprovalRequestsSection();
            ...
            Utils.safeError('Ø®Ø·Ø£ ÙÙŠ Ø±ÙØ¶ Ø§Ù„Ø·Ù„Ø¨:', error);
            Notification.error('ØªØ¹Ø°Ø± Ø±ÙØ¶ Ø§Ù„Ø·Ù„Ø¨: ' + error.message);
        }
    },
    ...
    async renderAnalyticsSection() {
        ...
        if (typeof GoogleIntegration !== 'undefined' && GoogleIntegration.readFromSheets && AppState.googleConfig?.appsScript?.enabled) {
            try {
                ...
                if (typeof Utils !== 'undefined' && Utils.safeWarn) Utils.safeWarn('ØªØ¹Ø°Ø± Ø¬Ù„Ø¨ Ù…Ø®Ø§Ù„ÙØ§Øª Ø£Ùˆ ØªÙ‚ÙŠÙŠÙ…Ø§Øª Ù„ØªØ­Ù„ÙŠÙ„ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†:', e);
            }
        }

        const contractors = AppState.appData.contractors || [];
        const approvedContractors = AppState.appData.approvedContractors || [];
        const contractorsForAnalysis = this.getContractorsForAnalysis(contractors, approvedContractors);
        ...
        return `
            <div class="content-card border-2 border-indigo-200 rounded-xl shadow-xl overflow-hidden">
                ...
                <div class="card-body p-6 bg-gray-50">
                    ...
                    ${this.renderContractorViolationsAnalysis(contractorsForAnalysis, violations)}
                    ${this.renderExpiringContractsAlert(expiringContracts)}
                    ${this.renderDetailedContractorAnalysis(contractorsForAnalysis, approvedContractors, evaluations, violations)}
                </div>
            </div>
        `;
    },
    ...
    calculateContractorAnalytics(contractors, approvedContractors, evaluations, violations) {
        // Ù‚Ø§Ø¦Ù…Ø© Ù…ÙˆØ­Ø¯Ø© Ù„Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ù…Ø³Ø¬Ù„ÙŠÙ† (Ù…Ù† contractors Ùˆ approvedContractors) Ø¨Ø¯ÙˆÙ† ØªÙƒØ±Ø§Ø± Ø­Ø³Ø¨ id/contractorId/Ø§Ø³Ù…
        ...
        // Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ù…Ø³Ø¬Ù„ÙŠÙ† = Ø¹Ø¯Ø¯ Ø§Ù„Ø³Ø¬Ù„Ø§Øª Ø§Ù„ÙØ±ÙŠØ¯Ø© ÙÙŠ Ø§Ù„Ù‚Ø§Ø¦Ù…ØªÙŠÙ†
        const totalContractors = mergedContractors.length;

        // Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ†: ÙƒÙ„ Ø³Ø¬Ù„ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† ÙŠÙØ­Ø³Ø¨ Ù…Ø¹ØªÙ…Ø¯Ø§Ù‹ Ù…Ø§ Ù„Ù… ØªÙƒÙ† Ø­Ø§Ù„ØªÙ‡ ØµØ±ÙŠØ­Ø© ØºÙŠØ± Ù…Ø¹ØªÙ…Ø¯Ø©
        const totalApproved = approvedContractors.filter(ac => {
            const status = (ac.status || '').toString().trim();
            const s = status.toLowerCase();
            if (!status) return true; // ÙˆØ¬ÙˆØ¯ Ø§Ù„Ø³Ø¬Ù„ ÙÙŠ Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ø¹ØªÙ…Ø¯ÙŠÙ† = Ù…Ø¹ØªÙ…Ø¯
            return s === 'approved' || s === 'Ù…Ø¹ØªÙ…Ø¯' || s === 'Ù†Ø´Ø·' || s === 'active';
        }).length;

        // Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…Ø§Øª
        const totalEvaluations = evaluations.length;

        // Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª (Ø¬Ù…ÙŠØ¹ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª Ø§Ù„Ù…ØªØ¹Ù„Ù‚Ø© Ø¨Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†)
        ...
        // Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ù†Ø´Ø·ÙŠÙ† (Ù…Ù† Ø§Ù„Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…ÙˆØ­Ø¯Ø©)
        const activeContractors = mergedContractors.filter(c => {
            const s = (c._status || (c.status || '').toString()).toLowerCase();
            return s === 'Ù†Ø´Ø·' || s === 'active' || s === 'Ù…Ø¹ØªÙ…Ø¯' || s === 'approved';
        }).length;

        // Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø§Ù„Ù…Ù†ØªÙ‡ÙŠØ© Ø¹Ù‚ÙˆØ¯Ù‡Ù… (Ù…Ù† Ø§Ù„Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…ÙˆØ­Ø¯Ø©ØŒ endDate Ø£Ùˆ expiryDate)
        const now = new Date();
        ...
        // Ù†Ø³Ø¨Ø© Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª (Ù…Ø®Ø§Ù„ÙØ§Øª Ù„ÙƒÙ„ Ù…Ù‚Ø§ÙˆÙ„)
        ...
        // Ù…Ø¹Ø¯Ù„ Ø­Ù„ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª
        ...
        // ØªÙˆØ²ÙŠØ¹ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª Ø­Ø³Ø¨ Ø§Ù„Ø´Ø¯Ø©
        ...
        const lowSeverityViolations = contractorViolations.filter(v => {
            const severity = (v.severity || '').toString().trim();
            return severity === 'Ù…Ù†Ø®ÙØ¶Ø©' || severity === 'low' || severity === 'Ù‚Ù„ÙŠÙ„Ø©';
        }).length;
        ...
        return `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="analytics-card bg-gradient-to-br from-red-50 via-red-100 to-red-50 border-2 border-red-300 rounded-xl p-6 shadow-lg"
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-700 mb-1">Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª</p>
                    ...
                    <div class="text-xs text-gray-600 mt-2">
                        <span class="font-semibold text-red-700">${analytics.violationsPerContractor}</span> Ù…Ø®Ø§Ù„ÙØ© Ù„ÙƒÙ„ Ù…Ù‚Ø§ÙˆÙ„
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="analytics-card bg-gradient-to-br from-purple-50 via-purple-100 to-purple-50 border-2 border-purple-300 rounded-xl p-6 shadow-lg"
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-700 mb-1">Ù…Ø¹Ø¯Ù„ Ø­Ù„ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª</p>
                    ...
                    <div class="text-xs text-gray-600 mt-2">
                        ${analytics.resolvedViolations} Ù…Ù† ${analytics.totalViolations} Ù…Ø®Ø§Ù„ÙØ© Ù…Ø­Ù„ÙˆÙ„Ø©
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-gradient-to-br from-slate-50 to-slate-100 border-2 border-slate-300 rounded-xl p-5 shadow-md">
                    <p class="text-sm font-medium text-gray-600 mb-3">ØªÙˆØ²ÙŠØ¹ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª Ø­Ø³Ø¨ Ø§Ù„Ø´Ø¯Ø©</p>
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-green-600 font-medium">Ù…Ù†Ø®ÙØ¶Ø©:</span>
    ...
    renderContractorViolationsAnalysis(contractors, violations) {
                ...
                <div class="content-card mb-6 border-2 border-gray-200 rounded-xl shadow-lg">
                    <div class="card-header bg-gradient-to-r from-gray-50 to-gray-100 border-b-2 border-gray-200">
                        <h3 class="card-title text-lg font-bold text-gray-800">
                            ...
                            ØªØ­Ù„ÙŠÙ„ Ù…Ø®Ø§Ù„ÙØ§Øª Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†
                        </h3>
                    </div>
                    <div class="card-body p-8">
                        <div class="text-center">
                            <i class="fas fa-check-circle text-5xl text-green-400 mb-4"></i>
                            <p class="text-gray-600 text-lg font-medium">Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ø®Ø§Ù„ÙØ§Øª Ù…Ø³Ø¬Ù„Ø© Ù„Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†</p>
        ...
        // âœ… Ø¥ØµÙ„Ø§Ø­ Ø¬Ø°Ø±ÙŠ: Ø§Ø³ØªØ®Ø¯Ø§Ù… Ù†Ø¸Ø§Ù… Ø§Ù„ØªØ¬Ù…ÙŠØ¹ Ø§Ù„Ø¯Ù‚ÙŠÙ‚ (Map-Reduce)
        // Ø¨Ø¯Ù„Ø§Ù‹ Ù…Ù† Ø§Ù„Ù…Ø·Ø§Ø¨Ù‚Ø© Ø§Ù„Ù†ØµÙŠØ© Ø§Ù„Ù…Ø¹Ù‚Ø¯Ø© Ø§Ù„ØªÙŠ ØªØ³Ø¨Ø¨Øª ÙÙŠ ØªØ¶Ø§Ø¹Ù Ø§Ù„Ø£Ø±Ù‚Ø§Ù…
        
        // 1. ØªØ¬Ù…ÙŠØ¹ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª Ø¨Ù†Ø§Ø¡Ù‹ Ø¹Ù„Ù‰ Ø§Ù„Ù…Ø¹Ø±Ù Ø£Ùˆ Ø§Ù„Ø§Ø³Ù… Ø¨Ø¯Ù‚Ø©
        const violationsStatsMap = new Map();

        violations.forEach(v => {
            // ØªØ­Ø¯ÙŠØ¯ Ù…ÙØªØ§Ø­ ÙØ±ÙŠØ¯ Ù„Ù„Ù…Ù‚Ø§ÙˆÙ„ (Ø§Ù„Ø£ÙˆÙ„ÙˆÙŠØ© Ù„Ù„Ù…Ø¹Ø±Ù Ø«Ù… Ø§Ù„Ø§Ø³Ù…)
            const normalizedContractorId = v.contractorId || v.contractorCode || v.code || v.isoCode || v.licenseNumber || v.contractNumber || v.approvedEntityId || v.entityCode;
            const normalizedContractorName = v.contractorName || v.companyName || v.contractorCompany || v.name || v.externalName;
            let mapKey = null;
            if (normalizedContractorId) {
                mapKey = `ID:${String(normalizedContractorId).trim().toLowerCase()}`;
            } else if (normalizedContractorName) {
                mapKey = `NAME:${String(normalizedContractorName).trim().toLowerCase()}`;
            }
        ...
        // 2. Ø±Ø¨Ø· Ø§Ù„Ø¥Ø­ØµØ§Ø¦ÙŠØ§Øª Ø¨Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ†
        const contractorsWithStats = (contractors || []).map(contractor => {
            ...
            const idCandidates = [
                ...
                contractor.approvedEntityId,
                contractor.entityCode
            ];
            const nameCandidates = [
                ...
                contractor.externalName
            ];

            for (const value of idCandidates) {
                if (!value) continue;
                const idKey = `ID:${String(value).trim().toLowerCase()}`;
            ...
            if (stats.total === 0) {
                for (const value of nameCandidates) {
                    if (!value) continue;
                    const nameKey = `NAME:${String(value).trim().toLowerCase()}`;
            ...
            return {
                name: contractor.name || contractor.companyName || 'ØºÙŠØ± Ù…Ø­Ø¯Ø¯',
                stats: stats
            };
        }).filter(item => item.stats.total > 0); // Ø¹Ø±Ø¶ Ù…Ù† Ù„Ø¯ÙŠÙ‡Ù… Ù…Ø®Ø§Ù„ÙØ§Øª ÙÙ‚Ø·

        // ØªØ±ØªÙŠØ¨ ØªÙ†Ø§Ø²Ù„ÙŠ Ø­Ø³Ø¨ Ø¹Ø¯Ø¯ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª
                        ...
                        <table class="data-table w-full">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 text-center font-bold text-gray-700 border-b border-gray-200">Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª</th>
                                    ...
                                    <th class="px-6 py-4 text-center font-bold text-gray-700 border-b border-gray-200">
                                        <span class="text-green-600">Ù…Ù†Ø®ÙØ¶Ø©</span>
                                    </th>
                                    <th class="px-6 py-4 text-center font-bold text-gray-700 border-b border-gray-200">
    ...
    /**
     * Ù…Ø·Ø§Ø¨Ù‚Ø© Ù…ÙˆØ­Ù‘Ø¯Ø© Ù„Ø³Ø¬Ù„Ø§Øª Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ (Ù…Ø®Ø§Ù„ÙØ§ØªØŒ ØªÙ‚ÙŠÙŠÙ…Ø§ØªØŒ ØªØ¯Ø±ÙŠØ¨ØŒ Ø¹ÙŠØ§Ø¯Ø©ØŒ Ø¥Ù„Ø®).
     * ØªÙØ³ØªØ®Ø¯Ù… ÙÙŠ Ø¬Ø¯ÙˆÙ„ Â«ØªØ­Ù„ÙŠÙ„ Ù…ÙØµÙ„Â» ÙˆÙÙŠ Ù†Ø§ÙØ°Ø© Â«Ø¹Ø±Ø¶Â» Ù„ØªØ·Ø§Ø¨Ù‚ Ø§Ù„Ø£Ø±Ù‚Ø§Ù… Ù…Ø¹ Ù‚Ø§Ø¹Ø¯Ø© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª.
     */
    getContractorsForAnalysis(contractors, approvedContractors) {
        const merged = [];
        const seenKeys = new Set();
        const addContractor = (contractor) => {
            if (!contractor || typeof contractor !== 'object') return;
            const id = contractor.id || contractor.contractorId || contractor.approvedEntityId || contractor.contractorCode || contractor.code || contractor.isoCode || contractor.licenseNumber || contractor.contractNumber || contractor.entityCode;
            const name = contractor.companyName || contractor.name || contractor.contractorName || contractor.company || contractor.contractorCompany || contractor.externalName || '';
            const key = id ? String(id).trim().toLowerCase() : String(name).trim().toLowerCase();
            if (!key || seenKeys.has(key)) return;
            seenKeys.add(key);
            merged.push({
                ...contractor,
                id: id || contractor.id || contractor.contractorId || null,
                name,
                endDate: contractor.expiryDate || contractor.endDate,
                status: contractor.status || 'Ù†Ø´Ø·'
            });
        };

        if (Array.isArray(contractors)) contractors.forEach(addContractor);
        if (Array.isArray(approvedContractors)) approvedContractors.forEach(addContractor);
        return merged;
    },
    ...
    buildContractorAnalyticsMatchers(contractor, contractorIdParam) {
        ...
        const canonicalizeName = (value) => String(value == null ? '' : value).replace(/\s+/g, ' ').trim().toLowerCase();
        const idFields = ['id', 'contractorId', 'contractorCode', 'code', 'isoCode', 'licenseNumber', 'contractNumber', 'approvedEntityId', 'entityCode'];
        const nameFields = ['contractorName', 'companyName', 'company', 'contractorCompany', 'name', 'externalName', 'entityName'];
        ...
        idFields.forEach((field) => addId(contractor?.[field]));
        addIdCollection(contractor?.aliasIds);
        addIdCollection(contractor?.identityIds);
        addIdCollection(contractor?.legacyIds);
        addIdCollection(contractor?.altIds);
        nameFields.forEach((field) => addName(contractor?.[field]));
        ...
        const collectEntityNames = (record) => {
            if (!record || typeof record !== 'object') return [];
            return ['contractorName', 'companyName', 'company', 'contractorCompany', 'name', 'externalName', 'entityName']
        ...
        return {
            ...
            exactNameSet,
            canonicalNameSet,
            contractorName: String(contractor?.name || contractor?.companyName || contractor?.contractorName || '').trim(),
            matchesNameValue,
    ...
    renderDetailedContractorAnalysis(contractors, approvedContractors, evaluations, violations) {
                ...
                <div class="content-card border-2 border-gray-200 rounded-xl shadow-lg overflow-hidden">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h3 class="card-title text-lg font-bold text-indigo-900">
                                        ØªØ­Ù„ÙŠÙ„ Ù…ÙØµÙ„ Ù„ÙƒÙ„ Ù…Ù‚Ø§ÙˆÙ„
                                    </h3>
                                    <p class="text-sm text-indigo-700 mt-1">0 Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Ø§Ù„Ù†Ø¸Ø§Ù…</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body p-8">
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500 text-lg">Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† ÙÙŠ Ø§Ù„Ù†Ø¸Ø§Ù…</p>
                            <p class="text-gray-400 text-sm mt-2">ÙŠØ±Ø¬Ù‰ Ø¥Ø¶Ø§ÙØ© Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ù„Ø¹Ø±Ø¶ Ø§Ù„ØªØ­Ù„ÙŠÙ„ Ø§Ù„Ù…ÙØµÙ„</p>
                        </div>
                    </div>
                </div>
            `;
        ...
        // ØªØ±ØªÙŠØ¨ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ÙŠÙ† Ø­Ø³Ø¨ Ø§Ù„Ø£Ø¯Ø§Ø¡ (Ù…ØªÙˆØ³Ø· Ø§Ù„ØªÙ‚ÙŠÙŠÙ… - Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª)
                    ...
                    <div class="flex items-center justify-between p-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-indigo-700 mt-1">${contractorsWithStats.length} Ù…Ù‚Ø§ÙˆÙ„ ÙÙŠ Ø§Ù„Ù†Ø¸Ø§Ù…</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="data-table w-full" style="border-collapse: collapse; table-layout: fixed; min-width: 900px;">
                            ...
                            <thead style="position: sticky; top: 0; z-index: 10; background: #e0e7ff; box-shadow: 0 2px 0 0 #c7d2fe;">
                                <tr>
                                    ...
                                    <th id="header-Ø§Ø³Ù…-Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„" class="px-4 py-3 text-right font-bold text-indigo-900 border-b-2 border-indigo-200" style="background: #e0e7ff; white-space: nowrap;" scope="col">Ø§Ø³Ù… Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„</th>
                                    ...
                                    <th class="px-4 py-3 text-center font-bold text-indigo-900 border-b-2 border-indigo-200" style="background: #e0e7ff; white-space: nowrap;">Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª</th>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ${contractorsWithStats.map((contractor, index) => {
                                    ...
                                    <tr class="hover:bg-indigo-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}">
                                        ...
                                        <td class="px-4 py-3 text-right align-middle" style="overflow: hidden; text-overflow: ellipsis;" headers="header-Ø§Ø³Ù…-Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„">
                                            <div style="min-width: 0;">
                                                ...
                                                <span class="text-xs text-gray-500 mt-1 block text-right">
                                                    <span class="badge badge-${['Ù†Ø´Ø·', 'approved', 'Ù…Ø¹ØªÙ…Ø¯', 'active'].includes((contractor.status || '').toString().trim().toLowerCase()) ? 'success' : 'danger'} text-xs">
                                                        ${contractor.status || '-'}
                                                    </span>
                                                </span>
                                            </div>
    ...
    async viewContractorAnalytics(contractorId) {
        ...
        if (typeof GoogleIntegration !== 'undefined' && GoogleIntegration.sendRequest && AppState.googleConfig?.appsScript?.enabled) {
            ...
            if (needCT || needT || needPTW || needViol || needEval || needClinic || needInj) {
                try {
                    ...
                    if (typeof Utils !== 'undefined' && Utils.safeWarn) Utils.safeWarn('ØªØ¹Ø°Ø± ØªØ­Ù…ÙŠÙ„ Ø¨Ø¹Ø¶ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„ØªØ­Ù„ÙŠÙ„:', e);
                }
            }
        }
        ...
        if (typeof GoogleIntegration !== 'undefined' && GoogleIntegration.sendRequest && AppState.googleConfig?.appsScript?.enabled) {
            try {
                ...
                if (typeof Utils !== 'undefined' && Utils.safeWarn) {
                    Utils.safeWarn('ØªØ¹Ø°Ø± Ø¬Ù„Ø¨ ØªØ­Ù„ÙŠÙ„ Ø§Ù„Ù…Ù‚Ø§ÙˆÙ„ Ù…Ù† Ø§Ù„Ø®Ø§Ø¯Ù…Ø› ÙŠÙØ³ØªØ®Ø¯Ù… Ø§Ù„ØªØµÙÙŠØ© Ø§Ù„Ù…Ø­Ù„ÙŠØ©:', e);
                }
            }
        }
            ...
            <div class="modal-content" style="max-width: 1000px; max-height: 90vh; overflow-y: auto;">
                <div class="modal-header bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h2 class="modal-title text-xl font-bold">ØªØ­Ù„ÙŠÙ„ Ù…ÙØµÙ„: ${Utils.escapeHTML(contractorName || contractor.name || contractor.companyName || '')}</h2>
                ...
                <div class="modal-body p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-300 rounded-xl p-5 shadow-md">
                            ...
                            <p class="text-sm text-gray-600 mb-1">Ø¹Ø¯Ø¯ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª</p>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-xl p-5 shadow-md">
                            ...
                            <p class="text-sm text-gray-600 mb-1">Ù…Ø¹Ø¯Ù„ Ø­Ù„ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div class="bg-gray-50 border-2 border-gray-200 rounded-xl p-4">
                            <p class="text-sm text-gray-600 mb-2">Ù…Ø®Ø§Ù„ÙØ§Øª Ø¹Ø§Ù„ÙŠØ© Ø§Ù„Ø®Ø·ÙˆØ±Ø©</p>
                            <p class="text-2xl font-bold text-red-600">${highViolations}</p>
                        </div>
                        <div class="bg-gray-50 border-2 border-gray-200 rounded-xl p-4">
                            <p class="text-sm text-gray-600 mb-2">Ù…Ø®Ø§Ù„ÙØ§Øª Ù…Ø­Ù„ÙˆÙ„Ø©</p>
                            <p class="text-2xl font-bold text-green-600">${resolvedViolations}</p>
                        </div>
                        <div class="bg-gray-50 border-2 border-gray-200 rounded-xl p-4">
                            <p class="text-sm text-gray-600 mb-2">Ù…Ø®Ø§Ù„ÙØ§Øª Ù‚ÙŠØ¯ Ø§Ù„Ù…Ø¹Ø§Ù„Ø¬Ø©</p>
                        ...
                        <div class="border-2 border-gray-200 rounded-xl overflow-hidden shadow-md">
                            <div class="bg-gradient-to-r from-red-50 to-red-100 border-b-2 border-red-200 p-4">
                                <h3 class="text-lg font-bold text-red-800 flex items-center">
                                    <i class="fas fa-exclamation-triangle ml-2"></i>
                                    Ø§Ù„Ù…Ø®Ø§Ù„ÙØ§Øª (${violations.length})
                                </h3>
                            </div>
                            <div class="overflow-x-auto">
                                <table class="data-table w-full">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            ...
                                            <th class="px-6 py-3 text-right font-bold text-gray-700">Ù†ÙˆØ¹ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ©</th>
                    ...
                    ` : `
                        <div class="bg-green-50 border-2 border-green-200 rounded-xl p-8 text-center">
                            ...
                            <p class="text-lg font-semibold text-green-700">Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ø®Ø§Ù„ÙØ§Øª Ù…Ø³Ø¬Ù„Ø©</p>
...
// ØªØµØ¯ÙŠØ± Ø§Ù„Ù…ÙˆØ¯ÙŠÙˆÙ„ Ø¥Ù„Ù‰ window ÙÙˆØ±Ø§Ù‹ Ù„Ø¶Ù…Ø§Ù† ØªÙˆØ§ÙØ±Ù‡
(function () {
    'use strict';
    try {
        if (typeof window !== 'undefined' && typeof Contractors !== 'undefined') {
            window.Contractors = Contractors;
            // ØªØµØ¯ÙŠØ± Ø§Ù„Ø«ÙˆØ§Ø¨Øª Ù„Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù… ÙÙŠ Ù…ÙˆØ¯ÙŠÙˆÙ„Ø§Øª Ø£Ø®Ø±Ù‰
        ...
        console.error('âŒ Ø®Ø·Ø£ ÙÙŠ ØªØµØ¯ÙŠØ± Contractors:', error);
        // Ù…Ø­Ø§ÙˆÙ„Ø© Ø§Ù„ØªØµØ¯ÙŠØ± Ù…Ø±Ø© Ø£Ø®Ø±Ù‰ Ø­ØªÙ‰ ÙÙŠ Ø­Ø§Ù„Ø© Ø§Ù„Ø®Ø·Ø£
        if (typeof window !== 'undefined' && typeof Contractors !== 'undefined') {
            try {
                window.Contractors = Contractors;
                window.Contractors.APPROVED_ENTITY_STATUS_OPTIONS = APPROVED_ENTITY_STATUS_OPTIONS;
                ...
                console.error('âŒ ÙØ´Ù„ ØªØµØ¯ÙŠØ± Contractors:', e);
            }
        }
    }
})();
