...
const ActionTrackingRegister = {
    ...
    async viewAction(id) {
        ...
        const modal = document.createElement('div');
        modal.className = 'modal-overlay atr-modal-overlay';
        modal.innerHTML = `
            <div class="modal-content atr-modal-content">
                <div class="modal-header atr-modal-header">
                    <h2 class="modal-title atr-modal-title">
                    ...
                    <div class="flex gap-2">
                        ...
                        <div class="dropdown atr-dropdown">
                            <button class="btn-secondary btn-sm" title="تصدير">
                                <i class="fas fa-file-export ml-1"></i>
                                تصدير
                                <i class="fas fa-chevron-down mr-1 atr-chevron-icon"></i>
                            </button>
