...
const Dashboard = {
    ...
    animateStatCards(container) {
        ...
        cards.forEach((card, index) => {
            ...
            if (card.classList.contains('enhanced-stat-card')) {
                ...
                // Legacy stat cards: add the CSS-driven hover class instead of inline styles.
                // All animation values are defined in css/dashboard-enhanced.css (.stat-card--hovered).
                card.classList.add('stat-card-legacy');
                card.addEventListener('mouseenter', function () {
                    this.classList.add('stat-card--hovered');
                }, { passive: true });

                card.addEventListener('mouseleave', function () {
                    this.classList.remove('stat-card--hovered');
                }, { passive: true });
            }
    ...
    setupReportsWidgetEvents(container) {
        ...
        exportBtns.forEach(btn => {
            ...
            // Hover effect handled by CSS (.dashboard-action-btn:hover in dashboard-enhanced.css)
            btn.classList.add('dashboard-action-btn');
        });
