...
\u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0648\u0625\u0639\u062F\u0627\u062F\u0627\u062A Google Apps Script.`,s=r=>{typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save();try{localStorage.setItem("training_last_sync",String(Date.now()))}catch{}this._markAllTabsDirty();const o=this._currentActiveTab||"programs";if(o==="programs")this.loadTrainingList();else if(o==="contractors"){this.refreshContractorTrainingList(),this._syncSelectOptions("contractor-month-filter",this.getMonthOptions());try{this.updateContractorStatsWithFilter(document.getElementById("contractor-month-filter")?.value||"")}catch{}}else o==="attendance"?this.loadAttendanceRegistry():o==="legalTraining"?this.loadLegalTrainingList():o==="analysis"&&this.refreshAnalysisTabContent();const l=r||o;l==="programs"&&(this._trainingBackendFetchOk=!0),this._trainingTabFetchOk&&Object.prototype.hasOwnProperty.call(this._trainingTabFetchOk,l)&&(this._trainingTabFetchOk[l]=!0)};try{const r=y=>Utils.promiseWithTimeout(y,i,n),o={filters:{},__timeoutMs:i},l=async(y,v)=>{const b=await r(GoogleIntegration.sendRequest({action:y,data:{...o}})).catch(D=>{const A=D?.message||D?.toString()||"";return A.includes("\u0627\u0646\u062A\u0647\u062A \u0645\u0647\u0644\u0629 \u0627\u0644\u0627\u062A\u0635\u0627\u0644")||A.includes("timeout")?Utils.safeWarn("\u26A0\uFE0F \u0627\u0646\u062A\u0647\u062A \u0645\u0647\u0644\u0629 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u062E\u0627\u062F\u0645 - \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629"):Utils.safeWarn(`\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 ${v}:`,D),{success:!1,data:[]}});return b&&b.success&&Array.isArray(b.data)?b.data:null},d=t||this._currentActiveTab||"programs",c=()=>Date.now()-(this._trainingLocalSaveTime||0)>6e4,p=()=>Date.now()-(this._trainingAttendanceLocalSaveTime||0)>6e4,g=()=>Date.now()-(this._legalTrainingsLocalSaveTime||0)>6e4,f=()=>Date.now()-(this._legalAttendeesLocalSaveTime||0)>6e4,m=()=>Date.now()-(this._legalRegisterLocalSaveTime||0)>6e4;if(d==="contractors"){await this.loadContractorTrainingsPriority(),s(d);return}if(d==="attendance"){const y=await l("getAllTrainingAttendance","\u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631");y&&p()&&(AppState.appData.trainingAttendance=this._dedupeRegistryRecords(y)),s(d),this._trainingTabFetchOk.programs!==!0&&l("getAllTrainings","\u0628\u0631\u0627\u0645\u062C \u0627\u0644\u062A\u062F\u0631\u064A\u0628").then(v=>{v&&c()&&(AppState.appData.training=v,this._trainingTabFetchOk.programs=!0,this._trainingBackendFetchOk=!0,typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save())}).catch(()=>{});return}if(d==="legalTraining"){const y=await l("getAllLegalTrainings","\u0627\u0644\u062A\u062F\u0631\u064A\u0628\u0627\u062A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A\u0629");y&&g()&&(AppState.appData.legalTrainings=y);const v=await l("getAllLegalTrainingAttendees","\u062D\u0636\u0648\u0631 \u0627\u0644\u062A\u062F\u0631\u064A\u0628\u0627\u062A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A\u0629");v&&f()&&(AppState.appData.legalTrainingAttendees=v);const b=await l("getAllLegalRegisters","\u0633\u062C\u0644 \u0627\u0644\u062A\u0634\u0631\u064A\u0639\u0627\u062A");b&&m()&&(AppState.appData.legalRegister=b),s(d);return}const u=await l("getAllTrainings","\u0628\u0631\u0627\u0645\u062C \u0627\u0644\u062A\u062F\u0631\u064A\u0628");u&&c()&&(AppState.appData.training=u,Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${u.length} \u0628\u0631\u0646\u0627\u0645\u062C \u062A\u062F\u0631\u064A\u0628\u064A`)),s(d)}catch(r){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062A\u062F\u0631\u064A\u0628:",r),this._trainingBackendFetchOk=!0,this._trainingTabFetchOk={programs:!0,attendance:!0,legalTraining:!0},this._contractorTrainingsFetchOk=!0}},getStats(){this.ensureData();const t=AppState.appData.training||[],e=new Date;let a=0,i=0,n=0;return t.forEach(s=>{const r=this.getParticipantsCount(s);a+=r,s.status==="\u0645\u0643\u062A\u0645\u0644"&&(n+=1);const o=s.startDate?new Date(s.startDate):null;(s.status==="\u0645\u062E\u0637\u0637"||o&&o>=e)&&(i+=1)}),{totalTrainings:t.length,upcomingTrainings:i,completedTrainings:n,totalParticipants:a}},getStatsFromTrainingsArray(t){const e=Array.isArray(t)?t:[],a=new Date;let i=0,n=0,s=0;return e.forEach(r=>{i+=this.getParticipantsCount(r),r.status==="\u0645\u0643\u062A\u0645\u0644"&&(s+=1);const o=r.startDate?new Date(r.startDate):null;(r.status==="\u0645\u062E\u0637\u0637"||o&&o>=a)&&(n+=1)}),{totalTrainings:e.length,upcomingTrainings:n,completedTrainings:s,totalParticipants:i}},refreshProgramsTabKpiCards(){const t=this.getStats();[["training-programs-kpi-total",t.totalTrainings],["training-programs-kpi-upcoming",t.upcomingTrainings],["training-programs-kpi-completed",t.completedTrainings],["training-programs-kpi-participants",t.totalParticipants]].forEach(([a,i])=>{const n=document.getElementById(a);n&&(n.textContent=String(i))})},getContractorTrainingStats(t=""){this.ensureData();const e=this._dedupeRegistryRecords(AppState.appData.contractorTrainings||[]),a=this.getContractorOptions(),i=new Map(a.map(m=>[String(m?.id??"").trim(),m.name||""]));i.size===0&&(AppState.appData.contractors||[]).filter(u=>u&&u.isActive!=="inactive"&&u.isActive!==!1&&u.isActive!=="false"&&u.isActive!=="FALSE").forEach(u=>{u?.id&&i.set(String(u.id).trim(),u.name||u.company||u.contractorName||"")});let n=e;t&&(n=e.filter(m=>{if(!m.date)return!1;const u=new Date(m.date);return`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,"0")}`===t}));const s=new Set,r=new Set,o=new Set;let l=0;const d={},c={},p=new Date,g=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,"0")}`;let f=0;return n.forEach(m=>{m.topic&&s.add(m.topic);const u=String(m.contractorId||"").trim(),y=String(m.contractorName||"").replace(/\s+/g," ").trim(),b=y&&!["\u063A\u064A\u0631 \u0645\u062D\u062F\u062F","\u0628\u062F\u0648\u0646 \u0627\u0633\u0645","\u2014","-"].includes(y)?y:i.get(u)||y||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";(u||m.contractorName)&&r.add(b);const D=m.trainer||m.conductedBy||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";(m.trainer||m.conductedBy)&&o.add(D);const A=Number(m.traineesCount||m.attendees||0);l+=A;const h=parseFloat(m.totalHours||m.trainingHours||0);if(d[b]||(d[b]={count:0,trainees:0,hours:0}),d[b].count+=1,d[b].trainees+=A,d[b].hours+=h,c[D]||(c[D]={count:0,trainees:0,hours:0}),c[D].count+=1,c[D].trainees+=A,c[D].hours+=h,m.date){const L=new Date(m.date);`${L.getFullYear()}-${String(L.getMonth()+1).padStart(2,"0")}`===g&&(f+=1)}}),{uniqueTopics:s.size,uniqueContractors:r.size,totalTrainees:l,uniqueTrainers:o.size,currentMonthCount:f,contractorDetails:d,trainerDetails:c}},renderContractorDetailsTable(t){const e=Object.entries(t);return e.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-4">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</td></tr>':e.sort((a,i)=>i[1].count-a[1].count).map(([a,i])=>`
        ...
        `,document.body.appendChild(f),g!==""){const x=f.querySelector("#contractor-training-contractor");x&&x.value!==g&&(x.value=g)}let m=!1,u=null;const y=x=>{x&&(x.preventDefault(),x.stopPropagation()),!m&&(m=!0,f&&f.parentNode&&f.remove(),u&&(document.removeEventListener("keydown",u),u=null))},v=f.querySelector(".modal-content");v&&v.addEventListener("click",x=>{x.stopPropagation()});const b=x=>{x&&(x.preventDefault(),x.stopPropagation()),y(x)},D=f.querySelector(".modal-close");D&&D.addEventListener("click",b);const A=f.querySelector('[data-action="close"]');A&&A.addEventListener("click",b),f.addEventListener("click",x=>{x.target===f&&(x.preventDefault(),x.stopPropagation(),typeof Notification<"u"&&Notification.warning?Notification.warning("\u062A\u0646\u0628\u064A\u0647: \u0644\u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0632\u0631 \u0627\u0644\u0625\u063A\u0644\u0627\u0642 (\xD7) \u0623\u0648 \u0632\u0631 \u0625\u0644\u063A\u0627\u0621 \u0623\u0633\u0641\u0644 \u0627\u0644\u0646\u0645\u0648\u0630\u062C."):alert("\u062A\u0646\u0628\u064A\u0647: \u0644\u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0632\u0631 \u0627\u0644\u0625\u063A\u0644\u0627\u0642 (\xD7) \u0623\u0648 \u0632\u0631 \u0625\u0644\u063A\u0627\u0621 \u0623\u0633\u0641\u0644 \u0627\u0644\u0646\u0645\u0648\u0630\u062C."))}),u=x=>{(x.key==="Escape"||x.keyCode===27)&&(x.preventDefault(),x.stopPropagation(),y(x))},document.addEventListener("keydown",u);const h=()=>{const x=f.querySelector("#contractor-training-from-time"),E=f.querySelector("#contractor-training-to-time"),M=f.querySelector("#contractor-training-duration"),N=f.querySelector("#contractor-training-trainees"),S=f.querySelector("#contractor-training-hours");if(!x||!E||!M||!N||!S)return;const I=x.value,_=E.value;if(!I||!_){M.value="",S.value="";return}const U=I.split(":"),H=_.split(":"),O=parseInt(U[0],10)*60+parseInt(U[1],10);let R=parseInt(H[0],10)*60+parseInt(H[1],10)-O;R<0&&(R=1440+R),M.value=R>0?R:"";const P=parseInt(N.value||"0",10);if(Number.isFinite(P)&&P>0&&R>0){const q=Number((P*R/60).toFixed(2));S.value=q>0?q.toFixed(2):""}else S.value=""},L=f.querySelector("#contractor-training-from-time"),w=f.querySelector("#contractor-training-to-time"),$=f.querySelector("#contractor-training-trainees");L&&(L.addEventListener("change",h),L.addEventListener("input",h)),w&&(w.addEventListener("change",h),w.addEventListener("input",h)),$&&($.addEventListener("change",h),$.addEventListener("input",h)),setTimeout(h,100);const C=f.querySelector("#contractor-training-form-body"),F=f.querySelector("#contractor-training-scroll-indicator");if(C&&F){const x=()=>{const E=C.scrollHeight>C.clientHeight,M=C.scrollTop<C.scrollHeight-C.clientHeight-20;F.style.display=E&&M?"block":"none"};setTimeout(x,200),C.addEventListener("scroll",x),window.addEventListener("resize",x)}const T=f.querySelector("#contractor-training-location"),k=f.querySelector("#contractor-training-sub-location");if(T&&k){const x=()=>{const E=T.value;if(!E){k.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0643\u0627\u0646 \u0627\u0644\u0641\u0631\u0639\u064A</option>';return}const M=this.getPlaceOptions(E),N=k.value||(n?.subLocationId?String(n.subLocationId):"");k.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0643\u0627\u0646 \u0627\u0644\u0641\u0631\u0639\u064A</option>',M.forEach(S=>{const I=document.createElement("option");I.value=S.id,I.textContent=S.name,(S.id===N||S.id===String(N)||n?.subLocationId&&(S.id===n.subLocationId||S.id===String(n.subLocationId)))&&(I.selected=!0),k.appendChild(I)})};T.addEventListener("change",x),n?.locationId||T.value?requestAnimationFrame(()=>{x()}):T.value&&requestAnimationFrame(()=>{x()})}f.querySelector("#contractor-training-form")?.addEventListener("submit",async x=>{x.preventDefault();const E=f.querySelector('button[type="submit"]');if(E&&E.disabled)return;let M="";E&&(M=E.innerHTML,E.disabled=!0,E.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');try{const N=f.querySelector("#contractor-training-date")?.value,S=f.querySelector("#contractor-training-topic")?.value.trim(),I=f.querySelector("#contractor-training-trainer")?.value.trim(),_=f.querySelector("#contractor-training-contractor")?.value,U=parseInt(f.querySelector("#contractor-training-trainees")?.value||"0",10),H=f.querySelector("#contractor-training-from-time")?.value||"",O=f.querySelector("#contractor-training-to-time")?.value||"",G=parseInt(f.querySelector("#contractor-training-duration")?.value||"0",10),R=f.querySelector("#contractor-training-hours"),P=R?parseFloat(R.value||"0"):0,q=f.querySelector("#contractor-training-location")?.value.trim(),K=f.querySelector("#contractor-training-sub-location")?.value.trim(),J=this.getSiteOptions().find(B=>B.id===q||String(B.id)===String(q)),tt=this.getPlaceOptions(q).find(B=>B.id===K||String(B.id)===String(K)),et=f.querySelector("#contractor-training-location"),at=f.querySelector("#contractor-training-sub-location"),rt=J?J.name:et?.options[et.selectedIndex]?.text||"",ot=tt?tt.name:at?.options[at.selectedIndex]?.text||"",lt=f.querySelector("#contractor-training-notes")?.value.trim(),W=String(_??"").trim();if(!N||!S||!I||!W||!Number.isFinite(U)||U<=0||!H||!O){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u0643\u0645\u0627\u0644 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0625\u0644\u0632\u0627\u0645\u064A\u0629 \u0644\u0644\u062A\u062F\u0631\u064A\u0628"),E&&(E.disabled=!1,E.innerHTML=M);return}const it=f.querySelector("#contractor-training-contractor"),V=it?.options[it?.selectedIndex];let z="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";if(V&&V.textContent?z=V.textContent.trim():z=a.get(W)||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",!z||z==="\u0628\u062F\u0648\u0646 \u0627\u0633\u0645"||z==="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"){const B=e.find(j=>String(j.id||"").trim()===W);B&&B.name?z=B.name.trim():z=a.get(W)||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}let Q=new Date().toISOString();if(N){const B=N.split("-");if(B.length===3){const j=parseInt(B[0],10),ct=parseInt(B[1],10)-1,dt=parseInt(B[2],10),nt=new Date(j,ct,dt,12,0,0);isNaN(nt.getTime())||(Q=nt.toISOString())}else{const j=new Date(N);isNaN(j.getTime())||(Q=j.toISOString())}}const X={id:n?.id||Utils.generateSequentialId("CTR",AppState.appData?.contractorTrainings||[]),date:Q,topic:S,trainer:I,contractorId:W,contractorName:z,traineesCount:U,startTime:this.cleanTime(H)||H,endTime:this.cleanTime(O)||O,durationMinutes:Number.isFinite(G)&&G>0?G:"",totalHours:P>0?P:"",location:rt,locationId:q?String(q).trim():null,subLocation:ot,subLocationId:K?String(K).trim():null,notes:lt,createdAt:n?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString()},Z=AppState.appData.contractorTrainings;if(n){const B=Z.findIndex(j=>j.id===n.id);B!==-1&&(Z[B]=X)}else Z.push(X);this._contractorTrainingsLocalSaveTime=Date.now(),y(),Notification.success(n?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u062A\u062F\u0631\u064A\u0628 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u062A\u062F\u0631\u064A\u0628 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u0628\u0646\u062C\u0627\u062D"),setTimeout(()=>{try{typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save()}catch(B){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B:",B)}this.refreshContractorTrainingList().catch(B=>{Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0642\u0627\u0626\u0645\u0629:",B)}),(async()=>{try{AppState.googleConfig?.appsScript?.enabled&&typeof GoogleIntegration<"u"?n?await GoogleIntegration.sendRequest({action:"updateContractorTraining",data:{trainingId:X.id,updateData:X}}):await GoogleIntegration.sendRequest({action:"addContractorTraining",data:X}):typeof GoogleIntegration<"u"&&GoogleIntegration.autoSave&&await GoogleIntegration.autoSave("ContractorTrainings",AppState.appData.contractorTrainings)}catch(B){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 Google Sheets (\u0633\u064A\u062A\u0645 \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0644\u0627\u062D\u0642\u0627\u064B):",B)}})()},0)}catch(N){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u062A\u062F\u0631\u064A\u0628 \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646:",N),Notification.error("\u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u062A\u062F\u0631\u064A\u0628 \u0627\u0644\u0645\u0642\u0627\u0648\u0644: "+N.message),E&&(E.disabled=!1,E.innerHTML=M)}})},viewContractorTraining(t){this.ensureData();const a=(AppState.appData.contractorTrainings||[]).find(c=>c.id===t);if(!a){Notification.error("\u0627\u0644\u0633\u062C\u0644 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const i=new Map((this.getContractorOptions()||[]).map(c=>[String(c?.id??"").trim(),c.name||""])),n=String(a.contractorId||"").trim(),s=String(a.contractorName||"").replace(/\s+/g," ").trim(),o=s&&!["\u063A\u064A\u0631 \u0645\u062D\u062F\u062F","\u0628\u062F\u0648\u0646 \u0627\u0633\u0645","\u2014","-"].includes(s)?s:i.get(n)||s||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",l=document.createElement("div");l.className="modal-overlay",l.innerHTML=`
        ...
        `,document.body.appendChild(n);const s=()=>n.remove();n.querySelector(".modal-close")?.addEventListener("click",s),n.querySelector('[data-action="close"]')?.addEventListener("click",s),n.addEventListener("click",p=>{p.target===n&&s()});const r=n.querySelectorAll('input[name="date-range-type"]'),o=n.querySelector("#contractor-report-month"),l=n.querySelector("#contractor-report-from-date"),d=n.querySelector("#contractor-report-to-date"),c=()=>{const p=n.querySelector('input[name="date-range-type"]:checked')?.value||"all";p==="month"?(o.disabled=!1,o.required=!0,l.disabled=!0,l.required=!1,d.disabled=!0,d.required=!1):p==="custom"?(o.disabled=!0,o.required=!1,l.disabled=!1,l.required=!0,d.disabled=!1,d.required=!0):(o.disabled=!0,o.required=!1,l.disabled=!0,l.required=!1,d.disabled=!0,d.required=!1)};r.forEach(p=>{p.addEventListener("change",c)}),n.querySelector("#generate-contractor-report-btn")?.addEventListener("click",async()=>{const p=n.querySelector("#contractor-report-select"),g=p?.value?String(p.value).trim():"",f=g?String(p?.options?.[p.selectedIndex]?.textContent||"").replace(/\s+/g," ").trim():"",m=n.querySelector('input[name="date-range-type"]:checked')?.value||"all",u=n.querySelector("#contractor-report-month")?.value||"",y=n.querySelector("#contractor-report-from-date")?.value||"",v=n.querySelector("#contractor-report-to-date")?.value||"";if(m==="month"&&!u){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0634\u0647\u0631 \u0627\u0644\u0645\u0637\u0644\u0648\u0628");return}if(m==="custom"){if(!y||!v){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0628\u062F\u0627\u064A\u0629 \u0648\u0627\u0644\u0646\u0647\u0627\u064A\u0629 \u0644\u0644\u0641\u062A\u0631\u0629");return}if(new Date(y)>new Date(v)){Notification.warning("\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0628\u062F\u0627\u064A\u0629 \u064A\u062C\u0628 \u0623\u0646 \u064A\u0643\u0648\u0646 \u0642\u0628\u0644 \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0646\u0647\u0627\u064A\u0629");return}}if(g){const b=p?.options[p?.selectedIndex];if(!b||!b.value){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0645\u0642\u0627\u0648\u0644 \u0635\u062D\u064A\u062D \u0645\u0646 \u0627\u0644\u0642\u0627\u0626\u0645\u0629");return}}s(),await this.generateContractorTrainingReport(g,{dateRangeType:m,month:u,fromDate:y,toDate:v},f)})},_buildTrainingAnalysisExportMonthOptionsHtml(){const t=new Date,e=t.getFullYear(),a=[];for(let i=0;i<24;i++){const n=new Date(e,t.getMonth()-i,1),s=n.getFullYear(),r=n.getMonth()+1,o=`${s}-${String(r).padStart(2,"0")}`,l=n.toLocaleDateString("ar-SA",{year:"numeric",month:"long"});a.push(`<option value="${Utils.escapeHTML(o)}">${Utils.escapeHTML(l)}</option>`)}return a.join("")},_readDateFilterFromTrainingExportModal(t){const e=t.querySelector('input[name="ta-modal-date-range"]:checked')?.value||"all";if(e==="all")return{type:"all",month:"",start:"",end:""};if(e==="month")return{type:"month",month:t.querySelector("#ta-modal-month")?.value?.trim()||"",start:"",end:""};const a=t.querySelector("#ta-modal-from-date")?.value?.trim()||"",i=t.querySelector("#ta-modal-to-date")?.value?.trim()||"";return{type:"range",month:"",start:a,end:i}},_refreshAnalysisExportModalLists(t,e){this.ensureData();const a=this._readDateFilterFromTrainingExportModal(t);if(e==="trainers"){const i=t.querySelector("#ta-modal-trainer-select");if(!i)return;const n=i.value;let s=Array.isArray(AppState.appData.training)?AppState.appData.training:[];s=this.filterRecordsByAnalysisDate(s,a,"training");const r=new Set;s.forEach(l=>r.add(this.getTrainingAnalysisValue("training","trainer",l)));const o=Array.from(r).filter(l=>l&&l!=="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").sort((l,d)=>String(l).localeCompare(String(d),"ar"));i.innerHTML='<option value="">\u2014 \u0643\u0644 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646 \u2014</option>'+o.map(l=>`<option value="${Utils.escapeHTML(l)}">${Utils.escapeHTML(l)}</option>`).join(""),n&&o.includes(n)&&(i.value=n)}else{const i=t.querySelector("#ta-modal-department-select"),n=t.querySelector("#ta-modal-person-select");if(!n)return;const s=n.value,r=t.querySelector("#ta-modal-audience")?.value||"all";let o=Array.isArray(AppState.appData.trainingAttendance)?AppState.appData.trainingAttendance:[];if(o=this.filterRecordsByAnalysisDate(o,a,"trainingAttendance"),r==="employee"?o=o.filter(c=>!this._isAttendanceContractorLike(c)):r==="contractor"&&(o=o.filter(c=>this._isAttendanceContractorLike(c))),i){const c=i.value,p=Array.from(new Set(o.map(f=>this._attendanceRecordDepartmentLabel(f)))).sort((f,m)=>String(f).localeCompare(String(m),"ar",{sensitivity:"base"}));i.innerHTML='<option value="">\u2014 \u0643\u0644 \u0627\u0644\u0625\u062F\u0627\u0631\u0627\u062A \u2014</option>'+p.map(f=>`<option value="${Utils.escapeHTML(f)}">${Utils.escapeHTML(f)}</option>`).join(""),c&&p.includes(c)&&(i.value=c);const g=i.value||"";g&&(o=o.filter(f=>this._attendanceRecordDepartmentLabel(f)===g))}const l=new Map;o.forEach(c=>{const p=this._attendancePersonRowKey(c);if(l.has(p))return;const g=String(c.employeeCode||c.code||c.employeeNumber||"").trim(),f=String(c.employeeName||c.name||"").trim(),m=f?g?`${f} (${g})`:f:g||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";l.set(p,m)});const d=Array.from(l.entries()).sort((c,p)=>String(c[1]).localeCompare(String(p[1]),"ar"));n.innerHTML='<option value="">\u2014 \u0643\u0644 \u0627\u0644\u0623\u0634\u062E\u0627\u0635 \u2014</option>'+d.map(([c,p])=>`<option value="${Utils.escapeHTML(c)}">${Utils.escapeHTML(p)}</option>`).join(""),s&&l.has(s)&&(n.value=s)}},showTrainingAnalysisExportDialog(t){if(typeof this.isCurrentUserAdmin=="function"&&!this.isCurrentUserAdmin()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 \u062A\u0642\u0627\u0631\u064A\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644");return}this.ensureData();const e=t==="trainers",a=e?"\u062A\u0635\u062F\u064A\u0631 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u062F\u0631\u0628\u064A\u0646 \u2014 \u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u062A\u062F\u0631\u064A\u0628":"\u062A\u0635\u062F\u064A\u0631 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u062A\u062F\u0631\u0628\u064A\u0646 \u2014 \u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u062A\u062F\u0631\u064A\u0628",i=this._buildTrainingAnalysisExportMonthOptionsHtml(),n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
            <div class="modal-content" style="max-width: 720px;">
                ...
                <tr style="${k%2===0?"background-color: #FFFFFF;":"background-color: #F9FAFB;"}">
                    ...
                    <td style="padding: 10px 8px; border: 1px solid #E5E7EB; text-align: center; font-size: 11px;">${S}</td>
            ...
            `}).join("");let D="";if(p==="month"&&g){const[T,k]=g.split("-");D=` - ${new Date(parseInt(T,10),parseInt(k,10)-1,1).toLocaleDateString("ar-SA",{year:"numeric",month:"long"})}`}else if(p==="custom"&&f&&m){const T=new Date(f),k=new Date(m),x=T.toLocaleDateString("ar-SA",{year:"numeric",month:"long",day:"numeric"}),E=k.toLocaleDateString("ar-SA",{year:"numeric",month:"long",day:"numeric"});D=` - \u0645\u0646 ${x} \u0625\u0644\u0649 ${E}`}const A=l?`\u062A\u0642\u0631\u064A\u0631 \u062A\u062F\u0631\u064A\u0628\u0627\u062A \u0627\u0644\u0645\u0642\u0627\u0648\u0644: ${Utils.escapeHTML(l)}${D}`:`\u062A\u0642\u0631\u064A\u0631 \u062A\u062F\u0631\u064A\u0628\u0627\u062A \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646${D}`,h=`
                        ...
                        <div class="mt-4">
                            ...
                            <div class="bg-gray-50 rounded-lg p-3 max-h-60 overflow-y-auto">
                                <table class="w-full text-sm">
                                    ...
                                    <tbody>
                                        ${u.map((b,D)=>{const A=b.type==="contractor"||b.personType==="contractor";return`
...
- \u062A\u0645 \u062A\u062E\u0637\u064A: ${n} \u0635\u0641 \u0628\u0633\u0628\u0628 \u0623\u062E\u0637\u0627\u0621`:"");Notification.success(l),n>0&&n>t.length*.5&&Notification.warning("\u062A\u0645 \u062A\u062E\u0637\u064A \u0623\u0643\u062B\u0631 \u0645\u0646 50% \u0645\u0646 \u0627\u0644\u0635\u0641\u0648\u0641. \u064A\u0631\u062C\u0649 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0635\u062D\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A \u0645\u0644\u0641 Excel.")}catch(a){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",a),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+(a.message||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641")),e&&e.parentNode&&e.remove()}},showAnalysisDataModal(){if(!this.isCurrentUserAdmin()){Notification.warning("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062A\u062D\u0644\u064A\u0644");return}this.ensureData();const t=AppState.appData.trainingAttendance||[],e=AppState.appData.trainingAnalysisData||{notes:"",goals:"",recommendations:"",targets:{},customMetrics:{}},a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
        ...
        `,document.body.appendChild(o),o.addEventListener("click",g=>{g.target===o&&o.remove()});const l=o.querySelector("#edit-attendance-start-time"),d=o.querySelector("#edit-attendance-end-time"),c=o.querySelector("#edit-attendance-hours"),p=()=>{if(l.value&&d.value){const g=this.calculateTrainingHours(l.value,d.value);g&&parseFloat(g)>0&&(c.value=g)}};l?.addEventListener("change",p),d?.addEventListener("change",p),o.querySelector("#save-edit-attendance-btn")?.addEventListener("click",async()=>{try{const g=o.querySelector("#edit-attendance-date")?.value,f=o.querySelector("#edit-attendance-code")?.value.trim(),m=o.querySelector("#edit-attendance-name")?.value.trim(),u=o.querySelector("#edit-attendance-topic")?.value.trim();if(!g||!f||!m||!u){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629");return}Loading.show("\u062C\u0627\u0631\u064A \u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644\u0627\u062A...");const y=e.findIndex(v=>v.id===t);y>=0?(e[y]={...e[y],date:new Date(g).toISOString(),trainingType:o.querySelector("#edit-attendance-type")?.value||"\u062F\u0627\u062E\u0644\u064A",factory:o.querySelector("#edit-attendance-factory")?.value.trim()||"",factoryName:o.querySelector("#edit-attendance-factory")?.value.trim()||"",employeeCode:f,employeeName:m,position:o.querySelector("#edit-attendance-position")?.value.trim()||"",department:o.querySelector("#edit-attendance-department")?.value.trim()||"",topic:u,trainer:o.querySelector("#edit-attendance-trainer")?.value.trim()||"",startTime:this.cleanTime(o.querySelector("#edit-attendance-start-time")?.value||""),endTime:this.cleanTime(o.querySelector("#edit-attendance-end-time")?.value||""),totalHours:o.querySelector("#edit-attendance-hours")?.value||this.calculateTrainingHours(o.querySelector("#edit-attendance-start-time")?.value,o.querySelector("#edit-attendance-end-time")?.value),updatedAt:new Date().toISOString()},typeof window.DataManager<"u"&&window.DataManager.save&&await window.DataManager.save(),typeof GoogleIntegration<"u"&&GoogleIntegration.autoSave&&await GoogleIntegration.autoSave("TrainingAttendance",e).catch(v=>{Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644\u0627\u062A \u0641\u064A Google Sheets:",v),Notification.error("\u0641\u0634\u0644 \u062D\u0641\u0638 \u062A\u0639\u062F\u064A\u0644\u0627\u062A \u0633\u062C\u0644 \u0627\u0644\u062A\u062F\u0631\u064A\u0628 \u0641\u064A Google Sheets. \u0633\u064A\u062A\u0645 \u0627\u0644\u0627\u062D\u062A\u0641\u0627\u0638 \u0628\u0627\u0644\u062A\u063A\u064A\u064A\u0631\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u0642\u0637 \u062D\u062A\u0649 \u064A\u062A\u0645 \u0627\u0644\u062D\u0641\u0638 \u0628\u0646\u062C\u0627\u062D.")}),Loading.hide(),o.remove(),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0633\u062C\u0644 \u0628\u0646\u062C\u0627\u062D"),this.loadAttendanceRegistry()):(Loading.hide(),Notification.error("\u0627\u0644\u0633\u062C\u0644 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"))}catch(g){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0633\u062C\u0644:",g),Notification.error("\u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0633\u062C\u0644: "+(g.message||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641"))}})},async deleteAttendanceRecord(t){if(!this.isCurrentUserAdminOrManager()){Notification.error("\u0635\u0644\u0627\u062D\u064A\u0629 \u0627\u0644\u062D\u0630\u0641 \u063A\u064A\u0631 \u0645\u062A\u0627\u062D\u0629 \u0644\u0644\u0645\u0633\u062A\u062E\u062F\u0645. \u0627\u0644\u062D\u0630\u0641 \u064A\u062A\u0645 \u0628\u0637\u0644\u0628 \u0644\u0644\u0645\u062F\u064A\u0631 \u0641\u0642\u0637.");return}if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0633\u062C\u0644\u061F"))try{Loading.show("\u062C\u0627\u0631\u064A \u062D\u0630\u0641 \u0627\u0644\u0633\u062C\u0644..."),this.ensureData();const e=AppState.appData.trainingAttendance||[],a=e.findIndex(i=>i.id===t);a>=0?(e.splice(a,1),typeof window.DataManager<"u"&&window.DataManager.save&&await window.DataManager.save(),typeof GoogleIntegration<"u"&&GoogleIntegration.autoSave&&await GoogleIntegration.autoSave("TrainingAttendance",e).catch(i=>{Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644\u0627\u062A \u0641\u064A Google Sheets:",i),Notification.error("\u0641\u0634\u0644 \u062D\u0641\u0638 \u062A\u0639\u062F\u064A\u0644\u0627\u062A \u0633\u062C\u0644 \u0627\u0644\u062A\u062F\u0631\u064A\u0628 \u0641\u064A Google Sheets. \u0633\u064A\u062A\u0645 \u0627\u0644\u0627\u062D\u062A\u0641\u0627\u0638 \u0628\u0627\u0644\u062A\u063A\u064A\u064A\u0631\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u0642\u0637 \u062D\u062A\u0649 \u064A\u062A\u0645 \u0627\u0644\u062D\u0641\u0638 \u0628\u0646\u062C\u0627\u062D.")}),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0633\u062C\u0644 \u0628\u0646\u062C\u0627\u062D"),this.loadAttendanceRegistry()):(Loading.hide(),Notification.error("\u0627\u0644\u0633\u062C\u0644 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"))}catch(e){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0633\u062C\u0644:",e),Notification.error("\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0633\u062C\u0644: "+(e.message||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641"))}},async updateTrainingAnalyticsDashboard(){const t=document.getElementById("train-analytics-root");if(!t)return;try{this.ensureData()}catch{}const e=parseInt(this._trainPeriod||"0",10),a=S=>({...S,_locationDisplay:S.locationName||(S.location&&S.factory&&this.getPlaceName?this.getPlaceName(S.location,S.factory):S.location)||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",_factoryDisplay:S.factoryName||S.factory||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",_trainer:S.trainer||S.conductedBy||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}),i=(AppState.appData?.training||[]).concat(AppState.appData?.contractorTrainings||[]).concat((AppState.appData?.legalTrainings||[]).map(S=>({...S,trainingType:S.category||"\u062A\u062F\u0631\u064A\u0628 \u0642\u0627\u0646\u0648\u0646\u064A",name:S.title,topic:S.title,date:S.actualDate||S.scheduledDate,startDate:S.scheduledDate,totalHours:Number(S.duration)||0,_isLegalTraining:!0}))).map(a),n=this._tFilterByPeriod(i,e);this._tPopulateFilters(n);const s=this._tApplyFilters(n),r=s.length,o=document.getElementById("train-filter-count");o&&(o.textContent=`${r} \u0628\u0631\u0646\u0627\u0645\u062C`);const l=s.filter(S=>S.status==="\u0645\u0643\u062A\u0645\u0644").length,d=s.filter(S=>S.status==="\u0645\u062E\u0637\u0637"||S.status==="\u0642\u0627\u062F\u0645").length,c=s.reduce((S,I)=>S+(this.getParticipantsCount?this.getParticipantsCount(I):Number(I.participantsCount)||0),0),p=s.reduce((S,I)=>S+(Number(I.totalHours)||0),0),g=(AppState.appData?.contractorTrainings||[]).filter(S=>this._tFilterByPeriod([S],e).length&&this._tApplyFilters([S]).length).length,f=s.filter(S=>S._isLegalTraining).length,m=s.filter(S=>S._isLegalTraining&&S.complianceStatus==="\u0645\u0645\u062A\u062B\u0644").length,u=f>0?Math.round(m/f*100):0,y=r-g-f,v=r>0?Math.round(c/r):0,b=r>0?Math.round(l/r*100):0,D=s.filter(S=>{const I=new Date(S.date||S.startDate||""),_=new Date;return!isNaN(I)&&I.getFullYear()===_.getFullYear()&&I.getMonth()===_.getMonth()}).length,A=document.getElementById("train-kpi-strip");if(A){const S=[{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0628\u0631\u0627\u0645\u062C",value:r,icon:"fas fa-graduation-cap",color:"#4f46e5",bg:"#eef2ff",border:"#c7d2fe"},{label:"\u0645\u0643\u062A\u0645\u0644\u0629",value:l,icon:"fas fa-check-circle",color:"#10b981",bg:"#ecfdf5",border:"#a7f3d0"},{label:"\u0645\u062E\u0637\u0637\u0629/\u0642\u0627\u062F\u0645\u0629",value:d,icon:"fas fa-calendar-alt",color:"#f59e0b",bg:"#fffbeb",border:"#fde68a"},{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0645\u062A\u062F\u0631\u0628\u064A\u0646",value:c.toLocaleString("en-US"),icon:"fas fa-users",color:"#6366f1",bg:"#eef2ff",border:"#c7d2fe"},{label:"\u0628\u0631\u0627\u0645\u062C \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646",value:y,icon:"fas fa-user-tie",color:"#0ea5e9",bg:"#f0f9ff",border:"#bae6fd"},{label:"\u0628\u0631\u0627\u0645\u062C \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646",value:g,icon:"fas fa-users-cog",color:"#f97316",bg:"#fff7ed",border:"#fed7aa"},{label:"\u0645\u062A\u0648\u0633\u0637 \u0645\u0634\u0627\u0631\u0643\u064A\u0646/\u0628\u0631\u0646\u0627\u0645\u062C",value:v,icon:"fas fa-chart-line",color:"#8b5cf6",bg:"#f5f3ff",border:"#ddd6fe"},{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u062A\u062F\u0631\u064A\u0628",value:p.toLocaleString("en-US"),icon:"fas fa-clock",color:"#14b8a6",bg:"#f0fdfa",border:"#99f6e4"},{label:"\u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631",value:D,icon:"fas fa-calendar-day",color:"#db2777",bg:"#fdf2f8",border:"#fbcfe8"},{label:"\u062A\u062F\u0631\u064A\u0628\u0627\u062A \u0642\u0627\u0646\u0648\u0646\u064A\u0629",value:f,icon:"fas fa-gavel",color:"#dc2626",bg:"#fef2f2",border:"#fecaca"},{label:"\u0646\u0633\u0628\u0629 \u0627\u0644\u0627\u0645\u062A\u062B\u0627\u0644 \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A",value:u+"%",icon:"fas fa-balance-scale",color:"#059669",bg:"#ecfdf5",border:"#a7f3d0"}];A.innerHTML=S.map(I=>`
                ...
                </div>`).join("")}if(!await this._tEnsureChartJS()||typeof Chart>"u"){t.insertAdjacentHTML("afterbegin",'<div style="background:#fffbeb;border:1px solid #fde68a;border-radius:10px;padding:14px 18px;margin-bottom:16px;"><i class="fas fa-exclamation-triangle" style="color:#d97706;"></i> <span style="font-size:0.85rem;color:#92400e;">\u062A\u0639\u0630\u0651\u0631 \u062A\u062D\u0645\u064A\u0644 \u0645\u0643\u062A\u0628\u0629 \u0627\u0644\u0631\u0633\u0648\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u064A\u0629.</span></div>');return}const L={\u0645\u0643\u062A\u0645\u0644:"rgba(16,185,129,0.85)",\u0645\u062E\u0637\u0637:"rgba(245,158,11,0.85)",\u062C\u0627\u0631\u064D:"rgba(59,130,246,0.85)",\u0642\u0627\u062F\u0645:"rgba(139,92,246,0.85)",\u0645\u0644\u063A\u064A:"rgba(239,68,68,0.85)"},w=this._tGroupBy(s,"status");this._tDrawDoughnut("train-chart-status",w.labels,w.data,w.labels.map(S=>L[S]||"rgba(148,163,184,0.8)"));const $=this._tGroupBy(s,"trainingType",10);this._tDrawDoughnut("train-chart-type",$.labels,$.data,this._tChartColors($.labels.length)),this._tDrawTrend("train-chart-trend",s);const C=this._tGroupBy(s,"_trainer",10);this._tDrawHBar("train-chart-trainer",C.labels,C.data,"rgba(245,158,11,0.75)");const F=this._tGroupBy(s,"topic",10);this._tDrawHBar("train-chart-topic",F.labels,F.data,"rgba(16,185,129,0.75)");const T=this._tGroupBy(s,"_factoryDisplay",8);this._tDrawHBar("train-chart-factory",T.labels,T.data,"rgba(99,102,241,0.75)");const k=this._tGroupBy(s,"_locationDisplay",8);this._tDrawHBar("train-chart-location",k.labels,k.data,"rgba(59,130,246,0.75)"),this._tDrawParticipants("train-chart-participants",s);const x=s.filter(S=>S._isLegalTraining);if(x.length>0){const S=this._tGroupBy(x,"complianceStatus"),I=S.labels.map(H=>H==="\u0645\u0645\u062A\u062B\u0644"?"rgba(5,150,105,0.85)":H==="\u063A\u064A\u0631 \u0645\u0645\u062A\u062B\u0644"?"rgba(220,38,38,0.85)":H==="\u0642\u0627\u0631\u0628 \u0639\u0644\u0649 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621"?"rgba(245,158,11,0.85)":H==="\u0645\u062E\u0637\u0637"?"rgba(59,130,246,0.85)":"rgba(148,163,184,0.8)");this._tDrawDoughnut("train-chart-legal-compliance",S.labels,S.data,I);const _=this._tGroupBy(x,"category",10);this._tDrawHBar("train-chart-legal-categories",_.labels,_.data,"rgba(220,38,38,0.7)");const U=document.getElementById("train-chart-legal-compliance-empty");U&&(U.style.display="none")}else{const S=document.getElementById("train-chart-legal-compliance-empty");S&&(S.style.display="flex");const I=document.getElementById("train-chart-legal-categories");I&&I.parentElement&&(I.parentElement.innerHTML='<div style="display:flex;align-items:center;justify-content:center;height:100%;color:#94a3b8;font-size:0.85rem;">\u0644\u0627 \u062A\u0648\u062C\u062F \u062A\u062F\u0631\u064A\u0628\u0627\u062A \u0642\u0627\u0646\u0648\u0646\u064A\u0629</div>')}const E=s.slice().sort((S,I)=>{const _=this.getParticipantsCount?this.getParticipantsCount(I):Number(I.participantsCount)||0,U=this.getParticipantsCount?this.getParticipantsCount(S):Number(S.participantsCount)||0;return _-U}).slice(0,20),M=document.getElementById("train-top-count"),N=document.getElementById("train-top-tbody");if(M&&(M.textContent=`${E.length} \u0628\u0631\u0646\u0627\u0645\u062C`),N)if(!E.length)N.innerHTML='<tr><td colspan="8" style="padding:24px;text-align:center;color:#10b981;"><i class="fas fa-info-circle ml-2"></i>\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</td></tr>';else{const S={\u0645\u0643\u062A\u0645\u0644:"background:#ecfdf5;color:#065f46;",\u0645\u062E\u0637\u0637:"background:#fffbeb;color:#92400e;",\u062C\u0627\u0631\u064D:"background:#eff6ff;color:#1e40af;","\u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630":"background:#eff6ff;color:#1e40af;",\u0645\u0644\u063A\u064A:"background:#fef2f2;color:#991b1b;"};N.innerHTML=E.map((I,_)=>{const U=this.getParticipantsCount?this.getParticipantsCount(I):Number(I.participantsCount)||0,H=Number(I.totalHours||I.hours||0),O=Utils.escapeHTML(I._trainer||I.trainer||I.conductedBy||"\u2014"),G=Utils.escapeHTML(I._factoryDisplay||I.factoryName||I.factory||"\u2014"),R=Utils.escapeHTML(I._locationDisplay||I.locationName||I.location||"\u2014"),P=Utils.escapeHTML(I.topic||I.name||I.subject||"\u2014"),q=_%2===0?"#fff":"#fafafa",K=S[I.status]||"background:#f1f5f9;color:#374151;",Y=I.date||I.startDate||"",J=Y?(()=>{try{return new Date(Y).toLocaleDateString("ar-SA",{year:"numeric",month:"short",day:"numeric"})}catch{return Y.slice(0,10)}})():"\u2014";return`<tr style="border-bottom:1px solid #f8fafc;background:${q};" onmouseover="this.style.background='#f0f9ff'" onmouseout="this.style.background='${q}'">
