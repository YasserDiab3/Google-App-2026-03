const Users={currentView:"list",currentEditId:null,autoRefreshInterval:null,refreshInterval:15e3,sectionChangeHandler:null,_getI18nCore(){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n:window.I18n&&typeof window.I18n.t=="function"?window.I18n:null},t(e,s){const o=this._getI18nCore();return o?o.t(e,null,s||e):s||e},applyModuleI18n(e){const s=this._getI18nCore();if(!s)return;const o=e||document.getElementById("users-section")||document;typeof s.applyI18n=="function"&&s.applyI18n(o),typeof s.applyLiteralTranslations=="function"&&s.applyLiteralTranslations(o)},generateRandomPassword(e=10){const s="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnpqrstuvwxyz23456789!@#$%&*";let o="";if(window.crypto&&window.crypto.getRandomValues){const a=new Uint32Array(e);window.crypto.getRandomValues(a);for(let i=0;i<e;i++)o+=s[a[i]%s.length]}else for(let a=0;a<e;a++)o+=s.charAt(Math.floor(Math.random()*s.length));return o},showUserCredentialsModal(e){if(!e||!e.email)return;const s=document.getElementById("user-credentials-modal-overlay");s&&s.remove();const a={admin:"\u{1F534} \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645 (Admin)",safety_officer:"\u{1F535} \u0645\u0633\u0626\u0648\u0644 \u0627\u0644\u0633\u0644\u0627\u0645\u0629 (Safety Officer)",user:"\u{1F7E2} \u0645\u0633\u062A\u062E\u062F\u0645 \u0639\u0627\u062F\u064A (Regular User)",read_only:"\u{1F7E3} \u0642\u0631\u0627\u0621\u0629 \u0641\u0642\u0637 (Read Only)"}[e.role]||e.role||"\u0645\u0633\u062A\u062E\u062F\u0645",i=window.location.origin+window.location.pathname,t=`\u0645\u0631\u062D\u0628\u0627\u064B ${e.name||"\u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645"}\u060C
...
\u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u062D\u062A\u0641\u0627\u0638 \u0628\u0647\u0630\u0647 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u062A\u063A\u064A\u064A\u0631 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631 \u0639\u0646\u062F \u0623\u0648\u0644 \u062A\u0633\u062C\u064A\u0644 \u062F\u062E\u0648\u0644.`,n=encodeURIComponent(`\u0628\u064A\u0627\u0646\u0627\u062A \u062D\u0633\u0627\u0628\u0643 \u0641\u064A \u0646\u0638\u0627\u0645 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0648\u0627\u0644\u0635\u062D\u0629 \u0627\u0644\u0645\u0647\u0646\u064A\u0629 - ${e.name||""}`),d=encodeURIComponent(t),r=`mailto:${encodeURIComponent(e.email)}?subject=${n}&body=${d}`,l=document.createElement("div");l.id="user-credentials-modal-overlay",l.className="modal-overlay animate-fade-in",l.style.zIndex="9999",l.style.backdropFilter="blur(8px)",l.innerHTML=`
            ...
            <form id="user-form" class="space-y-6">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 16px;">
                        ...
                        <div style="grid-column: 1 / -1;">
                            <label for="user-password" style="display: block; font-size: 13px; font-weight: 700; color: #334155; margin-bottom: 6px;">
                                <i class="fas fa-key ml-1 text-amber-500"></i> \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631 ${s?'<span style="color: #64748b; font-weight: normal;">(\u0627\u062A\u0631\u0643\u0647 \u0641\u0627\u0631\u063A\u0627\u064B \u0644\u0644\u0625\u0628\u0642\u0627\u0621 \u0639\u0644\u0649 \u0643\u0644\u0645\u0629 \u0627\u0644\u0633\u0631 \u0627\u0644\u062D\u0627\u0644\u064A\u0629)</span>':'<span style="color: #ef4444;">*</span>'}
                            </label>
                ...
                <div style="background: #ffffff; border: 1px solid #cbd5e1; border-radius: 14px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 12px;" id="modules-permissions-container">
                        ${MODULE_PERMISSIONS_CONFIG.map(o=>{const a=e?.permissions&&e.permissions[o.key]===!0,t=(document.getElementById("user-role")?.value||e?.role)==="admin"||e?.role==="admin",n=o.hasDetailedPermissions&&MODULE_DETAILED_PERMISSIONS[o.key];return`
                                <div class="module-perm-card" style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 10px 12px; transition: all 0.2s; display: flex; align-items: center; justify-content: space-between; gap: 8px;">
                                    <label style="display: flex; align-items: center; gap: 8px; flex: 1; cursor: ${t?"not-allowed":"pointer"}; margin: 0;">
                                        <input 
                                            type="checkbox" 
                                            ...
                                            ${a||t?"checked":""}
                                            ${t?"disabled":""}
                                            style="width: 16px; height: 16px; accent-color: #2563eb; cursor: ${t?"not-allowed":"pointer"};"
                                        >
                ...
                <div style="display: flex; align-items: center; justify-content: flex-end; gap: 12px; padding-top: 16px; margin-top: 8px; border-top: 1px solid #e2e8f0;">
                    ...
                    <button type="submit" class="btn-primary" style="background: linear-gradient(135deg, #003865 0%, #005696 100%); color: white; border: none; border-radius: 10px; padding: 10px 24px; font-size: 13px; font-weight: 800; cursor: pointer; box-shadow: 0 4px 12px rgba(0, 56, 101, 0.2); display: flex; align-items: center; gap: 8px;">
                        ...
                        ${s?"\u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644\u0627\u062A":"\u062D\u0641\u0638 \u0648\u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645"}
                    </button>
                </div>
            </form>
        `},async loadUsersList(){const e=document.getElementById("users-table-container");if(!e)return;let s=AppState.appData.users||[];if(s.length===0&&typeof Permissions<"u"&&typeof Permissions.isCurrentUserEffectiveAdmin=="function"&&Permissions.isCurrentUserEffectiveAdmin()&&typeof GoogleIntegration<"u"&&typeof GoogleIntegration.syncUsers=="function")try{e.innerHTML=`
            ...
            <div class="table-wrapper" style="overflow-x: auto;">
                <table class="data-table">
                    ...
                    <tbody>
                        ${s.map(i=>{const t=i.isOnline===!0,n=i.lastLogin?Utils.formatDateTime(i.lastLogin):"-";return`
                            <tr>
                                <td>
...
`).filter(p=>p.trim());n={},l.forEach(p=>{const f=p.match(/^([^:]+):\s*(.+)$/);if(f){const g=f[1].trim(),h=f[2].trim();h==="true"?n[g]=!0:h==="false"?n[g]=!1:isNaN(h)?n[g]=h:n[g]=Number(h)}})}catch{n={}}}else n=e.permissions}catch{n={}}(!n||typeof n!="object"||Array.isArray(n))&&(n={});const d={};Object.keys(n).forEach(r=>{const l=n[r];r.endsWith("Permissions")&&typeof l=="object"&&!Array.isArray(l)?this.currentDetailedPermissions[r]=l:r.endsWith("Permissions")||(d[r]=l===!0)}),s=d}const o=e?{...e,permissions:s??(e.permissions&&typeof e.permissions=="object"&&!Array.isArray(e.permissions)?e.permissions:{})}:null,a=document.getElementById("user-form-modal-overlay");a&&a.remove();const i=!!e,t=document.createElement("div");t.id="user-form-modal-overlay",t.className="modal-overlay animate-fade-in",t.style.zIndex="9990",t.style.backdropFilter="blur(6px)",t.innerHTML=`
        ...
        `,document.body.appendChild(t),this.applyModuleI18n(t),this.setupEventListeners(),setTimeout(()=>{const n=t.querySelector("#generate-password-btn");n&&n.addEventListener("click",()=>{const p=t.querySelector("#user-password");if(p){const f=this.generateRandomPassword(10);p.value=f,p.type="text";const g=t.querySelector("#toggle-password-visibility-btn i");g&&(g.className="fas fa-eye-slash text-amber-600");const h=t.querySelector("#generated-pass-notice");h&&h.classList.remove("hidden"),Notification.success("\u062A\u0645 \u062A\u0648\u0644\u064A\u062F \u0643\u0644\u0645\u0629 \u0645\u0631\u0648\u0631 \u0639\u0634\u0648\u0627\u0626\u064A\u0629 \u0642\u0648\u064A\u0629")}});const d=t.querySelector("#toggle-password-visibility-btn");d&&d.addEventListener("click",()=>{const p=t.querySelector("#user-password");if(p){const f=p.type==="password";p.type=f?"text":"password";const g=d.querySelector("i");g&&(g.className=f?"fas fa-eye-slash text-amber-600":"fas fa-eye text-gray-400")}});const r=t.querySelector("#user-role");r&&r.addEventListener("change",()=>{this.updatePermissionsUI()});const l=t.querySelector("#cancel-user-btn");l&&l.addEventListener("click",()=>t.remove()),this.setupSelectAllButtons(),this.setupDetailedPermissionsButtons(),this.updatePermissionsUI()},100)},updatePermissionsUI(){const o=document.getElementById("user-role")?.value==="admin";document.querySelectorAll(".user-permission-checkbox").forEach(n=>{if(o){n.disabled=!0,n.checked=!0;const d=n.closest(".module-perm-card")||n.parentElement;d&&(d.style.opacity="0.75",d.style.cursor="not-allowed")}else{n.disabled=!1;const d=n.closest(".module-perm-card")||n.parentElement;d&&(d.style.opacity="1",d.style.cursor="pointer")}});const i=document.getElementById("admin-permissions-banner");i&&(i.style.display=o?"flex":"none");const t=document.getElementById("permissions-action-btns");t&&(t.style.display=o?"none":"flex")},setupSelectAllButtons(){const e=document.getElementById("select-all-permissions-btn"),s=document.getElementById("deselect-all-permissions-btn");e&&e.addEventListener("click",()=>{document.querySelectorAll(".user-permission-checkbox:not([disabled])").forEach(a=>{a.checked=!0}),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062F \u062C\u0645\u064A\u0639 \u0627\u0644\u0635\u0644\u0627\u062D\u064A\u0627\u062A")}),s&&s.addEventListener("click",()=>{document.querySelectorAll(".user-permission-checkbox:not([disabled])").forEach(a=>{a.checked=!1}),Notification.success("\u062A\u0645 \u0625\u0644\u063A\u0627\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u0635\u0644\u0627\u062D\u064A\u0627\u062A")})},setupDetailedPermissionsButtons(){document.querySelectorAll('[data-action="show-detailed-permissions"]').forEach(s=>{s.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const a=s.getAttribute("data-module");this.showDetailedPermissionsModal(a)})})},showDetailedPermissionsModal(e){const s=MODULE_DETAILED_PERMISSIONS[e];if(!s){Notification.error("\u0644\u0627 \u062A\u0648\u062C\u062F \u0635\u0644\u0627\u062D\u064A\u0627\u062A \u062A\u0641\u0635\u064A\u0644\u064A\u0629 \u0644\u0647\u0630\u0627 \u0627\u0644\u0645\u062F\u064A\u0648\u0644");return}const a=(this.currentDetailedPermissions||{})[`${e}Permissions`]||{},i=document.createElement("div");i.className="modal-overlay",i.innerHTML=`
            <div class="modal-content" style="max-width: 600px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="space-y-2">
                        ${s.permissions.map(r=>{const l=r.key==="observations-view-department"?a[r.key]!==!1:a[r.key]===!0;return`
...
\u0633\u064A\u062A\u0645 \u0625\u0646\u0634\u0627\u0621 \u0643\u0644\u0645\u0629 \u0645\u0631\u0648\u0631 \u0645\u0624\u0642\u062A\u0629 \u062C\u062F\u064A\u062F\u0629.`,"\u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u062A\u0639\u064A\u064A\u0646","\u0625\u0644\u063A\u0627\u0621"))try{Loading.show();const t=await Auth.resetPassword(a.email);if(Loading.hide(),t&&t.success){const n=t.tempPassword||"\u063A\u064A\u0631 \u0645\u062A\u0627\u062D",d=`
                ...
                `,document.body.appendChild(r),r.addEventListener("click",l=>{l.target===r&&r.remove()}),this.loadUsersList()}else Notification.error(t?.message||"\u0641\u0634\u0644 \u0625\u0639\u0627\u062F\u0629 \u062A\u0639\u064A\u064A\u0646 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631")}catch(t){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0639\u0627\u062F\u0629 \u062A\u0639\u064A\u064A\u0646 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631:",t)}},async deleteUser(e){if(!(typeof Permissions<"u"&&typeof Permissions.isCurrentUserAdmin=="function"?Permissions.isCurrentUserAdmin():(AppState.currentUser?.role||"").toLowerCase()==="admin")){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062D\u0630\u0641 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645\u064A\u0646");return}const o=AppState.appData.users.find(t=>t.id===e);if(!o){Notification.error("\u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}if(AppState.currentUser&&o.id===AppState.currentUser.id){Notification.error("\u0644\u0627 \u064A\u0645\u0643\u0646\u0643 \u062D\u0630\u0641 \u062D\u0633\u0627\u0628\u0643 \u0627\u0644\u062E\u0627\u0635");return}const a=AppState.appData.users.filter(t=>t.role==="admin"&&t.active!==!1);if(o.role==="admin"&&a.length===1){Notification.error("\u0644\u0627 \u064A\u0645\u0643\u0646 \u062D\u0630\u0641 \u0622\u062E\u0631 \u0645\u062F\u064A\u0631 \u0641\u064A \u0627\u0644\u0646\u0638\u0627\u0645");return}if(await Utils.confirmDialog("\u062D\u0630\u0641 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645",`\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 "${o.name}" (${o.email})\u061F

\u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647.`,"\u062D\u0630\u0641","\u0625\u0644\u063A\u0627\u0621")){Loading.show();try{let t=!1;if(AppState.googleConfig.appsScript.enabled)try{const n=await GoogleIntegration.sendToAppsScript("deleteUser",{userId:e});if(t=n&&n.success===!0,!t&&n&&n.message)throw new Error(n.message)}catch(n){const d=AppState.appData.users.filter(r=>r.id!==e);try{await GoogleIntegration.autoSave("Users",d),t=!0}catch(r){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 Google Sheets \u0648\u0628\u062F\u064A\u0644 autoSave:",r),Loading.hide(),Notification.error("\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+(n.message||n)),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645:",n);return}}else await GoogleIntegration.autoSave("Users",AppState.appData.users.filter(n=>n.id!==e)),t=!0;if(!t){Loading.hide(),Notification.error("\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A");return}AppState.appData.users=AppState.appData.users.filter(n=>n.id!==e),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0628\u0646\u062C\u0627\u062D"),this.loadUsersList()}catch(t){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(t&&t.message?t.message:String(t))),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645:",t)}}},filterUsers(e="",s=""){let a=AppState.appData.users||[];if(e){const t=e.toLowerCase();a=a.filter(n=>n.name?.toLowerCase().includes(t)||n.email?.toLowerCase().includes(t)||n.department?.toLowerCase().includes(t))}s&&(a=a.filter(t=>t.role===s));const i=document.querySelector("#users-table-container tbody");i&&(a.length===0?i.innerHTML=`
                    <tr>
        ...
        `,document.body.appendChild(s);const o=document.getElementById("excel-file-input"),a=document.getElementById("confirm-import-btn");let i=[];(()=>{if(typeof XLSX>"u"){const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/xlsx@0.18.5/dist/xlsx.full.min.js",n.onerror=function(){this.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js"},n.onload=()=>{o.addEventListener("change",d=>{i=[],this.handleExcelFile(d.target.files[0],s,a,r=>{i=r})})},document.head.appendChild(n)}else o.addEventListener("change",n=>{i=[],this.handleExcelFile(n.target.files[0],s,a,d=>{i=d})})})(),a.addEventListener("click",async()=>{if(i.length===0){Notification.error("\u064A\u0631\u062C\u0649 \u062A\u062D\u0645\u064A\u0644 \u0645\u0644 Excel \u0623\u0648\u0644\u0627\u064B");return}await this.processImport(i,s)}),s.addEventListener("click",n=>{n.target===s&&s.remove()})},handleExcelFile(e,s,o,a){if(!e)return;const i=new FileReader;i.onload=async t=>{try{Loading.show();const n=new Uint8Array(t.target.result),d=XLSX.read(n,{type:"array"}),r=d.SheetNames[0],l=d.Sheets[r],p=XLSX.utils.sheet_to_json(l);if(p.length===0){Loading.hide(),Notification.error("\u0627\u0644\u0645\u0644\u0641 \u0641\u0627\u0631\u063A \u0623\u0648 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D");return}a&&a(p);const f=document.getElementById("import-preview"),g=document.getElementById("preview-head"),h=document.getElementById("preview-body"),v=document.getElementById("preview-count");if(f&&p.length>0){const x=Object.keys(p[0]);g.innerHTML=`<tr>${x.map(b=>`<th class="px-2 py-1">${Utils.escapeHTML(b)}</th>`).join("")}</tr>`,h.innerHTML=p.slice(0,5).map(b=>`<tr>${x.map(w=>`<td class="px-2 py-1">${Utils.escapeHTML(String(b[w]||""))}</td>`).join("")}</tr>`).join(""),v.textContent=`\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0635\u0641\u0648\u0641: ${p.length}`,f.classList.remove("hidden"),o.disabled=!1}Loading.hide()}catch(n){Loading.hide(),Notification.error("\u0641\u0634\u0644 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641: "+n.message)}},i.readAsArrayBuffer(e)},async processImport(e,s){try{Loading.show();let o=0,a=0;const i=[];for(const t of e)try{const n=t.\u0627\u0644\u0627\u0633\u0645||t.Name||t.name||t.NAME||"",d=t["\u0627\u0644\u0628\u0631\u064A\u062F \u0627\u0644\u0625\u0644\u0643\u062A\u0631\u0648\u0646\u064A"]||t.Email||t.email||t.EMAIL||"",r=t.\u0627\u0644\u062F\u0648\u0631||t.Role||t.role||t.ROLE||"user",l=t.\u0627\u0644\u0642\u0633\u0645||t.Department||t.department||t.DEPARTMENT||"";if(!n||!d){a++,i.push(`\u0635\u0641 \u0628\u062F\u0648\u0646 \u0627\u0633\u0645 \u0623\u0648 \u0628\u0631\u064A\u062F: ${JSON.stringify(t)}`);continue}if(!Utils.isValidEmail(d)){a++,i.push(`\u0628\u0631\u064A\u062F \u063A\u064A\u0631 \u0635\u062D\u064A\u062D: ${d}`);continue}if(AppState.appData.users.find(b=>b.email===d.toLowerCase())){a++;continue}const f=Math.random().toString(36).substring(2,10),g=Date.now().toString(36).substring(5,9),h="Temp"+f+g+"!",v=await Utils.hashPassword(h),x={id:Utils.generateId("USER"),name:n.trim(),email:d.toLowerCase().trim(),password:"***",passwordHash:v,role:this.mapRole(r),department:l.trim(),active:!0,permissions:this.mapRole(r)==="admin"?{}:void 0,forcePasswordChange:!0,passwordChanged:!1,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};AppState.appData.users.push(x),o++}catch{a++}if(o>0&&typeof removeDefaultUsersIfNeeded=="function")try{await removeDefaultUsersIfNeeded()}catch(t){Utils.safeWarn("\u26A0 \u062E\u0637\u0623 \u0641\u064A \u0625\u0632\u0627\u0644\u0629 \u0627\u0644\u062D\u0633\u0627\u0628\u0627\u062A \u0627\u0644\u0627\u0641\u062A\u0631\u0627\u0636\u064A\u0629 \u0628\u0639\u062F \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F:",t)}typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),o>0&&await GoogleIntegration.autoSave("Users",AppState.appData.users),Loading.hide(),Notification.success(`\u062A\u0645 \u0627\u0633\u062A\u064A\u0631\u0627\u062F ${o} \u0645\u0648\u0638${a>0?` (\u0641\u0634\u0644 ${a})`:""}`),s.remove(),this.loadUsersList()}catch(o){Loading.hide(),Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+o.message)}},mapRole(e){const s=String(e||"").toLowerCase().trim();return s.includes("\u0645\u062F\u064A\u0631")||s.includes("admin")?"admin":s.includes("\u0633\u0644\u0627\u0645\u0629")||s.includes("safety")?"safety_officer":"user"},async convertImageToBase64(e){return new Promise((s,o)=>{const a=new FileReader;a.onload=()=>s(a.result),a.onerror=o,a.readAsDataURL(e)})},collectPermissions(){const e={},s=document.querySelectorAll(".user-permission-checkbox:checked:not([disabled])");for(const o of s){const a=o.getAttribute("data-module");a&&(e[a]=!0)}return this.currentDetailedPermissions&&typeof this.currentDetailedPermissions=="object"&&Object.assign(e,this.currentDetailedPermissions),typeof MODULE_PERMISSIONS_CONFIG<"u"&&MODULE_PERMISSIONS_CONFIG.forEach(o=>{e[o.key]||delete e[`${o.key}Permissions`]}),Object.keys(e).length>0?e:{}},setupPhotoPreview(){const e=document.getElementById("user-photo-input"),s=document.getElementById("user-photo-preview"),o=document.getElementById("user-photo-icon");e&&s&&o&&e.addEventListener("change",a=>{const i=a.target.files[0];if(i){const t=new FileReader;t.onload=n=>{s.src=n.target.result,s.style.display="block",o.style.display="none"},t.readAsDataURL(i)}})},startAutoRefresh(){this.stopAutoRefresh(),this.autoRefreshInterval=setInterval(()=>{const e=document.getElementById("users-section");e&&e.style.display!=="none"&&!e.hidden&&this.refreshUsersTable()},this.refreshInterval),Utils.safeLog("\u2705 \u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A \u0644\u062D\u0627\u0644\u0629 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0648\u0622\u062E\u0631 \u062A\u0633\u062C\u064A\u0644 \u062F\u062E\u0648\u0644")},stopAutoRefresh(){this.autoRefreshInterval&&(clearInterval(this.autoRefreshInterval),this.autoRefreshInterval=null,Utils.safeLog("\u{1F6D1} \u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u0627\u0644\u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A"))},refreshUsersTable(){const e=document.getElementById("users-table-container");if(!e)return;const s=e.querySelector("tbody");if(!s){this.loadUsersList();return}const o=AppState.appData.users||[];s.querySelectorAll("tr").forEach(a=>{const i=a.querySelectorAll("td");if(i.length<9)return;const t=i[1]?.textContent?.trim();if(!t)return;const n=o.find(f=>f.email&&f.email.toLowerCase().trim()===t.toLowerCase().trim());if(!n)return;const d=n.isOnline===!0,r=n.lastLogin?Utils.formatDateTime(n.lastLogin):"-",l=i[7];l&&(l.innerHTML=`
                    <div class="flex items-center gap-2">
                ...
                `)})},updateUserStatus(e){const s=document.getElementById("users-table-container");if(!s)return;const o=s.querySelector("tbody");if(!o)return;const a=AppState.appData.users.find(t=>t.id===e);if(!a)return;o.querySelectorAll("tr").forEach(t=>{const n=t.querySelectorAll("td");if(n.length>0){const d=a.email;if(n[1]?.textContent?.trim()===d){const l=a.isOnline===!0,p=a.lastLogin?Utils.formatDateTime(a.lastLogin):"-";n[7]&&(n[7].innerHTML=`
                            <div class="flex items-center gap-2">
