const Violations={_t(e,t){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n.t(e,t):window.I18n&&typeof window.I18n.t=="function"?window.I18n.t(e,t):t},applyModuleI18n(e){const t=window.AppI18n&&typeof window.AppI18n.applyI18n=="function"?window.AppI18n:window.I18n&&typeof window.I18n.applyI18n=="function"?window.I18n:null;if(!t)return;const o=e||document.getElementById("viol-analytics-root");o&&(typeof t.applyI18n=="function"&&t.applyI18n(o),typeof t.applyLiteralTranslations=="function"&&t.applyLiteralTranslations(o))},currentFilters:{search:"",personType:"",violationType:"",severity:"",status:""},parseFineAmount(e){if(e==null||e==="")return 0;if(typeof e=="number")return Number.isFinite(e)&&e>=0?e:0;const t="\u0660\u0661\u0662\u0663\u0664\u0665\u0666\u0667\u0668\u0669",o="\u06F0\u06F1\u06F2\u06F3\u06F4\u06F5\u06F6\u06F7\u06F8\u06F9",i=r=>String(r||"").replace(/[٠-٩۰-۹]/g,c=>{const l=t.indexOf(c);if(l>=0)return String(l);const d=o.indexOf(c);return d>=0?String(d):c}),n=String(e).trim(),a=i(n).replace(/[,\u066C]/g,"").replace(/\u066B/g,".").replace(/[^\d.\-]/g,""),s=Number(a);return Number.isFinite(s)&&s>=0?s:0},_VIOL_CURRENCY_KEY:"viol_currency",_VIOL_RATE_KEY:"viol_exchange_rate",_VIOL_DEFAULT_RATE:50,getCurrentCurrency(){try{return localStorage.getItem(this._VIOL_CURRENCY_KEY)==="USD"?"USD":"EGP"}catch{return"EGP"}},setCurrentCurrency(e){const t=e==="USD"?"USD":"EGP";try{localStorage.setItem(this._VIOL_CURRENCY_KEY,t)}catch{}return t},getExchangeRate(){try{const e=parseFloat(localStorage.getItem(this._VIOL_RATE_KEY));return Number.isFinite(e)&&e>0?e:this._VIOL_DEFAULT_RATE}catch{return this._VIOL_DEFAULT_RATE}},setExchangeRate(e){const t=parseFloat(e);if(!Number.isFinite(t)||t<=0)return!1;try{localStorage.setItem(this._VIOL_RATE_KEY,String(t))}catch{}return!0},convertFineAmount(e,t){const o=t||this.getCurrentCurrency(),i=Number(e)||0;if(o==="USD"){const n=this.getExchangeRate();return n>0?i/n:0}return i},formatFineAmount(e,t={}){const o=t.currency||this.getCurrentCurrency(),i=o==="USD"?"$":"\u062C.\u0645",n=this.convertFineAmount(e,o),a=o==="USD"?n.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:2}):n.toLocaleString("en-US",{maximumFractionDigits:0});return o==="USD"?`${a} $`:`${a} ${i}`},getCurrencyLabel(e="short"){return this.getCurrentCurrency()==="USD"?e==="long"?this._t("module.violations.analytics.currency.usd_long","\u062F\u0648\u0644\u0627\u0631 \u0623\u0645\u0631\u064A\u0643\u064A"):"$":e==="long"?this._t("module.violations.analytics.currency.egp_long","\u062C\u0646\u064A\u0647 \u0645\u0635\u0631\u064A"):this._t("module.violations.analytics.currency.egp_short","\u062C.\u0645")},normalizeViolationRecord(e){if(!e||typeof e!="object")return null;const t=e.fineAmount??e.defaultFineAmount??e.fine_amount??e.fine??e.amount??e["\u0627\u0644\u0642\u064A\u0645\u0629 \u0627\u0644\u0645\u0627\u0644\u064A\u0629"]??e["\u0642\u064A\u0645\u0629 \u0645\u0627\u0644\u064A\u0629"]??0,o=this.parseFineAmount(t),i=e.personType||(e.contractorName?"contractor":"employee");return{...e,personType:i,fineAmount:o}},_escapeIdForHandler(e){return JSON.stringify(e==null?"":String(e))},getEffectiveFineAmount(e){const t=this.normalizeViolationRecord(e);if(!t)return 0;const o=this.parseFineAmount(t.fineAmount);if(o>0)return o;let i=[];try{typeof ViolationTypesManager<"u"&&ViolationTypesManager.ensureInitialized&&ViolationTypesManager.getAll&&(ViolationTypesManager.ensureInitialized(),i=ViolationTypesManager.getAll()||[])}catch{i=[]}!i.length&&typeof AppState<"u"&&Array.isArray(AppState?.appData?.violationTypes)&&(i=AppState.appData.violationTypes);const n=String(t.violationTypeId||"").trim(),a=String(t.violationType||"").trim().toLowerCase();let s=0;if(n){const r=i.find(c=>c&&String(c.id)===n);r&&(s=this.parseFineAmount(r.fineAmount))}if(s<=0&&a){const r=i.find(c=>c&&String(c.name||"").trim().toLowerCase()===a);r&&(s=this.parseFineAmount(r.fineAmount))}return s>0?s:o},_normKeyStr(e){if(e==null)return"";let t=String(e).trim().toLowerCase();return t=t.replace(/[\u064B-\u065F\u0670]/g,""),t=t.replace(/[أإآ]/g,"\u0627"),t=t.replace(/ة/g,"\u0647"),t=t.replace(/[ى]/g,"\u064A"),t=t.replace(/\s+/g," "),t=t.replace(/[^\w\s\u0600-\u06FF]/g,""),t.trim()},sameViolationPersonForSequence(e,t){const o=this._normKeyStr(e.personType)||"employee",i=this._normKeyStr(t.personType)||"employee";if(o!==i)return!1;if(o==="contractor"){const s=this._normKeyStr(e.contractorName),r=this._normKeyStr(t.contractorName);if(!s||!r||s!==r)return!1;const c=this._normKeyStr(e.contractorWorker),l=this._normKeyStr(t.contractorWorker);return!c&&!l?!0:c===l}const n=this._normKeyStr(e.employeeCode||e.employeeNumber),a=this._normKeyStr(t.employeeCode||t.employeeNumber);return!!n&&n===a},getViolationYearMonthKey(e){const t=new Date(e);return isNaN(t.getTime())?null:t.getFullYear()*12+t.getMonth()},_violApprovalSettingsCache:null,_violApprovalSettingsCacheAt:0,_violApprovalRequestsCache:null,_violApprovalRequestsCacheAt:0,_violApprovalRequestsCacheKey:"",async getViolationApprovalSettings(){const e=Date.now();if(this._violApprovalSettingsCache&&e-this._violApprovalSettingsCacheAt<3e5)return this._violApprovalSettingsCache;try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest){const t=await GoogleIntegration.sendRequest({action:"getViolationApprovalSettings",data:{__timeoutMs:2e4}});if(t&&t.success&&t.data)return this._violApprovalSettingsCache={requireApproval:t.data.requireApproval===!0,defaultApprovers:Array.isArray(t.data.defaultApprovers)?t.data.defaultApprovers:[],bypassRoles:Array.isArray(t.data.bypassRoles)?t.data.bypassRoles:["admin","\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"]},this._violApprovalSettingsCacheAt=e,this._violApprovalSettingsCache}}catch(t){AppState.debugMode&&Utils.safeWarn("getViolationApprovalSettings:",t)}return{requireApproval:!1,defaultApprovers:[],bypassRoles:["admin","\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"]}},isCurrentUserBypassApproval(e){try{if(typeof Permissions<"u"&&typeof Permissions.isCurrentUserEffectiveAdmin=="function"&&Permissions.isCurrentUserEffectiveAdmin())return!0;const t=AppState.currentUser?.role||"";if(Array.isArray(e)&&e.length>0){const o=String(t).toLowerCase();return e.some(i=>String(i).toLowerCase()===o||String(i)===t)}}catch{}return!1},async checkViolationApprovalGate(e,t={}){const o=await this.getViolationApprovalSettings();return!o||!o.requireApproval?{requiresApproval:!1,settings:o}:this.isCurrentUserBypassApproval(o.bypassRoles)?{requiresApproval:!1,settings:o,bypassed:!0}:!Array.isArray(o.defaultApprovers)||o.defaultApprovers.length===0?(AppState.debugMode&&Utils.safeWarn("approval required but no approvers configured \u2014 allowing direct save"),{requiresApproval:!1,settings:o,reason:"no_approvers"}):{requiresApproval:!0,settings:o}},async submitViolationForApproval(e,t={}){try{const i=((await this.getViolationApprovalSettings()).defaultApprovers||[]).slice(),n=AppState.currentUser||{},a={requestType:t.isEdit?"update":"add",violationData:e,originalViolationId:t.originalId||"",approvers:i,createdBy:n.id||n.email||"",createdByName:n.name||n.email||"",notes:t.notes||""};return await GoogleIntegration.sendRequest({action:"addViolationApprovalRequest",data:{...a,__timeoutMs:3e4}})||{success:!1,message:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0627\u0633\u062A\u062C\u0627\u0628\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645"}}catch(o){return{success:!1,message:o?.message||String(o)}}},async fetchViolationApprovalRequests(e={}){try{const t=await GoogleIntegration.sendRequest({action:"getAllViolationApprovalRequests",data:{...e,__timeoutMs:25e3}});return t&&t.success&&Array.isArray(t.data)?t.data:[]}catch(t){return AppState.debugMode&&Utils.safeWarn("fetchViolationApprovalRequests:",t),[]}},async approveViolationRequest(e,t={}){const o=AppState.currentUser||{},i={userId:o.id||o.email||"",userName:o.name||"",userEmail:o.email||""};try{const n=await GoogleIntegration.sendRequest({action:"approveViolationApprovalRequest",data:{requestId:e,approver:i,notes:t.notes||"",force:t.force===!0,__timeoutMs:3e4}});return this._violApprovalSettingsCache=null,this._invalidateViolationApprovalRequestsCache(),n||{success:!1,message:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0627\u0633\u062A\u062C\u0627\u0628\u0629"}}catch(n){return{success:!1,message:n?.message||String(n)}}},async rejectViolationRequest(e,t){const o=AppState.currentUser||{},i={userId:o.id||o.email||"",userName:o.name||"",userEmail:o.email||""};try{const n=await GoogleIntegration.sendRequest({action:"rejectViolationApprovalRequest",data:{requestId:e,approver:i,reason:String(t||"").trim(),__timeoutMs:3e4}});return this._invalidateViolationApprovalRequestsCache(),n||{success:!1,message:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0627\u0633\u062A\u062C\u0627\u0628\u0629"}}catch(n){return{success:!1,message:n?.message||String(n)}}},async saveViolationApprovalSettings(e){const t=AppState.currentUser||{};try{const o=await GoogleIntegration.sendRequest({action:"updateViolationApprovalSettings",data:{requireApproval:e.requireApproval===!0,defaultApprovers:Array.isArray(e.defaultApprovers)?e.defaultApprovers:[],bypassRoles:Array.isArray(e.bypassRoles)?e.bypassRoles:["admin","\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"],updatedBy:t.id||t.email||"",updatedByName:t.name||"",__timeoutMs:25e3}});return this._violApprovalSettingsCache=null,this._invalidateViolationApprovalRequestsCache(),o||{success:!1,message:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0627\u0633\u062A\u062C\u0627\u0628\u0629"}}catch(o){return{success:!1,message:o?.message||String(o)}}},_getViolationApprovalRequestsCacheKey(e,t){return e?"admin":String(t?.email||t?.id||"user")},_getCachedViolationApprovalRequests(e,t){const o=this._getViolationApprovalRequestsCacheKey(e,t),i=Date.now();return this._violApprovalRequestsCache&&this._violApprovalRequestsCacheKey===o&&i-this._violApprovalRequestsCacheAt<12e4?this._violApprovalRequestsCache:null},_setCachedViolationApprovalRequests(e,t,o){this._violApprovalRequestsCache=Array.isArray(e)?e:[],this._violApprovalRequestsCacheKey=this._getViolationApprovalRequestsCacheKey(t,o),this._violApprovalRequestsCacheAt=Date.now()},_invalidateViolationApprovalRequestsCache(){this._violApprovalRequestsCache=null,this._violApprovalRequestsCacheAt=0,this._violApprovalRequestsCacheKey=""},_cloneViolationApprovalSettings(e){const t=e||{};return{requireApproval:t.requireApproval===!0,defaultApprovers:Array.isArray(t.defaultApprovers)?t.defaultApprovers.map(o=>({...o})):[],bypassRoles:Array.isArray(t.bypassRoles)?[...t.bypassRoles]:["admin","\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"]}},_getViolationApprovalSettingsSnapshot(){const e=Date.now();return this._violApprovalSettingsCache&&e-this._violApprovalSettingsCacheAt<3e5?this._cloneViolationApprovalSettings(this._violApprovalSettingsCache):{requireApproval:!1,defaultApprovers:[],bypassRoles:["admin","\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"]}},_prefetchViolationApprovalPanelData(){const e=typeof Permissions<"u"&&typeof Permissions.isCurrentUserEffectiveAdmin=="function"?Permissions.isCurrentUserEffectiveAdmin():!1,t=AppState.currentUser||{},o={userEmail:e?"":t.email||"",userId:e?"":t.id||""};Promise.all([this.getViolationApprovalSettings(),this.fetchViolationApprovalRequests(o)]).then(([,i])=>{this._setCachedViolationApprovalRequests(i,e,t)}).catch(()=>{})},_buildViolationApprovalsSettingsHtml(e,t,o){if(!t)return"";const i=e||{requireApproval:!1,defaultApprovers:[]};return`
                ...
                \u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0637\u0644\u0628\u0627\u062A...
            </div>`;const t=(e.requests||[]).filter(o=>o.status==="pending");return this._renderViolationApprovalRequests(t,{isAdmin:e.isAdmin})},_refreshViolationApprovalsModalBody(e,t){const o=(t.requests||[]).filter(s=>s.status==="pending").length,i=e.querySelector("#viol-approval-pending-count");i&&(i.textContent=t.loading?"...":String(o));const n=e.querySelector("#viol-approvals-settings-panel");if(n&&t.isAdmin){const s=document.createElement("div");s.innerHTML=this._buildViolationApprovalsSettingsHtml(t.settings,!0,t.allUsers);const r=s.firstElementChild;r&&n.replaceWith(r)}const a=e.querySelector("#viol-approval-requests-list");if(a){const s=e.querySelector(".viol-req-filter.viol-req-filter-active")?.getAttribute("data-filter")||"pending",r=s==="all"?t.requests||[]:(t.requests||[]).filter(c=>c.status===s);a.innerHTML=t.loading?this._buildViolationApprovalsRequestsHtml(t):this._renderViolationApprovalRequests(r,{isAdmin:t.isAdmin}),this._wireViolationApprovalActions(e,t.isAdmin)}},async _loadViolationApprovalsPanelData(e,t){try{const[o,i]=await Promise.all([this.fetchViolationApprovalRequests(t.filters),this.getViolationApprovalSettings()]);if(!e.isConnected)return;t.requests=Array.isArray(o)?o:[],t.settings=this._cloneViolationApprovalSettings(i),t.loading=!1,this._setCachedViolationApprovalRequests(t.requests,t.isAdmin,AppState.currentUser||{}),this._refreshViolationApprovalsModalBody(e,t),this._wireViolationApprovalActions(e,t.isAdmin)}catch(o){if(!e.isConnected)return;t.loading=!1;const i=e.querySelector("#viol-approval-requests-list");i&&(i.innerHTML=`<div style="text-align:center;padding:24px;color:#dc2626;background:#fef2f2;border-radius:10px;">
                    <i class="fas fa-exclamation-circle"></i> \u062A\u0639\u0630\u0651\u0631 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0637\u0644\u0628\u0627\u062A \u2014 \u0623\u0639\u062F \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629
                </div>`),AppState.debugMode&&Utils.safeWarn("_loadViolationApprovalsPanelData:",o)}},_bindViolationApprovalsModalEvents(e){if(e._violApprovalsEventsBound)return;e._violApprovalsEventsBound=!0;const t=()=>e._violApprovalState;e.addEventListener("click",o=>{if(o.target.closest("#viol-approvals-close")){e.remove();return}const i=o.target.closest(".viol-remove-approver");if(i){const a=parseInt(i.getAttribute("data-idx"),10),s=t();if(!s||isNaN(a))return;s.settings.defaultApprovers.splice(a,1),this._refreshViolationApprovalsModalBody(e,s);return}const n=o.target.closest(".viol-req-filter");if(n){const a=t();if(!a)return;e.querySelectorAll(".viol-req-filter").forEach(l=>l.classList.remove("viol-req-filter-active")),n.classList.add("viol-req-filter-active");const s=n.getAttribute("data-filter"),r=s==="all"?a.requests:a.requests.filter(l=>l.status===s),c=e.querySelector("#viol-approval-requests-list");c&&(c.innerHTML=a.loading?this._buildViolationApprovalsRequestsHtml(a):this._renderViolationApprovalRequests(r,{isAdmin:a.isAdmin}),this._wireViolationApprovalActions(e,a.isAdmin));return}if(o.target.closest("#viol-add-approver-btn")){const a=t();if(!a)return;const s=e.querySelector("#viol-add-approver-select"),r=s?.value;if(!r){Notification.warning("\u0627\u062E\u062A\u0631 \u0645\u0633\u062A\u062E\u062F\u0645\u0627\u064B");return}const c=s.options[s.selectedIndex],l={userId:r,userName:c?.dataset?.name||"",userEmail:c?.dataset?.email||"",role:c?.dataset?.role||""};if(a.settings.defaultApprovers.some(d=>d.userId===l.userId)){Notification.warning("\u0647\u0630\u0627 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0645\u0636\u0627\u0641 \u0628\u0627\u0644\u0641\u0639\u0644");return}a.settings.defaultApprovers.push(l),this._refreshViolationApprovalsModalBody(e,a);return}if(o.target.closest("#viol-save-settings-btn")){const a=t();if(!a)return;const s=o.target.closest("#viol-save-settings-btn");if(s.disabled)return;s.disabled=!0;const c={requireApproval:e.querySelector("#viol-require-approval")?.checked===!0,defaultApprovers:a.settings.defaultApprovers,bypassRoles:a.settings.bypassRoles};this.saveViolationApprovalSettings(c).then(l=>{s.disabled=!1,l&&l.success?(a.settings=this._cloneViolationApprovalSettings(c),Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0628\u0646\u062C\u0627\u062D")):Notification.error(l&&l.message||"\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A")}).catch(()=>{s.disabled=!1})}})},showViolationApprovalsManager(){const e=typeof Permissions<"u"&&typeof Permissions.isCurrentUserEffectiveAdmin=="function"?Permissions.isCurrentUserEffectiveAdmin():!1,t=AppState.currentUser||{},o=(AppState.appData?.users||[]).filter(l=>l&&(l.email||l.id||l.name)),i={userEmail:e?"":t.email||"",userId:e?"":t.id||""},n=this._getCachedViolationApprovalRequests(e,t),a={settings:this._getViolationApprovalSettingsSnapshot(),requests:n||[],isAdmin:e,allUsers:o,filters:i,loading:!n},s=document.getElementById("viol-approvals-manager-modal");s&&s.remove();const r=document.createElement("div");r.id="viol-approvals-manager-modal",r.className="modal modal-open",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9999;display:flex;align-items:flex-start;justify-content:center;padding:24px;overflow:auto;";const c=a.loading?"...":String(a.requests.filter(l=>l.status==="pending").length);r.innerHTML=`
        ...
        `},hasActiveFilters(){const e=this.currentFilters||{};return!!(e.search||e.personType||e.violationType||e.severity||e.status)},getFilteredViolations(){try{if(typeof AppState>"u"||!AppState.appData)return[];const e=(AppState.appData.violations||[]).map(c=>{const l=this.normalizeViolationRecord(c);if(!l)return null;const d=this.getEffectiveFineAmount(l);return d===l.fineAmount?l:{...l,fineAmount:d}}).filter(Boolean),t=this.currentFilters||{},o=String(t.search||"").trim().toLowerCase(),i=t.personType||"",n=(t.violationType||"").toLowerCase(),a=t.severity||"",s=t.status||"";let r=[];if(o&&typeof Utils<"u"&&typeof Utils.findApprovedContractorByTerm=="function"){const c=[...AppState?.appData?.approvedContractors||[],...AppState?.appData?.contractors||[]].filter(Boolean),l=Utils.findApprovedContractorByTerm(o,c);r=(l.matches&&l.matches.length>0?l.matches:l.contractor?[l.contractor]:[]).map(p=>Utils.buildContractorIdentityMatcher(p,o))}return e.filter(c=>{if(!c||i==="employee"&&!c.employeeName&&c.personType!=="employee"||i==="contractor"&&!c.contractorName&&!c.contractorCode&&!c.contractorId&&c.personType!=="contractor"||n&&(c.violationType||"").trim().toLowerCase()!==n||a&&(c.severity||"")!==a||s&&(c.status||"")!==s)return!1;if(o){let l=!1;if(r.length>0&&r.some(d=>d.violationBelongsToContractor(c))&&(l=!0),l||(l=Object.values(c||{}).map(p=>String(p??"").toLowerCase()).join(" ").includes(o)),!l)return!1}return!0})}catch(e){return typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A getFilteredViolations:",e),[]}},renderFilters(e=""){const t=this.currentFilters||{};e&&(t.personType=e);let o=[];if(typeof ViolationTypesManager<"u"&&ViolationTypesManager.ensureInitialized&&ViolationTypesManager.getAll)try{ViolationTypesManager.ensureInitialized(),o=ViolationTypesManager.getAll()}catch(n){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0623\u0646\u0648\u0627\u0639 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0627\u062A:",n),o=[]}else o=typeof AppState<"u"&&AppState?.appData?.violationTypes?AppState.appData.violationTypes:[];const i=o.map(n=>`
        ...
        `},getContractorViolationsExportOptions(){const e=new Map,t=(o,i,n="")=>{const a=String(i||"").replace(/\s+/g," ").trim();if(!a)return;const s=this._normalizeContractorExportName(a);!s||e.has(s)||e.set(s,{id:String(o||n||a).trim(),name:a,code:String(n||"").trim()})};return typeof Contractors<"u"&&typeof Contractors.getContractorOptionsForModules=="function"?Contractors.getContractorOptionsForModules({includeSuppliers:!0,approvedOnly:!1}).forEach(o=>t(o.id,o.name,o.code)):((AppState.appData?.contractors||[]).forEach(o=>{t(o.id||o.contractorId,o.name||o.companyName,o.code||o.contractorCode||o.isoCode)}),(AppState.appData?.approvedContractors||[]).forEach(o=>{t(o.id||o.contractorId,o.companyName||o.name,o.code||o.contractorCode)})),(AppState.appData?.violations||[]).forEach(o=>{o?.contractorName&&t(o.contractorId,o.contractorName,o.contractorCode||o.code||o.isoCode)}),Array.from(e.values()).sort((o,i)=>o.name.localeCompare(i.name,"ar",{sensitivity:"base"}))},_normalizeContractorExportName(e){const t=String(e||"").replace(/\s+/g," ").trim();if(!t)return"";const o=t.indexOf(" - "),i=o>0?t.slice(0,o).trim():t;return this._normKeyStr(i)},_buildContractorExportMatcher(e="",t="",o=""){const i=String(e||"").trim(),n=String(t||"").trim(),a=String(o||"").trim();if(!i&&!n&&!a)return null;let s=null;typeof Contractors<"u"&&typeof Contractors.resolveContractorForAnalytics=="function"&&(s=Contractors.resolveContractorForAnalytics(i||a,n));const r=i||a||n,c=s||{id:i,name:n,companyName:n,code:a,contractorCode:a};if(typeof Utils<"u"&&typeof Utils.buildContractorIdentityMatcher=="function")return Utils.buildContractorIdentityMatcher(c,r);if(typeof Contractors<"u"&&typeof Contractors.buildContractorAnalyticsMatchers=="function")return Contractors.buildContractorAnalyticsMatchers(c,r);const l=this._normalizeContractorExportName(n||i),d=new Set([i,a].filter(Boolean).map(p=>String(p).trim().toLowerCase()));return{violationBelongsToContractor:p=>{if(!p||!(p.personType==="contractor"||!!String(p.contractorName||"").trim()))return!1;const m=this._normalizeContractorExportName(p.contractorName),$=String(p.contractorId||p.contractorCode||p.code||"").trim().toLowerCase();return $&&d.has($)?!0:!!l&&m===l}}},showContractorViolationsReportDialog(){const e=this.getContractorViolationsExportOptions(),t=new Date,o=t.getFullYear(),i=[];for(let p=0;p<24;p++){const f=new Date(o,t.getMonth()-p,1),m=f.getFullYear(),$=f.getMonth()+1,b=`${m}-${String($).padStart(2,"0")}`,z=f.toLocaleDateString("ar-SA-u-nu-latn",{year:"numeric",month:"long"});i.push({value:b,label:z})}const n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
        ...
        <div id="viol-analytics-root" style="font-family:'Cairo','Inter',sans-serif !important;">
            ...
            <div class="content-card" style="padding:0;overflow:hidden;">
                ...
                <div style="background:${E.bg};border:1px solid ${E.border};border-radius:12px;padding:12px 14px;display:flex;align-items:center;gap:10px;transition:all .2s;cursor:default;" onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 6px 20px rgba(0,0,0,0.09)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                    ...
                    </tr>`}).join(""))},_vFilterByPeriod(e,t){if(!t||t===0)return e;const o=new Date;return o.setDate(o.getDate()-t),e.filter(i=>{if(!i.violationDate)return!0;const n=new Date(i.violationDate);return!isNaN(n.getTime())&&n>=o})},_vGroupBy(e,t,o=0){const i={};e.forEach(a=>{const s=String(a[t]||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").trim()||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";i[s]=(i[s]||0)+1});let n=Object.entries(i).sort((a,s)=>s[1]-a[1]);return o>0&&(n=n.slice(0,o)),{labels:n.map(a=>a[0]),data:n.map(a=>a[1])}},_vApplyFilters(e){const t=l=>{const d=document.getElementById(l);return d?d.value.trim():""},o=t("viol-af-ptype"),i=t("viol-af-type"),n=t("viol-af-sev"),a=t("viol-af-status"),s=t("viol-af-loc"),r=[o,i,n,a,s].some(l=>l!==""),c=document.getElementById("viol-filter-badge");return c&&(c.style.display=r?"inline":"none"),e.filter(l=>!(o&&String(l.personType||"").trim()!==o||i&&String(l.violationType||"").trim()!==i||n&&String(l.severity||"").trim()!==n||a&&String(l.status||"").trim()!==a||s&&String(l.violationLocation||"").trim()!==s))},_vPopulateFilters(e){const t=(a,s)=>this._t(a,s),o=a=>[...new Set(e.map(a).filter(Boolean))].sort(),i=(a,s,r)=>{const c=document.getElementById(a);if(!c)return;const l=c.value;c.innerHTML=`<option value="">${t("module.common.all","\u0627\u0644\u0643\u0644")}</option>`+s.map(d=>{const p=r?t(r+d,d):d;return`<option value="${d}"${d===l?" selected":""}>${p}</option>`}).join("")},n=document.getElementById("viol-af-ptype");if(n){const a=n.value;n.innerHTML=`
...
<style id="violations-arabic-pdf-fix">
    ...
    .header-info h1 { letter-spacing: 0 !important; }
        ...
        </div>`},async _vExportPDF(){const e=document.getElementById("viol-analytics-capture");if(!e)return;const t=document.getElementById("viol-export-pdf-btn"),o=t?t.innerHTML:"";t&&(t.disabled=!0,t.innerHTML='<i class="fas fa-spinner fa-spin"></i>');try{if(await this._ensureReportPdfLibs_(),typeof html2canvas>"u")throw new Error("html2canvas unavailable");const i=document.getElementById("viol-filter-panel"),n=i&&i.style.display!=="none";n&&(i.style.display="none");const a=Utils.PdfExport.getOptimalCaptureScale(e.scrollWidth,e.scrollHeight,Utils.PdfExport.DEFAULT_CAPTURE_SCALE),s=await html2canvas(e,{scale:a,useCORS:!0,backgroundColor:"#f8fafc",scrollX:0,scrollY:0,logging:!1});n&&(i.style.display="");const{dataUrl:r}=Utils.PdfExport.compressCanvasToJpegDataUrl(s,Utils.PdfExport.TARGET_MAX_BYTES),c=`
...
\u0627\u0644\u0633\u0639\u0631 \u0627\u0644\u062D\u0627\u0644\u064A: ${r} \u062C\u0646\u064A\u0647 = 1 \u062F\u0648\u0644\u0627\u0631`,String(r));if(c===null)return;const l=parseFloat(String(c).trim());if(!Number.isFinite(l)||l<=0){typeof Notification<"u"&&Notification.error?Notification.error("\u0633\u0639\u0631 \u0635\u0631\u0641 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D"):alert("\u0633\u0639\u0631 \u0635\u0631\u0641 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D");return}this.setExchangeRate(l),typeof Notification<"u"&&Notification.success&&Notification.success(`\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0633\u0639\u0631 \u0627\u0644\u0635\u0631\u0641 \u0625\u0644\u0649 ${l} \u062C\u0646\u064A\u0647 = 1 \u062F\u0648\u0644\u0627\u0631`),this.updateViolationAnalytics()})},loadContractorsIntoSelect(e,t="",o=""){if(!e||e.tagName!=="SELECT"){Utils.safeWarn("\u26A0\uFE0F loadContractorsIntoSelect: \u0639\u0646\u0635\u0631 select \u063A\u064A\u0631 \u0635\u0627\u0644\u062D");return}if(typeof Contractors<"u"&&typeof Contractors.populateContractorSelect=="function"){Contractors.populateContractorSelect(e,{placeholder:"-- \u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 --",selectedValue:t,selectedContractorId:o,valueMode:"name",showServiceType:!0,includeSuppliers:!0,approvedOnly:!1});return}let i=[];if(typeof Contractors<"u"&&typeof Contractors.getAllContractorsForModules=="function")try{const s=Contractors.getAllContractorsForModules();if(s&&s.length>0){const r=new Map;s.forEach(c=>{const l=(c.name||"").trim();if(!l||l==="\u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641")return;const d=((c.code||c.isoCode||"")+"").trim().toUpperCase(),p=((c.licenseNumber||"")+"").trim(),f=/^CON-\d+$/i.test(d)?`CODE:${d}`:p?`LIC:${p}`:c.id?`ID:${c.id}`:`NAME:${l.toLowerCase()}`;r.has(f)||r.set(f,{id:c.id||"",name:l,serviceType:(c.serviceType||"").trim(),licenseNumber:(c.licenseNumber||"").trim()})}),i=Array.from(r.values()).sort((c,l)=>{const d=c.name.toLowerCase(),p=l.name.toLowerCase();return d.localeCompare(p,"ar",{sensitivity:"base"})})}}catch(s){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646 \u0645\u0646 getAllContractorsForModules:",s)}if(i.length===0&&typeof Contractors<"u"&&typeof Contractors.getApprovedOptions=="function")try{const s=Contractors.getApprovedOptions(!1);s&&s.length>0&&(i=s.map(r=>({id:r.id||r.contractorId||"",name:(r.name||"").trim(),serviceType:(r.serviceType||"").trim(),licenseNumber:(r.licenseNumber||"").trim()})).filter(r=>r.name))}catch(s){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646 \u0627\u0644\u0645\u0639\u062A\u0645\u062F\u0629:",s)}if(i.length===0){const s=AppState.appData.approvedContractors||[],r=new Map;s.filter(c=>c&&(c.companyName||c.name)&&c.isActive!=="inactive"&&c.isActive!==!1&&c.isActive!=="false"&&c.isActive!=="FALSE").forEach(c=>{const l=(c.companyName||c.name||"").trim();!l||l==="\u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641"||r.has(l)||r.set(l,{id:c.id||"",name:l,serviceType:(c.serviceType||"").trim(),licenseNumber:(c.licenseNumber||c.contractNumber||"").trim()})}),i=Array.from(r.values()).sort((c,l)=>{const d=c.name.toLowerCase(),p=l.name.toLowerCase();return d.localeCompare(p,"ar",{sensitivity:"base"})})}e.innerHTML='<option value="">-- \u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 --</option>';const n=document.createDocumentFragment();let a=null;if(i.forEach(s=>{if(!s||!s.name)return;const r=document.createElement("option");r.value=s.name,r.textContent=s.name,s.serviceType&&(r.textContent+=` - ${s.serviceType}`),r.dataset.contractorId=s.id||"",(t&&s.name===t||o&&s.id===o)&&(r.selected=!0,a=r),n.appendChild(r)}),e.appendChild(n),t&&!a&&e.value!==t)try{e.value=t}catch{Utils.safeWarn("\u26A0\uFE0F \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u0627\u0644\u0645\u062D\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A \u0627\u0644\u0642\u0627\u0626\u0645\u0629:",t)}},async showViolationForm(e=null){let t=null;typeof e=="string"?t=AppState.appData.violations?.find(u=>u.id===e)||null:typeof e=="object"&&(t=e),t=this.normalizeViolationRecord(t);const o=t?this.getEffectiveFineAmount(t):0,i=!!t,a=String(t?.personType||"").trim().toLowerCase()==="contractor"||!!t?.contractorName&&!t?.employeeName,s=!a,r=String(t?.violationLocationId||t?.violationLocation||"").trim(),c=String(t?.violationPlaceId||t?.violationPlace||"").trim();let l=[];if(typeof ViolationTypesManager<"u"&&ViolationTypesManager.ensureInitialized&&ViolationTypesManager.getAll)try{ViolationTypesManager.ensureInitialized(),l=ViolationTypesManager.getAll()}catch(u){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0623\u0646\u0648\u0627\u0639 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0627\u062A:",u),l=AppState?.appData?.violationTypes||[]}else l=AppState?.appData?.violationTypes||[];const d=t?.violationTypeId||"",p=(t?.violationType||"").trim(),f=(AppState?.currentUser?.role||"").toString().trim().toLowerCase(),m=["admin","manager","\u0645\u062F\u064A\u0631","\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645","system-manager","system_admin"].includes(f),$=l.map(u=>{const h=d?u.id===d:u.name===p,x=Number(u?.fineAmount||0);return`
        ...
        `,document.body.appendChild(a),a.querySelector("#violation-view-quick-save")?.addEventListener("click",async()=>{await this.saveViolationQuickEditsFromView(o.id,a)}),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(a,{onFetchFail:s=>{try{s.onerror=null,s.src="data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22400%22 height=%22200%22%3E%3Crect fill=%22%23f0f0f0%22 width=%22400%22 height=%22200%22/%3E%3Ctext fill=%22%23999%22 font-family=%22sans-serif%22 font-size=%2216%22 x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22%3E\u0644\u0627 \u062A\u0648\u062C\u062F \u0635\u0648\u0631\u0629%3C/text%3E%3C/svg%3E"}catch{}}}),a.addEventListener("click",s=>{s.target===a&&a.remove()})},async saveViolationQuickEditsFromView(e,t){const o=t.querySelector("#violation-view-q-severity")?.value?.trim()||"",i=t.querySelector("#violation-view-q-status")?.value?.trim()||"",n=t.querySelector("#violation-view-q-details")?.value?.trim()||"",a=t.querySelector("#violation-view-q-action")?.value?.trim()||"",s=t.querySelector("#violation-view-quick-save");if(!AppState.appData?.violations){Notification.error("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062E\u0627\u0644\u0641\u0627\u062A.");return}const r=AppState.appData.violations.findIndex(l=>l.id===e);if(r===-1){Notification.error("\u062A\u0639\u0630\u0651\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0629.");return}const c=s?.innerHTML;s&&(s.disabled=!0,s.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');try{AppState.appData.violations[r]={...AppState.appData.violations[r],severity:o,status:i,violationDetails:n,actionTaken:a,updatedAt:new Date().toISOString()},typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save();let l=!0;try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.autoSave){const d=await GoogleIntegration.autoSave("Violations",AppState.appData.violations);d&&d.success===!1&&(l=!1)}}catch(d){l=!1,AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 Google Sheets:",d)}if(!l)Notification.warning("\u062A\u0645 \u0627\u0644\u062D\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B \u0644\u0643\u0646 \u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638 \u0641\u064A Google Sheets");else try{localStorage.setItem("violations_last_sync",String(Date.now()))}catch{}Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644\u0627\u062A \u0627\u0644\u0633\u0631\u064A\u0639\u0629 \u0628\u0646\u062C\u0627\u062D"),t.remove(),await this.viewViolation(e);try{const d=document.querySelector("#violations-section .tabs-container .tab-btn.active")?.dataset?.tab||"all",p=document.getElementById("violations-list");if(p&&(d==="all"?p.innerHTML=this.renderViolationsList():d==="employees"?p.innerHTML=this.renderEmployeeViolationsList():d==="contractors"&&(p.innerHTML=this.renderContractorViolationsList())),d==="all"){const f=document.getElementById("violations-stats-cards");f&&(f.outerHTML=this.renderAllViolationsStats())}}catch(d){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u062A\u062D\u062F\u064A\u062B \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0627\u062A \u0628\u0639\u062F \u0627\u0644\u062D\u0641\u0638 \u0627\u0644\u0633\u0631\u064A\u0639:",d)}}catch(l){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0641\u0638 \u0627\u0644\u0633\u0631\u064A\u0639 \u0644\u0644\u0645\u062E\u0627\u0644\u0641\u0629:",l),Notification.error("\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638: "+(l.message||String(l))),s&&(s.disabled=!1,s.innerHTML=c||'<i class="fas fa-save ml-2"></i> \u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644\u0627\u062A \u0627\u0644\u0633\u0631\u064A\u0639\u0629')}},_buildViolationReportTableHtml(e){const t=this.normalizeViolationRecord(e)||e,o=(r,c="\u2014")=>Utils.escapeHTML(String(r==null||r===""?c:r)),i=r=>{if(!r)return"\u2014";const c=new Date(r);return Number.isNaN(c.getTime())?String(r):c.toLocaleString("ar-EG-u-nu-latn",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})},n=t.personType==="contractor"||!!t.contractorName,a=(r,c,l={})=>`
            ...
            <div class="violation-report">
                ...
                ${s?`<section class="vr-section"><div class="vr-section-title">\u0635\u0648\u0631\u0629 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0629</div><div class="vr-photo"><img src="${o(s,"")}" alt="\u0635\u0648\u0631\u0629 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0629" onerror="this.style.display='none'"></div></section>`:""}
...
${i}
        ...
        `},renderBlacklistStats(){const e=AppState.appData?.blacklistRegister||[],t=e.length,o=new Date().getMonth(),i=new Date().getFullYear(),n=e.filter(r=>{if(!r.banDate)return!1;const c=new Date(r.banDate);return c.getMonth()===o&&c.getFullYear()===i}).length,a=new Set;e.forEach(r=>{r.factory&&r.location?a.add(`${r.factory} - ${r.location}`):r.factory?a.add(r.factory):r.location&&a.add(r.location)});const s=a.size;return`
        ...
        `,document.body.appendChild(m),this.setupBlacklistFormInModal(m,e).catch(b=>{Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0625\u0639\u062F\u0627\u062F \u0646\u0645\u0648\u0630\u062C Blacklist:",b)}),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(m,{onFetchFail:b=>this._onBlacklistTablePhotoError(b)}),m.addEventListener("click",b=>{b.target===m&&m.remove()});const $=b=>{b.key==="Escape"&&document.body.contains(m)&&(m.remove(),document.removeEventListener("keydown",$))};document.addEventListener("keydown",$)},renderBlacklistFormContent(e,t,o,i,n,a){const s=!!e,r=this.processPhoto(e),c=r&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(r):{canonical:r||"",displaySrc:r||"",needsProxy:!1,proxyFileId:""},l=c.canonical?c.displaySrc:"",d=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(c):"";return`
                ...
                <div class="table-wrapper" style="overflow-x: auto;">
                    <table class="data-table" id="blacklist-table">
                        ...
                        <tbody id="blacklist-table-body">
                            ${t.map(o=>{const i=this.processPhoto(o),n=i&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(i):{canonical:i||"",displaySrc:i||"",needsProxy:!1,proxyFileId:""},a=n.canonical?n.displaySrc:"",s=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(n):"";return`
                                <tr>
                                    ...
                                    <td>
                                        ${i?`<img src="${Utils.escapeHTML(a)}" alt="\u0635\u0648\u0631\u0629"${s} class="blacklist-table-photo w-12 h-12 object-cover rounded cursor-pointer"
                                                data-photo-url="${Utils.escapeHTML(i)}"
