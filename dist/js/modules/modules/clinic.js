...
<i class="fas fa-info-circle ml-1" style="color:#2563eb;"></i>
            ...
            </div>`;document.getElementById("clinic-attendance-punch-modal")?.remove(),document.body.insertAdjacentHTML("beforeend",p),document.getElementById("clinic-attendance-punch-save")?.addEventListener("click",async m=>{const d=m.currentTarget||document.getElementById("clinic-attendance-punch-save"),u=document.getElementById("clinic-attendance-punch-time")?.value||"",f=document.getElementById("clinic-attendance-punch-notes")?.value?.trim()||"";if(!u){Notification?.warning?.("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u0627\u0644\u0648\u0642\u062A");return}const y=this._formatLocalDatetimeToIso(u);d&&(d.disabled=!0,d.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i>\u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');try{if(a&&(n&&(a.checkIn=y),i&&(a.checkOut=y),a.checkIn&&a.checkOut)){try{const b=new Date(a.checkIn).getTime(),S=new Date(a.checkOut).getTime();!isNaN(b)&&!isNaN(S)&&S>b&&(a.workDuration=Math.round((S-b)/36e5*100)/100+" \u0633\u0627\u0639\u0629")}catch{}a.status="present"}const g=await GoogleIntegration.sendRequest({action:"updateClinicStaffAttendance",data:{recordId:a.id,staffId:a.staffId||"",userId:a.userId||"",userEmail:a.userEmail||"",date:a.date||o||"",punchType:s,[n?"checkIn":"checkOut"]:y,notes:f}});g?.success?(Notification?.success?.(g.message||"\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u0635\u0645\u0629 \u0628\u0646\u062C\u0627\u062D"),document.getElementById("clinic-attendance-punch-modal")?.remove(),this.renderAttendanceTab({force:!0}),this.loadClinicAttendanceData(!0).then(()=>{this.renderAttendanceTab({force:!0})}).catch(()=>{})):(Notification?.error?.(g?.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"),d&&(d.disabled=!1,d.innerHTML='<i class="fas fa-save ml-2"></i>\u062D\u0641\u0638'))}catch(g){Notification?.error?.(g?.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"),d&&(d.disabled=!1,d.innerHTML='<i class="fas fa-save ml-2"></i>\u062D\u0641\u0638')}})},_formatLocalDatetimeToIso(e){if(!e)return"";const t=String(e).trim();if(!t)return"";if(/[Z+-]\d{2}:?\d{2}$/i.test(t)||/Z$/i.test(t))return t;const a=t.match(/^(\d{4})-(\d{2})-(\d{2})[T ](\d{1,2}):(\d{2})/);if(a){const n=new Date(Number(a[1]),Number(a[2])-1,Number(a[3]),Number(a[4]),Number(a[5]),0,0);if(!isNaN(n.getTime()))return n.toISOString()}const s=new Date(t);return isNaN(s.getTime())?t:s.toISOString()},getClinicShiftRules(){return Array.isArray(AppState.appData?.clinicShiftRules)&&AppState.appData.clinicShiftRules.length>0?AppState.appData.clinicShiftRules:[{id:"shift_1",name:"\u0627\u0644\u0648\u0631\u062F\u064A\u0629 \u0627\u0644\u0623\u0648\u0644\u0649",startTime:"07:30",endTime:"15:30",isOvernight:!1},{id:"shift_2",name:"\u0627\u0644\u0648\u0631\u062F\u064A\u0629 \u0627\u0644\u062B\u0627\u0646\u064A\u0629",startTime:"15:30",endTime:"22:30",isOvernight:!1},{id:"shift_3",name:"\u0627\u0644\u0648\u0631\u062F\u064A\u0629 \u0627\u0644\u062B\u0627\u0644\u062B\u0629",startTime:"22:30",endTime:"07:30",isOvernight:!0}]},showClinicShiftSettingsModal(){if(!this.isCurrentUserAdmin()){Notification?.error?.("\u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0645\u062A\u0627\u062D \u0644\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645 \u0641\u0642\u0637");return}const e=this.getClinicShiftRules(),t=`
