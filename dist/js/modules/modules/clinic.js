...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&c()})},editSickLeave(e){const t=this.getSickLeaves().find(a=>a.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629");return}this.showSickLeaveForm(t)},printSickLeaveRecord(e){const t=this.getSickLeaves().find(c=>c.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const a=t.employeeName||t.personName||"",s=t.employeeDepartment||"\u2014",n=t.treatingDoctor||"\u2014",i=t.daysCount??this.calculateSickLeaveDays(t.startDate,t.endDate),o=`
        ...
        <div id="clinic-analytics-root" style="font-family:inherit;">
            ...
            <div class="content-card" style="padding:0;overflow:hidden;">
        ...
        </div>`,this.applyModuleI18n(e),setTimeout(()=>{this.updateClinicAnalyticsDashboard(),this._clinicBindAnalyticsEvents()},80))},bindDataAnalysisTabEvents(e){},async updateClinicAnalyticsDashboard(){const e=document.getElementById("clinic-analytics-root");if(!e)return;try{this.ensureData()}catch{}const t=parseInt(this._clinicPeriod||"0",10),a=AppState.appData?.clinicVisits||[],s=AppState.appData?.clinicMedications||[],n=AppState.appData?.sickLeave||[],i=AppState.appData?.injuries||[],o=AppState.appData?.clinicSupplyRequests||[],l=t>0?(()=>{const D=new Date;return D.setDate(D.getDate()-t),D})():null,r=(D,H)=>l?D.filter(Q=>{const G=new Date(Q[H]||Q.createdAt||"");return!isNaN(G.getTime())&&G>=l}):D,c=r(a,"visitDate"),d=r(n,"startDate"),f=r(i,"injuryDate");this._clinicPopulateFilters(c);const p=this._clinicApplyFilters(c),m=p.length,u=document.getElementById("clinic-filter-count");u&&(u.textContent=`${m} \u0632\u064A\u0627\u0631\u0629`);const y=p.filter(D=>String(D.personType||"").toLowerCase()!=="contractor"),g=p.filter(D=>String(D.personType||"").toLowerCase()==="contractor"),b=new Date,v=p.filter(D=>{const H=new Date(D.visitDate||D.createdAt||"");return H.getFullYear()===b.getFullYear()&&H.getMonth()===b.getMonth()}).length,S=s.filter(D=>D.status==="\u0645\u0646\u062A\u0647\u064A").length,A=s.filter(D=>D.status==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621").length,T=d.filter(D=>!D.status||D.status==="\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629").length,h=new Set(p.map(D=>{const H=new Date(D.visitDate||D.createdAt||"");return isNaN(H.getTime())?null:`${H.getFullYear()}-${H.getMonth()}`}).filter(Boolean)).size,M=h>0?(m/h).toFixed(1):0,I=this.analyzeDispensedMedications_(p,s),N=document.getElementById("clinic-kpi-strip");if(N){const D=[{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0632\u064A\u0627\u0631\u0627\u062A",value:m,icon:"fas fa-hospital-user",color:"#0d9488",bg:"#f0fdfa",border:"#99f6e4"},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646",value:y.length,icon:"fas fa-user-tie",color:"#3b82f6",bg:"#eff6ff",border:"#bfdbfe"},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646",value:g.length,icon:"fas fa-hard-hat",color:"#f97316",bg:"#fff7ed",border:"#fed7aa"},{label:"\u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0631\u0636\u064A\u0629",value:d.length,icon:"fas fa-notes-medical",color:"#f59e0b",bg:"#fffbeb",border:"#fde68a"},{label:"\u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A",value:f.length,icon:"fas fa-user-injured",color:"#ef4444",bg:"#fef2f2",border:"#fecaca"},{label:"\u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u062A\u0647\u064A\u0629",value:S,icon:"fas fa-pills",color:"#dc2626",bg:"#fef2f2",border:"#fca5a5"},{label:"\u0642\u0631\u064A\u0628\u0629 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621",value:A,icon:"fas fa-exclamation",color:"#d97706",bg:"#fffbeb",border:"#fde68a"},{label:"\u0625\u062C\u0627\u0632\u0627\u062A \u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629",value:T,icon:"fas fa-clock",color:"#8b5cf6",bg:"#f5f3ff",border:"#ddd6fe"},{label:"\u0645\u062A\u0648\u0633\u0637 \u0634\u0647\u0631\u064A",value:M,icon:"fas fa-calendar-check",color:"#6366f1",bg:"#eef2ff",border:"#c7d2fe"}];N.innerHTML=D.map(H=>`
                ...
                <div style="background:${H.bg};border:1px solid ${H.border};border-radius:12px;padding:11px 12px;text-align:center;">
                    ...
                    <div style="font-size:0.65rem;color:#64748b;margin-top:2px;">${H.label}</div>
                </div>`).join("")}if(!await this.ensureChartJSLoaded()||typeof Chart>"u"){e.insertAdjacentHTML("afterbegin",'<div style="background:#fffbeb;border:1px solid #fde68a;border-radius:10px;padding:14px 18px;margin-bottom:16px;display:flex;align-items:center;gap:10px;"><i class="fas fa-exclamation-triangle" style="color:#d97706;"></i><span style="font-size:0.85rem;color:#92400e;">\u062A\u0639\u0630\u0651\u0631 \u062A\u062D\u0645\u064A\u0644 \u0645\u0643\u062A\u0628\u0629 \u0627\u0644\u0631\u0633\u0648\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u064A\u0629.</span></div>');return}const x={};p.forEach(D=>{const H=String(D.personType||"").toLowerCase()==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0645\u0648\u0638\u0641";x[H]=(x[H]||0)+1}),this._cDoughnut("clinic-chart-ptype",Object.keys(x),Object.values(x),["rgba(59,130,246,0.85)","rgba(249,115,22,0.85)"]),this._cTrend("clinic-chart-trend",a,"visitDate");const _=this._cGroupBy(p,D=>D.reason||D.diagnosis||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",10);this._cHBar("clinic-chart-reason",_.labels,_.data,"rgba(13,148,136,0.75)");const B=this._cGroupBy(p,D=>D.employeeDepartment||D.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",8);this._cHBar("clinic-chart-dept",B.labels,B.data,"rgba(99,102,241,0.75)");const q=p.filter(D=>{const H=String(D.contractorName||"").trim(),Q=String(D.externalName||"").trim(),G=String(D.personType||"").trim().toLowerCase();return H||Q||G==="contractor"||G==="external"}),F=this._cGroupBy(q,D=>String(D.contractorName||D.externalName||"").trim()||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",8),O=document.getElementById("clinic-chart-contractor-count");O&&(O.textContent=q.length>0?`${q.length} \u0632\u064A\u0627\u0631\u0629 \u2022 ${F.labels.length} \u0645\u0642\u0627\u0648\u0644`:""),this._cHBar("clinic-chart-contractor",F.labels,F.data,"rgba(8,145,178,0.75)");const z=this._cGroupBy(p,D=>D.employeeLocation||D.workArea||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",8);this._cHBar("clinic-chart-loc",z.labels,z.data,"rgba(245,158,11,0.75)");const j=this._cGroupBy(d,D=>D.status||"\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629"),L={\u0645\u0639\u062A\u0645\u062F\u0629:"rgba(16,185,129,0.85)",\u0645\u0631\u0641\u0648\u0636\u0629:"rgba(239,68,68,0.85)","\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629":"rgba(245,158,11,0.85)"};this._cDoughnut("clinic-chart-sl-status",j.labels,j.data,j.labels.map(D=>L[D]||"rgba(148,163,184,0.8)"));const $=this._cGroupBy(f,D=>D.injuryType||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",8);this._cHBar("clinic-chart-inj-type",$.labels,$.data,"rgba(239,68,68,0.75)");const k=this._cGroupBy(s,D=>D.status||"\u0633\u0627\u0631\u064A"),P={\u0633\u0627\u0631\u064A:"rgba(16,185,129,0.85)",\u0645\u0646\u062A\u0647\u064A:"rgba(239,68,68,0.85)","\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621":"rgba(245,158,11,0.85)"};this._cDoughnut("clinic-chart-med-status",k.labels,k.data,k.labels.map(D=>P[D]||"rgba(148,163,184,0.8)")),this._cCompare("clinic-chart-compare",a,n,i);const U=I.topByQuantity.slice(0,10);this._cHBar("clinic-chart-med-top-qty",U.map(D=>D.name),U.map(D=>D.totalQty),"rgba(16,185,129,0.78)");const R=I.byMonth.labels,V=I.byMonth.data;if(R.length&&V.reduce((D,H)=>D+H,0)>0){const D=document.getElementById("clinic-chart-med-monthly"),H=document.getElementById("clinic-chart-med-monthly-empty");if(D){H&&(H.style.display="none"),D.style.display="",this._clinicCharts||(this._clinicCharts={});try{this._clinicCharts["clinic-chart-med-monthly"]&&this._clinicCharts["clinic-chart-med-monthly"].destroy()}catch{}this._clinicCharts["clinic-chart-med-monthly"]=new Chart(D,{type:"line",data:{labels:R,datasets:[{label:"\u0643\u0645\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629",data:V,borderColor:"rgba(5,150,105,0.9)",backgroundColor:"rgba(16,185,129,0.12)",borderWidth:2.5,pointRadius:4,tension:.35,fill:!0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10},maxRotation:45}},y:{beginAtZero:!0,ticks:{precision:0,font:{size:11}},grid:{color:"#f1f5f9"}}}}})}}else{const D=document.getElementById("clinic-chart-med-monthly"),H=document.getElementById("clinic-chart-med-monthly-empty");D&&(D.style.display="none"),H&&(H.style.display="flex")}this._cDoughnut("clinic-chart-med-ptype",["\u0645\u0648\u0638\u0641","\u0645\u0642\u0627\u0648\u0644"],[I.byPersonType.\u0645\u0648\u0638\u0641||0,I.byPersonType.\u0645\u0642\u0627\u0648\u0644||0],["rgba(59,130,246,0.85)","rgba(249,115,22,0.85)"]),this._cHBar("clinic-chart-med-dept",I.byDepartment.labels,I.byDepartment.data,"rgba(99,102,241,0.75)");const W=document.getElementById("clinic-med-table-count"),Y=document.getElementById("clinic-med-top-tbody"),te=I.topByQuantity.slice(0,15);W&&(W.textContent=te.length?`${te.length} \u062F\u0648\u0627\u0621`:""),Y&&(Y.innerHTML=te.length===0?'<tr><td colspan="9" style="padding:24px;text-align:center;color:#94a3b8;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629 \u0641\u064A \u0627\u0644\u0641\u062A\u0631\u0629 \u0627\u0644\u0645\u062D\u062F\u062F\u0629</td></tr>':te.map((D,H)=>{const Q=D.stockRemaining===null?"\u2014":Number(D.stockRemaining).toLocaleString("en-US"),G=D.stockRemaining!==null&&D.stockRemaining<=10?"#dc2626":"#0f766e",X=D.stockStatus==="\u0645\u0646\u062A\u0647\u064A"?"#dc2626":D.stockStatus==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621"?"#d97706":"#64748b",Z=H%2===0?"#fff":"#fafafa";return`<tr style="border-bottom:1px solid #f8fafc;background:${Z};" onmouseover="this.style.background='#ecfdf5'" onmouseout="this.style.background='${Z}'">
                        ...
                        <td style="padding:9px 12px;text-align:center;font-weight:700;color:${G};">${Q}</td>
                        <td style="padding:9px 12px;color:${X};">${Utils.escapeHTML(D.stockStatus)}</td>
                    </tr>`}).join(""));const ee=document.getElementById("clinic-med-low-stock-alert"),se=document.getElementById("clinic-med-low-stock-list");ee&&se&&(I.lowStockHighDemand.length>0?(ee.style.display="block",se.innerHTML=I.lowStockHighDemand.map(D=>`<li><strong>${Utils.escapeHTML(D.name)}</strong>: \u0645\u0646\u0635\u0631\u0641 ${D.totalQty} \u2014 \u0645\u062E\u0632\u0648\u0646 ${D.stockRemaining??"\u2014"}</li>`).join("")):(ee.style.display="none",se.innerHTML=""));const K={};p.forEach(D=>{const H=D.contractorWorkerName||D.employeeName||D.externalName||D.personName||D.name||"",Q=String(H).trim(),G=String(D.contractorName||"").trim(),X=Q||(G?G+" (\u0628\u062F\u0648\u0646 \u0627\u0633\u0645 \u0639\u0627\u0645\u0644)":"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F");K[X]||(K[X]={count:0,dept:"",loc:""}),K[X].count++,K[X].dept||(K[X].dept=D.employeeDepartment||D.department||D.contractorName||D.contractorPosition||"\u2014"),K[X].loc||(K[X].loc=D.employeeLocation||D.workArea||D.factoryName||D.factory||"\u2014")});const ae=Object.entries(K).sort((D,H)=>H[1].count-D[1].count).slice(0,15),oe=document.getElementById("clinic-top-visitors-count"),re=document.getElementById("clinic-top-visitors-tbody");oe&&(oe.textContent=`${ae.length} \u0634\u062E\u0635`),re&&(re.innerHTML=ae.length===0?'<tr><td colspan="5" style="padding:24px;text-align:center;color:#94a3b8;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0632\u064A\u0627\u0631\u0627\u062A</td></tr>':ae.map(([D,H],Q)=>{const G=Q%2===0?"#fff":"#fafafa",X=H.count>=5?"#dc2626":H.count>=3?"#f59e0b":"#0d9488";return`<tr style="border-bottom:1px solid #f8fafc;background:${G};" onmouseover="this.style.background='#f0fdfa'" onmouseout="this.style.background='${G}'">
                        ...
                        <td style="padding:9px 12px;text-align:center;"><span style="background:#f0fdfa;color:${X};padding:3px 10px;border-radius:20px;font-weight:700;font-size:0.82rem;">${H.count} \u0632\u064A\u0627\u0631\u0629</span></td>
        ...
        `,s=`CLINIC-DATA-ANALYSIS-${new Date().toISOString().slice(0,10)}`,n=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(s,"\u062A\u062D\u0644\u064A\u0644 \u0634\u0627\u0645\u0644 \u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0637\u0628\u064A\u0629",a,!1,!0):`<html><body>${a}</body></html>`;try{const i=new Blob([n],{type:"text/html;charset=utf-8"}),o=URL.createObjectURL(i),l=window.open(o,"_blank");l?(l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>URL.revokeObjectURL(o),1e3)},400)},Notification?.success?.("\u062C\u0627\u0631\u064A \u062A\u062D\u0636\u064A\u0631 \u0645\u0644\u0641 PDF \u0644\u0644\u0637\u0628\u0627\u0639\u0629...")):Notification?.error?.("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF")}catch(i){Utils.safeError("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 \u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",i),Notification?.error?.("\u062A\u0639\u0630\u0631 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644")}},scheduleVisitsTabRender(e=!1,t=0){this._visitsRenderTimer&&(clearTimeout(this._visitsRenderTimer),this._visitsRenderTimer=null);const a=()=>{this._visitsRenderTimer=null,requestAnimationFrame(()=>{this.renderVisitsTab(e)})};this._visitsRenderTimer=setTimeout(a,Math.max(0,t))},scheduleAttendanceTabRender(e=0){this._attendanceRenderTimer&&(clearTimeout(this._attendanceRenderTimer),this._attendanceRenderTimer=null);const t=()=>{this._attendanceRenderTimer=null,requestAnimationFrame(()=>{this.renderAttendanceTab()})};this._attendanceRenderTimer=setTimeout(t,Math.max(0,e))},scheduleMedicationsTabRender(e=0){this._medicationsRenderTimer&&(clearTimeout(this._medicationsRenderTimer),this._medicationsRenderTimer=null);const t=()=>{this._medicationsRenderTimer=null,requestAnimationFrame(()=>{this.renderMedicationsTab()})};this._medicationsRenderTimer=setTimeout(t,Math.max(0,e))},async renderVisitsTab(e=!1){try{const t=document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]');if(!t){Utils.safeWarn("\u26A0\uFE0F \u0644\u0648\u062D\u0629 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}this.ensureData(),this.ensureFilterDefaults();const a=this.shouldFetchClinicVisitsFromBackend({forceRefresh:e});this.renderVisitsTabContent(t),a&&typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest&&this.loadVisitsDataFromBackend().then(()=>{const s=document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]');s&&this.state&&this.state.activeTab==="visits"&&(this.ensureData(),this.renderVisitsTabContent(s)),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0628\u0639\u062F \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 \u0627\u0644\u062E\u0627\u062F\u0645 (\u0628\u062F\u0648\u0646 \u062D\u062C\u0628 \u0627\u0644\u0648\u0627\u062C\u0647\u0629)")}).catch(s=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645:",s&&s.message)})}catch(t){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u0639\u0631\u0636 \u062A\u0628\u0648\u064A\u0628 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F:",t);const a=document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]');a&&(a.innerHTML=`
                ...
                <tr>
                    ...
                    <td style="word-wrap: break-word; white-space: normal; max-width: 150px; text-align: ${L};">${Utils.escapeHTML(N)}</td>
                    <td style="word-wrap: break-word; white-space: normal; max-width: 150px; text-align: ${L};">${Utils.escapeHTML(C)}</td>
                    <td style="word-wrap: break-word; white-space: normal; max-width: 150px; text-align: ${L};">${Utils.escapeHTML(w)}</td>
                    <td style="word-wrap: break-word; white-space: normal; text-align: ${L};">${Utils.escapeHTML(E)}</td>
                    <td style="word-wrap: break-word; white-space: normal; text-align: ${L};">${x}</td>
                    <td style="word-wrap: break-word; white-space: normal; text-align: ${L};">${_}</td>
                    <td style="word-wrap: break-word; white-space: normal; max-width: 200px; text-align: ${L};">${Utils.escapeHTML(B)}</td>
                    <td style="word-wrap: break-word; white-space: normal; max-width: 200px; text-align: ${L};">${Utils.escapeHTML(q)}</td>
                    ...
                    <td style="word-wrap: break-word; white-space: normal; max-width: 150px; text-align: ${L};">${j}</td>
            ...
            `:this.renderEmptyState(t(l?"empty.noResults":s==="employees"?"empty.noEmployeeVisits":"empty.noContractorVisits")),v=a?"ml-2":"mr-2",S=a?"mr-2":"ml-2",A=a?"ml-1":"mr-1",T=`
...
\u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647.`,"\u062D\u0630\u0641","\u0625\u0644\u063A\u0627\u0621")){Loading.show("\u062C\u0627\u0631\u064A \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629...");try{if(AppState.googleConfig?.appsScript?.enabled){const i=await GoogleIntegration.sendRequest({action:"deleteClinicVisit",data:{visitId:e}});if(!i||i.success!==!0)throw new Error(i?.message||"\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645")}AppState.appData.clinicVisits=(AppState.appData.clinicVisits||[]).filter(i=>i.id!==e),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0628\u0646\u062C\u0627\u062D"),this.renderVisitsTab()}catch(i){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629: "+i.message),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",i)}}},async requestVisitDeletion(e){try{if(!e){Notification.error("\u0645\u0639\u0631\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D");return}const t=(AppState.appData.clinicVisits||[]).find(i=>i.id===e);if(!t){Notification.error("\u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}if(!(AppState?.googleConfig?.appsScript?.enabled&&AppState?.googleConfig?.appsScript?.scriptUrl)||typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest){Notification.error("\u062A\u0639\u0630\u0631 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641 (\u0627\u0644\u062E\u0627\u062F\u0645 \u063A\u064A\u0631 \u0645\u062A\u0627\u062D)");return}const s={id:AppState.currentUser?.id||"",name:AppState.currentUser?.name||"",email:AppState.currentUser?.email||"",role:AppState.currentUser?.role||""};Loading.show("\u062C\u0627\u0631\u064A \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629...");const n=await GoogleIntegration.sendRequest({action:"addClinicVisitDeletionRequest",data:{visitId:e,visitData:t,requestedBy:s}});if(Loading.hide(),!n||n.success!==!0)throw new Error(n?.message||"\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641");try{AppState.appData.clinicVisitDeletionRequests=Array.isArray(AppState.appData.clinicVisitDeletionRequests)?AppState.appData.clinicVisitDeletionRequests:[],n.data&&AppState.appData.clinicVisitDeletionRequests.unshift({...n.data,requestType:"visit"}),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save()}catch{}Notification.success("\u062A\u0645 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0625\u0644\u0649 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645")}catch(t){try{Loading.hide()}catch{}Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",t),Notification.error("\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641: "+(t.message||"\u062D\u062F\u062B \u062E\u0637\u0623"))}},getMedicationRowClass(e){return e==="\u0645\u0646\u062A\u0647\u064A"?"bg-red-50":e==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621"?"bg-yellow-50":"bg-green-50"},ensureData(){if(typeof AppState>"u")return;AppState.appData=AppState.appData||{};const e=AppState.appData;Array.isArray(e.clinicVisits)||(e.clinicVisits=[]),Array.isArray(e.medications)||(e.medications=[]),Array.isArray(e.clinicMedications)||(e.clinicMedications=[]),Array.isArray(e.clinicInventory)||(e.clinicInventory=[]);const t=e.medications.length>0?e.medications:e.clinicMedications.length>0?e.clinicMedications:e.clinicInventory.length>0?e.clinicInventory:[];e.medications.length===0&&t.length>0&&(e.medications=[...t]),e.clinicMedications.length===0&&t.length>0&&(e.clinicMedications=[...t]),e.clinicInventory.length===0&&t.length>0&&(e.clinicInventory=[...t]),Array.isArray(e.sickLeave)||(e.sickLeave=[]),Array.isArray(e.injuries)||(e.injuries=[]),Array.isArray(e.clinicSupplyRequests)||(e.clinicSupplyRequests=[]),Array.isArray(e.clinicStaff)||(e.clinicStaff=[]),Array.isArray(e.clinicStaffAttendance)||(e.clinicStaffAttendance=[]),Array.isArray(e.clinicStaffTimeOffRequests)||(e.clinicStaffTimeOffRequests=[]),Array.isArray(e.clinicStaffLeaveBalances)||(e.clinicStaffLeaveBalances=[]),Array.isArray(e.clinicStaffSystemActivities)||(e.clinicStaffSystemActivities=[]);let a=!1;if(Array.isArray(e.clinicContractorVisits)&&e.clinicContractorVisits.length>0){const n=new Set(e.clinicVisits.map(o=>o&&o.id).filter(Boolean));let i=0;e.clinicContractorVisits.forEach(o=>{o&&o.id&&!n.has(o.id)&&(o.personType="contractor",e.clinicVisits.push(o),n.add(o.id),a=!0,i++)}),i>0&&AppState.debugMode&&Utils.safeLog(`\u{1F517} [CLINIC] \u062A\u0645 \u062F\u0645\u062C ${i} \u0632\u064A\u0627\u0631\u0629 \u0645\u0642\u0627\u0648\u0644 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B \u0641\u064A ensureData`)}e.clinicVisits=e.clinicVisits.map(n=>{if(!n||typeof n!="object")return n;let i=String(n.personType||"").toLowerCase().trim();i==="external"||i==="\u062E\u0627\u0631\u062C\u064A"||i==="\u0645\u0642\u0627\u0648\u0644"||i==="contractor"?i="contractor":(i==="\u0645\u0648\u0638\u0641"||i==="staff"||i==="employee"||!i)&&(n.contractorName||n.contractorWorkerName?i="contractor":i="employee"),n.personType!==i&&(n.personType=i,a=!0);let o=[];if(n.medications&&(o=this.normalizeVisitMedications(n.medications)),(!o||o.length===0)&&n.medicationsDispensed){const d=this.normalizeVisitMedications(n.medicationsDispensed);d&&d.length>0&&(o=d,AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0648\u064A\u0644 medicationsDispensed \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,d.length,"\u062F\u0648\u0627\u0621"))}if((!o||o.length===0)&&n.medicationsDispensedQty&&n.medicationsDispensedQty>0){const d=parseInt(n.medicationsDispensedQty,10)||0;d>0&&(o=[{medicationName:n.medicationsDispensed||"\u062F\u0648\u0627\u0621 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F",quantity:d,unit:"\u0648\u062D\u062F\u0629",notes:""}],AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0646\u0634\u0627\u0621 \u0633\u062C\u0644 \u062F\u0648\u0627\u0621 \u0645\u0646 medicationsDispensedQty \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,d))}o||(o=[]);const l=Array.isArray(n.medications)?n.medications:[],r=JSON.stringify(l.sort((d,f)=>(d.medicationName||"").localeCompare(f.medicationName||""))),c=JSON.stringify(o.sort((d,f)=>(d.medicationName||"").localeCompare(f.medicationName||"")));if(r!==c&&(n.medications=o,a=!0,AppState.debugMode&&o.length>0&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B medications \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,o.length,"\u062F\u0648\u0627\u0621")),n.visitDate){const d=String(n.visitDate).trim();if(d.length===10&&d.match(/^\d{4}-\d{2}-\d{2}$/)){const f=new Date(d+"T00:00:00");n.visitDate=f.toISOString(),a=!0}else if(!d.includes("T")&&!d.includes("Z"))try{const f=new Date(d);isNaN(f.getTime())||(n.visitDate=f.toISOString(),a=!0)}catch{}}if(n.exitDate){const d=String(n.exitDate).trim();if(d.length===10&&d.match(/^\d{4}-\d{2}-\d{2}$/)){const f=new Date(d+"T00:00:00");n.exitDate=f.toISOString(),a=!0}else if(!d.includes("T")&&!d.includes("Z"))try{const f=new Date(d);isNaN(f.getTime())||(n.exitDate=f.toISOString(),a=!0)}catch{}}return n});let s=!1;if(e.clinicMedications=e.clinicMedications.map(n=>{const i=this.normalizeMedicationRecord(n),o=this.calculateMedicationStatus(i),l=n&&(n.quantityAdded!==i.quantityAdded||n.remainingQuantity!==i.remainingQuantity)||typeof n?.quantityAdded!="number"||typeof n?.remainingQuantity!="number";return(i.status!==o.status||i.daysRemaining!==o.daysRemaining||l)&&(s=!0,i.status=o.status,i.daysRemaining=o.daysRemaining),i}),e.clinicInventory=e.clinicMedications,e.sickLeave=e.sickLeave.map(n=>this.normalizeSickLeaveRecord(n)),e.injuries=e.injuries.map(n=>this.normalizeInjuryRecord(n)),AppState.appData=e,typeof window.DataManager<"u"&&window.DataManager.save)try{window.DataManager.save(),AppState.debugMode&&(s||a)&&Utils.safeLog(`\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u064A ensureData (medicationsChanged: ${s}, visitsChanged: ${a})`)}catch(n){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u064A ensureData:",n.message)}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},ensureFilterDefaults(){this.state||(this.state={activeTab:"medications",filters:{}}),this.state.activeTab||(this.state.activeTab="medications");const e={medications:{search:"",status:"all",dateFrom:"",dateTo:""},visits:{search:"",factory:"",position:"",workplace:""},sickLeave:{search:"",department:"",dateFrom:"",dateTo:""},injuries:{search:"",status:"all",department:"",dateFrom:"",dateTo:""},attendance:{search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"}};this.state.filters=this.state.filters||{},Object.keys(e).forEach(t=>{const a=this.state.filters[t]||{};this.state.filters[t]=Object.assign({},e[t],a)}),Array.isArray(this.state.currentInjuryAttachments)||(this.state.currentInjuryAttachments=[])},getCurrentUserSummary(e=null){if(e&&typeof e=="object"&&(e.name||e.id))return e;if(!AppState.currentUser)return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F AppState.currentUser \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F - \u0625\u0631\u062C\u0627\u0639 \u0627\u0644\u0646\u0638\u0627\u0645"),{id:"",name:"\u0627\u0644\u0646\u0638\u0627\u0645",email:"",role:""};const t=(AppState.currentUser.name||AppState.currentUser.displayName||"").toString().trim(),a=(AppState.currentUser.email||"").toString().trim(),s=(AppState.currentUser.id||"").toString().trim();AppState.debugMode&&Utils.safeLog("\u{1F50D} getCurrentUserSummary - name:",t,"email:",a,"id:",s);const n=t||a||s||"\u0627\u0644\u0646\u0638\u0627\u0645";return AppState.debugMode&&n==="\u0627\u0644\u0646\u0638\u0627\u0645"&&Utils.safeWarn('\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: getCurrentUserSummary \u064A\u0639\u064A\u062F "\u0627\u0644\u0646\u0638\u0627\u0645" - AppState.currentUser:',AppState.currentUser),{id:s,name:n,email:a,role:(AppState.currentUser.role||"").toString().trim()}},getMonthlyVisits(){const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),1);return AppState.appData.clinicVisits.filter(a=>new Date(a.visitDate||a.createdAt)>=t).length},calculateTotalTime(e,t){if(!e||!t)return"-";try{const a=e instanceof Date?e:new Date(e),s=t instanceof Date?t:new Date(t);if(isNaN(a.getTime())||isNaN(s.getTime()))return"-";const n=s.getTime()-a.getTime();if(n<0)return"-";const i=Math.floor(n/(1e3*60)),o=Math.floor(i/60),l=i%60;return o>0&&l>0?`${o} \u0633\u0627\u0639\u0629 ${l} \u062F\u0642\u064A\u0642\u0629`:o>0?`${o} \u0633\u0627\u0639\u0629`:l>0?`${l} \u062F\u0642\u064A\u0642\u0629`:"\u0623\u0642\u0644 \u0645\u0646 \u062F\u0642\u064A\u0642\u0629"}catch(a){return Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0633\u0627\u0628 \u0627\u0644\u0648\u0642\u062A:",a,{visitDate:e,exitDate:t}),"-"}},async renderVisitsList(){const e=AppState.appData.clinicVisits.slice(-10).reverse();return e.length===0?'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0645\u0633\u062C\u0644\u0629</p></div>':`
        ...
        `,document.body.appendChild(a);const d=a.querySelector("#sick-leave-form"),f=d.querySelector("#sick-leave-person-type"),p=d.querySelector("#sick-leave-employee-code"),m=d.querySelector("#sick-leave-name"),u=d.querySelector("#sick-leave-position"),y=d.querySelector("#sick-leave-department"),g=d.querySelector("#sick-leave-position-container"),b=d.querySelector("#sick-leave-department-container"),v=d.querySelector("#sick-leave-code-container"),S=d.querySelector("#sick-leave-name-label"),A=d.querySelector("#sick-leave-dropdown"),T=d.querySelector("#sick-leave-start-date"),h=d.querySelector("#sick-leave-end-date"),M=d.querySelector("#sick-leave-days"),I=()=>{if(!T.value||!h.value){M.textContent="\u2014";return}const x=new Date(T.value).toISOString(),_=new Date(h.value).toISOString(),B=this.calculateSickLeaveDays(x,_);M.textContent=`${B} \u064A\u0648\u0645`};T.addEventListener("change",I),h.addEventListener("change",I),T.value&&h.value&&I();const N=()=>{m&&(m.value=""),u&&(u.value=""),y&&(y.value=""),p&&(p.value="")},C=x=>{if(!x){N();return}const _=EmployeeHelper.getPrimaryCode(x);p&&_&&(p.value=_),m&&(m.value=x.name||""),u&&(u.value=x.position||x.jobTitle||""),y&&(y.value=x.department||x.unit||x.section||"")},w=()=>{!p||!m||typeof EmployeeHelper>"u"||(EmployeeHelper.setupEmployeeCodeSearch("sick-leave-employee-code","sick-leave-name",x=>{x?C(x):N()}),EmployeeHelper.setupAutocomplete("sick-leave-name",x=>{x&&C(x)}))},E=(x,_=!1)=>{const B=x==="employee";v&&(v.style.display=B?"block":"none"),g&&(g.style.display=B?"block":"none"),b&&(b.style.display=B?"block":"none"),S&&(S.textContent=`\u0627\u0633\u0645 ${B?"\u0627\u0644\u0645\u0648\u0638\u0641":x==="contractor"?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"} *`),p&&(p.disabled=!B,p.required=B,p.placeholder=B?"\u0623\u062F\u062E\u0644 \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A":"\u0631\u0642\u0645 \u0627\u0644\u062A\u0639\u0631\u064A\u0641 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)",!B&&_&&(p.value="")),m&&(m.readOnly=B,m.placeholder=B?"\u0633\u064A\u062A\u0645 \u062A\u0639\u0628\u0626\u0629 \u0627\u0644\u0627\u0633\u0645 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B":`\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 ${x==="contractor"?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"}`,B&&_&&(m.value="")),!B&&_&&(u&&(u.value=""),y&&(y.value="")),A&&(A.classList.add("hidden"),A.innerHTML=""),B&&w()};if(E(s,!1),s==="employee"&&typeof EmployeeHelper<"u"&&c){const x=EmployeeHelper.findByTerm(c);x&&C(x)}f.addEventListener("change",()=>{E(f.value,!0),f.value==="employee"&&p&&p.focus()}),d.addEventListener("submit",async x=>{x.preventDefault();const B=f.value==="employee";if(!T.value||!h.value){Notification.warning("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u062A\u0627\u0631\u064A\u062E \u0628\u062F\u0627\u064A\u0629 \u0648\u0646\u0647\u0627\u064A\u0629 \u0627\u0644\u0625\u062C\u0627\u0632\u0629");return}const q=new Date(T.value).toISOString(),F=new Date(h.value).toISOString(),O=this.calculateSickLeaveDays(q,F),z=e?.createdAt||new Date().toISOString(),j=e?.createdBy||this.getCurrentUserSummary(),L=this.getCurrentUserSummary(),$=this.isCurrentUserAdmin();let k,P=!1;if(t)$?(k=this.normalizeMedicationRecord({id:e?.id||Utils.generateId("MED"),name,type,usage,purchaseDate:purchaseISO,productionDate:productionISO,expiryDate:expiryISO,quantityAdded,remainingQuantity,location,notes,createdAt:z,createdBy:j,createdById:j?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:L,status:statusInfoLatest.status,daysRemaining:statusInfoLatest.daysRemaining}),delete k.pendingUpdate):(k={...e},k.pendingUpdate={name,type,usage,purchaseDate:purchaseISO,productionDate:productionISO,expiryDate:expiryISO,quantityAdded,remainingQuantity,location,notes,requestedBy:L,requestedAt:new Date().toISOString()},P=!0);else{const U=$?statusInfoLatest.status:"\u0642\u064A\u062F \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F";$||(P=!0),k=this.normalizeMedicationRecord({id:Utils.generateId("MED"),name,type,usage,purchaseDate:purchaseISO,productionDate:productionISO,expiryDate:expiryISO,quantityAdded,remainingQuantity,location,notes,createdAt:z,createdBy:j,createdById:j?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:L,status:U,daysRemaining:statusInfoLatest.daysRemaining})}Loading.show();try{const U=AppState.appData.sickLeave||[];if(t){const R=U.findIndex(V=>V.id===k.id);R!==-1?U[R]=k:U.push(k)}else U.push(k);AppState.appData.sickLeave=U;try{this.calculateClinicCardValues(),this.updateClinicAnalysisResults()}catch(R){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0643\u0631\u0648\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 (\u0625\u062C\u0627\u0632\u0629 \u0645\u0631\u0636\u064A\u0629):",R)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0628\u0646\u062C\u0627\u062D"),a.remove(),setTimeout(()=>{document.querySelector('.clinic-tab-panel[data-tab-panel="sickLeave"]')&&this.state.activeTab==="sickLeave"&&this.renderSickLeaveTab();const V=document.querySelector("#total-sick-leave");V&&(V.textContent=U.length)},100),(async()=>{try{t?await GoogleIntegration.sendRequest({action:"updateSickLeave",data:{leaveId:k.id,updateData:k}}):await GoogleIntegration.sendRequest({action:"addSickLeave",data:k})}catch(R){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 Google Sheets:",R)}})()}catch(U){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629: "+U.message)}}),a.addEventListener("click",x=>{x.target===a&&confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&a.remove()})},async showInjuryForm(e=null){Utils.safeLog("\u{1F537} \u062A\u0645 \u0627\u0633\u062A\u062F\u0639\u0627\u0621 showInjuryForm - \u0628\u062F\u0621 \u0641\u062A\u062D \u0627\u0644\u0646\u0645\u0648\u0630\u062C..."),this.ensureData();const t=!!e,a=this;this.state.currentInjuryAttachments=Array.isArray(e?.attachments)?e.attachments.map(k=>this.normalizeAttachment(k)).filter(Boolean):[];const s=document.createElement("div");s.className="modal-overlay";const n=e?.personType||"employee",i=e?.injuryDate?Utils.toDateTimeLocalString(e.injuryDate):"",o=e?.employeeName||e?.personName||"",l=e?.contractorName||"",r=e?.employeeCode||e?.employeeNumber||"",c=e?.employeePosition||e?.contractorPosition||"",d=e?.employeeDepartment||e?.department||"",f=e?.factory||"",p=e?.subLocation||e?.subLocationName||"",m=e?.status||"\u0642\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629",u=this.getInjuryTypeOptions(),y=this.getSiteOptions();s.innerHTML=`
        ...
        `,document.body.appendChild(s);const g=s.querySelector("#injury-form"),b=g.querySelector("#injury-person-type"),v=g.querySelector("#injury-name"),S=g.querySelector("#injury-employee-code"),A=g.querySelector("#injury-code-container"),T=g.querySelector("#injury-contractor-container"),h=g.querySelector("#injury-contractor-name-select"),M=g.querySelector("#injury-employee-name-container"),I=g.querySelector("#injury-contractor-worker-container"),N=g.querySelector("#injury-contractor-worker-name"),C=g.querySelector("#injury-name-label"),w=g.querySelector("#injury-position"),E=g.querySelector("#injury-factory"),x=g.querySelector("#injury-sub-location"),_=g.querySelector("#injury-department"),B=g.querySelector("#injury-dropdown"),q=g.querySelector("#injury-attachments-input"),F=s.querySelector(".modal-close"),O=g.querySelector("#injury-cancel-btn"),z=k=>{if(k){if(v&&(v.value=k.name||""),S){const P=EmployeeHelper.getPrimaryCode(k);P&&(S.value=P)}_&&(_.value=k.department||k.unit||k.section||_.value),w&&(w.value=k.position||k.job||"")}},j=()=>{!S||!v||typeof EmployeeHelper>"u"||(EmployeeHelper.setupEmployeeCodeSearch("injury-employee-code","injury-name",k=>{k&&z(k)}),EmployeeHelper.setupAutocomplete("injury-name",k=>{k&&z(k)}))},L=(k,P=!1)=>{const U=k==="employee",R=k==="contractor",V=k==="external";A&&(A.style.display=U?"block":"none"),T&&(T.style.display=R?"block":"none"),M&&(M.style.display=U?"block":"none"),I&&(I.style.display=R||V?"block":"none"),S&&(S.required=U,S.disabled=!U,S.placeholder=U?"\u0623\u062F\u062E\u0644 \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A":"\u0631\u0642\u0645 \u0627\u0644\u062A\u0639\u0631\u064A\u0641 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)",!U&&P&&(S.value="")),C&&(C.textContent=`\u0627\u0633\u0645 ${U?"\u0627\u0644\u0645\u0648\u0638\u0641":k==="contractor"?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"} *`),v&&(v.readOnly=U,v.disabled=!U,v.required=U,v.placeholder=U?"\u0633\u064A\u062A\u0645 \u062A\u0639\u0628\u0626\u0629 \u0627\u0644\u0627\u0633\u0645 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B":`\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 ${k==="contractor"?"\u0627\u0644\u0645\u0648\u0638\u0641 \u0627\u0644\u062A\u0627\u0628\u0639 \u0644\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"}`,P&&!U&&(v.value="")),h&&(h.required=R,h.disabled=!R,R?this.loadContractorsIntoSelect(h):P&&(h.value="")),N&&(N.required=R||V,N.disabled=!(R||V),P&&U&&(N.value=""),V?N.placeholder="\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 \u0627\u0644\u0639\u0627\u0645\u0644 \u0627\u0644\u062E\u0627\u0631\u062C\u064A":R?N.placeholder="\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 \u0627\u0644\u0645\u0635\u0627\u0628 \u0627\u0644\u062A\u0627\u0628\u0639 \u0644\u0644\u0645\u0642\u0627\u0648\u0644":N.placeholder=""),!U&&P&&_&&(_.value=""),!U&&P&&w&&(w.value=""),B&&(B.classList.add("hidden"),B.innerHTML=""),U&&j()};if(L(n,!1),n==="employee"&&typeof EmployeeHelper<"u"&&r){const k=EmployeeHelper.findByTerm(r);k&&z(k)}b.addEventListener("change",()=>{L(b.value,!0)}),h?.addEventListener("input",()=>{b.value!=="contractor"||!(h.value||"").trim()||v.value.trim()||v.focus()}),typeof this.setupClinicWorkplaceDatalist=="function"&&this.setupClinicWorkplaceDatalist("injury-factory","injury-sub-location","injury-sub-location-datalist",{includeFallbackNameMatch:!0}),q?.addEventListener("change",async k=>{await a.handleInjuryAttachmentsChange(k.target.files)}),typeof a.renderInjuryAttachmentsPreview=="function"?a.renderInjuryAttachmentsPreview():Utils.safeWarn("\u26A0\uFE0F renderInjuryAttachmentsPreview \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");const $=()=>{a.state.currentInjuryAttachments=[],s.remove()};F?.addEventListener("click",$),O?.addEventListener("click",$),Utils.safeLog("\u{1F537} \u062A\u0645 \u0625\u0636\u0627\u0641\u0629 event listener \u0644\u0644\u0646\u0645\u0648\u0630\u062C..."),g.addEventListener("submit",async k=>{Utils.safeLog("\u{1F534} \u062A\u0645 \u0627\u0644\u0636\u063A\u0637 \u0639\u0644\u0649 \u0632\u0631 \u0627\u0644\u062D\u0641\u0638! \u0628\u062F\u0621 \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629...");try{k.preventDefault(),k.stopPropagation(),k.stopImmediatePropagation(),Utils.safeLog("\u{1F504} \u0628\u062F\u0621 \u0645\u0639\u0627\u0644\u062C\u0629 \u0646\u0645\u0648\u0630\u062C \u0627\u0644\u0625\u0635\u0627\u0628\u0629...");const P=b.value,U=P==="employee",R=g.querySelector("#injury-date");if(!R.value){Notification.warning("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}const V=Utils.dateTimeLocalToISO(R.value)||new Date().toISOString(),W=e?.createdAt||new Date().toISOString(),Y=e?.createdBy||a.getCurrentUserSummary(),te=a.getCurrentUserSummary(),ee=_?.value.trim()||"",se=w?.value.trim()||"",K=h?.value?.trim()||"",ae=U?v?.value?.trim()||"":N?.value?.trim()||v?.value?.trim()||"",oe=g.querySelector("#injury-type")?.value||"",re=g.querySelector("#injury-body-part")?.value||"",D=g.querySelector("#injury-location")?.value?.trim()||"",H=g.querySelector("#injury-description")?.value?.trim()||"",Q=E?.value?.trim()||"",G=x?.value?.trim()||"";if(U&&!ae){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644/\u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641");return}if(P==="contractor"&&h){const J=(()=>{try{return JSON.parse(h.dataset.allowedValues||"[]")}catch{return[]}})();if(!K||!J.includes(K.toLowerCase().trim())){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u0645\u0646 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0641\u0642\u0637");return}if(!ae){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0633\u0645 \u0627\u0644\u0645\u0635\u0627\u0628 \u0627\u0644\u062A\u0627\u0628\u0639 \u0644\u0644\u0645\u0642\u0627\u0648\u0644");return}}if(P==="external"&&!ae){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0633\u0645 \u0627\u0644\u0639\u0627\u0645\u0644 \u0627\u0644\u062E\u0627\u0631\u062C\u064A");return}if(!oe){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0646\u0648\u0639 \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}if(!re){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0645\u0643\u0627\u0646 \u0627\u0644\u0625\u0635\u0627\u0628\u0629 (\u0628\u0627\u0644\u062C\u0633\u0645)");return}if(!D){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0645\u0643\u0627\u0646 \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}if(!H){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0648\u0635\u0641 \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}let X="";Q&&(X=y.find(ie=>ie.id===Q||ie.name===Q)?.name||"");const Z=a.normalizeInjuryRecord({id:e?.id||Utils.generateId("INJURY"),personType:P,employeeName:U?v.value.trim():null,employeeCode:U?S?.value.trim()||"":null,employeeNumber:U?S?.value.trim()||"":null,personName:U?null:ae,contractorName:P==="contractor"?K:null,employeePosition:se,contractorPosition:U?null:se,employeeDepartment:ee,department:ee,factory:Q||null,factoryName:X||null,subLocation:G||null,subLocationName:G||null,injuryDate:V,injuryType:oe,injuryBodyPart:re,injuryLocation:D,injuryDescription:H,actionsTaken:g.querySelector("#injury-actions").value.trim(),treatment:g.querySelector("#injury-treatment").value.trim(),status:g.querySelector("#injury-status").value,attachments:a.state.currentInjuryAttachments.map(J=>({...J})),createdAt:W,createdBy:Y,createdById:Y?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:te});Utils.safeLog("\u2705 \u062A\u0645 \u0625\u0646\u0634\u0627\u0621 payload \u0628\u0646\u062C\u0627\u062D:",Z),Loading.show();const ne=AppState.appData.injuries||[];if(t){const J=ne.findIndex(ie=>ie.id===Z.id);J!==-1?ne[J]=Z:ne.push(Z)}else ne.push(Z);AppState.appData.injuries=ne;try{a.calculateClinicCardValues(),a.updateClinicAnalysisResults()}catch(J){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0643\u0631\u0648\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 (\u0625\u0635\u0627\u0628\u0629):",J)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B"),Loading.hide(),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0625\u0635\u0627\u0628\u0629 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0625\u0635\u0627\u0628\u0629 \u0628\u0646\u062C\u0627\u062D"),$(),Utils.safeLog("\u2705 \u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C \u0628\u0646\u062C\u0627\u062D"),setTimeout(()=>{try{Utils.safeLog("\u2705 \u0645\u062D\u0627\u0648\u0644\u0629 \u062A\u062D\u062F\u064A\u062B \u0648\u0627\u062C\u0647\u0629 \u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A..."),document.querySelector('.clinic-tab-panel[data-tab-panel="injuries"]')&&a.state.activeTab==="injuries"&&(Utils.safeLog("\u2705 \u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 panel\u060C \u0633\u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062B\u0647"),a.renderInjuriesTab());const ie=document.querySelector("#total-injuries");ie&&(ie.textContent=ne.length)}catch(J){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0648\u0627\u062C\u0647\u0629 \u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A:",J)}},100),(async()=>{try{t?(await GoogleIntegration.sendRequest({action:"updateInjury",data:{injuryId:Z.id,updateData:Z}}),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A Google Sheets (\u062A\u062D\u062F\u064A\u062B)")):(await GoogleIntegration.sendRequest({action:"addInjury",data:Z}),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A Google Sheets (\u0625\u0636\u0627\u0641\u0629)"))}catch(J){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 Google Sheets:",J)}})()}catch(P){Loading.hide(),Utils.safeError("\u274C \u062E\u0637\u0623 \u0639\u0627\u0645 \u0641\u064A \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0625\u0635\u0627\u0628\u0629:",P),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0625\u0635\u0627\u0628\u0629: "+P.message)}}),s.addEventListener("click",k=>{if(k.target===s){if(!confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`))return;a.state.currentInjuryAttachments=[],s.remove()}})},showVisitForm(e=null,t=null){const a=!!e;if(!document.getElementById("clinic-section")){t&&(t.disabled=!1);return}try{this.ensureData()}catch(o){t&&(t.disabled=!1),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0636\u064A\u0631 \u0646\u0645\u0648\u0630\u062C \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",o);return}typeof Permissions<"u"&&Permissions.ensureFormSettingsState&&Permissions.ensureFormSettingsState().catch(()=>{});const n=document.createElement("div");if(n.className="modal-overlay",n.innerHTML=`
        ...
        `,document.body.appendChild(n),t){const o=new MutationObserver(()=>{document.body.contains(n)||(t.disabled=!1,o.disconnect())});o.observe(document.body,{childList:!0,subtree:!0})}setTimeout(()=>{const o=document.getElementById("visit-person-type"),l=document.getElementById("visit-employee-code"),r=document.getElementById("visit-history-tbody"),c=()=>{if(!r)return;const v=o?.value||"employee",S=l?.value.trim();if(v!=="employee"||!S){r.innerHTML='<tr><td colspan="6" class="text-center text-gray-500 py-4">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</td></tr>';return}const A=(AppState.appData.clinicVisits||[]).filter(T=>T.personType==="employee"&&(T.employeeCode===S||T.employeeNumber===S)).sort((T,h)=>new Date(h.visitDate||h.createdAt)-new Date(T.visitDate||T.createdAt)).slice(0,10);A.length===0?r.innerHTML='<tr><td colspan="6" class="text-center text-gray-500 py-4">\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0633\u0627\u0628\u0642\u0629</td></tr>':r.innerHTML=A.map(T=>`
                        <tr>
                            <td>${T.visitDate?Utils.escapeHTML(Utils.formatDateTime(T.visitDate)):"-"}</td>
                            <td>${T.exitDate?Utils.escapeHTML(Utils.formatDateTime(T.exitDate)):"-"}</td>
                            <td>${Utils.escapeHTML(T.reason||"-")}</td>
                            <td>${Utils.escapeHTML(T.diagnosis||"-")}</td>
                            <td>${Utils.escapeHTML(T.treatment||"-")}</td>
                            <td>${Utils.escapeHTML(T.employeeLocation||T.workArea||"-")}</td>
                        </tr>
                    `).join("")};if(l&&r&&(l.addEventListener("blur",c),l.addEventListener("input",()=>{l.value.trim().length>=3&&c()})),o&&o.addEventListener("change",()=>{const v=document.querySelector("#visit-history-table")?.closest(".mt-6");v&&(v.style.display=o.value==="employee"?"block":"none"),o.value==="employee"&&c()}),e&&e.employeeCode&&c(),e?.personType==="contractor"){const v=document.getElementById("visit-contractor-name-select");v&&(Clinic.loadContractorsIntoSelect(v),(e.employeeName||e.contractorName)&&(v.value=e.employeeName||e.contractorName||""))}typeof Clinic.handlePersonTypeChange=="function"&&Clinic.handlePersonTypeChange(),typeof Clinic.setupClinicWorkplaceDatalist=="function"&&(Clinic.setupClinicWorkplaceDatalist("visit-factory","visit-employee-location","visit-employee-location-datalist"),Clinic.setupClinicWorkplaceDatalist("visit-contractor-factory","visit-work-area","visit-work-area-datalist"));const d=document.getElementById("visit-medication-select"),f=document.getElementById("visit-medications-list"),p=document.getElementById("visit-add-medication-btn"),m=document.getElementById("visit-medication-quantity"),u=document.getElementById("visit-medications-datalist");let y=e?.medications&&Array.isArray(e.medications)?[...e.medications]:[];const g=()=>{if(!d||!u)return;const v=this.getMedications().filter(A=>(A.remainingQuantity??A.quantity??0)<=0?!1:!y.some(M=>M.medicationId===A.id)),S={};u.innerHTML=v.map(A=>{const T=A.remainingQuantity??A.quantity??0,h=`${A.name||""} (\u0645\u062A\u0648\u0641\u0631: ${T})`,M=String(A.name||"").toLowerCase().trim();return M&&(S[M]=A.id),`<option value="${Utils.escapeHTML(h)}"></option>`}).join(""),d.dataset.nameToId=JSON.stringify(S),d.dataset.selectedId=""},b=()=>{if(f){if(y.length===0){f.innerHTML="";return}f.innerHTML=y.map((v,S)=>{const A=this.getMedications().find(T=>T.id===v.medicationId);return`
                        <div class="flex items-center justify-between bg-gray-50 border border-gray-200 rounded px-3 py-2" data-med-id="${v.medicationId||""}">
                            <div>
                                <span class="font-medium">${Utils.escapeHTML(v.medicationName||A?.name||"")}</span>
                    ...
                    `}).join(""),f.querySelectorAll("[data-remove-med]").forEach(v=>{v.addEventListener("click",()=>{const S=parseInt(v.getAttribute("data-remove-med"),10);y.splice(S,1),b(),g()})})}};p&&d&&m&&p.addEventListener("click",()=>{const S=(d.value||"").trim().replace(/\s*\(.*\)\s*$/,"").trim(),A=(()=>{try{return JSON.parse(d.dataset.nameToId||"{}")}catch{return{}}})(),T=d.dataset.selectedId||A[String(S).toLowerCase().trim()]||"",h=parseInt(m.value,10)||1;if(!T){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u062F\u0648\u0627\u0621");return}const M=this.getMedications().find(C=>C.id===T);if(!M){Notification.error("\u0627\u0644\u062F\u0648\u0627\u0621 \u0627\u0644\u0645\u062D\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const I=M.remainingQuantity??M.quantity??0,N=y.filter(C=>C.medicationId===T).reduce((C,w)=>C+(w.quantity||0),0);if(N+h>I){Notification.error(`\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u062A\u0627\u062D\u0629 \u063A\u064A\u0631 \u0643\u0627\u0641\u064A\u0629. \u0627\u0644\u0645\u062A\u0648\u0641\u0631: ${I-N}`);return}y.push({medicationId:T,medicationName:M.name||"",quantity:h}),m.value="1",d.value="",b(),g()}),d&&!d.hasAttribute("data-datalist-attached")&&(d.setAttribute("data-datalist-attached","true"),d.addEventListener("input",()=>{const S=(d.value||"").trim().replace(/\s*\(.*\)\s*$/,"").trim(),A=(()=>{try{return JSON.parse(d.dataset.nameToId||"{}")}catch{return{}}})();d.dataset.selectedId=A[String(S).toLowerCase().trim()]||""}),d.addEventListener("blur",()=>{try{const v=(d.value||"").trim();if(!v)return;const S=v.replace(/\s*\(.*\)\s*$/,"").trim(),A=(()=>{try{return JSON.parse(d.dataset.nameToId||"{}")}catch{return{}}})();!!(d.dataset.selectedId||A[String(S).toLowerCase().trim()])||(d.value="",d.dataset.selectedId="",Notification?.warning?.("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u062F\u0648\u0627\u0621 \u0645\u0646 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0641\u0642\u0637"))}catch{}})),g(),b()},300);const i=n.querySelector("#visit-form");i.addEventListener("submit",async o=>{o.preventDefault(),this.clearVisitFormAlert();const l=i?.querySelector('button[type="submit"]')||o.target?.querySelector('button[type="submit"]');if(l&&l.disabled)return;let r="";l&&(r=l.innerHTML,l.disabled=!0,l.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const c=document.getElementById("visit-person-type"),d=document.getElementById("visit-date"),f=document.getElementById("visit-exit-date");if(!c||!d||!f){this.showVisitFormAlert("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649."),l&&(l.disabled=!1,l.innerHTML=r);return}const p=String(c.value||"").trim().toLowerCase(),m=p==="employee"?"employee":"contractor",u=d.value,y=f.value,g=document.getElementById("visit-contractor-worker")?.value.trim()||"",b=m==="employee"?document.getElementById("visit-employee-location")?.value.trim()||"":document.getElementById("visit-work-area")?.value.trim()||"",v=m==="contractor"?document.getElementById("visit-contractor-position")?.value.trim()||"":null;let S="";if(p==="contractor"){const q=document.getElementById("visit-contractor-name-select"),F=document.getElementById("visit-employee-name");if(S=q?(q.value||"").trim():F?(F.value||"").trim():"",q){const O=(()=>{try{return JSON.parse(q.dataset.allowedValues||"[]")}catch{return[]}})();if(S&&!O.includes(S.toLowerCase().trim())){this.showVisitFormAlert("\u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u064A\u062C\u0628 \u0627\u062E\u062A\u064A\u0627\u0631\u0647 \u0645\u0646 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0641\u0642\u0637"),l&&(l.disabled=!1,l.innerHTML=r);return}}}else{const q=document.getElementById("visit-employee-name");S=q?(q.value||"").trim():""}const A=document.getElementById("visit-medications-list"),T=[];A&&A.querySelectorAll("[data-med-id]").forEach(q=>{const F=q.getAttribute("data-med-id");if(!F)return;const O=q.textContent.match(/×\s*(\d+)/),z=O?parseInt(O[1],10):1,j=q.querySelector(".font-medium"),L=j?j.textContent.trim():"";T.push({medicationId:F,medicationName:L,quantity:z})});const h=m==="employee"?document.getElementById("visit-factory")?.value.trim()||null:document.getElementById("visit-contractor-factory")?.value.trim()||null;let M=null;if(h){const F=this.getSiteOptions().find(O=>O.id===h);M=F?F.name:null}let I=null,N=null;if(u&&u.trim())try{const[q,F]=u.split("T");if(q&&F){const[O,z,j]=q.split("-").map(Number),[L,$]=F.split(":").map(Number),k=new Date(O,z-1,j,L,$,0,0);isNaN(k.getTime())?AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0642\u064A\u0645\u0629 \u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D\u0629:",u):I=k.toISOString()}else{const O=new Date(u);isNaN(O.getTime())||(I=O.toISOString())}}catch(q){AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0648\u064A\u0644 \u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644:",q)}if(y&&y.trim())try{const[q,F]=y.split("T");if(q&&F){const[O,z,j]=q.split("-").map(Number),[L,$]=F.split(":").map(Number),k=new Date(O,z-1,j,L,$,0,0);isNaN(k.getTime())?AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0642\u064A\u0645\u0629 \u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C \u063A\u064A\u0631 \u0635\u062D\u064A\u062D\u0629:",y):N=k.toISOString()}else{const O=new Date(y);isNaN(O.getTime())||(N=O.toISOString())}}catch(q){AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0648\u064A\u0644 \u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C:",q)}const C=AppState.currentUser,w=(C?.email||"").toLowerCase().trim(),_=(AppState.appData.users||[]).find(q=>(q.email||"").toLowerCase().trim()===w)?.name||C?.name||w||"\u0645\u0633\u062A\u062E\u062F\u0645",B={id:e?.id||Utils.generateId("CLINIC_VISIT"),personType:m,employeeName:m==="employee"?S:null,employeeCode:m==="employee"?document.getElementById("visit-employee-code").value.trim():null,employeeNumber:m==="employee"?document.getElementById("visit-employee-code").value.trim():null,employeePosition:m==="employee"?document.getElementById("visit-employee-position")?.value.trim()||"":v||null,contractorPosition:v||null,employeeDepartment:m==="employee"?document.getElementById("visit-employee-department")?.value.trim()||"":null,factory:h,factoryName:M,employeeLocation:m==="employee"?b:null,contractorName:m==="contractor"?S:null,contractorWorkerName:m==="contractor"?g:null,externalName:null,workArea:b||null,visitDate:I,exitDate:N,visitType:document.getElementById("visit-type")?.value?.trim()||null,reason:document.getElementById("visit-reason").value.trim(),diagnosis:document.getElementById("visit-diagnosis").value.trim(),treatment:document.getElementById("visit-treatment").value.trim(),medications:T.length>0?T:null,createdAt:e?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString(),createdBy:e?.createdBy||_,updatedBy:_,email:w,userId:C?.id||""};Loading.show();try{const q=U=>{const R={};return(Array.isArray(U)?U:[]).forEach(V=>{const W=V&&(V.medicationId||V.id)?String(V.medicationId||V.id):"";if(!W)return;const Y=parseInt(V.quantity,10)||0;R[W]=(R[W]||0)+Y}),R},F=a?this.normalizeVisitMedications(e?.medications):[],O=q(F),z=q(T),j=[];new Set([...Object.keys(O),...Object.keys(z)]).forEach(U=>{const R=(z[U]||0)-(O[U]||0);R!==0&&j.push({medicationId:U,delta:R})});const $=j.length>0,k=$?this.getMedications():[];if($)for(const U of j){if(U.delta<=0)continue;const R=k.find(W=>String(W.id)===String(U.medicationId));if(!R)throw new Error("\u0627\u0644\u062F\u0648\u0627\u0621 \u0627\u0644\u0645\u062D\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A \u0627\u0644\u0645\u062E\u0632\u0648\u0646");const V=parseInt(R.remainingQuantity??R.quantity??0,10)||0;if(V<U.delta){const W=R.name||R.medicationName||"\u062F\u0648\u0627\u0621";throw new Error(`\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u062A\u0627\u062D\u0629 \u063A\u064A\u0631 \u0643\u0627\u0641\u064A\u0629 \u0644\u0644\u062F\u0648\u0627\u0621: ${W}. \u0627\u0644\u0645\u062A\u0648\u0641\u0631: ${V}`)}}if(a){const U=AppState.appData.clinicVisits.findIndex(R=>R.id===e.id);U!==-1&&(AppState.appData.clinicVisits[U]=B)}else AppState.appData.clinicVisits.push(B);if($){for(const U of j){const R=k.find(ee=>String(ee.id)===String(U.medicationId));if(!R)continue;const V=parseInt(R.remainingQuantity??R.quantity??0,10)||0;if(!(typeof R.quantityAdded=="number"&&R.quantityAdded>0)&&U.delta>0){const ee=parseInt(R.quantity??0,10)||0;R.quantityAdded=Math.max(ee,V+U.delta)}let Y=V-U.delta;Y=Math.max(0,Y);const te=typeof R.quantityAdded=="number"&&R.quantityAdded>0?R.quantityAdded:typeof R.quantity=="number"&&R.quantity>0?R.quantity:null;te!==null&&(Y=Math.min(te,Y)),R.remainingQuantity=Y}AppState.appData.medications=k,AppState.appData.clinicMedications=k,AppState.appData.clinicInventory=k}try{this.updateClinicAnalysisResults(),this.calculateClinicCardValues()}catch(U){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0625\u062D\u0635\u0627\u0626\u064A\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0645\u062D\u0644\u064A\u0627\u064B:",U)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save();try{const U=this.getMonthlyVisitsAlertThreshold(),R=this.getMonthlyVisitCountForPerson(B);if(R>=U){const V=(B.personType||"").toString().toLowerCase()==="employee"?"\u0627\u0644\u0645\u0648\u0638\u0641":"\u0627\u0644\u0645\u0642\u0627\u0648\u0644/\u0627\u0644\u0639\u0627\u0645\u0644";typeof Notification<"u"&&Notification.warning&&Notification.warning("\u062A\u0646\u0628\u064A\u0647: \u0639\u062F\u062F \u0632\u064A\u0627\u0631\u0627\u062A "+V+" \u0644\u0644\u0639\u064A\u0627\u062F\u0629 \u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631 \u0648\u0635\u0644 \u0623\u0648 \u062A\u062C\u0627\u0648\u0632 "+U+" \u0632\u064A\u0627\u0631\u0629. \u062A\u0645 \u0625\u0634\u0639\u0627\u0631 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645."),this.notifyAdminsAboutHighClinicVisits(B,R).catch(function(W){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F Clinic: \u0641\u0634\u0644 \u0625\u0634\u0639\u0627\u0631 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645 \u0639\u0646 \u062A\u062C\u0627\u0648\u0632 \u062A\u0631\u062F\u062F \u0627\u0644\u0632\u064A\u0627\u0631\u0627\u062A:",W)})}}catch(U){Utils.safeWarn("\u0641\u062D\u0635 \u062A\u0631\u062F\u062F \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0634\u0647\u0631\u064A:",U)}Loading.hide(),Notification.success(`\u062A\u0645 ${a?"\u062A\u062D\u062F\u064A\u062B":"\u062A\u0633\u062C\u064A\u0644"} \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0628\u0646\u062C\u0627\u062D`),n.remove();const P=6e4;(async()=>{try{const U=$&&j.length>0?j.map(R=>({medicationId:String(R.medicationId),delta:Number(R.delta)||0})):null;if(a){const R={...B};U&&(R.medicationAdjustments=U);const V=await GoogleIntegration.sendRequest({action:"updateClinicVisit",data:{visitId:e.id,updateData:R,__timeoutMs:P}});this.assertClinicVisitRpcResult(V)}else{const R={...B,__timeoutMs:P};U&&(R.medicationAdjustments=U);const V=await GoogleIntegration.sendRequest({action:"addClinicVisit",data:R});this.assertClinicVisitRpcResult(V),this.applyClinicVisitIdFromServer(B,V)}$&&(GoogleIntegration.sendRequest({action:"getAllMedications",data:{}}).then(R=>{if(R&&R.success&&Array.isArray(R.data)){const V=R.data.map(W=>this.normalizeMedicationRecord(W));if(AppState.appData.medications=V,AppState.appData.clinicMedications=V,AppState.appData.clinicInventory=V,Utils.safeLog("\u2705 [CLINIC] \u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0645\u064F\u062D\u062F\u064E\u0651\u062B\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645 \u0628\u0639\u062F \u0627\u0644\u0632\u064A\u0627\u0631\u0629: "+V.length+" \u062F\u0648\u0627\u0621"),this.state&&this.state.activeTab==="medications")try{this.renderMedicationsTab()}catch{}}}).catch(()=>{}),document.dispatchEvent(new CustomEvent("data-saved",{detail:{module:"medications",action:"\u062A\u062D\u062F\u064A\u062B",data:{updated:j.length}}}))),document.dispatchEvent(new CustomEvent("data-saved",{detail:{module:"clinicVisits",action:a?"\u062A\u062D\u062F\u064A\u062B":"\u0625\u0636\u0627\u0641\u0629",data:B}})),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),this.refreshClinicVisitsFromServerAfterSave()}catch(U){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",U);try{typeof window.DataManager<"u"&&window.DataManager.addToPendingSync&&window.DataManager.addToPendingSync("ClinicVisits",AppState.appData.clinicVisits)}catch{}try{this.refreshClinicVisitsFromServerAfterSave()}catch{}try{const R=U&&U.message?U.message:"\u0641\u0634\u0644 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Notification.warning("\u26A0\uFE0F \u062A\u0639\u0630\u0651\u0631 \u062A\u0623\u0643\u064A\u062F \u062D\u0641\u0638 \u0627\u0644\u0632\u064A\u0627\u0631\u0629: "+R+". \u0633\u064A\u062A\u0645 \u0627\u0644\u062A\u062D\u0642\u0642 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645.")}catch{}}})(),setTimeout(()=>{document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]')&&this.state.activeTab==="visits"&&this.renderVisitsTab(),$&&document.querySelector('.clinic-tab-panel[data-tab-panel="medications"]')&&this.state.activeTab==="medications"&&this.renderMedicationsTab(),document.querySelector('.clinic-tab-panel[data-tab-panel="dispensed-medications"]')&&this.state.activeTab==="dispensed-medications"&&this.renderDispensedMedicationsTab();const V=document.querySelector("#total-visits");V&&(V.textContent=AppState.appData.clinicVisits.length)},100)}catch(q){Loading.hide(),this.showVisitFormAlert("\u062D\u062F\u062B \u062E\u0637\u0623: "+(q.message||"\u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641")),l&&(l.disabled=!1,l.innerHTML=r)}}),n.addEventListener("click",o=>{o.target===n&&confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.

\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&n.remove()})},async showMedicationForm(e=null){this.ensureData(),e&&(e=this.normalizeMedicationRecord(e));const t=!!e,a=document.createElement("div");a.className="modal-overlay";const s=(A="")=>Utils.escapeHTML(A||""),n=e?.purchaseDate?new Date(e.purchaseDate).toISOString().slice(0,10):"",i=e?.productionDate?new Date(e.productionDate).toISOString().slice(0,10):"",o=e?.expiryDate?new Date(e.expiryDate).toISOString().slice(0,10):"",l=this.calculateMedicationStatus(e||{}),r=e?.quantityAdded??e?.quantity??0,c=e?.remainingQuantity??e?.quantity??0,d=Math.max(0,r-c);a.innerHTML=`
        ...
        `,document.body.appendChild(a);const f=a.querySelector("#medication-form"),p=f.querySelector("#med-purchase"),m=f.querySelector("#med-expiry"),u=f.querySelector("#med-status-badge"),y=f.querySelector("#med-status-hint"),g=f.querySelector("#med-quantity"),b=f.querySelector("#med-remaining"),v=f.querySelector("#med-dispensed"),S=()=>{const A=this.calculateMedicationStatus({expiryDate:m.value?new Date(m.value).toISOString():null});u.className=`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${this.getMedicationStatusClasses(A.status)}`,u.innerHTML=`<i class="fas fa-info-circle"></i>${A.status}`,y.textContent=this.getMedicationStatusHint(A)};m?.addEventListener("change",S),g.addEventListener("input",()=>{const A=parseInt(g.value)||0,T=parseInt(v.value)||0;b.value=Math.max(0,A-T)}),b.addEventListener("input",()=>{const A=parseInt(g.value)||0,T=parseInt(b.value)||0;v.value=Math.max(0,A-T)}),f.addEventListener("submit",async A=>{A.preventDefault();const T=f.querySelector("#med-name").value.trim(),h=f.querySelector("#med-type").value.trim(),M=f.querySelector("#med-usage")?.value.trim()||"",I=f.querySelector("#med-purchase").value,N=f.querySelector("#med-production").value,C=f.querySelector("#med-expiry").value,w=parseInt(f.querySelector("#med-quantity").value,10)||0,E=parseInt(f.querySelector("#med-remaining").value,10)||0,x=f.querySelector("#med-location").value.trim(),_=f.querySelector("#med-notes").value.trim(),B=e?.createdAt||new Date().toISOString(),q=e?.createdBy||this.getCurrentUserSummary(),F=I?new Date(I).toISOString():new Date().toISOString(),O=N?new Date(N).toISOString():new Date().toISOString(),z=C?new Date(C).toISOString():"",j=this.calculateMedicationStatus({expiryDate:z}),L=this.getCurrentUserSummary(),$=this.normalizeMedicationRecord({id:e?.id||Utils.generateId("MED"),name:T,type:h,usage:M,purchaseDate:F,productionDate:O,expiryDate:z,quantityAdded:w,remainingQuantity:E,location:x,notes:_,createdAt:B,createdBy:q,createdById:q?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:L,status:j.status,daysRemaining:j.daysRemaining});Loading.show();try{const k=AppState.appData.medications||[];if(t){const P=k.findIndex(U=>U.id===$.id);P!==-1?k[P]=$:k.push($)}else k.push($);AppState.appData.medications=k,AppState.appData.clinicMedications=k,AppState.appData.clinicInventory=k;try{this.calculateClinicCardValues(),this.updateClinicAnalysisResults()}catch(P){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0643\u0631\u0648\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 (\u062F\u0648\u0627\u0621):",P)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0648\u0627\u0621 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u0648\u0627\u0621 \u0628\u0646\u062C\u0627\u062D"),a.remove(),this.state.medicationAlertsNotified.delete($.id),setTimeout(()=>{document.querySelector('.clinic-tab-panel[data-tab-panel="medications"]')&&this.state.activeTab==="medications"&&this.renderMedicationsTab();const U=document.querySelector("#total-medications");U&&(U.textContent=k.length)},100),(async()=>{try{t?await GoogleIntegration.sendRequest({action:"updateMedication",data:{medicationId:$.id,updateData:$}}):await GoogleIntegration.sendRequest({action:"addMedication",data:$}),pendingNotification&&typeof GoogleIntegration<"u"&&await GoogleIntegration.sendRequest({action:"addNotification",data:{id:Utils.generateId("NOTIF"),title:t?"\u0637\u0644\u0628 \u062A\u0639\u062F\u064A\u0644 \u062F\u0648\u0627\u0621":"\u0637\u0644\u0628 \u0625\u0636\u0627\u0641\u0629 \u062F\u0648\u0627\u0621 \u062C\u062F\u064A\u062F",message:`\u0642\u0627\u0645 ${L.name} \u0628\u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 ${t?"\u062A\u0639\u062F\u064A\u0644":"\u0625\u0636\u0627\u0641\u0629"} \u0644\u0644\u062F\u0648\u0627\u0621: ${$.name}`,type:"alert",targetRoles:["admin","manager"],createdAt:new Date().toISOString(),readBy:[],link:"#clinic-medications"}}),document.dispatchEvent(new CustomEvent("data-saved",{detail:{module:"medications",action:t?"\u062A\u062D\u062F\u064A\u062B":"\u0625\u0636\u0627\u0641\u0629",data:$}}))}catch(P){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 Google Sheets:",P)}})()}catch(k){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+k.message)}}),a.addEventListener("click",A=>{A.target===a&&confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&d.remove()})},printVisitsList(){const e=AppState.appData.clinicVisits.slice().reverse();if(e.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const a=`
        ...
        `,s=window.open("","_blank");s&&(s.document.write(a),s.document.close(),s.onload=()=>{setTimeout(()=>{s.print(),Notification.success("\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u0633\u062C\u0644\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629")},250)})},exportVisitsToExcel(){this.ensureData();const e=this.state.activeVisitType||"employees",t=e==="contractors",a=(AppState.appData.clinicVisits||[]).slice().reverse(),s=a.filter(o=>o.personType==="employee"||!o.personType),n=a.filter(o=>o.personType==="contractor"),i=e==="employees"?s:n;if(i.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}if(typeof XLSX>"u"){Notification.error("\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629");return}try{const o=i.map(d=>{const f=t?d.contractorName||d.employeeName||d.externalName||"-":d.employeeCode||d.employeeNumber||"-",p=t?d.contractorWorkerName||"-":d.employeeName||"-",m=d.employeePosition||d.contractorPosition||"-",u=this.getVisitFactoryDisplayName(d),y=t?d.workArea||d.employeeLocation||"-":d.employeeLocation||d.workArea||"-",g=d.visitDate?Utils.formatDateTime(d.visitDate):"-",b=d.exitDate?Utils.formatDateTime(d.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",v=this.calculateTotalTime(d.visitDate,d.exitDate),S=d.reason||"",A=d.diagnosis||"",T=this.normalizeVisitMedications(d.medications),h=T.length>0?T.map(N=>`${N.medicationName||""} (${N.quantity||1})`).join("\u060C "):"-",M=T.length>0?T.reduce((N,C)=>N+(parseInt(C.quantity,10)||0),0):0,I={};return I[t?"\u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A"]=f,I.\u0627\u0644\u0627\u0633\u0645=p,I.\u0627\u0644\u0648\u0638\u064A\u0641\u0629=m,I.\u0627\u0644\u0645\u0635\u0646\u0639=u,I["\u0645\u0643\u0627\u0646 \u0627\u0644\u0639\u0645\u0644"]=y,I["\u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644"]=g,I["\u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C"]=b,I["\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0648\u0642\u062A"]=v,I["\u0633\u0628\u0628 \u0627\u0644\u0632\u064A\u0627\u0631\u0629"]=S,I.\u0627\u0644\u062A\u0634\u062E\u064A\u0635=A,I["\u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629"]=h,I["\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629"]=M,I}),l=XLSX.utils.book_new(),r=XLSX.utils.json_to_sheet(o);r["!cols"]=[{wch:18},{wch:25},{wch:20},{wch:16},{wch:20},{wch:20},{wch:20},{wch:15},{wch:25},{wch:25},{wch:30},{wch:14}],XLSX.utils.book_append_sheet(l,r,`\u0633\u062C\u0644\u0627\u062A_${t?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646":"\u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646"}`);const c=`\u0633\u062C\u0644\u0627\u062A_\u0627\u0644\u0632\u064A\u0627\u0631\u0629_${t?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646":"\u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646"}_\u0627\u0644\u0639\u064A\u0627\u062F\u0629_\u0627\u0644\u0637\u0628\u064A\u0629_${new Date().toISOString().slice(0,10)}.xlsx`;XLSX.writeFile(l,c),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0633\u062C\u0644\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0625\u0644\u0649 Excel \u0628\u0646\u062C\u0627\u062D")}catch(o){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 Excel:",o),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 Excel: "+o.message)}},async exportVisitsToPDF(){this.ensureData();const e=this.state.activeVisitType||"employees",t=e==="contractors",a=(AppState.appData.clinicVisits||[]).slice().reverse(),s=a.filter(o=>o.personType==="employee"||!o.personType),n=a.filter(o=>o.personType==="contractor"),i=e==="employees"?s:n;if(i.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}try{const o=i.map(u=>{const y=t?u.contractorName||u.employeeName||u.externalName||"-":u.employeeCode||u.employeeNumber||"-",g=t?u.contractorWorkerName||"-":u.employeeName||"-",b=t?u.contractorPosition||u.employeePosition||"-":u.employeePosition||"-",v=this.getVisitFactoryDisplayName(u),S=t?u.workArea||u.employeeLocation||"-":u.employeeLocation||u.workArea||"-",A=u.visitDate?Utils.formatDateTime(u.visitDate):"-",T=u.exitDate?Utils.formatDateTime(u.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",h=Clinic.calculateTotalTime(u.visitDate,u.exitDate),M=u.reason||"",I=u.diagnosis||"",N=this.normalizeVisitMedications(u.medications),C=N.length>0?N.map(E=>`${Utils.escapeHTML(E.medicationName||"")} (${E.quantity||1})`).join("\u060C "):"-",w=N.length>0?N.reduce((E,x)=>E+(parseInt(x.quantity,10)||0),0):0;return`
            ...
            `,d=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(l,r,c,!1,!0,{source:"ClinicVisits"},new Date().toISOString(),new Date().toISOString()):`<html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>${r}</title></head><body>${c}</body></html>`,f=new Blob([d],{type:"text/html;charset=utf-8"}),p=URL.createObjectURL(f),m=window.open(p,"_blank");m?m.onload=()=>{setTimeout(()=>{m.print(),setTimeout(()=>{URL.revokeObjectURL(p)},1e3),Notification.success("\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u0633\u062C\u0644\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629/\u0627\u0644\u062D\u0641\u0638 \u0643\u0640 PDF")},250)}:(URL.revokeObjectURL(p),Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF"))}catch(o){URL.revokeObjectURL(url),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF:",o),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF: "+o.message)}},async exportVisitToPDF(e){if(!e){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}try{const t=e.personType==="employee"?"\u0645\u0648\u0638\u0641":e.personType==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0639\u0645\u0627\u0644\u0629 \u062E\u0627\u0631\u062C\u064A\u0629",a=e.employeeCode||e.employeeNumber||"-",s=e.employeeName||e.contractorName||e.externalName||"",n=e.contractorWorkerName?` (${e.contractorWorkerName})`:"",i=e.employeePosition||e.contractorPosition||"-",o=e.employeeLocation||e.workArea||"-",l=e.visitDate?Utils.formatDateTime(e.visitDate):"-",r=e.exitDate?Utils.formatDateTime(e.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",c=this.calculateTotalTime(e.visitDate,e.exitDate),d=e.reason||"",f=e.diagnosis||"",p=e.treatment||"",m=e.medications&&Array.isArray(e.medications)&&e.medications.length>0?e.medications.map(T=>`${Utils.escapeHTML(T.medicationName||"")} (${T.quantity||1})`).join("\u060C "):"\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629",u=`CLINIC-VISIT-${e.id||new Date().toISOString().slice(0,10)}`,y="\u062A\u0642\u0631\u064A\u0631 \u0632\u064A\u0627\u0631\u0629 \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0637\u0628\u064A\u0629",g=`
                <div style="margin-bottom: 20px;">
...
<div class="att-report-doc" id="attendance-report-root">
    ...
    <div class="att-report-footer">${s} \u2014 \u062A\u0642\u0631\u064A\u0631 \u062D\u0636\u0648\u0631 \u0645\u0633\u0626\u0648\u0644\u064A \u0627\u0644\u0639\u064A\u0627\u062F\u0629</div>
            ...
            <div id="clinic-attendance-self-root">
                ...
                <div id="clinic-attendance-filter-panel" style="display:${g?"block":"none"};background:#f0fdfa;border:1.5px solid #99f6e4;border-radius:12px;padding:14px;margin-bottom:14px;">
                    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px;">
                        <div><label style="${T}">\u0627\u0644\u0634\u0647\u0631</label><input type="month" id="clinic-attendance-month" style="${A}" value="${Utils.escapeAttr(l.month||"")}"></div>
                        <div><label style="${T}">\u0627\u0644\u062D\u0627\u0644\u0629</label>
                            <select id="clinic-attendance-status" style="${A}">
                        ...
                        <div><label style="${T}">\u0645\u0646 \u062A\u0627\u0631\u064A\u062E</label><input type="date" id="clinic-attendance-from" style="${A}" value="${Utils.escapeAttr(l.dateFrom||"")}"></div>
                        <div><label style="${T}">\u0625\u0644\u0649 \u062A\u0627\u0631\u064A\u062E</label><input type="date" id="clinic-attendance-to" style="${A}" value="${Utils.escapeAttr(l.dateTo||"")}"></div>
                    </div>
        ...
        `).join(""):'<tr><td colspan="10" class="text-center text-gray-500 py-8"><i class="fas fa-calendar-times ml-2 opacity-60"></i>\u0644\u0627 \u062A\u0648\u062C\u062F \u0633\u062C\u0644\u0627\u062A \u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0644\u0641\u0644\u0627\u062A\u0631</td></tr>',B=b?c.length?c.map(L=>{const $=String(L.isActive||"true").toLowerCase()!=="false";return`<tr>
                <td>${Utils.escapeHTML(L.userName||"\u2014")}</td>
                <td>${Utils.escapeHTML(this.getStaffRoleLabel(L.staffRole))}</td>
            ...
            <div id="clinic-attendance-root" style="font-family:inherit;">
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(155px,1fr));gap:10px;margin-bottom:14px;">
                    ${[{label:"\u062D\u0627\u0636\u0631\u0648\u0646 \u0627\u0644\u064A\u0648\u0645",value:y,icon:"fa-user-check",color:"#059669",bg:"#ecfdf5"},{label:"\u0628\u062F\u0648\u0646 \u062A\u0633\u062C\u064A\u0644 \u062E\u0631\u0648\u062C",value:g,icon:"fa-door-open",color:"#d97706",bg:"#fffbeb"},{label:"\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0641\u0644\u062A\u0631",value:r.length,icon:"fa-filter",color:"#2563eb",bg:"#eff6ff"},{label:"\u0645\u0633\u0626\u0648\u0644\u0648\u0646 \u0646\u0634\u0637\u0648\u0646",value:f.length,icon:"fa-users",color:"#4f46e5",bg:"#eef2ff"}].map(L=>`
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:12px;padding:14px 18px;background:linear-gradient(135deg,#134e4a 0%,#0d9488 100%);border-radius:14px;color:#fff;box-shadow:0 4px 18px rgba(13,148,136,0.28);">
                    ...
                    <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
                        ...
                        <button type="button" id="clinic-attendance-toggle-filters" style="padding:6px 12px;border-radius:8px;border:1px solid rgba(255,255,255,0.35);cursor:pointer;background:rgba(255,255,255,0.12);color:#fff;font-size:0.76rem;font-weight:600;display:flex;align-items:center;gap:5px;">
                            ...
                            ${A?`<span style="background:#fbbf24;color:#78350f;font-size:0.65rem;padding:1px 6px;border-radius:10px;">${A}</span>`:""}
                        </button>
                ...
                <!-- \u0644\u0648\u062D\u0629 \u0627\u0644\u0641\u0644\u0627\u062A\u0631 -->
                <div id="clinic-attendance-filter-panel" style="display:${T?"block":"none"};background:#f0fdfa;border:1.5px solid #99f6e4;border-radius:12px;padding:16px 18px;margin-bottom:14px;">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;flex-wrap:wrap;gap:8px;">
                        <div style="display:flex;align-items:center;gap:8px;">
                            <i class="fas fa-sliders-h" style="color:#0d9488;font-size:14px;"></i>
                            <span style="font-weight:700;font-size:0.88rem;color:#134e4a;">\u0641\u0644\u0627\u062A\u0631 \u0627\u0644\u0628\u062D\u062B</span>
                            ${A?`<span style="background:#ccfbf1;color:#0f766e;padding:2px 8px;border-radius:12px;font-size:0.72rem;font-weight:600;">${A} \u0646\u0634\u0637</span>`:'<span style="color:#94a3b8;font-size:0.72rem;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0641\u0644\u0627\u062A\u0631 \u0646\u0634\u0637\u0629</span>'}
                        </div>
