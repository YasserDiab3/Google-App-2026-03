...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&c()})},editSickLeave(e){const t=this.getSickLeaves().find(a=>a.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629");return}this.showSickLeaveForm(t)},printSickLeaveRecord(e){const t=this.getSickLeaves().find(c=>c.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const a=t.employeeName||t.personName||"",i=t.employeeDepartment||"\u2014",n=t.treatingDoctor||"\u2014",s=t.daysCount??this.calculateSickLeaveDays(t.startDate,t.endDate),o=`
        ...
        <div id="clinic-analytics-root" style="font-family:inherit;">
            ...
            <div class="content-card" style="padding:0;overflow:hidden;">
        ...
        </div>`,this.applyModuleI18n(e),setTimeout(()=>{this.updateClinicAnalyticsDashboard(),this._clinicBindAnalyticsEvents()},80))},bindDataAnalysisTabEvents(e){},async updateClinicAnalyticsDashboard(){const e=document.getElementById("clinic-analytics-root");if(!e)return;try{this.ensureData()}catch{}const t=parseInt(this._clinicPeriod||"0",10),a=this.getActualClinicVisits_(AppState.appData?.clinicVisits),i=AppState.appData?.clinicMedications||[],n=AppState.appData?.sickLeave||[],s=AppState.appData?.injuries||[],o=AppState.appData?.clinicSupplyRequests||[],l=t>0?(()=>{const $=new Date;return $.setDate($.getDate()-t),$})():null,r=($,P)=>l?$.filter(W=>{const Q=new Date(W[P]||W.createdAt||"");return!isNaN(Q.getTime())&&Q>=l}):$,c=r(a,"visitDate"),d=r(n,"startDate"),p=r(s,"injuryDate");this._clinicPopulateFilters(c);const f=this._clinicApplyFilters(c),m=f.length,u=document.getElementById("clinic-filter-count");u&&(u.textContent=`${m} \u0632\u064A\u0627\u0631\u0629`);const g=f.filter($=>String($.personType||"").toLowerCase()!=="contractor"),y=f.filter($=>String($.personType||"").toLowerCase()==="contractor"),v=new Date,h=f.filter($=>{const P=new Date($.visitDate||$.createdAt||"");return P.getFullYear()===v.getFullYear()&&P.getMonth()===v.getMonth()}).length,w=i.filter($=>$.status==="\u0645\u0646\u062A\u0647\u064A").length,L=i.filter($=>$.status==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621").length,E=d.filter($=>!$.status||$.status==="\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629").length,b=new Set(f.map($=>{const P=new Date($.visitDate||$.createdAt||"");return isNaN(P.getTime())?null:`${P.getFullYear()}-${P.getMonth()}`}).filter(Boolean)).size,M=b>0?(m/b).toFixed(1):0,U=this.analyzeDispensedMedications_(f,i),N=document.getElementById("clinic-kpi-strip");if(N){const $=[{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0632\u064A\u0627\u0631\u0627\u062A",value:m,icon:"fas fa-hospital-user",color:"#0d9488",bg:"#f0fdfa",border:"#99f6e4"},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646",value:g.length,icon:"fas fa-user-tie",color:"#3b82f6",bg:"#eff6ff",border:"#bfdbfe"},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646",value:y.length,icon:"fas fa-hard-hat",color:"#f97316",bg:"#fff7ed",border:"#fed7aa"},{label:"\u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0631\u0636\u064A\u0629",value:d.length,icon:"fas fa-notes-medical",color:"#f59e0b",bg:"#fffbeb",border:"#fde68a"},{label:"\u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A",value:p.length,icon:"fas fa-user-injured",color:"#ef4444",bg:"#fef2f2",border:"#fecaca"},{label:"\u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u062A\u0647\u064A\u0629",value:w,icon:"fas fa-pills",color:"#dc2626",bg:"#fef2f2",border:"#fca5a5"},{label:"\u0642\u0631\u064A\u0628\u0629 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621",value:L,icon:"fas fa-exclamation",color:"#d97706",bg:"#fffbeb",border:"#fde68a"},{label:"\u0625\u062C\u0627\u0632\u0627\u062A \u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629",value:E,icon:"fas fa-clock",color:"#8b5cf6",bg:"#f5f3ff",border:"#ddd6fe"},{label:"\u0645\u062A\u0648\u0633\u0637 \u0634\u0647\u0631\u064A",value:M,icon:"fas fa-calendar-check",color:"#6366f1",bg:"#eef2ff",border:"#c7d2fe"}];N.innerHTML=$.map(P=>`
                ...
                </div>`).join("")}const S=document.getElementById("clinic-med-analysis-summary");S&&(S.textContent=U.totalDispensedQty>0?`${U.uniqueMedicines} \u062F\u0648\u0627\u0621 \u0645\u062E\u062A\u0644\u0641 \u2022 ${U.dispenseLines} \u0639\u0645\u0644\u064A\u0629 \u0635\u0631\u0641 \u2022 ${U.visitsWithMedications} \u0632\u064A\u0627\u0631\u0629 \u0628\u062F\u0648\u0627\u0621`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629 \u0636\u0645\u0646 \u0627\u0644\u0641\u0644\u0627\u062A\u0631 \u0627\u0644\u062D\u0627\u0644\u064A\u0629");const T=document.getElementById("clinic-med-kpi-strip");if(T){const $=[{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629",value:U.totalDispensedQty,icon:"fas fa-prescription-bottle-alt",color:"#10b981",bg:"#ecfdf5",border:"#a7f3d0"},{label:"\u0623\u062F\u0648\u064A\u0629 \u0645\u062E\u062A\u0644\u0641\u0629",value:U.uniqueMedicines,icon:"fas fa-pills",color:"#059669",bg:"#f0fdf4",border:"#bbf7d0"},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0628\u0635\u0631\u0641 \u062F\u0648\u0627\u0621",value:U.visitsWithMedications,icon:"fas fa-capsules",color:"#0d9488",bg:"#f0fdfa",border:"#99f6e4"},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0628\u062F\u0648\u0646 \u062F\u0648\u0627\u0621",value:U.visitsWithoutMedications,icon:"fas fa-hospital",color:"#64748b",bg:"#f8fafc",border:"#e2e8f0"},{label:"\u0639\u0645\u0644\u064A\u0627\u062A \u0635\u0631\u0641",value:U.dispenseLines,icon:"fas fa-hand-holding-medical",color:"#0891b2",bg:"#ecfeff",border:"#a5f3fc"}];T.innerHTML=$.map(P=>`
                <div style="background:${P.bg};border:1px solid ${P.border};border-radius:12px;padding:11px 12px;text-align:center;">
                    ...
                    <div style="font-size:0.65rem;color:#64748b;margin-top:2px;">${P.label}</div>
                </div>`).join("")}if(!await this.ensureChartJSLoaded()||typeof Chart>"u"){e.insertAdjacentHTML("afterbegin",'<div style="background:#fffbeb;border:1px solid #fde68a;border-radius:10px;padding:14px 18px;margin-bottom:16px;display:flex;align-items:center;gap:10px;"><i class="fas fa-exclamation-triangle" style="color:#d97706;"></i><span style="font-size:0.85rem;color:#92400e;">\u062A\u0639\u0630\u0651\u0631 \u062A\u062D\u0645\u064A\u0644 \u0645\u0643\u062A\u0628\u0629 \u0627\u0644\u0631\u0633\u0648\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u064A\u0629.</span></div>');return}const x={};f.forEach($=>{const P=String($.personType||"").toLowerCase()==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0645\u0648\u0638\u0641";x[P]=(x[P]||0)+1}),this._cDoughnut("clinic-chart-ptype",Object.keys(x),Object.values(x),["rgba(59,130,246,0.85)","rgba(249,115,22,0.85)"]),this._cTrend("clinic-chart-trend",a,"visitDate");const k=this._cGroupBy(f,$=>$.reason||$.diagnosis||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",10);this._cHBar("clinic-chart-reason",k.labels,k.data,"rgba(13,148,136,0.75)");const _=this._cGroupBy(f,$=>$.employeeLocation||$.workArea||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",10),R=document.getElementById("clinic-locs-list");R&&(m===0||_.labels.length===0?R.innerHTML='<div style="text-align:center;color:#94a3b8;font-size:0.85rem;padding:40px 0;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</div>':R.innerHTML=_.labels.map(($,P)=>{const W=_.data[P],Q=Math.round(W/m*100);return`
                        <div style="display:flex;flex-direction:column;gap:5px;border-bottom:1px solid #f1f5f9;padding-bottom:8px;cursor:pointer;transition:background 0.2s;padding-left:4px;padding-right:4px;" 
                             ...
                             onclick="const el = document.getElementById('clinic-af-loc'); if(el){el.value='${Utils.escapeHTML($)}'; el.dispatchEvent(new Event('change'));}">
                            <div style="display:flex;justify-content:space-between;align-items:center;">
                                <div style="display:flex;align-items:center;gap:6px;min-width:0;flex:1;">
                                    ...
                                    <span style="font-size:0.78rem;font-weight:700;color:#374151;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;" title="${Utils.escapeHTML($)}">${Utils.escapeHTML($)}</span>
                                </div>
                    ...
                    `}).join(""));const q=this._cGroupBy(f,$=>$.employeeDepartment||$.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",10),H=document.getElementById("clinic-depts-list");H&&(m===0||q.labels.length===0?H.innerHTML='<div style="text-align:center;color:#94a3b8;font-size:0.85rem;padding:40px 0;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</div>':H.innerHTML=q.labels.map(($,P)=>{const W=q.data[P],Q=Math.round(W/m*100);return`
                        <div style="cursor:pointer;padding:4px;border-radius:6px;transition:background 0.2s;" 
                             onmouseover="this.style.background='#eff6ff'" 
                             onmouseout="this.style.background='transparent'"
                             onclick="const el = document.getElementById('clinic-af-dept'); if(el){el.value='${Utils.escapeHTML($)}'; el.dispatchEvent(new Event('change'));}">
                            <div style="display:flex;justify-content:space-between;font-size:0.8rem;font-weight:700;color:#374151;margin-bottom:4px;">
                                <span>${Utils.escapeHTML($)}</span>
                    ...
                    `}).join(""));const V=document.getElementById("clinic-factories-cards");if(V)if(m===0)V.innerHTML='<div style="text-align:center;color:#94a3b8;font-size:0.85rem;padding:40px 0;grid-column:1/-1;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</div>';else{const $=new Set(c.map(W=>String(W.factoryName||W.factory||"").trim()).filter(W=>W&&W!=="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F")),P=Array.from($).sort();P.length===0?V.innerHTML='<div style="text-align:center;color:#94a3b8;font-size:0.85rem;padding:40px 0;grid-column:1/-1;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0635\u0627\u0646\u0639</div>':V.innerHTML=P.map((W,Q)=>{const J=f.filter(pe=>(pe.factoryName||pe.factory||"").trim()===W).length,ce=m>0?Math.round(J/m*100):0,de=[{primary:"#0284c7",light:"#e0f2fe",progress:"linear-gradient(90deg, #38bdf8 0%, #0284c7 100%)"},{primary:"#059669",light:"#ecfdf5",progress:"linear-gradient(90deg, #34d399 0%, #059669 100%)"},{primary:"#7c3aed",light:"#f5f3ff",progress:"linear-gradient(90deg, #a78bfa 0%, #7c3aed 100%)"},{primary:"#ea580c",light:"#fff7ed",progress:"linear-gradient(90deg, #fb923c 0%, #ea580c 100%)"},{primary:"#db2777",light:"#fdf2f8",progress:"linear-gradient(90deg, #f472b6 0%, #db2777 100%)"}],le=de[Q%de.length];return`
                        ...
                        `}).join("")}const B=f.filter($=>{const P=String($.contractorName||"").trim(),W=String($.externalName||"").trim(),Q=String($.personType||"").trim().toLowerCase();return P||W||Q==="contractor"||Q==="external"}),A=this._cGroupBy(B,$=>String($.contractorName||$.externalName||"").trim()||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",8),I=document.getElementById("clinic-chart-contractor-count");I&&(I.textContent=B.length>0?`${B.length} \u0632\u064A\u0627\u0631\u0629 \u2022 ${A.labels.length} \u0645\u0642\u0627\u0648\u0644`:""),this._cHBar("clinic-chart-contractor",A.labels,A.data,"rgba(8,145,178,0.75)");const C=this._cGroupBy(d,$=>$.status||"\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629"),z={\u0645\u0639\u062A\u0645\u062F\u0629:"rgba(16,185,129,0.85)",\u0645\u0631\u0641\u0648\u0636\u0629:"rgba(239,68,68,0.85)","\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629":"rgba(245,158,11,0.85)"};this._cDoughnut("clinic-chart-sl-status",C.labels,C.data,C.labels.map($=>z[$]||"rgba(148,163,184,0.8)"));const j=this._cGroupBy(p,$=>$.injuryType||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",8);this._cHBar("clinic-chart-inj-type",j.labels,j.data,"rgba(239,68,68,0.75)");const F=this._cGroupBy(i,$=>$.status||"\u0633\u0627\u0631\u064A"),O={\u0633\u0627\u0631\u064A:"rgba(16,185,129,0.85)",\u0645\u0646\u062A\u0647\u064A:"rgba(239,68,68,0.85)","\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621":"rgba(245,158,11,0.85)"};this._cDoughnut("clinic-chart-med-status",F.labels,F.data,F.labels.map($=>O[$]||"rgba(148,163,184,0.8)")),this._cCompare("clinic-chart-compare",a,n,s);const X=U.topByQuantity.slice(0,10);this._cHBar("clinic-chart-med-top-qty",X.map($=>$.name),X.map($=>$.totalQty),"rgba(16,185,129,0.78)");const Y=U.byMonth.labels,ae=U.byMonth.data;if(Y.length&&ae.reduce(($,P)=>$+P,0)>0){const $=document.getElementById("clinic-chart-med-monthly"),P=document.getElementById("clinic-chart-med-monthly-empty");if($){P&&(P.style.display="none"),$.style.display="",this._clinicCharts||(this._clinicCharts={});try{this._clinicCharts["clinic-chart-med-monthly"]&&this._clinicCharts["clinic-chart-med-monthly"].destroy()}catch{}this._clinicCharts["clinic-chart-med-monthly"]=new Chart($,{type:"line",data:{labels:Y,datasets:[{label:"\u0643\u0645\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629",data:ae,borderColor:"rgba(5,150,105,0.9)",backgroundColor:"rgba(16,185,129,0.12)",borderWidth:2.5,pointRadius:4,tension:.35,fill:!0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10},maxRotation:45}},y:{beginAtZero:!0,ticks:{precision:0,font:{size:11}},grid:{color:"#f1f5f9"}}}}})}}else{const $=document.getElementById("clinic-chart-med-monthly"),P=document.getElementById("clinic-chart-med-monthly-empty");$&&($.style.display="none"),P&&(P.style.display="flex")}this._cDoughnut("clinic-chart-med-ptype",["\u0645\u0648\u0638\u0641","\u0645\u0642\u0627\u0648\u0644"],[U.byPersonType.\u0645\u0648\u0638\u0641||0,U.byPersonType.\u0645\u0642\u0627\u0648\u0644||0],["rgba(59,130,246,0.85)","rgba(249,115,22,0.85)"]),this._cHBar("clinic-chart-med-dept",U.byDepartment.labels,U.byDepartment.data,"rgba(99,102,241,0.75)");const Z=document.getElementById("clinic-med-table-count"),oe=document.getElementById("clinic-med-top-tbody"),ee=U.topByQuantity.slice(0,15);Z&&(Z.textContent=ee.length?`${ee.length} \u062F\u0648\u0627\u0621`:""),oe&&(oe.innerHTML=ee.length===0?'<tr><td colspan="9" style="padding:24px;text-align:center;color:#94a3b8;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629 \u0641\u064A \u0627\u0644\u0641\u062A\u0631\u0629 \u0627\u0644\u0645\u062D\u062F\u062F\u0629</td></tr>':ee.map(($,P)=>{const W=$.stockRemaining===null?"\u2014":Number($.stockRemaining).toLocaleString("en-US"),Q=$.stockRemaining!==null&&$.stockRemaining<=10?"#dc2626":"#0f766e",G=$.stockStatus==="\u0645\u0646\u062A\u0647\u064A"?"#dc2626":$.stockStatus==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621"?"#d97706":"#64748b",J=P%2===0?"#fff":"#fafafa";return`<tr style="border-bottom:1px solid #f8fafc;background:${J};" onmouseover="this.style.background='#ecfdf5'" onmouseout="this.style.background='${J}'">
                        <td style="padding:9px 12px;font-weight:700;color:#64748b;">${P+1}</td>
                        <td style="padding:9px 12px;font-weight:600;color:#047857;">${Utils.escapeHTML($.name)}</td>
                        <td style="padding:9px 12px;text-align:center;font-weight:700;">${Number($.totalQty).toLocaleString("en-US")}</td>
                        <td style="padding:9px 12px;text-align:center;">${$.dispenseCount}</td>
                        <td style="padding:9px 12px;text-align:center;">${$.visitsCount}</td>
                        <td style="padding:9px 12px;text-align:center;">${$.avgQty}</td>
                        <td style="padding:9px 12px;">${Utils.escapeHTML($.type)}</td>
                        <td style="padding:9px 12px;text-align:center;font-weight:700;color:${Q};">${W}</td>
                        <td style="padding:9px 12px;color:${G};">${Utils.escapeHTML($.stockStatus)}</td>
                    </tr>`}).join(""));const te=document.getElementById("clinic-med-low-stock-alert"),se=document.getElementById("clinic-med-low-stock-list");te&&se&&(U.lowStockHighDemand.length>0?(te.style.display="block",se.innerHTML=U.lowStockHighDemand.map($=>`<li><strong>${Utils.escapeHTML($.name)}</strong>: \u0645\u0646\u0635\u0631\u0641 ${$.totalQty} \u2014 \u0645\u062E\u0632\u0648\u0646 ${$.stockRemaining??"\u2014"}</li>`).join("")):(te.style.display="none",se.innerHTML=""));const K={};f.forEach($=>{const P=$.contractorWorkerName||$.employeeName||$.externalName||$.personName||$.name||"",W=String(P).trim(),Q=String($.contractorName||"").trim(),G=W||(Q?Q+" (\u0628\u062F\u0648\u0646 \u0627\u0633\u0645 \u0639\u0627\u0645\u0644)":"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F");K[G]||(K[G]={count:0,dept:"",loc:""}),K[G].count++,K[G].dept||(K[G].dept=$.employeeDepartment||$.department||$.contractorName||$.contractorPosition||"\u2014"),K[G].loc||(K[G].loc=$.employeeLocation||$.workArea||$.factoryName||$.factory||"\u2014")});const ne=Object.entries(K).sort(($,P)=>P[1].count-$[1].count).slice(0,15),re=document.getElementById("clinic-top-visitors-count"),ie=document.getElementById("clinic-top-visitors-tbody");re&&(re.textContent=`${ne.length} \u0634\u062E\u0635`),ie&&(ie.innerHTML=ne.length===0?'<tr><td colspan="5" style="padding:24px;text-align:center;color:#94a3b8;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0632\u064A\u0627\u0631\u0627\u062A</td></tr>':ne.map(([$,P],W)=>{const Q=W%2===0?"#fff":"#fafafa",G=P.count>=5?"#dc2626":P.count>=3?"#f59e0b":"#0d9488";return`<tr style="border-bottom:1px solid #f8fafc;background:${Q};" onmouseover="this.style.background='#f0fdfa'" onmouseout="this.style.background='${Q}'">
                        <td style="padding:9px 12px;font-weight:700;color:#64748b;">${W+1}</td>
                        <td style="padding:9px 12px;font-weight:600;color:#0f766e;">${Utils.escapeHTML($)}</td>
        ...
        `,i=`CLINIC-DATA-ANALYSIS-${new Date().toISOString().slice(0,10)}`,n=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(i,"\u062A\u062D\u0644\u064A\u0644 \u0634\u0627\u0645\u0644 \u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0637\u0628\u064A\u0629",a,!1,!0):`<html><body>${a}</body></html>`;try{const s=new Blob([n],{type:"text/html;charset=utf-8"}),o=URL.createObjectURL(s),l=window.open(o,"_blank");l?(l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>URL.revokeObjectURL(o),1e3)},400)},Notification?.success?.("\u062C\u0627\u0631\u064A \u062A\u062D\u0636\u064A\u0631 \u0645\u0644\u0641 PDF \u0644\u0644\u0637\u0628\u0627\u0639\u0629...")):Notification?.error?.("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF")}catch(s){Utils.safeError("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 \u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",s),Notification?.error?.("\u062A\u0639\u0630\u0631 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644")}},scheduleVisitsTabRender(e=!1,t=0){this._visitsRenderTimer&&(clearTimeout(this._visitsRenderTimer),this._visitsRenderTimer=null);const a=()=>{this._visitsRenderTimer=null,requestAnimationFrame(()=>{this.renderVisitsTab(e)})};this._visitsRenderTimer=setTimeout(a,Math.max(0,t))},scheduleAttendanceTabRender(e=0){this._attendanceRenderTimer&&(clearTimeout(this._attendanceRenderTimer),this._attendanceRenderTimer=null);const t=()=>{this._attendanceRenderTimer=null,requestAnimationFrame(()=>{this.renderAttendanceTab()})};this._attendanceRenderTimer=setTimeout(t,Math.max(0,e))},scheduleMedicationsTabRender(e=0){this._medicationsRenderTimer&&(clearTimeout(this._medicationsRenderTimer),this._medicationsRenderTimer=null);const t=()=>{this._medicationsRenderTimer=null,requestAnimationFrame(()=>{this.renderMedicationsTab()})};this._medicationsRenderTimer=setTimeout(t,Math.max(0,e))},async renderVisitsTab(e=!1){try{const t=document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]');if(!t){Utils.safeWarn("\u26A0\uFE0F \u0644\u0648\u062D\u0629 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}this.ensureData(),this.ensureFilterDefaults();const a=this.shouldFetchClinicVisitsFromBackend({forceRefresh:e});this.renderVisitsTabContent(t),a&&typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest&&this.loadVisitsDataFromBackend().then(()=>{const i=document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]');i&&this.state&&this.state.activeTab==="visits"&&(this.ensureData(),this.renderVisitsTabContent(i)),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0628\u0639\u062F \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 \u0627\u0644\u062E\u0627\u062F\u0645 (\u0628\u062F\u0648\u0646 \u062D\u062C\u0628 \u0627\u0644\u0648\u0627\u062C\u0647\u0629)")}).catch(i=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645:",i&&i.message)})}catch(t){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u0639\u0631\u0636 \u062A\u0628\u0648\u064A\u0628 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F:",t);const a=document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]');a&&(a.innerHTML=`
            ...
            `:this.renderEmptyState(t(l?"empty.noResults":i==="employees"?"empty.noEmployeeVisits":"empty.noContractorVisits")),h=a?"ml-2":"mr-2",w=a?"mr-2":"ml-2",L=a?"ml-1":"mr-1",E=`
            ...
            ${v}
        `;e.innerHTML=E,this.applyModuleI18n(e),typeof requestIdleCallback=="function"?requestIdleCallback(()=>this.updateVisitFilterOptions(u),{timeout:900}):setTimeout(()=>this.updateVisitFilterOptions(u),0);try{const b=e.querySelector("#clinic-visits-tbody");if(b&&Array.isArray(g)&&g.length>0){this._clinicVisitsRowsToken=(this._clinicVisitsRowsToken||0)+1;const M=this._clinicVisitsRowsToken;let U=0;const N=g.length,S=T=>{if(M!==this._clinicVisitsRowsToken||this.state&&this.state.activeTab!=="visits")return;const D=typeof performance<"u"&&performance.now?performance.now():Date.now();let x="",k=0;for(;U<N;){x+=y(g[U]),U+=1,k+=1;const _=typeof performance<"u"&&performance.now?performance.now():Date.now(),R=T&&typeof T.timeRemaining=="function"?T.timeRemaining()>6:_-D<12;if(k>=25&&!R||k>=75)break}x&&b.insertAdjacentHTML("beforeend",x),U<N&&(typeof requestIdleCallback=="function"?requestIdleCallback(S,{timeout:900}):setTimeout(()=>S(null),0))};typeof requestIdleCallback=="function"?requestIdleCallback(S,{timeout:900}):setTimeout(()=>S(null),0)}}catch{}this.bindVisitsTabEvents(e),this.state._shouldFocusSearch&&requestAnimationFrame(()=>{const b=e.querySelector("#visits-search");if(b){b.focus();const M=this.state._searchCursorPosition;if(M!=null)try{b.setSelectionRange(M,M)}catch{}this.state._shouldFocusSearch=!1}}),requestAnimationFrame(()=>{const b=e.querySelector(".clinic-table-wrapper");b&&this.setupTableScrollListeners(b)})}catch(t){const a=t instanceof Error?t.message:typeof t=="string"?t:JSON.stringify(t);if(Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u0639\u0631\u0636 \u0645\u062D\u062A\u0648\u0649 \u062A\u0628\u0648\u064A\u0628 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F:",a),e)try{e.innerHTML=`
                        <div class="empty-state">
...
\u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647.`,"\u062D\u0630\u0641","\u0625\u0644\u063A\u0627\u0621")){Loading.show("\u062C\u0627\u0631\u064A \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629...");try{if(AppState.googleConfig?.appsScript?.enabled){const s=await GoogleIntegration.sendRequest({action:"deleteClinicVisit",data:{visitId:e}});if(!s||s.success!==!0)throw new Error(s?.message||"\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645")}AppState.appData.clinicVisits=(AppState.appData.clinicVisits||[]).filter(s=>s.id!==e),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0628\u0646\u062C\u0627\u062D"),this.renderVisitsTab()}catch(s){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629: "+s.message),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",s)}}},async requestVisitDeletion(e){try{if(!e){Notification.error("\u0645\u0639\u0631\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D");return}const t=(AppState.appData.clinicVisits||[]).find(s=>s.id===e);if(!t){Notification.error("\u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}if(!(AppState?.googleConfig?.appsScript?.enabled&&AppState?.googleConfig?.appsScript?.scriptUrl)||typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest){Notification.error("\u062A\u0639\u0630\u0631 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641 (\u0627\u0644\u062E\u0627\u062F\u0645 \u063A\u064A\u0631 \u0645\u062A\u0627\u062D)");return}const i={id:AppState.currentUser?.id||"",name:AppState.currentUser?.name||"",email:AppState.currentUser?.email||"",role:AppState.currentUser?.role||""};Loading.show("\u062C\u0627\u0631\u064A \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629...");const n=await GoogleIntegration.sendRequest({action:"addClinicVisitDeletionRequest",data:{visitId:e,visitData:t,requestedBy:i}});if(Loading.hide(),!n||n.success!==!0)throw new Error(n?.message||"\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641");try{AppState.appData.clinicVisitDeletionRequests=Array.isArray(AppState.appData.clinicVisitDeletionRequests)?AppState.appData.clinicVisitDeletionRequests:[],n.data&&AppState.appData.clinicVisitDeletionRequests.unshift({...n.data,requestType:"visit"}),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save()}catch{}Notification.success("\u062A\u0645 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0625\u0644\u0649 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645")}catch(t){try{Loading.hide()}catch{}Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",t),Notification.error("\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641: "+(t.message||"\u062D\u062F\u062B \u062E\u0637\u0623"))}},getMedicationRowClass(e){return e==="\u0645\u0646\u062A\u0647\u064A"?"bg-red-50":e==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621"?"bg-yellow-50":"bg-green-50"},ensureData(){if(typeof AppState>"u")return;AppState.appData=AppState.appData||{};const e=AppState.appData;Array.isArray(e.clinicVisits)||(e.clinicVisits=[]),Array.isArray(e.medications)||(e.medications=[]),Array.isArray(e.clinicMedications)||(e.clinicMedications=[]),Array.isArray(e.clinicInventory)||(e.clinicInventory=[]);const t=e.medications.length>0?e.medications:e.clinicMedications.length>0?e.clinicMedications:e.clinicInventory.length>0?e.clinicInventory:[];e.medications.length===0&&t.length>0&&(e.medications=[...t]),e.clinicMedications.length===0&&t.length>0&&(e.clinicMedications=[...t]),e.clinicInventory.length===0&&t.length>0&&(e.clinicInventory=[...t]),Array.isArray(e.sickLeave)||(e.sickLeave=[]),Array.isArray(e.injuries)||(e.injuries=[]),Array.isArray(e.clinicSupplyRequests)||(e.clinicSupplyRequests=[]),Array.isArray(e.clinicStaff)||(e.clinicStaff=[]),Array.isArray(e.clinicStaffAttendance)||(e.clinicStaffAttendance=[]),Array.isArray(e.clinicStaffTimeOffRequests)||(e.clinicStaffTimeOffRequests=[]),Array.isArray(e.clinicStaffLeaveBalances)||(e.clinicStaffLeaveBalances=[]),Array.isArray(e.clinicStaffSystemActivities)||(e.clinicStaffSystemActivities=[]);let a=!1;if(Array.isArray(e.clinicContractorVisits)&&e.clinicContractorVisits.length>0){const n=new Set(e.clinicVisits.map(o=>o&&o.id).filter(Boolean));let s=0;e.clinicContractorVisits.forEach(o=>{o&&o.id&&!n.has(o.id)&&(o.personType="contractor",e.clinicVisits.push(o),n.add(o.id),a=!0,s++)}),s>0&&AppState.debugMode&&Utils.safeLog(`\u{1F517} [CLINIC] \u062A\u0645 \u062F\u0645\u062C ${s} \u0632\u064A\u0627\u0631\u0629 \u0645\u0642\u0627\u0648\u0644 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B \u0641\u064A ensureData`)}e.clinicVisits=e.clinicVisits.map(n=>{if(!n||typeof n!="object")return n;let s=String(n.personType||"").toLowerCase().trim();s==="external"||s==="\u062E\u0627\u0631\u062C\u064A"||s==="\u0645\u0642\u0627\u0648\u0644"||s==="contractor"?s="contractor":(s==="\u0645\u0648\u0638\u0641"||s==="staff"||s==="employee"||!s)&&(n.contractorName||n.contractorWorkerName?s="contractor":s="employee"),n.personType!==s&&(n.personType=s,a=!0);let o=[];if(n.medications&&(o=this.normalizeVisitMedications(n.medications)),(!o||o.length===0)&&n.medicationsDispensed){const d=this.normalizeVisitMedications(n.medicationsDispensed);d&&d.length>0&&(o=d,AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0648\u064A\u0644 medicationsDispensed \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,d.length,"\u062F\u0648\u0627\u0621"))}if((!o||o.length===0)&&n.medicationsDispensedQty&&n.medicationsDispensedQty>0){const d=parseInt(n.medicationsDispensedQty,10)||0;d>0&&(o=[{medicationName:n.medicationsDispensed||"\u062F\u0648\u0627\u0621 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F",quantity:d,unit:"\u0648\u062D\u062F\u0629",notes:""}],AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0646\u0634\u0627\u0621 \u0633\u062C\u0644 \u062F\u0648\u0627\u0621 \u0645\u0646 medicationsDispensedQty \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,d))}o||(o=[]);const l=Array.isArray(n.medications)?n.medications:[],r=JSON.stringify(l.sort((d,p)=>(d.medicationName||"").localeCompare(p.medicationName||""))),c=JSON.stringify(o.sort((d,p)=>(d.medicationName||"").localeCompare(p.medicationName||"")));if(r!==c&&(n.medications=o,a=!0,AppState.debugMode&&o.length>0&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B medications \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,o.length,"\u062F\u0648\u0627\u0621")),n.visitDate){const d=String(n.visitDate).trim();if(d.length===10&&d.match(/^\d{4}-\d{2}-\d{2}$/)){const p=new Date(d+"T00:00:00");n.visitDate=p.toISOString(),a=!0}else if(!d.includes("T")&&!d.includes("Z"))try{const p=new Date(d);isNaN(p.getTime())||(n.visitDate=p.toISOString(),a=!0)}catch{}}if(n.exitDate){const d=String(n.exitDate).trim();if(d.length===10&&d.match(/^\d{4}-\d{2}-\d{2}$/)){const p=new Date(d+"T00:00:00");n.exitDate=p.toISOString(),a=!0}else if(!d.includes("T")&&!d.includes("Z"))try{const p=new Date(d);isNaN(p.getTime())||(n.exitDate=p.toISOString(),a=!0)}catch{}}return n});let i=!1;if(e.clinicMedications=e.clinicMedications.map(n=>{const s=this.normalizeMedicationRecord(n),o=this.calculateMedicationStatus(s),l=n&&(n.quantityAdded!==s.quantityAdded||n.remainingQuantity!==s.remainingQuantity)||typeof n?.quantityAdded!="number"||typeof n?.remainingQuantity!="number";return(s.status!==o.status||s.daysRemaining!==o.daysRemaining||l)&&(i=!0,s.status=o.status,s.daysRemaining=o.daysRemaining),s}),e.clinicInventory=e.clinicMedications,e.sickLeave=e.sickLeave.map(n=>this.normalizeSickLeaveRecord(n)),e.injuries=e.injuries.map(n=>this.normalizeInjuryRecord(n)),AppState.appData=e,typeof window.DataManager<"u"&&window.DataManager.save)try{window.DataManager.save(),AppState.debugMode&&(i||a)&&Utils.safeLog(`\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u064A ensureData (medicationsChanged: ${i}, visitsChanged: ${a})`)}catch(n){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u064A ensureData:",n.message)}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},ensureFilterDefaults(){this.state||(this.state={activeTab:"medications",filters:{}}),this.state.activeTab||(this.state.activeTab="medications");const e={medications:{search:"",status:"all",dateFrom:"",dateTo:""},visits:{search:"",factory:"",position:"",workplace:""},sickLeave:{search:"",department:"",dateFrom:"",dateTo:""},injuries:{search:"",status:"all",department:"",dateFrom:"",dateTo:""},attendance:{search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"}};this.state.filters=this.state.filters||{},Object.keys(e).forEach(t=>{const a=this.state.filters[t]||{};this.state.filters[t]=Object.assign({},e[t],a)}),Array.isArray(this.state.currentInjuryAttachments)||(this.state.currentInjuryAttachments=[])},getCurrentUserSummary(e=null){if(e&&typeof e=="object"&&(e.name||e.id))return e;if(!AppState.currentUser)return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F AppState.currentUser \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F - \u0625\u0631\u062C\u0627\u0639 \u0627\u0644\u0646\u0638\u0627\u0645"),{id:"",name:"\u0627\u0644\u0646\u0638\u0627\u0645",email:"",role:""};const t=(AppState.currentUser.name||AppState.currentUser.displayName||"").toString().trim(),a=(AppState.currentUser.email||"").toString().trim(),i=(AppState.currentUser.id||"").toString().trim();AppState.debugMode&&Utils.safeLog("\u{1F50D} getCurrentUserSummary - name:",t,"email:",a,"id:",i);const n=t||a||i||"\u0627\u0644\u0646\u0638\u0627\u0645";return AppState.debugMode&&n==="\u0627\u0644\u0646\u0638\u0627\u0645"&&Utils.safeWarn('\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: getCurrentUserSummary \u064A\u0639\u064A\u062F "\u0627\u0644\u0646\u0638\u0627\u0645" - AppState.currentUser:',AppState.currentUser),{id:i,name:n,email:a,role:(AppState.currentUser.role||"").toString().trim()}},getMonthlyVisits(){const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),1);return AppState.appData.clinicVisits.filter(a=>new Date(a.visitDate||a.createdAt)>=t).length},calculateTotalTime(e,t){if(!e||!t)return"-";try{const a=e instanceof Date?e:new Date(e),i=t instanceof Date?t:new Date(t);if(isNaN(a.getTime())||isNaN(i.getTime()))return"-";const n=i.getTime()-a.getTime();if(n<0)return"-";const s=Math.floor(n/(1e3*60)),o=Math.floor(s/60),l=s%60;return o>0&&l>0?`${o} \u0633\u0627\u0639\u0629 ${l} \u062F\u0642\u064A\u0642\u0629`:o>0?`${o} \u0633\u0627\u0639\u0629`:l>0?`${l} \u062F\u0642\u064A\u0642\u0629`:"\u0623\u0642\u0644 \u0645\u0646 \u062F\u0642\u064A\u0642\u0629"}catch(a){return Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0633\u0627\u0628 \u0627\u0644\u0648\u0642\u062A:",a,{visitDate:e,exitDate:t}),"-"}},async renderVisitsList(){const e=AppState.appData.clinicVisits.slice(-10).reverse();return e.length===0?'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0645\u0633\u062C\u0644\u0629</p></div>':`
        ...
        `,document.body.appendChild(a);const d=a.querySelector("#sick-leave-form"),p=d.querySelector("#sick-leave-person-type"),f=d.querySelector("#sick-leave-employee-code"),m=d.querySelector("#sick-leave-name"),u=d.querySelector("#sick-leave-position"),g=d.querySelector("#sick-leave-department"),y=d.querySelector("#sick-leave-position-container"),v=d.querySelector("#sick-leave-department-container"),h=d.querySelector("#sick-leave-code-container"),w=d.querySelector("#sick-leave-name-label"),L=d.querySelector("#sick-leave-dropdown"),E=d.querySelector("#sick-leave-start-date"),b=d.querySelector("#sick-leave-end-date"),M=d.querySelector("#sick-leave-days"),U=()=>{if(!E.value||!b.value){M.textContent="\u2014";return}const x=new Date(E.value).toISOString(),k=new Date(b.value).toISOString(),_=this.calculateSickLeaveDays(x,k);M.textContent=`${_} \u064A\u0648\u0645`};E.addEventListener("change",U),b.addEventListener("change",U),E.value&&b.value&&U();const N=()=>{m&&(m.value=""),u&&(u.value=""),g&&(g.value=""),f&&(f.value="")},S=x=>{if(!x){N();return}const k=EmployeeHelper.getPrimaryCode(x);f&&k&&(f.value=k),m&&(m.value=x.name||""),u&&(u.value=x.position||x.jobTitle||""),g&&(g.value=x.department||x.unit||x.section||"")},T=()=>{!f||!m||typeof EmployeeHelper>"u"||(EmployeeHelper.setupEmployeeCodeSearch("sick-leave-employee-code","sick-leave-name",x=>{x?S(x):N()}),EmployeeHelper.setupAutocomplete("sick-leave-name",x=>{x&&S(x)}))},D=(x,k=!1)=>{const _=x==="employee";h&&(h.style.display=_?"block":"none"),y&&(y.style.display=_?"block":"none"),v&&(v.style.display=_?"block":"none"),w&&(w.textContent=`\u0627\u0633\u0645 ${_?"\u0627\u0644\u0645\u0648\u0638\u0641":x==="contractor"?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"} *`),f&&(f.disabled=!_,f.required=_,f.placeholder=_?"\u0623\u062F\u062E\u0644 \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A":"\u0631\u0642\u0645 \u0627\u0644\u062A\u0639\u0631\u064A\u0641 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)",!_&&k&&(f.value="")),m&&(m.readOnly=_,m.placeholder=_?"\u0633\u064A\u062A\u0645 \u062A\u0639\u0628\u0626\u0629 \u0627\u0644\u0627\u0633\u0645 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B":`\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 ${x==="contractor"?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"}`,_&&k&&(m.value="")),!_&&k&&(u&&(u.value=""),g&&(g.value="")),L&&(L.classList.add("hidden"),L.innerHTML=""),_&&T()};if(D(i,!1),i==="employee"&&typeof EmployeeHelper<"u"&&c){const x=EmployeeHelper.findByTerm(c);x&&S(x)}p.addEventListener("change",()=>{D(p.value,!0),p.value==="employee"&&f&&f.focus()}),d.addEventListener("submit",async x=>{x.preventDefault();const _=p.value==="employee";if(!E.value||!b.value){Notification.warning("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u062A\u0627\u0631\u064A\u062E \u0628\u062F\u0627\u064A\u0629 \u0648\u0646\u0647\u0627\u064A\u0629 \u0627\u0644\u0625\u062C\u0627\u0632\u0629");return}const R=new Date(E.value).toISOString(),q=new Date(b.value).toISOString(),H=this.calculateSickLeaveDays(R,q),V=e?.createdAt||new Date().toISOString(),B=e?.createdBy||this.getCurrentUserSummary(),A=this.getCurrentUserSummary(),I=this.isCurrentUserAdmin();let C,z=!1;if(t)I?(C=this.normalizeMedicationRecord({id:e?.id||Utils.generateId("MED"),name,type,usage,purchaseDate:purchaseISO,productionDate:productionISO,expiryDate:expiryISO,quantityAdded,remainingQuantity,location,notes,createdAt:V,createdBy:B,createdById:B?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:A,status:statusInfoLatest.status,daysRemaining:statusInfoLatest.daysRemaining}),delete C.pendingUpdate):(C={...e},C.pendingUpdate={name,type,usage,purchaseDate:purchaseISO,productionDate:productionISO,expiryDate:expiryISO,quantityAdded,remainingQuantity,location,notes,requestedBy:A,requestedAt:new Date().toISOString()},z=!0);else{const j=I?statusInfoLatest.status:"\u0642\u064A\u062F \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F";I||(z=!0),C=this.normalizeMedicationRecord({id:Utils.generateId("MED"),name,type,usage,purchaseDate:purchaseISO,productionDate:productionISO,expiryDate:expiryISO,quantityAdded,remainingQuantity,location,notes,createdAt:V,createdBy:B,createdById:B?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:A,status:j,daysRemaining:statusInfoLatest.daysRemaining})}Loading.show();try{const j=AppState.appData.sickLeave||[];if(t){const F=j.findIndex(O=>O.id===C.id);F!==-1?j[F]=C:j.push(C)}else j.push(C);AppState.appData.sickLeave=j;try{this.calculateClinicCardValues(),this.updateClinicAnalysisResults()}catch(F){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0643\u0631\u0648\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 (\u0625\u062C\u0627\u0632\u0629 \u0645\u0631\u0636\u064A\u0629):",F)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0628\u0646\u062C\u0627\u062D"),a.remove(),setTimeout(()=>{document.querySelector('.clinic-tab-panel[data-tab-panel="sickLeave"]')&&this.state.activeTab==="sickLeave"&&this.renderSickLeaveTab();const O=document.querySelector("#total-sick-leave");O&&(O.textContent=j.length)},100),(async()=>{try{t?await GoogleIntegration.sendRequest({action:"updateSickLeave",data:{leaveId:C.id,updateData:C}}):await GoogleIntegration.sendRequest({action:"addSickLeave",data:C})}catch(F){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 Google Sheets:",F)}})()}catch(j){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629: "+j.message)}}),a.addEventListener("click",x=>{x.target===a&&confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&a.remove()})},async showInjuryForm(e=null){Utils.safeLog("\u{1F537} \u062A\u0645 \u0627\u0633\u062A\u062F\u0639\u0627\u0621 showInjuryForm - \u0628\u062F\u0621 \u0641\u062A\u062D \u0627\u0644\u0646\u0645\u0648\u0630\u062C..."),this.ensureData();const t=!!e,a=this;this.state.currentInjuryAttachments=Array.isArray(e?.attachments)?e.attachments.map(C=>this.normalizeAttachment(C)).filter(Boolean):[];const i=document.createElement("div");i.className="modal-overlay";const n=e?.personType||"employee",s=e?.injuryDate?Utils.toDateTimeLocalString(e.injuryDate):"",o=e?.employeeName||e?.personName||"",l=e?.contractorName||"",r=e?.employeeCode||e?.employeeNumber||"",c=e?.employeePosition||e?.contractorPosition||"",d=e?.employeeDepartment||e?.department||"",p=e?.factory||"",f=e?.subLocation||e?.subLocationName||"",m=e?.status||"\u0642\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629",u=this.getInjuryTypeOptions(),g=this.getSiteOptions();i.innerHTML=`
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4" style="background: linear-gradient(135deg, #f8fafc 0%, #eef2ff 100%); padding: 16px; border-radius: 12px;">
                            ...
                            <div>
                                ...
                                <select id="injury-factory" class="form-input">
                                    ...
                                    ${g.map(C=>`<option value="${Utils.escapeHTML(C.id)}" ${p===C.id||p===C.name?"selected":""}>${Utils.escapeHTML(C.name)}</option>`).join("")}
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select id="injury-type" required class="form-input">
                                    ...
                                    ${u.map(C=>`<option value="${Utils.escapeHTML(C)}" ${e?.injuryType===C?"selected":""}>${Utils.escapeHTML(C)}</option>`).join("")}
                                </select>
                            </div>
                            <div>
        ...
        `,document.body.appendChild(i);const y=i.querySelector("#injury-form"),v=y.querySelector("#injury-person-type"),h=y.querySelector("#injury-name"),w=y.querySelector("#injury-employee-code"),L=y.querySelector("#injury-code-container"),E=y.querySelector("#injury-contractor-container"),b=y.querySelector("#injury-contractor-name-select"),M=y.querySelector("#injury-employee-name-container"),U=y.querySelector("#injury-contractor-worker-container"),N=y.querySelector("#injury-contractor-worker-name"),S=y.querySelector("#injury-name-label"),T=y.querySelector("#injury-position"),D=y.querySelector("#injury-factory"),x=y.querySelector("#injury-sub-location"),k=y.querySelector("#injury-department"),_=y.querySelector("#injury-dropdown"),R=y.querySelector("#injury-attachments-input"),q=i.querySelector(".modal-close"),H=y.querySelector("#injury-cancel-btn"),V=C=>{if(C){if(h&&(h.value=C.name||""),w){const z=EmployeeHelper.getPrimaryCode(C);z&&(w.value=z)}k&&(k.value=C.department||C.unit||C.section||k.value),T&&(T.value=C.position||C.job||"")}},B=()=>{!w||!h||typeof EmployeeHelper>"u"||(EmployeeHelper.setupEmployeeCodeSearch("injury-employee-code","injury-name",C=>{C&&V(C)}),EmployeeHelper.setupAutocomplete("injury-name",C=>{C&&V(C)}))},A=(C,z=!1)=>{const j=C==="employee",F=C==="contractor",O=C==="external";L&&(L.style.display=j?"block":"none"),E&&(E.style.display=F?"block":"none"),M&&(M.style.display=j?"block":"none"),U&&(U.style.display=F||O?"block":"none"),w&&(w.required=j,w.disabled=!j,w.placeholder=j?"\u0623\u062F\u062E\u0644 \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A":"\u0631\u0642\u0645 \u0627\u0644\u062A\u0639\u0631\u064A\u0641 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)",!j&&z&&(w.value="")),S&&(S.textContent=`\u0627\u0633\u0645 ${j?"\u0627\u0644\u0645\u0648\u0638\u0641":C==="contractor"?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"} *`),h&&(h.readOnly=j,h.disabled=!j,h.required=j,h.placeholder=j?"\u0633\u064A\u062A\u0645 \u062A\u0639\u0628\u0626\u0629 \u0627\u0644\u0627\u0633\u0645 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B":`\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 ${C==="contractor"?"\u0627\u0644\u0645\u0648\u0638\u0641 \u0627\u0644\u062A\u0627\u0628\u0639 \u0644\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"}`,z&&!j&&(h.value="")),b&&(b.required=F,b.disabled=!F,F?this.loadContractorsIntoSelect(b):z&&(b.value="")),N&&(N.required=F||O,N.disabled=!(F||O),z&&j&&(N.value=""),O?N.placeholder="\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 \u0627\u0644\u0639\u0627\u0645\u0644 \u0627\u0644\u062E\u0627\u0631\u062C\u064A":F?N.placeholder="\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 \u0627\u0644\u0645\u0635\u0627\u0628 \u0627\u0644\u062A\u0627\u0628\u0639 \u0644\u0644\u0645\u0642\u0627\u0648\u0644":N.placeholder=""),!j&&z&&k&&(k.value=""),!j&&z&&T&&(T.value=""),_&&(_.classList.add("hidden"),_.innerHTML=""),j&&B()};if(A(n,!1),n==="employee"&&typeof EmployeeHelper<"u"&&r){const C=EmployeeHelper.findByTerm(r);C&&V(C)}v.addEventListener("change",()=>{A(v.value,!0)}),b?.addEventListener("input",()=>{v.value!=="contractor"||!(b.value||"").trim()||h.value.trim()||h.focus()}),typeof this.setupClinicWorkplaceDatalist=="function"&&this.setupClinicWorkplaceDatalist("injury-factory","injury-sub-location","injury-sub-location-datalist",{includeFallbackNameMatch:!0}),R?.addEventListener("change",async C=>{await a.handleInjuryAttachmentsChange(C.target.files)}),typeof a.renderInjuryAttachmentsPreview=="function"?a.renderInjuryAttachmentsPreview():Utils.safeWarn("\u26A0\uFE0F renderInjuryAttachmentsPreview \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");const I=()=>{a.state.currentInjuryAttachments=[],i.remove()};q?.addEventListener("click",I),H?.addEventListener("click",I),Utils.safeLog("\u{1F537} \u062A\u0645 \u0625\u0636\u0627\u0641\u0629 event listener \u0644\u0644\u0646\u0645\u0648\u0630\u062C..."),y.addEventListener("submit",async C=>{Utils.safeLog("\u{1F534} \u062A\u0645 \u0627\u0644\u0636\u063A\u0637 \u0639\u0644\u0649 \u0632\u0631 \u0627\u0644\u062D\u0641\u0638! \u0628\u062F\u0621 \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629...");try{C.preventDefault(),C.stopPropagation(),C.stopImmediatePropagation(),Utils.safeLog("\u{1F504} \u0628\u062F\u0621 \u0645\u0639\u0627\u0644\u062C\u0629 \u0646\u0645\u0648\u0630\u062C \u0627\u0644\u0625\u0635\u0627\u0628\u0629...");const z=v.value,j=z==="employee",F=y.querySelector("#injury-date");if(!F.value){Notification.warning("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}const O=Utils.dateTimeLocalToISO(F.value)||new Date().toISOString(),X=e?.createdAt||new Date().toISOString(),Y=e?.createdBy||a.getCurrentUserSummary(),ae=a.getCurrentUserSummary(),Z=k?.value.trim()||"",oe=T?.value.trim()||"",ee=b?.value?.trim()||"",te=j?h?.value?.trim()||"":N?.value?.trim()||h?.value?.trim()||"",se=y.querySelector("#injury-type")?.value||"",K=y.querySelector("#injury-body-part")?.value||"",ne=y.querySelector("#injury-location")?.value?.trim()||"",re=y.querySelector("#injury-description")?.value?.trim()||"",ie=D?.value?.trim()||"",$=x?.value?.trim()||"";if(j&&!te){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644/\u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641");return}if(z==="contractor"&&b){const G=(()=>{try{return JSON.parse(b.dataset.allowedValues||"[]")}catch{return[]}})();if(!ee||!G.includes(ee.toLowerCase().trim())){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u0645\u0646 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0641\u0642\u0637");return}if(!te){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0633\u0645 \u0627\u0644\u0645\u0635\u0627\u0628 \u0627\u0644\u062A\u0627\u0628\u0639 \u0644\u0644\u0645\u0642\u0627\u0648\u0644");return}}if(z==="external"&&!te){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0633\u0645 \u0627\u0644\u0639\u0627\u0645\u0644 \u0627\u0644\u062E\u0627\u0631\u062C\u064A");return}if(!se){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0646\u0648\u0639 \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}if(!K){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0645\u0643\u0627\u0646 \u0627\u0644\u0625\u0635\u0627\u0628\u0629 (\u0628\u0627\u0644\u062C\u0633\u0645)");return}if(!ne){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0645\u0643\u0627\u0646 \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}if(!re){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0648\u0635\u0641 \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}let P="";ie&&(P=g.find(J=>J.id===ie||J.name===ie)?.name||"");const W=a.normalizeInjuryRecord({id:e?.id||Utils.generateId("INJURY"),personType:z,employeeName:j?h.value.trim():null,employeeCode:j?w?.value.trim()||"":null,employeeNumber:j?w?.value.trim()||"":null,personName:j?null:te,contractorName:z==="contractor"?ee:null,employeePosition:oe,contractorPosition:j?null:oe,employeeDepartment:Z,department:Z,factory:ie||null,factoryName:P||null,subLocation:$||null,subLocationName:$||null,injuryDate:O,injuryType:se,injuryBodyPart:K,injuryLocation:ne,injuryDescription:re,actionsTaken:y.querySelector("#injury-actions").value.trim(),treatment:y.querySelector("#injury-treatment").value.trim(),status:y.querySelector("#injury-status").value,attachments:a.state.currentInjuryAttachments.map(G=>({...G})),createdAt:X,createdBy:Y,createdById:Y?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:ae});Utils.safeLog("\u2705 \u062A\u0645 \u0625\u0646\u0634\u0627\u0621 payload \u0628\u0646\u062C\u0627\u062D:",W),Loading.show();const Q=AppState.appData.injuries||[];if(t){const G=Q.findIndex(J=>J.id===W.id);G!==-1?Q[G]=W:Q.push(W)}else Q.push(W);AppState.appData.injuries=Q;try{a.calculateClinicCardValues(),a.updateClinicAnalysisResults()}catch(G){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0643\u0631\u0648\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 (\u0625\u0635\u0627\u0628\u0629):",G)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B"),Loading.hide(),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0625\u0635\u0627\u0628\u0629 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0625\u0635\u0627\u0628\u0629 \u0628\u0646\u062C\u0627\u062D"),I(),Utils.safeLog("\u2705 \u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C \u0628\u0646\u062C\u0627\u062D"),setTimeout(()=>{try{Utils.safeLog("\u2705 \u0645\u062D\u0627\u0648\u0644\u0629 \u062A\u062D\u062F\u064A\u062B \u0648\u0627\u062C\u0647\u0629 \u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A..."),document.querySelector('.clinic-tab-panel[data-tab-panel="injuries"]')&&a.state.activeTab==="injuries"&&(Utils.safeLog("\u2705 \u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 panel\u060C \u0633\u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062B\u0647"),a.renderInjuriesTab());const J=document.querySelector("#total-injuries");J&&(J.textContent=Q.length)}catch(G){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0648\u0627\u062C\u0647\u0629 \u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A:",G)}},100),(async()=>{try{t?(await GoogleIntegration.sendRequest({action:"updateInjury",data:{injuryId:W.id,updateData:W}}),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A Google Sheets (\u062A\u062D\u062F\u064A\u062B)")):(await GoogleIntegration.sendRequest({action:"addInjury",data:W}),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A Google Sheets (\u0625\u0636\u0627\u0641\u0629)"))}catch(G){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 Google Sheets:",G)}})()}catch(z){Loading.hide(),Utils.safeError("\u274C \u062E\u0637\u0623 \u0639\u0627\u0645 \u0641\u064A \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0625\u0635\u0627\u0628\u0629:",z),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0625\u0635\u0627\u0628\u0629: "+z.message)}}),i.addEventListener("click",C=>{if(C.target===i){if(!confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`))return;a.state.currentInjuryAttachments=[],i.remove()}})},showVisitForm(e=null,t=null){const a=!!e;if(!document.getElementById("clinic-section")){t&&(t.disabled=!1);return}try{this.ensureData()}catch(o){t&&(t.disabled=!1),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0636\u064A\u0631 \u0646\u0645\u0648\u0630\u062C \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",o);return}typeof Permissions<"u"&&Permissions.ensureFormSettingsState&&Permissions.ensureFormSettingsState().catch(()=>{});const n=document.createElement("div");if(n.className="modal-overlay",n.innerHTML=`
        ...
        `,document.body.appendChild(n),t){const o=new MutationObserver(()=>{document.body.contains(n)||(t.disabled=!1,o.disconnect())});o.observe(document.body,{childList:!0,subtree:!0})}setTimeout(()=>{const o=document.getElementById("visit-person-type"),l=document.getElementById("visit-employee-code"),r=document.getElementById("visit-history-tbody"),c=()=>{if(!r)return;const S=o?.value||"employee",T=l?.value.trim();if(S!=="employee"||!T){r.innerHTML='<tr><td colspan="6" class="text-center text-gray-500 py-4">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</td></tr>';return}const D=(AppState.appData.clinicVisits||[]).filter(x=>x.personType==="employee"&&(x.employeeCode===T||x.employeeNumber===T)).sort((x,k)=>new Date(k.visitDate||k.createdAt)-new Date(x.visitDate||x.createdAt)).slice(0,10);D.length===0?r.innerHTML='<tr><td colspan="6" class="text-center text-gray-500 py-4">\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0633\u0627\u0628\u0642\u0629</td></tr>':r.innerHTML=D.map(x=>`
                        <tr>
                    ...
                    `).join("")};if(l&&r&&(l.addEventListener("blur",c),l.addEventListener("input",()=>{l.value.trim().length>=3&&c()})),o&&o.addEventListener("change",()=>{const S=document.querySelector("#visit-history-table")?.closest(".mt-6");S&&(S.style.display=o.value==="employee"?"block":"none"),o.value==="employee"&&c()}),e&&e.employeeCode&&c(),e?.personType==="contractor"){const S=document.getElementById("visit-contractor-name-select");S&&(Clinic.loadContractorsIntoSelect(S),(e.employeeName||e.contractorName)&&(S.value=e.employeeName||e.contractorName||""))}typeof Clinic.handlePersonTypeChange=="function"&&Clinic.handlePersonTypeChange(),typeof Clinic.setupClinicWorkplaceDatalist=="function"&&(Clinic.setupClinicWorkplaceDatalist("visit-factory","visit-employee-location","visit-employee-location-datalist"),Clinic.setupClinicWorkplaceDatalist("visit-contractor-factory","visit-work-area","visit-work-area-datalist"));const d=document.getElementById("visit-medication-select"),p=document.getElementById("visit-medications-list"),f=document.getElementById("visit-add-medication-btn"),m=document.getElementById("visit-medication-quantity"),u=document.getElementById("visit-medications-datalist"),g=document.getElementById("visit-type"),y=document.getElementById("visit-treatment"),v=document.getElementById("visit-treatment-medication-mode"),h=document.getElementById("visit-treatment-medication-select"),w=document.getElementById("visit-treatment-medications-datalist");let L=e?.medications&&Array.isArray(e.medications)?[...e.medications]:[];const E=()=>this.getMedications().filter(S=>(parseInt(S.remainingQuantity??S.quantity??0,10)||0)>0),b=()=>{if(!h||!w)return;const S={};w.innerHTML=E().map(T=>{const D=parseInt(T.remainingQuantity??T.quantity??0,10)||0,x=String(T.name||T.medicationName||"").trim();if(!x)return"";const k=`${x} (\u0645\u062A\u0648\u0641\u0631: ${D})`;return S[this.normalizeArabicText(x)]={id:T.id||"",name:x,label:k},`<option value="${Utils.escapeHTML(k)}"></option>`}).join(""),h.dataset.medicationMap=JSON.stringify(S)},M=()=>{const S=this.isMedicationDispenseVisitType_(g?.value||"");y&&(y.style.display=S?"none":"block"),v&&(v.style.display=S?"block":"none"),S&&(b(),h&&L.length>0&&(h.value=L.map(T=>T.medicationName).filter(Boolean).join("\u060C ")))},U=()=>{if(!d||!u)return;const S=this.getMedications().filter(D=>(D.remainingQuantity??D.quantity??0)<=0?!1:!L.some(_=>_.medicationId===D.id)),T={};u.innerHTML=S.map(D=>{const x=D.remainingQuantity??D.quantity??0,k=String(D.name||D.medicationName||"").trim(),_=`${k} (\u0645\u062A\u0648\u0641\u0631: ${x})`,R=k.toLowerCase().trim();return R&&(T[R]=D.id),`<option value="${Utils.escapeHTML(_)}"></option>`}).join(""),d.dataset.nameToId=JSON.stringify(T),d.dataset.selectedId=""},N=()=>{if(p){if(L.length===0){p.innerHTML="",this.isMedicationDispenseVisitType_(g?.value||"")&&y&&(y.value="");return}p.innerHTML=L.map((S,T)=>{const D=this.getMedications().find(x=>x.id===S.medicationId);return`
                        <div class="flex items-center justify-between bg-gray-50 border border-gray-200 rounded px-3 py-2" data-med-id="${S.medicationId||""}">
                            <div>
                                <span class="font-medium">${Utils.escapeHTML(S.medicationName||D?.name||"")}</span>
                                <span class="text-sm text-gray-600 mr-2">\xD7 ${S.quantity||1}</span>
                            </div>
                            <button type="button" class="btn-icon btn-icon-danger btn-xs" data-remove-med="${T}">
                                <i class="fas fa-times"></i>
                            </button>
                        </div>
                    `}).join(""),this.isMedicationDispenseVisitType_(g?.value||"")&&y&&(y.value=L.map(S=>S.medicationName).filter(Boolean).join("\u060C "),h&&(h.value=y.value)),p.querySelectorAll("[data-remove-med]").forEach(S=>{S.addEventListener("click",()=>{const T=parseInt(S.getAttribute("data-remove-med"),10);L.splice(T,1),N(),U()})})}};f&&d&&m&&f.addEventListener("click",()=>{const T=(d.value||"").trim().replace(/\s*\(.*\)\s*$/,"").trim(),D=(()=>{try{return JSON.parse(d.dataset.nameToId||"{}")}catch{return{}}})(),x=d.dataset.selectedId||D[String(T).toLowerCase().trim()]||"",k=parseInt(m.value,10)||1;if(!x){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u062F\u0648\u0627\u0621");return}const _=this.getMedications().find(H=>H.id===x);if(!_){Notification.error("\u0627\u0644\u062F\u0648\u0627\u0621 \u0627\u0644\u0645\u062D\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const R=_.remainingQuantity??_.quantity??0,q=L.filter(H=>H.medicationId===x).reduce((H,V)=>H+(V.quantity||0),0);if(q+k>R){Notification.error(`\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u062A\u0627\u062D\u0629 \u063A\u064A\u0631 \u0643\u0627\u0641\u064A\u0629. \u0627\u0644\u0645\u062A\u0648\u0641\u0631: ${R-q}`);return}L.push({medicationId:x,medicationName:_.name||_.medicationName||"",quantity:k}),m.value="1",d.value="",N(),U()}),d&&!d.hasAttribute("data-datalist-attached")&&(d.setAttribute("data-datalist-attached","true"),d.addEventListener("input",()=>{const T=(d.value||"").trim().replace(/\s*\(.*\)\s*$/,"").trim(),D=(()=>{try{return JSON.parse(d.dataset.nameToId||"{}")}catch{return{}}})();d.dataset.selectedId=D[String(T).toLowerCase().trim()]||""}),d.addEventListener("blur",()=>{try{const S=(d.value||"").trim();if(!S)return;const T=S.replace(/\s*\(.*\)\s*$/,"").trim(),D=(()=>{try{return JSON.parse(d.dataset.nameToId||"{}")}catch{return{}}})();d.dataset.selectedId||D[String(T).toLowerCase().trim()]||(d.value="",d.dataset.selectedId="",Notification?.warning?.("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u062F\u0648\u0627\u0621 \u0645\u0646 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0641\u0642\u0637"))}catch{}})),g?.addEventListener("change",M),h?.addEventListener("input",()=>{const T=String(h.value||"").trim().replace(/\s*\(.*\)\s*$/,"").trim();let D={};try{D=JSON.parse(h.dataset.medicationMap||"{}")}catch{D={}}const x=D[this.normalizeArabicText(T)];if(!x){h.dataset.selectedId="";return}h.dataset.selectedId=x.id,y&&(y.value=x.name),d&&(d.value=x.label,d.dataset.selectedId=x.id),m?.focus()}),h?.addEventListener("blur",()=>{if(!String(h.value||"").trim()||h.dataset.selectedId)return;const T=L.map(D=>D.medicationName).filter(Boolean).join("\u060C ");h.value=T,Notification?.warning?.("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u062F\u0648\u0627\u0621 \u0645\u0646 \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u062E\u0632\u0648\u0646 \u0627\u0644\u0641\u0639\u0644\u064A")}),U(),N(),M()},300);const s=n.querySelector("#visit-form");s.addEventListener("submit",async o=>{o.preventDefault(),this.clearVisitFormAlert();const l=s?.querySelector('button[type="submit"]')||o.target?.querySelector('button[type="submit"]');if(l&&l.disabled)return;let r="";l&&(r=l.innerHTML,l.disabled=!0,l.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const c=document.getElementById("visit-person-type"),d=document.getElementById("visit-date"),p=document.getElementById("visit-exit-date");if(!c||!d||!p){this.showVisitFormAlert("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649."),l&&(l.disabled=!1,l.innerHTML=r);return}const f=String(c.value||"").trim().toLowerCase(),m=f==="employee"?"employee":"contractor",u=d.value,g=p.value,y=document.getElementById("visit-contractor-worker")?.value.trim()||"",v=m==="employee"?document.getElementById("visit-employee-location")?.value.trim()||"":document.getElementById("visit-work-area")?.value.trim()||"",h=m==="contractor"?document.getElementById("visit-contractor-position")?.value.trim()||"":null;if(f==="contractor"&&h&&!this.getContractorJobTitleOptions().some(q=>this.normalizeArabicText(q)===this.normalizeArabicText(h))){this.showVisitFormAlert("\u0627\u0644\u0648\u0638\u064A\u0641\u0629 \u064A\u062C\u0628 \u0627\u062E\u062A\u064A\u0627\u0631\u0647\u0627 \u0645\u0646 \u0642\u0627\u0626\u0645\u0629 \u0648\u0638\u0627\u0626\u0641 \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646 \u0627\u0644\u0645\u0639\u062A\u0645\u062F\u0629"),l&&(l.disabled=!1,l.innerHTML=r);return}let w="";if(f==="contractor"){const R=document.getElementById("visit-contractor-name-select"),q=document.getElementById("visit-employee-name");if(w=R?(R.value||"").trim():q?(q.value||"").trim():"",R){const H=(()=>{try{return JSON.parse(R.dataset.allowedValues||"[]")}catch{return[]}})();if(w&&!H.includes(w.toLowerCase().trim())){this.showVisitFormAlert("\u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u064A\u062C\u0628 \u0627\u062E\u062A\u064A\u0627\u0631\u0647 \u0645\u0646 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0641\u0642\u0637"),l&&(l.disabled=!1,l.innerHTML=r);return}}}else{const R=document.getElementById("visit-employee-name");w=R?(R.value||"").trim():""}const L=document.getElementById("visit-medications-list"),E=[];L&&L.querySelectorAll("[data-med-id]").forEach(R=>{const q=R.getAttribute("data-med-id");if(!q)return;const H=R.textContent.match(/×\s*(\d+)/),V=H?parseInt(H[1],10):1,B=R.querySelector(".font-medium"),A=B?B.textContent.trim():"";E.push({medicationId:q,medicationName:A,quantity:V})});const b=m==="employee"?document.getElementById("visit-factory")?.value.trim()||null:document.getElementById("visit-contractor-factory")?.value.trim()||null;let M=null;if(b){const q=this.getSiteOptions().find(H=>H.id===b);M=q?q.name:null}let U=null,N=null;if(u&&u.trim())try{const[R,q]=u.split("T");if(R&&q){const[H,V,B]=R.split("-").map(Number),[A,I]=q.split(":").map(Number),C=new Date(H,V-1,B,A,I,0,0);isNaN(C.getTime())?AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0642\u064A\u0645\u0629 \u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D\u0629:",u):U=C.toISOString()}else{const H=new Date(u);isNaN(H.getTime())||(U=H.toISOString())}}catch(R){AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0648\u064A\u0644 \u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644:",R)}if(g&&g.trim())try{const[R,q]=g.split("T");if(R&&q){const[H,V,B]=R.split("-").map(Number),[A,I]=q.split(":").map(Number),C=new Date(H,V-1,B,A,I,0,0);isNaN(C.getTime())?AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0642\u064A\u0645\u0629 \u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C \u063A\u064A\u0631 \u0635\u062D\u064A\u062D\u0629:",g):N=C.toISOString()}else{const H=new Date(g);isNaN(H.getTime())||(N=H.toISOString())}}catch(R){AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0648\u064A\u0644 \u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C:",R)}const S=AppState.currentUser,T=(S?.email||"").toLowerCase().trim(),k=(AppState.appData.users||[]).find(R=>(R.email||"").toLowerCase().trim()===T)?.name||S?.name||T||"\u0645\u0633\u062A\u062E\u062F\u0645",_={id:e?.id||Utils.generateId("CLINIC_VISIT"),personType:m,employeeName:m==="employee"?w:null,employeeCode:m==="employee"?document.getElementById("visit-employee-code").value.trim():null,employeeNumber:m==="employee"?document.getElementById("visit-employee-code").value.trim():null,employeePosition:m==="employee"?document.getElementById("visit-employee-position")?.value.trim()||"":h||null,contractorPosition:h||null,employeeDepartment:m==="employee"?document.getElementById("visit-employee-department")?.value.trim()||"":null,factory:b,factoryName:M,employeeLocation:m==="employee"?v:null,contractorName:m==="contractor"?w:null,contractorWorkerName:m==="contractor"?y:null,externalName:null,workArea:v||null,visitDate:U,exitDate:N,visitType:document.getElementById("visit-type")?.value?.trim()||null,reason:document.getElementById("visit-reason").value.trim(),diagnosis:document.getElementById("visit-diagnosis").value.trim(),treatment:document.getElementById("visit-treatment").value.trim(),medications:E.length>0?E:null,createdAt:e?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString(),createdBy:e?.createdBy||k,updatedBy:k,email:T,userId:S?.id||""};Loading.show();try{const R=j=>{const F={};return(Array.isArray(j)?j:[]).forEach(O=>{const X=O&&(O.medicationId||O.id)?String(O.medicationId||O.id):"";if(!X)return;const Y=parseInt(O.quantity,10)||0;F[X]=(F[X]||0)+Y}),F},q=a?this.normalizeVisitMedications(e?.medications):[],H=R(q),V=R(E),B=[];new Set([...Object.keys(H),...Object.keys(V)]).forEach(j=>{const F=(V[j]||0)-(H[j]||0);F!==0&&B.push({medicationId:j,delta:F})});const I=B.length>0,C=I?this.getMedications():[];if(I)for(const j of B){if(j.delta<=0)continue;const F=C.find(X=>String(X.id)===String(j.medicationId));if(!F)throw new Error("\u0627\u0644\u062F\u0648\u0627\u0621 \u0627\u0644\u0645\u062D\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A \u0627\u0644\u0645\u062E\u0632\u0648\u0646");const O=parseInt(F.remainingQuantity??F.quantity??0,10)||0;if(O<j.delta){const X=F.name||F.medicationName||"\u062F\u0648\u0627\u0621";throw new Error(`\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u062A\u0627\u062D\u0629 \u063A\u064A\u0631 \u0643\u0627\u0641\u064A\u0629 \u0644\u0644\u062F\u0648\u0627\u0621: ${X}. \u0627\u0644\u0645\u062A\u0648\u0641\u0631: ${O}`)}}if(a){const j=AppState.appData.clinicVisits.findIndex(F=>F.id===e.id);j!==-1&&(AppState.appData.clinicVisits[j]=_)}else AppState.appData.clinicVisits.push(_);if(I){for(const j of B){const F=C.find(Z=>String(Z.id)===String(j.medicationId));if(!F)continue;const O=parseInt(F.remainingQuantity??F.quantity??0,10)||0;if(!(typeof F.quantityAdded=="number"&&F.quantityAdded>0)&&j.delta>0){const Z=parseInt(F.quantity??0,10)||0;F.quantityAdded=Math.max(Z,O+j.delta)}let Y=O-j.delta;Y=Math.max(0,Y);const ae=typeof F.quantityAdded=="number"&&F.quantityAdded>0?F.quantityAdded:typeof F.quantity=="number"&&F.quantity>0?F.quantity:null;ae!==null&&(Y=Math.min(ae,Y)),F.remainingQuantity=Y}AppState.appData.medications=C,AppState.appData.clinicMedications=C,AppState.appData.clinicInventory=C}try{this.updateClinicAnalysisResults(),this.calculateClinicCardValues()}catch(j){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0625\u062D\u0635\u0627\u0626\u064A\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0645\u062D\u0644\u064A\u0627\u064B:",j)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save();try{const j=this.getMonthlyVisitsAlertThreshold(),F=this.getMonthlyVisitCountForPerson(_);if(F>=j){const O=(_.personType||"").toString().toLowerCase()==="employee"?"\u0627\u0644\u0645\u0648\u0638\u0641":"\u0627\u0644\u0645\u0642\u0627\u0648\u0644/\u0627\u0644\u0639\u0627\u0645\u0644";typeof Notification<"u"&&Notification.warning&&Notification.warning("\u062A\u0646\u0628\u064A\u0647: \u0639\u062F\u062F \u0632\u064A\u0627\u0631\u0627\u062A "+O+" \u0644\u0644\u0639\u064A\u0627\u062F\u0629 \u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631 \u0648\u0635\u0644 \u0623\u0648 \u062A\u062C\u0627\u0648\u0632 "+j+" \u0632\u064A\u0627\u0631\u0629. \u062A\u0645 \u0625\u0634\u0639\u0627\u0631 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645."),this.notifyAdminsAboutHighClinicVisits(_,F).catch(function(X){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F Clinic: \u0641\u0634\u0644 \u0625\u0634\u0639\u0627\u0631 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645 \u0639\u0646 \u062A\u062C\u0627\u0648\u0632 \u062A\u0631\u062F\u062F \u0627\u0644\u0632\u064A\u0627\u0631\u0627\u062A:",X)})}}catch(j){Utils.safeWarn("\u0641\u062D\u0635 \u062A\u0631\u062F\u062F \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0634\u0647\u0631\u064A:",j)}Loading.hide(),Notification.success(`\u062A\u0645 ${a?"\u062A\u062D\u062F\u064A\u062B":"\u062A\u0633\u062C\u064A\u0644"} \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0628\u0646\u062C\u0627\u062D`),n.remove();const z=6e4;(async()=>{try{const j=I&&B.length>0?B.map(F=>({medicationId:String(F.medicationId),delta:Number(F.delta)||0})):null;if(a){const F={..._};j&&(F.medicationAdjustments=j);const O=await GoogleIntegration.sendRequest({action:"updateClinicVisit",data:{visitId:e.id,updateData:F,__timeoutMs:z}});this.assertClinicVisitRpcResult(O)}else{const F={..._,__timeoutMs:z};j&&(F.medicationAdjustments=j);const O=await GoogleIntegration.sendRequest({action:"addClinicVisit",data:F});this.assertClinicVisitRpcResult(O),this.applyClinicVisitIdFromServer(_,O)}I&&(GoogleIntegration.sendRequest({action:"getAllMedications",data:{}}).then(F=>{if(F&&F.success&&Array.isArray(F.data)){const O=F.data.map(X=>this.normalizeMedicationRecord(X));if(AppState.appData.medications=O,AppState.appData.clinicMedications=O,AppState.appData.clinicInventory=O,Utils.safeLog("\u2705 [CLINIC] \u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0645\u064F\u062D\u062F\u064E\u0651\u062B\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645 \u0628\u0639\u062F \u0627\u0644\u0632\u064A\u0627\u0631\u0629: "+O.length+" \u062F\u0648\u0627\u0621"),this.state&&this.state.activeTab==="medications")try{this.renderMedicationsTab()}catch{}}}).catch(()=>{}),document.dispatchEvent(new CustomEvent("data-saved",{detail:{module:"medications",action:"\u062A\u062D\u062F\u064A\u062B",data:{updated:B.length}}}))),document.dispatchEvent(new CustomEvent("data-saved",{detail:{module:"clinicVisits",action:a?"\u062A\u062D\u062F\u064A\u062B":"\u0625\u0636\u0627\u0641\u0629",data:_}})),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),this.refreshClinicVisitsFromServerAfterSave()}catch(j){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",j);try{typeof window.DataManager<"u"&&window.DataManager.addToPendingSync&&window.DataManager.addToPendingSync("ClinicVisits",AppState.appData.clinicVisits)}catch{}try{this.refreshClinicVisitsFromServerAfterSave()}catch{}try{const F=j&&j.message?j.message:"\u0641\u0634\u0644 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Notification.warning("\u26A0\uFE0F \u062A\u0639\u0630\u0651\u0631 \u062A\u0623\u0643\u064A\u062F \u062D\u0641\u0638 \u0627\u0644\u0632\u064A\u0627\u0631\u0629: "+F+". \u0633\u064A\u062A\u0645 \u0627\u0644\u062A\u062D\u0642\u0642 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645.")}catch{}}})(),setTimeout(()=>{document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]')&&this.state.activeTab==="visits"&&this.renderVisitsTab(),I&&document.querySelector('.clinic-tab-panel[data-tab-panel="medications"]')&&this.state.activeTab==="medications"&&this.renderMedicationsTab(),document.querySelector('.clinic-tab-panel[data-tab-panel="dispensed-medications"]')&&this.state.activeTab==="dispensed-medications"&&this.renderDispensedMedicationsTab();const O=document.querySelector("#total-visits");O&&(O.textContent=AppState.appData.clinicVisits.length)},100)}catch(R){Loading.hide(),this.showVisitFormAlert("\u062D\u062F\u062B \u062E\u0637\u0623: "+(R.message||"\u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641")),l&&(l.disabled=!1,l.innerHTML=r)}}),n.addEventListener("click",o=>{o.target===n&&confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&n.remove()})},async showMedicationForm(e=null){this.ensureData(),e&&(e=this.normalizeMedicationRecord(e));const t=!!e,a=document.createElement("div");a.className="modal-overlay";const i=(L="")=>Utils.escapeHTML(L||""),n=e?.purchaseDate?new Date(e.purchaseDate).toISOString().slice(0,10):"",s=e?.productionDate?new Date(e.productionDate).toISOString().slice(0,10):"",o=e?.expiryDate?new Date(e.expiryDate).toISOString().slice(0,10):"",l=this.calculateMedicationStatus(e||{}),r=e?.quantityAdded??e?.quantity??0,c=e?.remainingQuantity??e?.quantity??0,d=Math.max(0,r-c);a.innerHTML=`
        ...
        `,document.body.appendChild(a);const p=a.querySelector("#medication-form"),f=p.querySelector("#med-purchase"),m=p.querySelector("#med-expiry"),u=p.querySelector("#med-status-badge"),g=p.querySelector("#med-status-hint"),y=p.querySelector("#med-quantity"),v=p.querySelector("#med-remaining"),h=p.querySelector("#med-dispensed"),w=()=>{const L=this.calculateMedicationStatus({expiryDate:m.value?new Date(m.value).toISOString():null});u.className=`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${this.getMedicationStatusClasses(L.status)}`,u.innerHTML=`<i class="fas fa-info-circle"></i>${L.status}`,g.textContent=this.getMedicationStatusHint(L)};m?.addEventListener("change",w),y.addEventListener("input",()=>{const L=parseInt(y.value)||0,E=parseInt(h.value)||0;v.value=Math.max(0,L-E)}),v.addEventListener("input",()=>{const L=parseInt(y.value)||0,E=parseInt(v.value)||0;h.value=Math.max(0,L-E)}),p.addEventListener("submit",async L=>{L.preventDefault();const E=p.querySelector("#med-name").value.trim(),b=p.querySelector("#med-type").value.trim(),M=p.querySelector("#med-usage")?.value.trim()||"",U=p.querySelector("#med-purchase").value,N=p.querySelector("#med-production").value,S=p.querySelector("#med-expiry").value,T=parseInt(p.querySelector("#med-quantity").value,10)||0,D=parseInt(p.querySelector("#med-remaining").value,10)||0,x=p.querySelector("#med-location").value.trim(),k=p.querySelector("#med-notes").value.trim(),_=e?.createdAt||new Date().toISOString(),R=e?.createdBy||this.getCurrentUserSummary(),q=U?new Date(U).toISOString():new Date().toISOString(),H=N?new Date(N).toISOString():new Date().toISOString(),V=S?new Date(S).toISOString():"",B=this.calculateMedicationStatus({expiryDate:V}),A=this.getCurrentUserSummary(),I=this.normalizeMedicationRecord({id:e?.id||Utils.generateId("MED"),name:E,type:b,usage:M,purchaseDate:q,productionDate:H,expiryDate:V,quantityAdded:T,remainingQuantity:D,location:x,notes:k,createdAt:_,createdBy:R,createdById:R?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:A,status:B.status,daysRemaining:B.daysRemaining});Loading.show();try{const C=AppState.appData.medications||[];if(t){const z=C.findIndex(j=>j.id===I.id);z!==-1?C[z]=I:C.push(I)}else C.push(I);AppState.appData.medications=C,AppState.appData.clinicMedications=C,AppState.appData.clinicInventory=C;try{this.calculateClinicCardValues(),this.updateClinicAnalysisResults()}catch(z){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0643\u0631\u0648\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 (\u062F\u0648\u0627\u0621):",z)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0648\u0627\u0621 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u0648\u0627\u0621 \u0628\u0646\u062C\u0627\u062D"),a.remove(),this.state.medicationAlertsNotified.delete(I.id),setTimeout(()=>{document.querySelector('.clinic-tab-panel[data-tab-panel="medications"]')&&this.state.activeTab==="medications"&&this.renderMedicationsTab();const j=document.querySelector("#total-medications");j&&(j.textContent=C.length)},100),(async()=>{try{t?await GoogleIntegration.sendRequest({action:"updateMedication",data:{medicationId:I.id,updateData:I}}):await GoogleIntegration.sendRequest({action:"addMedication",data:I}),pendingNotification&&typeof GoogleIntegration<"u"&&await GoogleIntegration.sendRequest({action:"addNotification",data:{id:Utils.generateId("NOTIF"),title:t?"\u0637\u0644\u0628 \u062A\u0639\u062F\u064A\u0644 \u062F\u0648\u0627\u0621":"\u0637\u0644\u0628 \u0625\u0636\u0627\u0641\u0629 \u062F\u0648\u0627\u0621 \u062C\u062F\u064A\u062F",message:`\u0642\u0627\u0645 ${A.name} \u0628\u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 ${t?"\u062A\u0639\u062F\u064A\u0644":"\u0625\u0636\u0627\u0641\u0629"} \u0644\u0644\u062F\u0648\u0627\u0621: ${I.name}`,type:"alert",targetRoles:["admin","manager"],createdAt:new Date().toISOString(),readBy:[],link:"#clinic-medications"}}),document.dispatchEvent(new CustomEvent("data-saved",{detail:{module:"medications",action:t?"\u062A\u062D\u062F\u064A\u062B":"\u0625\u0636\u0627\u0641\u0629",data:I}}))}catch(z){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 Google Sheets:",z)}})()}catch(C){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+C.message)}}),a.addEventListener("click",L=>{L.target===a&&confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&d.remove()})},printVisitsList(){const e=AppState.appData.clinicVisits.slice().reverse();if(e.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const a=`
        ...
        `,i=window.open("","_blank");i&&(i.document.write(a),i.document.close(),i.onload=()=>{setTimeout(()=>{i.print(),Notification.success("\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u0633\u062C\u0644\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629")},250)})},exportVisitsToExcel(){this.ensureData();const e=this.state.activeVisitType||"employees",t=e==="contractors",a=(AppState.appData.clinicVisits||[]).slice().reverse(),i=a.filter(o=>o.personType==="employee"||!o.personType),n=a.filter(o=>o.personType==="contractor"),s=e==="employees"?i:n;if(s.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}if(typeof XLSX>"u"){Notification.error("\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629");return}try{const o=s.map(d=>{const p=t?d.contractorName||d.employeeName||d.externalName||"-":d.employeeCode||d.employeeNumber||"-",f=t?d.contractorWorkerName||"-":d.employeeName||"-",m=d.employeePosition||d.contractorPosition||"-",u=this.getVisitFactoryDisplayName(d),g=t?d.workArea||d.employeeLocation||"-":d.employeeLocation||d.workArea||"-",y=d.visitDate?Utils.formatDateTime(d.visitDate):"-",v=d.exitDate?Utils.formatDateTime(d.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",h=this.calculateTotalTime(d.visitDate,d.exitDate),w=d.reason||"",L=d.diagnosis||"",E=this.normalizeVisitMedications(d.medications),b=E.length>0?E.map(N=>`${N.medicationName||""} (${N.quantity||1})`).join("\u060C "):"-",M=E.length>0?E.reduce((N,S)=>N+(parseInt(S.quantity,10)||0),0):0,U={};return U[t?"\u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A"]=p,U.\u0627\u0644\u0627\u0633\u0645=f,U.\u0627\u0644\u0648\u0638\u064A\u0641\u0629=m,U.\u0627\u0644\u0645\u0635\u0646\u0639=u,U["\u0645\u0643\u0627\u0646 \u0627\u0644\u0639\u0645\u0644"]=g,U["\u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644"]=y,U["\u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C"]=v,U["\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0648\u0642\u062A"]=h,U["\u0633\u0628\u0628 \u0627\u0644\u0632\u064A\u0627\u0631\u0629"]=w,U.\u0627\u0644\u062A\u0634\u062E\u064A\u0635=L,U["\u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629"]=b,U["\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629"]=M,U}),l=XLSX.utils.book_new(),r=XLSX.utils.json_to_sheet(o);r["!cols"]=[{wch:18},{wch:25},{wch:20},{wch:16},{wch:20},{wch:20},{wch:20},{wch:15},{wch:25},{wch:25},{wch:30},{wch:14}],XLSX.utils.book_append_sheet(l,r,`\u0633\u062C\u0644\u0627\u062A_${t?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646":"\u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646"}`);const c=`\u0633\u062C\u0644\u0627\u062A_\u0627\u0644\u0632\u064A\u0627\u0631\u0629_${t?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646":"\u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646"}_\u0627\u0644\u0639\u064A\u0627\u062F\u0629_\u0627\u0644\u0637\u0628\u064A\u0629_${new Date().toISOString().slice(0,10)}.xlsx`;XLSX.writeFile(l,c),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0633\u062C\u0644\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0625\u0644\u0649 Excel \u0628\u0646\u062C\u0627\u062D")}catch(o){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 Excel:",o),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 Excel: "+o.message)}},async exportVisitsToPDF(){this.ensureData();const e=this.state.activeVisitType||"employees",t=e==="contractors",a=(AppState.appData.clinicVisits||[]).slice().reverse(),i=a.filter(o=>o.personType==="employee"||!o.personType),n=a.filter(o=>o.personType==="contractor"),s=e==="employees"?i:n;if(s.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}try{const o=s.map(u=>{const g=t?u.contractorName||u.employeeName||u.externalName||"-":u.employeeCode||u.employeeNumber||"-",y=t?u.contractorWorkerName||"-":u.employeeName||"-",v=t?u.contractorPosition||u.employeePosition||"-":u.employeePosition||"-",h=this.getVisitFactoryDisplayName(u),w=t?u.workArea||u.employeeLocation||"-":u.employeeLocation||u.workArea||"-",L=u.visitDate?Utils.formatDateTime(u.visitDate):"-",E=u.exitDate?Utils.formatDateTime(u.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",b=Clinic.calculateTotalTime(u.visitDate,u.exitDate),M=u.reason||"",U=u.diagnosis||"",N=this.normalizeVisitMedications(u.medications),S=N.length>0?N.map(D=>`${Utils.escapeHTML(D.medicationName||"")} (${D.quantity||1})`).join("\u060C "):"-",T=N.length>0?N.reduce((D,x)=>D+(parseInt(x.quantity,10)||0),0):0;return`
                    <tr>
                        ...
                        <td style="border: 1px solid #d1d5db; padding: 6px; text-align: right; font-size: 9px;">${S}</td>
            ...
            `,d=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(l,r,c,!1,!0,{source:"ClinicVisits"},new Date().toISOString(),new Date().toISOString()):`<html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>${r}</title></head><body>${c}</body></html>`,p=new Blob([d],{type:"text/html;charset=utf-8"}),f=URL.createObjectURL(p),m=window.open(f,"_blank");m?m.onload=()=>{setTimeout(()=>{m.print(),setTimeout(()=>{URL.revokeObjectURL(f)},1e3),Notification.success("\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u0633\u062C\u0644\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629/\u0627\u0644\u062D\u0641\u0638 \u0643\u0640 PDF")},250)}:(URL.revokeObjectURL(f),Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF"))}catch(o){URL.revokeObjectURL(url),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF:",o),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF: "+o.message)}},async exportVisitToPDF(e){if(!e){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}try{const t=e.personType==="employee"?"\u0645\u0648\u0638\u0641":e.personType==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0639\u0645\u0627\u0644\u0629 \u062E\u0627\u0631\u062C\u064A\u0629",a=e.employeeCode||e.employeeNumber||"-",i=e.employeeName||e.contractorName||e.externalName||"",n=e.contractorWorkerName?` (${e.contractorWorkerName})`:"",s=e.employeePosition||e.contractorPosition||"-",o=e.employeeLocation||e.workArea||"-",l=e.visitDate?Utils.formatDateTime(e.visitDate):"-",r=e.exitDate?Utils.formatDateTime(e.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",c=this.calculateTotalTime(e.visitDate,e.exitDate),d=e.reason||"",p=e.diagnosis||"",f=e.treatment||"",m=e.medications&&Array.isArray(e.medications)&&e.medications.length>0?e.medications.map(E=>`${Utils.escapeHTML(E.medicationName||"")} (${E.quantity||1})`).join("\u060C "):"\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629",u=`CLINIC-VISIT-${e.id||new Date().toISOString().slice(0,10)}`,g="\u062A\u0642\u0631\u064A\u0631 \u0632\u064A\u0627\u0631\u0629 \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0637\u0628\u064A\u0629",y=`
                <div style="margin-bottom: 20px;">
            ...
            @media(prefers-reduced-motion:reduce){.cw-control{transition:none}}
                ...
                <div class="clinic-workflow-root" id="clinic-approvals-root">
                    ...
                    <section class="cw-kpis" aria-label="\u0645\u0644\u062E\u0635 \u0637\u0644\u0628\u0627\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629">
                        ...
                        <div class="cw-kpi"><span class="cw-kpi-icon"><i class="fas fa-check"></i></span><div><small>\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647\u0627</small><strong>${E.length}</strong></div></div>
                ...
                </div>`;const U=document.getElementById("approvals-status-filter"),N=document.getElementById("approvals-type-filter"),S=document.getElementById("approvals-search-filter"),T=document.getElementById("approvals-reset-filters"),D=document.getElementById("approvals-refresh-btn"),x=()=>{const k=U?.value||"all",_=N?.value||"all",R=this.normalizeArabicText(S?.value||"");let q=w;k!=="all"&&(q=q.filter(A=>A.status===k)),_!=="all"&&(q=q.filter(A=>this._approvalRequestMatchesTypeFilter(A,_))),R&&(q=q.filter(A=>this.normalizeArabicText([A.itemName,A.requestedBy?.name,A.requestedByName,A.userName,A.userEmail,A.medicationData?.name,A.visitData?.employeeName,A.visitData?.contractorName,A.reason].filter(Boolean).join(" ")).includes(R)));const H=document.getElementById("approvals-table-container");H&&(H.innerHTML=this.renderApprovalsTable(q),this.bindApprovalsEvents(H));const V=document.getElementById("approvals-filter-count"),B=document.getElementById("approvals-result-pill");V&&(V.textContent=`${q.length} \u0645\u0646 ${w.length}`),B&&(B.textContent=`${q.length} \u0637\u0644\u0628`)};U&&U.addEventListener("change",x),N&&N.addEventListener("change",x),S?.addEventListener("input",x),T?.addEventListener("click",()=>{S&&(S.value=""),U&&(U.value="pending"),N&&(N.value="all"),x()}),D?.addEventListener("click",async()=>{D.disabled=!0,D.innerHTML='<i class="fas fa-spinner fa-spin"></i>\u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u062F\u064A\u062B';try{await this.ensureApprovalsDataLoaded({force:!0})}finally{this.renderApprovalsTab()}}),this.bindApprovalsEvents(e),setTimeout(()=>{const k=e.querySelector(".clinic-table-wrapper");k&&this.setupTableScrollListeners(k)},100)}catch(t){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0639\u0631\u0636 \u0637\u0644\u0628\u0627\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629:",t),e.innerHTML='<div class="alert alert-error">\u062D\u062F\u062B \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A</div>'}},renderApprovalsTable(e){return!e||e.length===0?'<div class="cw-empty"><i class="fas fa-inbox"></i><h3>\u0644\u0627 \u062A\u0648\u062C\u062F \u0637\u0644\u0628\u0627\u062A \u0645\u0637\u0627\u0628\u0642\u0629</h3><p>\u063A\u064A\u0651\u0631 \u0627\u0644\u0641\u0644\u0627\u062A\u0631 \u0623\u0648 \u062D\u062F\u0651\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0639\u0631\u0636 \u0627\u0644\u0637\u0644\u0628\u0627\u062A.</p></div>':`
...
<div class="att-report-doc" id="attendance-report-root">
    ...
    <div class="att-report-footer">${i} \u2014 \u062A\u0642\u0631\u064A\u0631 \u062D\u0636\u0648\u0631 \u0645\u0633\u0626\u0648\u0644\u064A \u0627\u0644\u0639\u064A\u0627\u062F\u0629</div>
            ...
            <tbody>${t}</tbody>
        </table>`)},renderAttendanceSelfTab(e){this._saveTimeOffFormDraftFromDom(),this._scheduleLeaveBalancesLoadIfNeeded(!1),this.ensureData();const t=this._isAttendanceDataLoading(),a=this._isLeaveBalancesLoading(),i=this._getLeaveBalancePeriodDefaults(),n=this.getClinicStaffLeaveBalancesList()[0]||{},s=n.month||{},o=n.year||{};this.state.filters=this.state.filters||{},this.state.filters.attendance=Object.assign({search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"},this.state.filters.attendance||{});const l=this.state.filters.attendance,r=this.getFilteredClinicAttendance(),c=this.getClinicStaffTimeOffRequestsList().sort((T,D)=>new Date(D.requestedAt||D.createdAt)-new Date(T.requestedAt||T.createdAt)),d=c.filter(T=>T.status==="pending").length,p=this._computeAttendanceReportStats(r),f=this.getCurrentUserStaffRecord(),m=this.getFilteredClinicStaffActivities(),u=!!this._clinicStaffActivitiesLoading,g=this._countActiveAttendanceFilters(l),y=this.state.attendanceFilterPanelOpen!==!1,v=l.period||"all",h={today:"\u0627\u0644\u064A\u0648\u0645",week:"7 \u0623\u064A\u0627\u0645",month:"30 \u064A\u0648\u0645",all:"\u0627\u0644\u0643\u0644"},L="min-width:0;box-sizing:border-box;width:100%;padding:8px 11px;border:1.5px solid #99f6e4;border-radius:8px;font-size:0.82rem;background:#fff;color:#374151;",E="font-size:0.72rem;font-weight:700;color:#64748b;display:block;margin-bottom:5px;",b=t&&r.length===0?this._renderAttendanceTableLoadingRow(5):r.length?r.map(T=>`
            <tr>
        ...
        `).join(""):'<tr><td colspan="6" class="text-center text-gray-500 py-8">\u0644\u0627 \u062A\u0648\u062C\u062F \u0633\u062C\u0644\u0627\u062A \u062D\u0636\u0648\u0631</td></tr>',M=[{id:"clinic-attendance-section-timeoff",label:"\u0637\u0644\u0628 \u062C\u062F\u064A\u062F",icon:"fa-paper-plane"},{id:"clinic-attendance-section-my-requests",label:"\u0637\u0644\u0628\u0627\u062A\u064A",icon:"fa-list"},{id:"clinic-attendance-section-records",label:"\u0633\u062C\u0644 \u062D\u0636\u0648\u0631\u064A",icon:"fa-clipboard-user"},{id:"clinic-staff-activities-section",label:"\u0646\u0634\u0627\u0637\u064A",icon:"fa-history"},{id:"clinic-leave-balances-section",label:"\u0623\u0631\u0635\u062F\u0629 \u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A",icon:"fa-wallet"},{id:"clinic-approved-timeoff-section",label:"\u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0639\u062A\u0645\u062F\u0629",icon:"fa-check-circle"}];e.innerHTML=`
            <div id="clinic-attendance-self-root">
                ...
                <div style="padding:14px 18px;background:linear-gradient(135deg,#134e4a,#0d9488);border-radius:14px;color:#fff;margin-bottom:14px;display:flex;justify-content:space-between;flex-wrap:wrap;gap:10px;align-items:center;">
                    ...
                    <div style="display:flex;gap:6px;flex-wrap:wrap;">
                        ${["today","week","month","all"].map(T=>{const D=v===T;return`<button type="button" class="clinic-attendance-period-btn" data-period="${T}" style="padding:5px 10px;border-radius:8px;border:none;cursor:pointer;font-size:0.74rem;font-weight:600;background:${D?"#fff":"rgba(255,255,255,0.14)"};color:${D?"#134e4a":"#fff"};">${h[T]}</button>`}).join("")}
                ...
                <div id="clinic-attendance-filter-panel" style="display:${y?"block":"none"};background:#f0fdfa;border:1.5px solid #99f6e4;border-radius:12px;padding:14px;margin-bottom:14px;">
                    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px;">
                        <div><label style="${E}">\u0627\u0644\u0634\u0647\u0631</label><input type="month" id="clinic-attendance-month" style="${L}" value="${Utils.escapeAttr(l.month||"")}"></div>
                        ...
                        <div><label style="${E}">\u0645\u0646 \u062A\u0627\u0631\u064A\u062E</label><input type="date" id="clinic-attendance-from" style="${L}" value="${Utils.escapeAttr(l.dateFrom||"")}"></div>
                        <div><label style="${E}">\u0625\u0644\u0649 \u062A\u0627\u0631\u064A\u062E</label><input type="date" id="clinic-attendance-to" style="${L}" value="${Utils.escapeAttr(l.dateTo||"")}"></div>
                    </div>
            ...
            </div>`;const U=()=>{const T=document.getElementById("clinic-attendance-month")?.value||"";let D=document.getElementById("clinic-attendance-from")?.value||"",x=document.getElementById("clinic-attendance-to")?.value||"";if(T&&!D&&!x){const k=this._getAttendanceMonthRange(T);D=k.dateFrom,x=k.dateTo}else{const k=this._normalizeAttendanceDateRange(D,x);D=k.dateFrom,x=k.dateTo}return{search:"",staffRole:"all",status:document.getElementById("clinic-attendance-status")?.value||"all",staffId:"all",month:T,dateFrom:D,dateTo:x,period:this.state.filters.attendance?.period||"all"}},N=()=>{this.state.filters.attendance=U.call(this),this.renderAttendanceTab({force:!0})},S=T=>{const D=this._getTodayLocalKey();let x="",k="";if(T==="today")x=D,k=D;else if(T==="week"){const _=new Date;_.setDate(_.getDate()-6),x=this._attendanceDayKey(_),k=D}else if(T==="month"){const _=new Date;_.setDate(_.getDate()-29),x=this._attendanceDayKey(_),k=D}this.state.filters.attendance=Object.assign({},this.state.filters.attendance||{},{period:T,month:"",dateFrom:x,dateTo:k}),this.renderAttendanceTab({force:!0})};e.querySelector("#clinic-attendance-status")?.addEventListener("change",N),e.querySelector("#clinic-attendance-month")?.addEventListener("change",N),e.querySelector("#clinic-attendance-from")?.addEventListener("change",N),e.querySelector("#clinic-attendance-to")?.addEventListener("change",N),e.querySelector("#clinic-attendance-reset-filters")?.addEventListener("click",()=>{this.state.filters.attendance={search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"},this.renderAttendanceTab({force:!0})}),e.querySelector("#clinic-attendance-toggle-filters")?.addEventListener("click",()=>{this.state.attendanceFilterPanelOpen=!y;const T=e.querySelector("#clinic-attendance-filter-panel");T&&(T.style.display=this.state.attendanceFilterPanelOpen?"block":"none")}),e.querySelectorAll(".clinic-attendance-period-btn").forEach(T=>{T.addEventListener("click",()=>S(T.dataset.period||"all"))}),e.querySelector("#clinic-attendance-export-btn")?.addEventListener("click",()=>this.exportAttendanceToExcel()),e.querySelector("#clinic-attendance-pdf-btn")?.addEventListener("click",()=>this.exportAttendanceToPDF()),e.querySelector("#clinic-attendance-refresh-btn")?.addEventListener("click",async()=>{Notification?.info?.("\u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u062F\u064A\u062B..."),this._attendanceDataFetchedInSession=!1,await this.loadClinicAttendanceData(!0),this._attendanceDataFetchedInSession=!0,this.renderAttendanceTab({force:!0}),Notification?.success?.("\u062A\u0645 \u0627\u0644\u062A\u062D\u062F\u064A\u062B")}),this.bindClinicStaffActivitiesEvents(e),this.bindClinicStaffLeaveBalanceEvents(e),this.bindAttendanceQuickNav(e),this.initAttendanceTableScroll(e),this._applyTimeOffFormDraftToPanel(e),this._bindTimeOffFormPanelEvents(e)},renderAttendanceTab(e){if(!(e&&e.force===!0)&&this._shouldDeferAttendanceRender()){this._attendanceRenderPending=!0;return}this._attendanceRenderPending=!1;const a=document.querySelector('.clinic-tab-panel[data-tab-panel="attendance"]');if(!a)return;if(!this.canAccessAttendanceTab()){a.innerHTML=`<div class="text-center py-12 text-gray-500">
            ...
            </div>`;return}this.isCurrentUserAdmin()&&this.prefetchClinicAttendanceForAdminIfNeeded(!1),this._scheduleAttendanceDataLoadIfNeeded(!1),this._scheduleLeaveBalancesLoadIfNeeded(!1);const i=this._isAttendanceDataLoading(),n=this._isLeaveBalancesLoading(),s=this._getLeaveBalancePeriodDefaults(),o=this.getClinicStaffLeaveBalancesList();if(!this.canViewAllAttendanceData())return this.renderAttendanceSelfTab(a);this.ensureData(),this.state.filters=this.state.filters||{},this.state.filters.attendance=Object.assign({search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"},this.state.filters.attendance||{});const l=this.state.filters.attendance,r=this.getFilteredClinicAttendance(),c=this.getClinicStaffList(),d=this._getAttendanceStaffOptions(),p=c.filter(A=>String(A.isActive||"true").toLowerCase()!=="false"),f=this._getTodayLocalKey(),m=this.getClinicStaffAttendanceList(),u=m.filter(A=>this._attendanceDayKey(A.date)===f),g=u.filter(A=>A.checkIn).length,y=u.filter(A=>A.checkIn&&!A.checkOut).length,v=this.isCurrentUserAdmin(),h=this.getFilteredClinicStaffActivities(),w=!!this._clinicStaffActivitiesLoading,L=this._countActiveAttendanceFilters(l),E=this.state.attendanceFilterPanelOpen!==!1,b=l.period||"all",M={today:"\u0627\u0644\u064A\u0648\u0645",week:"7 \u0623\u064A\u0627\u0645",month:"30 \u064A\u0648\u0645",all:"\u0627\u0644\u0643\u0644"},U="min-width:0;box-sizing:border-box;",N=`${U}width:100%;padding:8px 11px;border:1.5px solid #99f6e4;border-radius:8px;font-size:0.82rem;background:#fff;color:#374151;transition:border-color .2s,box-shadow .2s;`,S="font-size:0.72rem;font-weight:700;color:#64748b;display:block;margin-bottom:5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;",T="this.style.borderColor='#0d9488';this.style.boxShadow='0 0 0 3px rgba(13,148,136,0.12)'",D="this.style.borderColor='#99f6e4';this.style.boxShadow='none'",x=d.map(A=>`<option value="${Utils.escapeAttr(A.id)}" ${String(l.staffId)===String(A.id)?"selected":""}>${Utils.escapeHTML(A.name)}</option>`).join(""),k=i&&r.length===0?this._renderAttendanceTableLoadingRow(10):r.length?r.map(A=>`
            <tr>
                <td>${Utils.escapeHTML(A.userName||"\u2014")}</td>
                <td>${Utils.escapeHTML(A.userEmail||"\u2014")}</td>
                <td>${Utils.escapeHTML(this.getStaffRoleLabel(A.staffRole))}</td>
                <td>${Utils.escapeHTML(A.date||"\u2014")}</td>
                <td>${A.checkIn?Utils.formatDateTime?Utils.formatDateTime(A.checkIn):Utils.escapeHTML(String(A.checkIn)):"\u2014"}</td>
                <td>${A.checkOut?Utils.formatDateTime?Utils.formatDateTime(A.checkOut):Utils.escapeHTML(String(A.checkOut)):"\u2014"}</td>
                <td>${Utils.escapeHTML(String(A.workDuration||"\u2014"))}</td>
                <td><span class="badge ${this.getAttendanceStatusBadgeClass(A.status)}">${Utils.escapeHTML(this.getAttendanceStatusLabel(A.status))}</span></td>
                <td class="text-xs text-gray-500">${Utils.escapeHTML(String(A.sessionId||"\u2014").slice(0,18))}</td>
                <td>${this._renderAttendancePunchActions(A)}</td>
            </tr>
        `).join(""):'<tr><td colspan="10" class="text-center text-gray-500 py-8"><i class="fas fa-calendar-times ml-2 opacity-60"></i>\u0644\u0627 \u062A\u0648\u062C\u062F \u0633\u062C\u0644\u0627\u062A \u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0644\u0641\u0644\u0627\u062A\u0631</td></tr>',_=v?c.length?c.map(A=>{const I=String(A.isActive||"true").toLowerCase()!=="false";return`<tr>
                <td>${Utils.escapeHTML(A.userName||"\u2014")}</td>
                <td>${Utils.escapeHTML(this.getStaffRoleLabel(A.staffRole))}</td>
                <td>${I?'<span class="badge badge-success">\u0646\u0634\u0637</span>':'<span class="badge badge-secondary">\u0645\u0648\u0642\u0648\u0641</span>'}</td>
                <td>
                    <button type="button" class="btn-icon btn-icon-warning" title="${I?"\u0625\u064A\u0642\u0627\u0641":"\u062A\u0641\u0639\u064A\u0644"}" onclick="Clinic.toggleClinicStaffActive('${Utils.escapeAttr(A.id)}', ${!I})"><i class="fas fa-${I?"pause":"play"}"></i></button>
                    <button type="button" class="btn-icon btn-icon-danger" title="\u062D\u0630\u0641" onclick="Clinic.deleteClinicStaffMember('${Utils.escapeAttr(A.id)}')"><i class="fas fa-trash"></i></button>
                </td>
            </tr>`}).join(""):'<tr><td colspan="4" class="text-center text-gray-500 py-4">\u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0633\u0626\u0648\u0644\u0648\u0646 \u2014 \u0623\u0636\u0641 \u0645\u0646 \u0627\u0644\u0642\u0627\u0626\u0645\u0629</td></tr>':"",R=[{id:"clinic-attendance-section-records",label:"\u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631",icon:"fa-clipboard-user"},{id:"clinic-staff-activities-section",label:"\u0646\u0634\u0627\u0637 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645\u064A\u0646",icon:"fa-history"},{id:"clinic-leave-balances-section",label:"\u0623\u0631\u0635\u062F\u0629 \u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A",icon:"fa-wallet"},{id:"clinic-approved-timeoff-section",label:"\u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0639\u062A\u0645\u062F\u0629",icon:"fa-check-circle"}];v&&R.push({id:"clinic-attendance-section-staff",label:"\u0645\u0633\u0626\u0648\u0644\u0648 \u0627\u0644\u0639\u064A\u0627\u062F\u0629",icon:"fa-users"}),a.innerHTML=`
            <style>
            ...
            <div id="clinic-attendance-root" style="font-family:inherit;">
                ${this.renderAttendanceQuickNav(R)}
                <!-- KPI -->
                <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(155px,1fr));gap:10px;margin-bottom:14px;">
                    ${[{label:"\u062D\u0627\u0636\u0631\u0648\u0646 \u0627\u0644\u064A\u0648\u0645",value:g,icon:"fa-user-check",color:"#059669",bg:"#ecfdf5"},{label:"\u0628\u062F\u0648\u0646 \u062A\u0633\u062C\u064A\u0644 \u062E\u0631\u0648\u062C",value:y,icon:"fa-door-open",color:"#d97706",bg:"#fffbeb"},{label:"\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0641\u0644\u062A\u0631",value:r.length,icon:"fa-filter",color:"#2563eb",bg:"#eff6ff"},{label:"\u0645\u0633\u0626\u0648\u0644\u0648\u0646 \u0646\u0634\u0637\u0648\u0646",value:p.length,icon:"fa-users",color:"#4f46e5",bg:"#eef2ff"}].map(A=>`
                        <div style="background:${A.bg};border:1px solid rgba(0,0,0,0.04);border-radius:12px;padding:14px 16px;display:flex;align-items:center;gap:12px;">
                            ...
                            <div>
                                <p style="margin:0;font-size:0.72rem;color:#64748b;font-weight:600;">${A.label}</p>
                                <p style="margin:2px 0 0;font-size:1.45rem;font-weight:800;color:${A.color};line-height:1.1;">${A.value}</p>
                            </div>
                        </div>
                    `).join("")}
                </div>
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:12px;padding:14px 18px;background:linear-gradient(135deg,#134e4a 0%,#0d9488 100%);border-radius:14px;color:#fff;box-shadow:0 4px 18px rgba(13,148,136,0.28);">
                    ...
                    <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
                        ...
                        ${["today","week","month","all"].map(A=>{const I=b===A;return`<button type="button" class="clinic-attendance-period-btn" data-period="${A}" style="padding:5px 11px;border-radius:8px;border:none;cursor:pointer;font-size:0.74rem;font-weight:600;transition:all .2s;background:${I?"#fff":"rgba(255,255,255,0.14)"};color:${I?"#134e4a":"#fff"};">${M[A]}</button>`}).join("")}
                ...
                <div id="clinic-attendance-filter-panel" style="display:${E?"block":"none"};background:#f0fdfa;border:1.5px solid #99f6e4;border-radius:12px;padding:16px 18px;margin-bottom:14px;">
                    ...
                    <div id="clinic-attendance-filter-grid" style="display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px 12px;">
                        <div style="grid-column:1/-1;${U}">
                            <label style="${S}"><i class="fas fa-search" style="color:#0d9488;margin-left:4px;"></i>\u0628\u062D\u062B \u0628\u0627\u0644\u0627\u0633\u0645 \u0623\u0648 \u0627\u0644\u0628\u0631\u064A\u062F</label>
                            <input type="search" id="clinic-attendance-search" style="${N}" placeholder="\u0627\u0643\u062A\u0628 \u0644\u0644\u0628\u062D\u062B..." value="${Utils.escapeAttr(l.search||"")}" autocomplete="off" onfocus="${T}" onblur="${D}">
                        </div>
                        <div style="${U}">
                            <label style="${S}"><i class="fas fa-calendar-alt" style="color:#f59e0b;margin-left:4px;"></i>\u0627\u0644\u0634\u0647\u0631</label>
                            <input type="month" id="clinic-attendance-month" style="${N}" value="${Utils.escapeAttr(l.month||"")}" onfocus="${T}" onblur="${D}">
                        </div>
                        <div style="${U}">
                            <label style="${S}"><i class="fas fa-user" style="color:#6366f1;margin-left:4px;"></i>\u0627\u0644\u0645\u0633\u0626\u0648\u0644</label>
                            <select id="clinic-attendance-staff" style="${N}cursor:pointer;" onfocus="${T}" onblur="${D}">
                                <option value="all" ${!l.staffId||l.staffId==="all"?"selected":""}>\u0643\u0644 \u0627\u0644\u0645\u0633\u0626\u0648\u0644\u064A\u0646</option>
                                ${x}
                            </select>
                        </div>
                        <div style="${U}">
                            <label style="${S}"><i class="fas fa-user-tag" style="color:#8b5cf6;margin-left:4px;"></i>\u0627\u0644\u062F\u0648\u0631</label>
                            <select id="clinic-attendance-role" style="${N}cursor:pointer;" onfocus="${T}" onblur="${D}">
                        ...
                        <div style="${U}">
                            <label style="${S}"><i class="fas fa-circle-check" style="color:#059669;margin-left:4px;"></i>\u0627\u0644\u062D\u0627\u0644\u0629</label>
                            <select id="clinic-attendance-status" style="${N}cursor:pointer;" onfocus="${T}" onblur="${D}">
                        ...
                        <div style="${U}">
                            <label style="${S}"><i class="fas fa-calendar-day" style="color:#f59e0b;margin-left:4px;"></i>\u0645\u0646 \u062A\u0627\u0631\u064A\u062E</label>
                            <input type="date" id="clinic-attendance-from" style="${N}" value="${Utils.escapeAttr(l.dateFrom||"")}" onfocus="${T}" onblur="${D}">
                        </div>
                        <div style="${U}">
                            <label style="${S}"><i class="fas fa-calendar-check" style="color:#3b82f6;margin-left:4px;"></i>\u0625\u0644\u0649 \u062A\u0627\u0631\u064A\u062E</label>
                            <input type="date" id="clinic-attendance-to" style="${N}" value="${Utils.escapeAttr(l.dateTo||"")}" onfocus="${T}" onblur="${D}">
                        </div>
                    </div>
                    ${L?`
                    <div style="margin-top:12px;padding-top:10px;border-top:1px dashed #99f6e4;display:flex;flex-wrap:wrap;gap:6px;align-items:center;">
                        ...
                        ${l.staffId&&l.staffId!=="all"?`<span style="background:#fff;border:1px solid #99f6e4;color:#0f766e;padding:3px 8px;border-radius:999px;font-size:0.72rem;">${Utils.escapeHTML((d.find(A=>String(A.id)===String(l.staffId))||{}).name||l.staffId)}</span>`:""}
            ...
            </div>`;const q=()=>{const A=document.getElementById("clinic-attendance-month")?.value||"";let I=document.getElementById("clinic-attendance-from")?.value||"",C=document.getElementById("clinic-attendance-to")?.value||"";if(A&&!I&&!C){const z=this._getAttendanceMonthRange(A);I=z.dateFrom,C=z.dateTo}else{const z=this._normalizeAttendanceDateRange(I,C);I=z.dateFrom,C=z.dateTo}return{search:document.getElementById("clinic-attendance-search")?.value||"",staffRole:document.getElementById("clinic-attendance-role")?.value||"all",status:document.getElementById("clinic-attendance-status")?.value||"all",staffId:document.getElementById("clinic-attendance-staff")?.value||"all",month:A,dateFrom:I,dateTo:C,period:this.state.filters.attendance?.period||"all"}},H=()=>{this.state.filters.attendance=q.call(this),this.renderAttendanceTab({force:!0})},V=A=>{const I=this._getTodayLocalKey();let C="",z="";if(A==="today")C=I,z=I;else if(A==="week"){const j=new Date;j.setDate(j.getDate()-6),C=this._attendanceDayKey(j),z=I}else if(A==="month"){const j=new Date;j.setDate(j.getDate()-29),C=this._attendanceDayKey(j),z=I}this.state.filters.attendance=Object.assign({},this.state.filters.attendance||{},{period:A,month:"",dateFrom:C,dateTo:z}),this.renderAttendanceTab({force:!0})},B=a.querySelector("#clinic-attendance-search");if(B?.addEventListener("input",A=>{this._attendanceSearchFocused=!0,this._attendanceSearchCursor=A.target.selectionStart,clearTimeout(this._attendanceSearchTimer),this._attendanceSearchTimer=setTimeout(H,280)}),B?.addEventListener("focus",()=>{this._attendanceSearchFocused=!0}),B?.addEventListener("blur",()=>{this._attendanceSearchFocused=!1}),a.querySelector("#clinic-attendance-role")?.addEventListener("change",H),a.querySelector("#clinic-attendance-status")?.addEventListener("change",H),a.querySelector("#clinic-attendance-staff")?.addEventListener("change",H),a.querySelector("#clinic-attendance-month")?.addEventListener("change",()=>{const A=document.getElementById("clinic-attendance-month")?.value||"",I=A?this._getAttendanceMonthRange(A):{dateFrom:"",dateTo:""};this.state.filters.attendance=Object.assign({},q.call(this),{month:A,dateFrom:I.dateFrom,dateTo:I.dateTo,period:"monthPick"}),H()}),a.querySelector("#clinic-attendance-from")?.addEventListener("change",()=>{this.state.filters.attendance=Object.assign({},q.call(this),{month:"",period:"custom"}),H()}),a.querySelector("#clinic-attendance-to")?.addEventListener("change",()=>{this.state.filters.attendance=Object.assign({},q.call(this),{month:"",period:"custom"}),H()}),a.querySelector("#clinic-attendance-reset-filters")?.addEventListener("click",()=>{this.state.filters.attendance={search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"},this.renderAttendanceTab({force:!0})}),a.querySelector("#clinic-attendance-toggle-filters")?.addEventListener("click",()=>{this.state.attendanceFilterPanelOpen=!E;const A=a.querySelector("#clinic-attendance-filter-panel");A&&(A.style.display=this.state.attendanceFilterPanelOpen?"block":"none")}),a.querySelectorAll(".clinic-attendance-period-btn").forEach(A=>{A.addEventListener("click",()=>V(A.dataset.period||"all"))}),a.querySelector("#clinic-attendance-export-btn")?.addEventListener("click",()=>this.exportAttendanceToExcel()),a.querySelector("#clinic-attendance-pdf-btn")?.addEventListener("click",()=>this.exportAttendanceToPDF()),a.querySelector("#clinic-attendance-report-btn")?.addEventListener("click",()=>this.showAttendanceReportModal()),a.querySelector("#clinic-attendance-add-staff-btn")?.addEventListener("click",()=>this.showAddClinicStaffModal()),a.querySelector("#clinic-attendance-add-punch-btn")?.addEventListener("click",()=>this.showAddMissingAttendanceModal()),a.querySelector("#clinic-attendance-refresh-btn")?.addEventListener("click",async()=>{Notification?.info?.("\u062C\u0627\u0631\u064A \u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631..."),this._attendanceDataFetchedInSession=!1,await this.loadClinicAttendanceData(!0),this._attendanceDataFetchedInSession=!0,this.renderAttendanceTab({force:!0}),Notification?.success?.("\u062A\u0645 \u0627\u0644\u062A\u062D\u062F\u064A\u062B")}),this.bindClinicStaffActivitiesEvents(a),this.bindClinicStaffLeaveBalanceEvents(a),this.bindAttendanceQuickNav(a),this.initAttendanceTableScroll(a),this._attendanceSearchFocused&&B){B.focus();const A=this._attendanceSearchCursor;if(A!=null&&typeof B.setSelectionRange=="function")try{B.setSelectionRange(A,A)}catch{}}},hasTabAccess(e){const t=AppState.currentUser;if(!t)return!1;if(this.isCurrentUserAdmin())return!0;if(e==="attendance")return this.canAccessAttendanceTab();if(typeof Permissions<"u"){if(e==="data-analysis"){const a=["data-analysis","analytics","analysis","dataAnalysis","data_analysis"];if(typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("clinic"))return!1;if(a.some(o=>Permissions.hasDetailedPermission("clinic",o)))return!0;const n=(typeof Permissions.getEffectivePermissions=="function"?Permissions.getEffectivePermissions(t):null)?.clinicPermissions,s=o=>o===!0||o===1||String(o||"").trim().toLowerCase()==="true";return!!n&&typeof n=="object"&&a.some(o=>s(n[o]))}if(!Permissions.hasDetailedPermission("clinic",e))return!1}return!0},renderUI(){const e=document.getElementById("clinic-section");if(!e){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u0642\u0633\u0645 clinic-section \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");return}const t=AppState.appData;if(!t){e.innerHTML='<div class="content-card"><div class="card-body"><p class="text-gray-600">\u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A...</p></div></div>';return}const a=this.getMedications().length,i=this.getSickLeaves().length,n=this.getInjuries().length,s=(t.clinicVisits||[]).length,o=this.isCurrentUserAdmin();this.state.activeTab==="attendance"&&!this.canAccessAttendanceTab()&&(this.state.activeTab=this.hasTabAccess("visits")?"visits":this.hasTabAccess("medications")?"medications":"visits"),e.innerHTML=`
        ...
        `,this.applyModuleI18n(e),e.querySelector("#supply-new-request-btn")?.addEventListener("click",()=>this.showSupplyRequestForm());const r=()=>{e.querySelectorAll('[data-action="view-request"]').forEach(y=>{y.addEventListener("click",()=>this.viewSupplyRequest(y.getAttribute("data-id")))}),e.querySelectorAll('[data-action="update-status"]').forEach(y=>{y.addEventListener("click",()=>this.updateSupplyRequestStatus(y.getAttribute("data-id"),y.getAttribute("data-status")))})},c=e.querySelector("#supply-search-filter"),d=e.querySelector("#supply-status-filter"),p=e.querySelector("#supply-type-filter"),f=e.querySelector("#supply-priority-filter"),m=e.querySelector("#supply-reset-filters"),u=e.querySelector("#supply-requests-list-container"),g=()=>{const y=this.normalizeArabicText(c?.value||""),v=d?.value||"all",h=p?.value||"all",w=f?.value||"all",L=i.filter(M=>!(v!=="all"&&(M.status||"pending")!==v||h!=="all"&&M.type!==h||w!=="all"&&(M.priority||"normal")!==w||y&&!this.normalizeArabicText([M.itemName,M.requestedBy?.name,M.requestedByName,M.notes,M.unit].filter(Boolean).join(" ")).includes(y)));u&&(u.innerHTML=this.renderSupplyRequestsList(L,a));const E=e.querySelector("#supply-filter-count"),b=e.querySelector("#supply-result-pill");E&&(E.textContent=`${L.length} \u0645\u0646 ${i.length}`),b&&(b.textContent=`${L.length} \u0637\u0644\u0628`),r()};[d,p,f].forEach(y=>y?.addEventListener("change",g)),c?.addEventListener("input",g),m?.addEventListener("click",()=>{c&&(c.value=""),d&&(d.value="all"),p&&(p.value="all"),f&&(f.value="all"),g()}),r(),setTimeout(()=>{const y=e.querySelector(".clinic-table-wrapper");y&&this.setupTableScrollListeners(y)},100)},renderSupplyRequestsList(e,t){return!e||e.length===0?'<div class="cw-empty"><i class="fas fa-box-open"></i><h3>\u0644\u0627 \u062A\u0648\u062C\u062F \u0637\u0644\u0628\u0627\u062A \u0645\u0637\u0627\u0628\u0642\u0629</h3><p>\u0633\u062A\u0638\u0647\u0631 \u0627\u0644\u0637\u0644\u0628\u0627\u062A \u0647\u0646\u0627 \u0628\u0639\u062F \u0625\u0631\u0633\u0627\u0644\u0647\u0627 \u0623\u0648 \u0639\u0646\u062F \u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0641\u0644\u0627\u062A\u0631.</p></div>':`
            <div class="cw-table-scroll clinic-table-wrapper">
                <table class="cw-table">
                    <thead>
                        <tr>
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&a.remove()});const d=a.querySelector("#enhanced-visit-form"),p=a.querySelector("#enhanced-visit-person-type");p?.addEventListener("change",()=>{const u=p.value,g=a.querySelector("#enhanced-visit-employee-code-container"),y=a.querySelector("#enhanced-visit-employee-details-container"),v=a.querySelector("#enhanced-visit-employee-code"),h=a.querySelector("#enhanced-visit-employee-name"),w=a.querySelector("#enhanced-visit-employee-name-label"),L=a.querySelector("#enhanced-visit-employee-department"),E=a.querySelector("#enhanced-visit-factory");u==="employee"?(g.style.display="block",y.style.display="grid",v.required=!0,h.readOnly=!0,h.placeholder="\u0633\u064A\u062A\u0645 \u062A\u0639\u0628\u0626\u0629 \u0627\u0644\u0627\u0633\u0645 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B",w.innerHTML='<i class="fas fa-user text-purple-600"></i> \u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 *',L&&(L.readOnly=!0,L.placeholder="\u0633\u064A\u062A\u0645 \u0627\u0644\u062A\u0639\u0628\u0626\u0629 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B"),E&&(E.style.display="block")):(g.style.display="none",y.style.display="none",v.required=!1,h.readOnly=!1,h.placeholder=u==="contractor"?"\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 \u0627\u0644\u0639\u0627\u0645\u0644",w.innerHTML=`<i class="fas fa-user text-purple-600"></i> ${u==="contractor"?"\u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0633\u0645 \u0627\u0644\u0639\u0627\u0645\u0644"} *`,L&&(L.readOnly=!1,L.placeholder=""),E&&(E.style.display="none"))}),d?.addEventListener("submit",async u=>{u.preventDefault(),await this.saveEnhancedVisit(e,t,a)}),typeof this.setupClinicWorkplaceDatalist=="function"&&this.setupClinicWorkplaceDatalist("enhanced-visit-factory","enhanced-visit-employee-location","enhanced-visit-employee-location-datalist"),a.querySelectorAll(".sidebar-nav-btn").forEach(u=>{u.addEventListener("click",()=>{const y=parseInt(u.getAttribute("data-section"),10),v=a.querySelectorAll(".form-section");v[y]&&v[y].scrollIntoView({behavior:"smooth",block:"start",inline:"nearest"})});const g=u.style.borderColor;u.addEventListener("mouseenter",()=>{u.style.background=g,u.style.color="white",u.style.transform="translateX(-5px)"}),u.addEventListener("mouseleave",()=>{u.style.background="white",u.style.color=g,u.style.transform="translateX(0)"})});const m=a.querySelector('button[type="submit"]');m?.addEventListener("mouseenter",()=>{m.style.transform="translateY(-2px)",m.style.boxShadow="0 6px 20px 0 rgba(102, 126, 234, 0.6)"}),m?.addEventListener("mouseleave",()=>{m.style.transform="translateY(0)",m.style.boxShadow="0 4px 15px 0 rgba(102, 126, 234, 0.4)"})},async saveEnhancedVisit(e,t,a){Loading.show();try{const i=document.getElementById("enhanced-visit-person-type").value,n=document.getElementById("enhanced-visit-employee-code")?.value.trim()||"",s=document.getElementById("enhanced-visit-employee-name").value.trim(),o=document.getElementById("enhanced-visit-employee-position")?.value.trim()||"",l=document.getElementById("enhanced-visit-employee-department")?.value.trim()||"",r=document.getElementById("enhanced-visit-factory")?.value.trim()||null,c=document.getElementById("enhanced-visit-employee-location").value.trim(),d=document.getElementById("enhanced-visit-date").value,p=document.getElementById("enhanced-visit-exit-date").value||null,f=document.getElementById("enhanced-visit-type")?.value?.trim()||null,m=document.getElementById("enhanced-visit-reason").value.trim(),u=document.getElementById("enhanced-visit-diagnosis").value.trim(),g=document.getElementById("enhanced-visit-treatment").value.trim();let y=null;if(r){const x=this.getSiteOptions().find(k=>k.id===r);y=x?x.name:null}let v=null,h=null;if(d&&d.trim())try{const[D,x]=d.split("T");if(D&&x){const[k,_,R]=D.split("-").map(Number),[q,H]=x.split(":").map(Number),V=new Date(k,_-1,R,q,H,0,0);isNaN(V.getTime())?AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0642\u064A\u0645\u0629 \u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D\u0629:",d):v=V.toISOString()}else{const k=new Date(d);isNaN(k.getTime())||(v=k.toISOString())}}catch(D){AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0648\u064A\u0644 \u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644:",D)}if(p&&p.trim())try{const[D,x]=p.split("T");if(D&&x){const[k,_,R]=D.split("-").map(Number),[q,H]=x.split(":").map(Number),V=new Date(k,_-1,R,q,H,0,0);isNaN(V.getTime())?AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0642\u064A\u0645\u0629 \u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C \u063A\u064A\u0631 \u0635\u062D\u064A\u062D\u0629:",p):h=V.toISOString()}else{const k=new Date(p);isNaN(k.getTime())||(h=k.toISOString())}}catch(D){AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0648\u064A\u0644 \u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C:",D)}if(!AppState.currentUser){Utils.safeError("\u274C \u062E\u0637\u0623: AppState.currentUser \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F! \u0644\u0627 \u064A\u0645\u0643\u0646 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0628\u062F\u0648\u0646 \u0645\u0639\u0631\u0641\u0629 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645."),Notification.error("\u062E\u0637\u0623: \u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u062A\u0639\u0631\u0641 \u0639\u0644\u0649 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645. \u064A\u0631\u062C\u0649 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649."),Loading.hide();return}if(!AppState.currentUser.name&&!AppState.currentUser.email&&!AppState.currentUser.id){Utils.safeError("\u274C \u062E\u0637\u0623: AppState.currentUser \u0644\u0627 \u064A\u062D\u062A\u0648\u064A \u0639\u0644\u0649 name \u0623\u0648 email \u0623\u0648 id!",AppState.currentUser),Notification.error("\u062E\u0637\u0623: \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u063A\u064A\u0631 \u0645\u0643\u062A\u0645\u0644\u0629. \u064A\u0631\u062C\u0649 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649."),Loading.hide();return}const w=AppState.currentUser,L=(w?.email||"").toString().toLowerCase().trim(),b=(AppState.appData.users||[]).find(D=>(D.email||"").toString().toLowerCase().trim()===L);let M="";b&&b.name&&b.name.trim()!==""?M=b.name.trim():w?.name&&w.name.trim()!==""?M=w.name.trim():L?M=L:M="\u0645\u0633\u062A\u062E\u062F\u0645";const U=M,N=i==="contractor",S={id:e?.id||Utils.generateId("VISIT"),personType:i,employeeCode:N?null:n,employeeName:N?null:s,employeePosition:N?null:o,employeeDepartment:N?null:l,employeeLocation:N?null:c,contractorName:N?s:null,contractorWorkerName:N?n:null,contractorPosition:N?o:null,factory:r,factoryName:y,workArea:c,visitDate:v,exitDate:h,visitType:f,reason:m,diagnosis:u,treatment:g,medications:[],createdAt:e?.createdAt||new Date().toISOString(),createdBy:M,updatedAt:new Date().toISOString(),updatedBy:U,email:AppState.currentUser?.email||"",userId:AppState.currentUser?.id||""};if(S.createdBy==="\u0627\u0644\u0646\u0638\u0627\u0645"||typeof S.createdBy=="object"&&S.createdBy.name,AppState.debugMode&&(Utils.safeLog("\u{1F50D} formData.createdBy \u0627\u0644\u0646\u0647\u0627\u0626\u064A \u0642\u0628\u0644 \u0627\u0644\u0625\u0631\u0633\u0627\u0644 (\u064A\u062C\u0628 \u0623\u0646 \u064A\u0643\u0648\u0646 string):",S.createdBy),Utils.safeLog("\u{1F50D} formData.createdBy type:",typeof S.createdBy)),AppState.appData.clinicVisits||(AppState.appData.clinicVisits=[]),t){const D=AppState.appData.clinicVisits.findIndex(x=>x.id===S.id);D!==-1&&(AppState.appData.clinicVisits[D]=S)}else AppState.appData.clinicVisits.push(S);typeof DataManager<"u"&&DataManager.save&&DataManager.save();try{const D=this.getMonthlyVisitsAlertThreshold(),x=this.getMonthlyVisitCountForPerson(S);if(x>=D){const k=(S.personType||"").toString().toLowerCase()==="employee"?"\u0627\u0644\u0645\u0648\u0638\u0641":"\u0627\u0644\u0645\u0642\u0627\u0648\u0644/\u0627\u0644\u0639\u0627\u0645\u0644";typeof Notification<"u"&&Notification.warning&&Notification.warning("\u062A\u0646\u0628\u064A\u0647: \u0639\u062F\u062F \u0632\u064A\u0627\u0631\u0627\u062A "+k+" \u0644\u0644\u0639\u064A\u0627\u062F\u0629 \u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631 \u0648\u0635\u0644 \u0623\u0648 \u062A\u062C\u0627\u0648\u0632 "+D+" \u0632\u064A\u0627\u0631\u0629. \u062A\u0645 \u0625\u0634\u0639\u0627\u0631 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645."),this.notifyAdminsAboutHighClinicVisits(S,x).catch(function(_){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F Clinic: \u0641\u0634\u0644 \u0625\u0634\u0639\u0627\u0631 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645 \u0639\u0646 \u062A\u062C\u0627\u0648\u0632 \u062A\u0631\u062F\u062F \u0627\u0644\u0632\u064A\u0627\u0631\u0627\u062A:",_)})}}catch(D){Utils.safeWarn("\u0641\u062D\u0635 \u062A\u0631\u062F\u062F \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0634\u0647\u0631\u064A:",D)}const T=45e3;try{AppState.debugMode&&Utils.safeLog("\u{1F50D} \u0625\u0631\u0633\u0627\u0644 formData \u0625\u0644\u0649 Backend:",{action:t?"updateClinicVisit":"addClinicVisit",createdBy:S.createdBy,createdByType:typeof S.createdBy,createdByName:typeof S.createdBy=="object"?S.createdBy.name:S.createdBy});const D=await GoogleIntegration.sendRequest({action:t?"updateClinicVisit":"addClinicVisit",data:t?{visitId:S.id,updateData:S,__timeoutMs:T}:{...S,__timeoutMs:T}});this.assertClinicVisitRpcResult(D),t||this.applyClinicVisitIdFromServer(S,D),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u0625\u0631\u0633\u0627\u0644 formData \u0625\u0644\u0649 Backend \u0628\u0646\u062C\u0627\u062D",D),typeof DataManager<"u"&&DataManager.save&&DataManager.save(),this.refreshClinicVisitsFromServerAfterSave()}catch(D){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 (\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0642\u062F \u062A\u0643\u0648\u0646 \u062D\u064F\u0641\u0638\u062A):",D),Loading.hide();try{typeof DataManager<"u"&&DataManager.addToPendingSync&&DataManager.addToPendingSync("ClinicVisits",AppState.appData.clinicVisits)}catch{}try{this.refreshClinicVisitsFromServerAfterSave()}catch{}return}Loading.hide(),Notification.success(`\u062A\u0645 ${t?"\u062A\u062D\u062F\u064A\u062B":"\u062A\u0633\u062C\u064A\u0644"} \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0628\u0646\u062C\u0627\u062D`),a.remove(),this.state.activeTab==="visits"&&this.renderVisitsTab()}catch(i){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+i.message)}},async handleInjuryAttachmentsChange(e){if(!e||e.length===0)return;const t=Array.from(e),a=["jpg","jpeg","png","pdf"],i=5*1024*1024;for(const s of t){const o=(s.name.split(".").pop()||"").toLowerCase();if(!a.includes(o)){Notification.warning(`\u0627\u0644\u0645\u0644\u0641 ${s.name} \u063A\u064A\u0631 \u0645\u062F\u0639\u0648\u0645. \u064A\u0633\u0645\u062D \u0628\u0645\u0644\u0641\u0627\u062A JPG \u0623\u0648 PNG \u0623\u0648 PDF \u0641\u0642\u0637.`);continue}if(s.size>i){Notification.warning(`\u0627\u0644\u0645\u0644\u0641 ${s.name} \u064A\u062A\u062C\u0627\u0648\u0632 \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 \u0627\u0644\u0645\u0633\u0645\u0648\u062D \u0628\u0647 (5MB).`);continue}try{const l=await this.readFileAsBase64(s);this.state.currentInjuryAttachments.push({id:Utils.generateId("ATT"),name:s.name,type:s.type||this.detectMimeType(s.name),data:l,size:Math.round(s.size/1024),uploadedAt:new Date().toISOString()})}catch(l){Utils.safeError("\u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0644\u0641:",l),Notification.error(`\u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0644\u0641 ${s.name}`)}}this.renderInjuryAttachmentsPreview();const n=document.getElementById("injury-attachments-input");n&&(n.value="")},renderInjuryAttachmentsPreview(){const e=document.getElementById("injury-attachments-preview");if(e){if(!this.state.currentInjuryAttachments||this.state.currentInjuryAttachments.length===0){e.innerHTML='<p class="text-sm text-gray-500">\u0644\u0645 \u064A\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0645\u0631\u0641\u0642\u0627\u062A \u0628\u0639\u062F</p>';return}e.innerHTML=this.state.currentInjuryAttachments.map((t,a)=>{const i=t.type&&t.type.startsWith("image/"),n=i?"fa-image":"fa-file-pdf",s=t.size||0;return`
