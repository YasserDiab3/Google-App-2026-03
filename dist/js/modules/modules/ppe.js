const PPE={state:{activeTab:"receipts",isSwitchingTab:!1,eventListeners:new Map,stockItemsCache:null,stockItemsCacheTime:null,stockCacheExpiry:3e5,ppeItemsListCache:null,ppeItemsListCacheTime:null,ppeItemsListCacheExpiry:12e4,ppeItemsOptionsHTML:"",stockStaleWarningMsg:"",stockLoadHardErrorMsg:"",lastSyncTime:null,filters:{receipts:{search:"",equipmentType:"",status:"",dateFrom:"",dateTo:""},stock:{search:"",category:"",supplier:"",status:"",dateFrom:"",dateTo:""}}},_t(t,e){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n.t(t,e):window.I18n&&typeof window.I18n.t=="function"?window.I18n.t(t,e):e},applyModuleI18n(t){const e=t&&t.nodeType?t:document.getElementById("ppe-section");if(!e)return;const s=window.AppI18n&&typeof window.AppI18n.applyModuleI18n=="function"?window.AppI18n:window.I18n&&typeof window.I18n.applyModuleI18n=="function"?window.I18n:null;s&&s.applyModuleI18n(e)},ensurePpeFilterStyles(){if(document.getElementById("ppe-module-filter-styles"))return;const t=document.createElement("style");t.id="ppe-module-filter-styles",t.textContent=`
        ...
        `,document.head.appendChild(t)},computeReceiptsKpiStats(t,e){const s=Array.isArray(t)?t:[],i=Array.isArray(e)?e:s;let a=0,n=0;const r=new Set;for(let p=0;p<s.length;p++){const l=s[p];if(!l)continue;const o=String(l.status||"").trim();o==="\u0645\u0633\u062A\u0644\u0645"?a++:o==="\u0642\u064A\u062F \u0627\u0644\u062A\u0633\u0644\u064A\u0645"&&n++;const d=l.employeeCode||l.employeeNumber||l.employeeName;d&&r.add(String(d).trim().toLowerCase())}return{total:s.length,received:a,pending:n,employees:r.size,filteredCount:i.length,hasFilters:this.hasActiveReceiptFilters()}},buildReceiptsKpiHtml(t){const e=(p,l)=>this._t(p,l),s=p=>Utils.escapeHTML(p),i=t||this.computeReceiptsKpiStats(AppState.appData.ppe||[],[]),a=i.hasFilters?`${e("module.ppe.kpi.showingFiltered","\u0639\u0631\u0636")} ${i.filteredCount} ${e("module.ppe.kpi.ofTotal","\u0645\u0646")} ${i.total}`:`${e("module.ppe.kpi.liveSnapshot","\u0645\u0644\u062E\u0635 \u0641\u0648\u0631\u064A \u0644\u0644\u0633\u062C\u0644")}`,n=i.pending>0?`<span class="ppe-rk-card__chip"><i class="fas fa-exclamation-circle ml-1"></i>${s(e("module.ppe.kpi.needsFollowUp","\u062A\u062D\u062A\u0627\u062C \u0645\u062A\u0627\u0628\u0639\u0629"))}</span>`:`<span class="ppe-rk-card__chip">${s(e("module.ppe.kpi.noPending","\u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0639\u0644\u0651\u0642"))}</span>`,r=i.total>0?Math.round(i.received/i.total*100):0;return`
            <section class="ppe-receipts-kpi" id="ppe-receipts-kpi" aria-label="${s(e("module.ppe.kpi.sectionLabel","\u0645\u0644\u062E\u0635 \u0633\u062C\u0644 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645"))}">
                ...
                <div class="ppe-receipts-kpi__grid">
                    ...
                    <article class="ppe-rk-card ppe-rk-card--received">
                        ...
                        <span class="ppe-rk-card__chip">${r}% ${s(e("module.ppe.kpi.ofAll","\u0645\u0646 \u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A"))}</span>
                    </article>
        ...
        `},_ppeBindOnce(t,e,s){if(!t||!e||typeof s!="function")return;const i=`data-ppe-bound-${e}`;t.hasAttribute(i)||(t.setAttribute(i,"1"),t.addEventListener(e,s))},_ppeCaptureFocus(t){try{const e=document.activeElement;return!e||!t||!t.contains(e)||!e.id?null:{id:e.id,start:typeof e.selectionStart=="number"?e.selectionStart:null,end:typeof e.selectionEnd=="number"?e.selectionEnd:null}}catch{return null}},_ppeRestoreFocus(t){if(!(!t||!t.id))try{const e=document.getElementById(t.id);if(!e)return;if(e.focus({preventScroll:!0}),t.start!=null&&typeof e.setSelectionRange=="function"){const s=String(e.value||"").length,i=Math.min(t.start,s),a=Math.min(t.end!=null?t.end:i,s);e.setSelectionRange(i,a)}}catch{}},_ppeMatchesSearch(t,e){const s=String(e||"").trim().toLowerCase();if(!s)return!0;const i=(Array.isArray(t)?t:[t]).map(n=>String(n??"").toLowerCase()).join(" | "),a=s.split(/\s+/).filter(Boolean);return a.length?a.every(n=>i.includes(n)):!0},showPPEFormById(t){const s=(typeof AppState<"u"&&AppState.appData&&Array.isArray(AppState.appData.ppe)?AppState.appData.ppe:[]).find(i=>i&&String(i.id)===String(t));return this.showPPEForm(s||null)},getDisplayStatus(t){const e=String(t||"").trim();return e==="\u0645\u0633\u062A\u0644\u0645"?this._t("module.ppe.status.received","\u0645\u0633\u062A\u0644\u0645"):e==="\u0642\u064A\u062F \u0627\u0644\u062A\u0633\u0644\u064A\u0645"?this._t("module.ppe.status.pending","\u0642\u064A\u062F \u0627\u0644\u062A\u0633\u0644\u064A\u0645"):e||"\u2014"},isStatusReceived(t){return String(t||"").trim()==="\u0645\u0633\u062A\u0644\u0645"},getFilteredPpeReceipts(t){const e=Array.isArray(t)?t:[],s=this.state.filters?.receipts||{},i=(s.search||"").trim().toLowerCase(),a=s.equipmentType||"",n=s.status||"",r=s.dateFrom?new Date(s.dateFrom+"T00:00:00"):null,p=s.dateTo?new Date(s.dateTo+"T23:59:59.999"):null;return r&&isNaN(r.getTime())||p&&isNaN(p.getTime())?e:e.filter(l=>{if(a&&String(l.equipmentType||"")!==a||n&&String(l.status||"")!==n)return!1;if(r||p){if(!l.receiptDate)return!1;const o=new Date(l.receiptDate);if(isNaN(o.getTime())||r&&o<r||p&&o>p)return!1}return!(i&&!this._ppeMatchesSearch([l.receiptNumber,l.id,l.employeeName,l.employeeCode,l.employeeNumber,l.equipmentType,l.status,l.employeeDepartment,l.department,l.createdBy,l.createdByUser,l.recordedBy,l.recorderName,l.shoeSize,l.quantity,l.notes,l.remarks,l.site,l.location],i))})},hasActiveReceiptFilters(){const t=this.state.filters?.receipts||{};return!!(t.search||t.equipmentType||t.status||t.dateFrom||t.dateTo)},resetReceiptFilters(){this.state.filters||(this.state.filters={}),this.state.filters.receipts={search:"",equipmentType:"",status:"",dateFrom:"",dateTo:""}},getFilteredStockItems(t){const e=Array.isArray(t)?t:[],s=this.state.filters&&this.state.filters.stock||{},i=(s.search||"").trim().toLowerCase(),a=s.category||"",n=s.supplier||"",r=s.status||"",p=s.dateFrom?new Date(s.dateFrom+"T00:00:00"):null,l=s.dateTo?new Date(s.dateTo+"T23:59:59.999"):null;return p&&isNaN(p.getTime())||l&&isNaN(l.getTime())?e:e.filter(o=>{if(!o||a&&String(o.category||"")!==a||n&&String(o.supplier||"")!==n)return!1;if(r){const d=parseFloat(o.balance||0),h=parseFloat(o.minThreshold||0),y=d<h;if(r==="low"&&!y||r==="available"&&y)return!1}if(p||l){if(!o.lastUpdate)return!1;const d=new Date(o.lastUpdate);if(isNaN(d.getTime())||p&&d<p||l&&d>l)return!1}return!(i&&!this._ppeMatchesSearch([o.itemCode,o.itemName,o.category,o.supplier,o.itemId,o.unit,o.notes,o.balance,o.minThreshold,o.location],i))})},hasActiveStockFilters(){const t=this.state.filters&&this.state.filters.stock||{};return!!(t.search||t.category||t.supplier||t.status||t.dateFrom||t.dateTo)},resetStockFilters(){this.state.filters||(this.state.filters={}),this.state.filters.stock={search:"",category:"",supplier:"",status:"",dateFrom:"",dateTo:""}},buildStockFilterRow(t){const e=(o,d)=>this._t(o,d),s=o=>Utils.escapeHTML(o);this.ensurePpeFilterStyles();const i=Array.isArray(t)?t:[],a=this.state.filters&&this.state.filters.stock||{},n=this.getFilteredStockItems(i),r=typeof document<"u"&&(document.documentElement.getAttribute("dir")==="rtl"||window.AppI18n&&window.AppI18n.getCurrentLang&&window.AppI18n.getCurrentLang()==="ar"),p=[...new Set(i.map(o=>o&&o.category).filter(Boolean))].sort(),l=[...new Set(i.map(o=>o&&o.supplier).filter(Boolean))].sort();return`
            <div class="ppe-visits-filters-row visits-filters-row" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); padding: 16px 20px; margin: 0 0 14px 0; width: 100%; direction: ${r?"rtl":"ltr"}; border-radius: 10px;">
            ...
            </div>`},buildPPEListHtml(){const t=(u,v)=>this._t(u,v);this.ensurePpeFilterStyles();const e=AppState.appData.ppe||[],s=this.state.filters?.receipts||{},i=this.getFilteredPpeReceipts(e),a=this.hasActiveReceiptFilters(),n=typeof document<"u"&&(document.documentElement.getAttribute("dir")==="rtl"||window.AppI18n&&window.AppI18n.getCurrentLang&&window.AppI18n.getCurrentLang()==="ar"),r=u=>Utils.escapeHTML(u),p=[...new Set(e.map(u=>u.equipmentType).filter(Boolean))].sort(),l=["\u0645\u0633\u062A\u0644\u0645","\u0642\u064A\u062F \u0627\u0644\u062A\u0633\u0644\u064A\u0645"],o=this.computeReceiptsKpiStats(e,i),d=this.buildReceiptsKpiHtml(o),h=`
                ...
                <div class="filters-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 12px; align-items: end;">
                    <div class="filter-field" style="min-width: 180px;">
                        <label class="filter-label" for="ppe-receipts-search">
                            <i class="fas fa-search ml-1"></i>${r(t("module.ppe.filter.search","\u0628\u062D\u062B"))}
                        </label>
                        <input type="text" id="ppe-receipts-search" class="form-input pr-10 filter-input" placeholder="${r(t("module.ppe.filter.searchPlaceholder",""))}" value="${r(s.search||"")}">
                    </div>
                    <div class="filter-field" style="min-width: 160px;">
                        <label class="filter-label" for="ppe-receipts-filter-type">
                            <i class="fas fa-hard-hat ml-1"></i>${r(t("module.ppe.filter.equipmentType","\u0646\u0648\u0639 \u0627\u0644\u0645\u0639\u062F\u0629"))}
                            ${s.equipmentType?`<span class="filter-count-badge" title="${r(t("module.ppe.filter.badgeCount",""))}">${i.length}</span>`:""}
                        </label>
                        <select id="ppe-receipts-filter-type" class="form-input filter-input">
                            <option value="">${r(t("module.common.all","\u0627\u0644\u0643\u0644"))}</option>
                            ${p.map(u=>`<option value="${r(u)}" ${s.equipmentType===u?"selected":""}>${r(u)}</option>`).join("")}
                        </select>
                    </div>
                    <div class="filter-field" style="min-width: 160px;">
                        <label class="filter-label" for="ppe-receipts-filter-status">
                            <i class="fas fa-signal ml-1"></i>${r(t("module.ppe.filter.status","\u0627\u0644\u062D\u0627\u0644\u0629"))}
                            ${s.status?`<span class="filter-count-badge" title="${r(t("module.ppe.filter.badgeCount",""))}">${i.length}</span>`:""}
                        </label>
                        <select id="ppe-receipts-filter-status" class="form-input filter-input">
                            <option value="">${r(t("module.common.all","\u0627\u0644\u0643\u0644"))}</option>
                            ${l.map(u=>`<option value="${r(u)}" ${s.status===u?"selected":""}>${r(this.getDisplayStatus(u))}</option>`).join("")}
                        </select>
                    </div>
                    <div class="filter-field">
                        <label class="filter-label" for="ppe-receipts-date-from"><i class="fas fa-calendar-alt ml-1"></i>${r(t("module.ppe.filter.dateFrom","\u0645\u0646 \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645"))}</label>
                        <input type="date" id="ppe-receipts-date-from" class="form-input filter-input" value="${r(s.dateFrom||"")}">
                    </div>
                    <div class="filter-field">
                        <label class="filter-label" for="ppe-receipts-date-to"><i class="fas fa-calendar-check ml-1"></i>${r(t("module.ppe.filter.dateTo","\u0625\u0644\u0649 \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645"))}</label>
                        <input type="date" id="ppe-receipts-date-to" class="form-input filter-input" value="${r(s.dateTo||"")}">
                    </div>
                    <div class="filter-field" style="min-width: 170px;">
                        <button type="button" id="ppe-receipts-reset-filters" class="filter-reset-btn" title="${r(t("module.ppe.filter.resetTitle",""))}">
                            <i class="fas fa-rotate-left ml-1"></i>${r(t("module.ppe.filter.reset","\u0625\u0639\u0627\u062F\u0629 \u062A\u0639\u064A\u064A\u0646 \u0627\u0644\u0641\u0644\u0627\u062A\u0631"))}
                        </button>
                    </div>
                </div>
            </div>`;if(e.length===0){const u=`<div class="empty-state"><p class="text-gray-500">${r(t("module.ppe.empty.noReceipts","\u0644\u0627 \u062A\u0648\u062C\u062F \u0627\u0633\u062A\u0644\u0627\u0645\u0627\u062A \u0645\u0633\u062C\u0644\u0629"))}</p></div>`;return d+this._buildExcelToolbarHtml("receipts")+`<div id="ppe-receipts-filters-host">${h}</div><div id="ppe-receipts-results-host">${u}</div>`}const y=a&&i.length===0?`
            <div class="empty-state">
                <i class="fas fa-filter text-4xl text-gray-300 mb-4"></i>
                <p class="text-gray-500 mb-2">${r(t("module.ppe.filter.noMatch","\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C \u0645\u0637\u0627\u0628\u0642\u0629"))}</p>
                <button type="button" id="ppe-receipts-clear-empty-filters" class="btn-secondary mt-2">
                    <i class="fas fa-undo-alt ml-2"></i>${r(t("module.ppe.filter.clearEmpty","\u0645\u0633\u062D \u0627\u0644\u0641\u0644\u0627\u062A\u0631"))}
                </button>
            </div>
        `:"";if(i.length===0)return d+this._buildExcelToolbarHtml("receipts")+`<div id="ppe-receipts-filters-host">${h}</div><div id="ppe-receipts-results-host">${y}</div>`;const c=t("module.common.view","\u0639\u0631\u0636"),m=t("module.kpi.exportPDF","\u062A\u0635\u062F\u064A\u0631 PDF"),x=t("module.common.edit","\u062A\u0639\u062F\u064A\u0644"),k=t("module.ppe.btn.deleteReceipt","\u062D\u0630\u0641"),f=`
            <table class="data-table table-header-blue">
                <thead>
                    <tr>
                        <th>${r(t("module.ppe.table.receiptNo","\u0631\u0642\u0645 \u0627\u0644\u0625\u064A\u0635\u0627\u0644"))}</th>
                        <th>${r(t("module.ppe.table.employeeName","\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641"))}</th>
                        <th>${r(t("module.ppe.table.employeeCode","\u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A"))}</th>
                        <th>${r(t("module.ppe.table.equipmentType","\u0646\u0648\u0639 \u0627\u0644\u0645\u0639\u062F\u0629"))}</th>
                        <th>${r(t("module.ppe.table.quantity","\u0627\u0644\u0643\u0645\u064A\u0629"))}</th>
                        <th>${r(t("module.ppe.table.createdBy","\u0645\u0633\u062C\u0651\u0644 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645"))}</th>
                        <th>${r(t("module.ppe.table.receiptDate","\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645"))}</th>
                        <th>${r(t("module.ppe.table.status","\u0627\u0644\u062D\u0627\u0644\u0629"))}</th>
                        <th>${r(t("module.ppe.table.actions","\u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A"))}</th>
                    </tr>
                </thead>
                <tbody>
                    ${i.map(u=>{const v=this.getDisplayStatus(u.status),w=String(u.id||"").replace(/\\/g,"\\\\").replace(/'/g,"\\'"),C=u.createdBy||u.createdByUser||u.recordedBy||u.recorderName||u.user||"\u2014";return`
                        <tr>
                            <td class="font-mono font-semibold">${r(u.receiptNumber||u.id||"")}</td>
                            <td>${r(u.employeeName||"")}</td>
                            <td>${r(u.employeeCode||u.employeeNumber||"")}</td>
                            <td>
                                ${r(u.equipmentType||"")}
                                ${u.shoeSize?`<span class="block text-[11px] text-blue-600 font-semibold mt-0.5"><i class="fas fa-shoe-prints ml-1 text-[10px]"></i>\u0645\u0642\u0627\u0633: ${r(u.shoeSize)}</span>`:""}
                            </td>
                            <td>${u.quantity||0}</td>
                            <td><span class="text-xs font-semibold text-slate-700"><i class="fas fa-user-edit text-blue-500 ml-1 text-[11px]"></i>${r(C)}</span></td>
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    <button onclick="PPE.viewPPE('${w}')" class="btn-icon btn-icon-info" title="${r(c)}">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <button onclick="PPE.exportPDF('${w}')" class="btn-icon btn-icon-success" title="${r(m)}">
                                        <i class="fas fa-file-pdf"></i>
                                    </button>
                                    <button onclick="PPE.showPPEFormById('${w}')" class="btn-icon btn-icon-primary" title="${r(x)}">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button onclick="PPE.deletePPE('${w}')" class="btn-icon btn-icon-danger" title="${r(k)}">
        ...
        `;return d+this._buildExcelToolbarHtml("receipts")+`<div id="ppe-receipts-filters-host">${h}</div><div id="ppe-receipts-results-host">${f}</div>`},buildPPEReceiptsResultsHtml(){const t=(o,d)=>this._t(o,d),e=o=>Utils.escapeHTML(o),s=AppState.appData.ppe||[],i=this.getFilteredPpeReceipts(s),a=this.hasActiveReceiptFilters();if(s.length===0)return`<div class="empty-state"><p class="text-gray-500">${e(t("module.ppe.empty.noReceipts","\u0644\u0627 \u062A\u0648\u062C\u062F \u0627\u0633\u062A\u0644\u0627\u0645\u0627\u062A \u0645\u0633\u062C\u0644\u0629"))}</p></div>`;if(i.length===0)return`
            ...
            </div>`;const n=t("module.common.view","\u0639\u0631\u0636"),r=t("module.kpi.exportPDF","\u062A\u0635\u062F\u064A\u0631 PDF"),p=t("module.common.edit","\u062A\u0639\u062F\u064A\u0644"),l=t("module.ppe.btn.deleteReceipt","\u062D\u0630\u0641");return`
            <table class="data-table table-header-blue">
                <thead>
                    <tr>
                ...
                <tbody>
                    ${i.map(o=>{const d=this.getDisplayStatus(o.status),h=String(o.id||"").replace(/\\/g,"\\\\").replace(/'/g,"\\'"),y=o.createdBy||o.createdByUser||o.recordedBy||o.recorderName||o.user||"\u2014";return`
                        <tr>
                            ...
                            <td>${o.quantity||0}</td>
                            <td><span class="text-xs font-semibold text-slate-700"><i class="fas fa-user-edit text-blue-500 ml-1 text-[11px]"></i>${e(y)}</span></td>
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    <button onclick="PPE.viewPPE('${h}')" class="btn-icon btn-icon-info" title="${e(n)}">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <button onclick="PPE.exportPDF('${h}')" class="btn-icon btn-icon-success" title="${e(r)}">
                                        <i class="fas fa-file-pdf"></i>
                                    </button>
            ...
            <div class="overflow-x-auto">
                <table class="data-table table-header-blue">
                    ...
                    <tbody>
                        ${t.map(i=>{const a=parseFloat(i.balance||0),n=parseFloat(i.minThreshold||0),r=a<n;return`
                                <tr class="${r?"bg-red-50":""}">
                                    ...
                                    <td class="font-bold ${r?"text-red-600":"text-blue-600"}">${a.toFixed(0)}</td>
                                    <td>${n.toFixed(0)}</td>
        ...
        `},cleanupEventListeners(){this.state.eventListeners.forEach((t,e)=>{e&&e.removeEventListener&&e.removeEventListener(t.event,t.handler)}),this.state.eventListeners.clear()},setupEventListeners(){this.cleanupEventListeners(),setTimeout(()=>{document.querySelectorAll(".ppe-tab-btn").forEach(r=>{const p=()=>{const l=r.getAttribute("data-tab");l&&!this.state.isSwitchingTab&&this.switchTab(l)};r.addEventListener("click",p),this.state.eventListeners.set(r,{event:"click",handler:p})});const e=document.getElementById("add-ppe-btn"),s=document.getElementById("view-ppe-matrix-btn");if(e){const r=()=>this.showPPEForm();e.addEventListener("click",r),this.state.eventListeners.set(e,{event:"click",handler:r})}if(s){const r=()=>this.showPPEMatrix();s.addEventListener("click",r),this.state.eventListeners.set(s,{event:"click",handler:r})}const i=document.getElementById("ppe-refresh-btn");if(i){const r=()=>this.refreshActiveTab();i.addEventListener("click",r),this.state.eventListeners.set(i,{event:"click",handler:r})}const a=document.getElementById("add-stock-item-btn"),n=document.getElementById("add-transaction-btn");if(a){const r=()=>this.showStockItemForm();a.addEventListener("click",r),this.state.eventListeners.set(a,{event:"click",handler:r})}if(n){const r=()=>this.showTransactionForm();n.addEventListener("click",r),this.state.eventListeners.set(n,{event:"click",handler:r})}this._bindPpeReceiptExcelToolbar(),this._bindPpeStockExcelToolbar()},100)},updateHeaderButtons(){const t=document.querySelector("#ppe-section .section-header .flex.gap-2");if(!t)return;[document.getElementById("add-ppe-btn"),document.getElementById("view-ppe-matrix-btn"),document.getElementById("ppe-refresh-btn"),document.getElementById("add-stock-item-btn"),document.getElementById("add-transaction-btn")].filter(Boolean).forEach(o=>{if(this.state.eventListeners.has(o)){const d=this.state.eventListeners.get(o);o.removeEventListener(d.event,d.handler),this.state.eventListeners.delete(o)}});const s=(o,d)=>this._t(o,d),i=o=>Utils.escapeHTML(o);this.state.activeTab==="receipts"?t.innerHTML=`
                <button id="view-ppe-matrix-btn" class="btn-secondary">
                    <i class="fas fa-table ml-2"></i>
            ...
            `,this.applyModuleI18n(t);const a=document.getElementById("add-ppe-btn"),n=document.getElementById("view-ppe-matrix-btn"),r=document.getElementById("add-stock-item-btn"),p=document.getElementById("add-transaction-btn");if(a){const o=()=>this.showPPEForm();a.addEventListener("click",o),this.state.eventListeners.set(a,{event:"click",handler:o})}if(n){const o=()=>this.showPPEMatrix();n.addEventListener("click",o),this.state.eventListeners.set(n,{event:"click",handler:o})}const l=document.getElementById("ppe-refresh-btn");if(l){const o=()=>this.refreshActiveTab();l.addEventListener("click",o),this.state.eventListeners.set(l,{event:"click",handler:o})}if(r){const o=()=>this.showStockItemForm();r.addEventListener("click",o),this.state.eventListeners.set(r,{event:"click",handler:o})}if(p){const o=()=>this.showTransactionForm();p.addEventListener("click",o),this.state.eventListeners.set(p,{event:"click",handler:o})}this._bindPpeReceiptExcelToolbar(),this._bindPpeStockExcelToolbar()},async switchTab(t){if(this.state.isSwitchingTab){Utils.safeWarn("\u26A0\uFE0F \u0627\u0644\u062A\u0628\u062F\u064A\u0644 \u0628\u064A\u0646 \u0627\u0644\u062A\u0628\u0648\u064A\u0628\u0627\u062A \u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630 \u0628\u0627\u0644\u0641\u0639\u0644");return}if(this.state.activeTab===t)return;const e=this._switchTabToken=(this._switchTabToken||0)+1;try{this.state.isSwitchingTab=!0,this.state.activeTab=t,document.querySelectorAll(".ppe-tab-btn").forEach(a=>{a.classList.remove("active"),a.getAttribute("data-tab")===t&&a.classList.add("active")});const i=document.getElementById("ppe-tab-content");if(i)try{if(i.style.opacity="1",i.style.pointerEvents="auto",t==="receipts")i.innerHTML=await this.renderReceiptsTab(),this.ensurePpeFilterStyles(),this.bindReceiptsFilters(),this._bindPpeReceiptExcelToolbar(),this.applyModuleI18n(i);else if(t==="stock-control"){const a=this.state.stockItemsCache&&this.state.stockItemsCache.length?this.state.stockItemsCache:Array.isArray(AppState.appData.ppeStock)&&AppState.appData.ppeStock.length?AppState.appData.ppeStock:[],n=`<div role="status" class="rounded-lg border border-blue-100 bg-blue-50/90 px-4 py-2 text-sm text-blue-900 flex items-center gap-2 mb-3">
        ...
        `,document.body.appendChild(r),typeof EmailDispatch<"u"&&EmailDispatch.bindFooterButtons(r,{moduleKey:"ppe",record:e,recordId:e.id||e.isoCode||""}),this.applyModuleI18n(r),r.addEventListener("click",l=>{l.target===r&&r.remove()})},async deletePPE(t){if(!t){Notification.error(this._t("module.ppe.notify.idMissing","\u0645\u0639\u0631\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}const e=AppState.appData.ppe.find(i=>i.id===t);if(!e){Notification.error(this._t("module.ppe.notify.receiptNotFound","\u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}const s=`${this._t("module.ppe.confirm.delete","\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645\u061F")}

${e.receiptNumber||e.id} \u2014 ${e.employeeName||""}`;if(confirm(s)){Loading.show();try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendToAppsScript){const i=await GoogleIntegration.sendToAppsScript("deletePPE",{ppeId:t});i&&i.success?(AppState.appData.ppe&&(AppState.appData.ppe=AppState.appData.ppe.filter(a=>a.id!==t)),Notification.success(this._t("module.ppe.notify.deleteSuccess","\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645 \u0628\u0646\u062C\u0627\u062D")),await this.load()):Notification.error(i?.message||this._t("module.ppe.notify.deleteError","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645"))}else AppState.appData.ppe?(AppState.appData.ppe=AppState.appData.ppe.filter(i=>i.id!==t),Notification.success(this._t("module.ppe.notify.deleteSuccess","\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645 \u0628\u0646\u062C\u0627\u062D")),await this.load()):Notification.error(this._t("module.ppe.empty.noReceipts","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A"))}catch(i){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645:",i),Notification.error(this._t("module.ppe.notify.deleteError","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645")+": "+(i.message||i))}finally{Loading.hide()}}},async exportPDF(t){const e=AppState.appData.ppe.find(s=>s.id===t);if(!e){Notification.error(this._t("module.ppe.notify.receiptNotFound","\u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}try{Loading.show();const s=e.receiptNumber||`PPE-${e.id?.substring(0,8)||"UNKNOWN"}`,i=y=>Utils.escapeHTML(y||""),a=y=>y?Utils.formatDate(y):"-",n=e.createdBy||e.createdByUser||e.recordedBy||e.recorderName||e.user||"\u2014",r=`
                <table>
            ...
            `,p={type:"PPE",id:e.id,code:s,url:`${window.location.origin}/ppe/${e.id}`},l=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(s,this._t("module.ppe.pdf.receiptTitle","\u0625\u064A\u0635\u0627\u0644 \u0627\u0633\u062A\u0644\u0627\u0645 \u0645\u0647\u0645\u0627\u062A \u0627\u0644\u0648\u0642\u0627\u064A\u0629 \u0627\u0644\u0634\u062E\u0635\u064A\u0629"),r,!1,!0,{version:"1.0",releaseDate:e.receiptDate||e.createdAt,revisionDate:e.updatedAt||e.receiptDate||e.createdAt,qrData:p},e.createdAt,e.updatedAt||e.receiptDate||e.createdAt):`<html dir="rtl" lang="ar"><head><meta charset="UTF-8"><style>@page { size: A4 portrait; margin: 1cm; } @media print { @page { size: A4 portrait; margin: 1cm; } body { padding: 0; } }</style><title>${Utils.escapeHTML(this._t("module.ppe.pdf.pageTitle","\u0625\u064A\u0635\u0627\u0644 \u0645\u0647\u0645\u0627\u062A \u0627\u0644\u0648\u0642\u0627\u064A\u0629 \u0627\u0644\u0634\u062E\u0635\u064A\u0629"))}</title></head><body>${r}</body></html>`,o=new Blob([l],{type:"text/html;charset=utf-8"}),d=URL.createObjectURL(o),h=window.open(d,"_blank");h?h.onload=()=>{setTimeout(()=>{h.print(),setTimeout(()=>{URL.revokeObjectURL(d),Loading.hide()},800)},500)}:(Loading.hide(),Notification.error(this._t("module.ppe.notify.pdfBlocked","\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0639\u0631\u0636 \u0627\u0644\u062A\u0642\u0631\u064A\u0631")))}catch(s){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF \u0644\u0644\u0627\u0633\u062A\u0644\u0627\u0645:",s),Notification.error(this._t("module.ppe.notify.pdfError","\u0641\u0634\u0644 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF")+": "+s.message)}},async showPPEMatrix(){const t=(n,r)=>this._t(n,r),e=n=>Utils.escapeHTML(n),s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
        ...
        `,document.body.appendChild(s),this.applyModuleI18n(s);const i=document.getElementById("ppe-matrix-search");i&&i.addEventListener("input",n=>{this.filterPPEMatrix(n.target.value.trim())});const a=document.getElementById("add-ppe-matrix-btn");a&&a.addEventListener("click",()=>{this.showAddPPEMatrixForm()}),s.addEventListener("click",n=>{n.target===s&&s.remove()})},async renderPPEMatrix(){const t=(r,p)=>this._t(r,p),e=r=>Utils.escapeHTML(r),s=AppState.appData.employees||[],i=AppState.appData.employeePPEMatrixByCode||{},a=AppState.appData.ppe||[];if(s.length===0)return`
            ...
            `;const n=s.map(r=>{const p=r.employeeNumber||r.sapId||"",l=r.name||r.employeeName||"-",o=r.position||t("module.ppe.label.undefinedDept","\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"),d=r.department||"-",h=i[p]||[],y=a.filter(m=>m.employeeCode===p||m.employeeNumber===p),c=[...new Set(y.map(m=>m.equipmentType).filter(Boolean))];return{code:p,name:l,position:o,department:d,requiredPPE:h,receivedPPE:c}});return`
            <div class="table-wrapper" style="overflow-x: auto;">
                <table class="data-table">
                    ...
                    <tbody>
                        ${n.map(r=>{const p=r.requiredPPE.length>0?r.requiredPPE.map(o=>`<span class="badge badge-success mr-1 mb-1">${Utils.escapeHTML(o)}</span>`).join(""):`<span class="text-gray-500 text-sm">${e(t("module.ppe.matrix.notSet","\u0644\u0645 \u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062F"))}</span>`,l=r.receivedPPE.length>0?r.receivedPPE.map(o=>`<span class="badge badge-info mr-1 mb-1">${Utils.escapeHTML(o)}</span>`).join(""):`<span class="text-gray-500 text-sm">${e(t("module.ppe.matrix.noneReceived","\u0644\u0627 \u062A\u0648\u062C\u062F"))}</span>`;return`
                                <tr data-employee-code="${Utils.escapeHTML(r.code)}" data-employee-name="${Utils.escapeHTML(r.name)}" data-position="${Utils.escapeHTML(r.position)}">
                                    <td><strong class="font-mono">${Utils.escapeHTML(r.code||"-")}</strong></td>
                                    <td>${Utils.escapeHTML(r.name)}</td>
                                    <td>${Utils.escapeHTML(r.position)}</td>
                                    ...
                                    <td>
                                        <button onclick="PPE.editEmployeePPEMatrix('${Utils.escapeHTML(r.code)}')" class="btn-icon btn-icon-primary" title="${e(t("module.common.edit","\u062A\u0639\u062F\u064A\u0644"))}">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                    </td>
                                </tr>
        ...
        `},filterPPEMatrix(t){const e=document.querySelector("#ppe-matrix-content tbody");if(!e)return;e.querySelectorAll("tr[data-employee-code]").forEach(i=>{const a=i.getAttribute("data-employee-code")||"",n=i.getAttribute("data-employee-name")||"",r=i.getAttribute("data-position")||"",p=this._ppeMatchesSearch([a,n,r],t);i.style.display=p?"":"none"})},async showAddPPEMatrixForm(t=null){const e=!!t,s=AppState.appData.employeePPEMatrix||{},i=AppState.appData.ppe||[],a=[...new Set(i.map(f=>f.equipmentType).filter(Boolean))],n=AppState.appData.employees||[],r=[...new Set(n.map(f=>f.position).filter(Boolean))],p=t?s[t]:null,l=document.createElement("div");l.className="modal-overlay",l.innerHTML=`
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642 \u062F\u0648\u0646 \u062D\u0641\u0638\u061F`))return;l.remove()}})},async editPPEMatrix(t){this.showAddPPEMatrixForm(t)},async editEmployeePPEMatrix(t){const s=(AppState.appData.employees||[]).find(h=>(h.employeeNumber||h.sapId)===t);if(!s){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const a=(AppState.appData.employeePPEMatrixByCode||{})[t]||[],n=AppState.appData.ppe||[],r=[...new Set(n.map(h=>h.equipmentType).filter(Boolean))],p=["\u062E\u0648\u0630\u0629 \u0623\u0645\u0627\u0646","\u0646\u0638\u0627\u0631\u0627\u062A \u0648\u0642\u0627\u064A\u0629","\u0642\u0641\u0627\u0632\u0627\u062A","\u0623\u062D\u0630\u064A\u0629 \u0623\u0645\u0627\u0646","\u0633\u062A\u0631\u0629 \u0639\u0627\u0643\u0633\u0629","\u0633\u062F\u0627\u062F\u0627\u062A \u0623\u0630\u0646","\u0643\u0645\u0627\u0645\u0629","\u0628\u062F\u0644\u0629 \u0648\u0627\u0642\u064A\u0629","\u062D\u0632\u0627\u0645 \u0623\u0645\u0627\u0646","\u0645\u0639\u062F\u0627\u062A \u062D\u0645\u0627\u064A\u0629 \u062A\u0646\u0641\u0633\u064A\u0629"],l=[...new Set([...p,...r])],o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
        ...
        `},async renderStockControlTab(){try{const t=await this.loadStockItems(),e=this.state.stockStaleWarningMsg?`<div role="status" class="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900 flex items-start gap-2">
                ...
                `;const i=t.filter(a=>{if(!a)return!1;const n=parseFloat(a.balance||0),r=parseFloat(a.minThreshold||0);return n<r});return`
            <div class="space-y-6">
                ${e}
        ...
        `}catch(t){return Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A renderStockControlTab:",t),`
            ...
            `}},renderStockDashboard(t,e){const s=(l,o)=>this._t(l,o),i=l=>Utils.escapeHTML(l),a=t.length,n=t.reduce((l,o)=>l+parseFloat(o.balance||0),0),r=t.reduce((l,o)=>l+parseFloat(o.stock_IN||0),0),p=t.reduce((l,o)=>l+parseFloat(o.stock_OUT||0),0);return`
        ...
        `},renderStockTable(t){const e=(l,o)=>this._t(l,o),s=l=>Utils.escapeHTML(l),i=Array.isArray(t)?t:[],a=this._buildExcelToolbarHtml("stock");if(i.length===0)return`
            ...
            `;const n=this.buildStockFilterRow(i),r=this.getFilteredStockItems(i),p=this.hasActiveStockFilters();return r.length===0&&p?`
                <div id="ppe-stock-table-card" class="content-card">
                    ...
                    <div class="card-body">
                        ${a}
                        <div id="ppe-stock-filters-host">${n}</div>
        ...
        `},buildStockResultsInnerHtml(t){const e=(r,p)=>this._t(r,p),s=r=>Utils.escapeHTML(r),i=Array.isArray(t)?t:[],a=this.getFilteredStockItems(i),n=this.hasActiveStockFilters();return a.length===0&&n?`
                <div class="empty-state">
                    <i class="fas fa-filter text-4xl text-gray-300 mb-4"></i>
                    ...
                    <div class="table-wrapper" style="overflow-x: auto;">
                        <table class="data-table">
                            ...
                            <tbody>
                                ${a.map(r=>{const p=parseFloat(r.balance||0),l=parseFloat(r.minThreshold||0),o=p<l;return`
                                        <tr class="${o?"bg-red-50":""}" data-item-id="${r.itemId||""}">
                                            ...
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    <button onclick="PPE.showStockItemForm('${r.itemId}')" class="btn-icon btn-icon-primary" title="${s(e("module.common.edit","\u062A\u0639\u062F\u064A\u0644"))}">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button onclick="PPE.showStockTransactions('${r.itemId}')" class="btn-icon btn-icon-info" title="${s(e("module.ppe.btn.transactions","\u0627\u0644\u062D\u0631\u0643\u0627\u062A"))}">
                                                        <i class="fas fa-list"></i>
                                                    </button>
                                                    <button onclick="PPE.showTransactionForm('${r.itemId}')" class="btn-icon btn-icon-success" title="${s(e("module.ppe.btn.addMovement","\u0625\u0636\u0627\u0641\u0629 \u062D\u0631\u0643\u0629"))}">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                                    <button onclick="PPE.deleteStockItem('${r.itemId}')" class="btn-icon btn-icon-danger" title="${s(e("module.ppe.btn.deleteItem","\u062D\u0630\u0641 \u0627\u0644\u0635\u0646\u0641"))}">
                                                        <i class="fas fa-trash"></i>
                                                    </button>
                                                </div>
                                            </td>
        ...
        `,document.body.appendChild(n),this.applyModuleI18n(n),n.querySelector("#stock-item-form").addEventListener("submit",async p=>{p.preventDefault(),Loading.show();try{const l=document.getElementById("stock-item-code"),o=document.getElementById("stock-item-name"),d=document.getElementById("stock-item-category"),h=document.getElementById("stock-item-min-threshold"),y=document.getElementById("stock-item-supplier");if(!l||!o||!d||!h||!y){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.fieldsMissing","\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649."));return}const c=l.value.trim(),m=o.value.trim();if(c&&(await this.loadStockItems()).find(u=>(e?u.itemId!==s.itemId:!0)&&u.itemCode&&String(u.itemCode).trim().toLowerCase()===c.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateCode","\u0643\u0648\u062F \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0643\u0648\u062F \u0622\u062E\u0631.")),l.focus(),l.style.borderColor="#ef4444";return}if(m&&(await this.loadStockItems()).find(u=>(e?u.itemId!==s.itemId:!0)&&u.itemName&&String(u.itemName).trim().toLowerCase()===m.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateName","\u0627\u0633\u0645 \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0633\u0645 \u0622\u062E\u0631.")),o.focus(),o.style.borderColor="#ef4444";return}const x={itemId:s?.itemId||Utils.generateId("STOCK"),itemCode:c,itemName:o.value.trim(),category:d.value.trim(),minThreshold:parseFloat(h.value)||0,supplier:y.value.trim(),stock_IN:s?.stock_IN||0,stock_OUT:s?.stock_OUT||0,balance:s?.balance||0,lastUpdate:new Date().toISOString(),createdAt:s?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString()};if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendToAppsScript){const k=await GoogleIntegration.sendToAppsScript("addOrUpdatePPEStockItem",x);if(k&&k.success){this.clearCache(),n.remove(),Loading.hide(),Notification.success(`\u062A\u0645 ${e?"\u062A\u062D\u062F\u064A\u062B":"\u0625\u0636\u0627\u0641\u0629"} \u0627\u0644\u0635\u0646\u0641 \u0628\u0646\u062C\u0627\u062D`),this.refreshActiveTab();return}else{const f=k?.message||"\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0627\u0644\u0635\u0646\u0641";Notification.error(f),f.includes("\u0643\u0648\u062F \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F")?(l.style.borderColor="#ef4444",l.focus()):f.includes("\u0627\u0633\u0645 \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F")&&(o.style.borderColor="#ef4444",o.focus())}}else{if(AppState.appData.ppeStock||(AppState.appData.ppeStock=[]),e){const k=AppState.appData.ppeStock.findIndex(f=>f.itemId===s.itemId);if(k!==-1){if(c&&AppState.appData.ppeStock.find((u,v)=>v!==k&&u.itemCode&&String(u.itemCode).trim().toLowerCase()===c.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateCode","\u0643\u0648\u062F \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0643\u0648\u062F \u0622\u062E\u0631.")),l.focus(),l.style.borderColor="#ef4444";return}if(m&&AppState.appData.ppeStock.find((u,v)=>v!==k&&u.itemName&&String(u.itemName).trim().toLowerCase()===m.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateName","\u0627\u0633\u0645 \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0633\u0645 \u0622\u062E\u0631.")),o.focus(),o.style.borderColor="#ef4444";return}AppState.appData.ppeStock[k]=x}}else{if(c&&AppState.appData.ppeStock.find(f=>f.itemCode&&String(f.itemCode).trim().toLowerCase()===c.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateCode","\u0643\u0648\u062F \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0643\u0648\u062F \u0622\u062E\u0631.")),l.focus(),l.style.borderColor="#ef4444";return}if(m&&AppState.appData.ppeStock.find(f=>f.itemName&&String(f.itemName).trim().toLowerCase()===m.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateName","\u0627\u0633\u0645 \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0633\u0645 \u0622\u062E\u0631.")),o.focus(),o.style.borderColor="#ef4444";return}AppState.appData.ppeStock.push(x)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),this.clearCache(),n.remove(),Loading.hide(),Notification.success(`\u062A\u0645 ${e?"\u062A\u062D\u062F\u064A\u062B":"\u0625\u0636\u0627\u0641\u0629"} \u0627\u0644\u0635\u0646\u0641 \u0628\u0646\u062C\u0627\u062D`),this.refreshActiveTab();return}}catch(l){Notification.error(PPE._t("module.ppe.notify.saveRuntimeError","\u062D\u062F\u062B \u062E\u0637\u0623")+": "+l.message)}finally{Loading.hide()}}),n.addEventListener("click",p=>{p.target===n&&n.remove()})},async showTransactionForm(t=null){const e=await this.loadStockItems(),s=t?e.find(n=>n.itemId===t):null,i=document.createElement("div");i.className="modal-overlay",i.innerHTML=`
                ...
                `:l=`
                    <div class="table-wrapper" style="overflow-x: auto;">
                        <table class="data-table">
                            ...
                            <tbody>
                                ${i.map(o=>{const d=o.action==="IN"?"\u0648\u0627\u0631\u062F":"\u0645\u0646\u0635\u0631\u0641",h=o.action==="IN"?"badge-success":"badge-warning",y=o.action==="IN"?"fa-arrow-down":"fa-arrow-up";return`
                                        <tr>
                            ...
                            <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-orange-600">${r.toFixed(0)}</p>
                                    </div>
...
\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: \u0644\u0627 \u064A\u0645\u0643\u0646 \u062D\u0630\u0641 \u0627\u0644\u0635\u0646\u0641 \u0625\u0630\u0627 \u0643\u0627\u0646 \u064A\u062D\u062A\u0648\u064A \u0639\u0644\u0649 \u062D\u0631\u0643\u0627\u062A \u0645\u0633\u062C\u0644\u0629.`;if(confirm(i)){Loading.show();try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendToAppsScript){const a=await GoogleIntegration.sendToAppsScript("deletePPEStockItem",{itemId:t});a&&a.success?(this.state.stockItemsCache=null,this.state.stockItemsCacheTime=null,Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0635\u0646\u0641 \u0628\u0646\u062C\u0627\u062D"),await this.load()):Notification.error(a?.message||"\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0635\u0646\u0641")}else AppState.appData.ppeStock?(AppState.appData.ppeStock=AppState.appData.ppeStock.filter(a=>a.itemId!==t),this.state.stockItemsCache=null,this.state.stockItemsCacheTime=null,Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0635\u0646\u0641 \u0628\u0646\u062C\u0627\u062D"),await this.load()):Notification.error("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0629 \u0644\u0644\u062D\u0630\u0641")}catch(a){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0635\u0646\u0641:",a),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0635\u0646\u0641: "+(a.message||a))}finally{Loading.hide()}}},_ppeAnalyticsPeriod:"0",_ppeAnalyticsCharts:{},async renderPpeAnalysisTab(){return this._ppeEnsureChartJS().catch(()=>{}),`
        ...
        `},async _ppeEnsureChartJS(){return typeof Chart<"u"?!0:document.querySelector('script[src*="chart.js"],script[src*="chartjs"]')?new Promise(e=>{let s=0;const i=setInterval(()=>{typeof Chart<"u"?(clearInterval(i),e(!0)):++s>50&&(clearInterval(i),e(!1))},100)}):new Promise(e=>{const s=document.createElement("script");s.src="https://cdn.jsdelivr.net/npm/chart.js@4.4.0/dist/chart.umd.min.js",s.onload=()=>e(!0),s.onerror=()=>{const i=document.createElement("script");i.src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/4.4.0/chart.umd.min.js",i.onload=()=>e(!0),i.onerror=()=>e(!1),document.head.appendChild(i)},document.head.appendChild(s)})},_getPpeReceiptsData(){return(Array.isArray(AppState?.appData?.ppe)?AppState.appData.ppe:[]).map(e=>{if(e._factoryDisplay!==void 0)return e;const s=String(e.employeeLocation||e.location||"").trim();let i="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",a="";if(s){const n=s.indexOf(" - ");n>0?(i=s.substring(0,n).trim()||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",a=s.substring(n+3).trim()):i=s}return e._factoryDisplay=i,e._locationDisplay=a||i,e._deptDisplay=String(e.employeeDepartment||e.department||e.dept||"").trim()||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",e})},_getPpeStockData(){return Array.isArray(AppState?.appData?.ppeStock)?AppState.appData.ppeStock:[]},_getPpeReceiptDate(t){if(!t)return null;const e=t.receiptDate||t.date||t.createdAt||t.timestamp||null;if(!e)return null;try{const s=new Date(e);return isNaN(s.getTime())?null:s}catch{return null}},_normalizePpeStatus(t){const e=String(t||"").trim().toLowerCase();return e==="\u0645\u0633\u062A\u0644\u0645"||e==="received"||e==="\u0645\u0643\u062A\u0645\u0644"?"received":e==="\u0642\u064A\u062F \u0627\u0644\u062A\u0633\u0644\u064A\u0645"||e==="pending"||e==="\u0628\u0627\u0646\u062A\u0638\u0627\u0631"?"pending":"other"},async updatePpeAnalyticsDashboard(){const t=document.getElementById("ppe-analytics-root");if(!t)return;const e=this._getPpeReceiptsData(),s=this._getPpeStockData(),i=parseInt(this._ppeAnalyticsPeriod||"0",10),a=i>0?(()=>{const E=new Date;return E.setDate(E.getDate()-i),E})():null,n=a?e.filter(E=>{const S=this._getPpeReceiptDate(E);return S&&S>=a}):e.slice();this._ppePopulateAnalyticsFilters(n,s);const{receipts:r,stock:p}=this._ppeApplyAnalyticsFilters(n,s),l=r.length,o=document.getElementById("ppe-filter-count");o&&(o.textContent=`${l} \u0627\u0633\u062A\u0644\u0627\u0645`);const d=r.reduce((E,S)=>E+(parseFloat(S.quantity)||0),0),h=r.filter(E=>this._normalizePpeStatus(E.status)==="received").length,y=r.filter(E=>this._normalizePpeStatus(E.status)==="pending").length,c=p.filter(E=>{const S=parseFloat(E.balance||0),_=parseFloat(E.minThreshold||0);return _>0&&S<_}),m=p.length,x=c.length,k=new Set(r.map(E=>E.employeeCode||E.employeeName).filter(Boolean)).size,f=new Date,u=r.filter(E=>{const S=this._getPpeReceiptDate(E);return S&&S.getFullYear()===f.getFullYear()&&S.getMonth()===f.getMonth()}).length,v=new Set(r.map(E=>{const S=this._getPpeReceiptDate(E);return S?`${S.getFullYear()}-${S.getMonth()}`:null}).filter(Boolean)),w=v.size>0?(l/v.size).toFixed(1):"0",C=document.getElementById("ppe-kpi-strip");if(C){const E=[{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645\u0627\u062A",value:l,icon:"fas fa-receipt",color:"#0F766E",bg:"#f0fdfa",border:"#99f6e4"},{label:"\u0627\u0644\u0643\u0645\u064A\u0627\u062A \u0627\u0644\u0645\u064F\u0633\u062A\u0644\u064E\u0645\u0629",value:d.toFixed(0),icon:"fas fa-cubes",color:"#0E7490",bg:"#ecfeff",border:"#a5f3fc"},{label:"\u0645\u0643\u062A\u0645\u0644\u0629 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645",value:h,icon:"fas fa-circle-check",color:"#047857",bg:"#ecfdf5",border:"#a7f3d0"},{label:"\u0642\u064A\u062F \u0627\u0644\u062A\u0633\u0644\u064A\u0645",value:y,icon:"fas fa-hourglass-half",color:"#b45309",bg:"#fffbeb",border:"#fde68a"},{label:"\u0623\u0635\u0646\u0627\u0641 \u0627\u0644\u0645\u062E\u0632\u0648\u0646",value:m,icon:"fas fa-boxes",color:"#6366f1",bg:"#eef2ff",border:"#c7d2fe"},{label:"\u0645\u0646\u062E\u0641\u0636 \u0627\u0644\u0645\u062E\u0632\u0648\u0646",value:x,icon:"fas fa-triangle-exclamation",color:"#dc2626",bg:"#fef2f2",border:"#fecaca"},{label:"\u0627\u0644\u0645\u0648\u0638\u0641\u0648\u0646",value:k,icon:"fas fa-users",color:"#7c3aed",bg:"#f5f3ff",border:"#ddd6fe"},{label:"\u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631",value:u,icon:"fas fa-calendar-day",color:"#db2777",bg:"#fdf2f8",border:"#fbcfe8"},{label:"\u0645\u062A\u0648\u0633\u0637 \u0634\u0647\u0631\u064A",value:w,icon:"fas fa-calendar-check",color:"#1E3A8A",bg:"#eef2ff",border:"#c7d2fe"}];C.innerHTML=E.map(S=>`
            ...
            `}).join("")},_ppePopulateAnalyticsLists(t,e,s){const i=o=>Utils.escapeHTML(o),a=(o,d,h,y,c,m)=>o.labels.length?o.labels.map((x,k)=>{const f=o.data[k],u=d>0?Math.round(f/d*100):0,v=m?`onclick="const el = document.getElementById('${m}'); if(el){el.value=this.getAttribute('data-value'); el.dispatchEvent(new Event('change'));}"`:"";return`
            ...
            `,t.insertBefore(a,t.firstChild);const n=await html2canvas(t,{scale:Utils.PdfExport.getOptimalCaptureScale(t.scrollWidth,t.scrollHeight,Utils.PdfExport.DEFAULT_CAPTURE_SCALE),useCORS:!0,backgroundColor:"#ffffff",logging:!1});a.remove();const r=Utils.PdfExport.createPdf({orientation:"portrait",unit:"mm",format:"a4"});if(!r)throw new Error("jsPDF unavailable");Utils.PdfExport.appendCanvasAsPdfPages(r,n,{marginMm:0});const p=new Date().toISOString().replace(/[:.]/g,"-").slice(0,19);Utils.PdfExport.savePdf(r,`PPE-Analytics-${p}.pdf`),Loading.hide(),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644 \u0628\u0646\u062C\u0627\u062D")}catch(t){Loading.hide(),Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF:",t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u062A\u0635\u062F\u064A\u0631: "+(t.message||t));const e=document.getElementById("ppe-pdf-header-temp");e&&e.remove()}}};(function(){"use strict";try{typeof window<"u"&&typeof PPE<"u"&&(window.PPE=PPE,typeof AppState<"u"&&AppState.debugMode&&typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u2705 PPE module loaded and available on window.PPE"))}catch{if(typeof window<"u"&&typeof PPE<"u")try{window.PPE=PPE}catch{}}})();
