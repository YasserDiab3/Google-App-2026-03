const PPE={state:{activeTab:"receipts",isSwitchingTab:!1,eventListeners:new Map,stockItemsCache:null,stockItemsCacheTime:null,stockCacheExpiry:3e5,ppeItemsListCache:null,ppeItemsListCacheTime:null,ppeItemsListCacheExpiry:12e4,ppeItemsOptionsHTML:"",stockStaleWarningMsg:"",stockLoadHardErrorMsg:"",lastSyncTime:null,filters:{receipts:{search:"",equipmentType:"",status:"",dateFrom:"",dateTo:""},stock:{search:"",category:"",supplier:"",status:"",dateFrom:"",dateTo:""}}},_t(e,t){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n.t(e,t):window.I18n&&typeof window.I18n.t=="function"?window.I18n.t(e,t):t},applyModuleI18n(e){const t=e&&e.nodeType?e:document.getElementById("ppe-section");if(!t)return;const s=window.AppI18n&&typeof window.AppI18n.applyModuleI18n=="function"?window.AppI18n:window.I18n&&typeof window.I18n.applyModuleI18n=="function"?window.I18n:null;s&&s.applyModuleI18n(t)},ensurePpeFilterStyles(){if(document.getElementById("ppe-module-filter-styles"))return;const e=document.createElement("style");e.id="ppe-module-filter-styles",e.textContent=`
        ...
        `,document.head.appendChild(e)},getDisplayStatus(e){const t=String(e||"").trim();return t==="\u0645\u0633\u062A\u0644\u0645"?this._t("module.ppe.status.received","\u0645\u0633\u062A\u0644\u0645"):t==="\u0642\u064A\u062F \u0627\u0644\u062A\u0633\u0644\u064A\u0645"?this._t("module.ppe.status.pending","\u0642\u064A\u062F \u0627\u0644\u062A\u0633\u0644\u064A\u0645"):t||"\u2014"},isStatusReceived(e){return String(e||"").trim()==="\u0645\u0633\u062A\u0644\u0645"},getFilteredPpeReceipts(e){const t=Array.isArray(e)?e:[],s=this.state.filters?.receipts||{},i=(s.search||"").trim().toLowerCase(),a=s.equipmentType||"",r=s.status||"",n=s.dateFrom?new Date(s.dateFrom+"T00:00:00"):null,p=s.dateTo?new Date(s.dateTo+"T23:59:59.999"):null;return n&&isNaN(n.getTime())||p&&isNaN(p.getTime())?t:t.filter(l=>{if(a&&String(l.equipmentType||"")!==a||r&&String(l.status||"")!==r)return!1;if(n||p){if(!l.receiptDate)return!1;const o=new Date(l.receiptDate);if(isNaN(o.getTime())||n&&o<n||p&&o>p)return!1}return!(i&&![l.receiptNumber,l.id,l.employeeName,l.employeeCode,l.employeeNumber,l.equipmentType,l.status,l.employeeDepartment].map(d=>String(d||"").toLowerCase()).join(" | ").includes(i))})},hasActiveReceiptFilters(){const e=this.state.filters?.receipts||{};return!!(e.search||e.equipmentType||e.status||e.dateFrom||e.dateTo)},resetReceiptFilters(){this.state.filters||(this.state.filters={}),this.state.filters.receipts={search:"",equipmentType:"",status:"",dateFrom:"",dateTo:""}},getFilteredStockItems(e){const t=Array.isArray(e)?e:[],s=this.state.filters&&this.state.filters.stock||{},i=(s.search||"").trim().toLowerCase(),a=s.category||"",r=s.supplier||"",n=s.status||"",p=s.dateFrom?new Date(s.dateFrom+"T00:00:00"):null,l=s.dateTo?new Date(s.dateTo+"T23:59:59.999"):null;return p&&isNaN(p.getTime())||l&&isNaN(l.getTime())?t:t.filter(o=>{if(!o||a&&String(o.category||"")!==a||r&&String(o.supplier||"")!==r)return!1;if(n){const d=parseFloat(o.balance||0),y=parseFloat(o.minThreshold||0),h=d<y;if(n==="low"&&!h||n==="available"&&h)return!1}if(p||l){if(!o.lastUpdate)return!1;const d=new Date(o.lastUpdate);if(isNaN(d.getTime())||p&&d<p||l&&d>l)return!1}return!(i&&![o.itemCode,o.itemName,o.category,o.supplier].map(y=>String(y||"").toLowerCase()).join(" | ").includes(i))})},hasActiveStockFilters(){const e=this.state.filters&&this.state.filters.stock||{};return!!(e.search||e.category||e.supplier||e.status||e.dateFrom||e.dateTo)},resetStockFilters(){this.state.filters||(this.state.filters={}),this.state.filters.stock={search:"",category:"",supplier:"",status:"",dateFrom:"",dateTo:""}},buildStockFilterRow(e){const t=(o,d)=>this._t(o,d),s=o=>Utils.escapeHTML(o);this.ensurePpeFilterStyles();const i=Array.isArray(e)?e:[],a=this.state.filters&&this.state.filters.stock||{},r=this.getFilteredStockItems(i),n=typeof document<"u"&&(document.documentElement.getAttribute("dir")==="rtl"||window.AppI18n&&window.AppI18n.getCurrentLang&&window.AppI18n.getCurrentLang()==="ar"),p=[...new Set(i.map(o=>o&&o.category).filter(Boolean))].sort(),l=[...new Set(i.map(o=>o&&o.supplier).filter(Boolean))].sort();return`
            ...
            </div>`},buildPPEListHtml(){const e=(u,m)=>this._t(u,m);this.ensurePpeFilterStyles();const t=AppState.appData.ppe||[],s=this.state.filters?.receipts||{},i=this.getFilteredPpeReceipts(t),a=this.hasActiveReceiptFilters(),r=typeof document<"u"&&(document.documentElement.getAttribute("dir")==="rtl"||window.AppI18n&&window.AppI18n.getCurrentLang&&window.AppI18n.getCurrentLang()==="ar"),n=u=>Utils.escapeHTML(u);if(t.length===0)return`<div class="empty-state"><p class="text-gray-500">${n(e("module.ppe.empty.noReceipts","\u0644\u0627 \u062A\u0648\u062C\u062F \u0627\u0633\u062A\u0644\u0627\u0645\u0627\u062A \u0645\u0633\u062C\u0644\u0629"))}</p></div>`;const p=[...new Set(t.map(u=>u.equipmentType).filter(Boolean))].sort(),l=["\u0645\u0633\u062A\u0644\u0645","\u0642\u064A\u062F \u0627\u0644\u062A\u0633\u0644\u064A\u0645"],o=`
        ...
        `:"";if(i.length===0)return this._buildExcelToolbarHtml("receipts")+o+d;const y=e("module.common.view","\u0639\u0631\u0636"),h=e("module.kpi.exportPDF","\u062A\u0635\u062F\u064A\u0631 PDF"),c=e("module.common.edit","\u062A\u0639\u062F\u064A\u0644"),f=e("module.ppe.btn.deleteReceipt","\u062D\u0630\u0641"),v=`
            <table class="data-table table-header-blue">
                ...
                <tbody>
                    ${i.map(u=>{const m=this.getDisplayStatus(u.status),x=String(u.id||"").replace(/\\/g,"\\\\").replace(/'/g,"\\'");return`
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    ...
                                    <button onclick="PPE.showPPEForm(${JSON.stringify(u).replace(/"/g,"&quot;")});" class="btn-icon btn-icon-primary" title="${n(c)}">
                        ...
                        <div class="${c.tileSurface}">
                            <div class="flex items-center gap-3 sm:gap-4 text-start h-full">
                                ...
                                <div class="flex-1 min-w-0 flex flex-col gap-1.5 justify-center">
                                    <div class="${c.labelClass} text-xs sm:text-[11px] leading-snug">${m.label}</div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4" style="margin-bottom: 16px;">
                                    ...
                                    <div>
                                        ...
                                        <select id="ppe-status" required class="form-input" style="width: 100%; border: 1px solid #cbd5e1; border-radius: 6px; padding: 8px 12px; font-size: 0.85rem; outline: none;">
                                            <option value="\u0645\u0633\u062A\u0644\u0645" ${e?.status==="\u0645\u0633\u062A\u0644\u0645"?"selected":""}>${d(y)}</option>
...
${t.receiptNumber||t.id} \u2014 ${t.employeeName||""}`;if(confirm(s)){Loading.show();try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendToAppsScript){const i=await GoogleIntegration.sendToAppsScript("deletePPE",{ppeId:e});i&&i.success?(AppState.appData.ppe&&(AppState.appData.ppe=AppState.appData.ppe.filter(a=>a.id!==e)),Notification.success(this._t("module.ppe.notify.deleteSuccess","\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645 \u0628\u0646\u062C\u0627\u062D")),await this.load()):Notification.error(i?.message||this._t("module.ppe.notify.deleteError","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645"))}else AppState.appData.ppe?(AppState.appData.ppe=AppState.appData.ppe.filter(i=>i.id!==e),Notification.success(this._t("module.ppe.notify.deleteSuccess","\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645 \u0628\u0646\u062C\u0627\u062D")),await this.load()):Notification.error(this._t("module.ppe.empty.noReceipts","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A"))}catch(i){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645:",i),Notification.error(this._t("module.ppe.notify.deleteError","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645")+": "+(i.message||i))}finally{Loading.hide()}}},async exportPDF(e){const t=AppState.appData.ppe.find(s=>s.id===e);if(!t){Notification.error(this._t("module.ppe.notify.receiptNotFound","\u0627\u0644\u0627\u0633\u062A\u0644\u0627\u0645 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}try{Loading.show();const s=t.receiptNumber||`PPE-${t.id?.substring(0,8)||"UNKNOWN"}`,i=y=>Utils.escapeHTML(y||""),a=y=>y?Utils.formatDate(y):"-",r=`
        ...
        `,document.body.appendChild(s),this.applyModuleI18n(s);const i=document.getElementById("ppe-matrix-search");i&&i.addEventListener("input",r=>{this.filterPPEMatrix(r.target.value.trim())});const a=document.getElementById("add-ppe-matrix-btn");a&&a.addEventListener("click",()=>{this.showAddPPEMatrixForm()}),s.addEventListener("click",r=>{r.target===s&&s.remove()})},async renderPPEMatrix(){const e=(n,p)=>this._t(n,p),t=n=>Utils.escapeHTML(n),s=AppState.appData.employees||[],i=AppState.appData.employeePPEMatrixByCode||{},a=AppState.appData.ppe||[];if(s.length===0)return`
            ...
            `;const r=s.map(n=>{const p=n.employeeNumber||n.sapId||"",l=n.name||n.employeeName||"-",o=n.position||e("module.ppe.label.undefinedDept","\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"),d=n.department||"-",y=i[p]||[],h=a.filter(f=>f.employeeCode===p||f.employeeNumber===p),c=[...new Set(h.map(f=>f.equipmentType).filter(Boolean))];return{code:p,name:l,position:o,department:d,requiredPPE:y,receivedPPE:c}});return`
                                    ...
                                    ${a.map((m,x)=>`
                                        <label class="flex items-center p-2 border rounded cursor-pointer hover:bg-blue-50 transition-colors">
                                            <input type="checkbox" name="ppe-type" value="${Utils.escapeHTML(m)}" 
                                                ${p&&p.requiredPPE&&p.requiredPPE.includes(m)?"checked":""}
        ...
        `,document.body.appendChild(l);let o=!1;const d=l.querySelector('[data-action="close"]'),y=l.querySelector(".modal-close"),h=()=>{o&&!u&&!confirm(`\u062A\u0646\u0628\u064A\u0647: \u0644\u062F\u064A\u0643 \u062A\u063A\u064A\u064A\u0631\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.

\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642 \u062F\u0648\u0646 \u062D\u0641\u0638\u061F`)||l.remove()};d&&d.addEventListener("click",h),y&&y.addEventListener("click",h);const c=document.getElementById("ppe-matrix-position"),f=document.getElementById("ppe-matrix-position-custom");c&&f&&c.addEventListener("change",()=>{c.value==="__custom__"?(f.style.display="block",f.required=!0):(f.style.display="none",f.required=!1)});const v=l.querySelector("#ppe-matrix-form");let u=!1;v.addEventListener("change",()=>{o=!0}),v.addEventListener("input",()=>{o=!0}),v.addEventListener("submit",async m=>{if(m.preventDefault(),u)return;const x=t?e:c?.value==="__custom__"?f?.value.trim():c?.value;if(!x){Notification.error("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u0629");return}const w=Array.from(v.querySelectorAll('input[name="ppe-type"]:checked')).map(D=>D.value);if(w.length===0){Notification.error("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u0645\u0647\u0645\u0627\u062A \u0648\u0642\u0627\u064A\u0629 \u0648\u0627\u062D\u062F\u0629 \u0639\u0644\u0649 \u0627\u0644\u0623\u0642\u0644");return}u=!0;const E=v.querySelector('button[type="submit"]'),N=E?.innerHTML;E&&(E.disabled=!0,E.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');try{const D=r.filter($=>$.position===x).map($=>$.employeeNumber||$.sapId||"");AppState.appData.employeePPEMatrix||(AppState.appData.employeePPEMatrix={});const q=AppState.appData.employeePPEMatrix[x]||{};AppState.appData.employeePPEMatrix[x]={requiredPPE:w,employees:D,updatedAt:new Date().toISOString(),createdAt:q?.createdAt||new Date().toISOString()},AppState.appData.employeePPEMatrixByCode||(AppState.appData.employeePPEMatrixByCode={}),D.forEach($=>{$&&(AppState.appData.employeePPEMatrixByCode[$]||(AppState.appData.employeePPEMatrixByCode[$]=[]),w.forEach(L=>{AppState.appData.employeePPEMatrixByCode[$].includes(L)||AppState.appData.employeePPEMatrixByCode[$].push(L)}))}),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),o=!1,Notification.success("\u062A\u0645 "+(t?"\u062A\u062D\u062F\u064A\u062B":"\u0625\u0636\u0627\u0641\u0629")+' \u0645\u0635\u0641\u0648\u0641\u0629 \u0645\u0647\u0645\u0627\u062A \u0627\u0644\u0648\u0642\u0627\u064A\u0629 \u0644\u0644\u0648\u0638\u064A\u0641\u0629 "'+x+'" \u0628\u0646\u062C\u0627\u062D'),l.remove(),this.showPPEMatrix(),Promise.allSettled([GoogleIntegration.autoSave("PPEMatrix",AppState.appData.employeePPEMatrix).catch($=>(Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 Google Sheets:",$),{success:!1,error:$})),GoogleIntegration.autoSave("EmployeePPEMatrixByCode",AppState.appData.employeePPEMatrixByCode).catch($=>(Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0645\u0635\u0641\u0648\u0641\u0629 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0641\u064A Google Sheets:",$),{success:!1,error:$}))]).then($=>{$.every(U=>U.status==="fulfilled")||Utils.safeWarn("\u26A0\uFE0F \u0628\u0639\u0636 \u0627\u0644\u0645\u0647\u0627\u0645 \u0627\u0644\u062E\u0644\u0641\u064A\u0629 \u0644\u0645 \u062A\u0643\u062A\u0645\u0644 \u0628\u0646\u062C\u0627\u062D\u060C \u0644\u0643\u0646 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0641\u0648\u0638\u0629 \u0645\u062D\u0644\u064A\u0627\u064B")}).catch($=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u0627\u0644\u0645\u0647\u0627\u0645 \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",$)})}catch(D){Notification.error(PPE._t("module.ppe.notify.saveRuntimeError","\u062D\u062F\u062B \u062E\u0637\u0623")+": "+D.message),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0645\u0635\u0641\u0648\u0641\u0629 \u0645\u0647\u0645\u0627\u062A \u0627\u0644\u0648\u0642\u0627\u064A\u0629:",D),E&&(E.disabled=!1,E.innerHTML=N),u=!1}}),l.addEventListener("click",m=>{if(m.target===l){if(o&&!u&&!confirm(`\u062A\u0646\u0628\u064A\u0647: \u0644\u062F\u064A\u0643 \u062A\u063A\u064A\u064A\u0631\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.

\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642 \u062F\u0648\u0646 \u062D\u0641\u0638\u061F`))return;l.remove()}})},async editPPEMatrix(e){this.showAddPPEMatrixForm(e)},async editEmployeePPEMatrix(e){const s=(AppState.appData.employees||[]).find(y=>(y.employeeNumber||y.sapId)===e);if(!s){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const a=(AppState.appData.employeePPEMatrixByCode||{})[e]||[],r=AppState.appData.ppe||[],n=[...new Set(r.map(y=>y.equipmentType).filter(Boolean))],p=["\u062E\u0648\u0630\u0629 \u0623\u0645\u0627\u0646","\u0646\u0638\u0627\u0631\u0627\u062A \u0648\u0642\u0627\u064A\u0629","\u0642\u0641\u0627\u0632\u0627\u062A","\u0623\u062D\u0630\u064A\u0629 \u0623\u0645\u0627\u0646","\u0633\u062A\u0631\u0629 \u0639\u0627\u0643\u0633\u0629","\u0633\u062F\u0627\u062F\u0627\u062A \u0623\u0630\u0646","\u0643\u0645\u0627\u0645\u0629","\u0628\u062F\u0644\u0629 \u0648\u0627\u0642\u064A\u0629","\u062D\u0632\u0627\u0645 \u0623\u0645\u0627\u0646","\u0645\u0639\u062F\u0627\u062A \u062D\u0645\u0627\u064A\u0629 \u062A\u0646\u0641\u0633\u064A\u0629"],l=[...new Set([...p,...n])],o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
        ...
        `,document.body.appendChild(o);const d=o.querySelector("#employee-ppe-matrix-form");d.addEventListener("submit",async y=>{y.preventDefault();const h=d.querySelectorAll('input[name="ppe-type"]:checked'),c=Array.from(h).map(f=>f.value);try{AppState.appData.employeePPEMatrixByCode||(AppState.appData.employeePPEMatrixByCode={}),AppState.appData.employeePPEMatrixByCode[e]=c,typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0645\u0635\u0641\u0648\u0641\u0629 \u0645\u0647\u0645\u0627\u062A \u0627\u0644\u0648\u0642\u0627\u064A\u0629 \u0644\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D"),o.remove();const f=document.getElementById("ppe-matrix-content");f&&(f.innerHTML=await this.renderPPEMatrix()),typeof GoogleIntegration<"u"&&GoogleIntegration.autoSave&&GoogleIntegration.autoSave("EmployeePPEMatrixByCode",AppState.appData.employeePPEMatrixByCode).catch(v=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 Google Sheets:",v)})}catch(f){Notification.error(PPE._t("module.ppe.notify.saveRuntimeError","\u062D\u062F\u062B \u062E\u0637\u0623")+": "+f.message),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0645\u0635\u0641\u0648\u0641\u0629 \u0645\u0647\u0645\u0627\u062A \u0627\u0644\u0648\u0642\u0627\u064A\u0629:",f)}}),o.addEventListener("click",y=>{y.target===o&&o.remove()})},async viewPositionEmployees(e){const s=(AppState.appData.employeePPEMatrix||{})[e],a=(AppState.appData.employees||[]).filter(l=>l.position===e),r=document.createElement("div");r.className="modal-overlay";const n=s&&s.requiredPPE?s.requiredPPE.map(l=>`<span class="badge badge-success mr-2">${Utils.escapeHTML(l)}</span>`).join(""):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062F";let p="";a.length>0?p=`
                <div class="table-wrapper" style="overflow-x: auto;">
                    <table class="data-table">
                        ...
                        <tbody>
                            ${a.map(l=>{const o=l.employeeNumber||l.sapId||"",d=(AppState.appData.ppe||[]).filter(v=>v.employeeCode===o||v.employeeNumber===o),h=(AppState.appData.employeePPEMatrixByCode||{})[o]||[],c=d.length>0?d.map(v=>`<span class="badge badge-info">${Utils.escapeHTML(v.equipmentType||"")}</span>`).join(""):'<span class="text-gray-500 text-sm">\u0644\u0627 \u062A\u0648\u062C\u062F</span>',f=h.length>0?h.map(v=>`<span class="badge badge-success">${Utils.escapeHTML(v)}</span>`).join(""):'<span class="text-gray-500 text-sm">\u0644\u0645 \u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062F</span>';return`
                                    <tr>
        ...
        `},showPpeReceiptsImportModal(){if(!this._isPpeAdminUser())return;if(typeof XLSX>"u"){Notification.error(this._t("module.ppe.notify.xlsxMissing","\u0645\u0643\u062A\u0628\u0629 SheetJS \u063A\u064A\u0631 \u0645\u062D\u0645\u0651\u0644\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629"));return}try{document.getElementById("ppe-receipts-import-modal")?.remove()}catch{}const e=(c,f)=>this._t(c,f),t=c=>Utils.escapeHTML(c),i=this._ppeReceiptExcelFieldDefs().map(c=>`<li><strong>${t(c.ar)}</strong> \u2014 <span class="font-mono text-xs">${t(c.en)}</span></li>`).join(""),a=document.createElement("div");a.className="modal-overlay",a.id="ppe-receipts-import-modal",a.innerHTML=`
            <div class="modal-content" style="max-width: 800px;">
                <div class="modal-header">
            ...
            </div>`,document.body.appendChild(a),this.applyModuleI18n(a);const r=a.querySelector("#ppe-receipts-modal-file"),n=a.querySelector("#ppe-receipts-modal-download-template"),p=a.querySelector("#ppe-receipts-import-preview"),l=a.querySelector("#ppe-receipts-preview-head"),o=a.querySelector("#ppe-receipts-preview-body"),d=a.querySelector("#ppe-receipts-preview-count"),y=a.querySelector("#ppe-receipts-import-confirm");let h=null;n&&(n.onclick=()=>this.downloadReceiptsExcelTemplate()),r.addEventListener("change",async c=>{const f=c.target.files&&c.target.files[0];if(h=f||null,y.disabled=!h,!f){p.classList.add("hidden");return}try{const v=await f.arrayBuffer(),u=XLSX.read(v,{type:"array",cellDates:!0}),m=XLSX.utils.sheet_to_json(u.Sheets[u.SheetNames[0]],{header:1,defval:"",raw:!1});if(!m||m.length<2){p.classList.add("hidden"),Notification.warning(this._t("module.ppe.excel.importEmpty","\u0627\u0644\u0645\u0644\u0641 \u0641\u0627\u0631\u063A \u0623\u0648 \u0644\u0627 \u064A\u062D\u062A\u0648\u064A \u0635\u0641 \u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0639\u062F \u0627\u0644\u0631\u0624\u0648\u0633"));return}const x=(m[0]||[]).map(E=>String(E||"").trim());l.innerHTML=`<tr>${x.map(E=>`<th>${t(E)}</th>`).join("")}</tr>`,o.innerHTML=m.slice(1,6).map(E=>`<tr>${x.map((N,D)=>`<td>${t(String(E[D]??""))}</td>`).join("")}</tr>`).join("");const w=Math.max(0,m.length-1);d.textContent=`${this._t("module.ppe.excel.previewRowCount","\u0639\u062F\u062F \u0635\u0641\u0648\u0641 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")}: ${w}`,p.classList.remove("hidden")}catch(v){Utils.safeError("ppe receipts import preview",v),p.classList.add("hidden"),Notification.error(this._t("module.ppe.excel.previewErr","\u062A\u0639\u0630\u0651\u0631 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641 \u0644\u0644\u0645\u0639\u0627\u064A\u0646\u0629"))}}),y.addEventListener("click",async()=>{h&&(a.remove(),await this.importReceiptsExcel(h))}),a.addEventListener("click",c=>{c.target===a&&a.remove()})},showPpeStockImportModal(){if(!this._isPpeAdminUser())return;if(typeof XLSX>"u"){Notification.error(this._t("module.ppe.notify.xlsxMissing","\u0645\u0643\u062A\u0628\u0629 SheetJS \u063A\u064A\u0631 \u0645\u062D\u0645\u0651\u0644\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629"));return}try{document.getElementById("ppe-stock-import-modal")?.remove()}catch{}const e=(c,f)=>this._t(c,f),t=c=>Utils.escapeHTML(c),i=this._ppeStockExcelFieldDefs().filter(c=>!["stock_IN","stock_OUT","balance"].includes(c.key)).map(c=>`<li><strong>${t(c.ar)}</strong> \u2014 <span class="font-mono text-xs">${t(c.en)}</span></li>`).join(""),a=document.createElement("div");a.className="modal-overlay",a.id="ppe-stock-import-modal",a.innerHTML=`
            <div class="modal-content" style="max-width: 800px;">
                <div class="modal-header">
                ...
                <div class="card-body">
                    ...
                    <div class="table-wrapper" style="overflow-x: auto;">
                        <table class="data-table">
                            ...
                            <tbody>
                                ${n.map(l=>{const o=parseFloat(l.balance||0),d=parseFloat(l.minThreshold||0),y=o<d;return`
                                        <tr class="${y?"bg-red-50":""}" data-item-id="${l.itemId||""}">
        ...
        `,document.body.appendChild(r),this.applyModuleI18n(r),r.querySelector("#stock-item-form").addEventListener("submit",async p=>{p.preventDefault(),Loading.show();try{const l=document.getElementById("stock-item-code"),o=document.getElementById("stock-item-name"),d=document.getElementById("stock-item-category"),y=document.getElementById("stock-item-min-threshold"),h=document.getElementById("stock-item-supplier");if(!l||!o||!d||!y||!h){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.fieldsMissing","\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649."));return}const c=l.value.trim(),f=o.value.trim();if(c&&(await this.loadStockItems()).find(x=>(t?x.itemId!==s.itemId:!0)&&x.itemCode&&String(x.itemCode).trim().toLowerCase()===c.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateCode","\u0643\u0648\u062F \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0643\u0648\u062F \u0622\u062E\u0631.")),l.focus(),l.style.borderColor="#ef4444";return}if(f&&(await this.loadStockItems()).find(x=>(t?x.itemId!==s.itemId:!0)&&x.itemName&&String(x.itemName).trim().toLowerCase()===f.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateName","\u0627\u0633\u0645 \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0633\u0645 \u0622\u062E\u0631.")),o.focus(),o.style.borderColor="#ef4444";return}const v={itemId:s?.itemId||Utils.generateId("STOCK"),itemCode:c,itemName:o.value.trim(),category:d.value.trim(),minThreshold:parseFloat(y.value)||0,supplier:h.value.trim(),stock_IN:s?.stock_IN||0,stock_OUT:s?.stock_OUT||0,balance:s?.balance||0,lastUpdate:new Date().toISOString(),createdAt:s?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString()};if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendToAppsScript){const u=await GoogleIntegration.sendToAppsScript("addOrUpdatePPEStockItem",v);if(u&&u.success){this.clearCache(),r.remove(),Loading.hide(),Notification.success(`\u062A\u0645 ${t?"\u062A\u062D\u062F\u064A\u062B":"\u0625\u0636\u0627\u0641\u0629"} \u0627\u0644\u0635\u0646\u0641 \u0628\u0646\u062C\u0627\u062D`),this.refreshActiveTab();return}else{const m=u?.message||"\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0627\u0644\u0635\u0646\u0641";Notification.error(m),m.includes("\u0643\u0648\u062F \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F")?(l.style.borderColor="#ef4444",l.focus()):m.includes("\u0627\u0633\u0645 \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F")&&(o.style.borderColor="#ef4444",o.focus())}}else{if(AppState.appData.ppeStock||(AppState.appData.ppeStock=[]),t){const u=AppState.appData.ppeStock.findIndex(m=>m.itemId===s.itemId);if(u!==-1){if(c&&AppState.appData.ppeStock.find((x,w)=>w!==u&&x.itemCode&&String(x.itemCode).trim().toLowerCase()===c.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateCode","\u0643\u0648\u062F \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0643\u0648\u062F \u0622\u062E\u0631.")),l.focus(),l.style.borderColor="#ef4444";return}if(f&&AppState.appData.ppeStock.find((x,w)=>w!==u&&x.itemName&&String(x.itemName).trim().toLowerCase()===f.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateName","\u0627\u0633\u0645 \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0633\u0645 \u0622\u062E\u0631.")),o.focus(),o.style.borderColor="#ef4444";return}AppState.appData.ppeStock[u]=v}}else{if(c&&AppState.appData.ppeStock.find(m=>m.itemCode&&String(m.itemCode).trim().toLowerCase()===c.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateCode","\u0643\u0648\u062F \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0643\u0648\u062F \u0622\u062E\u0631.")),l.focus(),l.style.borderColor="#ef4444";return}if(f&&AppState.appData.ppeStock.find(m=>m.itemName&&String(m.itemName).trim().toLowerCase()===f.toLowerCase())){Loading.hide(),Notification.error(PPE._t("module.ppe.notify.duplicateName","\u0627\u0633\u0645 \u0627\u0644\u0635\u0646\u0641 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0633\u0645 \u0622\u062E\u0631.")),o.focus(),o.style.borderColor="#ef4444";return}AppState.appData.ppeStock.push(v)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),this.clearCache(),r.remove(),Loading.hide(),Notification.success(`\u062A\u0645 ${t?"\u062A\u062D\u062F\u064A\u062B":"\u0625\u0636\u0627\u0641\u0629"} \u0627\u0644\u0635\u0646\u0641 \u0628\u0646\u062C\u0627\u062D`),this.refreshActiveTab();return}}catch(l){Notification.error(PPE._t("module.ppe.notify.saveRuntimeError","\u062D\u062F\u062B \u062E\u0637\u0623")+": "+l.message)}finally{Loading.hide()}}),r.addEventListener("click",p=>{p.target===r&&r.remove()})},async showTransactionForm(e=null){const t=await this.loadStockItems(),s=e?t.find(r=>r.itemId===e):null,i=document.createElement("div");i.className="modal-overlay",i.innerHTML=`
                ...
                `:l=`
                    <div class="table-wrapper" style="overflow-x: auto;">
                        <table class="data-table">
                            ...
                            <tbody>
                                ${i.map(o=>{const d=o.action==="IN"?"\u0648\u0627\u0631\u062F":"\u0645\u0646\u0635\u0631\u0641",y=o.action==="IN"?"badge-success":"badge-warning",h=o.action==="IN"?"fa-arrow-down":"fa-arrow-up";return`
                                        <tr>
