const PeriodicEquipment={state:{filters:{search:"",typeId:"all",status:"all",location:"all"}},_qrStream:null,_qrScanInterval:null,isAdmin(){return typeof PeriodicInspections<"u"&&typeof PeriodicInspections.isCurrentUserAdmin=="function"?PeriodicInspections.isCurrentUserAdmin():!1},_t(e,t){try{if(typeof I18n<"u"&&I18n.t)return I18n.t(e,t)}catch{}return t},ensureData(){typeof PeriodicEquipmentStore<"u"&&PeriodicEquipmentStore.ensureInitialized()},getSiteOptions(){return typeof PeriodicInspections<"u"&&typeof PeriodicInspections.getSiteOptions=="function"?PeriodicInspections.getSiteOptions():[]},getPlaceOptions(e){return typeof PeriodicInspections<"u"&&typeof PeriodicInspections.getPlaceOptions=="function"?PeriodicInspections.getPlaceOptions(e):[]},resolveAssetFactoryId(e){if(!e)return"";if(e.factoryId)return String(e.factoryId);if(e.factory)return String(e.factory);if(e.location){const t=this.getSiteOptions().find(i=>i.name===e.location);if(t)return String(t.id)}return""},resolveAssetSubLocationId(e,t){if(!e)return"";if(e.subLocationId)return String(e.subLocationId);const i=t||this.resolveAssetFactoryId(e);if(e.subLocation&&i){const a=this.getPlaceOptions(i).find(s=>s.name===e.subLocation||s.id===e.subLocation);if(a)return String(a.id)}return""},getAssetSiteLabel(e){return e?.factoryName||e?.location||"-"},getAssetSubLocationLabel(e){return e?.subLocationName||e?.subLocation||"-"},getAssets(){return this.ensureData(),PeriodicEquipmentStore.listAssets()},statusOptions:[{value:"\u0635\u0627\u0644\u062D",label:"\u0635\u0627\u0644\u062D",cls:"badge-success"},{value:"\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629",label:"\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629",cls:"badge-warning"},{value:"\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629",label:"\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629",cls:"badge-danger"}],getStatusBadge(e){const t=this.statusOptions.find(i=>i.value===e)||{label:e||"-",cls:"badge-secondary"};return`<span class="badge ${t.cls}">${Utils.escapeHTML(t.label)}</span>`},async renderTab(){return this.ensureData(),await this.renderDatabaseTab()},async renderDatabaseTab(){const e=this.getFilteredAssets(),t=this.getStats(),i=PeriodicEquipmentStore.listTypes();return`
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div class="content-card text-center">
                    ...
                    <p class="text-2xl font-bold text-blue-600" id="pe-stat-total">${t.total}</p>
                </div>
                <div class="content-card text-center">
                    <p class="text-sm text-gray-500">${this._t("module.periodic.equipment.valid","\u0635\u0627\u0644\u062D")}</p>
                    <p class="text-2xl font-bold text-green-600" id="pe-stat-valid">${t.valid}</p>
                </div>
                <div class="content-card text-center">
                    <p class="text-sm text-gray-500">${this._t("module.periodic.equipment.needsAttention","\u0628\u062D\u0627\u062C\u0629 \u0645\u062A\u0627\u0628\u0639\u0629")}</p>
                    <p class="text-2xl font-bold text-yellow-600" id="pe-stat-attention">${t.needsAttention}</p>
                </div>
            </div>
        ...
        `},getStats(){const e=this.getAssets();return{total:e.length,valid:e.filter(t=>t.status==="\u0635\u0627\u0644\u062D").length,needsAttention:e.filter(t=>t.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629"||t.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length}},getFilteredAssets(){const e=this.state.filters;return this.getAssets().filter(t=>{if(e.typeId!=="all"&&t.typeId!==e.typeId||e.status!=="all"&&t.status!==e.status||e.location!=="all"&&!(t.factoryId===e.location||t.factory===e.location||t.location===e.location))return!1;if(e.search){const i=e.search.toLowerCase();if(![t.id,t.assetNumber,t.typeName,t.location,t.serialNumber,t.manufacturer].join(" ").toLowerCase().includes(i))return!1}return!0})},renderAssetsTable(e){return e.length?`
            <div class="table-wrapper overflow-x-auto">
                <table class="data-table">
                    ...
                    <tbody>
                        ${e.map(t=>`
                            <tr>
                                <td><span class="font-mono font-semibold">${Utils.escapeHTML(t.assetNumber||t.id)}</span></td>
        ...
        `:`<div class="empty-state"><p class="text-gray-500">${this._t("module.periodic.equipment.empty","\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0639\u062F\u0627\u062A \u0645\u0633\u062C\u0644\u0629")}</p></div>`},bindTabEvents(e){const t=e||document.getElementById("periodic-inspections-content-area");if(!t)return;const i=()=>{const s=document.getElementById("pe-assets-table-wrap");if(!s)return;const o=this.getFilteredAssets();s.innerHTML=this.renderAssetsTable(o);const l=this.getStats(),n=document.getElementById("pe-stat-total"),d=document.getElementById("pe-stat-valid"),p=document.getElementById("pe-stat-attention");n&&(n.textContent=l.total),d&&(d.textContent=l.valid),p&&(p.textContent=l.needsAttention),this.bindTableActions(t)};["pe-filter-search","pe-filter-type","pe-filter-status","pe-filter-location"].forEach(s=>{const o=t.querySelector("#"+s)||document.getElementById(s);if(!o||o.dataset.peBound==="1")return;o.dataset.peBound="1";const l=()=>{this.state.filters.search=(document.getElementById("pe-filter-search")?.value||"").trim(),this.state.filters.typeId=document.getElementById("pe-filter-type")?.value||"all",this.state.filters.status=document.getElementById("pe-filter-status")?.value||"all",this.state.filters.location=document.getElementById("pe-filter-location")?.value||"all",i()};o.addEventListener(o.tagName==="INPUT"?"input":"change",l)});const a=(s,o)=>{const l=document.getElementById(s);!l||l.dataset.peBound==="1"||(l.dataset.peBound="1",l.addEventListener("click",o))};a("pe-add-asset-btn",()=>this.showAssetForm()),a("pe-manage-types-btn",()=>this.showTypeManagement()),a("pe-scan-qr-btn",()=>this.startQRScan()),a("pe-refresh-btn",async()=>{await this.loadDataFromBackend(!0),typeof PeriodicInspections<"u"&&await PeriodicInspections.refreshCurrentTabContent()}),this.bindTableActions(t)},bindTableActions(e){const t=e||document.getElementById("periodic-inspections-content-area");t&&t.querySelectorAll("[data-pe-action]").forEach(i=>{i.dataset.peActionBound!=="1"&&(i.dataset.peActionBound="1",i.addEventListener("click",async()=>{const a=i.getAttribute("data-pe-action"),s=i.getAttribute("data-id"),o=PeriodicEquipmentStore.getAssetById(s);o&&(a==="view"?await this.showAssetDetails(o):a==="inspect"?await this.showInspectionForm(o):a==="edit"?await this.showAssetForm(o):a==="delete"&&await this.deleteAsset(o))}))})},async showAssetForm(e=null){if(!this.isAdmin()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629. \u064A\u062C\u0628 \u0623\u0646 \u062A\u0643\u0648\u0646 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645.");return}typeof Permissions<"u"&&typeof Permissions.ensureFormSettingsState=="function"&&await Permissions.ensureFormSettingsState();const t=!!e,i=PeriodicEquipmentStore.listTypes(),a=e?.id||PeriodicEquipmentStore.generateAssetId(),s=this.resolveAssetFactoryId(e),o=this.resolveAssetSubLocationId(e,s),l=this.getPlaceOptions(s),n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="pe-asset-sub-location" class="form-input">
                                    ...
                                    ${l.map(c=>{const r=o&&(o===c.id||o===String(c.id));return`<option value="${Utils.escapeHTML(c.id)}" ${r?"selected":""}>${Utils.escapeHTML(c.name)}</option>`}).join("")}
                                </select>
                            </div>
                            <div>
        ...
        `,document.body.appendChild(n);const d=()=>n.remove();n.querySelector(".modal-close")?.addEventListener("click",d),n.querySelector("[data-close]")?.addEventListener("click",d),n.addEventListener("click",c=>{c.target===n&&d()});const p=n.querySelector("#pe-asset-site"),f=n.querySelector("#pe-asset-sub-location");p&&f&&p.addEventListener("change",()=>{const c=this.getPlaceOptions(p.value);f.innerHTML='<option value="">-- \u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A --</option>'+c.map(r=>`<option value="${Utils.escapeHTML(r.id)}">${Utils.escapeHTML(r.name)}</option>`).join("")}),n.querySelector("#pe-asset-form")?.addEventListener("submit",async c=>{c.preventDefault();try{const r=n.querySelector("#pe-asset-type")?.value,g=PeriodicEquipmentStore.getTypeById(r),u=n.querySelector("#pe-asset-site")?.value||"",b=n.querySelector("#pe-asset-sub-location")?.value||"";if(!u){Notification.warning("\u064A\u062C\u0628 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0645\u0648\u0642\u0639");return}const v=this.getSiteOptions().find(m=>m.id===u),y=this.getPlaceOptions(u).find(m=>m.id===b),h={...e||{},id:a,typeId:r,typeName:g?.name||"",assetNumber:n.querySelector("#pe-asset-number")?.value.trim()||a,factoryId:u,factory:u,factoryName:v?.name||"",location:v?.name||"",subLocationId:b||"",subLocation:y?.name||"",subLocationName:y?.name||"",manufacturer:n.querySelector("#pe-asset-manufacturer")?.value.trim(),model:n.querySelector("#pe-asset-model")?.value.trim(),serialNumber:n.querySelector("#pe-asset-serial")?.value.trim(),status:n.querySelector("#pe-asset-status")?.value,responsible:n.querySelector("#pe-asset-responsible")?.value.trim(),installationDate:n.querySelector("#pe-asset-install")?.value||"",notes:n.querySelector("#pe-asset-notes")?.value.trim()};PeriodicEquipmentStore.upsertAsset(h),typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest&&await GoogleIntegration.sendRequest({action:"saveOrUpdatePeriodicEquipmentAsset",data:h}).catch(()=>{}),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0639\u062F\u0629":"\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0639\u062F\u0629"),d(),typeof PeriodicInspections<"u"&&await PeriodicInspections.refreshCurrentTabContent()}catch(r){Notification.error(r.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638")}})},async deleteAsset(e){if(this.isAdmin()&&confirm(`\u062D\u0630\u0641 \u0627\u0644\u0645\u0639\u062F\u0629 ${e.assetNumber||e.id}\u061F`))try{PeriodicEquipmentStore.deleteAsset(e.id),typeof GoogleIntegration<"u"&&await GoogleIntegration.sendRequest({action:"deletePeriodicEquipmentAsset",data:{assetId:e.id}}).catch(()=>{}),Notification.success("\u062A\u0645 \u0627\u0644\u062D\u0630\u0641"),typeof PeriodicInspections<"u"&&await PeriodicInspections.refreshCurrentTabContent()}catch(t){Notification.error(t.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641")}},async showTypeManagement(){if(!this.isAdmin()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629.");return}const e=PeriodicEquipmentStore.getAllTypes(),t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`
        ...
        `,document.body.appendChild(t);const i=()=>t.remove();t.querySelector(".modal-close")?.addEventListener("click",i),t.addEventListener("click",s=>{s.target===t&&i()});const a=(s=null)=>{const o=document.createElement("div");o.className="modal-overlay",o.style.zIndex="10001",o.innerHTML=`
                        ...
                        <div class="modal-body space-y-3">
                            ...
                            <div><label class="form-label">\u0642\u0627\u0644\u0628 \u0627\u0644\u0641\u062D\u0635 \u0627\u0644\u0645\u0631\u062A\u0628\u0637</label>
                                <select id="pe-type-template" class="form-input">
                                    ...
                                    ${Object.values(PeriodicInspections?.INSPECTION_TEMPLATES||{}).map(n=>`<option value="${Utils.escapeHTML(n.id)}" ${s?.linkedTemplateId===n.id?"selected":""}>${Utils.escapeHTML(n.name)}</option>`).join("")}
                                </select>
                            </div>
            ...
            `,document.body.appendChild(o);const l=()=>o.remove();o.querySelector("[data-close]")?.addEventListener("click",l),o.querySelector("#pe-type-form")?.addEventListener("submit",async n=>{n.preventDefault();try{const d=PeriodicEquipmentStore.upsertType({...s||{},name:o.querySelector("#pe-type-name")?.value.trim(),icon:o.querySelector("#pe-type-icon")?.value.trim(),linkedTemplateId:o.querySelector("#pe-type-template")?.value||"",description:o.querySelector("#pe-type-desc")?.value.trim()});typeof GoogleIntegration<"u"&&await GoogleIntegration.sendRequest({action:"savePeriodicEquipmentType",data:d}).catch(()=>{}),Notification.success("\u062A\u0645 \u0627\u0644\u062D\u0641\u0638"),l(),i(),await this.showTypeManagement()}catch(d){Notification.error(d.message)}})};t.querySelector("#pe-add-type-btn")?.addEventListener("click",()=>a()),t.querySelectorAll("[data-edit-type]").forEach(s=>{s.addEventListener("click",()=>{const o=s.getAttribute("data-edit-type");a(PeriodicEquipmentStore.getTypeById(o))})}),t.querySelectorAll("[data-del-type]").forEach(s=>{s.addEventListener("click",async()=>{const o=s.getAttribute("data-del-type");if(confirm("\u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0646\u0648\u0639\u061F"))try{PeriodicEquipmentStore.deleteType(o),await GoogleIntegration?.sendRequest?.({action:"deletePeriodicEquipmentType",data:{typeId:o}}).catch(()=>{}),Notification.success("\u062A\u0645 \u0627\u0644\u062D\u0630\u0641"),i(),await this.showTypeManagement()}catch(l){Notification.error(l.message)}})})},async showAssetDetails(e){const t=PeriodicEquipmentStore.listInspections(e.id),i=typeof QRCode<"u"?QRCode.generate(e.qrCodeData||e.id,180):null,a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
                    ...
                    <div class="content-card">
                        ...
                        <div class="card-body">
                            ${t.length?`<table class="data-table text-sm"><thead><tr><th>\u0627\u0644\u062A\u0627\u0631\u064A\u062E</th><th>\u0627\u0644\u0645\u0641\u062A\u0634</th><th>\u0627\u0644\u0646\u062A\u064A\u062C\u0629</th></tr></thead><tbody>
                                ${t.slice(0,10).map(o=>`<tr><td>${Utils.formatDate(o.inspectionDate)}</td><td>${Utils.escapeHTML(o.inspector||"-")}</td><td>${Utils.escapeHTML(o.result||"-")}</td></tr>`).join("")}
        ...
        `,document.body.appendChild(e);const t=e.querySelector("#pe-qr-video"),i=e.querySelector("#pe-qr-canvas"),a=i.getContext("2d"),s=()=>{this.stopQRScan(),e.remove()};e.querySelector("#pe-qr-close")?.addEventListener("click",s);const o=async l=>{const n=String(l||"").trim();if(!n)return;s();const d=PeriodicEquipmentStore.getAssetById(n);if(!d){Notification.error(`\u0644\u0645 \u064A\u064F\u0639\u062B\u0631 \u0639\u0644\u0649 \u0645\u0639\u062F\u0629: ${n}`);return}await this.showInspectionForm(d)};e.querySelector("#pe-manual-submit")?.addEventListener("click",()=>o(e.querySelector("#pe-manual-id")?.value));try{this._qrStream=await navigator.mediaDevices.getUserMedia({video:{facingMode:{ideal:"environment"}}}),t.srcObject=this._qrStream,t.addEventListener("loadedmetadata",()=>{i.width=t.videoWidth,i.height=t.videoHeight}),this._qrScanInterval=setInterval(()=>{if(t.readyState!==t.HAVE_ENOUGH_DATA||typeof jsQR>"u")return;a.drawImage(t,0,0,i.width,i.height);const l=jsQR(a.getImageData(0,0,i.width,i.height).data,i.width,i.height);l?.data&&o(l.data.trim())},200)}catch{Notification.warning("\u062A\u0639\u0630\u0631 \u0641\u062A\u062D \u0627\u0644\u0643\u0627\u0645\u064A\u0631\u0627 \u2014 \u0623\u062F\u062E\u0644 \u0627\u0644\u0631\u0642\u0645 \u064A\u062F\u0648\u064A\u0627\u064B")}},stopQRScan(){this._qrStream&&(this._qrStream.getTracks().forEach(e=>e.stop()),this._qrStream=null),this._qrScanInterval&&(clearInterval(this._qrScanInterval),this._qrScanInterval=null)},async loadDataFromBackend(e){if(typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return;this.ensureData();const t=AppState.appData.periodicEquipmentAssets?.length>0;if(!e&&t&&PeriodicInspections?._peDataLoadedOnce)return;const[i,a,s]=await Promise.allSettled([GoogleIntegration.sendRequest({action:"getAllPeriodicEquipmentTypes",data:{}}),GoogleIntegration.sendRequest({action:"getAllPeriodicEquipmentAssets",data:{}}),GoogleIntegration.sendRequest({action:"getAllPeriodicEquipmentInspections",data:{}})]),o=(l,n)=>{if(n.status!=="fulfilled"||!n.value?.success||!Array.isArray(n.value.data))return;const d=n.value.data;!d.length&&AppState.appData[l]?.length>0||(AppState.appData[l]=d)};o("periodicEquipmentTypes",i),o("periodicEquipmentAssets",a),o("periodicEquipmentInspections",s),PeriodicEquipmentStore.ensureInitialized(),typeof DataManager<"u"&&DataManager.save&&DataManager.save(),typeof PeriodicInspections<"u"&&(PeriodicInspections._peDataLoadedOnce=!0)}};typeof window<"u"&&(window.PeriodicEquipment=PeriodicEquipment);
