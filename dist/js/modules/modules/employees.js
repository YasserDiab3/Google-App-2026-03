const Employees={cache:{data:null,lastLoad:null,lastUpdate:null,isUpdating:!1},config:{cacheTimeout:9e5,backgroundUpdateInterval:6e5,backgroundUpdateTimer:null,_refreshedOnceForInactive:!1,listPageSize:100},activeTab:"employees-list",externalWorkforceYear:new Date().getFullYear(),_externalWorkforceLoaded:!1,_externalWorkforceLoadPromise:null,_externalWorkforceCache:new Map,_empAnalyticsCharts:{},_empAnalyticsDetailTab:"department",_empAnalyticsEventsBound:!1,_visibilityResumeBound:!1,_listRowsCache:null,_listVisibleCount:0,_listCanEdit:!1,_employeeStableKey_(e){const t=e&&(e.employeeNumber||e.id||e.sapId)||"";let a=String(t).trim().toLowerCase();return!a||(/^\d+(\.0+)?$/.test(a)&&(a=String(parseInt(a,10))),/^\d{4}-\d{2}-\d{2}/.test(a)||/^\d{1,2}\/\d{1,2}\/\d{2,4}/.test(a))?"":a},_employeeDisplayName_(e){return!e||typeof e!="object"?"":String(e.name||e.employeeName||e.fullName||"").replace(/\s+/g," ").trim()},_countNamedEmployees_(e){const t=Array.isArray(e)?e:[];let a=0;for(let i=0;i<t.length;i++)this._employeeDisplayName_(t[i])&&a++;return a},mergeEmployeesPreservingNames_(e,t){const a=Array.isArray(e)?e:[],i=Array.isArray(t)?t:[];if(a.length===0&&i.length>0)return i.slice();const o=new Map;for(let d=0;d<i.length;d++){const l=i[d],c=this._employeeStableKey_(l);c&&o.set(c,l)}const n=a.map(d=>{if(!d||typeof d!="object")return d;const l=this._employeeStableKey_(d),c=l?o.get(l):null,p=this._employeeDisplayName_(d);if(p)return String(d.name||"").trim()===p?d:Object.assign({},d,{name:p});if(c){const u=this._employeeDisplayName_(c);if(u)return Object.assign({},d,{name:u})}return d}),s=this._countNamedEmployees_(n);return this._countNamedEmployees_(i)>0&&s===0&&i.length>0?i.slice():n},applyEmployeesData_(e){const t=AppState.appData&&Array.isArray(AppState.appData.employees)?AppState.appData.employees:[],a=Array.isArray(e)?e.map(n=>this.sanitizeEmployeeRecordDrift_({...n||{}})):e,i=this.mergeEmployeesPreservingNames_(a,t);if((!i||i.length===0)&&t.length>0)return this.cache.data=t,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),t;const o=(i||[]).map(n=>this.sanitizeEmployeeRecordDrift_(n));return AppState.appData=AppState.appData||{},AppState.appData.employees=o,this.cache.data=o,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),o},_ensureVisibilityResumeBound_(){this._visibilityResumeBound||(this._visibilityResumeBound=!0,document.addEventListener("visibilitychange",()=>{try{if(document.hidden){const t=AppState.appData&&AppState.appData.employees||[];(!t.length||this._countNamedEmployees_(t)===0||!this.cache.lastLoad)&&!this.cache.isUpdating&&this.loadEmployeesFromBackend(!1);return}if(!(AppState.currentSection==="employees"||!!document.getElementById("employees-table-container")||!!document.getElementById("employees-section")))return;(async()=>{try{if((AppState.appData.employees||[]).length>0&&this.activeTab==="employees-list"){const t=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(t),this.renderStatsCards()}if(await this.ensureEmployeesLoaded(!1),this.activeTab==="employees-list"&&document.getElementById("employees-table-container")){const t=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(t)}this.renderStatsCards()}catch{}})()}catch{}}))},_getI18nCore(){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n:window.I18n&&typeof window.I18n.t=="function"?window.I18n:null},t(e,t){const a=this._getI18nCore();return a?a.t(e,null,t||e):t||e},applyModuleI18n(e){const t=this._getI18nCore();if(!t)return;const a=e||document.getElementById("employees-section")||document;typeof t.applyI18n=="function"&&t.applyI18n(a),typeof t.applyLiteralTranslations=="function"&&t.applyLiteralTranslations(a)},_photoFailKey(e){return`hse_emp_photo_failed_${String(e||"").trim()}`},_getDriveIdFromUrl(e){try{const t=String(e||"").trim();if(!t)return"";const a=t.match(/[?&]id=([^&]+)/)||t.match(/\/file\/d\/([^/]+)/);return a?String(a[1]||"").trim():""}catch{return""}},_normalizeEmployeePhotoUrl(e,t=""){try{const a=typeof Utils<"u"&&typeof Utils.extractImageSourceCandidate=="function"?String(Utils.extractImageSourceCandidate(e)||"").trim():String(e||"").trim();if(!a)return"";let i=a;typeof Utils<"u"&&typeof Utils.normalizeImageSource=="function"?i=Utils.normalizeImageSource(a)||a:typeof window<"u"&&typeof window.__convertGoogleDriveUrl=="function"&&(i=window.__convertGoogleDriveUrl(a)||a);const n=this._getDriveIdFromUrl(i)||t||i;return sessionStorage.getItem(this._photoFailKey(n))?"":i}catch{return""}},_setupEmployeePhotoFallbacks(e){try{const a=(e||document).querySelectorAll('img[data-emp-photo="1"]');if(!a||a.length===0)return;a.forEach(i=>{if(!i||i.dataset._fallbackBound==="1")return;i.dataset._fallbackBound="1";const o=(i.dataset.photoKey||"").trim();i.addEventListener("error",()=>{try{o&&sessionStorage.setItem(this._photoFailKey(o),Date.now().toString())}catch{}try{const n=i.parentElement;n&&(n.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}},{passive:!0})})}catch{}},canEditOrDelete(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},canAddOrImport(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},getEmployeesDetailedPermissionsState(){try{if(typeof Permissions<"u"&&typeof Permissions.getEffectivePermissions=="function"){const a=Permissions.getEffectivePermissions()?.employeesPermissions;if(a&&typeof a=="object"&&!Array.isArray(a))return a}}catch{}const e=AppState.currentUser?.permissions?.employeesPermissions;return e&&typeof e=="object"&&!Array.isArray(e)?e:null},canViewEmployeesRegistryTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["employees-list"]!==!1:!0},canViewExternalWorkforceTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["external-workforce"]===!0:!0},canViewEmployeesAnalysisTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["data-analysis"]!==!1:!0},canManageExternalWorkforceTab(){return this.canAddOrImport()},isValidDate(e){if(!e)return!1;try{const t=new Date(e);return t instanceof Date&&!isNaN(t.getTime())}catch{return!1}},normalizeDateOnly(e){if(e==null||e==="")return"";if(e instanceof Date&&!isNaN(e.getTime())){const n=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${n}-${s}-${r}`}if(typeof e=="number"&&isFinite(e))try{if(typeof XLSX<"u"&&XLSX?.SSF?.parse_date_code){const n=XLSX.SSF.parse_date_code(e);if(n&&n.y&&n.m&&n.d){const s=String(n.y).padStart(4,"0"),r=String(n.m).padStart(2,"0"),d=String(n.d).padStart(2,"0");return`${s}-${r}-${d}`}}}catch{}let t=String(e).trim();if(!t)return"";if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const n=JSON.parse(t);typeof n=="string"?t=n.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return""}const a=t.match(/^(\d{4}-\d{2}-\d{2})/);if(a)return a[1];const i=t.match(/^(\d{1,2})[\/\-](\d{1,2})[\/\-](\d{2,4})$/);if(i){const n=String(i[1]).padStart(2,"0"),s=String(i[2]).padStart(2,"0");return`${i[3].length===2?`20${i[3]}`:String(i[3]).padStart(4,"0")}-${s}-${n}`}const o=t.match(/^(\d{4})[\/\-](\d{1,2})[\/\-](\d{1,2})$/);if(o){const n=String(o[1]).padStart(4,"0"),s=String(o[2]).padStart(2,"0"),r=String(o[3]).padStart(2,"0");return`${n}-${s}-${r}`}try{const n=new Date(t);if(!isNaN(n.getTime())){const s=n.getFullYear(),r=String(n.getMonth()+1).padStart(2,"0"),d=String(n.getDate()).padStart(2,"0");return`${s}-${r}-${d}`}}catch{}return""},parseLocalDate(e){if(!e)return null;if(e instanceof Date&&!isNaN(e.getTime()))return e;let t=String(e).trim();if(!t)return null;if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const o=JSON.parse(t);typeof o=="string"?t=o.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return null}const a=t.match(/^(\d{4})-(\d{2})-(\d{2})/);if(a){const o=Number(a[1]),n=Number(a[2])-1,s=Number(a[3]),r=new Date(o,n,s);return isNaN(r.getTime())?null:r}const i=new Date(t);return isNaN(i.getTime())?null:i},formatDateSafe(e){return this.normalizeDateOnly(e)},calculateAge(e){if(!e)return"";try{const t=this.parseLocalDate(e);if(!t)return"";const a=new Date;let i=a.getFullYear()-t.getFullYear();const o=a.getMonth()-t.getMonth();return(o<0||o===0&&a.getDate()<t.getDate())&&i--,i>=0?i:""}catch{return""}},async load(){if(this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{typeof AppState<"u"&&AppState._languageRefresh||this.load()}),this._languageChangeListenerAdded=!0),typeof Utils>"u")return;if(typeof AppState>"u"){const t=document.getElementById("employees-section");t&&(t.innerHTML=`
            ...
            `,this.applyModuleI18n(e),setTimeout(async()=>{try{const a=document.getElementById("employees-content");if(!a)return;const i=await this.renderList().catch(o=>(Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629:",o),`
                        ...
                        `));if(a.innerHTML=i,this.applyModuleI18n(a),this.setupEventListeners(),this.activeTab==="data-analysis"&&this.canViewEmployeesAnalysisTab())await this.loadEmployeesAnalysis();else if(this.activeTab==="external-workforce"&&this.canViewExternalWorkforceTab())await this.ensureExternalWorkforceDataLoaded(),this.renderExternalWorkforceTable();else if(this.activeTab==="employees-list"&&this.canViewEmployeesRegistryTab()){const o=document.getElementById("employees-table-container"),n=Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0;n?await this.loadEmployeesList():o&&(o.innerHTML=`
                ...
                `,this.applyModuleI18n(e))}},_isRealResignationDateValue_(e,t){if(e==null||e==="")return!1;if(e instanceof Date&&!isNaN(e.getTime()))return!0;const a=String(e).trim();if(!a||a==="active"||a==="inactive"||a==="\u0646\u0634\u0637"||a==="\u063A\u064A\u0631 \u0646\u0634\u0637")return!1;const i=String(t&&(t.employeeNumber||t.id||t.sapId)||"").trim();if(i&&a===i||/^\d+(\.0+)?$/.test(a)&&a.length>=4&&a.length<=12)return!1;if(/^\d{4}-\d{2}-\d{2}/.test(a)||/^\d{1,2}\/\d{1,2}\/\d{2,4}/.test(a)||/^\d{1,2}-\d{1,2}-\d{2,4}/.test(a)||a.indexOf("T")>0&&!isNaN(new Date(a).getTime()))return!0;const o=new Date(a);return!isNaN(o.getTime())},sanitizeEmployeeRecordDrift_(e){if(!e||typeof e!="object")return e;const t=String(e.employeeNumber||"").trim(),a=String(e.status!=null?e.status:"").trim(),i=String(e.resignationDate!=null?e.resignationDate:"").trim(),o=String(e.id!=null?e.id:"").trim(),n=String(e.createdAt!=null?e.createdAt:"").trim(),s=String(e.photo!=null?e.photo:"").trim(),r=d=>d?!!(/^\d{4}-\d{2}-\d{2}/.test(d)||/^\d{1,2}\/\d{1,2}\/\d{2,4}/.test(d)||/^\d{1,2}-\d{1,2}-\d{2,4}/.test(d)||d.indexOf("T")>0&&!isNaN(new Date(d).getTime())):!1;return(s==="active"||s==="inactive")&&(e.photo=""),r(a),r(a)?((!e.createdAt||n==="active"||n==="inactive")&&(e.createdAt=a),e.status="active"):a&&a!=="active"&&a!=="inactive"&&a!=="\u0646\u0634\u0637"&&a!=="\u063A\u064A\u0631 \u0646\u0634\u0637"&&(e.status="active"),(n==="active"||n==="inactive")&&(r(o)?e.createdAt=o:r(a)?e.createdAt=a:e.createdAt=""),this._isRealResignationDateValue_(i,e)||(e.resignationDate=""),(t&&r(o)||!o&&t)&&(e.id=t),e},isEmployeeInactive(e){if(!e)return!1;const t=e.status!=null&&e.status!==""?String(e.status).trim():"",a=t.toLowerCase();if(a==="active"||t==="\u0646\u0634\u0637"||a==="true"||t==="1")return!1;const i=e.resignationDate!=null&&e.resignationDate!==""?String(e.resignationDate).trim():"";return!!(i&&this._isRealResignationDateValue_(i,e)||a==="inactive"||t==="\u063A\u064A\u0631 \u0646\u0634\u0637"||a==="false"||t==="0")},calculateStatistics(){const e=AppState.appData.employees||[];if(e.length===0)return{total:0,averageAge:0,genderStats:{male:0,female:0},averageExperience:0,inactiveCount:0};const t=e.filter(f=>!this.isEmployeeInactive(f)),a=t.length;let i=0,o=0;t.forEach(f=>{const y=this.calculateAge(f.birthDate);y&&y>0&&(i+=y,o++)});const n=o>0?Math.round(i/o):0;let s=0,r=0,d=0;const l=f=>{if(!f)return"";let y=String(f).trim().replace(/\s+/g," ").trim();return y=y.replace(/[\u200B-\u200D\uFEFF]/g,""),y},c=f=>{const y=l(f);if(!y)return{isMale:!1,isFemale:!1};const E=y.toLowerCase(),h=y.length===1?y.toUpperCase():"",m=["\u0630\u0643\u0631","male","m","M","\u0630\u0643\u0631 "," \u0630\u0643\u0631"],x=["\u0623\u0646\u062B\u0649","female","f","F","\u0623\u0646\u062B\u0649 "," \u0623\u0646\u062B\u0649"],w=y==="\u0630\u0643\u0631"||E==="male"||h==="M"||m.some(A=>l(A)===y),S=y==="\u0623\u0646\u062B\u0649"||E==="female"||h==="F"||x.some(A=>l(A)===y);return{isMale:w,isFemale:S,normalized:y}};t.forEach(f=>{const y=c(f.gender);y.isMale?s++:y.isFemale?r++:d++}),d>0&&typeof AppState<"u"&&AppState.debugMode&&typeof console<"u";let p=0,u=0;const g=new Date;t.forEach(f=>{if(f.hireDate)try{const y=this.parseLocalDate(f.hireDate);if(y){const E=g.getFullYear()-y.getFullYear(),h=g.getMonth()-y.getMonth(),m=g.getDate()-y.getDate();let x=E;(h<0||h===0&&m<0)&&x--,x>=0&&(p+=x,u++)}}catch{}});const v=u>0?(p/u).toFixed(1):0,b=e.filter(f=>this.isEmployeeInactive(f)).length;return{total:a,averageAge:n,genderStats:{male:s,female:r},averageExperience:parseFloat(v),inactiveCount:b}},ensureEmployeesStatsCardsStyles(){const e="employees-stats-cards-styles-v2";if(document.getElementById(e))return;document.getElementById("employees-stats-cards-styles")?.remove();const a=document.createElement("style");a.id=e,a.textContent=`
        ...
        `,d=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${e.year}`,o,r,!1,!0,{version:"1.0",source:"ExternalWorkforceMonthly",reportYear:e.year,releaseDate:n,revisionDate:n},n,n):`<!DOCTYPE html><html lang="${i.lang}" dir="${i.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${i.dir};padding:20px;">${r}</body></html>`,l=new Blob(["\uFEFF"+d],{type:"text/html;charset=utf-8"}),c=URL.createObjectURL(l),p=window.open(c,"_blank");if(!p){URL.revokeObjectURL(c),Notification.error("Unable to open print window");return}p.onload=()=>{setTimeout(()=>{p.print(),setTimeout(()=>URL.revokeObjectURL(c),1e3)},400)}},async importExternalWorkforceExcelFile(e){if(!(!e||!this.canManageExternalWorkforceTab())){if(typeof XLSX>"u"){Notification.error("XLSX library is not available");return}Loading.show();try{const t=await e.arrayBuffer(),a=XLSX.read(t,{type:"array",cellDates:!0}),i=a.Sheets[a.SheetNames[0]],o=XLSX.utils.sheet_to_json(i,{header:1,defval:"",raw:!1});if(!Array.isArray(o)||o.length<2)throw new Error("File is empty");const n=o[0].map(b=>String(b||"").trim().toLowerCase()),s=this.getAvailableContractorsForExternalWorkforce(),r=Number(this.externalWorkforceYear),d={jan:0,january:0,feb:1,february:1,mar:2,march:2,apr:3,april:3,may:4,jun:5,june:5,jul:6,july:6,aug:7,august:7,sep:8,sept:8,september:8,oct:9,october:9,nov:10,november:10,dec:11,december:11,\u064A\u0646\u0627\u064A\u0631:0,\u0641\u0628\u0631\u0627\u064A\u0631:1,\u0645\u0627\u0631\u0633:2,\u0623\u0628\u0631\u064A\u0644:3,\u0627\u0628\u0631\u064A\u0644:3,\u0645\u0627\u064A\u0648:4,\u064A\u0648\u0646\u064A\u0648:5,\u064A\u0648\u0644\u064A\u0648:6,\u0623\u063A\u0633\u0637\u0633:7,\u0627\u063A\u0633\u0637\u0633:7,\u0633\u0628\u062A\u0645\u0628\u0631:8,\u0623\u0643\u062A\u0648\u0628\u0631:9,\u0627\u0643\u062A\u0648\u0628\u0631:9,\u0646\u0648\u0641\u0645\u0628\u0631:10,\u062F\u064A\u0633\u0645\u0628\u0631:11},l=this.getExternalWorkforceMonths().map(b=>b.key),c=n.findIndex(b=>b.includes("contractor")||b.includes("company")||b.includes("\u0627\u0644\u0634\u0631\u0643\u0629")||b.includes("\u0627\u0644\u0645\u0642\u0627\u0648\u0644")),p=n.findIndex(b=>b==="code"||b.includes("contractor code")||b.includes("\u0627\u0644\u0643\u0648\u062F")),u={};n.forEach((b,f)=>{const y=b.replace(/\./g,"").trim();d[y]!==void 0&&(u[l[d[y]]]=f)});const g=this.getExternalWorkforceRecords();let v=0;o.slice(1).forEach(b=>{const f=c>=0?String(b[c]||"").trim():"",y=p>=0?String(b[p]||"").trim():"";if(!f&&!y)return;const E=s.find(m=>y&&(m.contractorCode||"").trim().toLowerCase()===y.toLowerCase()||f&&m.contractorName.trim().toLowerCase()===f.toLowerCase());if(!E)return;let h=this.getExternalWorkforceRecord(r,E.stableKey);h||(h={id:`EWM-${r}-${E.stableKey}`,year:r,contractorId:E.contractorId||"",contractorCode:E.contractorCode||"",contractorName:E.contractorName||"",createdAt:new Date().toISOString()},g.push(h)),l.forEach(m=>{const x=u[m];x!==void 0&&(h[m]=Math.max(0,parseInt(b[x]||"0",10)||0))}),h.total=l.reduce((m,x)=>m+(parseInt(h[x]||"0",10)||0),0),h.updatedAt=new Date().toISOString(),h.updatedBy=AppState.currentUser?.name||AppState.currentUser?.email||"admin",v+=1}),this._externalWorkforceCache.clear(),this.renderExternalWorkforceTable(),typeof DataManager<"u"&&typeof DataManager.save=="function"&&DataManager.save(),typeof GoogleIntegration<"u"&&typeof GoogleIntegration.autoSave=="function"&&await GoogleIntegration.autoSave("ExternalWorkforceMonthly",g).catch(()=>{}),window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{externalWorkforce:!0,year:r}})),Notification.success(`Imported ${v} rows successfully`)}catch(t){Notification.error(`Failed to import file: ${t.message}`)}finally{Loading.hide()}}},renderExternalWorkforceTable(){const e=document.getElementById("external-workforce-table-container");if(!e)return;const t=this.buildExternalWorkforceModel(this.externalWorkforceYear),a=this.getExternalWorkforceViewState(),{dir:i,stickySide:o,textAlign:n,labels:s}=a;this.renderExternalWorkforceSummary(t);const r=this.canManageExternalWorkforceTab(),d=t.months.map(m=>`<th style="min-width: 74px;">${m.label}</th>`).join(""),l=t.rows.map((m,x)=>{const w=t.months.map((S,A)=>{const $=m.values[A]||0;return`<td style="background:#dceaf6;">${r?`<input type="number" min="0" step="1" class="form-input external-workforce-input" style="min-width:70px;text-align:center;padding:6px 8px;" value="${$}" data-row="${x}" data-contractor-key="${m.stableKey}" data-month="${S.key}" />`:`<span class="font-semibold text-slate-700">${$}</span>`}</td>`}).join("");return`
                <tr>
                    <td class="sticky-cell" style="background:#c7dcef; font-weight:700; text-align:${n};">
                        <div>${Utils.escapeHTML(m.contractorName)}</div>
                        <div class="text-xs text-gray-500 mt-1">${Utils.escapeHTML(m.contractorCode||m.contractorId||"\u0628\u062F\u0648\u0646 \u0643\u0648\u062F")}</div>
                    </td>
                    ${w}
                    <td style="background:#dceaf6; font-weight:800;">${m.total}</td>
                </tr>
            `}).join(""),c=t.monthTotals.map(m=>`<td style="background:#fff6cf; font-weight:800;">${m}</td>`).join(""),p=t.directEmployees.map(m=>`<td style="background:#eef2ff; font-weight:700;">${m}</td>`).join(""),u=t.combined.map(m=>`<td style="background:#ecfdf5; font-weight:800;">${m}</td>`).join(""),g=t.estimatedHours.map(m=>`<td style="background:#fff7ed; font-weight:700;">${m.toLocaleString("en-US")}</td>`).join("");e.innerHTML=`
            <style>
            ...
            <table class="external-workforce-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ${p}
                        <td style="background:#eef2ff; font-weight:900;">${t.directEmployees.reduce((m,x)=>m+x,0)}</td>
                    </tr>
                    <tr>
                        ...
                        ${u}
                        <td style="background:#ecfdf5; font-weight:900;">${t.combined.reduce((m,x)=>m+x,0)}</td>
                    </tr>
                    <tr>
        ...
        `).join("")},_empRenderAnalyticsBreadcrumb(e){const t=document.getElementById("emp-analytics-breadcrumb");if(!t)return;const a=[this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")];e.department&&a.push(e.department),e.job&&a.push(e.job),t.innerHTML=a.map((i,o)=>{const n=o===a.length-1;return`<span class="emp-analytics-crumb${n?" emp-analytics-crumb--active":""}">${Utils.escapeHTML(i)}</span>${n?"":'<span class="emp-analytics-crumb-sep">\u203A</span>'}`}).join("")},_empPopulateAnalyticsFilterOptions(e){const t=Array.isArray(e)?e:[],a=n=>[...new Set(t.map(s=>this._empAnalyticsLabel(s[n])).filter(Boolean))].sort((s,r)=>s.localeCompare(r,"ar")),i=(n,s,r)=>{const d=document.getElementById(n);if(!d)return;const l=r||d.value;d.innerHTML=`<option value="">${this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")}</option>`+s.map(c=>`<option value="${Utils.escapeHTML(c)}"${c===l?" selected":""}>${Utils.escapeHTML(c)}</option>`).join("")},o=this._empGetAnalyticsFiltersFromDom();i("emp-af-department",a("department"),o.department),i("emp-af-job",a("job"),o.job),i("emp-af-branch",a("branch"),o.branch),i("emp-af-location",a("location"),o.location),i("emp-af-position",a("position"),o.position)},_empRenderAnalyticsHeatmap(e){const t=document.getElementById("emp-analytics-heatmap");if(!t)return;const a=e.departmentJobMatrix||{},i=Object.entries(a).map(([l,c])=>{const[p,u]=l.split("|||");return{dept:p,job:u,count:c}}).sort((l,c)=>c.count-l.count);if(!i.length){t.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const o=[...new Set(i.slice(0,12).map(l=>l.dept))],n=[...new Set(i.slice(0,12).map(l=>l.job))],s=Math.max(...i.map(l=>l.count),1),r={};i.forEach(l=>{r[l.dept+"|||"+l.job]=l.count});let d='<table class="emp-analytics-heatmap-table"><thead><tr><th></th>';n.forEach(l=>{d+=`<th title="${Utils.escapeHTML(l)}">${Utils.escapeHTML(l.length>14?l.slice(0,14)+"\u2026":l)}</th>`}),d+="</tr></thead><tbody>",o.forEach(l=>{d+=`<tr><th title="${Utils.escapeHTML(l)}">${Utils.escapeHTML(l.length>16?l.slice(0,16)+"\u2026":l)}</th>`,n.forEach(c=>{const p=r[l+"|||"+c]||0,u=p>0?.15+p/s*.85:0,g=p>0?`rgba(29, 78, 216, ${u})`:"#f8fafc",v=u>.5?"#fff":"#334155";d+=`<td class="emp-analytics-heatmap-cell" data-dept="${Utils.escapeHTML(l)}" data-job="${Utils.escapeHTML(c)}" style="background:${g};color:${v};" title="${Utils.escapeHTML(l)} / ${Utils.escapeHTML(c)}: ${p}">${p||""}</td>`}),d+="</tr>"}),d+="</tbody></table>",t.innerHTML=d,t.querySelectorAll(".emp-analytics-heatmap-cell").forEach(l=>{l.addEventListener("click",()=>{const c=l.getAttribute("data-dept")||"",p=l.getAttribute("data-job")||"";!c&&!p||(this._empApplyAnalyticsFilter("department",c,{skipUpdate:!0}),this._empApplyAnalyticsFilter("job",p))})})},_empRenderAnalyticsDetailTable(e){const t=document.getElementById("emp-analytics-detail-table");if(!t)return;const a=this._empAnalyticsDetailTab||"department",i=a==="job"?e.byJob:e.byDepartment,o=a==="job"?this.t("module.employees.job","\u0627\u0644\u0648\u0638\u064A\u0641\u0629"):this.t("module.employees.department","\u0627\u0644\u0642\u0633\u0645"),n=a==="job"?"job":"department";if(!i.length){t.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const r=this._empGetAnalyticsFiltersFromDom()[n];t.innerHTML=`
            <table class="emp-analytics-detail-table">
                ...
                <tbody>
                    ${i.map(d=>`
                        <tr class="emp-analytics-detail-row${r===d.label?" emp-analytics-detail-row--selected":""}" data-filter-key="${n}" data-filter-value="${Utils.escapeHTML(d.label)}">
        ...
        `},_empBindChartClick(e,t,a){const i=this._empAnalyticsCharts[e];!i||!t?.length||(i.options.onClick=(o,n)=>{if(!n?.length)return;const s=n[0].index,r=t[s];r?.label&&this._empApplyAnalyticsFilter(a,r.label)},i.update("none"))},_empRenderAnalyticsCharts(e){const t=this._empChartPalette(),a=this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A"),i=(f,y)=>{const E=document.getElementById(f+"-empty"),h=document.getElementById(f);E&&(E.style.display=y?"none":"flex"),h&&(h.style.display=y?"block":"none")},o=e.byDepartment.slice(0,12);i("emp-chart-departments",o.length>0),o.length&&(this._empCreateAnalyticsChart("emp-chart-departments",{type:"bar",data:{labels:o.map(f=>f.label),datasets:[{data:o.map(f=>f.count),backgroundColor:f=>this._empMakeBarGradient(f.chart.ctx,f.chart.chartArea,"#1d4ed8","#6366f1"),borderRadius:8,borderSkipped:!1}]},options:{...this._empChartBaseOptions(),indexAxis:"y",plugins:{...this._empChartBaseOptions().plugins,legend:{display:!1}},scales:{x:{beginAtZero:!0,grid:{color:"#f1f5f9"}},y:{grid:{display:!1}}}}}),this._empBindChartClick("emp-chart-departments",o,"department"));const n=e.byJob.slice(0,12);i("emp-chart-jobs",n.length>0),n.length&&(this._empCreateAnalyticsChart("emp-chart-jobs",{type:"bar",data:{labels:n.map(f=>f.label),datasets:[{data:n.map(f=>f.count),backgroundColor:t.map((f,y)=>t[y%t.length]),borderRadius:8}]},options:{...this._empChartBaseOptions(),indexAxis:"y",plugins:{...this._empChartBaseOptions().plugins,legend:{display:!1}},scales:{x:{beginAtZero:!0},y:{grid:{display:!1}}}}}),this._empBindChartClick("emp-chart-jobs",n,"job"));const s=[e.male,e.female];i("emp-chart-gender",s.some(f=>f>0)),s.some(f=>f>0)&&this._empCreateAnalyticsChart("emp-chart-gender",{type:"doughnut",data:{labels:[this.t("module.employees.genderMale","\u0630\u0643\u0631"),this.t("module.employees.genderFemale","\u0623\u0646\u062B\u0649")],datasets:[{data:s,backgroundColor:["#3b82f6","#ec4899"],borderWidth:0}]},options:{...this._empChartBaseOptions(),cutout:"65%",plugins:{...this._empChartBaseOptions().plugins,legend:{position:"bottom"}}}});const r=[e.activeCount,e.inactiveCount];i("emp-chart-status",e.total>0),e.total>0&&this._empCreateAnalyticsChart("emp-chart-status",{type:"doughnut",data:{labels:[this.t("module.employees.analytics.active","\u0646\u0634\u0637"),this.t("module.employees.analytics.inactive","\u063A\u064A\u0631 \u0646\u0634\u0637")],datasets:[{data:r,backgroundColor:["#16a34a","#ef4444"],borderWidth:0}]},options:{...this._empChartBaseOptions(),cutout:"65%"}});const d=(f,y,E)=>{const h=y.slice(0,10);i(f,h.length>0),h.length&&(this._empCreateAnalyticsChart(f,{type:"bar",data:{labels:h.map(m=>m.label),datasets:[{data:h.map(m=>m.count),backgroundColor:t,borderRadius:6}]},options:{...this._empChartBaseOptions(),plugins:{...this._empChartBaseOptions().plugins,legend:{display:!1}},scales:{y:{beginAtZero:!0}}}}),E&&this._empBindChartClick(f,h,E))};d("emp-chart-branches",e.byBranch,"branch"),d("emp-chart-locations",e.byLocation,"location"),d("emp-chart-positions",e.byPosition,"position");const l=Object.keys(e.ageBuckets),c=l.map(f=>e.ageBuckets[f]);i("emp-chart-age",c.some(f=>f>0)),c.some(f=>f>0)&&this._empCreateAnalyticsChart("emp-chart-age",{type:"bar",data:{labels:l,datasets:[{data:c,backgroundColor:"#6366f1",borderRadius:8}]},options:{...this._empChartBaseOptions(),plugins:{...this._empChartBaseOptions().plugins,legend:{display:!1}}}});const p=Object.keys(e.tenureBuckets),u=p.map(f=>e.tenureBuckets[f]);i("emp-chart-tenure",u.some(f=>f>0)),u.some(f=>f>0)&&this._empCreateAnalyticsChart("emp-chart-tenure",{type:"bar",data:{labels:p,datasets:[{data:u,backgroundColor:"#0ea5e9",borderRadius:8}]},options:{...this._empChartBaseOptions(),plugins:{...this._empChartBaseOptions().plugins,legend:{display:!1}}}});const g=e.hireYears||[],v=g.map(f=>e.hireByYear[f]||0);i("emp-chart-hire",g.length>0),g.length&&this._empCreateAnalyticsChart("emp-chart-hire",{type:"line",data:{labels:g.map(String),datasets:[{data:v,borderColor:"#1d4ed8",backgroundColor:"rgba(29,78,216,0.12)",fill:!0,tension:.35,pointRadius:4,pointBackgroundColor:"#1d4ed8"}]},options:{...this._empChartBaseOptions(),plugins:{...this._empChartBaseOptions().plugins,legend:{display:!1}},scales:{y:{beginAtZero:!0}}}});const b=e.genderByDept||[];i("emp-chart-gender-dept",b.length>0),b.length&&(this._empCreateAnalyticsChart("emp-chart-gender-dept",{type:"bar",data:{labels:b.map(f=>f.label),datasets:[{label:this.t("module.employees.genderMale","\u0630\u0643\u0631"),data:b.map(f=>f.male),backgroundColor:"#3b82f6",borderRadius:4},{label:this.t("module.employees.genderFemale","\u0623\u0646\u062B\u0649"),data:b.map(f=>f.female),backgroundColor:"#ec4899",borderRadius:4}]},options:{...this._empChartBaseOptions(),scales:{x:{stacked:!0},y:{stacked:!0,beginAtZero:!0}}}}),this._empBindChartClick("emp-chart-gender-dept",b,"department"))},renderEmployeesAnalysisShellHTML(){const e=[{id:"emp-af-department",icon:"fa-building",label:this.t("module.employees.department","\u0627\u0644\u0642\u0633\u0645")},{id:"emp-af-job",icon:"fa-briefcase",label:this.t("module.employees.job","\u0627\u0644\u0648\u0638\u064A\u0641\u0629")},{id:"emp-af-branch",icon:"fa-sitemap",label:this.t("module.employees.branch","\u0627\u0644\u0641\u0631\u0639")},{id:"emp-af-location",icon:"fa-map-marker-alt",label:this.t("module.employees.location","\u0627\u0644\u0645\u0648\u0642\u0639")},{id:"emp-af-position",icon:"fa-user-tie",label:this.t("module.employees.position","\u0627\u0644\u0645\u0646\u0635\u0628")},{id:"emp-af-gender",icon:"fa-venus-mars",label:this.t("module.employees.gender","\u0627\u0644\u0646\u0648\u0639"),options:[{value:"",label:this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")},{value:"male",label:this.t("module.employees.genderMale","\u0630\u0643\u0631")},{value:"female",label:this.t("module.employees.genderFemale","\u0623\u0646\u062B\u0649")}]},{id:"emp-af-status",icon:"fa-toggle-on",label:"\u0627\u0644\u062D\u0627\u0644\u0629",options:[{value:"",label:this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")},{value:"active",label:this.t("module.employees.analytics.active","\u0646\u0634\u0637")},{value:"inactive",label:this.t("module.employees.analytics.inactive","\u063A\u064A\u0631 \u0646\u0634\u0637")}]}],t=(a,i,o)=>`
        ...
        `},async _waitWhileUpdating_(e=6e4){const t=Date.now();for(;this.cache.isUpdating&&Date.now()-t<e;)await new Promise(a=>setTimeout(a,50));this.cache.isUpdating&&(Utils.safeWarn("\u26A0\uFE0F \u062A\u062C\u0627\u0648\u0632 \u0627\u0646\u062A\u0638\u0627\u0631 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u2014 \u0641\u0643 \u0627\u0644\u0642\u0641\u0644"),this.cache.isUpdating=!1)},async _ensureEmployeesLoadedWithTimeout_(e=!1,t=9e4){const a=new Promise((i,o)=>{setTimeout(()=>o(new Error("EMPLOYEES_LOAD_TIMEOUT")),t)});return Promise.race([this.ensureEmployeesLoaded(e),a])},async ensureEmployeesLoaded(e=!1){if(this.cache.isUpdating&&!e&&(await this._waitWhileUpdating_(6e4),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0))return!0;const t=AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0,a=this.cache.data&&this.cache.lastLoad&&Date.now()-this.cache.lastLoad<this.config.cacheTimeout&&!e;return t&&a?(AppState.debugMode&&Utils.safeLog(`\u2705 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 Cache (${this.cache.data.length} \u0645\u0648\u0638\u0641)`),this.cache.data&&this.cache.data.length>0&&this.applyEmployeesData_(this.cache.data),!this.config._refreshedOnceForInactive&&AppState.appData.employees.length>0&&AppState.googleConfig?.appsScript?.enabled&&(AppState.appData.employees||[]).filter(o=>this.isEmployeeInactive(o)).length===0&&(this.config._refreshedOnceForInactive=!0,this.loadEmployeesFromBackend(!0).then(()=>{window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{}}))}).catch(()=>{})),!0):t&&!a&&!e?(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),this.updateEmployeesInBackground(),!0):await this.loadEmployeesFromBackend(e)},async loadEmployeesFromBackend(e=!1){if(this.cache.isUpdating&&!e&&(AppState.debugMode&&Utils.safeLog("\u26A0\uFE0F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630 \u0628\u0627\u0644\u0641\u0639\u0644\u060C \u0627\u0646\u062A\u0638\u0627\u0631..."),await this._waitWhileUpdating_(6e4),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0))return!0;this.cache.isUpdating=!0;try{if(!AppState.googleConfig?.appsScript?.enabled||!AppState.googleConfig?.appsScript?.scriptUrl)return AppState.debugMode&&Utils.safeLog("\u26A0\uFE0F Google Apps Script \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644 - \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629 \u0641\u0642\u0637"),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),!1;if(typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F GoogleIntegration \u063A\u064A\u0631 \u0645\u062A\u0627\u062D"),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),!1;try{const t={filters:{includeInactive:!0},__timeoutMs:12e4,...e?{skipCache:!0,forceRefresh:!0}:{}};e&&typeof GoogleIntegration._invalidateSmartCacheForRead_=="function"&&GoogleIntegration._invalidateSmartCacheForRead_("getAllEmployees",{filters:{includeInactive:!0},skipCache:!0,forceRefresh:!0});const a=await GoogleIntegration.sendRequest({action:"getAllEmployees",data:t});if(a&&a.success&&Array.isArray(a.data))return a.data.length===0&&(AppState.appData.employees||[]).length>0?(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),!0):(this.applyEmployeesData_(a.data),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${a.data.length} \u0645\u0648\u0638\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A`),!0);AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F getAllEmployees \u0641\u0634\u0644\u060C \u062C\u0627\u0631\u064A \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0628\u0640 readFromSheet...");const i={sheetName:"Employees",spreadsheetId:AppState.googleConfig.sheets.spreadsheetId,__timeoutMs:12e4,...e?{skipCache:!0,forceRefresh:!0}:{}};e&&typeof GoogleIntegration._invalidateSmartCacheForRead_=="function"&&GoogleIntegration._invalidateSmartCacheForRead_("readFromSheet",i);const o=await GoogleIntegration.sendRequest({action:"readFromSheet",data:i});if(o&&o.success&&Array.isArray(o.data))return o.data.length===0&&(AppState.appData.employees||[]).length>0?(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),!0):(this.applyEmployeesData_(o.data),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${o.data.length} \u0645\u0648\u0638\u0641 \u0645\u0646 Google Sheets`),!0)}catch(t){return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 Backend:",t),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),!1}return!1}catch(t){return AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A loadEmployeesFromBackend:",t),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),!1}finally{this.cache.isUpdating=!1}},async updateEmployeesInBackground(){if(!this.cache.isUpdating){this.cache.isUpdating=!0;try{if(!AppState.googleConfig?.appsScript?.enabled||!AppState.googleConfig?.appsScript?.scriptUrl||typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return;const e={filters:{includeInactive:!0},__timeoutMs:12e4},t=await GoogleIntegration.sendRequest({action:"getAllEmployees",data:e});if(t&&t.success&&Array.isArray(t.data)){if(t.data.length===0&&(AppState.appData.employees||[]).length>0)return;const a=this._countNamedEmployees_(AppState.appData.employees),i=this.applyEmployeesData_(t.data),o=this._countNamedEmployees_(i),n=(AppState.appData.employees||[]).length,s=t.data.length;(n!==s||o!==a||o>0)&&(typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u{1F504} \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629 (${i.length} \u0645\u0648\u0638\u0641\u060C \u0623\u0633\u0645\u0627\u0621: ${o})`),window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{count:i.length}})))}}catch(e){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",e)}finally{this.cache.isUpdating=!1}}},startBackgroundUpdate(){this.config.backgroundUpdateTimer&&clearInterval(this.config.backgroundUpdateTimer),this.config.backgroundUpdateTimer=setInterval(()=>{this.updateEmployeesInBackground()},this.config.backgroundUpdateInterval),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0628\u062F\u0621 \u0627\u0644\u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A \u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 (\u0643\u0644 ${this.config.backgroundUpdateInterval/6e4} \u062F\u0642\u064A\u0642\u0629)`)},stopBackgroundUpdate(){this.config.backgroundUpdateTimer&&(clearInterval(this.config.backgroundUpdateTimer),this.config.backgroundUpdateTimer=null)},cleanup(){try{AppState.debugMode&&Utils.safeLog("\u{1F9F9} \u062A\u0646\u0638\u064A\u0641 \u0645\u0648\u0627\u0631\u062F Employees module..."),this.stopBackgroundUpdate(),this.handleDataUpdate&&(window.removeEventListener("employeesDataUpdated",this.handleDataUpdate),this.handleDataUpdate=null),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062A\u0646\u0638\u064A\u0641 \u0645\u0648\u0627\u0631\u062F Employees module")}catch(e){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u0646\u0638\u064A\u0641 Employees module:",e)}},buildEmployeeTableRowElement_(e,t){const a=this.formatDateSafe(e.birthDate),i=this.formatDateSafe(e.hireDate),o=this.calculateAge(e.birthDate),n=this.isEmployeeInactive(e),s=document.createElement("tr");n&&(s.style.cssText="opacity: 0.7; background-color: #f8f9fa;");const d=(this._getDriveIdFromUrl(e.photo||"")||e.id||e.employeeNumber||e.name||"").toString(),l=this._normalizeEmployeePhotoUrl(e.photo,e.id),c=l&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(l):{canonical:l||"",displaySrc:l||"",needsProxy:!1,proxyFileId:""},p=c.canonical?c.displaySrc:"",u=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(c):"",g=this._employeeDisplayName_(e)||e.name||"",v=String(e.id||"").replace(/'/g,"\\'");return s.innerHTML=`
            ...
            <td style="min-width: 150px;">
                <div class="flex items-center gap-2 flex-wrap">
                    <button onclick="Employees.viewEmployee('${v}')" class="btn-icon btn-icon-info" title="${this.t("module.common.view","\u0639\u0631\u0636")}">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button onclick="Employees.editEmployee('${v}')" class="btn-icon btn-icon-primary" title="${this.t("module.common.edit","\u062A\u0639\u062F\u064A\u0644")}">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button onclick="Employees.deactivateEmployee('${v}')" class="btn-icon btn-icon-danger" title="${this.t("module.employees.deactivate","\u0625\u0644\u063A\u0627\u0621 \u062A\u0641\u0639\u064A\u0644")}">
            ...
            `}
        `,s},fillEmployeesTbodyPaged_(e,t,a,i){if(!e)return;const o=Array.isArray(t)?t:[],n=Math.max(40,parseInt(this.config.listPageSize,10)||100);if(i){this._listRowsCache=o,this._listVisibleCount=0,this._listCanEdit=!!a,e.innerHTML="";const p=document.getElementById("employees-load-more-wrap");p&&p.remove()}const s=this._listVisibleCount||0,r=Math.min(o.length,s+n),d=document.createDocumentFragment();for(let p=s;p<r;p++)d.appendChild(this.buildEmployeeTableRowElement_(o[p],this._listCanEdit));e.appendChild(d),this._listVisibleCount=r;let l=document.getElementById("employees-load-more-wrap");const c=e.closest(".table-wrapper")||e.parentElement?.parentElement;if(r<o.length){if(!l&&c&&c.parentElement&&(l=document.createElement("div"),l.id="employees-load-more-wrap",l.style.cssText="padding:12px;text-align:center;",c.parentElement.appendChild(l)),l){l.innerHTML=`
                    <button type="button" id="employees-load-more-btn" class="btn-secondary">
                        <i class="fas fa-chevron-down ml-2"></i>
                        \u0639\u0631\u0636 \u0627\u0644\u0645\u0632\u064A\u062F (${r} / ${o.length})
                    </button>`;const p=l.querySelector("#employees-load-more-btn");p&&p.addEventListener("click",()=>{this.fillEmployeesTbodyPaged_(e,this._listRowsCache||o,this._listCanEdit,!1);const u=document.getElementById("employees-table-container");u&&(this._setupEmployeePhotoFallbacks(u),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(u))})}}else l&&l.remove()},async loadEmployeesList(e=!1){const t=document.getElementById("employees-table-container");if(!t){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A loadEmployeesList");return}let a=(AppState.appData.employees||[]).map(c=>this.sanitizeEmployeeRecordDrift_({...c||{}}));if(AppState.appData.employees=a,AppState.debugMode&&Utils.safeLog(`\u{1F4CA} loadEmployeesList: \u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 = ${a.length}, showInactive = ${e}`),e)AppState.debugMode&&Utils.safeLog(`\u{1F4CA} \u0639\u0631\u0636 \u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646: ${a.length}`);else{const c=a.length,p=a.filter(u=>!this.isEmployeeInactive(u));p.length===0&&c>0?Utils.safeWarn(`\u26A0\uFE0F \u062A\u0635\u0641\u064A\u0629 \u0627\u0644\u0646\u0634\u0637\u064A\u0646 \u0623\u062E\u0641\u062A ${c} \u0645\u0648\u0638\u0641\u0627\u064B \u2014 \u0639\u0631\u0636 \u0627\u0644\u0643\u0644 \u0645\u0624\u0642\u062A\u0627\u064B \u0644\u062D\u0645\u0627\u064A\u0629 \u0627\u0644\u0648\u0627\u062C\u0647\u0629`):a=p,AppState.debugMode&&Utils.safeLog(`\u{1F4CA} \u0628\u0639\u062F \u0627\u0644\u062A\u0635\u0641\u064A\u0629 (\u0646\u0634\u0637\u064A\u0646): ${a.length} \u0645\u0646 ${c}`)}this.renderStatsCards(),this.updateInactiveCount();const i=this.canAddOrImport(),o=this.canEditOrDelete(),n=document.createDocumentFragment();if(a.length===0){const c=document.createElement("div");c.className="empty-state",c.innerHTML=`
                ...
                `:""}
            `,n.appendChild(c),t.innerHTML="",t.appendChild(n),requestAnimationFrame(()=>{const p=document.getElementById("add-employee-empty-btn");p&&this.canAddOrImport()&&p.addEventListener("click",()=>this.showForm())});return}const s=document.createElement("div");s.className="table-wrapper",s.style.cssText="width: 100%; max-width: 100%; overflow-x: auto;";const r=document.createElement("table");r.className="data-table table-header-blue",r.style.cssText="width: 100%; min-width: 100%; table-layout: auto;";const d=document.createElement("thead");d.innerHTML=`
            <tr>
        ...
        `;const l=document.createElement("tbody");r.appendChild(d),r.appendChild(l),s.appendChild(r),n.appendChild(s),t.innerHTML="",t.appendChild(n),this.fillEmployeesTbodyPaged_(l,a,o,!0),this.applyModuleI18n(t),typeof requestIdleCallback=="function"?requestIdleCallback(()=>{this._setupEmployeePhotoFallbacks(t),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(t,{onFetchFail:c=>{try{const p=(c.dataset.photoKey||"").trim();p&&sessionStorage.setItem(this._photoFailKey(p),Date.now().toString())}catch{}try{const p=c.parentElement;p&&(p.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}})},{timeout:600}):setTimeout(()=>{this._setupEmployeePhotoFallbacks(t),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(t,{onFetchFail:c=>{try{const p=(c.dataset.photoKey||"").trim();p&&sessionStorage.setItem(this._photoFailKey(p),Date.now().toString())}catch{}try{const p=c.parentElement;p&&(p.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}})},0),this.populateFilters(),requestAnimationFrame(async()=>{try{const c=this.getFilterValues();(c.search||c.department||c.branch||c.location||c.job||c.position||c.gender||c.showInactive)&&await this.applyFilters()}catch(c){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",c)}})},populateFilters(){const e=AppState.appData.employees||[],t=[...new Set(e.map(p=>p.department).filter(Boolean))].sort(),a=[...new Set(e.map(p=>p.branch).filter(Boolean))].sort(),i=[...new Set(e.map(p=>p.location).filter(Boolean))].sort(),o=[...new Set(e.map(p=>p.job||p.position).filter(Boolean))].sort(),n=[...new Set(e.map(p=>p.position||p.job).filter(Boolean))].sort(),s=document.getElementById("employee-filter-department");if(s){const p=s.value;s.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+t.map(u=>`<option value="${Utils.escapeHTML(u)}" ${u===p?"selected":""}>${Utils.escapeHTML(u)}</option>`).join("")}const r=document.getElementById("employee-filter-branch");if(r){const p=r.value;r.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+a.map(u=>`<option value="${Utils.escapeHTML(u)}" ${u===p?"selected":""}>${Utils.escapeHTML(u)}</option>`).join("")}const d=document.getElementById("employee-filter-location");if(d){const p=d.value;d.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+i.map(u=>`<option value="${Utils.escapeHTML(u)}" ${u===p?"selected":""}>${Utils.escapeHTML(u)}</option>`).join("")}const l=document.getElementById("employee-filter-job");if(l){const p=l.value;l.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+o.map(u=>`<option value="${Utils.escapeHTML(u)}" ${u===p?"selected":""}>${Utils.escapeHTML(u)}</option>`).join("")}const c=document.getElementById("employee-filter-position");if(c){const p=c.value;c.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+n.map(u=>`<option value="${Utils.escapeHTML(u)}" ${u===p?"selected":""}>${Utils.escapeHTML(u)}</option>`).join("")}},setupEventListeners(){setTimeout(()=>{window.removeEventListener("employeesDataUpdated",this.handleDataUpdate),this.handleDataUpdate=h=>{if(h.detail?.externalWorkforce){clearTimeout(this._employeesUpdateDebounceTimer),this._externalWorkforceCache.clear(),this._employeesUpdateDebounceTimer=setTimeout(()=>{document.getElementById("external-workforce-table-container")&&this.renderExternalWorkforceTable()},60);return}if(this.activeTab==="data-analysis"&&document.getElementById("emp-analytics-root")){clearTimeout(this._employeesUpdateDebounceTimer),this._employeesUpdateDebounceTimer=setTimeout(()=>{this.updateEmployeesAnalyticsDashboard().catch(()=>{})},120);return}h.detail&&h.detail.count&&(clearTimeout(this._employeesUpdateDebounceTimer),this._employeesUpdateDebounceTimer=setTimeout(()=>{document.getElementById("employees-table-container")?requestAnimationFrame(()=>setTimeout(()=>this.loadEmployeesList(),0)):this.renderStatsCards()},120))},window.addEventListener("employeesDataUpdated",this.handleDataUpdate),document.querySelectorAll("[data-employees-tab]").forEach(h=>{h.addEventListener("click",()=>this.switchTab(h.getAttribute("data-employees-tab")||"employees-list"))}),this.ensureExternalWorkforceToolbar();const e=document.getElementById("external-workforce-year");e&&e.addEventListener("change",async h=>{const m=Number(h.target.value);!Number.isFinite(m)||m<2e3||(this.externalWorkforceYear=m,await this.ensureExternalWorkforceDataLoaded(),this.renderExternalWorkforceTable())});const t=document.getElementById("external-workforce-table-container");if(t){const h=async m=>{const x=m.target;!x||!x.matches(".external-workforce-input")||await this.saveExternalWorkforceValue(x.getAttribute("data-contractor-key")||"",x.getAttribute("data-month")||"",x.value)};t.addEventListener("change",h),t.addEventListener("blur",h,!0)}document.getElementById("external-workforce-export-excel-btn")?.addEventListener("click",()=>{this.exportExternalWorkforceToExcel()}),document.getElementById("external-workforce-export-pdf-btn")?.addEventListener("click",()=>{this.exportExternalWorkforceToPDF()});const a=document.getElementById("external-workforce-import-excel-btn"),i=document.getElementById("external-workforce-import-input");a&&i&&(a.addEventListener("click",()=>i.click()),i.addEventListener("change",async h=>{const m=h.target.files?.[0];m&&(await this.importExternalWorkforceExcelFile(m),h.target.value="")})),this.canViewExternalWorkforceTab()&&(this.populateExternalWorkforceYearSelector(),this.activeTab==="external-workforce"&&this.ensureExternalWorkforceDataLoaded().then(()=>this.renderExternalWorkforceTable()).catch(()=>{}));const o=document.getElementById("add-employee-btn"),n=document.getElementById("add-employee-empty-btn"),s=document.getElementById("import-employees-excel-btn"),r=document.getElementById("refresh-employees-btn"),d=document.getElementById("refresh-employee-names-btn"),l=document.getElementById("delete-all-employees-btn");if(AppState.debugMode&&Utils.safeLog("\u{1F50D} \u0641\u062D\u0635 \u0627\u0644\u0623\u0632\u0631\u0627\u0631:",{refreshBtn:!!r,refreshNamesBtn:!!d,deleteAllBtn:!!l,searchInput:!!document.getElementById("employees-search"),filterSearchInput:!!document.getElementById("employees-search-filter")}),o&&this.canAddOrImport()&&o.addEventListener("click",()=>this.showForm()),n&&this.canAddOrImport()&&n.addEventListener("click",()=>this.showForm()),s&&this.canAddOrImport()&&s.addEventListener("click",()=>this.showImportExcel()),r){const h=r.cloneNode(!0);r.parentNode.replaceChild(h,r),h.addEventListener("click",async()=>{h.disabled=!0;const m=h.innerHTML;h.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u062F\u064A\u062B...',typeof Loading<"u"&&Loading.show();try{if(await this.loadEmployeesFromBackend(!0)){const w=document.getElementById("show-inactive-employees")?.checked||!1;await this.loadEmployeesList(w),await this.applyFilters(),typeof Notification<"u"&&Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}else typeof Notification<"u"&&Notification.warning("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u062C\u062F\u064A\u062F\u0629")}catch(x){typeof Notification<"u"&&Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+x.message),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",x)}finally{typeof Loading<"u"&&Loading.hide(),h.disabled=!1,h.innerHTML=m}})}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0632\u0631 \u0627\u0644\u062A\u062D\u062F\u064A\u062B \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");d&&this.canAddOrImport()&&d.addEventListener("click",async()=>this.refreshEmployeeNames());const c=document.getElementById("report-employee-duplicates-btn");c&&this.canAddOrImport()&&c.addEventListener("click",async()=>this.reportEmployeeDuplicates());const p=document.getElementById("cleanup-employee-duplicates-btn");p&&this.canAddOrImport()&&p.addEventListener("click",async()=>this.cleanupDuplicateEmployees()),l&&this.canAddOrImport()&&l.addEventListener("click",async()=>this.deleteAllEmployees());const u=document.getElementById("employees-search");if(u){const h=u.cloneNode(!0);u.parentNode.replaceChild(h,u);let m=null;const x=async()=>{try{const w=document.getElementById("employees-search-filter");w&&(w.value=h.value),await this.applyFilters()}catch(w){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0628\u062D\u062B:",w)}};h.addEventListener("input",w=>{m&&clearTimeout(m),m=setTimeout(x,300)}),h.addEventListener("keydown",async w=>{w.key==="Enter"&&(w.preventDefault(),m&&clearTimeout(m),await x())})}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062D\u0642\u0644 \u0627\u0644\u0628\u062D\u062B \u0641\u064A header \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");const g=document.getElementById("employees-search-filter");if(g){const h=g.cloneNode(!0);g.parentNode.replaceChild(h,g);let m=null;const x=async()=>{try{u&&(u.value=h.value),await this.applyFilters()}catch(w){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0628\u062D\u062B:",w)}};h.addEventListener("input",w=>{m&&clearTimeout(m),m=setTimeout(x,300)}),h.addEventListener("keydown",async w=>{w.key==="Enter"&&(w.preventDefault(),m&&clearTimeout(m),await x())})}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062D\u0642\u0644 \u0627\u0644\u0628\u062D\u062B \u0641\u064A \u0627\u0644\u0641\u0644\u062A\u0631 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");["employee-filter-department","employee-filter-branch","employee-filter-location","employee-filter-job","employee-filter-position","employee-filter-gender"].forEach(h=>{const m=document.getElementById(h);m&&m.addEventListener("change",async()=>{try{await this.applyFilters()}catch(x){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0641\u0644\u062A\u0631:",x)}})});const b=document.getElementById("employee-reset-filters");if(b){const h=b.cloneNode(!0);b.parentNode.replaceChild(h,b),h.addEventListener("click",async()=>{try{await this.resetFilters()}catch(m){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0639\u0627\u062F\u0629 \u062A\u0639\u064A\u064A\u0646 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",m),typeof Notification<"u"&&Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0625\u0639\u0627\u062F\u0629 \u062A\u0639\u064A\u064A\u0646 \u0627\u0644\u0641\u0644\u0627\u062A\u0631")}})}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0632\u0631 \u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u062A\u0639\u064A\u064A\u0646 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");let f=document.getElementById("show-inactive-employees");if(f){const h=f.cloneNode(!0);f.parentNode.replaceChild(h,f),h.addEventListener("change",async m=>{const x=m.target.checked;AppState.debugMode&&Utils.safeLog(`\u{1F504} \u062A\u063A\u064A\u064A\u0631 \u062D\u0627\u0644\u0629 \u0639\u0631\u0636 \u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u064A\u0646: ${x?"\u0639\u0631\u0636":"\u0625\u062E\u0641\u0627\u0621"}`);try{typeof Loading<"u"&&Loading.show();const w=document.getElementById("show-inactive-employees-container");w&&(x?(w.style.background="linear-gradient(135deg, #fee2e2 0%, #fecaca 100%)",w.style.borderColor="#dc2626",w.style.boxShadow="0 4px 12px rgba(220, 38, 38, 0.2)"):(w.style.background="linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)",w.style.borderColor="#dee2e6",w.style.boxShadow="none")),await this.loadEmployeesList(x);const S=document.getElementById("show-inactive-employees");S&&S.checked!==x&&(S.checked=x),await this.applyFilters(),this.updateInactiveCount(),typeof Notification<"u"&&Notification.success(x?"\u062A\u0645 \u0639\u0631\u0636 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u063A\u064A\u0631 \u0627\u0644\u0646\u0634\u0637\u064A\u0646 (\u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u064A\u0646)":"\u062A\u0645 \u0625\u062E\u0641\u0627\u0621 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u063A\u064A\u0631 \u0627\u0644\u0646\u0634\u0637\u064A\u0646")}catch(w){h.checked=!x,AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629:",w),typeof Notification<"u"&&Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")}finally{typeof Loading<"u"&&Loading.hide(),this.updateInactiveCount()}}),this.updateInactiveCount(),setTimeout(()=>this.updateInactiveCount(),300)}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0632\u0631 \u0639\u0631\u0636 \u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u064A\u0646 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");window.addEventListener("employeesDataUpdated",()=>{this.updateInactiveCount(),setTimeout(()=>this.updateInactiveCount(),100)}),requestAnimationFrame(async()=>{try{const h=this.getFilterValues();(h.search||h.department||h.branch||h.location||h.job||h.position||h.gender||h.showInactive)&&await this.applyFilters()}catch(h){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",h)}});const y=document.getElementById("employee-form");y&&y.addEventListener("submit",h=>this.handleSubmit(h));const E=document.getElementById("cancel-employee-btn");E&&E.addEventListener("click",()=>this.showList()),this.setupPhotoPreview()},100)},async refreshEmployeeNames(){if(!this.canAddOrImport()){Notification?.error?.("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0646\u0641\u064A\u0630 \u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621");return}const e=document.getElementById("refresh-employee-names-btn"),t=e?.innerHTML;e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0623\u0633\u0645\u0627\u0621...'),typeof Loading<"u"&&Loading.show();try{await this.loadEmployeesFromBackend(!0);const a=Array.isArray(AppState.appData.employees)?AppState.appData.employees:[];if(a.length===0){Notification?.warning?.("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0648\u0638\u0641\u064A\u0646");return}let i=0;const o=a.map(s=>{const r=s?.name??"",d=String(r).replace(/\s+/g," ").trim();return d!==String(r)&&i++,{...s,name:d}});AppState.appData.employees=o,this.cache.data=o,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),await GoogleIntegration.autoSave("Employees",AppState.appData.employees);const n=document.getElementById("show-inactive-employees")?.checked||!1;this.renderStatsCards(),this.loadEmployeesList(n),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(s){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",s)}}),Notification?.success?.(i>0?`\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0623\u0633\u0645\u0627\u0621 (${i} \u062A\u0639\u062F\u064A\u0644\u0627\u062A)`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u062A\u063A\u064A\u064A\u0631\u0627\u062A \u0641\u064A \u0627\u0644\u0623\u0633\u0645\u0627\u0621")}catch(a){Notification?.error?.("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0623\u0633\u0645\u0627\u0621: "+(a?.message||a)),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0623\u0633\u0645\u0627\u0621 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",a)}finally{typeof Loading<"u"&&Loading.hide(),e&&(e.disabled=!1,e.innerHTML=t)}},async deleteAllEmployees(){if(!this.canAddOrImport()){Notification?.error?.("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0646\u0641\u064A\u0630 \u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621");return}if(!window.confirm("\u062A\u062D\u0630\u064A\u0631: \u0633\u064A\u062A\u0645 \u062D\u0630\u0641 \u062C\u0645\u064A\u0639 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646. \u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F\u061F"))return;const t=window.prompt("\u0623\u062F\u062E\u0644 \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0633\u0631\u064A \u0644\u0644\u062D\u0630\u0641:");if(t===null){Notification?.warning?.("\u062A\u0645 \u0625\u0644\u063A\u0627\u0621 \u0627\u0644\u0639\u0645\u0644\u064A\u0629");return}const a=document.getElementById("delete-all-employees-btn"),i=a?.innerHTML;a&&(a.disabled=!0,a.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0630\u0641...');try{if(typeof GoogleIntegration>"u"||!GoogleIntegration.callBackend)throw new Error("GoogleIntegration \u063A\u064A\u0631 \u0645\u062A\u0627\u062D");const o=await GoogleIntegration.callBackend("deleteAllEmployees",{pin:String(t||"").trim()});if(!o||!o.success)throw new Error(o?.message||"\u0641\u0634\u0644 \u062D\u0630\u0641 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A");AppState.appData.employees=[],this.cache.data=[],this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),this.renderStatsCards();const n=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(n),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(s){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",s)}}),Notification?.success?.(o?.message||"\u062A\u0645 \u062D\u0630\u0641 \u062C\u0645\u064A\u0639 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0628\u0646\u062C\u0627\u062D")}catch(o){Notification?.error?.("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+(o?.message||o))}finally{a&&(a.disabled=!1,a.innerHTML=i)}},async reportEmployeeDuplicates(){if(!this.canAddOrImport()){Notification?.error?.("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0646\u0641\u064A\u0630 \u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621");return}if(typeof GoogleIntegration>"u"||!GoogleIntegration.callBackend){Notification?.error?.("GoogleIntegration \u063A\u064A\u0631 \u0645\u062A\u0627\u062D");return}const e=document.getElementById("report-employee-duplicates-btn"),t=e?.innerHTML;e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u0641\u062D\u0635...');try{Loading?.show?.("\u062C\u0627\u0631\u064A \u0641\u062D\u0635 \u0645\u0643\u0631\u0631\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646...");const a=await GoogleIntegration.callBackend("reportEmployeeDuplicates",{sampleLimit:30,__timeoutMs:12e4});if(Loading?.hide?.(),!a||!a.success)throw new Error(a?.message||"\u0641\u0634\u0644 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A");const i=[a.message||"","",`\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0635\u0641\u0648\u0641: ${a.totalRows??"\u2014"}`,`\u0645\u0641\u0627\u062A\u064A\u062D \u0641\u0631\u064A\u062F\u0629: ${a.uniqueKeys??"\u2014"}`,`\u0645\u062C\u0645\u0648\u0639\u0627\u062A \u0645\u0643\u0631\u0631\u0629: ${a.duplicateGroupCount??0}`,`\u0635\u0641\u0648\u0641 \u0632\u0627\u0626\u062F\u0629 \u0645\u0631\u0634\u062D\u0629 \u0644\u0644\u062D\u0630\u0641: ${a.rowsToDeleteCount??0}`,`\u0633\u064A\u062A\u0628\u0642\u0649 \u0628\u0639\u062F \u0627\u0644\u062A\u0646\u0638\u064A\u0641: ${a.keepCount??"\u2014"}`,`\u0635\u0641\u0648\u0641 \u0645\u0646\u0632\u0627\u062D\u0629 \u0623\u0639\u0645\u062F\u0629: ${a.driftedCount??0}`,`\u0635\u0641\u0648\u0641 \u064A\u062A\u064A\u0645\u0629 \u0628\u0644\u0627 \u0645\u0641\u062A\u0627\u062D: ${a.orphanCount??0}`],o=Array.isArray(a.duplicateGroupsSample)?a.duplicateGroupsSample.slice(0,8):[];o.length&&(i.push("","\u0639\u064A\u0651\u0646\u0629 \u0645\u062C\u0645\u0648\u0639\u0627\u062A:"),o.forEach(n=>{i.push(`- ${n.key} \xD7${n.count} (\u064A\u064F\u0628\u0642\u0649 \u0635\u0641 ${n.keepSheetRow}: ${n.keepName||"\u2014"})`)})),window.alert(i.join(`
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629 \u0644\u0637\u0644\u0628 \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0633\u0631\u064A\u061F`)){Notification?.warning?.("\u062A\u0645 \u0625\u0644\u063A\u0627\u0621 \u0627\u0644\u062A\u0646\u0638\u064A\u0641");return}const n=window.prompt("\u0623\u062F\u062E\u0644 \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0633\u0631\u064A \u0644\u062A\u0646\u0638\u064A\u0641 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A (EMPLOYEES_DELETE_PIN):");if(n===null){Notification?.warning?.("\u062A\u0645 \u0625\u0644\u063A\u0627\u0621 \u0627\u0644\u0639\u0645\u0644\u064A\u0629");return}e&&(e.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062A\u0646\u0638\u064A\u0641...'),Loading?.show?.("\u062C\u0627\u0631\u064A \u062A\u0646\u0638\u064A\u0641 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A \u0645\u0639 \u0646\u0633\u062E\u0629 \u0627\u062D\u062A\u064A\u0627\u0637\u064A\u0629...");const s=await GoogleIntegration.callBackend("cleanupDuplicateEmployees",{pin:String(n||"").trim(),execute:!0,__timeoutMs:18e4});if(Loading?.hide?.(),!s||!s.success)throw new Error(s?.message||"\u0641\u0634\u0644 \u062A\u0646\u0638\u064A\u0641 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A");window.alert(`${s.message||"\u062A\u0645 \u0627\u0644\u062A\u0646\u0638\u064A\u0641"}
\u0645\u062D\u0630\u0648\u0641: ${s.deletedCount??0}
\u0627\u062D\u062A\u064A\u0627\u0637\u064A: ${s.backupSheetName||"\u2014"}`);try{await this.ensureEmployeesLoaded(!0)}catch{const d=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(d)}this.renderStatsCards(),requestAnimationFrame(()=>{try{this.applyFilters()}catch{}}),Notification?.success?.(s.message||"\u062A\u0645 \u062A\u0646\u0638\u064A\u0641 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A")}catch(a){Loading?.hide?.(),Notification?.error?.("\u0641\u0634\u0644 \u062A\u0646\u0638\u064A\u0641 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A: "+(a?.message||a))}finally{e&&(e.disabled=!1,e.innerHTML=t)}},setupPhotoPreview(){const e=document.getElementById("employee-photo-input"),t=document.getElementById("employee-photo-preview"),a=document.getElementById("employee-photo-icon");e&&t&&a&&e.addEventListener("change",i=>{const o=i.target.files[0];if(o){const n=new FileReader;n.onload=s=>{t.src=s.target.result,t.style.display="block",a.style.display="none"},n.readAsDataURL(o)}})},currentEditId:null,async showForm(e=null){if(!e&&!this.canAddOrImport()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0625\u0636\u0627\u0641\u0629 \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F");return}if(e&&!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}this.currentEditId=e?.id||null;const t=document.getElementById("employees-content");t&&(t.innerHTML=await this.renderForm(e),this.applyModuleI18n(t),this.setupEventListeners())},async renderForm(e=null){const t=!!e;return`
            <div class="content-card">
                <div class="card-header">
                    <h2 class="card-title">
        ...
        `},normalizeEmployeeImportKey(e){return e==null?"":String(e).trim().replace(/\s+/g,"")},buildEmployeeImportExistingKeySet(e){const t=new Set,a=Array.isArray(e)?e:AppState.appData.employees||[];for(let i=0;i<a.length;i++){const o=a[i];if(!o)continue;const n=this.normalizeEmployeeImportKey(o.employeeNumber||o.id),s=this.normalizeEmployeeImportKey(o.sapId),r=this.normalizeEmployeeImportKey(o.id);n&&t.add(n),s&&t.add(s),r&&t.add(r)}return t},employeeImportKeysMatchExisting(e,t,a){const i=this.normalizeEmployeeImportKey(e),o=this.normalizeEmployeeImportKey(t);return a instanceof Set?!!(i&&a.has(i)||o&&a.has(o)):!!this.findExistingEmployeeByImportKey(e,t)},findExistingEmployeeByImportKey(e,t){const a=this.normalizeEmployeeImportKey(e),i=this.normalizeEmployeeImportKey(t);return(AppState.appData.employees||[]).find(n=>{const s=this.normalizeEmployeeImportKey(n.employeeNumber||n.id),r=this.normalizeEmployeeImportKey(n.sapId),d=this.normalizeEmployeeImportKey(n.id);return!!(a&&(s===a||d===a||r===a)||i&&(r===i||s===i||d===i))})||null},parseEmployeeImportRow(e,t){const a=r=>r==null?"":String(r).trim(),i=a(e["\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638"]||e["\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641"]||e["Employee Name"]||e.Name||e.name||""),o=a(e["ID SAP"]||e["\u0631\u0642\u0645 SAP"]||e["SAP ID"]||e.sap_id||""),s=a(e["\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641"]||e["\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0648\u0638\u064A\u0641\u064A"]||e["Employee Number"]||e.employee_number||"")||o;return{uid:t,name:i,sapId:o,employeeNumber:s,hireDate:a(e["\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062A\u0639\u064A\u064A\u0646"]||e["Hire Date"]||e.hire_date||""),job:a(e.Job||e.job||e.\u0627\u0644\u0645\u0646\u0635\u0628||""),department:a(e.Department||e.department||e.\u0627\u0644\u0642\u0633\u0645||""),branch:a(e.Branch||e.branch||e.\u0627\u0644\u0631\u0639||e.\u0627\u0644\u0641\u0631\u0639||""),location:a(e.Location||e.location||e.\u0627\u0644\u0645\u0648\u0642\u0639||""),gender:a(e.Gender||e.gender||e.\u0627\u0644\u062C\u0646\u0633||""),nationalId:a(e["\u0631\u0642\u0645 \u0627\u0644\u0628\u0637\u0627\u0642\u0629 \u0627\u0644\u0642\u0648\u0645\u0649"]||e["\u0631\u0642\u0645 \u0627\u0644\u0628\u0637\u0627\u0642\u0629 \u0627\u0644\u0642\u0648\u0645\u064A"]||e["National ID"]||e.national_id||""),birthDate:a(e["\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0645\u064A\u0644\u0627\u062F"]||e["Date of Birth"]||e.birth_date||""),email:a(e.Email||e.email||e["\u0627\u0644\u0628\u0631\u064A\u062F \u0627\u0644\u0625\u0644\u0643\u062A\u0631\u0648\u0646\u064A"]||""),phone:a(e.Phone||e.phone||e.\u0627\u0644\u0647\u0627\u062A\u0641||e.\u0627\u0644\u0647\u0627\u062A||""),insuranceNumber:a(e["\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u062A\u0623\u0645\u064A\u0646\u064A"]||e["Insurance Number"]||e.insurance_number||e["\u0631\u0642\u0645 \u0627\u0644\u062A\u0623\u0645\u064A\u0646"]||""),status:"invalid"}},getEmployeeImportHireMonths(){const e=parseInt(AppState?.companySettings?.employeeImportHireMonths,10);return!isNaN(e)&&e>=1&&e<=120?e:3},getEmployeeImportHireWindowLabel(){const e=this.getEmployeeImportHireMonths();return e===1?"\u0622\u062E\u0631 \u0634\u0647\u0631 \u0648\u0627\u062D\u062F":`\u0622\u062E\u0631 ${e} \u0623\u0634\u0647\u0631`},isEmployeeImportHireDateAllowed(e){const t=this.normalizeDateOnly(e);if(!t)return!1;const a=new Date(`${t}T12:00:00`);if(Number.isNaN(a.getTime()))return!1;const i=new Date;i.setHours(12,0,0,0);const o=new Date(i);return o.setMonth(o.getMonth()-this.getEmployeeImportHireMonths()),a.getTime()>=o.getTime()&&a.getTime()<=i.getTime()},classifyEmployeeImportDraft(e,t,a){const i=this.normalizeEmployeeImportKey(e.employeeNumber),o=this.normalizeEmployeeImportKey(e.sapId),n=i||o;if(e._dupInFile=!1,e._hireDateRejected=!1,!n||!String(e.name||"").trim())return e.status="invalid",e;if(t){if(t.has(n))return e.status="invalid",e._dupInFile=!0,e;t.add(n)}return this.employeeImportKeysMatchExisting(e.employeeNumber,e.sapId,a)?(e.status="exists",e):this.isEmployeeImportHireDateAllowed(e.hireDate)?(e.status="new",e):(e.status="invalid",e._hireDateRejected=!0,e)},getEmployeeImportCounts(e){const t=Array.isArray(e)?e:[];return{total:t.length,newCount:t.filter(a=>a.status==="new").length,existsCount:t.filter(a=>a.status==="exists").length,invalidCount:t.filter(a=>a.status==="invalid").length,hireDateRejectedCount:t.filter(a=>a._hireDateRejected).length}},reclassifyAllEmployeeImportDrafts(e,t){const a=new Set,i=t instanceof Set?t:this.buildEmployeeImportExistingKeySet();return e.forEach(o=>{o._dupInFile=!1,this.classifyEmployeeImportDraft(o,a,i)}),e},async yieldEmployeeImportUi_(){await new Promise(e=>{typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>setTimeout(e,0)):setTimeout(e,0)})},buildEmployeeFromImportDraft(e){const t=this.normalizeEmployeeImportKey(e.employeeNumber)||this.normalizeEmployeeImportKey(e.sapId);if(!t||!String(e.name||"").trim()||!this.isEmployeeImportHireDateAllowed(e.hireDate))return null;const a=this.normalizeDateOnly(e.hireDate);if(!a)return null;const i=new Date().toISOString();return{id:t,name:String(e.name||"").trim(),employeeNumber:t,sapId:String(e.sapId||"").trim(),hireDate:a,job:String(e.job||"").trim(),position:String(e.job||"").trim(),department:String(e.department||"").trim(),branch:String(e.branch||"").trim(),location:String(e.location||"").trim(),gender:String(e.gender||"").trim(),nationalId:String(e.nationalId||"").trim(),birthDate:this.normalizeDateOnly(e.birthDate),email:String(e.email||"").trim(),phone:String(e.phone||"").trim(),insuranceNumber:String(e.insuranceNumber||"").trim(),photo:"",status:"active",createdAt:i,updatedAt:i}},renderEmployeeImportReview(e,t){const a=e.querySelector("#employee-import-summary"),i=e.querySelector("#employee-import-preview"),o=e.querySelector("#employee-import-new-body"),n=e.querySelector("#employee-import-confirm-btn");if(!a||!i||!o||!n)return;const s=this.getEmployeeImportCounts(t),r=t.filter(l=>l.status==="new"),d=this.getEmployeeImportHireWindowLabel();if(a.innerHTML=`
            <div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:8px;">
                ...
                <span style="background:#ffedd5;color:#9a3412;padding:4px 10px;border-radius:6px;font-size:12px;font-weight:600;">
                    \u062A\u0639\u064A\u064A\u0646 \u062E\u0627\u0631\u062C ${Utils.escapeHTML(d)} / \u063A\u064A\u0631 \u0645\u0642\u0628\u0648\u0644: ${s.hireDateRejectedCount}
                </span>
            ...
            <p style="font-size:12px;color:#1e3a8a;margin:0;">
                \u0627\u0644\u062C\u062F\u0648\u0644 \u064A\u0639\u0631\u0636 \u0641\u0642\u0637 \u0627\u0644\u062C\u062F\u062F \u063A\u064A\u0631 \u0627\u0644\u0645\u0648\u062C\u0648\u062F\u064A\u0646 \u0628\u0627\u0644\u0646\u0638\u0627\u0645 \u0648\u062A\u0627\u0631\u064A\u062E \u062A\u0639\u064A\u064A\u0646\u0647\u0645 \u062E\u0644\u0627\u0644 ${Utils.escapeHTML(d)}. \u0627\u0644\u0645\u0648\u062C\u0648\u062F\u0648\u0646 \u0648\u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u0648\u0646 \u0644\u0627 \u064A\u064F\u0639\u062F\u0651\u064E\u0644\u0648\u0646 \u0648\u0644\u0627 \u064A\u064F\u062D\u0630\u0641\u0648\u0646.
            </p>
        `,r.length===0)o.innerHTML=`
                <tr>
                    <td colspan="8" style="text-align:center;padding:16px;color:#64748b;">
                        \u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0648\u0638\u0641\u0648\u0646 \u062C\u062F\u062F \u0644\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0645\u0646 \u0647\u0630\u0627 \u0627\u0644\u0645\u0644\u0641.
                    </td>
                </tr>
            `;else{const c=r.slice(0,200),p=r.length-c.length;o.innerHTML=c.map(u=>`
                <tr data-import-uid="${Utils.escapeHTML(u.uid)}">
                    <td><input type="text" class="form-input emp-imp-field" data-field="employeeNumber" value="${Utils.escapeHTML(u.employeeNumber||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="sapId" value="${Utils.escapeHTML(u.sapId||"")}" style="min-width:80px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="name" value="${Utils.escapeHTML(u.name||"")}" style="min-width:120px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="department" value="${Utils.escapeHTML(u.department||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="job" value="${Utils.escapeHTML(u.job||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="branch" value="${Utils.escapeHTML(u.branch||"")}" style="min-width:80px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="hireDate" value="${Utils.escapeHTML(u.hireDate||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
            ...
            `).join("")+(p>0?`<tr><td colspan="8" style="text-align:center;padding:12px;color:#075985;background:#e0f2fe;font-size:12px;">
                    \u064A\u064F\u0639\u0631\u0636 \u0623\u0648\u0644 200 \u0635\u0641 \u0644\u0644\u0645\u0631\u0627\u062C\u0639\u0629. ${p} \u0635\u0641 \u0625\u0636\u0627\u0641\u064A \u0633\u064A\u064F\u0636\u0627\u0641 \u0623\u064A\u0636\u0627\u064B \u0639\u0646\u062F \u0627\u0644\u062A\u0623\u0643\u064A\u062F \u0628\u062F\u0648\u0646 \u0639\u0631\u0636.
        ...
        `,this.applyModuleI18n(a),document.body.appendChild(a);const i=a.querySelector("#employee-excel-file-input"),o=a.querySelector("#employee-import-confirm-btn"),n=a.querySelector("#employee-import-ready-hint");let s=[],r=this.buildEmployeeImportExistingKeySet(),d=null,l=r.size>0;const c=()=>this.renderEmployeeImportReview(a,s),p=(u,g)=>{n&&(g&&u?(n.hidden=!1,n.textContent=u):(n.hidden=!0,n.textContent=""))};l||p("\u062C\u0627\u0631\u064A \u062A\u062C\u0647\u064A\u0632 \u0641\u0647\u0631\u0633 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0627\u0644\u062D\u0627\u0644\u064A \u0628\u0627\u0644\u062E\u0644\u0641\u064A\u0629 \u0644\u0645\u0637\u0627\u0628\u0642\u0629 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A\u2026",!0),(async()=>{try{await this.ensureEmployeesLoaded(!1)}catch{}a.isConnected&&(r=this.buildEmployeeImportExistingKeySet(),l=!0,p("",!1),s.length>0&&(this.reclassifyAllEmployeeImportDrafts(s,r),c()))})(),i.addEventListener("change",async u=>{const g=u.target.files[0];if(g){Loading.show("\u062C\u0627\u0631\u064A \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641...");try{if(l)r=this.buildEmployeeImportExistingKeySet();else{Loading.show("\u062C\u0627\u0631\u064A \u062A\u062C\u0647\u064A\u0632 \u0641\u0647\u0631\u0633 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0644\u0644\u0645\u0637\u0627\u0628\u0642\u0629...");try{await this.ensureEmployeesLoaded(!1)}catch{}r=this.buildEmployeeImportExistingKeySet(),l=!0,p("",!1)}await this.yieldEmployeeImportUi_();const v=await g.arrayBuffer();Loading.show("\u062C\u0627\u0631\u064A \u062A\u062D\u0644\u064A\u0644 Excel..."),await this.yieldEmployeeImportUi_();const b=XLSX.read(v,{type:"array",cellDates:!0}),f=b.SheetNames[0],y=b.Sheets[f],E=XLSX.utils.sheet_to_json(y,{header:1,defval:"",raw:!1});if(E.length<2){Notification.error(this.t("module.employees.invalidFile","\u0627\u0644\u0645\u0644\u0641 \u0641\u0627\u0631\u063A \u0623\u0648 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D")),s=[],c(),Loading.hide();return}const h=E[0].map(A=>String(A||"").trim()),m=E.slice(1).map(A=>{const $={};return h.forEach((k,I)=>{const _=A[I];$[k]=_??""}),$}).filter(A=>h.some($=>String(A[$]||"").trim()!==""));r=this.buildEmployeeImportExistingKeySet();const x=new Set,w=Date.now();s=new Array(m.length);const S=400;for(let A=0;A<m.length;A+=S){const $=Math.min(A+S,m.length);Loading.show(`\u062C\u0627\u0631\u064A \u0645\u0637\u0627\u0628\u0642\u0629 \u0627\u0644\u0635\u0641\u0648\u0641... ${$} / ${m.length}`);for(let k=A;k<$;k++){const I=this.parseEmployeeImportRow(m[k],`imp-${k}-${w}`);s[k]=this.classifyEmployeeImportDraft(I,x,r)}await this.yieldEmployeeImportUi_()}Loading.show("\u062C\u0627\u0631\u064A \u062A\u062C\u0647\u064A\u0632 \u0634\u0627\u0634\u0629 \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629..."),await this.yieldEmployeeImportUi_(),c(),Loading.hide()}catch(v){Loading.hide(),Notification.error(this.t("module.employees.readFileFailed","\u0641\u0634\u0644 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641")+": "+v.message)}}}),a.addEventListener("change",u=>{const g=u.target.closest(".emp-imp-field");if(!g)return;const v=g.closest("tr[data-import-uid]");if(!v)return;const b=v.getAttribute("data-import-uid"),f=s.find(E=>E.uid===b);if(!f)return;const y=g.getAttribute("data-field");y&&(f[y]=g.value,d&&clearTimeout(d),d=setTimeout(()=>{this.reclassifyAllEmployeeImportDrafts(s,r),c()},180))}),a.addEventListener("click",u=>{const g=u.target.closest(".emp-imp-remove");if(g){const v=g.closest("tr[data-import-uid]");if(!v)return;const b=v.getAttribute("data-import-uid");s=s.filter(f=>f.uid!==b),this.reclassifyAllEmployeeImportDrafts(s,r),c();return}u.target===a&&a.remove()}),o.addEventListener("click",async()=>{const u=s.filter(f=>f.status==="new");if(u.length===0){Notification.warning("\u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0648\u0638\u0641\u0648\u0646 \u062C\u062F\u062F \u0644\u0644\u0625\u0636\u0627\u0641\u0629");return}const g=this.getEmployeeImportCounts(s),v=this.getEmployeeImportHireWindowLabel();if(window.confirm(`\u0633\u064A\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 ${u.length} \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F \u0641\u0642\u0637.
\u062A\u062E\u0637\u0651\u064A \u0645\u0648\u062C\u0648\u062F \u0645\u0633\u0628\u0642\u0627\u064B: ${g.existsCount}
\u0646\u0627\u0642\u0635/\u063A\u064A\u0631 \u0635\u0627\u0644\u062D: ${g.invalidCount}
\u062A\u0639\u064A\u064A\u0646 \u062E\u0627\u0631\u062C ${v}: ${g.hireDateRejectedCount}

\u0627\u0644\u0645\u0648\u062C\u0648\u062F\u0648\u0646 \u0648\u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u0648\u0646 \u0644\u0646 \u064A\u064F\u0639\u062F\u0651\u064E\u0644\u0648\u0627 \u0648\u0644\u0646 \u064A\u064F\u062D\u0630\u0641\u0648\u0627.
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629\u061F`)){Loading.show(`\u062C\u0627\u0631\u064A \u0625\u0636\u0627\u0641\u0629 ${u.length} \u0645\u0648\u0638\u0641...`);try{let f=0,y=0;const E=[],h=r instanceof Set?new Set(r):this.buildEmployeeImportExistingKeySet(),m=300;for(let w=0;w<u.length;w+=m){const S=Math.min(w+m,u.length);for(let A=w;A<S;A++){const $=u[A];try{if(this.employeeImportKeysMatchExisting($.employeeNumber,$.sapId,h)){y++;continue}const k=this.buildEmployeeFromImportDraft($);if(!k){y++;continue}if(this.employeeImportKeysMatchExisting(k.employeeNumber,k.sapId,h)){y++;continue}AppState.appData.employees.push(k),E.push(k);const I=this.normalizeEmployeeImportKey(k.employeeNumber),_=this.normalizeEmployeeImportKey(k.sapId),B=this.normalizeEmployeeImportKey(k.id);I&&h.add(I),_&&h.add(_),B&&h.add(B),f++}catch{y++}}Loading.show(`\u062C\u0627\u0631\u064A \u0627\u0644\u0625\u0636\u0627\u0641\u0629... ${S} / ${u.length}`),await this.yieldEmployeeImportUi_()}typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),r=h,Loading.hide(),Notification.success(`\u0623\u064F\u0636\u064A\u0641 ${f} \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F \u0645\u062D\u0644\u064A\u0627\u064B`+(g.existsCount>0?` \u2014 \u062A\u064F\u062E\u0637\u064A \u0645\u0648\u062C\u0648\u062F ${g.existsCount}`:"")+(g.hireDateRejectedCount>0?` \u2014 \u062A\u0639\u064A\u064A\u0646 \u062E\u0627\u0631\u062C ${this.getEmployeeImportHireWindowLabel()} ${g.hireDateRejectedCount}`:"")+(g.invalidCount>g.hireDateRejectedCount?` \u2014 \u0646\u0627\u0642\u0635 ${g.invalidCount-g.hireDateRejectedCount}`:"")+(y>0?` \u2014 \u0627\u0633\u062A\u064F\u0628\u0639\u062F \u0639\u0646\u062F \u0627\u0644\u062D\u0641\u0638 ${y}`:"")+(E.length>0?" \u2014 \u062C\u0627\u0631\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062C\u062F\u062F \u0645\u0639 \u0627\u0644\u0633\u062D\u0627\u0628\u0629 \u0628\u0627\u0644\u062E\u0644\u0641\u064A\u0629":"")),a.remove(),this.renderStatsCards();const x=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(x),requestAnimationFrame(()=>{this.applyFilters()}),E.length>0&&this.syncImportedEmployeesToCloud_(E)}catch(f){Loading.hide(),Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+f.message)}}})},async syncImportedEmployeesToCloud_(e){const t=Array.isArray(e)?e.filter(Boolean):[];if(!t.length||typeof GoogleIntegration>"u")return;if(typeof GoogleIntegration._isBackendRpcConfigured=="function"&&!GoogleIntegration._isBackendRpcConfigured()){Notification?.warning?.("\u062D\u064F\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B \u2014 \u0627\u0644\u062E\u0627\u062F\u0645 \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629");return}const a=s=>({id:s.id,name:s.name,employeeNumber:s.employeeNumber,sapId:s.sapId,hireDate:s.hireDate,job:s.job||s.position||"",position:s.position||s.job||"",department:s.department||"",branch:s.branch||"",location:s.location||"",gender:s.gender||"",nationalId:s.nationalId||"",birthDate:s.birthDate||"",email:s.email||"",phone:s.phone||"",insuranceNumber:s.insuranceNumber||"",photo:"",status:s.status||"active",resignationDate:s.resignationDate||"",createdAt:s.createdAt||new Date().toISOString(),updatedAt:s.updatedAt||new Date().toISOString()}),i=40;let o=0,n=0;for(let s=0;s<t.length;s+=i){const r=t.slice(s,s+i).map(a);try{const d=typeof GoogleIntegration.sendRequest=="function"?GoogleIntegration.sendRequest({action:"appendToSheet",data:{sheetName:"Employees",data:r,__timeoutMs:9e4,userData:AppState.currentUser||{}}}):GoogleIntegration.sendToAppsScript("appendToSheet",{sheetName:"Employees",data:r,__timeoutMs:9e4,userData:AppState.currentUser||{}}),l=typeof Utils<"u"&&Utils.promiseWithTimeout?await Utils.promiseWithTimeout(d,95e3,"\u0627\u0646\u062A\u0647\u062A \u0645\u0647\u0644\u0629 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646"):await d;l&&l.success?o+=r.length:(n+=r.length,Utils.safeWarn?.("\u26A0\uFE0F \u0641\u0634\u0644 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646:",l?.message))}catch(d){n+=r.length,Utils.safeWarn?.("\u26A0\uFE0F \u062E\u0637\u0623 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646:",d?.message||d)}await this.yieldEmployeeImportUi_()}o>0&&n===0?Notification?.success?.(`\u062A\u0645\u062A \u0645\u0632\u0627\u0645\u0646\u0629 ${o} \u0645\u0648\u0638\u0641\u0627\u064B \u062C\u062F\u064A\u062F\u0627\u064B \u0645\u0639 \u0627\u0644\u0633\u062D\u0627\u0628\u0629`):o>0&&n>0?Notification?.warning?.(`\u062A\u0645\u062A \u0645\u0632\u0627\u0645\u0646\u0629 ${o} \u2014 \u062A\u0639\u0630\u0651\u0631 ${n}. \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0641\u0648\u0638\u0629 \u0645\u062D\u0644\u064A\u0627\u064B.`):n>0&&Notification?.warning?.(`\u062D\u064F\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B \u2014 \u062A\u0639\u0630\u0651\u0631\u062A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0633\u062D\u0627\u0628\u0629 (${n}). \u0623\u0639\u062F \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0644\u0627\u062D\u0642\u0627\u064B \u0623\u0648 \u0645\u0646 \u0632\u0631 \u0627\u0644\u062A\u062D\u062F\u064A\u062B.`)},async handleSubmit(e){e.preventDefault();const t=e.target?.querySelector('button[type="submit"]')||document.querySelector('#employee-form button[type="submit"]');if(t&&t.disabled)return;let a="";t&&(a=t.innerHTML,t.disabled=!0,t.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const i=this.currentEditId?AppState.appData.employees.find(k=>k.id===this.currentEditId):null;let o=i?.photo||"";const n=document.getElementById("employee-photo-input");if(n&&n.files.length>0){const k=n.files[0];if(k.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 \u0647\u0648 2MB"),t&&(t.disabled=!1,t.innerHTML=a);return}o=await this.convertImageToBase64(k)}const s=document.getElementById("employee-name"),r=document.getElementById("employee-number"),d=document.getElementById("employee-sap-id"),l=document.getElementById("employee-hire-date"),c=document.getElementById("employee-birth-date"),p=document.getElementById("employee-department"),u=document.getElementById("employee-position"),g=document.getElementById("employee-branch"),v=document.getElementById("employee-location"),b=document.getElementById("employee-gender"),f=document.getElementById("employee-national-id"),y=document.getElementById("employee-email"),E=document.getElementById("employee-phone"),h=document.getElementById("employee-insurance-number");if(!s||!r||!d||!p||!u||!g||!v||!b||!y||!E){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649.");return}const m=!!this.currentEditId,x=m&&i?.hireDate||"",w=m&&i?.birthDate||"",S={id:r.value.trim()||this.currentEditId||Utils.generateId("EMP"),name:s.value.trim(),employeeNumber:r.value.trim(),sapId:d.value.trim(),hireDate:l?.value?this.normalizeDateOnly(l.value):m?this.normalizeDateOnly(x):this.normalizeDateOnly(new Date),birthDate:c?.value?this.normalizeDateOnly(c.value):m?this.normalizeDateOnly(w):"",department:p.value.trim(),job:u.value.trim(),position:u.value.trim(),branch:g.value.trim(),location:v.value.trim(),gender:b.value,nationalId:f?.value.trim()||"",email:y.value.trim(),phone:E.value.trim(),insuranceNumber:h?.value.trim()||"",photo:o,status:m&&i?.status||"active",resignationDate:m&&i?.resignationDate||"",createdAt:this.currentEditId?i?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};if(!S.name||!S.sapId||!S.employeeNumber||!S.department||!S.position){Notification.error("\u064A\u0631\u062C\u0649 \u0645\u0644\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 (\u0627\u0644\u0627\u0633\u0645\u060C \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0642\u0633\u0645\u060C \u0627\u0644\u0645\u0646\u0635\u0628)"),t&&(t.disabled=!1,t.innerHTML=a);return}const A=String(S.id||"").trim();if(!A){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D (\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u0646\u0634\u0627\u0621 id \u0641\u0627\u0631\u063A)"),t&&(t.disabled=!1,t.innerHTML=a);return}if(AppState.appData.employees.some(k=>{const I=String(k?.id||"").trim();return!I||this.currentEditId&&I===String(this.currentEditId).trim()?!1:I===A})){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u0645\u0633\u062A\u062E\u062F\u0645 \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0631\u0642\u0645 \u0622\u062E\u0631."),t&&(t.disabled=!1,t.innerHTML=a);return}Loading.show();try{if(this.currentEditId){const k=AppState.appData.employees.findIndex(I=>I.id===this.currentEditId);k!==-1&&(AppState.appData.employees[k]=S,this.currentEditId=A),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D")}else AppState.appData.employees.push(S),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D");typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("Employees",AppState.appData.employees),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),t&&(t.disabled=!1,t.innerHTML=a),this.renderStatsCards(),this.showList()}catch(k){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+k.message),t&&(t.disabled=!1,t.innerHTML=a)}},async convertImageToBase64(e){return new Promise((t,a)=>{const i=new FileReader;i.onload=()=>t(i.result),i.onerror=a,i.readAsDataURL(e)})},async showList(){this.currentEditId=null,!this.canViewEmployeesRegistryTab()&&this.canViewEmployeesAnalysisTab()?this.activeTab="data-analysis":!this.canViewEmployeesRegistryTab()&&this.canViewExternalWorkforceTab()?this.activeTab="external-workforce":!this.canViewExternalWorkforceTab()&&!this.canViewEmployeesAnalysisTab()&&(this.activeTab="employees-list");const e=document.getElementById("employees-content");e&&(e.innerHTML=await this.renderList(),this.applyModuleI18n(e),requestAnimationFrame(()=>{this.setupEventListeners(),this.canViewEmployeesRegistryTab()&&this.activeTab==="employees-list"?this.loadEmployeesList():this.activeTab==="data-analysis"&&this.canViewEmployeesAnalysisTab()?this.loadEmployeesAnalysis().catch(()=>{}):this.canViewExternalWorkforceTab()&&(this.populateExternalWorkforceYearSelector(),this.ensureExternalWorkforceDataLoaded().then(()=>this.renderExternalWorkforceTable()).catch(()=>{})),this.activeTab==="employees-list"&&this.scrollToSearchField()}))},async editEmployee(e){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const t=AppState.appData.employees.find(a=>a.id===e);t&&await this.showForm(t)},async printEmployee(e){const t=AppState.appData.employees.find(a=>a.id===e);if(!t){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}try{Loading.show();let a="";const i=this._normalizeEmployeePhotoUrl(t.photo,t.id);if(i&&typeof Utils.resolveDriveAwareImgDisplay=="function"){const y=Utils.resolveDriveAwareImgDisplay(i);if(y.needsProxy&&typeof Utils.fetchDriveImageDataUri=="function")try{a=await Utils.fetchDriveImageDataUri(y.proxyFileId)||""}catch{a=""}a||(a=y.canonical||i)}else i&&(a=i);const o=this.formatDateSafe(t.birthDate),n=this.formatDateSafe(t.hireDate),s=this.calculateAge(t.birthDate),r=y=>{if(!y)return"-";try{const E=new Date(y),h=E.getFullYear(),m=E.getMonth()+1,x=E.getDate(),w=["\u0660","\u0661","\u0662","\u0663","\u0664","\u0665","\u0666","\u0667","\u0668","\u0669"],S=A=>String(A).split("").map($=>w[parseInt($)]||$).join("");return`${S(h)}/${S(m)}/${S(x)}`}catch{return y}},d=new Date,l=r(d.toISOString().split("T")[0]),c=d.toLocaleTimeString("ar-SA",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}),p=AppState?.companySettings?.name||AppState?.appData?.companyName||"\u0627\u0644\u0634\u0631\u0643\u0629",u=`
                <style>
                ...
                <div class="employee-card">
                    <div class="card-header">
                        <div class="company-name">${Utils.escapeHTML(p)}</div>
                    ...
                    <div class="employee-details">
                        ...
                        <div class="detail-field">
                            ...
                            <div class="detail-value">${r(o)}</div>
                        </div>
                        <div class="detail-field">
                        ...
                        <div class="detail-field">
                            ...
                            <div class="detail-value">${r(n)}</div>
                        </div>
                        <div class="detail-field">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="print-date">\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0637\u0628\u0627\u0639\u0629: ${l} - ${c}</div>
                    </div>
                </div>
            `,g=`<!DOCTYPE html>
...
<body>
    ${u}
                ...
                <div class="modal-body">
                    <div class="space-y-4">
                        <div class="text-center mb-4">
                            ${(()=>{const s=this._normalizeEmployeePhotoUrl(t.photo,t.id);if(!s)return'<div class="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center mx-auto"><i class="fas fa-user text-5xl text-gray-400"></i></div>';const r=typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(s):{canonical:s,displaySrc:s,needsProxy:!1,proxyFileId:""},d=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(r):"";return`<img src="${Utils.escapeHTML(r.displaySrc)}" alt="${Utils.escapeHTML(t.name||"")}"${d} class="emp-detail-photo w-32 h-32 rounded-full object-cover mx-auto border-4 border-gray-200">`})()}
                        </div>
        ...
        `,this.applyModuleI18n(n),document.body.appendChild(n),typeof EmailDispatch<"u"&&EmailDispatch.bindFooterButtons(n,{moduleKey:"employees",record:t,recordId:t.id||t.employeeNumber||t.isoCode||""}),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(n,{onFetchFail:s=>{try{const r=document.createElement("div");r.className="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center mx-auto",r.innerHTML='<i class="fas fa-user text-5xl text-gray-400"></i>',s.replaceWith(r)}catch{}}}),n.addEventListener("click",s=>{s.target===n&&n.remove()})},async deactivateEmployee(e){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0625\u0644\u063A\u0627\u0621 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const t=AppState.appData.employees.find(a=>a.id===e);if(!t){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}if(confirm(`\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u0625\u0644\u063A\u0627\u0621 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641 "${t.name}"\u061F
...
\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: \u0647\u0630\u0647 \u0627\u0644\u0639\u0645\u0644\u064A\u0629 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647\u0627!`)){Loading.show();try{AppState.appData.employees=(AppState.appData.employees||[]).filter(a=>a.id!==e),setTimeout(()=>{typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},50),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D"),this.renderStatsCards();const t=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(t),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(a){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",a)}}),AppState.googleConfig?.appsScript?.enabled&&GoogleIntegration.sendToAppsScript("deleteEmployee",{employeeId:e}).then(a=>{!a||!a.success?Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 Google Sheets:",a?.message):Utils.safeLog("\u2705 \u062A\u0645 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}).catch(a=>Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062D\u0630\u0641 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",a))}catch(t){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}}},scrollToSearchField(){setTimeout(()=>{const e=document.getElementById("employees-search");if(e){const t=window.scrollY||document.documentElement.scrollTop,a=Math.max(0,(e.offsetTop||0)-20),i=t+window.innerHeight;(a<t||a>i-100)&&window.scrollTo({top:a,behavior:"smooth"})}},0)},getFilterValues(){return{search:document.getElementById("employees-search-filter")?.value||document.getElementById("employees-search")?.value||"",department:document.getElementById("employee-filter-department")?.value||"",branch:document.getElementById("employee-filter-branch")?.value||"",location:document.getElementById("employee-filter-location")?.value||"",job:document.getElementById("employee-filter-job")?.value||"",position:document.getElementById("employee-filter-position")?.value||"",gender:document.getElementById("employee-filter-gender")?.value||"",showInactive:document.getElementById("show-inactive-employees")?.checked||!1}},async filterEmployees(e="",t=!1,a=null){try{if(a)t=a.showInactive!==void 0&&a.showInactive!==null?a.showInactive:t;else{const l=this.getFilterValues();e=e||l.search,t=t??(l.showInactive||!1),a=l,a.showInactive=t}const i=document.getElementById("employees-table-container");if(!i){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}let o=i.querySelector("tbody");if(!o&&(await this.loadEmployeesList(t),o=i.querySelector("tbody"),!o)){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F tbody \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0628\u0639\u062F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629");return}let n=(AppState.appData.employees||[]).map(l=>this.sanitizeEmployeeRecordDrift_({...l||{}}));if(AppState.appData.employees=n,!t){const l=n.length,c=n.filter(p=>!this.isEmployeeInactive(p));c.length===0&&l>0?Utils.safeWarn("\u26A0\uFE0F filterEmployees: \u0627\u0644\u062A\u0635\u0641\u064A\u0629 \u0623\u062E\u0641\u062A \u0627\u0644\u062C\u0645\u064A\u0639 \u2014 \u0639\u0631\u0636 \u0627\u0644\u0643\u0644"):n=c}let s=n;const r=this.canEditOrDelete();if(e&&e.trim()){const l=e.trim().toLowerCase();s=s.filter(c=>c.name&&c.name.toLowerCase().includes(l)||c.employeeNumber&&String(c.employeeNumber).toLowerCase().includes(l)||c.sapId&&String(c.sapId).toLowerCase().includes(l)||c.department&&c.department.toLowerCase().includes(l)||c.position&&c.position.toLowerCase().includes(l)||c.job&&c.job.toLowerCase().includes(l)||c.branch&&c.branch.toLowerCase().includes(l)||c.location&&c.location.toLowerCase().includes(l)||c.nationalId&&c.nationalId.toLowerCase().includes(l)||c.phone&&c.phone.toLowerCase().includes(l)||c.insuranceNumber&&c.insuranceNumber.toLowerCase().includes(l)||c.email&&c.email.toLowerCase().includes(l)||c.gender&&c.gender.toLowerCase().includes(l))}a.department&&(s=s.filter(l=>String(l.department||"").trim()===String(a.department).trim())),a.branch&&(s=s.filter(l=>String(l.branch||"").trim()===String(a.branch).trim())),a.location&&(s=s.filter(l=>String(l.location||"").trim()===String(a.location).trim())),a.job&&(s=s.filter(l=>String(l.job||"").trim()===String(a.job).trim())),a.position&&(s=s.filter(l=>String(l.position||"").trim()===String(a.position).trim())),a.gender&&(s=s.filter(l=>String(l.gender||"").trim()===String(a.gender).trim()));const d=13;if(s.length===0){const l=document.createElement("tr");l.innerHTML=`<td colspan="${d}" class="text-center text-gray-500 py-8">\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C</td>`,o.innerHTML="",o.appendChild(l);const c=document.getElementById("employees-load-more-wrap");c&&c.remove(),this._listRowsCache=[],this._listVisibleCount=0}else{const l=document.createDocumentFragment();for(let p=0;p<s.length;p++)l.appendChild(this.buildEmployeeTableRowElement_(s[p],r));o.innerHTML="",o.appendChild(l),this._listRowsCache=s,this._listVisibleCount=s.length,this._listCanEdit=r;const c=document.getElementById("employees-load-more-wrap");c&&c.remove()}typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(o,{onFetchFail:l=>{try{const c=(l.dataset.photoKey||"").trim();c&&sessionStorage.setItem(this._photoFailKey(c),Date.now().toString())}catch{}try{const c=l.parentElement;c&&(c.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}}),this.updateFilterBadges(n,s,a),AppState.debugMode&&e&&Utils.safeLog(`\u{1F50D} \u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0628\u062D\u062B: ${s.length} \u0645\u0646 ${n.length} \u0645\u0648\u0638\u0641`)}catch(i){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A filterEmployees:",i)}},updateFilterBadges(e,t,a){try{if(!a){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F updateFilterBadges: filters \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}const i=(o,n,s)=>{try{const r=document.getElementById(o);if(!r){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: ${o} \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F`);return}const d=r.closest(".filter-field");if(!d){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-field \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const l=d.querySelector(".filter-label");if(!l){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-label \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const c=l.querySelector(".filter-count-badge");if(c&&c.remove(),n&&n.trim()!==""){const p=document.createElement("span");p.className="filter-count-badge",p.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",p.textContent=s;const u=l.querySelector("i");u?u.insertAdjacentElement("afterend",p):l.insertBefore(p,l.firstChild),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0639\u062F\u062F (${s}) \u0644\u0640 ${o}`)}}catch(r){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0641\u0644\u062A\u0631:",r)}};if(a.department?i("employee-filter-department",a.department,t.length):i("employee-filter-department","",0),a.branch?i("employee-filter-branch",a.branch,t.length):i("employee-filter-branch","",0),a.location?i("employee-filter-location",a.location,t.length):i("employee-filter-location","",0),a.job?i("employee-filter-job",a.job,t.length):i("employee-filter-job","",0),a.position?i("employee-filter-position",a.position,t.length):i("employee-filter-position","",0),a.gender?i("employee-filter-gender",a.gender,t.length):i("employee-filter-gender","",0),a.search&&a.search.trim())try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const n=o.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const r=s.querySelector(".filter-count-badge");r&&r.remove();const d=document.createElement("span");d.className="filter-count-badge",d.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",d.textContent=t.length;const l=s.querySelector("i");l?l.insertAdjacentElement("afterend",d):s.insertBefore(d,s.firstChild)}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}else try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const n=o.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const r=s.querySelector(".filter-count-badge");r&&r.remove()}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0625\u0632\u0627\u0644\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}}catch(i){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A updateFilterBadges:",i)}},async applyFilters(){try{const e=this.getFilterValues();await this.filterEmployees(e.search,e.showInactive,e),this.updateInactiveCount()}catch(e){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A applyFilters:",e)}finally{this.updateInactiveCount()}},async resetFilters(){const e=document.getElementById("employees-search"),t=document.getElementById("employees-search-filter");e&&(e.value=""),t&&(t.value=""),["employee-filter-department","employee-filter-branch","employee-filter-location","employee-filter-job","employee-filter-position","employee-filter-gender"].forEach(n=>{const s=document.getElementById(n);s&&(s.value="")});const i=document.getElementById("show-inactive-employees");i&&(i.checked=!1);const o=document.getElementById("show-inactive-employees-container");o&&(o.style.background="linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)",o.style.borderColor="#dee2e6",o.style.boxShadow="none"),await this.applyFilters(),this.updateInactiveCount()},updateInactiveCount(e=0){const i=()=>{try{const n=(AppState.appData.employees||[]).filter(r=>this.isEmployeeInactive(r)).length,s=document.getElementById("inactive-employees-count");if(s){s.textContent=n;const r=n===0,d=r?"#6b7280":"#dc2626",l=r?"0 2px 4px rgba(107, 114, 128, 0.3)":"0 2px 4px rgba(220, 38, 38, 0.3)";s.style.cssText=`
    ...
    `,d=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${e.year}`,o,r,!1,!0,{version:"1.0",releaseDate:n,revisionDate:n,includeQRCode:!0},n,n):`<!DOCTYPE html><html lang="${i.lang}" dir="${i.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${i.dir};padding:20px;">${r}</body></html>`,l=new Blob(["\uFEFF"+d],{type:"text/html;charset=utf-8"}),c=URL.createObjectURL(l),p=window.open(c,"_blank");if(!p){URL.revokeObjectURL(c),Notification.error("\u062A\u0639\u0630\u0631 \u0641\u062A\u062D \u0646\u0627\u0641\u0630\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629");return}p.onload=()=>{setTimeout(()=>{p.print(),setTimeout(()=>URL.revokeObjectURL(c),1e3)},400)}},(function(){"use strict";try{typeof window<"u"&&typeof Employees<"u"&&(window.Employees=Employees,typeof AppState<"u"&&AppState.debugMode&&typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u2705 Employees module loaded and available on window.Employees"),typeof AppState<"u"&&AppState.currentUser&&setTimeout(()=>{window.Employees&&window.Employees.init&&window.Employees.init().catch(e=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u0647\u064A\u0626\u0629 \u0645\u0648\u062F\u064A\u0648\u0644 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",e)})},2e3))}catch{if(typeof window<"u"&&typeof Employees<"u")try{window.Employees=Employees}catch{}}})();
