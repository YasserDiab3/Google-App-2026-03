const Employees={cache:{data:null,lastLoad:null,lastUpdate:null,isUpdating:!1},config:{cacheTimeout:3e5,backgroundUpdateInterval:6e5,backgroundUpdateTimer:null,_refreshedOnceForInactive:!1},activeTab:"employees-list",externalWorkforceYear:new Date().getFullYear(),_externalWorkforceLoaded:!1,_externalWorkforceLoadPromise:null,_externalWorkforceCache:new Map,_empAnalyticsCharts:{},_empAnalyticsDetailTab:"department",_empAnalyticsEventsBound:!1,_getI18nCore(){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n:window.I18n&&typeof window.I18n.t=="function"?window.I18n:null},t(t,e){const a=this._getI18nCore();return a?a.t(t,null,e||t):e||t},applyModuleI18n(t){const e=this._getI18nCore();if(!e)return;const a=t||document.getElementById("employees-section")||document;typeof e.applyI18n=="function"&&e.applyI18n(a),typeof e.applyLiteralTranslations=="function"&&e.applyLiteralTranslations(a)},_photoFailKey(t){return`hse_emp_photo_failed_${String(t||"").trim()}`},_getDriveIdFromUrl(t){try{const e=String(t||"").trim();if(!e)return"";const a=e.match(/[?&]id=([^&]+)/)||e.match(/\/file\/d\/([^/]+)/);return a?String(a[1]||"").trim():""}catch{return""}},_normalizeEmployeePhotoUrl(t,e=""){try{const a=typeof Utils<"u"&&typeof Utils.extractImageSourceCandidate=="function"?String(Utils.extractImageSourceCandidate(t)||"").trim():String(t||"").trim();if(!a)return"";let o=a;typeof Utils<"u"&&typeof Utils.normalizeImageSource=="function"?o=Utils.normalizeImageSource(a)||a:typeof window<"u"&&typeof window.__convertGoogleDriveUrl=="function"&&(o=window.__convertGoogleDriveUrl(a)||a);const n=this._getDriveIdFromUrl(o)||e||o;return sessionStorage.getItem(this._photoFailKey(n))?"":o}catch{return""}},_setupEmployeePhotoFallbacks(t){try{const a=(t||document).querySelectorAll('img[data-emp-photo="1"]');if(!a||a.length===0)return;a.forEach(o=>{if(!o||o.dataset._fallbackBound==="1")return;o.dataset._fallbackBound="1";const i=(o.dataset.photoKey||"").trim();o.addEventListener("error",()=>{try{i&&sessionStorage.setItem(this._photoFailKey(i),Date.now().toString())}catch{}try{const n=o.parentElement;n&&(n.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}},{passive:!0})})}catch{}},canEditOrDelete(){const t=AppState.currentUser;return t?(t.role||"").toLowerCase()==="admin":!1},canAddOrImport(){const t=AppState.currentUser;return t?(t.role||"").toLowerCase()==="admin":!1},getEmployeesDetailedPermissionsState(){try{if(typeof Permissions<"u"&&typeof Permissions.getEffectivePermissions=="function"){const a=Permissions.getEffectivePermissions()?.employeesPermissions;if(a&&typeof a=="object"&&!Array.isArray(a))return a}}catch{}const t=AppState.currentUser?.permissions?.employeesPermissions;return t&&typeof t=="object"&&!Array.isArray(t)?t:null},canViewEmployeesRegistryTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const t=this.getEmployeesDetailedPermissionsState();return t?t["employees-list"]!==!1:!0},canViewExternalWorkforceTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const t=this.getEmployeesDetailedPermissionsState();return t?t["external-workforce"]===!0:!0},canViewEmployeesAnalysisTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const t=this.getEmployeesDetailedPermissionsState();return t?t["data-analysis"]!==!1:!0},canManageExternalWorkforceTab(){return this.canAddOrImport()},isValidDate(t){if(!t)return!1;try{const e=new Date(t);return e instanceof Date&&!isNaN(e.getTime())}catch{return!1}},normalizeDateOnly(t){if(t==null||t==="")return"";if(t instanceof Date&&!isNaN(t.getTime())){const n=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),c=String(t.getDate()).padStart(2,"0");return`${n}-${s}-${c}`}if(typeof t=="number"&&isFinite(t))try{if(typeof XLSX<"u"&&XLSX?.SSF?.parse_date_code){const n=XLSX.SSF.parse_date_code(t);if(n&&n.y&&n.m&&n.d){const s=String(n.y).padStart(4,"0"),c=String(n.m).padStart(2,"0"),m=String(n.d).padStart(2,"0");return`${s}-${c}-${m}`}}}catch{}let e=String(t).trim();if(!e)return"";if(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'")){try{const n=JSON.parse(e);typeof n=="string"?e=n.trim():e=e.substring(1,e.length-1).trim()}catch{e=e.substring(1,e.length-1).trim()}if(!e)return""}const a=e.match(/^(\d{4}-\d{2}-\d{2})/);if(a)return a[1];const o=e.match(/^(\d{1,2})[\/\-](\d{1,2})[\/\-](\d{2,4})$/);if(o){const n=String(o[1]).padStart(2,"0"),s=String(o[2]).padStart(2,"0");return`${o[3].length===2?`20${o[3]}`:String(o[3]).padStart(4,"0")}-${s}-${n}`}const i=e.match(/^(\d{4})[\/\-](\d{1,2})[\/\-](\d{1,2})$/);if(i){const n=String(i[1]).padStart(4,"0"),s=String(i[2]).padStart(2,"0"),c=String(i[3]).padStart(2,"0");return`${n}-${s}-${c}`}try{const n=new Date(e);if(!isNaN(n.getTime())){const s=n.getFullYear(),c=String(n.getMonth()+1).padStart(2,"0"),m=String(n.getDate()).padStart(2,"0");return`${s}-${c}-${m}`}}catch{}return""},parseLocalDate(t){if(!t)return null;if(t instanceof Date&&!isNaN(t.getTime()))return t;let e=String(t).trim();if(!e)return null;if(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'")){try{const i=JSON.parse(e);typeof i=="string"?e=i.trim():e=e.substring(1,e.length-1).trim()}catch{e=e.substring(1,e.length-1).trim()}if(!e)return null}const a=e.match(/^(\d{4})-(\d{2})-(\d{2})/);if(a){const i=Number(a[1]),n=Number(a[2])-1,s=Number(a[3]),c=new Date(i,n,s);return isNaN(c.getTime())?null:c}const o=new Date(e);return isNaN(o.getTime())?null:o},formatDateSafe(t){return this.normalizeDateOnly(t)},calculateAge(t){if(!t)return"";try{const e=this.parseLocalDate(t);if(!e)return"";const a=new Date;let o=a.getFullYear()-e.getFullYear();const i=a.getMonth()-e.getMonth();return(i<0||i===0&&a.getDate()<e.getDate())&&o--,o>=0?o:""}catch{return""}},async load(){if(this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{this.load()}),this._languageChangeListenerAdded=!0),typeof Utils>"u")return;if(typeof AppState>"u"){const e=document.getElementById("employees-section");e&&(e.innerHTML=`
        ...
        `,s=c=>{const m=c.maleCount||0,l=c.femaleCount||0,r=m+l,d=r>0?Math.round(m/r*100):0,h=r>0?100-d:0;return`
        ...
        `).join("")},ensureExternalWorkforceToolbar(){const t=document.getElementById("employees-external-panel");if(!t)return;const e=t.querySelector(".card-header"),a=t.querySelector(".card-title"),o=t.querySelector(".card-header p"),i=t.querySelector('label[for="external-workforce-year"]'),n=t.querySelector(".rounded-full"),s=i?.parentElement,c=this.canManageExternalWorkforceTab(),m=this.getExternalWorkforceViewState().labels,l={description:this.getExternalWorkforceViewState().lang==="en"?"Monthly table linked to approved contractors and used automatically in Safety Performance Scorecard to calculate combined headcount and work hours.":"\u062C\u062F\u0648\u0644 \u0634\u0647\u0631\u064A \u0645\u0631\u062A\u0628\u0637 \u0628\u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646 \u0627\u0644\u0645\u0639\u062A\u0645\u062F\u064A\u0646 \u0648\u064A\u064F\u0633\u062A\u062E\u062F\u0645 \u062A\u0644\u0642\u0627\u0626\u064A\u064B\u0627 \u062F\u0627\u062E\u0644 Safety Performance Scorecard \u0644\u062D\u0633\u0627\u0628 \u0627\u0644\u0639\u062F\u062F \u0627\u0644\u0643\u0644\u064A \u0648\u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644.",year:this.getExternalWorkforceViewState().lang==="en"?"Year":"\u0627\u0644\u0633\u0646\u0629",admin:this.getExternalWorkforceViewState().lang==="en"?"Admin Edit":"\u062A\u062D\u0631\u064A\u0631 \u0625\u062F\u0627\u0631\u064A",viewOnly:this.getExternalWorkforceViewState().lang==="en"?"View Only":"\u0639\u0631\u0636 \u0641\u0642\u0637",exportExcel:this.getExternalWorkforceViewState().lang==="en"?"Export Excel":"\u062A\u0635\u062F\u064A\u0631 Excel",exportPdf:this.getExternalWorkforceViewState().lang==="en"?"Export PDF":"\u062A\u0635\u062F\u064A\u0631 PDF",importExcel:this.getExternalWorkforceViewState().lang==="en"?"Import Excel":"\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0643\u0633\u064A\u0644"};if(a&&(a.innerHTML=`<i class="fas fa-helmet-safety ml-2"></i>${m.externalTab}`),o&&(o.textContent=l.description),i&&(i.textContent=l.year),n&&(n.textContent=c?l.admin:l.viewOnly),!s)return;let r=document.getElementById("external-workforce-actions");r||(r=document.createElement("div"),r.id="external-workforce-actions",r.className="flex items-center gap-3 flex-wrap",r.innerHTML=`
                ...
                `:""}
            `,s.insertBefore(r,s.firstChild));const d=r.querySelector("#external-workforce-export-excel-btn span"),h=r.querySelector("#external-workforce-export-pdf-btn span"),v=r.querySelector("#external-workforce-import-excel-btn span");d&&(d.textContent=l.exportExcel),h&&(h.textContent=l.exportPdf),v&&(v.textContent=l.importExcel)},getExternalWorkforceExportRows(t=this.externalWorkforceYear){const e=this.buildExternalWorkforceModel(t),a=this.getExternalWorkforceViewState().labels,o=[a.contractor,"Code",...e.months.map(n=>n.label),a.total],i=e.rows.map(n=>[n.contractorName,n.contractorCode||n.contractorId||"",...n.values,n.total]);return i.push([a.externalTotal,"",...e.monthTotals,e.grandTotal]),i.push([a.directEmployees,"",...e.directEmployees,e.directEmployees.reduce((n,s)=>n+s,0)]),i.push([a.combinedTotal,"",...e.combined,e.combined.reduce((n,s)=>n+s,0)]),i.push([a.estimatedHours,"",...e.estimatedHours,e.estimatedHours.reduce((n,s)=>n+s,0)]),{model:e,header:o,rows:i}},exportExternalWorkforceToExcel(){if(typeof XLSX>"u"){Notification.error("XLSX library is not available");return}const{model:t,header:e,rows:a}=this.getExternalWorkforceExportRows(),o=XLSX.utils.book_new(),i=XLSX.utils.aoa_to_sheet([e,...a]);XLSX.utils.book_append_sheet(o,i,"External Workforce"),XLSX.writeFile(o,`external_workforce_${t.year}_${new Date().toISOString().slice(0,10)}.xlsx`)},exportExternalWorkforceToPDF(){const{model:t,header:e,rows:a}=this.getExternalWorkforceExportRows(),o=this.getExternalWorkforceViewState(),i=`${o.labels.externalTab} - ${t.year}`,n=new Date().toISOString(),s=[e,...a].map((h,v)=>`
            <tr>
        ...
        `,m=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${t.year}`,i,c,!1,!0,{version:"1.0",source:"ExternalWorkforceMonthly",reportYear:t.year,releaseDate:n,revisionDate:n},n,n):`<!DOCTYPE html><html lang="${o.lang}" dir="${o.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(i)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${o.dir};padding:20px;">${c}</body></html>`,l=new Blob(["\uFEFF"+m],{type:"text/html;charset=utf-8"}),r=URL.createObjectURL(l),d=window.open(r,"_blank");if(!d){URL.revokeObjectURL(r),Notification.error("Unable to open print window");return}d.onload=()=>{setTimeout(()=>{d.print(),setTimeout(()=>URL.revokeObjectURL(r),1e3)},400)}},async importExternalWorkforceExcelFile(t){if(!(!t||!this.canManageExternalWorkforceTab())){if(typeof XLSX>"u"){Notification.error("XLSX library is not available");return}Loading.show();try{const e=await t.arrayBuffer(),a=XLSX.read(e,{type:"array",cellDates:!0}),o=a.Sheets[a.SheetNames[0]],i=XLSX.utils.sheet_to_json(o,{header:1,defval:"",raw:!1});if(!Array.isArray(i)||i.length<2)throw new Error("File is empty");const n=i[0].map(b=>String(b||"").trim().toLowerCase()),s=this.getAvailableContractorsForExternalWorkforce(),c=Number(this.externalWorkforceYear),m={jan:0,january:0,feb:1,february:1,mar:2,march:2,apr:3,april:3,may:4,jun:5,june:5,jul:6,july:6,aug:7,august:7,sep:8,sept:8,september:8,oct:9,october:9,nov:10,november:10,dec:11,december:11,\u064A\u0646\u0627\u064A\u0631:0,\u0641\u0628\u0631\u0627\u064A\u0631:1,\u0645\u0627\u0631\u0633:2,\u0623\u0628\u0631\u064A\u0644:3,\u0627\u0628\u0631\u064A\u0644:3,\u0645\u0627\u064A\u0648:4,\u064A\u0648\u0646\u064A\u0648:5,\u064A\u0648\u0644\u064A\u0648:6,\u0623\u063A\u0633\u0637\u0633:7,\u0627\u063A\u0633\u0637\u0633:7,\u0633\u0628\u062A\u0645\u0628\u0631:8,\u0623\u0643\u062A\u0648\u0628\u0631:9,\u0627\u0643\u062A\u0648\u0628\u0631:9,\u0646\u0648\u0641\u0645\u0628\u0631:10,\u062F\u064A\u0633\u0645\u0628\u0631:11},l=this.getExternalWorkforceMonths().map(b=>b.key),r=n.findIndex(b=>b.includes("contractor")||b.includes("company")||b.includes("\u0627\u0644\u0634\u0631\u0643\u0629")||b.includes("\u0627\u0644\u0645\u0642\u0627\u0648\u0644")),d=n.findIndex(b=>b==="code"||b.includes("contractor code")||b.includes("\u0627\u0644\u0643\u0648\u062F")),h={};n.forEach((b,u)=>{const p=b.replace(/\./g,"").trim();m[p]!==void 0&&(h[l[m[p]]]=u)});const v=this.getExternalWorkforceRecords();let x=0;i.slice(1).forEach(b=>{const u=r>=0?String(b[r]||"").trim():"",p=d>=0?String(b[d]||"").trim():"";if(!u&&!p)return;const y=s.find(f=>p&&(f.contractorCode||"").trim().toLowerCase()===p.toLowerCase()||u&&f.contractorName.trim().toLowerCase()===u.toLowerCase());if(!y)return;let g=this.getExternalWorkforceRecord(c,y.stableKey);g||(g={id:`EWM-${c}-${y.stableKey}`,year:c,contractorId:y.contractorId||"",contractorCode:y.contractorCode||"",contractorName:y.contractorName||"",createdAt:new Date().toISOString()},v.push(g)),l.forEach(f=>{const w=h[f];w!==void 0&&(g[f]=Math.max(0,parseInt(b[w]||"0",10)||0))}),g.total=l.reduce((f,w)=>f+(parseInt(g[w]||"0",10)||0),0),g.updatedAt=new Date().toISOString(),g.updatedBy=AppState.currentUser?.name||AppState.currentUser?.email||"admin",x+=1}),this._externalWorkforceCache.clear(),this.renderExternalWorkforceTable(),typeof DataManager<"u"&&typeof DataManager.save=="function"&&DataManager.save(),typeof GoogleIntegration<"u"&&typeof GoogleIntegration.autoSave=="function"&&await GoogleIntegration.autoSave("ExternalWorkforceMonthly",v).catch(()=>{}),window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{externalWorkforce:!0,year:c}})),Notification.success(`Imported ${x} rows successfully`)}catch(e){Notification.error(`Failed to import file: ${e.message}`)}finally{Loading.hide()}}},renderExternalWorkforceTable(){const t=document.getElementById("external-workforce-table-container");if(!t)return;const e=this.buildExternalWorkforceModel(this.externalWorkforceYear),a=this.getExternalWorkforceViewState(),{dir:o,stickySide:i,textAlign:n,labels:s}=a;this.renderExternalWorkforceSummary(e);const c=this.canManageExternalWorkforceTab(),m=e.months.map(f=>`<th style="min-width: 74px;">${f.label}</th>`).join(""),l=e.rows.map((f,w)=>{const S=e.months.map((k,$)=>{const D=f.values[$]||0;return`<td style="background:#dceaf6;">${c?`<input type="number" min="0" step="1" class="form-input external-workforce-input" style="min-width:70px;text-align:center;padding:6px 8px;" value="${D}" data-row="${w}" data-contractor-key="${f.stableKey}" data-month="${k.key}" />`:`<span class="font-semibold text-slate-700">${D}</span>`}</td>`}).join("");return`
                <tr>
        ...
        `).join("")},_empRenderAnalyticsBreadcrumb(t){const e=document.getElementById("emp-analytics-breadcrumb");if(!e)return;const a=[this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")];t.department&&a.push(t.department),t.job&&a.push(t.job),e.innerHTML=a.map((o,i)=>{const n=i===a.length-1;return`<span class="emp-analytics-crumb${n?" emp-analytics-crumb--active":""}">${Utils.escapeHTML(o)}</span>${n?"":'<span class="emp-analytics-crumb-sep">\u203A</span>'}`}).join("")},_empPopulateAnalyticsFilterOptions(t){const e=Array.isArray(t)?t:[],a=n=>[...new Set(e.map(s=>this._empAnalyticsLabel(s[n])).filter(Boolean))].sort((s,c)=>s.localeCompare(c,"ar")),o=(n,s,c)=>{const m=document.getElementById(n);if(!m)return;const l=c||m.value;m.innerHTML=`<option value="">${this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")}</option>`+s.map(r=>`<option value="${Utils.escapeHTML(r)}"${r===l?" selected":""}>${Utils.escapeHTML(r)}</option>`).join("")},i=this._empGetAnalyticsFiltersFromDom();o("emp-af-department",a("department"),i.department),o("emp-af-job",a("job"),i.job),o("emp-af-branch",a("branch"),i.branch),o("emp-af-location",a("location"),i.location),o("emp-af-position",a("position"),i.position)},_empRenderAnalyticsHeatmap(t){const e=document.getElementById("emp-analytics-heatmap");if(!e)return;const a=t.departmentJobMatrix||{},o=Object.entries(a).map(([l,r])=>{const[d,h]=l.split("|||");return{dept:d,job:h,count:r}}).sort((l,r)=>r.count-l.count);if(!o.length){e.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const i=[...new Set(o.slice(0,12).map(l=>l.dept))],n=[...new Set(o.slice(0,12).map(l=>l.job))],s=Math.max(...o.map(l=>l.count),1),c={};o.forEach(l=>{c[l.dept+"|||"+l.job]=l.count});let m='<table class="emp-analytics-heatmap-table"><thead><tr><th></th>';n.forEach(l=>{m+=`<th title="${Utils.escapeHTML(l)}">${Utils.escapeHTML(l.length>14?l.slice(0,14)+"\u2026":l)}</th>`}),m+="</tr></thead><tbody>",i.forEach(l=>{m+=`<tr><th title="${Utils.escapeHTML(l)}">${Utils.escapeHTML(l.length>16?l.slice(0,16)+"\u2026":l)}</th>`,n.forEach(r=>{const d=c[l+"|||"+r]||0,h=d>0?.15+d/s*.85:0,v=d>0?`rgba(29, 78, 216, ${h})`:"#f8fafc",x=h>.5?"#fff":"#334155";m+=`<td class="emp-analytics-heatmap-cell" data-dept="${Utils.escapeHTML(l)}" data-job="${Utils.escapeHTML(r)}" style="background:${v};color:${x};" title="${Utils.escapeHTML(l)} / ${Utils.escapeHTML(r)}: ${d}">${d||""}</td>`}),m+="</tr>"}),m+="</tbody></table>",e.innerHTML=m,e.querySelectorAll(".emp-analytics-heatmap-cell").forEach(l=>{l.addEventListener("click",()=>{const r=l.getAttribute("data-dept")||"",d=l.getAttribute("data-job")||"";!r&&!d||(this._empApplyAnalyticsFilter("department",r,{skipUpdate:!0}),this._empApplyAnalyticsFilter("job",d))})})},_empRenderAnalyticsDetailTable(t){const e=document.getElementById("emp-analytics-detail-table");if(!e)return;const a=this._empAnalyticsDetailTab||"department",o=a==="job"?t.byJob:t.byDepartment,i=a==="job"?this.t("module.employees.job","\u0627\u0644\u0648\u0638\u064A\u0641\u0629"):this.t("module.employees.department","\u0627\u0644\u0642\u0633\u0645"),n=a==="job"?"job":"department";if(!o.length){e.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const c=this._empGetAnalyticsFiltersFromDom()[n];e.innerHTML=`
            <table class="emp-analytics-detail-table">
                ...
                <tbody>
                    ${o.map(m=>`
                        <tr class="emp-analytics-detail-row${c===m.label?" emp-analytics-detail-row--selected":""}" data-filter-key="${n}" data-filter-value="${Utils.escapeHTML(m.label)}">
        ...
        `;const l=document.createElement("tbody");a.forEach(r=>{const d=this.formatDateSafe(r.birthDate),h=this.formatDateSafe(r.hireDate),v=this.calculateAge(r.birthDate),x=this.isEmployeeInactive(r),b=x?"opacity: 0.7; background-color: #f8f9fa;":"",u=document.createElement("tr");x&&(u.style.cssText=b);const y=(this._getDriveIdFromUrl(r.photo||"")||r.id||r.employeeNumber||r.name||"").toString(),g=this._normalizeEmployeePhotoUrl(r.photo,r.id),f=g&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(g):{canonical:g||"",displaySrc:g||"",needsProxy:!1,proxyFileId:""},w=f.canonical?f.displaySrc:"",S=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(f):"";u.innerHTML=`
                <td style="word-wrap: break-word;">
                    ${g?`<img data-emp-photo="1" data-photo-key="${Utils.escapeHTML(y)}" src="${Utils.escapeHTML(w)}" alt="${Utils.escapeHTML(r.name||"")}"${S} class="w-12 h-12 rounded-full object-cover" loading="lazy" decoding="async" referrerpolicy="no-referrer">`:'<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>'}
                </td>
        ...
        `,this.applyModuleI18n(t),document.body.appendChild(t);const e=document.getElementById("employee-excel-file-input"),a=document.getElementById("employee-import-preview"),o=document.getElementById("employee-import-confirm-btn");let i=[];e.addEventListener("change",async n=>{const s=n.target.files[0];if(s){Loading.show();try{const c=await s.arrayBuffer(),m=XLSX.read(c,{type:"array",cellDates:!0}),l=m.SheetNames[0],r=m.Sheets[l],d=XLSX.utils.sheet_to_json(r,{header:1,defval:"",raw:!1});if(d.length<2){Notification.error(this.t("module.employees.invalidFile","\u0627\u0644\u0645\u0644\u0641 \u0641\u0627\u0631\u063A \u0623\u0648 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D")),Loading.hide();return}const h=d[0].map(u=>String(u||"").trim());i=d.slice(1).map(u=>{const p={};return h.forEach((y,g)=>{const f=u[g];p[y]=f??""}),p}).filter(u=>String(u[h[0]]||"").trim()!=="");const v=document.getElementById("employee-preview-head"),x=document.getElementById("employee-preview-body"),b=document.getElementById("employee-preview-count");v.innerHTML=`<tr>${h.map(u=>`<th>${Utils.escapeHTML(u)}</th>`).join("")}</tr>`,x.innerHTML=i.slice(0,5).map(u=>`<tr>${h.map(p=>`<td>${Utils.escapeHTML(String(u[p]||""))}</td>`).join("")}</tr>`).join(""),b.textContent=`${this.t("module.employees.totalRows","\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0635\u0641\u0648\u0641")}: ${i.length}`,a.classList.remove("hidden"),o.disabled=!1,Loading.hide()}catch(c){Loading.hide(),Notification.error(this.t("module.employees.readFileFailed","\u0641\u0634\u0644 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641")+": "+c.message)}}}),o.addEventListener("click",async()=>{if(i.length!==0){Loading.show();try{let n=0,s=0;const c=l=>l==null?"":String(l).trim();i.forEach(l=>{try{const r=l["\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638"]||l["\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641"]||l["Employee Name"]||l.Name||l.name||"",d=l["ID SAP"]||l["\u0631\u0642\u0645 SAP"]||l["SAP ID"]||l.sap_id||"",h=l["\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641"]||l["\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0648\u0638\u064A\u0641\u064A"]||l["Employee Number"]||l.employee_number||"",v=l["\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062A\u0639\u064A\u064A\u0646"]||l["Hire Date"]||l.hire_date||"",x=l.Job||l.job||l.\u0627\u0644\u0645\u0646\u0635\u0628||"",b=l.Department||l.department||l.\u0627\u0644\u0642\u0633\u0645||"",u=l.Branch||l.branch||l.\u0627\u0644\u0631\u0639||"",p=l.Location||l.location||l.\u0627\u0644\u0645\u0648\u0642\u0639||"",y=l.Gender||l.gender||l.\u0627\u0644\u062C\u0646\u0633||"",g=l["\u0631\u0642\u0645 \u0627\u0644\u0628\u0637\u0627\u0642\u0629 \u0627\u0644\u0642\u0648\u0645\u0649"]||l["National ID"]||l.national_id||"",f=l["\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0645\u064A\u0644\u0627\u062F"]||l["Date of Birth"]||l.birth_date||"",w=l.Email||l.email||l["\u0627\u0644\u0628\u0631\u064A\u062F \u0627\u0644\u0625\u0644\u0643\u062A\u0631\u0648\u0646\u064A"]||"",S=l.Phone||l.phone||l.\u0627\u0644\u0647\u0627\u062A||"",k=l["\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u062A\u0623\u0645\u064A\u0646\u064A"]||l["Insurance Number"]||l.insurance_number||l["\u0631\u0642\u0645 \u0627\u0644\u062A\u0623\u0645\u064A\u0646"]||"",$=c(h)||c(d);if(!r&&!$){s++;return}if(AppState.appData.employees.find(A=>A.employeeNumber&&A.employeeNumber===$||A.name&&A.name.toLowerCase()===c(r).toLowerCase()))s++;else{const A={id:$||Utils.generateId("EMP"),name:c(r),employeeNumber:$||Utils.generateId("EMP"),sapId:c(d),hireDate:this.normalizeDateOnly(v)||this.normalizeDateOnly(new Date),job:c(x),position:c(x),department:c(b),branch:c(u),location:c(p),gender:c(y),nationalId:c(g),birthDate:this.normalizeDateOnly(f),email:c(w),phone:c(S),insuranceNumber:c(k),photo:"",createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};AppState.appData.employees.push(A),n++}}catch{s++}}),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("Employees",AppState.appData.employees),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),Notification.success(`\u062A\u0645 \u0627\u0633\u062A\u064A\u0631\u0627\u062F ${n} \u0645\u0648\u0638\u0641${s>0?` (\u0641\u0634\u0644 ${s} \u0645\u0648\u0638\u0641\u064A\u0646)`:""}`),t.remove(),this.renderStatsCards();const m=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(m),requestAnimationFrame(()=>{this.applyFilters()})}catch(n){Loading.hide(),Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+n.message)}}}),t.addEventListener("click",n=>{n.target===t&&t.remove()})},async handleSubmit(t){t.preventDefault();const e=t.target?.querySelector('button[type="submit"]')||document.querySelector('#employee-form button[type="submit"]');if(e&&e.disabled)return;let a="";e&&(a=e.innerHTML,e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const o=this.currentEditId?AppState.appData.employees.find(A=>A.id===this.currentEditId):null;let i=o?.photo||"";const n=document.getElementById("employee-photo-input");if(n&&n.files.length>0){const A=n.files[0];if(A.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 \u0647\u0648 2MB"),e&&(e.disabled=!1,e.innerHTML=a);return}i=await this.convertImageToBase64(A)}const s=document.getElementById("employee-name"),c=document.getElementById("employee-number"),m=document.getElementById("employee-sap-id"),l=document.getElementById("employee-hire-date"),r=document.getElementById("employee-birth-date"),d=document.getElementById("employee-department"),h=document.getElementById("employee-position"),v=document.getElementById("employee-branch"),x=document.getElementById("employee-location"),b=document.getElementById("employee-gender"),u=document.getElementById("employee-national-id"),p=document.getElementById("employee-email"),y=document.getElementById("employee-phone"),g=document.getElementById("employee-insurance-number");if(!s||!c||!m||!d||!h||!v||!x||!b||!p||!y){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649.");return}const f=!!this.currentEditId,w=f&&o?.hireDate||"",S=f&&o?.birthDate||"",k={id:c.value.trim()||this.currentEditId||Utils.generateId("EMP"),name:s.value.trim(),employeeNumber:c.value.trim(),sapId:m.value.trim(),hireDate:l?.value?this.normalizeDateOnly(l.value):f?this.normalizeDateOnly(w):this.normalizeDateOnly(new Date),birthDate:r?.value?this.normalizeDateOnly(r.value):f?this.normalizeDateOnly(S):"",department:d.value.trim(),job:h.value.trim(),position:h.value.trim(),branch:v.value.trim(),location:x.value.trim(),gender:b.value,nationalId:u?.value.trim()||"",email:p.value.trim(),phone:y.value.trim(),insuranceNumber:g?.value.trim()||"",photo:i,status:f&&o?.status||"active",resignationDate:f&&o?.resignationDate||"",createdAt:this.currentEditId?o?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};if(!k.name||!k.sapId||!k.employeeNumber||!k.department||!k.position){Notification.error("\u064A\u0631\u062C\u0649 \u0645\u0644\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 (\u0627\u0644\u0627\u0633\u0645\u060C \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0642\u0633\u0645\u060C \u0627\u0644\u0645\u0646\u0635\u0628)"),e&&(e.disabled=!1,e.innerHTML=a);return}const $=String(k.id||"").trim();if(!$){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D (\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u0646\u0634\u0627\u0621 id \u0641\u0627\u0631\u063A)"),e&&(e.disabled=!1,e.innerHTML=a);return}if(AppState.appData.employees.some(A=>{const U=String(A?.id||"").trim();return!U||this.currentEditId&&U===String(this.currentEditId).trim()?!1:U===$})){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u0645\u0633\u062A\u062E\u062F\u0645 \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0631\u0642\u0645 \u0622\u062E\u0631."),e&&(e.disabled=!1,e.innerHTML=a);return}Loading.show();try{if(this.currentEditId){const A=AppState.appData.employees.findIndex(U=>U.id===this.currentEditId);A!==-1&&(AppState.appData.employees[A]=k,this.currentEditId=$),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D")}else AppState.appData.employees.push(k),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D");typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("Employees",AppState.appData.employees),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),e&&(e.disabled=!1,e.innerHTML=a),this.renderStatsCards(),this.showList()}catch(A){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+A.message),e&&(e.disabled=!1,e.innerHTML=a)}},async convertImageToBase64(t){return new Promise((e,a)=>{const o=new FileReader;o.onload=()=>e(o.result),o.onerror=a,o.readAsDataURL(t)})},async showList(){this.currentEditId=null,!this.canViewEmployeesRegistryTab()&&this.canViewEmployeesAnalysisTab()?this.activeTab="data-analysis":!this.canViewEmployeesRegistryTab()&&this.canViewExternalWorkforceTab()?this.activeTab="external-workforce":!this.canViewExternalWorkforceTab()&&!this.canViewEmployeesAnalysisTab()&&(this.activeTab="employees-list");const t=document.getElementById("employees-content");t&&(t.innerHTML=await this.renderList(),this.applyModuleI18n(t),requestAnimationFrame(()=>{this.setupEventListeners(),this.canViewEmployeesRegistryTab()&&this.activeTab==="employees-list"?this.loadEmployeesList():this.activeTab==="data-analysis"&&this.canViewEmployeesAnalysisTab()?this.loadEmployeesAnalysis().catch(()=>{}):this.canViewExternalWorkforceTab()&&(this.populateExternalWorkforceYearSelector(),this.ensureExternalWorkforceDataLoaded().then(()=>this.renderExternalWorkforceTable()).catch(()=>{})),this.activeTab==="employees-list"&&this.scrollToSearchField()}))},async editEmployee(t){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const e=AppState.appData.employees.find(a=>a.id===t);e&&await this.showForm(e)},async printEmployee(t){const e=AppState.appData.employees.find(a=>a.id===t);if(!e){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}try{Loading.show();let a="";const o=this._normalizeEmployeePhotoUrl(e.photo,e.id);if(o&&typeof Utils.resolveDriveAwareImgDisplay=="function"){const p=Utils.resolveDriveAwareImgDisplay(o);if(p.needsProxy&&typeof Utils.fetchDriveImageDataUri=="function")try{a=await Utils.fetchDriveImageDataUri(p.proxyFileId)||""}catch{a=""}a||(a=p.canonical||o)}else o&&(a=o);const i=this.formatDateSafe(e.birthDate),n=this.formatDateSafe(e.hireDate),s=this.calculateAge(e.birthDate),c=p=>{if(!p)return"-";try{const y=new Date(p),g=y.getFullYear(),f=y.getMonth()+1,w=y.getDate(),S=["\u0660","\u0661","\u0662","\u0663","\u0664","\u0665","\u0666","\u0667","\u0668","\u0669"],k=$=>String($).split("").map(D=>S[parseInt(D)]||D).join("");return`${k(g)}/${k(f)}/${k(w)}`}catch{return p}},m=new Date,l=c(m.toISOString().split("T")[0]),r=m.toLocaleTimeString("ar-SA",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}),d=AppState?.companySettings?.name||AppState?.appData?.companyName||"\u0627\u0644\u0634\u0631\u0643\u0629",h=`
                ...
                <div class="employee-card">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="print-date">\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0637\u0628\u0627\u0639\u0629: ${l} - ${r}</div>
                    </div>
                </div>
            `,v=`<!DOCTYPE html>
...
<body>
    ${h}
        ...
        `,this.applyModuleI18n(n),document.body.appendChild(n),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(n,{onFetchFail:s=>{try{const c=document.createElement("div");c.className="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center mx-auto",c.innerHTML='<i class="fas fa-user text-5xl text-gray-400"></i>',s.replaceWith(c)}catch{}}}),n.addEventListener("click",s=>{s.target===n&&n.remove()})},async deactivateEmployee(t){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0625\u0644\u063A\u0627\u0621 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const e=AppState.appData.employees.find(a=>a.id===t);if(!e){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}if(confirm(`\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u0625\u0644\u063A\u0627\u0621 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641 "${e.name}"\u061F
...
\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: \u0647\u0630\u0647 \u0627\u0644\u0639\u0645\u0644\u064A\u0629 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647\u0627!`)){Loading.show();try{AppState.appData.employees=(AppState.appData.employees||[]).filter(a=>a.id!==t),setTimeout(()=>{typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},50),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D"),this.renderStatsCards();const e=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(e),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(a){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",a)}}),AppState.googleConfig?.appsScript?.enabled&&GoogleIntegration.sendToAppsScript("deleteEmployee",{employeeId:t}).then(a=>{!a||!a.success?Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 Google Sheets:",a?.message):Utils.safeLog("\u2705 \u062A\u0645 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}).catch(a=>Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062D\u0630\u0641 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",a))}catch(e){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+e.message)}}},scrollToSearchField(){setTimeout(()=>{const t=document.getElementById("employees-search");if(t){const e=window.scrollY||document.documentElement.scrollTop,a=Math.max(0,(t.offsetTop||0)-20),o=e+window.innerHeight;(a<e||a>o-100)&&window.scrollTo({top:a,behavior:"smooth"})}},0)},getFilterValues(){return{search:document.getElementById("employees-search-filter")?.value||document.getElementById("employees-search")?.value||"",department:document.getElementById("employee-filter-department")?.value||"",branch:document.getElementById("employee-filter-branch")?.value||"",location:document.getElementById("employee-filter-location")?.value||"",job:document.getElementById("employee-filter-job")?.value||"",position:document.getElementById("employee-filter-position")?.value||"",gender:document.getElementById("employee-filter-gender")?.value||"",showInactive:document.getElementById("show-inactive-employees")?.checked||!1}},async filterEmployees(t="",e=!1,a=null){try{if(a)e=a.showInactive!==void 0&&a.showInactive!==null?a.showInactive:e;else{const r=this.getFilterValues();t=t||r.search,e=e??(r.showInactive||!1),a=r,a.showInactive=e}const o=document.getElementById("employees-table-container");if(!o){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}let i=o.querySelector("tbody");if(!i&&(await this.loadEmployeesList(e),i=o.querySelector("tbody"),!i)){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F tbody \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0628\u0639\u062F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629");return}let n=AppState.appData.employees||[];e||(n=n.filter(r=>!this.isEmployeeInactive(r)));let s=n;const c=this.canEditOrDelete();if(t&&t.trim()){const r=t.trim().toLowerCase();s=s.filter(d=>d.name&&d.name.toLowerCase().includes(r)||d.employeeNumber&&String(d.employeeNumber).toLowerCase().includes(r)||d.sapId&&String(d.sapId).toLowerCase().includes(r)||d.department&&d.department.toLowerCase().includes(r)||d.position&&d.position.toLowerCase().includes(r)||d.job&&d.job.toLowerCase().includes(r)||d.branch&&d.branch.toLowerCase().includes(r)||d.location&&d.location.toLowerCase().includes(r)||d.nationalId&&d.nationalId.toLowerCase().includes(r)||d.phone&&d.phone.toLowerCase().includes(r)||d.insuranceNumber&&d.insuranceNumber.toLowerCase().includes(r)||d.email&&d.email.toLowerCase().includes(r)||d.gender&&d.gender.toLowerCase().includes(r))}a.department&&(s=s.filter(r=>String(r.department||"").trim()===String(a.department).trim())),a.branch&&(s=s.filter(r=>String(r.branch||"").trim()===String(a.branch).trim())),a.location&&(s=s.filter(r=>String(r.location||"").trim()===String(a.location).trim())),a.job&&(s=s.filter(r=>String(r.job||"").trim()===String(a.job).trim())),a.position&&(s=s.filter(r=>String(r.position||"").trim()===String(a.position).trim())),a.gender&&(s=s.filter(r=>String(r.gender||"").trim()===String(a.gender).trim()));const m=document.createDocumentFragment(),l=13;if(s.length===0){const r=document.createElement("tr");r.innerHTML=`<td colspan="${l}" class="text-center text-gray-500 py-8">\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C</td>`,m.appendChild(r)}else s.forEach(r=>{const d=this.formatDateSafe(r.birthDate),h=this.formatDateSafe(r.hireDate),v=this.calculateAge(r.birthDate),x=this.isEmployeeInactive(r),b=x?"opacity: 0.7; background-color: #f8f9fa;":"",u=document.createElement("tr");x&&(u.style.cssText=b);const p=this._normalizeEmployeePhotoUrl(r.photo,r.id),g=(this._getDriveIdFromUrl(r.photo||"")||r.id||r.employeeNumber||r.name||"").toString(),f=p&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(p):{canonical:p||"",displaySrc:p||"",needsProxy:!1,proxyFileId:""},w=f.canonical?f.displaySrc:"",S=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(f):"";u.innerHTML=`
                    ...
                    `}
                `,m.appendChild(u)});i.innerHTML="",i.appendChild(m),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(i,{onFetchFail:r=>{try{const d=(r.dataset.photoKey||"").trim();d&&sessionStorage.setItem(this._photoFailKey(d),Date.now().toString())}catch{}try{const d=r.parentElement;d&&(d.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}}),this.updateFilterBadges(n,s,a),AppState.debugMode&&t&&Utils.safeLog(`\u{1F50D} \u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0628\u062D\u062B: ${s.length} \u0645\u0646 ${n.length} \u0645\u0648\u0638\u0641`)}catch(o){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A filterEmployees:",o)}},updateFilterBadges(t,e,a){try{if(!a){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F updateFilterBadges: filters \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}const o=(i,n,s)=>{try{const c=document.getElementById(i);if(!c){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: ${i} \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F`);return}const m=c.closest(".filter-field");if(!m){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-field \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${i}`);return}const l=m.querySelector(".filter-label");if(!l){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-label \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${i}`);return}const r=l.querySelector(".filter-count-badge");if(r&&r.remove(),n&&n.trim()!==""){const d=document.createElement("span");d.className="filter-count-badge",d.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",d.textContent=s;const h=l.querySelector("i");h?h.insertAdjacentElement("afterend",d):l.insertBefore(d,l.firstChild),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0639\u062F\u062F (${s}) \u0644\u0640 ${i}`)}}catch(c){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0641\u0644\u062A\u0631:",c)}};if(a.department?o("employee-filter-department",a.department,e.length):o("employee-filter-department","",0),a.branch?o("employee-filter-branch",a.branch,e.length):o("employee-filter-branch","",0),a.location?o("employee-filter-location",a.location,e.length):o("employee-filter-location","",0),a.job?o("employee-filter-job",a.job,e.length):o("employee-filter-job","",0),a.position?o("employee-filter-position",a.position,e.length):o("employee-filter-position","",0),a.gender?o("employee-filter-gender",a.gender,e.length):o("employee-filter-gender","",0),a.search&&a.search.trim())try{const i=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(i){const n=i.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const c=s.querySelector(".filter-count-badge");c&&c.remove();const m=document.createElement("span");m.className="filter-count-badge",m.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",m.textContent=e.length;const l=s.querySelector("i");l?l.insertAdjacentElement("afterend",m):s.insertBefore(m,s.firstChild)}}}}catch(i){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",i)}else try{const i=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(i){const n=i.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const c=s.querySelector(".filter-count-badge");c&&c.remove()}}}}catch(i){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0625\u0632\u0627\u0644\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",i)}}catch(o){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A updateFilterBadges:",o)}},async applyFilters(){try{const t=this.getFilterValues();await this.filterEmployees(t.search,t.showInactive,t),this.updateInactiveCount()}catch(t){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A applyFilters:",t)}finally{this.updateInactiveCount()}},async resetFilters(){const t=document.getElementById("employees-search"),e=document.getElementById("employees-search-filter");t&&(t.value=""),e&&(e.value=""),["employee-filter-department","employee-filter-branch","employee-filter-location","employee-filter-job","employee-filter-position","employee-filter-gender"].forEach(n=>{const s=document.getElementById(n);s&&(s.value="")});const o=document.getElementById("show-inactive-employees");o&&(o.checked=!1);const i=document.getElementById("show-inactive-employees-container");i&&(i.style.background="linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)",i.style.borderColor="#dee2e6",i.style.boxShadow="none"),await this.applyFilters(),this.updateInactiveCount()},updateInactiveCount(t=0){const o=()=>{try{const n=(AppState.appData.employees||[]).filter(c=>this.isEmployeeInactive(c)).length,s=document.getElementById("inactive-employees-count");if(s){s.textContent=n;const c=n===0,m=c?"#6b7280":"#dc2626",l=c?"0 2px 4px rgba(107, 114, 128, 0.3)":"0 2px 4px rgba(220, 38, 38, 0.3)";s.style.cssText=`
    ...
    `,m=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${t.year}`,i,c,!1,!0,{version:"1.0",releaseDate:n,revisionDate:n,includeQRCode:!0},n,n):`<!DOCTYPE html><html lang="${o.lang}" dir="${o.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(i)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${o.dir};padding:20px;">${c}</body></html>`,l=new Blob(["\uFEFF"+m],{type:"text/html;charset=utf-8"}),r=URL.createObjectURL(l),d=window.open(r,"_blank");if(!d){URL.revokeObjectURL(r),Notification.error("\u062A\u0639\u0630\u0631 \u0641\u062A\u062D \u0646\u0627\u0641\u0630\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629");return}d.onload=()=>{setTimeout(()=>{d.print(),setTimeout(()=>URL.revokeObjectURL(r),1e3)},400)}},(function(){"use strict";try{typeof window<"u"&&typeof Employees<"u"&&(window.Employees=Employees,typeof AppState<"u"&&AppState.debugMode&&typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u2705 Employees module loaded and available on window.Employees"),typeof AppState<"u"&&AppState.currentUser&&setTimeout(()=>{window.Employees&&window.Employees.init&&window.Employees.init().catch(t=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u0647\u064A\u0626\u0629 \u0645\u0648\u062F\u064A\u0648\u0644 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",t)})},2e3))}catch{if(typeof window<"u"&&typeof Employees<"u")try{window.Employees=Employees}catch{}}})();
