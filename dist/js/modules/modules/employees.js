        ...
        `},normalizeEmployeeImportKey(e){return e==null?"":String(e).trim().replace(/\s+/g,"")},findExistingEmployeeByImportKey(e,t){const a=this.normalizeEmployeeImportKey(e),i=this.normalizeEmployeeImportKey(t);return(AppState.appData.employees||[]).find(n=>{const s=this.normalizeEmployeeImportKey(n.employeeNumber||n.id),c=this.normalizeEmployeeImportKey(n.sapId),d=this.normalizeEmployeeImportKey(n.id);return!!(a&&(s===a||d===a||c===a)||i&&(c===i||s===i||d===i))})||null},parseEmployeeImportRow(e,t){const a=c=>c==null?"":String(c).trim(),i=a(e["\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638"]||e["\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641"]||e["Employee Name"]||e.Name||e.name||""),o=a(e["ID SAP"]||e["\u0631\u0642\u0645 SAP"]||e["SAP ID"]||e.sap_id||""),s=a(e["\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641"]||e["\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0648\u0638\u064A\u0641\u064A"]||e["Employee Number"]||e.employee_number||"")||o;return{uid:t,name:i,sapId:o,employeeNumber:s,hireDate:a(e["\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062A\u0639\u064A\u064A\u0646"]||e["Hire Date"]||e.hire_date||""),job:a(e.Job||e.job||e.\u0627\u0644\u0645\u0646\u0635\u0628||""),department:a(e.Department||e.department||e.\u0627\u0644\u0642\u0633\u0645||""),branch:a(e.Branch||e.branch||e.\u0627\u0644\u0631\u0639||e.\u0627\u0644\u0641\u0631\u0639||""),location:a(e.Location||e.location||e.\u0627\u0644\u0645\u0648\u0642\u0639||""),gender:a(e.Gender||e.gender||e.\u0627\u0644\u062C\u0646\u0633||""),nationalId:a(e["\u0631\u0642\u0645 \u0627\u0644\u0628\u0637\u0627\u0642\u0629 \u0627\u0644\u0642\u0648\u0645\u0649"]||e["\u0631\u0642\u0645 \u0627\u0644\u0628\u0637\u0627\u0642\u0629 \u0627\u0644\u0642\u0648\u0645\u064A"]||e["National ID"]||e.national_id||""),birthDate:a(e["\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0645\u064A\u0644\u0627\u062F"]||e["Date of Birth"]||e.birth_date||""),email:a(e.Email||e.email||e["\u0627\u0644\u0628\u0631\u064A\u062F \u0627\u0644\u0625\u0644\u0643\u062A\u0631\u0648\u0646\u064A"]||""),phone:a(e.Phone||e.phone||e.\u0627\u0644\u0647\u0627\u062A\u0641||e.\u0627\u0644\u0647\u0627\u062A||""),insuranceNumber:a(e["\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u062A\u0623\u0645\u064A\u0646\u064A"]||e["Insurance Number"]||e.insurance_number||e["\u0631\u0642\u0645 \u0627\u0644\u062A\u0623\u0645\u064A\u0646"]||""),status:"invalid"}},isEmployeeImportHireDateAllowed(e){const t=this.normalizeDateOnly(e);if(!t)return!1;const a=new Date(`${t}T12:00:00`);if(Number.isNaN(a.getTime()))return!1;const i=new Date;i.setHours(12,0,0,0);const o=new Date(i);return o.setMonth(o.getMonth()-3),a.getTime()>=o.getTime()&&a.getTime()<=i.getTime()},classifyEmployeeImportDraft(e,t){const a=this.normalizeEmployeeImportKey(e.employeeNumber),i=this.normalizeEmployeeImportKey(e.sapId),o=a||i;if(e._dupInFile=!1,e._hireDateRejected=!1,!o||!String(e.name||"").trim())return e.status="invalid",e;if(t){if(t.has(o))return e.status="invalid",e._dupInFile=!0,e;t.add(o)}return this.findExistingEmployeeByImportKey(e.employeeNumber,e.sapId)?(e.status="exists",e):this.isEmployeeImportHireDateAllowed(e.hireDate)?(e.status="new",e):(e.status="invalid",e._hireDateRejected=!0,e)},getEmployeeImportCounts(e){const t=Array.isArray(e)?e:[];return{total:t.length,newCount:t.filter(a=>a.status==="new").length,existsCount:t.filter(a=>a.status==="exists").length,invalidCount:t.filter(a=>a.status==="invalid").length,hireDateRejectedCount:t.filter(a=>a._hireDateRejected).length}},reclassifyAllEmployeeImportDrafts(e){const t=new Set;return e.forEach(a=>{a._dupInFile=!1,this.classifyEmployeeImportDraft(a,t)}),e},buildEmployeeFromImportDraft(e){const t=this.normalizeEmployeeImportKey(e.employeeNumber)||this.normalizeEmployeeImportKey(e.sapId);if(!t||!String(e.name||"").trim()||!this.isEmployeeImportHireDateAllowed(e.hireDate))return null;const a=this.normalizeDateOnly(e.hireDate);if(!a)return null;const i=new Date().toISOString();return{id:t,name:String(e.name||"").trim(),employeeNumber:t,sapId:String(e.sapId||"").trim(),hireDate:a,job:String(e.job||"").trim(),position:String(e.job||"").trim(),department:String(e.department||"").trim(),branch:String(e.branch||"").trim(),location:String(e.location||"").trim(),gender:String(e.gender||"").trim(),nationalId:String(e.nationalId||"").trim(),birthDate:this.normalizeDateOnly(e.birthDate),email:String(e.email||"").trim(),phone:String(e.phone||"").trim(),insuranceNumber:String(e.insuranceNumber||"").trim(),photo:"",status:"active",createdAt:i,updatedAt:i}},renderEmployeeImportReview(e,t){const a=e.querySelector("#employee-import-summary"),i=e.querySelector("#employee-import-preview"),o=e.querySelector("#employee-import-new-body"),n=e.querySelector("#employee-import-confirm-btn");if(!a||!i||!o||!n)return;const s=this.getEmployeeImportCounts(t),c=t.filter(d=>d.status==="new");a.innerHTML=`
            <div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:8px;">
                ...
                <span style="background:#ffedd5;color:#9a3412;padding:4px 10px;border-radius:6px;font-size:12px;font-weight:600;">
                    \u062A\u0639\u064A\u064A\u0646 \u0623\u0642\u062F\u0645 \u0645\u0646 3 \u0623\u0634\u0647\u0631 / \u063A\u064A\u0631 \u0645\u0642\u0628\u0648\u0644: ${s.hireDateRejectedCount}
                </span>
