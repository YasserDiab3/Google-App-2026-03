const Employees={cache:{data:null,lastLoad:null,lastUpdate:null,isUpdating:!1},config:{cacheTimeout:9e5,backgroundUpdateInterval:6e5,backgroundUpdateTimer:null,_refreshedOnceForInactive:!1,listPageSize:100},activeTab:"employees-list",externalWorkforceYear:new Date().getFullYear(),_externalWorkforceLoaded:!1,_externalWorkforceLoadPromise:null,_externalWorkforceCache:new Map,_empAnalyticsCharts:{},_empAnalyticsDetailTab:"department",_empAnalyticsEventsBound:!1,_visibilityResumeBound:!1,_listRowsCache:null,_listVisibleCount:0,_listCanEdit:!1,_employeeStableKey_(e){const t=e&&(e.employeeNumber||e.id||e.sapId)||"";let a=String(t).trim().toLowerCase();return!a||(/^\d+(\.0+)?$/.test(a)&&(a=String(parseInt(a,10))),/^\d{4}-\d{2}-\d{2}/.test(a)||/^\d{1,2}\/\d{1,2}\/\d{2,4}/.test(a))?"":a},_employeeDisplayName_(e){return!e||typeof e!="object"?"":String(e.name||e.employeeName||e.fullName||"").replace(/\s+/g," ").trim()},_countNamedEmployees_(e){const t=Array.isArray(e)?e:[];let a=0;for(let i=0;i<t.length;i++)this._employeeDisplayName_(t[i])&&a++;return a},mergeEmployeesPreservingNames_(e,t){const a=Array.isArray(e)?e:[],i=Array.isArray(t)?t:[];if(a.length===0&&i.length>0)return i.slice();const o=new Map;for(let c=0;c<i.length;c++){const l=i[c],p=this._employeeStableKey_(l);p&&o.set(p,l)}const n=a.map(c=>{if(!c||typeof c!="object")return c;const l=this._employeeStableKey_(c),p=l?o.get(l):null,d=this._employeeDisplayName_(c);if(d)return String(c.name||"").trim()===d?c:Object.assign({},c,{name:d});if(p){const m=this._employeeDisplayName_(p);if(m)return Object.assign({},c,{name:m})}return c}),s=this._countNamedEmployees_(n);return this._countNamedEmployees_(i)>0&&s===0&&i.length>0?i.slice():n},applyEmployeesData_(e){const t=AppState.appData&&Array.isArray(AppState.appData.employees)?AppState.appData.employees:[],a=Array.isArray(e)?e.map(n=>this.sanitizeEmployeeRecordDrift_({...n||{}})):e,i=this.mergeEmployeesPreservingNames_(a,t);if((!i||i.length===0)&&t.length>0)return this.cache.data=t,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),t;const o=(i||[]).map(n=>this.sanitizeEmployeeRecordDrift_(n));return AppState.appData=AppState.appData||{},AppState.appData.employees=o,this.cache.data=o,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),o},_ensureVisibilityResumeBound_(){this._visibilityResumeBound||(this._visibilityResumeBound=!0,document.addEventListener("visibilitychange",()=>{try{if(document.hidden){const t=AppState.appData&&AppState.appData.employees||[];(!t.length||this._countNamedEmployees_(t)===0||!this.cache.lastLoad)&&!this.cache.isUpdating&&this.loadEmployeesFromBackend(!1);return}if(!(AppState.currentSection==="employees"||!!document.getElementById("employees-table-container")||!!document.getElementById("employees-section")))return;(async()=>{try{if((AppState.appData.employees||[]).length>0&&this.activeTab==="employees-list"){const t=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(t),this.renderStatsCards()}if(await this.ensureEmployeesLoaded(!1),this.activeTab==="employees-list"&&document.getElementById("employees-table-container")){const t=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(t)}this.renderStatsCards()}catch{}})()}catch{}}))},_getI18nCore(){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n:window.I18n&&typeof window.I18n.t=="function"?window.I18n:null},t(e,t){const a=this._getI18nCore();return a?a.t(e,null,t||e):t||e},applyModuleI18n(e){const t=this._getI18nCore();if(!t)return;const a=e||document.getElementById("employees-section")||document;typeof t.applyI18n=="function"&&t.applyI18n(a),typeof t.applyLiteralTranslations=="function"&&t.applyLiteralTranslations(a)},_photoFailKey(e){return`hse_emp_photo_failed_${String(e||"").trim()}`},_getDriveIdFromUrl(e){try{const t=String(e||"").trim();if(!t)return"";const a=t.match(/[?&]id=([^&]+)/)||t.match(/\/file\/d\/([^/]+)/);return a?String(a[1]||"").trim():""}catch{return""}},_normalizeEmployeePhotoUrl(e,t=""){try{const a=typeof Utils<"u"&&typeof Utils.extractImageSourceCandidate=="function"?String(Utils.extractImageSourceCandidate(e)||"").trim():String(e||"").trim();if(!a)return"";let i=a;typeof Utils<"u"&&typeof Utils.normalizeImageSource=="function"?i=Utils.normalizeImageSource(a)||a:typeof window<"u"&&typeof window.__convertGoogleDriveUrl=="function"&&(i=window.__convertGoogleDriveUrl(a)||a);const n=this._getDriveIdFromUrl(i)||t||i;return sessionStorage.getItem(this._photoFailKey(n))?"":i}catch{return""}},_setupEmployeePhotoFallbacks(e){try{const a=(e||document).querySelectorAll('img[data-emp-photo="1"]');if(!a||a.length===0)return;a.forEach(i=>{if(!i||i.dataset._fallbackBound==="1")return;i.dataset._fallbackBound="1";const o=(i.dataset.photoKey||"").trim();i.addEventListener("error",()=>{try{o&&sessionStorage.setItem(this._photoFailKey(o),Date.now().toString())}catch{}try{const n=i.parentElement;n&&(n.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}},{passive:!0})})}catch{}},canEditOrDelete(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},canAddOrImport(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},getEmployeesDetailedPermissionsState(){try{if(typeof Permissions<"u"&&typeof Permissions.getEffectivePermissions=="function"){const a=Permissions.getEffectivePermissions()?.employeesPermissions;if(a&&typeof a=="object"&&!Array.isArray(a))return a}}catch{}const e=AppState.currentUser?.permissions?.employeesPermissions;return e&&typeof e=="object"&&!Array.isArray(e)?e:null},canViewEmployeesRegistryTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["employees-list"]!==!1:!0},canViewExternalWorkforceTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["external-workforce"]===!0:!0},canViewEmployeesAnalysisTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["data-analysis"]!==!1:!0},canManageExternalWorkforceTab(){return this.canAddOrImport()},isValidDate(e){if(!e)return!1;try{const t=new Date(e);return t instanceof Date&&!isNaN(t.getTime())}catch{return!1}},normalizeDateOnly(e){if(e==null||e==="")return"";if(e instanceof Date&&!isNaN(e.getTime())){const n=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${n}-${s}-${r}`}if(typeof e=="number"&&isFinite(e))try{if(typeof XLSX<"u"&&XLSX?.SSF?.parse_date_code){const n=XLSX.SSF.parse_date_code(e);if(n&&n.y&&n.m&&n.d){const s=String(n.y).padStart(4,"0"),r=String(n.m).padStart(2,"0"),c=String(n.d).padStart(2,"0");return`${s}-${r}-${c}`}}}catch{}let t=String(e).trim();if(!t)return"";if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const n=JSON.parse(t);typeof n=="string"?t=n.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return""}const a=t.match(/^(\d{4}-\d{2}-\d{2})/);if(a)return a[1];const i=t.match(/^(\d{1,2})[\/\-](\d{1,2})[\/\-](\d{2,4})$/);if(i){const n=String(i[1]).padStart(2,"0"),s=String(i[2]).padStart(2,"0");return`${i[3].length===2?`20${i[3]}`:String(i[3]).padStart(4,"0")}-${s}-${n}`}const o=t.match(/^(\d{4})[\/\-](\d{1,2})[\/\-](\d{1,2})$/);if(o){const n=String(o[1]).padStart(4,"0"),s=String(o[2]).padStart(2,"0"),r=String(o[3]).padStart(2,"0");return`${n}-${s}-${r}`}try{const n=new Date(t);if(!isNaN(n.getTime())){const s=n.getFullYear(),r=String(n.getMonth()+1).padStart(2,"0"),c=String(n.getDate()).padStart(2,"0");return`${s}-${r}-${c}`}}catch{}return""},parseLocalDate(e){if(!e)return null;if(e instanceof Date&&!isNaN(e.getTime()))return e;let t=String(e).trim();if(!t)return null;if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const o=JSON.parse(t);typeof o=="string"?t=o.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return null}const a=t.match(/^(\d{4})-(\d{2})-(\d{2})/);if(a){const o=Number(a[1]),n=Number(a[2])-1,s=Number(a[3]),r=new Date(o,n,s);return isNaN(r.getTime())?null:r}const i=new Date(t);return isNaN(i.getTime())?null:i},formatDateSafe(e){return this.normalizeDateOnly(e)},calculateAge(e){if(!e)return"";try{const t=this.parseLocalDate(e);if(!t)return"";const a=new Date;let i=a.getFullYear()-t.getFullYear();const o=a.getMonth()-t.getMonth();return(o<0||o===0&&a.getDate()<t.getDate())&&i--,i>=0?i:""}catch{return""}},async load(){if(this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{typeof AppState<"u"&&AppState._languageRefresh||this.load()}),this._languageChangeListenerAdded=!0),typeof Utils>"u")return;if(typeof AppState>"u"){const t=document.getElementById("employees-section");t&&(t.innerHTML=`
            ...
            `,this.applyModuleI18n(e),setTimeout(async()=>{try{const a=document.getElementById("employees-content");if(!a)return;const i=await this.renderList().catch(o=>(Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629:",o),`
                        ...
                        `));if(a.innerHTML=i,this.applyModuleI18n(a),this.setupEventListeners(),this.activeTab==="data-analysis"&&this.canViewEmployeesAnalysisTab())await this.loadEmployeesAnalysis();else if(this.activeTab==="external-workforce"&&this.canViewExternalWorkforceTab())await this.ensureExternalWorkforceDataLoaded(),this.renderExternalWorkforceTable();else if(this.activeTab==="employees-list"&&this.canViewEmployeesRegistryTab()){const o=document.getElementById("employees-table-container");o&&(o.innerHTML=`
        ...
        `,s=r=>{const c=r.maleCount||0,l=r.femaleCount||0,p=c+l,d=p>0?Math.round(c/p*100):0,m=p>0?100-d:0;return`
        ...
        `,c=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${e.year}`,o,r,!1,!0,{version:"1.0",source:"ExternalWorkforceMonthly",reportYear:e.year,releaseDate:n,revisionDate:n},n,n):`<!DOCTYPE html><html lang="${i.lang}" dir="${i.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${i.dir};padding:20px;">${r}</body></html>`,l=new Blob(["\uFEFF"+c],{type:"text/html;charset=utf-8"}),p=URL.createObjectURL(l),d=window.open(p,"_blank");if(!d){URL.revokeObjectURL(p),Notification.error("Unable to open print window");return}d.onload=()=>{setTimeout(()=>{d.print(),setTimeout(()=>URL.revokeObjectURL(p),1e3)},400)}},async importExternalWorkforceExcelFile(e){if(!(!e||!this.canManageExternalWorkforceTab())){if(typeof XLSX>"u"){Notification.error("XLSX library is not available");return}Loading.show();try{const t=await e.arrayBuffer(),a=XLSX.read(t,{type:"array",cellDates:!0}),i=a.Sheets[a.SheetNames[0]],o=XLSX.utils.sheet_to_json(i,{header:1,defval:"",raw:!1});if(!Array.isArray(o)||o.length<2)throw new Error("File is empty");const n=o[0].map(b=>String(b||"").trim().toLowerCase()),s=this.getAvailableContractorsForExternalWorkforce(),r=Number(this.externalWorkforceYear),c={jan:0,january:0,feb:1,february:1,mar:2,march:2,apr:3,april:3,may:4,jun:5,june:5,jul:6,july:6,aug:7,august:7,sep:8,sept:8,september:8,oct:9,october:9,nov:10,november:10,dec:11,december:11,\u064A\u0646\u0627\u064A\u0631:0,\u0641\u0628\u0631\u0627\u064A\u0631:1,\u0645\u0627\u0631\u0633:2,\u0623\u0628\u0631\u064A\u0644:3,\u0627\u0628\u0631\u064A\u0644:3,\u0645\u0627\u064A\u0648:4,\u064A\u0648\u0646\u064A\u0648:5,\u064A\u0648\u0644\u064A\u0648:6,\u0623\u063A\u0633\u0637\u0633:7,\u0627\u063A\u0633\u0637\u0633:7,\u0633\u0628\u062A\u0645\u0628\u0631:8,\u0623\u0643\u062A\u0648\u0628\u0631:9,\u0627\u0643\u062A\u0648\u0628\u0631:9,\u0646\u0648\u0641\u0645\u0628\u0631:10,\u062F\u064A\u0633\u0645\u0628\u0631:11},l=this.getExternalWorkforceMonths().map(b=>b.key),p=n.findIndex(b=>b.includes("contractor")||b.includes("company")||b.includes("\u0627\u0644\u0634\u0631\u0643\u0629")||b.includes("\u0627\u0644\u0645\u0642\u0627\u0648\u0644")),d=n.findIndex(b=>b==="code"||b.includes("contractor code")||b.includes("\u0627\u0644\u0643\u0648\u062F")),m={};n.forEach((b,f)=>{const g=b.replace(/\./g,"").trim();c[g]!==void 0&&(m[l[c[g]]]=f)});const y=this.getExternalWorkforceRecords();let v=0;o.slice(1).forEach(b=>{const f=p>=0?String(b[p]||"").trim():"",g=d>=0?String(b[d]||"").trim():"";if(!f&&!g)return;const E=s.find(u=>g&&(u.contractorCode||"").trim().toLowerCase()===g.toLowerCase()||f&&u.contractorName.trim().toLowerCase()===f.toLowerCase());if(!E)return;let h=this.getExternalWorkforceRecord(r,E.stableKey);h||(h={id:`EWM-${r}-${E.stableKey}`,year:r,contractorId:E.contractorId||"",contractorCode:E.contractorCode||"",contractorName:E.contractorName||"",createdAt:new Date().toISOString()},y.push(h)),l.forEach(u=>{const x=m[u];x!==void 0&&(h[u]=Math.max(0,parseInt(b[x]||"0",10)||0))}),h.total=l.reduce((u,x)=>u+(parseInt(h[x]||"0",10)||0),0),h.updatedAt=new Date().toISOString(),h.updatedBy=AppState.currentUser?.name||AppState.currentUser?.email||"admin",v+=1}),this._externalWorkforceCache.clear(),this.renderExternalWorkforceTable(),typeof DataManager<"u"&&typeof DataManager.save=="function"&&DataManager.save(),typeof GoogleIntegration<"u"&&typeof GoogleIntegration.autoSave=="function"&&await GoogleIntegration.autoSave("ExternalWorkforceMonthly",y).catch(()=>{}),window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{externalWorkforce:!0,year:r}})),Notification.success(`Imported ${v} rows successfully`)}catch(t){Notification.error(`Failed to import file: ${t.message}`)}finally{Loading.hide()}}},renderExternalWorkforceTable(){const e=document.getElementById("external-workforce-table-container");if(!e)return;const t=this.buildExternalWorkforceModel(this.externalWorkforceYear),a=this.getExternalWorkforceViewState(),{dir:i,stickySide:o,textAlign:n,labels:s}=a;this.renderExternalWorkforceSummary(t);const r=this.canManageExternalWorkforceTab(),c=t.months.map(u=>`<th style="min-width: 74px;">${u.label}</th>`).join(""),l=t.rows.map((u,x)=>{const w=t.months.map((S,A)=>{const $=u.values[A]||0;return`<td style="background:#dceaf6;">${r?`<input type="number" min="0" step="1" class="form-input external-workforce-input" style="min-width:70px;text-align:center;padding:6px 8px;" value="${$}" data-row="${x}" data-contractor-key="${u.stableKey}" data-month="${S.key}" />`:`<span class="font-semibold text-slate-700">${$}</span>`}</td>`}).join("");return`
                <tr>
                    <td class="sticky-cell" style="background:#c7dcef; font-weight:700; text-align:${n};">
                        <div>${Utils.escapeHTML(u.contractorName)}</div>
                        <div class="text-xs text-gray-500 mt-1">${Utils.escapeHTML(u.contractorCode||u.contractorId||"\u0628\u062F\u0648\u0646 \u0643\u0648\u062F")}</div>
                    </td>
                    ${w}
                    <td style="background:#dceaf6; font-weight:800;">${u.total}</td>
                </tr>
            `}).join(""),p=t.monthTotals.map(u=>`<td style="background:#fff6cf; font-weight:800;">${u}</td>`).join(""),d=t.directEmployees.map(u=>`<td style="background:#eef2ff; font-weight:700;">${u}</td>`).join(""),m=t.combined.map(u=>`<td style="background:#ecfdf5; font-weight:800;">${u}</td>`).join(""),y=t.estimatedHours.map(u=>`<td style="background:#fff7ed; font-weight:700;">${u.toLocaleString("en-US")}</td>`).join("");e.innerHTML=`
            <style>
            ...
            <table class="external-workforce-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ${d}
                        <td style="background:#eef2ff; font-weight:900;">${t.directEmployees.reduce((u,x)=>u+x,0)}</td>
                    </tr>
                    <tr>
                        ...
                        ${m}
                        <td style="background:#ecfdf5; font-weight:900;">${t.combined.reduce((u,x)=>u+x,0)}</td>
                    </tr>
                    <tr>
                        ...
                        ${y}
                        <td style="background:#fff7ed; font-weight:900;">${t.estimatedHours.reduce((u,x)=>u+x,0).toLocaleString("en-US")}</td>
                    </tr>
                </tbody>
            </table>
        `;const v=e.querySelector(".external-workforce-table");if(!v)return;let b=e.querySelector(".external-workforce-shell");b||(b=document.createElement("div"),b.className="external-workforce-shell",v.parentNode.insertBefore(b,v),b.appendChild(v)),b.setAttribute("dir",i),Object.assign(b.style,{width:"100%",maxWidth:"100%",maxHeight:"min(70vh, calc(100vh - 260px))",overflow:"auto",border:"1px solid #cbd5e1",borderRadius:"18px",background:"#ffffff"}),Object.assign(v.style,{width:"max(100%, 1180px)",borderCollapse:"separate",borderSpacing:"0",direction:i,tableLayout:"fixed"}),v.querySelectorAll("th, td").forEach(u=>{u.style.padding="clamp(6px, 0.7vw, 10px)",u.style.fontSize="clamp(11px, 0.85vw, 14px)"});const f=Array.from(v.querySelectorAll("thead th"));f.forEach(u=>{u.style.position="sticky",u.style.top="0",u.style.zIndex="4",u.style.background="#b7d2ea"}),f[0]&&(f[0].textContent=s.contractor,f[0].classList.add("sticky-cell"),f[0].style.textAlign=n),f[f.length-1]&&(f[f.length-1].textContent=s.total),v.querySelectorAll(".sticky-cell").forEach(u=>{u.style.position="sticky",u.style.left="",u.style.right="",u.style[o]="0",u.style.zIndex=u.closest("thead")?"6":"2",u.style.minWidth="clamp(170px, 18vw, 240px)",u.style.maxWidth="clamp(170px, 18vw, 260px)",u.style.whiteSpace="normal",u.style.wordBreak="break-word"});const g=Array.from(v.querySelectorAll("tbody tr"));g.slice(0,t.rows.length).forEach((u,x)=>{const w=u.querySelector(".sticky-cell"),S=t.rows[x];!w||!S||(w.style.textAlign=n,w.innerHTML=`
        ...
        `},async ensureEmployeesLoaded(e=!1){if(this.cache.isUpdating&&!e){for(;this.cache.isUpdating;)await new Promise(i=>setTimeout(i,50));if(AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0)return!0}const t=AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0,a=this.cache.data&&this.cache.lastLoad&&Date.now()-this.cache.lastLoad<this.config.cacheTimeout&&!e;return t&&a?(AppState.debugMode&&Utils.safeLog(`\u2705 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 Cache (${this.cache.data.length} \u0645\u0648\u0638\u0641)`),this.cache.data&&this.cache.data.length>0&&this.applyEmployeesData_(this.cache.data),!this.config._refreshedOnceForInactive&&AppState.appData.employees.length>0&&AppState.googleConfig?.appsScript?.enabled&&(AppState.appData.employees||[]).filter(o=>this.isEmployeeInactive(o)).length===0&&(this.config._refreshedOnceForInactive=!0,this.loadEmployeesFromBackend(!0).then(()=>{window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{}}))}).catch(()=>{})),!0):t&&!a&&!e?(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),this.updateEmployeesInBackground(),!0):await this.loadEmployeesFromBackend(e)},async loadEmployeesFromBackend(e=!1){if(this.cache.isUpdating&&!e){for(AppState.debugMode&&Utils.safeLog("\u26A0\uFE0F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630 \u0628\u0627\u0644\u0641\u0639\u0644\u060C \u0627\u0646\u062A\u0638\u0627\u0631...");this.cache.isUpdating;)await new Promise(t=>setTimeout(t,50));if(AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0)return!0}this.cache.isUpdating=!0;try{if(!AppState.googleConfig?.appsScript?.enabled||!AppState.googleConfig?.appsScript?.scriptUrl)return AppState.debugMode&&Utils.safeLog("\u26A0\uFE0F Google Apps Script \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644 - \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629 \u0641\u0642\u0637"),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1;if(typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F GoogleIntegration \u063A\u064A\u0631 \u0645\u062A\u0627\u062D"),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1;try{const t={filters:{includeInactive:!0},skipCache:!0,forceRefresh:!0};typeof GoogleIntegration._invalidateSmartCacheForRead_=="function"&&GoogleIntegration._invalidateSmartCacheForRead_("getAllEmployees",t);const a=await GoogleIntegration.sendRequest({action:"getAllEmployees",data:t});if(a&&a.success&&Array.isArray(a.data))return a.data.length===0&&(AppState.appData.employees||[]).length>0?(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),this.cache.isUpdating=!1,!0):(this.applyEmployeesData_(a.data),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${a.data.length} \u0645\u0648\u0638\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A`),this.cache.isUpdating=!1,!0);{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F getAllEmployees \u0641\u0634\u0644\u060C \u062C\u0627\u0631\u064A \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0628\u0640 readFromSheet...");const i={sheetName:"Employees",spreadsheetId:AppState.googleConfig.sheets.spreadsheetId,skipCache:!0,forceRefresh:!0};typeof GoogleIntegration._invalidateSmartCacheForRead_=="function"&&GoogleIntegration._invalidateSmartCacheForRead_("readFromSheet",i);const o=await GoogleIntegration.sendRequest({action:"readFromSheet",data:i});if(o&&o.success&&Array.isArray(o.data))return o.data.length===0&&(AppState.appData.employees||[]).length>0?(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),this.cache.isUpdating=!1,!0):(this.applyEmployeesData_(o.data),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${o.data.length} \u0645\u0648\u0638\u0641 \u0645\u0646 Google Sheets`),this.cache.isUpdating=!1,!0)}}catch(t){return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 Backend:",t),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1}return this.cache.isUpdating=!1,!1}catch(t){return AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A loadEmployeesFromBackend:",t),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1}},async updateEmployeesInBackground(){if(!this.cache.isUpdating){this.cache.isUpdating=!0;try{if(!AppState.googleConfig?.appsScript?.enabled||!AppState.googleConfig?.appsScript?.scriptUrl||typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return;const e={filters:{includeInactive:!0},skipCache:!0,forceRefresh:!0};typeof GoogleIntegration._invalidateSmartCacheForRead_=="function"&&GoogleIntegration._invalidateSmartCacheForRead_("getAllEmployees",e);const t=await GoogleIntegration.sendRequest({action:"getAllEmployees",data:e});if(t&&t.success&&Array.isArray(t.data)){if(t.data.length===0&&(AppState.appData.employees||[]).length>0)return;const a=this._countNamedEmployees_(AppState.appData.employees),i=this.applyEmployeesData_(t.data),o=this._countNamedEmployees_(i),n=(AppState.appData.employees||[]).length,s=t.data.length;(n!==s||o!==a||o>0)&&(typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u{1F504} \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629 (${i.length} \u0645\u0648\u0638\u0641\u060C \u0623\u0633\u0645\u0627\u0621: ${o})`),window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{count:i.length}})))}}catch(e){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",e)}finally{this.cache.isUpdating=!1}}},startBackgroundUpdate(){this.config.backgroundUpdateTimer&&clearInterval(this.config.backgroundUpdateTimer),this.config.backgroundUpdateTimer=setInterval(()=>{this.updateEmployeesInBackground()},this.config.backgroundUpdateInterval),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0628\u062F\u0621 \u0627\u0644\u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A \u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 (\u0643\u0644 ${this.config.backgroundUpdateInterval/6e4} \u062F\u0642\u064A\u0642\u0629)`)},stopBackgroundUpdate(){this.config.backgroundUpdateTimer&&(clearInterval(this.config.backgroundUpdateTimer),this.config.backgroundUpdateTimer=null)},cleanup(){try{AppState.debugMode&&Utils.safeLog("\u{1F9F9} \u062A\u0646\u0638\u064A\u0641 \u0645\u0648\u0627\u0631\u062F Employees module..."),this.stopBackgroundUpdate(),this.handleDataUpdate&&(window.removeEventListener("employeesDataUpdated",this.handleDataUpdate),this.handleDataUpdate=null),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062A\u0646\u0638\u064A\u0641 \u0645\u0648\u0627\u0631\u062F Employees module")}catch(e){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u0646\u0638\u064A\u0641 Employees module:",e)}},buildEmployeeTableRowElement_(e,t){const a=this.formatDateSafe(e.birthDate),i=this.formatDateSafe(e.hireDate),o=this.calculateAge(e.birthDate),n=this.isEmployeeInactive(e),s=document.createElement("tr");n&&(s.style.cssText="opacity: 0.7; background-color: #f8f9fa;");const c=(this._getDriveIdFromUrl(e.photo||"")||e.id||e.employeeNumber||e.name||"").toString(),l=this._normalizeEmployeePhotoUrl(e.photo,e.id),p=l&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(l):{canonical:l||"",displaySrc:l||"",needsProxy:!1,proxyFileId:""},d=p.canonical?p.displaySrc:"",m=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(p):"",y=this._employeeDisplayName_(e)||e.name||"",v=String(e.id||"").replace(/'/g,"\\'");return s.innerHTML=`
            ...
            `}
        `,s},fillEmployeesTbodyPaged_(e,t,a,i){if(!e)return;const o=Array.isArray(t)?t:[],n=Math.max(40,parseInt(this.config.listPageSize,10)||100);if(i){this._listRowsCache=o,this._listVisibleCount=0,this._listCanEdit=!!a,e.innerHTML="";const d=document.getElementById("employees-load-more-wrap");d&&d.remove()}const s=this._listVisibleCount||0,r=Math.min(o.length,s+n),c=document.createDocumentFragment();for(let d=s;d<r;d++)c.appendChild(this.buildEmployeeTableRowElement_(o[d],this._listCanEdit));e.appendChild(c),this._listVisibleCount=r;let l=document.getElementById("employees-load-more-wrap");const p=e.closest(".table-wrapper")||e.parentElement?.parentElement;if(r<o.length){if(!l&&p&&p.parentElement&&(l=document.createElement("div"),l.id="employees-load-more-wrap",l.style.cssText="padding:12px;text-align:center;",p.parentElement.appendChild(l)),l){l.innerHTML=`
                    <button type="button" id="employees-load-more-btn" class="btn-secondary">
                        <i class="fas fa-chevron-down ml-2"></i>
                        \u0639\u0631\u0636 \u0627\u0644\u0645\u0632\u064A\u062F (${r} / ${o.length})
                    </button>`;const d=l.querySelector("#employees-load-more-btn");d&&d.addEventListener("click",()=>{this.fillEmployeesTbodyPaged_(e,this._listRowsCache||o,this._listCanEdit,!1);const m=document.getElementById("employees-table-container");m&&(this._setupEmployeePhotoFallbacks(m),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(m))})}}else l&&l.remove()},async loadEmployeesList(e=!1){const t=document.getElementById("employees-table-container");if(!t){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A loadEmployeesList");return}let a=(AppState.appData.employees||[]).map(d=>this.sanitizeEmployeeRecordDrift_({...d||{}}));if(AppState.appData.employees=a,AppState.debugMode&&Utils.safeLog(`\u{1F4CA} loadEmployeesList: \u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 = ${a.length}, showInactive = ${e}`),e)AppState.debugMode&&Utils.safeLog(`\u{1F4CA} \u0639\u0631\u0636 \u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646: ${a.length}`);else{const d=a.length,m=a.filter(y=>!this.isEmployeeInactive(y));m.length===0&&d>0?Utils.safeWarn(`\u26A0\uFE0F \u062A\u0635\u0641\u064A\u0629 \u0627\u0644\u0646\u0634\u0637\u064A\u0646 \u0623\u062E\u0641\u062A ${d} \u0645\u0648\u0638\u0641\u0627\u064B \u2014 \u0639\u0631\u0636 \u0627\u0644\u0643\u0644 \u0645\u0624\u0642\u062A\u0627\u064B \u0644\u062D\u0645\u0627\u064A\u0629 \u0627\u0644\u0648\u0627\u062C\u0647\u0629`):a=m,AppState.debugMode&&Utils.safeLog(`\u{1F4CA} \u0628\u0639\u062F \u0627\u0644\u062A\u0635\u0641\u064A\u0629 (\u0646\u0634\u0637\u064A\u0646): ${a.length} \u0645\u0646 ${d}`)}this.renderStatsCards(),this.updateInactiveCount();const i=this.canAddOrImport(),o=this.canEditOrDelete(),n=document.createDocumentFragment();if(a.length===0){const d=document.createElement("div");d.className="empty-state",d.innerHTML=`
...
\u0627\u062D\u062A\u064A\u0627\u0637\u064A: ${s.backupSheetName||"\u2014"}`);try{await this.ensureEmployeesLoaded(!0)}catch{const c=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(c)}this.renderStatsCards(),requestAnimationFrame(()=>{try{this.applyFilters()}catch{}}),Notification?.success?.(s.message||"\u062A\u0645 \u062A\u0646\u0638\u064A\u0641 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A")}catch(a){Loading?.hide?.(),Notification?.error?.("\u0641\u0634\u0644 \u062A\u0646\u0638\u064A\u0641 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A: "+(a?.message||a))}finally{e&&(e.disabled=!1,e.innerHTML=t)}},setupPhotoPreview(){const e=document.getElementById("employee-photo-input"),t=document.getElementById("employee-photo-preview"),a=document.getElementById("employee-photo-icon");e&&t&&a&&e.addEventListener("change",i=>{const o=i.target.files[0];if(o){const n=new FileReader;n.onload=s=>{t.src=s.target.result,t.style.display="block",a.style.display="none"},n.readAsDataURL(o)}})},currentEditId:null,async showForm(e=null){if(!e&&!this.canAddOrImport()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0625\u0636\u0627\u0641\u0629 \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F");return}if(e&&!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}this.currentEditId=e?.id||null;const t=document.getElementById("employees-content");t&&(t.innerHTML=await this.renderForm(e),this.applyModuleI18n(t),this.setupEventListeners())},async renderForm(e=null){const t=!!e;return`
        ...
        `,r.length===0)o.innerHTML=`
            ...
            `;else{const p=r.slice(0,200),d=r.length-p.length;o.innerHTML=p.map(m=>`
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629\u061F`)){Loading.show(`\u062C\u0627\u0631\u064A \u0625\u0636\u0627\u0641\u0629 ${m.length} \u0645\u0648\u0638\u0641...`);try{let f=0,g=0;const E=[],h=r instanceof Set?new Set(r):this.buildEmployeeImportExistingKeySet(),u=300;for(let w=0;w<m.length;w+=u){const S=Math.min(w+u,m.length);for(let A=w;A<S;A++){const $=m[A];try{if(this.employeeImportKeysMatchExisting($.employeeNumber,$.sapId,h)){g++;continue}const k=this.buildEmployeeFromImportDraft($);if(!k){g++;continue}if(this.employeeImportKeysMatchExisting(k.employeeNumber,k.sapId,h)){g++;continue}AppState.appData.employees.push(k),E.push(k);const I=this.normalizeEmployeeImportKey(k.employeeNumber),_=this.normalizeEmployeeImportKey(k.sapId),B=this.normalizeEmployeeImportKey(k.id);I&&h.add(I),_&&h.add(_),B&&h.add(B),f++}catch{g++}}Loading.show(`\u062C\u0627\u0631\u064A \u0627\u0644\u0625\u0636\u0627\u0641\u0629... ${S} / ${m.length}`),await this.yieldEmployeeImportUi_()}typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),r=h,Loading.hide(),Notification.success(`\u0623\u064F\u0636\u064A\u0641 ${f} \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F \u0645\u062D\u0644\u064A\u0627\u064B`+(y.existsCount>0?` \u2014 \u062A\u064F\u062E\u0637\u064A \u0645\u0648\u062C\u0648\u062F ${y.existsCount}`:"")+(y.hireDateRejectedCount>0?` \u2014 \u062A\u0639\u064A\u064A\u0646 \u062E\u0627\u0631\u062C ${this.getEmployeeImportHireWindowLabel()} ${y.hireDateRejectedCount}`:"")+(y.invalidCount>y.hireDateRejectedCount?` \u2014 \u0646\u0627\u0642\u0635 ${y.invalidCount-y.hireDateRejectedCount}`:"")+(g>0?` \u2014 \u0627\u0633\u062A\u064F\u0628\u0639\u062F \u0639\u0646\u062F \u0627\u0644\u062D\u0641\u0638 ${g}`:"")+(E.length>0?" \u2014 \u062C\u0627\u0631\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062C\u062F\u062F \u0645\u0639 \u0627\u0644\u0633\u062D\u0627\u0628\u0629 \u0628\u0627\u0644\u062E\u0644\u0641\u064A\u0629":"")),a.remove(),this.renderStatsCards();const x=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(x),requestAnimationFrame(()=>{this.applyFilters()}),E.length>0&&this.syncImportedEmployeesToCloud_(E)}catch(f){Loading.hide(),Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+f.message)}}})},async syncImportedEmployeesToCloud_(e){const t=Array.isArray(e)?e.filter(Boolean):[];if(!t.length||typeof GoogleIntegration>"u")return;if(typeof GoogleIntegration._isBackendRpcConfigured=="function"&&!GoogleIntegration._isBackendRpcConfigured()){Notification?.warning?.("\u062D\u064F\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B \u2014 \u0627\u0644\u062E\u0627\u062F\u0645 \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629");return}const a=s=>({id:s.id,name:s.name,employeeNumber:s.employeeNumber,sapId:s.sapId,hireDate:s.hireDate,job:s.job||s.position||"",position:s.position||s.job||"",department:s.department||"",branch:s.branch||"",location:s.location||"",gender:s.gender||"",nationalId:s.nationalId||"",birthDate:s.birthDate||"",email:s.email||"",phone:s.phone||"",insuranceNumber:s.insuranceNumber||"",photo:"",status:s.status||"active",resignationDate:s.resignationDate||"",createdAt:s.createdAt||new Date().toISOString(),updatedAt:s.updatedAt||new Date().toISOString()}),i=40;let o=0,n=0;for(let s=0;s<t.length;s+=i){const r=t.slice(s,s+i).map(a);try{const c=typeof GoogleIntegration.sendRequest=="function"?GoogleIntegration.sendRequest({action:"appendToSheet",data:{sheetName:"Employees",data:r,__timeoutMs:9e4,userData:AppState.currentUser||{}}}):GoogleIntegration.sendToAppsScript("appendToSheet",{sheetName:"Employees",data:r,__timeoutMs:9e4,userData:AppState.currentUser||{}}),l=typeof Utils<"u"&&Utils.promiseWithTimeout?await Utils.promiseWithTimeout(c,95e3,"\u0627\u0646\u062A\u0647\u062A \u0645\u0647\u0644\u0629 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646"):await c;l&&l.success?o+=r.length:(n+=r.length,Utils.safeWarn?.("\u26A0\uFE0F \u0641\u0634\u0644 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646:",l?.message))}catch(c){n+=r.length,Utils.safeWarn?.("\u26A0\uFE0F \u062E\u0637\u0623 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646:",c?.message||c)}await this.yieldEmployeeImportUi_()}o>0&&n===0?Notification?.success?.(`\u062A\u0645\u062A \u0645\u0632\u0627\u0645\u0646\u0629 ${o} \u0645\u0648\u0638\u0641\u0627\u064B \u062C\u062F\u064A\u062F\u0627\u064B \u0645\u0639 \u0627\u0644\u0633\u062D\u0627\u0628\u0629`):o>0&&n>0?Notification?.warning?.(`\u062A\u0645\u062A \u0645\u0632\u0627\u0645\u0646\u0629 ${o} \u2014 \u062A\u0639\u0630\u0651\u0631 ${n}. \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0641\u0648\u0638\u0629 \u0645\u062D\u0644\u064A\u0627\u064B.`):n>0&&Notification?.warning?.(`\u062D\u064F\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B \u2014 \u062A\u0639\u0630\u0651\u0631\u062A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0633\u062D\u0627\u0628\u0629 (${n}). \u0623\u0639\u062F \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0644\u0627\u062D\u0642\u0627\u064B \u0623\u0648 \u0645\u0646 \u0632\u0631 \u0627\u0644\u062A\u062D\u062F\u064A\u062B.`)},async handleSubmit(e){e.preventDefault();const t=e.target?.querySelector('button[type="submit"]')||document.querySelector('#employee-form button[type="submit"]');if(t&&t.disabled)return;let a="";t&&(a=t.innerHTML,t.disabled=!0,t.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const i=this.currentEditId?AppState.appData.employees.find(k=>k.id===this.currentEditId):null;let o=i?.photo||"";const n=document.getElementById("employee-photo-input");if(n&&n.files.length>0){const k=n.files[0];if(k.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 \u0647\u0648 2MB"),t&&(t.disabled=!1,t.innerHTML=a);return}o=await this.convertImageToBase64(k)}const s=document.getElementById("employee-name"),r=document.getElementById("employee-number"),c=document.getElementById("employee-sap-id"),l=document.getElementById("employee-hire-date"),p=document.getElementById("employee-birth-date"),d=document.getElementById("employee-department"),m=document.getElementById("employee-position"),y=document.getElementById("employee-branch"),v=document.getElementById("employee-location"),b=document.getElementById("employee-gender"),f=document.getElementById("employee-national-id"),g=document.getElementById("employee-email"),E=document.getElementById("employee-phone"),h=document.getElementById("employee-insurance-number");if(!s||!r||!c||!d||!m||!y||!v||!b||!g||!E){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649.");return}const u=!!this.currentEditId,x=u&&i?.hireDate||"",w=u&&i?.birthDate||"",S={id:r.value.trim()||this.currentEditId||Utils.generateId("EMP"),name:s.value.trim(),employeeNumber:r.value.trim(),sapId:c.value.trim(),hireDate:l?.value?this.normalizeDateOnly(l.value):u?this.normalizeDateOnly(x):this.normalizeDateOnly(new Date),birthDate:p?.value?this.normalizeDateOnly(p.value):u?this.normalizeDateOnly(w):"",department:d.value.trim(),job:m.value.trim(),position:m.value.trim(),branch:y.value.trim(),location:v.value.trim(),gender:b.value,nationalId:f?.value.trim()||"",email:g.value.trim(),phone:E.value.trim(),insuranceNumber:h?.value.trim()||"",photo:o,status:u&&i?.status||"active",resignationDate:u&&i?.resignationDate||"",createdAt:this.currentEditId?i?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};if(!S.name||!S.sapId||!S.employeeNumber||!S.department||!S.position){Notification.error("\u064A\u0631\u062C\u0649 \u0645\u0644\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 (\u0627\u0644\u0627\u0633\u0645\u060C \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0642\u0633\u0645\u060C \u0627\u0644\u0645\u0646\u0635\u0628)"),t&&(t.disabled=!1,t.innerHTML=a);return}const A=String(S.id||"").trim();if(!A){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D (\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u0646\u0634\u0627\u0621 id \u0641\u0627\u0631\u063A)"),t&&(t.disabled=!1,t.innerHTML=a);return}if(AppState.appData.employees.some(k=>{const I=String(k?.id||"").trim();return!I||this.currentEditId&&I===String(this.currentEditId).trim()?!1:I===A})){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u0645\u0633\u062A\u062E\u062F\u0645 \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0631\u0642\u0645 \u0622\u062E\u0631."),t&&(t.disabled=!1,t.innerHTML=a);return}Loading.show();try{if(this.currentEditId){const k=AppState.appData.employees.findIndex(I=>I.id===this.currentEditId);k!==-1&&(AppState.appData.employees[k]=S,this.currentEditId=A),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D")}else AppState.appData.employees.push(S),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D");typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("Employees",AppState.appData.employees),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),t&&(t.disabled=!1,t.innerHTML=a),this.renderStatsCards(),this.showList()}catch(k){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+k.message),t&&(t.disabled=!1,t.innerHTML=a)}},async convertImageToBase64(e){return new Promise((t,a)=>{const i=new FileReader;i.onload=()=>t(i.result),i.onerror=a,i.readAsDataURL(e)})},async showList(){this.currentEditId=null,!this.canViewEmployeesRegistryTab()&&this.canViewEmployeesAnalysisTab()?this.activeTab="data-analysis":!this.canViewEmployeesRegistryTab()&&this.canViewExternalWorkforceTab()?this.activeTab="external-workforce":!this.canViewExternalWorkforceTab()&&!this.canViewEmployeesAnalysisTab()&&(this.activeTab="employees-list");const e=document.getElementById("employees-content");e&&(e.innerHTML=await this.renderList(),this.applyModuleI18n(e),requestAnimationFrame(()=>{this.setupEventListeners(),this.canViewEmployeesRegistryTab()&&this.activeTab==="employees-list"?this.loadEmployeesList():this.activeTab==="data-analysis"&&this.canViewEmployeesAnalysisTab()?this.loadEmployeesAnalysis().catch(()=>{}):this.canViewExternalWorkforceTab()&&(this.populateExternalWorkforceYearSelector(),this.ensureExternalWorkforceDataLoaded().then(()=>this.renderExternalWorkforceTable()).catch(()=>{})),this.activeTab==="employees-list"&&this.scrollToSearchField()}))},async editEmployee(e){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const t=AppState.appData.employees.find(a=>a.id===e);t&&await this.showForm(t)},async printEmployee(e){const t=AppState.appData.employees.find(a=>a.id===e);if(!t){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}try{Loading.show();let a="";const i=this._normalizeEmployeePhotoUrl(t.photo,t.id);if(i&&typeof Utils.resolveDriveAwareImgDisplay=="function"){const g=Utils.resolveDriveAwareImgDisplay(i);if(g.needsProxy&&typeof Utils.fetchDriveImageDataUri=="function")try{a=await Utils.fetchDriveImageDataUri(g.proxyFileId)||""}catch{a=""}a||(a=g.canonical||i)}else i&&(a=i);const o=this.formatDateSafe(t.birthDate),n=this.formatDateSafe(t.hireDate),s=this.calculateAge(t.birthDate),r=g=>{if(!g)return"-";try{const E=new Date(g),h=E.getFullYear(),u=E.getMonth()+1,x=E.getDate(),w=["\u0660","\u0661","\u0662","\u0663","\u0664","\u0665","\u0666","\u0667","\u0668","\u0669"],S=A=>String(A).split("").map($=>w[parseInt($)]||$).join("");return`${S(h)}/${S(u)}/${S(x)}`}catch{return g}},c=new Date,l=r(c.toISOString().split("T")[0]),p=c.toLocaleTimeString("ar-SA",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}),d=AppState?.companySettings?.name||AppState?.appData?.companyName||"\u0627\u0644\u0634\u0631\u0643\u0629",m=`
                ...
                <div class="employee-card">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="print-date">\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0637\u0628\u0627\u0639\u0629: ${l} - ${p}</div>
                    </div>
                </div>
            `,y=`<!DOCTYPE html>
...
\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: \u0647\u0630\u0647 \u0627\u0644\u0639\u0645\u0644\u064A\u0629 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647\u0627!`)){Loading.show();try{AppState.appData.employees=(AppState.appData.employees||[]).filter(a=>a.id!==e),setTimeout(()=>{typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},50),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D"),this.renderStatsCards();const t=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(t),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(a){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",a)}}),AppState.googleConfig?.appsScript?.enabled&&GoogleIntegration.sendToAppsScript("deleteEmployee",{employeeId:e}).then(a=>{!a||!a.success?Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 Google Sheets:",a?.message):Utils.safeLog("\u2705 \u062A\u0645 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}).catch(a=>Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062D\u0630\u0641 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",a))}catch(t){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}}},scrollToSearchField(){setTimeout(()=>{const e=document.getElementById("employees-search");if(e){const t=window.scrollY||document.documentElement.scrollTop,a=Math.max(0,(e.offsetTop||0)-20),i=t+window.innerHeight;(a<t||a>i-100)&&window.scrollTo({top:a,behavior:"smooth"})}},0)},getFilterValues(){return{search:document.getElementById("employees-search-filter")?.value||document.getElementById("employees-search")?.value||"",department:document.getElementById("employee-filter-department")?.value||"",branch:document.getElementById("employee-filter-branch")?.value||"",location:document.getElementById("employee-filter-location")?.value||"",job:document.getElementById("employee-filter-job")?.value||"",position:document.getElementById("employee-filter-position")?.value||"",gender:document.getElementById("employee-filter-gender")?.value||"",showInactive:document.getElementById("show-inactive-employees")?.checked||!1}},async filterEmployees(e="",t=!1,a=null){try{if(a)t=a.showInactive!==void 0&&a.showInactive!==null?a.showInactive:t;else{const l=this.getFilterValues();e=e||l.search,t=t??(l.showInactive||!1),a=l,a.showInactive=t}const i=document.getElementById("employees-table-container");if(!i){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}let o=i.querySelector("tbody");if(!o&&(await this.loadEmployeesList(t),o=i.querySelector("tbody"),!o)){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F tbody \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0628\u0639\u062F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629");return}let n=(AppState.appData.employees||[]).map(l=>this.sanitizeEmployeeRecordDrift_({...l||{}}));if(AppState.appData.employees=n,!t){const l=n.length,p=n.filter(d=>!this.isEmployeeInactive(d));p.length===0&&l>0?Utils.safeWarn("\u26A0\uFE0F filterEmployees: \u0627\u0644\u062A\u0635\u0641\u064A\u0629 \u0623\u062E\u0641\u062A \u0627\u0644\u062C\u0645\u064A\u0639 \u2014 \u0639\u0631\u0636 \u0627\u0644\u0643\u0644"):n=p}let s=n;const r=this.canEditOrDelete();if(e&&e.trim()){const l=e.trim().toLowerCase();s=s.filter(p=>p.name&&p.name.toLowerCase().includes(l)||p.employeeNumber&&String(p.employeeNumber).toLowerCase().includes(l)||p.sapId&&String(p.sapId).toLowerCase().includes(l)||p.department&&p.department.toLowerCase().includes(l)||p.position&&p.position.toLowerCase().includes(l)||p.job&&p.job.toLowerCase().includes(l)||p.branch&&p.branch.toLowerCase().includes(l)||p.location&&p.location.toLowerCase().includes(l)||p.nationalId&&p.nationalId.toLowerCase().includes(l)||p.phone&&p.phone.toLowerCase().includes(l)||p.insuranceNumber&&p.insuranceNumber.toLowerCase().includes(l)||p.email&&p.email.toLowerCase().includes(l)||p.gender&&p.gender.toLowerCase().includes(l))}a.department&&(s=s.filter(l=>String(l.department||"").trim()===String(a.department).trim())),a.branch&&(s=s.filter(l=>String(l.branch||"").trim()===String(a.branch).trim())),a.location&&(s=s.filter(l=>String(l.location||"").trim()===String(a.location).trim())),a.job&&(s=s.filter(l=>String(l.job||"").trim()===String(a.job).trim())),a.position&&(s=s.filter(l=>String(l.position||"").trim()===String(a.position).trim())),a.gender&&(s=s.filter(l=>String(l.gender||"").trim()===String(a.gender).trim()));const c=13;if(s.length===0){const l=document.createElement("tr");l.innerHTML=`<td colspan="${c}" class="text-center text-gray-500 py-8">\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C</td>`,o.innerHTML="",o.appendChild(l);const p=document.getElementById("employees-load-more-wrap");p&&p.remove(),this._listRowsCache=[],this._listVisibleCount=0}else{const l=document.createDocumentFragment();for(let d=0;d<s.length;d++)l.appendChild(this.buildEmployeeTableRowElement_(s[d],r));o.innerHTML="",o.appendChild(l),this._listRowsCache=s,this._listVisibleCount=s.length,this._listCanEdit=r;const p=document.getElementById("employees-load-more-wrap");p&&p.remove()}typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(o,{onFetchFail:l=>{try{const p=(l.dataset.photoKey||"").trim();p&&sessionStorage.setItem(this._photoFailKey(p),Date.now().toString())}catch{}try{const p=l.parentElement;p&&(p.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}}),this.updateFilterBadges(n,s,a),AppState.debugMode&&e&&Utils.safeLog(`\u{1F50D} \u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0628\u062D\u062B: ${s.length} \u0645\u0646 ${n.length} \u0645\u0648\u0638\u0641`)}catch(i){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A filterEmployees:",i)}},updateFilterBadges(e,t,a){try{if(!a){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F updateFilterBadges: filters \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}const i=(o,n,s)=>{try{const r=document.getElementById(o);if(!r){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: ${o} \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F`);return}const c=r.closest(".filter-field");if(!c){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-field \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const l=c.querySelector(".filter-label");if(!l){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-label \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const p=l.querySelector(".filter-count-badge");if(p&&p.remove(),n&&n.trim()!==""){const d=document.createElement("span");d.className="filter-count-badge",d.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",d.textContent=s;const m=l.querySelector("i");m?m.insertAdjacentElement("afterend",d):l.insertBefore(d,l.firstChild),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0639\u062F\u062F (${s}) \u0644\u0640 ${o}`)}}catch(r){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0641\u0644\u062A\u0631:",r)}};if(a.department?i("employee-filter-department",a.department,t.length):i("employee-filter-department","",0),a.branch?i("employee-filter-branch",a.branch,t.length):i("employee-filter-branch","",0),a.location?i("employee-filter-location",a.location,t.length):i("employee-filter-location","",0),a.job?i("employee-filter-job",a.job,t.length):i("employee-filter-job","",0),a.position?i("employee-filter-position",a.position,t.length):i("employee-filter-position","",0),a.gender?i("employee-filter-gender",a.gender,t.length):i("employee-filter-gender","",0),a.search&&a.search.trim())try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const n=o.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const r=s.querySelector(".filter-count-badge");r&&r.remove();const c=document.createElement("span");c.className="filter-count-badge",c.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",c.textContent=t.length;const l=s.querySelector("i");l?l.insertAdjacentElement("afterend",c):s.insertBefore(c,s.firstChild)}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}else try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const n=o.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const r=s.querySelector(".filter-count-badge");r&&r.remove()}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0625\u0632\u0627\u0644\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}}catch(i){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A updateFilterBadges:",i)}},async applyFilters(){try{const e=this.getFilterValues();await this.filterEmployees(e.search,e.showInactive,e),this.updateInactiveCount()}catch(e){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A applyFilters:",e)}finally{this.updateInactiveCount()}},async resetFilters(){const e=document.getElementById("employees-search"),t=document.getElementById("employees-search-filter");e&&(e.value=""),t&&(t.value=""),["employee-filter-department","employee-filter-branch","employee-filter-location","employee-filter-job","employee-filter-position","employee-filter-gender"].forEach(n=>{const s=document.getElementById(n);s&&(s.value="")});const i=document.getElementById("show-inactive-employees");i&&(i.checked=!1);const o=document.getElementById("show-inactive-employees-container");o&&(o.style.background="linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)",o.style.borderColor="#dee2e6",o.style.boxShadow="none"),await this.applyFilters(),this.updateInactiveCount()},updateInactiveCount(e=0){const i=()=>{try{const n=(AppState.appData.employees||[]).filter(r=>this.isEmployeeInactive(r)).length,s=document.getElementById("inactive-employees-count");if(s){s.textContent=n;const r=n===0,c=r?"#6b7280":"#dc2626",l=r?"0 2px 4px rgba(107, 114, 128, 0.3)":"0 2px 4px rgba(220, 38, 38, 0.3)";s.style.cssText=`
    ...
    `,c=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${e.year}`,o,r,!1,!0,{version:"1.0",releaseDate:n,revisionDate:n,includeQRCode:!0},n,n):`<!DOCTYPE html><html lang="${i.lang}" dir="${i.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${i.dir};padding:20px;">${r}</body></html>`,l=new Blob(["\uFEFF"+c],{type:"text/html;charset=utf-8"}),p=URL.createObjectURL(l),d=window.open(p,"_blank");if(!d){URL.revokeObjectURL(p),Notification.error("\u062A\u0639\u0630\u0631 \u0641\u062A\u062D \u0646\u0627\u0641\u0630\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629");return}d.onload=()=>{setTimeout(()=>{d.print(),setTimeout(()=>URL.revokeObjectURL(p),1e3)},400)}},(function(){"use strict";try{typeof window<"u"&&typeof Employees<"u"&&(window.Employees=Employees,typeof AppState<"u"&&AppState.debugMode&&typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u2705 Employees module loaded and available on window.Employees"),typeof AppState<"u"&&AppState.currentUser&&setTimeout(()=>{window.Employees&&window.Employees.init&&window.Employees.init().catch(e=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u0647\u064A\u0626\u0629 \u0645\u0648\u062F\u064A\u0648\u0644 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",e)})},2e3))}catch{if(typeof window<"u"&&typeof Employees<"u")try{window.Employees=Employees}catch{}}})();
