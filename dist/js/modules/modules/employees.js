const Employees={cache:{data:null,lastLoad:null,lastUpdate:null,isUpdating:!1},config:{cacheTimeout:3e5,backgroundUpdateInterval:6e5,backgroundUpdateTimer:null,_refreshedOnceForInactive:!1},activeTab:"employees-list",externalWorkforceYear:new Date().getFullYear(),_externalWorkforceLoaded:!1,_externalWorkforceLoadPromise:null,_externalWorkforceCache:new Map,_empAnalyticsCharts:{},_empAnalyticsDetailTab:"department",_empAnalyticsEventsBound:!1,_getI18nCore(){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n:window.I18n&&typeof window.I18n.t=="function"?window.I18n:null},t(e,t){const a=this._getI18nCore();return a?a.t(e,null,t||e):t||e},applyModuleI18n(e){const t=this._getI18nCore();if(!t)return;const a=e||document.getElementById("employees-section")||document;typeof t.applyI18n=="function"&&t.applyI18n(a),typeof t.applyLiteralTranslations=="function"&&t.applyLiteralTranslations(a)},_photoFailKey(e){return`hse_emp_photo_failed_${String(e||"").trim()}`},_getDriveIdFromUrl(e){try{const t=String(e||"").trim();if(!t)return"";const a=t.match(/[?&]id=([^&]+)/)||t.match(/\/file\/d\/([^/]+)/);return a?String(a[1]||"").trim():""}catch{return""}},_normalizeEmployeePhotoUrl(e,t=""){try{const a=typeof Utils<"u"&&typeof Utils.extractImageSourceCandidate=="function"?String(Utils.extractImageSourceCandidate(e)||"").trim():String(e||"").trim();if(!a)return"";let i=a;typeof Utils<"u"&&typeof Utils.normalizeImageSource=="function"?i=Utils.normalizeImageSource(a)||a:typeof window<"u"&&typeof window.__convertGoogleDriveUrl=="function"&&(i=window.__convertGoogleDriveUrl(a)||a);const n=this._getDriveIdFromUrl(i)||t||i;return sessionStorage.getItem(this._photoFailKey(n))?"":i}catch{return""}},_setupEmployeePhotoFallbacks(e){try{const a=(e||document).querySelectorAll('img[data-emp-photo="1"]');if(!a||a.length===0)return;a.forEach(i=>{if(!i||i.dataset._fallbackBound==="1")return;i.dataset._fallbackBound="1";const o=(i.dataset.photoKey||"").trim();i.addEventListener("error",()=>{try{o&&sessionStorage.setItem(this._photoFailKey(o),Date.now().toString())}catch{}try{const n=i.parentElement;n&&(n.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}},{passive:!0})})}catch{}},canEditOrDelete(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},canAddOrImport(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},getEmployeesDetailedPermissionsState(){try{if(typeof Permissions<"u"&&typeof Permissions.getEffectivePermissions=="function"){const a=Permissions.getEffectivePermissions()?.employeesPermissions;if(a&&typeof a=="object"&&!Array.isArray(a))return a}}catch{}const e=AppState.currentUser?.permissions?.employeesPermissions;return e&&typeof e=="object"&&!Array.isArray(e)?e:null},canViewEmployeesRegistryTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["employees-list"]!==!1:!0},canViewExternalWorkforceTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["external-workforce"]===!0:!0},canViewEmployeesAnalysisTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["data-analysis"]!==!1:!0},canManageExternalWorkforceTab(){return this.canAddOrImport()},isValidDate(e){if(!e)return!1;try{const t=new Date(e);return t instanceof Date&&!isNaN(t.getTime())}catch{return!1}},normalizeDateOnly(e){if(e==null||e==="")return"";if(e instanceof Date&&!isNaN(e.getTime())){const n=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),l=String(e.getDate()).padStart(2,"0");return`${n}-${s}-${l}`}if(typeof e=="number"&&isFinite(e))try{if(typeof XLSX<"u"&&XLSX?.SSF?.parse_date_code){const n=XLSX.SSF.parse_date_code(e);if(n&&n.y&&n.m&&n.d){const s=String(n.y).padStart(4,"0"),l=String(n.m).padStart(2,"0"),d=String(n.d).padStart(2,"0");return`${s}-${l}-${d}`}}}catch{}let t=String(e).trim();if(!t)return"";if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const n=JSON.parse(t);typeof n=="string"?t=n.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return""}const a=t.match(/^(\d{4}-\d{2}-\d{2})/);if(a)return a[1];const i=t.match(/^(\d{1,2})[\/\-](\d{1,2})[\/\-](\d{2,4})$/);if(i){const n=String(i[1]).padStart(2,"0"),s=String(i[2]).padStart(2,"0");return`${i[3].length===2?`20${i[3]}`:String(i[3]).padStart(4,"0")}-${s}-${n}`}const o=t.match(/^(\d{4})[\/\-](\d{1,2})[\/\-](\d{1,2})$/);if(o){const n=String(o[1]).padStart(4,"0"),s=String(o[2]).padStart(2,"0"),l=String(o[3]).padStart(2,"0");return`${n}-${s}-${l}`}try{const n=new Date(t);if(!isNaN(n.getTime())){const s=n.getFullYear(),l=String(n.getMonth()+1).padStart(2,"0"),d=String(n.getDate()).padStart(2,"0");return`${s}-${l}-${d}`}}catch{}return""},parseLocalDate(e){if(!e)return null;if(e instanceof Date&&!isNaN(e.getTime()))return e;let t=String(e).trim();if(!t)return null;if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const o=JSON.parse(t);typeof o=="string"?t=o.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return null}const a=t.match(/^(\d{4})-(\d{2})-(\d{2})/);if(a){const o=Number(a[1]),n=Number(a[2])-1,s=Number(a[3]),l=new Date(o,n,s);return isNaN(l.getTime())?null:l}const i=new Date(t);return isNaN(i.getTime())?null:i},formatDateSafe(e){return this.normalizeDateOnly(e)},calculateAge(e){if(!e)return"";try{const t=this.parseLocalDate(e);if(!t)return"";const a=new Date;let i=a.getFullYear()-t.getFullYear();const o=a.getMonth()-t.getMonth();return(o<0||o===0&&a.getDate()<t.getDate())&&i--,i>=0?i:""}catch{return""}},async load(){if(this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{typeof AppState<"u"&&AppState._languageRefresh||this.load()}),this._languageChangeListenerAdded=!0),typeof Utils>"u")return;if(typeof AppState>"u"){const t=document.getElementById("employees-section");t&&(t.innerHTML=`
            ...
            `,this.applyModuleI18n(e),setTimeout(async()=>{try{const a=document.getElementById("employees-content");if(!a)return;const i=await this.renderList().catch(o=>(Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629:",o),`
                ...
                `,this.applyModuleI18n(e))}},isEmployeeInactive(e){if(!e)return!1;const t=e.status!=null&&e.status!==""?String(e.status).trim():"";return!!((e.resignationDate!=null&&e.resignationDate!==""?String(e.resignationDate).trim():"")||t==="inactive"||t.toLowerCase()==="inactive"||t==="\u063A\u064A\u0631 \u0646\u0634\u0637")},calculateStatistics(){const e=AppState.appData.employees||[];if(e.length===0)return{total:0,averageAge:0,genderStats:{male:0,female:0},averageExperience:0,inactiveCount:0};const t=e.filter(u=>!this.isEmployeeInactive(u)),a=t.length;let i=0,o=0;t.forEach(u=>{const y=this.calculateAge(u.birthDate);y&&y>0&&(i+=y,o++)});const n=o>0?Math.round(i/o):0;let s=0,l=0,d=0;const m=u=>{if(!u)return"";let y=String(u).trim().replace(/\s+/g," ").trim();return y=y.replace(/[\u200B-\u200D\uFEFF]/g,""),y},r=u=>{const y=m(u);if(!y)return{isMale:!1,isFemale:!1};const E=y.toLowerCase(),h=y.length===1?y.toUpperCase():"",p=["\u0630\u0643\u0631","male","m","M","\u0630\u0643\u0631 "," \u0630\u0643\u0631"],v=["\u0623\u0646\u062B\u0649","female","f","F","\u0623\u0646\u062B\u0649 "," \u0623\u0646\u062B\u0649"],w=y==="\u0630\u0643\u0631"||E==="male"||h==="M"||p.some($=>m($)===y),k=y==="\u0623\u0646\u062B\u0649"||E==="female"||h==="F"||v.some($=>m($)===y);return{isMale:w,isFemale:k,normalized:y}};t.forEach(u=>{const y=r(u.gender);y.isMale?s++:y.isFemale?l++:d++}),d>0&&typeof AppState<"u"&&AppState.debugMode&&typeof console<"u";let c=0,f=0;const g=new Date;t.forEach(u=>{if(u.hireDate)try{const y=this.parseLocalDate(u.hireDate);if(y){const E=g.getFullYear()-y.getFullYear(),h=g.getMonth()-y.getMonth(),p=g.getDate()-y.getDate();let v=E;(h<0||h===0&&p<0)&&v--,v>=0&&(c+=v,f++)}}catch{}});const x=f>0?(c/f).toFixed(1):0,b=e.filter(u=>this.isEmployeeInactive(u)).length;return{total:a,averageAge:n,genderStats:{male:s,female:l},averageExperience:parseFloat(x),inactiveCount:b}},ensureEmployeesStatsCardsStyles(){const e="employees-stats-cards-styles-v2";if(document.getElementById(e))return;document.getElementById("employees-stats-cards-styles")?.remove();const a=document.createElement("style");a.id=e,a.textContent=`
        ...
        `,s=l=>{const d=l.maleCount||0,m=l.femaleCount||0,r=d+m,c=r>0?Math.round(d/r*100):0,f=r>0?100-c:0;return`
                    ...
                    ${r>0?`
                        <div class="employee-stat-gender-row">
                            <div class="employee-stat-gender-item employee-stat-gender-item--male" title="${i}: ${d}">
                                ...
                                <span class="employee-stat-gender-pct">${c}%</span>
                            </div>
        ...
        `,d=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${e.year}`,o,l,!1,!0,{version:"1.0",source:"ExternalWorkforceMonthly",reportYear:e.year,releaseDate:n,revisionDate:n},n,n):`<!DOCTYPE html><html lang="${i.lang}" dir="${i.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${i.dir};padding:20px;">${l}</body></html>`,m=new Blob(["\uFEFF"+d],{type:"text/html;charset=utf-8"}),r=URL.createObjectURL(m),c=window.open(r,"_blank");if(!c){URL.revokeObjectURL(r),Notification.error("Unable to open print window");return}c.onload=()=>{setTimeout(()=>{c.print(),setTimeout(()=>URL.revokeObjectURL(r),1e3)},400)}},async importExternalWorkforceExcelFile(e){if(!(!e||!this.canManageExternalWorkforceTab())){if(typeof XLSX>"u"){Notification.error("XLSX library is not available");return}Loading.show();try{const t=await e.arrayBuffer(),a=XLSX.read(t,{type:"array",cellDates:!0}),i=a.Sheets[a.SheetNames[0]],o=XLSX.utils.sheet_to_json(i,{header:1,defval:"",raw:!1});if(!Array.isArray(o)||o.length<2)throw new Error("File is empty");const n=o[0].map(b=>String(b||"").trim().toLowerCase()),s=this.getAvailableContractorsForExternalWorkforce(),l=Number(this.externalWorkforceYear),d={jan:0,january:0,feb:1,february:1,mar:2,march:2,apr:3,april:3,may:4,jun:5,june:5,jul:6,july:6,aug:7,august:7,sep:8,sept:8,september:8,oct:9,october:9,nov:10,november:10,dec:11,december:11,\u064A\u0646\u0627\u064A\u0631:0,\u0641\u0628\u0631\u0627\u064A\u0631:1,\u0645\u0627\u0631\u0633:2,\u0623\u0628\u0631\u064A\u0644:3,\u0627\u0628\u0631\u064A\u0644:3,\u0645\u0627\u064A\u0648:4,\u064A\u0648\u0646\u064A\u0648:5,\u064A\u0648\u0644\u064A\u0648:6,\u0623\u063A\u0633\u0637\u0633:7,\u0627\u063A\u0633\u0637\u0633:7,\u0633\u0628\u062A\u0645\u0628\u0631:8,\u0623\u0643\u062A\u0648\u0628\u0631:9,\u0627\u0643\u062A\u0648\u0628\u0631:9,\u0646\u0648\u0641\u0645\u0628\u0631:10,\u062F\u064A\u0633\u0645\u0628\u0631:11},m=this.getExternalWorkforceMonths().map(b=>b.key),r=n.findIndex(b=>b.includes("contractor")||b.includes("company")||b.includes("\u0627\u0644\u0634\u0631\u0643\u0629")||b.includes("\u0627\u0644\u0645\u0642\u0627\u0648\u0644")),c=n.findIndex(b=>b==="code"||b.includes("contractor code")||b.includes("\u0627\u0644\u0643\u0648\u062F")),f={};n.forEach((b,u)=>{const y=b.replace(/\./g,"").trim();d[y]!==void 0&&(f[m[d[y]]]=u)});const g=this.getExternalWorkforceRecords();let x=0;o.slice(1).forEach(b=>{const u=r>=0?String(b[r]||"").trim():"",y=c>=0?String(b[c]||"").trim():"";if(!u&&!y)return;const E=s.find(p=>y&&(p.contractorCode||"").trim().toLowerCase()===y.toLowerCase()||u&&p.contractorName.trim().toLowerCase()===u.toLowerCase());if(!E)return;let h=this.getExternalWorkforceRecord(l,E.stableKey);h||(h={id:`EWM-${l}-${E.stableKey}`,year:l,contractorId:E.contractorId||"",contractorCode:E.contractorCode||"",contractorName:E.contractorName||"",createdAt:new Date().toISOString()},g.push(h)),m.forEach(p=>{const v=f[p];v!==void 0&&(h[p]=Math.max(0,parseInt(b[v]||"0",10)||0))}),h.total=m.reduce((p,v)=>p+(parseInt(h[v]||"0",10)||0),0),h.updatedAt=new Date().toISOString(),h.updatedBy=AppState.currentUser?.name||AppState.currentUser?.email||"admin",x+=1}),this._externalWorkforceCache.clear(),this.renderExternalWorkforceTable(),typeof DataManager<"u"&&typeof DataManager.save=="function"&&DataManager.save(),typeof GoogleIntegration<"u"&&typeof GoogleIntegration.autoSave=="function"&&await GoogleIntegration.autoSave("ExternalWorkforceMonthly",g).catch(()=>{}),window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{externalWorkforce:!0,year:l}})),Notification.success(`Imported ${x} rows successfully`)}catch(t){Notification.error(`Failed to import file: ${t.message}`)}finally{Loading.hide()}}},renderExternalWorkforceTable(){const e=document.getElementById("external-workforce-table-container");if(!e)return;const t=this.buildExternalWorkforceModel(this.externalWorkforceYear),a=this.getExternalWorkforceViewState(),{dir:i,stickySide:o,textAlign:n,labels:s}=a;this.renderExternalWorkforceSummary(t);const l=this.canManageExternalWorkforceTab(),d=t.months.map(p=>`<th style="min-width: 74px;">${p.label}</th>`).join(""),m=t.rows.map((p,v)=>{const w=t.months.map((k,$)=>{const D=p.values[$]||0;return`<td style="background:#dceaf6;">${l?`<input type="number" min="0" step="1" class="form-input external-workforce-input" style="min-width:70px;text-align:center;padding:6px 8px;" value="${D}" data-row="${v}" data-contractor-key="${p.stableKey}" data-month="${k.key}" />`:`<span class="font-semibold text-slate-700">${D}</span>`}</td>`}).join("");return`
                <tr>
                    <td class="sticky-cell" style="background:#c7dcef; font-weight:700; text-align:${n};">
                        <div>${Utils.escapeHTML(p.contractorName)}</div>
                        <div class="text-xs text-gray-500 mt-1">${Utils.escapeHTML(p.contractorCode||p.contractorId||"\u0628\u062F\u0648\u0646 \u0643\u0648\u062F")}</div>
                    </td>
                    ${w}
                    <td style="background:#dceaf6; font-weight:800;">${p.total}</td>
                </tr>
            `}).join(""),r=t.monthTotals.map(p=>`<td style="background:#fff6cf; font-weight:800;">${p}</td>`).join(""),c=t.directEmployees.map(p=>`<td style="background:#eef2ff; font-weight:700;">${p}</td>`).join(""),f=t.combined.map(p=>`<td style="background:#ecfdf5; font-weight:800;">${p}</td>`).join(""),g=t.estimatedHours.map(p=>`<td style="background:#fff7ed; font-weight:700;">${p.toLocaleString("en-US")}</td>`).join("");e.innerHTML=`
            <style>
            ...
            <table class="external-workforce-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ${c}
                        <td style="background:#eef2ff; font-weight:900;">${t.directEmployees.reduce((p,v)=>p+v,0)}</td>
                    </tr>
                    <tr>
                        ...
                        ${f}
                        <td style="background:#ecfdf5; font-weight:900;">${t.combined.reduce((p,v)=>p+v,0)}</td>
                    </tr>
                    <tr>
                        ...
                        ${g}
                        <td style="background:#fff7ed; font-weight:900;">${t.estimatedHours.reduce((p,v)=>p+v,0).toLocaleString("en-US")}</td>
                    </tr>
                </tbody>
            </table>
        `;const x=e.querySelector(".external-workforce-table");if(!x)return;let b=e.querySelector(".external-workforce-shell");b||(b=document.createElement("div"),b.className="external-workforce-shell",x.parentNode.insertBefore(b,x),b.appendChild(x)),b.setAttribute("dir",i),Object.assign(b.style,{width:"100%",maxWidth:"100%",maxHeight:"min(70vh, calc(100vh - 260px))",overflow:"auto",border:"1px solid #cbd5e1",borderRadius:"18px",background:"#ffffff"}),Object.assign(x.style,{width:"max(100%, 1180px)",borderCollapse:"separate",borderSpacing:"0",direction:i,tableLayout:"fixed"}),x.querySelectorAll("th, td").forEach(p=>{p.style.padding="clamp(6px, 0.7vw, 10px)",p.style.fontSize="clamp(11px, 0.85vw, 14px)"});const u=Array.from(x.querySelectorAll("thead th"));u.forEach(p=>{p.style.position="sticky",p.style.top="0",p.style.zIndex="4",p.style.background="#b7d2ea"}),u[0]&&(u[0].textContent=s.contractor,u[0].classList.add("sticky-cell"),u[0].style.textAlign=n),u[u.length-1]&&(u[u.length-1].textContent=s.total),x.querySelectorAll(".sticky-cell").forEach(p=>{p.style.position="sticky",p.style.left="",p.style.right="",p.style[o]="0",p.style.zIndex=p.closest("thead")?"6":"2",p.style.minWidth="clamp(170px, 18vw, 240px)",p.style.maxWidth="clamp(170px, 18vw, 260px)",p.style.whiteSpace="normal",p.style.wordBreak="break-word"});const y=Array.from(x.querySelectorAll("tbody tr"));y.slice(0,t.rows.length).forEach((p,v)=>{const w=p.querySelector(".sticky-cell"),k=t.rows[v];!w||!k||(w.style.textAlign=n,w.innerHTML=`
        ...
        `).join("")},_empRenderAnalyticsBreadcrumb(e){const t=document.getElementById("emp-analytics-breadcrumb");if(!t)return;const a=[this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")];e.department&&a.push(e.department),e.job&&a.push(e.job),t.innerHTML=a.map((i,o)=>{const n=o===a.length-1;return`<span class="emp-analytics-crumb${n?" emp-analytics-crumb--active":""}">${Utils.escapeHTML(i)}</span>${n?"":'<span class="emp-analytics-crumb-sep">\u203A</span>'}`}).join("")},_empPopulateAnalyticsFilterOptions(e){const t=Array.isArray(e)?e:[],a=n=>[...new Set(t.map(s=>this._empAnalyticsLabel(s[n])).filter(Boolean))].sort((s,l)=>s.localeCompare(l,"ar")),i=(n,s,l)=>{const d=document.getElementById(n);if(!d)return;const m=l||d.value;d.innerHTML=`<option value="">${this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")}</option>`+s.map(r=>`<option value="${Utils.escapeHTML(r)}"${r===m?" selected":""}>${Utils.escapeHTML(r)}</option>`).join("")},o=this._empGetAnalyticsFiltersFromDom();i("emp-af-department",a("department"),o.department),i("emp-af-job",a("job"),o.job),i("emp-af-branch",a("branch"),o.branch),i("emp-af-location",a("location"),o.location),i("emp-af-position",a("position"),o.position)},_empRenderAnalyticsHeatmap(e){const t=document.getElementById("emp-analytics-heatmap");if(!t)return;const a=e.departmentJobMatrix||{},i=Object.entries(a).map(([m,r])=>{const[c,f]=m.split("|||");return{dept:c,job:f,count:r}}).sort((m,r)=>r.count-m.count);if(!i.length){t.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const o=[...new Set(i.slice(0,12).map(m=>m.dept))],n=[...new Set(i.slice(0,12).map(m=>m.job))],s=Math.max(...i.map(m=>m.count),1),l={};i.forEach(m=>{l[m.dept+"|||"+m.job]=m.count});let d='<table class="emp-analytics-heatmap-table"><thead><tr><th></th>';n.forEach(m=>{d+=`<th title="${Utils.escapeHTML(m)}">${Utils.escapeHTML(m.length>14?m.slice(0,14)+"\u2026":m)}</th>`}),d+="</tr></thead><tbody>",o.forEach(m=>{d+=`<tr><th title="${Utils.escapeHTML(m)}">${Utils.escapeHTML(m.length>16?m.slice(0,16)+"\u2026":m)}</th>`,n.forEach(r=>{const c=l[m+"|||"+r]||0,f=c>0?.15+c/s*.85:0,g=c>0?`rgba(29, 78, 216, ${f})`:"#f8fafc",x=f>.5?"#fff":"#334155";d+=`<td class="emp-analytics-heatmap-cell" data-dept="${Utils.escapeHTML(m)}" data-job="${Utils.escapeHTML(r)}" style="background:${g};color:${x};" title="${Utils.escapeHTML(m)} / ${Utils.escapeHTML(r)}: ${c}">${c||""}</td>`}),d+="</tr>"}),d+="</tbody></table>",t.innerHTML=d,t.querySelectorAll(".emp-analytics-heatmap-cell").forEach(m=>{m.addEventListener("click",()=>{const r=m.getAttribute("data-dept")||"",c=m.getAttribute("data-job")||"";!r&&!c||(this._empApplyAnalyticsFilter("department",r,{skipUpdate:!0}),this._empApplyAnalyticsFilter("job",c))})})},_empRenderAnalyticsDetailTable(e){const t=document.getElementById("emp-analytics-detail-table");if(!t)return;const a=this._empAnalyticsDetailTab||"department",i=a==="job"?e.byJob:e.byDepartment,o=a==="job"?this.t("module.employees.job","\u0627\u0644\u0648\u0638\u064A\u0641\u0629"):this.t("module.employees.department","\u0627\u0644\u0642\u0633\u0645"),n=a==="job"?"job":"department";if(!i.length){t.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const l=this._empGetAnalyticsFiltersFromDom()[n];t.innerHTML=`
            <table class="emp-analytics-detail-table">
                ...
                <tbody>
                    ${i.map(d=>`
                        <tr class="emp-analytics-detail-row${l===d.label?" emp-analytics-detail-row--selected":""}" data-filter-key="${n}" data-filter-value="${Utils.escapeHTML(d.label)}">
        ...
        `},async ensureEmployeesLoaded(e=!1){if(this.cache.isUpdating&&!e){for(;this.cache.isUpdating;)await new Promise(i=>setTimeout(i,50));if(AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0)return!0}const t=AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0,a=this.cache.data&&this.cache.lastLoad&&Date.now()-this.cache.lastLoad<this.config.cacheTimeout&&!e;return t&&a?(AppState.debugMode&&Utils.safeLog(`\u2705 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 Cache (${this.cache.data.length} \u0645\u0648\u0638\u0641)`),this.cache.data&&this.cache.data.length>0&&(AppState.appData.employees=this.cache.data),!this.config._refreshedOnceForInactive&&AppState.appData.employees.length>0&&AppState.googleConfig?.appsScript?.enabled&&(AppState.appData.employees||[]).filter(o=>this.isEmployeeInactive(o)).length===0&&(this.config._refreshedOnceForInactive=!0,this.loadEmployeesFromBackend(!0).then(()=>{window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{}}))}).catch(()=>{})),!0):t&&!a&&!e?(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),this.updateEmployeesInBackground(),!0):await this.loadEmployeesFromBackend(e)},async loadEmployeesFromBackend(e=!1){if(this.cache.isUpdating&&!e){for(AppState.debugMode&&Utils.safeLog("\u26A0\uFE0F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630 \u0628\u0627\u0644\u0641\u0639\u0644\u060C \u0627\u0646\u062A\u0638\u0627\u0631...");this.cache.isUpdating;)await new Promise(t=>setTimeout(t,50));if(AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0)return!0}this.cache.isUpdating=!0;try{if(!AppState.googleConfig?.appsScript?.enabled||!AppState.googleConfig?.appsScript?.scriptUrl)return AppState.debugMode&&Utils.safeLog("\u26A0\uFE0F Google Apps Script \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644 - \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629 \u0641\u0642\u0637"),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1;if(typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F GoogleIntegration \u063A\u064A\u0631 \u0645\u062A\u0627\u062D"),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1;try{const t=await GoogleIntegration.sendRequest({action:"getAllEmployees",data:{filters:{includeInactive:!0}}});if(t&&t.success&&Array.isArray(t.data))return AppState.appData.employees=t.data,this.cache.data=t.data,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${t.data.length} \u0645\u0648\u0638\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A`),this.cache.isUpdating=!1,!0;{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F getAllEmployees \u0641\u0634\u0644\u060C \u062C\u0627\u0631\u064A \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0628\u0640 readFromSheet...");const a=await GoogleIntegration.sendRequest({action:"readFromSheet",data:{sheetName:"Employees",spreadsheetId:AppState.googleConfig.sheets.spreadsheetId}});if(a&&a.success&&Array.isArray(a.data))return AppState.appData.employees=a.data,this.cache.data=a.data,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${a.data.length} \u0645\u0648\u0638\u0641 \u0645\u0646 Google Sheets`),this.cache.isUpdating=!1,!0}}catch(t){return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 Backend:",t),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1}return this.cache.isUpdating=!1,!1}catch(t){return AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A loadEmployeesFromBackend:",t),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1}},async updateEmployeesInBackground(){if(!this.cache.isUpdating){this.cache.isUpdating=!0;try{if(!AppState.googleConfig?.appsScript?.enabled||!AppState.googleConfig?.appsScript?.scriptUrl||typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return;const e=await GoogleIntegration.sendRequest({action:"getAllEmployees",data:{filters:{includeInactive:!0}}});if(e&&e.success&&Array.isArray(e.data)){const t=AppState.appData.employees?.length||0,a=e.data.length;(t!==a||JSON.stringify(AppState.appData.employees)!==JSON.stringify(e.data))&&(AppState.appData.employees=e.data,this.cache.data=e.data,this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u{1F504} \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629 (${e.data.length} \u0645\u0648\u0638\u0641)`),window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{count:e.data.length}})))}}catch(e){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",e)}finally{this.cache.isUpdating=!1}}},startBackgroundUpdate(){this.config.backgroundUpdateTimer&&clearInterval(this.config.backgroundUpdateTimer),this.config.backgroundUpdateTimer=setInterval(()=>{this.updateEmployeesInBackground()},this.config.backgroundUpdateInterval),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0628\u062F\u0621 \u0627\u0644\u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A \u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 (\u0643\u0644 ${this.config.backgroundUpdateInterval/6e4} \u062F\u0642\u064A\u0642\u0629)`)},stopBackgroundUpdate(){this.config.backgroundUpdateTimer&&(clearInterval(this.config.backgroundUpdateTimer),this.config.backgroundUpdateTimer=null)},cleanup(){try{AppState.debugMode&&Utils.safeLog("\u{1F9F9} \u062A\u0646\u0638\u064A\u0641 \u0645\u0648\u0627\u0631\u062F Employees module..."),this.stopBackgroundUpdate(),this.handleDataUpdate&&(window.removeEventListener("employeesDataUpdated",this.handleDataUpdate),this.handleDataUpdate=null),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062A\u0646\u0638\u064A\u0641 \u0645\u0648\u0627\u0631\u062F Employees module")}catch(e){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u0646\u0638\u064A\u0641 Employees module:",e)}},async loadEmployeesList(e=!1){const t=document.getElementById("employees-table-container");if(!t){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A loadEmployeesList");return}let a=AppState.appData.employees||[];if(AppState.debugMode&&Utils.safeLog(`\u{1F4CA} loadEmployeesList: \u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 = ${a.length}, showInactive = ${e}`),e)AppState.debugMode&&Utils.safeLog(`\u{1F4CA} \u0639\u0631\u0636 \u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 (\u0628\u0645\u0627 \u0641\u064A \u0630\u0644\u0643 \u063A\u064A\u0631 \u0627\u0644\u0646\u0634\u0637\u064A\u0646): ${a.length}`);else{const r=a.length;a=a.filter(c=>!this.isEmployeeInactive(c)),AppState.debugMode&&Utils.safeLog(`\u{1F4CA} \u0628\u0639\u062F \u0627\u0644\u062A\u0635\u0641\u064A\u0629 (\u0646\u0634\u0637\u064A\u0646 \u0641\u0642\u0637): ${a.length} \u0645\u0646 ${r}`)}this.renderStatsCards(),this.updateInactiveCount();const i=this.canAddOrImport(),o=this.canEditOrDelete(),n=document.createDocumentFragment();if(a.length===0){const r=document.createElement("div");r.className="empty-state",r.innerHTML=`
                ...
                `:""}
            `,n.appendChild(r),t.innerHTML="",t.appendChild(n),requestAnimationFrame(()=>{const c=document.getElementById("add-employee-empty-btn");c&&this.canAddOrImport()&&c.addEventListener("click",()=>this.showForm())});return}const s=document.createElement("div");s.className="table-wrapper",s.style.cssText="width: 100%; max-width: 100%; overflow-x: auto;";const l=document.createElement("table");l.className="data-table table-header-blue",l.style.cssText="width: 100%; min-width: 100%; table-layout: auto;";const d=document.createElement("thead");d.innerHTML=`
            <tr>
        ...
        `;const m=document.createElement("tbody");a.forEach(r=>{const c=this.formatDateSafe(r.birthDate),f=this.formatDateSafe(r.hireDate),g=this.calculateAge(r.birthDate),x=this.isEmployeeInactive(r),b=x?"opacity: 0.7; background-color: #f8f9fa;":"",u=document.createElement("tr");x&&(u.style.cssText=b);const E=(this._getDriveIdFromUrl(r.photo||"")||r.id||r.employeeNumber||r.name||"").toString(),h=this._normalizeEmployeePhotoUrl(r.photo,r.id),p=h&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(h):{canonical:h||"",displaySrc:h||"",needsProxy:!1,proxyFileId:""},v=p.canonical?p.displaySrc:"",w=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(p):"";u.innerHTML=`
                <td style="word-wrap: break-word;">
                    ${h?`<img data-emp-photo="1" data-photo-key="${Utils.escapeHTML(E)}" src="${Utils.escapeHTML(v)}" alt="${Utils.escapeHTML(r.name||"")}"${w} class="w-12 h-12 rounded-full object-cover" loading="lazy" decoding="async" referrerpolicy="no-referrer">`:'<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>'}
                </td>
                ...
                <td style="word-wrap: break-word; white-space: normal;">${c||""}</td>
                <td style="word-wrap: break-word; white-space: normal;">${g?g+" "+this.t("module.common.yearsUnit","\u0633\u0646\u0629"):""}</td>
                <td style="word-wrap: break-word; white-space: normal;">${f||""}</td>
                ...
                `}
            `,m.appendChild(u)}),l.appendChild(d),l.appendChild(m),s.appendChild(l),n.appendChild(s),t.innerHTML="",t.appendChild(n),this.applyModuleI18n(t),typeof requestIdleCallback=="function"?requestIdleCallback(()=>{this._setupEmployeePhotoFallbacks(t),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(t,{onFetchFail:r=>{try{const c=(r.dataset.photoKey||"").trim();c&&sessionStorage.setItem(this._photoFailKey(c),Date.now().toString())}catch{}try{const c=r.parentElement;c&&(c.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}})},{timeout:600}):setTimeout(()=>{this._setupEmployeePhotoFallbacks(t),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(t,{onFetchFail:r=>{try{const c=(r.dataset.photoKey||"").trim();c&&sessionStorage.setItem(this._photoFailKey(c),Date.now().toString())}catch{}try{const c=r.parentElement;c&&(c.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}})},0),this.populateFilters(),requestAnimationFrame(async()=>{try{const r=this.getFilterValues();(r.search||r.department||r.branch||r.location||r.job||r.position||r.gender||r.showInactive)&&await this.applyFilters()}catch(r){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",r)}})},populateFilters(){const e=AppState.appData.employees||[],t=[...new Set(e.map(c=>c.department).filter(Boolean))].sort(),a=[...new Set(e.map(c=>c.branch).filter(Boolean))].sort(),i=[...new Set(e.map(c=>c.location).filter(Boolean))].sort(),o=[...new Set(e.map(c=>c.job||c.position).filter(Boolean))].sort(),n=[...new Set(e.map(c=>c.position||c.job).filter(Boolean))].sort(),s=document.getElementById("employee-filter-department");if(s){const c=s.value;s.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+t.map(f=>`<option value="${Utils.escapeHTML(f)}" ${f===c?"selected":""}>${Utils.escapeHTML(f)}</option>`).join("")}const l=document.getElementById("employee-filter-branch");if(l){const c=l.value;l.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+a.map(f=>`<option value="${Utils.escapeHTML(f)}" ${f===c?"selected":""}>${Utils.escapeHTML(f)}</option>`).join("")}const d=document.getElementById("employee-filter-location");if(d){const c=d.value;d.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+i.map(f=>`<option value="${Utils.escapeHTML(f)}" ${f===c?"selected":""}>${Utils.escapeHTML(f)}</option>`).join("")}const m=document.getElementById("employee-filter-job");if(m){const c=m.value;m.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+o.map(f=>`<option value="${Utils.escapeHTML(f)}" ${f===c?"selected":""}>${Utils.escapeHTML(f)}</option>`).join("")}const r=document.getElementById("employee-filter-position");if(r){const c=r.value;r.innerHTML='<option value="">\u0627\u0644\u0643\u0644</option>'+n.map(f=>`<option value="${Utils.escapeHTML(f)}" ${f===c?"selected":""}>${Utils.escapeHTML(f)}</option>`).join("")}},setupEventListeners(){setTimeout(()=>{window.removeEventListener("employeesDataUpdated",this.handleDataUpdate),this.handleDataUpdate=h=>{if(h.detail?.externalWorkforce){clearTimeout(this._employeesUpdateDebounceTimer),this._externalWorkforceCache.clear(),this._employeesUpdateDebounceTimer=setTimeout(()=>{document.getElementById("external-workforce-table-container")&&this.renderExternalWorkforceTable()},60);return}if(this.activeTab==="data-analysis"&&document.getElementById("emp-analytics-root")){clearTimeout(this._employeesUpdateDebounceTimer),this._employeesUpdateDebounceTimer=setTimeout(()=>{this.updateEmployeesAnalyticsDashboard().catch(()=>{})},120);return}h.detail&&h.detail.count&&(clearTimeout(this._employeesUpdateDebounceTimer),this._employeesUpdateDebounceTimer=setTimeout(()=>{document.getElementById("employees-table-container")?requestAnimationFrame(()=>setTimeout(()=>this.loadEmployeesList(),0)):this.renderStatsCards()},120))},window.addEventListener("employeesDataUpdated",this.handleDataUpdate),document.querySelectorAll("[data-employees-tab]").forEach(h=>{h.addEventListener("click",()=>this.switchTab(h.getAttribute("data-employees-tab")||"employees-list"))}),this.ensureExternalWorkforceToolbar();const e=document.getElementById("external-workforce-year");e&&e.addEventListener("change",async h=>{const p=Number(h.target.value);!Number.isFinite(p)||p<2e3||(this.externalWorkforceYear=p,await this.ensureExternalWorkforceDataLoaded(),this.renderExternalWorkforceTable())});const t=document.getElementById("external-workforce-table-container");if(t){const h=async p=>{const v=p.target;!v||!v.matches(".external-workforce-input")||await this.saveExternalWorkforceValue(v.getAttribute("data-contractor-key")||"",v.getAttribute("data-month")||"",v.value)};t.addEventListener("change",h),t.addEventListener("blur",h,!0)}document.getElementById("external-workforce-export-excel-btn")?.addEventListener("click",()=>{this.exportExternalWorkforceToExcel()}),document.getElementById("external-workforce-export-pdf-btn")?.addEventListener("click",()=>{this.exportExternalWorkforceToPDF()});const a=document.getElementById("external-workforce-import-excel-btn"),i=document.getElementById("external-workforce-import-input");a&&i&&(a.addEventListener("click",()=>i.click()),i.addEventListener("change",async h=>{const p=h.target.files?.[0];p&&(await this.importExternalWorkforceExcelFile(p),h.target.value="")})),this.canViewExternalWorkforceTab()&&(this.populateExternalWorkforceYearSelector(),this.activeTab==="external-workforce"&&this.ensureExternalWorkforceDataLoaded().then(()=>this.renderExternalWorkforceTable()).catch(()=>{}));const o=document.getElementById("add-employee-btn"),n=document.getElementById("add-employee-empty-btn"),s=document.getElementById("import-employees-excel-btn"),l=document.getElementById("refresh-employees-btn"),d=document.getElementById("refresh-employee-names-btn"),m=document.getElementById("delete-all-employees-btn");if(AppState.debugMode&&Utils.safeLog("\u{1F50D} \u0641\u062D\u0635 \u0627\u0644\u0623\u0632\u0631\u0627\u0631:",{refreshBtn:!!l,refreshNamesBtn:!!d,deleteAllBtn:!!m,searchInput:!!document.getElementById("employees-search"),filterSearchInput:!!document.getElementById("employees-search-filter")}),o&&this.canAddOrImport()&&o.addEventListener("click",()=>this.showForm()),n&&this.canAddOrImport()&&n.addEventListener("click",()=>this.showForm()),s&&this.canAddOrImport()&&s.addEventListener("click",()=>this.showImportExcel()),l){const h=l.cloneNode(!0);l.parentNode.replaceChild(h,l),h.addEventListener("click",async()=>{h.disabled=!0;const p=h.innerHTML;h.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u062F\u064A\u062B...',typeof Loading<"u"&&Loading.show();try{if(await this.loadEmployeesFromBackend(!0)){const w=document.getElementById("show-inactive-employees")?.checked||!1;await this.loadEmployeesList(w),await this.applyFilters(),typeof Notification<"u"&&Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}else typeof Notification<"u"&&Notification.warning("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u062C\u062F\u064A\u062F\u0629")}catch(v){typeof Notification<"u"&&Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+v.message),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",v)}finally{typeof Loading<"u"&&Loading.hide(),h.disabled=!1,h.innerHTML=p}})}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0632\u0631 \u0627\u0644\u062A\u062D\u062F\u064A\u062B \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");d&&this.canAddOrImport()&&d.addEventListener("click",async()=>this.refreshEmployeeNames());const r=document.getElementById("report-employee-duplicates-btn");r&&this.canAddOrImport()&&r.addEventListener("click",async()=>this.reportEmployeeDuplicates());const c=document.getElementById("cleanup-employee-duplicates-btn");c&&this.canAddOrImport()&&c.addEventListener("click",async()=>this.cleanupDuplicateEmployees()),m&&this.canAddOrImport()&&m.addEventListener("click",async()=>this.deleteAllEmployees());const f=document.getElementById("employees-search");if(f){const h=f.cloneNode(!0);f.parentNode.replaceChild(h,f);let p=null;const v=async()=>{try{const w=document.getElementById("employees-search-filter");w&&(w.value=h.value),await this.applyFilters()}catch(w){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0628\u062D\u062B:",w)}};h.addEventListener("input",w=>{p&&clearTimeout(p),p=setTimeout(v,300)}),h.addEventListener("keydown",async w=>{w.key==="Enter"&&(w.preventDefault(),p&&clearTimeout(p),await v())})}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062D\u0642\u0644 \u0627\u0644\u0628\u062D\u062B \u0641\u064A header \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");const g=document.getElementById("employees-search-filter");if(g){const h=g.cloneNode(!0);g.parentNode.replaceChild(h,g);let p=null;const v=async()=>{try{f&&(f.value=h.value),await this.applyFilters()}catch(w){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0628\u062D\u062B:",w)}};h.addEventListener("input",w=>{p&&clearTimeout(p),p=setTimeout(v,300)}),h.addEventListener("keydown",async w=>{w.key==="Enter"&&(w.preventDefault(),p&&clearTimeout(p),await v())})}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062D\u0642\u0644 \u0627\u0644\u0628\u062D\u062B \u0641\u064A \u0627\u0644\u0641\u0644\u062A\u0631 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");["employee-filter-department","employee-filter-branch","employee-filter-location","employee-filter-job","employee-filter-position","employee-filter-gender"].forEach(h=>{const p=document.getElementById(h);p&&p.addEventListener("change",async()=>{try{await this.applyFilters()}catch(v){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0641\u0644\u062A\u0631:",v)}})});const b=document.getElementById("employee-reset-filters");if(b){const h=b.cloneNode(!0);b.parentNode.replaceChild(h,b),h.addEventListener("click",async()=>{try{await this.resetFilters()}catch(p){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0639\u0627\u062F\u0629 \u062A\u0639\u064A\u064A\u0646 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",p),typeof Notification<"u"&&Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0625\u0639\u0627\u062F\u0629 \u062A\u0639\u064A\u064A\u0646 \u0627\u0644\u0641\u0644\u0627\u062A\u0631")}})}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0632\u0631 \u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u062A\u0639\u064A\u064A\u0646 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");let u=document.getElementById("show-inactive-employees");if(u){const h=u.cloneNode(!0);u.parentNode.replaceChild(h,u),h.addEventListener("change",async p=>{const v=p.target.checked;AppState.debugMode&&Utils.safeLog(`\u{1F504} \u062A\u063A\u064A\u064A\u0631 \u062D\u0627\u0644\u0629 \u0639\u0631\u0636 \u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u064A\u0646: ${v?"\u0639\u0631\u0636":"\u0625\u062E\u0641\u0627\u0621"}`);try{typeof Loading<"u"&&Loading.show();const w=document.getElementById("show-inactive-employees-container");w&&(v?(w.style.background="linear-gradient(135deg, #fee2e2 0%, #fecaca 100%)",w.style.borderColor="#dc2626",w.style.boxShadow="0 4px 12px rgba(220, 38, 38, 0.2)"):(w.style.background="linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)",w.style.borderColor="#dee2e6",w.style.boxShadow="none")),await this.loadEmployeesList(v);const k=document.getElementById("show-inactive-employees");k&&k.checked!==v&&(k.checked=v),await this.applyFilters(),this.updateInactiveCount(),typeof Notification<"u"&&Notification.success(v?"\u062A\u0645 \u0639\u0631\u0636 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u063A\u064A\u0631 \u0627\u0644\u0646\u0634\u0637\u064A\u0646 (\u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u064A\u0646)":"\u062A\u0645 \u0625\u062E\u0641\u0627\u0621 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u063A\u064A\u0631 \u0627\u0644\u0646\u0634\u0637\u064A\u0646")}catch(w){h.checked=!v,AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629:",w),typeof Notification<"u"&&Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")}finally{typeof Loading<"u"&&Loading.hide(),this.updateInactiveCount()}}),this.updateInactiveCount(),setTimeout(()=>this.updateInactiveCount(),300)}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0632\u0631 \u0639\u0631\u0636 \u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u064A\u0646 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");window.addEventListener("employeesDataUpdated",()=>{this.updateInactiveCount(),setTimeout(()=>this.updateInactiveCount(),100)}),requestAnimationFrame(async()=>{try{const h=this.getFilterValues();(h.search||h.department||h.branch||h.location||h.job||h.position||h.gender||h.showInactive)&&await this.applyFilters()}catch(h){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",h)}});const y=document.getElementById("employee-form");y&&y.addEventListener("submit",h=>this.handleSubmit(h));const E=document.getElementById("cancel-employee-btn");E&&E.addEventListener("click",()=>this.showList()),this.setupPhotoPreview()},100)},async refreshEmployeeNames(){if(!this.canAddOrImport()){Notification?.error?.("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0646\u0641\u064A\u0630 \u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621");return}const e=document.getElementById("refresh-employee-names-btn"),t=e?.innerHTML;e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0623\u0633\u0645\u0627\u0621...'),typeof Loading<"u"&&Loading.show();try{await this.loadEmployeesFromBackend(!0);const a=Array.isArray(AppState.appData.employees)?AppState.appData.employees:[];if(a.length===0){Notification?.warning?.("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0648\u0638\u0641\u064A\u0646");return}let i=0;const o=a.map(s=>{const l=s?.name??"",d=String(l).replace(/\s+/g," ").trim();return d!==String(l)&&i++,{...s,name:d}});AppState.appData.employees=o,this.cache.data=o,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),await GoogleIntegration.autoSave("Employees",AppState.appData.employees);const n=document.getElementById("show-inactive-employees")?.checked||!1;this.renderStatsCards(),this.loadEmployeesList(n),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(s){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",s)}}),Notification?.success?.(i>0?`\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0623\u0633\u0645\u0627\u0621 (${i} \u062A\u0639\u062F\u064A\u0644\u0627\u062A)`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u062A\u063A\u064A\u064A\u0631\u0627\u062A \u0641\u064A \u0627\u0644\u0623\u0633\u0645\u0627\u0621")}catch(a){Notification?.error?.("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0623\u0633\u0645\u0627\u0621: "+(a?.message||a)),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0623\u0633\u0645\u0627\u0621 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",a)}finally{typeof Loading<"u"&&Loading.hide(),e&&(e.disabled=!1,e.innerHTML=t)}},async deleteAllEmployees(){if(!this.canAddOrImport()){Notification?.error?.("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0646\u0641\u064A\u0630 \u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621");return}if(!window.confirm("\u062A\u062D\u0630\u064A\u0631: \u0633\u064A\u062A\u0645 \u062D\u0630\u0641 \u062C\u0645\u064A\u0639 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646. \u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F\u061F"))return;const t=window.prompt("\u0623\u062F\u062E\u0644 \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0633\u0631\u064A \u0644\u0644\u062D\u0630\u0641:");if(t===null){Notification?.warning?.("\u062A\u0645 \u0625\u0644\u063A\u0627\u0621 \u0627\u0644\u0639\u0645\u0644\u064A\u0629");return}const a=document.getElementById("delete-all-employees-btn"),i=a?.innerHTML;a&&(a.disabled=!0,a.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0630\u0641...');try{if(typeof GoogleIntegration>"u"||!GoogleIntegration.callBackend)throw new Error("GoogleIntegration \u063A\u064A\u0631 \u0645\u062A\u0627\u062D");const o=await GoogleIntegration.callBackend("deleteAllEmployees",{pin:String(t||"").trim()});if(!o||!o.success)throw new Error(o?.message||"\u0641\u0634\u0644 \u062D\u0630\u0641 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A");AppState.appData.employees=[],this.cache.data=[],this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),this.renderStatsCards();const n=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(n),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(s){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",s)}}),Notification?.success?.(o?.message||"\u062A\u0645 \u062D\u0630\u0641 \u062C\u0645\u064A\u0639 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0628\u0646\u062C\u0627\u062D")}catch(o){Notification?.error?.("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+(o?.message||o))}finally{a&&(a.disabled=!1,a.innerHTML=i)}},async reportEmployeeDuplicates(){if(!this.canAddOrImport()){Notification?.error?.("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0646\u0641\u064A\u0630 \u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621");return}if(typeof GoogleIntegration>"u"||!GoogleIntegration.callBackend){Notification?.error?.("GoogleIntegration \u063A\u064A\u0631 \u0645\u062A\u0627\u062D");return}const e=document.getElementById("report-employee-duplicates-btn"),t=e?.innerHTML;e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u0641\u062D\u0635...');try{Loading?.show?.("\u062C\u0627\u0631\u064A \u0641\u062D\u0635 \u0645\u0643\u0631\u0631\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646...");const a=await GoogleIntegration.callBackend("reportEmployeeDuplicates",{sampleLimit:30,__timeoutMs:12e4});if(Loading?.hide?.(),!a||!a.success)throw new Error(a?.message||"\u0641\u0634\u0644 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A");const i=[a.message||"","",`\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0635\u0641\u0648\u0641: ${a.totalRows??"\u2014"}`,`\u0645\u0641\u0627\u062A\u064A\u062D \u0641\u0631\u064A\u062F\u0629: ${a.uniqueKeys??"\u2014"}`,`\u0645\u062C\u0645\u0648\u0639\u0627\u062A \u0645\u0643\u0631\u0631\u0629: ${a.duplicateGroupCount??0}`,`\u0635\u0641\u0648\u0641 \u0632\u0627\u0626\u062F\u0629 \u0645\u0631\u0634\u062D\u0629 \u0644\u0644\u062D\u0630\u0641: ${a.rowsToDeleteCount??0}`,`\u0633\u064A\u062A\u0628\u0642\u0649 \u0628\u0639\u062F \u0627\u0644\u062A\u0646\u0638\u064A\u0641: ${a.keepCount??"\u2014"}`,`\u0635\u0641\u0648\u0641 \u0645\u0646\u0632\u0627\u062D\u0629 \u0623\u0639\u0645\u062F\u0629: ${a.driftedCount??0}`,`\u0635\u0641\u0648\u0641 \u064A\u062A\u064A\u0645\u0629 \u0628\u0644\u0627 \u0645\u0641\u062A\u0627\u062D: ${a.orphanCount??0}`],o=Array.isArray(a.duplicateGroupsSample)?a.duplicateGroupsSample.slice(0,8):[];o.length&&(i.push("","\u0639\u064A\u0651\u0646\u0629 \u0645\u062C\u0645\u0648\u0639\u0627\u062A:"),o.forEach(n=>{i.push(`- ${n.key} \xD7${n.count} (\u064A\u064F\u0628\u0642\u0649 \u0635\u0641 ${n.keepSheetRow}: ${n.keepName||"\u2014"})`)})),window.alert(i.join(`
...
\u0627\u062D\u062A\u064A\u0627\u0637\u064A: ${s.backupSheetName||"\u2014"}`);try{await this.ensureEmployeesLoaded(!0)}catch{const d=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(d)}this.renderStatsCards(),requestAnimationFrame(()=>{try{this.applyFilters()}catch{}}),Notification?.success?.(s.message||"\u062A\u0645 \u062A\u0646\u0638\u064A\u0641 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A")}catch(a){Loading?.hide?.(),Notification?.error?.("\u0641\u0634\u0644 \u062A\u0646\u0638\u064A\u0641 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A: "+(a?.message||a))}finally{e&&(e.disabled=!1,e.innerHTML=t)}},setupPhotoPreview(){const e=document.getElementById("employee-photo-input"),t=document.getElementById("employee-photo-preview"),a=document.getElementById("employee-photo-icon");e&&t&&a&&e.addEventListener("change",i=>{const o=i.target.files[0];if(o){const n=new FileReader;n.onload=s=>{t.src=s.target.result,t.style.display="block",a.style.display="none"},n.readAsDataURL(o)}})},currentEditId:null,async showForm(e=null){if(!e&&!this.canAddOrImport()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0625\u0636\u0627\u0641\u0629 \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F");return}if(e&&!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}this.currentEditId=e?.id||null;const t=document.getElementById("employees-content");t&&(t.innerHTML=await this.renderForm(e),this.applyModuleI18n(t),this.setupEventListeners())},async renderForm(e=null){const t=!!e;return`
        ...
        `,l.length===0)o.innerHTML=`
            ...
            `;else{const r=l.slice(0,200),c=l.length-r.length;o.innerHTML=r.map(f=>`
                <tr data-import-uid="${Utils.escapeHTML(f.uid)}">
                    <td><input type="text" class="form-input emp-imp-field" data-field="employeeNumber" value="${Utils.escapeHTML(f.employeeNumber||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="sapId" value="${Utils.escapeHTML(f.sapId||"")}" style="min-width:80px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="name" value="${Utils.escapeHTML(f.name||"")}" style="min-width:120px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="department" value="${Utils.escapeHTML(f.department||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="job" value="${Utils.escapeHTML(f.job||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="branch" value="${Utils.escapeHTML(f.branch||"")}" style="min-width:80px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="hireDate" value="${Utils.escapeHTML(f.hireDate||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
            ...
            `).join("")+(c>0?`<tr><td colspan="8" style="text-align:center;padding:12px;color:#075985;background:#e0f2fe;font-size:12px;">
                    \u064A\u064F\u0639\u0631\u0636 \u0623\u0648\u0644 200 \u0635\u0641 \u0644\u0644\u0645\u0631\u0627\u062C\u0639\u0629. ${c} \u0635\u0641 \u0625\u0636\u0627\u0641\u064A \u0633\u064A\u064F\u0636\u0627\u0641 \u0623\u064A\u0636\u0627\u064B \u0639\u0646\u062F \u0627\u0644\u062A\u0623\u0643\u064A\u062F \u0628\u062F\u0648\u0646 \u0639\u0631\u0636.
        ...
        `,this.applyModuleI18n(a),document.body.appendChild(a);const i=a.querySelector("#employee-excel-file-input"),o=a.querySelector("#employee-import-confirm-btn"),n=a.querySelector("#employee-import-ready-hint");let s=[],l=this.buildEmployeeImportExistingKeySet(),d=null,m=l.size>0;const r=()=>this.renderEmployeeImportReview(a,s),c=(f,g)=>{n&&(g&&f?(n.hidden=!1,n.textContent=f):(n.hidden=!0,n.textContent=""))};m||c("\u062C\u0627\u0631\u064A \u062A\u062C\u0647\u064A\u0632 \u0641\u0647\u0631\u0633 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0627\u0644\u062D\u0627\u0644\u064A \u0628\u0627\u0644\u062E\u0644\u0641\u064A\u0629 \u0644\u0645\u0637\u0627\u0628\u0642\u0629 \u0627\u0644\u0645\u0643\u0631\u0631\u0627\u062A\u2026",!0),(async()=>{try{await this.ensureEmployeesLoaded(!1)}catch{}a.isConnected&&(l=this.buildEmployeeImportExistingKeySet(),m=!0,c("",!1),s.length>0&&(this.reclassifyAllEmployeeImportDrafts(s,l),r()))})(),i.addEventListener("change",async f=>{const g=f.target.files[0];if(g){Loading.show("\u062C\u0627\u0631\u064A \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641...");try{if(m)l=this.buildEmployeeImportExistingKeySet();else{Loading.show("\u062C\u0627\u0631\u064A \u062A\u062C\u0647\u064A\u0632 \u0641\u0647\u0631\u0633 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0644\u0644\u0645\u0637\u0627\u0628\u0642\u0629...");try{await this.ensureEmployeesLoaded(!1)}catch{}l=this.buildEmployeeImportExistingKeySet(),m=!0,c("",!1)}await this.yieldEmployeeImportUi_();const x=await g.arrayBuffer();Loading.show("\u062C\u0627\u0631\u064A \u062A\u062D\u0644\u064A\u0644 Excel..."),await this.yieldEmployeeImportUi_();const b=XLSX.read(x,{type:"array",cellDates:!0}),u=b.SheetNames[0],y=b.Sheets[u],E=XLSX.utils.sheet_to_json(y,{header:1,defval:"",raw:!1});if(E.length<2){Notification.error(this.t("module.employees.invalidFile","\u0627\u0644\u0645\u0644\u0641 \u0641\u0627\u0631\u063A \u0623\u0648 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D")),s=[],r(),Loading.hide();return}const h=E[0].map($=>String($||"").trim()),p=E.slice(1).map($=>{const D={};return h.forEach((S,I)=>{const T=$[I];D[S]=T??""}),D}).filter($=>h.some(D=>String($[D]||"").trim()!==""));l=this.buildEmployeeImportExistingKeySet();const v=new Set,w=Date.now();s=new Array(p.length);const k=400;for(let $=0;$<p.length;$+=k){const D=Math.min($+k,p.length);Loading.show(`\u062C\u0627\u0631\u064A \u0645\u0637\u0627\u0628\u0642\u0629 \u0627\u0644\u0635\u0641\u0648\u0641... ${D} / ${p.length}`);for(let S=$;S<D;S++){const I=this.parseEmployeeImportRow(p[S],`imp-${S}-${w}`);s[S]=this.classifyEmployeeImportDraft(I,v,l)}await this.yieldEmployeeImportUi_()}Loading.show("\u062C\u0627\u0631\u064A \u062A\u062C\u0647\u064A\u0632 \u0634\u0627\u0634\u0629 \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629..."),await this.yieldEmployeeImportUi_(),r(),Loading.hide()}catch(x){Loading.hide(),Notification.error(this.t("module.employees.readFileFailed","\u0641\u0634\u0644 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641")+": "+x.message)}}}),a.addEventListener("change",f=>{const g=f.target.closest(".emp-imp-field");if(!g)return;const x=g.closest("tr[data-import-uid]");if(!x)return;const b=x.getAttribute("data-import-uid"),u=s.find(E=>E.uid===b);if(!u)return;const y=g.getAttribute("data-field");y&&(u[y]=g.value,d&&clearTimeout(d),d=setTimeout(()=>{this.reclassifyAllEmployeeImportDrafts(s,l),r()},180))}),a.addEventListener("click",f=>{const g=f.target.closest(".emp-imp-remove");if(g){const x=g.closest("tr[data-import-uid]");if(!x)return;const b=x.getAttribute("data-import-uid");s=s.filter(u=>u.uid!==b),this.reclassifyAllEmployeeImportDrafts(s,l),r();return}f.target===a&&a.remove()}),o.addEventListener("click",async()=>{const f=s.filter(u=>u.status==="new");if(f.length===0){Notification.warning("\u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0648\u0638\u0641\u0648\u0646 \u062C\u062F\u062F \u0644\u0644\u0625\u0636\u0627\u0641\u0629");return}const g=this.getEmployeeImportCounts(s),x=this.getEmployeeImportHireWindowLabel();if(window.confirm(`\u0633\u064A\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 ${f.length} \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F \u0641\u0642\u0637.
\u062A\u062E\u0637\u0651\u064A \u0645\u0648\u062C\u0648\u062F \u0645\u0633\u0628\u0642\u0627\u064B: ${g.existsCount}
\u0646\u0627\u0642\u0635/\u063A\u064A\u0631 \u0635\u0627\u0644\u062D: ${g.invalidCount}
\u062A\u0639\u064A\u064A\u0646 \u062E\u0627\u0631\u062C ${x}: ${g.hireDateRejectedCount}

\u0627\u0644\u0645\u0648\u062C\u0648\u062F\u0648\u0646 \u0648\u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u0648\u0646 \u0644\u0646 \u064A\u064F\u0639\u062F\u0651\u064E\u0644\u0648\u0627 \u0648\u0644\u0646 \u064A\u064F\u062D\u0630\u0641\u0648\u0627.
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629\u061F`)){Loading.show(`\u062C\u0627\u0631\u064A \u0625\u0636\u0627\u0641\u0629 ${f.length} \u0645\u0648\u0638\u0641...`);try{let u=0,y=0;const E=[],h=l instanceof Set?new Set(l):this.buildEmployeeImportExistingKeySet(),p=300;for(let w=0;w<f.length;w+=p){const k=Math.min(w+p,f.length);for(let $=w;$<k;$++){const D=f[$];try{if(this.employeeImportKeysMatchExisting(D.employeeNumber,D.sapId,h)){y++;continue}const S=this.buildEmployeeFromImportDraft(D);if(!S){y++;continue}if(this.employeeImportKeysMatchExisting(S.employeeNumber,S.sapId,h)){y++;continue}AppState.appData.employees.push(S),E.push(S);const I=this.normalizeEmployeeImportKey(S.employeeNumber),T=this.normalizeEmployeeImportKey(S.sapId),B=this.normalizeEmployeeImportKey(S.id);I&&h.add(I),T&&h.add(T),B&&h.add(B),u++}catch{y++}}Loading.show(`\u062C\u0627\u0631\u064A \u0627\u0644\u0625\u0636\u0627\u0641\u0629... ${k} / ${f.length}`),await this.yieldEmployeeImportUi_()}typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),l=h,Loading.hide(),Notification.success(`\u0623\u064F\u0636\u064A\u0641 ${u} \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F \u0645\u062D\u0644\u064A\u0627\u064B`+(g.existsCount>0?` \u2014 \u062A\u064F\u062E\u0637\u064A \u0645\u0648\u062C\u0648\u062F ${g.existsCount}`:"")+(g.hireDateRejectedCount>0?` \u2014 \u062A\u0639\u064A\u064A\u0646 \u062E\u0627\u0631\u062C ${this.getEmployeeImportHireWindowLabel()} ${g.hireDateRejectedCount}`:"")+(g.invalidCount>g.hireDateRejectedCount?` \u2014 \u0646\u0627\u0642\u0635 ${g.invalidCount-g.hireDateRejectedCount}`:"")+(y>0?` \u2014 \u0627\u0633\u062A\u064F\u0628\u0639\u062F \u0639\u0646\u062F \u0627\u0644\u062D\u0641\u0638 ${y}`:"")+(E.length>0?" \u2014 \u062C\u0627\u0631\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062C\u062F\u062F \u0645\u0639 \u0627\u0644\u0633\u062D\u0627\u0628\u0629 \u0628\u0627\u0644\u062E\u0644\u0641\u064A\u0629":"")),a.remove(),this.renderStatsCards();const v=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(v),requestAnimationFrame(()=>{this.applyFilters()}),E.length>0&&this.syncImportedEmployeesToCloud_(E)}catch(u){Loading.hide(),Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+u.message)}}})},async syncImportedEmployeesToCloud_(e){const t=Array.isArray(e)?e.filter(Boolean):[];if(!t.length||typeof GoogleIntegration>"u")return;if(typeof GoogleIntegration._isBackendRpcConfigured=="function"&&!GoogleIntegration._isBackendRpcConfigured()){Notification?.warning?.("\u062D\u064F\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B \u2014 \u0627\u0644\u062E\u0627\u062F\u0645 \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629");return}const a=s=>({id:s.id,name:s.name,employeeNumber:s.employeeNumber,sapId:s.sapId,hireDate:s.hireDate,job:s.job||s.position||"",position:s.position||s.job||"",department:s.department||"",branch:s.branch||"",location:s.location||"",gender:s.gender||"",nationalId:s.nationalId||"",birthDate:s.birthDate||"",email:s.email||"",phone:s.phone||"",insuranceNumber:s.insuranceNumber||"",photo:"",status:s.status||"active",resignationDate:s.resignationDate||"",createdAt:s.createdAt||new Date().toISOString(),updatedAt:s.updatedAt||new Date().toISOString()}),i=40;let o=0,n=0;for(let s=0;s<t.length;s+=i){const l=t.slice(s,s+i).map(a);try{const d=typeof GoogleIntegration.sendRequest=="function"?GoogleIntegration.sendRequest({action:"appendToSheet",data:{sheetName:"Employees",data:l,__timeoutMs:9e4,userData:AppState.currentUser||{}}}):GoogleIntegration.sendToAppsScript("appendToSheet",{sheetName:"Employees",data:l,__timeoutMs:9e4,userData:AppState.currentUser||{}}),m=typeof Utils<"u"&&Utils.promiseWithTimeout?await Utils.promiseWithTimeout(d,95e3,"\u0627\u0646\u062A\u0647\u062A \u0645\u0647\u0644\u0629 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646"):await d;m&&m.success?o+=l.length:(n+=l.length,Utils.safeWarn?.("\u26A0\uFE0F \u0641\u0634\u0644 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646:",m?.message))}catch(d){n+=l.length,Utils.safeWarn?.("\u26A0\uFE0F \u062E\u0637\u0623 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646:",d?.message||d)}await this.yieldEmployeeImportUi_()}o>0&&n===0?Notification?.success?.(`\u062A\u0645\u062A \u0645\u0632\u0627\u0645\u0646\u0629 ${o} \u0645\u0648\u0638\u0641\u0627\u064B \u062C\u062F\u064A\u062F\u0627\u064B \u0645\u0639 \u0627\u0644\u0633\u062D\u0627\u0628\u0629`):o>0&&n>0?Notification?.warning?.(`\u062A\u0645\u062A \u0645\u0632\u0627\u0645\u0646\u0629 ${o} \u2014 \u062A\u0639\u0630\u0651\u0631 ${n}. \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0641\u0648\u0638\u0629 \u0645\u062D\u0644\u064A\u0627\u064B.`):n>0&&Notification?.warning?.(`\u062D\u064F\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B \u2014 \u062A\u0639\u0630\u0651\u0631\u062A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0633\u062D\u0627\u0628\u0629 (${n}). \u0623\u0639\u062F \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0644\u0627\u062D\u0642\u0627\u064B \u0623\u0648 \u0645\u0646 \u0632\u0631 \u0627\u0644\u062A\u062D\u062F\u064A\u062B.`)},async handleSubmit(e){e.preventDefault();const t=e.target?.querySelector('button[type="submit"]')||document.querySelector('#employee-form button[type="submit"]');if(t&&t.disabled)return;let a="";t&&(a=t.innerHTML,t.disabled=!0,t.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const i=this.currentEditId?AppState.appData.employees.find(S=>S.id===this.currentEditId):null;let o=i?.photo||"";const n=document.getElementById("employee-photo-input");if(n&&n.files.length>0){const S=n.files[0];if(S.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 \u0647\u0648 2MB"),t&&(t.disabled=!1,t.innerHTML=a);return}o=await this.convertImageToBase64(S)}const s=document.getElementById("employee-name"),l=document.getElementById("employee-number"),d=document.getElementById("employee-sap-id"),m=document.getElementById("employee-hire-date"),r=document.getElementById("employee-birth-date"),c=document.getElementById("employee-department"),f=document.getElementById("employee-position"),g=document.getElementById("employee-branch"),x=document.getElementById("employee-location"),b=document.getElementById("employee-gender"),u=document.getElementById("employee-national-id"),y=document.getElementById("employee-email"),E=document.getElementById("employee-phone"),h=document.getElementById("employee-insurance-number");if(!s||!l||!d||!c||!f||!g||!x||!b||!y||!E){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649.");return}const p=!!this.currentEditId,v=p&&i?.hireDate||"",w=p&&i?.birthDate||"",k={id:l.value.trim()||this.currentEditId||Utils.generateId("EMP"),name:s.value.trim(),employeeNumber:l.value.trim(),sapId:d.value.trim(),hireDate:m?.value?this.normalizeDateOnly(m.value):p?this.normalizeDateOnly(v):this.normalizeDateOnly(new Date),birthDate:r?.value?this.normalizeDateOnly(r.value):p?this.normalizeDateOnly(w):"",department:c.value.trim(),job:f.value.trim(),position:f.value.trim(),branch:g.value.trim(),location:x.value.trim(),gender:b.value,nationalId:u?.value.trim()||"",email:y.value.trim(),phone:E.value.trim(),insuranceNumber:h?.value.trim()||"",photo:o,status:p&&i?.status||"active",resignationDate:p&&i?.resignationDate||"",createdAt:this.currentEditId?i?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};if(!k.name||!k.sapId||!k.employeeNumber||!k.department||!k.position){Notification.error("\u064A\u0631\u062C\u0649 \u0645\u0644\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 (\u0627\u0644\u0627\u0633\u0645\u060C \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0642\u0633\u0645\u060C \u0627\u0644\u0645\u0646\u0635\u0628)"),t&&(t.disabled=!1,t.innerHTML=a);return}const $=String(k.id||"").trim();if(!$){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D (\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u0646\u0634\u0627\u0621 id \u0641\u0627\u0631\u063A)"),t&&(t.disabled=!1,t.innerHTML=a);return}if(AppState.appData.employees.some(S=>{const I=String(S?.id||"").trim();return!I||this.currentEditId&&I===String(this.currentEditId).trim()?!1:I===$})){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u0645\u0633\u062A\u062E\u062F\u0645 \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0631\u0642\u0645 \u0622\u062E\u0631."),t&&(t.disabled=!1,t.innerHTML=a);return}Loading.show();try{if(this.currentEditId){const S=AppState.appData.employees.findIndex(I=>I.id===this.currentEditId);S!==-1&&(AppState.appData.employees[S]=k,this.currentEditId=$),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D")}else AppState.appData.employees.push(k),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D");typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("Employees",AppState.appData.employees),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),t&&(t.disabled=!1,t.innerHTML=a),this.renderStatsCards(),this.showList()}catch(S){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+S.message),t&&(t.disabled=!1,t.innerHTML=a)}},async convertImageToBase64(e){return new Promise((t,a)=>{const i=new FileReader;i.onload=()=>t(i.result),i.onerror=a,i.readAsDataURL(e)})},async showList(){this.currentEditId=null,!this.canViewEmployeesRegistryTab()&&this.canViewEmployeesAnalysisTab()?this.activeTab="data-analysis":!this.canViewEmployeesRegistryTab()&&this.canViewExternalWorkforceTab()?this.activeTab="external-workforce":!this.canViewExternalWorkforceTab()&&!this.canViewEmployeesAnalysisTab()&&(this.activeTab="employees-list");const e=document.getElementById("employees-content");e&&(e.innerHTML=await this.renderList(),this.applyModuleI18n(e),requestAnimationFrame(()=>{this.setupEventListeners(),this.canViewEmployeesRegistryTab()&&this.activeTab==="employees-list"?this.loadEmployeesList():this.activeTab==="data-analysis"&&this.canViewEmployeesAnalysisTab()?this.loadEmployeesAnalysis().catch(()=>{}):this.canViewExternalWorkforceTab()&&(this.populateExternalWorkforceYearSelector(),this.ensureExternalWorkforceDataLoaded().then(()=>this.renderExternalWorkforceTable()).catch(()=>{})),this.activeTab==="employees-list"&&this.scrollToSearchField()}))},async editEmployee(e){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const t=AppState.appData.employees.find(a=>a.id===e);t&&await this.showForm(t)},async printEmployee(e){const t=AppState.appData.employees.find(a=>a.id===e);if(!t){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}try{Loading.show();let a="";const i=this._normalizeEmployeePhotoUrl(t.photo,t.id);if(i&&typeof Utils.resolveDriveAwareImgDisplay=="function"){const y=Utils.resolveDriveAwareImgDisplay(i);if(y.needsProxy&&typeof Utils.fetchDriveImageDataUri=="function")try{a=await Utils.fetchDriveImageDataUri(y.proxyFileId)||""}catch{a=""}a||(a=y.canonical||i)}else i&&(a=i);const o=this.formatDateSafe(t.birthDate),n=this.formatDateSafe(t.hireDate),s=this.calculateAge(t.birthDate),l=y=>{if(!y)return"-";try{const E=new Date(y),h=E.getFullYear(),p=E.getMonth()+1,v=E.getDate(),w=["\u0660","\u0661","\u0662","\u0663","\u0664","\u0665","\u0666","\u0667","\u0668","\u0669"],k=$=>String($).split("").map(D=>w[parseInt(D)]||D).join("");return`${k(h)}/${k(p)}/${k(v)}`}catch{return y}},d=new Date,m=l(d.toISOString().split("T")[0]),r=d.toLocaleTimeString("ar-SA",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}),c=AppState?.companySettings?.name||AppState?.appData?.companyName||"\u0627\u0644\u0634\u0631\u0643\u0629",f=`
                <style>
                ...
                <div class="employee-card">
                    <div class="card-header">
                        <div class="company-name">${Utils.escapeHTML(c)}</div>
                    ...
                    <div class="employee-details">
                        ...
                        <div class="detail-field">
                            ...
                            <div class="detail-value">${l(o)}</div>
                        </div>
                        <div class="detail-field">
                        ...
                        <div class="detail-field">
                            ...
                            <div class="detail-value">${l(n)}</div>
                        </div>
                        <div class="detail-field">
...
<body>
    ${f}
                ...
                <div class="modal-body">
                    <div class="space-y-4">
                        <div class="text-center mb-4">
                            ${(()=>{const s=this._normalizeEmployeePhotoUrl(t.photo,t.id);if(!s)return'<div class="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center mx-auto"><i class="fas fa-user text-5xl text-gray-400"></i></div>';const l=typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(s):{canonical:s,displaySrc:s,needsProxy:!1,proxyFileId:""},d=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(l):"";return`<img src="${Utils.escapeHTML(l.displaySrc)}" alt="${Utils.escapeHTML(t.name||"")}"${d} class="emp-detail-photo w-32 h-32 rounded-full object-cover mx-auto border-4 border-gray-200">`})()}
                        </div>
        ...
        `,this.applyModuleI18n(n),document.body.appendChild(n),typeof EmailDispatch<"u"&&EmailDispatch.bindFooterButtons(n,{moduleKey:"employees",record:t,recordId:t.id||t.employeeNumber||t.isoCode||""}),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(n,{onFetchFail:s=>{try{const l=document.createElement("div");l.className="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center mx-auto",l.innerHTML='<i class="fas fa-user text-5xl text-gray-400"></i>',s.replaceWith(l)}catch{}}}),n.addEventListener("click",s=>{s.target===n&&n.remove()})},async deactivateEmployee(e){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0625\u0644\u063A\u0627\u0621 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const t=AppState.appData.employees.find(a=>a.id===e);if(!t){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}if(confirm(`\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u0625\u0644\u063A\u0627\u0621 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641 "${t.name}"\u061F
...
\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: \u0647\u0630\u0647 \u0627\u0644\u0639\u0645\u0644\u064A\u0629 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647\u0627!`)){Loading.show();try{AppState.appData.employees=(AppState.appData.employees||[]).filter(a=>a.id!==e),setTimeout(()=>{typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},50),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D"),this.renderStatsCards();const t=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(t),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(a){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",a)}}),AppState.googleConfig?.appsScript?.enabled&&GoogleIntegration.sendToAppsScript("deleteEmployee",{employeeId:e}).then(a=>{!a||!a.success?Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 Google Sheets:",a?.message):Utils.safeLog("\u2705 \u062A\u0645 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}).catch(a=>Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062D\u0630\u0641 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",a))}catch(t){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}}},scrollToSearchField(){setTimeout(()=>{const e=document.getElementById("employees-search");if(e){const t=window.scrollY||document.documentElement.scrollTop,a=Math.max(0,(e.offsetTop||0)-20),i=t+window.innerHeight;(a<t||a>i-100)&&window.scrollTo({top:a,behavior:"smooth"})}},0)},getFilterValues(){return{search:document.getElementById("employees-search-filter")?.value||document.getElementById("employees-search")?.value||"",department:document.getElementById("employee-filter-department")?.value||"",branch:document.getElementById("employee-filter-branch")?.value||"",location:document.getElementById("employee-filter-location")?.value||"",job:document.getElementById("employee-filter-job")?.value||"",position:document.getElementById("employee-filter-position")?.value||"",gender:document.getElementById("employee-filter-gender")?.value||"",showInactive:document.getElementById("show-inactive-employees")?.checked||!1}},async filterEmployees(e="",t=!1,a=null){try{if(a)t=a.showInactive!==void 0&&a.showInactive!==null?a.showInactive:t;else{const r=this.getFilterValues();e=e||r.search,t=t??(r.showInactive||!1),a=r,a.showInactive=t}const i=document.getElementById("employees-table-container");if(!i){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}let o=i.querySelector("tbody");if(!o&&(await this.loadEmployeesList(t),o=i.querySelector("tbody"),!o)){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F tbody \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0628\u0639\u062F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629");return}let n=AppState.appData.employees||[];t||(n=n.filter(r=>!this.isEmployeeInactive(r)));let s=n;const l=this.canEditOrDelete();if(e&&e.trim()){const r=e.trim().toLowerCase();s=s.filter(c=>c.name&&c.name.toLowerCase().includes(r)||c.employeeNumber&&String(c.employeeNumber).toLowerCase().includes(r)||c.sapId&&String(c.sapId).toLowerCase().includes(r)||c.department&&c.department.toLowerCase().includes(r)||c.position&&c.position.toLowerCase().includes(r)||c.job&&c.job.toLowerCase().includes(r)||c.branch&&c.branch.toLowerCase().includes(r)||c.location&&c.location.toLowerCase().includes(r)||c.nationalId&&c.nationalId.toLowerCase().includes(r)||c.phone&&c.phone.toLowerCase().includes(r)||c.insuranceNumber&&c.insuranceNumber.toLowerCase().includes(r)||c.email&&c.email.toLowerCase().includes(r)||c.gender&&c.gender.toLowerCase().includes(r))}a.department&&(s=s.filter(r=>String(r.department||"").trim()===String(a.department).trim())),a.branch&&(s=s.filter(r=>String(r.branch||"").trim()===String(a.branch).trim())),a.location&&(s=s.filter(r=>String(r.location||"").trim()===String(a.location).trim())),a.job&&(s=s.filter(r=>String(r.job||"").trim()===String(a.job).trim())),a.position&&(s=s.filter(r=>String(r.position||"").trim()===String(a.position).trim())),a.gender&&(s=s.filter(r=>String(r.gender||"").trim()===String(a.gender).trim()));const d=document.createDocumentFragment(),m=13;if(s.length===0){const r=document.createElement("tr");r.innerHTML=`<td colspan="${m}" class="text-center text-gray-500 py-8">\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C</td>`,d.appendChild(r)}else s.forEach(r=>{const c=this.formatDateSafe(r.birthDate),f=this.formatDateSafe(r.hireDate),g=this.calculateAge(r.birthDate),x=this.isEmployeeInactive(r),b=x?"opacity: 0.7; background-color: #f8f9fa;":"",u=document.createElement("tr");x&&(u.style.cssText=b);const y=this._normalizeEmployeePhotoUrl(r.photo,r.id),h=(this._getDriveIdFromUrl(r.photo||"")||r.id||r.employeeNumber||r.name||"").toString(),p=y&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(y):{canonical:y||"",displaySrc:y||"",needsProxy:!1,proxyFileId:""},v=p.canonical?p.displaySrc:"",w=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(p):"";u.innerHTML=`
                    ...
                    <td style="word-wrap: break-word; white-space: normal;">${Utils.escapeHTML(r.nationalId||"")}</td>
                    <td style="word-wrap: break-word; white-space: normal;">${c||""}</td>
                    <td style="word-wrap: break-word; white-space: normal;">${g?g+" \u0633\u0646\u0629":""}</td>
                    <td style="word-wrap: break-word; white-space: normal;">${f||""}</td>
                    <td style="word-wrap: break-word; white-space: normal;">${Utils.escapeHTML(r.gender||"")}</td>
                    <td style="word-wrap: break-word; white-space: normal;">${Utils.escapeHTML(r.phone||"")}</td>
                    <td style="word-wrap: break-word; white-space: normal;">${Utils.escapeHTML(r.insuranceNumber||"")}</td>
                    ...
                    `}
                `,d.appendChild(u)});o.innerHTML="",o.appendChild(d),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(o,{onFetchFail:r=>{try{const c=(r.dataset.photoKey||"").trim();c&&sessionStorage.setItem(this._photoFailKey(c),Date.now().toString())}catch{}try{const c=r.parentElement;c&&(c.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}}),this.updateFilterBadges(n,s,a),AppState.debugMode&&e&&Utils.safeLog(`\u{1F50D} \u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0628\u062D\u062B: ${s.length} \u0645\u0646 ${n.length} \u0645\u0648\u0638\u0641`)}catch(i){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A filterEmployees:",i)}},updateFilterBadges(e,t,a){try{if(!a){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F updateFilterBadges: filters \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}const i=(o,n,s)=>{try{const l=document.getElementById(o);if(!l){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: ${o} \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F`);return}const d=l.closest(".filter-field");if(!d){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-field \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const m=d.querySelector(".filter-label");if(!m){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-label \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const r=m.querySelector(".filter-count-badge");if(r&&r.remove(),n&&n.trim()!==""){const c=document.createElement("span");c.className="filter-count-badge",c.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",c.textContent=s;const f=m.querySelector("i");f?f.insertAdjacentElement("afterend",c):m.insertBefore(c,m.firstChild),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0639\u062F\u062F (${s}) \u0644\u0640 ${o}`)}}catch(l){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0641\u0644\u062A\u0631:",l)}};if(a.department?i("employee-filter-department",a.department,t.length):i("employee-filter-department","",0),a.branch?i("employee-filter-branch",a.branch,t.length):i("employee-filter-branch","",0),a.location?i("employee-filter-location",a.location,t.length):i("employee-filter-location","",0),a.job?i("employee-filter-job",a.job,t.length):i("employee-filter-job","",0),a.position?i("employee-filter-position",a.position,t.length):i("employee-filter-position","",0),a.gender?i("employee-filter-gender",a.gender,t.length):i("employee-filter-gender","",0),a.search&&a.search.trim())try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const n=o.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const l=s.querySelector(".filter-count-badge");l&&l.remove();const d=document.createElement("span");d.className="filter-count-badge",d.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",d.textContent=t.length;const m=s.querySelector("i");m?m.insertAdjacentElement("afterend",d):s.insertBefore(d,s.firstChild)}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}else try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const n=o.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const l=s.querySelector(".filter-count-badge");l&&l.remove()}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0625\u0632\u0627\u0644\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}}catch(i){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A updateFilterBadges:",i)}},async applyFilters(){try{const e=this.getFilterValues();await this.filterEmployees(e.search,e.showInactive,e),this.updateInactiveCount()}catch(e){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A applyFilters:",e)}finally{this.updateInactiveCount()}},async resetFilters(){const e=document.getElementById("employees-search"),t=document.getElementById("employees-search-filter");e&&(e.value=""),t&&(t.value=""),["employee-filter-department","employee-filter-branch","employee-filter-location","employee-filter-job","employee-filter-position","employee-filter-gender"].forEach(n=>{const s=document.getElementById(n);s&&(s.value="")});const i=document.getElementById("show-inactive-employees");i&&(i.checked=!1);const o=document.getElementById("show-inactive-employees-container");o&&(o.style.background="linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)",o.style.borderColor="#dee2e6",o.style.boxShadow="none"),await this.applyFilters(),this.updateInactiveCount()},updateInactiveCount(e=0){const i=()=>{try{const n=(AppState.appData.employees||[]).filter(l=>this.isEmployeeInactive(l)).length,s=document.getElementById("inactive-employees-count");if(s){s.textContent=n;const l=n===0,d=l?"#6b7280":"#dc2626",m=l?"0 2px 4px rgba(107, 114, 128, 0.3)":"0 2px 4px rgba(220, 38, 38, 0.3)";s.style.cssText=`
    ...
    `,d=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${e.year}`,o,l,!1,!0,{version:"1.0",releaseDate:n,revisionDate:n,includeQRCode:!0},n,n):`<!DOCTYPE html><html lang="${i.lang}" dir="${i.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${i.dir};padding:20px;">${l}</body></html>`,m=new Blob(["\uFEFF"+d],{type:"text/html;charset=utf-8"}),r=URL.createObjectURL(m),c=window.open(r,"_blank");if(!c){URL.revokeObjectURL(r),Notification.error("\u062A\u0639\u0630\u0631 \u0641\u062A\u062D \u0646\u0627\u0641\u0630\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629");return}c.onload=()=>{setTimeout(()=>{c.print(),setTimeout(()=>URL.revokeObjectURL(r),1e3)},400)}},(function(){"use strict";try{typeof window<"u"&&typeof Employees<"u"&&(window.Employees=Employees,typeof AppState<"u"&&AppState.debugMode&&typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u2705 Employees module loaded and available on window.Employees"),typeof AppState<"u"&&AppState.currentUser&&setTimeout(()=>{window.Employees&&window.Employees.init&&window.Employees.init().catch(e=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u0647\u064A\u0626\u0629 \u0645\u0648\u062F\u064A\u0648\u0644 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",e)})},2e3))}catch{if(typeof window<"u"&&typeof Employees<"u")try{window.Employees=Employees}catch{}}})();
