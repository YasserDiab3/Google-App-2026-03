const NearMiss={TYPES:[{value:"\u0633\u0642\u0648\u0637 \u0623\u0634\u064A\u0627\u0621 / \u0623\u062D\u0645\u0627\u0644",label:"\u0633\u0642\u0648\u0637 \u0623\u0634\u064A\u0627\u0621 / \u0623\u062D\u0645\u0627\u0644",icon:"fa-arrow-down"},{value:"\u062A\u0639\u062B\u0631 / \u0627\u0646\u0632\u0644\u0627\u0642",label:"\u062A\u0639\u062B\u0631 / \u0627\u0646\u0632\u0644\u0627\u0642",icon:"fa-walking"},{value:"\u0627\u0642\u062A\u0631\u0627\u0628 \u0645\u0639\u062F\u0627\u062A / \u0641\u0648\u0631\u0643\u0644\u0641\u062A",label:"\u0627\u0642\u062A\u0631\u0627\u0628 \u0645\u0639\u062F\u0627\u062A / \u0641\u0648\u0631\u0643\u0644\u0641\u062A",icon:"fa-truck-pickup"},{value:"\u062E\u0637\u0631 \u0643\u0647\u0631\u0628\u0627\u0626\u064A \u0648\u0634\u064A\u0643",label:"\u062E\u0637\u0631 \u0643\u0647\u0631\u0628\u0627\u0626\u064A \u0648\u0634\u064A\u0643",icon:"fa-bolt"},{value:"\u062A\u0633\u0631\u064A\u0628 \u0645\u0648\u0627\u062F \u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629 / \u063A\u0627\u0632",label:"\u062A\u0633\u0631\u064A\u0628 \u0645\u0648\u0627\u062F \u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629 / \u063A\u0627\u0632",icon:"fa-flask"},{value:"\u062D\u0631\u064A\u0642 \u0648\u0634\u064A\u0643",label:"\u062D\u0631\u064A\u0642 \u0648\u0634\u064A\u0643",icon:"fa-fire"},{value:"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643",label:"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643 \u0639\u0627\u0645",icon:"fa-exclamation-triangle"},{value:"\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0622\u0645\u0646",label:"\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0622\u0645\u0646",icon:"fa-user-times"},{value:"\u0648\u0636\u0639 \u063A\u064A\u0631 \u0622\u0645\u0646",label:"\u0648\u0636\u0639 \u063A\u064A\u0631 \u0622\u0645\u0646",icon:"fa-ban"},{value:"\u0645\u0642\u062A\u0631\u062D",label:"\u0645\u0642\u062A\u0631\u062D \u062A\u062D\u0633\u064A\u0646",icon:"fa-lightbulb"}],state:{activeTab:"register",filters:{search:"",type:"",department:"",startDate:"",endDate:"",period:"365"},currentAttachments:[],editingId:null},_charts:{},applyModuleI18n(e){const t=e||document,i=window.AppI18n&&typeof window.AppI18n.applyI18n=="function"?window.AppI18n:window.I18n&&typeof window.I18n.applyI18n=="function"?window.I18n:null;i&&(typeof i.applyI18n=="function"&&i.applyI18n(t),typeof i.applyLiteralTranslations=="function"&&i.applyLiteralTranslations(t))},ensureI18nObservers(e){},async fetchLiveNearMisses(){try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.callApi){const e=await GoogleIntegration.callApi("getAllNearMisses");e&&e.success&&Array.isArray(e.data)&&(AppState.appData.nearmiss=e.data.map(t=>this.normalizeRecord(t)),this.renderKpiStrip(),this.renderActiveTabContent())}}catch{}},async load(){try{const e=document.getElementById("nearmiss-section");if(!e)return;this.ensureDataIntegrity(),this.renderMainLayout(e),this.fetchLiveNearMisses()}catch{}},ensureDataIntegrity(){let e=AppState.appData.nearmiss||AppState.appData.NearMiss||[];Array.isArray(e)||(e=[]),AppState.appData.nearmiss=e.map(t=>this.normalizeRecord(t))},normalizeRecord(e={}){const t=this.TYPES[0].value,i=e.id||(typeof Utils<"u"&&Utils.generateId?Utils.generateId("NEARMISS"):"NRM-"+Math.floor(Math.random()*1e5));let a;try{a=e.date?new Date(e.date).toISOString():new Date().toISOString()}catch{a=new Date().toISOString()}let l=[];if(Array.isArray(e.attachments))l=e.attachments.map(r=>this.normalizeAttachment(r)).filter(Boolean);else if(typeof e.attachments=="string"&&e.attachments.trim().startsWith("["))try{const r=JSON.parse(e.attachments);Array.isArray(r)&&(l=r.map(s=>this.normalizeAttachment(s)).filter(Boolean))}catch{}const c=e.correctiveProposed===!0||e.correctiveProposed==="\u0646\u0639\u0645"||!!(e.correctiveDescription||e.correctiveAction);return{id:i,isoCode:e.isoCode||e.id||i,type:e.type||t,severity:e.severity||"\u0645\u062A\u0648\u0633\u0637",date:a,observerName:e.observerName||e.reportedBy||"\u0641\u0627\u0639\u0644 \u062E\u064A\u0631 (\u0633\u0631\u064A)",phone:e.phone||"",location:e.location||e.place||"",department:e.department||e.departmentName||"",description:e.description||e.details||"",correctiveProposed:c,correctiveDescription:e.correctiveDescription||e.correctiveProposed||e.correctiveAction||"",attachments:l,status:e.status||(c?"\u0645\u0641\u062A\u0648\u062D":"\u0645\u063A\u0644\u0642"),createdAt:e.createdAt||a,updatedAt:e.updatedAt||a}},normalizeAttachment(e){return e?typeof e=="string"?{id:"att-"+Math.random(),name:"\u0645\u0631\u0641\u0642",url:e,data:e,type:"image/jpeg"}:{id:e.id||"att-"+Math.random(),name:e.name||"\u0645\u0631\u0641\u0642",type:e.type||"image/jpeg",url:e.url||e.data||"",data:e.data||e.url||"",size:e.size||0}:null},renderMainLayout(e){e.innerHTML=`
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div style="background:#fff; border-radius:16px; padding:18px 20px; border:1px solid #d1fae5; box-shadow:0 4px 15px rgba(0,0,0,0.03); display:flex; align-items:center; gap:16px;">
                    ...
                    <div>
                        ...
                        <div style="font-size:1.05rem; font-weight:800; color:#065f46; line-height:1.2; margin-top:3px;">${Utils.escapeHTML(p)}</div>
        ...
        `,setTimeout(()=>this.drawAnalyticsCharts(t),100)},drawAnalyticsCharts(e){if(typeof Chart>"u")return;["types","severity","locations","departments"].forEach(o=>{if(this._charts[o])try{this._charts[o].destroy()}catch{}});const t={};e.forEach(o=>{const g=o.type||"\u0623\u062E\u0631\u0649";t[g]=(t[g]||0)+1});const i=document.getElementById("nrm-chart-types");i&&(this._charts.types=new Chart(i,{type:"doughnut",data:{labels:Object.keys(t),datasets:[{data:Object.values(t),backgroundColor:["#4f46e5","#f59e0b","#10b981","#ef4444","#06b6d4","#8b5cf6","#ec4899"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"}}}}));const a={\u0645\u0646\u062E\u0641\u0636:0,\u0645\u062A\u0648\u0633\u0637:0,\u0639\u0627\u0644\u064A:0,"\u0643\u0627\u0631\u062B\u064A / \u0648\u0634\u064A\u0643":0};e.forEach(o=>{const g=o.severity||"\u0645\u062A\u0648\u0633\u0637";g.includes("\u0645\u0646\u062E\u0641\u0636")?a.\u0645\u0646\u062E\u0641\u0636++:g.includes("\u0639\u0627\u0644\u064A")||g.includes("high")?a.\u0639\u0627\u0644\u064A++:g.includes("\u0643\u0627\u0631\u062B\u064A")||g.includes("\u0648\u0634\u064A\u0643")?a["\u0643\u0627\u0631\u062B\u064A / \u0648\u0634\u064A\u0643"]++:a.\u0645\u062A\u0648\u0633\u0637++});const l=document.getElementById("nrm-chart-severity");l&&(this._charts.severity=new Chart(l,{type:"pie",data:{labels:Object.keys(a),datasets:[{data:Object.values(a),backgroundColor:["#10b981","#f59e0b","#ef4444","#991b1b"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"}}}}));const c={};e.forEach(o=>{const g=(o.location||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").split("\u2014")[0].trim();c[g]=(c[g]||0)+1});const r=Object.entries(c).sort((o,g)=>g[1]-o[1]).slice(0,6),s=document.getElementById("nrm-chart-locations");s&&(this._charts.locations=new Chart(s,{type:"bar",data:{labels:r.map(o=>o[0]),datasets:[{label:"\u0639\u062F\u062F \u0627\u0644\u0628\u0644\u0627\u063A\u0627\u062A",data:r.map(o=>o[1]),backgroundColor:"#6366f1",borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}}}));const d={};e.forEach(o=>{const g=(o.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").trim();d[g]=(d[g]||0)+1});const p=Object.entries(d).sort((o,g)=>g[1]-o[1]).slice(0,6),f=document.getElementById("nrm-chart-departments");f&&(this._charts.departments=new Chart(f,{type:"bar",data:{labels:p.map(o=>o[0]),datasets:[{label:"\u0639\u062F\u062F \u0627\u0644\u0628\u0644\u0627\u063A\u0627\u062A",data:p.map(o=>o[1]),backgroundColor:"#10b981",borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}}}))},bindEvents(){document.querySelectorAll(".nrm-nav-tab").forEach(a=>{a.addEventListener("click",()=>{const l=a.getAttribute("data-tab");l&&(this.state.activeTab=l,document.querySelectorAll(".nrm-nav-tab").forEach(c=>{const r=c.getAttribute("data-tab")===l;c.style.background=r?"#fff":"rgba(255,255,255,0.12)",c.style.color=r?"#1e1b4b":"#fff"}),this.renderActiveTabContent())})});const e=document.getElementById("nearmiss-public-qr-btn");e&&e.addEventListener("click",()=>this.openPublicQrModal());const t=document.getElementById("nearmiss-print-badges-btn");t&&t.addEventListener("click",()=>this.printLocationQrBadges());const i=document.getElementById("nearmiss-create-new-btn");i&&i.addEventListener("click",()=>this.showForm())},bindFilterEvents(){const e=document.getElementById("nrm-filter-toggle-btn");e&&e.addEventListener("click",()=>{const p=document.getElementById("nrm-filter-body"),f=e.querySelector(".nrm-chevron");if(p){const o=p.classList.toggle("collapsed");this.state._filtersExpanded=!o,f&&f.classList.toggle("open",!o)}});const t=document.getElementById("nearmiss-filter-search");if(t){let p;t.addEventListener("input",f=>{clearTimeout(p),p=setTimeout(()=>{this.handleFilterChange("search",f.target.value)},250)})}const i=document.getElementById("nearmiss-filter-type");i&&i.addEventListener("change",p=>this.handleFilterChange("type",p.target.value));const a=document.getElementById("nearmiss-filter-severity");a&&a.addEventListener("change",p=>this.handleFilterChange("severity",p.target.value));const l=document.getElementById("nearmiss-filter-department");l&&l.addEventListener("change",p=>this.handleFilterChange("department",p.target.value));const c=document.getElementById("nearmiss-filter-start");c&&c.addEventListener("change",p=>this.handleFilterChange("startDate",p.target.value));const r=document.getElementById("nearmiss-filter-end");r&&r.addEventListener("change",p=>this.handleFilterChange("endDate",p.target.value));const s=document.getElementById("nearmiss-reset-filters");s&&s.addEventListener("click",()=>this.resetFilters());const d=document.getElementById("nrm-active-tags");d&&d.addEventListener("click",p=>{const f=p.target.closest("[data-clear-filter]");if(f){const o=f.getAttribute("data-clear-filter");this.handleFilterChange(o,"")}})},handleFilterChange(e,t){this.state.filters[e]=t,this._refreshFilterUI(),this.renderTable()},resetFilters(){this.state.filters={search:"",type:"",severity:"",department:"",startDate:"",endDate:"",period:"365"},this.renderRegisterTab(document.getElementById("nearmiss-tab-content"))},_getActiveFilterCount(){const e=this.state.filters;let t=0;return e.search&&t++,e.type&&t++,e.severity&&t++,e.department&&t++,e.startDate&&t++,e.endDate&&t++,t},_renderActiveFilterTags(){const e=this.state.filters,t=[],i={search:{icon:"fa-search",prefix:"\u0628\u062D\u062B"},type:{icon:"fa-tag",prefix:"\u0627\u0644\u0646\u0648\u0639"},severity:{icon:"fa-exclamation-circle",prefix:"\u0627\u0644\u062E\u0637\u0648\u0631\u0629"},department:{icon:"fa-building",prefix:"\u0627\u0644\u0625\u062F\u0627\u0631\u0629"},startDate:{icon:"fa-calendar",prefix:"\u0645\u0646"},endDate:{icon:"fa-calendar-check",prefix:"\u0625\u0644\u0649"}};for(const[a,l]of Object.entries(i))e[a]&&t.push(`<span class="nrm-tag"><i class="fas ${l.icon}" style="font-size:.6rem;opacity:.7;"></i> ${l.prefix}: ${Utils.escapeHTML(e[a])}<button data-clear-filter="${a}" title="\u0625\u0632\u0627\u0644\u0629"><i class="fas fa-times"></i></button></span>`);return t.join("")},_refreshFilterUI(){const e=document.getElementById("nrm-active-tags");e&&(e.innerHTML=this._renderActiveFilterTags());const t=this._getActiveFilterCount(),i=document.getElementById("nrm-filter-toggle-btn");if(i){const r=i.querySelector(".nrm-filter-badge");if(t)if(r)r.textContent=t;else{const s=document.createElement("span");s.className="nrm-filter-badge",s.textContent=t;const d=i.querySelector(".nrm-chevron");i.insertBefore(s,d)}else r&&r.remove()}const a=document.querySelector(".nrm-filter-actions");if(a){const r=a.querySelector(".nrm-filter-reset");if(t&&!r){const s=document.createElement("button");s.id="nearmiss-reset-filters",s.className="nrm-filter-reset",s.type="button",s.innerHTML='<i class="fas fa-undo" style="font-size:.65rem;"></i> \u0645\u0633\u062D \u0627\u0644\u0643\u0644',s.addEventListener("click",()=>this.resetFilters()),a.insertBefore(s,a.firstChild)}else!t&&r&&r.remove()}["nearmiss-filter-search","nearmiss-filter-type","nearmiss-filter-severity","nearmiss-filter-department","nearmiss-filter-start","nearmiss-filter-end"].forEach(r=>{const s=document.getElementById(r);s&&(s.value?s.classList.add("has-value"):s.classList.remove("has-value"))});const l=this.state.filters,c={"nearmiss-filter-search":"search","nearmiss-filter-type":"type","nearmiss-filter-severity":"severity","nearmiss-filter-department":"department","nearmiss-filter-start":"startDate","nearmiss-filter-end":"endDate"};for(const[r,s]of Object.entries(c)){const d=document.getElementById(r);d&&d.value!==l[s]&&(d.value=l[s])}},getFilteredItems(){const{search:e,type:t,severity:i,department:a,startDate:l,endDate:c}=this.state.filters;let r=(AppState.appData.nearmiss||[]).filter(s=>!!s);if(t&&(r=r.filter(s=>(s.type||"").toLowerCase()===t.toLowerCase())),a&&(r=r.filter(s=>(s.department||"").toLowerCase()===a.toLowerCase())),i&&(r=r.filter(s=>{const d=String(s.severity||"").toLowerCase(),p=i.toLowerCase();return p==="\u0643\u0627\u0631\u062B\u064A"?d.includes("\u0643\u0627\u0631\u062B\u064A")||d.includes("\u0648\u0634\u064A\u0643")||d.includes("critical"):d.includes(p)})),l){const s=new Date(l);s.setHours(0,0,0,0),r=r.filter(d=>new Date(d.date)>=s)}if(c){const s=new Date(c);s.setHours(23,59,59,999),r=r.filter(d=>new Date(d.date)<=s)}if(e){const s=e.toLowerCase();r=r.filter(d=>[d.type,d.location,d.department,d.observerName,d.phone,d.description,d.correctiveDescription,d.isoCode].some(p=>p&&String(p).toLowerCase().includes(s)))}return r.sort((s,d)=>new Date(d.date)-new Date(s.date))},renderTable(){const e=document.getElementById("nearmiss-table-container");if(!e)return;const t=this.getFilteredItems(),i=document.getElementById("nearmiss-result-count");if(i&&(i.textContent=t.length?`${t.length} \u0628\u0644\u0627\u063A`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C"),!t.length){e.innerHTML=`
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <datalist id="nearmiss-departments-list">
                                        ${i.map(c=>`<option value="${Utils.escapeHTML(c)}"></option>`).join("")}
                                    </datalist>
                                </div>
                                <div>
        ...
        `,l},bindFormEvents(e,t){const i=e.querySelector("#nearmiss-form");i&&i.addEventListener("submit",async l=>{l.preventDefault(),await this.handleSubmit(i,t),e.remove()});const a=e.querySelector("#nearmiss-attachments");a&&a.addEventListener("change",async l=>{const c=l.target.files;if(!(!c||!c.length))for(let r=0;r<c.length;r++){const s=c[r],d=new FileReader;d.onload=p=>{this.state.currentAttachments.push({id:"att-"+Date.now()+"-"+r,name:s.name,type:s.type,data:p.target.result,url:p.target.result}),this.renderAttachmentsPreview(e)},d.readAsDataURL(s)}})},renderAttachmentsPreview(e){const t=e.querySelector("#nearmiss-attachments-preview");if(t){if(!this.state.currentAttachments.length){t.innerHTML="";return}t.innerHTML=this.state.currentAttachments.map((i,a)=>`
        ...
        `,document.body.appendChild(r);const s=r.querySelector("#nrm-batch-site-filter"),d=r.querySelector("#nrm-batch-place-filter"),p=r.querySelector("#nrm-batch-layout-select"),f=r.querySelector("#nrm-batch-selected-preview"),o=r.querySelector("#nrm-batch-print-btn"),g=()=>{const n=s.value,m=d.value;return i.filter(b=>!(n!=="all"&&b.site!==n||m!=="all"&&b.place!==m))},x=()=>{const n=g();f.textContent=`${n.length} \u0645\u0648\u0642\u0639 \u062C\u0627\u0647\u0632 \u0644\u0644\u0637\u0628\u0627\u0639\u0629`,o.disabled=n.length===0,o.style.opacity=n.length===0?"0.5":"1"};s.addEventListener("change",x),d.addEventListener("change",x),o.addEventListener("click",()=>{const n=g();if(n.length===0){alert("\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0648\u0627\u0642\u0639 \u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0644\u062A\u0635\u0641\u064A\u0629.");return}r.remove(),this.renderNearMissQrPrintPage(n,p.value)})},renderNearMissQrPrintPage(e,t="1x1"){if(!e||e.length===0)return;const i=this.getPublicUrl(),a=window.open("","_blank");if(!a){alert("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0637\u0628\u0627\u0639\u0629 \u0643\u0631\u0648\u062A \u0648\u0628\u0648\u0633\u062A\u0631\u0627\u062A QR");return}if(t==="1x1"){const f=e.map((o,g)=>{const x=o.site,n=o.place||"\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0639\u0627\u0645",m=`${i}?factory=${encodeURIComponent(x)}&place=${encodeURIComponent(n)}`,b=this.generateQrDataUrl(m,280),u=encodeURIComponent(m);return`
                    <div class="a4-poster-page">
                        ...
                        <div class="iso-header-table">
                            ...
                            <div class="iso-h-cell iso-meta-cell">
                                ...
                                <div><b>\u0627\u0644\u0645\u0648\u0642\u0639:</b> ${Utils.escapeHTML(x)}</div>
                            </div>
                        </div>
                        ...
                        <div class="location-banner">
                            ...
                            <div class="loc-name-highlight">${Utils.escapeHTML(x)} \u2014 ${Utils.escapeHTML(n)}</div>
                        </div>
                        ...
                        <div class="qr-main-container">
                            <div class="qr-frame">
                                <img src="${b}" alt="QR Code" class="qr-img-large" onerror="if(!this.dataset.errCount){this.dataset.errCount=1;this.src='https://quickchart.io/qr?size=280&text=${u}';}" />
                            </div>
                        ...
                        <div class="iso-footer-table">
                            ...
                            <div>\u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0648\u0627\u0644\u0635\u062D\u0629 \u0627\u0644\u0645\u0647\u0646\u064A\u0629 \u0648\u0627\u0644\u0628\u064A\u0626\u0629 &bull; \u0635\u0641\u062D\u0629 #${g+1} \u0645\u0646 ${e.length}</div>
                        </div>
                    </div>
            ...
            `),a.document.close();return}let l=2,c="120px",r=100,s="13px",d="11px";t==="3x4"?(l=3,c="110px",r=85,s="11.5px",d="9.5px"):t==="2x3"?(l=2,c="150px",r=125,s="14px",d="12px"):t==="2x2"?(l=2,c="180px",r=145,s="16px",d="13px"):(l=2,c="130px",r=105,s="13.5px",d="11.5px");const p=e.map((f,o)=>{const g=f.site,x=f.place||"\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0639\u0627\u0645",n=`${i}?factory=${encodeURIComponent(g)}&place=${encodeURIComponent(x)}`,m=this.generateQrDataUrl(n,r),b=encodeURIComponent(n);return`
                <div class="qr-card">
                    <div class="qr-card-header">
                        <span class="qr-card-tag"><i class="fas fa-shield-alt"></i> SafetyHub | ICAPP</span>
                        <span class="qr-card-badge">\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643 #${o+1}</span>
                    </div>
                    <div class="qr-card-body">
                        <div class="qr-card-info">
                            <div class="qr-card-site" style="font-size:${s};">${Utils.escapeHTML(g)}</div>
                            <div class="qr-card-place" style="font-size:${d};">${Utils.escapeHTML(x)}</div>
                            <div class="qr-card-inst"><i class="fas fa-camera ml-1"></i> \u0627\u0645\u0633\u062D \u0644\u0644\u0625\u0628\u0644\u0627\u063A \u0627\u0644\u0641\u0648\u0631\u064A \u0639\u0646 \u062E\u0637\u0631 \u0648\u0634\u064A\u0643</div>
                        </div>
                        <div class="qr-card-img-wrap">
                            <img src="${m}" alt="QR" class="qr-code-img" style="width:${r}px; height:${r}px;" onerror="if(!this.dataset.errCount){this.dataset.errCount=1;this.src='https://quickchart.io/qr?size=${r}&text=${b}';}">
                        </div>
                    </div>
                </div>
            `}).join("");a.document.write(`
