...
`))&&n.remove()})},printPermitForm(){if(!document.getElementById("ptw-form")){Notification.warning(this._t("module.ptw.notify.formNotFound","\u0627\u0644\u0646\u0645\u0648\u0630\u062C \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}try{const e=this.collectFormDataForPrint(),a=this.currentEditId||e.id||"NEW",r=`PTW-${a.substring(0,8)}`,s=this.generatePrintContent(e),i=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(r,`\u062A\u0635\u0631\u064A\u062D \u0639\u0645\u0644 #${a.substring(0,8)}`,s,!1,!1,{version:"1.0",releaseDate:e.createdAt||new Date().toISOString(),revisionDate:e.updatedAt||new Date().toISOString(),compactPdfFooter:!0,"\u0631\u0642\u0645 \u0627\u0644\u062A\u0635\u0631\u064A\u062D":a.substring(0,8)},e.createdAt||new Date().toISOString(),e.updatedAt||new Date().toISOString()):`<html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>\u0637\u0628\u0627\u0639\u0629 \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644</title></head><body>${s}</body></html>`,o=new Blob([i],{type:"text/html;charset=utf-8"}),n=URL.createObjectURL(o),l=window.open(n,"_blank");l?l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>{URL.revokeObjectURL(n)},800)},500)}:Notification.error(this._t("module.ptw.notify.popupsPrint","\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629"))}catch(e){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0637\u0628\u0627\u0639\u0629 \u0627\u0644\u0646\u0645\u0648\u0630\u062C:",e),Notification.error(this._t("module.ptw.notify.printErr","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u0637\u0628\u0627\u0639\u0629: ")+e.message)}},collectFormDataForPrint(){if(!document.getElementById("ptw-form"))return{};const e=document.getElementById("ptw-location"),a=document.getElementById("ptw-sublocation"),r=e?.options[e?.selectedIndex]?.text||"",s=a?.options[a?.selectedIndex]?.text||"",i=c=>{const m=[];return document.querySelectorAll(`input[name="${c}-option"]`).forEach(u=>{if(u.checked)if(u.value==="other"){const h=document.getElementById(`${c}-other-text`)?.value.trim();h&&m.push(h)}else{const h=u.getAttribute("data-label")||u.value;m.push(h)}}),m},o=[];document.querySelectorAll("#approvals-tbody tr").forEach((c,m)=>{const h=document.getElementById(`approval-role-${m}`)?.value.trim()||"",f=document.getElementById(`approval-approver-select-${m}`),x=document.getElementById(`approval-approver-${m}`),y=f?f.options[f.selectedIndex]?.text||"":x?.value.trim()||"",b=document.getElementById(`approval-status-${m}`)?.value||"pending",z=document.getElementById(`approval-date-${m}`)?.value||"",C=document.getElementById(`approval-comments-${m}`)?.value.trim()||"";h&&o.push({role:h,approver:y,status:b,date:z,comments:C})});const l=typeof PPEMatrix<"u"?PPEMatrix.getSelected():[],p={};if(typeof RiskMatrix<"u"){const c=document.querySelector("#ptw-risk-matrix .risk-matrix-cell.selected")||document.querySelector('#ptw-risk-matrix .risk-matrix-cell[data-selected="true"]');c&&(p.likelihood=c.getAttribute("data-likelihood")||c.getAttribute("data-probability")||"",p.consequence=c.getAttribute("data-consequence")||c.getAttribute("data-severity")||"",p.riskLevel=c.textContent.trim()||"")}const d=document.getElementById("ptw-risk-notes")?.value.trim()||"";return{id:this.currentEditId||"NEW",location:r,sublocation:s,workDescription:document.getElementById("ptw-workDescription")?.value||"",startDate:document.getElementById("ptw-startDate")?.value||"",endDate:document.getElementById("ptw-endDate")?.value||"",requestingParty:(()=>{const c=document.getElementById("ptw-requestingParty-select"),m=document.getElementById("ptw-requestingParty");return c&&c.value&&c.value!=="__custom__"?c.value.trim():m?m.value.trim():""})(),authorizedParty:(()=>{const c=document.getElementById("ptw-authorizedParty-select"),m=document.getElementById("ptw-authorizedParty");return c&&c.value&&c.value!=="__custom__"?c.value.trim():m?m.value.trim():""})(),equipment:this.collectEquipmentFieldValue(document,{matrixId:"#ptw-equipment-matrix",notesId:"#ptw-equipment-notes"}),tools:document.getElementById("ptw-tools")?.value||"",teamMembers:Array.from(document.querySelectorAll("#team-members-list .ptw-team-member-name")).map(c=>({name:c.value.trim()})).filter(c=>c.name),hotWorkDetails:i("ptw-hot"),hotWorkOther:document.getElementById("ptw-hot-other-text")?.value.trim()||"",confinedSpaceDetails:i("ptw-confined"),confinedSpaceOther:document.getElementById("ptw-confined-other-text")?.value.trim()||"",heightWorkDetails:i("ptw-height"),heightWorkOther:document.getElementById("ptw-height-other-text")?.value.trim()||"",electricalWorkType:document.getElementById("ptw-electrical-work-type")?.value.trim()||"",coldWorkType:document.getElementById("ptw-cold-work-type")?.value.trim()||"",otherWorkType:document.getElementById("ptw-other-work-type")?.value.trim()||"",excavationLength:document.getElementById("ptw-excavation-length")?.value.trim()||"",excavationWidth:document.getElementById("ptw-excavation-width")?.value.trim()||"",excavationDepth:document.getElementById("ptw-excavation-depth")?.value.trim()||"",soilType:document.getElementById("ptw-excavation-soil")?.value.trim()||"",preStartChecklist:document.getElementById("ptw-preStartChecklist")?.checked||!1,lotoApplied:document.getElementById("ptw-lotoApplied")?.checked||!1,governmentPermits:document.getElementById("ptw-governmentPermits")?.checked||!1,riskAssessmentAttached:document.getElementById("ptw-riskAssessmentAttached")?.checked||!1,gasTesting:document.getElementById("ptw-gasTesting")?.checked||!1,mocRequest:document.getElementById("ptw-mocRequest")?.checked||!1,requiredPPE:l,riskAssessment:p,riskNotes:d,permitDisclaimer:document.getElementById("ptw-permit-disclaimer-text")?.value.trim()||"",approvals:o,closureStatus:document.querySelector('input[name="ptw-closure-status"]:checked')?.value||"",closureTime:document.getElementById("ptw-closure-time")?.value||"",closureReason:document.getElementById("ptw-closure-reason")?.value||"",closureApprovals:(()=>{const c=[],m=document.getElementById("closure-approvals-tbody");return m&&m.querySelectorAll("tr[data-closure-approval-index]").forEach((h,f)=>{const x=document.getElementById(`closure-approval-role-${f}`),y=document.getElementById(`closure-approval-approver-select-${f}`),k=document.getElementById(`closure-approval-approver-${f}`),b=document.getElementById(`closure-approval-approver-manual-${f}`),E=document.getElementById(`closure-approval-status-${f}`),z=document.getElementById(`closure-approval-date-${f}`),_=document.getElementById(`closure-approval-comments-${f}`);let C=y?.value||"",M=k?.value||"";y&&(C==="__manual__"?(C="",M=b?.value?.trim()||""):C?M=y.options[y.selectedIndex]?.text?.replace(/\s*\((?:مقاول|موظف)\)\s*(\s*-\s*.*)?$/,"").trim()||M:M=""),c.push({role:x?.value||"",approverId:C,approver:M,status:E?.value||"pending",date:z?.value||"",comments:_?.value||"",required:h.getAttribute("data-required")!=="false"})}),c})(),closureApprovalCircuitOwnerId:document.getElementById("closure-approval-circuit-owner-id")?.value||"__default__",closureApprovalCircuitName:this.formClosureCircuitName||"",closureApproval:{name1:"",name2:"",name3:"",name4:"",signature1:"",signature2:"",signature3:"",signature4:""},createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()}},generatePrintContent(t){const e=m=>m?String(m).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):"",a=m=>{if(!m)return"-";try{const u=this.parseDateTimeValue(m);return!u||isNaN(u.getTime())?m||"-":u.toLocaleDateString("ar-SA",{year:"numeric",month:"long",day:"numeric"})}catch{return m}},r=m=>{if(!m)return"-";try{const u=this.parseDateTimeValue(m);return!u||isNaN(u.getTime())?m||"-":u.toLocaleString("ar-SA",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return m}},s=t.teamMembers&&t.teamMembers.length>0?t.teamMembers.map(m=>e(m.name)).join("\u060C "):"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";let i=t.hotWorkDetails&&t.hotWorkDetails.length>0?t.hotWorkDetails.map(m=>e(m)).join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F";t.hotWorkOther&&(i=(i!=="\u0644\u0627 \u064A\u0648\u062C\u062F"?i+"\u060C ":"")+e(t.hotWorkOther));let o=t.confinedSpaceDetails&&t.confinedSpaceDetails.length>0?t.confinedSpaceDetails.map(m=>e(m)).join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F";t.confinedSpaceOther&&(o=(o!=="\u0644\u0627 \u064A\u0648\u062C\u062F"?o+"\u060C ":"")+e(t.confinedSpaceOther));let n=t.heightWorkDetails&&t.heightWorkDetails.length>0?t.heightWorkDetails.map(m=>e(m)).join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F";t.heightWorkOther&&(n=(n!=="\u0644\u0627 \u064A\u0648\u062C\u062F"?n+"\u060C ":"")+e(t.heightWorkOther));const l=[];t.preStartChecklist&&l.push("\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u062A\u062D\u0642\u0642 \u0628\u0642\u0631\u0627\u0631 \u0628\u062F\u0621 \u0627\u0644\u0639\u0645\u0644"),t.lotoApplied&&l.push("\u062A\u0637\u0628\u064A\u0642 \u0646\u0638\u0627\u0645 \u0627\u0644\u0639\u0632\u0644 LOTO"),t.governmentPermits&&l.push("\u062A\u0635\u0627\u0631\u064A\u062D \u062C\u0647\u0627\u062A \u062D\u0643\u0648\u0645\u064A\u0629"),t.riskAssessmentAttached&&l.push("\u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0645\u062E\u0627\u0637\u0631 \u0648\u0648\u0633\u0627\u0626\u0644 \u0627\u0644\u062A\u062D\u0643\u0645"),t.gasTesting&&l.push("\u0642\u064A\u0627\u0633 \u0627\u0644\u063A\u0627\u0632\u0627\u062A"),t.mocRequest&&l.push("\u0637\u0644\u0628 \u062A\u063A\u064A\u064A\u0631 \u0641\u0646\u064A (MOC)");const p=l.length>0?l.join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F",d=t.requiredPPE&&t.requiredPPE.length>0?t.requiredPPE.map(m=>e(m)).join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F",c=t.approvals&&t.approvals.length>0?`
        ...
        `},_wrapPermitHtmlForA4Export(t){if(!t)return t;const e=`<style id="ptw-a4-export-overrides">${this.getPermitA4ExportOverrides_()}</style>`;return t.includes("</head>")?t.replace("</head>",`${e}</head>`):`<!DOCTYPE html><html dir="rtl" lang="ar"><head><meta charset="UTF-8">${e}</head><body><div id="ptw-permit-print-root">${t}</div></body></html>`},_formatManualPermitDateTime(t){if(!t||t==="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F")return"\u2014";try{const e=this.parseDateTimeValue(t);return!e||isNaN(e.getTime())?String(t):e.toLocaleString("ar-SA",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return String(t)}},generateManualPermitPrintContent(t){const e=this.normalizeManualPermitEntryForPrint(t);if(!e)return"";const a=S=>Utils.escapeHTML(S==null?"":String(S)),r=(S,P,A=!1)=>`
            ...
            </tr>`).join(""),n=[{key:"preStartChecklist",label:"\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u062A\u062D\u0642\u0642 \u0628\u0642\u0631\u0627\u0631 \u0628\u062F\u0621 \u0627\u0644\u0639\u0645\u0644"},{key:"lotoApplied",label:"\u062A\u0637\u0628\u064A\u0642 \u0646\u0638\u0627\u0645 \u0627\u0644\u0639\u0632\u0644 LOTO"},{key:"governmentPermits",label:"\u062A\u0635\u0627\u0631\u064A\u062D \u062C\u0647\u0627\u062A \u062D\u0643\u0648\u0645\u064A\u0629"},{key:"riskAssessmentAttached",label:"\u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0645\u062E\u0627\u0637\u0631 \u0648\u0648\u0633\u0627\u0626\u0644 \u0627\u0644\u062A\u062D\u0643\u0645"},{key:"gasTesting",label:"\u0642\u064A\u0627\u0633 \u0627\u0644\u063A\u0627\u0632\u0627\u062A"},{key:"mocRequest",label:"\u0637\u0644\u0628 \u062A\u063A\u064A\u064A\u0631 \u0641\u0646\u064A (MOC)"}],l=S=>S===!0||S==="true"||S===1||S==="1",p=n.map(S=>{const P=l(e[S.key]);return`<div class="manual-print-req-item${P?" on":""}">${P?"\u2611":"\u2610"} ${a(S.label)}</div>`}).join(""),d=[],c=(S,P,A)=>{const U=Array.isArray(P)?P.filter(Boolean):[],F=A?String(A).trim():"";!U.length&&!F||d.push(`<div class="manual-work-block"><h4>${a(S)}</h4><div>${a([...U,F].filter(Boolean).join("\u060C ")||"\u2014")}</div></div>`)};c("\u0623\u0639\u0645\u0627\u0644 \u0633\u0627\u062E\u0646\u0629",e.hotWorkDetails,e.hotWorkOther),c("\u0623\u0645\u0627\u0643\u0646 \u0645\u063A\u0644\u0642\u0629",e.confinedSpaceDetails,e.confinedSpaceOther),c("\u0639\u0645\u0644 \u0639\u0644\u0649 \u0627\u0631\u062A\u0641\u0627\u0639",e.heightWorkDetails,e.heightWorkOther),(e.excavationLength||e.excavationWidth||e.excavationDepth||e.soilType)&&d.push(`<div class="manual-work-block"><h4>\u0623\u0639\u0645\u0627\u0644 \u062D\u0641\u0631</h4>
            ...
            ${d.length?d.join(""):'<div class="manual-print-field full"><div class="val">\u2014</div></div>'}`,h={5:"\u0634\u0628\u0647 \u0645\u0624\u0643\u062F",4:"\u0645\u062D\u062A\u0645\u0644 \u062C\u062F\u0627\u064B",3:"\u0645\u062D\u062A\u0645\u0644",2:"\u063A\u064A\u0631 \u0645\u062D\u062A\u0645\u0644",1:"\u0646\u0627\u062F\u0631"},f=parseInt(e.riskLikelihood,10),x=parseInt(e.riskConsequence,10),y=[5,4,3,2,1].map(S=>{const P=[1,2,3,4,5].map(A=>{const U=S*A;let F="#22c55e",X="#fff";return U<=4?(F="#22c55e",X="#fff"):U<=9?(F="#eab308",X="#1c1917"):U<=16?(F="#f97316",X="#fff"):(F="#dc2626",X="#fff"),`<td class="risk-cell${f===S&&x===A?" risk-selected":""}" style="background:${F};color:${X};">${U}</td>`}).join("");return`<tr><td class="row-label">${S} - ${h[S]}</td>${P}</tr>`}).join(""),k=e.riskScore?e.riskScore<=4?"#22c55e":e.riskScore<=9?"#eab308":e.riskScore<=16?"#f97316":"#dc2626":"#94a3b8",b=e.riskScore>4&&e.riskScore<=9?"#1c1917":"#fff",z=["\u0645\u0633\u0626\u0648\u0644 \u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0637\u0627\u0644\u0628\u0629","\u0645\u062F\u064A\u0631 \u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644","\u0645\u062F\u064A\u0631 / \u0645\u0647\u0646\u062F\u0633 \u0627\u0644\u0635\u064A\u0627\u0646\u0629","\u0645\u0633\u0626\u0648\u0644 \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0648\u0627\u0644\u0635\u062D\u0629 \u0627\u0644\u0645\u0647\u0646\u064A\u0629"].map(S=>this._findManualApprovalByRoles(e.manualApprovals,[S,S.replace(/ئ/g,"\u0624"),S.replace(/ؤ/g,"\u0626"),S.replace(/مسئول/g,"\u0645\u0633\u0624\u0648\u0644"),S.replace(/مسؤول/g,"\u0645\u0633\u0626\u0648\u0644")])),C=["\u0645\u0633\u0624\u0648\u0644 \u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0637\u0627\u0644\u0628\u0629","\u0645\u062F\u064A\u0631 \u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644","\u0645\u0633\u0624\u0648\u0644 \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0648\u0627\u0644\u0635\u062D\u0629 \u0627\u0644\u0645\u0647\u0646\u064A\u0629","\u0645\u062F\u064A\u0631 \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0648\u0627\u0644\u0635\u062D\u0629 \u0627\u0644\u0645\u0647\u0646\u064A\u0629"].map(S=>this._findManualApprovalByRoles(e.manualClosureApprovals,[S,S.replace(/ئ/g,"\u0624"),S.replace(/ؤ/g,"\u0626"),S.replace(/مسئول/g,"\u0645\u0633\u0624\u0648\u0644"),S.replace(/مسؤول/g,"\u0645\u0633\u0626\u0648\u0644")])),M=S=>{const P=String(S||"").trim();return P?a(P):"\u2014"},R=e.status==="\u0627\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644 \u0628\u0634\u0643\u0644 \u0622\u0645\u0646"?"manual-status-completed":e.status==="\u0625\u063A\u0644\u0627\u0642 \u062C\u0628\u0631\u064A"?"manual-status-forced":e.status==="\u0644\u0645 \u064A\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644"?"manual-status-incomplete":"",W=e.sublocation||(Array.isArray(e.locationEntries)&&e.locationEntries.length?e.locationEntries.map(S=>S.sublocation).filter(Boolean).join(" | "):"");return`
            ...
            <div class="ptw-manual-form-section manual-section-9">
                ...
                <table class="ptw-paper-grid-table">
                    ...
                    <tbody>
                        <tr>
                            <td class="row-label">\u0627\u0644\u0627\u0633\u0645</td>
                            ${C.map(S=>`<td class="approval-name-cell">${M(S.name)}</td>`).join("")}
                        </tr>
                        <tr>
                            <td class="row-label">\u0627\u0644\u062A\u0648\u0642\u064A\u0639</td>
                            ${C.map(S=>`<td class="approval-sig-cell">${M(S.signature)}</td>`).join("")}
                        </tr>
                    </tbody>
                </table>
            </div>
...
\u0633\u064A\u062A\u0645 \u062D\u0630\u0641\u0647 \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u0627\u0644\u0646\u0638\u0627\u0645.`)))try{Loading.show();const e=AppState.appData.ptw.findIndex(r=>r.id===t);e>-1&&AppState.appData.ptw.splice(e,1),this.removeFromRegistry(t),typeof window.DataManager<"u"&&window.DataManager.save&&await window.DataManager.save(),document.querySelector(".modal-overlay")?.remove(),this.loadPTWList(!0);const a=document.getElementById("ptw-registry-content");a&&a.style.display!=="none"&&this._refreshRegistryViewLight(!0),Notification.success(this._t("module.ptw.notify.deleted","\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062A\u0635\u0631\u064A\u062D \u0628\u0646\u062C\u0627\u062D"))}catch(e){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u062A\u0635\u0631\u064A\u062D:",e),Notification.error(this._t("module.ptw.notify.deleteErr","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u062A\u0635\u0631\u064A\u062D"))}finally{Loading.hide()}},setupRegistryEventListeners(){const t=document.getElementById("ptw-registry-import-excel");t&&(t.onclick=()=>this.showImportExcelModal());const e=document.getElementById("ptw-registry-export-excel");e&&(e.onclick=()=>this.exportRegistryToExcel());const a=document.getElementById("ptw-registry-export-pdf");a&&(a.onclick=()=>this.exportRegistryToPDF());const r=document.getElementById("registry-search");r&&(r.oninput=()=>{clearTimeout(this._registryFilterDebounceTimer),this._registryFilterDebounceTimer=setTimeout(()=>this.applyRegistryFilters(),120)},r.onkeydown=n=>{n.key==="Escape"&&r.value&&(r.value="",this.applyRegistryFilters())});const s=document.getElementById("registry-filter-status");s&&(s.onchange=()=>this.applyRegistryFilters());const i=document.getElementById("registry-filter-date-from"),o=document.getElementById("registry-filter-date-to");i&&(i.onchange=()=>this.applyRegistryFilters()),o&&(o.onchange=()=>this.applyRegistryFilters()),this.applyRegistryFilters()},_normalizeRegistrySearchText(t){return String(t??"").trim().replace(/\s+/g," ").replace(/[أإآٱ]/g,"\u0627").replace(/ة/g,"\u0647").replace(/ى/g,"\u064A").toLowerCase()},_getLinkedPermitForRegistryEntry(t){if(!t||t.isManualEntry)return null;const e=String(t.permitId||"").trim();return e&&(Array.isArray(AppState?.appData?.ptw)?AppState.appData.ptw:[]).find(r=>r&&(String(r.id)===e||String(r.permitId||"")===e))||null},_getRegistryEntrySearchHaystack(t){if(!t)return[];const e=this._getLinkedPermitForRegistryEntry(t),a=(()=>{try{return this.getPermitTypeDisplay(t)}catch{return""}})(),r=(()=>{try{return this.statusLabel(t.status)}catch{return String(t.status||"")}})(),s=(()=>{try{return this.getPermitDisplayNumber(t)}catch{return""}})();return[t.paperPermitNumber,t.paperPermitNo,t.permitNumber,t.sequentialNumber,t.permitId,t.id,s,t.workDescription,t.requestingParty,t.authorizedParty,t.location,t.sublocation,t.supervisor1,t.supervisor2,a,r,e?.paperPermitNumber,e?.paperPermitNo,e?.permitNumber,e?.id,e?.workDescription].map(o=>String(o??"").trim()).filter(o=>o&&o!=="\u2014"&&o!=="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"&&o!=="-")},_registryEntryMatchesSearch(t,e){const a=this._normalizeRegistrySearchText(e);if(!a)return!0;const r=this._getRegistryEntrySearchHaystack(t);if(r.some(i=>this._normalizeRegistrySearchText(i).includes(a)))return!0;const s=String(e||"").replace(/\D/g,"");return s&&/^\d+$/.test(String(e||"").trim())?r.some(i=>{const o=String(i).replace(/\D/g,"");return o&&(o===s||o.includes(s))}):!1},resetRegistryFilters(){const t=document.getElementById("registry-search"),e=document.getElementById("registry-filter-status"),a=document.getElementById("registry-filter-date-from"),r=document.getElementById("registry-filter-date-to");t&&(t.value=""),e&&(e.value=""),a&&(a.value=""),r&&(r.value=""),clearTimeout(this._registryFilterDebounceTimer),this.applyRegistryFilters(),t&&typeof t.focus=="function"&&t.focus()},applyRegistryFilters(){const t=document.getElementById("registry-search")?.value.trim()||"",e=t.toLowerCase(),a=document.getElementById("registry-filter-status")?.value||"",r=document.getElementById("registry-filter-date-from")?.value||"",s=document.getElementById("registry-filter-date-to")?.value||"",i=!!(t||a||r||s),o=document.querySelectorAll("[data-registry-id]");let n=0;o.forEach(m=>{let u=!0;const h=m.textContent.toLowerCase(),f=m.getAttribute("data-registry-id"),x=f!=null?String(f):"",y=this.registryData.find(b=>b.id!=null&&String(b.id)===x||b.permitId!=null&&String(b.permitId)===x);if(!y){m.style.display="none";return}t&&(this._registryEntryMatchesSearch(y,t)||e&&h.includes(e)||(u=!1)),a&&y.status!==a&&(u=!1);const k=y.timeFrom||y.openDate;if(r){const b=k?new Date(k):null,E=b&&!isNaN(b.getTime())?b.toISOString().split("T")[0]:"";(!E||E<r)&&(u=!1)}if(s){const b=k?new Date(k):null,E=b&&!isNaN(b.getTime())?b.toISOString().split("T")[0]:"";(!E||E>s)&&(u=!1)}m.style.display=u?"":"none",u&&(n+=1)});const l=document.getElementById("registry-filter-count");l&&(l.textContent=String(n));const p=document.getElementById("ptw-registry-filter-count-head"),d=document.getElementById("ptw-registry-visible-count");p&&(p.textContent=String(n)),d&&(d.textContent=String(n));const c=document.getElementById("registry-filter-reset");c&&(c.disabled=!i),["registry-search","registry-filter-status","registry-filter-date-from","registry-filter-date-to"].forEach(m=>{const u=document.getElementById(m),h=u?.closest?.("[data-registry-filter-field]");h&&h.classList.toggle("is-active",!!u.value)})},toggleManualPermitFormFullscreen(t){const e=t&&t.closest?t.closest(".ptw-manual-permit-modal"):null;if(!e)return;const a=e.classList.toggle("ptw-manual-permit-modal-fullscreen"),r=t.querySelector("i"),s=t.querySelector(".ptw-manual-permit-fullscreen-label");r&&(r.className=a?"fas fa-compress":"fas fa-expand"),s&&(s.textContent=a?"\u0627\u0633\u062A\u0639\u0627\u062F\u0629":"\u0645\u0644\u0621 \u0627\u0644\u0634\u0627\u0634\u0629"),t.setAttribute("title",a?"\u0627\u0633\u062A\u0639\u0627\u062F\u0629":"\u0645\u0644\u0621 \u0627\u0644\u0634\u0627\u0634\u0629")},_normEquipmentItemKey(t){return String(t||"").trim().replace(/\s+/g," ").replace(/[أإآٱ]/g,"\u0627").replace(/ة/g,"\u0647").replace(/ى/g,"\u064A").toLowerCase()},getManualFixedEquipmentRowLabels(){return[["\u0631\u0627\u0641\u0639\u0629","\u0633\u0644\u0645 \u0645\u062A\u062D\u0631\u0643","\u0633\u0642\u0627\u0644\u0629","\u0645\u0646\u0635\u0629 \u0631\u0641\u0639","\u0648\u0646\u0634","\u0645\u0636\u062E\u0629","\u062E\u0632\u0627\u0646","\u062E\u0637 \u0623\u0646\u0627\u0628\u064A\u0628","\u0644\u0648\u062D\u0629 \u0643\u0647\u0631\u0628\u0627\u0626\u064A\u0629"],["\u0645\u0648\u0644\u062F \u0643\u0647\u0631\u0628\u0627\u0621","\u0636\u0627\u063A\u0637 \u0647\u0648\u0627\u0621","\u0645\u0627\u0643\u064A\u0646\u0629 \u0644\u062D\u0627\u0645","\u062C\u0644\u0627\u062E\u0629","\u0645\u0646\u0634\u0627\u0631","\u0645\u062B\u0642\u0627\u0628 \u0643\u0647\u0631\u0628\u0627\u0626\u064A","\u0645\u062D\u0631\u0643 \u0643\u0647\u0631\u0628\u0627\u0626\u064A","\u0631\u0627\u0641\u0639\u0629 \u0634\u0648\u0643\u064A\u0629","\u0639\u062F\u0629 \u064A\u062F\u0648\u064A\u0629 \u062E\u0641\u064A\u0641\u0629"],["\u0635\u0627\u0631\u0648\u062E","\u0647\u064A\u0644\u062A\u0649","\u0633\u064A\u0632\u0631","\u0634\u062D\u0646","\u0643\u0627\u0628\u0644 \u0643\u0647\u0631\u0628\u0627\u0621","\u0648\u0635\u0644\u0627\u062A \u0643\u0647\u0631\u0628\u0627\u0621","\u0623\u062E\u0631\u0649"]]},getManualFixedEquipmentLabels(){return this.getManualFixedEquipmentRowLabels().flat()},_isFixedEquipmentLabel(t){const e=this._normEquipmentItemKey(t);return this.getManualFixedEquipmentLabels().some(a=>this._normEquipmentItemKey(a)===e)},_splitEquipmentTokens(t){return String(t||"").split(/[-+،,]/).map(e=>e.trim().replace(/^[\d\s]+/,"")).filter(Boolean)},_collectEquipmentEntriesForLookup(t=null){const e=new Set,a=[],r=String(t||"").trim(),s=i=>{if(!i)return;const o=String(i.id||i.permitId||"").trim();if(r&&o&&o===r)return;const n=o||`seq:${i.sequentialNumber||""}:${i.paperPermitNo||i.permitNumber||""}`;n&&e.has(n)||(n&&e.add(n),a.push(i))};return(Array.isArray(this.registryData)?this.registryData:[]).forEach(s),(Array.isArray(AppState?.appData?.ptw)?AppState.appData.ptw:[]).forEach(s),a.sort((i,o)=>this._getManualPermitEntryTimestamp(o)-this._getManualPermitEntryTimestamp(i))},buildKnownEquipmentHistoryLabels(t=null,e=20){const a=new Set(this.getManualFixedEquipmentLabels().map(i=>this._normEquipmentItemKey(i))),r=new Set,s=[];return this._collectEquipmentEntriesForLookup(t).forEach(i=>{this._splitEquipmentTokens(i.equipment).forEach(o=>{const n=this._normEquipmentItemKey(o);!n||a.has(n)||r.has(n)||(r.add(n),s.push(o))})}),s.sort((i,o)=>i.localeCompare(o,"ar")),s.slice(0,e)},parseEquipmentToSelection(t,e=[]){const r=this.getManualFixedEquipmentRowLabels().flat(),s=Array.isArray(e)?e:[],i=new Map;[...r,...s].forEach(p=>{const d=this._normEquipmentItemKey(p);d&&!i.has(d)&&i.set(d,p)});const o=[],n=[],l=new Set;return this._splitEquipmentTokens(t).forEach(p=>{const d=this._normEquipmentItemKey(p);if(i.has(d)){const c=i.get(d);l.has(d)||(l.add(d),o.push(c))}else n.push(p)}),{matrixSelected:o,manualNotes:n.join("\u060C ")}},_equipmentSelectionIsChecked(t,e){const a=new Set((e||[]).map(i=>String(i||"").trim()).filter(Boolean)),r=String(t||"").trim();if(a.has(r))return!0;const s=this._normEquipmentItemKey(r);for(const i of a)if(this._normEquipmentItemKey(i)===s)return!0;return!1},buildManualFixedEquipmentCheckboxesHtml(t=[],e=[]){const a=Utils.escapeHTML,r=n=>this._equipmentSelectionIsChecked(n,t),s=this.getManualFixedEquipmentRowLabels(),i=(Array.isArray(e)?e:[]).filter(Boolean);let o='<div class="ptw-manual-equipment-fixed-wrap">';return s.forEach(n=>{o+='<div class="ptw-manual-equipment-chips-row ptw-manual-equipment-grid-row">',n.forEach(l=>{const p=r(l)?" checked":"";o+=`<label class="ptw-manual-equipment-cell"><input type="checkbox" class="equipment-fixed-cb" value="${a(l)}"${p}><span class="ptw-manual-equipment-label">${a(l)}</span></label>`}),o+="</div>"}),i.length&&(o+='<div class="ptw-manual-equipment-chips-row ptw-manual-equipment-history-row">',i.forEach(n=>{const l=r(n)?" checked":"";o+=`<label class="ptw-manual-equipment-cell ptw-manual-equipment-history-cell"><input type="checkbox" class="equipment-history-cb" value="${a(n)}"${l}><span class="ptw-manual-equipment-label">${a(n)}</span></label>`}),o+="</div>"),o+="</div>",o},buildManualFixedEquipmentPrintHtml(t=[]){const e=o=>Utils.escapeHTML(o),a=o=>this._equipmentSelectionIsChecked(o,t),r=this.getManualFixedEquipmentRowLabels(),s=(t||[]).filter(o=>{const n=String(o||"").trim();return n&&!this._isFixedEquipmentLabel(n)});let i='<div class="ptw-manual-equipment-print-matrix"><div class="ptw-manual-equipment-fixed-wrap">';return r.forEach((o,n)=>{const l=n===r.length-1?"ptw-manual-equipment-fixed-row equipment-row-last":"ptw-manual-equipment-fixed-row";i+=`<div class="${l}">`,o.forEach(p=>{const d=a(p);i+=`<span class="ptw-manual-equipment-cell${d?" equipment-selected":""}"><span class="equipment-checkbox${d?" checked":""}" aria-hidden="true"></span><span class="equipment-label">${e(p)}</span></span>`}),i+="</div>"}),s.length&&(i+='<div class="ptw-manual-equipment-fixed-row ptw-manual-equipment-history-row equipment-row-last">',s.forEach(o=>{i+=`<span class="ptw-manual-equipment-cell equipment-selected ptw-manual-equipment-history-cell"><span class="equipment-checkbox checked" aria-hidden="true"></span><span class="equipment-label">${e(o)}</span></span>`}),i+="</div>"),i+="</div></div>",i},collectEquipmentFieldValue(t,e={}){const a=t?.querySelector?t:document,r=e.matrixId||"#manual-equipment-matrix",s=e.notesId||"#manual-equipment-notes",i=a.querySelector(r),o=a.querySelector(s),n=Array.from(i?.querySelectorAll(".equipment-fixed-cb:checked")||[]).map(c=>String(c.value||"").trim()).filter(Boolean),l=Array.from(i?.querySelectorAll(".equipment-history-cb:checked")||[]).map(c=>String(c.value||"").trim()).filter(Boolean),p=String(o?.value||"").trim(),d=p?this._splitEquipmentTokens(p):[];return[...new Set([...n,...l,...d])].join("\u060C ")},setupManualEquipmentToolsSync(t){if(!t)return;const e=t.querySelector("#manual-permit-tools"),a=t.querySelector("#manual-equipment-matrix"),r=t.querySelector("#manual-equipment-notes");if(!e||!a)return;const s=()=>{const i=this.collectEquipmentFieldValue(t,{matrixId:"#manual-equipment-matrix",notesId:"#manual-equipment-notes"}),o=String(e.value||"").trim(),n=String(a.dataset.autoToolsValue||"").trim();(!o||o===n)&&(e.value=i,a.dataset.autoToolsValue=i)};s(),a.addEventListener("change",s),r?.addEventListener("input",s)},buildManualFixedPPECheckboxesHtml(t=[]){const e=Utils.escapeHTML,a=new Set((t||[]).map(n=>String(n||"").trim()).filter(Boolean)),r=n=>String(n||"").trim().replace(/\s+/g," ").replace(/[أإآٱ]/g,"\u0627").replace(/ة/g,"\u0647").replace(/ى/g,"\u064A"),s=n=>{const l=String(n).trim();if(a.has(l))return!0;const p=r(l);for(const d of a)if(r(d)===p)return!0;return!1},i=[["\u062D\u0630\u0627\u0621 \u0633\u0644\u0627\u0645\u0629","\u062C\u0648\u0627\u0646\u062A\u064A \u0633\u0644\u0627\u0645\u0629","\u062C\u0648\u0627\u0646\u062A\u0649 \u0627\u062D\u0645\u0627\u0636","\u062C\u0648\u0627\u0646\u062A\u064A \u0643\u0647\u0631\u0628\u064A","\u0643\u0645\u0627\u0645\u0629","\u0633\u062F\u0627\u062F\u0629 \u0623\u0630\u0646","\u0643\u0627\u062A\u0645 \u0623\u0630\u0646","\u0628\u062F\u0644\u0629 \u0643\u064A\u0645\u0627\u0626\u064A\u0629","\u0643\u0634\u0627\u0641 \u0625\u0646\u0627\u0631\u0629"],["\u0648\u0627\u0642\u064A \u0631\u0623\u0633","\u0646\u0638\u0627\u0631\u0629 \u0648\u0627\u0642\u064A\u0629","\u0648\u062C\u0647 \u0644\u062D\u0627\u0645","\u0623\u0630\u0631\u0639 \u0648\u0627\u0642\u064A\u0629","\u062D\u0632\u0627\u0645 \u0623\u0645\u0627\u0646","\u062D\u0628\u0644 \u0633\u0644\u0627\u0645\u0629","\u062C\u0647\u0627\u0632 \u062A\u0646\u0641\u0633","\u0633\u062A\u0631\u0629 \u0639\u0627\u0643\u0633\u0629","\u0634\u0631\u064A\u0637 \u0639\u0627\u0643\u0633"],["\u062D\u0648\u0627\u062C\u0632","\u0623\u0642\u0645\u0627\u0639 \u0645\u0631\u0648\u0631","\u0648\u0633\u0627\u0626\u0644 \u0627\u062A\u0635\u0627\u0644","\u0628\u0637\u0627\u0646\u064A\u0629 \u062D\u0631\u064A\u0642","\u0623\u062E\u0631\u0649"]];let o='<div class="ptw-manual-ppe-fixed-wrap">';return i.forEach(n=>{o+='<div class="ptw-manual-ppe-fixed-row">',n.forEach(l=>{const p=s(l)?" checked":"";o+=`<label class="ptw-manual-ppe-cell"><input type="checkbox" class="manual-ppe-fixed-cb" value="${e(l)}"${p}><span>${e(l)}</span></label>`}),o+="</div>"}),o+="</div>",o},async openManualPermitForm(t=null){if(typeof Permissions<"u"&&typeof Permissions.isReadOnlyRole=="function"&&Permissions.isReadOnlyRole()||!this.hasDetailedPermission("registry")){typeof Notification<"u"&&Notification.error&&Notification.error("\u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0644\u0643 \u0628\u0625\u0636\u0627\u0641\u0629 \u0623\u0648 \u062A\u0639\u062F\u064A\u0644 \u062A\u0635\u0631\u064A\u062D \u064A\u062F\u0648\u064A");return}const a="ptw-manual-form-loading-"+Date.now(),r=document.createElement("div");r.id=a,r.className="modal-overlay",r.style.zIndex="999999",r.innerHTML=`
        ...
        `,document.body.appendChild(r);try{await new Promise(g=>requestAnimationFrame(()=>requestAnimationFrame(()=>setTimeout(g,50))));const s=t!==null,i=t?this.registryData.find(g=>g.id===t):null;if(i&&(!i.teamMembers||!i.teamMembers.length)&&i.teamMembersText){const g=String(i.teamMembersText).trim();i.teamMembers=g.split(/[،,]/).map(I=>{I=I.trim();const q=I.match(/^(.+?)\s*\(([^)]*)\)\s*$/);return q?{name:q[1].trim(),signature:q[2].trim()}:{name:I,signature:""}}).filter(I=>I.name||I.signature)}i&&(!i.teamMembers||!i.teamMembers.length)&&(i.teamMembers=[{name:"",signature:""}]),["hotWorkDetails","confinedSpaceDetails","heightWorkDetails"].forEach(g=>{i&&i[g]!=null&&typeof i[g]=="string"&&(i[g]=i[g].split(/[،,]/).map(I=>I.trim()).filter(Boolean))});const o=this.getSiteOptions(),n=["\u0623\u0639\u0645\u0627\u0644 \u0633\u0627\u062E\u0646\u0629","\u0623\u0639\u0645\u0627\u0644 \u0628\u0627\u0631\u062F\u0629","\u0623\u0639\u0645\u0627\u0644 \u0643\u0647\u0631\u0628\u0627\u0626\u064A\u0629","\u0623\u0639\u0645\u0627\u0644 \u0641\u064A \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0627\u0644\u0645\u063A\u0644\u0642\u0629","\u0623\u0639\u0645\u0627\u0644 \u0641\u064A \u0627\u0644\u0627\u0631\u062A\u0641\u0627\u0639\u0627\u062A","\u0623\u0639\u0645\u0627\u0644 \u0623\u062E\u0631\u0649"],l=["\u0627\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644 \u0628\u0634\u0643\u0644 \u0622\u0645\u0646","\u0644\u0645 \u064A\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644","\u0625\u063A\u0644\u0627\u0642 \u062C\u0628\u0631\u064A"],d=String(i?.status||"").trim()||"\u0627\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644 \u0628\u0634\u0643\u0644 \u0622\u0645\u0646",c=i?.sequentialNumber||this.generateRegistrySequentialNumber(),m=typeof Contractors<"u"&&typeof Contractors.getContractorOptionsForModules=="function"?(Contractors.getContractorOptionsForModules({includeSuppliers:!0,approvedOnly:!0})||[]).map(g=>({name:(g.name||"").trim()})).filter(g=>g.name):[],u=m.length>0,h=i?.authorizedParty||"",f=this.getDepartmentOptionsForPTW(),x=f.length>0,y=i?.requestingParty||"",k=i?.requiredPPE&&Array.isArray(i.requiredPPE)&&i.requiredPPE.length?i.requiredPPE.map(g=>String(g||"").trim()).filter(Boolean):i?.ppeNotes?String(i.ppeNotes).split(/[،,]/).map(g=>g.trim()).filter(Boolean):[],b=i?.id||i?.permitId||null,E=this.buildKnownEquipmentHistoryLabels(b),z=this.parseEquipmentToSelection(i?.equipment,E),_=this.buildManualFixedEquipmentCheckboxesHtml(z.matrixSelected,E),C=typeof Training<"u"&&typeof Training.getSafetyTeamMembers=="function"?Training.getSafetyTeamMembers({excludeSystemUsers:!0}):[],M=(g,I)=>{const q=Utils.escapeHTML,K=String(I||"").trim(),Y=C.map(j=>String(j.name||"").trim()).filter(Boolean);let Q=`<option value="">${q(g)}</option>`;return Y.forEach(j=>{Q+=`<option value="${q(j)}"${K===j?" selected":""}>${q(j)}</option>`}),K&&!Y.includes(K)&&(Q+=`<option value="${q(K)}" selected>${q(K)}</option>`),Q},R=`class="form-input" style="border: 2px solid #e0e7ff; border-radius: 10px; transition: all 0.3s; padding: 10px 12px; width: 100%;" onfocus="this.style.borderColor='#667eea'; this.style.boxShadow='0 0 0 3px rgba(102,126,234,0.15)'" onblur="this.style.borderColor='#e0e7ff'; this.style.boxShadow='none'"`,W=this._manualEntryToPtwStub(i);let S=[],P=[];try{[S,P]=await Promise.all([this._fetchIaCandidatesForRole(W,"areaManager"),this._fetchIaCandidatesForRole(W,"maintenanceEngineer")])}catch(g){typeof Utils<"u"&&Utils.safeWarn("openManualPermitForm IA fetch:",g)}const A=g=>{const I=(i?.manualApprovals||[]).find(q=>q.role===g)||{};return{name:I.name||"",approverId:I.approverId||"",personType:I.personType||""}},U=A("\u0645\u062F\u064A\u0631 \u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644"),F=A("\u0645\u062F\u064A\u0631 / \u0645\u0647\u0646\u062F\u0633 \u0627\u0644\u0635\u064A\u0627\u0646\u0629"),X=(i?.manualClosureApprovals||[]).find(g=>g.role==="\u0645\u062F\u064A\u0631 \u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644")||{},st=this._renderIaRolePickerHTML({roleLabel:"\u0645\u062F\u064A\u0631 \u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644",roleKey:"areaManager",candidates:S,selectedId:U.approverId,selectedName:U.name}),v=this._renderIaRolePickerHTML({roleLabel:"\u0645\u062F\u064A\u0631 / \u0645\u0647\u0646\u062F\u0633 \u0627\u0644\u0635\u064A\u0627\u0646\u0629",roleKey:"maintenanceEngineer",candidates:P,selectedId:F.approverId,selectedName:F.name}),$=this._renderIaRolePickerHTML({roleLabel:"\u0645\u062F\u064A\u0631 \u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644",roleKey:"areaManager",candidates:S,selectedId:X.approverId||"",selectedName:X.name||"",isClosure:!0,inputClass:"form-input text-sm w-full manual-closure-approval-name"}),O=i?.id||i?.permitId||null,D=this.buildKnownTeamMembersIndex(O),w=this.buildKnownManualApprovalsIndex(O),V=this.buildManualPermitDatalistHtml(this.getKnownTeamMemberNames(D)),J=this.buildManualPermitDatalistHtml(this.getKnownApproverNamesForRole(w,"\u0645\u0633\u0626\u0648\u0644 \u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0637\u0627\u0644\u0628\u0629")),H=this.buildManualPermitDatalistHtml(this.getKnownApproverNamesForRole(w,"\u0645\u062F\u064A\u0631 \u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644")),Z=this.buildManualPermitDatalistHtml(this.getKnownApproverNamesForRole(w,"\u0645\u062F\u064A\u0631 / \u0645\u0647\u0646\u062F\u0633 \u0627\u0644\u0635\u064A\u0627\u0646\u0629")),B=document.createElement("div");B.className="modal-overlay",B.style.cssText="display: flex; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 10000; align-items: center; justify-content: center;",B.innerHTML=`
            <style>
            ...
            <div class="ptw-paper-footer">
                ...
                `;return w.hasOther?`
                        ...
                        <div id="${O}-other-wrapper" class="ptw-other-input ${V?"":"hidden"}">
                            <input type="text" id="${O}-other-text" class="form-input" placeholder="\u0627\u0630\u0643\u0631 \u0627\u0644\u062A\u0641\u0627\u0635\u064A\u0644" value="${l(D)}">
                        </div>
                    `:H}).join(""),st=p.map(v=>`
...
\u0648\u0639\u0644\u064A\u0647 \u0641\u0625\u0646\u0647 \u064A\u062C\u0628 \u0627\u0644\u0627\u0644\u062A\u0632\u0627\u0645 \u0628\u0645\u062F\u0629 \u0635\u0644\u0627\u062D\u064A\u0629 \u0627\u0644\u062A\u0635\u0631\u064A\u062D \u0644\u0644\u0639\u0645\u0644 \u0627\u0644\u0645\u0630\u0643\u0648\u0631 \u0623\u062F\u0646\u0627\u0647 \u0648\u0641\u0649 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0645\u0635\u0631\u062D \u0644\u0644\u0639\u0645\u0644 \u0641\u064A\u0647 \u0641\u0642\u0637.`)}</textarea>
        ...
        `,document.body.appendChild(a),this.setupEventListeners(t),setTimeout(()=>{const s=a.querySelector('input:not([type="hidden"]), select, textarea');s&&s.focus()},100)},async showList(){this.currentEditId=null,this.switchTab("permits"),await new Promise(e=>setTimeout(e,50));const t=document.getElementById("ptw-permits-content")||document.getElementById("ptw-content");t&&(t.style.display="block",t.style.visibility="visible",t.style.opacity="1",t.innerHTML=await this.renderList(),this.setupEventListeners(),this.loadPTWList(!0),setTimeout(()=>{t.scrollIntoView({behavior:"smooth",block:"start"})},100))},async handleSubmit(t){if(t.preventDefault(),this._isSubmitting){Notification.info(this._t("module.ptw.notify.waitRequest","\u062C\u0627\u0631\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u0627\u0644\u0637\u0644\u0628 \u0627\u0644\u0633\u0627\u0628\u0642\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631..."));return}const e=t.target?.querySelector('button[type="submit"]')||document.querySelector('#ptw-form button[type="submit"]')||t.target?.closest("form")?.querySelector('button[type="submit"]');if(e&&e.disabled)return;this._isSubmitting=!0;let a="";e&&(a=e.innerHTML,e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const r=!this.currentEditId,s=[];document.querySelectorAll("#approvals-tbody tr").forEach((P,A)=>{const U=Array.isArray(this.formApprovals)?this.formApprovals[A]||{}:{},X=document.getElementById(`approval-role-${A}`)?.value.trim()||U.role||"",st=P.getAttribute("data-required")!=="false",v=document.getElementById(`approval-approver-select-${A}`);let $=U.approverId||"",O=U.approver||"",D=U.approverEmail||"";if(v)if($=v.value||"",$==="__manual__")$="",O=document.getElementById(`approval-approver-manual-${A}`)?.value.trim()||"",D="";else if($){const tt=(U.candidates||[]).find(ot=>ot.id===$);if(tt)O=tt.name||"",D=tt.email||"";else{const ot=ApprovalCircuits.getUserById($);ot&&(O=ot.name||ot.email||O,D=ot.email||D)}}else O="",D="";else O=document.getElementById(`approval-approver-${A}`)?.value.trim()||O;const V=document.getElementById(`approval-status-${A}`)?.value||U.status||"pending",H=document.getElementById(`approval-date-${A}`)?.value||"",B=document.getElementById(`approval-comments-${A}`)?.value.trim()||"";X&&s.push({role:X,approver:O,approverId:$,approverEmail:D,status:V,approved:V==="approved",rejected:V==="rejected",date:H?new Date(H).toISOString():U.date||"",comments:B,order:A,required:st,candidates:Array.isArray(U.candidates)?U.candidates:[],history:Array.isArray(U.history)?U.history:[],assignedAt:U.assignedAt||"",assignedBy:U.assignedBy||null,isSafetyOfficer:U.isSafetyOfficer===!0,circuitOwnerId:U.circuitOwnerId||this.formCircuitOwnerId||"__default__",issuingAuthoritySource:U.issuingAuthoritySource===!0,approvalRoleKey:U.approvalRoleKey||this._resolveIaRoleKey(X),isManualApprover:!$&&!!O,personType:$&&(U.candidates||[]).find(tt=>tt.id===$)?.personType||"",requiresHseCoApproval:U.requiresHseCoApproval===!0,isHseCoApprovalGate:U.isHseCoApprovalGate===!0})});const o=P=>{const A=[];return document.querySelectorAll(`input[name="${P}-option"]`).forEach(U=>{if(U.checked)if(U.value==="other"){const F=document.getElementById(`${P}-other-text`)?.value.trim();F&&A.push(F)}else{const F=U.getAttribute("data-label")||U.value;A.push(F)}}),A},n=o("ptw-hot"),l=o("ptw-confined"),p=o("ptw-height"),d=document.getElementById("ptw-hot-other-text")?.value.trim()||"",c=document.getElementById("ptw-confined-other-text")?.value.trim()||"",m=document.getElementById("ptw-height-other-text")?.value.trim()||"",u=()=>Array.from(document.querySelectorAll("#team-members-list .ptw-team-member-row")).map(P=>{const A=P.querySelector(".ptw-team-member-name")?.value.trim();return A?{name:A}:null}).filter(Boolean),h=document.getElementById("ptw-workDescription"),f=document.getElementById("ptw-startDate"),x=document.getElementById("ptw-endDate");if(!h||!f||!x){Notification.error(this._t("module.ptw.notify.missingFormFields","\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649.")),e&&(e.disabled=!1,e.innerHTML=a);return}const y="",k="PTW",b=this.generateSequentialPTWId(""),E=this.currentEditId?AppState.appData.ptw.find(P=>P.id===this.currentEditId):null,z=document.getElementById("ptw-location"),_=document.getElementById("ptw-sublocation"),C=z?.value||"",M=z?.options[z?.selectedIndex]?.text||"",R=_?.value||"",W=_?.options[_?.selectedIndex]?.text||"",S={id:this.currentEditId||`${k}_${b}`,workType:"",workDescription:h.value.trim(),location:M||C,siteId:C,siteName:M,sublocation:W||R,sublocationId:R,sublocationName:W,startDate:(()=>{const P=f.value;return P&&Utils.dateTimeLocalToISO(P)||""})(),endDate:(()=>{const P=x.value;return P&&Utils.dateTimeLocalToISO(P)||""})(),status:E?.status||"\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629",approvals:this.normalizeApprovals(s),requiredPPE:typeof PPEMatrix<"u"?PPEMatrix.getSelected():[],riskAssessment:(()=>{if(typeof RiskMatrix>"u")return{};try{const P=document.querySelector("#ptw-risk-matrix .risk-matrix-cell.selected")||document.querySelector("#ptw-risk-matrix td.ring-2")||document.querySelector('#ptw-risk-matrix .risk-matrix-cell[data-selected="true"]');if(P){const A=P.getAttribute("data-likelihood")||P.getAttribute("data-probability")||"",U=P.getAttribute("data-consequence")||P.getAttribute("data-severity")||"",F=P.textContent.trim()||P.querySelector(".risk-matrix-cell-value")?.textContent.trim()||"";return{likelihood:A,consequence:U,riskLevel:F}}}catch(P){Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0642\u0631\u0627\u0621\u0629 \u0645\u0635\u0641\u0648\u0641\u0629 \u0627\u0644\u0645\u062E\u0627\u0637\u0631:",P)}return{}})(),riskNotes:document.getElementById("ptw-risk-notes")?.value.trim()||"",authorizedParty:(()=>{const P=document.getElementById("ptw-authorizedParty-select"),A=document.getElementById("ptw-authorizedParty");return P&&P.value&&P.value!=="__custom__"?P.value.trim():A?A.value.trim():""})(),requestingParty:(()=>{const P=document.getElementById("ptw-requestingParty-select"),A=document.getElementById("ptw-requestingParty");return P&&P.value&&P.value!=="__custom__"?P.value.trim():A?A.value.trim():""})(),equipment:this.collectEquipmentFieldValue(document,{matrixId:"#ptw-equipment-matrix",notesId:"#ptw-equipment-notes"}),tools:document.getElementById("ptw-tools")?.value.trim()||"",toolsList:document.getElementById("ptw-tools")?.value.trim()||"",teamMembers:u(),hotWorkDetails:n,hotWorkOther:d,confinedSpaceDetails:l,confinedSpaceOther:c,heightWorkDetails:p,heightWorkOther:m,electricalWorkType:document.getElementById("ptw-electrical-work-type")?.value.trim()||"",coldWorkType:document.getElementById("ptw-cold-work-type")?.value.trim()||"",otherWorkType:document.getElementById("ptw-other-work-type")?.value.trim()||"",excavationLength:document.getElementById("ptw-excavation-length")?.value.trim()||"",excavationWidth:document.getElementById("ptw-excavation-width")?.value.trim()||"",excavationDepth:document.getElementById("ptw-excavation-depth")?.value.trim()||"",soilType:document.getElementById("ptw-excavation-soil")?.value.trim()||"",preStartChecklist:document.getElementById("ptw-preStartChecklist")?.checked||!1,lotoApplied:document.getElementById("ptw-lotoApplied")?.checked||!1,governmentPermits:document.getElementById("ptw-governmentPermits")?.checked||!1,riskAssessmentAttached:document.getElementById("ptw-riskAssessmentAttached")?.checked||!1,gasTesting:document.getElementById("ptw-gasTesting")?.checked||!1,mocRequest:document.getElementById("ptw-mocRequest")?.checked||!1,closureStatus:document.querySelector('input[name="ptw-closure-status"]:checked')?.value||"",closureTime:(()=>{const P=document.getElementById("ptw-closure-time")?.value;return P&&Utils.dateTimeLocalToISO(P)||""})(),closureReason:document.getElementById("ptw-closure-reason")?.value.trim()||"",closureApproval:{name1:document.getElementById("ptw-closure-approval-name-1")?.value.trim()||"",name2:document.getElementById("ptw-closure-approval-name-2")?.value.trim()||"",name3:document.getElementById("ptw-closure-approval-name-3")?.value.trim()||"",name4:document.getElementById("ptw-closure-approval-name-4")?.value.trim()||"",signature1:document.getElementById("ptw-closure-approval-signature-1")?.value.trim()||"",signature2:document.getElementById("ptw-closure-approval-signature-2")?.value.trim()||"",signature3:document.getElementById("ptw-closure-approval-signature-3")?.value.trim()||"",signature4:document.getElementById("ptw-closure-approval-signature-4")?.value.trim()||""},permitDisclaimer:document.getElementById("ptw-permit-disclaimer-text")?.value.trim()||E?.permitDisclaimer||"",createdAt:E?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString(),approvalCircuitOwnerId:this.formCircuitOwnerId||E?.approvalCircuitOwnerId||"__default__",approvalCircuitName:this.formCircuitName||E?.approvalCircuitName||""};if(this.updatePermitStatus(S),r&&(S.status="\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629"),this.updateStatusField(S.status),S.startDate&&S.endDate){const P=this.parseDateTimeValue(S.startDate),A=this.parseDateTimeValue(S.endDate);if(P&&A&&A<=P){Notification.error(this._t("module.ptw.notify.endBeforeStart","\u064A\u062C\u0628 \u0623\u0646 \u064A\u0643\u0648\u0646 \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621 \u0628\u0639\u062F \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0628\u062F\u0621.")),this._isSubmitting=!1,e&&(e.disabled=!1,e.innerHTML=a);return}}if(!S.workDescription||!S.location||!S.status){Notification.error(this._t("module.ptw.notify.fillRequired","\u064A\u0631\u062C\u0649 \u0645\u0644\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629")),this._isSubmitting=!1,e&&(e.disabled=!1,e.innerHTML=a);return}if(r&&this.formCircuitOwnerId==="__issuing_authorities__"&&(!S.approvals||S.approvals.length===0)&&this._extractPermitTypeFields(S).length>0){Notification.error("\u0644\u0627 \u064A\u0648\u062C\u062F \u0623\u0634\u062E\u0627\u0635 \u0645\u0635\u0631\u062D \u0644\u0647\u0645 \u0628\u0627\u0644\u062A\u0648\u0642\u064A\u0639 \u0639\u0644\u0649 \u0647\u0630\u0627 \u0627\u0644\u0646\u0648\u0639 \u0645\u0646 \u0627\u0644\u062A\u0635\u0627\u0631\u064A\u062D. \u064A\u0631\u062C\u0649 \u0645\u0631\u0627\u062C\u0639\u0629 \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u0635\u0631\u062D \u0644\u0647\u0645 \u0628\u0627\u0644\u062A\u0648\u0642\u064A\u0639 (Issuing Authorities) \u0623\u0648 \u0627\u0644\u062A\u0646\u0633\u064A\u0642 \u0645\u0639 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645."),this._isSubmitting=!1,e&&(e.disabled=!1,e.innerHTML=a);return}try{if(this.currentEditId){const P=AppState.appData.ptw.findIndex(A=>A.id===this.currentEditId);if(P!==-1){const U=AppState.appData.ptw[P].status!=="\u0645\u063A\u0644\u0642",F=S.status==="\u0645\u063A\u0644\u0642"||S.closureStatus&&S.closureTime;AppState.appData.ptw[P]=S,S._wasClosedTransition=!!(U&&F)}}else AppState.appData.ptw.push(S),this.notifyPermitCreated(S);this.setPtwRegistryState(this.registryData,"handleSubmit.preBackground"),this.showList(),this._isSubmitting=!1,e&&(e.disabled=!1,e.innerHTML=a),Notification.info(this._t("module.ptw.notify.localSavedSyncing","\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B\u060C \u062C\u0627\u0631\u064D \u0645\u0632\u0627\u0645\u0646\u062A\u0647\u0627 \u0645\u0639 \u0627\u0644\u0633\u062D\u0627\u0628\u0629...")),Promise.allSettled([Promise.resolve().then(()=>{typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")}),this.currentEditId?this.updateRegistryEntry(S):this.addToRegistry(S),GoogleIntegration.autoSave("PTW",AppState.appData.ptw)]).then(P=>{const A=P[0]?.status==="rejected",U=P[1]?.status==="rejected",F=P[2],X=F?.status==="fulfilled"?F.value:null,st=!!(X&&X.success===!0);if(A&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B:",P[0]?.reason),U&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u0627\u0644\u062A\u0635\u0627\u0631\u064A\u062D:",P[1]?.reason),st)this.currentEditId?S._wasClosedTransition?Notification.success(this._t("module.ptw.notify.closeOk","\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u062A\u0635\u0631\u064A\u062D \u0628\u0646\u062C\u0627\u062D")):Notification.success(this._t("module.ptw.notify.permUpdateOk","\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0635\u0631\u064A\u062D \u0628\u0646\u062C\u0627\u062D")):Notification.success(this._t("module.ptw.notify.permAddOk","\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u062A\u0635\u0631\u064A\u062D \u0628\u0646\u062C\u0627\u062D"));else{const $=F?.status==="rejected"?F.reason?.message||String(F.reason||""):X?.message||"";Notification.warning(this._t("module.ptw.notify.cloudSyncFailed","\u062A\u0645 \u0627\u0644\u062D\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B\u060C \u0644\u0643\u0646 \u0641\u0634\u0644\u062A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0633\u062D\u0627\u0628\u0629: ")+($||this._t("module.ptw.notify.unknownError","\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641")))}this.triggerNotificationsUpdate(),this.updateKPIs();const v=document.getElementById("ptw-analysis-content");v&&v.style.display!=="none"&&(v.innerHTML=this.renderAnalysisContent(),this.setupAnalysisEventListeners())})}catch(P){Notification.error(this._t("module.ptw.notify.errorGeneric","\u062D\u062F\u062B \u062E\u0637\u0623: ")+P.message),this._isSubmitting=!1,e&&(e.disabled=!1,e.innerHTML=a)}},addTeamMemberRow(t=""){const e=document.getElementById("team-members-list");if(!e||!e.parentNode||!document.body.contains(e)){Utils.safeWarn("\u26A0\uFE0F addTeamMemberRow: container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0623\u0648 \u063A\u064A\u0631 \u0645\u062A\u0635\u0644 \u0628\u0627\u0644\u0640 DOM");return}const a=typeof Utils<"u"&&Utils&&typeof Utils.escapeHTML=="function"?Utils.escapeHTML(t||""):t||"",r=document.createElement("div");r.className="ptw-team-member-row flex items-center gap-3",r.innerHTML=`
                        ...
                        <div class="border-t pt-4 mt-4">
                            ...
                            <div class="table-wrapper">
                                <table class="data-table">
                                    ...
                                    <tbody>
                                        ${s.map((b,E)=>{const z=b.status==="approved"?"success":b.status==="rejected"?"danger":"warning",_=b.status==="approved"?"\u0645\u0648\u0627\u0641\u0642\u0629":b.status==="rejected"?"\u0645\u0631\u0641\u0648\u0636":"\u0642\u064A\u062F \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631",C=(b.candidates||[]).map(S=>`
...
`))&&a.remove()}),setTimeout(()=>{a.querySelectorAll('[onclick*="handleApprovalAction"][onclick*="approved"]').forEach(_=>{const C=_.getAttribute("onclick");if(C){const M=C.match(/handleApprovalAction\('([^']+)',\s*(\d+),\s*'approved'\)/);M&&M[1]&&M[2]&&(_.removeAttribute("onclick"),_.addEventListener("click",R=>{R.preventDefault(),R.stopPropagation(),this.handleApprovalAction(M[1],parseInt(M[2]),"approved")}))}}),a.querySelectorAll('[onclick*="handleApprovalAction"][onclick*="rejected"]').forEach(_=>{const C=_.getAttribute("onclick");if(C){const M=C.match(/handleApprovalAction\('([^']+)',\s*(\d+),\s*'rejected'\)/);M&&M[1]&&M[2]&&(_.removeAttribute("onclick"),_.addEventListener("click",R=>{R.preventDefault(),R.stopPropagation(),this.handleApprovalAction(M[1],parseInt(M[2]),"rejected")}))}}),a.querySelectorAll('[onclick*="assignApproval"]').forEach(_=>{const C=_.getAttribute("onclick");if(C){const M=C.match(/assignApproval\('([^']+)',\s*(\d+)\)/);M&&M[1]&&M[2]&&(_.removeAttribute("onclick"),_.addEventListener("click",R=>{R.preventDefault(),R.stopPropagation(),this.assignApproval(M[1],parseInt(M[2]))}))}})},50)},async handleApprovalAction(t,e,a){const r=`approval_${t}_${e}`;if(this[`_processing_${r}`]){Notification.info(this._t("module.ptw.notify.approvalProcessing","\u062C\u0627\u0631\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u0647\u0630\u0627 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631..."));return}const s=AppState.appData.ptw.find(l=>l.id===t);if(!s){Notification.error(this._t("module.ptw.notify.findPermitFail","\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644 \u0627\u0644\u0645\u062D\u062F\u062F"));return}s.approvals=this.normalizeApprovals(s.approvals||[]);const i=s.approvals[e];if(!i){Notification.error(this._t("module.ptw.notify.approvalItemMissing","\u0639\u0646\u0635\u0631 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}if(s.status==="\u0645\u063A\u0644\u0642"){Notification.warning(this._t("module.ptw.notify.cannotEditClosed","\u0644\u0627 \u064A\u0645\u0643\u0646 \u062A\u0639\u062F\u064A\u0644 \u062A\u0635\u0631\u064A\u062D \u0645\u063A\u0644\u0642"));return}if(i.status!=="pending"){Notification.info(this._t("module.ptw.notify.approvalDone","\u062A\u0645\u062A \u0645\u0639\u0627\u0644\u062C\u0629 \u0647\u0630\u0627 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u0628\u0627\u0644\u0641\u0639\u0644"));return}const o=AppState.currentUser?.email?AppState.currentUser.email.toLowerCase():"";if(i.approverEmail&&o&&i.approverEmail.toLowerCase()!==o&&AppState.currentUser?.role!=="admin"){Notification.warning(this._t("module.ptw.notify.otherUser","\u0647\u0630\u0627 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u0645\u0648\u062C\u0647 \u0625\u0644\u0649 \u0645\u0633\u062A\u062E\u062F\u0645 \u0622\u062E\u0631."));return}if(a==="approved"){const l=s.approvals.filter((d,c)=>c<e&&d.required!==!1);if(l.some(d=>d.status!=="approved")){const d=this._t("module.ptw.common.notSpecified","\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"),c=this._t("module.ptw.common.listSep","\u060C "),m=l.filter(u=>u.status!=="approved").map(u=>this.approvalRoleLabel(u.role||d)).join(c);Notification.warning(this._t("module.ptw.notify.prevApprovals","\u064A\u062C\u0628 \u0627\u0639\u062A\u0645\u0627\u062F \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0627\u062A \u0627\u0644\u0633\u0627\u0628\u0642\u0629 \u0623\u0648\u0644\u0627\u064B: {roles}").replace(/\{roles\}/g,m));return}}this[`_processing_${r}`]=!0;let n=i.comments||"";if(a==="rejected"){const l=prompt(this._t("module.ptw.approval.rejectPrompt","\u0623\u062F\u062E\u0644 \u0633\u0628\u0628 \u0627\u0644\u0631\u0641\u0636 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A):"),n);if(l===null){this[`_processing_${r}`]=!1;return}n=l.trim()}Loading.show();try{if(i.status=a==="approved"?"approved":"rejected",i.approved=a==="approved",i.rejected=a==="rejected",i.date=new Date().toISOString(),i.comments=n,AppState.currentUser&&(i.approver=AppState.currentUser.name||i.approver||"",i.approverEmail=AppState.currentUser.email||i.approverEmail||"",i.approverId=AppState.currentUser.id||i.approverId||""),i.history=Array.isArray(i.history)?i.history:[],i.history.push(ApprovalCircuits.buildHistoryEntry(a==="approved"?"approved":"rejected",{performedBy:ApprovalCircuits.buildUserSnapshot(AppState.currentUser),comments:n,status:i.status,timestamp:new Date().toISOString()})),this.updatePermitStatus(s),s.updatedAt=new Date().toISOString(),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),GoogleIntegration.autoSave("PTW",AppState.appData.ptw).catch(c=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 Google Sheets:",c)}),a==="approved"){const c=this.getNextPendingApproval(s.approvals);if(s.status==="\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647")Notification.success(this._t("module.ptw.notify.permAllApproved","\u062A\u0645 \u0627\u0639\u062A\u0645\u0627\u062F \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644 \u0628\u0634\u0643\u0644 \u0646\u0647\u0627\u0626\u064A \u0628\u0639\u062F \u0645\u0648\u0627\u0641\u0642\u0629 \u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0627\u062A \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629."));else{const m=this.approvalRoleLabel(i.role);if(Notification.success(this._t("module.ptw.notify.stageApproved",'\u062A\u0645 \u0627\u0639\u062A\u0645\u0627\u062F \u0645\u0631\u062D\u0644\u0629 "{r}".').replace(/\{r\}/g,m)),c&&c.role){const u=this.approvalRoleLabel(c.role);Notification.info(this._t("module.ptw.notify.nextRole","\u0627\u0644\u0645\u0631\u062D\u0644\u0629 \u0627\u0644\u062A\u0627\u0644\u064A\u0629 \u0628\u0627\u0646\u062A\u0638\u0627\u0631 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F: {r}").replace(/\{r\}/g,u))}else Notification.info(this._t("module.ptw.notify.allStages","\u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0631\u0627\u062D\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u062A\u0645 \u0627\u0639\u062A\u0645\u0627\u062F\u0647\u0627."))}}else{const c=this.approvalRoleLabel(i.role);Notification.error(this._t("module.ptw.notify.rejectedBy",'\u062A\u0645 \u0631\u0641\u0636 \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644 \u0645\u0646 \u0642\u0628\u0644 "{r}".').replace(/\{r\}/g,c)),n&&Notification.info(this._t("module.ptw.notify.rejectionReason","\u0633\u0628\u0628 \u0627\u0644\u0631\u0641\u0636: {c}").replace(/\{c\}/g,n))}this.triggerNotificationsUpdate(),this.loadPTWList();const l=document.getElementById("ptw-analysis-content");l&&l.style.display!=="none"&&(l.innerHTML=this.renderAnalysisContent(),this.setupAnalysisEventListeners());const p=document.getElementById("ptw-approvals-content");p&&p.style.display!=="none"&&setTimeout(()=>{this.refreshApprovalsContent()},300);const d=document.querySelector(".modal-overlay");d&&(d.remove(),setTimeout(()=>{this.viewPTW(t)},100))}catch(l){Utils.safeError("\u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0645\u0639\u0627\u0644\u062C\u0629 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F:",l),Notification.error(this._t("module.ptw.notify.approvalUpdateErr","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u062F\u064A\u062B \u062D\u0627\u0644\u0629 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F"))}finally{this[`_processing_${r}`]=!1,Loading.hide()}},async assignApproval(t,e){const a=AppState.appData.ptw.find(n=>n.id===t);if(!a){Notification.error(this._t("module.ptw.notify.findPermitFail","\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644 \u0627\u0644\u0645\u062D\u062F\u062F"));return}a.approvals=this.normalizeApprovals(a.approvals||[]);const r=a.approvals[e];if(!r){Notification.error(this._t("module.ptw.notify.approvalItemMissing","\u0639\u0646\u0635\u0631 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}const s=document.getElementById(`approval-assign-${t}-${e}`);if(!s){Notification.error(this._t("module.ptw.notify.cannotFindAssignee","\u062A\u0639\u0630\u0631 \u062A\u062D\u062F\u064A\u062F \u062E\u0627\u0646\u0629 \u0627\u0644\u062A\u0639\u064A\u064A\u0646"));return}const i=s.value;if(!i){Notification.warning(this._t("module.ptw.notify.selectApprover","\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0627\u0644\u0645\u0633\u0624\u0648\u0644 \u0639\u0646 \u0647\u0630\u0627 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F."));return}const o=ApprovalCircuits.getUserById(i);if(!o){Notification.error(this._t("module.ptw.notify.userNotInSystem","\u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0627\u0644\u0645\u062D\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A \u0627\u0644\u0646\u0638\u0627\u0645."));return}Loading.show();try{r.approverId=o.id||o.email||"",r.approver=o.name||o.email||"",r.approverEmail=o.email||"",r.assignedAt=new Date().toISOString(),r.assignedBy=ApprovalCircuits.buildUserSnapshot(AppState.currentUser),r.history=Array.isArray(r.history)?r.history:[],r.history.push(ApprovalCircuits.buildHistoryEntry("assigned",{assignedBy:r.assignedBy,assignedTo:ApprovalCircuits.buildUserSnapshot(o)})),this.updatePermitStatus(a),a.updatedAt=new Date().toISOString(),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("PTW",AppState.appData.ptw),Notification.success(this._t("module.ptw.notify.assignedTo","\u062A\u0645 \u062A\u0648\u062C\u064A\u0647 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u0625\u0644\u0649 {name}.").replace(/\{name\}/g,r.approver||"")),this.triggerNotificationsUpdate(),this.loadPTWList();const n=document.getElementById("ptw-analysis-content");n&&n.style.display!=="none"&&(n.innerHTML=this.renderAnalysisContent(),this.setupAnalysisEventListeners());const l=document.querySelector(".modal-overlay");l&&(l.remove(),this.viewPTW(t))}catch(n){Utils.safeError("\u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u0639\u064A\u064A\u0646 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629:",n),Notification.error(this._t("module.ptw.notify.assignErr","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u0639\u064A\u064A\u0646 \u0627\u0644\u0645\u0633\u0624\u0648\u0644 \u0639\u0646 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F"))}finally{Loading.hide()}},async deletePTW(t){if(confirm(this._t("module.ptw.notify.deletePtwShort","\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u062A\u0635\u0631\u064A\u062D\u061F"))){Loading.show();try{await this.removeFromRegistry(t),AppState.appData.ptw=AppState.appData.ptw.filter(a=>a.id!==t),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("PTW",AppState.appData.ptw),Loading.hide(),Notification.success(this._t("module.ptw.notify.deleted","\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062A\u0635\u0631\u064A\u062D \u0628\u0646\u062C\u0627\u062D")),this.updateKPIs(),this.loadPTWList(),this.triggerNotificationsUpdate();const e=document.getElementById("ptw-analysis-content");e&&e.style.display!=="none"&&(e.innerHTML=this.renderAnalysisContent(),this.setupAnalysisEventListeners())}catch(e){Notification.error(this._t("module.ptw.notify.errorGeneric","\u062D\u062F\u062B \u062E\u0637\u0623: ")+e.message),submitBtn&&(submitBtn.disabled=!1,submitBtn.innerHTML=originalText)}}},async exportPDF(t){try{Loading.show();const e=await this.buildPermitExportPayload(t);if(Loading.hide(),!e){Notification.error(this._t("module.ptw.notify.permitNotFound","\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u062A\u0635\u0631\u064A\u062D"));return}if(e.isManualEntry&&e.exportReview&&!e.exportReview.ok&&Utils.safeWarn("\u062A\u0635\u062F\u064A\u0631 \u062A\u0635\u0631\u064A\u062D \u064A\u062F\u0648\u064A \u0628\u0639\u0646\u0627\u0635\u0631 \u0646\u0627\u0642\u0635\u0629:",e.exportReview.failed),Loading.show(this._t("module.ptw.pdf.exportLoading","\u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 PDF...")),!await this._ensurePermitPdfLibs_()){Notification.error(this._t("module.ptw.notify.pdfLibsError","\u062A\u0639\u0630\u0651\u0631 \u062A\u062D\u0645\u064A\u0644 \u0645\u0643\u062A\u0628\u0627\u062A PDF \u2014 \u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062A\u0631\u0646\u062A"));return}await this._downloadPermitHtmlAsPdf(e.html,e.fileName)?Notification.success(this._t("module.ptw.notify.pdfDownloadOk","\u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062A\u0635\u0631\u064A\u062D PDF \u0628\u0646\u062C\u0627\u062D")):e.isManualEntry&&e.printHtml?(Notification.warning("\u062A\u0639\u0630\u0651\u0631 \u0627\u0644\u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0628\u0627\u0634\u0631 \u2014 \u062C\u0627\u0631\u064A \u0641\u062A\u062D \u0645\u0639\u0627\u064A\u0646\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629. \u0627\u062E\u062A\u0631 \xAB\u062D\u0641\u0638 \u0643\u0640 PDF\xBB \u0623\u0648 \xABMicrosoft Print to PDF\xBB."),this.openPermitPrintWindow(e.printHtml)):Notification.error(this._t("module.ptw.notify.pdfErr","\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF"))}catch(e){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF:",e);const a=this._t("module.ptw.notify.unknownError","\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641");Notification.error(this._t("module.ptw.notify.pdfErr","\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF: ")+(e?.message||a))}finally{Loading.hide()}},initMapFilters(){this.setupMapSettingsEventListeners(),["ptw-map-filter-status","ptw-map-filter-type"].forEach(a=>{const r=document.getElementById(a);if(r&&r.parentNode){const s=r.cloneNode(!0);r.parentNode.replaceChild(s,r),s.addEventListener("change",()=>this.updateMapUI())}});const t=(a,r)=>{const s=document.getElementById(a);if(s&&s.parentNode){const i=s.cloneNode(!0);s.parentNode.replaceChild(i,s),i.addEventListener("click",()=>this.switchMapType(r))}};t("ptw-map-type-normal","normal"),t("ptw-map-type-satellite","satellite"),t("ptw-map-type-terrain","terrain");const e=document.getElementById("ptw-map-fullscreen-btn");if(e&&e.parentNode){const a=e.cloneNode(!0);e.parentNode.replaceChild(a,e),a.addEventListener("click",()=>this.toggleFullscreen())}},updateMapUI(){this.currentTab==="map"&&this.updateMapMarkers()},getMarkerColor(t){switch(t){case"\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647":return"#10b981";case"\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629":return"#3b82f6";case"\u0645\u063A\u0644\u0642":return"#6b7280";case"\u0645\u0631\u0641\u0648\u0636":return"#ef4444";default:return"#f59e0b"}},createMapPopup(t){const e=Utils.escapeHTML;return`
        ...
        <div id="ptw-analytics-root" style="font-family:inherit;">
            ...
            `,document.head.appendChild(v)}if(["ptw-analysis-date-from","ptw-analysis-date-to","ptw-analysis-work-type","ptw-analysis-authorized","ptw-analysis-requesting","ptw-analysis-status"].forEach(v=>{const $=document.getElementById(v);if(!$)return;const O=$.closest("div");if(!O)return;const D=O.querySelector('.ptw-analysis-filter-label[data-filter-id="'+v+'"]');if(!D)return;const w=D.querySelector(".ptw-analysis-filter-badge");w&&w.remove();let V=!1;if(($.tagName==="INPUT"||$.tagName==="SELECT")&&(V=!!$.value),V&&r>0){const J=document.createElement("span");J.className="ptw-analysis-filter-badge",J.title=e("module.ptw.analysis.badgeCountTitle","\u0639\u062F\u062F \u0627\u0644\u062A\u0635\u0627\u0631\u064A\u062D \u0627\u0644\u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0647\u0630\u0627 \u0627\u0644\u0641\u0644\u062A\u0631 \u0645\u0639 \u0627\u0644\u0641\u0644\u0627\u062A\u0631 \u0627\u0644\u0623\u062E\u0631\u0649"),J.textContent=String(r);const H=D.querySelector("i");H&&H.nextSibling?H.insertAdjacentElement("afterend",J):D.appendChild(J)}}),typeof Chart>"u")return;const b=["ptw-chart-work-type","ptw-chart-authorized","ptw-chart-status","ptw-chart-timeline"];this.analysisCharts||(this.analysisCharts={}),b.forEach(v=>{this.analysisCharts[v]&&(this.analysisCharts[v].destroy(),this.analysisCharts[v]=null)});const E=v=>{const $=v.workType;return Array.isArray($)?$.length?$:["\u0623\u062E\u0631\u0649"]:$?[String($)]:["\u0623\u062E\u0631\u0649"]},z={};a.forEach(v=>E(v).forEach($=>{const O=($||"").trim()||"\u0623\u062E\u0631\u0649";z[O]=(z[O]||0)+1}));const _=Object.entries(z).sort((v,$)=>$[1]-v[1]),C={};a.forEach(v=>{const $=(v.authorizedParty||"").trim()||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";C[$]=(C[$]||0)+1});const M=Object.entries(C).sort((v,$)=>$[1]-v[1]).slice(0,12),R={};a.forEach(v=>{const $=(v.status||"").trim()||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";R[$]=(R[$]||0)+1});const W=Object.entries(R),S={};a.forEach(v=>{const $=v.startDate||v.openDate||v.createdAt||v.endDate,O=$?new Date($):null,D=O?O.getFullYear()+"-"+String(O.getMonth()+1).padStart(2,"0"):"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";S[D]=(S[D]||0)+1});const A=Object.keys(S).filter(v=>v!=="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").sort().map(v=>({label:v,count:S[v]})),U=["#3b82f6","#10b981","#f59e0b","#ef4444","#8b5cf6","#06b6d4","#ec4899","#84cc16","#6366f1","#f97316"],F=(v,$,O,D)=>{const w=document.getElementById(v);if(!w)return;const V=w.getContext("2d");this.analysisCharts[v]=new Chart(V,{type:"doughnut",data:{labels:$,datasets:[{data:O,backgroundColor:U.slice(0,$.length),borderWidth:1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom",rtl:!0}}}})},X=(v,$,O,D)=>{const w=document.getElementById(v);if(!w)return;const V=w.getContext("2d");this.analysisCharts[v]=new Chart(V,{type:"bar",data:{labels:$,datasets:[{label:e("module.ptw.analysis.chartCount","\u0627\u0644\u0639\u062F\u062F"),data:O,backgroundColor:U[0],borderColor:"#1d4ed8",borderWidth:1}]},options:{indexAxis:"y",responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{beginAtZero:!0}}}})},st=(v,$,O)=>{const D=document.getElementById(v);if(!D)return;const w=D.getContext("2d");this.analysisCharts[v]=new Chart(w,{type:"line",data:{labels:$,datasets:[{label:e("module.ptw.analysis.permitsPerMonth","\u0639\u062F\u062F \u0627\u0644\u062A\u0635\u0627\u0631\u064A\u062D"),data:O,borderColor:U[0],backgroundColor:U[0]+"33",fill:!0,tension:.2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0}}}})};_.length&&F("ptw-chart-work-type",_.map(([v])=>v),_.map(([,v])=>v)),M.length&&X("ptw-chart-authorized",M.map(([v])=>v),M.map(([,v])=>v)),W.length&&F("ptw-chart-status",W.map(([v])=>v),W.map(([,v])=>v)),A.length&&st("ptw-chart-timeline",A.map(({label:v})=>v),A.map(({count:v})=>v))},exportAnalysisReportToExcel(){const t=this.getFilteredAnalysisPermits();if(!t||t.length===0){Notification.warning(this._t("module.ptw.notify.analysisNoExport","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631. \u063A\u064A\u0651\u0631 \u0627\u0644\u0641\u0644\u062A\u0631 \u0623\u0648 \u0623\u0636\u0641 \u062A\u0635\u0627\u0631\u064A\u062D."));return}const e=(_,C)=>this._t(_,C),r=(typeof AppState<"u"&&AppState.currentLanguage||typeof localStorage<"u"&&localStorage.getItem("language")||"ar")==="en"?"en-GB":"ar-EG",s=_=>{if(!_)return"-";try{return new Date(_).toLocaleDateString(r)}catch{return String(_)}},i=this._t("module.ptw.common.listSep","\u060C "),o=_=>Array.isArray(_.workType)?(_.workType||[]).join(i):_.workType||"-",n=e("module.ptw.excelColSeq","\u0645"),l=e("module.ptw.excelColPermitType","\u0646\u0648\u0639 \u0627\u0644\u062A\u0635\u0631\u064A\u062D"),p=e("module.ptw.excelColReq","\u0627\u0644\u0625\u062F\u0627\u0631\u0629 (\u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0637\u0627\u0644\u0628\u0629)"),d=e("module.ptw.excelColAuth","\u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0645\u0635\u0631\u062D \u0644\u0647\u0627"),c=e("module.ptw.excelColLoc","\u0627\u0644\u0645\u0635\u0646\u0639"),m=e("module.ptw.excelColDate","\u0627\u0644\u062A\u0627\u0631\u064A\u062E"),u=e("module.ptw.excelColStatus","\u0627\u0644\u062D\u0627\u0644\u0629"),h=e("module.ptw.excelColWorkDesc","\u0648\u0635\u0641 \u0627\u0644\u0639\u0645\u0644"),f=t.map((_,C)=>({[n]:C+1,[l]:o(_),[p]:_.requestingParty||"-",[d]:_.authorizedParty||"-",[c]:_.location||_.siteName||"-",[m]:s(_.startDate||_.openDate||_.createdAt),[u]:this.statusLabel(_.status||"-"),[h]:(_.workDescription||"-").toString().slice(0,200)}));if(typeof XLSX>"u"){Notification.error(this._t("module.ptw.notify.xlsxNoLib","\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629"));return}const x=XLSX.utils.json_to_sheet(f),y=XLSX.utils.book_new(),k=e("module.ptw.excelSheetAnalysis","\u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644");XLSX.utils.book_append_sheet(y,x,k);const b=document.getElementById("ptw-analysis-date-from")?.value||"",E=document.getElementById("ptw-analysis-date-to")?.value||"",z=e("module.ptw.excelNameAnalysis","\u062A\u0642\u0631\u064A\u0631_\u062A\u062D\u0644\u064A\u0644_\u0627\u0644\u062A\u0635\u0627\u0631\u064A\u062D_{f}_{t}.xlsx").replace(/\{f\}/g,(b||e("module.ptw.excelNameAll","\u0643\u0644")).replace(/\s/g,"_")).replace(/\{t\}/g,(E||e("module.ptw.excelNameTime","\u0627\u0644\u0648\u0642\u062A")).replace(/\s/g,"_"));XLSX.writeFile(y,z),Notification.success(this._t("module.ptw.notify.analysisExportXlsxOk","\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644 \u0625\u0644\u0649 Excel \u0628\u0646\u062C\u0627\u062D"))},async exportAnalysisReportToPDF(){const t=this.getFilteredAnalysisPermits();if(!t||t.length===0){Notification.warning(this._t("module.ptw.notify.analysisNoExport","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631. \u063A\u064A\u0651\u0631 \u0627\u0644\u0641\u0644\u062A\u0631 \u0623\u0648 \u0623\u0636\u0641 \u062A\u0635\u0627\u0631\u064A\u062D."));return}const e=(l,p)=>this._t(l,p),a=typeof AppState<"u"&&AppState.currentLanguage||typeof localStorage<"u"&&localStorage.getItem("language")||"ar",r=a==="en"?"en-GB":"ar-EG",s=a!=="en",i=s?"rtl":"ltr",o=a==="en"?"en":"ar",n=s?"right":"left";try{Loading.show(e("module.ptw.pdf.exportLoading","\u062C\u0627\u0631\u064A \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u062A\u0642\u0631\u064A\u0631 PDF..."));const l=H=>{if(!H)return"-";try{const Z=this.parseDateTimeValue(H);return!Z||isNaN(Z.getTime())?String(H):Z.toLocaleDateString(r)}catch{return String(H)}},p=this._t("module.ptw.common.listSep","\u060C "),d=H=>Array.isArray(H.workType)?(H.workType||[]).join(p):H.workType||"-",c=document.getElementById("ptw-analysis-date-from"),m=document.getElementById("ptw-analysis-date-to"),u=document.getElementById("ptw-analysis-work-type"),h=document.getElementById("ptw-analysis-authorized"),f=document.getElementById("ptw-analysis-requesting"),x=document.getElementById("ptw-analysis-status"),y=[];c&&c.value&&y.push(e("module.ptw.analysis.fromDate","\u0645\u0646 \u062A\u0627\u0631\u064A\u062E")+": "+c.value),m&&m.value&&y.push(e("module.ptw.analysis.toDate","\u0625\u0644\u0649 \u062A\u0627\u0631\u064A\u062E")+": "+m.value),u&&u.value&&y.push(e("module.ptw.analysis.permitType","\u0646\u0648\u0639 \u0627\u0644\u062A\u0635\u0631\u064A\u062D")+": "+u.value),h&&h.value&&y.push(e("module.ptw.analysis.authorized","\u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0645\u0635\u0631\u062D \u0644\u0647\u0627 (\u0645\u0642\u0627\u0648\u0644)")+": "+h.value),f&&f.value&&y.push(e("module.ptw.analysis.requesting","\u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0637\u0627\u0644\u0628\u0629")+": "+f.value),x&&x.value&&y.push(e("module.ptw.analysis.filterStatus","\u0627\u0644\u062D\u0627\u0644\u0629")+": "+x.value);const k=e("module.ptw.analysis.partSep"," | "),b=y.length?y.join(k):e("module.ptw.analysis.noFilters","\u0628\u062F\u0648\u0646 \u0641\u0644\u062A\u0631 (\u062C\u0645\u064A\u0639 \u0627\u0644\u062A\u0635\u0627\u0631\u064A\u062D)"),E=t.filter(H=>{const Z=(H.status||"").trim();return Z!=="\u0645\u063A\u0644\u0642"&&Z!=="\u0645\u0631\u0641\u0648\u0636"&&Z!=="\u0627\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644 \u0628\u0634\u0643\u0644 \u0622\u0645\u0646"&&Z!=="\u0625\u063A\u0644\u0627\u0642 \u062C\u0628\u0631\u064A"}).length,z=t.filter(H=>{const Z=(H.status||"").trim();return Z==="\u0645\u063A\u0644\u0642"||Z==="\u0627\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644 \u0628\u0634\u0643\u0644 \u0622\u0645\u0646"||Z==="\u0625\u063A\u0644\u0627\u0642 \u062C\u0628\u0631\u064A"}).length,_=e("module.ptw.excelColSeq","\u0645"),C=e("module.ptw.excelColPermitType","\u0646\u0648\u0639 \u0627\u0644\u062A\u0635\u0631\u064A\u062D"),M=e("module.ptw.excelColReq","\u0627\u0644\u0625\u062F\u0627\u0631\u0629 (\u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0637\u0627\u0644\u0628\u0629)"),R=e("module.ptw.excelColAuth","\u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0645\u0635\u0631\u062D \u0644\u0647\u0627"),W=e("module.ptw.excelColLoc","\u0627\u0644\u0645\u0635\u0646\u0639"),S=e("module.ptw.excelColDate","\u0627\u0644\u062A\u0627\u0631\u064A\u062E"),P=e("module.ptw.excelColStatus","\u0627\u0644\u062D\u0627\u0644\u0629"),A=e("module.ptw.excelColWorkDesc","\u0648\u0635\u0641 \u0627\u0644\u0639\u0645\u0644"),U=t.map((H,Z)=>`
                <tr>
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 10px;">
                    <thead>
                        <tr style="background-color: #3b82f6; color: white;">
                            ...
                            <th style="border: 1px solid #d1d5db; padding: 6px; text-align: ${n};">${Utils.escapeHTML(C)}</th>
            ...
            `,$="PTW-ANALYSIS-"+new Date().toISOString().slice(0,10),O=F,D=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML($,O,v,!1,!0,{source:"PTWAnalysis"},new Date().toISOString(),new Date().toISOString()):`<html dir="${i}" lang="${o}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(O)}</title></head><body>${v}</body></html>`,w=new Blob([D],{type:"text/html;charset=utf-8"}),V=URL.createObjectURL(w),J=window.open(V,"_blank");J?J.onload=()=>{setTimeout(()=>{J.print(),setTimeout(()=>{URL.revokeObjectURL(V),Loading.hide(),Notification.success(PTW._t("module.ptw.pdf.readyPrint","\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u062A\u0642\u0631\u064A\u0631 \u0644\u0644\u0637\u0628\u0627\u0639\u0629/\u0627\u0644\u062D\u0641\u0638 \u0643\u0640 PDF"))},800)},500)}:(Loading.hide(),Notification.error(this._t("module.ptw.notify.popupsPdf","\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF")))}catch(l){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644 PDF:",l);const p=this._t("module.ptw.notify.unknownError","\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641");Notification.error(this._t("module.ptw.notify.pdfErr","\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF: ")+(l&&l.message?l.message:p))}},setupAnalysisEventListeners(){setTimeout(()=>{this.updatePTWAnalyticsDashboard()},150),this._ptwBindAnalyticsEvents();const t=document.getElementById("ptw-analysis-add");if(t){const a=t.cloneNode(!0);t.parentNode.replaceChild(a,t),a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),this.showAnalysisForm()})}const e=document.getElementById("ptw-analysis-export-excel");if(e){const a=e.cloneNode(!0);e.parentNode.replaceChild(a,e),a.addEventListener("click",()=>this.exportAnalysisReportToExcel())}},_ptwBindAnalyticsEvents(){const t=document.getElementById("ptw-analytics-root");if(!t)return;t.querySelectorAll(".ptw-period-btn").forEach(o=>{o.addEventListener("click",()=>{this._ptwPeriod=o.getAttribute("data-period"),t.querySelectorAll(".ptw-period-btn").forEach(n=>{const l=n===o;n.style.background=l?"#fff":"rgba(255,255,255,0.15)",n.style.color=l?"#1e3a5f":"#fff"}),this.updatePTWAnalyticsDashboard()})});const e=document.getElementById("ptw-analytics-refresh");e&&e.addEventListener("click",()=>this.updatePTWAnalyticsDashboard());const a=document.getElementById("ptw-export-pdf-btn");a&&a.addEventListener("click",()=>this._ptwExportPDF());const r=document.getElementById("ptw-toggle-filters-btn"),s=document.getElementById("ptw-filter-panel");r&&s&&r.addEventListener("click",()=>{const o=s.style.display!=="none";s.style.display=o?"none":"block",r.style.background=o?"rgba(255,255,255,0.12)":"rgba(255,255,255,0.35)"});const i=document.getElementById("ptw-filter-reset-btn");i&&i.addEventListener("click",()=>{["ptw-af-status","ptw-af-work-type","ptw-af-authorized","ptw-af-requesting","ptw-af-location"].forEach(o=>{const n=document.getElementById(o);n&&(n.value="")}),this.updatePTWAnalyticsDashboard()}),["ptw-af-status","ptw-af-work-type","ptw-af-authorized","ptw-af-requesting","ptw-af-location"].forEach(o=>{const n=document.getElementById(o);n&&n.addEventListener("change",()=>this.updatePTWAnalyticsDashboard())})},async updatePTWAnalyticsDashboard(){if(!document.getElementById("ptw-analytics-root"))return;try{AppState.appData||(AppState.appData={})}catch{}const e=parseInt(this._ptwPeriod||"0",10),a=this.getAnalysisPermits(),r=this._ptwFilterByPeriod(a,e);this._ptwPopulateFilters(r);const s=this._ptwApplyFilters(r),i=s.length,o=document.getElementById("ptw-filter-count");o&&(o.textContent=`${i} \u062A\u0635\u0631\u064A\u062D`);const n=s.filter(D=>this.isPermitOpenStatus(D?.status)).length,l=s.filter(D=>this.isPermitClosedStatus(D?.status)).length,p=s.filter(D=>(D.status||"").trim()==="\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647").length,d=s.filter(D=>D?.isManualEntry!==!0&&(D.status||"").trim()==="\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629").length,c=s.filter(D=>(D.status||"").trim()==="\u0645\u0631\u0641\u0648\u0636").length,m=i>0?Math.round(l/i*100):0,u=i>0?Math.round(n/i*100):0,h=i>0?Math.round(p/i*100):0,f=s.filter(D=>{const w=new Date(D.startDate||D.openDate||D.createdAt||""),V=new Date;return!isNaN(w)&&w.getFullYear()===V.getFullYear()&&w.getMonth()===V.getMonth()}).length,x={};s.forEach(D=>{const w=(D.requestingParty||"").trim()||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";w!=="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"&&w!=="\u2014"&&(x[w]=(x[w]||0)+1)});const y=Object.entries(x).sort((D,w)=>w[1]-D[1]),k=y[0],b=k?k[0]:"\u0644\u0627 \u064A\u0648\u062C\u062F",E=k?k[1]:0,z=document.getElementById("ptw-kpi-strip");if(z){const D=[{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u062A\u0635\u0627\u0631\u064A\u062D",value:i,icon:"fas fa-clipboard-check",color:"#1d4ed8",bg:"#dbeafe",border:"#bfdbfe"},{label:"\u0645\u0641\u062A\u0648\u062D\u0629 / \u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630",value:n,icon:"fas fa-folder-open",color:"#d97706",bg:"#fffbeb",border:"#fde68a"},{label:"\u0645\u063A\u0644\u0642\u0629 / \u0645\u0643\u062A\u0645\u0644\u0629",value:l,icon:"fas fa-check-circle",color:"#059669",bg:"#ecfdf5",border:"#a7f3d0"},{label:"\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647\u0627",value:p,icon:"fas fa-thumbs-up",color:"#7c3aed",bg:"#f5f3ff",border:"#ddd6fe"},{label:"\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629",value:d,icon:"fas fa-clock",color:"#b45309",bg:"#fffbeb",border:"#fde68a"},{label:"\u0645\u0631\u0641\u0648\u0636\u0629",value:c,icon:"fas fa-times-circle",color:"#dc2626",bg:"#fef2f2",border:"#fecaca"},{label:"\u0646\u0633\u0628\u0629 \u0627\u0644\u0625\u063A\u0644\u0627\u0642",value:m+"%",icon:"fas fa-chart-pie",color:"#0891b2",bg:"#ecfeff",border:"#a5f3fc"},{label:"\u0627\u0644\u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0623\u0643\u062B\u0631 \u0637\u0644\u0628\u0627\u064B",value:E>0?b:"\u2014",icon:"fas fa-hotel",color:"#2563eb",bg:"#eff6ff",border:"#bfdbfe",subText:E>0?`${E} \u062A\u0635\u0631\u064A\u062D`:""},{label:"\u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631",value:f,icon:"fas fa-calendar-day",color:"#db2777",bg:"#fdf2f8",border:"#fbcfe8"}];z.innerHTML=D.map(w=>`
                <div style="background:${w.bg};border:1px solid ${w.border};border-radius:12px;padding:12px 14px;display:flex;align-items:center;gap:10px;transition:all .2s;cursor:default;min-width:0;" onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 6px 20px rgba(0,0,0,0.09)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                    ...
                    `}).join(""));const X=document.getElementById("ptw-depts-list");X&&(i===0?X.innerHTML='<div style="text-align:center;color:#94a3b8;font-size:0.85rem;padding:40px 0;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</div>':X.innerHTML=y.map(([D,w])=>{const V=Math.round(w/i*100);return`
                        <div>
