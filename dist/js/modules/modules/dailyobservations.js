...
`,options:{fontSize:11,bold:!0,color:"64748B",rtl:!b}},{text:w.val,options:{fontSize:13.5,bold:!0,color:w.color,rtl:!b}}],{x:I,y:5.2,w:3.13,h:1.3,align:"center",valign:"middle",fontFace:"Arial"})}),P.addShape(y.ShapeType.rect,{x:0,y:6.95,w:"100%",h:.55,fill:{color:"1E3A8A"}}),P.addText("Safety First \u2014 \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0623\u0648\u0644\u0627\u064B \u0648\u0628\u0646\u0627\u0621 \u0628\u064A\u0626\u0629 \u0639\u0645\u0644 \u0622\u0645\u0646\u0629 \u0648\u0645\u0633\u062A\u062F\u0627\u0645\u0629",{x:0,y:6.98,w:"100%",h:.48,fontSize:11,bold:!0,color:"FBBF24",align:"center",valign:"middle",fontFace:"Arial"});const D=y.addSlide();D.background={color:"F8FAFC"},D.addShape(y.ShapeType.rect,{x:0,y:0,w:"100%",h:.7,fill:{color:"1E3A8A"}}),D.addShape(y.ShapeType.rect,{x:0,y:.7,w:"100%",h:.04,fill:{color:"D97706"}}),D.addText(b?"Report Overview & Safety Performance Dashboard":"\u0646\u0638\u0631\u0629 \u0639\u0627\u0645\u0629 \u0639\u0644\u0649 \u0627\u0644\u062A\u0642\u0631\u064A\u0631",{x:4.5,y:.05,w:8,h:.6,fontSize:18,bold:!0,color:"FFFFFF",align:b?"left":"right",rtl:!b,fontFace:"Arial"}),D.addText(b?`Total: ${x.length} Observations`:`\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A: ${x.length} \u0645\u0644\u0627\u062D\u0638\u0629 | \u0627\u0644\u062A\u0627\u0631\u064A\u062E: ${L}`,{x:.4,y:.05,w:4,h:.6,fontSize:11,bold:!0,color:"FBBF24",align:b?"right":"left",rtl:!b,fontFace:"Arial"});const R=x.length,V=x.filter(w=>w.status!=="\u0645\u063A\u0644\u0642").length,M=x.filter(w=>w.status==="\u0645\u063A\u0644\u0642").length,N=x.filter(w=>String(w.riskLevel||"").includes("\u0639\u0627\u0644\u064A")||String(w.riskLevel||"").includes("\u062D\u0631\u062C\u0629")).length,q=x.filter(w=>String(w.riskLevel||"").includes("\u0645\u062A\u0648\u0633\u0637")).length,Q=Math.max(0,R-N-q),H=Math.round(M/Math.max(1,R)*100),G=Math.round(V/Math.max(1,R)*100),ne=Math.round(N/Math.max(1,R)*100),be={};x.forEach(w=>{const S=String(w.observationType||(b?"General":"\u0639\u0627\u0645")).trim();be[S]=(be[S]||0)+1});const ve=Object.entries(be).sort((w,S)=>S[1]-w[1]).slice(0,4),ye=new Set(x.map(w=>w.siteName||w.locationName).filter(Boolean)).size||1;[{label:b?"Total Observations":"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A",val:R,sub:b?"100% of recorded":"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u062D\u0627\u0644\u0627\u062A \u0627\u0644\u0645\u0631\u0635\u0648\u062F\u0629",color:"1E3A8A",bg:"DBEAFE",border:"3B82F6"},{label:b?"Open Actions":"\u0645\u0644\u0627\u062D\u0638\u0627\u062A \u0645\u0641\u062A\u0648\u062D\u0629",val:V,sub:b?`${G}% pending actions`:`${G}% \u0642\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629 \u0648\u0627\u0644\u062A\u0646\u0641\u064A\u0630`,color:"B45309",bg:"FEF3C7",border:"F59E0B"},{label:b?"Closed Observations":"\u0645\u0644\u0627\u062D\u0638\u0627\u062A \u0645\u063A\u0644\u0642\u0629",val:M,sub:b?`${H}% resolution rate`:`${H}% \u0646\u0633\u0628\u0629 \u0627\u0644\u0625\u0646\u062C\u0627\u0632 \u0648\u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629`,color:"047857",bg:"D1FAE5",border:"10B981"},{label:b?"High Risk":"\u0639\u0627\u0644\u064A\u0629 \u0627\u0644\u062E\u0637\u0648\u0631\u0629",val:N,sub:b?`${ne}% critical priority`:N>0?`${ne}% \u062A\u062A\u0637\u0644\u0628 \u0623\u0648\u0644\u0648\u064A\u0629 \u0642\u0635\u0648\u0649`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0644\u0627\u062D\u0638\u0627\u062A \u062D\u0631\u062C\u0629",color:"B91C1C",bg:"FEE2E2",border:"EF4444"}].forEach((w,S)=>{const I=b?.5+S*3.1:.5+(3-S)*3.1;D.addShape(y.ShapeType.roundRect,{x:I,y:.9,w:2.85,h:1.45,fill:{color:w.bg},line:{color:w.border,width:1.5},rectRadius:.1}),D.addText([{text:String(w.val)+`
...
`,options:{color:"0F172A",fontSize:10}},{text:"\u2022 Action Status: ",options:{bold:!0,color:"1E3A8A",fontSize:10}},{text:`${M} actions completed, ${V} in progress.
...
`,options:{color:"0F172A",fontSize:10,rtl:!0}},{text:"\u2022 \u062D\u0627\u0644\u0629 \u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A \u0627\u0644\u062A\u0635\u062D\u064A\u062D\u064A\u0629: ",options:{bold:!0,color:"1E3A8A",fontSize:10,rtl:!0}},{text:`\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 ${M} \u0645\u0644\u0627\u062D\u0638\u0629 \u0648\u062C\u0627\u0631\u064A \u062A\u0646\u0641\u064A\u0630 ${V}.
        ...
        `,document.body.appendChild(a),a.addEventListener("click",s=>{s.target===a&&a.remove()})},_buildObservationAttachmentsHtml(e){if(!Array.isArray(e)||e.length===0)return"";const t=a=>{if(!a)return!1;if(String(a.type||"").toLowerCase().startsWith("image/"))return!0;const o=String(a.name||"").toLowerCase();if(/\.(jpg|jpeg|png|gif|webp|bmp|heic|svg)($|\?)/i.test(o)||/^image[-_]?\d+/i.test(o))return!0;const r=String(a.data||a.url||a.shareableLink||a.directLink||a.cloudLink&&a.cloudLink.url||"").trim();return!!(r.startsWith("data:image/")||/\.(jpg|jpeg|png|gif|webp|bmp|heic|svg)($|\?)/i.test(r)||r&&!/\.(pdf|doc|docx|xls|xlsx|ppt|pptx|zip|rar|txt)($|\?)/i.test(o)&&!/\.(pdf|doc|docx|xls|xlsx|ppt|pptx|zip|rar|txt)($|\?)/i.test(r))},i=a=>a&&(a.data||a.url||a.shareableLink||a.directLink||a.cloudLink&&a.cloudLink.url)||"";return e.map(a=>{const s=t(a),o=i(a),r=Utils.escapeHTML(a.name||"\u0635\u0648\u0631\u0629 \u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0629");if(s&&o){const n=this._extractDriveFileId(o);let d=o,c=[];n?(d=`https://lh3.googleusercontent.com/d/${n}=w1200`,c=[`https://drive.google.com/thumbnail?id=${n}&sz=w1200`,`https://drive.google.com/uc?export=view&id=${n}`,`https://drive.google.com/uc?export=download&id=${n}`,o]):(o.startsWith("http://")||o.startsWith("https://"))&&(d=o);const l=n?` data-drive-proxy-id="${n}"`:"",p=c.length?` data-fallbacks="${Utils.escapeHTML(JSON.stringify(c))}"`:"";return`
                    <div class="border-2 border-gray-200 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all bg-slate-50 flex flex-col items-center p-3">
                        <div class="w-full flex justify-center items-center overflow-hidden rounded-lg bg-black/5" style="min-height: 200px; max-height: 450px;">
                            <img src="${Utils.escapeHTML(d)}"${l}${p} alt="${r}" 
