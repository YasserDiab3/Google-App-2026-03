class GateSecurityModule{constructor(){this.visitors=[],this.filteredVisitors=[],this.filterSite="all",this.filterStatus="all",this.searchQuery="",this.autoRefreshTimer=null,this.init()}init(){window.GateSecurity=this,document.addEventListener("DOMContentLoaded",()=>{this.checkAndApplyVisibility()})}checkAndApplyVisibility(){const t=this.isAdmin(),i=document.querySelector('a[data-section="gate-security"]');i&&(i.style.display=t?"flex":"none");const e=document.getElementById("gate-security-section");e&&!t&&(e.style.display="none")}isAdmin(){try{if(typeof Permissions<"u"&&typeof Permissions.isCurrentUserAdmin=="function"&&Permissions.isCurrentUserAdmin()||typeof Permissions<"u"&&typeof Permissions.isCurrentUserEffectiveAdmin=="function"&&Permissions.isCurrentUserEffectiveAdmin())return!0;const t=AppState?.currentUser?.role;return t==="admin"||t==="hse_manager"||t==="general_manager"||t==="security_admin"}catch{return!1}}render(){const t=document.getElementById("gate-security-section");if(!t)return;if(!this.isAdmin()){t.innerHTML=`
        ...
        `,this.loadVisitorsData(),this.startAutoRefresh()}getGatePortalUrl(){const t=window.location.origin||window.location.protocol+"//"+window.location.host,i=window.location.pathname;return i.includes("/Frontend/")?`${t}/Frontend/gate-visitor-entry.html`:i.includes("/dist/")?`${t}/dist/gate-visitor-entry.html`:`${t}/gate-visitor-entry.html`}copyGateLink(t){navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(t).then(()=>{typeof Utils<"u"&&Utils.showNotification?Utils.showNotification("\u062A\u0645 \u0646\u0633\u062E \u0631\u0627\u0628\u0637 \u062A\u0633\u062C\u064A\u0644 \u0623\u0645\u0646 \u0627\u0644\u0628\u0648\u0627\u0628\u0627\u062A \u0628\u0646\u062C\u0627\u062D \u2705","success"):alert("\u062A\u0645 \u0646\u0633\u062E \u0627\u0644\u0631\u0627\u0628\u0637 \u0628\u0646\u062C\u0627\u062D: "+t)}):prompt("\u0627\u0646\u0633\u062E \u0627\u0644\u0631\u0627\u0628\u0637 \u0627\u0644\u062A\u0627\u0644\u064A \u0644\u0645\u0633\u0624\u0648\u0644 \u0627\u0644\u0623\u0645\u0646 \u0639\u0646\u062F \u0627\u0644\u0628\u0648\u0627\u0628\u0629:",t)}async loadVisitorsData(){try{const t=localStorage.getItem("HSE_GATE_VISITORS_REGISTRY");if(this.visitors=t?JSON.parse(t):[],navigator.onLine&&typeof GoogleIntegration<"u")try{const e=await(await fetch(this.getEffectiveApiUrl()+"?action=getActiveGateVisitors",{method:"GET",mode:"cors"})).json();if(e&&e.success&&Array.isArray(e.activeVisitors)){const o=e.activeVisitors.map(a=>({...a,entryTimestamp:new Date(a.entryDate+" "+a.entryTime).getTime()||Date.now()})),r=new Map;this.visitors.forEach(a=>r.set(a.id,a)),o.forEach(a=>r.set(a.id,a)),this.visitors=Array.from(r.values()).sort((a,n)=>(n.entryTimestamp||0)-(a.entryTimestamp||0)),localStorage.setItem("HSE_GATE_VISITORS_REGISTRY",JSON.stringify(this.visitors))}}catch{}this.applyFilters(),this.updateKpis()}catch{}}getEffectiveApiUrl(){const t="https://script.google.com/macros/s/AKfycbw6ycjx5XAyHKCqW6kzMwWjOxuv7fdm-rBbKN9f1nhp7300R87hTNsQmZfSa49qeGlQ/exec";try{const i=localStorage.getItem("HSE_SETTINGS_CACHE");if(i){const e=JSON.parse(i);if(e&&e.scriptUrl&&e.scriptUrl.includes("script.google.com"))return e.scriptUrl}}catch{}return t}updateKpis(){const t=new Date().toISOString().split("T")[0],i=t.slice(0,7),e=this.visitors.filter(c=>c.entryDate===t),o=this.visitors.filter(c=>!c.exitTime),r=this.visitors.filter(c=>c.entryDate&&c.entryDate.startsWith(i)),a=Date.now(),n=o.filter(c=>(a-(c.entryTimestamp||0))/6e4>=240).length,d=document.getElementById("kpiActiveVisitors");d&&(d.textContent=o.length);const l=document.getElementById("kpiTodayVisitors");l&&(l.textContent=e.length);const f=document.getElementById("kpiOverstayVisitors");f&&(f.textContent=n);const s=document.getElementById("kpiMonthVisitors");s&&(s.textContent=r.length)}applyFilters(){let t=[...this.visitors];if(this.filterSite!=="all"&&(t=t.filter(i=>i.site===this.filterSite)),this.filterStatus==="active"?t=t.filter(i=>!i.exitTime):this.filterStatus==="exited"&&(t=t.filter(i=>!!i.exitTime)),this.searchQuery){const i=this.searchQuery.toLowerCase();t=t.filter(e=>e.name&&e.name.toLowerCase().includes(i)||e.org&&e.org.toLowerCase().includes(i)||e.badge&&e.badge.toLowerCase().includes(i)||e.host&&e.host.toLowerCase().includes(i)||e.phone&&e.phone.includes(i)||e.vehicle&&e.vehicle.toLowerCase().includes(i))}this.filteredVisitors=t,this.renderTable()}renderTable(){const t=document.getElementById("gateVisitorsTableBody");if(!t)return;if(this.filteredVisitors.length===0){t.innerHTML=`
            ...
            `;return}const i=Date.now();t.innerHTML=this.filteredVisitors.map(e=>{const o=!e.exitTime,r=Math.round((i-(e.entryTimestamp||i))/6e4),a=Math.floor(r/60),n=r%60,d=o&&r>=240,l=o?a>0?`${a}\u0633 ${n}\u062F`:`${n}\u062F`:e.durationMinutes?`${e.durationMinutes} \u062F\u0642\u064A\u0642\u0629`:"\u0645\u0643\u062A\u0645\u0644";return`
                        ...
                        <div style="display: flex; flex-direction: column; gap: 10px;">
                            <div style="display: flex; justify-content: space-between; align-items: center; background: #f1f5f9; padding: 8px 12px; border-radius: 8px; border: 1px solid #cbd5e1;">
                                ...
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    ...
                                    <input type="range" id="frameScaleRange" min="80" max="140" value="${t.frameScale||100}" oninput="GateSecurity.updateEditorFrameScale(this.value)" style="width: 90px; cursor: pointer;">
                            ...
                            <div id="canvasViewport" style="border: 2px solid #334155; border-radius: 10px; background: ${t.frameBg||"#f1f5f9"}; overflow: hidden; position: relative; width: 100%; height: 380px; display: flex; align-items: center; justify-content: center; box-shadow: inset 0 2px 6px rgba(0,0,0,0.1);">
                            ...
                            <div style="font-size: 0.72rem; color: #64748b; text-align: center; font-weight: 700;">
                                \u{1F4A1} \u0646\u0635\u064A\u062D\u0629: \u0627\u0646\u0642\u0631 \u0628\u0627\u0644\u0645\u0627\u0648\u0633 \u0648\u0627\u0633\u062D\u0628 \u0623\u064A \u0645\u0628\u0646\u0649 \u0623\u0648 \u0646\u0642\u0637\u0629 \u062A\u062C\u0645\u0639 \u0623\u0648 \u0623\u064A\u0642\u0648\u0646\u0629 \u0633\u0644\u0627\u0645\u0629 \u0644\u062A\u062D\u0631\u064A\u0643\u0647\u0627 \u0625\u0644\u0649 \u0623\u064A \u0645\u0648\u0642\u0650\u0639 \u0628\u062F\u0642\u0629.
                            </div>
                        </div>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 12px; overflow-y: auto; max-height: 70vh; padding-left: 4px;">
                            ...
                            <div style="background: #eff6ff; border: 1.5px solid #bfdbfe; border-radius: 10px; padding: 10px;">
                                ...
                                <div style="display: flex; flex-wrap: wrap; gap: 6px;">
                                    <button type="button" onclick="GateSecurity.addEditorSafetyIcon('\u{1F9EF}', '\u0645\u0637\u0641\u0623\u0629 \u062D\u0631\u064A\u0642', '#dc2626')" style="background: #ffffff; border: 1px solid #fca5a5; color: #dc2626; padding: 4px 10px; border-radius: 6px; font-weight: 800; font-size: 0.75rem; cursor: pointer;">\u{1F9EF} \u0645\u0637\u0641\u0623\u0629 \u062D\u0631\u064A\u0642</button>
                                    <button type="button" onclick="GateSecurity.addEditorSafetyIcon('\u{1F6AA}', '\u0645\u062E\u0631\u062C \u0637\u0648\u0627\u0631\u0626', '#16a34a')" style="background: #ffffff; border: 1px solid #86efac; color: #16a34a; padding: 4px 10px; border-radius: 6px; font-weight: 800; font-size: 0.75rem; cursor: pointer;">\u{1F6AA} \u0645\u062E\u0631\u062C \u0637\u0648\u0627\u0631\u0626</button>
                                    ...
                                    <button type="button" onclick="GateSecurity.addEditorSafetyIcon('\u{1F6AD}', '\u0645\u0645\u0646\u0648\u0639 \u0627\u0644\u062A\u062F\u062E\u064A\u0646', '#dc2626')" style="background: #ffffff; border: 1px solid #fca5a5; color: #dc2626; padding: 4px 10px; border-radius: 6px; font-weight: 800; font-size: 0.75rem; cursor: pointer;">\u{1F6AD} \u0645\u0646\u0639 \u062A\u062F\u062E\u064A\u0646</button>
                                    <button type="button" onclick="GateSecurity.addEditorSafetyIcon('\u{1F4A7}', '\u062F\u0634 \u0637\u0648\u0627\u0631\u0626', '#0284c7')" style="background: #ffffff; border: 1px solid #7dd3fc; color: #0284c7; padding: 4px 10px; border-radius: 6px; font-weight: 800; font-size: 0.75rem; cursor: pointer;">\u{1F4A7} \u062F\u0634 \u0637\u0648\u0627\u0631\u0626</button>
                                    <button type="button" onclick="GateSecurity.addEditorSafetyIcon('\u{1F97D}', '\u0645\u0647\u0645\u0627\u062A \u0648\u0642\u0627\u064A\u0629', '#4f46e5')" style="background: #ffffff; border: 1px solid #c7d2fe; color: #4338ca; padding: 4px 10px; border-radius: 6px; font-weight: 800; font-size: 0.75rem; cursor: pointer;">\u{1F97D} \u0645\u0647\u0645\u0627\u062A PPE</button>
                                </div>
                            </div>
        ...
        `;document.body.insertAdjacentHTML("beforeend",i),this.renderEditorCanvas()}renderEditorCanvas(){const t=window._currentEditorConfig;if(!t)return;const i=(t.frameScale||100)/100,e=document.getElementById("interactiveCanvasSvg");e&&(e.style.transform=`scale(${i})`,e.style.transformOrigin="center center");const o=document.getElementById("svgBuildingsGroup");o&&(o.innerHTML=t.buildings.map((n,d)=>`
            ...
            `).join(""));const r=document.getElementById("svgMusterPointsGroup");r&&(r.innerHTML=t.musterPoints.map((n,d)=>`
            ...
            `).join(""));const a=document.getElementById("svgSafetyIconsGroup");a&&(a.innerHTML=(t.safetyIcons||[]).map((n,d)=>`
            ...
            `).join("")),this.renderEditorLists()}renderEditorLists(){const t=window._currentEditorConfig;if(!t)return;const i=document.getElementById("editorBuildingsList");i&&(i.innerHTML=t.buildings.map((o,r)=>`
                <div style="display: grid; grid-template-columns: 120px 1fr 50px 50px 30px; gap: 6px; align-items: center; background: #fff; padding: 4px 8px; border: 1px solid #cbd5e1; border-radius: 6px;">
                    <input type="text" value="${o.name}" onchange="GateSecurity.updateBuildingProp(${r}, 'name', this.value)" style="padding: 2px 4px; font-size: 0.75rem; font-weight: 800;">
                    <input type="text" value="${o.sub||""}" placeholder="\u0648\u0635\u0641 \u0627\u0644\u0641\u0631\u0639\u064A" onchange="GateSecurity.updateBuildingProp(${r}, 'sub', this.value)" style="padding: 2px 4px; font-size: 0.75rem;">
                    <div><span style="font-size: 0.65rem;">W:</span><input type="number" value="${o.w}" onchange="GateSecurity.updateBuildingProp(${r}, 'w', parseInt(this.value))" style="width: 35px; font-size: 0.7rem;"></div>
                    <div><span style="font-size: 0.65rem;">H:</span><input type="number" value="${o.h}" onchange="GateSecurity.updateBuildingProp(${r}, 'h', parseInt(this.value))" style="width: 35px; font-size: 0.7rem;"></div>
                    <button type="button" onclick="GateSecurity.removeBuilding(${r})" style="color: #dc2626; border: none; background: none; cursor: pointer; font-weight: 900;">\u2715</button>
                </div>
            `).join(""));const e=document.getElementById("editorMusterList");e&&(e.innerHTML=t.musterPoints.map((o,r)=>`
                <div style="display: grid; grid-template-columns: 100px 1fr 30px; gap: 6px; align-items: center; background: #fff; padding: 4px 8px; border: 1px solid #cbd5e1; border-radius: 6px;">
                    <input type="text" value="${o.name}" onchange="GateSecurity.updateMusterProp(${r}, 'name', this.value)" style="padding: 2px 4px; font-size: 0.75rem; font-weight: 800;">
                    <span style="font-size: 0.72rem; color: #64748b;">\u0645\u0648\u0642\u0639: (${o.x}, ${o.y})</span>
                    <button type="button" onclick="GateSecurity.removeMuster(${r})" style="color: #dc2626; border: none; background: none; cursor: pointer; font-weight: 900;">\u2715</button>
                </div>
            `).join(""))}updateEditorFrameScale(t){if(!window._currentEditorConfig)return;window._currentEditorConfig.frameScale=parseInt(t)||100;const i=document.getElementById("scaleValText");i&&(i.textContent=t+"%"),this.renderEditorCanvas()}updateEditorFrameBg(t){if(!window._currentEditorConfig)return;window._currentEditorConfig.frameBg=t;const i=document.getElementById("canvasViewport");i&&(i.style.background=t)}addEditorSafetyIcon(t,i,e){window._currentEditorConfig&&(window._currentEditorConfig.safetyIcons||(window._currentEditorConfig.safetyIcons=[]),window._currentEditorConfig.safetyIcons.push({id:"s_"+Date.now(),name:i,icon:t,x:220+window._currentEditorConfig.safetyIcons.length*15,y:180,color:e}),this.renderEditorCanvas())}addEditorBuildingZone(){if(!window._currentEditorConfig)return;const t=window._currentEditorConfig.buildings.length+1;window._currentEditorConfig.buildings.push({id:"b_"+Date.now(),name:`\u0645\u0646\u0637\u0642\u0629 ${t}`,sub:"\u0642\u0633\u0645 \u062C\u062F\u064A\u062F",x:180,y:150,w:120,h:60,fill:"#dbeafe",stroke:"#1d4ed8",color:"#1e3a8a"}),this.renderEditorCanvas()}addEditorMusterPoint(){if(!window._currentEditorConfig)return;const t=window._currentEditorConfig.musterPoints.length+1;window._currentEditorConfig.musterPoints.push({id:"m_"+Date.now(),name:`\u0646\u0642\u0637\u0629 ${t}`,desc:"\u0646\u0642\u0637\u0629 \u062A\u062C\u0645\u0639 \u0645\u062E\u0635\u0635\u0629",x:200,y:200}),this.renderEditorCanvas()}updateBuildingProp(t,i,e){!window._currentEditorConfig||!window._currentEditorConfig.buildings[t]||(window._currentEditorConfig.buildings[t][i]=e,this.renderEditorCanvas())}updateMusterProp(t,i,e){!window._currentEditorConfig||!window._currentEditorConfig.musterPoints[t]||(window._currentEditorConfig.musterPoints[t][i]=e,this.renderEditorCanvas())}removeBuilding(t){window._currentEditorConfig&&(window._currentEditorConfig.buildings.splice(t,1),this.renderEditorCanvas())}removeMuster(t){window._currentEditorConfig&&(window._currentEditorConfig.musterPoints.splice(t,1),this.renderEditorCanvas())}handleCanvasMouseDown(t){const i=t.target.closest(".draggable-item");if(!i)return;const e=i.getAttribute("data-type"),o=parseInt(i.getAttribute("data-idx")),a=document.getElementById("interactiveCanvasSvg").getBoundingClientRect(),n=(t.clientX-a.left)*(500/a.width),d=(t.clientY-a.top)*(360/a.height);window._dragState={type:e,idx:o,svgX:n,svgY:d,elemX:window._currentEditorConfig[e==="building"?"buildings":e==="muster"?"musterPoints":"safetyIcons"][o].x,elemY:window._currentEditorConfig[e==="building"?"buildings":e==="muster"?"musterPoints":"safetyIcons"][o].y}}handleCanvasMouseMove(t){if(!window._dragState)return;const{type:i,idx:e,svgX:o,svgY:r,elemX:a,elemY:n}=window._dragState,l=document.getElementById("interactiveCanvasSvg").getBoundingClientRect(),f=(t.clientX-l.left)*(500/l.width),s=(t.clientY-l.top)*(360/l.height),c=Math.round(f-o),p=Math.round(s-r),g=i==="building"?"buildings":i==="muster"?"musterPoints":"safetyIcons";window._currentEditorConfig[g][e].x=Math.max(15,Math.min(460,a+c)),window._currentEditorConfig[g][e].y=Math.max(15,Math.min(330,n+p)),this.renderEditorCanvas()}handleCanvasMouseUp(){window._dragState=null}saveEditorMapConfig(){if(!window._currentEditorConfig)return;const t=document.getElementById("editMapCoords")?.value||window._currentEditorConfig.coords;window._currentEditorConfig.coords=t,this.saveMapConfig(window._currentEditorConfig);const i=document.getElementById("mapEditorModal");i&&i.remove()}resetMapConfigToDefault(){if(confirm("\u0647\u0644 \u0623\u0646\u062A \u062A\u0623\u0643\u062F \u0645\u0646 \u0627\u0633\u062A\u0639\u0627\u062F\u0629 \u0627\u0644\u0645\u062E\u0637\u0637 \u0627\u0644\u0647\u064A\u0643\u0644\u064A \u0627\u0644\u0627\u0641\u062A\u0631\u0627\u0636\u064A \u0644\u0644\u062E\u0631\u064A\u0637\u0629 \u0648\u0646\u0642\u0627\u0637 \u0627\u0644\u062A\u062C\u0645\u0639\u061F")){localStorage.removeItem("icapp_visitor_map_config"),alert("\u062A\u0645 \u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u0645\u062E\u0637\u0637 \u0627\u0644\u0647\u064A\u0643\u0644\u064A \u0644\u0644\u0627\u0641\u062A\u0631\u0627\u0636\u064A.");const t=document.getElementById("mapEditorModal");t&&t.remove()}}printMasterVisitorBadges(t){const i=this.getGatePortalUrl(),e=this.getMapConfig(),o=this.visitors.length||0,r=t||`VIS-${new Date().getFullYear()}-${(o+1).toString().padStart(3,"0")}`,a=window.open("","_blank");if(!a){alert("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0637\u0628\u0627\u0639\u0629 \u0643\u0627\u0631\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0644\u0644\u0632\u0627\u0626\u0631\u064A\u0646 (Pop-ups)");return}const n=e.musterPoints.map(s=>`
            <g transform="translate(${s.x}, ${s.y})">
                <rect x="-24" y="-14" width="48" height="28" rx="4" fill="#15803d" stroke="#ffffff" stroke-width="1.5"/>
                <text x="0" y="3" font-size="9.5" font-weight="900" fill="#ffffff" text-anchor="middle" font-family="Segoe UI">${s.name}</text>
            </g>
        `).join(""),d=e.buildings.map(s=>`
            <rect x="${s.x}" y="${s.y}" width="${s.w}" height="${s.h}" rx="4" fill="${s.fill}" stroke="${s.stroke}" stroke-width="2"/>
            <text x="${s.x+s.w/2}" y="${s.y+s.h/2-(s.sub?6:0)}" font-size="11.5" font-weight="900" fill="${s.color}" text-anchor="middle" font-family="Segoe UI">${s.name}</text>
            ${s.sub?`<text x="${s.x+s.w/2}" y="${s.y+s.h/2+12}" font-size="8.5" font-weight="700" fill="${s.stroke}" text-anchor="middle" font-family="Segoe UI">${s.sub}</text>`:""}
        `).join(""),l=(e.safetyIcons||[]).map(s=>`
            <g transform="translate(${s.x}, ${s.y})">
        ...
        `).join(""),f=`transform: scale(${(e.frameScale||100)/100}); transform-origin: center center;`;a.document.write(`
            <!DOCTYPE html>
            <html lang="ar" dir="rtl">
            <head>
                <meta charset="UTF-8">
            ...
            <body>
                <div class="toolbar-top">
                    <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                        ...
                        <input type="text" id="badgeSerialInput" value="${r}" style="padding: 4px 8px; border-radius: 6px; border: 1.5px solid #059669; font-weight: 900; font-size: 12px; color: #047857; width: 140px; font-family: monospace;" oninput="document.getElementById('badgeSerialBox').textContent = 'Badge: ' + this.value">
        ...
        `),a.document.close()}exportToExcel(){if(this.filteredVisitors.length===0){alert("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u062A\u0635\u062F\u064A\u0631\u0647\u0627");return}let t=`\uFEFF\u0631\u0642\u0645 \u0627\u0644\u0643\u0627\u0631\u062A,\u0627\u0633\u0645 \u0627\u0644\u0632\u0627\u0626\u0631,\u0627\u0644\u062C\u0647\u0629 / \u0627\u0644\u0634\u0631\u0643\u0629,\u0631\u0642\u0645 \u0627\u0644\u0647\u0627\u062A\u0641,\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0642\u0648\u0645\u064A,\u0627\u0644\u0645\u0635\u0646\u0639 \u0627\u0644\u0645\u0633\u062A\u0647\u062F\u0641,\u0627\u0644\u0645\u0643\u0627\u0646 \u0627\u0644\u0645\u0633\u062A\u0647\u062F\u0641,\u0627\u0644\u0645\u0633\u062A\u0636\u064A\u0641,\u063A\u0631\u0636 \u0627\u0644\u0632\u064A\u0627\u0631\u0629,\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062F\u062E\u0648\u0644,\u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644,\u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C,\u0627\u0644\u062D\u0627\u0644\u0629
`;this.filteredVisitors.forEach(r=>{t+=`"${r.badge||""}","${r.name||""}","${r.org||""}","${r.phone||""}","${r.idNumber||""}","${r.site||""}","${r.area||""}","${r.host||""}","${r.purpose||""}","${r.entryDate||""}","${r.entryTime||""}","${r.exitTime||""}","${r.exitTime?"\u062A\u0645 \u0627\u0644\u062E\u0631\u0648\u062C":"\u0628\u0627\u0644\u062F\u0627\u062E\u0644"}"
