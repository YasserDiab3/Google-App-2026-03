const Settings={currentApprovalCircuitOwner:"__default__",async compressLogo(e,t=800,s=800,i=.8){return new Promise((n,o)=>{try{const a=new Image;a.onload=function(){try{let r=a.width,c=a.height;if(r>t||c>s){const y=Math.min(t/r,s/c);r=Math.round(r*y),c=Math.round(c*y)}const u=document.createElement("canvas");u.width=r,u.height=c;const b=u.getContext("2d");b.drawImage(a,0,0,r,c);const d=u.toDataURL("image/jpeg",i);if(d.length>45e3){if(i>.5){const y=u.toDataURL("image/jpeg",.5);if(y.length<=45e3){n(y);return}}if(r>600||c>600){const y=Math.min(600/r,600/c),S=Math.round(r*y),x=Math.round(c*y);u.width=S,u.height=x,b.clearRect(0,0,u.width,u.height),b.drawImage(a,0,0,S,x);const B=u.toDataURL("image/jpeg",.5);n(B);return}}n(d)}catch(r){o(r)}},a.onerror=function(){o(new Error("\u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0635\u0648\u0631\u0629"))},a.src=e}catch(a){o(a)}})},currentApprovalCircuitId:null,currentApprovalCircuitSteps:[],formSettingsState:null,formSettingsEventsBound:!1,getPostLoginItems(){const e=AppState?.companySettings?.postLoginItems;if(Array.isArray(e))return e.slice();if(typeof e=="string"&&e.trim()!=="")try{const t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}return[]},renderPostLoginItemsList(){const e=document.getElementById("post-login-items-list");if(!e)return;const t=this.getPostLoginItems();if(t.length===0){e.innerHTML='<p class="text-sm text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0639\u0646\u0627\u0635\u0631. \u0627\u0636\u063A\u0637 \xAB\u0625\u0636\u0627\u0641\u0629 \u0639\u0646\u0635\u0631\xBB \u0644\u0628\u062F\u0621 \u0627\u0644\u0625\u0636\u0627\u0641\u0629.</p>';return}const s=t.slice().sort((i,n)=>(i.order??999)-(n.order??999));e.innerHTML=s.map((i,n)=>{const o=Utils.escapeHTML((i.title||"").slice(0,60))||"(\u0628\u062F\u0648\u0646 \u0639\u0646\u0648\u0627\u0646)",a=i.durationSeconds!==void 0?i.durationSeconds:10,r=i.active!==!1,c=i.order??n;return`
...
\u0633\u064A\u062A\u0645 \u0627\u0633\u062A\u0628\u062F\u0627\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u062C\u0648\u062F\u0629 \u0647\u0646\u0627\u0643.`)&&await GoogleIntegration.saveAllToSheets()});const o=document.getElementById("generate-incidents-report-btn");o&&o.addEventListener("click",()=>Settings.generateReport("incidents"));const a=document.getElementById("generate-training-report-btn");a&&a.addEventListener("click",()=>Settings.generateReport("training"));const r=document.getElementById("generate-ptw-report-btn");r&&r.addEventListener("click",()=>Settings.generateReport("ptw"));const c=document.getElementById("generate-full-report-btn");c&&c.addEventListener("click",()=>Settings.generateReport("full"));const u=document.getElementById("generate-monthly-safety-report-ar-btn"),b=document.getElementById("generate-monthly-safety-report-en-btn");u&&u.addEventListener("click",()=>Settings.generateMonthlySafetyReport("ar")),b&&b.addEventListener("click",()=>Settings.generateMonthlySafetyReport("en"));const d=document.getElementById("settings-check-app-update-btn");d&&d.addEventListener("click",async()=>{if(typeof UI<"u"&&typeof UI.updateAppVersionDisplay=="function"&&UI.updateAppVersionDisplay(),typeof UI<"u"&&typeof UI._checkServerVersion=="function"){d.disabled=!0;try{await UI._checkServerVersion(),typeof Notification<"u"&&Notification.info("\u062A\u0645 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u062A\u062D\u062F\u064A\u062B\u0627\u062A. \u0625\u0646 \u0648\u064F\u062C\u062F \u0625\u0635\u062F\u0627\u0631 \u0623\u062D\u062F\u062B \u0633\u064A\u0638\u0647\u0631 \u0625\u0634\u0639\u0627\u0631.")}finally{d.disabled=!1}}else typeof Notification<"u"&&Notification.info("\u0627\u0644\u0625\u0635\u062F\u0627\u0631 \u0627\u0644\u062D\u0627\u0644\u064A: "+(AppState.appVersion||"\u2014"))});const y=document.getElementById("upload-logo-btn"),S=document.getElementById("company-logo-input"),x=document.getElementById("remove-logo-btn");y&&S&&(y.addEventListener("click",()=>{S.click()}),S.addEventListener("change",async l=>{const p=l.target.files[0];if(!p)return;if(p.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB");return}const m=new FileReader;m.onload=async h=>{let g=h.target.result;try{g=await Settings.compressLogo(g),Utils.safeLog("\u2705 \u062A\u0645 \u0636\u063A\u0637 \u0627\u0644\u0634\u0639\u0627\u0631 (\u0627\u0644\u062D\u062C\u0645 \u0627\u0644\u0646\u0647\u0627\u0626\u064A: "+g.length+" \u062D\u0631\u0641)")}catch(f){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0636\u063A\u0637 \u0627\u0644\u0634\u0639\u0627\u0631\u060C \u0633\u064A\u062A\u0645 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0627\u0644\u0623\u0635\u0644\u064A\u0629:",f)}if(AppState.companyLogo=g,AppState.companySettings||(AppState.companySettings={}),AppState.companySettings.logo=g,localStorage.setItem("company_logo",g),localStorage.setItem("hse_company_logo",g),typeof window.DataManager<"u"&&window.DataManager.saveCompanySettings&&window.DataManager.saveCompanySettings(),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),AppState.googleConfig?.appsScript?.enabled&&typeof GoogleIntegration<"u")try{const f=AppState.currentUser||{},v=await GoogleIntegration.sendToAppsScript("saveCompanySettings",{name:AppState.companySettings?.name||"",secondaryName:AppState.companySettings?.secondaryName||"",formVersion:AppState.companySettings?.formVersion||"1.0",nameFontSize:AppState.companySettings?.nameFontSize||16,secondaryNameFontSize:AppState.companySettings?.secondaryNameFontSize||14,secondaryNameColor:AppState.companySettings?.secondaryNameColor||"#6B7280",clinicMonthlyVisitsAlertThreshold:AppState.companySettings?.clinicMonthlyVisitsAlertThreshold??10,address:AppState.companySettings?.address||"",phone:AppState.companySettings?.phone||"",email:AppState.companySettings?.email||"",logo:g,postLoginItems:typeof AppState.companySettings?.postLoginItems=="string"?AppState.companySettings.postLoginItems:JSON.stringify(AppState.companySettings?.postLoginItems||[]),userData:{email:f.email,name:f.name,role:f.role,permissions:f.permissions}});if(v&&v.success)Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D"),Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D"),typeof DataManager<"u"&&DataManager.loadCompanySettings&&setTimeout(async()=>{try{await DataManager.loadCompanySettings(!0),Utils.safeLog("\u2705 \u062A\u0645 \u0625\u0639\u0627\u062F\u0629 \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0628\u0639\u062F \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631")}catch(w){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0625\u0639\u0627\u062F\u0629 \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629:",w)}},100);else{const w=v?.message||"\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A";Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",w),Notification.error("\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+w)}}catch(f){const v=f?.message||f?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",f),Notification.error("\u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+v)}typeof UI<"u"&&UI.updateLoginLogo&&UI.updateLoginLogo(),typeof UI<"u"&&UI.updateCompanyLogoHeader&&UI.updateCompanyLogoHeader(),typeof UI<"u"&&UI.updateDashboardLogo&&UI.updateDashboardLogo(),window.dispatchEvent(new CustomEvent("companyLogoUpdated",{detail:{logoUrl:g}})),Notification.success("\u062A\u0645 \u0631\u0641\u0639 \u0627\u0644\u0634\u0639\u0627\u0631 \u0628\u0646\u062C\u0627\u062D"),Settings.load()},m.onerror=()=>{Notification.error("\u0641\u0634\u0644 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0635\u0648\u0631\u0629")},m.readAsDataURL(p)})),x&&x.addEventListener("click",async()=>{if(confirm("\u0647\u0644 \u062A\u0631\u064A\u062F \u0625\u0632\u0627\u0644\u0629 \u0634\u0639\u0627\u0631 \u0627\u0644\u0634\u0631\u0643\u0629\u061F")){if(AppState.companyLogo="",AppState.companySettings&&(AppState.companySettings.logo=""),localStorage.removeItem("company_logo"),localStorage.removeItem("hse_company_logo"),typeof window.DataManager<"u"&&window.DataManager.saveCompanySettings&&window.DataManager.saveCompanySettings(),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),AppState.googleConfig?.appsScript?.enabled&&typeof GoogleIntegration<"u")try{const l=AppState.currentUser||{},p=await GoogleIntegration.sendToAppsScript("saveCompanySettings",{name:AppState.companySettings?.name||"",secondaryName:AppState.companySettings?.secondaryName||"",formVersion:AppState.companySettings?.formVersion||"1.0",nameFontSize:AppState.companySettings?.nameFontSize||16,secondaryNameFontSize:AppState.companySettings?.secondaryNameFontSize||14,secondaryNameColor:AppState.companySettings?.secondaryNameColor||"#6B7280",clinicMonthlyVisitsAlertThreshold:AppState.companySettings?.clinicMonthlyVisitsAlertThreshold??10,address:AppState.companySettings?.address||"",phone:AppState.companySettings?.phone||"",email:AppState.companySettings?.email||"",logo:"",postLoginItems:typeof AppState.companySettings?.postLoginItems=="string"?AppState.companySettings.postLoginItems:JSON.stringify(AppState.companySettings?.postLoginItems||[]),userData:{email:l.email,name:l.name,role:l.role,permissions:l.permissions}});p&&p.success?Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0634\u0639\u0627\u0631 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D"):Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0634\u0639\u0627\u0631 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",p?.message)}catch(l){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0634\u0639\u0627\u0631 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",l)}typeof UI<"u"&&UI.updateLoginLogo&&UI.updateLoginLogo(),typeof UI<"u"&&UI.updateCompanyLogoHeader&&UI.updateCompanyLogoHeader(),typeof UI<"u"&&UI.updateDashboardLogo&&UI.updateDashboardLogo(),window.dispatchEvent(new CustomEvent("companyLogoUpdated",{detail:{logoUrl:""}})),Notification.success("\u062A\u0645 \u0625\u0632\u0627\u0644\u0629 \u0627\u0644\u0634\u0639\u0627\u0631"),Settings.load()}});const B=document.getElementById("date-format-select"),_=document.getElementById("save-date-format-btn");_&&B&&_.addEventListener("click",()=>{AppState.dateFormat=B.value,typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u062A\u0627\u0631\u064A\u062E \u0628\u0646\u062C\u0627\u062D")});const A=document.getElementById("wh-total-override"),T=document.getElementById("wh-hours-per-day"),L=document.getElementById("wh-days-per-month"),U=document.getElementById("wh-months-per-year"),M=document.getElementById("wh-include-contractors"),te=document.getElementById("wh-multiplier-trir"),se=document.getElementById("wh-multiplier-afr"),ie=document.getElementById("wh-multiplier-far"),ae=document.getElementById("wh-multiplier-sr"),ne=document.getElementById("wh-multiplier-ir"),le=document.getElementById("save-work-hours-settings-btn");(()=>{try{if(A&&(A.value=localStorage.getItem("hse_total_work_hours")||""),T&&(T.value=localStorage.getItem("hse_hours_per_day")||""),L&&(L.value=localStorage.getItem("hse_work_days_per_month")||""),U&&(U.value=localStorage.getItem("hse_work_months_per_year")||""),te&&(te.value=localStorage.getItem("hse_multiplier_trir")||""),se&&(se.value=localStorage.getItem("hse_multiplier_afr")||""),ie&&(ie.value=localStorage.getItem("hse_multiplier_far")||""),ae&&(ae.value=localStorage.getItem("hse_multiplier_sr")||""),ne&&(ne.value=localStorage.getItem("hse_multiplier_ir")||""),M){const l=localStorage.getItem("hse_work_hours_include_contractors");l===null||String(l).trim()===""?M.checked=!0:M.checked=l!=="0"&&String(l).toLowerCase()!=="false"&&String(l).toLowerCase()!=="no"}}catch(l){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0628\u0626\u0629 \u062D\u0642\u0648\u0644 \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644:",l)}})(),le&&le.addEventListener("click",()=>{try{const l=A&&String(A.value).trim();if(!l)localStorage.removeItem("hse_total_work_hours");else{const m=parseFloat(l.replace(/,/g,""));Number.isFinite(m)&&m>0?localStorage.setItem("hse_total_work_hours",String(m)):localStorage.removeItem("hse_total_work_hours")}const p=(m,h)=>{if(!h)return;const g=String(h.value).trim();if(g===""){localStorage.removeItem(m);return}const f=parseFloat(g.replace(/,/g,""));Number.isFinite(f)&&f>0?localStorage.setItem(m,String(f)):localStorage.removeItem(m)};p("hse_hours_per_day",T),p("hse_work_days_per_month",L),p("hse_work_months_per_year",U),p("hse_multiplier_trir",te),p("hse_multiplier_afr",se),p("hse_multiplier_far",ie),p("hse_multiplier_sr",ae),p("hse_multiplier_ir",ne),localStorage.setItem("hse_work_hours_include_contractors",M&&M.checked?"1":"0"),typeof Dashboard<"u"&&typeof Dashboard.updateKPIs=="function"&&Dashboard.updateKPIs(),typeof SafetyPerformanceKPIs<"u"&&typeof SafetyPerformanceKPIs.updateAllKPIs=="function"&&SafetyPerformanceKPIs.updateAllKPIs(),typeof SafetyPerformanceKPIs<"u"&&typeof SafetyPerformanceKPIs.queueScorecardRefresh=="function"&&SafetyPerformanceKPIs.queueScorecardRefresh(!0),Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644 \u0648\u062A\u062D\u062F\u064A\u062B \u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645")}catch(l){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644:",l),Notification.error("\u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644")}});const W=document.getElementById("company-name-input"),X=document.getElementById("company-name-font-size-input"),J=document.getElementById("company-secondary-name-input"),Q=document.getElementById("company-secondary-name-font-size-input"),N=document.getElementById("company-secondary-name-color-input"),D=document.getElementById("company-secondary-name-color-text-input"),re=document.getElementById("form-version-input"),ce=document.getElementById("clinic-monthly-visits-threshold-input"),de=document.getElementById("profile-teams-url-input"),pe=document.getElementById("profile-whatsapp-url-input"),C=document.getElementById("ppe-eligibility-rules-container"),me=document.getElementById("ppe-add-rule-btn"),ue=document.getElementById("ppe-download-template-btn"),ge=document.getElementById("ppe-import-rules-btn"),z=document.getElementById("ppe-rules-import-file"),fe=document.getElementById("save-company-settings-btn"),k={items:[],rules:[]},ke=l=>{let p=[];if(!l)return[];try{let m=l;if(typeof l=="string"&&(m=l.trim()?JSON.parse(l):[]),!Array.isArray(m))return[];p=m.filter(Boolean)}catch{return[]}return p.map(function(m){if(!m||typeof m!="object")return null;const h=String(m.equipmentType||m.itemName||"").trim();let g=parseInt(m.months,10);const f=parseInt(m.days,10)||0;return(isNaN(g)||g<0)&&(g=0),g=Math.min(120,g),g<1&&f>0&&(g=Math.min(120,Math.max(1,Math.ceil(f/30)))),h?{equipmentType:h,months:g,days:0}:null}).filter(Boolean)},Te=l=>{const p=(l||"").trim(),m=['<option value="">\u2014 \u0627\u062E\u062A\u0631 \u0627\u0644\u0635\u0646\u0641 \u2014</option>'];return k.items.forEach(h=>{const g=(h||"").toString(),f=Utils.escapeHTML(g),v=g.trim()===p?" selected":"";m.push(`<option value="${f}"${v}>${f}</option>`)}),m.join("")},K=()=>{if(!C)return;const l=C.scrollTop||0,p=window.scrollY||window.pageYOffset||0,m=g=>`
                ...
                `;if(!k.rules.length){C.innerHTML=m(`
                    ...
                    `),C.scrollTop=l,window.scrollTo({top:p});return}const h=k.rules.map((g,f)=>{const v=Te(g.equipmentType),w=Math.max(0,Math.min(120,parseInt(g.months,10)||0));return`
