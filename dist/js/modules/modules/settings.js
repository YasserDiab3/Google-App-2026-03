const Settings={currentApprovalCircuitOwner:"__default__",async compressLogo(e,t=800,s=800,i=.8){return new Promise((n,o)=>{try{const a=new Image;a.onload=function(){try{let r=a.width,p=a.height;if(r>t||p>s){const y=Math.min(t/r,s/p);r=Math.round(r*y),p=Math.round(p*y)}const u=document.createElement("canvas");u.width=r,u.height=p;const b=u.getContext("2d");b.drawImage(a,0,0,r,p);const c=u.toDataURL("image/jpeg",i);if(c.length>45e3){if(i>.5){const y=u.toDataURL("image/jpeg",.5);if(y.length<=45e3){n(y);return}}if(r>600||p>600){const y=Math.min(600/r,600/p),S=Math.round(r*y),x=Math.round(p*y);u.width=S,u.height=x,b.clearRect(0,0,u.width,u.height),b.drawImage(a,0,0,S,x);const B=u.toDataURL("image/jpeg",.5);n(B);return}}n(c)}catch(r){o(r)}},a.onerror=function(){o(new Error("\u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0635\u0648\u0631\u0629"))},a.src=e}catch(a){o(a)}})},currentApprovalCircuitId:null,currentApprovalCircuitSteps:[],formSettingsState:null,formSettingsEventsBound:!1,getPostLoginItems(){const e=AppState?.companySettings?.postLoginItems;if(Array.isArray(e))return e.slice();if(typeof e=="string"&&e.trim()!=="")try{const t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}return[]},renderPostLoginItemsList(){const e=document.getElementById("post-login-items-list");if(!e)return;const t=this.getPostLoginItems();if(t.length===0){e.innerHTML='<p class="text-sm text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0639\u0646\u0627\u0635\u0631. \u0627\u0636\u063A\u0637 \xAB\u0625\u0636\u0627\u0641\u0629 \u0639\u0646\u0635\u0631\xBB \u0644\u0628\u062F\u0621 \u0627\u0644\u0625\u0636\u0627\u0641\u0629.</p>';return}const s=t.slice().sort((i,n)=>(i.order??999)-(n.order??999));e.innerHTML=s.map((i,n)=>{const o=Utils.escapeHTML((i.title||"").slice(0,60))||"(\u0628\u062F\u0648\u0646 \u0639\u0646\u0648\u0627\u0646)",a=i.durationSeconds!==void 0?i.durationSeconds:10,r=i.active!==!1,p=i.order??n;return`
                <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg bg-white" data-post-login-index="${n}" data-post-login-order="${p}">
                ...
                </div>`}).join("")},async saveHelpContentToBackend(){AppState.companySettings||(AppState.companySettings={});const e=this.getHelpContentConfig();if(this.setHelpContentConfig(e),typeof DataManager<"u"&&DataManager.saveCompanySettings&&DataManager.saveCompanySettings(),!(AppState.googleConfig?.appsScript?.enabled&&typeof GoogleIntegration<"u"))return{success:!0};try{const t=AppState.currentUser||{};return await GoogleIntegration.sendToAppsScript("saveCompanySettings",{name:AppState.companySettings.name||"",secondaryName:AppState.companySettings.secondaryName||"",formVersion:AppState.companySettings.formVersion||"1.0",nameFontSize:AppState.companySettings.nameFontSize||16,secondaryNameFontSize:AppState.companySettings.secondaryNameFontSize||14,secondaryNameColor:AppState.companySettings.secondaryNameColor||"#6B7280",clinicMonthlyVisitsAlertThreshold:AppState.companySettings.clinicMonthlyVisitsAlertThreshold??10,profileTeamsUrl:AppState.companySettings.profileTeamsUrl||"",profileWhatsAppUrl:AppState.companySettings.profileWhatsAppUrl||"",address:AppState.companySettings.address||"",phone:AppState.companySettings.phone||"",email:AppState.companySettings.email||"",logo:AppState.companySettings.logo||AppState.companyLogo||"",postLoginItems:typeof AppState.companySettings.postLoginItems=="string"?AppState.companySettings.postLoginItems:JSON.stringify(AppState.companySettings.postLoginItems||[]),helpContent:AppState.companySettings.helpContent||JSON.stringify(e),userData:{email:t.email,name:t.name,role:t.role,permissions:t.permissions}})||{success:!1}}catch(t){return{success:!1,message:t?.message||String(t)}}},initHelpContentTabUI(){const e=this.getHelpContentConfig(),t=document.getElementById("help-content-enabled"),s=document.getElementById("help-content-intro");t&&(t.checked=e.enabled===!0),s&&(s.value=e.introText||""),this.renderHelpContentQaList()},bindHelpContentSettingsEvents(){if(this._helpContentEventsBound){this.initHelpContentTabUI();return}this._helpContentEventsBound=!0;const e=document.getElementById("help-content-qa-form"),t=document.getElementById("help-content-qa-form-title"),s=document.getElementById("help-content-qa-question"),i=document.getElementById("help-content-qa-answer"),n=document.getElementById("help-content-qa-module"),o=document.getElementById("help-content-qa-keywords"),a=document.getElementById("help-content-qa-active"),r=document.getElementById("help-content-qa-list");let p=-1;const u=()=>{e&&e.classList.add("hidden"),p=-1,t&&(t.textContent="\u0625\u0636\u0627\u0641\u0629 \u0633\u0624\u0627\u0644 \u062C\u062F\u064A\u062F"),s&&(s.value=""),i&&(i.value=""),n&&(n.value=""),o&&(o.value=""),a&&(a.checked=!0)},b=()=>{const c=document.getElementById("help-content-enabled"),y=document.getElementById("help-content-intro"),S=this.getHelpContentConfig();S.enabled=c?c.checked:S.enabled,S.introText=y?y.value.trim():S.introText,this.setHelpContentConfig(S)};this.initHelpContentTabUI(),document.getElementById("help-content-add-qa-btn")?.addEventListener("click",()=>{p=-1,t&&(t.textContent="\u0625\u0636\u0627\u0641\u0629 \u0633\u0624\u0627\u0644 \u062C\u062F\u064A\u062F"),s&&(s.value=""),i&&(i.value=""),n&&(n.value=""),o&&(o.value=""),a&&(a.checked=!0),e?.classList.remove("hidden")}),document.getElementById("help-content-qa-cancel-btn")?.addEventListener("click",u),document.getElementById("help-content-qa-save-btn")?.addEventListener("click",()=>{const c=s?.value?.trim()||"",y=i?.value?.trim()||"";if(!c||!y){Notification.error("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0644\u0633\u0624\u0627\u0644 \u0648\u0627\u0644\u0625\u062C\u0627\u0628\u0629.");return}const S=this.getHelpContentConfig(),x=this.getHelpContentQaItems(),B=x.length?Math.max(...x.map(A=>A.order??0)):0,N={id:p>=0&&x[p]?.id?x[p].id:"qa-"+Date.now(),question:c,answer:y,moduleId:n?.value?.trim()||"",keywords:o?.value?.trim()||"",active:a?a.checked:!0,order:p>=0?x[p].order??p:B+1};p>=0&&p<x.length?x[p]=N:x.push(N),S.qaItems=x,b(),this.setHelpContentConfig(S),this.renderHelpContentQaList(),u(),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0633\u0624\u0627\u0644 \u0645\u062D\u0644\u064A\u0627\u064B \u2014 \u0627\u0636\u063A\u0637 \xAB\u062D\u0641\u0638 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u0645\u0633\u0627\u0639\u062F\u0629\xBB \u0644\u0644\u0646\u0634\u0631.")}),r?.addEventListener("click",c=>{const y=c.target.closest(".help-qa-edit-btn"),S=c.target.closest(".help-qa-delete-btn"),x=c.target.closest(".help-qa-up-btn"),B=c.target.closest(".help-qa-down-btn"),N=y?.dataset?.index??S?.dataset?.index??x?.dataset?.index??B?.dataset?.index;if(N===void 0)return;const A=parseInt(N,10),T=this.getHelpContentConfig(),L=this.getHelpContentQaItems(),U=L[A];if(U){if(y){p=A,t&&(t.textContent="\u062A\u0639\u062F\u064A\u0644 \u0633\u0624\u0627\u0644"),s&&(s.value=U.question||""),i&&(i.value=U.answer||""),n&&(n.value=U.moduleId||""),o&&(o.value=U.keywords||""),a&&(a.checked=U.active!==!1),e?.classList.remove("hidden");return}if(S){if(!confirm("\u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0633\u0624\u0627\u0644\u061F"))return;L.splice(A,1),T.qaItems=L,this.setHelpContentConfig(T),this.renderHelpContentQaList();return}if(x&&A>0){const M=L[A].order??A;L[A].order=L[A-1].order??A-1,L[A-1].order=M,T.qaItems=L,this.setHelpContentConfig(T),this.renderHelpContentQaList()}if(B&&A<L.length-1){const M=L[A].order??A;L[A].order=L[A+1].order??A+1,L[A+1].order=M,T.qaItems=L,this.setHelpContentConfig(T),this.renderHelpContentQaList()}}}),document.getElementById("help-content-save-all-btn")?.addEventListener("click",async()=>{b();const c=await this.saveHelpContentToBackend();if(c?.success){if(Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u0645\u0633\u0627\u0639\u062F\u0629 \u0628\u0646\u062C\u0627\u062D."),typeof DataManager<"u"&&DataManager.loadCompanySettings)try{await DataManager.loadCompanySettings(!0)}catch{}}else Notification.error("\u062A\u0639\u0630\u0631 \u0627\u0644\u062D\u0641\u0638: "+(c?.message||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641"))}),document.getElementById("help-content-load-defaults-btn")?.addEventListener("click",()=>{if(!confirm("\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0623\u0633\u0626\u0644\u0629 \u0627\u0644\u0627\u0641\u062A\u0631\u0627\u0636\u064A\u0629 \u0645\u0646 \u0627\u0644\u0646\u0638\u0627\u0645 \u0644\u0644\u062A\u062D\u0631\u064A\u0631\u061F \u0633\u064A\u0633\u062A\u0628\u062F\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u062D\u0627\u0644\u064A\u0629 \u0641\u064A \u0627\u0644\u0648\u0627\u062C\u0647\u0629 (\u0644\u0645 \u064A\u064F\u062D\u0641\u0638 \u0628\u0639\u062F)."))return;if(typeof Help>"u"||typeof Help.getDefaultQaItems!="function"){Notification.error("\u0645\u0648\u062F\u064A\u0648\u0644 \u0627\u0644\u0645\u0633\u0627\u0639\u062F\u0629 \u063A\u064A\u0631 \u0645\u062D\u0645\u0651\u0644.");return}const c=this.getHelpContentConfig();c.enabled=!0,c.qaItems=Help.getDefaultQaItems().map((S,x)=>({id:S.id,question:S.question,answer:S.answer,moduleId:S.moduleId||"",keywords:S.keywords||"",active:!0,order:x+1}));const y=document.getElementById("help-content-enabled");y&&(y.checked=!0),this.setHelpContentConfig(c),this.renderHelpContentQaList(),Notification.info("\u062A\u0645 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u2014 \u0631\u0627\u062C\u0639 \u062B\u0645 \u0627\u0636\u063A\u0637 \xAB\u062D\u0641\u0638 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u0645\u0633\u0627\u0639\u062F\u0629\xBB.")})},async load(){this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{typeof AppState<"u"&&AppState._languageRefresh||this.load()}),this._languageChangeListenerAdded=!0);const e=document.getElementById("settings-section");if(e&&!(typeof Utils>"u")){if(typeof AppState>"u"){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("AppState \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631!");return}try{typeof ViolationTypesManager<"u"&&ViolationTypesManager.ensureInitialized&&ViolationTypesManager.ensureInitialized();const t=this.isCurrentUserAdmin();if(typeof Permissions<"u"&&(Permissions.formSettingsEventsBound=!1,Permissions._formSettingsBindDone=!1),e.innerHTML=`
...
\u0633\u064A\u062A\u0645 \u0627\u0633\u062A\u0628\u062F\u0627\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u062C\u0648\u062F\u0629 \u0647\u0646\u0627\u0643.`)&&await GoogleIntegration.saveAllToSheets()});const o=document.getElementById("generate-incidents-report-btn");o&&o.addEventListener("click",()=>Settings.generateReport("incidents"));const a=document.getElementById("generate-training-report-btn");a&&a.addEventListener("click",()=>Settings.generateReport("training"));const r=document.getElementById("generate-ptw-report-btn");r&&r.addEventListener("click",()=>Settings.generateReport("ptw"));const p=document.getElementById("generate-full-report-btn");p&&p.addEventListener("click",()=>Settings.generateReport("full"));const u=document.getElementById("generate-monthly-safety-report-ar-btn"),b=document.getElementById("generate-monthly-safety-report-en-btn");u&&u.addEventListener("click",()=>Settings.generateMonthlySafetyReport("ar")),b&&b.addEventListener("click",()=>Settings.generateMonthlySafetyReport("en"));const c=document.getElementById("settings-check-app-update-btn");c&&c.addEventListener("click",async()=>{if(typeof UI<"u"&&typeof UI.updateAppVersionDisplay=="function"&&UI.updateAppVersionDisplay(),typeof UI<"u"&&typeof UI._checkServerVersion=="function"){c.disabled=!0;try{await UI._checkServerVersion(),typeof Notification<"u"&&Notification.info("\u062A\u0645 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u062A\u062D\u062F\u064A\u062B\u0627\u062A. \u0625\u0646 \u0648\u064F\u062C\u062F \u0625\u0635\u062F\u0627\u0631 \u0623\u062D\u062F\u062B \u0633\u064A\u0638\u0647\u0631 \u0625\u0634\u0639\u0627\u0631.")}finally{c.disabled=!1}}else typeof Notification<"u"&&Notification.info("\u0627\u0644\u0625\u0635\u062F\u0627\u0631 \u0627\u0644\u062D\u0627\u0644\u064A: "+(AppState.appVersion||"\u2014"))});const y=document.getElementById("upload-logo-btn"),S=document.getElementById("company-logo-input"),x=document.getElementById("remove-logo-btn");y&&S&&(y.addEventListener("click",()=>{S.click()}),S.addEventListener("change",async l=>{const d=l.target.files[0];if(!d)return;if(d.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB");return}const m=new FileReader;m.onload=async h=>{let g=h.target.result;try{g=await Settings.compressLogo(g),Utils.safeLog("\u2705 \u062A\u0645 \u0636\u063A\u0637 \u0627\u0644\u0634\u0639\u0627\u0631 (\u0627\u0644\u062D\u062C\u0645 \u0627\u0644\u0646\u0647\u0627\u0626\u064A: "+g.length+" \u062D\u0631\u0641)")}catch(f){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0636\u063A\u0637 \u0627\u0644\u0634\u0639\u0627\u0631\u060C \u0633\u064A\u062A\u0645 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0627\u0644\u0623\u0635\u0644\u064A\u0629:",f)}if(AppState.companyLogo=g,AppState.companySettings||(AppState.companySettings={}),AppState.companySettings.logo=g,localStorage.setItem("company_logo",g),localStorage.setItem("hse_company_logo",g),typeof window.DataManager<"u"&&window.DataManager.saveCompanySettings&&window.DataManager.saveCompanySettings(),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),AppState.googleConfig?.appsScript?.enabled&&typeof GoogleIntegration<"u")try{const f=AppState.currentUser||{},v=await GoogleIntegration.sendToAppsScript("saveCompanySettings",{name:AppState.companySettings?.name||"",secondaryName:AppState.companySettings?.secondaryName||"",formVersion:AppState.companySettings?.formVersion||"1.0",nameFontSize:AppState.companySettings?.nameFontSize||16,secondaryNameFontSize:AppState.companySettings?.secondaryNameFontSize||14,secondaryNameColor:AppState.companySettings?.secondaryNameColor||"#6B7280",clinicMonthlyVisitsAlertThreshold:AppState.companySettings?.clinicMonthlyVisitsAlertThreshold??10,address:AppState.companySettings?.address||"",phone:AppState.companySettings?.phone||"",email:AppState.companySettings?.email||"",logo:g,postLoginItems:typeof AppState.companySettings?.postLoginItems=="string"?AppState.companySettings.postLoginItems:JSON.stringify(AppState.companySettings?.postLoginItems||[]),userData:{email:f.email,name:f.name,role:f.role,permissions:f.permissions}});if(v&&v.success)Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D"),Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D"),typeof DataManager<"u"&&DataManager.loadCompanySettings&&setTimeout(async()=>{try{await DataManager.loadCompanySettings(!0),Utils.safeLog("\u2705 \u062A\u0645 \u0625\u0639\u0627\u062F\u0629 \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0628\u0639\u062F \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631")}catch(w){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0625\u0639\u0627\u062F\u0629 \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629:",w)}},100);else{const w=v?.message||"\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A";Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",w),Notification.error("\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+w)}}catch(f){const v=f?.message||f?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",f),Notification.error("\u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0627\u0644\u0634\u0639\u0627\u0631 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+v)}typeof UI<"u"&&UI.updateLoginLogo&&UI.updateLoginLogo(),typeof UI<"u"&&UI.updateCompanyLogoHeader&&UI.updateCompanyLogoHeader(),typeof UI<"u"&&UI.updateDashboardLogo&&UI.updateDashboardLogo(),window.dispatchEvent(new CustomEvent("companyLogoUpdated",{detail:{logoUrl:g}})),Notification.success("\u062A\u0645 \u0631\u0641\u0639 \u0627\u0644\u0634\u0639\u0627\u0631 \u0628\u0646\u062C\u0627\u062D"),Settings.load()},m.onerror=()=>{Notification.error("\u0641\u0634\u0644 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0635\u0648\u0631\u0629")},m.readAsDataURL(d)})),x&&x.addEventListener("click",async()=>{if(confirm("\u0647\u0644 \u062A\u0631\u064A\u062F \u0625\u0632\u0627\u0644\u0629 \u0634\u0639\u0627\u0631 \u0627\u0644\u0634\u0631\u0643\u0629\u061F")){if(AppState.companyLogo="",AppState.companySettings&&(AppState.companySettings.logo=""),localStorage.removeItem("company_logo"),localStorage.removeItem("hse_company_logo"),typeof window.DataManager<"u"&&window.DataManager.saveCompanySettings&&window.DataManager.saveCompanySettings(),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),AppState.googleConfig?.appsScript?.enabled&&typeof GoogleIntegration<"u")try{const l=AppState.currentUser||{},d=await GoogleIntegration.sendToAppsScript("saveCompanySettings",{name:AppState.companySettings?.name||"",secondaryName:AppState.companySettings?.secondaryName||"",formVersion:AppState.companySettings?.formVersion||"1.0",nameFontSize:AppState.companySettings?.nameFontSize||16,secondaryNameFontSize:AppState.companySettings?.secondaryNameFontSize||14,secondaryNameColor:AppState.companySettings?.secondaryNameColor||"#6B7280",clinicMonthlyVisitsAlertThreshold:AppState.companySettings?.clinicMonthlyVisitsAlertThreshold??10,address:AppState.companySettings?.address||"",phone:AppState.companySettings?.phone||"",email:AppState.companySettings?.email||"",logo:"",postLoginItems:typeof AppState.companySettings?.postLoginItems=="string"?AppState.companySettings.postLoginItems:JSON.stringify(AppState.companySettings?.postLoginItems||[]),userData:{email:l.email,name:l.name,role:l.role,permissions:l.permissions}});d&&d.success?Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0634\u0639\u0627\u0631 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D"):Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0634\u0639\u0627\u0631 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",d?.message)}catch(l){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0634\u0639\u0627\u0631 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",l)}typeof UI<"u"&&UI.updateLoginLogo&&UI.updateLoginLogo(),typeof UI<"u"&&UI.updateCompanyLogoHeader&&UI.updateCompanyLogoHeader(),typeof UI<"u"&&UI.updateDashboardLogo&&UI.updateDashboardLogo(),window.dispatchEvent(new CustomEvent("companyLogoUpdated",{detail:{logoUrl:""}})),Notification.success("\u062A\u0645 \u0625\u0632\u0627\u0644\u0629 \u0627\u0644\u0634\u0639\u0627\u0631"),Settings.load()}});const B=document.getElementById("date-format-select"),N=document.getElementById("save-date-format-btn");N&&B&&N.addEventListener("click",()=>{AppState.dateFormat=B.value,typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u062A\u0627\u0631\u064A\u062E \u0628\u0646\u062C\u0627\u062D")});const A=document.getElementById("wh-total-override"),T=document.getElementById("wh-hours-per-day"),L=document.getElementById("wh-days-per-month"),U=document.getElementById("wh-months-per-year"),M=document.getElementById("wh-include-contractors"),te=document.getElementById("wh-multiplier-trir"),se=document.getElementById("wh-multiplier-afr"),ie=document.getElementById("wh-multiplier-far"),ae=document.getElementById("wh-multiplier-sr"),ne=document.getElementById("wh-multiplier-ir"),le=document.getElementById("save-work-hours-settings-btn");(()=>{try{if(A&&(A.value=localStorage.getItem("hse_total_work_hours")||""),T&&(T.value=localStorage.getItem("hse_hours_per_day")||""),L&&(L.value=localStorage.getItem("hse_work_days_per_month")||""),U&&(U.value=localStorage.getItem("hse_work_months_per_year")||""),te&&(te.value=localStorage.getItem("hse_multiplier_trir")||""),se&&(se.value=localStorage.getItem("hse_multiplier_afr")||""),ie&&(ie.value=localStorage.getItem("hse_multiplier_far")||""),ae&&(ae.value=localStorage.getItem("hse_multiplier_sr")||""),ne&&(ne.value=localStorage.getItem("hse_multiplier_ir")||""),M){const l=localStorage.getItem("hse_work_hours_include_contractors");l===null||String(l).trim()===""?M.checked=!0:M.checked=l!=="0"&&String(l).toLowerCase()!=="false"&&String(l).toLowerCase()!=="no"}}catch(l){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0628\u0626\u0629 \u062D\u0642\u0648\u0644 \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644:",l)}})(),le&&le.addEventListener("click",()=>{try{const l=A&&String(A.value).trim();if(!l)localStorage.removeItem("hse_total_work_hours");else{const m=parseFloat(l.replace(/,/g,""));Number.isFinite(m)&&m>0?localStorage.setItem("hse_total_work_hours",String(m)):localStorage.removeItem("hse_total_work_hours")}const d=(m,h)=>{if(!h)return;const g=String(h.value).trim();if(g===""){localStorage.removeItem(m);return}const f=parseFloat(g.replace(/,/g,""));Number.isFinite(f)&&f>0?localStorage.setItem(m,String(f)):localStorage.removeItem(m)};d("hse_hours_per_day",T),d("hse_work_days_per_month",L),d("hse_work_months_per_year",U),d("hse_multiplier_trir",te),d("hse_multiplier_afr",se),d("hse_multiplier_far",ie),d("hse_multiplier_sr",ae),d("hse_multiplier_ir",ne),localStorage.setItem("hse_work_hours_include_contractors",M&&M.checked?"1":"0"),typeof Dashboard<"u"&&typeof Dashboard.updateKPIs=="function"&&Dashboard.updateKPIs(),typeof SafetyPerformanceKPIs<"u"&&typeof SafetyPerformanceKPIs.updateAllKPIs=="function"&&SafetyPerformanceKPIs.updateAllKPIs(),typeof SafetyPerformanceKPIs<"u"&&typeof SafetyPerformanceKPIs.queueScorecardRefresh=="function"&&SafetyPerformanceKPIs.queueScorecardRefresh(!0),Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644 \u0648\u062A\u062D\u062F\u064A\u062B \u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645")}catch(l){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644:",l),Notification.error("\u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0633\u0627\u0639\u0627\u062A \u0627\u0644\u0639\u0645\u0644")}});const W=document.getElementById("company-name-input"),X=document.getElementById("company-name-font-size-input"),J=document.getElementById("company-secondary-name-input"),Q=document.getElementById("company-secondary-name-font-size-input"),_=document.getElementById("company-secondary-name-color-input"),D=document.getElementById("company-secondary-name-color-text-input"),re=document.getElementById("form-version-input"),ce=document.getElementById("clinic-monthly-visits-threshold-input"),de=document.getElementById("profile-teams-url-input"),pe=document.getElementById("profile-whatsapp-url-input"),C=document.getElementById("ppe-eligibility-rules-container"),me=document.getElementById("ppe-add-rule-btn"),ue=document.getElementById("ppe-download-template-btn"),ge=document.getElementById("ppe-import-rules-btn"),R=document.getElementById("ppe-rules-import-file"),fe=document.getElementById("save-company-settings-btn"),k={items:[],rules:[]},ke=l=>{let d=[];if(!l)return[];try{let m=l;if(typeof l=="string"&&(m=l.trim()?JSON.parse(l):[]),!Array.isArray(m))return[];d=m.filter(Boolean)}catch{return[]}return d.map(function(m){if(!m||typeof m!="object")return null;const h=String(m.equipmentType||m.itemName||"").trim();let g=parseInt(m.months,10);const f=parseInt(m.days,10)||0;return(isNaN(g)||g<0)&&(g=0),g=Math.min(120,g),g<1&&f>0&&(g=Math.min(120,Math.max(1,Math.ceil(f/30)))),h?{equipmentType:h,months:g,days:0}:null}).filter(Boolean)},Te=l=>{const d=(l||"").trim(),m=['<option value="">\u2014 \u0627\u062E\u062A\u0631 \u0627\u0644\u0635\u0646\u0641 \u2014</option>'];return k.items.forEach(h=>{const g=(h||"").toString(),f=Utils.escapeHTML(g),v=g.trim()===d?" selected":"";m.push(`<option value="${f}"${v}>${f}</option>`)}),m.join("")},K=()=>{if(!C)return;const l=C.scrollTop||0,d=window.scrollY||window.pageYOffset||0,m=g=>`
                ...
                `;if(!k.rules.length){C.innerHTML=m(`
                    ...
                    `),C.scrollTop=l,window.scrollTo({top:d});return}const h=k.rules.map((g,f)=>{const v=Te(g.equipmentType),w=Math.max(0,Math.min(120,parseInt(g.months,10)||0));return`
                    ...
                    </tr>`}).join("");C.innerHTML=m(h),C.scrollTop=l,window.scrollTo({top:d}),C.querySelectorAll(".ppe-rule-remove").forEach((g,f)=>{g.addEventListener("click",()=>{k.rules.splice(f,1),K()})}),C.querySelectorAll(".ppe-rule-edit").forEach((g,f)=>{g.addEventListener("click",()=>{const v=C.querySelector(`.ppe-rule-row[data-index="${f}"]`);if(!v)return;v.classList.add("bg-blue-100","ring-1","ring-blue-300");const w=v.querySelector(".ppe-rule-item"),E=v.querySelector(".ppe-rule-months");w?w.focus():E&&E.focus(),setTimeout(()=>v.classList.remove("bg-blue-100","ring-1","ring-blue-300"),1200)})})},Ue=()=>{if(!C)return[];const l=Array.from(C.querySelectorAll(".ppe-rule-row")),d=new Set,m=[];return l.forEach(h=>{const g=h.querySelector(".ppe-rule-item"),f=h.querySelector(".ppe-rule-months"),v=(g?.value||"").trim();if(!v||d.has(v))return;let w=parseInt(f?.value,10);isNaN(w)||w<1||(w=Math.min(120,w),d.add(v),m.push({equipmentType:v,months:w,days:0}))}),m},Be=()=>{if(!C)return Array.isArray(k.rules)?[...k.rules]:[];const l=Array.from(C.querySelectorAll(".ppe-rule-row"));return l.length?l.map(d=>{const m=d.querySelector(".ppe-rule-item"),h=d.querySelector(".ppe-rule-months"),g=(m?.value||"").trim();let f=parseInt(h?.value,10);return(isNaN(f)||f<1)&&(f=12),f=Math.min(120,f),{equipmentType:g,months:f,days:0}}):Array.isArray(k.rules)?[...k.rules]:[]},ye=l=>{const d=[],m=new Set;return(Array.isArray(l)?l:[]).forEach(h=>{if(!h||typeof h!="object")return;const g=String(h.equipmentType||h.itemName||h["\u0646\u0648\u0639 \u0627\u0644\u0635\u0646\u0641"]||h.\u0627\u0644\u0635\u0646\u0641||"").trim();let f=parseInt(h.months??h.\u0627\u0644\u0634\u0647\u0648\u0631??h.months,10);!g||m.has(g)||isNaN(f)||f<1||(f=Math.min(120,f),m.add(g),d.push({equipmentType:g,months:f,days:0}))}),d},Me=l=>{const d=String(l||"").split(/\r?\n/).map(g=>g.trim()).filter(Boolean);if(!d.length)return[];const h=d.filter((g,f)=>f!==0||!/الصنف|نوع|months|month|الشهور/i.test(g)).map(g=>{const f=g.includes("	")?"	":",",v=g.split(f).map(w=>w.trim()).filter(Boolean);return v.length<2?null:{equipmentType:v[0],months:v[1]}}).filter(Boolean);return ye(h)},De=async l=>{if(!l)return;const d=(l.name||"").toLowerCase();let m=[];if(d.endsWith(".xlsx")||d.endsWith(".xls")){if(typeof XLSX>"u"){Notification.error("\u0644\u0627 \u064A\u0645\u0643\u0646 \u0642\u0631\u0627\u0621\u0629 Excel \u062D\u0627\u0644\u064A\u0627\u064B. \u0627\u0633\u062A\u062E\u062F\u0645 CSV \u0623\u0648 \u0641\u0639\u0651\u0644 \u0645\u0643\u062A\u0628\u0629 XLSX.");return}const h=await l.arrayBuffer(),g=XLSX.read(h,{type:"array"}),f=g.SheetNames&&g.SheetNames[0];if(!f){Notification.error("\u0645\u0644\u0641 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0644\u0627 \u064A\u062D\u062A\u0648\u064A \u0623\u0648\u0631\u0627\u0642 \u0628\u064A\u0627\u0646\u0627\u062A.");return}const v=g.Sheets[f],w=XLSX.utils.sheet_to_json(v,{defval:""});m=ye(w)}else{const h=await l.text();m=Me(h)}if(!m.length){Notification.warning("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0635\u0641\u0648\u0641 \u0635\u0627\u0644\u062D\u0629 \u0644\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F. \u062A\u0623\u0643\u062F \u0645\u0646 \u0627\u0644\u0642\u0627\u0644\u0628: \u0627\u0644\u0635\u0646\u0641,\u0627\u0644\u0634\u0647\u0648\u0631");return}k.rules=m,K(),Notification.success(`\u062A\u0645 \u0627\u0633\u062A\u064A\u0631\u0627\u062F ${m.length} \u0642\u0627\u0639\u062F\u0629 \u0628\u0646\u062C\u0627\u062D.`)},Ne=async()=>{let l=[];try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendToAppsScript){const d=await GoogleIntegration.sendToAppsScript("getPPEItemsList",{});d&&d.success&&Array.isArray(d.data)&&(l=d.data.map(m=>(m&&(m.itemName||m.name)||"").toString().trim()).filter(Boolean))}}catch{l=[]}if(!l.length){const d=AppState.appData&&AppState.appData.ppe||[];l=[...new Set(d.map(m=>(m.equipmentType||"").toString().trim()).filter(Boolean))]}l.length||(l=["\u062E\u0648\u0630\u0629 \u0623\u0645\u0627\u0646","\u0646\u0638\u0627\u0631\u0627\u062A \u0648\u0642\u0627\u064A\u0629","\u0642\u0641\u0627\u0632\u0627\u062A","\u0623\u062D\u0630\u064A\u0629 \u0623\u0645\u0627\u0646","\u0633\u062A\u0631\u0629 \u0639\u0627\u0643\u0633\u0629","\u0633\u062F\u0627\u062F\u0627\u062A \u0623\u0630\u0646","\u0643\u0645\u0627\u0645\u0629","\u0628\u062F\u0644\u0629 \u0648\u0627\u0642\u064A\u0629","\u062D\u0632\u0627\u0645 \u0623\u0645\u0627\u0646","\u0645\u0639\u062F\u0627\u062A \u062D\u0645\u0627\u064A\u0629 \u062A\u0646\u0641\u0633\u064A\u0629"]),k.items=Array.from(new Set(l)).sort((d,m)=>d.localeCompare(m,"ar"))};(async()=>(k.rules=ke(AppState.companySettings?.ppeEligibilityRules),await Ne(),K()))(),me&&me.addEventListener("click",()=>{k.rules=Be(),k.rules.push({equipmentType:"",months:12,days:0}),K();const l=Array.from(C?.querySelectorAll(".ppe-rule-row")||[]),d=l[l.length-1],m=d?d.querySelector(".ppe-rule-item"):null;m&&typeof m.focus=="function"&&setTimeout(()=>m.focus(),0)}),ue&&ue.addEventListener("click",()=>{const d="\uFEFF"+[["\u0627\u0644\u0635\u0646\u0641","\u0627\u0644\u0634\u0647\u0648\u0631"],["\u062E\u0648\u0630\u0629 \u0623\u0645\u0627\u0646","12"],["\u0646\u0638\u0627\u0631\u0627\u062A \u0648\u0642\u0627\u064A\u0629","6"]].map(f=>f.join(",")).join(`
`),m=new Blob([d],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(m),g=document.createElement("a");g.href=h,g.download="ppe-eligibility-template.csv",document.body.appendChild(g),g.click(),g.remove(),URL.revokeObjectURL(h)}),ge&&R&&(ge.addEventListener("click",()=>R.click()),R.addEventListener("change",async()=>{const l=R.files&&R.files[0];try{await De(l)}catch(d){Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+(d?.message||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641"))}finally{R.value=""}}));const be=document.getElementById("reset-company-name-btn");_&&D&&(_.addEventListener("input",()=>{D.value=_.value}),D.addEventListener("input",()=>{const l=D.value.trim();/^#[0-9A-Fa-f]{6}$/.test(l)&&(_.value=l)})),fe&&W&&fe.addEventListener("click",async()=>{const l=W.value.trim();if(!l){Notification.error("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0633\u0645 \u0627\u0644\u0634\u0631\u0643\u0629.");return}const d=J?J.value.trim():"",m=re&&re.value.trim()||"1.0";let h=16;if(X){const I=parseInt(X.value,10);!isNaN(I)&&I>=8&&I<=72&&(h=I)}let g=14;if(Q){const I=parseInt(Q.value,10);!isNaN(I)&&I>=8&&I<=72&&(g=I)}let f="#6B7280";D&&D.value.trim()?f=D.value.trim():_&&(f=_.value);let v=10;if(ce){const I=parseInt(ce.value,10);!isNaN(I)&&I>=1&&I<=1e3&&(v=I)}const w=de?de.value.trim():"",E=pe?pe.value.trim():"";if(C){const I=Array.from(C.querySelectorAll(".ppe-rule-row"));for(const z of I){const Ce=(z.querySelector(".ppe-rule-item")?.value||"").trim(),oe=z.querySelector(".ppe-rule-months")?.value,ee=parseInt(oe,10);if(Ce&&(isNaN(ee)||ee<1)){Notification.error("\u064A\u064F\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0639\u062F\u062F \u0634\u0647\u0648\u0631 \u0635\u0627\u0644\u062D (\u0645\u0646 1 \u0625\u0644\u0649 120) \u0644\u0643\u0644 \u0635\u0646\u0641 \u0645\u062D\u062F\u062F \u0641\u064A \u062C\u062F\u0648\u0644 \u0627\u0633\u062A\u062D\u0642\u0627\u0642 \u0645\u0647\u0645\u0627\u062A \u0627\u0644\u0648\u0642\u0627\u064A\u0629.");return}if(!Ce&&oe!==""&&oe!==void 0&&!isNaN(ee)&&ee>=1){Notification.error("\u064A\u064F\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0646\u0648\u0639 \u0627\u0644\u0635\u0646\u0641 \u0644\u0643\u0644 \u0635\u0641 \u0641\u064A\u0647 \u0639\u062F\u062F \u0634\u0647\u0648\u0631 \u0641\u064A \u062C\u062F\u0648\u0644 \u0627\u0644\u0627\u0633\u062A\u062D\u0642\u0627\u0642.");return}}}const H=Ue(),Z=JSON.stringify(H);AppState.companySettings=Object.assign({},AppState.companySettings,{name:l,secondaryName:d,formVersion:m,nameFontSize:h,secondaryNameFontSize:g,secondaryNameColor:f,clinicMonthlyVisitsAlertThreshold:v,profileTeamsUrl:w,profileWhatsAppUrl:E,ppeEligibilityRules:Z}),DataManager.saveCompanySettings();let G=!0;if(AppState.googleConfig?.appsScript?.enabled&&typeof GoogleIntegration<"u")try{const I=AppState.currentUser||{},z=await GoogleIntegration.sendToAppsScript("saveCompanySettings",{name:l,secondaryName:d,formVersion:m,nameFontSize:h,secondaryNameFontSize:g,secondaryNameColor:f,clinicMonthlyVisitsAlertThreshold:v,profileTeamsUrl:w,profileWhatsAppUrl:E,ppeEligibilityRules:Z,address:AppState.companySettings?.address||"",phone:AppState.companySettings?.phone||"",email:AppState.companySettings?.email||"",logo:AppState.companySettings?.logo||AppState.companyLogo||"",postLoginItems:typeof AppState.companySettings?.postLoginItems=="string"?AppState.companySettings.postLoginItems:JSON.stringify(AppState.companySettings?.postLoginItems||[]),userData:{email:I.email,name:I.name,role:I.role,permissions:I.permissions}});z&&z.success?Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0641\u064A \u0627\u0644\u062E\u0627\u062F\u0645 \u0628\u0646\u062C\u0627\u062D"):(Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0641\u064A \u0627\u0644\u062E\u0627\u062F\u0645:",z?.message),G=!1,Notification.error("\u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0627\u0633\u062A\u062D\u0642\u0627\u0642 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+(z?.message||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641")))}catch(I){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0645\u0632\u0627\u0645\u0646\u0629 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0645\u0639 \u0627\u0644\u062E\u0627\u062F\u0645:",I),G=!1,Notification.error("\u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0627\u0633\u062A\u062D\u0642\u0627\u0642 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A (\u0627\u062A\u0635\u0627\u0644/\u062E\u0627\u062F\u0645): "+(I?.message||"\u064A\u0631\u062C\u0649 \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649."))}G&&(typeof UI<"u"&&typeof UI.updateCompanyBranding=="function"&&UI.updateCompanyBranding(),typeof DataManager<"u"&&DataManager.loadCompanySettings&&setTimeout(async()=>{try{await DataManager.loadCompanySettings(!0),Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0628\u0639\u062F \u0627\u0644\u062D\u0641\u0638")}catch(I){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0625\u0639\u0627\u062F\u0629 \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629:",I)}},100),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0628\u0646\u062C\u0627\u062D"),Settings.load())}),AppState.companySettings||(AppState.companySettings={}),Array.isArray(AppState.companySettings.postLoginItems)||(AppState.companySettings.postLoginItems=Settings.getPostLoginItems()),Settings.renderPostLoginItemsList();const ve=document.getElementById("post-login-items-list"),he=document.getElementById("post-login-add-item-btn"),O=document.getElementById("post-login-item-form"),j=document.getElementById("post-login-form-title"),$=document.getElementById("post-login-item-title"),F=document.getElementById("post-login-item-body"),q=document.getElementById("post-login-item-duration"),P=document.getElementById("post-login-item-active"),Se=document.getElementById("post-login-item-save-btn"),xe=document.getElementById("post-login-item-cancel-btn");let V=-1;const we=()=>{O&&O.classList.add("hidden"),V=-1,j&&(j.textContent="\u0625\u0636\u0627\u0641\u0629 \u0639\u0646\u0635\u0631 \u062C\u062F\u064A\u062F"),$&&($.value=""),F&&(F.value=""),q&&(q.value="10"),P&&(P.checked=!0)},Y=async()=>{if(AppState.companySettings||(AppState.companySettings={}),AppState.companySettings.postLoginItems=Settings.getPostLoginItems(),typeof DataManager<"u"&&DataManager.saveCompanySettings&&DataManager.saveCompanySettings(),AppState.googleConfig?.appsScript?.enabled&&typeof GoogleIntegration<"u")try{const l=AppState.currentUser||{},d={name:AppState.companySettings.name||"",secondaryName:AppState.companySettings.secondaryName||"",formVersion:AppState.companySettings.formVersion||"1.0",nameFontSize:AppState.companySettings.nameFontSize||16,secondaryNameFontSize:AppState.companySettings.secondaryNameFontSize||14,secondaryNameColor:AppState.companySettings.secondaryNameColor||"#6B7280",clinicMonthlyVisitsAlertThreshold:AppState.companySettings.clinicMonthlyVisitsAlertThreshold??10,address:AppState.companySettings.address||"",phone:AppState.companySettings.phone||"",email:AppState.companySettings.email||"",logo:AppState.companySettings.logo||AppState.companyLogo||"",postLoginItems:typeof AppState.companySettings.postLoginItems=="string"?AppState.companySettings.postLoginItems:JSON.stringify(AppState.companySettings.postLoginItems||[]),userData:{email:l.email,name:l.name,role:l.role,permissions:l.permissions}};await GoogleIntegration.sendToAppsScript("saveCompanySettings",d)}catch(l){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0645\u0632\u0627\u0645\u0646\u0629 \u062A\u0639\u0644\u064A\u0645\u0627\u062A \u0645\u0627 \u0628\u0639\u062F \u0627\u0644\u062F\u062E\u0648\u0644:",l)}};he&&he.addEventListener("click",()=>{V=-1,j&&(j.textContent="\u0625\u0636\u0627\u0641\u0629 \u0639\u0646\u0635\u0631 \u062C\u062F\u064A\u062F"),$&&($.value=""),F&&(F.value=""),q&&(q.value="10"),P&&(P.checked=!0),O&&O.classList.remove("hidden")}),xe&&xe.addEventListener("click",we),Se&&$&&F&&Se.addEventListener("click",async()=>{const l=$.value.trim(),d=F.value.trim(),m=parseInt(q?.value,10),h=P?P.checked:!0;if(!l){Notification.error("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0644\u0639\u0646\u0648\u0627\u0646.");return}const f=Settings.getPostLoginItems().slice().sort((w,E)=>(w.order??999)-(E.order??999)),v=f.length?Math.max(...f.map(w=>w.order??0)):0;V>=0&&V<f.length?f[V]={title:l,body:d,durationSeconds:isNaN(m)?10:Math.min(120,Math.max(0,m)),order:f[V].order??V,active:h}:f.push({title:l,body:d,durationSeconds:isNaN(m)?10:Math.min(120,Math.max(0,m)),order:v+1,active:h}),AppState.companySettings||(AppState.companySettings={}),AppState.companySettings.postLoginItems=f,await Y(),we(),Settings.renderPostLoginItemsList(),Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0639\u0646\u0635\u0631.")}),ve&&ve.addEventListener("click",async l=>{const d=l.target.closest(".post-login-edit-btn"),m=l.target.closest(".post-login-delete-btn"),h=l.target.closest(".post-login-up-btn"),g=l.target.closest(".post-login-down-btn"),f=d?.dataset?.index??m?.dataset?.index??h?.dataset?.index??g?.dataset?.index;if(f===void 0)return;const v=parseInt(f,10),E=Settings.getPostLoginItems().slice().sort((Z,G)=>(Z.order??999)-(G.order??999)),H=E[v];if(H){if(d){V=v,j&&(j.textContent="\u062A\u0639\u062F\u064A\u0644 \u0639\u0646\u0635\u0631"),$&&($.value=H.title||""),F&&(F.value=H.body||""),q&&(q.value=String(H.durationSeconds??10)),P&&(P.checked=H.active!==!1),O&&O.classList.remove("hidden");return}if(m){if(!confirm("\u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0639\u0646\u0635\u0631\u061F"))return;E.splice(v,1),AppState.companySettings||(AppState.companySettings={}),AppState.companySettings.postLoginItems=E,await Y(),Settings.renderPostLoginItemsList(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0639\u0646\u0635\u0631.");return}if(h&&v>0){[E[v-1].order,E[v].order]=[E[v].order,E[v-1].order],AppState.companySettings||(AppState.companySettings={}),AppState.companySettings.postLoginItems=E,await Y(),Settings.renderPostLoginItemsList();return}g&&v<E.length-1&&([E[v].order,E[v+1].order]=[E[v+1].order,E[v].order],AppState.companySettings||(AppState.companySettings={}),AppState.companySettings.postLoginItems=E,await Y(),Settings.renderPostLoginItemsList())}}),this.isCurrentUserAdmin()&&Settings.bindHelpContentSettingsEvents(),be&&W&&be.addEventListener("click",async()=>{if(confirm("\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0633\u062A\u0639\u0627\u062F\u0629 \u0627\u0644\u0627\u0633\u0645 \u0627\u0644\u0627\u0641\u062A\u0631\u0627\u0636\u064A \u0644\u0644\u0634\u0631\u0643\u0629\u061F")){if(AppState.companySettings=Object.assign({},AppState.companySettings,{name:DEFAULT_COMPANY_NAME,nameFontSize:16,secondaryNameFontSize:14,secondaryNameColor:"#6B7280"}),W.value=DEFAULT_COMPANY_NAME,J&&(AppState.companySettings.secondaryName="",J.value=""),X&&(X.value="16"),Q&&(Q.value="14"),_&&(_.value="#6B7280"),D&&(D.value="#6B7280"),DataManager.saveCompanySettings(),AppState.googleConfig?.appsScript?.enabled&&typeof GoogleIntegration<"u")try{const l=AppState.currentUser||{},d=await GoogleIntegration.sendToAppsScript("saveCompanySettings",{name:DEFAULT_COMPANY_NAME,secondaryName:"",formVersion:"1.0",nameFontSize:16,secondaryNameFontSize:14,secondaryNameColor:"#6B7280",clinicMonthlyVisitsAlertThreshold:AppState.companySettings?.clinicMonthlyVisitsAlertThreshold??10,address:AppState.companySettings?.address||"",phone:AppState.companySettings?.phone||"",email:AppState.companySettings?.email||"",logo:AppState.companySettings?.logo||AppState.companyLogo||"",postLoginItems:typeof AppState.companySettings?.postLoginItems=="string"?AppState.companySettings.postLoginItems:JSON.stringify(AppState.companySettings?.postLoginItems||[]),userData:{email:l.email,name:l.name,role:l.role,permissions:l.permissions}});d&&d.success?Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0627\u0644\u0627\u0641\u062A\u0631\u0627\u0636\u064A\u0629 \u0641\u064A \u0627\u0644\u062E\u0627\u062F\u0645 \u0628\u0646\u062C\u0627\u062D"):Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0641\u064A \u0627\u0644\u062E\u0627\u062F\u0645:",d?.message)}catch(l){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0645\u0632\u0627\u0645\u0646\u0629 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0645\u0639 \u0627\u0644\u062E\u0627\u062F\u0645:",l)}typeof UI<"u"&&typeof UI.updateCompanyBranding=="function"&&UI.updateCompanyBranding(),typeof DataManager<"u"&&DataManager.loadCompanySettings&&setTimeout(async()=>{try{await DataManager.loadCompanySettings(!0),Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0628\u0639\u062F \u0627\u0644\u0627\u0633\u062A\u0639\u0627\u062F\u0629")}catch(l){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0625\u0639\u0627\u062F\u0629 \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629:",l)}},100),Notification.success("\u062A\u0645\u062A \u0627\u0633\u062A\u0639\u0627\u062F\u0629 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0634\u0631\u0643\u0629 \u0627\u0644\u0627\u0641\u062A\u0631\u0627\u0636\u064A\u0629"),Settings.load()}});const Ie=document.getElementById("view-activity-log-btn");Ie&&Ie.addEventListener("click",()=>{UserActivityLog.showModal()});const Ae=document.getElementById("view-user-versions-btn");Ae&&Ae.addEventListener("click",()=>{typeof UserVersionsAdmin<"u"&&UserVersionsAdmin.open?UserVersionsAdmin.open():Notification.error("\u0644\u0648\u062D\u0629 \u0645\u062A\u0627\u0628\u0639\u0629 \u0627\u0644\u0625\u0635\u062F\u0627\u0631\u0627\u062A \u063A\u064A\u0631 \u0645\u062A\u0627\u062D\u0629. \u062D\u0627\u0648\u0644 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629.")});const Ee=document.getElementById("view-client-errors-btn");Ee&&Ee.addEventListener("click",()=>{typeof ClientErrorsAdmin<"u"&&ClientErrorsAdmin.open?ClientErrorsAdmin.open():Notification.error("\u0644\u0648\u062D\u0629 \u0645\u0631\u0627\u0642\u0628\u0629 \u0627\u0644\u0623\u062E\u0637\u0627\u0621 \u063A\u064A\u0631 \u0645\u062A\u0627\u062D\u0629. \u062D\u0627\u0648\u0644 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629.")});const Le=document.getElementById("open-client-errors-section-btn");Le&&Le.addEventListener("click",()=>{typeof UI<"u"&&typeof UI.showSection=="function"?UI.showSection("client-errors"):typeof ClientErrorsAdmin<"u"&&ClientErrorsAdmin.open?ClientErrorsAdmin.open():location.hash="#client-errors"}),this.isCurrentUserAdmin()&&typeof Permissions?.bindFormSettingsEvents=="function"&&Permissions.bindFormSettingsEvents(),this.isCurrentUserAdmin()&&(this.bindEmailSettingsEvents(),this.loadEmailSettingsUI()),this.bindViolationTypesEvents(),this.initializeApprovalCircuitsUI(),this.bindCloudStorageSettingsEvents()},100)},async loadEmailSettingsUI(){const e=document.getElementById("email-settings-modules-list");if(e){e.innerHTML='<p class="email-settings-loading"><i class="fas fa-spinner fa-spin ml-2"></i>\u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0628\u0631\u064A\u062F...</p>',this._emailSettingsGroupFilter=this._emailSettingsGroupFilter||"all",this._emailSettingsDirty=!1;try{let t=null;if(typeof EmailDispatch<"u")t=await EmailDispatch.loadSettings(!0);else if(typeof GoogleIntegration<"u"){const n=await GoogleIntegration.sendToAppsScript("getEmailSettings",{});t=n&&n.data?n.data:null}this._emailSettingsDraft=t||{globalEnabled:!1,defaultRecipients:[],modules:{}};const s=document.getElementById("email-settings-global-enabled"),i=document.getElementById("email-settings-default-recipients");s&&(s.checked=!!this._emailSettingsDraft.globalEnabled),i&&(i.value=(this._emailSettingsDraft.defaultRecipients||[]).join(", ")),this.renderEmailDefaultChips(),this.renderEmailGroupFilters(),this.updateEmailSettingsStatusBanner(),this.renderEmailModulesList(document.getElementById("email-settings-module-filter")?.value||""),this.setEmailSettingsDirty(!1)}catch{e.innerHTML='<p class="email-settings-error">\u062A\u0639\u0630\u0651\u0631 \u062A\u062D\u0645\u064A\u0644 \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0628\u0631\u064A\u062F</p>'}}},parseEmailListText(e){return String(e||"").split(/[,;\s]+/).map(t=>t.trim().toLowerCase()).filter(t=>t.includes("@"))},renderEmailDefaultChips(){const e=document.getElementById("email-settings-default-chips"),t=document.getElementById("email-settings-default-recipients");if(!e)return;const s=this.parseEmailListText(t?.value||"");if(!s.length){e.innerHTML='<span class="email-settings-chip email-settings-chip-muted">\u0644\u0627 \u0645\u0633\u062A\u0644\u0645\u064A\u0646 \u0628\u0639\u062F</span>';return}e.innerHTML=s.map(i=>`<span class="email-settings-chip" dir="ltr">${Utils.escapeHTML(i)}</span>`).join("")},setEmailSettingsDirty(e){this._emailSettingsDirty=!!e;const t=document.getElementById("email-settings-dirty-hint"),s=document.getElementById("email-settings-sticky-bar");t&&(t.hidden=!e),s&&s.classList.toggle("is-dirty",!!e)},updateEmailSettingsStatusBanner(){const t=!!(this._emailSettingsDraft||{}).globalEnabled||!!document.getElementById("email-settings-global-enabled")?.checked,s=document.getElementById("email-settings-status-banner"),i=document.getElementById("email-settings-status-title"),n=document.getElementById("email-settings-status-hint");s&&s.classList.toggle("is-on",t),i&&(i.textContent=t?"\u0646\u0638\u0627\u0645 \u0627\u0644\u0628\u0631\u064A\u062F \u0645\u0641\u0639\u0651\u0644":"\u0646\u0638\u0627\u0645 \u0627\u0644\u0628\u0631\u064A\u062F \u0645\u062A\u0648\u0642\u0641"),n&&(n.textContent=t?"\u0632\u0631 \u0627\u0644\u0625\u0631\u0633\u0627\u0644 \u064A\u0638\u0647\u0631 \u0641\u064A \u0627\u0644\u062A\u0641\u0627\u0635\u064A\u0644 \u0644\u0644\u0623\u0646\u0648\u0627\u0639 \u0627\u0644\u0645\u0641\u0639\u0651\u0644\u0629 \u064A\u062F\u0648\u064A\u0627\u064B. \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A \u064A\u0639\u0645\u0644 \u0639\u0646\u062F \u0627\u0644\u062D\u0641\u0638 \u0625\u0646 \u0643\u0627\u0646 \u0645\u0641\u0639\u0651\u0644\u0627\u064B.":"\u0639\u0646\u062F \u0627\u0644\u0625\u064A\u0642\u0627\u0641: \u0644\u0627 \u0632\u0631 \u064A\u062F\u0648\u064A \u0648\u0644\u0627 \u0625\u0631\u0633\u0627\u0644 \u062A\u0644\u0642\u0627\u0626\u064A \u0645\u0646 \u0647\u0630\u0647 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A.")},updateEmailModulesSummary(){const e=document.getElementById("email-settings-modules-summary");if(!e||!this._emailSettingsDraft)return;const t=this._emailSettingsDraft.modules||{},s=Object.keys(t),i=s.filter(a=>t[a].enabled).length,n=s.filter(a=>t[a].enabled&&t[a].manualSend).length,o=s.filter(a=>t[a].enabled&&t[a].autoSend).length;e.textContent=`${i} \u0645\u0641\u0639\u0651\u0644 \u0645\u0646 ${s.length} \xB7 \u064A\u062F\u0648\u064A ${n} \xB7 \u062A\u0644\u0642\u0627\u0626\u064A ${o}`},renderEmailGroupFilters(){const e=document.getElementById("email-settings-group-filters");if(!e||!this._emailSettingsDraft)return;const t=typeof EmailDispatch<"u"&&EmailDispatch.GROUP_LABELS?EmailDispatch.GROUP_LABELS:{ops:"\u0627\u0644\u062A\u0634\u063A\u064A\u0644 \u0648\u0627\u0644\u0633\u0644\u0627\u0645\u0629",clinic:"\u0627\u0644\u0639\u064A\u0627\u062F\u0629",reports:"\u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631",system:"\u0627\u0644\u0646\u0638\u0627\u0645"},s=this._emailSettingsDraft.modules||{},i={all:Object.keys(s).length};Object.keys(s).forEach(a=>{const r=s[a].group||"ops";i[r]=(i[r]||0)+1});const n=this._emailSettingsGroupFilter||"all",o=[{id:"all",label:"\u0627\u0644\u0643\u0644"}].concat(Object.keys(t).filter(a=>i[a]).map(a=>({id:a,label:t[a]})));e.innerHTML=o.map(a=>`
        ...
        `).join("")},renderEmailModulesList(e){const t=document.getElementById("email-settings-modules-list");if(!t||!this._emailSettingsDraft)return;const s=String(e||"").trim().toLowerCase(),i=this._emailSettingsGroupFilter||"all",n=this._emailSettingsDraft.modules||{},o=typeof EmailDispatch<"u"&&EmailDispatch.GROUP_LABELS?EmailDispatch.GROUP_LABELS:{ops:"\u0627\u0644\u062A\u0634\u063A\u064A\u0644 \u0648\u0627\u0644\u0633\u0644\u0627\u0645\u0629",clinic:"\u0627\u0644\u0639\u064A\u0627\u062F\u0629",reports:"\u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631",system:"\u0627\u0644\u0646\u0638\u0627\u0645"},a=Object.keys(n).sort((u,b)=>{const c=n[u].group||"ops",y=n[b].group||"ops";return c!==y?c.localeCompare(y):String(n[u].labelAr||u).localeCompare(String(n[b].labelAr||b),"ar")});let r="",p="";a.forEach(u=>{const b=n[u],c=b.labelAr||u,y=b.group||"ops";if(i!=="all"&&y!==i||s&&!c.toLowerCase().includes(s)&&!u.toLowerCase().includes(s))return;y!==p&&(p=y,r+=`<div class="email-settings-group-title">${Utils.escapeHTML(o[y]||y)}</div>`);const S=(b.recipients||[]).join(", "),x=!!b.enabled;r+=`
                <div class="email-module-row${x?" is-enabled":""}" data-module-key="${Utils.escapeHTML(u)}">
                    <div class="email-module-row-top">
                        <div class="email-module-identity">
                            <span class="email-module-name">${Utils.escapeHTML(c)}</span>
                        ...
                        <div class="email-module-toggles">
                            ...
                            <label class="email-toggle" title="\u0632\u0631 \u0625\u0631\u0633\u0627\u0644 \u0645\u0646 \u0634\u0627\u0634\u0629 \u0627\u0644\u062A\u0641\u0627\u0635\u064A\u0644">
                                <input type="checkbox" class="em-manual" ${b.manualSend?"checked":""} ${x?"":"disabled"}>
                                <span>\u064A\u062F\u0648\u064A</span>
                            </label>
                            <label class="email-toggle" title="\u0625\u0631\u0633\u0627\u0644 \u062A\u0644\u0642\u0627\u0626\u064A \u0639\u0646\u062F \u0627\u0644\u062D\u0641\u0638">
                                <input type="checkbox" class="em-auto" ${b.autoSend?"checked":""} ${x?"":"disabled"}>
                                <span>\u062A\u0644\u0642\u0627\u0626\u064A</span>
                            </label>
                        </div>
                    </div>
        ...
        `,document.body.appendChild(s),s.querySelector("#violation-type-form").addEventListener("submit",async n=>{n.preventDefault();const o=s.querySelector("#violation-type-name"),a=s.querySelector("#violation-type-description"),r=s.querySelector("#violation-type-fine-amount"),p=o?.value.trim()||"",u=a?.value.trim()||"",b=r?.value??"0",c=Number(b),y=Number.isFinite(c)&&c>=0?c:0;if(!p){Notification.error("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0633\u0645 \u0627\u0644\u0646\u0648\u0639"),o?.focus();return}try{t?(ViolationTypesManager.updateType(t.id,{name:p,description:u,fineAmount:y}),await ViolationTypesManager.persist(),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0646\u0648\u0639 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0628\u0646\u062C\u0627\u062D")):(ViolationTypesManager.addType({name:p,description:u,fineAmount:y}),await ViolationTypesManager.persist(),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0646\u0648\u0639 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0628\u0646\u062C\u0627\u062D")),s.remove(),this.refreshViolationTypesList()}catch(S){Notification.error(S.message)}}),s.addEventListener("click",n=>{n.target===s&&s.remove()})},deleteViolationType(e){if(!e)return;const t=ViolationTypesManager.getTypeById(e);if(!t){Notification.error("\u0646\u0648\u0639 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const s=ViolationTypesManager.countUsage(t),i=s>0?`\u0647\u0646\u0627\u0643 ${s} \u0633\u062C\u0644 \u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0631\u062A\u0628\u0637 \u0628\u0647\u0630\u0627 \u0627\u0644\u0646\u0648\u0639.
