...
\u0633\u064A\u062A\u0645 \u0641\u0642\u062F\u0627\u0646 \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.`)&&e.closest(".modal-overlay").remove()},closeModal(e){const t=e.closest(".modal-overlay");t&&t.remove()},generateFireDeviceID(){const t=this.getAssets().map(s=>s.id).filter(s=>s&&s.match(/^EFA-\d{4}$/)).map(s=>parseInt(s.split("-")[1])).filter(s=>!isNaN(s)),a=t.length>0?Math.max(...t)+1:1;return`EFA-${String(a).padStart(4,"0")}`},_injectFireIdentityStyles(){try{if(document.getElementById("fire-professional-identity-styles"))return;const e=document.createElement("style");e.id="fire-professional-identity-styles",e.textContent=`
        ...
        `},async renderInspectionsTab(){this.ensureData();const e=this.getInspections()||[],t=e.filter(o=>String(o.approvalStatus||"").toLowerCase()==="pending"||!o.approvalStatus&&o.submittedBy&&String(o.submittedBy).includes("Public")).length,a=e.filter(o=>String(o.approvalStatus||"").toLowerCase()==="approved").length,i=e.filter(o=>String(o.approvalStatus||"").toLowerCase()==="rejected").length,s=e.filter(o=>o.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629").length,n=e.filter(o=>o.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length,r=this.state.inspectionApprovalFilter||"all";let l=e;return r==="pending"?l=e.filter(o=>String(o.approvalStatus||"").toLowerCase()==="pending"||!o.approvalStatus&&o.submittedBy&&String(o.submittedBy).includes("Public")):r==="approved"?l=e.filter(o=>String(o.approvalStatus||"").toLowerCase()==="approved"):r==="rejected"&&(l=e.filter(o=>String(o.approvalStatus||"").toLowerCase()==="rejected")),`
            ...
            <div class="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-4">
                <div class="content-card text-center" style="cursor: pointer; ${r==="all"?"border: 2px solid #3b82f6;":""}" onclick="FireEquipment.filterInspectionsByApproval('all')">
                    <div class="text-2xl font-bold text-blue-600" id="inspections-total">${e.length}</div>
                    <div class="text-xs text-gray-600 mt-1">\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0641\u062D\u0648\u0635\u0627\u062A</div>
                </div>
                <div class="content-card text-center" style="cursor: pointer; background: #fffbeb; ${r==="pending"?"border: 2px solid #d97706;":""}" onclick="FireEquipment.filterInspectionsByApproval('pending')">
                    <div class="text-2xl font-bold text-amber-600" id="inspections-pending">${t}</div>
                    <div class="text-xs font-bold text-amber-800 mt-1">\u23F3 \u0628\u0627\u0646\u062A\u0638\u0627\u0631 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F</div>
                </div>
                <div class="content-card text-center" style="cursor: pointer; ${r==="approved"?"border: 2px solid #16a34a;":""}" onclick="FireEquipment.filterInspectionsByApproval('approved')">
                    <div class="text-2xl font-bold text-green-600" id="inspections-approved">${a}</div>
                    <div class="text-xs text-gray-600 mt-1">\u2705 \u0645\u0639\u062A\u0645\u062F \u0631\u0633\u0645\u064A\u0627\u064B</div>
                </div>
                <div class="content-card text-center">
                    <div class="text-2xl font-bold text-yellow-600" id="inspections-needs-repair">${s}</div>
                    <div class="text-xs text-gray-600 mt-1">\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629</div>
                </div>
                <div class="content-card text-center" style="cursor: pointer; ${r==="rejected"?"border: 2px solid #dc2626;":""}" onclick="FireEquipment.filterInspectionsByApproval('rejected')">
                    <div class="text-2xl font-bold text-red-600" id="inspections-rejected">${i||n}</div>
            ...
            <div style="display: flex; gap: 8px; margin-bottom: 12px; flex-wrap: wrap;">
                ...
                <button class="btn ${r==="rejected"?"btn-primary":"btn-secondary"}" style="padding: 6px 14px; font-size: 0.85rem; border-radius: 20px;" onclick="FireEquipment.filterInspectionsByApproval('rejected')">
                    \u274C \u0627\u0644\u0645\u0631\u0641\u0648\u0636\u0629 (${i})
                </button>
            </div>
