...
\u0633\u064A\u062A\u0645 \u0641\u0642\u062F\u0627\u0646 \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.`)&&e.closest(".modal-overlay").remove()},closeModal(e){const a=e.closest(".modal-overlay");a&&a.remove()},generateFireDeviceID(){const a=this.getAssets().map(s=>s.id).filter(s=>s&&s.match(/^EFA-\d{4}$/)).map(s=>parseInt(s.split("-")[1])).filter(s=>!isNaN(s)),t=a.length>0?Math.max(...a)+1:1;return`EFA-${String(t).padStart(4,"0")}`},_injectFireIdentityStyles(){try{if(document.getElementById("fire-professional-identity-styles"))return;const e=document.createElement("style");e.id="fire-professional-identity-styles",e.textContent=`
        ...
        `;return e==="database"?`
            ...
            `:a},async hideLoadingAndShowContent(){const e=this.state.currentTab,a=document.getElementById(`fire-tab-${e}`);if(a){const t=a.querySelector(".fire-tab-loading");t&&(t.style.display="none");try{const i=await this.renderTabContent(e);i&&(a.innerHTML=i,this.setupTabEventListeners(e))}catch(i){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062A\u0628\u0648\u064A\u0628:",i)}}},async renderTabContent(e){return e==="database"?await this.renderDatabaseTab():e==="register"?await this.renderRegisterTab():e==="inspections"?await this.renderInspectionsTab():e==="analytics"?await this.renderAnalyticsTab():e==="approval-requests"?await this.renderApprovalRequestsTab():""},async renderDatabaseTab(){return`
        ...
        `},renderRegisterStatisticsCards(){const e=this.getRegisterStatistics(),a=t=>e.total?Math.round((Number(t)||0)/e.total*100):0;return`
        ...
        `},updateRegisterStatisticsCards(){this.ensureData();const e=this.getRegisterStatistics(),a=document.getElementById("register-stat-total"),t=document.getElementById("register-stat-operational"),i=document.getElementById("register-stat-needs-maintenance"),s=document.getElementById("register-stat-out-of-service");a&&(a.textContent=e.total),t&&(t.textContent=e.operational),i&&(i.textContent=e.needsMaintenance),s&&(s.textContent=e.outOfService)},async renderRegisterTab(){this.ensureData();const e=this.getAssets(),a=e&&e.length>0;let t="";return a?t=this.renderRegisterTable():t=`
                <div class="empty-state">
                    <div style="width: 300px; margin: 0 auto 16px;">
                        <div style="width: 100%; height: 6px; background: rgba(59, 130, 246, 0.2); border-radius: 3px; overflow: hidden;">
                            <div style="height: 100%; background: linear-gradient(90deg, #3b82f6, #2563eb, #3b82f6); background-size: 200% 100%; border-radius: 3px; animation: loadingProgress 1.5s ease-in-out infinite;"></div>
        ...
        `},renderRegisterTable(){const e=this.getAssets();return!e||e.length===0?'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0639\u062F\u0627\u062A \u0645\u0633\u062C\u0644\u0629 \u0628\u0639\u062F\u060C \u0642\u0645 \u0628\u0625\u0636\u0627\u0641\u0629 \u062C\u0647\u0627\u0632 \u062C\u062F\u064A\u062F \u0644\u0628\u062F\u0621 \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629.</p></div>':`
            <div class="table-wrapper fire-register-table-wrapper" style="width: 100%; max-width: 100%; overflow-x: auto; overflow-y: auto; max-height: 70vh; position: relative;">
                <table class="data-table table-header-red" style="width: 100%; min-width: 100%; table-layout: auto;">
                    ...
                    <tbody>${e.map(t=>{const i=this.getStatusBadge(t.status),s=t.manufacturingYear||"-";return`
                <tr>
        ...
        `},async filterInspectionsByApproval(e){this.state.inspectionApprovalFilter=e;const a=document.getElementById("fire-tab-content");a&&(a.innerHTML=await this.renderInspectionsTab(),this.setupEventListeners())},async refreshRegisterTable(){this.ensureData(),this.updateRegisterStatisticsCards();const e=document.getElementById("fire-register-table");if(!e)return;const a=this.getAssets();!a||a.length===0?e.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0639\u062F\u0627\u062A \u0645\u0633\u062C\u0644\u0629 \u0628\u0639\u062F\u060C \u0642\u0645 \u0628\u0625\u0636\u0627\u0641\u0629 \u062C\u0647\u0627\u0632 \u062C\u062F\u064A\u062F \u0644\u0628\u062F\u0621 \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629.</p></div>':(e.innerHTML=this.renderRegisterTable(),e.dataset.eventsBound="false",this.bindRegisterTableEvents(e))},async refreshCurrentTab(e=!1){if(this.state.currentTab==="database")this.renderAssets();else if(this.state.currentTab==="register")await this.refreshRegisterTable();else if(this.state.currentTab==="inspections"){const a=this.getMonthlyInspections(),t=document.getElementById("inspections-completed"),i=document.getElementById("inspections-needs-repair"),s=document.getElementById("inspections-out-of-service"),n=document.getElementById("inspections-total");t&&(t.textContent=a.completed),i&&(i.textContent=a.needsRepair),s&&(s.textContent=a.outOfService),n&&(n.textContent=a.total);const o=document.getElementById("monthly-inspections-table");o&&(o.innerHTML=this.renderMonthlyInspectionsTable(a.list))}else this.renderAssets()},getMonthlyInspections(){const e=new Date,a=new Date(e.getFullYear(),e.getMonth(),1),t=new Date(e.getFullYear(),e.getMonth()+1,0,23,59,59),i=this.getInspections().filter(s=>{const n=new Date(s.checkDate||s.createdAt);return n>=a&&n<=t}).sort((s,n)=>{const o=new Date(s.checkDate||s.createdAt);return new Date(n.checkDate||n.createdAt)-o});return{list:i,total:i.length,completed:i.filter(s=>s.status==="\u0635\u0627\u0644\u062D").length,needsRepair:i.filter(s=>s.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629").length,outOfService:i.filter(s=>s.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length}},getApprovalBadge(e,a){const t=String(e||"").toLowerCase();return t==="approved"?'<span class="badge" style="background:#dcfce7; color:#166534; border:1px solid #bbf7d0; font-weight:700; padding:3px 8px; border-radius:6px; font-size:0.8rem;"><i class="fas fa-check-circle ml-1 text-emerald-600"></i> \u0645\u0639\u062A\u0645\u062F</span>':t==="rejected"?'<span class="badge" style="background:#fee2e2; color:#991b1b; border:1px solid #fecaca; font-weight:700; padding:3px 8px; border-radius:6px; font-size:0.8rem;"><i class="fas fa-times-circle ml-1 text-red-600"></i> \u0645\u0631\u0641\u0648\u0636</span>':'<span class="badge" style="background:#fef3c7; color:#92400e; border:1px solid #fde68a; font-weight:700; padding:3px 8px; border-radius:6px; font-size:0.8rem;"><i class="fas fa-clock ml-1 text-amber-600"></i> \u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629</span>'},renderMonthlyInspectionsTable(e){return!e||e.length===0?'<div class="empty-state" style="padding: 30px; text-align: center;"><i class="fas fa-clipboard-check text-4xl text-gray-300 mb-2"></i><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0641\u062D\u0648\u0635\u0627\u062A \u0645\u0633\u062C\u0644\u0629 \u062A\u0637\u0627\u0628\u0642 \u0627\u0644\u062A\u062D\u062F\u064A\u062F</p></div>':`
            <div class="table-wrapper" style="width: 100%; max-width: 100%; overflow-x: auto;">
                <table class="data-table table-header-red" style="width: 100%; min-width: 100%; table-layout: auto;">
                    ...
                    <tbody>${e.map(t=>{const i=this.getAssets().find(c=>c.id===t.assetId),s=i?`${i.number||i.id} - ${i.location||""}`:t.assetId,n=this.getStatusBadge(t.status),o=this.getApprovalBadge(t.approvalStatus,t.submittedBy),l=t.checkDate?Utils.formatDate(t.checkDate):"-",r=String(t.approvalStatus||"").toLowerCase()==="pending"||!t.approvalStatus&&t.submittedBy&&String(t.submittedBy).includes("Public");return`
                <tr>
                    <td>
        ...
        `},viewInspection(e){const a=this.getInspections().find(l=>l.id===e);if(!a){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0641\u062D\u0635");return}const t=this.getAssets().find(l=>l.id===a.assetId),i=t?`${t.number||t.id} - ${t.location||""}`:a.assetId,s=String(a.approvalStatus||"").toLowerCase()==="pending"||!a.approvalStatus&&a.submittedBy&&String(a.submittedBy).includes("Public");let n=[];if(a.attachments)try{n=typeof a.attachments=="string"?JSON.parse(a.attachments):a.attachments}catch{}const o=document.createElement("div");o.className="modal-overlay fire-modal",o.innerHTML=`
            <div class="modal-content" style="max-width: 720px; border-radius: 16px; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25);">
                <div class="modal-header" style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); color: #ffffff; padding: 18px 24px; display: flex; align-items: center; justify-content: space-between;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <div>
                            ...
                            <p style="font-size: 0.8rem; color: #94a3b8; margin: 0;">\u0643\u0648\u062F \u0627\u0644\u0641\u062D\u0635: ${Utils.escapeHTML(a.id)}</p>
                        </div>
                    </div>
                ...
                <div class="modal-body" style="padding: 22px; background: #f8fafc;">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; background: #ffffff; padding: 12px 16px; border-radius: 10px; border: 1px solid #e2e8f0; margin-bottom: 16px;">
                        ...
                        <div>${this.getApprovalBadge(a.approvalStatus,a.submittedBy)}</div>
                    </div>
                    ...
                    <div class="space-y-4" style="background: #ffffff; padding: 18px; border-radius: 12px; border: 1px solid #e2e8f0;">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900 font-bold mt-1" style="direction: ltr; text-align: right;">${Utils.escapeHTML(a.assetId||"-")}</p>
                            </div>
                            <div>
                                <label class="text-xs font-semibold text-gray-500">\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0641\u062D\u0635:</label>
                                <p class="text-gray-800 mt-1">${a.checkDate?Utils.formatDate(a.checkDate):"-"}</p>
                            </div>
                            <div>
                                <label class="text-xs font-semibold text-gray-500">\u0645\u0633\u0624\u0648\u0644 / \u0645\u0641\u062A\u0634 \u0627\u0644\u0633\u0644\u0627\u0645\u0629:</label>
                                <p class="text-gray-800 font-bold mt-1">${Utils.escapeHTML(a.inspector||"-")}</p>
                            </div>
                            <div>
                                <label class="text-xs font-semibold text-gray-500">\u0627\u0644\u062D\u0627\u0644\u0629 \u0627\u0644\u062A\u0634\u063A\u064A\u0644\u064A\u0629 \u0644\u0644\u062C\u0647\u0627\u0632:</label>
                                <p class="mt-1">${this.getStatusBadge(a.status)}</p>
                            </div>
                            <div>
                                <label class="text-xs font-semibold text-gray-500">\u0645\u0624\u0634\u0631 \u0639\u062F\u0627\u062F \u0627\u0644\u0636\u063A\u0637:</label>
                                <p class="text-gray-800 mt-1">${Utils.escapeHTML(a.gaugeReading||"\u0633\u0644\u064A\u0645")}</p>
                            </div>
                            <div>
                                <label class="text-xs font-semibold text-gray-500">\u0635\u0645\u0627\u0645 \u0648\u062A\u064A\u0644\u0629 \u0627\u0644\u0623\u0645\u0627\u0646:</label>
                                <p class="text-gray-800 font-bold mt-1">${Utils.escapeHTML(a.sealIntact===!0?"\u0633\u0644\u064A\u0645":a.sealIntact===!1?"\u0645\u0643\u0633\u0648\u0631":a.sealIntact||"\u0633\u0644\u064A\u0645")}</p>
                            </div>
                            <div>
                                <label class="text-xs font-semibold text-gray-500">\u0627\u0644\u062E\u0631\u0637\u0648\u0645 \u0648\u0627\u0644\u0642\u0627\u0630\u0641 / \u062C\u0633\u0645 \u0627\u0644\u0623\u0633\u0637\u0648\u0627\u0646\u0629:</label>
                                <p class="text-gray-800 mt-1">${Utils.escapeHTML(a.hoseCondition||a.bodyCondition||"\u0633\u0644\u064A\u0645")}</p>
                            </div>
                        </div>
                        ...
                        <div style="border-top: 1px solid #f1f5f9; padding-top: 10px;">
                            ...
                            <p class="text-gray-800 mt-1 bg-gray-50 p-2 rounded">${Utils.escapeHTML(a.remarks)}</p>
                        </div>`:""}

                        ${a.actions?`
                        <div style="border-top: 1px solid #f1f5f9; padding-top: 10px;">
                            <label class="text-xs font-semibold text-gray-500">\u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A \u0627\u0644\u0645\u062A\u062E\u0630\u0629:</label>
                            <p class="text-gray-800 mt-1 bg-gray-50 p-2 rounded">${Utils.escapeHTML(a.actions)}</p>
                        </div>`:""}
                        ...
                        <div style="border-top: 1px solid #dcfce7; background: #f0fdf4; padding: 10px 14px; border-radius: 8px; margin-top: 10px;">
                            ...
                            <span class="text-xs text-green-900 font-bold mr-1">${Utils.escapeHTML(a.approvedBy)}</span>
                            ${a.approvedAt?`<span class="text-xs text-green-700">\u0628\u062A\u0627\u0631\u064A\u062E (${Utils.formatDate(a.approvedAt)})</span>`:""}
                        </div>`:""}
                        ...
                        <div style="border-top: 1px solid #fee2e2; background: #fef2f2; padding: 10px 14px; border-radius: 8px; margin-top: 10px;">
                            ...
                            <span class="text-xs text-red-900 font-bold mr-1">${Utils.escapeHTML(a.rejectedBy)}</span>
                            <p class="text-xs text-red-700 mt-1">\u0627\u0644\u0633\u0628\u0628: ${Utils.escapeHTML(a.reviewNotes||"-")}</p>
                        </div>`:""}
                ...
                <div class="modal-footer" style="padding: 16px 24px; background: #ffffff; border-top: 1px solid #e2e8f0; display: flex; justify-content: space-between; align-items: center;">
                    <div style="display: flex; gap: 8px;">
                        ${s?`
                            <button type="button" class="btn-primary" style="background: #16a34a; display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px; border-radius: 8px;" onclick="FireEquipment.approveInspection('${a.id}', this)">
                                <i class="fas fa-check"></i> \u0627\u0639\u062A\u0645\u0627\u062F \u0648\u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u0627\u0644\u0637\u0641\u0627\u064A\u0629
                            </button>
                            <button type="button" class="btn-danger" style="background: #dc2626; color:#ffffff; display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px; border-radius: 8px; border:none;" onclick="FireEquipment.rejectInspection('${a.id}', this)">
        ...
        `,document.body.appendChild(o)},async approveInspection(e,a){if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u0627\u0639\u062A\u0645\u0627\u062F \u0646\u062A\u064A\u062C\u0629 \u0647\u0630\u0627 \u0627\u0644\u0641\u062D\u0635 \u0648\u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0633\u062C\u0644 \u0627\u0644\u0631\u0633\u0645\u064A \u0644\u0644\u0637\u0641\u0627\u064A\u0629\u061F"))try{const i=AppState.currentUser||{},s=i.name||i.fullName||i.userName||"\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645",n=new Date().toISOString(),l=(this.getInspections()||[]).find(r=>r.id===e);if(l&&(l.approvalStatus="approved",l.approvedBy=s,l.approvedAt=n,l.reviewNotes="\u062A\u0645 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u0627\u0644\u0645\u064A\u062F\u0627\u0646\u064A",l.assetId)){const c=(this.getAssets()||[]).find(f=>f.id===l.assetId);if(c){c.status=l.status||"\u0635\u0627\u0644\u062D",c.lastInspection=l.checkDate||n.split("T")[0];var t=new Date(l.checkDate||Date.now());t.setMonth(t.getMonth()+1),c.nextInspection=t.toISOString().split("T")[0],c.updatedAt=n}}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),document.querySelectorAll(".modal-overlay.fire-modal").forEach(r=>r.remove()),await this.refreshCurrentTab(!0),typeof Notification<"u"&&Notification.success("\u2705 \u062A\u0645 \u0627\u0639\u062A\u0645\u0627\u062F \u0627\u0644\u0641\u062D\u0635 \u0648\u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u062C\u0647\u0627\u0632 \u0627\u0644\u0625\u0637\u0641\u0627\u0621 \u0641\u0648\u0631\u0627\u064B"),typeof GoogleIntegration<"u"&&AppState.googleConfig?.appsScript?.enabled&&GoogleIntegration.sendRequest({action:"approveFireEquipmentInspection",data:{inspectionId:e,approverData:{name:s,id:i.id||i.userId||"",role:i.role||"admin"},reviewNotes:"\u062A\u0645 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u0627\u0644\u0645\u064A\u062F\u0627\u0646\u064A"}}).then(r=>{Utils.safeLog("\u2705 Backend inspection approval sync complete:",r)}).catch(r=>{Utils.safeWarn("\u26A0\uFE0F Background approval sync notice (saved locally):",r)})}catch(i){Utils.safeError("Error in approveInspection:",i),typeof Notification<"u"&&Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+i.message)}},async rejectInspection(e,a){const t=prompt("\u064A\u0631\u062C\u0649 \u0643\u062A\u0627\u0628\u0629 \u0633\u0628\u0628 \u0631\u0641\u0636 \u0647\u0630\u0627 \u0627\u0644\u0641\u062D\u0635 \u0627\u0644\u0645\u064A\u062F\u0627\u0646\u064A (\u0623\u0648 \u0637\u0644\u0628 \u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u0641\u062D\u0635):");if(t!==null)try{const i=AppState.currentUser||{},s=i.name||i.fullName||i.userName||"\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645",n=new Date().toISOString(),l=(this.getInspections()||[]).find(r=>r.id===e);l&&(l.approvalStatus="rejected",l.rejectedBy=s,l.rejectedAt=n,l.reviewNotes=t||"\u0645\u0631\u0641\u0648\u0636 - \u064A\u0644\u0632\u0645 \u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u0641\u062D\u0635"),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),document.querySelectorAll(".modal-overlay.fire-modal").forEach(r=>r.remove()),await this.refreshCurrentTab(!0),typeof Notification<"u"&&Notification.success("\u2705 \u062A\u0645 \u062A\u0648\u062B\u064A\u0642 \u0631\u0641\u0636 \u0627\u0644\u0641\u062D\u0635 \u0627\u0644\u0645\u064A\u062F\u0627\u0646\u064A \u0641\u0648\u0631\u0627\u064B"),typeof GoogleIntegration<"u"&&AppState.googleConfig?.appsScript?.enabled&&GoogleIntegration.sendRequest({action:"rejectFireEquipmentInspection",data:{inspectionId:e,approverData:{name:s,id:i.id||i.userId||"",role:i.role||"admin"},reason:t||"\u0645\u0631\u0641\u0648\u0636 - \u064A\u0644\u0632\u0645 \u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u0641\u062D\u0635"}}).then(r=>{Utils.safeLog("\u2705 Backend inspection rejection sync complete:",r)}).catch(r=>{Utils.safeWarn("\u26A0\uFE0F Background rejection sync notice (saved locally):",r)})}catch(i){Utils.safeError("Error in rejectInspection:",i),typeof Notification<"u"&&Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+i.message)}},async loadAssetsFromBackend(){try{if(!GoogleIntegration||!AppState.googleConfig?.appsScript?.enabled){Utils.safeWarn("\u26A0\uFE0F Backend \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629");return}this.ensureData(),Utils.safeLog("\u{1F504} \u062A\u062D\u0645\u064A\u0644 \u0623\u062C\u0647\u0632\u0629 \u0627\u0644\u062D\u0631\u064A\u0642 \u0645\u0646 Backend...");const e=await GoogleIntegration.sendRequest({action:"getAllFireEquipmentAssets",data:{}});if(e&&e.success&&Array.isArray(e.data)){const a=AppState.appData.fireEquipmentAssets||[],t=e.data,i=new Map;a.forEach(s=>{s.id&&i.set(s.id,s)}),t.forEach(s=>{s.id&&i.set(s.id,s)}),AppState.appData.fireEquipmentAssets=Array.from(i.values()),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0648\u062F\u0645\u062C ${e.data.length} \u062C\u0647\u0627\u0632 \u0645\u0646 Backend (\u0625\u062C\u0645\u0627\u0644\u064A: ${AppState.appData.fireEquipmentAssets.length})`)}else Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0646 Backend:",e?.message)}catch(e){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0646 Backend:",e)}},ensureData(){typeof AppState>"u"&&(AppState={}),AppState.appData||(AppState.appData={});const e=AppState.appData;let a=!1;if(Array.isArray(e.fireEquipmentAssets)||(e.fireEquipmentAssets=[]),Array.isArray(e.fireEquipmentInspections)||(e.fireEquipmentInspections=[]),Array.isArray(e.fireEquipment)&&e.fireEquipment.length>0){const t=e.fireEquipment.filter(i=>i.assetId&&(i.checkDate||i.createdAt));t.length>0&&(t.forEach(i=>{e.fireEquipmentInspections.some(n=>n.id===i.id)||e.fireEquipmentInspections.push({id:i.id||Utils.generateId("FEI"),assetId:i.assetId,checkDate:i.checkDate||i.createdAt,inspector:i.inspector||"",status:i.status||"\u0635\u0627\u0644\u062D",gaugeReading:i.gaugeReading||"",sealIntact:typeof i.sealIntact=="boolean"?i.sealIntact:null,remarks:i.remarks||i.notes||"",actions:i.actions||"",createdAt:i.createdAt||new Date().toISOString(),updatedAt:i.updatedAt||new Date().toISOString()})}),a=!0)}if(Array.isArray(e.fireEquipment)&&e.fireEquipment.length>0){const t=new Map,i=new Map;e.fireEquipmentAssets.forEach(r=>{r.id&&t.set(r.id,r),r.number&&t.set(r.number.toLowerCase(),r)}),e.fireEquipmentInspections.forEach(r=>{r.id&&i.set(r.id,r)});const s=new Map,n=new Map,o={\u0635\u0627\u0644\u062D:"\u0635\u0627\u0644\u062D","\u064A\u062D\u062A\u0627\u062C \u0625\u0635\u0644\u0627\u062D":"\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629",\u0645\u0639\u0637\u0644:"\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"};e.fireEquipment.forEach(r=>{const c=String(r.equipmentNumber||r.number||"").trim(),f=c.toLowerCase();let d=f?s.get(f):null;!d&&f&&(d=t.get(f));let p=r.assetId?String(r.assetId):null;if(p&&p.startsWith("FEA_")){const v=t.get(p);v&&v.id.match(/^EFA-\d{4}$/)?p=v.id:p=null}if(!d&&p&&(d=t.get(p)),d)r.equipmentType&&(d.type=r.equipmentType),r.location&&(d.location=r.location),r.manufacturer&&(d.manufacturer=r.manufacturer),r.model&&(d.model=r.model),r.capacity&&(d.capacity=r.capacity),r.installationDate&&(d.installationDate=r.installationDate),(r.checkDate||r.lastServiceDate)&&(d.lastServiceDate=r.checkDate||r.lastServiceDate),r.status&&(d.status=o[r.status]||r.status),r.inspector&&(d.responsible=r.inspector),r.notes&&(d.notes=r.notes),r.updatedAt&&(d.updatedAt=r.updatedAt),n.set(d.id,d);else{const v=p&&p.match(/^EFA-\d{4}$/)?p:this.generateFireDeviceID(),x=this.generateQrData(v),w=o[r.status]||r.status||"\u0635\u0627\u0644\u062D";d={id:v,number:c||v,type:r.equipmentType||"",location:r.location||"",manufacturer:r.manufacturer||"",model:r.model||"",capacity:r.capacity||"",installationDate:r.installationDate||"",lastServiceDate:r.checkDate||r.lastServiceDate||"",status:w,responsible:r.inspector||"",notes:r.notes||"",qrCodeData:x,createdAt:r.createdAt||new Date().toISOString(),updatedAt:r.updatedAt||new Date().toISOString()},f&&s.set(f,d),n.set(d.id,d)}const u=r.id?String(r.id):Utils.generateId("FEI"),g=u.startsWith("FEI")?u:u.replace(/^FIRE_EQUIP/,"FEI"),S=r.checkDate||r.createdAt||new Date().toISOString(),A=o[r.status]||r.status||"\u0635\u0627\u0644\u062D";let m=i.get(g);m?(r.checkDate&&(m.checkDate=r.checkDate),r.inspector&&(m.inspector=r.inspector),r.status&&(m.status=o[r.status]||r.status),r.gaugeReading!==void 0&&(m.gaugeReading=r.gaugeReading),typeof r.sealIntact=="boolean"&&(m.sealIntact=r.sealIntact),r.notes&&(m.remarks=r.notes),r.actions&&(m.actions=r.actions),r.updatedAt&&(m.updatedAt=r.updatedAt)):(m={id:g,assetId:d.id,checkDate:S,inspector:r.inspector||d.responsible||"",status:A,gaugeReading:r.gaugeReading||"",sealIntact:typeof r.sealIntact=="boolean"?r.sealIntact:null,remarks:r.notes||"",actions:r.actions||"",createdAt:r.createdAt||S,updatedAt:r.updatedAt||S},e.fireEquipmentInspections.push(m))});const l=[...e.fireEquipmentAssets];n.forEach((r,c)=>{const f=l.findIndex(d=>d.id===c);f>=0?l[f]=r:l.push(r)}),e.fireEquipmentAssets=l,e.fireEquipment=[],a=!0}return a},getAssets(){return Array.isArray(AppState.appData.fireEquipmentAssets)?AppState.appData.fireEquipmentAssets:[]},getRegisterStatistics(){const e=this.getAssets();return{total:e.length,operational:e.filter(a=>a.status==="\u0635\u0627\u0644\u062D").length,needsMaintenance:e.filter(a=>a.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629").length,outOfService:e.filter(a=>a.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length}},getInspections(){const e=Array.isArray(AppState.appData.fireEquipmentInspections)?AppState.appData.fireEquipmentInspections:[];return e.length===0&&Array.isArray(AppState.appData.fireEquipment)&&AppState.appData.fireEquipment.length>0?(AppState.appData.fireEquipmentInspections=AppState.appData.fireEquipment,AppState.appData.fireEquipment):e},async renderAssets(){this.refreshFilterOptions(),this.renderSummary();const e=this.getFilteredAssets(),a=document.getElementById("fire-assets-table");a&&(a.innerHTML=this.renderAssetsTable(e),this.bindTableEvents(a));const t=document.getElementById("fire-recent-inspections");t&&(t.innerHTML=this.renderRecentInspections())},refreshFilterOptions(){const e=this.getAssets(),a=document.getElementById("fire-assets-type"),t=document.getElementById("fire-assets-status"),i=document.getElementById("fire-assets-location");if(a){const s=this.state.filters.type,n=Array.from(new Set(e.map(o=>o.type).filter(Boolean)));a.innerHTML=['<option value="all">\u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0646\u0648\u0627\u0639</option>',...n.map(o=>`<option value="${Utils.escapeHTML(o)}">${Utils.escapeHTML(o)} (${e.filter(l=>l.type===o).length})</option>`)].join(""),a.value=n.includes(s)?s:"all",this.state.filters.type=a.value}if(t){const s=this.state.filters.status;t.innerHTML=['<option value="all">\u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0627\u0644\u0627\u062A</option>',...this.statusOptions.map(n=>`<option value="${n.value}">${n.label} (${e.filter(o=>o.status===n.value).length})</option>`)].join(""),t.value=this.statusOptions.some(n=>n.value===s)?s:"all",this.state.filters.status=t.value}if(i){const s=this.state.filters.location,n=Array.from(new Set(e.map(o=>o.location).filter(Boolean)));i.innerHTML=['<option value="all">\u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0648\u0627\u0642\u0639</option>',...n.map(o=>`<option value="${Utils.escapeHTML(o)}">${Utils.escapeHTML(o)} (${e.filter(l=>l.location===o).length})</option>`)].join(""),i.value=n.includes(s)?s:"all",this.state.filters.location=i.value}},renderSummary(){const e=this.getAssets(),a=this.getFilteredAssets(),t=this.getAssetStatsForList(a),i=Math.max(a.length,1),s=(u,g)=>{const S=document.getElementById(u);S&&S.style.setProperty("--fs-pct",`${Math.round((Number(g)||0)/i*100)}%`)},n=document.getElementById("fire-summary-total"),o=document.getElementById("fire-summary-active"),l=document.getElementById("fire-summary-maintenance"),r=document.getElementById("fire-summary-out");n&&(n.textContent=a.length),o&&(o.textContent=t.active),l&&(l.textContent=t.needsMaintenance),r&&(r.textContent=t.outOfService),s("fire-bar-total",a.length),s("fire-bar-active",t.active),s("fire-bar-maintenance",t.needsMaintenance),s("fire-bar-out",t.outOfService);const c=!!(this.state.filters.search||this.state.filters.type!=="all"||this.state.filters.status!=="all"||this.state.filters.location!=="all"),f=document.getElementById("fire-results-text");f&&(f.textContent=c?`${a.length} \u0645\u0646 \u0623\u0635\u0644 ${e.length} \u062C\u0647\u0627\u0632`:`\u0639\u0631\u0636 ${a.length} \u062C\u0647\u0627\u0632`);const d=document.getElementById("fire-results-chip");d&&d.classList.toggle("is-filtered",c);const p=document.getElementById("fire-clear-filters");p&&p.classList.toggle("visible",c),document.querySelectorAll("#fire-status-chips .fire-chip").forEach(u=>{u.classList.toggle("active",u.dataset.status===(this.state.filters.status||"all"))})},getAssetStatsForList(e){e=e||[];const a=e.length,t=e.filter(n=>n.status==="\u0635\u0627\u0644\u062D").length,i=e.filter(n=>n.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629").length,s=e.filter(n=>n.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length;return{total:a,active:t,needsMaintenance:i,outOfService:s}},renderAssetsTable(e){return e.length?`
            <div class="table-wrapper fire-assets-table-wrapper" style="width: 100%; max-width: 100%; overflow-x: auto; overflow-y: auto; max-height: 70vh; position: relative;">
                <table class="data-table table-header-red" style="width: 100%; min-width: 100%; table-layout: auto;">
                    ...
                    <tbody>${e.map(t=>{const i=this.getLatestInspection(t.id),s=i?Utils.formatDate(i.checkDate):"-",n=this.getStatusBadge(t.status);return`
                <tr>
                    <td>
        ...
        `:'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0639\u062F\u0627\u062A \u0645\u0633\u062C\u0644\u0629 \u0628\u0639\u062F\u060C \u0642\u0645 \u0628\u0625\u0636\u0627\u0641\u0629 \u062C\u0647\u0627\u0632 \u062C\u062F\u064A\u062F \u0644\u0628\u062F\u0621 \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629.</p></div>'},renderRecentInspections(){const e=this.getInspections().slice().sort((t,i)=>new Date(i.checkDate||i.createdAt||0)-new Date(t.checkDate||t.createdAt||0)).slice(0,6);return e.length?`<div class="divide-y divide-gray-100">${e.map(t=>{const i=this.getAssets().find(n=>n.id===t.assetId),s=i?i.number:t.assetId;return`
        ...
        `,document.body.appendChild(e);const a=e.querySelector("#qr-video"),t=e.querySelector("#qr-canvas"),i=t.getContext("2d");let s=null,n=null;const o=e.querySelector("#manual-submit-btn"),l=e.querySelector("#manual-device-id"),r=e.querySelector(".qr-scan-status");o.addEventListener("click",async()=>{const c=l.value.trim();if(!c){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 DeviceID");return}this.stopQRScan(),e.remove(),await this.processScannedDeviceId(c)}),l.addEventListener("keypress",async c=>{c.key==="Enter"&&o.click()});try{const c={video:{facingMode:{ideal:"environment"},width:{ideal:1280},height:{ideal:720}}};s=await navigator.mediaDevices.getUserMedia(c),a.srcObject=s,r&&(r.innerHTML='<i class="fas fa-camera ml-2"></i>\u062C\u0627\u0631\u064A \u0627\u0644\u0645\u0633\u062D...',r.style.background="rgba(34, 197, 94, 0.8)"),a.addEventListener("loadedmetadata",()=>{t.width=a.videoWidth,t.height=a.videoHeight}),n=setInterval(()=>{if(a.readyState===a.HAVE_ENOUGH_DATA){i.drawImage(a,0,0,t.width,t.height);const f=i.getImageData(0,0,t.width,t.height);if(typeof jsQR<"u"){const d=jsQR(f.data,f.width,f.height,{inversionAttempts:"dontInvert"});if(d&&d.data){const p=d.data.trim();r&&(r.innerHTML='<i class="fas fa-check-circle ml-2"></i>\u062A\u0645 \u0627\u0644\u0645\u0633\u062D!',r.style.background="rgba(34, 197, 94, 0.9)"),this.stopQRScan(),setTimeout(()=>e.remove(),300),this.processScannedDeviceId(p)}}}},100)}catch(c){const f=c?.message||c?.toString()||"",d=f.includes("Permissions policy")||f.includes("Permission policy")||f.includes("[Violation]")||f.includes("not allowed in this document");d||Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0627\u0644\u0643\u0627\u0645\u064A\u0631\u0627:",c),r&&(r.innerHTML='<i class="fas fa-exclamation-triangle ml-2"></i>\u0641\u0634\u0644 \u0627\u0644\u0648\u0635\u0648\u0644 \u0644\u0644\u0643\u0627\u0645\u064A\u0631\u0627',r.style.background="rgba(239, 68, 68, 0.8)"),d?Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0627\u0644\u0643\u0627\u0645\u064A\u0631\u0627 \u0641\u064A \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0645\u062A\u0635\u0641\u062D \u0623\u0648 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0625\u062F\u062E\u0627\u0644 \u0627\u0644\u064A\u062F\u0648\u064A."):Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0627\u0644\u0643\u0627\u0645\u064A\u0631\u0627. \u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0627\u0644\u0643\u0627\u0645\u064A\u0631\u0627 \u0623\u0648 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0625\u062F\u062E\u0627\u0644 \u0627\u0644\u064A\u062F\u0648\u064A.")}e.dataset.stream="active",window._fireEquipmentStream=s,window._fireEquipmentScanInterval=n},stopQRScan(){window._fireEquipmentStream&&(window._fireEquipmentStream.getTracks().forEach(e=>e.stop()),window._fireEquipmentStream=null),window._fireEquipmentScanInterval&&(clearInterval(window._fireEquipmentScanInterval),window._fireEquipmentScanInterval=null)},async processScannedDeviceId(e){if(!e){Notification.error("DeviceID \u063A\u064A\u0631 \u0635\u062D\u064A\u062D");return}Loading.show();try{const a=await this.getDeviceDataFromRegister(e);if(!a){Notification.error(`\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u062C\u0647\u0627\u0632 \u0628\u0631\u0642\u0645: ${e}`),Loading.hide();return}await this.showDeviceDataFromQR(a)}catch(a){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062C\u0644\u0628 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062C\u0647\u0627\u0632: "+a.message)}finally{Loading.hide()}},getDeviceDataFromRegister(e){const a=this.getAssets().find(i=>i.id===e);if(!a)return null;const t=this.getLatestInspection(e);return{deviceId:a.id,deviceNumber:a.number||a.id,deviceType:a.type||"",location:a.location||"",capacity:a.capacity||"",lastInspectionDate:t?t.checkDate:null,lastInspector:t?t.inspector:"",deviceStatus:a.status||"",manufacturer:a.manufacturer||"",model:a.model||"",installationDate:a.installationDate||""}},async showDeviceDataFromQR(e){const a=this.checkMonthlyInspectionAllowed(e.deviceId);if(!a.allowed){Notification.warning(a.reason||"\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A \u0647\u0630\u0627 \u0627\u0644\u0648\u0642\u062A");return}const t=AppState.currentUser,i=t&&(t.role==="admin"||t.role==="\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"||t.role==="system_admin"||typeof Permissions<"u"&&Permissions.isCurrentUserAdmin&&Permissions.isCurrentUserAdmin()),s=t&&(t.role==="safety_officer"||t.role==="\u0645\u0633\u0626\u0648\u0644 \u0627\u0644\u0633\u0644\u0627\u0645\u0629"),n=typeof Permissions<"u"&&Permissions.hasDetailedPermission&&Permissions.hasDetailedPermission("fire-equipment","inspections");if(!i&&!(s&&n)&&!(typeof Permissions<"u"&&Permissions.hasAccess&&Permissions.hasAccess("fire-equipment"))){Notification.error("\u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u064A\u062A\u0637\u0644\u0628 \u0635\u0644\u0627\u062D\u064A\u0629 \u0641\u062D\u0635 \u0645\u0639\u062F\u0627\u062A \u0627\u0644\u0625\u0637\u0641\u0627\u0621. \u064A\u0631\u062C\u0649 \u0627\u0644\u062A\u0648\u0627\u0635\u0644 \u0645\u0639 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645.");return}this.showMobileInspectionForm(null,e.deviceId)},async initiateMonthlyInspection(e){const a=this.checkMonthlyInspectionAllowed(e);if(!a.allowed){Notification.warning(a.reason||"\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A \u0647\u0630\u0627 \u0627\u0644\u0648\u0642\u062A");return}if(!await this.requestAdminApproval(e)){Notification.info("\u062A\u0645 \u0625\u0644\u063A\u0627\u0621 \u0627\u0644\u0639\u0645\u0644\u064A\u0629 - \u0645\u0637\u0644\u0648\u0628 \u0645\u0648\u0627\u0641\u0642\u0629 \u0627\u0644\u0645\u062F\u064A\u0631");return}this.showInspectionForm(null,e)},checkMonthlyInspectionAllowed(e){const a=new Date,t=a.getMonth(),i=a.getFullYear(),s=this.getInspections().filter(n=>{if(n.assetId!==e)return!1;const o=new Date(n.checkDate||n.createdAt);return o.getMonth()===t&&o.getFullYear()===i});if(s.length>0){const n=s[0];return{allowed:!1,reason:`\u062A\u0645 \u0641\u062D\u0635 \u0647\u0630\u0627 \u0627\u0644\u062C\u0647\u0627\u0632 \u0628\u0627\u0644\u0641\u0639\u0644 \u0641\u064A \u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631 (${Utils.formatDate(n.checkDate||n.createdAt)}). \u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u062C\u0631\u0627\u0621 \u0641\u062D\u0635 \u0622\u062E\u0631 \u0641\u064A \u0646\u0641\u0633 \u0627\u0644\u0634\u0647\u0631.`}}return{allowed:!0,reason:""}},async requestAdminApproval(e){return new Promise(async a=>{const t=AppState.currentUser;if(t&&(t.role==="admin"||t.role==="\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"||typeof Permissions<"u"&&Permissions.isCurrentUserAdmin&&Permissions.isCurrentUserAdmin())){a(!0);return}try{const s=this.getAssets().find(r=>r.id===e),n=s?s.number||s.id:e,o=s&&s.location||"",l=await this.createInspectionApprovalRequest(e,n,o);l&&(Notification.info("\u062A\u0645 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629. \u0633\u064A\u062A\u0645 \u0625\u0634\u0639\u0627\u0631 \u0627\u0644\u0645\u062F\u064A\u0631 \u0644\u0644\u0645\u0631\u0627\u062C\u0639\u0629."),typeof AppUI<"u"&&AppUI.updateNotificationsBadge&&AppUI.updateNotificationsBadge(),typeof RealtimeSyncManager<"u"&&RealtimeSyncManager.notifyChange&&RealtimeSyncManager.notifyChange("fireEquipmentApprovalRequests","add",l.id)),a(!1)}catch(s){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0646\u0634\u0627\u0621 \u0637\u0644\u0628 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629:",s),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629"),a(!1)}})},async createInspectionApprovalRequest(e,a,t){const i=AppState.currentUser;if(!i)throw new Error("\u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u063A\u064A\u0631 \u0645\u0633\u062C\u0644 \u062F\u062E\u0648\u0644");const s=Utils.generateId("FEAR"),n=new Date().toISOString(),o={id:s,type:"inspection",assetId:e,assetNumber:a,assetLocation:t,requestedBy:i.name||i.email||"\u0645\u0633\u062A\u062E\u062F\u0645 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F",requestedById:i.id||i.email||"",userEmail:i.email||"",requestedAt:n,status:"pending",comments:`\u0637\u0644\u0628 \u0645\u0648\u0627\u0641\u0642\u0629 \u0644\u0625\u062C\u0631\u0627\u0621 \u0641\u062D\u0635 \u0634\u0647\u0631\u064A \u0639\u0644\u0649 \u0627\u0644\u062C\u0647\u0627\u0632: ${a}${t?` - ${t}`:""}`,createdAt:n,updatedAt:n};return AppState.appData||(AppState.appData={}),AppState.appData.fireEquipmentApprovalRequests||(AppState.appData.fireEquipmentApprovalRequests=[]),AppState.appData.fireEquipmentApprovalRequests.push(o),typeof DataManager<"u"&&DataManager.save?DataManager.save():localStorage.setItem("fire_equipment_approval_requests",JSON.stringify(AppState.appData.fireEquipmentApprovalRequests)),typeof AppUI<"u"&&AppUI.updateNotificationsBadge&&AppUI.updateNotificationsBadge(),(async()=>{try{if(GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled){const l=await GoogleIntegration.sendRequest({action:"addFireEquipmentApprovalRequest",data:o});l.success?(Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0637\u0644\u0628 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0641\u064A Backend:",s),await this.loadApprovalRequestsFromBackend(),typeof AppUI<"u"&&AppUI.updateNotificationsBadge&&AppUI.updateNotificationsBadge()):Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0637\u0644\u0628 \u0641\u064A Backend:",l.message)}}catch(l){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0627\u0644\u0637\u0644\u0628 \u0641\u064A Backend:",l)}})(),this.notifyAdminsAboutApprovalRequest(o).catch(l=>{Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0625\u0634\u0639\u0627\u0631\u0627\u062A \u0644\u0644\u0645\u062F\u064A\u0631\u064A\u0646:",l)}),o},async notifyAdminsAboutApprovalRequest(e){try{const a=[];if(AppState.appData&&AppState.appData.users&&a.push(...AppState.appData.users.filter(t=>t.role==="admin"||t.role==="\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"||typeof Permissions<"u"&&Permissions.isUserAdmin&&Permissions.isUserAdmin(t))),a.length===0)GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled&&await GoogleIntegration.sendRequest({action:"addNotification",data:{userId:"admin",title:"\u0637\u0644\u0628 \u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0641\u062D\u0635 \u0645\u0639\u062F\u0627\u062A \u0627\u0644\u0625\u0637\u0641\u0627\u0621",message:`\u0637\u0644\u0628 ${e.requestedBy} \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0641\u062D\u0635 \u0627\u0644\u062C\u0647\u0627\u0632: ${e.assetNumber}${e.assetLocation?` - ${e.assetLocation}`:""}`,type:"approval_request",priority:"high",link:"#fire-equipment-approval-requests",data:{module:"fire-equipment",action:"inspection_approval",requestId:e.id}}}).catch(t=>{Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0627\u0644\u0625\u0634\u0639\u0627\u0631:",t)});else for(const t of a)if(t.id||t.email)try{GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled&&await GoogleIntegration.sendRequest({action:"addNotification",data:{userId:t.id||t.email,title:"\u0637\u0644\u0628 \u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0641\u062D\u0635 \u0645\u0639\u062F\u0627\u062A \u0627\u0644\u0625\u0637\u0641\u0627\u0621",message:`\u0637\u0644\u0628 ${e.requestedBy} \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0641\u062D\u0635 \u0627\u0644\u062C\u0647\u0627\u0632: ${e.assetNumber}${e.assetLocation?` - ${e.assetLocation}`:""}`,type:"approval_request",priority:"high",link:"#fire-equipment-approval-requests",data:{module:"fire-equipment",action:"inspection_approval",requestId:e.id}}}).catch(i=>{Utils.safeWarn(`\u26A0\uFE0F \u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0627\u0644\u0625\u0634\u0639\u0627\u0631 \u0644\u0644\u0645\u062F\u064A\u0631 ${t.name||t.email}:`,i)})}catch(i){Utils.safeWarn(`\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0627\u0644\u0625\u0634\u0639\u0627\u0631 \u0644\u0644\u0645\u062F\u064A\u0631 ${t.name||t.email}:`,i)}Utils.safeLog("\u2705 \u062A\u0645 \u0625\u0631\u0633\u0627\u0644 \u0625\u0634\u0639\u0627\u0631\u0627\u062A \u0644\u0644\u0645\u062F\u064A\u0631\u064A\u0646 \u0628\u062E\u0635\u0648\u0635 \u0637\u0644\u0628 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629:",e.id)}catch(a){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0625\u0634\u0639\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629:",a)}},showInspectionForm(e=null,a=null){if(!a&&!e?.assetId){Notification.warning("\u064A\u062C\u0628 \u0645\u0633\u062D QR Code \u0623\u0648\u0644\u0627\u064B \u0644\u0628\u062F\u0621 \u0627\u0644\u0641\u062D\u0635 \u0627\u0644\u0634\u0647\u0631\u064A");return}const t=!!e,i=e?.id||Utils.generateId("FEI"),s=e?.assetId||a,n=this.getAssets().find(f=>f.id===s);if(!n){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062C\u0647\u0627\u0632");return}const o=e?.checkDate?new Date(e.checkDate).toISOString().slice(0,10):new Date().toISOString().slice(0,10),l=document.createElement("div");l.className="modal-overlay fire-modal",l.innerHTML=`
        ...
        `,document.body.appendChild(n),typeof EmailDispatch<"u"&&EmailDispatch.bindFooterButtons(n,{moduleKey:"fire-equipment",record:a,recordId:a.id||a.number||a.isoCode||""}),n.addEventListener("click",l=>{l.target===n&&n.remove()});const o=n.querySelector(".modal-content");o&&o.addEventListener("click",l=>{l.stopPropagation()})},getInspectionsByAsset(e){return this.getInspections().filter(a=>a.assetId===e).sort((a,t)=>new Date(t.checkDate||t.createdAt||0)-new Date(a.checkDate||a.createdAt||0))},getLatestInspection(e){const a=this.getInspectionsByAsset(e);return a.length?a[0]:null},getAssetStats(){const e=this.getAssets(),a=e.length,t=e.filter(n=>n.status==="\u0635\u0627\u0644\u062D").length,i=e.filter(n=>n.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629").length,s=e.filter(n=>n.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length;return{total:a,active:t,needsMaintenance:i,outOfService:s}},generateQrData(e){return String(e||"").trim()},async persistAll(){if(typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),AppState.googleConfig?.appsScript?.enabled)try{Utils.safeLog("\u{1F504} \u0628\u062F\u0621 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0639\u062F\u0627\u062A \u0627\u0644\u062D\u0631\u064A\u0642...");const e=AppState.appData.fireEquipmentAssets||[];if(e.length>0){Utils.safeLog(`\u{1F4E6} \u062D\u0641\u0638 ${e.length} \u062C\u0647\u0627\u0632...`);const t=e.map(async o=>{try{return await GoogleIntegration.sendRequest({action:"saveOrUpdateFireEquipmentAsset",data:o}),{success:!0,id:o.id}}catch(l){return Utils.safeWarn(`\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u062C\u0647\u0627\u0632 ${o.id}:`,l),{success:!1,id:o.id,error:l}}}),i=await Promise.allSettled(t),s=i.filter(o=>o.status==="fulfilled"&&o.value.success).length,n=i.filter(o=>o.status==="rejected"||o.status==="fulfilled"&&!o.value.success).length;Utils.safeLog(`\u2705 \u062A\u0645 \u062D\u0641\u0638 ${s} \u062C\u0647\u0627\u0632\u060C \u0641\u0634\u0644 ${n}`)}const a=AppState.appData.fireEquipmentInspections||[];a.length>0&&(Utils.safeLog(`\u{1F4CB} \u062D\u0641\u0638 ${a.length} \u0641\u062D\u0635...`),await GoogleIntegration.sendRequest({action:"saveToSheet",data:{sheetName:"FireEquipmentInspections",data:a}})),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u062C\u0645\u064A\u0639 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}catch(e){if(Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0639\u062F\u0627\u062A \u0627\u0644\u062D\u0631\u064A\u0642 \u0641\u064A Google Sheets:",e),typeof GoogleIntegration<"u"&&GoogleIntegration.autoSave)try{const a=AppState.appData.fireEquipmentAssets.map(i=>({...i})),t=AppState.appData.fireEquipmentInspections.map(i=>({...i}));await Promise.allSettled([GoogleIntegration.autoSave("FireEquipmentAssets",a),GoogleIntegration.autoSave("FireEquipmentInspections",t)])}catch(a){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u062D\u062A\u0649 \u0628\u0627\u0633\u062A\u062E\u062F\u0627\u0645 autoSave:",a)}}else if(typeof GoogleIntegration<"u"&&GoogleIntegration.autoSave)try{const e=AppState.appData.fireEquipmentAssets.map(t=>({...t})),a=AppState.appData.fireEquipmentInspections.map(t=>({...t}));await Promise.allSettled([GoogleIntegration.autoSave("FireEquipmentAssets",e),GoogleIntegration.autoSave("FireEquipmentInspections",a)])}catch(e){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0639\u062F\u0627\u062A \u0627\u0644\u062D\u0631\u064A\u0642 \u0641\u064A Google Sheets",e)}},getPublicInspectionUrl(e="",a=""){try{const t=window.location,i=t.pathname.split("/");i.pop();const s=i.join("/");let o=`${t.origin||t.protocol+"//"+t.host}${s}/public-fire-inspection.html`.replace(/([^:]\/)\/+/g,"$1"),l=[];return e&&l.push(`id=${encodeURIComponent(e)}`),a&&l.push(`inspector=${encodeURIComponent(a)}`),l.length>0&&(o+=`?${l.join("&")}`),o}catch{return`public-fire-inspection.html${e?`?id=${encodeURIComponent(e)}`:""}`}},getSafetyMembersList(){const e=c=>{if(!c)return!1;if(c.isActive===!1||c.active===!1||c.isActive==="false"||c.active==="false")return!0;const f=String(c.status||c.employeeStatus||c.workStatus||c.employmentStatus||"").trim().toLowerCase();return f?f.includes("\u0645\u0633\u062A\u0642\u064A\u0644")||f.includes("\u0627\u0633\u062A\u0642\u0627\u0644")||f.includes("\u0645\u0646\u062A\u0647\u064A")||f.includes("\u0641\u0635\u0644")||f.includes("\u062A\u0631\u0643")||f.includes("resign")||f.includes("terminated")||f.includes("inactive")||f.includes("left"):!1},a=c=>!c||c.length<3||/[a-zA-Z]/.test(c)?!1:/[\u0600-\u06FF]/.test(c),t=c=>String(c||"").trim().toLowerCase().replace(/^(م\/|أ\/|د\/|مهندس\/|أستاذ\/|دكتور\/|mr\.|eng\.)\s*/i,"").replace(/[أإآ]/g,"\u0627").replace(/ة/g,"\u0647").replace(/ى/g,"\u064A").replace(/\s+/g," "),i=new Set,s=[],n=c=>{const f=String(c||"").trim();if(!a(f))return;const d=f.toLowerCase();if(d.includes("admin")||d.includes("support")||d.includes("system")||d.includes("tool")||d.includes("\u0645\u062C\u0647\u0648\u0644")||d.includes("\u0639\u0627\u0645\u0629"))return;const p=t(f);!p||i.has(p)||(i.add(p),s.push({name:f}))};(AppState.appData?.employees||[]).forEach(c=>{if(e(c))return;const f=c.name||c.employeeName||"",d=String(c.department||"").toLowerCase(),p=String(c.job||c.jobTitle||c.position||"").toLowerCase();if(p.includes("\u063A\u0630\u0627\u0621")||p.includes("food")||d.includes("\u062C\u0648\u062F\u0629")||d.includes("\u062A\u0635\u0646\u064A\u0639"))return;const u=d.includes("\u0633\u0644\u0627\u0645\u0629")||d.includes("hse")||d.includes("\u0635\u062D\u0629 \u0645\u0647\u0646\u064A\u0629"),g=p.includes("\u0633\u0644\u0627\u0645\u0629 \u0648\u0635\u062D\u0629")||p.includes("\u0633\u0644\u0627\u0645\u0647 \u0648\u0635\u062D\u0629")||p.includes("\u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0648\u0627\u0644\u0635\u062D\u0629")||p.includes("\u0633\u0644\u0627\u0645\u0629 \u0645\u0647\u0646\u064A\u0629")||p.includes("\u0623\u062E\u0635\u0627\u0626\u064A \u0633\u0644\u0627\u0645\u0629")||p.includes("\u0627\u062E\u0635\u0627\u0626\u0649 \u0633\u0644\u0627\u0645\u0647")||p.includes("\u0641\u0646\u064A \u0633\u0644\u0627\u0645\u0629")||p.includes("\u0641\u0646\u0649 \u0633\u0644\u0627\u0645\u0629")||p.includes("\u0645\u0634\u0631\u0641 \u0633\u0644\u0627\u0645\u0629")||p.includes("\u0645\u062F\u064A\u0631 \u0627\u0644\u0633\u0644\u0627\u0645\u0629")||p.includes("\u0645\u0641\u062A\u0634 \u0633\u0644\u0627\u0645\u0629")||p.includes("\u0645\u0633\u0624\u0648\u0644 \u0633\u0644\u0627\u0645\u0629")||p.includes("\u0625\u0637\u0641\u0627\u0621")||p.includes("\u062D\u0631\u064A\u0642")||p.includes("hse officer")||p.includes("hse specialist")||p.includes("hse manager");f&&u&&g&&n(f)});const l=AppState.companySettings||{},r=l.safetyTeam||l.safetyTeamMembers||l.hseTeam;return Array.isArray(r)?r.forEach(c=>n(typeof c=="string"?c:c.name)):typeof r=="string"&&r.split(/[\n,]/).forEach(c=>n(c)),s.sort((c,f)=>c.name.localeCompare(f.name,"ar")),s},showPublicLinkModal(){const e=this.getPublicInspectionUrl(),a=this.getAssets()||[],t=this.getSafetyMembersList(),i=document.createElement("div");i.className="modal-overlay fire-modal",i.innerHTML=`
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 18px;">
                        ...
                        <div>
                            ...
                            <select id="qr-fire-inspector-select" class="form-select" style="width: 100%; padding: 10px 12px; border-radius: 8px; border: 1.5px solid #cbd5e1; font-size: 0.88rem;">
                                ...
                                ${t.map(p=>`<option value="${Utils.escapeHTML(p.name)}">${Utils.escapeHTML(p.name)}</option>`).join("")}
                            </select>
                        </div>
                    </div>
        ...
        `,document.body.appendChild(i);const s=i.querySelector("#batch-location-filter"),n=i.querySelector("#batch-type-filter"),o=i.querySelector("#batch-layout-select"),l=i.querySelector("#batch-selected-preview"),r=i.querySelector("#start-batch-print-btn"),c=()=>{const d=s.value,p=n.value;return e.filter(u=>!(d!=="all"&&u.location!==d||p!=="all"&&(u.type||u.equipmentType)!==p))},f=()=>{const d=c();l.textContent=`${d.length} \u062C\u0647\u0627\u0632 \u062C\u0627\u0647\u0632 \u0644\u0644\u0637\u0628\u0627\u0639\u0629`,r.disabled=d.length===0};s.addEventListener("change",f),n.addEventListener("change",f),r.addEventListener("click",()=>{const d=c();if(d.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062C\u0647\u0632\u0629 \u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0644\u062A\u0635\u0641\u064A\u0629.");return}i.remove(),this.batchPrintQrCards(d,o.value)})},batchPrintQrCards(e,a="2x4"){if(!e||e.length===0)return;let t=2,i="120px",s=100,n="13px",o="10.5px";a==="3x4"?(t=3,i="110px",s=85,n="11.5px",o="9.5px"):a==="2x3"&&(t=2,i="150px",s=125,n="14px",o="11.5px");const l=window.open("","_blank");if(!l){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0637\u0628\u0627\u0639\u0629 \u0643\u0631\u0648\u062A QR");return}const r=e.map(c=>{const f=String(c.id||"").trim(),d=this.getPublicInspectionUrl(f);let p="";if(typeof qrcode=="function")try{const u=qrcode(0,"M");u.addData(d),u.make(),p=u.createDataURL(4,2)}catch{}if(!p&&window.QRCode&&typeof window.QRCode.generate=="function")try{p=window.QRCode.generate(d,140)}catch{}return p||(p=`https://api.qrserver.com/v1/create-qr-code/?size=140x140&data=${encodeURIComponent(d)}`),`
                <div class="qr-card">
        ...
        `),l.document.close()},printQr(e){const a=this.getAssets().find(n=>n.id===e);if(!a){Notification.error("\u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u062C\u0647\u0627\u0632 \u0627\u0644\u0645\u062D\u062F\u062F.");return}const t=this.getPublicInspectionUrl(a.id);let i="";if(typeof qrcode=="function")try{const n=qrcode(0,"M");n.addData(t),n.make(),i=n.createDataURL(6,4)}catch{}!i&&typeof QRCode<"u"&&(i=QRCode.generate(t,260)),i||(i=`https://api.qrserver.com/v1/create-qr-code/?size=260x260&data=${encodeURIComponent(t)}`);const s=window.open("","_blank");if(!s){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0637\u0628\u0627\u0639\u0629 QR Code");return}s.document.write(`
            <!DOCTYPE html>
        ...
        `,document.body.appendChild(e);const a=e.querySelector("#add-type-btn"),t=e.querySelector("#new-type-input");a.addEventListener("click",()=>{const i=t.value.trim();if(!i){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0646\u0648\u0639 \u0627\u0644\u062C\u0647\u0627\u0632");return}if(this.assetTypes.includes(i)){Notification.warning("\u0647\u0630\u0627 \u0627\u0644\u0646\u0648\u0639 \u0645\u0648\u062C\u0648\u062F \u0628\u0627\u0644\u0641\u0639\u0644");return}this.assetTypes.push(i),t.value="",this.refreshTypesList(e),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0646\u0648\u0639 \u0628\u0646\u062C\u0627\u062D")}),e.addEventListener("click",i=>{if(i.target.closest(".btn-remove-type")){const s=parseInt(i.target.closest(".btn-remove-type").dataset.typeIndex);confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0646\u0648\u0639\u061F")&&(this.assetTypes.splice(s,1),this.refreshTypesList(e),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0646\u0648\u0639 \u0628\u0646\u062C\u0627\u062D"))}})},refreshTypesList(e){const a=e.querySelector("#types-list");a&&(a.innerHTML=this.assetTypes.map((t,i)=>`
        ...
        `,document.body.appendChild(e);const a=e.querySelector("#excel-file-input"),t=e.querySelector("#confirm-import-btn"),i=e.querySelector("#import-preview"),s=e.querySelector("#preview-head"),n=e.querySelector("#preview-body"),o=e.querySelector("#preview-count");let l=[];(()=>{if(typeof XLSX>"u"){const c=document.createElement("script");c.src="https://cdn.jsdelivr.net/npm/xlsx@0.18.5/dist/xlsx.full.min.js",c.onerror=function(){this.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js"},c.onload=()=>{a.addEventListener("change",f=>{this.handleExcelFile(f.target.files[0],e,t,i,s,n,o,d=>{l=d})})},document.head.appendChild(c)}else a.addEventListener("change",c=>{this.handleExcelFile(c.target.files[0],e,t,i,s,n,o,f=>{l=f})})})(),t.addEventListener("click",async()=>{if(l.length===0){Notification.error("\u064A\u0631\u062C\u0649 \u062A\u062D\u0645\u064A\u0644 \u0645\u0644\u0641 Excel \u0623\u0648\u0644\u0627\u064B");return}await this.processImport(l,e)})},async handleExcelFile(e,a,t,i,s,n,o,l){if(e){if(typeof XLSX>"u"){Notification.error("\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629. \u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644\u0647\u0627...");return}Loading.show("\u062C\u0627\u0631\u064A \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641...");try{const r=await e.arrayBuffer(),c=XLSX.read(r,{type:"array"}),f=c.SheetNames[0],d=c.Sheets[f],p=XLSX.utils.sheet_to_json(d);if(p.length===0){Notification.error("\u0627\u0644\u0645\u0644\u0641 \u0641\u0627\u0631\u063A \u0623\u0648 \u0644\u0627 \u064A\u062D\u062A\u0648\u064A \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A"),Loading.hide();return}const g=this.getAssets().map(m=>m.id).filter(m=>m&&m.match(/^EFA-\d{4}$/)).map(m=>parseInt(m.split("-")[1])).filter(m=>!isNaN(m));let S=g.length>0?Math.max(...g)+1:1;const A=p.map(m=>{const x=`EFA-${String(S).padStart(4,"0")}`;return S++,{id:x,location:m["\u0645\u0643\u0627\u0646 / \u0645\u0648\u0642\u0639 \u0627\u0644\u062C\u0647\u0627\u0632"]||m["\u0645\u0643\u0627\u0646 \u0627\u0644\u062C\u0647\u0627\u0632"]||m.\u0627\u0644\u0645\u0648\u0642\u0639||"",subLocation:m["\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A"]||"",type:m["\u0646\u0648\u0639 \u0627\u0644\u062C\u0647\u0627\u0632"]||"",capacity:m["\u0627\u0644\u0633\u0639\u0629 / \u0643\u062C\u0645"]||m.\u0627\u0644\u0633\u0639\u0629||"",capacityKg:m["\u0627\u0644\u0633\u0639\u0629 / \u0643\u062C\u0645"]||m.\u0627\u0644\u0633\u0639\u0629||"",siteNumber:m["\u0631\u0642\u0645 \u0627\u0644\u062C\u0647\u0627\u0632 \u0628\u0627\u0644\u0645\u0648\u0642\u0639"]||m["\u0631\u0642\u0645 \u0627\u0644\u062C\u0647\u0627\u0632"]||"",number:m["\u0631\u0642\u0645 \u0627\u0644\u062C\u0647\u0627\u0632 \u0628\u0627\u0644\u0645\u0648\u0642\u0639"]||m["\u0631\u0642\u0645 \u0627\u0644\u062C\u0647\u0627\u0632"]||"",manufacturer:m["\u0627\u0644\u0634\u0631\u0643\u0629 \u0627\u0644\u0645\u0635\u0646\u0639\u0629"]||"",factory:m.\u0627\u0644\u0645\u0635\u0646\u0639||"",manufacturingYear:m["\u0633\u0646\u0629 \u0627\u0644\u0635\u0646\u0639"]?parseInt(m["\u0633\u0646\u0629 \u0627\u0644\u0635\u0646\u0639"]):null,productionDate:m["\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0627\u0646\u062A\u0627\u062C"]?this.parseDate(m["\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0627\u0646\u062A\u0627\u062C"]):"",serialNumber:m["\u0631\u0642\u0645 \u0645\u0633\u0644\u0633\u0644 \u0627\u0644\u062C\u0647\u0627\u0632"]||m["\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0645\u0633\u0644\u0633\u0644"]||"",status:m["\u062D\u0627\u0644\u0629 \u0627\u0644\u062C\u0647\u0627\u0632"]||"\u0635\u0627\u0644\u062D",installationMethod:m["\u0637\u0631\u064A\u0642\u0629 \u062A\u062B\u0628\u064A\u062A"]||"",notes:m.\u0645\u0644\u0627\u062D\u0638\u0627\u062A||"",qrCodeData:this.generateQrData(x),createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()}}).filter(m=>m.location&&m.type);if(A.length>0){const m=Object.keys(p[0]);s.innerHTML=`<tr>${m.map(v=>`<th>${Utils.escapeHTML(v)}</th>`).join("")}</tr>`,n.innerHTML=p.slice(0,5).map(v=>`<tr>${m.map(x=>`<td>${Utils.escapeHTML(String(v[x]||""))}</td>`).join("")}</tr>`).join(""),o.textContent=`\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0635\u0641\u0648\u0641 \u0627\u0644\u0645\u0631\u0627\u062F \u0627\u0633\u062A\u064A\u0631\u0627\u062F\u0647\u0627: ${A.length}`,i.classList.remove("hidden"),t.disabled=!1,l(A)}else Notification.error("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0635\u062D\u064A\u062D\u0629 \u0644\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F");Loading.hide()}catch(r){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641: "+r.message)}}},async processImport(e,a){if(!e||e.length===0){Notification.error("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0644\u0645\u0639\u0627\u0644\u062C\u0629");return}Loading.show("\u062C\u0627\u0631\u064A \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u062D\u0641\u0638\u0647\u0627 \u0641\u064A \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A...");try{let t=0,i=0;const s=e.length;if(GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled){for(let o=0;o<s;o+=5){const l=e.slice(o,o+5),r=l.map(f=>GoogleIntegration.sendRequest({action:"saveOrUpdateFireEquipmentAsset",data:f}).then(d=>(d.success?t++:i++,d)).catch(d=>(i++,{success:!1,error:d})));await Promise.allSettled(r);const c=Math.min(100,Math.round((o+l.length)/s*100));Loading.show(`\u062C\u0627\u0631\u064A \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A... ${c}% (${t} \u0646\u0627\u062C\u062D)`)}await this.loadAssetsFromBackend()}else{const n=this.getAssets();let o=0,l=0;e.forEach(r=>{const c=n.find(f=>f.id===r.id);c?(Object.assign(c,r),c.updatedAt=new Date().toISOString(),o++):(n.push(r),l++)}),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),t=l+o}if(Loading.hide(),i>0?Notification.warning(`\u062A\u0645 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: ${t} \u0646\u0627\u062C\u062D\u060C ${i} \u0641\u0634\u0644.`):Notification.success(`\u062A\u0645 \u0627\u0633\u062A\u064A\u0631\u0627\u062F ${t} \u0633\u062C\u0644 \u0628\u0646\u062C\u0627\u062D.`),a&&a.remove(),this.state.currentTab==="register"){const n=document.getElementById("fire-register-table");n&&(n.innerHTML=this.renderRegisterTable(),this.bindRegisterTableEvents(n))}else this.renderAssets();this.renderStats()}catch(t){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+t.message)}},parseDate(e){if(!e)return"";if(e instanceof Date)return e.toISOString();if(typeof e=="number"){const t=Math.floor(e),i=e-t,s=new Date(1899,11,30),n=new Date(s.getTime()+t*24*60*60*1e3);if(i>0){const o=Math.round(i*24*60*60),l=Math.floor(o/3600),r=Math.floor(o%3600/60),c=o%60;n.setHours(l,r,c,0)}return n.toISOString()}const a=new Date(e);return isNaN(a.getTime())?"":a.toISOString()},exportToExcel(){if(typeof XLSX>"u"){Notification.error("\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629. \u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644\u0647\u0627...");const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/xlsx@0.18.5/dist/xlsx.full.min.js",e.onerror=function(){this.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js"},e.onload=()=>this.exportToExcel(),document.head.appendChild(e);return}Loading.show("\u062C\u0627\u0631\u064A \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A...");try{const a=this.getAssets().map(n=>({\u0627\u0644\u0645\u0635\u0646\u0639:n.factoryName||n.factory||"","\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A":n.subLocationName||n.subLocation||"","\u0645\u0643\u0627\u0646 / \u0645\u0648\u0642\u0639 \u0627\u0644\u062C\u0647\u0627\u0632":n.location||"","\u0646\u0648\u0639 \u0627\u0644\u062C\u0647\u0627\u0632":n.type||"","\u0627\u0644\u0633\u0639\u0629 / \u0643\u062C\u0645":n.capacity||n.capacityKg||"","\u0631\u0642\u0645 \u0627\u0644\u062C\u0647\u0627\u0632 \u0628\u0627\u0644\u0645\u0648\u0642\u0639":n.siteNumber||n.number||"","\u0627\u0644\u0634\u0631\u0643\u0629 \u0627\u0644\u0645\u0635\u0646\u0639\u0629":n.manufacturer||"","\u0633\u0646\u0629 \u0627\u0644\u0635\u0646\u0639":n.manufacturingYear||"","\u0631\u0642\u0645 \u0645\u0633\u0644\u0633\u0644 \u0627\u0644\u062C\u0647\u0627\u0632":n.serialNumber||"","\u062D\u0627\u0644\u0629 \u0627\u0644\u062C\u0647\u0627\u0632":n.status||"","\u0637\u0631\u064A\u0642\u0629 \u062A\u062B\u0628\u064A\u062A":n.installationMethod||"",\u0645\u0644\u0627\u062D\u0638\u0627\u062A:n.notes||""})),t=XLSX.utils.json_to_sheet(a),i=XLSX.utils.book_new();XLSX.utils.book_append_sheet(i,t,"\u0633\u062C\u0644 \u0645\u0639\u062F\u0627\u062A \u0627\u0644\u0627\u0637\u0641\u0627\u0621");const s=`\u0633\u062C\u0644_\u0645\u0639\u062F\u0627\u062A_\u0627\u0644\u0627\u0637\u0641\u0627\u0621_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(i,s),Loading.hide(),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}catch(e){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u062A\u0635\u062F\u064A\u0631: "+e.message)}},async exportRegisterToPDF(){const e=this.getAssets();if(e.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}Loading.show("\u062C\u0627\u0631\u064A \u0625\u0646\u0634\u0627\u0621 PDF...");try{const a=window.open("","_blank");if(!a){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0639\u0631\u0636 \u0627\u0644\u062A\u0642\u0631\u064A\u0631"),Loading.hide();return}const t=e.map(s=>`
            ...
            `;a.document.write(i),a.document.close(),Loading.hide(),Notification.success("\u062A\u0645 \u0625\u0646\u0634\u0627\u0621 PDF \u0628\u0646\u062C\u0627\u062D")}catch(a){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0625\u0646\u0634\u0627\u0621 PDF: "+a.message)}},isAdmin(){if(typeof Permissions<"u"&&typeof Permissions.isCurrentUserEffectiveAdmin=="function")return Permissions.isCurrentUserEffectiveAdmin();const e=typeof AppState<"u"&&AppState?AppState.currentUser:null;return!!(e&&(e.role==="admin"||e.role==="\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"||e.role==="system_admin"||e.permissions&&(e.permissions.admin===!0||e.permissions["manage-modules"]===!0)))},hasTabAccess(e){return(typeof AppState<"u"&&AppState?AppState.currentUser:null)?this.isAdmin()?!0:typeof Permissions<"u"?Permissions.hasDetailedPermission("fire-equipment",e):!0:e==="database"},canAdd(){const e=typeof AppState<"u"&&AppState?AppState.currentUser:null;if(!e)return!1;if(this.isAdmin())return!0;const a=e.permissions?.fireEquipment||{};return a.add===!0||a.edit===!0},canEdit(){const e=typeof AppState<"u"&&AppState?AppState.currentUser:null;return e?this.isAdmin()?!0:(e.permissions?.fireEquipment||{}).edit===!0:!1},canDelete(){const e=typeof AppState<"u"&&AppState?AppState.currentUser:null;return e?this.isAdmin()?!0:(e.permissions?.fireEquipment||{}).delete===!0:!1},async deleteAsset(e){if(!this.canDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062D\u0630\u0641 \u0627\u0644\u0623\u062C\u0647\u0632\u0629. \u064A\u062C\u0628 \u0623\u0646 \u062A\u0643\u0648\u0646 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645 \u0623\u0648 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0627\u0644\u062D\u0630\u0641.");return}const a=this.getAssets().find(i=>i.id===e);if(!a){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u062C\u0647\u0627\u0632");return}if(confirm(`\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 "${a.number||e}"\u061F

\u0633\u064A\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0648\u062C\u0645\u064A\u0639 \u0627\u0644\u0641\u062D\u0648\u0635\u0627\u062A \u0627\u0644\u0645\u0631\u062A\u0628\u0637\u0629 \u0628\u0647 \u0646\u0647\u0627\u0626\u064A\u0627\u064B.`)){Loading.show();try{let i=!1;if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest)try{const r=await GoogleIntegration.sendRequest({action:"deleteFireEquipment",data:{assetId:e}});if(r&&r.success)i=!0,Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u0646 Backend \u0628\u0646\u062C\u0627\u062D");else{const c=r?.message||"\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u0646 Backend";Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u0646 Backend:",c)}}catch(r){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u0646 Backend:",r)}else i=!0;const s=this.getAssets(),n=s.findIndex(r=>r.id===e);n>-1&&s.splice(n,1);const o=this.getInspections();if(o.filter(r=>r.assetId===e).forEach(r=>{const c=o.findIndex(f=>f.id===r.id);c>-1&&o.splice(c,1)}),AppState.appData&&AppState.appData.fireEquipmentApprovalRequests){const r=AppState.appData.fireEquipmentApprovalRequests;r.filter(f=>f.assetId===e).forEach(f=>{const d=r.findIndex(p=>p.id===f.id);d>-1&&r.splice(d,1)})}AppState.appData||(AppState.appData={}),AppState.appData.fireEquipmentAssets=s,AppState.appData.fireEquipmentInspections=o,typeof DataManager<"u"&&DataManager.save?DataManager.save():(localStorage.setItem("fire_equipment_assets",JSON.stringify(s)),localStorage.setItem("fire_equipment_inspections",JSON.stringify(o))),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u062D\u0644\u064A\u0627\u064B"),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0628\u0646\u062C\u0627\u062D"),await this.refreshCurrentTab(!0),this.state.currentTab==="database"?(this.refreshFilterOptions(),this.renderSummary()):this.state.currentTab==="register"&&this.updateRegisterStatisticsCards()}catch(i){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632:",i),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632")}finally{Loading.hide()}}},async renderAnalyticsTab(){return this.isAdmin()?`
            <div class="space-y-6">
        ...
        `},renderTimelineTable(e){return!e||Object.keys(e).length===0?'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0632\u0645\u0646\u064A\u0629 \u0644\u0644\u0639\u0631\u0636</p></div>':`
            <div class="table-wrapper" style="width: 100%; max-width: 100%; overflow-x: auto;">
                <table class="data-table table-header-red" style="width: 100%; min-width: 100%; table-layout: auto;">
                    ...
                    <tbody>
                        ${Object.entries(e).sort((t,i)=>t[0].localeCompare(i[0])).map(([t,i])=>`
                    <tr>
        ...
        `},renderStatusTable(e){if(!e||Object.keys(e).length===0)return'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0644\u0639\u0631\u0636</p></div>';const a=Object.values(e).reduce((i,s)=>i+s,0);return`
            <div class="table-wrapper" style="width: 100%; max-width: 100%; overflow-x: auto;">
                <table class="data-table table-header-red" style="width: 100%; min-width: 100%; table-layout: auto;">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ${Object.entries(e).map(([i,s])=>{const n=a>0?(s/a*100).toFixed(1):0;let o="badge-info";return i==="\u0635\u0627\u0644\u062D"?o="badge-success":i==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629"?o="badge-warning":i==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"&&(o="badge-danger"),`
                    <tr>
                        <td><span class="badge ${o}">${Utils.escapeHTML(i)}</span></td>
        ...
        `},setupAnalyticsEventListeners(){const e=this.getAssets(),a=document.getElementById("analytics-type-filter"),t=document.getElementById("analytics-location-filter");if(a){const o=Array.from(new Set(e.map(l=>l.type).filter(Boolean)));a.innerHTML='<option value="all">\u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0646\u0648\u0627\u0639</option>'+o.map(l=>`<option value="${Utils.escapeHTML(l)}">${Utils.escapeHTML(l)}</option>`).join("")}if(t){const o=Array.from(new Set(e.map(l=>l.location).filter(Boolean)));t.innerHTML='<option value="all">\u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0648\u0627\u0642\u0639</option>'+o.map(l=>`<option value="${Utils.escapeHTML(l)}">${Utils.escapeHTML(l)}</option>`).join("")}const i=document.getElementById("analytics-apply-filters");if(i){const o=i.cloneNode(!0);i.parentNode.replaceChild(o,i),o.addEventListener("click",()=>{this.renderAnalyticsData()})}const s=document.getElementById("analytics-reset-filters");if(s){const o=s.cloneNode(!0);s.parentNode.replaceChild(o,s),o.addEventListener("click",()=>{document.getElementById("analytics-date-from").value="",document.getElementById("analytics-date-to").value="",document.getElementById("analytics-type-filter").value="all",document.getElementById("analytics-location-filter").value="all",this.renderAnalyticsData()})}const n=document.getElementById("analytics-export-data");if(n){const o=n.cloneNode(!0);n.parentNode.replaceChild(o,n),o.addEventListener("click",()=>{this.exportAnalyticsData()})}this.renderAnalyticsData()},exportAnalyticsData(){try{const e=document.getElementById("analytics-date-from")?.value||"",a=document.getElementById("analytics-date-to")?.value||"",t=document.getElementById("analytics-type-filter")?.value||"all",i=document.getElementById("analytics-location-filter")?.value||"all",s={dateFrom:e,dateTo:a,type:t,location:i},n=this.getAnalyticsData(s),o=this.getAssets(),l=this.getInspections();let r=`\u062A\u062D\u0644\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0639\u062F\u0627\u062A \u0627\u0644\u062D\u0631\u064A\u0642
...
`});const c=new Blob(["\uFEFF"+r],{type:"text/csv;charset=utf-8;"}),f=document.createElement("a"),d=URL.createObjectURL(c);f.setAttribute("href",d),f.setAttribute("download",`\u062A\u062D\u0644\u064A\u0644_\u0645\u0639\u062F\u0627\u062A_\u0627\u0644\u062D\u0631\u064A\u0642_${new Date().toISOString().slice(0,10)}.csv`),f.style.visibility="hidden",document.body.appendChild(f),f.click(),document.body.removeChild(f),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}catch(e){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+e.message)}},async renderApprovalRequestsTab(){if(!this.isAdmin())return'<div class="empty-state"><p class="text-gray-500">\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0647\u0630\u0627 \u0627\u0644\u0642\u0633\u0645. \u064A\u062C\u0628 \u0623\u0646 \u062A\u0643\u0648\u0646 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645.</p></div>';this.ensureData();try{const i=await this.loadApprovalRequestsFromBackend();i&&i.length>0&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${i.length} \u0637\u0644\u0628 \u0645\u0648\u0627\u0641\u0642\u0629 \u0645\u0646 Backend`)}catch(i){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0637\u0644\u0628\u0627\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629:",i)}const e=this.getApprovalRequests();if(!e||!Array.isArray(e))return Utils.safeWarn("\u26A0\uFE0F \u0644\u0627 \u062A\u0648\u062C\u062F \u0637\u0644\u0628\u0627\u062A \u0645\u0648\u0627\u0641\u0642\u0629 \u0645\u062A\u0627\u062D\u0629"),'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0637\u0644\u0628\u0627\u062A \u0645\u0648\u0627\u0641\u0642\u0629 \u062D\u0627\u0644\u064A\u0627\u064B</p></div>';const t=[...e].sort((i,s)=>{const n={pending:1,approved:2,rejected:3},o=n[i.status]||99,l=n[s.status]||99;if(o!==l)return o-l;const r=new Date(i.requestedAt||0);return new Date(s.requestedAt||0)-r}).map(i=>{const s=i.status==="approved"?'<span class="badge badge-success"><i class="fas fa-check-circle ml-1"></i>\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647</span>':i.status==="rejected"?'<span class="badge badge-danger"><i class="fas fa-times-circle ml-1"></i>\u0645\u0631\u0641\u0648\u0636</span>':'<span class="badge badge-warning"><i class="fas fa-clock ml-1"></i>\u0642\u064A\u062F \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631</span>',n=i.type==="inspection"?'<i class="fas fa-clipboard-check ml-1"></i>\u0641\u062D\u0635 \u0634\u0647\u0631\u064A':i.type==="add"?'<i class="fas fa-plus-circle ml-1"></i>\u0625\u0636\u0627\u0641\u0629 \u062C\u0647\u0627\u0632':i.type==="edit"?'<i class="fas fa-edit ml-1"></i>\u062A\u0639\u062F\u064A\u0644 \u062C\u0647\u0627\u0632':i.type==="delete"?'<i class="fas fa-trash ml-1"></i>\u062D\u0630\u0641 \u062C\u0647\u0627\u0632':'<i class="fas fa-question-circle ml-1"></i>\u0637\u0644\u0628 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F',o=this.getAssets().find(r=>r.id===i.assetId||r.number===i.assetNumber),l=o?`${o.number||o.id} - ${o.location||""}`:i.assetNumber||i.assetId||"-";return`
        ...
        `},async loadApprovalRequestsFromBackend(){try{if(GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled){const a=await GoogleIntegration.sendRequest({action:"getFireEquipmentApprovalRequests",data:{}});if(a&&a.success&&a.data){AppState.appData||(AppState.appData={});const t=Array.isArray(a.data)?a.data:[],s=[...AppState.appData.fireEquipmentApprovalRequests||[]];return t.forEach(n=>{const o=s.findIndex(l=>l.id===n.id);o>=0?s[o]={...s[o],...n}:s.push(n)}),AppState.appData.fireEquipmentApprovalRequests=s,typeof DataManager<"u"&&DataManager.save?DataManager.save():localStorage.setItem("fire_equipment_approval_requests",JSON.stringify(s)),Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0648\u062F\u0645\u062C ${s.length} \u0637\u0644\u0628 \u0645\u0648\u0627\u0641\u0642\u0629 (${t.length} \u0645\u0646 Backend)`),s}else Utils.safeWarn("\u26A0\uFE0F \u0627\u0633\u062A\u062C\u0627\u0628\u0629 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D\u0629 \u0645\u0646 Backend:",a)}else Utils.safeWarn("\u26A0\uFE0F GoogleIntegration \u063A\u064A\u0631 \u0645\u062A\u0627\u062D \u0623\u0648 \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644")}catch(a){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0637\u0644\u0628\u0627\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0645\u0646 Backend:",a)}return this.getApprovalRequests()||[]},getApprovalRequests(){AppState.appData||(AppState.appData={});let e=[];if(AppState.appData.fireEquipmentApprovalRequests&&Array.isArray(AppState.appData.fireEquipmentApprovalRequests))e=[...AppState.appData.fireEquipmentApprovalRequests];else{const t=localStorage.getItem("fire_equipment_approval_requests");if(t)try{const i=JSON.parse(t);Array.isArray(i)&&(e=[...i],AppState.appData.fireEquipmentApprovalRequests=i)}catch(i){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0644\u064A\u0644 \u0637\u0644\u0628\u0627\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0645\u0646 localStorage:",i)}}return(this.getInspections()||[]).forEach(t=>{const i=String(t.approvalStatus||"").toLowerCase()==="pending"||!t.approvalStatus&&t.submittedBy&&String(t.submittedBy).includes("Public"),s=String(t.approvalStatus||"").toLowerCase()==="approved",n=String(t.approvalStatus||"").toLowerCase()==="rejected";e.some(o=>o.id===t.id||o.inspectionId===t.id)||e.push({id:t.id,type:"inspection",assetId:t.assetId,requestedBy:t.inspector||(t.submittedBy?"\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0641\u062D\u0635 \u0627\u0644\u0645\u064A\u062F\u0627\u0646\u064A":"\u0645\u0633\u0624\u0648\u0644 \u0627\u0644\u0633\u0644\u0627\u0645\u0629"),requestedAt:t.checkDate||t.createdAt,status:s?"approved":n?"rejected":"pending",approvedBy:t.approvedBy||"",approvedAt:t.approvedAt||"",rejectedBy:t.rejectedBy||"",rejectionReason:t.reviewNotes||"",comments:`\u0641\u062D\u0635 \u0634\u0647\u0631\u064A \u0645\u064A\u062F\u0627\u0646\u064A - \u0627\u0644\u062D\u0627\u0644\u0629 \u0627\u0644\u0641\u0646\u064A\u0629: ${t.status||"\u0635\u0627\u0644\u062D"} | \u0635\u0645\u0627\u0645 \u0627\u0644\u0623\u0645\u0627\u0646: ${t.sealIntact||"\u0633\u0644\u064A\u0645"} | \u0639\u062F\u0627\u062F \u0627\u0644\u0636\u063A\u0637: ${t.gaugeReading||"\u0633\u0644\u064A\u0645"} ${t.remarks?" | \u0645\u0644\u0627\u062D\u0638\u0629: "+t.remarks:""}`,inspectionRecord:t})}),e},setupApprovalRequestsEventListeners(){const e=document.getElementById("approval-requests-search");if(e){const i=e.cloneNode(!0);e.parentNode.replaceChild(i,e),i.addEventListener("input",s=>{const n=s.target.value.toLowerCase();document.querySelectorAll("#approval-requests-table-body tr[data-request-id]").forEach(l=>{const r=l.textContent.toLowerCase();l.style.display=r.includes(n)?"":"none"})})}const a=document.getElementById("approval-requests-refresh");if(a){const i=a.cloneNode(!0);a.parentNode&&a.parentNode.replaceChild(i,a),i.addEventListener("click",async s=>{s.preventDefault(),s.stopPropagation();try{Loading.show(),await this.loadApprovalRequestsFromBackend(),await this.loadFireEquipmentDataAsync(),typeof AppUI<"u"&&AppUI.updateNotificationsBadge&&AppUI.updateNotificationsBadge(),await this.switchTab("approval-requests"),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0637\u0644\u0628\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}catch(n){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0637\u0644\u0628\u0627\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629:",n),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0637\u0644\u0628\u0627\u062A")}finally{Loading.hide()}})}const t=document.getElementById("approval-requests-table-body");t&&t.addEventListener("click",async i=>{const s=i.target.closest("[data-action]");if(!s)return;const n=s.dataset.action,o=s.dataset.id;switch(n){case"approve-request":await this.approveRequest(o);break;case"reject-request":await this.rejectRequest(o);break;case"view-request":await this.viewRequest(o);break;case"edit-request":await this.editRequest(o);break;case"delete-request":await this.deleteRequest(o);break}})},async approveRequest(e){if(!this.isAdmin()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628\u0627\u062A");return}if(String(e).startsWith("FEI-")||this.getInspections().some(t=>t.id===e)){await this.approveInspection(e),await this.switchTab("approval-requests");return}if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0647\u0630\u0627 \u0627\u0644\u0637\u0644\u0628\u061F")){Loading.show();try{const t=this.getApprovalRequests(),i=t.find(s=>s.id===e);if(!i){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628");return}i.status="approved",i.approvedBy=AppState.currentUser?.name||AppState.currentUser?.email||"\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645",i.approvedAt=new Date().toISOString(),AppState.appData||(AppState.appData={}),AppState.appData.fireEquipmentApprovalRequests=t,typeof DataManager<"u"&&DataManager.save&&DataManager.save(),typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest&&GoogleIntegration.sendRequest({action:"updateFireEquipmentApprovalRequest",data:{requestId:e,status:"approved",approvedBy:i.approvedBy,approvedAt:i.approvedAt}}).catch(s=>Utils.safeWarn("Warning background sync:",s)),Notification.success("\u062A\u0645\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628 \u0628\u0646\u062C\u0627\u062D"),await this.switchTab("approval-requests")}catch(t){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628:",t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628")}finally{Loading.hide()}}},async rejectRequest(e){if(!this.isAdmin()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0631\u0641\u0636 \u0627\u0644\u0637\u0644\u0628\u0627\u062A");return}if(String(e).startsWith("FEI-")||this.getInspections().some(t=>t.id===e)){await this.rejectInspection(e),await this.switchTab("approval-requests");return}const a=prompt("\u0623\u062F\u062E\u0644 \u0633\u0628\u0628 \u0627\u0644\u0631\u0641\u0636:");if(a!==null){Loading.show();try{const t=this.getApprovalRequests(),i=t.find(s=>s.id===e);if(!i){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628");return}i.status="rejected",i.rejectedBy=AppState.currentUser?.name||AppState.currentUser?.email||"\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645",i.rejectedAt=new Date().toISOString(),i.rejectionReason=a||"",AppState.appData||(AppState.appData={}),AppState.appData.fireEquipmentApprovalRequests=t,typeof DataManager<"u"&&DataManager.save&&DataManager.save(),Notification.success("\u062A\u0645 \u0631\u0641\u0636 \u0627\u0644\u0637\u0644\u0628 \u0628\u0646\u062C\u0627\u062D"),await this.switchTab("approval-requests")}catch(t){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u0631\u0641\u0636 \u0627\u0644\u0637\u0644\u0628:",t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0631\u0641\u0636 \u0627\u0644\u0637\u0644\u0628")}finally{Loading.hide()}}},async viewRequest(e){if(String(e).startsWith("FEI-")||this.getInspections().some(i=>i.id===e)){this.viewInspection(e);return}const t=this.getApprovalRequests().find(i=>i.id===e);if(!t){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628");return}alert(`\u062A\u0641\u0627\u0635\u064A\u0644 \u0627\u0644\u0637\u0644\u0628: ${t.id}
\u0627\u0644\u0646\u0648\u0639: ${t.type}
\u0645\u0642\u062F\u0645 \u0627\u0644\u0637\u0644\u0628: ${t.requestedBy}
\u0627\u0644\u062D\u0627\u0644\u0629: ${t.status}
\u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A: ${t.comments||"-"}`)},async notifyUserAboutRequestStatus(e,a,t=""){try{const i=e.requestedById||e.userEmail||"";if(!i){Utils.safeWarn("\u26A0\uFE0F \u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u0631\u0633\u0627\u0644 \u0625\u0634\u0639\u0627\u0631: \u0645\u0639\u0631\u0641 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const s=e.assetNumber||e.assetId||"\u062C\u0647\u0627\u0632 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F";let n,o,l;if(a==="approved")n="\u062A\u0645\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0637\u0644\u0628\u0643",o=`\u062A\u0645\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0637\u0644\u0628\u0643 \u0644\u0625\u062C\u0631\u0627\u0621 \u0641\u062D\u0635 \u0634\u0647\u0631\u064A \u0639\u0644\u0649 \u0627\u0644\u062C\u0647\u0627\u0632: ${s}`,l="success";else if(a==="rejected")n="\u062A\u0645 \u0631\u0641\u0636 \u0637\u0644\u0628\u0643",o=`\u062A\u0645 \u0631\u0641\u0636 \u0637\u0644\u0628\u0643 \u0644\u0625\u062C\u0631\u0627\u0621 \u0641\u062D\u0635 \u0634\u0647\u0631\u064A \u0639\u0644\u0649 \u0627\u0644\u062C\u0647\u0627\u0632: ${s}${t?`. \u0627\u0644\u0633\u0628\u0628: ${t}`:""}`,l="error";else return;GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled&&await GoogleIntegration.sendRequest({action:"addNotification",data:{userId:i,title:n,message:o,type:l,priority:a==="approved"?"normal":"high",link:"#fire-equipment-inspections",data:{module:"fire-equipment",action:"inspection_approval_status",requestId:e.id,status:a}}}).catch(r=>{Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0627\u0644\u0625\u0634\u0639\u0627\u0631 \u0644\u0644\u0645\u0633\u062A\u062E\u062F\u0645:",r)}),Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0631\u0633\u0627\u0644 \u0625\u0634\u0639\u0627\u0631 \u0644\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0628\u062E\u0635\u0648\u0635 \u062D\u0627\u0644\u0629 \u0627\u0644\u0637\u0644\u0628: ${a}`)}catch(i){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0625\u0634\u0639\u0627\u0631 \u062D\u0627\u0644\u0629 \u0627\u0644\u0637\u0644\u0628:",i)}},async viewRequest(e){const t=this.getApprovalRequests().find(l=>l.id===e);if(!t){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628");return}const i=this.getAssets().find(l=>l.id===t.assetId||l.number===t.assetNumber),s=t.status==="approved"?'<span class="badge badge-success"><i class="fas fa-check-circle ml-1"></i>\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647</span>':t.status==="rejected"?'<span class="badge badge-danger"><i class="fas fa-times-circle ml-1"></i>\u0645\u0631\u0641\u0648\u0636</span>':'<span class="badge badge-warning"><i class="fas fa-clock ml-1"></i>\u0642\u064A\u062F \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631</span>',n=t.type==="inspection"?"\u0641\u062D\u0635 \u0634\u0647\u0631\u064A":t.type==="add"?"\u0625\u0636\u0627\u0641\u0629 \u062C\u0647\u0627\u0632":t.type==="edit"?"\u062A\u0639\u062F\u064A\u0644 \u062C\u0647\u0627\u0632":t.type==="delete"?"\u062D\u0630\u0641 \u062C\u0647\u0627\u0632":"\u0637\u0644\u0628 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F",o=document.createElement("div");o.className="modal-overlay fire-modal",o.innerHTML=`
            <div class="modal-content" style="max-width: 700px;">
                <div class="modal-header modal-header-centered">
                    <h2 class="modal-title">
        ...
        `,document.body.appendChild(o)},async editRequest(e){if(!this.isAdmin()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0637\u0644\u0628\u0627\u062A");return}const a=this.getApprovalRequests(),t=a.find(s=>s.id===e);if(!t){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628");return}const i=prompt("\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A:",t.comments||"");if(i!==null){Loading.show();try{t.comments=i,t.updatedAt=new Date().toISOString(),AppState.appData||(AppState.appData={}),AppState.appData.fireEquipmentApprovalRequests=a,typeof DataManager<"u"&&DataManager.save?DataManager.save():localStorage.setItem("fire_equipment_approval_requests",JSON.stringify(a)),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0637\u0644\u0628 \u0628\u0646\u062C\u0627\u062D"),await this.switchTab("approval-requests")}catch(s){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0637\u0644\u0628:",s),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0637\u0644\u0628")}finally{Loading.hide()}}},async deleteRequest(e){if(!this.isAdmin()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062D\u0630\u0641 \u0627\u0644\u0637\u0644\u0628\u0627\u062A");return}if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0637\u0644\u0628\u061F")){Loading.show();try{const t=this.getApprovalRequests(),i=t.findIndex(s=>s.id===e);if(i===-1){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628");return}t.splice(i,1),AppState.appData||(AppState.appData={}),AppState.appData.fireEquipmentApprovalRequests=t,typeof DataManager<"u"&&DataManager.save?DataManager.save():localStorage.setItem("fire_equipment_approval_requests",JSON.stringify(t)),typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest&&await GoogleIntegration.sendRequest({action:"deleteFireEquipmentApprovalRequest",data:{requestId:e}}).catch(s=>{Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062D\u0630\u0641 \u0627\u0644\u0637\u0644\u0628 \u0645\u0646 Google Sheets:",s)}),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0637\u0644\u0628 \u0628\u0646\u062C\u0627\u062D"),await this.switchTab("approval-requests")}catch(t){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0637\u0644\u0628:",t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0637\u0644\u0628")}finally{Loading.hide()}}},getSiteOptions(){try{return typeof Permissions<"u"&&Permissions.formSettingsState&&Permissions.formSettingsState.sites?Permissions.formSettingsState.sites.map(e=>({id:e.id,name:e.name})):Array.isArray(AppState.appData?.observationSites)&&AppState.appData.observationSites.length>0?AppState.appData.observationSites.map(e=>({id:e.id||e.siteId||Utils.generateId("SITE"),name:e.name||e.title||e.label||"\u0645\u0648\u0642\u0639 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F"})):typeof DailyObservations<"u"&&Array.isArray(DailyObservations.DEFAULT_SITES)?DailyObservations.DEFAULT_SITES.map((e,a)=>({id:e.id||e.siteId||Utils.generateId("SITE"),name:e.name||e.title||e.label||`\u0645\u0648\u0642\u0639 ${a+1}`})):[]}catch(e){return Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u0648\u0627\u0642\u0639:",e),[]}},refreshSiteDropdowns(){try{var e=this.getSiteOptions(),a=typeof Utils<"u"&&Utils.escapeHTML?Utils.escapeHTML:function(o){return String(o??"")},t='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0635\u0646\u0639</option>'+(e||[]).map(function(o){return'<option value="'+a(o.id)+'">'+a(o.name)+"</option>"}).join("");["asset-factory","fire-assets-location"].forEach(function(o){var l=document.getElementById(o);if(l&&l.tagName==="SELECT"){var r=l.value;l.innerHTML=t,r&&(l.value=r)}});var i=document.getElementById("asset-sub-location");if(i&&i.tagName==="SELECT"){var s=(document.getElementById("asset-factory")||{}).value,n=this.getPlaceOptions(s);i.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A</option>'+(n||[]).map(function(o){return'<option value="'+a(o.id)+'">'+a(o.name)+"</option>"}).join("")}}catch(o){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F FireEquipment.refreshSiteDropdowns:",o)}},getPlaceOptions(e){try{if(!e)return[];if(!this.getSiteOptions().find(i=>i.id===e))return[];if(typeof Permissions<"u"&&Permissions.formSettingsState&&Permissions.formSettingsState.sites){const i=Permissions.formSettingsState.sites.find(s=>s.id===e);if(i&&Array.isArray(i.places))return i.places.map(s=>({id:s.id,name:s.name}))}if(Array.isArray(AppState.appData?.observationSites)){const i=AppState.appData.observationSites.find(s=>(s.id||s.siteId)===e);if(i)return(Array.isArray(i.places)?i.places:Array.isArray(i.locations)?i.locations:Array.isArray(i.children)?i.children:Array.isArray(i.areas)?i.areas:[]).map((n,o)=>({id:n.id||n.placeId||n.value||Utils.generateId("PLACE"),name:n.name||n.placeName||n.title||n.label||n.locationName||`\u0645\u0643\u0627\u0646 ${o+1}`}))}if(typeof DailyObservations<"u"&&Array.isArray(DailyObservations.DEFAULT_SITES)){const i=DailyObservations.DEFAULT_SITES.find(s=>(s.id||s.siteId)===e);if(i)return(Array.isArray(i.places)?i.places:Array.isArray(i.locations)?i.locations:Array.isArray(i.children)?i.children:Array.isArray(i.areas)?i.areas:[]).map((n,o)=>({id:n.id||n.placeId||n.value||Utils.generateId("PLACE"),name:n.name||n.placeName||n.title||n.label||n.locationName||`\u0645\u0643\u0627\u0646 ${o+1}`}))}return[]}catch(a){return Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0627\u0644\u0641\u0631\u0639\u064A\u0629:",a),[]}}},(function(){"use strict";try{typeof window<"u"&&typeof FireEquipment<"u"&&(window.FireEquipment=FireEquipment,typeof AppState<"u"&&AppState.debugMode&&typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u2705 FireEquipment module loaded and available on window.FireEquipment"))}catch{if(typeof window<"u"&&typeof FireEquipment<"u")try{window.FireEquipment=FireEquipment}catch{}}})();
