...
\u0633\u064A\u062A\u0645 \u0641\u0642\u062F\u0627\u0646 \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.`)&&e.closest(".modal-overlay").remove()},closeModal(e){const i=e.closest(".modal-overlay");i&&i.remove()},generateFireDeviceID(){const i=this.getAssets().map(n=>n.id).filter(n=>n&&n.match(/^EFA-\d{4}$/)).map(n=>parseInt(n.split("-")[1])).filter(n=>!isNaN(n)),t=i.length>0?Math.max(...i)+1:1;return`EFA-${String(t).padStart(4,"0")}`},_injectFireIdentityStyles(){try{if(document.getElementById("fire-professional-identity-styles"))return;const e=document.createElement("style");e.id="fire-professional-identity-styles",e.textContent=`
        ...
        `,document.body.appendChild(s);const n=s.querySelector("#fire-asset-form");n.addEventListener("submit",async r=>{r.preventDefault();const l=n?.querySelector('button[type="submit"]');if(l&&l.disabled)return;let o="";l&&(o=l.innerHTML,l.disabled=!0,l.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');try{const d=new Date().toISOString(),p=this.getAssets(),c=p.findIndex(y=>y.id===t),f=document.getElementById("asset-type").value.trim();f&&!this.assetTypes.includes(f)&&this.assetTypes.push(f);const m=y=>{const q=document.getElementById(y);return q?q.value.trim():""},h=y=>{const q=document.getElementById(y);return q?q.value.trim():null},w=m("asset-factory"),S=m("asset-sub-location"),x=this.getSiteOptions().find(y=>y.id===w),E=this.getPlaceOptions(w).find(y=>y.id===S),g={id:t,number:m("asset-site-number")||t,siteNumber:m("asset-site-number")||t,type:f,location:m("asset-location"),subLocation:S,subLocationId:S?String(S).trim():null,subLocationName:E?E.name:"",manufacturer:m("asset-manufacturer"),factory:w,factoryId:w?String(w).trim():null,factoryName:x?x.name:"",model:m("asset-model"),capacity:m("asset-capacity"),capacityKg:m("asset-capacity"),manufacturingYear:(()=>{const y=document.getElementById("asset-manufacturing-year");return y&&y.value?parseInt(y.value):null})(),productionDate:(()=>{const y=document.getElementById("asset-production-date");return y?this.toISODate(y.value):null})(),serialNumber:m("asset-serial-number"),installationMethod:m("asset-installation-method"),installationDate:(()=>{const y=document.getElementById("asset-installation");return y?this.toISODate(y.value):null})(),lastServiceDate:(()=>{const y=document.getElementById("asset-last-service");return y?this.toISODate(y.value):null})(),status:m("asset-status"),responsible:m("asset-responsible"),notes:m("asset-notes"),qrCodeData:e?.qrCodeData||this.generateQrData(t),createdAt:e?.createdAt||d,updatedAt:d};c>-1?p[c]={...p[c],...g}:p.push(g),Loading.show();let b;if(GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled){if(b=await GoogleIntegration.sendRequest({action:"saveOrUpdateFireEquipmentAsset",data:g}),!b.success)throw new Error(b.message||"\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u062C\u0647\u0627\u0632");Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u062C\u0647\u0627\u0632 \u0641\u064A Backend:",g.id);try{await this.loadAssetsFromBackend()}catch(y){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0646 Backend\u060C \u0633\u064A\u062A\u0645 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629:",y)}}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success(i?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062C\u0647\u0627\u0632":"\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u062C\u0647\u0627\u0632 \u0628\u0646\u062C\u0627\u062D"),l&&(l.disabled=!1,l.innerHTML=o),s.remove(),this.state.currentTab==="database"?this.renderAssets():this.state.currentTab==="register"?await this.refreshRegisterTable():await this.refreshCurrentTab()}catch(d){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0627\u0644\u062C\u0647\u0627\u0632:",d),Notification.error("\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u062C\u0647\u0627\u0632: "+(d.message||d)),l&&(l.disabled=!1,l.innerHTML=o)}});const a=s.querySelector("#manage-types-btn");a&&a.addEventListener("click",()=>{this.showManageTypesModal()}),setTimeout(()=>{const r=s.querySelector("#asset-factory"),l=s.querySelector("#asset-sub-location");r&&l&&r.addEventListener("change",()=>{const o=r.value,d=this.getPlaceOptions(o);l.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A</option>',d.forEach(p=>{const c=document.createElement("option");c.value=p.id,c.textContent=p.name,l.appendChild(c)})})},100)},async startQRScan(){if(!navigator.mediaDevices||!navigator.mediaDevices.getUserMedia){Notification.error("\u0627\u0644\u0645\u062A\u0635\u0641\u062D \u0644\u0627 \u064A\u062F\u0639\u0645 \u0627\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0627\u0644\u0643\u0627\u0645\u064A\u0631\u0627. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0645\u062A\u0635\u0641\u062D \u062D\u062F\u064A\u062B.");return}const e=document.createElement("div");e.className="modal-overlay fire-modal",e.innerHTML=`
            <style>
                .qr-scanner-modal {
                    max-width: 95%;
                    width: 100%;
        ...
        `,document.body.appendChild(l);const o=l.querySelector("#fire-inspection-form");if(!o){Utils.safeError("\u274C \u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0646\u0645\u0648\u0630\u062C #fire-inspection-form");return}let d=!1;o.addEventListener("submit",async p=>{if(p.preventDefault(),p.stopPropagation(),d){Utils.safeWarn("\u26A0\uFE0F \u0627\u0644\u0646\u0645\u0648\u0630\u062C \u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629 \u0628\u0627\u0644\u0641\u0639\u0644");return}d=!0;const c=o.querySelector('button[type="submit"]'),f=c?c.innerHTML:"";try{c&&(c.disabled=!0,c.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i>\u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const m=new Date().toISOString(),h=b=>{const y=document.getElementById(b);return y?y.value.trim():""},w=b=>{const y=document.getElementById(b);return y?y.value:null},S=document.getElementById("inspection-asset"),u=(S?S.value:"")||n;if(!u){Notification.error("\u062E\u0637\u0623: DeviceID \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"),d=!1,c&&(c.disabled=!1,c.innerHTML=f);return}if(!t){const b=this.checkMonthlyInspectionAllowed(u);if(!b.allowed){Notification.warning(b.reason||"\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A \u0647\u0630\u0627 \u0627\u0644\u0648\u0642\u062A"),d=!1,c&&(c.disabled=!1,c.innerHTML=f);return}}const x={id:s,assetId:u,checkDate:(()=>{const b=document.getElementById("inspection-date");return b&&this.toISODate(b.value)||m})(),inspector:h("inspection-inspector"),status:h("inspection-status"),gaugeReading:h("inspection-gauge"),sealIntact:(()=>{const b=document.getElementById("inspection-seal");if(!b)return null;const y=b.value;return y==="true"?!0:y==="false"?!1:null})(),remarks:h("inspection-remarks"),actions:h("inspection-actions"),createdAt:e?.createdAt||m,updatedAt:m};AppState.appData.fireEquipmentInspections||(AppState.appData.fireEquipmentInspections=[]);const A=AppState.appData.fireEquipmentInspections,E=A.findIndex(b=>b.id===s);E>-1?A[E]={...A[E],...x}:A.push(x);const g=this.getAssets().find(b=>b.id===u);g&&(g.lastServiceDate=x.checkDate,g.status=x.status,g.updatedAt=m),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),l&&l.parentNode&&l.remove(),this.refreshCurrentTab().catch(b=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0628\u0648\u064A\u0628:",b)}),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0641\u062D\u0635":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0641\u062D\u0635 \u0628\u0646\u062C\u0627\u062D"),(async()=>{try{if(GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled){const b=await GoogleIntegration.sendRequest({action:t?"updateFireEquipmentInspection":"addFireEquipmentInspection",data:x});if(!b.success)throw new Error(b.message||"\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0641\u062D\u0635");Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A Backend:",x.id),g&&(await GoogleIntegration.sendRequest({action:"saveOrUpdateFireEquipmentAsset",data:g}),Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u062D\u0627\u0644\u0629 \u0627\u0644\u062C\u0647\u0627\u0632:",g.id)),this.refreshCurrentTab().catch(y=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0628\u0648\u064A\u0628 \u0628\u0639\u062F \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629:",y)})}}catch(b){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0641\u062D\u0635:",b)}})(),d=!1,c&&(c.disabled=!1,c.innerHTML=f)}catch(m){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u062A\u0648\u0642\u0639 \u0641\u064A \u0627\u0644\u0646\u0645\u0648\u0630\u062C:",m),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u062A\u0648\u0642\u0639: "+(m.message||m)),d=!1,c&&(c.disabled=!1,c.innerHTML=f)}})},showMobileInspectionForm(e=null,i=null){if(!i&&!e?.assetId){Notification.warning("\u064A\u062C\u0628 \u0645\u0633\u062D QR Code \u0623\u0648\u0644\u0627\u064B \u0644\u0628\u062F\u0621 \u0627\u0644\u0641\u062D\u0635 \u0627\u0644\u0634\u0647\u0631\u064A");return}const t=!!e,s=e?.id||Utils.generateId("FEI"),n=e?.assetId||i,a=this.getAssets().find(p=>p.id===n);if(!a){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062C\u0647\u0627\u0632");return}const r=e?.checkDate?new Date(e.checkDate).toISOString().slice(0,10):new Date().toISOString().slice(0,10),l=document.createElement("div");l.className="modal-overlay fire-modal",l.innerHTML=`
            <style>
        ...
        `,document.body.appendChild(l);const o=l.querySelector("#mobile-inspection-form");if(!o){Utils.safeError("\u274C \u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0646\u0645\u0648\u0630\u062C #mobile-inspection-form");return}let d=!1;o.addEventListener("submit",async p=>{if(p.preventDefault(),p.stopPropagation(),d){Utils.safeWarn("\u26A0\uFE0F \u0627\u0644\u0646\u0645\u0648\u0630\u062C \u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629 \u0628\u0627\u0644\u0641\u0639\u0644");return}d=!0;const c=l.querySelector('button[type="submit"]'),f=c?c.innerHTML:"";try{c&&(c.disabled=!0,c.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i>\u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const m=new Date().toISOString(),h=g=>{const b=document.getElementById(g);return b?b.value.trim():""},w=document.getElementById("mobile-inspection-asset"),S=(w?w.value:"")||n;if(!S){Notification.error("\u062E\u0637\u0623: DeviceID \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"),d=!1,c&&(c.disabled=!1,c.innerHTML=f);return}if(!t){const g=this.checkMonthlyInspectionAllowed(S);if(!g.allowed){Notification.warning(g.reason||"\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A \u0647\u0630\u0627 \u0627\u0644\u0648\u0642\u062A"),d=!1,c&&(c.disabled=!1,c.innerHTML=f);return}}const u={id:s,assetId:S,checkDate:(()=>{const g=document.getElementById("mobile-inspection-date");return g&&this.toISODate(g.value)||m})(),inspector:h("mobile-inspection-inspector"),status:h("mobile-inspection-status"),gaugeReading:h("mobile-inspection-gauge"),sealIntact:(()=>{const g=document.getElementById("mobile-inspection-seal");if(!g)return null;const b=g.value;return b==="true"?!0:b==="false"?!1:null})(),remarks:h("mobile-inspection-remarks"),actions:h("mobile-inspection-actions"),createdAt:e?.createdAt||m,updatedAt:m};AppState.appData.fireEquipmentInspections||(AppState.appData.fireEquipmentInspections=[]);const x=AppState.appData.fireEquipmentInspections,A=x.findIndex(g=>g.id===s);A>-1?x[A]={...x[A],...u}:x.push(u);const E=this.getAssets().find(g=>g.id===S);E&&(E.lastServiceDate=u.checkDate,E.status=u.status,E.updatedAt=m),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),l&&l.parentNode&&l.remove(),this.refreshCurrentTab().catch(g=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0628\u0648\u064A\u0628:",g)}),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0641\u062D\u0635":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0641\u062D\u0635 \u0628\u0646\u062C\u0627\u062D"),(async()=>{try{if(GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled){const g=await GoogleIntegration.sendRequest({action:t?"updateFireEquipmentInspection":"addFireEquipmentInspection",data:u});if(!g.success)throw new Error(g.message||"\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0641\u062D\u0635");Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A Backend:",u.id),E&&(await GoogleIntegration.sendRequest({action:"saveOrUpdateFireEquipmentAsset",data:E}),Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u062D\u0627\u0644\u0629 \u0627\u0644\u062C\u0647\u0627\u0632:",E.id)),this.refreshCurrentTab().catch(b=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0628\u0648\u064A\u0628 \u0628\u0639\u062F \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629:",b)})}}catch(g){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0641\u062D\u0635:",g)}})(),d=!1,c&&(c.disabled=!1,c.innerHTML=f)}catch(m){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u062A\u0648\u0642\u0639 \u0641\u064A \u0627\u0644\u0646\u0645\u0648\u0630\u062C:",m),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u062A\u0648\u0642\u0639: "+(m.message||m)),d=!1,c&&(c.disabled=!1,c.innerHTML=f)}})},viewAsset(e){const i=this.getAssets().find(l=>l.id===e);if(!i){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062C\u0647\u0627\u0632.");return}const t=this.getInspectionsByAsset(e),s=typeof QRCode<"u"?QRCode.generate(i.qrCodeData||this.generateQrData(i.id),200):null,n=JSON.stringify(i).replace(/"/g,"&quot;"),a=document.createElement("div");a.className="modal-overlay fire-modal",a.innerHTML=`
        ...
        `,document.body.appendChild(s);const n=s.querySelector("#qr-fire-asset-select"),a=s.querySelector("#qr-fire-inspector-select"),r=s.querySelector("#fire-public-link-input"),l=s.querySelector("#fire-qr-img"),o=s.querySelector("#fire-qr-target-text"),d=s.querySelector("#fire-copy-link-btn"),p=s.querySelector("#fire-print-poster-btn"),c=()=>{const f=n.value,m=a.value,h=this.getPublicInspectionUrl(f,m);let w="";try{const A=typeof AppState<"u"&&(AppState.companyLogo||AppState.companySettings?.logo)||"",E={assets:i.map(g=>({id:g.id,number:g.number||g.id,type:g.type||"\u0637\u0641\u0627\u064A\u0629 \u062D\u0631\u064A\u0642",location:g.location||"",subLocation:g.subLocation||"",capacity:g.capacity||"",status:g.status||"\u0635\u0627\u0644\u062D",lastInspection:g.lastInspection||g.lastServiceDate||""})),safetyMembers:t.map(g=>g.name),logo:A};w="#cfg="+encodeURIComponent(btoa(unescape(encodeURIComponent(JSON.stringify(E)))))}catch{}const S=`${h}${w}`;r.value=S;let u="";const x=S.length<900?S:h;if(typeof qrcode=="function")try{const A=qrcode(0,"M");A.addData(x),A.make(),u=A.createDataURL(5,4)}catch{}if(!u&&window.QRCode&&typeof window.QRCode.generate=="function")try{u=window.QRCode.generate(h,240)}catch{}u&&u.startsWith("data:")?l.src=u:l.src=`https://api.qrserver.com/v1/create-qr-code/?size=240x240&data=${encodeURIComponent(h)}`,f?o.textContent=`\u0641\u062D\u0635 \u0645\u062E\u0635\u0635 \u0644\u0644\u062C\u0647\u0627\u0632: ${f}`:o.textContent="\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0641\u062D\u0635 \u0627\u0644\u0634\u0647\u0631\u064A \u0627\u0644\u0634\u0627\u0645\u0644 \u0644\u062C\u0645\u064A\u0639 \u0623\u062C\u0647\u0632\u0629 \u0627\u0644\u0625\u0637\u0641\u0627\u0621"};n?.addEventListener("change",c),a?.addEventListener("change",c),c(),d?.addEventListener("click",()=>{navigator.clipboard.writeText(r.value).then(()=>{d.innerHTML='<i class="fas fa-check ml-1 text-green-600"></i> \u062A\u0645 \u0627\u0644\u0646\u0633\u062E!',setTimeout(()=>{d.innerHTML='<i class="fas fa-copy ml-1"></i> \u0646\u0633\u062E'},2500)})}),p?.addEventListener("click",()=>{const f=r.value,m=window.open("","_blank");if(!m){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}m.document.write(`
                <!DOCTYPE html>
        ...
        `,document.body.appendChild(s);const n=s.querySelector("#batch-location-filter"),a=s.querySelector("#batch-type-filter"),r=s.querySelector("#batch-layout-select"),l=s.querySelector("#batch-selected-preview"),o=s.querySelector("#start-batch-print-btn"),d=()=>{const c=n.value,f=a.value;return e.filter(m=>!(c!=="all"&&m.location!==c||f!=="all"&&(m.type||m.equipmentType)!==f))},p=()=>{const c=d();l.textContent=`${c.length} \u062C\u0647\u0627\u0632 \u062C\u0627\u0647\u0632 \u0644\u0644\u0637\u0628\u0627\u0639\u0629`,o.disabled=c.length===0};n.addEventListener("change",p),a.addEventListener("change",p),o.addEventListener("click",()=>{const c=d();if(c.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062C\u0647\u0632\u0629 \u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0644\u062A\u0635\u0641\u064A\u0629.");return}s.remove(),this.batchPrintQrCards(c,r.value)})},batchPrintQrCards(e,i="2x4"){if(!e||e.length===0)return;let t=2,s="120px",n=100,a="13px",r="10.5px";i==="3x4"?(t=3,s="110px",n=85,a="11.5px",r="9.5px"):i==="2x3"&&(t=2,s="150px",n=125,a="14px",r="11.5px");const l=window.open("","_blank");if(!l){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0637\u0628\u0627\u0639\u0629 \u0643\u0631\u0648\u062A QR");return}const o=e.map(d=>{const p=String(d.id||"").trim(),c=this.getPublicInspectionUrl(p);let f="";if(typeof qrcode=="function")try{const m=qrcode(0,"M");m.addData(c),m.make(),f=m.createDataURL(4,2)}catch{}if(!f&&window.QRCode&&typeof window.QRCode.generate=="function")try{f=window.QRCode.generate(c,140)}catch{}return f||(f=`https://api.qrserver.com/v1/create-qr-code/?size=140x140&data=${encodeURIComponent(c)}`),`
                <div class="qr-card">
