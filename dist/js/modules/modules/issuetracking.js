const IssueTracking={state:{currentView:"list",filters:{status:"all",priority:"all",module:"all",category:"all",search:""},currentIssue:null},async load(){this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{this.load()}),this._languageChangeListenerAdded=!0);const e=document.getElementById("issue-tracking-section");if(!e){Utils.safeError("\u0642\u0633\u0645 issue-tracking-section \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");return}e.innerHTML=`
        ...
        `}},renderIssueCard(e){const t={Low:"bg-green-100 text-green-800",Medium:"bg-yellow-100 text-yellow-800",High:"bg-orange-100 text-orange-800",Critical:"bg-red-100 text-red-800"},s={New:"bg-blue-100 text-blue-800","In Progress":"bg-purple-100 text-purple-800",Resolved:"bg-green-100 text-green-800",Closed:"bg-gray-100 text-gray-800",Reopened:"bg-red-100 text-red-800"},a=typeof Utils<"u"&&Utils.escapeHTML?Utils.escapeHTML(e.id):e.id,i=typeof Utils<"u"&&Utils.escapeHTML?Utils.escapeHTML(e.title||"\u0628\u062F\u0648\u0646 \u0639\u0646\u0648\u0627\u0646"):e.title||"\u0628\u062F\u0648\u0646 \u0639\u0646\u0648\u0627\u0646",l=typeof Utils<"u"&&Utils.escapeHTML?Utils.escapeHTML((e.description||"").substring(0,150)):(e.description||"").substring(0,150),o=typeof Utils<"u"&&Utils.escapeHTML?Utils.escapeHTML(e.reportedBy||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"):e.reportedBy||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",r=typeof Utils<"u"&&Utils.escapeHTML?Utils.escapeHTML(e.module||""):e.module||"";return`
                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-4 text-sm text-gray-500">
                            ...
                            ${r?`<span><i class="fas fa-cube ml-1"></i> ${r}</span>`:""}
                        </div>
                    </div>
                    <div class="ml-4">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 p-4 rounded">
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    <div><strong>\u062A\u0645 \u0627\u0644\u0625\u0628\u0644\u0627\u063A \u0628\u0648\u0627\u0633\u0637\u0629:</strong> ${r}</div>
        ...
        `,document.body.appendChild(n)},renderSolutions(e){if(!e||e.length===0)return`
                <div>
