...
<style id="dashboard-arabic-pdf-fix">
    ...
    table, thead, tbody, tr, th, td { direction: rtl !important; }
            ...
            </div>`,m=f=>`padding:11px 8px;border:1px solid ${f};text-align:center;font-weight:700;font-size:11px;${a}`,g=`padding:10px 8px;border:1px solid #E5E7EB;text-align:right;font-size:11px;vertical-align:top;${a}`,h=`padding:10px 8px;border:1px solid #E5E7EB;text-align:center;font-size:11px;vertical-align:top;${a}`,C=(f,S,P,U)=>U?`
        ...
        `},buildContractorReportPdfContent(t){const e=t.contractor||{},i=this._AR_PDF_TEXT_STYLE_,a=f=>Utils.escapeHTML(String(f??"")),s=f=>f&&typeof Utils.formatDate=="function"?Utils.formatDate(f):"",r=t.contractorName||e.companyName||e.name||"\u2014",n=t.contractorCode||e.code||e.isoCode||"",o=r.trim().split(/\s+/).slice(0,2).map(f=>f.charAt(0)).join("")||"\u0645",p=s(new Date)||new Date().toLocaleDateString("ar-SA"),u=t.ptwOpen!=null?t.ptwOpen:0,l=t.ptwClosed!=null?t.ptwClosed:0,m=Array.isArray(t.ptwContractor)?t.ptwContractor:[],g=Array.isArray(t.injuriesContractor)?t.injuriesContractor:[],h=(f,S,P,U,E,H)=>`
            <div style="flex:1 1 140px;min-width:120px;padding:14px 12px;border-radius:12px;background:${P};border:1px solid ${U};text-align:center;">
            ...
            </div>`,C=f=>`padding:11px 8px;border:1px solid ${f};text-align:center;font-weight:700;font-size:11px;${i}`,b=`padding:10px 8px;border:1px solid #E5E7EB;text-align:right;font-size:11px;vertical-align:top;${i}`,x=`padding:10px 8px;border:1px solid #E5E7EB;text-align:center;font-size:11px;vertical-align:top;${i}`,A=(f,S,P,U)=>U?`
                <div style="margin:28px 0 16px;direction:rtl;">
