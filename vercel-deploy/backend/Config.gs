...
function getRequiredSheets() {
    ...
    const sheets = [
        'Users', 'Incidents', 'NearMiss', 'PTW', 'PTWRegistry', 'Training', 'ClinicVisits', 'ClinicContractorVisits', 'Medications', 'SickLeave', 'Injuries', 'ClinicContractorInjuries',
        ...
        'PeriodicInspectionChecklists', 'PeriodicInspectionSchedules', 'PeriodicInspectionRecords', 'PeriodicEquipmentTypes', 'PeriodicEquipmentAssets', 'PeriodicEquipmentInspections', 'SafetyBudget', 
