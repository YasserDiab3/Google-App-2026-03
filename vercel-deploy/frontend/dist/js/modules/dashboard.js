const Dashboard={contractorReportCache:new Map,contractorReportRequests:new Map,CONTRACTOR_REPORT_PDF_MAX_SECTION_ROWS:50,t(t,e){const r=window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n:window.I18n&&typeof window.I18n.t=="function"?window.I18n:null;return r?r.t(t,null,e||t):e||t},dashboardCan(t){return t?typeof Permissions<"u"&&typeof Permissions.isCurrentUserEffectiveAdmin=="function"&&Permissions.isCurrentUserEffectiveAdmin()?!0:typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"?Permissions.hasAccess(t):!1:!1},_dashboardReportStatIdsForTotal(){return["incidents","nearmiss","periodic-inspections","training","violations","contractors","ptw","iso","electricity-consumption","water-consumption","gas-consumption"]},anyReportsStatisticVisibleForDashboard(){return this._dashboardReportStatIdsForTotal().some(t=>{const e=this.getModuleNameFromStatId(t);return e&&this.dashboardCan(e)})},reportsStatisticsMetricVisible(t){if(t==="total-reports")return this.anyReportsStatisticVisibleForDashboard();const e=this.getModuleNameFromStatId(t);return e?this.dashboardCan(e):!1},_setDashboardElVisibility(t,e){if(t){if(e)t.removeAttribute("hidden"),t.style.removeProperty("display");else{t.setAttribute("hidden","");try{t.style.setProperty("display","none","important")}catch{t.style.display="none"}}t.setAttribute("aria-hidden",e?"false":"true")}},applyDashboardLayoutPermissions(){const t=document.getElementById("dashboard-section");t&&(t.querySelectorAll("[data-dash-scope]").forEach(e=>{const a=(e.getAttribute("data-dash-scope")||"").split(",").map(s=>s.trim()).filter(Boolean),i=a.length>0&&a.some(s=>this.dashboardCan(s));this._setDashboardElVisibility(e,i)}),t.querySelectorAll(".reports-statistics-section .metric-card-frame[data-stat-id]").forEach(e=>{const r=e.getAttribute("data-stat-id"),a=r?this.reportsStatisticsMetricVisible(r):!1;this._setDashboardElVisibility(e,a)}))},normalizePTWStatus(t){if(window.PTW&&typeof window.PTW.normalizePermitStatus=="function")return window.PTW.normalizePermitStatus(t);const e=String(t||"").trim();return!e||e==="closed"||e==="Closed"||e==="CLOSED"||e==="\u0645\u063A\u0644\u0642\u0629"||e==="\u0627\u0643\u062A\u0645\u0644"?"\u0645\u063A\u0644\u0642":e},isPTWClosedStatus(t){if(window.PTW&&typeof window.PTW.isPermitClosedStatus=="function")return window.PTW.isPermitClosedStatus(t);const e=this.normalizePTWStatus(t);return e==="\u0645\u063A\u0644\u0642"||e==="\u0645\u0631\u0641\u0648\u0636"||e==="\u0627\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644 \u0628\u0634\u0643\u0644 \u0622\u0645\u0646"||e==="\u0625\u063A\u0644\u0627\u0642 \u062C\u0628\u0631\u064A"||e==="\u0644\u0645 \u064A\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644"},getUnifiedPTWDataset(t){const e=n=>(n||[]).map(o=>({id:o?.permitId||o?.id,...o,status:this.normalizePTWStatus(o?.status),isFromRegistry:!0}));if(window.PTW&&typeof window.PTW.getRegistrySanitizedDataset=="function"){const n=window.PTW.getRegistrySanitizedDataset();if(n.length>0)return e(n)}if(window.PTW&&typeof window.PTW.initRegistry=="function")try{window.PTW.initRegistry(!0)}catch{}if(window.PTW&&typeof window.PTW.getPermitMetricsDataset=="function"){window.PTW._metricsDatasetCache=null;const n=window.PTW.getPermitMetricsDataset(),o=Array.isArray(n?.source)?n.source:[];if(o.length>0)return o.map(f=>({...f,status:this.normalizePTWStatus(f?.status)}))}const r=Array.isArray(AppState?.appData?.ptw)&&AppState.appData.ptw.length>0?AppState.appData.ptw:Array.isArray(t?.ptw)?t.ptw:[],a=Array.isArray(AppState?.appData?.ptwRegistry)&&AppState.appData.ptwRegistry.length>0?AppState.appData.ptwRegistry:Array.isArray(t?.ptwRegistry)?t.ptwRegistry:[],i=e(a),s=new Map;return r.forEach(n=>{if(!n||!n.id&&!n.permitId&&!n.paperPermitNumber)return;const o=String(n.id||n.permitId||n.paperPermitNumber);s.set(o,{...n,status:this.normalizePTWStatus(n.status)})}),i.forEach(n=>{if(!n||!n.id&&!n.permitId&&!n.paperPermitNumber)return;const o=String(n.id||n.permitId||n.paperPermitNumber);s.set(o,n)}),i.length>0?i:Array.from(s.values())},async load(){this.setupReportsStatisticsCardsClickHandlers();try{this.updateKPIs(),this.updateStats(),this.updateReportsStatistics()}catch{}try{await this.loadReportsWidget()}catch(r){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0643\u0627\u0631\u062A \u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631:",r);try{this.updateKPIs(),this.updateStats()}catch{}}this.loadRecentActivities(),this.loadUserTasksWidget(),this.loadEmployeeReportWidget();try{this.loadCharts()}catch(r){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0631\u0633\u0648\u0645 \u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645:",r)}this.applyDashboardLayoutPermissions(),this.dashboardCan("safety-calendar")&&typeof SafetyCalendar<"u"&&typeof SafetyCalendar.ensureFullCalendarLoaded=="function"&&SafetyCalendar.ensureFullCalendarLoaded().catch(()=>{}),setTimeout(()=>{try{if(typeof SafetyCalendar<"u"&&typeof SafetyCalendar.loadDashboardWidget=="function"){const r=SafetyCalendar.loadDashboardWidget();r&&typeof r.catch=="function"&&r.catch(()=>{})}}catch{}},0),this.dashboardCan("sustainability")&&typeof Sustainability<"u"&&typeof Sustainability.loadResourceConsumptionFromSheets=="function"&&Sustainability.loadResourceConsumptionFromSheets().catch(()=>{});const e=window.AppI18n&&typeof window.AppI18n.applyI18n=="function"?window.AppI18n:window.I18n&&typeof window.I18n.applyI18n=="function"?window.I18n:null;e&&(e.applyI18n(document),e.applyLiteralTranslations(document))},getContractorReportDataSignature(){const t=AppState.appData||{};return["approvedContractors","violations","incidents","clinicVisits","clinicContractorVisits","contractorEvaluations","training","contractorTrainings","ptw","ptwRegistry","injuries"].map(r=>`${r}:${Array.isArray(t[r])?t[r].length:0}`).join("|")},getContractorReportCacheKey(t,e,r){const a=s=>typeof Utils<"u"&&typeof Utils.normalizeContractorIdentityValue=="function"?Utils.normalizeContractorIdentityValue(s):String(s||"").trim().toLowerCase();return[e,t?.code,t?.isoCode,t?.contractorId,t?.id,t?.companyName,t?.name,r].map(a).filter(Boolean).join("|")},renderContractorReportLoading(t,e){const r=document.getElementById("contractor-report-data"),a=document.getElementById("contractor-report-content"),i=document.getElementById("export-contractor-report-btn"),s=document.getElementById("employee-report-content");if(s&&s.classList.add("hidden"),!r||!a)return;const n=String(t?.companyName||t?.name||"").trim(),o=t?.approvalDate?Utils.formatDate(t.approvalDate):"",f=t?.expiryDate?Utils.formatDate(t.expiryDate):"",p=(l,m)=>`
        ...
        `,a.classList.remove("hidden"),i&&(i.disabled=!0)},renderContractorReportFromData(t){const e=document.getElementById("contractor-report-data"),r=document.getElementById("contractor-report-content"),a=document.getElementById("export-contractor-report-btn"),i=document.getElementById("employee-report-content");if(i&&i.classList.add("hidden"),!e||!r||!t)return;const s=t.contractor||{},n=String(t.contractorName||s.companyName||s.name||"").trim(),o=t.contractorCode||s.code||s.isoCode||s.contractorId||s.id||"",f=Array.isArray(t.violations)?t.violations:[],p=Array.isArray(t.incidents)?t.incidents:[],l=Array.isArray(t.training)?t.training:[],m=Array.isArray(t.clinicVisits)?t.clinicVisits:[],g=Array.isArray(t.contractorEvaluations)?t.contractorEvaluations:[],b=Array.isArray(t.ptwContractor)?t.ptwContractor:[],C=typeof t.ptwOpen=="number"?t.ptwOpen:0,y=typeof t.ptwClosed=="number"?t.ptwClosed:0,x=Array.isArray(t.injuriesContractor)?t.injuriesContractor:[],A=s.approvalDate?Utils.formatDate(s.approvalDate):"",T=s.expiryDate?Utils.formatDate(s.expiryDate):"";e.innerHTML=`
            <div class="bg-amber-50 border border-amber-200 rounded-lg p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h3 class="text-xl font-bold text-gray-800 mb-2">
                        ...
                        ${s.entityType?`<p class="text-gray-600 mt-1"><i class="fas fa-tag ml-2"></i>\u0646\u0648\u0639 \u0627\u0644\u0643\u064A\u0627\u0646: ${Utils.escapeHTML(s.entityType)}</p>`:""}
                        ${s.serviceType?`<p class="text-gray-600 mt-1"><i class="fas fa-tools ml-2"></i>\u0646\u0648\u0639 \u0627\u0644\u062E\u062F\u0645\u0629: ${Utils.escapeHTML(s.serviceType)}</p>`:""}
        ...
        `,r.classList.remove("hidden"),a&&(a.disabled=!1),window.currentContractorReport=t},async prefetchReportStatsSheetsForDashboard(t={}){const e=t&&t.forceRefresh===!0;try{if(!AppState||!AppState.appData||typeof GoogleIntegration>"u"||typeof GoogleIntegration.batchReadFromSheets!="function"||typeof GoogleIntegration._isBackendRpcConfigured!="function"||!GoogleIntegration._isBackendRpcConfigured())return;const r=300*1e3,a=Date.now(),i=this._reportStatsSheetsFetchedInSession===!0;if(!e&&i&&typeof this._reportStatsSheetsFetchedAt=="number"&&a-this._reportStatsSheetsFetchedAt<r)return;const s=[];this.dashboardCan("violations")&&(s.push(["Violations","violations"]),s.push(["ViolationApprovalRequests","violationApprovalRequests"])),this.dashboardCan("training")&&s.push(["Training","training"]),this.dashboardCan("ppe")&&s.push(["PPE","ppe"]),this.dashboardCan("behavior-monitoring")&&s.push(["BehaviorMonitoring","behaviorMonitoring"]),this.dashboardCan("clinic")&&(s.push(["SickLeave","sickLeave"]),s.push(["Medications","medications"]),s.push(["ClinicInventory","clinicInventory"])),this.dashboardCan("incidents")&&(s.push(["Incidents","incidents"]),s.push(["IncidentsRegistry","incidentsRegistry"])),this.dashboardCan("ptw")&&(s.push(["PTW","ptw"]),s.push(["PTWRegistry","ptwRegistry"])),this.dashboardCan("employees")&&(s.push(["Employees","employees"]),s.push(["ExternalWorkforceMonthly","externalWorkforceMonthly"]),s.push(["ApprovedContractors","approvedContractors"]));const n=[];if(s.forEach(([p])=>{n.includes(p)||n.push(p)}),n.length===0){this._reportStatsSheetsFetchedAt=a;return}const o=await GoogleIntegration.batchReadFromSheets(n,{timeout:45e3,batchSize:12}),f=o&&o.data&&typeof o.data=="object"?o.data:{};s.forEach(([p,l])=>{const m=f[p];Array.isArray(m)&&(AppState.appData[l]=m)}),this._reportStatsSheetsFetchedAt=a,this._reportStatsSheetsFetchedInSession=!0;try{this.updateStats(),this.updateReportsStatistics()}catch{}if(typeof window.DataManager<"u"&&window.DataManager.save)try{window.DataManager.save()}catch{}}catch(r){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062C\u0644\u0628 \u0623\u0648\u0631\u0627\u0642 \u0625\u062D\u0635\u0627\u0626\u064A\u0627\u062A \u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645:",r)}},async loadReportsWidget(t){const e=t===!0||t&&t.forceRefresh===!0,r=document.getElementById("dashboard-reports-widget");if(!r){try{await Promise.allSettled([this.prefetchClinicVisitsForDashboard({forceRefresh:e}),this.prefetchReportStatsSheetsForDashboard({forceRefresh:e})]),this.updateKPIs(),this.updateStats()}catch(s){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062C\u0644\u0628 \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645 \u0628\u062F\u0648\u0646 \u062D\u0627\u0648\u064A\u0629 \u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631:",s)}return}const a=this,i=async s=>{try{const n=await a.calculateStatsAsync(s||AppState.appData||{}),o=a.dashboardCan("clinic")?await a.getExpiringMedicationsAsync(s||{}):[];if(!document.contains(r))return;r.innerHTML=a.renderReportsWidget(n,o),a.animateStatCards(r),a.setupReportsWidgetEvents(r),a.applyDashboardLayoutPermissions();try{a.updateKPIs(),a.updateStats(),a.updateReportsStatistics()}catch{}}catch(n){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("dashboard render error:",n)}};try{const s=this.prefetchClinicVisitsForDashboard({forceRefresh:e});typeof Clinic<"u"&&typeof Clinic.prefetchClinicTimeOffApprovalsForAdminIfNeeded=="function"&&Clinic.prefetchClinicTimeOffApprovalsForAdminIfNeeded().catch(()=>{}),await i(AppState.appData||{}),this.prefetchReportStatsSheetsForDashboard({forceRefresh:e}).then(()=>i(AppState.appData)).catch(n=>{typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("dashboard prefetch failed:",n)}),s.then(()=>i(AppState.appData)).catch(n=>{typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("dashboard clinic visits prefetch failed:",n)})}catch(s){Utils.safeError("dashboard load error:",s),r.innerHTML=`
                <div class="content-card">
                    <div class="card-body">
        ...
        `},_isClinicContractorLikeVisit(t){if(!t||typeof t!="object")return!1;const e=String(t.personType||"").toLowerCase();return!!(e==="contractor"||e==="external"||String(t.contractorName||"").trim()||String(t.externalName||"").trim()||String(t.contractorWorkerName||"").trim())},getClinicVisitsTotalCount(t){if(!t||typeof t!="object")return 0;const e=Array.isArray(t.clinicVisits)?t.clinicVisits:[],r=Array.isArray(t.clinicContractorVisits)?t.clinicContractorVisits:[],a=Array.isArray(t.Clinic)?t.Clinic:[];if(typeof Clinic<"u"&&Clinic._visitsBackendFetchOk===!0&&e.length>0)return e.length;const s=e.some(o=>this._isClinicContractorLikeVisit(o));if(e.length>0&&s)return e.length;let n=e.length+r.length;return n===0&&a.length>0&&(n=a.length),n},prefetchClinicVisitsForDashboard(t={}){const e=t&&t.forceRefresh===!0;return!AppState||!AppState.appData||typeof this.dashboardCan=="function"&&!this.dashboardCan("clinic")||typeof GoogleIntegration>"u"||typeof GoogleIntegration.sendRequest!="function"||typeof GoogleIntegration._isBackendRpcConfigured=="function"&&!GoogleIntegration._isBackendRpcConfigured()||typeof Clinic>"u"||typeof Clinic.loadVisitsDataFromBackend!="function"||(e&&(this._clinicVisitsPrefetchedInSession=!1,this._clinicVisitsPrefetchPromise=null,Clinic._visitsBackendFetchOk=!1),!e&&this._clinicVisitsPrefetchedInSession===!0)?Promise.resolve():!e&&typeof Clinic.shouldFetchClinicVisitsFromBackend=="function"&&!Clinic.shouldFetchClinicVisitsFromBackend({forceRefresh:e})?(this._clinicVisitsPrefetchedInSession=!0,Promise.resolve()):this._clinicVisitsPrefetchPromise?this._clinicVisitsPrefetchPromise:(this._clinicVisitsPrefetchPromise=Clinic.loadVisitsDataFromBackend({forceRefresh:e}).then(()=>{this._clinicVisitsPrefetchedInSession=!0,typeof Clinic.prefetchClinicTimeOffApprovalsForAdminIfNeeded=="function"&&Clinic.prefetchClinicTimeOffApprovalsForAdminIfNeeded().catch(()=>{})}).catch(r=>{typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0627\u0644\u0643\u0627\u0645\u0644 \u0644\u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645:",r)}).finally(()=>{this._clinicVisitsPrefetchPromise=null}),this._clinicVisitsPrefetchPromise)},async calculateStatsAsync(t){return new Promise(e=>{const r=()=>{const i=this._getDashboardIncidentsRecords(t).length;e({incidents:i,training:(t.training||[]).length,ptw:(t.ptw||[]).length,violations:(t.violations||[]).length,sickLeave:(t.sickLeave||[]).length,ppe:(t.ppe||[]).length,behaviorMonitoring:(t.behaviorMonitoring||[]).length,clinicVisits:this.getClinicVisitsTotalCount(t)})};window.requestIdleCallback?window.requestIdleCallback(r,{timeout:500}):setTimeout(r,50)})},async getExpiringMedicationsAsync(t){return new Promise(e=>{const r=()=>{const a=t.clinicMedications||t.clinicInventory||[],i=new Date,s=a.filter(n=>{if(!n||!n.expiryDate)return!1;const o=new Date(n.expiryDate);if(Number.isNaN(o.getTime()))return!1;const f=Math.ceil((o-i)/(1e3*60*60*24)),l=parseFloat(n.remainingQuantity??n.quantityAdded??n.quantity??0)>0;return f>=0&&f<=30&&l}).sort((n,o)=>{const f=new Date(n.expiryDate||0),p=new Date(o.expiryDate||0);return f-p});e(s)};window.requestIdleCallback?window.requestIdleCallback(r,{timeout:500}):setTimeout(r,50)})},renderReportsWidget(t,e){const r=new Date,a=[{id:"violations",key:"violations",labelKey:"dash.violations",labelFb:"\u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0627\u062A",icon:"fa-ban",color:"yellow",module:"violations"},{id:"sickLeave",key:"sickLeave",labelKey:"dash.sickLeaves",labelFb:"\u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0631\u0636\u064A\u0629",icon:"fa-calendar-times",color:"blue",module:"clinic"},{id:"training",key:"training",labelKey:"dash.trainingPrograms",labelFb:"\u0628\u0631\u0627\u0645\u062C \u0627\u0644\u062A\u062F\u0631\u064A\u0628",icon:"fa-graduation-cap",color:"green",module:"training"},{id:"ppe",key:"ppe",labelKey:"dash.ppeEquipment",labelFb:"\u0645\u0647\u0645\u0627\u062A \u0627\u0644\u0648\u0642\u0627\u064A\u0629",icon:"fa-hard-hat",color:"orange",module:"ppe"},{id:"behaviorMonitoring",key:"behaviorMonitoring",labelKey:"dash.behaviorMonitoring",labelFb:"\u0645\u0631\u0627\u0642\u0628\u0629 \u0627\u0644\u0633\u0644\u0648\u0643\u064A\u0627\u062A",icon:"fa-user-check",color:"purple",module:"behavior-monitoring"},{id:"clinicVisits",key:"clinicVisits",labelKey:"dash.clinicVisits",labelFb:"\u0627\u0644\u062A\u0631\u062F\u062F \u0639\u0644\u0649 \u0627\u0644\u0639\u064A\u0627\u062F\u0629",icon:"fa-hospital",color:"pink",module:"clinic"},{id:"incidents",key:"incidents",labelKey:"dash.incidents",labelFb:"\u0627\u0644\u062D\u0648\u0627\u062F\u062B",icon:"fa-exclamation-triangle",color:"red",module:"incidents"}];let i=0;const s=a.filter(g=>this.dashboardCan(g.module)).map(g=>{const b=typeof t[g.key]=="number"?t[g.key]:0,C=this.renderStatCard(g.id,b,this.t(g.labelKey,g.labelFb),g.icon,g.color,i);return i+=100,C}).join(""),n=this.dashboardCan("incidents"),o=this.dashboardCan("training"),f=typeof Permissions<"u"&&typeof Permissions.isCurrentUserEffectiveAdmin=="function"?Permissions.isCurrentUserEffectiveAdmin():!1,p=[n?`
                            ...
                            </button>`:""].join(""),l=s.trim()?`<div class="stats-cards-grid" id="reports-stats-grid">${s}</div>`:`<p class="text-gray-500 text-sm px-2">${this.t("dash.noStatsForPermissions","\u0644\u0627 \u062A\u0648\u062C\u062F \u0625\u062D\u0635\u0627\u0626\u064A\u0627\u062A \u0633\u0631\u064A\u0639\u0629 \u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0635\u0644\u0627\u062D\u064A\u0627\u062A\u0643 \u0627\u0644\u062D\u0627\u0644\u064A\u0629.")}</p>`,m=this.dashboardCan("clinic")?this.renderMedicationsAlerts(e,r):"";return`
        ...
        `},renderMedicationsAlerts(t,e){if(!(t&&t.length>0))return`
            ...
            `;const i=t.filter(s=>{const n=s.expiryDate?new Date(s.expiryDate):null;return n&&n<e}).length>0?"linear-gradient(135deg, #ef4444, #dc2626)":"linear-gradient(135deg, #f59e0b, #d97706)";return`
            <div class="medications-alerts-section" style="border-top: 1px dashed var(--border-color); padding-top: 1.75rem; margin-top: 2rem;">
                <!-- \u0627\u0644\u0647\u064A\u062F\u0631 -->
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.25rem; flex-wrap: wrap; gap: 0.75rem;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        <span style="padding: 0.45rem 0.9rem; border-radius: 20px; font-weight: 700; font-size: 0.82rem; background: ${i}; color: #ffffff; box-shadow: 0 4px 12px rgba(245, 158, 11, 0.3); display: flex; align-items: center; gap: 0.4rem;">
                            ...
                            <div class="medication-alert-item" style="opacity: 0; transform: translateY(10px); animation: slideInUp 0.35s ease ${n*60}ms forwards; background: ${p.bgTint}; border: 1px solid var(--border-color); border-radius: 14px; padding: 1.1rem 1.25rem; display: flex; align-items: center; justify-content: space-between; transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.03);">
                                ...
                                <div style="flex: 1; min-width: 0; padding-right: 0.6rem;">
                                    <div style="font-size: 0.98rem; font-weight: 700; color: var(--text-primary); margin-bottom: 0.4rem; line-height: 1.35; display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap;">
                                        ...
                                        ${s.batchNumber?`<span style="font-size: 0.72rem; font-weight: 600; padding: 0.15rem 0.45rem; border-radius: 6px; background: var(--bg-hover); color: var(--text-secondary); border: 1px solid var(--border-color);">\u062A\u0634\u063A\u064A\u0644\u0629 #${Utils.escapeHTML(s.batchNumber)}</span>`:""}
                                    </div>
                                    <div style="font-size: 0.82rem; color: var(--text-secondary); display: flex; align-items: center; gap: 1.25rem; flex-wrap: wrap;">
                                        <span style="display: flex; align-items: center; gap: 0.4rem;">
                                            ...
                                            <strong style="font-weight: 600;">\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621:</strong> ${s.expiryDate?Utils.formatDate(s.expiryDate):"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}
                                        </span>
                                        ${m?`
        ...
        `},animateStatCards(t){const e=t.querySelectorAll(".reports-stat-card"),r=t.querySelectorAll(".enhanced-stat-card"),a=[...e,...r],i=this;a.forEach((s,n)=>{if(s.dataset.animated==="true")return;s.dataset.animated="true";let o=null;s.classList.contains("enhanced-stat-card")||(s.addEventListener("mouseenter",function(){o&&cancelAnimationFrame(o),o=requestAnimationFrame(()=>{this.style.transform="translateY(-8px) scale(1.02)",this.style.boxShadow="0 12px 24px rgba(0,0,0,0.15)",this.style.transition="transform 0.3s cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.3s ease";const p=this.querySelector(".stat-card-top-bar");p&&(p.style.height="6px",p.style.transition="height 0.3s ease");const l=this.querySelector(".stat-card-icon");l&&(l.style.transform="scale(1.1) rotate(5deg)",l.style.transition="transform 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)")})},{passive:!0}),s.addEventListener("mouseleave",function(){o&&cancelAnimationFrame(o),o=requestAnimationFrame(()=>{this.style.transform="",this.style.boxShadow="";const p=this.querySelector(".stat-card-top-bar");p&&(p.style.height="");const l=this.querySelector(".stat-card-icon");l&&(l.style.transform="")})},{passive:!0}));const f=s.querySelector(".stat-value-number");if(f){const p=parseInt(s.dataset.statValue)||0;i.animateValue(f,0,p,1e3+n*100)}}),this.setupStatCardsClickHandlers(t)},animateValue(t,e,r,a){let i=null;const s=n=>{i||(i=n);const o=Math.min((n-i)/a,1),f=Math.floor(o*(r-e)+e);t.textContent=f.toLocaleString("en-US"),o<1&&window.requestAnimationFrame(s)};window.requestAnimationFrame(s)},setupReportsWidgetEvents(t){const e=t.querySelector("#refresh-reports-btn");e&&e.addEventListener("click",async()=>{const a=e.querySelector("i");a&&(a.style.transform="rotate(360deg)",setTimeout(()=>{a.style.transform="rotate(0deg)"},500)),await this.loadReportsWidget({forceRefresh:!0})}),t.querySelectorAll(".report-export-btn").forEach(a=>{a.addEventListener("click",()=>{const i=a.dataset.reportType;typeof Reports<"u"&&Reports.generateAndExport?Reports.generateAndExport(i):Notification.warning("\u0646\u0638\u0627\u0645 \u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631 \u063A\u064A\u0631 \u0645\u062A\u0627\u062D \u062D\u0627\u0644\u064A\u0627\u064B")}),a.addEventListener("mouseenter",function(){this.style.transform="translateY(-2px)",this.style.boxShadow="0 4px 12px rgba(0,0,0,0.1)"}),a.addEventListener("mouseleave",function(){this.style.transform="translateY(0)",this.style.boxShadow=""})}),this.setupStatCardsClickHandlers(t)},setupReportsStatisticsCardsClickHandlers(){const t=document.querySelector(".reports-statistics-section");if(!t)return;t.querySelectorAll('.metric-card-frame[data-clickable="true"]').forEach(r=>{r.dataset.clickHandlerAdded!=="true"&&(r.dataset.clickHandlerAdded="true",r.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation();const i=r.getAttribute("data-stat-id");if(!i)return;const s=this.getModuleNameFromStatId(i);if(!s)return;if(!(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"?Permissions.hasAccess(s):(AppState?.currentUser?.role||"").toLowerCase()==="admin")){typeof Notification<"u"&&typeof Notification.warning=="function"?Notification.warning("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0647\u0630\u0627 \u0627\u0644\u0642\u0633\u0645"):alert("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0647\u0630\u0627 \u0627\u0644\u0642\u0633\u0645");return}typeof UI<"u"&&typeof UI.showSection=="function"?UI.showSection(s):typeof window<"u"&&window.location&&(window.location.hash=s)}))})},setupStatCardsClickHandlers(t){t.querySelectorAll('.enhanced-stat-card[data-clickable="true"]').forEach(r=>{r.dataset.clickHandlerAdded!=="true"&&(r.dataset.clickHandlerAdded="true",r.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation();const i=r.getAttribute("data-stat-id");if(!i)return;const s=this.getModuleNameFromStatId(i);if(!s)return;if(!(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"?Permissions.hasAccess(s):(AppState?.currentUser?.role||"").toLowerCase()==="admin")){typeof Notification<"u"&&typeof Notification.warning=="function"?Notification.warning("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0647\u0630\u0627 \u0627\u0644\u0642\u0633\u0645"):alert("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0647\u0630\u0627 \u0627\u0644\u0642\u0633\u0645");return}typeof UI<"u"&&typeof UI.showSection=="function"?UI.showSection(s):typeof window<"u"&&window.location&&(window.location.hash=s)}))})},loadEmployeeReportWidget(){const t=document.getElementById("employee-report-widget");if(!t)return;const e=this.dashboardCan("employees"),r=this.dashboardCan("contractors");if(!e&&!r){t.innerHTML="",t.hidden=!0;return}t.hidden=!1;const a=e&&r?this.t("dash.queryComprehensiveReport","\u0627\u0644\u0627\u0633\u062A\u0639\u0644\u0627\u0645 - \u062A\u0642\u0631\u064A\u0631 \u0634\u0627\u0645\u0644 (\u0645\u0648\u0638\u0641 / \u0645\u0642\u0627\u0648\u0644)"):e?this.t("dash.queryEmployeeReport","\u0627\u0644\u0627\u0633\u062A\u0639\u0644\u0627\u0645 - \u062A\u0642\u0631\u064A\u0631 \u0645\u0648\u0638\u0641"):this.t("dash.queryContractorReport","\u0627\u0644\u0627\u0633\u062A\u0639\u0644\u0627\u0645 - \u062A\u0642\u0631\u064A\u0631 \u0645\u0642\u0627\u0648\u0644"),i=e?`
        ...
        `,e){const n=document.getElementById("search-employee-btn"),o=document.getElementById("export-employee-report-btn"),f=document.getElementById("employee-code-search");n&&n.addEventListener("click",async()=>{const p=f?.value.trim();p?await this.generateEmployeeReport(p):Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A")}),f&&f.addEventListener("keypress",async p=>{if(p.key==="Enter"){const l=f.value.trim();l&&await this.generateEmployeeReport(l)}}),o&&o.addEventListener("click",()=>{const p=f?.value.trim();p&&this.exportEmployeeReportPDF(p)})}if(r){const n=document.getElementById("search-contractor-btn"),o=document.getElementById("export-contractor-report-btn"),f=document.getElementById("contractor-code-search");n&&n.addEventListener("click",async()=>{const p=f?.value.trim();p?await this.generateContractorReport(p):Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0643\u0648\u062F \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u0623\u0648 \u0627\u0633\u0645 \u0627\u0644\u0634\u0631\u0643\u0629")}),f&&f.addEventListener("keypress",async p=>{if(p.key==="Enter"){const l=f.value.trim();l&&await this.generateContractorReport(l)}}),o&&o.addEventListener("click",()=>{const p=f?.value.trim();p&&this.exportContractorReportPDF(p)})}},async ensureEmployeeReportData(){AppState.appData||(AppState.appData={});const t=AppState.appData,e={Violations:"violations",Training:"training",TrainingAttendance:"trainingAttendance",ClinicVisits:"clinicVisits",PPE:"ppe",BehaviorMonitoring:"behaviorMonitoring",Incidents:"incidents",SickLeave:"sickLeave"},r=[];for(const[a,i]of Object.entries(e)){const s=t[i];(!Array.isArray(s)||s.length===0)&&r.push({sheetName:a,key:i})}typeof Loading<"u"&&Loading.show&&Loading.show();try{for(const{sheetName:a,key:i}of r)try{if(typeof GoogleIntegration>"u"||!GoogleIntegration.readFromSheets)continue;const s=await GoogleIntegration.readFromSheets(a);if(Array.isArray(s)){const n=Array.isArray(AppState.appData[i])?AppState.appData[i]:[];s.length===0&&n.length>0?Utils.safeLog&&Utils.safeLog(`\u26A0\uFE0F \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641: ${a} \u0641\u0627\u0631\u063A - \u0627\u0644\u0627\u062D\u062A\u0641\u0627\u0638 \u0628\u0627\u0644\u0645\u062D\u0644\u064A`):(AppState.appData[i]=s,Utils.safeLog&&Utils.safeLog(`\u2705 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641: \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${a} (${s.length} \u0633\u062C\u0644)`))}}catch(s){Utils.safeWarn&&Utils.safeWarn(`\u26A0\uFE0F \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641: \u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 ${a}:`,s?.message||s)}if((!t.training||t.training.length===0)&&typeof GoogleIntegration<"u"&&(GoogleIntegration.sendToAppsScript||GoogleIntegration.sendRequest))try{const a=GoogleIntegration.sendToAppsScript||(n=>GoogleIntegration.sendRequest&&GoogleIntegration.sendRequest({action:n.action||n.method,data:n.data||{}})),i=await(GoogleIntegration.sendToAppsScript?GoogleIntegration.sendToAppsScript("getAllTrainings",{}):Promise.resolve(GoogleIntegration.sendRequest({action:"getAllTrainings",data:{}}))),s=i&&(i.data||i.value)&&(Array.isArray(i.data)?i.data:Array.isArray(i.value)?i.value:Array.isArray((i.value||{}).data)?(i.value||{}).data:null);Array.isArray(s)&&s.length>0&&(AppState.appData.training=s,Utils.safeLog&&Utils.safeLog("\u2705 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641: \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062A\u062F\u0631\u064A\u0628 \u0639\u0628\u0631 getAllTrainings"))}catch(a){Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641: \u0641\u0634\u0644 getAllTrainings:",a?.message||a)}if((!t.trainingAttendance||t.trainingAttendance.length===0)&&typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest)try{const a=await GoogleIntegration.sendRequest({action:"getAllTrainingAttendance",data:{}}),i=a&&a.value&&Array.isArray(a.value.data)&&a.value.data?a.value.data:a&&Array.isArray(a.data)?a.data:Array.isArray(a&&a.value)?a.value:null;Array.isArray(i)&&(AppState.appData.trainingAttendance=i,Utils.safeLog&&Utils.safeLog("\u2705 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641: \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631 \u0639\u0628\u0631 getAllTrainingAttendance"))}catch(a){Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641: \u0641\u0634\u0644 getAllTrainingAttendance:",a?.message||a)}if(e.PPE&&(!t.ppe||t.ppe.length===0)&&typeof GoogleIntegration<"u"&&GoogleIntegration.sendToAppsScript)try{const a=await GoogleIntegration.sendToAppsScript("getAllPPE",{});a&&a.success&&Array.isArray(a.data)&&(AppState.appData.ppe=a.data,Utils.safeLog&&Utils.safeLog("\u2705 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641: \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 PPE \u0639\u0628\u0631 getAllPPE"))}catch(a){Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641: \u0641\u0634\u0644 getAllPPE:",a?.message||a)}}finally{typeof Loading<"u"&&Loading.hide&&Loading.hide()}},async ensureContractorReportData(){AppState.appData||(AppState.appData={});const t=AppState.appData,e={Violations:"violations",Incidents:"incidents",SickLeave:"sickLeave",ClinicVisits:"clinicVisits",ClinicContractorVisits:"clinicContractorVisits",ContractorEvaluations:"contractorEvaluations",Training:"training",ContractorTrainings:"contractorTrainings",PTW:"ptw",PTWRegistry:"ptwRegistry",Injuries:"injuries",ClinicContractorInjuries:"clinicContractorInjuries"},r=[];for(const[a,i]of Object.entries(e)){const s=t[i];(!Array.isArray(s)||s.length===0)&&r.push({sheetName:a,key:i})}if(r.length){typeof Loading<"u"&&Loading.show&&Loading.show();try{for(const{sheetName:a,key:i}of r)try{if(typeof GoogleIntegration>"u"||!GoogleIntegration.readFromSheets)continue;const s=await GoogleIntegration.readFromSheets(a);Array.isArray(s)&&(AppState.appData[i]=s,Utils.safeLog&&Utils.safeLog(`\u2705 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644: \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${a} (${s.length} \u0633\u062C\u0644)`))}catch(s){Utils.safeWarn&&Utils.safeWarn(`\u26A0\uFE0F \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644: \u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 ${a}:`,s?.message||s)}}finally{typeof Loading<"u"&&Loading.hide&&Loading.hide()}}},async generateEmployeeReport(t){AppState.appData||(AppState.appData={});const e=AppState.appData,r=Array.isArray(e.employees)?e.employees:Array.isArray(e.Employees)?e.Employees:[];let a=null;const i=String(t||"").trim(),s=(d,h)=>{if(!h)return!1;const $=String(h).trim();if(!$)return!1;const w=String(d.employeeNumber??"").trim(),k=String(d.sapId??"").trim(),M=String(d.employeeCode??"").trim(),R=String(d.id??"").trim(),W=String(d.code??"").trim();if(w===$||k===$||M===$||R===$||W===$||w.toLowerCase()===$.toLowerCase()||k.toLowerCase()===$.toLowerCase())return!0;const _=Number($);return!!(!isNaN(_)&&isFinite(_)&&(Number(w)===_||Number(k)===_||Number(M)===_||Number(R)===_||Number(W)===_||String(Number(w))===$||String(Number(k))===$||w===String(_)||k===String(_)))};if(a=r.find(d=>s(d,t)),!a){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0647\u0630\u0627 \u0627\u0644\u0643\u0648\u062F");const d=document.getElementById("employee-report-content");d&&d.classList.add("hidden");return}const n=d=>{if(!d)return null;const h=String(d).trim();return h?h.toLowerCase():null},o=new Set;if([a.id,a.employeeNumber,a.sapId,a.employeeCode,a.code,a.cardId,a.nationalId].forEach(d=>{if(d==null||d==="")return;const h=String(d).trim();if(!h)return;const $=n(d);$&&o.add($),o.add(h);const w=Number(d);!isNaN(w)&&isFinite(w)&&o.add(String(w))}),i){o.add(i),o.add(i.toLowerCase());const d=Number(i);!isNaN(d)&&isFinite(d)&&o.add(String(d))}const f=d=>d?[d.employeeCode,d.employeeNumber,d.employeeId,d.id,d.code,d.sapId,d.cardId,d.nationalId,d.participantCode].some($=>{if($==null||$==="")return!1;const w=String($).trim();if(!w)return!1;const k=n($);if(o.has(k)||o.has(w))return!0;const M=Number($);return!!(!isNaN(M)&&isFinite(M)&&o.has(String(M)))}):!1,p=d=>{if(d==null||d==="")return!1;const h=String(d).trim();if(!h)return!1;if(o.has(h)||o.has(n(h)))return!0;const $=Number(d);return!isNaN($)&&isFinite($)&&o.has(String($))};await this.ensureEmployeeReportData();const l=AppState.appData||{},m=(d,h)=>{const $=l[d]||l[h]||[];return Array.isArray($)?$:[]},g=m("violations").filter(d=>d.personType==="contractor"||d.contractorName?!1:f(d)),b=m("sickLeave").filter(d=>d.personType==="contractor"||d.contractorName?!1:f(d)),C=m("training").concat(m("trainingRecords")),x=m("trainingAttendance").filter(d=>f(d)),A=d=>{if(!d||typeof d!="object")return!1;const h={...d,code:d.code||d.participantCode,employeeCode:d.employeeCode||d.participantCode,employeeNumber:d.employeeNumber||d.participantCode};if((d.employeeCode!=null&&d.employeeCode!==""||d.employeeNumber!=null&&d.employeeNumber!==""||d.employeeId!=null&&d.employeeId!==""||d.participantCode!=null&&d.participantCode!=="")&&f(h))return!0;let $=d.participants;if(typeof $=="string")try{const w=JSON.parse($);$=Array.isArray(w)?w:w&&Array.isArray(w.participants)?w.participants:[]}catch{$=[]}return $&&Array.isArray($)?$.some(w=>!w||typeof w!="object"||w.personType==="contractor"||w.type==="contractor"||w.contractorName?!1:f(w)):!1},v=[...C.filter(A),...x.map(d=>({id:d.id,name:d.topic||d.trainingType||"\u062A\u062F\u0631\u064A\u0628",trainer:d.trainer||"",startDate:d.date||d.attendanceDate||d.createdAt,status:"\u0645\u0643\u062A\u0645\u0644"}))],I=m("ppe").filter(d=>f(d)),N=m("behaviorMonitoring").filter(d=>f(d)),L=m("clinicVisits","Clinic").filter(d=>d.personType==="contractor"||d.contractorName?!1:f(d)),u=m("incidents").filter(d=>d.personType==="contractor"||d.contractorName?!1:!!(f(d)||d.affectedCode&&p(d.affectedCode)||d.entries&&Array.isArray(d.entries)&&d.entries.some(h=>f(h)||p(h?.affectedCode||h?.employeeCode)))),S=document.getElementById("employee-report-data"),U=document.getElementById("employee-report-content"),P=document.getElementById("export-employee-report-btn"),E=document.getElementById("contractor-report-content");if(E&&E.classList.add("hidden"),U&&U.classList.add("hidden"),!S){Notification.error("\u0639\u0646\u0635\u0631 \u0639\u0631\u0636 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631");return}S.innerHTML=`
...
<style id="dashboard-arabic-pdf-fix">
    ...
    table, thead, tbody, tr, th, td { direction: rtl !important; }
</style>`,r=this._stripScriptsFromHtml_(t);return r?r.includes("</head>")?r.replace("</head>",`${e}</head>`):`<!DOCTYPE html><html lang="ar" dir="rtl"><head><meta charset="UTF-8">${e}</head><body>${r}</body></html>`:e},async _waitArabicPdfFontsReady_(t){if(!(!t||!t.fonts||typeof t.fonts.load!="function"))try{await Promise.all([t.fonts.load("400 12px Cairo"),t.fonts.load("600 14px Cairo"),t.fonts.load("700 18px Cairo"),t.fonts.load("800 24px Cairo")]),await t.fonts.ready}catch{}},async _captureHtmlToCanvas_(t,e={}){const a={scale:this._getAdaptivePdfCanvasScale_(t,e.scale||2.5),backgroundColor:"#ffffff",logging:!1,windowWidth:Math.max(t.scrollWidth,900),windowHeight:Math.max(t.scrollHeight,1),scrollX:0,scrollY:0},i=[{...a,useCORS:!0,allowTaint:!1},{...a,useCORS:!0,allowTaint:!0},{...a,useCORS:!1,allowTaint:!0}];let s=null;for(let n=0;n<i.length;n++)try{const o=await html2canvas(t,i[n]);if(o&&o.width>0&&o.height>0)return o}catch(o){s=o}if(s)throw s;return null},async _downloadHtmlReportAsPdf(t,e="report.pdf"){if(!await this._ensureReportPdfLibs_()||typeof html2canvas>"u"||!window.jspdf)return!1;await this._preloadCairoFontForPdf_();const a=this._prepareArabicPdfHtml_(t),i=String(e||"report.pdf").toLowerCase().endsWith(".pdf")?String(e):`${String(e)}.pdf`,s=document.createElement("iframe");s.setAttribute("aria-hidden","true"),s.style.cssText="position:fixed;left:-100000px;top:0;width:900px;height:1200px;border:0;visibility:hidden;",document.body.appendChild(s);try{s.srcdoc=a,await new Promise(m=>{s.onload=m,s.onerror=m,setTimeout(m,6e3)});const n=s.contentDocument||s.contentWindow?.document;if(!n)return!1;await this._waitArabicPdfFontsReady_(n);const o=Array.from(n.images||[]);await Promise.all(o.map(m=>new Promise(g=>{if(m.complete)return g();m.onload=g,m.onerror=g,setTimeout(g,3e3)})));const f=n.querySelector(".report-wrapper")||n.body;if(!f)return!1;const p=await this._captureHtmlToCanvas_(f);if(!p)return!1;const l=Utils.PdfExport.createPdf({orientation:"portrait",unit:"mm",format:"a4"});return l?(Utils.PdfExport.appendCanvasAsPdfPages(l,p,{marginMm:8}),Utils.PdfExport.savePdf(l,i),!0):!1}catch(n){return Utils.safeWarn&&Utils.safeWarn("\u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u062A\u0642\u0631\u064A\u0631 PDF:",n),!1}finally{s.remove()}},_getAdaptivePdfCanvasScale_(t,e=2.5){const r=Math.max(t?.scrollHeight||0,1),a=Math.max(t?.scrollWidth||900,900),i=14e3,s=9e7;let n=Number(e)||2.5;for(;n>.85&&(a*n>i||r*n>i||a*r*n*n>s);)n-=.25;return Math.max(.85,Math.round(n*100)/100)},_buildPdfSectionTable_(t,e,r,a,i,s,n){const o=Array.isArray(i)?i:[],f=Math.max(1,Number(n)||50),p=o.slice(0,f),l=Math.max(0,o.length-p.length),m=p.map(s).join(""),g=o.length?l>0?` (${o.length} \u2014 \u0639\u0631\u0636 ${p.length} \u0641\u064A PDF)`:` (${o.length})`:"";return t(`${e}${g}`,r,a,m)},_getContractorClinicVisitDisplayName_(t){return!t||typeof t!="object"?"":String(t.contractorWorkerName||t.personName||t.employeeName||t.externalName||t.name||"").replace(/\s+/g," ").trim()},buildEmployeeReportPdfContent(t,e){const r=t.employee||{},a=this._AR_PDF_TEXT_STYLE_,i=u=>Utils.escapeHTML(String(u??"")),s=u=>u&&typeof Utils.formatDate=="function"?Utils.formatDate(u):"",n=r.employeeNumber||r.sapId||r.employeeCode||e||"",o=r.name||"\u2014",f=o.trim().split(/\s+/).slice(0,2).map(u=>u.charAt(0)).join("")||"\u0645",p=s(new Date)||new Date().toLocaleDateString("ar-SA"),l=(u,S,U,P,E,H)=>`
            <div style="flex:1 1 140px;min-width:120px;padding:14px 12px;border-radius:12px;background:${U};border:1px solid ${P};text-align:center;">
                <div style="font-size:11px;color:${E};font-weight:600;margin-bottom:6px;${a}">${i(u)}</div>
                ...
                <div style="margin:28px 0 16px;direction:rtl;">
                    <h3 dir="rtl" style="font-size:16px;margin:0 0 12px;color:${S};font-weight:700;border-right:4px solid ${S};padding-right:12px;${a}">${i(u)}</h3>
                    <table dir="rtl" style="width:100%;border-collapse:collapse;${a}">
                        <thead><tr style="background:${S};color:#FFFFFF;">${U.map(E=>`<th dir="rtl" style="${m(S)}">${i(E)}</th>`).join("")}</tr></thead>
                        <tbody>${P}</tbody>
                </table>
                </div>`:"",y=(t.violations||[]).map(u=>`
            <tr>
                <td style="${g}">${i(u.violationType)}</td>
                <td style="${b}">${s(u.violationDate)}</td>
                <td style="${b}">${i(u.severity)}</td>
                <td style="${g}">${i(u.actionTaken)}</td>
                <td style="${b}">${i(u.status)}</td>
            </tr>`).join(""),x=(t.sickLeave||[]).map(u=>`
            <tr>
                <td style="${b}">${s(u.startDate)}</td>
                <td style="${b}">${s(u.endDate)}</td>
                <td style="${g}">${i(u.reason)}</td>
                <td style="${g}">${i(u.medicalNotes)}</td>
            </tr>`).join(""),A=(t.training||[]).map(u=>`
            <tr>
                <td style="${g}">${i(u.name)}</td>
                <td style="${g}">${i(u.trainer)}</td>
                <td style="${b}">${s(u.startDate)}</td>
                <td style="${b}">${i(u.status)}</td>
            </tr>`).join(""),T=(t.ppe||[]).map(u=>`
            <tr>
                <td style="${b}">${i(u.receiptNumber||u.id)}</td>
                <td style="${g}">${i(u.equipmentType)}</td>
                <td style="${b}">${u.quantity!=null?u.quantity:0}</td>
                <td style="${b}">${s(u.receiptDate)}</td>
                <td style="${b}">${i(u.status)}</td>
            </tr>`).join(""),v=(t.behaviorMonitoring||[]).map(u=>`
            <tr>
                <td style="${g}">${i(u.behaviorType)}</td>
                <td style="${b}">${u.rating!=null?`${u.rating}/5`:"\u2014"}</td>
                <td style="${b}">${s(u.date)}</td>
                <td style="${g}">${i(u.description)}</td>
            </tr>`).join(""),I=(t.clinicVisits||[]).map(u=>`
            <tr>
                <td style="${b}">${s(u.visitDate)}</td>
                <td style="${g}">${i(u.reason||"\u0632\u064A\u0627\u0631\u0629 \u0639\u0627\u062F\u064A\u0629")}</td>
                <td style="${g}">${i(u.diagnosis)}</td>
                <td style="${g}">${i(u.treatment)}</td>
            </tr>`).join(""),N=(t.incidents||[]).map(u=>`
            <tr>
                <td style="${b}">${s(u.incidentDate||u.date||u.createdAt)}</td>
                <td style="${g}">${i(String(u.title||u.description||"").substring(0,120))}</td>
                <td style="${b}">${i(u.severity)}</td>
                <td style="${b}">${i(u.status)}</td>
            ...
            <div style="direction:rtl;margin-bottom:24px;">
                <div style="display:flex;align-items:center;gap:18px;padding:20px 22px;border-radius:16px;background:linear-gradient(135deg,#eff6ff 0%,#dbeafe 100%);border:1px solid #93c5fd;">
                    <div style="width:72px;height:72px;border-radius:50%;background:linear-gradient(135deg,#2563eb,#1d4ed8);color:#fff;display:flex;align-items:center;justify-content:center;font-size:24px;font-weight:800;flex-shrink:0;box-shadow:0 8px 20px rgba(37,99,235,0.25);${a}">${i(f)}</div>
                    <div style="flex:1;min-width:0;">
                        <h2 dir="rtl" style="margin:0 0 8px;font-size:22px;font-weight:800;color:#1e3a8a;${a}">${i(o)}</h2>
                        <div style="display:flex;flex-wrap:wrap;gap:8px 20px;font-size:12px;color:#334155;${a}">
                            <span><strong style="color:#1e40af;">\u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A:</strong> ${i(n)}</span>
                            ${r.department?`<span><strong style="color:#1e40af;">\u0627\u0644\u0642\u0633\u0645:</strong> ${i(r.department)}</span>`:""}
                            ${r.position?`<span><strong style="color:#1e40af;">\u0627\u0644\u0645\u0646\u0635\u0628:</strong> ${i(r.position)}</span>`:""}
                        </div>
                    </div>
                    <div style="text-align:left;font-size:11px;color:#64748b;line-height:1.7;flex-shrink:0;${a}">
                        <div><strong>\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062A\u0642\u0631\u064A\u0631:</strong> ${i(p)}</div>
        ...
        `},buildContractorReportPdfContent(t){const e=t.contractor||{},r=this._AR_PDF_TEXT_STYLE_,a=u=>Utils.escapeHTML(String(u??"")),i=u=>u&&typeof Utils.formatDate=="function"?Utils.formatDate(u):"",s=t.contractorName||e.companyName||e.name||"\u2014",n=t.contractorCode||e.code||e.isoCode||"",o=s.trim().split(/\s+/).slice(0,2).map(u=>u.charAt(0)).join("")||"\u0645",f=i(new Date)||new Date().toLocaleDateString("ar-SA"),p=t.ptwOpen!=null?t.ptwOpen:0,l=t.ptwClosed!=null?t.ptwClosed:0,m=Array.isArray(t.ptwContractor)?t.ptwContractor:[],g=Array.isArray(t.injuriesContractor)?t.injuriesContractor:[],b=(u,S,U,P,E,H)=>`
            <div style="flex:1 1 140px;min-width:120px;padding:14px 12px;border-radius:12px;background:${U};border:1px solid ${P};text-align:center;">
                ...
                </div>`:"",T=this.CONTRACTOR_REPORT_PDF_MAX_SECTION_ROWS||50,v=(u,S,U,P,E)=>this._buildPdfSectionTable_(A,u,S,U,P,E,T),I=m.length+(t.violations?.length||0)+(t.incidents?.length||0)+g.length+(t.training?.length||0)+(t.clinicVisits?.length||0)+(t.contractorEvaluations?.length||0),N=e.approvalDate?i(e.approvalDate):"",L=e.expiryDate?i(e.expiryDate):"";return`
            <div style="direction:rtl;margin-bottom:24px;">
                <div style="display:flex;align-items:center;gap:18px;padding:20px 22px;border-radius:16px;background:linear-gradient(135deg,#fffbeb 0%,#fef3c7 100%);border:1px solid #fcd34d;">
                    ...
                    <div style="flex:1;min-width:0;">
                        <h2 dir="rtl" style="margin:0 0 8px;font-size:22px;font-weight:800;color:#92400e;${r}">${a(s)}</h2>
            ...
            <tr>
                <td style="${x}">${i(u.incidentDate||u.date||u.createdAt)}</td>
            ...
            <tr>
                ...
                <td style="${x}">${i(u.injuryDate||u.date||u.createdAt)}</td>
            ...
            <tr>
                ...
                <td style="${x}">${i(u.evaluationDate)}</td>
        ...
        `,Q.classList.remove("hidden"),rt&&(rt.disabled=!1);const X={__cacheKey:T,__signature:v,__cachedAt:Date.now(),contractor:n,contractorCode:p,contractorName:o,violations:E,incidents:h,training:at,clinicVisits:R,contractorEvaluations:B,ptwContractor:O,ptwOpen:K,ptwClosed:Y,injuriesContractor:it};window.currentContractorReport=X,this.contractorReportCache.set(T,X),this.contractorReportRequests.delete(I),typeof L=="function"&&L(X)},async exportContractorReportPDF(t){const e=String(t||"").trim(),r=window.currentContractorReport;(!r||!this.contractorReportMatchesSearchCode(r,e))&&await this.generateContractorReport(e);const a=window.currentContractorReport;if(!a){Notification.error("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u062A\u0642\u0631\u064A\u0631 \u0644\u0644\u0645\u0642\u0627\u0648\u0644");return}try{Loading.show("\u062C\u0627\u0631\u064A \u0625\u0639\u062F\u0627\u062F \u0648\u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062A\u0642\u0631\u064A\u0631...");const i=a.contractorName||"",s=String(a.contractorCode||e).replace(/[\\/:*?"<>|]/g,"_"),n=`CON-REPORT-${s}-${new Date().toISOString().slice(0,10)}`,o=`\u062A\u0642\u0631\u064A\u0631 \u0634\u0627\u0645\u0644 \u0644\u0644\u0645\u0642\u0627\u0648\u0644: ${i}`,f=this.buildContractorReportPdfContent(a),p=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(n,o,f,!1,!1,{titleAr:o,titleEn:"Comprehensive Contractor Report",compactPdfFooter:!0,includeQRCode:!1},new Date,new Date):`<html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body>${f}</body></html>`,l=`\u062A\u0642\u0631\u064A\u0631-\u0645\u0642\u0627\u0648\u0644-${s}-${new Date().toISOString().slice(0,10)}.pdf`,m=await this._downloadHtmlReportAsPdf(p,l);Loading.hide(),m?Notification.success("\u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u0628\u0635\u064A\u063A\u0629 PDF \u0628\u0646\u062C\u0627\u062D"):Notification.error("\u062A\u0639\u0630\u0651\u0631 \u0625\u0646\u0634\u0627\u0621 \u0645\u0644\u0641 PDF. \u0623\u0639\u062F \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0628\u0639\u062F \u0639\u0631\u0636 \u0627\u0644\u062A\u0642\u0631\u064A\u0631 \u0623\u0648\u0644\u0627\u064B.")}catch(i){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 PDF:",i),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF: "+(i&&i.message?i.message:String(i)))}},_getDashboardIncidentsRecords(t){const e=t&&typeof t=="object"?t:{},r=Array.isArray(e.incidents)?e.incidents.filter(Boolean):[];if(r.length>0){const s=new Set;return r.filter(n=>{const o=String(n.id||n.incidentId||"").trim();return!o||s.has(o)?!1:(s.add(o),!0)})}const a=Array.isArray(e.incidentsRegistry)?e.incidentsRegistry.filter(Boolean):[],i=new Set;return a.filter(s=>{const n=String(s.incidentId||s.id||s.registryId||"").trim();return!n||i.has(n)?!1:(i.add(n),!0)})},_classifyIncidentYearForDashboard(t,e){if(!t||typeof t!="object")return"unknown";const r=t.year!=null?t.year:t.incidentYear;if(r!=null&&String(r).trim()!==""){const o=String(r).trim();if(/^0+$/.test(o))return"unknown";const f=parseInt(o,10);return!Number.isFinite(f)||f<=0||f>e+5?"unknown":f===e?"current":"prior"}const i=t.incidentDate||t.date||t.createdAt;if(!i)return"unknown";const s=new Date(i);if(isNaN(s.getTime()))return"unknown";const n=s.getFullYear();return n<=0||n<1900||n>e+5||n>e?"unknown":n===e?"current":"prior"},workHoursIncludeContractors(){const t=typeof localStorage<"u"?localStorage.getItem("hse_work_hours_include_contractors"):null;return t===null||String(t).trim()===""?!0:t!=="0"&&String(t).toLowerCase()!=="false"&&String(t).toLowerCase()!=="no"},getDashboardTotalWorkHours(t){const e=typeof localStorage<"u"?localStorage.getItem("hse_total_work_hours"):null;if(e!=null&&String(e).trim()!==""){const s=parseFloat(String(e).replace(/,/g,""));if(Number.isFinite(s)&&s>0)return s}const r=t&&typeof t=="object"?t:{},a=Array.isArray(r.employees)?r.employees:[],i=Array.isArray(r.approvedContractors)?r.approvedContractors:[];return this._computeEstimatedAnnualWorkHoursTotal(a,i)},_getDashboardWorkforceCount(t){const e=t&&typeof t=="object"?t:{},r=Array.isArray(e.employees)?e.employees:[],a=Array.isArray(e.approvedContractors)?e.approvedContractors:[],i=r.filter(n=>n&&!this._isEmployeeInactive(n)).length,s=this.workHoursIncludeContractors()?this._sumContractorWorkforceHeadcount(a,e):0;return i+s},_getDaysSinceLastIncidentForDashboard(t){const e=t&&typeof t=="object"?t:{},r=new Date(2026,0,1).getTime(),a=Date.now(),s=680+Math.max(0,Math.floor((a-r)/(1e3*60*60*24))),n=this._getDashboardIncidentsRecords(e).filter(m=>m&&(m.incidentDate||m.date||m.createdAt));if(n.length===0)return s;const o=n.slice().sort((m,g)=>{const b=new Date(m.incidentDate||m.date||m.createdAt);return new Date(g.incidentDate||g.date||g.createdAt)-b}),f=new Date(o[0].incidentDate||o[0].date||o[0].createdAt),p=new Date;p.setHours(0,0,0,0),f.setHours(0,0,0,0);const l=Math.floor((p-f)/(1e3*60*60*24));return Math.max(0,l)},getDashboardSafeWorkingHours(t){const e=typeof localStorage<"u"?localStorage.getItem("hse_safe_working_hours")||localStorage.getItem("hse_total_work_hours"):null;if(e!=null&&String(e).trim()!==""){const g=parseFloat(String(e).replace(/,/g,""));if(Number.isFinite(g)&&g>=0)return Math.round(g)}const r=t&&typeof t=="object"?t:{},a=new Date(2026,0,1).getTime(),i=Date.now(),n=125e4+Math.max(0,Math.floor((i-a)/(1e3*60*60*24)))*1408,o=this._getDaysSinceLastIncidentForDashboard(r);if(o===null||o>=680)return n;const f=this._getDashboardWorkforceCount(r),p=this._parseNumWorkHours(typeof localStorage<"u"?localStorage.getItem("hse_hours_per_day"):null),l=!isNaN(p)&&p>0?p:8,m=Math.max(0,f)*l;return Math.round(Math.max(0,o)*m)},_parseNumWorkHours(t){if(t==null||t==="")return NaN;const e=parseFloat(String(t).replace(/,/g,""));return Number.isFinite(e)?e:NaN},_getDashboardDefaultAnnualHoursPerCapita(){const t=this._parseNumWorkHours(typeof localStorage<"u"?localStorage.getItem("hse_hours_per_day"):null),e=this._parseNumWorkHours(typeof localStorage<"u"?localStorage.getItem("hse_work_days_per_month"):null),r=this._parseNumWorkHours(typeof localStorage<"u"?localStorage.getItem("hse_work_months_per_year"):null),a=!isNaN(t)&&t>0?t:8,i=!isNaN(e)&&e>0?e:22,s=!isNaN(r)&&r>0?r:12;return a*i*s},_isEmployeeInactive(t){if(!t)return!1;const e=t.status!=null&&t.status!==""?String(t.status).trim():"";return!!((t.resignationDate!=null&&t.resignationDate!==""?String(t.resignationDate).trim():"")||e==="inactive"||e.toLowerCase()==="inactive"||e==="\u063A\u064A\u0631 \u0646\u0634\u0637")},_sumContractorWorkforceHeadcount(t,e){const r=e&&typeof e=="object"?e:typeof AppState<"u"&&AppState.appData?AppState.appData:{},a=Array.isArray(r.externalWorkforceMonthly)?r.externalWorkforceMonthly:[],i=new Date().getFullYear(),s=["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"],n=a.filter(p=>p&&Number(p.year)===i);if(n.length>0){let p=0;if(n.forEach(l=>{const m=parseFloat(l.total);Number.isFinite(m)&&m>0?p+=Math.round(m):s.forEach(g=>{const b=parseFloat(l[g]);Number.isFinite(b)&&b>0&&(p+=Math.round(b))})}),p>0)return p}if(!Array.isArray(t)||t.length===0)return 0;const o=["workerCount","workersCount","laborCount","manpower","employeesCount","totalWorkers","averageWorkers","contractorWorkers","numberOfWorkers","expectedWorkers","workforceCount"];let f=0;return t.forEach(p=>{if(!p||typeof p!="object"||p.active===!1||p.deactivated===!0||p.isActive==="inactive"||p.isActive===!1||p.isActive==="false"||p.isActive==="FALSE")return;let l=NaN;for(let m=0;m<o.length;m++){const g=this._parseNumWorkHours(p[o[m]]);if(!isNaN(g)&&g>0){l=g;break}}isNaN(l)||(f+=Math.round(l))}),f===0?t.filter(l=>l&&l.active!==!1&&l.deactivated!==!0&&l.isActive!=="inactive"&&l.isActive!==!1&&l.isActive!=="false"&&l.isActive!=="FALSE").length:f},_computeEstimatedAnnualWorkHoursTotal(t,e){const r=Array.isArray(t)?t.filter(l=>l&&!this._isEmployeeInactive(l)):[],a=r.length,i=this._getDashboardDefaultAnnualHoursPerCapita(),s=l=>{const m=["annualWorkHours","yearlyWorkHours","workHoursYear","annualHours","estimatedAnnualHours","totalAnnualHours"];for(let C=0;C<m.length;C++){const y=this._parseNumWorkHours(l[m[C]]);if(!isNaN(y)&&y>0)return y}const g=this._parseNumWorkHours(l.monthlyHours??l.monthlyWorkHours??l.workHoursMonth);if(!isNaN(g)&&g>0)return g*12;const b=this._parseNumWorkHours(l.weeklyHours??l.hoursPerWeek??l.workHoursWeek);return!isNaN(b)&&b>0?b*52:null};let n=0,o=0;r.forEach(l=>{const m=s(l);m!=null&&(n+=m,o+=1)});let f=0;a>0&&(o===0?f=a*i:f=n+(a-o)*i);let p=0;return this.workHoursIncludeContractors()&&(p=this._sumContractorWorkforceHeadcount(e,AppState.appData)*i),Math.round(f+p)},_updateKpiElement(t,e){if(!t||e==null)return;const r=String(e);t.textContent!==r&&(t.textContent=r,this.applyEnglishNumberFormat(t))},updateKPIs(){const t=AppState.appData;if(!t){Utils.safeWarn("\u26A0\uFE0F AppState.appData \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631");return}const e=AppState.syncMeta?.userEmail?String(AppState.syncMeta.userEmail).trim().toLowerCase():"",r=AppState.currentUser?.email?String(AppState.currentUser.email).trim().toLowerCase():"";if(e&&r&&e!==r){Utils.safeWarn("\u26A0\uFE0F \u0628\u064A\u0627\u0646\u0627\u062A KPI \u0645\u0646 \u062C\u0644\u0633\u0629 \u0645\u0633\u062A\u062E\u062F\u0645 \u0633\u0627\u0628\u0642 \u2014 \u062A\u062E\u0637\u064A \u0627\u0644\u062A\u062D\u062F\u064A\u062B"),typeof Notification<"u"&&typeof Notification.warning=="function"&&Notification.warning("\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629 \u0644\u0627 \u062A\u0637\u0627\u0628\u0642 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0627\u0644\u062D\u0627\u0644\u064A \u2014 \u062C\u0627\u0631\u064A \u0625\u0639\u0627\u062F\u0629 \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629..."),typeof GoogleIntegration<"u"&&typeof GoogleIntegration.syncData=="function"&&GoogleIntegration.syncData({silent:!0,showLoader:!1,notifyOnSuccess:!1,notifyOnError:!1}).catch(()=>{});return}try{const a=Array.isArray(t.incidents)?t.incidents:[],i=Array.isArray(t.users)?t.users:[],s=this.getUnifiedPTWDataset(t),n=Array.isArray(t.nearmiss)?t.nearmiss:[],o=Array.isArray(t.employees)?t.employees:[],f=this._getDashboardIncidentsRecords(t),p=f.length,l=new Date().getFullYear();let m=0,g=0;f.forEach($=>{const w=this._classifyIncidentYearForDashboard($,l);w==="current"?m+=1:w==="prior"&&(g+=1)});const b=i.filter($=>$&&$.active!==!1).length,C=s.filter($=>!this.isPTWClosedStatus($?.status)).length,y=s.filter($=>this.isPTWClosedStatus($?.status)).length,x=s.length,A=this.dashboardCan("incidents"),T=this.dashboardCan("nearmiss"),v=A?a:[],I=T?n:[],N=v.length+I.length,L=v.filter($=>$&&($.status==="\u0645\u063A\u0644\u0642"||$.status==="\u0645\u062D\u0644\u0648\u0644")).length,u=I.filter($=>$&&($.correctiveProposed===!1||$.status==="\u0645\u063A\u0644\u0642"||$.status==="\u0645\u062D\u0644\u0648\u0644")).length,S=N>0?Math.round((L+u)/N*100):A||T?100:0,U=S>=90?"kpi-value text-green-600":S>=70?"kpi-value text-yellow-600":"kpi-value text-red-600",P=this.getDashboardTotalWorkHours(t),E=this.getDashboardSafeWorkingHours(t);let H="N/A";if(A){const $=this._getDaysSinceLastIncidentForDashboard(t);$!==null&&(H=$>=0?this.formatNumber($):"0")}const d=this.getReportsStatisticsUpdates(),h=this;(function(){try{if(h.dashboardCan("incidents")){const w=document.getElementById("total-incidents");h._updateKpiElement(w,h.formatNumber(p));const k=document.getElementById("dash-incidents-label-current"),M=document.getElementById("dash-incidents-num-current"),R=document.getElementById("dash-incidents-num-prior"),W=`${h.t("dash.incidentsCurrentYear","\u062D\u0648\u0627\u062F\u062B \u0627\u0644\u0639\u0627\u0645 \u0627\u0644\u062D\u0627\u0644\u064A")} (${l}):`;k&&k.textContent!==W&&(k.textContent=W),h._updateKpiElement(M,h.formatNumber(m)),h._updateKpiElement(R,h.formatNumber(g))}if(h.dashboardCan("users")){const w=document.getElementById("active-users");w&&(w.textContent=h.formatNumber(b),h.applyEnglishNumberFormat(w))}if(h.dashboardCan("ptw")){const w=document.getElementById("open-ptw-count");w&&(w.textContent=h.formatNumber(C),h.applyEnglishNumberFormat(w));const k=document.getElementById("closed-ptw-count");k&&(k.textContent=h.formatNumber(y),h.applyEnglishNumberFormat(k));const M=document.getElementById("total-ptw-count");M&&(M.textContent=h.formatNumber(x),h.applyEnglishNumberFormat(M));const R=document.getElementById("active-ptw");R&&(R.textContent=h.formatNumber(C),h.applyEnglishNumberFormat(R))}if(A||T){const w=document.getElementById("compliance-rate");w&&(w.textContent=S+"%",w.className=U)}if(h.dashboardCan("employees")){const w=document.getElementById("total-work-hours");w&&(w.textContent=h.formatNumber(P),h.applyEnglishNumberFormat(w));const k=document.getElementById("safe-working-hours");k&&(k.textContent=h.formatNumber(E),h.applyEnglishNumberFormat(k));const M=document.getElementById("dash-kpi-employees-active-count");if(M){const W=o.filter(_=>_&&!h._isEmployeeInactive(_)).length;M.textContent=h.formatNumber(W),h.applyEnglishNumberFormat(M)}const R=document.getElementById("dash-kpi-contractors-active-count");if(R){const W=Array.isArray(t.approvedContractors)?t.approvedContractors:[],_=h._sumContractorWorkforceHeadcount(W,t);h._updateKpiElement(R,h.formatNumber(_)),(!Array.isArray(t.externalWorkforceMonthly)||t.externalWorkforceMonthly.length===0)&&typeof GoogleIntegration<"u"&&typeof GoogleIntegration.readFromSheets=="function"&&GoogleIntegration.readFromSheets("ExternalWorkforceMonthly",15e3).then(V=>{Array.isArray(V)&&V.length>0?AppState.appData.externalWorkforceMonthly=V:Array.isArray(AppState.appData.externalWorkforceMonthly)||(AppState.appData.externalWorkforceMonthly=[]);const B=h._sumContractorWorkforceHeadcount(W,AppState.appData);h._updateKpiElement(document.getElementById("dash-kpi-contractors-active-count"),h.formatNumber(B))}).catch(()=>{})}}if(h.dashboardCan("training")){const w=document.getElementById("dash-kpi-training-programs"),k=Array.isArray(t.training)?t.training:[];h._updateKpiElement(w,h.formatNumber(k.length))}if(h.dashboardCan("clinic")){const w=document.getElementById("dash-kpi-clinic-visits-total");w&&(w.textContent=h.formatNumber(h.getClinicVisitsTotalCount(t)),h.applyEnglishNumberFormat(w))}if(A){const w=document.getElementById("days-without-injury");w&&(w.textContent=H,h.applyEnglishNumberFormat(w))}h.dashboardCan("incidents")&&h.calculateSafetyMetrics(t),d&&d.length&&h.applyReportsStatisticsUpdates(d),document.querySelector(".safety-metrics-section")?.classList.add("kpis-values-ready"),document.querySelector(".reports-statistics-section")?.classList.add("kpis-values-ready"),document.getElementById("dashboard-section")?.classList.add("kpi-grid-values-ready")}catch(w){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B KPIs:",w)}})()}catch(a){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B KPIs:",a)}},calculateSafetyMetrics(t=null){try{if(!this.dashboardCan("incidents"))return;if(typeof HseMetrics>"u"||!HseMetrics.getDashboardSnapshot){Utils.safeWarn("\u26A0\uFE0F HseMetrics \u063A\u064A\u0631 \u0645\u062D\u0645\u0651\u0644 \u2014 \u062A\u062E\u0637\u064A \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0633\u0644\u0627\u0645\u0629");return}const e=t&&typeof t=="object"?t:typeof AppState<"u"&&AppState.appData?AppState.appData:{},r=HseMetrics.getDashboardSnapshot(e),a=r.rates||{},i=(n,o)=>{const f=document.getElementById(n);f&&f.textContent!==o&&(f.textContent=o,this.applyEnglishNumberFormat(f))};i("trir-value",this.formatMetricRate(a.trir,2)),i("afr-value",this.formatMetricRate(a.afr,2)),i("far-value",this.formatMetricRate(a.far,4)),i("fr-value",this.formatMetricRate(a.fr,2)),i("lti-value",this.formatNumber(a.ltiCount||0)),i("sr-value",this.formatMetricRate(a.sr,2)),i("ir-value",this.formatMetricRate(a.ir,2));const s=r.totals?.manDays??0;i("man-days-value",this.formatNumber(s)),typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u{1F4CA} \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0633\u0644\u0627\u0645\u0629 (HseMetrics YTD):",{year:r.year,ytdLimit:r.ytdLimit,totals:r.totals,rates:r.rates})}catch(e){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062D\u0633\u0627\u0628 \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0633\u0644\u0627\u0645\u0629:",e)}},refreshIncidents(){this.updateKPIs()},loadRecentActivities(){const t=document.getElementById("recent-activities");if(t)try{if(!AppState||!AppState.appData){t.innerHTML=`
                    <div class="empty-state">
                        <i class="fas fa-exclamation-triangle text-4xl text-yellow-500 mb-4"></i>
                        <p class="text-yellow-600">\u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A...</p>
                    </div>
                `;return}const e=[],r=AppState.appData;if(this.dashboardCan("incidents")&&(Array.isArray(r.incidents)?r.incidents:[]).forEach(i=>{if(i)try{const s=i.createdAt||i.date;if(!s)return;const n=new Date(s);if(isNaN(n.getTime()))return;const o=i.incidentType||i.title||i.type||"\u062D\u0627\u062F\u062B";e.push({type:"incident",title:`\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u062D\u0627\u062F\u062B: ${o}`,date:n,time:this.getTimeAgo(s),icon:"fa-exclamation-triangle",color:"text-red-500"})}catch(s){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u062D\u0627\u062F\u062B:",s)}}),this.dashboardCan("nearmiss")&&(Array.isArray(r.nearmiss)?r.nearmiss:[]).forEach(i=>{if(i)try{const s=i.createdAt||i.date||i.reportDate;if(!s)return;const n=new Date(s);if(isNaN(n.getTime()))return;const o=i.title||i.description||i.type||"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643";e.push({type:"nearmiss",title:`\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643: ${o}`,date:n,time:this.getTimeAgo(s),icon:"fa-triangle-exclamation",color:"text-orange-500"})}catch(s){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643:",s)}}),this.dashboardCan("ptw")&&this.getUnifiedPTWDataset(r).forEach(i=>{if(i)try{const s=i.createdAt||i.startDate||i.issueDate;if(!s)return;const n=new Date(s);if(isNaN(n.getTime()))return;const o=i.permitNumber||i.workDescription||i.location||"\u062A\u0635\u0631\u064A\u062D \u0639\u0645\u0644";e.push({type:"ptw",title:`\u062A\u0635\u0631\u064A\u062D \u0639\u0645\u0644: ${o}`,date:n,time:this.getTimeAgo(s),icon:"fa-id-card",color:"text-blue-500"})}catch(s){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u062A\u0635\u0631\u064A\u062D:",s)}}),this.dashboardCan("training")&&(Array.isArray(r.training)?r.training:[]).forEach(i=>{if(i)try{const s=i.createdAt||i.startDate||i.date;if(!s)return;const n=new Date(s);if(isNaN(n.getTime()))return;const o=i.programName||i.courseName||i.title||"\u0628\u0631\u0646\u0627\u0645\u062C \u062A\u062F\u0631\u064A\u0628\u064A";e.push({type:"training",title:`\u062A\u062F\u0631\u064A\u0628: ${o}`,date:n,time:this.getTimeAgo(s),icon:"fa-graduation-cap",color:"text-green-500"})}catch(s){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u062A\u062F\u0631\u064A\u0628:",s)}}),this.dashboardCan("violations")&&(Array.isArray(r.violations)?r.violations:[]).forEach(i=>{if(i)try{const s=i.createdAt||i.date||i.violationDate;if(!s)return;const n=new Date(s);if(isNaN(n.getTime()))return;const o=i.description||i.type||i.category||"\u0645\u062E\u0627\u0644\u0641\u0629";e.push({type:"violation",title:`\u0645\u062E\u0627\u0644\u0641\u0629: ${o}`,date:n,time:this.getTimeAgo(s),icon:"fa-ban",color:"text-pink-500"})}catch(s){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u0645\u062E\u0627\u0644\u0641\u0629:",s)}}),this.dashboardCan("periodic-inspections")&&(Array.isArray(r.dailySafetyCheckList)?r.dailySafetyCheckList:[]).forEach(i=>{if(i)try{const s=i.createdAt||i.date;if(!s)return;const n=new Date(s);if(isNaN(n.getTime()))return;const o=i.siteName||i.siteId||"\u0645\u0648\u0642\u0639";e.push({type:"daily-safety-checklist",title:`\u0645\u0631\u0648\u0631 \u064A\u0648\u0645\u064A \u0644\u0644\u0633\u0644\u0627\u0645\u0629: ${o} - ${i.shift||""}`,date:n,time:this.getTimeAgo(s),icon:"fa-clipboard-check",color:"text-cyan-500"})}catch(s){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u0627\u0644\u0645\u0631\u0648\u0631 \u0627\u0644\u064A\u0648\u0645\u064A:",s)}}),e.sort((a,i)=>!a.date||!i.date?0:i.date-a.date),e.length===0){t.innerHTML=`
                    <div class="empty-state">
        ...
        `;try{if(typeof AppState>"u"||!AppState.appData){t.innerHTML=`
                ...
                `;return}const r=e.id||e.email;let a=[];if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendToAppsScript)try{const o=await GoogleIntegration.sendToAppsScript("getUserTasksByUserId",{userId:r});o&&o.success&&o.data&&(a=Array.isArray(o.data)?o.data:[])}catch(o){const f=String(o?.message||"").toLowerCase();!f.includes("circuit breaker")&&!f.includes("google apps script \u063A\u064A\u0631 \u0645\u0641\u0639\u0644")&&!f.includes("\u063A\u064A\u0631 \u0645\u0641\u0639\u0644")&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062C\u0644\u0628 \u0627\u0644\u0645\u0647\u0627\u0645 \u0645\u0646 API:",o)}if(a.length===0){const o=AppState.appData.userTasks||[],f=e.id||e.email;a=o.filter(p=>{const l=p.userId||p.assignedTo||p.assignedUserId;return l===f||l===e.email})}a.sort((o,f)=>{if(o.status!=="\u0645\u0643\u062A\u0645\u0644"&&f.status==="\u0645\u0643\u062A\u0645\u0644")return-1;if(o.status==="\u0645\u0643\u062A\u0645\u0644"&&f.status!=="\u0645\u0643\u062A\u0645\u0644")return 1;const p={\u0639\u0627\u0644\u064A\u0629:3,\u0645\u062A\u0648\u0633\u0637\u0629:2,\u0645\u0646\u062E\u0641\u0636\u0629:1},l=p[o.priority]||0,m=p[f.priority]||0;return l!==m?m-l:o.dueDate&&f.dueDate?new Date(o.dueDate)-new Date(f.dueDate):o.dueDate?-1:f.dueDate?1:o.createdAt&&f.createdAt?new Date(f.createdAt)-new Date(o.createdAt):0});const i=a.slice(0,5);if(i.length===0){t.innerHTML=`
                    <div class="empty-state">
                        <i class="fas fa-tasks text-4xl text-gray-300 mb-4"></i>
                        <p class="text-gray-500">${this.t("dash.noTasks","\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0647\u0627\u0645")}</p>
                    </div>
                `;return}const s=o=>{switch(o){case"\u0645\u0643\u062A\u0645\u0644":case"\u0645\u0643\u062A\u0645\u0644\u0629":case"completed":return{icon:"fa-check-circle",color:"text-green-500",bgColor:"bg-green-100"};case"\u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630":case"\u0641\u064A \u0627\u0644\u0639\u0645\u0644":case"in-progress":return{icon:"fa-spinner",color:"text-blue-500",bgColor:"bg-blue-100"};case"\u0645\u0639\u0644\u0642\u0629":case"pending":return{icon:"fa-pause-circle",color:"text-yellow-500",bgColor:"bg-yellow-100"};case"\u0645\u0644\u063A\u0627\u0629":case"cancelled":return{icon:"fa-times-circle",color:"text-red-500",bgColor:"bg-red-100"};default:return{icon:"fa-circle",color:"text-gray-500",bgColor:"bg-gray-100"}}},n=o=>{switch(o){case"\u0639\u0627\u0644\u064A\u0629":case"high":return"text-red-600";case"\u0645\u062A\u0648\u0633\u0637\u0629":case"medium":return"text-yellow-600";case"\u0645\u0646\u062E\u0641\u0636\u0629":case"low":return"text-green-600";default:return"text-gray-600"}};t.innerHTML=i.map(o=>{const f=s(o.status),p=n(o.priority),l=o.dueDate?new Date(o.dueDate):null,m=l&&l<new Date&&o.status!=="\u0645\u0643\u062A\u0645\u0644"&&o.status!=="\u0645\u0643\u062A\u0645\u0644\u0629";let g="";if(l){const C=l-new Date,y=Math.ceil(C/(1e3*60*60*24));m?g=`<span class="text-red-600 font-semibold">\u0645\u062A\u0623\u062E\u0631\u0629 ${Math.abs(y)} \u064A\u0648\u0645</span>`:y===0?g='<span class="text-orange-600 font-semibold">\u0627\u0644\u064A\u0648\u0645</span>':y===1?g='<span class="text-yellow-600 font-semibold">\u063A\u062F\u0627\u064B</span>':y<=7?g=`<span class="text-gray-600">\u062E\u0644\u0627\u0644 ${y} \u0623\u064A\u0627\u0645</span>`:g=`<span class="text-gray-500">${y} \u064A\u0648\u0645 \u0645\u062A\u0628\u0642\u064A</span>`}return`
            ...
            `}},updateStats(){const t=AppState.appData;if(t)try{const e=new Date,r=new Date(e.getTime()-10080*60*1e3),a=this.getUnifiedPTWDataset(t),i=Array.isArray(t.training)?t.training:[],s=this._getDashboardIncidentsRecords(t),n=this.dashboardCan("incidents")?s.filter(b=>{if(!b)return!1;const C=b.incidentDate||b.date||b.createdAt;if(!C)return!1;try{const y=new Date(C);return!isNaN(y.getTime())&&y>r}catch{return!1}}).length:0,o=this.dashboardCan("ptw")?a.filter(b=>!this.isPTWClosedStatus(b?.status)).length:0,f=this.dashboardCan("training")?i.filter(b=>{if(!b||!b.status)return!1;const C=String(b.status).toLowerCase();return C==="\u0645\u0643\u062A\u0645\u0644"||C==="\u0645\u0646\u062A\u0647\u064A"||C==="completed"||C==="finished"}).length:0,p=document.getElementById("week-incidents"),l=document.getElementById("open-ptw"),m=document.getElementById("completed-training"),g=document.getElementById("days-without-incident");if(this.dashboardCan("incidents")&&p&&(p.textContent=this.formatNumber(n),this.applyEnglishNumberFormat(p)),this.dashboardCan("ptw")&&l&&(l.textContent=this.formatNumber(o),this.applyEnglishNumberFormat(l)),this.dashboardCan("training")&&m&&(m.textContent=this.formatNumber(f),this.applyEnglishNumberFormat(m)),this.dashboardCan("incidents")&&g){const b=this._getDashboardIncidentsRecords(t);if(b.length>0){const C=b.filter(y=>y&&(y.incidentDate||y.date||y.createdAt)).map(y=>new Date(y.incidentDate||y.date||y.createdAt)).filter(y=>!isNaN(y.getTime())).sort((y,x)=>x-y);if(C.length>0){const y=C[0],x=new Date;x.setHours(0,0,0,0),y.setHours(0,0,0,0);const A=Math.floor((x-y)/(1e3*60*60*24));g.textContent=A>=0?this.formatNumber(A):"0"}else g.textContent="0"}else g.textContent="0";this.applyEnglishNumberFormat(g)}}catch(e){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0625\u062D\u0635\u0627\u0626\u064A\u0627\u062A \u0627\u0644\u0633\u0631\u064A\u0639\u0629:",e)}},getReportsStatisticsUpdates(){const t=AppState.appData;if(!t)return null;try{const e=this._getDashboardIncidentsRecords(t),r=Array.isArray(t.nearmiss)?t.nearmiss:[],a=Array.isArray(t.inspections)?t.inspections:[],i=Array.isArray(t.training)?t.training:[],s=Array.isArray(t.violations)?t.violations:[],o=this.getUnifiedPTWDataset(t).length,f=Array.isArray(t.audits)?t.audits:[];let p=0;const l=[];if(this.dashboardCan("incidents")&&(p+=e.length,l.push(["incident-reports-value",e.length,"report"])),this.dashboardCan("nearmiss")&&(p+=r.length,l.push(["nearmiss-reports-value",r.length,"report"])),this.dashboardCan("periodic-inspections")&&(p+=a.length,l.push(["inspections-reports-value",a.length,"report"])),this.dashboardCan("training")&&(p+=i.length,l.push(["training-sessions-value",i.length,"report"])),this.dashboardCan("violations")&&(p+=s.length,l.push(["violations-value",s.length,"report"])),this.dashboardCan("contractors")){const y=Array.isArray(t.approvedContractors)?t.approvedContractors:[];l.push(["approved-contractors-value",this.getUniqueApprovedContractorsCount(y),"report"])}if(this.dashboardCan("ptw")&&(p+=o,l.push(["ptw-reports-value",o,"report"])),this.dashboardCan("iso")&&(p+=f.length,l.push(["audits-value",f.length,"report"])),this.dashboardCan("clinic")){const y=Array.isArray(t.injuries)?t.injuries:[];let x=0,A=0;for(const T of y)String(T&&T.personType||"employee").toLowerCase().trim()==="employee"?x++:A++;l.push(["clinic-injuries-employee-value",x,"report"]),l.push(["clinic-injuries-contractor-value",A,"report"])}this.anyReportsStatisticVisibleForDashboard()&&l.unshift(["total-reports-value",p,"report"]);const m=t.resourceConsumption||{},g=Array.isArray(m.electricity)?m.electricity:[],b=Array.isArray(m.water)?m.water:[],C=Array.isArray(m.gas)?m.gas:[];if(this.dashboardCan("sustainability")){const y=g.reduce((T,v)=>T+(parseFloat(v.totalConsumption)||0),0),x=b.reduce((T,v)=>T+(parseFloat(v.totalConsumption)||0),0),A=C.reduce((T,v)=>T+(parseFloat(v.totalConsumption)||0),0);l.push(["electricity-consumption-value",y,"consumption"],["water-consumption-value",x,"consumption"],["gas-consumption-value",A,"consumption"])}return l}catch(e){return Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062D\u0633\u0627\u0628 \u062A\u062D\u062F\u064A\u062B\u0627\u062A \u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631 \u0648\u0627\u0644\u0625\u062D\u0635\u0627\u0626\u064A\u0627\u062A:",e),null}},getUniqueApprovedContractorsCount(t=[]){if(!Array.isArray(t)||t.length===0)return 0;const e=new Set;return t.forEach(r=>{if(!r)return;const a=String(r.entityType||r.type||"").trim().toLowerCase(),i=String(r.companyName||r.name||"").replace(/\s+/g," ").trim().toLowerCase(),s=String(r.code||r.isoCode||"").replace(/\s+/g," ").trim().toLowerCase(),n=String(r.contractorId||r.id||"").replace(/\s+/g," ").trim().toLowerCase(),o=`${a}::${i||s||n}`;o&&o!==`${a}::`&&e.add(o)}),e.size},applyReportsStatisticsUpdates(t){if(!t||!t.length)return;const e=this;try{t.forEach(function(r){const a=r[0],i=r[1];r[2]==="consumption"?e.updateConsumptionValue(a,i):e.updateReportValue(a,i)})}catch(r){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0642\u064A\u0645 \u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631:",r)}},updateReportsStatistics(){const t=this.getReportsStatisticsUpdates();!t||!t.length||requestAnimationFrame(()=>this.applyReportsStatisticsUpdates(t))},updateReportValue(t,e){if(!t)return;const r=document.getElementById(t);if(!r){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn(`\u26A0\uFE0F \u0627\u0644\u0639\u0646\u0635\u0631 ${t} \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A DOM`);return}try{const a=this.formatNumber(e);r.textContent!==a&&(r.textContent=a),r.dataset.reportFormatted!=="true"&&(r.dataset.reportFormatted="true")}catch(a){Utils.safeWarn(`\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B ${t}:`,a)}},updateConsumptionValue(t,e){if(!t)return;const r=document.getElementById(t);if(!r){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn(`\u26A0\uFE0F \u0627\u0644\u0639\u0646\u0635\u0631 ${t} \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A DOM`);return}try{const a=Number(e),i=isNaN(a)||!isFinite(a)?"0.00":a.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2,useGrouping:!0});r.textContent!==i&&(r.textContent=i);const s=t==="electricity-consumption-value"||t==="gas-consumption-value";r.dataset.consumptionFormatted!=="true"&&(s||(r.setAttribute("dir","ltr"),r.style.direction="ltr",r.style.textAlign="left",r.style.unicodeBidi="embed",r.style.fontVariantNumeric="tabular-nums",r.style.fontFeatureSettings='"tnum"',r.classList.add("english-number")),r.dataset.consumptionFormatted="true")}catch(a){Utils.safeWarn(`\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B ${t}:`,a)}},formatMetricRate(t,e=2){if(typeof HseMetrics<"u"&&HseMetrics.formatRateDisplay)return HseMetrics.formatRateDisplay(t,e);const r=Number(t);return Number.isFinite(r)?r.toLocaleString("en-US",{minimumFractionDigits:e,maximumFractionDigits:e,useGrouping:!0}):"0"},formatNumber(t){if(t==null)return"0";const e=Number(t);return isNaN(e)||!isFinite(e)?"0":e.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0,useGrouping:!0})},applyEnglishNumberFormat(t){if(!t||t.dataset.numberFormatted==="true")return;const e=t.id||"",r=e==="trir-value"||e==="afr-value"||e==="far-value"||e==="fr-value"||e==="lti-value"||e==="sr-value"||e==="ir-value"||e==="man-days-value";try{if(r){t.dataset.numberFormatted="true";return}t.classList.add("english-number"),t.setAttribute("dir","ltr"),t.style.direction="ltr",t.style.textAlign="left",t.style.fontVariantNumeric="tabular-nums",t.dataset.numberFormatted="true"}catch(a){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u062A\u0646\u0633\u064A\u0642 \u0627\u0644\u0623\u0631\u0642\u0627\u0645 \u0627\u0644\u0625\u0646\u062C\u0644\u064A\u0632\u064A\u0629:",a)}},getTimeAgo(t){if(!t)return"\u062A\u0627\u0631\u064A\u062E \u063A\u064A\u0631 \u0645\u062D\u062F\u062F";const e=new Date,r=new Date(t);if(isNaN(r.getTime()))return"\u062A\u0627\u0631\u064A\u062E \u063A\u064A\u0631 \u0635\u062D\u064A\u062D";const a=e-r;if(a<0)return"\u0641\u064A \u0627\u0644\u0645\u0633\u062A\u0642\u0628\u0644";const i=Math.floor(a/6e4),s=Math.floor(i/60),n=Math.floor(s/24);return i<1?"\u0627\u0644\u0622\u0646":i<60?`\u0645\u0646\u0630 ${i} \u062F\u0642\u064A\u0642\u0629`:s<24?`\u0645\u0646\u0630 ${s} \u0633\u0627\u0639\u0629`:`\u0645\u0646\u0630 ${n} \u064A\u0648\u0645`},loadCharts(){let t=document.getElementById("dashboard-charts");if(!t){const y=document.getElementById("dashboard-section");if(y){const x=document.createElement("div");x.id="dashboard-charts",x.className="mt-6",y.appendChild(x),t=x}else return}const e=this.dashboardCan("incidents"),r=this.dashboardCan("ptw"),a=this.dashboardCan("training");if(!e&&!r&&!a){t.innerHTML="",t.classList.remove("dashboard-charts-root");return}t.classList.add("dashboard-charts-root");const i=AppState.appData||{},s=new Date,n=new Date(s.getTime()-720*60*60*1e3),o={},f={},p={},l=y=>{const x=new Date(y);if(isNaN(x.getTime()))return null;const A=x.getFullYear(),T=String(x.getMonth()+1).padStart(2,"0"),v=String(x.getDate()).padStart(2,"0");return`${A}-${T}-${v}`},m=y=>{if(!y)return null;const x=[y.date,y.incidentDate,y.createdAt,y.updatedAt,y.reportDate];for(const A of x){if(!A)continue;const T=new Date(A);if(!isNaN(T.getTime()))return T}return null},g=(i.incidents||[]).filter(y=>{const x=m(y);return x&&x>=n});e&&g.forEach(y=>{const x=l(m(y));x&&(o[x]=(o[x]||0)+1)}),r&&(i.ptw||[]).filter(x=>{const A=new Date(x.createdAt||x.startDate);return!isNaN(A.getTime())&&A>=n}).forEach(x=>{const A=l(x.createdAt||x.startDate);A&&(f[A]=(f[A]||0)+1)}),a&&(i.training||[]).filter(x=>{const A=new Date(x.createdAt||x.startDate);return!isNaN(A.getTime())&&A>=n}).forEach(x=>{const A=l(x.createdAt||x.startDate);A&&(p[A]=(p[A]||0)+1)});const b=[];e&&b.push(`
            <div class="dashboard-charts-grid-row">
                ...
                </div>`,s=e.unknown>0?i("\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",e.unknown,a(e.unknown),"unknown","text-gray-600"):"";return`
            <div class="dash-severity-chart">
                ...
                ${i("\u0639\u0627\u0644\u064A / \u062D\u0631\u062C",e.high,a(e.high),"high","text-red-600")}
                ${i("\u0645\u062A\u0648\u0633\u0637",e.medium,a(e.medium),"medium","text-yellow-600")}
                ${i("\u0645\u0646\u062E\u0641\u0636",e.low,a(e.low),"low","text-green-600")}
                ${s}
            </div>
        `},renderTrendBarList(t,e,r="ptw"){const a=Object.keys(t||{}).sort();if(a.length===0)return`<div class="dash-trend-empty"><p class="dash-trend-empty__text">${this.t("dash.noData30d","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A \u0622\u062E\u0631 30 \u064A\u0648\u0645\u0627\u064B")}</p></div>`;const i=a.slice(-14),s=i.map(m=>t[m]||0),n=s.reduce((m,g)=>m+g,0),o=Math.max(...s,1),f=m=>{const g=m.split("-").map(Number);return g.length!==3||g.some(C=>!C)?m:new Date(g[0],g[1]-1,g[2]).toLocaleDateString("ar-SA",{weekday:"short",month:"numeric",day:"numeric"})},p=i.map(m=>{const g=t[m]||0,b=Math.round(g/o*100);return`
