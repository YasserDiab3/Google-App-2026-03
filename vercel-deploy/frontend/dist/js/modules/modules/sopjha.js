        ...
        `,document.body.appendChild(t),t.querySelector("#sop-jha-form").addEventListener("submit",i=>{i.preventDefault(),this.handleSubmit(s?.id,t)}),t.addEventListener("click",i=>{i.target===t&&t.remove()})},async handleSubmit(s,e){const t=e?.querySelector('button[type="submit"]')||document.querySelector('.modal-overlay button[type="submit"]');if(t&&t.disabled)return;let a="";t&&(a=t.innerHTML,t.disabled=!0,t.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const i=document.getElementById("sop-type"),d=document.getElementById("sop-title"),l=document.getElementById("sop-department"),r=document.getElementById("sop-issue-date"),n=document.getElementById("sop-status"),c=document.getElementById("sop-version"),u=document.getElementById("sop-procedures"),f=document.getElementById("sop-hazards");if(!i||!d||!l||!r||!n||!c||!u||!f){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649."),t&&(t.disabled=!1,t.innerHTML=a);return}const p={id:s||Utils.generateId("SOP"),type:i.value,title:d.value.trim(),department:l.value.trim(),issueDate:new Date(r.value).toISOString(),status:n.value,version:c.value.trim(),procedures:u.value.trim(),hazards:f.value.trim(),requiredPPE:typeof PPEMatrix<"u"?PPEMatrix.getSelected():[],createdAt:s?AppState.appData.sopJHA?.find(o=>o.id===s)?.createdAt||new Date().toISOString():new Date().toISOString(),updatedAt:new Date().toISOString()};AppState.appData.sopJHA||(AppState.appData.sopJHA=[]);try{if(s){const o=AppState.appData.sopJHA.findIndex(m=>m.id===s);o!==-1?AppState.appData.sopJHA[o]=p:AppState.appData.sopJHA.push(p),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0639\u0644\u064A\u0645\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}else AppState.appData.sopJHA.push(p),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u062A\u0639\u0644\u064A\u0645\u0627\u062A \u0628\u0646\u062C\u0627\u062D");typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),e.remove(),t&&(t.disabled=!1,t.innerHTML=a),this.load(),typeof GoogleIntegration<"u"&&GoogleIntegration.autoSave&&GoogleIntegration.autoSave("SOPJHA",AppState.appData.sopJHA).catch(o=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0642\u0627\u0639\u062F\u0629 SQL:",o)})}catch(o){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u0644\u064A\u0645\u0627\u062A:",o),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+o.message),t&&(t.disabled=!1,t.innerHTML=a)}},async editSOPJHA(s){const e=AppState.appData.sopJHA?.find(t=>t.id===s);e?await this.showForm(e):Notification.error("\u0627\u0644\u062A\u0639\u0644\u064A\u0645\u0627\u062A \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629")},async viewSOPJHA(s){const e=AppState.appData.sopJHA?.find(a=>a.id===s);if(!e){Notification.error("\u0627\u0644\u062A\u0639\u0644\u064A\u0645\u0627\u062A \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`
            <div class="modal-content" style="max-width: 800px;">
                ...
                <div class="modal-footer">
                    ...
                    ${typeof EmailDispatch<"u"?EmailDispatch.renderFooterButtonHtml("sop-jha"):""}
