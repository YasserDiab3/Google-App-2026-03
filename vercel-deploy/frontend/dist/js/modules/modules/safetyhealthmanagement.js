const SafetyHealthManagement={currentView:"team",currentMemberId:null,filters:{department:"",jobTitle:"",period:"",search:""},isGoogleAppsScriptEnabled(){if(typeof AppState>"u"||!AppState.googleConfig)return!1;const e=AppState.googleConfig?.appsScript;if(!e||e.enabled!==!0)return!1;const t=e.scriptUrl;return!(!t||typeof t!="string"||t.trim()===""||typeof GoogleIntegration>"u"||typeof GoogleIntegration.sendRequest!="function")},hasLocalDataAvailable(e,t={}){try{if(typeof GoogleIntegration>"u"||typeof GoogleIntegration.getLocalData!="function")return!1;const s=GoogleIntegration.getLocalData(e,t);return s!=null}catch{return!1}},canAccessData(e=null,t={}){return this.isGoogleAppsScriptEnabled()?!0:e?this.hasLocalDataAvailable(e,t):!1},getDataAccessMessage(e=null,t={}){return this.isGoogleAppsScriptEnabled()||e&&this.hasLocalDataAvailable(e,t)?null:"\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644\u0647 \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A"},LOAD_TIMEOUT_MS:2e3,cache:{members:null,structure:null,jobDescriptions:null,jobDescriptionsLastLoad:null,kpis:new Map,lastLoad:null,cacheTimeout:12e4},_raceWithTimeout(e,t){const s=t??this.LOAD_TIMEOUT_MS;let a;const i=new Promise((n,o)=>{a=setTimeout(()=>o({timeout:!0}),s)});return Promise.race([e,i]).then(n=>(clearTimeout(a),n),n=>{throw clearTimeout(a),n})},_getMembersFromCache(){return this.cache.members&&this.cache.lastLoad!=null&&Date.now()-this.cache.lastLoad<this.cache.cacheTimeout?this.cache.members:null},_renderStructureIntoContainer(e,t){if(!(!e||!Array.isArray(t))){if(t.length===0){e.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u064A\u0648\u062C\u062F \u0647\u064A\u0643\u0644 \u0648\u0638\u064A\u0641\u064A \u0645\u0633\u062C\u0644</p></div>';return}t.sort((s,a)=>(s.order||0)-(a.order||0)),this.cache.structure=t,this.cache.lastLoad=Date.now(),e.innerHTML=t.map(s=>`
            <div class="org-node" data-id="${s.id}">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <h3 class="font-semibold text-gray-800">${Utils.escapeHTML(s.position||"")}</h3>
                        <p class="text-sm text-gray-600">${Utils.escapeHTML(s.memberName||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F")}</p>
                        <p class="text-xs text-gray-500">${Utils.escapeHTML(s.positionLevel||"")}</p>
                    </div>
                    <div class="flex gap-2">
                        <button onclick="SafetyHealthManagement.editStructure('${s.id}')" class="btn-icon btn-icon-primary"><i class="fas fa-edit"></i></button>
                        <button onclick="SafetyHealthManagement.deleteStructure('${s.id}')" class="btn-icon btn-icon-danger"><i class="fas fa-trash"></i></button>
                    </div>
                </div>
            </div>
        `).join(""),requestAnimationFrame(()=>{const s=document.getElementById("add-structure-btn");if(s){const a=s.cloneNode(!0);s.parentNode.replaceChild(a,s),a.addEventListener("click",()=>this.showStructureForm())}})}},loadingStates:{team:!1,structure:!1,jobDescriptions:!1,kpis:!1,reports:!1,settings:!1},debounceTimers:new Map,async load(){this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{typeof AppState<"u"&&AppState._languageRefresh||this.load()}),this._languageChangeListenerAdded=!0);const e=document.getElementById("safety-health-management-section");if(!e){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u0642\u0633\u0645 safety-health-management-section \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");return}try{let t="";try{t=this.render()}catch(a){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u0648\u0627\u062C\u0647\u0629:",a),t=`
                ...
                `}e.innerHTML=t;const s=document.getElementById("shm-tab-content");s&&(s.innerHTML=this.renderTeamView(),this.attachTeamAddMemberButton(),requestAnimationFrame(()=>this.loadTeamMembers().catch(()=>{})));try{this.setupEventListeners()}catch(a){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A setupEventListeners:",a)}}catch(t){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0645\u062F\u064A\u0648\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0648\u0627\u0644\u0635\u062D\u0629 \u0627\u0644\u0645\u0647\u0646\u064A\u0629:",t),e.innerHTML=`
        ...
        `},async switchTab(e){try{this.currentView=e,document.querySelectorAll(".shm-tab-btn").forEach(s=>{s.classList.remove("active"),s.dataset.tab===e&&s.classList.add("active")});const t=document.getElementById("shm-tab-content");if(!t){Utils.safeError("\u0639\u0646\u0635\u0631 \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}switch(e){case"team":t.innerHTML=this.renderTeamView(),requestAnimationFrame(()=>{this.attachTeamAddMemberButton(),this.loadTeamMembers()});break;case"structure":t.innerHTML=await this.renderStructureView(),requestAnimationFrame(()=>{const s=document.getElementById("add-structure-btn");if(s){const n=s.cloneNode(!0);s.parentNode.replaceChild(n,s),n.addEventListener("click",()=>this.showStructureForm())}const a=document.getElementById("shm-goto-team-btn");if(a){const n=a.cloneNode(!0);a.parentNode.replaceChild(n,a),n.addEventListener("click",()=>this.switchTab("team"))}const i=document.getElementById("create-structure-from-team-btn");if(i){const n=i.cloneNode(!0);i.parentNode.replaceChild(n,i),n.addEventListener("click",()=>this.createStructureFromTeam())}this.loadOrganizationalStructure()});break;case"job-descriptions":t.innerHTML=await this.renderJobDescriptionsView(),requestAnimationFrame(()=>{this.attachJobDescriptionAddButton(),this.loadJobDescriptions()});break;case"kpis":t.innerHTML=await this.renderKPIsView(),requestAnimationFrame(()=>{this.loadKPIs()});break;case"reports":t.innerHTML=await this.renderReportsView(),requestAnimationFrame(()=>{this.loadReports()});break;case"attendance":t.innerHTML=await this.renderAttendanceView(),requestAnimationFrame(()=>{this.loadAttendance()});break;case"analysis":t.innerHTML=await this.renderAnalysisView(),requestAnimationFrame(()=>{this.loadAnalysis()});break;case"settings":AppState.currentUser?.role==="admin"?(t.innerHTML=await this.renderSettingsView(),requestAnimationFrame(()=>{this.loadSettings()})):(Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A"),await this.switchTab("team"));break;default:Utils.safeWarn("\u062A\u0628\u0648\u064A\u0628 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641: "+e);break}}catch(t){const s=t?.message||t?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0628\u062F\u064A\u0644 \u0627\u0644\u062A\u0628\u0648\u064A\u0628:",s,t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062A\u0628\u0648\u064A\u0628: "+s)}},getTeamListSkeletonHTML(){if(!document.getElementById("shm-skeleton-style")){const t=document.createElement("style");t.id="shm-skeleton-style",t.textContent="@keyframes shm-shimmer{0%,100%{opacity:0.5}50%{opacity:1}}",document.head.appendChild(t)}return Array(8).fill(0).map(()=>`
        ...
        `},async loadTeamMembers(){const e=document.getElementById("team-members-list");if(!e)return;if(this.loadingStates.team){Utils.safeLog("\u26A0\uFE0F loadTeamMembers: \u0639\u0645\u0644\u064A\u0629 \u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630\u060C \u062A\u0645 \u062A\u062C\u0627\u0647\u0644 \u0627\u0644\u0637\u0644\u0628");return}this.loadingStates.team=!0;const t=this.cache.members&&this.cache.lastLoad&&Date.now()-this.cache.lastLoad<this.cache.cacheTimeout;if(this.cache.members&&this.cache.members.length>0&&(this.allMembers=this.cache.members,this.renderTeamMembers(this.cache.members),this.loadFilterOptions(this.cache.members)),t){this.loadingStates.team=!1;return}const s=this._getMembersFromCache();s&&s.length>0?(this.allMembers=s,this.loadFilterOptions(s),this.renderTeamMembers(s)):(!this.cache.members||this.cache.members.length===0)&&(e.innerHTML=this.getTeamListSkeletonHTML());try{const a=this.getDataAccessMessage("getSafetyTeamMembers",{});if(a){e.innerHTML=`<div class="empty-state col-span-full"><p class="text-yellow-600">${a}</p></div>`,this.loadingStates.team=!1;return}const i=GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});let n;try{n=await this._raceWithTimeout(i)}catch(o){o&&o.timeout&&((!s||s.length===0)&&e&&(e.innerHTML='<div class="empty-state col-span-full"><p class="text-gray-500">\u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u0645\u064A\u0644...</p></div>'),i.then(r=>{if(r&&r.success&&r.data){const c=Array.isArray(r.data)?r.data:[];if(this.allMembers=c,this.cache.members=c,this.cache.lastLoad=Date.now(),c.length===0){const d=document.getElementById("team-members-list");d&&(d.innerHTML='<div class="empty-state col-span-full"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0639\u0636\u0627\u0621 \u0645\u0633\u062C\u0644\u064A\u0646</p></div>')}else this.loadFilterOptions(c),this.renderTeamMembers(c)}}).catch(()=>{})),this.loadingStates.team=!1;return}if(n&&n.success&&n.data){const o=Array.isArray(n.data)?n.data:[];this.allMembers=o,this.cache.members=o,this.cache.lastLoad=Date.now(),o.length===0?e.innerHTML='<div class="empty-state col-span-full"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0639\u0636\u0627\u0621 \u0645\u0633\u062C\u0644\u064A\u0646</p></div>':(this.loadFilterOptions(o),this.renderTeamMembers(o))}else(!this.cache.members||this.cache.members.length===0)&&(e.innerHTML='<div class="empty-state col-span-full"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0639\u0636\u0627\u0621 \u0645\u0633\u062C\u0644\u064A\u0646</p></div>')}catch(a){const i=a?.message||a?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";if(i.includes("runtime.lastError")||i.includes("message port closed")||i.includes("Receiving end does not exist")||i.includes("Could not establish connection")||i.includes("Extension context invalidated")||i.includes("The message port closed before a response was received")){Utils.safeLog("\u26A0 \u062A\u0645 \u062A\u062C\u0627\u0647\u0644 \u062E\u0637\u0623 Chrome Extension \u0641\u064A loadTeamMembers"),setTimeout(()=>this.loadTeamMembers(),1e3),this.loadingStates.team=!1;return}!i.includes("\u062E\u0627\u062F\u0645 SQL")&&!i.includes("\u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644")&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0623\u0639\u0636\u0627\u0621 \u0627\u0644\u0641\u0631\u064A\u0642:",i,a),(!this.cache.members||this.cache.members.length===0)&&(e.innerHTML='<div class="empty-state col-span-full"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0639\u0636\u0627\u0621 \u0645\u0633\u062C\u0644\u064A\u0646</p></div>')}finally{this.loadingStates.team=!1}},loadFilterOptions(e){const t=[...new Set(e.map(n=>n.department).filter(Boolean))],s=document.getElementById("filter-department");s&&(s.innerHTML='<option value="">\u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0642\u0633\u0627\u0645</option>'+t.map(n=>`<option value="${Utils.escapeHTML(n)}">${Utils.escapeHTML(n)}</option>`).join(""));const a=[...new Set(e.map(n=>n.jobTitle).filter(Boolean))],i=document.getElementById("filter-job-title");i&&(i.innerHTML='<option value="">\u062C\u0645\u064A\u0639 \u0627\u0644\u0648\u0638\u0627\u0626\u0641</option>'+a.map(n=>`<option value="${Utils.escapeHTML(n)}">${Utils.escapeHTML(n)}</option>`).join(""))},applyFilters(){if(!this.allMembers)return;const e=(document.getElementById("filter-search")?.value||"").toLowerCase(),t=document.getElementById("filter-department")?.value||"",s=document.getElementById("filter-job-title")?.value||"";this.filters.search=e,this.filters.department=t,this.filters.jobTitle=s;const a=this.allMembers.filter(i=>{const n=!e||(i.name||"").toLowerCase().includes(e)||(i.email||"").toLowerCase().includes(e)||(i.phone||"").includes(e),o=!t||i.department===t,r=!s||i.jobTitle===s;return n&&o&&r});this.renderTeamMembers(a)},clearFilters(){document.getElementById("filter-search")&&(document.getElementById("filter-search").value=""),document.getElementById("filter-department")&&(document.getElementById("filter-department").value=""),document.getElementById("filter-job-title")&&(document.getElementById("filter-job-title").value=""),this.filters={department:"",jobTitle:"",period:"",search:""},this.allMembers&&this.renderTeamMembers(this.allMembers)},renderTeamMembers(e){const t=document.getElementById("team-members-list");if(t){if(e.length===0){t.innerHTML='<div class="empty-state col-span-full"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C</p></div>';return}t.innerHTML=e.map(s=>`
            <div class="member-card bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div class="flex flex-col items-center text-center mb-3">
                    ${s.photo?`
                        ${(()=>{const a=typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(s.photo):{canonical:String(s.photo),displaySrc:String(s.photo),needsProxy:!1,proxyFileId:""},i=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(a):"";return`<img src="${Utils.escapeHTML(a.displaySrc)}" alt="${Utils.escapeHTML(s.name)}"${i}
                    ...
                    `}
                    <div class="w-full">
                        <h3 class="font-bold text-gray-800 text-lg mb-1">${Utils.escapeHTML(s.name||"")}</h3>
                        <p class="text-sm font-semibold text-blue-600 mb-1">${Utils.escapeHTML(s.jobTitle||"")}</p>
                        <p class="text-xs text-gray-500 mb-2">${Utils.escapeHTML(s.department||"")}</p>
                        ${s.positionLevel?`<span class="inline-block px-2 py-1 text-xs bg-gray-100 text-gray-700 rounded">${Utils.escapeHTML(s.positionLevel)}</span>`:""}
                    </div>
                </div>
                <div class="space-y-2 text-sm text-gray-600 mb-4 pt-4 border-t border-gray-100">
                    ${s.email?`
                        <div class="flex items-center gap-2">
                            ...
                            <span class="truncate">${Utils.escapeHTML(s.email)}</span>
                        </div>
                    `:""}
                    ${s.phone?`
                        <div class="flex items-center gap-2">
                            <i class="fas fa-phone text-green-500 w-4"></i>
                            <span>${Utils.escapeHTML(s.phone)}</span>
                        </div>
                    `:""}
                    ${s.appointmentDate?`
                        <div class="flex items-center gap-2">
                            <i class="fas fa-calendar text-purple-500 w-4"></i>
                            <span>\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062A\u0639\u064A\u064A\u0646: ${Utils.formatDate(s.appointmentDate)}</span>
                        </div>
                    `:""}
                </div>
                <div class="flex gap-2 pt-3 border-t border-gray-200">
                    <button onclick="SafetyHealthManagement.viewMember('${s.id}')" class="btn-primary btn-sm flex-1">
                        <i class="fas fa-eye ml-1"></i>
                        \u0639\u0631\u0636
                    </button>
                    <button onclick="SafetyHealthManagement.showMemberForm(${JSON.stringify(s).replace(/"/g,"&quot;")})" class="btn-secondary btn-sm" title="\u062A\u0639\u062F\u064A\u0644">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button onclick="SafetyHealthManagement.deleteMember('${s.id}')" class="btn-danger btn-sm" title="\u062D\u0630\u0641">
                        <i class="fas fa-trash"></i>
                    </button>
                </div>
            </div>
        `).join(""),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(t,{onFetchFail:s=>{try{const a=document.createElement("div");a.className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center mb-3 shadow-lg",a.innerHTML='<i class="fas fa-user text-3xl text-white"></i>',s.replaceWith(a)}catch{}}})}},attachTeamAddMemberButton(){const e=document.getElementById("add-team-member-btn");if(e){const s=e.cloneNode(!0);e.parentNode.replaceChild(s,e),s.addEventListener("click",()=>this.showMemberForm())}const t=document.getElementById("shm-goto-structure-btn");if(t){const s=t.cloneNode(!0);t.parentNode.replaceChild(s,t),s.addEventListener("click",()=>this.switchTab("structure"))}},attachJobDescriptionAddButton(){const e=document.getElementById("add-job-description-btn");if(e){const t=e.cloneNode(!0);e.parentNode.replaceChild(t,e),t.addEventListener("click",()=>this.showJobDescriptionForm())}},setupEventListeners(){requestAnimationFrame(()=>{this.attachTeamAddMemberButton();const e=document.getElementById("shm-export-excel-btn");if(e){const t=e.cloneNode(!0);e.parentNode.replaceChild(t,e),t.addEventListener("click",()=>this.exportAllToExcel())}})},async showMemberForm(e=null){const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`
        ...
        `,document.body.appendChild(t);const s=t.querySelector("#import-employee-btn"),a=t.querySelector("#member-employee-code");s&&a&&(s.addEventListener("click",()=>this.importEmployeeFromDatabase(t)),a.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),this.importEmployeeFromDatabase(t))}));const i=t.querySelector("#save-member-btn"),n=t.querySelector("#team-member-form");i.addEventListener("click",()=>this.handleMemberSubmit(n,e?.id,t)),t.addEventListener("click",o=>{o.target===t&&t.remove()})},async importEmployeeFromDatabase(e){const t=e.querySelector("#member-employee-code");if(!t)return;const s=t.value.trim();if(!s){Notification.error("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A \u0623\u0648\u0644\u0627\u064B"),t.focus();return}try{Loading.show();let a=null;if(typeof EmployeeHelper<"u"&&EmployeeHelper.findByCode&&(a=EmployeeHelper.findByCode(s)),!a)try{const p=await GoogleIntegration.sendRequest({action:"readFromSheet",data:{sheetName:"Employees"}});p.success&&p.data&&(a=(Array.isArray(p.data)?p.data:[]).find(y=>{const b=String(y.employeeNumber||y.sapId||y.employeeCode||y.id||"").trim();return b===s||b.toLowerCase()===s.toLowerCase()}))}catch(p){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062C\u0644\u0628 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",p),typeof EmployeeHelper<"u"&&EmployeeHelper.findByPartial&&(a=EmployeeHelper.findByPartial(s))}if(!a){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0645\u0648\u0638\u0641 \u0628\u0647\u0630\u0627 \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A: "+s),Loading.hide();return}const i=e.querySelector("#member-name"),n=e.querySelector("#member-job-title"),o=e.querySelector("#member-department"),r=e.querySelector("#member-email"),c=e.querySelector("#member-phone"),d=e.querySelector("#member-appointment-date"),m=e.querySelector("#member-position-level"),u=e.querySelector("#member-photo");if(i&&a.name&&(i.value=a.name),n&&(a.job||a.position||a.jobTitle)&&(n.value=a.job||a.position||a.jobTitle),o&&a.department&&(o.value=a.department),r&&a.email&&(r.value=a.email),c&&a.phone&&(c.value=a.phone),d&&a.hireDate){const p=new Date(a.hireDate);isNaN(p.getTime())||(d.value=p.toISOString().split("T")[0])}if(m&&a.position&&(m.value=a.position),u&&a.photo&&(u.value=a.photo),t){const p=a.employeeNumber||a.sapId||a.employeeCode||s;t.value=p}Notification.success("\u062A\u0645 \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D")}catch(a){const i=a?.message||a?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0633\u062A\u064A\u0631\u0627\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641:",i,a),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+i)}finally{Loading.hide()}},async handleMemberSubmit(e,t=null,s){if(!e||!e.checkValidity()){e&&e.reportValidity();return}try{const a=document.getElementById("member-name"),i=document.getElementById("member-job-title"),n=document.getElementById("member-department"),o=document.getElementById("member-email"),r=document.getElementById("member-phone"),c=document.getElementById("member-appointment-date"),d=document.getElementById("member-position-level"),m=document.getElementById("member-employee-code"),u=document.getElementById("member-photo");if(!a||!i||!n){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: \u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}const p={name:a.value.trim(),jobTitle:i.value.trim(),department:n.value.trim(),email:o?o.value.trim():"",phone:r?r.value.trim():"",appointmentDate:c&&c.value?c.value:null,positionLevel:d?d.value.trim():"",employeeCode:m?m.value.trim():"",photo:u?u.value.trim():"",status:"active"};if(!p.name||!p.jobTitle||!p.department){Notification.error("\u064A\u0631\u062C\u0649 \u0645\u0644\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629");return}if(this.loadingStates.team){Notification.warning("\u062C\u0627\u0631\u064A \u062A\u0646\u0641\u064A\u0630 \u0639\u0645\u0644\u064A\u0629 \u0623\u062E\u0631\u0649\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631...");return}this.loadingStates.team=!0,Loading.show();const h=t?"updateSafetyTeamMember":"addSafetyTeamMember",y=t?{memberId:t,updateData:p}:p,b=await GoogleIntegration.sendRequest({action:h,data:y});if(b.success)Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u0636\u0648 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0639\u0636\u0648 \u0628\u0646\u062C\u0627\u062D"),this.cache.members=null,s&&s.remove(),await this.loadTeamMembers();else{const w=b.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638";Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+w)}}catch(a){const i=a?.message||a?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u0636\u0648:",i,a),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+i)}finally{Loading.hide(),this.loadingStates.team=!1}},async viewMember(e){if(!e){Notification.error("\u0645\u0639\u0631\u0641 \u0627\u0644\u0639\u0636\u0648 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D");return}try{Loading.show();const t=await GoogleIntegration.sendRequest({action:"getSafetyTeamMember",data:{memberId:e}});if(t.success&&t.data){const s=t.data;this.currentMemberId=e,await this.switchTab("kpis"),requestAnimationFrame(()=>{const a=document.getElementById("kpi-member-select");a?(a.value=e,this.loadMemberKPIs()):requestAnimationFrame(()=>{requestAnimationFrame(()=>{const i=document.getElementById("kpi-member-select");i&&(i.value=e,this.loadMemberKPIs())})})})}else{const s=t.message||"\u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F";Notification.error(s)}}catch(t){const s=t?.message||t?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0639\u0631\u0636 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u0636\u0648:",s,t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+s)}finally{Loading.hide()}},async deleteMember(e){if(!e){Notification.error("\u0645\u0639\u0631\u0641 \u0627\u0644\u0639\u0636\u0648 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D");return}if(confirm(`\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0639\u0636\u0648 \u0645\u0646 \u0641\u0631\u064A\u0642 \u0627\u0644\u0633\u0644\u0627\u0645\u0629\u061F

\u0647\u0630\u0647 \u0627\u0644\u0639\u0645\u0644\u064A\u0629 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647\u0627.`))try{if(this.loadingStates.team){Notification.warning("\u062C\u0627\u0631\u064A \u062A\u0646\u0641\u064A\u0630 \u0639\u0645\u0644\u064A\u0629 \u0623\u062E\u0631\u0649\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631...");return}this.loadingStates.team=!0,Loading.show();const t=await GoogleIntegration.sendRequest({action:"deleteSafetyTeamMember",data:{memberId:e}});if(t.success)Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0639\u0636\u0648 \u0628\u0646\u062C\u0627\u062D"),this.cache.members=null,await this.loadTeamMembers();else{const s=t.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641";Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+s)}}catch(t){const s=t?.message||t?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0639\u0636\u0648:",s,t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+s)}finally{Loading.hide(),this.loadingStates.team=!1}},async renderStructureView(){return`
            <div class="content-card">
                <div class="card-header">
        ...
        `},async loadOrganizationalStructure(){const e=document.getElementById("organizational-structure-container");if(!e)return;if(this.loadingStates.structure){Utils.safeLog("\u26A0\uFE0F loadOrganizationalStructure: \u0639\u0645\u0644\u064A\u0629 \u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630\u060C \u062A\u0645 \u062A\u062C\u0627\u0647\u0644 \u0627\u0644\u0637\u0644\u0628");return}if(this.loadingStates.structure=!0,this.cache.structure&&this.cache.lastLoad&&Date.now()-this.cache.lastLoad<this.cache.cacheTimeout){const s=this.cache.structure;s.sort((a,i)=>(a.order||0)-(i.order||0)),e.innerHTML=s.map(a=>`
            ...
            `}finally{this.loadingStates.structure=!1}},async showStructureForm(e=null){const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`
        ...
        `,document.body.appendChild(t);const s=await this.loadTeamMembersForDropdown(t.querySelector("#structure-member-id"),e?.memberId),a=t.querySelector("#structure-member-id"),i=t.querySelector("#structure-position"),n=t.querySelector("#structure-position-level"),o=t.querySelector("#structure-description"),r=m=>{if(!m||!Array.isArray(s)||s.length===0)return;const u=s.find(p=>String(p.id)===String(m));if(u&&(i&&(i.value=u.jobTitle||u.position||""),n&&(n.value=u.positionLevel||u.jobTitle||""),o&&!o.value)){const p=[u.department?"\u0627\u0644\u0642\u0633\u0645: "+u.department:"",u.jobTitle?"\u0627\u0644\u0648\u0638\u064A\u0641\u0629: "+u.jobTitle:""].filter(Boolean);o.value=p.length?p.join(" \u2014 "):""}};a&&(a.addEventListener("change",function(){r(this.value)}),e?.memberId?r(e.memberId):a.value&&r(a.value));const c=t.querySelector("#save-structure-btn"),d=t.querySelector("#structure-form");c.addEventListener("click",()=>this.handleStructureSubmit(d,e?.id,t)),t.addEventListener("click",m=>{m.target===t&&t.remove()})},async loadTeamMembersForDropdown(e,t=null){if(!e)return[];const s=this.getDataAccessMessage("getSafetyTeamMembers",{});if(s)return e.innerHTML=`<option value="">${s}</option>`,[];try{const a=await GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});if(a.success&&a.data){const i=Array.isArray(a.data)?a.data:[];return e.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+i.map(n=>`
                        <option value="${Utils.escapeHTML(String(n.id))}" ${n.id===t||String(n.id)===String(t)?"selected":""}>
                            ${Utils.escapeHTML(n.name||"")} - ${Utils.escapeHTML(n.jobTitle||n.position||"")}
                        </option>
                    `).join(""),i}}catch(a){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0623\u0639\u0636\u0627\u0621 \u0627\u0644\u0641\u0631\u064A\u0642:",a)}return[]},async handleStructureSubmit(e,t=null,s){if(!e.checkValidity()){e.reportValidity();return}const a=document.getElementById("structure-member-id").value;let i="";if(a)try{const o=await GoogleIntegration.sendRequest({action:"getSafetyTeamMember",data:{memberId:a}});o.success&&o.data&&(i=o.data.name||"")}catch{}const n={position:document.getElementById("structure-position").value.trim(),positionLevel:document.getElementById("structure-position-level").value.trim(),memberId:a||null,memberName:i,order:parseInt(document.getElementById("structure-order").value)||0,description:document.getElementById("structure-description").value.trim()};if(this.loadingStates.structure){Notification.warning("\u062C\u0627\u0631\u064A \u062A\u0646\u0641\u064A\u0630 \u0639\u0645\u0644\u064A\u0629 \u0623\u062E\u0631\u0649\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631...");return}this.loadingStates.structure=!0,Loading.show();try{const o=await GoogleIntegration.sendRequest({action:"saveOrganizationalStructure",data:n});o.success?(Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0646\u0635\u0628 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0646\u0635\u0628 \u0628\u0646\u062C\u0627\u062D"),this.cache.structure=null,s.remove(),await this.loadOrganizationalStructure()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(o.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"))}catch(o){const r=o?.message||o?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0627\u0644\u0645\u0646\u0635\u0628:",r,o),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+r)}finally{Loading.hide(),this.loadingStates.structure=!1}},async createStructureFromTeam(){if(this.loadingStates.structure){Notification.warning("\u062C\u0627\u0631\u064A \u062A\u0646\u0641\u064A\u0630 \u0639\u0645\u0644\u064A\u0629 \u0623\u062E\u0631\u0649\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631...");return}const e=this.getDataAccessMessage("getSafetyTeamMembers",{});if(e){Notification.error(e);return}const t=this.getDataAccessMessage("getOrganizationalStructure",{});if(t){Notification.error(t);return}try{this.loadingStates.structure=!0,Loading.show();const[s,a]=await Promise.all([GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}}),GoogleIntegration.sendRequest({action:"getOrganizationalStructure",data:{}})]),i=s.success&&s.data?Array.isArray(s.data)?s.data:[]:[],n=a.success&&a.data?Array.isArray(a.data)?a.data:[]:[],o=new Set(n.map(m=>m.memberId).filter(Boolean).map(m=>String(m))),r=i.filter(m=>!o.has(String(m.id)));if(r.length===0){Notification.info("\u062C\u0645\u064A\u0639 \u0623\u0639\u0636\u0627\u0621 \u0627\u0644\u0641\u0631\u064A\u0642 \u0645\u0636\u0627\u0641\u0648\u0646 \u0628\u0627\u0644\u0641\u0639\u0644 \u0625\u0644\u0649 \u0627\u0644\u0647\u064A\u0643\u0644 \u0627\u0644\u0648\u0638\u064A\u0641\u064A"),Loading.hide(),this.loadingStates.structure=!1;return}const c=n.length?Math.max(...n.map(m=>m.order||0)):0;let d=0;for(let m=0;m<r.length;m++){const u=r[m],p={position:u.jobTitle||u.position||"\u0645\u0646\u0635\u0628 \u0641\u064A \u0641\u0631\u064A\u0642 \u0627\u0644\u0633\u0644\u0627\u0645\u0629",positionLevel:u.positionLevel||u.jobTitle||"",memberId:u.id,memberName:u.name||"",order:c+m+1,description:u.department?"\u0627\u0644\u0642\u0633\u0645: "+(u.department||""):""},h=await GoogleIntegration.sendRequest({action:"saveOrganizationalStructure",data:p});h&&h.success&&d++}this.cache.structure=null,await this.loadOrganizationalStructure(),Notification.success("\u062A\u0645 \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u0647\u064A\u0643\u0644 \u0645\u0646 \u0627\u0644\u0641\u0631\u064A\u0642: \u062A\u0645\u062A \u0625\u0636\u0627\u0641\u0629 "+d+" \u0645\u0646\u0635\u0628/\u0645\u0646\u0627\u0635\u0628")}catch(s){const a=s?.message||s?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u0647\u064A\u0643\u0644 \u0645\u0646 \u0627\u0644\u0641\u0631\u064A\u0642:",a,s),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+a)}finally{Loading.hide(),this.loadingStates.structure=!1}},async editStructure(e){if(this.loadingStates.structure){Notification.warning("\u062C\u0627\u0631\u064A \u062A\u0646\u0641\u064A\u0630 \u0639\u0645\u0644\u064A\u0629 \u0623\u062E\u0631\u0649\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631...");return}try{Loading.show();let t=this.cache.structure;if(!t){const a=await GoogleIntegration.sendRequest({action:"getOrganizationalStructure",data:{}});if(a.success&&a.data)t=Array.isArray(a.data)?a.data:[],this.cache.structure=t;else{Notification.error("\u0641\u0634\u0644 \u062C\u0644\u0628 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0647\u064A\u0643\u0644 \u0627\u0644\u0648\u0638\u064A\u0641\u064A"),Loading.hide();return}}const s=t.find(a=>a.id===e);s?this.showStructureForm(s):Notification.error("\u0627\u0644\u0645\u0646\u0635\u0628 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F")}catch(t){const s=t?.message||t?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0646\u0635\u0628:",s,t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+s)}finally{Loading.hide()}},async deleteStructure(e){if(confirm(`\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0645\u0646\u0635\u0628\u061F

\u0647\u0630\u0647 \u0627\u0644\u0639\u0645\u0644\u064A\u0629 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647\u0627.`))try{if(this.loadingStates.structure){Notification.warning("\u062C\u0627\u0631\u064A \u062A\u0646\u0641\u064A\u0630 \u0639\u0645\u0644\u064A\u0629 \u0623\u062E\u0631\u0649\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631...");return}this.loadingStates.structure=!0,Loading.show();const t=await GoogleIntegration.sendRequest({action:"getOrganizationalStructure",data:{}});if(t.success&&t.data){const a=(Array.isArray(t.data)?t.data:[]).filter(n=>n.id!==e),i=await GoogleIntegration.sendRequest({action:"saveOrganizationalStructure",data:{structure:a}});i.success?(Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0646\u0635\u0628 \u0628\u0646\u062C\u0627\u062D"),this.cache.structure=null,await this.loadOrganizationalStructure()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(i.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641"))}else Notification.error("\u0641\u0634\u0644 \u062C\u0644\u0628 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0647\u064A\u0643\u0644 \u0627\u0644\u0648\u0638\u064A\u0641\u064A")}catch(t){const s=t?.message||t?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0645\u0646\u0635\u0628:",s,t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+s)}finally{Loading.hide(),this.loadingStates.structure=!1}},async renderJobDescriptionsView(){return`
            <div class="content-card">
                <div class="card-header">
                    <div class="flex items-center justify-between">
        ...
        `},async _loadJobDescriptionsFetch(e){if(!document.getElementById("job-descriptions-list")||!e||e.length===0)return;const s=e.map(i=>GoogleIntegration.sendRequest({action:"getJobDescription",data:{memberId:i.id}}).then(n=>n&&n.success&&n.data?{...n.data,member:i}:{member:i,hasDescription:!1}).catch(()=>({member:i,hasDescription:!1}))),a=Promise.all(s);try{const i=await this._raceWithTimeout(a);this.cache.jobDescriptions=i,this.cache.jobDescriptionsLastLoad=Date.now();const n=document.getElementById("job-descriptions-list");n&&(n.innerHTML=i.length===0?'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0648\u0635\u0627\u0641 \u0648\u0638\u064A\u0641\u064A\u0629 \u0645\u0633\u062C\u0644\u0629</p></div>':this._renderJobDescriptionsList(i))}catch(i){if(i&&i.timeout)a.then(n=>{this.cache.jobDescriptions=n,this.cache.jobDescriptionsLastLoad=Date.now();const o=document.getElementById("job-descriptions-list");o&&(o.innerHTML=n.length===0?'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0648\u0635\u0627\u0641 \u0648\u0638\u064A\u0641\u064A\u0629 \u0645\u0633\u062C\u0644\u0629</p></div>':this._renderJobDescriptionsList(n))}).catch(()=>{});else throw i}},async loadJobDescriptions(){const e=document.getElementById("job-descriptions-list");if(!e)return;const t=this.getDataAccessMessage("getJobDescriptions",{});if(t){e.innerHTML=`<div class="empty-state"><p class="text-gray-500">${t}</p></div>`;return}if(this.cache.jobDescriptions&&this.cache.jobDescriptionsLastLoad&&Date.now()-this.cache.jobDescriptionsLastLoad<this.cache.cacheTimeout&&this.cache.jobDescriptions.length>0){e.innerHTML=this._renderJobDescriptionsList(this.cache.jobDescriptions);return}e.innerHTML='<div class="empty-state"><p class="text-gray-500">\u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u0645\u064A\u0644...</p></div>';try{let a=this._getMembersFromCache(),i=null;if(!a||a.length===0){i=GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});try{const n=await this._raceWithTimeout(i);n&&n.success&&n.data&&(a=Array.isArray(n.data)?n.data:[],this.cache.members=a,this.cache.lastLoad=Date.now())}catch(n){if(n&&n.timeout){i.then(o=>{if(o&&o.success&&o.data){const r=Array.isArray(o.data)?o.data:[];this.cache.members=r,this.cache.lastLoad=Date.now(),r.length>0&&this._loadJobDescriptionsFetch(r)}}).catch(()=>{});return}throw n}}if(!a||a.length===0){e.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0639\u0636\u0627\u0621 \u0644\u0625\u0636\u0627\u0641\u0629 \u0623\u0648\u0635\u0627\u0641 \u0648\u0638\u064A\u0641\u064A\u0629</p></div>';return}await this._loadJobDescriptionsFetch(a)}catch(a){const i=a?.message||a?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";if(i.includes("runtime.lastError")||i.includes("message port closed")||i.includes("Receiving end does not exist")||i.includes("Could not establish connection")||i.includes("Extension context invalidated")||i.includes("The message port closed before a response was received")){Utils.safeLog("\u26A0 \u062A\u0645 \u062A\u062C\u0627\u0647\u0644 \u062E\u0637\u0623 Chrome Extension \u0641\u064A loadJobDescriptions"),setTimeout(()=>this.loadJobDescriptions(),1e3);return}const o=this.isGoogleAppsScriptEnabled();o&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0623\u0648\u0635\u0627\u0641 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u0629:",i,a);let r="\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0648\u0635\u0627\u0641 \u0648\u0638\u064A\u0641\u064A\u0629 \u0645\u0633\u062C\u0644\u0629",c=!1;i.includes("\u063A\u064A\u0631 \u0645\u0639\u062A\u0631\u0641 \u0628\u0647")||i.includes("Action not recognized")||i.includes("ACTION_NOT_RECOGNIZED")?(r=i,c=o):i.includes("\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644")?(r="\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644\u0647 \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A",c=!1):o&&(i.includes("Failed to fetch")||i.includes("NetworkError")||i.includes("CORS"))?(r="\u0641\u0634\u0644 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u062E\u0627\u062F\u0645. \u064A\u0631\u062C\u0649 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062A\u0631\u0646\u062A \u0648\u0625\u0639\u062F\u0627\u062F\u0627\u062A \u062E\u0627\u062F\u0645 SQL",c=!0):o&&i.includes("\u0641\u0634\u0644 \u0627\u0644\u0627\u062A\u0635\u0627\u0644")&&(r=i,c=!0),e.innerHTML=`
            ...
            `}},_renderJobDescriptionsList(e){return!Array.isArray(e)||e.length===0?"":e.map(t=>`
            <div class="bg-white border border-gray-200 rounded-lg p-4">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        <h3 class="font-semibold text-gray-800">${Utils.escapeHTML(t.member.name||"")}</h3>
                        <p class="text-sm text-gray-600">${Utils.escapeHTML(t.member.jobTitle||"")}</p>
                    </div>
                    <button onclick="SafetyHealthManagement.showJobDescriptionForm('${t.member.id}', ${t.hasDescription!==!1?JSON.stringify(t).replace(/"/g,"&quot;"):"null"})" class="btn-primary btn-sm">
                        <i class="fas fa-${t.hasDescription!==!1?"edit":"plus"} ml-2"></i>
                        ${t.hasDescription!==!1?"\u062A\u0639\u062F\u064A\u0644":"\u0625\u0636\u0627\u0641\u0629"}
                    </button>
                </div>
                ${t.hasDescription!==!1?`
                    <div class="mt-3 space-y-2">
                        <div><strong>\u0627\u0644\u062F\u0648\u0631 \u0627\u0644\u0648\u0638\u064A\u0641\u064A:</strong> ${Utils.escapeHTML(t.roleDescription||"\u2014")}</div>
                        <div><strong>\u0627\u0644\u0645\u0633\u0624\u0648\u0644\u064A\u0627\u062A:</strong> ${Utils.escapeHTML(t.responsibilities||"\u2014")}</div>
                        <div><strong>\u0627\u0644\u0645\u0647\u0627\u0645:</strong> ${Utils.escapeHTML(t.tasks||"\u2014")}</div>
                    </div>
                `:'<p class="text-gray-500 text-sm">\u0644\u0627 \u064A\u0648\u062C\u062F \u0648\u0635\u0641 \u0648\u0638\u064A\u0641\u064A \u0645\u0633\u062C\u0644</p>'}
            </div>
        `).join("")},async showJobDescriptionForm(e=null,t=null){const s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
            <div class="modal-content" style="max-width: 800px;">
                <div class="modal-header">
                    <h2 class="modal-title">${t?"\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0648\u0635\u0641 \u0627\u0644\u0648\u0638\u064A\u0641\u064A":"\u0625\u0636\u0627\u0641\u0629 \u0648\u0635\u0641 \u0648\u0638\u064A\u0641\u064A"}</h2>
                    <button class="modal-close" onclick="this.closest('.modal-overlay').remove()">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                    ...
                    <form id="job-description-form" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="jd-job-title" class="form-input" 
                                value="${Utils.escapeHTML(t?.jobTitle||"")}" placeholder="\u0627\u0644\u0648\u0638\u064A\u0641\u0629">
                        </div>
                        <div>
                            ...
                            <textarea id="jd-role-description" required class="form-input" rows="4" 
                                placeholder="\u0648\u0635\u0641 \u062A\u0641\u0635\u064A\u0644\u064A \u0644\u0644\u062F\u0648\u0631 \u0627\u0644\u0648\u0638\u064A\u0641\u064A">${Utils.escapeHTML(t?.roleDescription||"")}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="jd-responsibilities" required class="form-input" rows="5" 
                                placeholder="\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u0633\u0624\u0648\u0644\u064A\u0627\u062A \u0648\u0627\u0644\u0645\u0647\u0627\u0645">${Utils.escapeHTML(t?.responsibilities||"")}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="jd-tasks" class="form-input" rows="4" 
                                placeholder="\u0627\u0644\u0645\u0647\u0627\u0645 \u0627\u0644\u0625\u0636\u0627\u0641\u064A\u0629">${Utils.escapeHTML(t?.tasks||"")}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="jd-work-scope" class="form-input" rows="3" 
                                placeholder="\u0646\u0637\u0627\u0642 \u0627\u0644\u0639\u0645\u0644">${Utils.escapeHTML(t?.workScope||"")}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="jd-required-qualifications" class="form-input" rows="4" 
                                placeholder="\u0627\u0644\u0645\u0624\u0647\u0644\u0627\u062A \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629">${Utils.escapeHTML(t?.requiredQualifications||"")}</textarea>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
        ...
        `,document.body.appendChild(s);const a=s.querySelector("#jd-member-id");!t&&e&&a?a.value=e:!t&&a&&(await this.loadTeamMembersForDropdown(a),a.options.length<=1&&typeof Notification<"u"&&Notification.info&&Notification.info("\u0644\u0627 \u064A\u0648\u062C\u062F \u0623\u0639\u0636\u0627\u0621 \u062D\u0627\u0644\u064A\u0627\u064B. \u0623\u0636\u0641 \u0623\u0639\u0636\u0627\u0621 \u0645\u0646 \u062A\u0628\u0648\u064A\u0628 \u0641\u0631\u064A\u0642 \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0623\u0648\u0644\u0627\u064B."));const i=s.querySelector("#save-jd-btn"),n=s.querySelector("#job-description-form");i.addEventListener("click",()=>this.handleJobDescriptionSubmit(n,t?.id,t?.memberId||e,s)),s.addEventListener("click",o=>{o.target===s&&s.remove()})},async handleJobDescriptionSubmit(e,t=null,s=null,a){if(!e.checkValidity()){e.reportValidity();return}const i=s||document.getElementById("jd-member-id").value;if(!i){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642");return}const n={memberId:i,jobTitle:document.getElementById("jd-job-title").value.trim(),roleDescription:document.getElementById("jd-role-description").value.trim(),responsibilities:document.getElementById("jd-responsibilities").value.trim(),tasks:document.getElementById("jd-tasks").value.trim(),workScope:document.getElementById("jd-work-scope").value.trim(),requiredQualifications:document.getElementById("jd-required-qualifications").value.trim()};Loading.show();try{const o=t?"updateJobDescription":"saveJobDescription",r=t?{jobDescriptionId:t,updateData:n}:n,c=await GoogleIntegration.sendRequest({action:o,data:r});c.success?(Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0648\u0635\u0641 \u0627\u0644\u0648\u0638\u064A\u0641\u064A \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0648\u0635\u0641 \u0627\u0644\u0648\u0638\u064A\u0641\u064A \u0628\u0646\u062C\u0627\u062D"),a.remove(),this.cache.jobDescriptions=null,this.cache.jobDescriptionsLastLoad=null,this.loadJobDescriptions()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(c.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"))}catch(o){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+o.message)}finally{Loading.hide()}},async renderKPIsView(){return`
            <div class="content-card">
                <div class="card-header">
                    <div class="flex items-center justify-between">
        ...
        `},_fillKPIsDropdown(e){const t=document.getElementById("kpi-member-select"),s=document.getElementById("kpi-period-select"),a=document.getElementById("calculate-kpis-btn");if(t){if(t.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+(e||[]).map(i=>`
                <option value="${i.id}" ${i.id===this.currentMemberId?"selected":""}>
                    ${Utils.escapeHTML(i.name||"")}
                </option>
            `).join(""),s){const i=new Date;let n='<option value="">\u0627\u0644\u0641\u062A\u0631\u0629 \u0627\u0644\u062D\u0627\u0644\u064A\u0629</option>';for(let o=0;o<6;o++){const r=new Date(i.getFullYear(),i.getMonth()-o,1),c=["\u064A\u0646\u0627\u064A\u0631","\u0641\u0628\u0631\u0627\u064A\u0631","\u0645\u0627\u0631\u0633","\u0623\u0628\u0631\u064A\u0644","\u0645\u0627\u064A\u0648","\u064A\u0648\u0646\u064A\u0648","\u064A\u0648\u0644\u064A\u0648","\u0623\u063A\u0633\u0637\u0633","\u0633\u0628\u062A\u0645\u0628\u0631","\u0623\u0643\u062A\u0648\u0628\u0631","\u0646\u0648\u0641\u0645\u0628\u0631","\u062F\u064A\u0633\u0645\u0628\u0631"];n+=`<option value="${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}">${c[r.getMonth()]} ${r.getFullYear()}</option>`}s.innerHTML=n}t.removeEventListener("change",this._boundLoadMemberKPIs),this._boundLoadMemberKPIs=()=>this.loadMemberKPIs(),t.addEventListener("change",this._boundLoadMemberKPIs),s&&(s.onchange=()=>{t.value&&this.loadMemberKPIs()}),a&&(a.onclick=()=>this.calculateKPIs())}},async loadKPIs(){const e=document.getElementById("kpis-container"),t=document.getElementById("kpi-member-select"),s=document.getElementById("kpi-period-select"),a=document.getElementById("calculate-kpis-btn");if(!e||!t){Utils.safeError("\u0639\u0646\u0627\u0635\u0631 KPIs \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629 \u0641\u064A \u0627\u0644\u0635\u0641\u062D\u0629");return}const i=this.getDataAccessMessage("getSafetyTeamKPIs",{});if(i){t.innerHTML=`<option value="">${i}</option>`,e.innerHTML=`<div class="empty-state"><p class="text-gray-500">${i}</p></div>`;return}let n=this._getMembersFromCache();n&&n.length>0?(this._fillKPIsDropdown(n),this.currentMemberId&&t.value===this.currentMemberId?this.loadMemberKPIs():e.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0644\u062D\u0633\u0627\u0628 \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0623\u062F\u0627\u0621</p></div>'):e.innerHTML='<div class="empty-state"><p class="text-gray-500">\u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u0645\u064A\u0644...</p></div>';try{const o=GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});let r;try{r=await this._raceWithTimeout(o)}catch(c){c&&c.timeout&&o.then(d=>{if(d&&d.success&&d.data){const m=Array.isArray(d.data)?d.data:[];this.cache.members=m,this.cache.lastLoad=Date.now(),this._fillKPIsDropdown(m);const u=document.getElementById("kpi-member-select");this.currentMemberId&&u&&u.value===this.currentMemberId&&this.loadMemberKPIs()}}).catch(()=>{});return}if(r&&r.success&&r.data)n=Array.isArray(r.data)?r.data:[],this.cache.members=n,this.cache.lastLoad=Date.now(),this._fillKPIsDropdown(n),this.currentMemberId&&t.value===this.currentMemberId?this.loadMemberKPIs():e.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0644\u062D\u0633\u0627\u0628 \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0623\u062F\u0627\u0621</p></div>';else{const c=r&&r.message?r.message:"\u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0623\u0639\u0636\u0627\u0621 \u0627\u0644\u0641\u0631\u064A\u0642";e.innerHTML=`<div class="empty-state"><p class="text-red-500">${Utils.escapeHTML(c)}</p></div>`}}catch(o){const r=o?.message||o?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";if(r.includes("runtime.lastError")||r.includes("message port closed")||r.includes("Receiving end does not exist")||r.includes("Could not establish connection")||r.includes("Extension context invalidated")||r.includes("The message port closed before a response was received")){Utils.safeLog("\u26A0 \u062A\u0645 \u062A\u062C\u0627\u0647\u0644 \u062E\u0637\u0623 Chrome Extension \u0641\u064A loadKPIs"),setTimeout(()=>{this.loadKPIs()},1e3);return}const d=this.isGoogleAppsScriptEnabled();if(d&&e&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0623\u062F\u0627\u0621:",r,o),e){let m="\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0644\u062D\u0633\u0627\u0628 \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0623\u062F\u0627\u0621",u=!1;r.includes("\u063A\u064A\u0631 \u0645\u0639\u062A\u0631\u0641 \u0628\u0647")||r.includes("Action not recognized")||r.includes("ACTION_NOT_RECOGNIZED")?(m=r,u=d):r.includes("\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644")?(m="\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644\u0647 \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A",u=!1):d&&(r.includes("Failed to fetch")||r.includes("NetworkError")||r.includes("CORS"))?(m="\u0641\u0634\u0644 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u062E\u0627\u062F\u0645. \u064A\u0631\u062C\u0649 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062A\u0631\u0646\u062A \u0648\u0625\u0639\u062F\u0627\u062F\u0627\u062A \u062E\u0627\u062F\u0645 SQL",u=!0):d&&r.includes("\u0641\u0634\u0644 \u0627\u0644\u0627\u062A\u0635\u0627\u0644")&&(m=r,u=!0),e.innerHTML=`
                    <div class="empty-state">
                ...
                `}}},async loadMemberKPIs(){const e=document.getElementById("kpi-member-select"),t=document.getElementById("kpi-period-select"),s=document.getElementById("kpis-container");if(!e||!s){Utils.safeError("\u0639\u0646\u0627\u0635\u0631 KPIs \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629 \u0641\u064A \u0627\u0644\u0635\u0641\u062D\u0629");return}const a=e.value,i=t?t.value:"";if(!a){s&&(s.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0644\u062D\u0633\u0627\u0628 \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0623\u062F\u0627\u0621</p></div>');return}if(this.loadingStates.kpis){Utils.safeLog("\u26A0\uFE0F loadMemberKPIs: \u0639\u0645\u0644\u064A\u0629 \u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630\u060C \u062A\u0645 \u062A\u062C\u0627\u0647\u0644 \u0627\u0644\u0637\u0644\u0628");return}this.loadingStates.kpis=!0;const n=`kpi_${a}_${i||"current"}`;if(this.cache.kpis.has(n)){const o=this.cache.kpis.get(n);if(o&&o.data&&Date.now()-o.timestamp<this.cache.cacheTimeout){this.renderKPIs(o.data,s),this.loadingStates.kpis=!1;return}}try{const o=GoogleIntegration.sendRequest({action:"getSafetyTeamKPIs",data:{memberId:a,period:i||null}});let r;try{r=await this._raceWithTimeout(o)}catch(c){if(c&&c.timeout){s&&(s.innerHTML='<div class="empty-state"><p class="text-gray-500">\u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u0645\u064A\u0644...</p></div>'),o.then(d=>{if(d&&d.success&&d.data){const m=Array.isArray(d.data)?d.data:[d.data],u=m.length>0?m[0]:null,p=document.getElementById("kpis-container");p&&u&&(this.renderKPIs(u,p),this.cache.kpis.set(n,{data:u,timestamp:Date.now()}))}this.loadingStates.kpis=!1}).catch(()=>{this.loadingStates.kpis=!1});return}throw c}if(r.success&&r.data){const c=Array.isArray(r.data)?r.data:[r.data],d=c.length>0?c[0]:null;if(!d){s.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0624\u0634\u0631\u0627\u062A \u0623\u062F\u0627\u0621 \u0645\u062D\u0633\u0648\u0628\u0629. \u0627\u0636\u063A\u0637 \u0639\u0644\u0649 "\u062D\u0633\u0627\u0628 KPIs"</p></div>',this.loadingStates.kpis=!1;return}this.renderKPIs(d,s),this.cache.kpis.set(n,{data:d,timestamp:Date.now()})}else s.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0624\u0634\u0631\u0627\u062A \u0623\u062F\u0627\u0621 \u0645\u062D\u0633\u0648\u0628\u0629</p></div>'}catch(o){const r=o?.message||o?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0623\u062F\u0627\u0621:",r,o);const c=this.isGoogleAppsScriptEnabled();let d="\u062D\u062F\u062B \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0623\u062F\u0627\u0621",m=!0;r.includes("\u063A\u064A\u0631 \u0645\u0639\u062A\u0631\u0641 \u0628\u0647")||r.includes("Action not recognized")||r.includes("ACTION_NOT_RECOGNIZED")?d=r:r.includes("\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644")?c?(d='\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0624\u0634\u0631\u0627\u062A \u0623\u062F\u0627\u0621 \u0645\u062D\u0633\u0648\u0628\u0629. \u0627\u0636\u063A\u0637 \u0639\u0644\u0649 "\u062D\u0633\u0627\u0628 KPIs"',m=!1):d="\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644\u0647 \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0623\u0648 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062A\u0631\u0646\u062A":!c&&(r.includes("Failed to fetch")||r.includes("NetworkError")||r.includes("CORS"))?(d='\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0624\u0634\u0631\u0627\u062A \u0623\u062F\u0627\u0621 \u0645\u062D\u0633\u0648\u0628\u0629. \u0627\u0636\u063A\u0637 \u0639\u0644\u0649 "\u062D\u0633\u0627\u0628 KPIs"',m=!1):r.includes("Failed to fetch")||r.includes("NetworkError")||r.includes("CORS")?c?d="\u0641\u0634\u0644 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u062E\u0627\u062F\u0645. \u064A\u0631\u062C\u0649 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062A\u0631\u0646\u062A \u0648\u0625\u0639\u062F\u0627\u062F\u0627\u062A \u062E\u0627\u062F\u0645 SQL":(d='\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0624\u0634\u0631\u0627\u062A \u0623\u062F\u0627\u0621 \u0645\u062D\u0633\u0648\u0628\u0629. \u0627\u0636\u063A\u0637 \u0639\u0644\u0649 "\u062D\u0633\u0627\u0628 KPIs"',m=!1):c||(d='\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0624\u0634\u0631\u0627\u062A \u0623\u062F\u0627\u0621 \u0645\u062D\u0633\u0648\u0628\u0629. \u0627\u0636\u063A\u0637 \u0639\u0644\u0649 "\u062D\u0633\u0627\u0628 KPIs"',m=!1),s.innerHTML=`
                <div class="empty-state">
            ...
            `}finally{this.loadingStates.kpis=!1}},renderKPIs(e,t){if(!e||!t)return;const s=e.targetInspections||20,a=e.targetObservations||15,i=e.targetTrainings||3,n=e.targetCommitment||95,o=e.targetActionsClosure||80,r=s>0?Math.min((e.inspectionsCount||0)/s*100,100):0,c=e.closedActionsCount||0,d=Math.min(100,c/10*100),m=a>0?Math.min((e.observationsCount||0)/a*100,100):0,u=i>0?Math.min((e.trainingsCount||0)/i*100,100):0,p=typeof e.commitmentRate=="number"?e.commitmentRate:typeof e.commitmentRate=="object"&&e.commitmentRate!==null?0:parseFloat(e.commitmentRate)||0,h=Math.min(Number(e.targetCommitment)||95,100);t.innerHTML=`
            <style>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
                <div class="shm-kpi-card">
                    ...
                    <div class="shm-kpi-body">
                        ...
                        <div class="shm-kpi-target">\u0627\u0644\u0647\u062F\u0641: ${s}</div>
                    </div>
                ...
                <div class="shm-kpi-card">
                    <div class="shm-kpi-icon ${p>=h?"bg-emerald-100 text-emerald-600":"bg-amber-100 text-amber-600"}"><i class="fas fa-percentage"></i></div>
                    <div class="shm-kpi-body">
                        <div class="shm-kpi-label">\u0646\u0633\u0628\u0629 \u0627\u0644\u0627\u0644\u062A\u0632\u0627\u0645</div>
                        <div class="shm-kpi-value">${p.toFixed(1)}%</div>
                        <div class="shm-kpi-target">\u0627\u0644\u0647\u062F\u0641: ${h}%</div>
                    </div>
                    <div class="shm-kpi-bar-wrap"><div class="shm-kpi-bar-fill ${p>=h?"bg-emerald-500":"bg-amber-500"}" style="width: ${Math.min(p,100)}%"></div></div>
                </div>
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div class="space-y-0 divide-y divide-gray-100">
                    ${this.renderKPIChartBar("\u0627\u0644\u062C\u0648\u0644\u0627\u062A \u0627\u0644\u062A\u0641\u062A\u064A\u0634\u064A\u0629",e.inspectionsCount||0,s)}
        ...
        `,document.body.appendChild(t),t.querySelector("#save-kpi-btn").addEventListener("click",async()=>{const a={inspectionsCount:parseInt(document.getElementById("inspectionsCount").value)||0,closedActionsCount:parseInt(document.getElementById("closedActionsCount").value)||0,observationsCount:parseInt(document.getElementById("observationsCount").value)||0,trainingsCount:parseInt(document.getElementById("trainingsCount").value)||0,incidentsHandledCount:parseInt(document.getElementById("incidentsHandledCount").value)||0,nearMissCount:parseInt(document.getElementById("nearMissCount").value)||0,ptwCount:parseInt(document.getElementById("ptwCount").value)||0,commitmentRate:parseFloat(document.getElementById("commitmentRate").value)||0};try{Loading.show();const i=await GoogleIntegration.sendRequest({action:"updateSafetyTeamKPI",data:{kpiId:e.id,updateData:a}});i.success?(Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0624\u0634\u0631\u0627\u062A \u0628\u0646\u062C\u0627\u062D"),t.remove(),this.loadMemberKPIs()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(i.message||"\u0641\u0634\u0644 \u0627\u0644\u062A\u062D\u062F\u064A\u062B"))}catch(i){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+i.message)}finally{Loading.hide()}}),t.addEventListener("click",a=>{a.target===t&&t.remove()})},renderKPIChartBar(e,t,s){const a=s>0?Math.min(t/s*100,100):0,i=a>=80?"bg-emerald-500":a>=50?"bg-amber-500":"bg-red-500";return`
            <div class="shm-kpi-chart-row flex flex-wrap items-center gap-4 py-4">
                ...
                <span class="text-gray-600 font-medium text-base flex-shrink-0 min-w-[4rem]">${t} / ${s}</span>
        ...
        `},async loadTasks(){const e=document.getElementById("task-member-select"),t=document.getElementById("tasks-container");if(!(!e||!t))try{const s=await GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});if(s.success&&s.data){const a=Array.isArray(s.data)?s.data:[];e.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+a.map(i=>`
                        <option value="${i.id}">${Utils.escapeHTML(i.name||"")}</option>
                    `).join(""),e.addEventListener("change",()=>this.loadMemberTasks()),document.getElementById("add-task-btn")?.addEventListener("click",()=>this.showTaskForm())}}catch(s){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0647\u0627\u0645:",s)}},async loadMemberTasks(){const e=document.getElementById("task-member-select").value,t=document.getElementById("tasks-container");if(!e){t.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0644\u0639\u0631\u0636 \u0627\u0644\u0645\u0647\u0627\u0645</p></div>';return}try{Loading.show();const s=await GoogleIntegration.sendRequest({action:"getSafetyTeamTasks",data:{memberId:e}});if(s.success&&s.data){const a=Array.isArray(s.data)?s.data:[];if(a.length===0){t.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0647\u0627\u0645 \u0645\u0633\u062C\u0644\u0629</p></div>',Loading.hide();return}t.innerHTML=`
                    <div class="space-y-3">
                        ${a.map(i=>`
                ...
                `}else t.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0647\u0627\u0645 \u0645\u0633\u062C\u0644\u0629</p></div>'}catch(s){const a=s?.message||s?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0647\u0627\u0645:",a,s),t.innerHTML=`<div class="empty-state"><p class="text-red-500">\u062D\u062F\u062B \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: ${Utils.escapeHTML(a)}</p></div>`}finally{Loading.hide()}},showTaskForm(e=null){const t=document.getElementById("task-member-select")?.value;if(!t&&!e){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0623\u0648\u0644\u0627\u064B");return}const s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
            <div class="modal-content" style="max-width: 600px;">
                <div class="modal-header">
        ...
        `,document.body.appendChild(s),s.querySelector("#save-task-btn").addEventListener("click",async()=>{const i={memberId:e?e.memberId:t,taskTitle:document.getElementById("taskTitle").value.trim(),taskDescription:document.getElementById("taskDescription").value.trim(),taskType:document.getElementById("taskType").value,priority:document.getElementById("priority").value,dueDate:document.getElementById("dueDate").value||null,status:document.getElementById("status").value,notes:document.getElementById("notes").value.trim(),assignedBy:AppState.currentUser?.id||AppState.currentUser?.name||""};if(!i.taskTitle){Notification.error("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0639\u0646\u0648\u0627\u0646 \u0627\u0644\u0645\u0647\u0645\u0629");return}try{Loading.show();const n=e?await GoogleIntegration.sendRequest({action:"updateSafetyTeamTask",data:{taskId:e.id,updateData:i}}):await GoogleIntegration.sendRequest({action:"addSafetyTeamTask",data:i});n.success?(Notification.success(e?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0647\u0645\u0629 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0647\u0645\u0629 \u0628\u0646\u062C\u0627\u062D"),s.remove(),this.loadMemberTasks()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(n.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"))}catch(n){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+n.message)}finally{Loading.hide()}}),s.addEventListener("click",i=>{i.target===s&&s.remove()})},async editTask(e){try{Loading.show();const t=document.getElementById("task-member-select").value,s=await GoogleIntegration.sendRequest({action:"getSafetyTeamTasks",data:{memberId:t}});if(s.success&&s.data){const a=s.data.find(i=>i.id===e);a?this.showTaskForm(a):Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0645\u0647\u0645\u0629")}}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},async deleteTask(e){if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0647 \u0627\u0644\u0645\u0647\u0645\u0629\u061F"))try{Loading.show();const t=await GoogleIntegration.sendRequest({action:"deleteSafetyTeamTask",data:{taskId:e}});t.success?(Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0647\u0645\u0629 \u0628\u0646\u062C\u0627\u062D"),this.loadMemberTasks()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(t.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641"))}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},async renderReportsView(){return`
            <div class="content-card">
                <div class="card-header">
                    <div class="flex items-center justify-between">
        ...
        `},async loadReports(){const e=document.getElementById("report-member-select");if(!e)return;const t=this.getDataAccessMessage("generateSafetyTeamPerformanceReport",{});if(t){e.innerHTML=`<option value="">${t}</option>`;const a=document.getElementById("reports-container");a&&(a.innerHTML=`<div class="empty-state"><p class="text-gray-500">${t}</p></div>`);return}let s=this._getMembersFromCache();s&&s.length>0&&(e.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+s.map(a=>`<option value="${a.id}">${Utils.escapeHTML(a.name||"")}</option>`).join(""),document.getElementById("generate-report-btn")?.addEventListener("click",()=>this.generateReport()));try{const a=GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});let i;try{i=await this._raceWithTimeout(a)}catch(n){n&&n.timeout&&a.then(o=>{if(o&&o.success&&o.data){const r=Array.isArray(o.data)?o.data:[];this.cache.members=r,this.cache.lastLoad=Date.now();const c=document.getElementById("report-member-select");c&&(c.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+r.map(d=>`<option value="${d.id}">${Utils.escapeHTML(d.name||"")}</option>`).join("")),document.getElementById("generate-report-btn")?.addEventListener("click",()=>this.generateReport())}}).catch(()=>{});return}i&&i.success&&i.data&&(s=Array.isArray(i.data)?i.data:[],this.cache.members=s,this.cache.lastLoad=Date.now(),e.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+s.map(n=>`<option value="${n.id}">${Utils.escapeHTML(n.name||"")}</option>`).join(""),document.getElementById("generate-report-btn")?.addEventListener("click",()=>this.generateReport()))}catch(a){const i=a?.message||a?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";if(Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631:",i,a),e){const n=this.isGoogleAppsScriptEnabled();let o="\u062D\u062F\u062B \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631",r=!0;i.includes("\u063A\u064A\u0631 \u0645\u0639\u062A\u0631\u0641 \u0628\u0647")||i.includes("Action not recognized")||i.includes("ACTION_NOT_RECOGNIZED")?o=i:i.includes("\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644")?n?(o="\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0648\u0625\u0646\u0634\u0627\u0621 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0623\u062F\u0627\u0621",r=!1):o="\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644\u0647 \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0623\u0648 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062A\u0631\u0646\u062A":!n&&(i.includes("Failed to fetch")||i.includes("NetworkError")||i.includes("CORS"))?(o="\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0648\u0625\u0646\u0634\u0627\u0621 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0623\u062F\u0627\u0621",r=!1):i.includes("Failed to fetch")||i.includes("NetworkError")||i.includes("CORS")?n?o="\u0641\u0634\u0644 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u062E\u0627\u062F\u0645. \u064A\u0631\u062C\u0649 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062A\u0631\u0646\u062A \u0648\u0625\u0639\u062F\u0627\u062F\u0627\u062A \u062E\u0627\u062F\u0645 SQL":(o="\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0648\u0625\u0646\u0634\u0627\u0621 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0623\u062F\u0627\u0621",r=!1):n||(o="\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0648\u0625\u0646\u0634\u0627\u0621 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0623\u062F\u0627\u0621",r=!1),e.innerHTML=`
                ...
                `;const c=document.getElementById("reports-container");c&&(c.innerHTML=`
                    ...
                    `)}}},async generateReport(){const e=document.getElementById("report-member-select").value;if(!e){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642");return}try{Loading.show();var t=new Date,s=new Date(t.getFullYear(),t.getMonth(),1),a=new Date(t.getFullYear(),t.getMonth(),t.getDate());const i=await GoogleIntegration.sendRequest({action:"generateSafetyTeamPerformanceReport",data:{memberId:e,startDate:s.toISOString?s.toISOString().slice(0,10):s,endDate:a.toISOString?a.toISOString().slice(0,10):a}});if(i.success&&i.data){const n=i.data,o=document.getElementById("reports-container");o.innerHTML=`
                ...
                `}else Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(i.message||"\u0641\u0634\u0644 \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u062A\u0642\u0631\u064A\u0631"))}catch(i){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+i.message)}finally{Loading.hide()}},async exportReport(e){if(!e){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642");return}try{Loading.show();const t=await GoogleIntegration.sendRequest({action:"generateSafetyTeamPerformanceReport",data:{memberId:e}});if(t.success&&t.data){const s=t.data,a=s.member||{},i=s.kpis||{},n=s.summary||{},o=`
                    <div style="font-family: Arial, sans-serif; padding: 20px; direction: rtl;">
                        ...
                        <div style="background: #f3f4f6; padding: 15px; border-radius: 8px; margin-bottom: 20px;">
                            ...
                            <p style="margin-bottom: 10px;">${Utils.escapeHTML(s.jobDescription.roleDescription||"\u2014")}</p>
                            <p><strong>\u0627\u0644\u0645\u0633\u0624\u0648\u0644\u064A\u0627\u062A:</strong></p>
                            <p>${Utils.escapeHTML(s.jobDescription.responsibilities||"\u2014")}</p>
                        </div>
                        `:""}
                ...
                `;if(typeof PDFTemplates<"u"&&PDFTemplates.buildDocument){const r=`SAFETY-TEAM-PERFORMANCE-${a.id?.substring(0,8)||"UNKNOWN"}`,c=PDFTemplates.buildDocument({title:`\u062A\u0642\u0631\u064A\u0631 \u0623\u062F\u0627\u0621 - ${Utils.escapeHTML(a.name||"")}`,formCode:r,content:o,createdAt:new Date,meta:{"\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641":Utils.escapeHTML(a.name||""),\u0627\u0644\u0648\u0638\u064A\u0641\u0629:Utils.escapeHTML(a.jobTitle||""),\u0627\u0644\u0642\u0633\u0645:Utils.escapeHTML(a.department||"")}}),d=window.open("","_blank");d&&(d.document.write(c),d.document.close(),setTimeout(()=>d.print(),500))}else{const r=window.open("","_blank");r.document.write(`
                    ...
                    `),r.document.close(),setTimeout(()=>r.print(),250)}Notification.success("\u062A\u0645 \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u062A\u0642\u0631\u064A\u0631 \u0628\u0646\u062C\u0627\u062D")}else Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(t.message||"\u0641\u0634\u0644 \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u062A\u0642\u0631\u064A\u0631"))}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},async exportReportExcel(e){if(!e){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642");return}try{Loading.show();const t=await GoogleIntegration.sendRequest({action:"generateSafetyTeamPerformanceReport",data:{memberId:e}});if(t.success&&t.data){const s=t.data,a=s.member||{},i=s.kpis||{},n=s.summary||{};if(typeof XLSX>"u"){Notification.error("\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629. \u064A\u0631\u062C\u0649 \u0627\u0644\u062A\u0623\u0643\u062F \u0645\u0646 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0643\u062A\u0628\u0629"),Loading.hide();return}const o=XLSX.utils.book_new(),r=[["\u062A\u0642\u0631\u064A\u0631 \u0623\u062F\u0627\u0621 \u0645\u0648\u0638\u0641"],[""],["\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641"],["\u0627\u0644\u0627\u0633\u0645",a.name||"\u2014"],["\u0627\u0644\u0648\u0638\u064A\u0641\u0629",a.jobTitle||"\u2014"],["\u0627\u0644\u0642\u0633\u0645",a.department||"\u2014"],["\u0627\u0644\u0628\u0631\u064A\u062F \u0627\u0644\u0625\u0644\u0643\u062A\u0631\u0648\u0646\u064A",a.email||"\u2014"],["\u0627\u0644\u0647\u0627\u062A\u0641",a.phone||"\u2014"],["\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062A\u0639\u064A\u064A\u0646",a.appointmentDate?Utils.formatDate(a.appointmentDate):"\u2014"],[""],["\u0645\u0644\u062E\u0635 \u0627\u0644\u0623\u062F\u0627\u0621"],["\u0627\u0644\u062C\u0648\u0644\u0627\u062A \u0627\u0644\u062A\u0641\u062A\u064A\u0634\u064A\u0629",n.totalInspections||0],["\u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A \u0627\u0644\u062A\u0635\u062D\u064A\u062D\u064A\u0629",n.totalActions||0],["\u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A \u0627\u0644\u0645\u063A\u0644\u0642\u0629",n.closedActions||0],["\u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A",n.totalObservations||0],["\u0627\u0644\u062A\u062F\u0631\u064A\u0628\u0627\u062A",n.totalTrainings||0],["\u0646\u0633\u0628\u0629 \u0627\u0644\u0627\u0644\u062A\u0632\u0627\u0645",(n.commitmentRate||0).toFixed(1)+"%"],[""],["\u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0623\u062F\u0627\u0621"],["\u0627\u0644\u062C\u0648\u0644\u0627\u062A \u0627\u0644\u062A\u0641\u062A\u064A\u0634\u064A\u0629",i.inspectionsCount||0,"/",i.targetInspections||20],["\u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A \u0627\u0644\u0645\u063A\u0644\u0642\u0629",i.closedActionsCount||0],["\u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A",i.observationsCount||0,"/",i.targetObservations||15],["\u0627\u0644\u062A\u062F\u0631\u064A\u0628\u0627\u062A",i.trainingsCount||0,"/",i.targetTrainings||3],["\u0646\u0633\u0628\u0629 \u0627\u0644\u0627\u0644\u062A\u0632\u0627\u0645",(i.commitmentRate||0).toFixed(1)+"%","/",(i.targetCommitment||95)+"%"]],c=XLSX.utils.aoa_to_sheet(r);if(XLSX.utils.book_append_sheet(o,c,"\u0645\u0644\u062E\u0635 \u0627\u0644\u0623\u062F\u0627\u0621"),s.activities){const m=[["\u0627\u0644\u062C\u0648\u0644\u0627\u062A \u0627\u0644\u062A\u0641\u062A\u064A\u0634\u064A\u0629"],["\u0627\u0644\u062A\u0627\u0631\u064A\u062E","\u0627\u0644\u0645\u0648\u0642\u0639","\u0627\u0644\u062D\u0627\u0644\u0629"],...(s.activities.inspections||[]).map(p=>[p.inspectionDate?Utils.formatDate(p.inspectionDate):"\u2014",p.location||"\u2014",p.status||"\u2014"]),[""],["\u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A \u0627\u0644\u062A\u0635\u062D\u064A\u062D\u064A\u0629"],["\u0627\u0644\u062A\u0627\u0631\u064A\u062E","\u0627\u0644\u0648\u0635\u0641","\u0627\u0644\u062D\u0627\u0644\u0629"],...(s.activities.actions||[]).map(p=>[p.createdAt?Utils.formatDate(p.createdAt):"\u2014",p.description||"\u2014",p.status||"\u2014"]),[""],["\u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A"],["\u0627\u0644\u062A\u0627\u0631\u064A\u062E","\u0627\u0644\u0648\u0635\u0641","\u0627\u0644\u0646\u0648\u0639"],...(s.activities.observations||[]).map(p=>[p.date?Utils.formatDate(p.date):"\u2014",p.description||"\u2014",p.type||"\u2014"]),[""],["\u0627\u0644\u062A\u062F\u0631\u064A\u0628\u0627\u062A"],["\u0627\u0644\u062A\u0627\u0631\u064A\u062E","\u0627\u0644\u0645\u0648\u0636\u0648\u0639","\u0627\u0644\u0645\u0634\u0627\u0631\u0643\u0648\u0646"],...(s.activities.trainings||[]).map(p=>[p.startDate?Utils.formatDate(p.startDate):"\u2014",p.topic||"\u2014",(typeof Training<"u"&&Training.getParticipantsCount?Training.getParticipantsCount(p):0)||"\u2014"])],u=XLSX.utils.aoa_to_sheet(m);XLSX.utils.book_append_sheet(o,u,"\u0627\u0644\u0623\u0646\u0634\u0637\u0629")}const d=`\u062A\u0642\u0631\u064A\u0631_\u0623\u062F\u0627\u0621_${a.name||"\u0645\u0648\u0638\u0641"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(o,d),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u062A\u0642\u0631\u064A\u0631 \u0628\u0646\u062C\u0627\u062D")}else Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(t.message||"\u0641\u0634\u0644 \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u062A\u0642\u0631\u064A\u0631"))}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},async generateAttendanceReport(){const t=document.getElementById("attendance-member-select")?.value;if(!t){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0623\u0648\u0644\u0627\u064B");return}const s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
        ...
        `,document.body.appendChild(s);const a=s.querySelector("#report-period"),i=s.querySelector("#report-month-container");a.addEventListener("change",()=>{i.style.display=a.value==="monthly"?"block":"none"}),i.style.display="block",s.querySelector("#generate-attendance-report-btn").addEventListener("click",async()=>{const o=a.value,r=parseInt(document.getElementById("report-year").value),c=o==="monthly"?parseInt(document.getElementById("report-month").value):null;s.remove();try{Loading.show();const d=await GoogleIntegration.sendRequest({action:"generateAttendanceReport",data:{memberId:t,period:o,year:r,month:c}});if(d.success&&d.data){const m=d.data,u=document.createElement("div");u.className="modal-overlay",u.innerHTML=`
                        <div class="modal-content" style="max-width: 700px;">
                            <div class="modal-header">
                                <h2 class="modal-title">\u062A\u0642\u0631\u064A\u0631 \u062D\u0636\u0648\u0631/\u063A\u064A\u0627\u0628</h2>
                                <button class="modal-close" onclick="this.closest('.modal-overlay').remove()">
                    ...
                    `,document.body.appendChild(u),u.addEventListener("click",p=>{p.target===u&&u.remove()})}else Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(d.message||"\u0641\u0634\u0644 \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u062A\u0642\u0631\u064A\u0631"))}catch(d){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+d.message)}finally{Loading.hide()}}),s.addEventListener("click",o=>{o.target===s&&s.remove()})},async loadSettings(){if(AppState.currentUser?.role!=="admin")return;const e=document.getElementById("settings-container");if(!e)return;if(!this.isGoogleAppsScriptEnabled()){const s={leaveTypes:["\u0633\u0646\u0648\u064A\u0629","\u0645\u0631\u0636\u064A\u0629","\u0637\u0627\u0631\u0626\u0629","\u0623\u062E\u0631\u0649"],attendanceStatuses:["\u062D\u0627\u0636\u0631","\u0645\u062A\u0623\u062E\u0631","\u063A\u0627\u0626\u0628","\u0639\u0645\u0644 \u0645\u064A\u062F\u0627\u0646\u064A"],kpiTargets:{targetInspections:20,targetActionsClosure:80,targetObservations:15,targetTrainings:3,targetCommitment:95,inspectionsPerMonth:20,actionsClosureRate:80,observationsPerMonth:15,trainingsPerMonth:2,commitmentRate:95}};this.renderSettingsContent(e,s);return}try{e.innerHTML='<div class="empty-state"><p class="text-gray-500">\u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u0645\u064A\u0644...</p></div>';const s=GoogleIntegration.sendRequest({action:"getSafetyHealthManagementSettings",data:{}});let a;try{a=await this._raceWithTimeout(s)}catch(i){if(i&&i.timeout)s.then(n=>{const o=document.getElementById("settings-container");if(o)if(n&&n.success&&n.data)this.renderSettingsContent(o,n.data);else{const r={leaveTypes:["\u0633\u0646\u0648\u064A\u0629","\u0645\u0631\u0636\u064A\u0629","\u0637\u0627\u0631\u0626\u0629","\u0623\u062E\u0631\u0649"],attendanceStatuses:["\u062D\u0627\u0636\u0631","\u0645\u062A\u0623\u062E\u0631","\u063A\u0627\u0626\u0628","\u0639\u0645\u0644 \u0645\u064A\u062F\u0627\u0646\u064A"],kpiTargets:{targetInspections:20,targetActionsClosure:80,targetObservations:15,targetTrainings:3,targetCommitment:95}};this.renderSettingsContent(o,r)}}).catch(()=>{});else throw i}if(a&&a.success&&a.data){const i=a.data;this.renderSettingsContent(e,i)}else if(a){const i={leaveTypes:["\u0633\u0646\u0648\u064A\u0629","\u0645\u0631\u0636\u064A\u0629","\u0637\u0627\u0631\u0626\u0629","\u0623\u062E\u0631\u0649"],attendanceStatuses:["\u062D\u0627\u0636\u0631","\u0645\u062A\u0623\u062E\u0631","\u063A\u0627\u0626\u0628","\u0639\u0645\u0644 \u0645\u064A\u062F\u0627\u0646\u064A"],kpiTargets:{targetInspections:20,targetActionsClosure:80,targetObservations:15,targetTrainings:3,targetCommitment:95,inspectionsPerMonth:20,actionsClosureRate:80,observationsPerMonth:15,trainingsPerMonth:2,commitmentRate:95}};this.renderSettingsContent(e,i)}}catch(s){const a=s?.message||s?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";this.isGoogleAppsScriptEnabled()&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A:",a,s);const n={leaveTypes:["\u0633\u0646\u0648\u064A\u0629","\u0645\u0631\u0636\u064A\u0629","\u0637\u0627\u0631\u0626\u0629","\u0623\u062E\u0631\u0649"],attendanceStatuses:["\u062D\u0627\u0636\u0631","\u0645\u062A\u0623\u062E\u0631","\u063A\u0627\u0626\u0628","\u0639\u0645\u0644 \u0645\u064A\u062F\u0627\u0646\u064A"],kpiTargets:{targetInspections:20,targetActionsClosure:80,targetObservations:15,targetTrainings:3,targetCommitment:95,inspectionsPerMonth:20,actionsClosureRate:80,observationsPerMonth:15,trainingsPerMonth:2,commitmentRate:95}};this.renderSettingsContent(e,n)}},renderSettingsContent(e,t){!e||!t||(e.innerHTML=`
                    <div>
                        <h3 class="font-semibold text-gray-700 mb-3">\u0623\u0646\u0648\u0627\u0639 \u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A</h3>
                        <div id="leave-types-container" class="space-y-2">
                            ${(t.leaveTypes||["\u0633\u0646\u0648\u064A\u0629","\u0645\u0631\u0636\u064A\u0629","\u0637\u0627\u0631\u0626\u0629","\u0623\u062E\u0631\u0649"]).map((s,a)=>`
                                <div class="flex items-center gap-2">
                                    <input type="text" class="form-input flex-1 leave-type-input" 
                                           value="${Utils.escapeHTML(s)}" data-index="${a}">
                    ...
                    <div class="border-t border-gray-200 pt-6 mt-6">
                        ...
                        <div id="attendance-statuses-container" class="space-y-2">
                            ${(t.attendanceStatuses||["\u062D\u0627\u0636\u0631","\u0645\u062A\u0623\u062E\u0631","\u063A\u0627\u0626\u0628","\u0639\u0645\u0644 \u0645\u064A\u062F\u0627\u0646\u064A"]).map((s,a)=>`
                                <div class="flex items-center gap-2">
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-semibold">${t.kpiTargets?.inspectionsPerMonth||20}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">\u0646\u0633\u0628\u0629 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A:</span>
                                    <span class="font-semibold">${t.kpiTargets?.actionsClosureRate||80}%</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">\u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A \u0627\u0644\u0634\u0647\u0631\u064A\u0629:</span>
                                    <span class="font-semibold">${t.kpiTargets?.observationsPerMonth||15}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">\u0627\u0644\u062A\u062F\u0631\u064A\u0628\u0627\u062A \u0627\u0644\u0634\u0647\u0631\u064A\u0629:</span>
                                    <span class="font-semibold">${t.kpiTargets?.trainingsPerMonth||2}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">\u0646\u0633\u0628\u0629 \u0627\u0644\u0627\u0644\u062A\u0632\u0627\u0645:</span>
                                    <span class="font-semibold">${t.kpiTargets?.commitmentRate||95}%</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                `,this.currentSettings=t,requestAnimationFrame(()=>{const s=e.querySelector('button[onclick*="addLeaveType"]');if(s){const c=s.cloneNode(!0);s.parentNode.replaceChild(c,s),c.addEventListener("click",()=>this.addLeaveType())}const a=e.querySelector('button[onclick*="saveLeaveTypes"]');if(a){const c=a.cloneNode(!0);a.parentNode.replaceChild(c,a),c.addEventListener("click",()=>this.saveLeaveTypes())}const i=e.querySelector('button[onclick*="addAttendanceStatus"]');if(i){const c=i.cloneNode(!0);i.parentNode.replaceChild(c,i),c.addEventListener("click",()=>this.addAttendanceStatus())}const n=e.querySelector('button[onclick*="saveAttendanceStatuses"]');if(n){const c=n.cloneNode(!0);n.parentNode.replaceChild(c,n),c.addEventListener("click",()=>this.saveAttendanceStatuses())}const o=e.querySelector('button[onclick*="showKPITargetsForm"]');if(o){const c=o.cloneNode(!0);o.parentNode.replaceChild(c,o),c.addEventListener("click",()=>this.showKPITargetsForm())}const r=e.querySelector('button[onclick*="showCustomKPIForm"]');if(r){const c=r.cloneNode(!0);r.parentNode.replaceChild(c,r),c.addEventListener("click",()=>this.showCustomKPIForm())}}),this.loadCustomKPIs())},addLeaveType(){const e=document.getElementById("leave-types-container");if(!e)return;const t=e.children.length,s=document.createElement("div");s.className="flex items-center gap-2",s.innerHTML=`
            <input type="text" class="form-input flex-1 leave-type-input" 
                   placeholder="\u0646\u0648\u0639 \u0627\u0644\u0625\u062C\u0627\u0632\u0629" data-index="${t}">
            <button onclick="SafetyHealthManagement.removeLeaveType(${t})" class="btn-danger btn-sm">
                <i class="fas fa-trash"></i>
            </button>
        `,e.appendChild(s)},removeLeaveType(e){const t=document.getElementById("leave-types-container");if(!t)return;const s=t.querySelector(`[data-index="${e}"]`)?.closest(".flex");s&&s.remove()},async saveLeaveTypes(){const e=document.getElementById("leave-types-container");if(!e)return;if(!this.isGoogleAppsScriptEnabled()){Notification.warning("\u0644\u0627 \u064A\u0645\u0643\u0646 \u062D\u0641\u0638 \u0627\u0644\u062A\u063A\u064A\u064A\u0631\u0627\u062A. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644 \u062E\u0627\u062F\u0645 SQL \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A");return}const t=Array.from(e.querySelectorAll(".leave-type-input")).map(s=>s.value.trim()).filter(s=>s!=="");if(t.length===0){Notification.error("\u064A\u0631\u062C\u0649 \u0625\u0636\u0627\u0641\u0629 \u0646\u0648\u0639 \u0625\u062C\u0627\u0632\u0629 \u0648\u0627\u062D\u062F \u0639\u0644\u0649 \u0627\u0644\u0623\u0642\u0644");return}Loading.show();try{const s=await GoogleIntegration.sendRequest({action:"updateLeaveTypes",data:{leaveTypes:t}});s.success?(Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0623\u0646\u0648\u0627\u0639 \u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0628\u0646\u062C\u0627\u062D"),this.loadSettings()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(s.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"))}catch(s){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+s.message)}finally{Loading.hide()}},addAttendanceStatus(){const e=document.getElementById("attendance-statuses-container");if(!e)return;const t=e.children.length,s=document.createElement("div");s.className="flex items-center gap-2",s.innerHTML=`
            <input type="text" class="form-input flex-1 attendance-status-input" 
                   placeholder="\u062A\u0635\u0646\u064A\u0641 \u0627\u0644\u062D\u0636\u0648\u0631" data-index="${t}">
            <button onclick="SafetyHealthManagement.removeAttendanceStatus(${t})" class="btn-danger btn-sm">
                <i class="fas fa-trash"></i>
            </button>
        `,e.appendChild(s)},removeAttendanceStatus(e){const t=document.getElementById("attendance-statuses-container");if(!t)return;const s=t.querySelector(`[data-index="${e}"]`)?.closest(".flex");s&&s.remove()},async saveAttendanceStatuses(){const e=document.getElementById("attendance-statuses-container");if(!e)return;if(!this.isGoogleAppsScriptEnabled()){Notification.warning("\u0644\u0627 \u064A\u0645\u0643\u0646 \u062D\u0641\u0638 \u0627\u0644\u062A\u063A\u064A\u064A\u0631\u0627\u062A. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644 \u062E\u0627\u062F\u0645 SQL \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A");return}const t=Array.from(e.querySelectorAll(".attendance-status-input")).map(s=>s.value.trim()).filter(s=>s!=="");if(t.length===0){Notification.error("\u064A\u0631\u062C\u0649 \u0625\u0636\u0627\u0641\u0629 \u062A\u0635\u0646\u064A\u0641 \u062D\u0636\u0648\u0631 \u0648\u0627\u062D\u062F \u0639\u0644\u0649 \u0627\u0644\u0623\u0642\u0644");return}Loading.show();try{const s=await GoogleIntegration.sendRequest({action:"updateAttendanceStatuses",data:{statuses:t}});s.success?(Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u062A\u0635\u0646\u064A\u0641\u0627\u062A \u0627\u0644\u062D\u0636\u0648\u0631 \u0628\u0646\u062C\u0627\u062D"),this.loadSettings()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(s.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"))}catch(s){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+s.message)}finally{Loading.hide()}},showKPITargetsForm(){const t=(this.currentSettings||{}).kpiTargets||{},s=this.getCustomKPITargets(t),a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
            <div class="modal-content" style="max-width: 800px;">
                <div class="modal-header">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="kpi-target-inspections" required class="form-input" 
                                       value="${t.inspectionsPerMonth||20}" min="0">
                            ...
                            <div>
                                ...
                                <input type="number" id="kpi-target-actions-closure" required class="form-input" 
                                       value="${t.actionsClosureRate||80}" min="0" max="100">
                            ...
                            <div>
                                ...
                                <input type="number" id="kpi-target-observations" required class="form-input" 
                                       value="${t.observationsPerMonth||15}" min="0">
                            ...
                            <div>
                                ...
                                <input type="number" id="kpi-target-trainings" required class="form-input" 
                                       value="${t.trainingsPerMonth||2}" min="0">
                            ...
                            <div>
                                ...
                                <input type="number" id="kpi-target-commitment" required class="form-input" 
                                       value="${t.commitmentRate||95}" min="0" max="100">
        ...
        `,document.body.appendChild(a);const i=a.querySelector("#add-custom-target-btn");i&&i.addEventListener("click",()=>this.addCustomTarget(a)),a.querySelector("#save-kpi-targets-btn").addEventListener("click",()=>this.saveKPITargets(a)),a.addEventListener("click",o=>{o.target===a&&a.remove()})},getCustomKPITargets(e){const t=["inspectionsPerMonth","actionsClosureRate","observationsPerMonth","trainingsPerMonth","commitmentRate","targetInspections","targetActionsClosure","targetObservations","targetTrainings","targetCommitment"],s={};for(const a in e)t.includes(a)||(s[a]=e[a]);return s},renderCustomTargets(e){if(!e||Object.keys(e).length===0)return'<p class="text-sm text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0647\u062F\u0627\u0641 \u0625\u0636\u0627\u0641\u064A\u0629</p>';let t="";for(const s in e)t+=`
                <div class="flex items-center gap-2 custom-target-item" data-key="${Utils.escapeHTML(s)}">
                    <input type="text" class="form-input flex-1" value="${Utils.escapeHTML(s)}" 
                           placeholder="\u0627\u0633\u0645 \u0627\u0644\u0647\u062F\u0641" readonly>
                    <input type="number" class="form-input w-32" value="${e[s]}" 
                           placeholder="\u0627\u0644\u0642\u064A\u0645\u0629" min="0" data-target-key="${Utils.escapeHTML(s)}">
                    <button type="button" class="btn-icon btn-icon-danger" onclick="this.closest('.custom-target-item').remove()">
                        <i class="fas fa-trash"></i>
                    </button>
                </div>
            `;return t},addCustomTarget(e){const t=e.querySelector("#custom-targets-container");if(!t)return;const s=`custom_${Date.now()}`,a=document.createElement("div");a.className="flex items-center gap-2 custom-target-item",a.setAttribute("data-key",s),a.innerHTML=`
            <input type="text" class="form-input flex-1" placeholder="\u0627\u0633\u0645 \u0627\u0644\u0647\u062F\u0641 (\u0645\u062B\u0627\u0644: \u0639\u062F\u062F \u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631)" 
                   id="custom-target-name-${s}">
            <input type="number" class="form-input w-32" value="0" placeholder="\u0627\u0644\u0642\u064A\u0645\u0629" min="0" 
                   data-target-key="${s}" id="custom-target-value-${s}">
            <button type="button" class="btn-icon btn-icon-danger" onclick="this.closest('.custom-target-item').remove()">
                <i class="fas fa-trash"></i>
            </button>
        `,t.appendChild(a),requestAnimationFrame(()=>{const i=a.querySelector(`#custom-target-name-${s}`);i&&i.focus()})},async saveKPITargets(e=null){if(!this.isGoogleAppsScriptEnabled()){Notification.warning("\u0644\u0627 \u064A\u0645\u0643\u0646 \u062D\u0641\u0638 \u0627\u0644\u062A\u063A\u064A\u064A\u0631\u0627\u062A. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644 \u062E\u0627\u062F\u0645 SQL \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A");return}const t={inspectionsPerMonth:parseInt(document.getElementById("kpi-target-inspections")?.value)||20,actionsClosureRate:parseInt(document.getElementById("kpi-target-actions-closure")?.value)||80,observationsPerMonth:parseInt(document.getElementById("kpi-target-observations")?.value)||15,trainingsPerMonth:parseInt(document.getElementById("kpi-target-trainings")?.value)||2,commitmentRate:parseInt(document.getElementById("kpi-target-commitment")?.value)||95,targetInspections:parseInt(document.getElementById("kpi-target-inspections")?.value)||20,targetActionsClosure:parseInt(document.getElementById("kpi-target-actions-closure")?.value)||80,targetObservations:parseInt(document.getElementById("kpi-target-observations")?.value)||15,targetTrainings:parseInt(document.getElementById("kpi-target-trainings")?.value)||2,targetCommitment:parseInt(document.getElementById("kpi-target-commitment")?.value)||95};e&&e.querySelectorAll(".custom-target-item").forEach(a=>{const i=a.querySelector('input[type="text"]'),n=a.querySelector('input[type="number"]');if(i&&n){const o=i.value.trim(),r=parseInt(n.value)||0;o&&(t[o]=r)}}),Loading.show();try{const s=await GoogleIntegration.sendRequest({action:"updateKPITargets",data:{targets:t}});s.success?(Notification.success("\u062A\u0645 \u062D\u0641\u0638 \u0623\u0647\u062F\u0627\u0641 KPIs \u0628\u0646\u062C\u0627\u062D"),e&&e.remove(),this.loadSettings()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(s.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"))}catch(s){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+s.message)}finally{Loading.hide()}},async loadCustomKPIs(){const e=document.getElementById("custom-kpis-container");if(!e)return;const t=this.getDataAccessMessage("getCustomKPIs",{});if(t){e.innerHTML=`
                <div class="empty-state">
                    <p class="text-gray-500 mb-2">${t}</p>
                    <p class="text-xs text-gray-400">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0624\u0634\u0631\u0627\u062A \u0645\u062E\u0635\u0635\u0629 \u0645\u062A\u0627\u062D\u0629</p>
                </div>
            `;return}try{Loading.show();const s=await GoogleIntegration.sendRequest({action:"getSafetyHealthManagementSettings",data:{}});if(s.success&&s.data){const a=s.data;this.currentSettings=a;const i=a.customKPIs||[];if(i.length===0){e.innerHTML=`
                        <div class="empty-state">
                ...
                `).join("")}}catch(s){const a=s?.message||s?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0624\u0634\u0631\u0627\u062A \u0627\u0644\u0645\u062E\u0635\u0635\u0629:",a,s),e.innerHTML=`
                <div class="empty-state">
            ...
            `}finally{Loading.hide()}},showCustomKPIForm(e=null){const t=document.createElement("div");t.className="modal-overlay",t.innerHTML=`
            <div class="modal-content" style="max-width: 800px;">
                <div class="modal-header">
        ...
        `,document.body.appendChild(t),t.querySelector("#save-custom-kpi-btn").addEventListener("click",()=>this.handleCustomKPISubmit(t,e?.id)),t.addEventListener("click",a=>{a.target===t&&t.remove()})},async handleCustomKPISubmit(e,t=null){if(!this.isGoogleAppsScriptEnabled()){Notification.warning("\u0644\u0627 \u064A\u0645\u0643\u0646 \u062D\u0641\u0638 \u0627\u0644\u062A\u063A\u064A\u064A\u0631\u0627\u062A. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644 \u062E\u0627\u062F\u0645 SQL \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A");return}const s=e.querySelector("#custom-kpi-form");if(!s.checkValidity()){s.reportValidity();return}const a={name:document.getElementById("custom-kpi-name").value.trim(),category:document.getElementById("custom-kpi-category").value,description:document.getElementById("custom-kpi-description").value.trim(),module:document.getElementById("custom-kpi-module").value,targetValue:parseFloat(document.getElementById("custom-kpi-target").value)||0,unit:document.getElementById("custom-kpi-unit").value.trim()||"\u0639\u062F\u062F",fieldName:document.getElementById("custom-kpi-field").value.trim()||null,filterValue:document.getElementById("custom-kpi-filter-value").value.trim()||null,isActive:document.getElementById("custom-kpi-active").checked};if(!a.name||!a.category||!a.module){Notification.error("\u064A\u0631\u062C\u0649 \u0645\u0644\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629");return}Loading.show();try{const i=t?"updateCustomKPI":"addCustomKPI",n=t?{kpiId:t,updateData:a}:a,o=await GoogleIntegration.sendRequest({action:i,data:n});o.success?(Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0624\u0634\u0631 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0624\u0634\u0631 \u0628\u0646\u062C\u0627\u062D"),e.remove(),this.loadCustomKPIs(),this.loadSettings()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(o.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"))}catch(i){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+i.message)}finally{Loading.hide()}},async editCustomKPI(e){if(!this.isGoogleAppsScriptEnabled()){Notification.warning("\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644. \u0644\u0627 \u064A\u0645\u0643\u0646 \u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0624\u0634\u0631");return}try{Loading.show();const t=await GoogleIntegration.sendRequest({action:"getSafetyHealthManagementSettings",data:{}});if(t.success&&t.data){const a=t.data.customKPIs||[],i=a.find(n=>(n.id||"").toString()===e.toString()||a.indexOf(n).toString()===e.toString());i?this.showCustomKPIForm(i):Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0645\u0624\u0634\u0631")}}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},async deleteCustomKPI(e){if(!this.isGoogleAppsScriptEnabled()){Notification.warning("\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644. \u0644\u0627 \u064A\u0645\u0643\u0646 \u062D\u0630\u0641 \u0627\u0644\u0645\u0624\u0634\u0631");return}if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0645\u0624\u0634\u0631\u061F \u0633\u064A\u062A\u0645 \u0625\u0632\u0627\u0644\u0629 \u062C\u0645\u064A\u0639 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0631\u062A\u0628\u0637\u0629 \u0628\u0647."))try{Loading.show();const t=await GoogleIntegration.sendRequest({action:"deleteCustomKPI",data:{kpiId:e}});t.success?(Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0624\u0634\u0631 \u0628\u0646\u062C\u0627\u062D"),this.loadCustomKPIs()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(t.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641"))}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},async exportAllToExcel(){try{if(Loading.show(),typeof XLSX>"u"){Notification.error("\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629. \u064A\u0631\u062C\u0649 \u0627\u0644\u062A\u0623\u0643\u062F \u0645\u0646 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0643\u062A\u0628\u0629"),Loading.hide();return}const e=XLSX.utils.book_new();try{const s=await GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});if(s.success&&s.data){const a=Array.isArray(s.data)?s.data:[],i=[["\u0627\u0644\u0627\u0633\u0645","\u0627\u0644\u0648\u0638\u064A\u0641\u0629","\u0627\u0644\u0642\u0633\u0645","\u0627\u0644\u0628\u0631\u064A\u062F \u0627\u0644\u0625\u0644\u0643\u062A\u0631\u0648\u0646\u064A","\u0627\u0644\u0647\u0627\u062A\u0641","\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062A\u0639\u064A\u064A\u0646","\u0627\u0644\u062F\u0631\u062C\u0629 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u0629","\u0631\u0645\u0632 \u0627\u0644\u0645\u0648\u0638\u0641"]];a.forEach(o=>{i.push([o.name||"",o.jobTitle||"",o.department||"",o.email||"",o.phone||"",o.appointmentDate?Utils.formatDate(o.appointmentDate):"",o.positionLevel||"",o.employeeCode||""])});const n=XLSX.utils.aoa_to_sheet(i);XLSX.utils.book_append_sheet(e,n,"\u0641\u0631\u064A\u0642 \u0627\u0644\u0633\u0644\u0627\u0645\u0629")}}catch(s){Utils.safeLog("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 \u0641\u0631\u064A\u0642 \u0627\u0644\u0633\u0644\u0627\u0645\u0629:",s)}try{const s=await GoogleIntegration.sendRequest({action:"getOrganizationalStructure",data:{}});if(s.success&&s.data){const a=Array.isArray(s.data)?s.data:[],i=[["\u0627\u0644\u0645\u0646\u0635\u0628","\u0627\u0633\u0645 \u0627\u0644\u0639\u0636\u0648","\u0627\u0644\u062F\u0631\u062C\u0629 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u0629","\u0627\u0644\u062A\u0631\u062A\u064A\u0628"]];a.forEach(o=>{i.push([o.position||"",o.memberName||"",o.positionLevel||"",o.order||""])});const n=XLSX.utils.aoa_to_sheet(i);XLSX.utils.book_append_sheet(e,n,"\u0627\u0644\u0647\u064A\u0643\u0644 \u0627\u0644\u0648\u0638\u064A\u0641\u064A")}}catch(s){Utils.safeLog("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0647\u064A\u0643\u0644 \u0627\u0644\u0648\u0638\u064A\u0641\u064A:",s)}try{const s=await GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});if(s.success&&s.data){const a=Array.isArray(s.data)?s.data:[],i=[["\u0627\u0633\u0645 \u0627\u0644\u0639\u0636\u0648","\u0627\u0644\u0648\u0638\u064A\u0641\u0629","\u0627\u0644\u062F\u0648\u0631 \u0627\u0644\u0648\u0638\u064A\u0641\u064A","\u0627\u0644\u0645\u0633\u0624\u0648\u0644\u064A\u0627\u062A","\u0627\u0644\u0645\u0647\u0627\u0645","\u0646\u0637\u0627\u0642 \u0627\u0644\u0639\u0645\u0644","\u0627\u0644\u0645\u0624\u0647\u0644\u0627\u062A \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629"]];for(const n of a)try{const o=await GoogleIntegration.sendRequest({action:"getJobDescription",data:{memberId:n.id}});if(o.success&&o.data){const r=o.data;i.push([n.name||"",r.jobTitle||"",r.roleDescription||"",r.responsibilities||"",r.tasks||"",r.workScope||"",r.requiredQualifications||""])}}catch{}if(i.length>1){const n=XLSX.utils.aoa_to_sheet(i);XLSX.utils.book_append_sheet(e,n,"\u0627\u0644\u0648\u0635\u0641 \u0627\u0644\u0648\u0638\u064A\u0641\u064A")}}}catch(s){Utils.safeLog("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0623\u0648\u0635\u0627\u0641 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u0629:",s)}const t=`\u0625\u062F\u0627\u0631\u0629_\u0627\u0644\u0633\u0644\u0627\u0645\u0629_\u0648\u0627\u0644\u0635\u062D\u0629_\u0627\u0644\u0645\u0647\u0646\u064A\u0629_${new Date().toISOString().slice(0,10)}.xlsx`;XLSX.writeFile(e,t),Loading.hide(),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}catch(e){Loading.hide();const t=e?.message||e?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",t,e),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062A\u0635\u062F\u064A\u0631: "+t)}},getKPICategoryLabel(e){return{inspections:"\u0627\u0644\u062C\u0648\u0644\u0627\u062A \u0648\u0627\u0644\u0641\u062D\u0648\u0635\u0627\u062A",training:"\u0627\u0644\u062A\u062F\u0631\u064A\u0628",observations:"\u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A","near-miss":"\u0627\u0644\u062D\u0648\u0627\u062F\u062B \u0627\u0644\u0648\u0634\u064A\u0643\u0629",actions:"\u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A \u0627\u0644\u062A\u0635\u062D\u064A\u062D\u064A\u0629",other:"\u0623\u062E\u0631\u0649"}[e]||e},getKPICategoryColor(e){return{inspections:"bg-blue-100 text-blue-800",training:"bg-green-100 text-green-800",observations:"bg-yellow-100 text-yellow-800","near-miss":"bg-orange-100 text-orange-800",actions:"bg-purple-100 text-purple-800",other:"bg-gray-100 text-gray-800"}[e]||"bg-gray-100 text-gray-800"},getModuleLabel(e){return{PeriodicInspectionRecords:"\u0627\u0644\u062C\u0648\u0644\u0627\u062A \u0648\u0627\u0644\u0641\u062D\u0648\u0635\u0627\u062A \u0627\u0644\u062F\u0648\u0631\u064A\u0629",Training:"\u0627\u0644\u062A\u062F\u0631\u064A\u0628",DailyObservations:"\u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A \u0627\u0644\u064A\u0648\u0645\u064A\u0629",NearMiss:"\u0627\u0644\u062D\u0648\u0627\u062F\u062B \u0627\u0644\u0648\u0634\u064A\u0643\u0629",ActionTrackingRegister:"\u0633\u062C\u0644 \u0645\u062A\u0627\u0628\u0639\u0629 \u0627\u0644\u0625\u062C\u0631\u0627\u0621\u0627\u062A"}[e]||e},async renderAttendanceView(){return`
            <div class="content-card">
                <div class="card-header">
                    <div class="flex items-center justify-between flex-wrap gap-4">
        ...
        `},async loadAttendance(){const e=document.getElementById("attendance-member-select"),t=document.getElementById("add-attendance-btn"),s=document.getElementById("add-leave-btn");if(!e)return;const a=this.getDataAccessMessage("getSafetyTeamAttendance",{});if(a){e.innerHTML=`<option value="">${a}</option>`;const i=document.getElementById("attendance-list"),n=document.getElementById("leaves-list");i&&(i.innerHTML='<div class="empty-state"><p class="text-gray-500">\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644\u0647 \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A</p></div>'),n&&(n.innerHTML='<div class="empty-state"><p class="text-gray-500">\u062E\u0627\u062F\u0645 SQL \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644. \u064A\u0631\u062C\u0649 \u062A\u0641\u0639\u064A\u0644\u0647 \u0645\u0646 \u0627\u0644\u0625\u0639\u062F\u0627\u062F\u0627\u062A</p></div>');return}try{const i=await GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});if(i.success&&i.data){const n=Array.isArray(i.data)?i.data:[];e.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+n.map(o=>`
                        <option value="${o.id}">${Utils.escapeHTML(o.name||"")} - ${Utils.escapeHTML(o.jobTitle||"")}</option>
                    `).join(""),e.addEventListener("change",()=>{e.value?(this.loadMemberAttendance(),this.loadMemberLeaves()):(document.getElementById("attendance-list").innerHTML='<div class="empty-state"><p class="text-gray-500">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0644\u0639\u0631\u0636 \u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631</p></div>',document.getElementById("leaves-list").innerHTML='<div class="empty-state"><p class="text-gray-500">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0644\u0639\u0631\u0636 \u0633\u062C\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A</p></div>')}),t&&t.addEventListener("click",()=>this.showAttendanceForm()),s&&s.addEventListener("click",()=>this.showLeaveForm())}}catch(i){const n=i?.message||i?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062D\u0636\u0648\u0631 \u0648\u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A:",n,i)}},switchAttendanceTab(e){document.querySelectorAll(".attendance-tab-btn").forEach(a=>{a.classList.remove("active"),a.dataset.subtab===e&&a.classList.add("active")});const t=document.getElementById("attendance-content"),s=document.getElementById("leaves-content");t&&(t.style.display=e==="attendance"?"block":"none"),s&&(s.style.display=e==="leaves"?"block":"none")},async loadMemberAttendance(){const e=document.getElementById("attendance-member-select"),t=document.getElementById("attendance-list");if(!e||!t)return;const s=e.value;if(!s){t.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0644\u0639\u0631\u0636 \u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631</p></div>';return}try{Loading.show();const a=await GoogleIntegration.sendRequest({action:"getSafetyTeamAttendance",data:{memberId:s}});if(a.success&&a.data){const i=Array.isArray(a.data)?a.data:[];if(i.length===0){t.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0633\u062C\u0644\u0627\u062A \u062D\u0636\u0648\u0631</p></div>',Loading.hide();return}i.sort((n,o)=>{const r=new Date(n.date||0);return new Date(o.date||0)-r}),t.innerHTML=i.map(n=>{const r={\u062D\u0627\u0636\u0631:"bg-green-100 text-green-800",\u0645\u062A\u0623\u062E\u0631:"bg-yellow-100 text-yellow-800",\u063A\u0627\u0626\u0628:"bg-red-100 text-red-800","\u0639\u0645\u0644 \u0645\u064A\u062F\u0627\u0646\u064A":"bg-blue-100 text-blue-800"}[n.status]||"bg-gray-100 text-gray-800";return`
                        <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                            <div class="flex items-center justify-between">
                                <div class="flex-1">
                    ...
                    `}).join("")}else t.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0633\u062C\u0644\u0627\u062A \u062D\u0636\u0648\u0631</p></div>'}catch(a){const i=a?.message||a?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631:",i,a),t.innerHTML=`<div class="empty-state"><p class="text-red-500">\u062D\u062F\u062B \u062E\u0637\u0623: ${Utils.escapeHTML(i)}</p></div>`}finally{Loading.hide()}},async loadMemberLeaves(){const e=document.getElementById("attendance-member-select"),t=document.getElementById("leaves-list");if(!e||!t)return;const s=e.value;if(!s){t.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0644\u0639\u0631\u0636 \u0633\u062C\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A</p></div>';return}try{Loading.show();const a=await GoogleIntegration.sendRequest({action:"getSafetyTeamLeaves",data:{memberId:s}});if(a.success&&a.data){const i=Array.isArray(a.data)?a.data:[];if(i.length===0){t.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0633\u062C\u0644\u0627\u062A \u0625\u062C\u0627\u0632\u0627\u062A</p></div>',Loading.hide();return}i.sort((n,o)=>{const r=new Date(n.startDate||0);return new Date(o.startDate||0)-r}),t.innerHTML=i.map(n=>{const r={\u0645\u0639\u062A\u0645\u062F:"bg-green-100 text-green-800","\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629":"bg-yellow-100 text-yellow-800",\u0645\u0631\u0641\u0648\u0636:"bg-red-100 text-red-800"}[n.approvalStatus]||"bg-gray-100 text-gray-800";return`
                        <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                            <div class="flex items-center justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center gap-3 mb-2">
                    ...
                    `}).join("")}else t.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0633\u062C\u0644\u0627\u062A \u0625\u062C\u0627\u0632\u0627\u062A</p></div>'}catch(a){const i=a?.message||a?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0633\u062C\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A:",i,a),t.innerHTML=`<div class="empty-state"><p class="text-red-500">\u062D\u062F\u062B \u062E\u0637\u0623: ${Utils.escapeHTML(i)}</p></div>`}finally{Loading.hide()}},showAttendanceForm(e=null){const t=document.getElementById("attendance-member-select"),s=t?t.value:e?e.memberId:"";if(!s&&!e){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0623\u0648\u0644\u0627\u064B");return}const a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
            <div class="modal-content" style="max-width: 600px;">
                <div class="modal-header">
        ...
        `,document.body.appendChild(a),a.querySelector("#save-attendance-btn").addEventListener("click",async()=>{const n=a.querySelector("#attendance-form");if(!n.checkValidity()){n.reportValidity();return}const o={memberId:e?e.memberId:s,date:document.getElementById("attendance-date").value,checkIn:document.getElementById("attendance-check-in").value?new Date(document.getElementById("attendance-date").value+"T"+document.getElementById("attendance-check-in").value).toISOString():null,checkOut:document.getElementById("attendance-check-out").value?new Date(document.getElementById("attendance-date").value+"T"+document.getElementById("attendance-check-out").value).toISOString():null,status:document.getElementById("attendance-status").value,notes:document.getElementById("attendance-notes").value.trim()};try{Loading.show();const r=e?await GoogleIntegration.sendRequest({action:"updateSafetyTeamAttendance",data:{attendanceId:e.id,updateData:o}}):await GoogleIntegration.sendRequest({action:"addSafetyTeamAttendance",data:o});r.success?(Notification.success(e?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062D\u0636\u0648\u0631 \u0628\u0646\u062C\u0627\u062D"),a.remove(),this.loadMemberAttendance()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(r.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"))}catch(r){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+r.message)}finally{Loading.hide()}}),a.addEventListener("click",n=>{n.target===a&&a.remove()})},showLeaveForm(e=null){const t=document.getElementById("attendance-member-select"),s=t?t.value:e?e.memberId:"";if(!s&&!e){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642 \u0623\u0648\u0644\u0627\u064B");return}const a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
            <div class="modal-content" style="max-width: 600px;">
                <div class="modal-header">
        ...
        `,document.body.appendChild(a);const i=a.querySelector("#leave-start-date"),n=a.querySelector("#leave-end-date"),o=()=>{if(i.value&&n.value){const c=new Date(i.value),d=new Date(n.value),m=Math.abs(d-c),u=Math.ceil(m/(1e3*60*60*24))+1}};i.addEventListener("change",o),n.addEventListener("change",o),a.querySelector("#save-leave-btn").addEventListener("click",async()=>{const c=a.querySelector("#leave-form");if(!c.checkValidity()){c.reportValidity();return}const d=new Date(document.getElementById("leave-start-date").value),m=new Date(document.getElementById("leave-end-date").value),u=Math.abs(m-d),p=Math.ceil(u/(1e3*60*60*24))+1,h={memberId:e?e.memberId:s,leaveType:document.getElementById("leave-type").value,startDate:d.toISOString(),endDate:m.toISOString(),daysCount:p,reason:document.getElementById("leave-reason").value.trim(),approvalStatus:document.getElementById("leave-approval-status").value,notes:document.getElementById("leave-notes").value.trim()};try{Loading.show();const y=e?await GoogleIntegration.sendRequest({action:"updateSafetyTeamLeave",data:{leaveId:e.id,updateData:h}}):await GoogleIntegration.sendRequest({action:"addSafetyTeamLeave",data:h});y.success?(Notification.success(e?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0628\u0646\u062C\u0627\u062D"),a.remove(),this.loadMemberLeaves()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(y.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0641\u0638"))}catch(y){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+y.message)}finally{Loading.hide()}}),a.addEventListener("click",c=>{c.target===a&&a.remove()})},async editAttendance(e){try{Loading.show();const t=document.getElementById("attendance-member-select"),s=t?t.value:"";if(!s){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642"),Loading.hide();return}const a=await GoogleIntegration.sendRequest({action:"getSafetyTeamAttendance",data:{memberId:s}});if(a.success&&a.data){const n=(Array.isArray(a.data)?a.data:[]).find(o=>o.id===e);n?this.showAttendanceForm(n):Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631")}}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},async deleteAttendance(e){if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631 \u0647\u0630\u0627\u061F"))try{Loading.show();const t=await GoogleIntegration.sendRequest({action:"deleteSafetyTeamAttendance",data:{attendanceId:e}});t.success?(Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0633\u062C\u0644 \u0627\u0644\u062D\u0636\u0648\u0631 \u0628\u0646\u062C\u0627\u062D"),this.loadMemberAttendance()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(t.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641"))}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},async editLeave(e){try{Loading.show();const t=document.getElementById("attendance-member-select"),s=t?t.value:"";if(!s){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642"),Loading.hide();return}const a=await GoogleIntegration.sendRequest({action:"getSafetyTeamLeaves",data:{memberId:s}});if(a.success&&a.data){const n=(Array.isArray(a.data)?a.data:[]).find(o=>o.id===e);n?this.showLeaveForm(n):Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629")}}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},renderAnalysisView(){return`
            <div class="card">
                <div class="card-header">
                    <div class="flex items-center justify-between">
        ...
        `},async loadAnalysis(){const e=document.getElementById("analysis-container"),t=document.getElementById("analysis-member-select"),s=document.getElementById("analyze-data-btn");if(!e||!t){Utils.safeError("\u0639\u0646\u0627\u0635\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629 \u0641\u064A \u0627\u0644\u0635\u0641\u062D\u0629");return}const a=this.getDataAccessMessage("getAllIncidents",{});if(a){t.innerHTML=`<option value="">${a}</option>`,e.innerHTML=`<div class="empty-state"><p class="text-gray-500">${a}</p></div>`;return}let i=this._getMembersFromCache();i&&i.length>0&&(t.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+i.map(n=>`<option value="${n.id}">${Utils.escapeHTML(n.name||"")}</option>`).join(""));try{const n=GoogleIntegration.sendRequest({action:"getSafetyTeamMembers",data:{}});let o;try{o=await this._raceWithTimeout(n)}catch(r){r&&r.timeout&&n.then(c=>{if(c&&c.success&&c.data){const d=Array.isArray(c.data)?c.data:[];this.cache.members=d,this.cache.lastLoad=Date.now();const m=document.getElementById("analysis-member-select");m&&(m.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+d.map(u=>`<option value="${u.id}">${Utils.escapeHTML(u.name||"")}</option>`).join(""))}}).catch(()=>{}),this._attachAnalysisButton(e,t,s);return}o&&o.success&&o.data&&(i=Array.isArray(o.data)?o.data:[],this.cache.members=i,this.cache.lastLoad=Date.now(),t.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</option>'+i.map(r=>`<option value="${r.id}">${Utils.escapeHTML(r.name||"")}</option>`).join("")),this._attachAnalysisButton(e,t,s)}catch(n){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062A\u062D\u0644\u064A\u0644:",n?.message,n),this._attachAnalysisButton(e,t,s)}},_attachAnalysisButton(e,t,s){if(!s)return;const a=this;s.onclick=function(){const i=t?t.value:"";if(!i){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642");return}a.performComprehensiveAnalysis(i)}},async performComprehensiveAnalysis(e){const t=document.getElementById("analysis-container");if(!t){Notification.error("\u0639\u0646\u0635\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}t.innerHTML=`
            ...
            </div>`;try{const s=String(e),[a,i,n,o,r,c,d,m,u,p]=await Promise.all([GoogleIntegration.sendRequest({action:"getSafetyTeamMember",data:{memberId:e}}),GoogleIntegration.sendRequest({action:"getAllIncidents",data:{filters:{}}}).then(l=>({status:"fulfilled",value:l})).catch(l=>({status:"rejected",reason:l})),GoogleIntegration.sendRequest({action:"getAllNearMisses",data:{filters:{}}}).then(l=>({status:"fulfilled",value:l})).catch(l=>({status:"rejected",reason:l})),GoogleIntegration.sendRequest({action:"getAllPTWs",data:{filters:{}}}).then(l=>({status:"fulfilled",value:l})).catch(l=>({status:"rejected",reason:l})),GoogleIntegration.sendRequest({action:"getAllTrainings",data:{filters:{}}}).then(l=>({status:"fulfilled",value:l})).catch(l=>({status:"rejected",reason:l})),GoogleIntegration.sendRequest({action:"getAllPeriodicInspectionRecords",data:{filters:{}}}).then(l=>({status:"fulfilled",value:l})).catch(l=>({status:"rejected",reason:l})),GoogleIntegration.sendRequest({action:"getSafetyTeamAttendance",data:{memberId:e}}).then(l=>({status:"fulfilled",value:l})).catch(l=>({status:"rejected",reason:l})),GoogleIntegration.sendRequest({action:"getSafetyTeamLeaves",data:{memberId:e}}).then(l=>({status:"fulfilled",value:l})).catch(l=>({status:"rejected",reason:l})),GoogleIntegration.sendRequest({action:"getSafetyTeamKPIs",data:{memberId:e}}).then(l=>({status:"fulfilled",value:l})).catch(l=>({status:"rejected",reason:l})),GoogleIntegration.sendRequest({action:"getAllObservations",data:{filters:{}}}).then(l=>({status:"fulfilled",value:l})).catch(l=>({status:"rejected",reason:l}))]);if(!a.success||!a.data){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642"),t.innerHTML='<div class="empty-state"><p class="text-red-500">\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0639\u0636\u0648 \u0627\u0644\u0641\u0631\u064A\u0642</p></div>';return}const h=a.data;let y=[];try{AppState.appData&&AppState.appData.violations&&(y=AppState.appData.violations)}catch(l){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062C\u0644\u0628 \u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0627\u062A:",l)}const b=l=>l!=null&&String(l)===s,w=i.status==="fulfilled"&&i.value&&i.value.success?(i.value.data||[]).filter(l=>b(l.reportedBy)||b(l.investigatedBy)||b(l.responsible)||b(l.assignedTo)||l.assignees&&Array.isArray(l.assignees)&&l.assignees.some(v=>b(v))):[],k=n.status==="fulfilled"&&n.value&&n.value.success?(n.value.data||[]).filter(l=>b(l.reportedBy)||b(l.investigatedBy)||b(l.responsible)||b(l.assignedTo)):[],$=o.status==="fulfilled"&&o.value&&o.value.success?(o.value.data||[]).filter(l=>b(l.requestedBy)||b(l.approvedBy)||b(l.supervisedBy)||b(l.responsible)||b(l.assignedTo)||l.permitHolders&&Array.isArray(l.permitHolders)&&l.permitHolders.some(v=>b(v))):[],E=Array.isArray(y)?y.filter(l=>b(l.reportedBy)||b(l.investigatedBy)||b(l.assignedTo)||b(l.reporterId)||b(l.inspectorId)):[],H=r.status==="fulfilled"&&r.value&&r.value.success?(r.value.data||[]).filter(l=>{if(b(l.trainer))return!0;if(l.participants!=null){if(Array.isArray(l.participants)){if(l.participants.some(v=>b(v)||v&&b(v.id)))return!0}else if(typeof l.participants=="string"){try{const v=JSON.parse(l.participants);if(Array.isArray(v)&&v.some(T=>b(T)||T&&b(T.id)))return!0}catch{}if(l.participants.indexOf(s)!==-1)return!0}}return b(l.instructor)||l.instructor&&b(l.instructor.id)||b(l.conductedBy)||b(l.organizedBy)}):[],M=c.status==="fulfilled"&&c.value&&c.value.success?(c.value.data||[]).filter(l=>b(l.inspector)||b(l.responsible)||b(l.assignedTo)):[],A=(p.status==="fulfilled"&&p.value&&p.value.success?p.value.data||[]:[]).filter(l=>b(l.supervisor)||b(l.responsible)||b(l.reportedBy)||l.observerName&&h.name&&String(l.observerName).trim()===String(h.name).trim()),S=d.status==="fulfilled"&&d.value&&d.value.success?d.value.data||[]:[],I=m.status==="fulfilled"&&m.value&&m.value.success?m.value.data||[]:[];let L=u.status==="fulfilled"&&u.value&&u.value.success?u.value.data||[]:[];L.length>1&&(L=[...L].sort((l,v)=>{const T=(v.period||"").localeCompare(l.period||"");return T!==0?T:new Date(v.calculatedAt||0)-new Date(l.calculatedAt||0)}));const f={totalIncidents:w.length,totalNearMisses:k.length,totalPTWs:$.length,totalViolations:E.length,totalTrainings:H.length,totalInspections:M.length,totalObservations:A.length,totalAttendanceDays:S.length,presentDays:S.filter(l=>l&&(l.status==="\u062D\u0627\u0636\u0631"||l.status==="present")).length,absentDays:S.filter(l=>l&&(l.status==="\u063A\u0627\u0626\u0628"||l.status==="absent")).length,totalLeaves:I.length,activeLeaves:I.filter(l=>l&&(l.status==="\u0645\u0648\u0627\u0641\u0642"||l.status==="approved")).length,latestKPI:L.length>0?L[0]:null},B=f.totalAttendanceDays>0?(f.presentDays/f.totalAttendanceDays*100).toFixed(1):"0",g=(l,v=0)=>l!=null&&Number.isFinite(Number(l))?Number(l):v,x=f.latestKPI;t.innerHTML=`
                <div id="shm-analysis-root" class="shm-analysis space-y-6">
                    ...
                    <div class="shm-section-card bg-gradient-to-r from-slate-50 to-blue-50/50 border-blue-100">
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <div>
                                <h3 class="text-xl font-bold text-gray-800 mb-1">${Utils.escapeHTML(h.name||"")}</h3>
                                <p class="text-gray-600 text-sm">${Utils.escapeHTML(h.position||"")} \u2014 ${Utils.escapeHTML(h.department||"")}</p>
                            </div>
                            <div class="text-left">
            ...
            `}catch(s){const a=s?.message||s?.toString()||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641";Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",a,s),t.innerHTML=`<div class="empty-state"><p class="text-red-500">\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: ${Utils.escapeHTML(a)}</p></div>`,Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")}finally{Loading.hide()}},async deleteLeave(e){if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0647 \u0627\u0644\u0625\u062C\u0627\u0632\u0629\u061F"))try{Loading.show();const t=await GoogleIntegration.sendRequest({action:"deleteSafetyTeamLeave",data:{leaveId:e}});t.success?(Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0628\u0646\u062C\u0627\u062D"),this.loadMemberLeaves()):Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+(t.message||"\u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641"))}catch(t){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}finally{Loading.hide()}},formatTime(e){if(!e)return"\u2014";try{const t=new Date(e);if(isNaN(t.getTime()))return"\u2014";const s=String(t.getHours()).padStart(2,"0"),a=String(t.getMinutes()).padStart(2,"0");return`${s}:${a}`}catch{return"\u2014"}}};(function(){"use strict";try{typeof window<"u"&&typeof SafetyHealthManagement<"u"&&(window.SafetyHealthManagement=SafetyHealthManagement,typeof AppState<"u"&&AppState.debugMode&&typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u2705 SafetyHealthManagement module loaded and available on window.SafetyHealthManagement"))}catch{if(typeof window<"u"&&typeof SafetyHealthManagement<"u")try{window.SafetyHealthManagement=SafetyHealthManagement}catch{}}})();
