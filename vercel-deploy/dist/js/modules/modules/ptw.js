...
`))&&n.remove()})},printPermitForm(){if(!document.getElementById("ptw-form")){Notification.warning(this._t("module.ptw.notify.formNotFound","\u0627\u0644\u0646\u0645\u0648\u0630\u062C \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}try{const e=this.collectFormDataForPrint(),a=this.currentEditId||e.id||"NEW",r=`PTW-${a.substring(0,8)}`,s=this.generatePrintContent(e),i=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(r,`\u062A\u0635\u0631\u064A\u062D \u0639\u0645\u0644 #${a.substring(0,8)}`,s,!1,!1,{version:"1.0",releaseDate:e.createdAt||new Date().toISOString(),revisionDate:e.updatedAt||new Date().toISOString(),compactPdfFooter:!0,"\u0631\u0642\u0645 \u0627\u0644\u062A\u0635\u0631\u064A\u062D":a.substring(0,8)},e.createdAt||new Date().toISOString(),e.updatedAt||new Date().toISOString()):`<html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>\u0637\u0628\u0627\u0639\u0629 \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644</title></head><body>${s}</body></html>`,o=new Blob([i],{type:"text/html;charset=utf-8"}),n=URL.createObjectURL(o),l=window.open(n,"_blank");l?l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>{URL.revokeObjectURL(n)},800)},500)}:Notification.error(this._t("module.ptw.notify.popupsPrint","\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629"))}catch(e){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0637\u0628\u0627\u0639\u0629 \u0627\u0644\u0646\u0645\u0648\u0630\u062C:",e),Notification.error(this._t("module.ptw.notify.printErr","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u0637\u0628\u0627\u0639\u0629: ")+e.message)}},collectFormDataForPrint(){if(!document.getElementById("ptw-form"))return{};const e=document.getElementById("ptw-location"),a=document.getElementById("ptw-sublocation"),r=e?.options[e?.selectedIndex]?.text||"",s=a?.options[a?.selectedIndex]?.text||"",i=c=>{const u=[];return document.querySelectorAll(`input[name="${c}-option"]`).forEach(m=>{if(m.checked)if(m.value==="other"){const g=document.getElementById(`${c}-other-text`)?.value.trim();g&&u.push(g)}else{const g=m.getAttribute("data-label")||m.value;u.push(g)}}),u},o=[];document.querySelectorAll("#approvals-tbody tr").forEach((c,u)=>{const g=document.getElementById(`approval-role-${u}`)?.value.trim()||"",f=document.getElementById(`approval-approver-select-${u}`),x=document.getElementById(`approval-approver-${u}`),h=f?f.options[f.selectedIndex]?.text||"":x?.value.trim()||"",b=document.getElementById(`approval-status-${u}`)?.value||"pending",R=document.getElementById(`approval-date-${u}`)?.value||"",M=document.getElementById(`approval-comments-${u}`)?.value.trim()||"";g&&o.push({role:g,approver:h,status:b,date:R,comments:M})});const l=typeof PPEMatrix<"u"?PPEMatrix.getSelected():[],p={};if(typeof RiskMatrix<"u"){const c=document.querySelector("#ptw-risk-matrix .risk-matrix-cell.selected")||document.querySelector('#ptw-risk-matrix .risk-matrix-cell[data-selected="true"]');c&&(p.likelihood=c.getAttribute("data-likelihood")||c.getAttribute("data-probability")||"",p.consequence=c.getAttribute("data-consequence")||c.getAttribute("data-severity")||"",p.riskLevel=c.textContent.trim()||"")}const d=document.getElementById("ptw-risk-notes")?.value.trim()||"";return{id:this.currentEditId||"NEW",location:r,sublocation:s,workDescription:document.getElementById("ptw-workDescription")?.value||"",startDate:document.getElementById("ptw-startDate")?.value||"",endDate:document.getElementById("ptw-endDate")?.value||"",requestingParty:(()=>{const c=document.getElementById("ptw-requestingParty-select"),u=document.getElementById("ptw-requestingParty");return c&&c.value&&c.value!=="__custom__"?c.value.trim():u?u.value.trim():""})(),authorizedParty:(()=>{const c=document.getElementById("ptw-authorizedParty-select"),u=document.getElementById("ptw-authorizedParty");return c&&c.value&&c.value!=="__custom__"?c.value.trim():u?u.value.trim():""})(),equipment:this.collectEquipmentFieldValue(document,{matrixId:"#ptw-equipment-matrix",notesId:"#ptw-equipment-notes"}),tools:document.getElementById("ptw-tools")?.value||"",teamMembers:Array.from(document.querySelectorAll("#team-members-list .ptw-team-member-name")).map(c=>({name:c.value.trim()})).filter(c=>c.name),hotWorkDetails:i("ptw-hot"),hotWorkOther:document.getElementById("ptw-hot-other-text")?.value.trim()||"",confinedSpaceDetails:i("ptw-confined"),confinedSpaceOther:document.getElementById("ptw-confined-other-text")?.value.trim()||"",heightWorkDetails:i("ptw-height"),heightWorkOther:document.getElementById("ptw-height-other-text")?.value.trim()||"",electricalWorkType:document.getElementById("ptw-electrical-work-type")?.value.trim()||"",coldWorkType:document.getElementById("ptw-cold-work-type")?.value.trim()||"",otherWorkType:document.getElementById("ptw-other-work-type")?.value.trim()||"",excavationLength:document.getElementById("ptw-excavation-length")?.value.trim()||"",excavationWidth:document.getElementById("ptw-excavation-width")?.value.trim()||"",excavationDepth:document.getElementById("ptw-excavation-depth")?.value.trim()||"",soilType:document.getElementById("ptw-excavation-soil")?.value.trim()||"",preStartChecklist:document.getElementById("ptw-preStartChecklist")?.checked||!1,lotoApplied:document.getElementById("ptw-lotoApplied")?.checked||!1,governmentPermits:document.getElementById("ptw-governmentPermits")?.checked||!1,riskAssessmentAttached:document.getElementById("ptw-riskAssessmentAttached")?.checked||!1,gasTesting:document.getElementById("ptw-gasTesting")?.checked||!1,mocRequest:document.getElementById("ptw-mocRequest")?.checked||!1,requiredPPE:l,riskAssessment:p,riskNotes:d,permitDisclaimer:document.getElementById("ptw-permit-disclaimer-text")?.value.trim()||"",approvals:o,closureStatus:document.querySelector('input[name="ptw-closure-status"]:checked')?.value||"",closureTime:document.getElementById("ptw-closure-time")?.value||"",closureReason:document.getElementById("ptw-closure-reason")?.value||"",closureApprovals:(()=>{const c=[],u=document.getElementById("closure-approvals-tbody");return u&&u.querySelectorAll("tr[data-closure-approval-index]").forEach((g,f)=>{const x=document.getElementById(`closure-approval-role-${f}`),h=document.getElementById(`closure-approval-approver-select-${f}`),k=document.getElementById(`closure-approval-approver-${f}`),b=document.getElementById(`closure-approval-approver-manual-${f}`),I=document.getElementById(`closure-approval-status-${f}`),R=document.getElementById(`closure-approval-date-${f}`),E=document.getElementById(`closure-approval-comments-${f}`);let M=h?.value||"",$=k?.value||"";h&&(M==="__manual__"?(M="",$=b?.value?.trim()||""):M?$=h.options[h.selectedIndex]?.text?.replace(/\s*\((?:مقاول|موظف)\)\s*(\s*-\s*.*)?$/,"").trim()||$:$=""),c.push({role:x?.value||"",approverId:M,approver:$,status:I?.value||"pending",date:R?.value||"",comments:E?.value||"",required:g.getAttribute("data-required")!=="false"})}),c})(),closureApprovalCircuitOwnerId:document.getElementById("closure-approval-circuit-owner-id")?.value||"__default__",closureApprovalCircuitName:this.formClosureCircuitName||"",closureApproval:{name1:"",name2:"",name3:"",name4:"",signature1:"",signature2:"",signature3:"",signature4:""},createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()}},generatePrintContent(t){const e=u=>u?String(u).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):"",a=u=>{if(!u)return"-";try{const m=this.parseDateTimeValue(u);return!m||isNaN(m.getTime())?u||"-":m.toLocaleDateString("ar-SA",{year:"numeric",month:"long",day:"numeric"})}catch{return u}},r=u=>{if(!u)return"-";try{const m=this.parseDateTimeValue(u);return!m||isNaN(m.getTime())?u||"-":m.toLocaleString("ar-SA",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return u}},s=t.teamMembers&&t.teamMembers.length>0?t.teamMembers.map(u=>e(u.name)).join("\u060C "):"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";let i=t.hotWorkDetails&&t.hotWorkDetails.length>0?t.hotWorkDetails.map(u=>e(u)).join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F";t.hotWorkOther&&(i=(i!=="\u0644\u0627 \u064A\u0648\u062C\u062F"?i+"\u060C ":"")+e(t.hotWorkOther));let o=t.confinedSpaceDetails&&t.confinedSpaceDetails.length>0?t.confinedSpaceDetails.map(u=>e(u)).join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F";t.confinedSpaceOther&&(o=(o!=="\u0644\u0627 \u064A\u0648\u062C\u062F"?o+"\u060C ":"")+e(t.confinedSpaceOther));let n=t.heightWorkDetails&&t.heightWorkDetails.length>0?t.heightWorkDetails.map(u=>e(u)).join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F";t.heightWorkOther&&(n=(n!=="\u0644\u0627 \u064A\u0648\u062C\u062F"?n+"\u060C ":"")+e(t.heightWorkOther));const l=[];t.preStartChecklist&&l.push("\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u062A\u062D\u0642\u0642 \u0628\u0642\u0631\u0627\u0631 \u0628\u062F\u0621 \u0627\u0644\u0639\u0645\u0644"),t.lotoApplied&&l.push("\u062A\u0637\u0628\u064A\u0642 \u0646\u0638\u0627\u0645 \u0627\u0644\u0639\u0632\u0644 LOTO"),t.governmentPermits&&l.push("\u062A\u0635\u0627\u0631\u064A\u062D \u062C\u0647\u0627\u062A \u062D\u0643\u0648\u0645\u064A\u0629"),t.riskAssessmentAttached&&l.push("\u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0645\u062E\u0627\u0637\u0631 \u0648\u0648\u0633\u0627\u0626\u0644 \u0627\u0644\u062A\u062D\u0643\u0645"),t.gasTesting&&l.push("\u0642\u064A\u0627\u0633 \u0627\u0644\u063A\u0627\u0632\u0627\u062A"),t.mocRequest&&l.push("\u0637\u0644\u0628 \u062A\u063A\u064A\u064A\u0631 \u0641\u0646\u064A (MOC)");const p=l.length>0?l.join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F",d=t.requiredPPE&&t.requiredPPE.length>0?t.requiredPPE.map(u=>e(u)).join("\u060C "):"\u0644\u0627 \u064A\u0648\u062C\u062F",c=t.approvals&&t.approvals.length>0?`
        ...
        `},_wrapPermitHtmlForA4Export(t){if(!t)return t;const e=`<style id="ptw-a4-export-overrides">${this.getPermitA4ExportOverrides_()}</style>`;return t.includes("</head>")?t.replace("</head>",`${e}</head>`):`<!DOCTYPE html><html dir="rtl" lang="ar"><head><meta charset="UTF-8">${e}</head><body><div id="ptw-permit-print-root">${t}</div></body></html>`},_formatManualPermitDateTime(t){if(!t||t==="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F")return"\u2014";try{const e=this.parseDateTimeValue(t);return!e||isNaN(e.getTime())?String(t):e.toLocaleString("ar-SA",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return String(t)}},generateManualPermitPrintContent(t){const e=this.normalizeManualPermitEntryForPrint(t);if(!e)return"";const a=S=>Utils.escapeHTML(S==null?"":String(S)),r=(S,A,P=!1)=>`
            ...
            </tr>`).join(""),n=[{key:"preStartChecklist",label:"\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u062A\u062D\u0642\u0642 \u0628\u0642\u0631\u0627\u0631 \u0628\u062F\u0621 \u0627\u0644\u0639\u0645\u0644"},{key:"lotoApplied",label:"\u062A\u0637\u0628\u064A\u0642 \u0646\u0638\u0627\u0645 \u0627\u0644\u0639\u0632\u0644 LOTO"},{key:"governmentPermits",label:"\u062A\u0635\u0627\u0631\u064A\u062D \u062C\u0647\u0627\u062A \u062D\u0643\u0648\u0645\u064A\u0629"},{key:"riskAssessmentAttached",label:"\u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0645\u062E\u0627\u0637\u0631 \u0648\u0648\u0633\u0627\u0626\u0644 \u0627\u0644\u062A\u062D\u0643\u0645"},{key:"gasTesting",label:"\u0642\u064A\u0627\u0633 \u0627\u0644\u063A\u0627\u0632\u0627\u062A"},{key:"mocRequest",label:"\u0637\u0644\u0628 \u062A\u063A\u064A\u064A\u0631 \u0641\u0646\u064A (MOC)"}],l=S=>S===!0||S==="true"||S===1||S==="1",p=n.map(S=>{const A=l(e[S.key]);return`<div class="manual-print-req-item${A?" on":""}">${A?"\u2611":"\u2610"} ${a(S.label)}</div>`}).join(""),d=[],c=(S,A,P)=>{const N=Array.isArray(A)?A.filter(Boolean):[],F=P?String(P).trim():"";!N.length&&!F||d.push(`<div class="manual-work-block"><h4>${a(S)}</h4><div>${a([...N,F].filter(Boolean).join("\u060C ")||"\u2014")}</div></div>`)};c("\u0623\u0639\u0645\u0627\u0644 \u0633\u0627\u062E\u0646\u0629",e.hotWorkDetails,e.hotWorkOther),c("\u0623\u0645\u0627\u0643\u0646 \u0645\u063A\u0644\u0642\u0629",e.confinedSpaceDetails,e.confinedSpaceOther),c("\u0639\u0645\u0644 \u0639\u0644\u0649 \u0627\u0631\u062A\u0641\u0627\u0639",e.heightWorkDetails,e.heightWorkOther),(e.excavationLength||e.excavationWidth||e.excavationDepth||e.soilType)&&d.push(`<div class="manual-work-block"><h4>\u0623\u0639\u0645\u0627\u0644 \u062D\u0641\u0631</h4>
                                    ...
                                    <table class="w-full border-collapse text-center" id="manual-risk-matrix-table">
                                        ...
                                        <tbody>
                                            ${[5,4,3,2,1].map(y=>`<tr>
                                                ...
                                                ${[1,2,3,4,5].map(z=>{const K=y*z;let Y="",Q="",O="",rt="";return K<=4?(Y="#22c55e",Q="#ffffff",O="#16a34a",rt="\u0645\u0646\u062E\u0641\u0636"):K<=9?(Y="#eab308",Q="#1c1917",O="#ca8a04",rt="\u0645\u062A\u0648\u0633\u0637"):K<=16?(Y="#f97316",Q="#ffffff",O="#ea580c",rt="\u0645\u0631\u062A\u0641\u0639"):(Y="#dc2626",Q="#ffffff",O="#b91c1c",rt="\u062D\u0631\u062C"),`<td class="p-0 border border-gray-400">
                                                    <button type="button" class="manual-risk-cell w-full h-full p-3 font-bold cursor-pointer transition-all border-0 ${i?.riskLikelihood==y&&i?.riskConsequence==z?"ring-4 ring-blue-600 ring-inset":""}" data-likelihood="${y}" data-consequence="${z}" data-score="${K}" data-level="${rt}" data-bg="${Y}" data-text="${Q}" data-hover="${O}" style="background: ${Y}; color: ${Q};">
                                                        ${K}
                                                    </button>
                                                </td>`}).join("")}
                                            </tr>`).join("")}
...
`))&&et()});const ot=B.querySelector("#manual-paper-permit-number");ot&&ot.addEventListener("input",()=>{ot.style.border="2px solid #90caf9",ot.style.boxShadow="none"});const mt=B.querySelector("#manual-permit-time-from"),nt=B.querySelector("#manual-permit-time-to"),at=B.querySelector("#manual-permit-total-time"),bt=()=>{const y=mt.value,C=nt.value;if(!y||!C){at.value="";return}at.value=this.calculateTotalTime(y,C)};mt?.addEventListener("change",bt),nt?.addEventListener("change",bt),i?.timeFrom&&i?.timeTo&&bt();const lt=B.querySelector("#manual-permit-location"),wt=B.querySelector("#manual-permit-sublocation-wrapper"),it=B.querySelector("#manual-permit-sublocation"),vt=B.querySelector("#manual-permit-location-entries"),ht=B.querySelector("#manual-selected-sublocations-container"),q=B.querySelector("#manual-selected-sublocations-display"),ct=B.querySelector("#manual-selected-sublocations-list"),yt=3,dt=[],kt=y=>({locationId:String(y?.locationId||"").trim(),location:String(y?.location||"").trim(),sublocationId:String(y?.sublocationId||"").trim(),sublocation:String(y?.sublocation||"").trim()}),ft=()=>{vt&&(vt.value=JSON.stringify(dt))},gt=()=>{if(!ht||!q||!ct)return;const y=dt.map(z=>z.sublocation||z.location).filter(Boolean),C=y.length>0;ht.style.display=C?"block":"none",q.value=C?y.join("\u060C "):"",ct.innerHTML=dt.map((z,K)=>`
                <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-700 text-xs font-medium border border-blue-200">
                    ${Utils.escapeHTML(z.sublocation||z.location)}
            ...
            `).join(""),ct.querySelectorAll(".manual-remove-sublocation-btn").forEach(z=>{z.addEventListener("click",()=>{const K=Number(z.getAttribute("data-index"));Number.isInteger(K)&&K>=0&&(dt.splice(K,1),ft(),gt())})})},St=y=>{if(!it||!wt)return;if(!y){wt.style.display="none",it.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0643\u0627\u0646 \u0627\u0644\u0641\u0631\u0639\u064A</option>';return}const C=this.getPlaceOptions(y);if(!Array.isArray(C)||C.length===0){wt.style.display="none",it.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0643\u0627\u0646 \u0627\u0644\u0641\u0631\u0639\u064A</option>';return}wt.style.display="block",it.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0643\u0627\u0646 \u0627\u0644\u0641\u0631\u0639\u064A</option>'+C.map(z=>`
                <option value="${Utils.escapeHTML(z.id)}" data-place-name="${Utils.escapeHTML(z.name)}">${Utils.escapeHTML(z.name)}</option>
            `).join(""),it.value=""},Pt=()=>{if(!lt||!it)return;const y=String(lt.value||"").trim(),C=lt.options[lt.selectedIndex]?.getAttribute("data-site-name")||lt.options[lt.selectedIndex]?.textContent||"",z=String(it.value||"").trim(),K=it.options[it.selectedIndex],Y=K?.getAttribute("data-place-name")||(K?.value?K.textContent:"")||"";if(!y||!C||!z||!Y)return;if(dt.some(O=>O.locationId===y&&O.sublocationId===z)){Notification.warning(this._t("module.ptw.notify.sublocDup","\u062A\u0645 \u0627\u062E\u062A\u064A\u0627\u0631 \u0647\u0630\u0627 \u0627\u0644\u0645\u0643\u0627\u0646 \u0627\u0644\u0641\u0631\u0639\u064A \u0628\u0627\u0644\u0641\u0639\u0644")),it.value="";return}if(dt.length>=yt){Notification.warning(this._t("module.ptw.notify.sublocMax3","\u064A\u0645\u0643\u0646 \u0627\u062E\u062A\u064A\u0627\u0631 3 \u0623\u0645\u0627\u0643\u0646 \u0641\u0631\u0639\u064A\u0629 \u0641\u0642\u0637 \u0643\u062D\u062F \u0623\u0642\u0635\u0649")),it.value="";return}dt.push(kt({locationId:y,location:C.trim(),sublocationId:z,sublocation:Y.trim()})),ft(),gt(),it.value=""},_t=()=>{let y=[];if(vt?.value)try{const C=JSON.parse(vt.value);Array.isArray(C)&&(y=C)}catch{y=[]}if((!y||y.length===0)&&(i?.location||i?.sublocation)){const C=String(i?.locationId||lt?.value||"").trim(),z=String(lt?.options[lt?.selectedIndex]?.getAttribute("data-site-name")||"").trim(),K=String(i?.location||"").split("|").map(O=>O.trim()).filter(Boolean),Y=String(i?.sublocationId||"").split("|").map(O=>O.trim()).filter(Boolean),Q=String(i?.sublocation||"").split("|").map(O=>O.trim()).filter(Boolean);Q.length>0?y=Q.map((O,rt)=>({locationId:C,location:z||K[0]?.split(" - ")[0]||i?.location||"",sublocationId:Y[rt]||"",sublocation:O})):y=K.map((O,rt)=>{const ut=O.indexOf(" - ");return ut===-1?{locationId:C,location:O,sublocationId:Y[rt]||"",sublocation:""}:{locationId:C,location:O.slice(0,ut).trim(),sublocationId:Y[rt]||"",sublocation:O.slice(ut+3).trim()}})}y.map(kt).filter(C=>C.location&&C.sublocation).slice(0,yt).forEach(C=>dt.push(C)),ft(),gt()};lt?.addEventListener("change",()=>{dt.length=0,ft(),gt(),St(lt.value)}),it?.addEventListener("change",Pt),St(lt?.value),_t(),this.setupManualEquipmentToolsSync(B);const T=(y,C)=>{if(!y||!C)return;const z=()=>{const K=String(y.value||"").trim(),Y=String(C.value||"").trim(),Q=y.dataset.autoCopiedValue||"";y.dataset.knownLoaded!=="1"&&(!Y||Y===Q)&&(C.value=K,y.dataset.autoCopiedValue=K)};z(),y.addEventListener("input",z)},G=(y,C,z)=>{const K=B.querySelector(y);if(!K)return;const Y=new Set(["\u0645\u0633\u0626\u0648\u0644 \u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0637\u0627\u0644\u0628\u0629","\u0645\u062F\u064A\u0631 \u0645\u0646\u0637\u0642\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644","\u0645\u062F\u064A\u0631 / \u0645\u0647\u0646\u062F\u0633 \u0627\u0644\u0635\u064A\u0627\u0646\u0629","\u0645\u0633\u0624\u0648\u0644 \u0627\u0644\u062C\u0647\u0629 \u0627\u0644\u0637\u0627\u0644\u0628\u0629"]),Q=O=>{const rt=O?.dataset.role;if(!rt)return;const ut=K.querySelector(`${z}[data-role="${rt}"]`);T(O,ut)};K.querySelectorAll(C).forEach(O=>{if(O.matches(".ia-approval-select")||O.tagName==="SELECT"){Q(O);return}Y.has(O.dataset?.role)||Q(O)}),K.addEventListener("input",O=>{const rt=O.target?.dataset?.role;O.target.matches(C)&&(O.target.matches(".ia-approval-select")||Y.has(rt)||Q(O.target))}),K.addEventListener("change",O=>{(O.target.matches(C)||O.target.matches(".ia-approval-select"))&&Q(O.target)})};this._setupIaRolePickerListeners(B),this.setupManualPermitKnownLookups(B,D,w),G("#manual-approvals-list",".manual-approval-name, .ia-approval-select",".manual-approval-sig"),G("#manual-closure-approvals-list",".manual-closure-approval-name, .ia-approval-select",".manual-closure-approval-sig");const tt=B.querySelector("#manual-work-type-cards")||B.querySelector(".ptw-work-type-stack"),pt=()=>{tt&&tt.querySelectorAll(".ptw-work-type-row").forEach(y=>{const C=!!y.querySelector('input[type="checkbox"]:checked'),z=Array.from(y.querySelectorAll('input[type="text"]')).some(K=>String(K.value||"").trim()!=="");y.classList.toggle("is-filled",C||z)})};tt&&(tt.addEventListener("change",pt),tt.addEventListener("input",pt),pt());const xt=B.querySelectorAll('input[name="manual-permit-status-radio"]'),qt=B.querySelector("#manual-permit-status");i?.status?xt.forEach(y=>{y.value===i.status&&(y.checked=!0,PTW.updateManualStatusBtnSelection(y))}):xt.forEach(y=>{y.value==="\u0627\u0643\u062A\u0645\u0644 \u0627\u0644\u0639\u0645\u0644 \u0628\u0634\u0643\u0644 \u0622\u0645\u0646"&&(y.checked=!0,PTW.updateManualStatusBtnSelection(y))}),B.querySelector("#manual-add-team-member-btn")?.addEventListener("click",()=>{const y=B.querySelector("#manual-team-members-list");if(!y)return;const C=document.createElement("tr");C.className="manual-team-member-row",C.innerHTML=`
            ...
            `,y.appendChild(C),typeof B._attachManualTeamRowLookup=="function"&&B._attachManualTeamRowLookup(C)}),B.querySelectorAll(".manual-risk-cell").forEach(y=>{y.addEventListener("click",()=>{const C=y.dataset.likelihood,z=y.dataset.consequence,K=y.dataset.score,Y=y.dataset.level,Q=y.dataset.bg||"#22c55e",O=y.dataset.text||"#ffffff";B.querySelectorAll(".manual-risk-cell").forEach(Mt=>{Mt.classList.remove("ring-4","ring-blue-500","ring-blue-600","ring-inset")}),y.classList.add("ring-4","ring-blue-600","ring-inset"),B.querySelector("#manual-risk-likelihood").value=C,B.querySelector("#manual-risk-consequence").value=z,B.querySelector("#manual-risk-score").value=K,B.querySelector("#manual-risk-level").value=Y;const rt=B.querySelector("#manual-risk-result");rt&&rt.classList.remove("hidden");const ut=B.querySelector("#manual-risk-score-display"),$t=B.querySelector("#manual-risk-level-display"),Et=B.querySelector("#manual-risk-likelihood-display"),Lt=B.querySelector("#manual-risk-consequence-display");ut&&(ut.textContent=K),$t&&($t.textContent=Y),Et&&(Et.textContent=C),Lt&&(Lt.textContent=z);const At=B.querySelector("#manual-risk-result-badge");At&&(At.style.background=Q,At.style.color=O,At.textContent=K);const Tt=B.querySelector("#manual-risk-notes");if(Tt){const Dt=`\u062A\u0642\u064A\u064A\u0645 \u062A\u0644\u0642\u0627\u0626\u064A: \u0645\u0633\u062A\u0648\u0649 \u0627\u0644\u062E\u0637\u0631 ${Y} (\u062F\u0631\u062C\u0629 ${K}) \u2014 \u0627\u0644\u0627\u062D\u062A\u0645\u0627\u0644\u064A\u0629 ${C} \xD7 \u0627\u0644\u062E\u0637\u0648\u0631\u0629 ${z}. ${{\u0645\u0646\u062E\u0641\u0636:"\u064A\u0645\u0643\u0646 \u062A\u0646\u0641\u064A\u0630 \u0627\u0644\u0639\u0645\u0644 \u0645\u0639 \u0627\u0644\u0627\u0644\u062A\u0632\u0627\u0645 \u0628\u0627\u0644\u0636\u0648\u0627\u0628\u0637 \u0627\u0644\u0623\u0633\u0627\u0633\u064A\u0629 \u0648\u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629 \u0627\u0644\u062F\u0648\u0631\u064A\u0629.",\u0645\u062A\u0648\u0633\u0637:"\u064A\u0644\u0632\u0645 \u062A\u0639\u0632\u064A\u0632 \u0627\u0644\u0636\u0648\u0627\u0628\u0637 \u0627\u0644\u0648\u0642\u0627\u0626\u064A\u0629 \u0648\u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629 \u0627\u0644\u0645\u064A\u062F\u0627\u0646\u064A\u0629 \u0642\u0628\u0644 \u0648\u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u062A\u0646\u0641\u064A\u0630.",\u0645\u0631\u062A\u0641\u0639:"\u0644\u0627 \u064A\u0628\u062F\u0623 \u0627\u0644\u0639\u0645\u0644 \u0642\u0628\u0644 \u0627\u0639\u062A\u0645\u0627\u062F \u0636\u0648\u0627\u0628\u0637 \u0625\u0636\u0627\u0641\u064A\u0629 \u0648\u0627\u0636\u062D\u0629 \u0648\u0645\u062A\u0627\u0628\u0639\u0629 \u0625\u0634\u0631\u0627\u0641\u064A\u0629 \u0645\u0628\u0627\u0634\u0631\u0629.",\u062D\u0631\u062C:"\u0625\u064A\u0642\u0627\u0641 \u0627\u0644\u062A\u0646\u0641\u064A\u0630 \u0641\u0648\u0631\u0627\u064B \u062D\u062A\u0649 \u0625\u0632\u0627\u0644\u0629/\u062E\u0641\u0636 \u0627\u0644\u062E\u0637\u0631 \u0648\u0627\u0639\u062A\u0645\u0627\u062F \u062E\u0637\u0629 \u062A\u062D\u0643\u0645 \u0645\u0634\u062F\u062F\u0629."}[Y]||""}`.trim(),It=String(Tt.value||"").trim(),Ct=String(Tt.dataset.autoRiskText||"").trim();(!It||It===Ct||It.startsWith("\u062A\u0642\u064A\u064A\u0645 \u062A\u0644\u0642\u0627\u0626\u064A:"))&&(Tt.value=Dt,Tt.dataset.autoRiskText=Dt)}})}),B.querySelector("#manual-add-approval-btn")?.addEventListener("click",()=>{const y=B.querySelector("#manual-approvals-list");if(!y)return;const C=y.querySelectorAll("tr").length+1,z=document.createElement("tr");z.className="manual-approval-row border-b border-gray-100 hover:bg-amber-50 transition-colors",z.innerHTML=`
            ...
            `,y.appendChild(z)}),B.querySelector("#manual-add-closure-approval-btn")?.addEventListener("click",()=>{const y=B.querySelector("#manual-closure-approvals-list");if(!y)return;const C=y.querySelectorAll("tr").length+1,z=document.createElement("tr");z.className="manual-closure-approval-row border-b border-gray-100 hover:bg-cyan-50 transition-colors",z.innerHTML=`
                        ...
                        <div class="border-t pt-4 mt-4">
                            ...
                            <div class="table-wrapper">
                                <table class="data-table">
                                    ...
                                    <tbody>
                                        ${s.map((b,I)=>{const R=b.status==="approved"?"success":b.status==="rejected"?"danger":"warning",E=b.status==="approved"?"\u0645\u0648\u0627\u0641\u0642\u0629":b.status==="rejected"?"\u0645\u0631\u0641\u0648\u0636":"\u0642\u064A\u062F \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631",M=(b.candidates||[]).map(S=>`
...
`))&&a.remove()}),setTimeout(()=>{a.querySelectorAll('[onclick*="handleApprovalAction"][onclick*="approved"]').forEach(E=>{const M=E.getAttribute("onclick");if(M){const $=M.match(/handleApprovalAction\('([^']+)',\s*(\d+),\s*'approved'\)/);$&&$[1]&&$[2]&&(E.removeAttribute("onclick"),E.addEventListener("click",U=>{U.preventDefault(),U.stopPropagation(),this.handleApprovalAction($[1],parseInt($[2]),"approved")}))}}),a.querySelectorAll('[onclick*="handleApprovalAction"][onclick*="rejected"]').forEach(E=>{const M=E.getAttribute("onclick");if(M){const $=M.match(/handleApprovalAction\('([^']+)',\s*(\d+),\s*'rejected'\)/);$&&$[1]&&$[2]&&(E.removeAttribute("onclick"),E.addEventListener("click",U=>{U.preventDefault(),U.stopPropagation(),this.handleApprovalAction($[1],parseInt($[2]),"rejected")}))}}),a.querySelectorAll('[onclick*="assignApproval"]').forEach(E=>{const M=E.getAttribute("onclick");if(M){const $=M.match(/assignApproval\('([^']+)',\s*(\d+)\)/);$&&$[1]&&$[2]&&(E.removeAttribute("onclick"),E.addEventListener("click",U=>{U.preventDefault(),U.stopPropagation(),this.assignApproval($[1],parseInt($[2]))}))}})},50)},async handleApprovalAction(t,e,a){const r=`approval_${t}_${e}`;if(this[`_processing_${r}`]){Notification.info(this._t("module.ptw.notify.approvalProcessing","\u062C\u0627\u0631\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u0647\u0630\u0627 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631..."));return}const s=AppState.appData.ptw.find(l=>l.id===t);if(!s){Notification.error(this._t("module.ptw.notify.findPermitFail","\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644 \u0627\u0644\u0645\u062D\u062F\u062F"));return}s.approvals=this.normalizeApprovals(s.approvals||[]);const i=s.approvals[e];if(!i){Notification.error(this._t("module.ptw.notify.approvalItemMissing","\u0639\u0646\u0635\u0631 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}if(s.status==="\u0645\u063A\u0644\u0642"){Notification.warning(this._t("module.ptw.notify.cannotEditClosed","\u0644\u0627 \u064A\u0645\u0643\u0646 \u062A\u0639\u062F\u064A\u0644 \u062A\u0635\u0631\u064A\u062D \u0645\u063A\u0644\u0642"));return}if(i.status!=="pending"){Notification.info(this._t("module.ptw.notify.approvalDone","\u062A\u0645\u062A \u0645\u0639\u0627\u0644\u062C\u0629 \u0647\u0630\u0627 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u0628\u0627\u0644\u0641\u0639\u0644"));return}const o=AppState.currentUser?.email?AppState.currentUser.email.toLowerCase():"";if(i.approverEmail&&o&&i.approverEmail.toLowerCase()!==o&&AppState.currentUser?.role!=="admin"){Notification.warning(this._t("module.ptw.notify.otherUser","\u0647\u0630\u0627 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u0645\u0648\u062C\u0647 \u0625\u0644\u0649 \u0645\u0633\u062A\u062E\u062F\u0645 \u0622\u062E\u0631."));return}if(a==="approved"){const l=s.approvals.filter((d,c)=>c<e&&d.required!==!1);if(l.some(d=>d.status!=="approved")){const d=this._t("module.ptw.common.notSpecified","\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"),c=this._t("module.ptw.common.listSep","\u060C "),u=l.filter(m=>m.status!=="approved").map(m=>this.approvalRoleLabel(m.role||d)).join(c);Notification.warning(this._t("module.ptw.notify.prevApprovals","\u064A\u062C\u0628 \u0627\u0639\u062A\u0645\u0627\u062F \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0627\u062A \u0627\u0644\u0633\u0627\u0628\u0642\u0629 \u0623\u0648\u0644\u0627\u064B: {roles}").replace(/\{roles\}/g,u));return}}this[`_processing_${r}`]=!0;let n=i.comments||"";if(a==="rejected"){const l=prompt(this._t("module.ptw.approval.rejectPrompt","\u0623\u062F\u062E\u0644 \u0633\u0628\u0628 \u0627\u0644\u0631\u0641\u0636 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A):"),n);if(l===null){this[`_processing_${r}`]=!1;return}n=l.trim()}Loading.show();try{if(i.status=a==="approved"?"approved":"rejected",i.approved=a==="approved",i.rejected=a==="rejected",i.date=new Date().toISOString(),i.comments=n,AppState.currentUser&&(i.approver=AppState.currentUser.name||i.approver||"",i.approverEmail=AppState.currentUser.email||i.approverEmail||"",i.approverId=AppState.currentUser.id||i.approverId||""),i.history=Array.isArray(i.history)?i.history:[],i.history.push(ApprovalCircuits.buildHistoryEntry(a==="approved"?"approved":"rejected",{performedBy:ApprovalCircuits.buildUserSnapshot(AppState.currentUser),comments:n,status:i.status,timestamp:new Date().toISOString()})),this.updatePermitStatus(s),s.updatedAt=new Date().toISOString(),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),this._autoSavePtwToCloud(AppState.appData.ptw).catch(c=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 Google Sheets:",c)}),a==="approved"){const c=this.getNextPendingApproval(s.approvals);if(s.status==="\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647")Notification.success(this._t("module.ptw.notify.permAllApproved","\u062A\u0645 \u0627\u0639\u062A\u0645\u0627\u062F \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644 \u0628\u0634\u0643\u0644 \u0646\u0647\u0627\u0626\u064A \u0628\u0639\u062F \u0645\u0648\u0627\u0641\u0642\u0629 \u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0627\u062A \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629."));else{const u=this.approvalRoleLabel(i.role);if(Notification.success(this._t("module.ptw.notify.stageApproved",'\u062A\u0645 \u0627\u0639\u062A\u0645\u0627\u062F \u0645\u0631\u062D\u0644\u0629 "{r}".').replace(/\{r\}/g,u)),c&&c.role){const m=this.approvalRoleLabel(c.role);Notification.info(this._t("module.ptw.notify.nextRole","\u0627\u0644\u0645\u0631\u062D\u0644\u0629 \u0627\u0644\u062A\u0627\u0644\u064A\u0629 \u0628\u0627\u0646\u062A\u0638\u0627\u0631 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F: {r}").replace(/\{r\}/g,m))}else Notification.info(this._t("module.ptw.notify.allStages","\u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0631\u0627\u062D\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u062A\u0645 \u0627\u0639\u062A\u0645\u0627\u062F\u0647\u0627."))}}else{const c=this.approvalRoleLabel(i.role);Notification.error(this._t("module.ptw.notify.rejectedBy",'\u062A\u0645 \u0631\u0641\u0636 \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644 \u0645\u0646 \u0642\u0628\u0644 "{r}".').replace(/\{r\}/g,c)),n&&Notification.info(this._t("module.ptw.notify.rejectionReason","\u0633\u0628\u0628 \u0627\u0644\u0631\u0641\u0636: {c}").replace(/\{c\}/g,n))}this.triggerNotificationsUpdate(),this.loadPTWList();const l=document.getElementById("ptw-analysis-content");l&&l.style.display!=="none"&&(l.innerHTML=this.renderAnalysisContent(),this.setupAnalysisEventListeners());const p=document.getElementById("ptw-approvals-content");p&&p.style.display!=="none"&&setTimeout(()=>{this.refreshApprovalsContent()},300);const d=document.querySelector(".modal-overlay");d&&(d.remove(),setTimeout(()=>{this.viewPTW(t)},100))}catch(l){Utils.safeError("\u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0645\u0639\u0627\u0644\u062C\u0629 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F:",l),Notification.error(this._t("module.ptw.notify.approvalUpdateErr","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u062F\u064A\u062B \u062D\u0627\u0644\u0629 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F"))}finally{this[`_processing_${r}`]=!1,Loading.hide()}},async assignApproval(t,e){const a=AppState.appData.ptw.find(n=>n.id===t);if(!a){Notification.error(this._t("module.ptw.notify.findPermitFail","\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u062A\u0635\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644 \u0627\u0644\u0645\u062D\u062F\u062F"));return}a.approvals=this.normalizeApprovals(a.approvals||[]);const r=a.approvals[e];if(!r){Notification.error(this._t("module.ptw.notify.approvalItemMissing","\u0639\u0646\u0635\u0631 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"));return}const s=document.getElementById(`approval-assign-${t}-${e}`);if(!s){Notification.error(this._t("module.ptw.notify.cannotFindAssignee","\u062A\u0639\u0630\u0631 \u062A\u062D\u062F\u064A\u062F \u062E\u0627\u0646\u0629 \u0627\u0644\u062A\u0639\u064A\u064A\u0646"));return}const i=s.value;if(!i){Notification.warning(this._t("module.ptw.notify.selectApprover","\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0627\u0644\u0645\u0633\u0624\u0648\u0644 \u0639\u0646 \u0647\u0630\u0627 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F."));return}const o=ApprovalCircuits.getUserById(i);if(!o){Notification.error(this._t("module.ptw.notify.userNotInSystem","\u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0627\u0644\u0645\u062D\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A \u0627\u0644\u0646\u0638\u0627\u0645."));return}Loading.show();try{r.approverId=o.id||o.email||"",r.approver=o.name||o.email||"",r.approverEmail=o.email||"",r.assignedAt=new Date().toISOString(),r.assignedBy=ApprovalCircuits.buildUserSnapshot(AppState.currentUser),r.history=Array.isArray(r.history)?r.history:[],r.history.push(ApprovalCircuits.buildHistoryEntry("assigned",{assignedBy:r.assignedBy,assignedTo:ApprovalCircuits.buildUserSnapshot(o)})),this.updatePermitStatus(a),a.updatedAt=new Date().toISOString(),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await this._autoSavePtwToCloud(AppState.appData.ptw),Notification.success(this._t("module.ptw.notify.assignedTo","\u062A\u0645 \u062A\u0648\u062C\u064A\u0647 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u0625\u0644\u0649 {name}.").replace(/\{name\}/g,r.approver||"")),this.triggerNotificationsUpdate(),this.loadPTWList();const n=document.getElementById("ptw-analysis-content");n&&n.style.display!=="none"&&(n.innerHTML=this.renderAnalysisContent(),this.setupAnalysisEventListeners());const l=document.querySelector(".modal-overlay");l&&(l.remove(),this.viewPTW(t))}catch(n){Utils.safeError("\u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u0639\u064A\u064A\u0646 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629:",n),Notification.error(this._t("module.ptw.notify.assignErr","\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u0639\u064A\u064A\u0646 \u0627\u0644\u0645\u0633\u0624\u0648\u0644 \u0639\u0646 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F"))}finally{Loading.hide()}},async deletePTW(t){if(confirm(this._t("module.ptw.notify.deletePtwShort","\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u062A\u0635\u0631\u064A\u062D\u061F"))){Loading.show();try{await this.removeFromRegistry(t),AppState.appData.ptw=AppState.appData.ptw.filter(a=>a.id!==t),typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await this._autoSavePtwToCloud(AppState.appData.ptw),Loading.hide(),Notification.success(this._t("module.ptw.notify.deleted","\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062A\u0635\u0631\u064A\u062D \u0628\u0646\u062C\u0627\u062D")),this.updateKPIs(),this.loadPTWList(),this.triggerNotificationsUpdate();const e=document.getElementById("ptw-analysis-content");e&&e.style.display!=="none"&&(e.innerHTML=this.renderAnalysisContent(),this.setupAnalysisEventListeners())}catch(e){Notification.error(this._t("module.ptw.notify.errorGeneric","\u062D\u062F\u062B \u062E\u0637\u0623: ")+e.message),submitBtn&&(submitBtn.disabled=!1,submitBtn.innerHTML=originalText)}}},async exportPDF(t){try{Loading.show();const e=await this.buildPermitExportPayload(t);if(Loading.hide(),!e){Notification.error(this._t("module.ptw.notify.permitNotFound","\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u062A\u0635\u0631\u064A\u062D"));return}if(e.isManualEntry&&e.exportReview&&!e.exportReview.ok&&Utils.safeWarn("\u062A\u0635\u062F\u064A\u0631 \u062A\u0635\u0631\u064A\u062D \u064A\u062F\u0648\u064A \u0628\u0639\u0646\u0627\u0635\u0631 \u0646\u0627\u0642\u0635\u0629:",e.exportReview.failed),Loading.show(this._t("module.ptw.pdf.exportLoading","\u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 PDF...")),!await this._ensurePermitPdfLibs_()){Notification.error(this._t("module.ptw.notify.pdfLibsError","\u062A\u0639\u0630\u0651\u0631 \u062A\u062D\u0645\u064A\u0644 \u0645\u0643\u062A\u0628\u0627\u062A PDF \u2014 \u062A\u062D\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062A\u0631\u0646\u062A"));return}await this._downloadPermitHtmlAsPdf(e.html,e.fileName)?Notification.success(this._t("module.ptw.notify.pdfDownloadOk","\u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062A\u0635\u0631\u064A\u062D PDF \u0628\u0646\u062C\u0627\u062D")):e.isManualEntry&&e.printHtml?(Notification.warning("\u062A\u0639\u0630\u0651\u0631 \u0627\u0644\u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0645\u0628\u0627\u0634\u0631 \u2014 \u062C\u0627\u0631\u064A \u0641\u062A\u062D \u0645\u0639\u0627\u064A\u0646\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629. \u0627\u062E\u062A\u0631 \xAB\u062D\u0641\u0638 \u0643\u0640 PDF\xBB \u0623\u0648 \xABMicrosoft Print to PDF\xBB."),this.openPermitPrintWindow(e.printHtml)):Notification.error(this._t("module.ptw.notify.pdfErr","\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF"))}catch(e){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF:",e);const a=this._t("module.ptw.notify.unknownError","\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641");Notification.error(this._t("module.ptw.notify.pdfErr","\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF: ")+(e?.message||a))}finally{Loading.hide()}},initMapFilters(){this.setupMapSettingsEventListeners(),["ptw-map-filter-status","ptw-map-filter-type"].forEach(a=>{const r=document.getElementById(a);if(r&&r.parentNode){const s=r.cloneNode(!0);r.parentNode.replaceChild(s,r),s.addEventListener("change",()=>this.updateMapUI())}});const t=(a,r)=>{const s=document.getElementById(a);if(s&&s.parentNode){const i=s.cloneNode(!0);s.parentNode.replaceChild(i,s),i.addEventListener("click",()=>this.switchMapType(r))}};t("ptw-map-type-normal","normal"),t("ptw-map-type-satellite","satellite"),t("ptw-map-type-terrain","terrain");const e=document.getElementById("ptw-map-fullscreen-btn");if(e&&e.parentNode){const a=e.cloneNode(!0);e.parentNode.replaceChild(a,e),a.addEventListener("click",()=>this.toggleFullscreen())}},updateMapUI(){this.currentTab==="map"&&this.updateMapMarkers()},getMarkerColor(t){switch(t){case"\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647":return"#10b981";case"\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629":return"#3b82f6";case"\u0645\u063A\u0644\u0642":return"#6b7280";case"\u0645\u0631\u0641\u0648\u0636":return"#ef4444";default:return"#f59e0b"}},createMapPopup(t){const e=Utils.escapeHTML;return`
        ...
        <div id="ptw-analytics-root" style="font-family:inherit;">
            ...
            `).join(""),F=e("module.ptw.pdf.analysisReportTitle","\u062A\u0642\u0631\u064A\u0631 \u062A\u062D\u0644\u064A\u0644 \u062A\u0635\u0627\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644"),X=e("module.ptw.pdf.filterCriteriaLine","\u0645\u0639\u0627\u064A\u064A\u0631 \u0627\u0644\u0641\u0644\u062A\u0631: {text}").replace(/\{text\}/g,b),st=e("module.ptw.pdf.totalsLine","\u0625\u062C\u0645\u0627\u0644\u064A: {total} | \u0645\u0641\u062A\u0648\u062D\u0629: {open} | \u0645\u063A\u0644\u0642\u0629: {closed}").replace(/\{total\}/g,String(t.length)).replace(/\{open\}/g,String(I)).replace(/\{closed\}/g,String(R)),v=`
