            ...
            <div class="ctr-panel">
                ...
                `:y.map((x,$)=>{const R=(x.severity||"").toString().trim(),M=(x.status||"").toString().trim(),j=R==="\u0639\u0627\u0644\u064A\u0629"||R==="high"||R==="\u062D\u0631\u062C\u0629"?"badge-danger":R==="\u0645\u062A\u0648\u0633\u0637\u0629"||R==="medium"?"badge-warning":"badge-info",z=M==="\u0645\u062D\u0644\u0648\u0644"||M==="resolved"||M==="\u062A\u0645 \u0627\u0644\u062D\u0644"?"badge-success":"badge-warning";return`
                    <tr class="hover:bg-gray-50 transition-colors ${$%2===0?"bg-white":"bg-gray-50"}">
                        ...
                        <td class="px-6 py-4 text-center">
                            <span class="badge ${j} text-sm font-bold px-3 py-1">${x.severity||"-"}</span>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <span class="badge ${z} text-sm font-bold px-3 py-1">${x.status||"-"}</span>
                        </td>
                    </tr>
