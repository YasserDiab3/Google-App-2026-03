...
`),o=new Blob([a],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(o),r=document.createElement("a");r.href=n,r.download=`BehaviorMonitoring_Log_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)},renderFormTab(e=!1){const t=`bhm-tab-${Date.now()}`;return`
        ...
        `},bindBehaviorForm({form:e,uid:t,data:i,modal:a,signal:o}){if(typeof EmployeeHelper<"u")try{EmployeeHelper.setupAutocomplete(`${t}-employee-name`,l=>{if(l){const f=document.getElementById(`${t}-employee-code`),L=document.getElementById(`${t}-employee-name`),u=document.getElementById(`${t}-department`),S=document.getElementById(`${t}-job`);f&&(f.value=l.code||""),L&&(L.value=l.name||""),u&&(l.department||l.employeeDepartment)&&(u.value=l.department||l.employeeDepartment||""),S&&(l.job||l.position||l.title)&&(S.value=l.job||l.position||l.title||"")}}),EmployeeHelper.setupEmployeeCodeSearch(`${t}-employee-code`,`${t}-employee-name`)}catch(l){Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0628\u062D\u062B \u0639\u0646 \u0627\u0644\u0645\u0648\u0638\u0641:",l)}const n=()=>{try{const l=(document.getElementById(`${t}-employee-code`)?.value||"").trim(),f=(document.getElementById(`${t}-employee-name`)?.value||"").trim(),u=(Array.isArray(AppState?.appData?.employees)?AppState.appData.employees:[]).find(B=>l&&(B.employeeNumber&&B.employeeNumber===l||B.sapId&&B.sapId===l)||f&&B.name===f);if(!u)return;const S=document.getElementById(`${t}-department`),w=document.getElementById(`${t}-job`);S&&!S.value&&(S.value=u.department||u.employeeDepartment||""),w&&!w.value&&(w.value=u.job||u.position||u.title||"")}catch{}};document.getElementById(`${t}-employee-code`)?.addEventListener("blur",n,{signal:o}),document.getElementById(`${t}-employee-name`)?.addEventListener("blur",n,{signal:o});const r=document.getElementById(`${t}-photo-input`),s=document.getElementById(`${t}-photo-preview`),h=document.getElementById(`${t}-photo-img`);r&&s&&h&&r.addEventListener("change",l=>{const f=l.target.files?.[0];if(!f)return;if(f.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB"),r.value="";return}const L=new FileReader;L.onload=u=>{h.src=u.target.result,s.classList.remove("hidden")},L.readAsDataURL(f)},{signal:o}),e.querySelector('[data-action="clear-photo"]')?.addEventListener("click",()=>{const l=document.getElementById(`${t}-photo-input`),f=document.getElementById(`${t}-photo-preview`);l&&(l.value=""),f&&f.classList.add("hidden")},{signal:o});const c=document.getElementById(`${t}-type`),d=document.getElementById(`${t}-type-badge`),v=e.closest(".behavior-form-wrapper")||e.parentElement,g=document.getElementById(`${t}-negative-section`),T=document.getElementById(`${t}-corrective-action`),m=l=>{v&&v.setAttribute("data-behavior-type",l||""),d&&(d.className=`badge ${this.getBehaviorTypeBadgeClass(l)}`,d.textContent=l||"\u2014");const f=a?.querySelector?.(".behavior-modal");f&&f.setAttribute("data-behavior-type",l||"");const L=(l||"")==="\u0633\u0644\u0628\u064A";g&&(g.style.display=L?"":"none"),T&&(L?T.setAttribute("required","required"):T.removeAttribute("required"))};m(c?.value||i?.behaviorType||""),c?.addEventListener("change",()=>m(c.value),{signal:o});const b=document.getElementById(`${t}-factory`),y=document.getElementById(`${t}-sublocation`),p=()=>{if(!b||!y)return;const l=b.value,f=this.getPlaceOptions(l),L=y.value;y.innerHTML=`
                <option value="">${this.t("module.behavior.selectSubLocation","\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A")}</option>
                ${f.map(u=>`<option value="${u.id}">${Utils.escapeHTML(u.name)}</option>`).join("")}
            `,L&&f.some(u=>u.id===L)&&(y.value=L)};b?.addEventListener("change",p,{signal:o}),e.querySelector('[data-action="cancel-form"]')?.addEventListener("click",()=>a?.remove(),{signal:o}),document.getElementById(`${t}-save-btn`)?.addEventListener("click",()=>this.handleSubmit({uid:t,form:e,editId:i?.id||null,modal:a}),{signal:o})},async showForm(e=null){if(typeof Permissions<"u"&&Permissions.ensureFormSettingsState)try{await Permissions.ensureFormSettingsState()}catch{}const t=document.createElement("div");t.className="modal-overlay";const i=`bhm-modal-${Date.now()}`;t.innerHTML=`
...
`),o=new Blob([a],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(o),r=document.createElement("a");r.href=n,r.download=`ContractorBehaviorMonitoring_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)},getContractorBehaviorFormHTML(e,t){const i=e?.date?new Date(e.date).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],a=this.getSiteOptions(),o=e?.factory||e?.factoryId||"",n=e?.subLocation||e?.subLocationId||"",r=a.find(b=>b.id===o)?.id||a.find(b=>b.name===o)?.id||o,s=this.getPlaceOptions(r),h=s.find(b=>b.id===n)?.id||s.find(b=>b.name===n)?.id||n,c=(e?.behaviorType||"")==="\u0633\u0644\u0628\u064A",d=this.processPhoto(e?.photo),v=d&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(d):{canonical:d||"",displaySrc:d||"",needsProxy:!1,proxyFileId:""},g=v.canonical?v.displaySrc:"",T=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(v):"",m={contractorSelect:`${t}-contractor-select`,contractorWorker:`${t}-contractor-worker`,department:`${t}-cb-department`,job:`${t}-cb-job`,factory:`${t}-cb-factory`,subLocation:`${t}-cb-sublocation`,behaviorType:`${t}-cb-type`,behaviorDate:`${t}-cb-date`,behaviorRating:`${t}-cb-rating`,correctiveAction:`${t}-cb-corrective`,correctiveActionDetails:`${t}-cb-corrective-details`,description:`${t}-cb-description`,photoInput:`${t}-cb-photo-input`,photoPreview:`${t}-cb-photo-preview`,photoImg:`${t}-cb-photo-img`,saveBtn:`${t}-cb-save-btn`,typeBadge:`${t}-cb-type-badge`,negativeSection:`${t}-cb-negative-section`};return`
                            ...
                            <div class="bhm-grid bhm-grid-media">
                                <div class="bhm-field bhm-upload-wrap">
                                    ...
                                    <div id="${m.photoPreview}" class="bhm-photo-preview mt-3 ${e?.photo?"":"hidden"}">
                                        <img src="${Utils.escapeHTML(g)}" alt=""${T} class="bhm-photo-thumb" id="${m.photoImg}">
        ...
        `},bindContractorBehaviorForm({form:e,uid:t,data:i,modal:a,signal:o}){const n=document.getElementById(`${t}-contractor-select`);if(n&&typeof Contractors<"u"&&Contractors.populateContractorSelect)try{Contractors.populateContractorSelect(n,{placeholder:"-- \u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 --",selectedValue:i?.contractorName||"",selectedContractorId:i?.contractorId||"",valueMode:"name",showServiceType:!0,includeSuppliers:!0,approvedOnly:!1})}catch(p){Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646:",p)}const r=document.getElementById(`${t}-cb-factory`),s=document.getElementById(`${t}-cb-sublocation`),h=()=>{if(!r||!s)return;const p=this.getPlaceOptions(r.value),$=s.value;s.innerHTML='<option value="">'+this.t("module.behavior.selectSubLocation","\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A")+"</option>"+p.map(l=>`<option value="${l.id}">${Utils.escapeHTML(l.name)}</option>`).join(""),$&&p.some(l=>l.id===$)&&(s.value=$)};r?.addEventListener("change",h,{signal:o});const c=document.getElementById(`${t}-cb-type`),d=document.getElementById(`${t}-cb-type-badge`),v=document.getElementById(`${t}-cb-negative-section`),g=document.getElementById(`${t}-cb-corrective`),T=p=>{const $=e.closest(".behavior-form-wrapper");$&&$.setAttribute("data-behavior-type",p||""),d&&(d.className=`badge ${this.getBehaviorTypeBadgeClass(p)} bhm-type-chip`,d.textContent=p||"\u2014");const l=(p||"")==="\u0633\u0644\u0628\u064A";v&&(v.style.display=l?"":"none"),g&&(l?g.setAttribute("required","required"):g.removeAttribute("required"))};T(c?.value||i?.behaviorType||""),c?.addEventListener("change",()=>T(c.value),{signal:o});const m=document.getElementById(`${t}-cb-photo-input`),b=document.getElementById(`${t}-cb-photo-preview`),y=document.getElementById(`${t}-cb-photo-img`);m&&b&&y&&m.addEventListener("change",p=>{const $=p.target.files?.[0];if(!$)return;if($.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB"),m.value="";return}const l=new FileReader;l.onload=f=>{y.src=f.target.result,b.classList.remove("hidden")},l.readAsDataURL($)},{signal:o}),e.querySelector('[data-action="cb-clear-photo"]')?.addEventListener("click",()=>{const p=document.getElementById(`${t}-cb-photo-input`),$=document.getElementById(`${t}-cb-photo-preview`);p&&(p.value=""),$&&$.classList.add("hidden")},{signal:o}),e.querySelector('[data-action="cb-cancel-form"]')?.addEventListener("click",()=>a?.remove(),{signal:o}),document.getElementById(`${t}-cb-save-btn`)?.addEventListener("click",()=>this.handleContractorSubmit({uid:t,form:e,editId:i?.id||null,modal:a}),{signal:o})},async handleContractorSubmit({uid:e,form:t,editId:i=null,modal:a}){let o=i&&this.getRawContractorBehaviorById(i)?.photo||"";const n=document.getElementById(`${e}-cb-photo-input`);if(n&&n.files.length>0){const x=n.files[0];if(x.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB");return}o=await this.convertImageToBase64(x)}const r=document.getElementById(`${e}-contractor-select`),s=r?.selectedOptions?.[0],h=(r?.value||"").trim(),c=(s?.dataset?.contractorId||"").trim();if(!h){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644");return}const d=document.getElementById(`${e}-cb-type`),v=document.getElementById(`${e}-cb-date`),g=document.getElementById(`${e}-cb-rating`),T=document.getElementById(`${e}-cb-description`),m=document.getElementById(`${e}-cb-department`),b=document.getElementById(`${e}-cb-job`),y=document.getElementById(`${e}-cb-factory`),p=document.getElementById(`${e}-cb-sublocation`),$=document.getElementById(`${e}-cb-corrective`),l=document.getElementById(`${e}-cb-corrective-details`),f=document.getElementById(`${e}-contractor-worker`);if(!d||!v||!g||!T||!y||!p){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629.");return}const L=(d.value||"")==="\u0633\u0644\u0628\u064A";if(L&&(!$||!$.value)){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u062A\u0635\u062D\u064A\u062D\u064A \u0644\u0644\u062A\u0635\u0631\u0641 \u0627\u0644\u0633\u0644\u0628\u064A");return}const u=AppState.appData.contractorBehaviorMonitoring||[],S=i?this.getRawContractorBehaviorById(i):null,w=typeof generateISOCode=="function"?generateISOCode:null,B={id:i||Utils.generateId("CBHM"),isoCode:S&&S.isoCode?S.isoCode:w?w("BHC",u):`BHC-${Date.now()}`,contractorId:c,contractorName:h,contractorWorker:(f?.value||"").trim(),department:(m?.value||"").trim(),job:(b?.value||"").trim(),factory:(y.value||"").trim(),factoryId:y.value?String(y.value).trim():null,factoryName:this.resolveSiteName(y.value),subLocation:(p.value||"").trim(),subLocationId:p.value?String(p.value).trim():null,subLocationName:this.resolvePlaceName(p.value,y.value),photo:o,behaviorType:d.value,date:new Date(v.value).toISOString(),rating:g.value,correctiveAction:L&&$?.value||"",correctiveActionDetails:L?(l?.value||"").trim():"",description:T.value.trim(),createdAt:i?this.getRawContractorBehaviorById(i)?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};Loading.show();try{if(Array.isArray(AppState.appData.contractorBehaviorMonitoring)||(AppState.appData.contractorBehaviorMonitoring=[]),i){const x=AppState.appData.contractorBehaviorMonitoring.findIndex(A=>A.id===i);x!==-1&&(AppState.appData.contractorBehaviorMonitoring[x]=B),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0635\u0631\u0641 \u0628\u0646\u062C\u0627\u062D")}else AppState.appData.contractorBehaviorMonitoring.push(B),Notification.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062A\u0635\u0631\u0641 \u0628\u0646\u062C\u0627\u062D");typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),await GoogleIntegration.autoSave("ContractorBehaviorMonitoring",AppState.appData.contractorBehaviorMonitoring),Loading.hide(),a&&a.remove(),this.refreshCurrentTab()}catch(x){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+x.message)}},async showContractorForm(e=null){if(typeof Permissions<"u"&&Permissions.ensureFormSettingsState)try{await Permissions.ensureFormSettingsState()}catch{}const t=document.createElement("div");t.className="modal-overlay bhmc-contractor-overlay";const i=`bhmc-modal-${Date.now()}`,a=e?this.presentContractorBehavior(e):null;t.innerHTML=`
