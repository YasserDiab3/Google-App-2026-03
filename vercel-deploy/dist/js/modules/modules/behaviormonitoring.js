                                                ...
                                                ${c.map(l=>`
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button onclick="BehaviorMonitoring.viewBehavior('${l.id}')" class="btn-icon btn-icon-primary" title="\u0639\u0631\u0636">
