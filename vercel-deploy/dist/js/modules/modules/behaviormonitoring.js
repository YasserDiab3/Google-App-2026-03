const BehaviorMonitoring={_setupTimeoutId:null,_eventListenersAbortController:null,_modalAbortController:null,processPhoto(t){return typeof Utils<"u"&&typeof Utils.normalizeImageSource=="function"?Utils.normalizeImageSource(t)||null:!t||typeof t!="string"?null:t.trim()||null},state:{activeTab:"log",filters:{search:"",behaviorType:"",rating:"",dateFrom:"",dateTo:""},sort:"date_desc",contractorFilters:{search:"",behaviorType:"",rating:"",dateFrom:"",dateTo:""},contractorSort:"date_desc",logPage:1,contractorLogPage:1,pageSize:50},getPageSize(){const t=Number(this.state?.pageSize);return Number.isFinite(t)&&t>0?t:50},paginateItems(t,e){const a=Array.isArray(t)?t:[],i=this.getPageSize(),o=a.length,n=Math.max(1,Math.ceil(o/i)||1),r=Math.min(Math.max(1,Number(e)||1),n),s=(r-1)*i;return{page:r,totalPages:n,total:o,start:s,end:Math.min(s+i,o),items:a.slice(s,s+i)}},renderTablePaginationHTML(t,e){const{page:a,totalPages:i,total:o,start:n,end:r}=e;if(o<=this.getPageSize())return o?`<div class="bhm-pagination text-sm text-gray-500 mt-3">${n+1}\u2013${r} / ${o}</div>`:"";const s=a<=1?"disabled":"",h=a>=i?"disabled":"",c=t==="contractor"?"setContractorLogPage":"setLogPage";return`
            <div class="bhm-pagination flex flex-wrap items-center justify-between gap-3 mt-3">
                ...
                <div class="flex items-center gap-2">
                    <button type="button" class="btn-secondary btn-sm" ${s} onclick="BehaviorMonitoring.${c}(${a-1})">
                        <i class="fas fa-chevron-right"></i>
                    </button>
                    <span class="text-sm font-semibold">${a} / ${i}</span>
                    <button type="button" class="btn-secondary btn-sm" ${h} onclick="BehaviorMonitoring.${c}(${a+1})">
        ...
        `},setLogPage(t){this.state.logPage=Math.max(1,Number(t)||1),this.renderLogTable()},setContractorLogPage(t){this.state.contractorLogPage=Math.max(1,Number(t)||1),this.renderContractorLogTable()},t(t,e){try{if(typeof AppI18n<"u"&&typeof AppI18n.t=="function")return AppI18n.t(t,null,e!=null?String(e):"");if(typeof I18n<"u"&&typeof I18n.t=="function")return I18n.t(t,null,e!=null?String(e):"")}catch{}return e!=null?String(e):t},NEGATIVE_ACTIONS:["\u062A\u0648\u0639\u064A\u0629 / \u062A\u0648\u062C\u064A\u0647","\u0625\u0639\u0627\u062F\u0629 \u062A\u062F\u0631\u064A\u0628","\u062A\u062D\u0630\u064A\u0631 \u0634\u0641\u0647\u064A","\u0625\u0646\u0630\u0627\u0631 \u0643\u062A\u0627\u0628\u064A","\u0625\u064A\u0642\u0627\u0641 \u0645\u0624\u0642\u062A \u0639\u0646 \u0627\u0644\u0639\u0645\u0644","\u062A\u0637\u0628\u064A\u0642 / \u062A\u0639\u062F\u064A\u0644 \u0625\u062C\u0631\u0627\u0621 \u0639\u0645\u0644","\u062A\u062D\u0633\u064A\u0646\u0627\u062A \u0647\u0646\u062F\u0633\u064A\u0629 (Engineering)","\u062A\u0648\u0641\u064A\u0631 / \u0625\u0644\u0632\u0627\u0645 PPE","\u0623\u062E\u0631\u0649"],getSiteOptions(){try{return typeof Permissions<"u"&&Permissions.formSettingsState&&Permissions.formSettingsState.sites?Permissions.formSettingsState.sites.map(t=>({id:t.id,name:t.name})):Array.isArray(AppState.appData?.observationSites)&&AppState.appData.observationSites.length>0?AppState.appData.observationSites.map(t=>({id:t.id||t.siteId||Utils.generateId("SITE"),name:t.name||t.title||t.label||"\u0645\u0648\u0642\u0639 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F"})):typeof DailyObservations<"u"&&Array.isArray(DailyObservations.DEFAULT_SITES)?DailyObservations.DEFAULT_SITES.map((t,e)=>({id:t.id||t.siteId||Utils.generateId("SITE"),name:t.name||t.title||t.label||`\u0645\u0648\u0642\u0639 ${e+1}`})):[]}catch(t){return Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u0648\u0627\u0642\u0639:",t),[]}},getPlaceOptions(t){try{if(!t)return[];if(typeof Permissions<"u"&&Permissions.formSettingsState&&Permissions.formSettingsState.sites){const e=Permissions.formSettingsState.sites.find(a=>a.id===t);if(e&&Array.isArray(e.places))return e.places.map(a=>({id:a.id,name:a.name}))}if(Array.isArray(AppState.appData?.observationSites)){const e=AppState.appData.observationSites.find(a=>(a.id||a.siteId)===t);if(e)return(Array.isArray(e.places)?e.places:Array.isArray(e.locations)?e.locations:Array.isArray(e.children)?e.children:Array.isArray(e.areas)?e.areas:[]).map((i,o)=>({id:i.id||i.placeId||i.value||Utils.generateId("PLACE"),name:i.name||i.placeName||i.title||i.label||i.locationName||`\u0645\u0643\u0627\u0646 ${o+1}`}))}if(typeof DailyObservations<"u"&&Array.isArray(DailyObservations.DEFAULT_SITES)){const e=DailyObservations.DEFAULT_SITES.find(a=>(a.id||a.siteId)===t);if(e)return(Array.isArray(e.places)?e.places:Array.isArray(e.locations)?e.locations:Array.isArray(e.children)?e.children:Array.isArray(e.areas)?e.areas:[]).map((i,o)=>({id:i.id||i.placeId||i.value||Utils.generateId("PLACE"),name:i.name||i.placeName||i.title||i.label||i.locationName||`\u0645\u0643\u0627\u0646 ${o+1}`}))}return[]}catch(e){return Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0623\u0645\u0627\u0643\u0646:",e),[]}},refreshSiteDropdowns(){try{var t=this.getSiteOptions();if(!t||!t.length)return;var e=typeof Utils<"u"&&Utils.escapeHTML?Utils.escapeHTML:function(a){return String(a??"")};document.querySelectorAll('select[id$="-factory"]').forEach(function(a){if(a.tagName==="SELECT"){var i=a.value;a.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0635\u0646\u0639</option>'+t.map(function(o){return'<option value="'+e(o.id)+'">'+e(o.name)+"</option>"}).join(""),i&&(a.value=i)}})}catch(a){typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F BehaviorMonitoring.refreshSiteDropdowns:",a)}},resolveSiteName(t){const e=(t||"").toString();if(!e)return"";const a=this.getSiteOptions();return(a.find(o=>o.id===e)||a.find(o=>(o.name||"")===e))?.name||e},resolvePlaceName(t,e){const a=(t||"").toString();if(!a)return"";const i=(e||"").toString(),o=this.getPlaceOptions(i);return(o.find(r=>r.id===a)||o.find(r=>(r.name||"")===a))?.name||a},async load(){if(this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{typeof AppState<"u"&&AppState._languageRefresh||AppState?.currentSection&&AppState.currentSection!=="behavior-monitoring"||this.load()}),this._languageChangeListenerAdded=!0),typeof Utils>"u")return;if(typeof AppState>"u"){const e=document.getElementById("behavior-monitoring-section");e&&(e.innerHTML=`
            ...
            `,this.setupEventListeners(),await this.switchTab(a,{initial:!0}),typeof AppState<"u"&&AppState._languageRefresh===!0)return;setTimeout(()=>{this.loadBehaviorDataAsync().then(()=>{const i=this.state?.activeTab||"log";this.switchTab(i,{silent:!0}).catch(()=>{this.refreshCurrentTab()})}).catch(i=>{typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0631\u0627\u0642\u0628\u0629 \u0627\u0644\u0633\u0644\u0648\u0643:",i),this.refreshCurrentTab()})},100)}catch(e){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0645\u062F\u064A\u0648\u0644 \u0645\u0631\u0627\u0642\u0628\u0629 \u0627\u0644\u0633\u0644\u0648\u0643\u064A\u0627\u062A:",e),t.innerHTML=`
                <div class="section-header">
                    <div>
                        <h1 class="section-title">
                            <i class="fas fa-eye ml-3"></i>
                                                ...
                                                ${c.map(l=>`
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button onclick="BehaviorMonitoring.viewBehavior(${JSON.stringify(String(l.id||""))})" class="btn-icon btn-icon-primary" title="\u0639\u0631\u0636">
                            ...
                            <div class="bf-row">
                                <div class="bf-field bf-field--search">
                                    ...
                                    <div class="bf-search-wrap">
                                        <input id="behavior-filter-search" type="text" class="bf-input" placeholder="${this.t("common.searchPlaceholder","ISO / \u0627\u0633\u0645 / \u0643\u0648\u062F / \u0648\u0635\u0641")}" value="${a(e.search)}" autocomplete="off">
                                ...
                                <div class="bf-field bf-field--date">
                                    ...
                                    <input id="behavior-filter-from" type="date" class="bf-input" value="${a(e.dateFrom)}">
                                </div>
                                <div class="bf-field bf-field--date">
                                    <label for="behavior-filter-to" class="bf-label"><i class="fas fa-calendar-check"></i>${this.t("common.toDate","\u0625\u0644\u0649 \u062A\u0627\u0631\u064A\u062E")}</label>
                                    <input id="behavior-filter-to" type="date" class="bf-input" value="${a(e.dateTo)}">
                                </div>
            ...
            <div class="table-wrapper" style="overflow-x:auto;">
                <table class="data-table table-header-purple">
                    ...
                    <tbody>
                        ${a.map(i=>`
                            <tr>
                                <td>${Utils.escapeHTML(i.isoCode||"")}</td>
                                <td>
                                    <div class="flex flex-col">
                                        <span class="font-semibold">${Utils.escapeHTML(i.employeeName||"")}</span>
                                        <span class="text-xs text-gray-500">${Utils.escapeHTML(i.employeeCode||i.employeeNumber||"")}</span>
                                    </div>
                                </td>
                                <td>${Utils.escapeHTML(i.factoryName||i.factory||"\u2014")}</td>
                                <td>${Utils.escapeHTML(i.subLocationName||i.subLocation||"\u2014")}</td>
                                <td><span class="badge ${this.getBehaviorTypeBadgeClass(i.behaviorType)}">${Utils.escapeHTML(i.behaviorType||"\u2014")}</span></td>
                                <td>${this.getBehaviorDate(i)?this.formatBehaviorDateDisplay(i):"\u2014"}</td>
                                <td><span class="badge ${this.getRatingBadgeClass(i.rating)}">${Utils.escapeHTML(i.rating||"\u2014")}</span></td>
                                <td class="text-center bhm-log-table-actions">
                                    <div class="flex items-center justify-center gap-2 flex-wrap">
                                        <button type="button" onclick="BehaviorMonitoring.viewBehavior(${JSON.stringify(String(i.id||""))})" class="btn-icon btn-icon-primary bhm-action-icon" title="\u0639\u0631\u0636">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button type="button" onclick="BehaviorMonitoring.exportPDF(${JSON.stringify(String(i.id||""))})" class="btn-icon btn-icon-success bhm-action-icon" title="\u062A\u0635\u062F\u064A\u0631 PDF">
                                            <i class="fas fa-file-pdf"></i>
                                        </button>
                                        <button type="button" onclick="BehaviorMonitoring.printReport(${JSON.stringify(String(i.id||""))})" class="btn-icon btn-icon-info bhm-action-icon" title="\u0637\u0628\u0627\u0639\u0629">
...
`),o=new Blob([i],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(o),r=document.createElement("a");r.href=n,r.download=`BehaviorMonitoring_Log_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)},renderFormTab(t=!1){const e=`bhm-tab-${Date.now()}`;return`
        ...
        `},bindCurrentTabEvents(){this._eventListenersAbortController&&this._eventListenersAbortController.abort(),this._eventListenersAbortController=new AbortController;const t=this._eventListenersAbortController.signal,e=this.state?.activeTab||"log";if(e==="log"){const a=document.getElementById("behavior-filter-search"),i=document.getElementById("behavior-filter-type"),o=document.getElementById("behavior-filter-rating"),n=document.getElementById("behavior-filter-from"),r=document.getElementById("behavior-filter-to"),s=document.getElementById("behavior-sort"),h=document.getElementById("behavior-clear-filters-btn"),c=document.getElementById("behavior-export-csv-btn"),d=()=>{this.state.filters=this.state.filters||{},this.state.filters.search=(a?.value||"").toString(),this.state.filters.behaviorType=(i?.value||"").toString(),this.state.filters.rating=(o?.value||"").toString(),this.state.filters.dateFrom=(n?.value||"").toString(),this.state.filters.dateTo=(r?.value||"").toString(),this.state.sort=(s?.value||"date_desc").toString(),this.state.logPage=1,this.renderLogTable()};a?.addEventListener("input",d,{signal:t}),i?.addEventListener("change",d,{signal:t}),o?.addEventListener("change",d,{signal:t}),n?.addEventListener("change",d,{signal:t}),r?.addEventListener("change",d,{signal:t}),s?.addEventListener("change",d,{signal:t}),h?.addEventListener("click",()=>this.clearFilters(),{signal:t}),c?.addEventListener("click",()=>this.exportLogCSV(),{signal:t}),this.renderLogTable();return}if(e==="form"){const a=document.querySelector('#behavior-form-container form[data-behavior-form="true"]'),i=a?.getAttribute("data-form-uid");if(a&&i){this.bindBehaviorForm({form:a,uid:i,data:null,modal:null,signal:t});const o=document.getElementById("behavior-form-container");o&&typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(o,{onFetchFail:n=>{try{n.onerror=null,n.removeAttribute("src")}catch{}}})}return}if(e==="contractors"){const a=document.getElementById("bhmc-filter-search"),i=document.getElementById("bhmc-filter-type"),o=document.getElementById("bhmc-filter-rating"),n=document.getElementById("bhmc-filter-from"),r=document.getElementById("bhmc-filter-to"),s=document.getElementById("bhmc-sort"),h=document.getElementById("bhmc-clear-filters-btn"),c=document.getElementById("bhmc-export-csv-btn"),d=document.getElementById("behavior-add-contractor-btn"),v=()=>{this.state.contractorFilters=this.state.contractorFilters||{},this.state.contractorFilters.search=(a?.value||"").toString(),this.state.contractorFilters.behaviorType=(i?.value||"").toString(),this.state.contractorFilters.rating=(o?.value||"").toString(),this.state.contractorFilters.dateFrom=(n?.value||"").toString(),this.state.contractorFilters.dateTo=(r?.value||"").toString(),this.state.contractorSort=(s?.value||"date_desc").toString(),this.state.contractorLogPage=1,this.renderContractorLogTable()};a?.addEventListener("input",v,{signal:t}),i?.addEventListener("change",v,{signal:t}),o?.addEventListener("change",v,{signal:t}),n?.addEventListener("change",v,{signal:t}),r?.addEventListener("change",v,{signal:t}),s?.addEventListener("change",v,{signal:t}),h?.addEventListener("click",()=>this.clearContractorFilters(),{signal:t}),c?.addEventListener("click",()=>this.exportContractorLogCSV(),{signal:t}),d?.addEventListener("click",()=>this.showContractorForm(null),{signal:t}),this.renderContractorLogTable()}},setupEventListeners(){this._setupTimeoutId&&clearTimeout(this._setupTimeoutId),this._setupTimeoutId=setTimeout(()=>{const t=document.getElementById("behavior-add-btn");t&&t.addEventListener("click",()=>this.showForm(),{passive:!0});const e=document.getElementById("behavior-add-contractor-header-btn");e&&e.addEventListener("click",()=>this.showContractorForm(null),{passive:!0});const a=document.getElementById("behavior-refresh-btn");a&&a.addEventListener("click",()=>{this.loadBehaviorDataAsync(),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},{passive:!0})},50)},getBehaviorFormHTML(t=null,e,a={}){const i={employeeCode:`${e}-employee-code`,employeeName:`${e}-employee-name`,dropdown:`${e}-employee-dropdown`,department:`${e}-department`,job:`${e}-job`,factory:`${e}-factory`,subLocation:`${e}-sublocation`,photoInput:`${e}-photo-input`,photoPreview:`${e}-photo-preview`,photoImg:`${e}-photo-img`,behaviorType:`${e}-type`,behaviorDate:`${e}-date`,behaviorRating:`${e}-rating`,correctiveAction:`${e}-corrective-action`,correctiveActionDetails:`${e}-corrective-action-details`,description:`${e}-description`,saveBtn:`${e}-save-btn`},o=t?.date?new Date(t.date).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=!!a.inline,r=this.getSiteOptions(),s=t?.factory||t?.factoryId||t?.siteId||"",h=t?.subLocation||t?.subLocationId||t?.location||"",c=r.find(p=>p.id===s)?.id||r.find(p=>p.name===s)?.id||s,d=this.getPlaceOptions(c),v=d.find(p=>p.id===h)?.id||d.find(p=>p.name===h)?.id||h,g=(t?.behaviorType||"")==="\u0633\u0644\u0628\u064A",L=this.processPhoto(t?.photo),m=L&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(L):{canonical:L||"",displaySrc:L||"",needsProxy:!1,proxyFileId:""},b=m.canonical?m.displaySrc:"",y=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(m):"";return`
                            ...
                            <div class="bhm-grid bhm-grid-2">
                                <div class="bhm-field">
                                    ...
                                    <select id="${i.factory}" required class="form-input bhm-input">
                                        ...
                                        ${r.map(p=>`
                                            <option value="${p.id}" ${c===p.id||s===p.name?"selected":""}>${Utils.escapeHTML(p.name)}</option>
                                        `).join("")}
                                    </select>
                                </div>
                                <div class="bhm-field">
        ...
        `},bindBehaviorForm({form:t,uid:e,data:a,modal:i,signal:o}){if(typeof EmployeeHelper<"u")try{EmployeeHelper.setupAutocomplete(`${e}-employee-name`,l=>{if(l){const u=document.getElementById(`${e}-employee-code`),T=document.getElementById(`${e}-employee-name`),f=document.getElementById(`${e}-department`),S=document.getElementById(`${e}-job`);u&&(u.value=l.code||""),T&&(T.value=l.name||""),f&&(l.department||l.employeeDepartment)&&(f.value=l.department||l.employeeDepartment||""),S&&(l.job||l.position||l.title)&&(S.value=l.job||l.position||l.title||"")}}),EmployeeHelper.setupEmployeeCodeSearch(`${e}-employee-code`,`${e}-employee-name`)}catch(l){Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0628\u062D\u062B \u0639\u0646 \u0627\u0644\u0645\u0648\u0638\u0641:",l)}const n=()=>{try{const l=(document.getElementById(`${e}-employee-code`)?.value||"").trim(),u=(document.getElementById(`${e}-employee-name`)?.value||"").trim(),f=(Array.isArray(AppState?.appData?.employees)?AppState.appData.employees:[]).find(B=>l&&(B.employeeNumber&&B.employeeNumber===l||B.sapId&&B.sapId===l)||u&&B.name===u);if(!f)return;const S=document.getElementById(`${e}-department`),I=document.getElementById(`${e}-job`);S&&!S.value&&(S.value=f.department||f.employeeDepartment||""),I&&!I.value&&(I.value=f.job||f.position||f.title||"")}catch{}};document.getElementById(`${e}-employee-code`)?.addEventListener("blur",n,{signal:o}),document.getElementById(`${e}-employee-name`)?.addEventListener("blur",n,{signal:o});const r=document.getElementById(`${e}-photo-input`),s=document.getElementById(`${e}-photo-preview`),h=document.getElementById(`${e}-photo-img`);r&&s&&h&&r.addEventListener("change",l=>{const u=l.target.files?.[0];if(!u)return;if(u.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB"),r.value="";return}const T=new FileReader;T.onload=f=>{h.src=f.target.result,s.classList.remove("hidden")},T.readAsDataURL(u)},{signal:o}),t.querySelector('[data-action="clear-photo"]')?.addEventListener("click",()=>{const l=document.getElementById(`${e}-photo-input`),u=document.getElementById(`${e}-photo-preview`);l&&(l.value=""),u&&u.classList.add("hidden")},{signal:o});const c=document.getElementById(`${e}-type`),d=document.getElementById(`${e}-type-badge`),v=t.closest(".behavior-form-wrapper")||t.parentElement,g=document.getElementById(`${e}-negative-section`),L=document.getElementById(`${e}-corrective-action`),m=l=>{v&&v.setAttribute("data-behavior-type",l||""),d&&(d.className=`badge ${this.getBehaviorTypeBadgeClass(l)}`,d.textContent=l||"\u2014");const u=i?.querySelector?.(".behavior-modal");u&&u.setAttribute("data-behavior-type",l||"");const T=(l||"")==="\u0633\u0644\u0628\u064A";g&&(g.style.display=T?"":"none"),L&&(T?L.setAttribute("required","required"):L.removeAttribute("required"))};m(c?.value||a?.behaviorType||""),c?.addEventListener("change",()=>m(c.value),{signal:o});const b=document.getElementById(`${e}-factory`),y=document.getElementById(`${e}-sublocation`),p=()=>{if(!b||!y)return;const l=b.value,u=this.getPlaceOptions(l),T=y.value;y.innerHTML=`
                <option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A</option>
                ${u.map(f=>`<option value="${f.id}">${Utils.escapeHTML(f.name)}</option>`).join("")}
            `,T&&u.some(f=>f.id===T)&&(y.value=T)};b?.addEventListener("change",p,{signal:o}),t.querySelector('[data-action="cancel-form"]')?.addEventListener("click",()=>i?.remove(),{signal:o}),document.getElementById(`${e}-save-btn`)?.addEventListener("click",()=>this.handleSubmit({uid:e,form:t,editId:a?.id||null,modal:i}),{signal:o})},async showForm(t=null){if(typeof Permissions<"u"&&Permissions.ensureFormSettingsState)try{await Permissions.ensureFormSettingsState()}catch{}const e=document.createElement("div");e.className="modal-overlay";const a=`bhm-modal-${Date.now()}`;e.innerHTML=`
            ...
            <div class="modal-content behavior-modal bhm-detail-modal" style="max-width: 820px;">
                ...
                <div class="modal-body bhm-detail-body">
                    <div class="bhm-detail-grid">
                        ...
                        `:""}
                        ${(()=>{const c=this.processPhoto(a.photo);if(!c)return"";const d=typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(c):{canonical:c,displaySrc:c,needsProxy:!1,proxyFileId:""},v=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(d):"";return`
                            <div class="bhm-detail-field bhm-detail-field-span2">
                ...
                <div class="bhm-detail-footer">
                    <button type="button" class="btn-primary" onclick="BehaviorMonitoring.editBehavior(${JSON.stringify(String(a.id||""))}); this.closest('.modal-overlay').remove();">
                        <i class="fas fa-pen ml-2"></i>\u062A\u0639\u062F\u064A\u0644
                    </button>
                    <button type="button" class="btn-secondary" onclick="BehaviorMonitoring.printReport(${JSON.stringify(String(a.id||""))});">
                        <i class="fas fa-print ml-2"></i>\u0637\u0628\u0627\u0639\u0629
                    </button>
                    <button type="button" class="btn-secondary" onclick="BehaviorMonitoring.exportPDF(${JSON.stringify(String(a.id||""))});">
                        ...
                        <div class="behavior-filters-toolbar behavior-contractors-filters-inline-bar" role="search" aria-label="${this.t("module.behavior.contractorBehaviorsTitle","\u0633\u062C\u0644 \u062A\u0635\u0631\u0641\u0627\u062A \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646 (\u0628\u062D\u062B / \u0641\u0644\u062A\u0631\u0629)")}">
                            <div class="bf-row">
                                <div class="bf-field bf-field--search">
                                    ...
                                    <div class="bf-search-wrap">
                                        <input id="bhmc-filter-search" type="text" class="bf-input" placeholder="${this.t("common.searchPlaceholder","ISO / \u0645\u0642\u0627\u0648\u0644 / \u0639\u0627\u0645\u0644 / \u0648\u0635\u0641")}" value="${a(e.search)}" autocomplete="off">
                                        <i class="fas fa-search bf-search-icon" aria-hidden="true"></i>
                                    </div>
                                </div>
                                <div class="bf-field bf-field--select">
                                ...
                                <div class="bf-field bf-field--date">
                                    ...
                                    <input id="bhmc-filter-from" type="date" class="bf-input" value="${a(e.dateFrom)}">
                                </div>
                                <div class="bf-field bf-field--date">
                                    <label for="bhmc-filter-to" class="bf-label"><i class="fas fa-calendar-check"></i>${this.t("common.toDate","\u0625\u0644\u0649 \u062A\u0627\u0631\u064A\u062E")}</label>
                                    <input id="bhmc-filter-to" type="date" class="bf-input" value="${a(e.dateTo)}">
                                </div>
                                <div class="bf-field bf-field--sort">
        ...
        `},renderContractorLogTableHTML(){const t=this.getFilteredContractorBehaviors();if(!t.length)return`<div class="empty-state"><p class="text-gray-500">${this.t("common.noMatchingResults","\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C \u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0644\u0641\u0644\u0627\u062A\u0631 \u0627\u0644\u062D\u0627\u0644\u064A\u0629")}</p></div>`;const e=this.paginateItems(t,this.state.contractorLogPage||1);this.state.contractorLogPage=e.page;const a=e.items;return`
            <div class="table-wrapper" style="overflow-x:auto;">
                <table class="data-table table-header-purple">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ${a.map(i=>`
                            <tr>
                                <td>${Utils.escapeHTML(i.isoCode||"")}</td>
                                <td><span class="font-semibold">${Utils.escapeHTML(i.contractorName||"")}</span></td>
                                <td>${Utils.escapeHTML(i.contractorWorker||"\u2014")}</td>
                                <td>${Utils.escapeHTML(i.factoryName||i.factory||"\u2014")}</td>
                                <td>${Utils.escapeHTML(i.subLocationName||i.subLocation||"\u2014")}</td>
                                <td><span class="badge ${this.getBehaviorTypeBadgeClass(i.behaviorType)}">${Utils.escapeHTML(i.behaviorType||"\u2014")}</span></td>
                                <td>${this.getBehaviorDate(i)?this.formatBehaviorDateDisplay(i):"\u2014"}</td>
                                ...
                                <td class="text-center">
                                    <div class="flex items-center justify-center gap-2 flex-wrap">
                                        <button type="button" onclick="BehaviorMonitoring.viewContractorBehavior(${JSON.stringify(String(i.id||""))})" class="btn-icon btn-icon-primary" title="\u0639\u0631\u0636"><i class="fas fa-eye"></i></button>
                                        <button type="button" onclick="BehaviorMonitoring.editContractorBehavior(${JSON.stringify(String(i.id||""))})" class="btn-icon btn-icon-warning" title="\u062A\u0639\u062F\u064A\u0644"><i class="fas fa-edit"></i></button>
                                        <button type="button" onclick="BehaviorMonitoring.exportContractorPDF(${JSON.stringify(String(i.id||""))})" class="btn-icon btn-icon-success" title="\u062A\u0635\u062F\u064A\u0631 PDF"><i class="fas fa-file-pdf"></i></button>
                                        <button type="button" onclick="BehaviorMonitoring.printContractorReport(${JSON.stringify(String(i.id||""))})" class="btn-icon btn-icon-info" title="\u0637\u0628\u0627\u0639\u0629"><i class="fas fa-print"></i></button>
                                    </div>
                                </td>
                            </tr>
                        `).join("")}
...
`),o=new Blob([i],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(o),r=document.createElement("a");r.href=n,r.download=`ContractorBehaviorMonitoring_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)},getContractorBehaviorFormHTML(t,e){const a=t?.date?new Date(t.date).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],i=this.getSiteOptions(),o=t?.factory||t?.factoryId||"",n=t?.subLocation||t?.subLocationId||"",r=i.find(b=>b.id===o)?.id||i.find(b=>b.name===o)?.id||o,s=this.getPlaceOptions(r),h=s.find(b=>b.id===n)?.id||s.find(b=>b.name===n)?.id||n,c=(t?.behaviorType||"")==="\u0633\u0644\u0628\u064A",d=this.processPhoto(t?.photo),v=d&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(d):{canonical:d||"",displaySrc:d||"",needsProxy:!1,proxyFileId:""},g=v.canonical?v.displaySrc:"",L=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(v):"",m={contractorSelect:`${e}-contractor-select`,contractorWorker:`${e}-contractor-worker`,department:`${e}-cb-department`,job:`${e}-cb-job`,factory:`${e}-cb-factory`,subLocation:`${e}-cb-sublocation`,behaviorType:`${e}-cb-type`,behaviorDate:`${e}-cb-date`,behaviorRating:`${e}-cb-rating`,correctiveAction:`${e}-cb-corrective`,correctiveActionDetails:`${e}-cb-corrective-details`,description:`${e}-cb-description`,photoInput:`${e}-cb-photo-input`,photoPreview:`${e}-cb-photo-preview`,photoImg:`${e}-cb-photo-img`,saveBtn:`${e}-cb-save-btn`,typeBadge:`${e}-cb-type-badge`,negativeSection:`${e}-cb-negative-section`};return`
            <div class="behavior-form-wrapper bhm-form behavior-form-modal" data-behavior-type="${Utils.escapeHTML(t?.behaviorType||"")}">
                <form data-contractor-behavior-form="true" data-form-uid="${e}" class="bhm-form-inner">
                    ...
                    <section id="${m.negativeSection}" class="bhm-negative-panel" style="${c?"":"display:none;"}">
                        <div class="bhm-negative-head">
                        ...
                        <div class="bhm-negative-body">
                            <div class="bhm-grid bhm-grid-2">
                                <div class="bhm-field">
                                    ...
                                    <select id="${m.correctiveAction}" class="form-input bhm-input" ${c?"required":""}>
                                        <option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0625\u062C\u0631\u0627\u0621</option>
        ...
        `},bindContractorBehaviorForm({form:t,uid:e,data:a,modal:i,signal:o}){const n=document.getElementById(`${e}-contractor-select`);if(n&&typeof Contractors<"u"&&Contractors.populateContractorSelect)try{Contractors.populateContractorSelect(n,{placeholder:"-- \u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 --",selectedValue:a?.contractorName||"",selectedContractorId:a?.contractorId||"",valueMode:"name",showServiceType:!0,includeSuppliers:!0,approvedOnly:!1})}catch(p){Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646:",p)}const r=document.getElementById(`${e}-cb-factory`),s=document.getElementById(`${e}-cb-sublocation`),h=()=>{if(!r||!s)return;const p=this.getPlaceOptions(r.value),$=s.value;s.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A</option>'+p.map(l=>`<option value="${l.id}">${Utils.escapeHTML(l.name)}</option>`).join(""),$&&p.some(l=>l.id===$)&&(s.value=$)};r?.addEventListener("change",h,{signal:o});const c=document.getElementById(`${e}-cb-type`),d=document.getElementById(`${e}-cb-type-badge`),v=document.getElementById(`${e}-cb-negative-section`),g=document.getElementById(`${e}-cb-corrective`),L=p=>{const $=t.closest(".behavior-form-wrapper");$&&$.setAttribute("data-behavior-type",p||""),d&&(d.className=`badge ${this.getBehaviorTypeBadgeClass(p)} bhm-type-chip`,d.textContent=p||"\u2014");const l=(p||"")==="\u0633\u0644\u0628\u064A";v&&(v.style.display=l?"":"none"),g&&(l?g.setAttribute("required","required"):g.removeAttribute("required"))};L(c?.value||a?.behaviorType||""),c?.addEventListener("change",()=>L(c.value),{signal:o});const m=document.getElementById(`${e}-cb-photo-input`),b=document.getElementById(`${e}-cb-photo-preview`),y=document.getElementById(`${e}-cb-photo-img`);m&&b&&y&&m.addEventListener("change",p=>{const $=p.target.files?.[0];if(!$)return;if($.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB"),m.value="";return}const l=new FileReader;l.onload=u=>{y.src=u.target.result,b.classList.remove("hidden")},l.readAsDataURL($)},{signal:o}),t.querySelector('[data-action="cb-clear-photo"]')?.addEventListener("click",()=>{const p=document.getElementById(`${e}-cb-photo-input`),$=document.getElementById(`${e}-cb-photo-preview`);p&&(p.value=""),$&&$.classList.add("hidden")},{signal:o}),t.querySelector('[data-action="cb-cancel-form"]')?.addEventListener("click",()=>i?.remove(),{signal:o}),document.getElementById(`${e}-cb-save-btn`)?.addEventListener("click",()=>this.handleContractorSubmit({uid:e,form:t,editId:a?.id||null,modal:i}),{signal:o})},async handleContractorSubmit({uid:t,form:e,editId:a=null,modal:i}){let o=a&&this.getRawContractorBehaviorById(a)?.photo||"";const n=document.getElementById(`${t}-cb-photo-input`);if(n&&n.files.length>0){const C=n.files[0];if(C.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB");return}o=await this.convertImageToBase64(C)}const r=document.getElementById(`${t}-contractor-select`),s=r?.selectedOptions?.[0],h=(r?.value||"").trim(),c=(s?.dataset?.contractorId||"").trim();if(!h){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644");return}const d=document.getElementById(`${t}-cb-type`),v=document.getElementById(`${t}-cb-date`),g=document.getElementById(`${t}-cb-rating`),L=document.getElementById(`${t}-cb-description`),m=document.getElementById(`${t}-cb-department`),b=document.getElementById(`${t}-cb-job`),y=document.getElementById(`${t}-cb-factory`),p=document.getElementById(`${t}-cb-sublocation`),$=document.getElementById(`${t}-cb-corrective`),l=document.getElementById(`${t}-cb-corrective-details`),u=document.getElementById(`${t}-contractor-worker`);if(!d||!v||!g||!L||!y||!p){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629.");return}const T=(d.value||"")==="\u0633\u0644\u0628\u064A";if(T&&(!$||!$.value)){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u062A\u0635\u062D\u064A\u062D\u064A \u0644\u0644\u062A\u0635\u0631\u0641 \u0627\u0644\u0633\u0644\u0628\u064A");return}const f=AppState.appData.contractorBehaviorMonitoring||[],S=a?this.getRawContractorBehaviorById(a):null,I=typeof generateISOCode=="function"?generateISOCode:null,B={id:a||Utils.generateId("CBHM"),isoCode:S&&S.isoCode?S.isoCode:I?I("BHC",f):`BHC-${Date.now()}`,contractorId:c,contractorName:h,contractorWorker:(u?.value||"").trim(),department:(m?.value||"").trim(),job:(b?.value||"").trim(),factory:(y.value||"").trim(),factoryId:y.value?String(y.value).trim():null,factoryName:this.resolveSiteName(y.value),subLocation:(p.value||"").trim(),subLocationId:p.value?String(p.value).trim():null,subLocationName:this.resolvePlaceName(p.value,y.value),photo:o,behaviorType:d.value,date:new Date(v.value).toISOString(),rating:g.value,correctiveAction:T&&$?.value||"",correctiveActionDetails:T?(l?.value||"").trim():"",description:L.value.trim(),createdAt:a?this.getRawContractorBehaviorById(a)?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};Loading.show();try{if(Array.isArray(AppState.appData.contractorBehaviorMonitoring)||(AppState.appData.contractorBehaviorMonitoring=[]),a){const C=AppState.appData.contractorBehaviorMonitoring.findIndex(w=>w.id===a);C!==-1&&(AppState.appData.contractorBehaviorMonitoring[C]=B),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0635\u0631\u0641 \u0628\u0646\u062C\u0627\u062D")}else AppState.appData.contractorBehaviorMonitoring.push(B),Notification.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062A\u0635\u0631\u0641 \u0628\u0646\u062C\u0627\u062D");typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),await GoogleIntegration.autoSave("ContractorBehaviorMonitoring",AppState.appData.contractorBehaviorMonitoring),Loading.hide(),i&&i.remove(),this.refreshCurrentTab()}catch(C){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+C.message)}},async showContractorForm(t=null){if(typeof Permissions<"u"&&Permissions.ensureFormSettingsState)try{await Permissions.ensureFormSettingsState()}catch{}const e=document.createElement("div");e.className="modal-overlay bhmc-contractor-overlay";const a=`bhmc-modal-${Date.now()}`,i=t?this.presentContractorBehavior(t):null;e.innerHTML=`
            ...
            <div class="modal-content behavior-modal bhm-detail-modal" style="max-width: 820px;">
                ...
                <div class="bhm-detail-footer">
                    <button type="button" class="btn-primary" onclick="BehaviorMonitoring.editContractorBehavior(${JSON.stringify(String(a.id||""))}); this.closest('.modal-overlay').remove();"><i class="fas fa-pen ml-2"></i>\u062A\u0639\u062F\u064A\u0644</button>
                    <button type="button" class="btn-secondary" onclick="BehaviorMonitoring.printContractorReport(${JSON.stringify(String(a.id||""))})"><i class="fas fa-print ml-2"></i>\u0637\u0628\u0627\u0639\u0629</button>
                    <button type="button" class="btn-secondary" onclick="BehaviorMonitoring.exportContractorPDF(${JSON.stringify(String(a.id||""))})"><i class="fas fa-file-pdf ml-2"></i>PDF</button>
                    <button type="button" class="btn-secondary" onclick="this.closest('.modal-overlay').remove()">\u0625\u063A\u0644\u0627\u0642</button>
                </div>
