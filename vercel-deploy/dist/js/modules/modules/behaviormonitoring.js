const BehaviorMonitoring={_setupTimeoutId:null,_eventListenersAbortController:null,_modalAbortController:null,_employeeSubmitLock:!1,_contractorSubmitLock:!1,processPhoto(e){return typeof Utils<"u"&&typeof Utils.normalizeImageSource=="function"?Utils.normalizeImageSource(e)||null:!e||typeof e!="string"?null:e.trim()||null},state:{activeTab:"log",filters:{search:"",behaviorType:"",rating:"",dateFrom:"",dateTo:""},sort:"date_desc",contractorFilters:{search:"",behaviorType:"",rating:"",dateFrom:"",dateTo:""},contractorSort:"date_desc",logPage:1,contractorLogPage:1,pageSize:50},getPageSize(){const e=Number(this.state?.pageSize);return Number.isFinite(e)&&e>0?e:50},paginateItems(e,t){const i=Array.isArray(e)?e:[],o=this.getPageSize(),a=i.length,n=Math.max(1,Math.ceil(a/o)||1),r=Math.min(Math.max(1,Number(t)||1),n),s=(r-1)*o;return{page:r,totalPages:n,total:a,start:s,end:Math.min(s+o,a),items:i.slice(s,s+o)}},renderTablePaginationHTML(e,t){const{page:i,totalPages:o,total:a,start:n,end:r}=t;if(a<=this.getPageSize())return a?`<div class="bhm-pagination text-sm text-gray-500 mt-3">${n+1}\u2013${r} / ${a}</div>`:"";const s=i<=1?"disabled":"",d=i>=o?"disabled":"",c=e==="contractor"?"setContractorLogPage":"setLogPage";return`
                ...
                <div class="content-card behavior-overview-card">
                    ...
                    <div class="card-body">
                        <div class="behavior-overview-stats-scroller mb-6">
                            <div class="behavior-overview-stats">
                                ...
                                <div class="behavior-stat behavior-stat-contractors">
                                    <div class="behavior-stat-inner">
                                        <div>
                                            <p class="stat-label behavior-stat-caption">${Utils.escapeHTML(T)}</p>
                                ...
                                <div class="behavior-stat behavior-stat-negative">
                                    <div class="behavior-stat-inner">
                                        <div>
                                            ...
                                            <p class="behavior-stat-value">${e?"\u2014":d}</p>
                                        </div>
                        ...
                        <div class="content-card behavior-mini-card">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-clock ml-2"></i>${Utils.escapeHTML(L)}</h3>
                            </div>
                            <div class="card-body">
                                ${e?`
        ...
        `},renderLogTable(){const e=document.getElementById("behavior-log-table-container");e&&(e.innerHTML=this.renderLogTableHTML());const t=document.getElementById("behavior-filter-count");t&&(t.textContent=String(this.getFilteredBehaviors().length));const i=document.getElementById("behavior-active-filter-chips");i&&(i.innerHTML=this.renderEmployeeActiveFilterChips())},clearFilters(){this.state.filters={search:"",behaviorType:"",rating:"",dateFrom:"",dateTo:""},this.state.sort="date_desc",this.state.logPage=1,this.refreshCurrentTab()},exportLogCSV(){const e=this.getFilteredBehaviors();if(!e.length){Notification.info("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u062A\u0635\u062F\u064A\u0631\u0647\u0627");return}const t=s=>{const d=(s??"").toString().replace(/\r?\n/g," ").trim();return d.includes('"')||d.includes(",")||d.includes(";")?`"${d.replace(/"/g,'""')}"`:d},o=[["ISO","EmployeeName","EmployeeCode","Department","Job","Factory","SubLocation","BehaviorType","Date","Rating","CorrectiveAction","CorrectiveActionDetails","Description"].join(","),...e.map(s=>[t(s.isoCode||""),t(s.employeeName||""),t(s.employeeCode||s.employeeNumber||""),t(s.department||""),t(s.job||s.position||""),t(s.factoryName||s.factory||""),t(s.subLocationName||s.subLocation||""),t(s.behaviorType||""),t(this.getBehaviorDate(s)?Utils.formatDateForInput(this.getBehaviorDate(s)):""),t(s.rating||""),t(s.correctiveAction||""),t(s.correctiveActionDetails||""),t(s.description||"")].join(","))].join(`
`),a=new Blob([o],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`BehaviorMonitoring_Log_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)},renderFormTab(e=!1){const t=`bhm-tab-${Date.now()}`;return`
        ...
        `},bindCurrentTabEvents(){this._eventListenersAbortController&&this._eventListenersAbortController.abort(),this._eventListenersAbortController=new AbortController;const e=this._eventListenersAbortController.signal,t=this.state?.activeTab||"log";if(t==="log"){const i=document.getElementById("behavior-filter-search"),o=document.getElementById("behavior-filter-type"),a=document.getElementById("behavior-filter-rating"),n=document.getElementById("behavior-filter-from"),r=document.getElementById("behavior-filter-to"),s=document.getElementById("behavior-sort"),d=document.getElementById("behavior-clear-filters-btn"),c=document.getElementById("behavior-export-csv-btn"),h=()=>{this.state.filters=this.state.filters||{},this.state.filters.search=(i?.value||"").toString(),this.state.filters.behaviorType=(o?.value||"").toString(),this.state.filters.rating=(a?.value||"").toString(),this.state.filters.dateFrom=(n?.value||"").toString(),this.state.filters.dateTo=(r?.value||"").toString(),this.state.sort=(s?.value||"date_desc").toString(),this.state.logPage=1,this.renderLogTable()};i?.addEventListener("input",h,{signal:e}),o?.addEventListener("change",h,{signal:e}),a?.addEventListener("change",h,{signal:e}),n?.addEventListener("change",h,{signal:e}),r?.addEventListener("change",h,{signal:e}),s?.addEventListener("change",h,{signal:e}),d?.addEventListener("click",()=>this.clearFilters(),{signal:e}),c?.addEventListener("click",()=>this.exportLogCSV(),{signal:e}),this.renderLogTable();return}if(t==="form"){const i=document.querySelector('#behavior-form-container form[data-behavior-form="true"]'),o=i?.getAttribute("data-form-uid");if(i&&o){this.bindBehaviorForm({form:i,uid:o,data:null,modal:null,signal:e});const a=document.getElementById("behavior-form-container");a&&typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(a,{onFetchFail:n=>{try{n.onerror=null,n.removeAttribute("src")}catch{}}})}return}if(t==="contractors"){const i=document.getElementById("bhmc-filter-search"),o=document.getElementById("bhmc-filter-type"),a=document.getElementById("bhmc-filter-rating"),n=document.getElementById("bhmc-filter-from"),r=document.getElementById("bhmc-filter-to"),s=document.getElementById("bhmc-sort"),d=document.getElementById("bhmc-clear-filters-btn"),c=document.getElementById("bhmc-export-csv-btn"),h=document.getElementById("behavior-add-contractor-btn"),v=()=>{this.state.contractorFilters=this.state.contractorFilters||{},this.state.contractorFilters.search=(i?.value||"").toString(),this.state.contractorFilters.behaviorType=(o?.value||"").toString(),this.state.contractorFilters.rating=(a?.value||"").toString(),this.state.contractorFilters.dateFrom=(n?.value||"").toString(),this.state.contractorFilters.dateTo=(r?.value||"").toString(),this.state.contractorSort=(s?.value||"date_desc").toString(),this.state.contractorLogPage=1,this.renderContractorLogTable()};i?.addEventListener("input",v,{signal:e}),o?.addEventListener("change",v,{signal:e}),a?.addEventListener("change",v,{signal:e}),n?.addEventListener("change",v,{signal:e}),r?.addEventListener("change",v,{signal:e}),s?.addEventListener("change",v,{signal:e}),d?.addEventListener("click",()=>this.clearContractorFilters(),{signal:e}),c?.addEventListener("click",()=>this.exportContractorLogCSV(),{signal:e}),h?.addEventListener("click",()=>this.showContractorForm(null),{signal:e}),this.renderContractorLogTable()}},setupEventListeners(){this._setupTimeoutId&&clearTimeout(this._setupTimeoutId),this._setupTimeoutId=setTimeout(()=>{const e=document.getElementById("behavior-add-btn");e&&e.addEventListener("click",()=>this.showForm(),{passive:!0});const t=document.getElementById("behavior-add-contractor-header-btn");t&&t.addEventListener("click",()=>this.showContractorForm(null),{passive:!0});const i=document.getElementById("behavior-refresh-btn");i&&i.addEventListener("click",()=>{this.loadBehaviorDataAsync(),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},{passive:!0})},50)},getBehaviorFormHTML(e=null,t,i={}){const o={employeeCode:`${t}-employee-code`,employeeName:`${t}-employee-name`,dropdown:`${t}-employee-dropdown`,department:`${t}-department`,job:`${t}-job`,factory:`${t}-factory`,subLocation:`${t}-sublocation`,photoInput:`${t}-photo-input`,photoPreview:`${t}-photo-preview`,photoImg:`${t}-photo-img`,behaviorType:`${t}-type`,behaviorDate:`${t}-date`,behaviorRating:`${t}-rating`,correctiveAction:`${t}-corrective-action`,correctiveActionDetails:`${t}-corrective-action-details`,description:`${t}-description`,saveBtn:`${t}-save-btn`},a=e?.date?new Date(e.date).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=!!i.inline,r=this.getSiteOptions(),s=e?.factory||e?.factoryId||e?.siteId||"",d=e?.subLocation||e?.subLocationId||e?.location||"",c=r.find(m=>m.id===s)?.id||r.find(m=>m.name===s)?.id||s,h=this.getPlaceOptions(c),v=h.find(m=>m.id===d)?.id||h.find(m=>m.name===d)?.id||d,y=(e?.behaviorType||"")==="\u0633\u0644\u0628\u064A",T=this.processPhoto(e?.photo),p=T&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(T):{canonical:T||"",displaySrc:T||"",needsProxy:!1,proxyFileId:""},b=p.canonical?p.displaySrc:"",L=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(p):"";return`
                            ...
                            <div class="bhm-grid bhm-grid-2">
                                ...
                                <div class="bhm-field">
                                    ...
                                    <select id="${o.subLocation}" required class="form-input bhm-input">
                                        ...
                                        ${h.map(m=>`
                                            <option value="${m.id}" ${v===m.id||d===m.name?"selected":""}>${Utils.escapeHTML(m.name)}</option>
                                        `).join("")}
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="bhm-grid bhm-grid-media">
                                <div class="bhm-field bhm-upload-wrap">
                                    ...
                                    <div id="${o.photoPreview}" class="bhm-photo-preview mt-3 ${e?.photo?"":"hidden"}">
                                        <img src="${Utils.escapeHTML(b)}" alt="\u0645\u0639\u0627\u064A\u0646\u0629"${L} class="bhm-photo-thumb" id="${o.photoImg}">
        ...
        `},bindBehaviorForm({form:e,uid:t,data:i,modal:o,signal:a}){if(typeof EmployeeHelper<"u")try{EmployeeHelper.setupAutocomplete(`${t}-employee-name`,l=>{if(l){const f=document.getElementById(`${t}-employee-code`),B=document.getElementById(`${t}-employee-name`),g=document.getElementById(`${t}-department`),x=document.getElementById(`${t}-job`);f&&(f.value=l.code||""),B&&(B.value=l.name||""),g&&(l.department||l.employeeDepartment)&&(g.value=l.department||l.employeeDepartment||""),x&&(l.job||l.position||l.title)&&(x.value=l.job||l.position||l.title||"")}}),EmployeeHelper.setupEmployeeCodeSearch(`${t}-employee-code`,`${t}-employee-name`)}catch(l){Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0628\u062D\u062B \u0639\u0646 \u0627\u0644\u0645\u0648\u0638\u0641:",l)}const n=()=>{try{const l=(document.getElementById(`${t}-employee-code`)?.value||"").trim(),f=(document.getElementById(`${t}-employee-name`)?.value||"").trim(),g=(Array.isArray(AppState?.appData?.employees)?AppState.appData.employees:[]).find(S=>l&&(S.employeeNumber&&S.employeeNumber===l||S.sapId&&S.sapId===l)||f&&S.name===f);if(!g)return;const x=document.getElementById(`${t}-department`),$=document.getElementById(`${t}-job`);x&&!x.value&&(x.value=g.department||g.employeeDepartment||""),$&&!$.value&&($.value=g.job||g.position||g.title||"")}catch{}};document.getElementById(`${t}-employee-code`)?.addEventListener("blur",n,{signal:a}),document.getElementById(`${t}-employee-name`)?.addEventListener("blur",n,{signal:a});const r=document.getElementById(`${t}-photo-input`),s=document.getElementById(`${t}-photo-preview`),d=document.getElementById(`${t}-photo-img`);r&&s&&d&&r.addEventListener("change",l=>{const f=l.target.files?.[0];if(!f)return;if(f.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB"),r.value="";return}const B=new FileReader;B.onload=g=>{d.src=g.target.result,s.classList.remove("hidden")},B.readAsDataURL(f)},{signal:a}),e.querySelector('[data-action="clear-photo"]')?.addEventListener("click",()=>{const l=document.getElementById(`${t}-photo-input`),f=document.getElementById(`${t}-photo-preview`);l&&(l.value=""),f&&f.classList.add("hidden")},{signal:a});const c=document.getElementById(`${t}-type`),h=document.getElementById(`${t}-type-badge`),v=e.closest(".behavior-form-wrapper")||e.parentElement,y=document.getElementById(`${t}-negative-section`),T=document.getElementById(`${t}-corrective-action`),p=l=>{v&&v.setAttribute("data-behavior-type",l||""),h&&(h.className=`badge ${this.getBehaviorTypeBadgeClass(l)}`,h.textContent=l||"\u2014");const f=o?.querySelector?.(".behavior-modal");f&&f.setAttribute("data-behavior-type",l||"");const B=(l||"")==="\u0633\u0644\u0628\u064A";y&&(y.style.display=B?"":"none"),T&&(B?T.setAttribute("required","required"):T.removeAttribute("required"))};p(c?.value||i?.behaviorType||""),c?.addEventListener("change",()=>p(c.value),{signal:a});const b=document.getElementById(`${t}-factory`),L=document.getElementById(`${t}-sublocation`),m=()=>{if(!b||!L)return;const l=b.value,f=this.getPlaceOptions(l),B=L.value;L.innerHTML=`
                <option value="">${this.t("module.behavior.selectSubLocation","\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A")}</option>
                ${f.map(g=>`<option value="${g.id}">${Utils.escapeHTML(g.name)}</option>`).join("")}
            `,B&&f.some(g=>g.id===B)&&(L.value=B)};b?.addEventListener("change",m,{signal:a}),e.querySelector('[data-action="cancel-form"]')?.addEventListener("click",()=>o?.remove(),{signal:a}),document.getElementById(`${t}-save-btn`)?.addEventListener("click",()=>this.handleSubmit({uid:t,form:e,editId:i?.id||null,modal:o}),{signal:a})},async showForm(e=null){if(typeof Permissions<"u"&&Permissions.ensureFormSettingsState)try{await Permissions.ensureFormSettingsState()}catch{}const t=document.createElement("div");t.className="modal-overlay";const i=`bhm-modal-${Date.now()}`;t.innerHTML=`
        ...
        `,document.body.appendChild(t),this._modalAbortController&&this._modalAbortController.abort(),this._modalAbortController=new AbortController;const o=this._modalAbortController.signal,a=t.querySelector('form[data-behavior-form="true"]');a&&this.bindBehaviorForm({form:a,uid:i,data:e,modal:t,signal:o}),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(t,{onFetchFail:n=>{try{n.onerror=null,n.src="data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22200%22 height=%22150%22%3E%3Crect fill=%22%23f0f0f0%22 width=%22200%22 height=%22150%22/%3E%3Ctext fill=%22%23999%22 font-size=%2212%22 x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22%3E\u0645\u0639\u0627\u064A\u0646\u0629%3C/text%3E%3C/svg%3E"}catch{}}}),t.addEventListener("click",n=>{n.target===t&&t.remove()},{signal:o})},async convertImageToBase64(e){return new Promise((t,i)=>{const o=new FileReader;o.onload=()=>t(o.result),o.onerror=i,o.readAsDataURL(e)})},async handleSubmit({uid:e,form:t,editId:i=null,modal:o}){if(this._employeeSubmitLock){Notification.warning("\u062C\u0627\u0631\u064A \u062D\u0641\u0638 \u0627\u0644\u062A\u0635\u0631\u0641... \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631 \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0643\u0631\u0627\u0631");return}const a=document.getElementById(`${e}-save-btn`);this._employeeSubmitLock=!0,a&&(a.disabled=!0,a.setAttribute("aria-busy","true"));try{let n=i&&this.getBehaviors().find($=>$.id===i)?.photo||"";const r=document.getElementById(`${e}-photo-input`);if(r&&r.files.length>0){const $=r.files[0];if($.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB");return}n=await this.convertImageToBase64($)}const s=(document.getElementById(`${e}-employee-code`)?.value||"").trim(),d=(document.getElementById(`${e}-employee-name`)?.value||"").trim(),h=(Array.isArray(AppState?.appData?.employees)?AppState.appData.employees:[]).find($=>$.employeeNumber&&$.employeeNumber===s||$.sapId&&$.sapId===s||$.name===d),v=document.getElementById(`${e}-type`),y=document.getElementById(`${e}-date`),T=document.getElementById(`${e}-rating`),p=document.getElementById(`${e}-description`),b=document.getElementById(`${e}-department`),L=document.getElementById(`${e}-job`),m=document.getElementById(`${e}-factory`),u=document.getElementById(`${e}-sublocation`),l=document.getElementById(`${e}-corrective-action`),f=document.getElementById(`${e}-corrective-action-details`);if(!v||!y||!T||!p||!b||!L||!m||!u){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649.");return}const B=(v.value||"")==="\u0633\u0644\u0628\u064A";if(B&&(!l||!l.value)){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u062A\u0635\u062D\u064A\u062D\u064A \u0644\u0644\u062A\u0635\u0631\u0641 \u0627\u0644\u0633\u0644\u0628\u064A");return}const g={id:i||Utils.generateId("BEHAV"),isoCode:generateISOCode("BEH",AppState.appData.behaviorMonitoring),employeeId:h?.id||"",employeeCode:s,employeeNumber:s,employeeName:d,department:(b.value||"").trim(),job:(L.value||"").trim(),factory:(m.value||"").trim(),factoryId:m.value?String(m.value).trim():null,factoryName:this.resolveSiteName(m.value),subLocation:(u.value||"").trim(),subLocationId:u.value?String(u.value).trim():null,subLocationName:this.resolvePlaceName(u.value,m.value),photo:n,behaviorType:v.value,date:new Date(y.value).toISOString(),rating:T.value,correctiveAction:B&&l?.value||"",correctiveActionDetails:B?(f?.value||"").trim():"",description:p.value.trim(),createdAt:i?this.getBehaviors().find($=>$.id===i)?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};if(this.findDuplicateEmployeeBehavior(g,i)){Notification.warning("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0646\u0641\u0633 \u0627\u0644\u062A\u0635\u0631\u0641 \u0644\u0646\u0641\u0633 \u0627\u0644\u0634\u062E\u0635 \u0641\u064A \u0646\u0641\u0633 \u0627\u0644\u062A\u0627\u0631\u064A\u062E \u0645\u0633\u0628\u0642\u0627\u064B. \u0644\u0646 \u064A\u062A\u0645 \u0627\u0644\u062A\u0643\u0631\u0627\u0631.");return}Loading.show();try{if(i){const $=AppState.appData.behaviorMonitoring.findIndex(S=>S.id===i);$!==-1&&(AppState.appData.behaviorMonitoring[$]=g),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0635\u0631\u0641 \u0628\u0646\u062C\u0627\u062D")}else{if(this.findDuplicateEmployeeBehavior(g,i)){Notification.warning("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0646\u0641\u0633 \u0627\u0644\u062A\u0635\u0631\u0641 \u0645\u0633\u0628\u0642\u0627\u064B. \u0644\u0646 \u064A\u062A\u0645 \u0627\u0644\u062A\u0643\u0631\u0627\u0631.");return}AppState.appData.behaviorMonitoring.push(g),Notification.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062A\u0635\u0631\u0641 \u0628\u0646\u062C\u0627\u062D")}typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("BehaviorMonitoring",AppState.appData.behaviorMonitoring),o&&o.remove(),this.refreshCurrentTab()}catch($){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+$.message)}finally{Loading.hide()}}finally{this._employeeSubmitLock=!1,a&&document.body.contains(a)&&(a.disabled=!1,a.removeAttribute("aria-busy"))}},async viewBehavior(e){const t=this.getRawBehaviorById(e);if(!t){Notification.error("\u0627\u0644\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const i=this.presentBehavior(t),o=c=>Utils.escapeHTML((c??"").toString()),a=c=>{const h=(c??"").toString().trim();return h?o(h):'<span class="bhm-detail-empty">\u2014</span>'},n=(i.description||"").toString().trim(),r=n?`<div class="bhm-detail-value bhm-detail-desc">${o(n)}</div>`:'<div class="bhm-detail-empty-block"><i class="fas fa-align-right ml-2"></i>\u0644\u0627 \u064A\u0648\u062C\u062F \u0648\u0635\u0641 \u0645\u0633\u062C\u0644 \u0644\u0647\u0630\u0627 \u0627\u0644\u062A\u0635\u0631\u0641.</div>',s=this.getBehaviorDate(i)?this.formatBehaviorDateDisplay(i):"\u2014",d=document.createElement("div");d.className="modal-overlay bhm-detail-overlay",d.innerHTML=`
                ...
                <div class="modal-body bhm-detail-body">
                    <div class="bhm-detail-grid">
                        ...
                        <div class="bhm-detail-field">
                            ...
                            <div class="bhm-detail-value">${s==="\u2014"?'<span class="bhm-detail-empty">\u2014</span>':o(s)}</div>
                        </div>
                        <div class="bhm-detail-field">
                        ...
                        `:""}
                        ${(()=>{const c=this.processPhoto(i.photo);if(!c)return"";const h=typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(c):{canonical:c,displaySrc:c,needsProxy:!1,proxyFileId:""},v=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(h):"";return`
                            <div class="bhm-detail-field bhm-detail-field-span2">
        ...
        `,document.body.appendChild(d),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(d,{onFetchFail:c=>{try{c.onerror=null,c.src="data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22400%22 height=%22300%22%3E%3Crect fill=%22%23f0f0f0%22 width=%22400%22 height=%22300%22/%3E%3Ctext fill=%22%23999%22 font-family=%22sans-serif%22 font-size=%2216%22 x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22%3E\u0644\u0627 \u062A\u0648\u062C\u062F \u0635\u0648\u0631\u0629%3C/text%3E%3C/svg%3E"}catch{}}}),d.addEventListener("click",c=>{c.target===d&&d.remove()})},async exportPDF(e){const t=this.getRawBehaviorById(e);if(!t){Notification.error("\u0627\u0644\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const i=this.presentBehavior(t);try{Loading.show();const o=i.isoCode||`BEH-${i.id?.substring(0,8)||"UNKNOWN"}`,a="\u062A\u0642\u0631\u064A\u0631 \u0645\u0631\u0627\u0642\u0628\u0629 \u0627\u0644\u062A\u0635\u0631\u0641\u0627\u062A",n=this.getBehaviorDate(i)?this.formatBehaviorDateDisplay(i):"\u2014",r=`
                <table>
        ...
        `},renderContractorLogTable(){const e=document.getElementById("bhmc-log-table-container");e&&(e.innerHTML=this.renderContractorLogTableHTML());const t=document.getElementById("bhmc-filter-count");t&&(t.textContent=String(this.getFilteredContractorBehaviors().length))},exportContractorLogCSV(){const e=this.getFilteredContractorBehaviors();if(!e.length){Notification.info("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u062A\u0635\u062F\u064A\u0631\u0647\u0627");return}const t=s=>{const d=(s??"").toString().replace(/\r?\n/g," ").trim();return d.includes('"')||d.includes(",")||d.includes(";")?`"${d.replace(/"/g,'""')}"`:d},o=[["ISO","ContractorName","ContractorWorker","Department","Job","Factory","SubLocation","BehaviorType","Date","Rating","CorrectiveAction","CorrectiveActionDetails","Description"].join(","),...e.map(s=>[t(s.isoCode||""),t(s.contractorName||""),t(s.contractorWorker||""),t(s.department||""),t(s.job||s.position||""),t(s.factoryName||s.factory||""),t(s.subLocationName||s.subLocation||""),t(s.behaviorType||""),t(this.getBehaviorDate(s)?Utils.formatDateForInput(this.getBehaviorDate(s)):""),t(s.rating||""),t(s.correctiveAction||""),t(s.correctiveActionDetails||""),t(s.description||"")].join(","))].join(`
`),a=new Blob([o],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`ContractorBehaviorMonitoring_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)},getContractorBehaviorFormHTML(e,t){const i=e?.date?new Date(e.date).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],o=this.getSiteOptions(),a=e?.factory||e?.factoryId||"",n=e?.subLocation||e?.subLocationId||"",r=o.find(b=>b.id===a)?.id||o.find(b=>b.name===a)?.id||a,s=this.getPlaceOptions(r),d=s.find(b=>b.id===n)?.id||s.find(b=>b.name===n)?.id||n,c=(e?.behaviorType||"")==="\u0633\u0644\u0628\u064A",h=this.processPhoto(e?.photo),v=h&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(h):{canonical:h||"",displaySrc:h||"",needsProxy:!1,proxyFileId:""},y=v.canonical?v.displaySrc:"",T=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(v):"",p={contractorSelect:`${t}-contractor-select`,contractorWorker:`${t}-contractor-worker`,department:`${t}-cb-department`,job:`${t}-cb-job`,factory:`${t}-cb-factory`,subLocation:`${t}-cb-sublocation`,behaviorType:`${t}-cb-type`,behaviorDate:`${t}-cb-date`,behaviorRating:`${t}-cb-rating`,correctiveAction:`${t}-cb-corrective`,correctiveActionDetails:`${t}-cb-corrective-details`,description:`${t}-cb-description`,photoInput:`${t}-cb-photo-input`,photoPreview:`${t}-cb-photo-preview`,photoImg:`${t}-cb-photo-img`,saveBtn:`${t}-cb-save-btn`,typeBadge:`${t}-cb-type-badge`,negativeSection:`${t}-cb-negative-section`};return`
                            ...
                            <div class="bhm-grid bhm-grid-2">
                                <div class="bhm-field">
                                    ...
                                    <select id="${p.factory}" required class="form-input bhm-input">
                                        <option value="">${this.t("module.behavior.selectFactory","\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0635\u0646\u0639")}</option>
                                        ${o.map(b=>`
                                            <option value="${b.id}" ${r===b.id||a===b.name?"selected":""}>${Utils.escapeHTML(b.name)}</option>
                                        `).join("")}
                                    </select>
                                </div>
                                <div class="bhm-field">
                                    ...
                                    <select id="${p.subLocation}" required class="form-input bhm-input">
                                        <option value="">${this.t("module.behavior.selectSubLocation","\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A")}</option>
                                        ${s.map(b=>`
                                            <option value="${b.id}" ${d===b.id||n===b.name?"selected":""}>${Utils.escapeHTML(b.name)}</option>
                                        `).join("")}
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="bhm-grid bhm-grid-media">
                                <div class="bhm-field bhm-upload-wrap">
                                    ...
                                    <div id="${p.photoPreview}" class="bhm-photo-preview mt-3 ${e?.photo?"":"hidden"}">
                                        <img src="${Utils.escapeHTML(y)}" alt=""${T} class="bhm-photo-thumb" id="${p.photoImg}">
        ...
        `},bindContractorBehaviorForm({form:e,uid:t,data:i,modal:o,signal:a}){const n=document.getElementById(`${t}-contractor-select`);if(n&&typeof Contractors<"u"&&Contractors.populateContractorSelect)try{Contractors.populateContractorSelect(n,{placeholder:"-- \u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 --",selectedValue:i?.contractorName||"",selectedContractorId:i?.contractorId||"",valueMode:"name",showServiceType:!0,includeSuppliers:!0,approvedOnly:!1})}catch(m){Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646:",m)}const r=document.getElementById(`${t}-cb-factory`),s=document.getElementById(`${t}-cb-sublocation`),d=()=>{if(!r||!s)return;const m=this.getPlaceOptions(r.value),u=s.value;s.innerHTML='<option value="">'+this.t("module.behavior.selectSubLocation","\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A")+"</option>"+m.map(l=>`<option value="${l.id}">${Utils.escapeHTML(l.name)}</option>`).join(""),u&&m.some(l=>l.id===u)&&(s.value=u)};r?.addEventListener("change",d,{signal:a});const c=document.getElementById(`${t}-cb-type`),h=document.getElementById(`${t}-cb-type-badge`),v=document.getElementById(`${t}-cb-negative-section`),y=document.getElementById(`${t}-cb-corrective`),T=m=>{const u=e.closest(".behavior-form-wrapper");u&&u.setAttribute("data-behavior-type",m||""),h&&(h.className=`badge ${this.getBehaviorTypeBadgeClass(m)} bhm-type-chip`,h.textContent=m||"\u2014");const l=(m||"")==="\u0633\u0644\u0628\u064A";v&&(v.style.display=l?"":"none"),y&&(l?y.setAttribute("required","required"):y.removeAttribute("required"))};T(c?.value||i?.behaviorType||""),c?.addEventListener("change",()=>T(c.value),{signal:a});const p=document.getElementById(`${t}-cb-photo-input`),b=document.getElementById(`${t}-cb-photo-preview`),L=document.getElementById(`${t}-cb-photo-img`);p&&b&&L&&p.addEventListener("change",m=>{const u=m.target.files?.[0];if(!u)return;if(u.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB"),p.value="";return}const l=new FileReader;l.onload=f=>{L.src=f.target.result,b.classList.remove("hidden")},l.readAsDataURL(u)},{signal:a}),e.querySelector('[data-action="cb-clear-photo"]')?.addEventListener("click",()=>{const m=document.getElementById(`${t}-cb-photo-input`),u=document.getElementById(`${t}-cb-photo-preview`);m&&(m.value=""),u&&u.classList.add("hidden")},{signal:a}),e.querySelector('[data-action="cb-cancel-form"]')?.addEventListener("click",()=>o?.remove(),{signal:a}),document.getElementById(`${t}-cb-save-btn`)?.addEventListener("click",()=>this.handleContractorSubmit({uid:t,form:e,editId:i?.id||null,modal:o}),{signal:a})},async handleContractorSubmit({uid:e,form:t,editId:i=null,modal:o}){if(this._contractorSubmitLock){Notification.warning("\u062C\u0627\u0631\u064A \u062D\u0641\u0638 \u0627\u0644\u062A\u0635\u0631\u0641... \u064A\u0631\u062C\u0649 \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631 \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0643\u0631\u0627\u0631");return}const a=document.getElementById(`${e}-cb-save-btn`);this._contractorSubmitLock=!0,a&&(a.disabled=!0,a.setAttribute("aria-busy","true"));try{let n=i&&this.getRawContractorBehaviorById(i)?.photo||"";const r=document.getElementById(`${e}-cb-photo-input`);if(r&&r.files.length>0){const w=r.files[0];if(w.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 2MB");return}n=await this.convertImageToBase64(w)}const s=document.getElementById(`${e}-contractor-select`),d=s?.selectedOptions?.[0],c=(s?.value||"").trim(),h=(d?.dataset?.contractorId||"").trim();if(!c){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0645\u0642\u0627\u0648\u0644");return}const v=document.getElementById(`${e}-cb-type`),y=document.getElementById(`${e}-cb-date`),T=document.getElementById(`${e}-cb-rating`),p=document.getElementById(`${e}-cb-description`),b=document.getElementById(`${e}-cb-department`),L=document.getElementById(`${e}-cb-job`),m=document.getElementById(`${e}-cb-factory`),u=document.getElementById(`${e}-cb-sublocation`),l=document.getElementById(`${e}-cb-corrective`),f=document.getElementById(`${e}-cb-corrective-details`),B=document.getElementById(`${e}-contractor-worker`);if(!v||!y||!T||!p||!m||!u){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629.");return}const g=(v.value||"")==="\u0633\u0644\u0628\u064A";if(g&&(!l||!l.value)){Notification.error("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u062A\u0635\u062D\u064A\u062D\u064A \u0644\u0644\u062A\u0635\u0631\u0641 \u0627\u0644\u0633\u0644\u0628\u064A");return}const x=AppState.appData.contractorBehaviorMonitoring||[],$=i?this.getRawContractorBehaviorById(i):null,S=typeof generateISOCode=="function"?generateISOCode:null,C={id:i||Utils.generateId("CBHM"),isoCode:$&&$.isoCode?$.isoCode:S?S("BHC",x):`BHC-${Date.now()}`,contractorId:h,contractorName:c,contractorWorker:(B?.value||"").trim(),department:(b?.value||"").trim(),job:(L?.value||"").trim(),factory:(m.value||"").trim(),factoryId:m.value?String(m.value).trim():null,factoryName:this.resolveSiteName(m.value),subLocation:(u.value||"").trim(),subLocationId:u.value?String(u.value).trim():null,subLocationName:this.resolvePlaceName(u.value,m.value),photo:n,behaviorType:v.value,date:new Date(y.value).toISOString(),rating:T.value,correctiveAction:g&&l?.value||"",correctiveActionDetails:g?(f?.value||"").trim():"",description:p.value.trim(),createdAt:i?this.getRawContractorBehaviorById(i)?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};if(this.findDuplicateContractorBehavior(C,i)){Notification.warning("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0646\u0641\u0633 \u0627\u0644\u062A\u0635\u0631\u0641 \u0644\u0646\u0641\u0633 \u0627\u0644\u0634\u062E\u0635 \u0641\u064A \u0646\u0641\u0633 \u0627\u0644\u062A\u0627\u0631\u064A\u062E \u0645\u0633\u0628\u0642\u0627\u064B. \u0644\u0646 \u064A\u062A\u0645 \u0627\u0644\u062A\u0643\u0631\u0627\u0631.");return}Loading.show();try{if(Array.isArray(AppState.appData.contractorBehaviorMonitoring)||(AppState.appData.contractorBehaviorMonitoring=[]),i){const w=AppState.appData.contractorBehaviorMonitoring.findIndex(A=>A.id===i);w!==-1&&(AppState.appData.contractorBehaviorMonitoring[w]=C),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0635\u0631\u0641 \u0628\u0646\u062C\u0627\u062D")}else{if(this.findDuplicateContractorBehavior(C,i)){Notification.warning("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0646\u0641\u0633 \u0627\u0644\u062A\u0635\u0631\u0641 \u0645\u0633\u0628\u0642\u0627\u064B. \u0644\u0646 \u064A\u062A\u0645 \u0627\u0644\u062A\u0643\u0631\u0627\u0631.");return}AppState.appData.contractorBehaviorMonitoring.push(C),Notification.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062A\u0635\u0631\u0641 \u0628\u0646\u062C\u0627\u062D")}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),await GoogleIntegration.autoSave("ContractorBehaviorMonitoring",AppState.appData.contractorBehaviorMonitoring),o&&o.remove(),this.refreshCurrentTab()}catch(w){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+w.message)}finally{Loading.hide()}}finally{this._contractorSubmitLock=!1,a&&document.body.contains(a)&&(a.disabled=!1,a.removeAttribute("aria-busy"))}},async showContractorForm(e=null){if(typeof Permissions<"u"&&Permissions.ensureFormSettingsState)try{await Permissions.ensureFormSettingsState()}catch{}const t=document.createElement("div");t.className="modal-overlay bhmc-contractor-overlay";const i=`bhmc-modal-${Date.now()}`,o=e?this.presentContractorBehavior(e):null;t.innerHTML=`
            ...
            </div>`,document.body.appendChild(t),this._modalAbortController&&this._modalAbortController.abort(),this._modalAbortController=new AbortController;const a=this._modalAbortController.signal,n=t.querySelector('form[data-contractor-behavior-form="true"]');n&&this.bindContractorBehaviorForm({form:n,uid:i,data:o,modal:t,signal:a}),t.addEventListener("click",r=>{r.target===t&&t.remove()},{signal:a})},editContractorBehavior(e){const t=this.getRawContractorBehaviorById(e);if(!t){Notification.error("\u0627\u0644\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}this.showContractorForm(t)},async viewContractorBehavior(e){const t=this.getRawContractorBehaviorById(e);if(!t){Notification.error("\u0627\u0644\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const i=this.presentContractorBehavior(t),o=s=>Utils.escapeHTML((s??"").toString()),a=s=>{const d=(s??"").toString().trim();return d?o(d):'<span class="bhm-detail-empty">\u2014</span>'},n=this.getBehaviorDate(i)?this.formatBehaviorDateDisplay(i):"\u2014",r=document.createElement("div");r.className="modal-overlay bhm-detail-overlay",r.innerHTML=`
            <div class="modal-content behavior-modal bhm-detail-modal" style="max-width: 820px;">
                <div class="bhm-detail-hero">
                    <div class="bhm-detail-hero-text">
                ...
                <div class="modal-body bhm-detail-body">
                    <div class="bhm-detail-grid">
                        ...
                        <div class="bhm-detail-field"><span class="bhm-detail-label">\u0627\u0644\u062A\u0627\u0631\u064A\u062E</span><div class="bhm-detail-value">${o(n)}</div></div>
            ...
            </div>`,document.body.appendChild(r)},async exportContractorPDF(e){const t=this.getRawContractorBehaviorById(e);if(!t){Notification.error("\u0627\u0644\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const i=this.presentContractorBehavior(t);try{Loading.show();const o=i.isoCode||`BHC-${i.id?.substring(0,8)||"UNKNOWN"}`,a="\u062A\u0642\u0631\u064A\u0631 \u062A\u0635\u0631\u0641 \u0645\u0642\u0627\u0648\u0644",n=this.getBehaviorDate(i)?this.formatBehaviorDateDisplay(i):"\u2014",r=`
                <table>
                    <tr><th>\u0643\u0648\u062F ISO</th><td>${Utils.escapeHTML(i.isoCode||"")}</td></tr>
