...
\u0633\u064A\u062A\u0645 \u0641\u0642\u062F\u0627\u0646 \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.`)&&e.closest(".modal-overlay").remove()},closeModal(e){const a=e.closest(".modal-overlay");a&&a.remove()},generateFireDeviceID(){const a=this.getAssets().map(i=>i.id).filter(i=>i&&i.match(/^EFA-\d{4}$/)).map(i=>parseInt(i.split("-")[1])).filter(i=>!isNaN(i)),s=a.length>0?Math.max(...a)+1:1;return`EFA-${String(s).padStart(4,"0")}`},_injectFireIdentityStyles(){try{if(document.getElementById("fire-professional-identity-styles"))return;const e=document.createElement("style");e.id="fire-professional-identity-styles",e.textContent=`
            ...
            `,this.applyModuleI18n(e);try{this.setupEventListeners()}catch(s){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A setupEventListeners:",s)}setTimeout(async()=>{try{await new Promise(n=>{if(typeof AppState<"u"&&AppState&&AppState.appData){n();return}let r=0;const l=50,o=setInterval(()=>{r++,typeof AppState<"u"&&AppState&&AppState.appData?(clearInterval(o),n()):r>=l&&(clearInterval(o),(typeof AppState>"u"||!AppState)&&(AppState={}),AppState.appData||(AppState.appData={}),n())},100)});let t=!1;try{t=this.ensureData()}catch(n){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A ensureData:",n)}if(t)try{setTimeout(async()=>{try{await this.persistAll()}catch(n){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A persistAll:",n)}},0)}catch(n){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A persistAll:",n)}const i=document.getElementById("fire-tab-database");if(i){const n=async l=>{const o=(c,u,d)=>{const p=new Promise((f,b)=>{setTimeout(()=>b(new Error(d||"Timeout")),u)});return Promise.race([c,p])};return typeof Utils<"u"&&Utils.promiseWithTimeout?await Utils.promiseWithTimeout(l(),1e4,"Timeout: renderTabContent"):await o(l(),1e4,"Timeout: renderTabContent")},r=`
        ...
        `},renderRegisterStatisticsCards(){const e=this.getRegisterStatistics(),a=s=>e.total?Math.round((Number(s)||0)/e.total*100):0;return`
            <div class="fire-stat-grid">
                <div class="fire-stat fire-stat--blue">
                    ...
                    <div class="fire-stat__bar"><span class="fire-stat__bar-fill" style="--fs-pct:${a(e.total)}%"></span></div>
                </div>
                ...
                <div class="fire-stat fire-stat--green">
                    ...
                    <div class="fire-stat__bar"><span class="fire-stat__bar-fill" style="--fs-pct:${a(e.operational)}%"></span></div>
                </div>
                ...
                <div class="fire-stat fire-stat--amber">
                    ...
                    <div class="fire-stat__bar"><span class="fire-stat__bar-fill" style="--fs-pct:${a(e.needsMaintenance)}%"></span></div>
                </div>
                ...
                <div class="fire-stat fire-stat--red">
                    ...
                    <div class="fire-stat__bar"><span class="fire-stat__bar-fill" style="--fs-pct:${a(e.outOfService)}%"></span></div>
                </div>
            </div>
        ...
        `},async refreshRegisterTable(){this.ensureData(),this.updateRegisterStatisticsCards();const e=document.getElementById("fire-register-table");if(!e)return;const a=this.getAssets();!a||a.length===0?e.innerHTML='<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0639\u062F\u0627\u062A \u0645\u0633\u062C\u0644\u0629 \u0628\u0639\u062F\u060C \u0642\u0645 \u0628\u0625\u0636\u0627\u0641\u0629 \u062C\u0647\u0627\u0632 \u062C\u062F\u064A\u062F \u0644\u0628\u062F\u0621 \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629.</p></div>':(e.innerHTML=this.renderRegisterTable(),e.dataset.eventsBound="false",this.bindRegisterTableEvents(e))},async refreshCurrentTab(e=!1){if(this.state.currentTab==="database")this.renderAssets();else if(this.state.currentTab==="register")await this.refreshRegisterTable();else if(this.state.currentTab==="inspections"){const a=this.getMonthlyInspections(),s=document.getElementById("inspections-completed"),t=document.getElementById("inspections-needs-repair"),i=document.getElementById("inspections-out-of-service"),n=document.getElementById("inspections-total");s&&(s.textContent=a.completed),t&&(t.textContent=a.needsRepair),i&&(i.textContent=a.outOfService),n&&(n.textContent=a.total);const r=document.getElementById("monthly-inspections-table");r&&(r.innerHTML=this.renderMonthlyInspectionsTable(a.list))}else this.renderAssets()},getMonthlyInspections(){const e=new Date,a=new Date(e.getFullYear(),e.getMonth(),1),s=new Date(e.getFullYear(),e.getMonth()+1,0,23,59,59),t=this.getInspections().filter(i=>{const n=new Date(i.checkDate||i.createdAt);return n>=a&&n<=s}).sort((i,n)=>{const r=new Date(i.checkDate||i.createdAt);return new Date(n.checkDate||n.createdAt)-r});return{list:t,total:t.length,completed:t.filter(i=>i.status==="\u0635\u0627\u0644\u062D").length,needsRepair:t.filter(i=>i.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629").length,outOfService:t.filter(i=>i.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length}},renderMonthlyInspectionsTable(e){return!e||e.length===0?'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0641\u062D\u0648\u0635\u0627\u062A \u0645\u0633\u062C\u0644\u0629 \u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631</p></div>':`
            <div class="table-wrapper" style="width: 100%; max-width: 100%; overflow-x: auto;">
                <table class="data-table table-header-red" style="width: 100%; min-width: 100%; table-layout: auto;">
                    ...
                    <tbody>${e.map(s=>{const t=this.getAssets().find(l=>l.id===s.assetId),i=t?`${t.number||t.id} - ${t.location||""}`:s.assetId,n=this.getStatusBadge(s.status),r=s.checkDate?Utils.formatDate(s.checkDate):"-";return`
                <tr>
                    <td>
        ...
        `},viewInspection(e){const a=this.getInspections().find(n=>n.id===e);if(!a){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0641\u062D\u0635");return}const s=this.getAssets().find(n=>n.id===a.assetId),t=s?`${s.number||s.id} - ${s.location||""}`:a.assetId,i=document.createElement("div");i.className="modal-overlay fire-modal",i.innerHTML=`
        ...
        `,document.body.appendChild(t);const i=t.querySelector("#fire-asset-form");i.addEventListener("submit",async r=>{r.preventDefault();const l=i?.querySelector('button[type="submit"]');if(l&&l.disabled)return;let o="";l&&(o=l.innerHTML,l.disabled=!0,l.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');try{const c=new Date().toISOString(),u=this.getAssets(),d=u.findIndex(g=>g.id===s),p=document.getElementById("asset-type").value.trim();p&&!this.assetTypes.includes(p)&&this.assetTypes.push(p);const f=g=>{const E=document.getElementById(g);return E?E.value.trim():""},b=g=>{const E=document.getElementById(g);return E?E.value.trim():null},w=f("asset-factory"),A=f("asset-sub-location"),y=this.getSiteOptions().find(g=>g.id===w),x=this.getPlaceOptions(w).find(g=>g.id===A),v={id:s,number:f("asset-site-number")||s,siteNumber:f("asset-site-number")||s,type:p,location:f("asset-location"),subLocation:A,subLocationId:A?String(A).trim():null,subLocationName:x?x.name:"",manufacturer:f("asset-manufacturer"),factory:w,factoryId:w?String(w).trim():null,factoryName:y?y.name:"",model:f("asset-model"),capacity:f("asset-capacity"),capacityKg:f("asset-capacity"),manufacturingYear:(()=>{const g=document.getElementById("asset-manufacturing-year");return g&&g.value?parseInt(g.value):null})(),productionDate:(()=>{const g=document.getElementById("asset-production-date");return g?this.toISODate(g.value):null})(),serialNumber:f("asset-serial-number"),installationMethod:f("asset-installation-method"),installationDate:(()=>{const g=document.getElementById("asset-installation");return g?this.toISODate(g.value):null})(),lastServiceDate:(()=>{const g=document.getElementById("asset-last-service");return g?this.toISODate(g.value):null})(),status:f("asset-status"),responsible:f("asset-responsible"),notes:f("asset-notes"),qrCodeData:e?.qrCodeData||this.generateQrData(s),createdAt:e?.createdAt||c,updatedAt:c};d>-1?u[d]={...u[d],...v}:u.push(v),Loading.show();let h;if(GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled){if(h=await GoogleIntegration.sendRequest({action:"saveOrUpdateFireEquipmentAsset",data:v}),!h.success)throw new Error(h.message||"\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u062C\u0647\u0627\u0632");Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u062C\u0647\u0627\u0632 \u0641\u064A Backend:",v.id);try{await this.loadAssetsFromBackend()}catch(g){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0646 Backend\u060C \u0633\u064A\u062A\u0645 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629:",g)}}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success(a?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062C\u0647\u0627\u0632":"\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u062C\u0647\u0627\u0632 \u0628\u0646\u062C\u0627\u062D"),l&&(l.disabled=!1,l.innerHTML=o),t.remove(),this.state.currentTab==="database"?this.renderAssets():this.state.currentTab==="register"?await this.refreshRegisterTable():await this.refreshCurrentTab()}catch(c){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0641\u0638 \u0627\u0644\u062C\u0647\u0627\u0632:",c),Notification.error("\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u062C\u0647\u0627\u0632: "+(c.message||c)),l&&(l.disabled=!1,l.innerHTML=o)}});const n=t.querySelector("#manage-types-btn");n&&n.addEventListener("click",()=>{this.showManageTypesModal()}),setTimeout(()=>{const r=t.querySelector("#asset-factory"),l=t.querySelector("#asset-sub-location");r&&l&&r.addEventListener("change",()=>{const o=r.value,c=this.getPlaceOptions(o);l.innerHTML='<option value="">\u0627\u062E\u062A\u0631 \u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0641\u0631\u0639\u064A</option>',c.forEach(u=>{const d=document.createElement("option");d.value=u.id,d.textContent=u.name,l.appendChild(d)})})},100)},async startQRScan(){if(!navigator.mediaDevices||!navigator.mediaDevices.getUserMedia){Notification.error("\u0627\u0644\u0645\u062A\u0635\u0641\u062D \u0644\u0627 \u064A\u062F\u0639\u0645 \u0627\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0627\u0644\u0643\u0627\u0645\u064A\u0631\u0627. \u064A\u0631\u062C\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0645\u062A\u0635\u0641\u062D \u062D\u062F\u064A\u062B.");return}const e=document.createElement("div");e.className="modal-overlay fire-modal",e.innerHTML=`
            <style>
                .qr-scanner-modal {
                    max-width: 95%;
                    width: 100%;
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="inspection-status" class="form-input" required>
                                    ${this.statusOptions.map(u=>`<option value="${u.value}" ${e?.status===u.value?"selected":""}>${u.label}</option>`).join("")}
                                </select>
                            </div>
                            <div>
        ...
        `,document.body.appendChild(l);const o=l.querySelector("#fire-inspection-form");if(!o){Utils.safeError("\u274C \u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0646\u0645\u0648\u0630\u062C #fire-inspection-form");return}let c=!1;o.addEventListener("submit",async u=>{if(u.preventDefault(),u.stopPropagation(),c){Utils.safeWarn("\u26A0\uFE0F \u0627\u0644\u0646\u0645\u0648\u0630\u062C \u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629 \u0628\u0627\u0644\u0641\u0639\u0644");return}c=!0;const d=o.querySelector('button[type="submit"]'),p=d?d.innerHTML:"";try{d&&(d.disabled=!0,d.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i>\u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const f=new Date().toISOString(),b=h=>{const g=document.getElementById(h);return g?g.value.trim():""},w=h=>{const g=document.getElementById(h);return g?g.value:null},A=document.getElementById("inspection-asset"),m=(A?A.value:"")||i;if(!m){Notification.error("\u062E\u0637\u0623: DeviceID \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"),c=!1,d&&(d.disabled=!1,d.innerHTML=p);return}if(!s){const h=this.checkMonthlyInspectionAllowed(m);if(!h.allowed){Notification.warning(h.reason||"\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A \u0647\u0630\u0627 \u0627\u0644\u0648\u0642\u062A"),c=!1,d&&(d.disabled=!1,d.innerHTML=p);return}}const y={id:t,assetId:m,checkDate:(()=>{const h=document.getElementById("inspection-date");return h&&this.toISODate(h.value)||f})(),inspector:b("inspection-inspector"),status:b("inspection-status"),gaugeReading:b("inspection-gauge"),sealIntact:(()=>{const h=document.getElementById("inspection-seal");if(!h)return null;const g=h.value;return g==="true"?!0:g==="false"?!1:null})(),remarks:b("inspection-remarks"),actions:b("inspection-actions"),createdAt:e?.createdAt||f,updatedAt:f};AppState.appData.fireEquipmentInspections||(AppState.appData.fireEquipmentInspections=[]);const S=AppState.appData.fireEquipmentInspections,x=S.findIndex(h=>h.id===t);x>-1?S[x]={...S[x],...y}:S.push(y);const v=this.getAssets().find(h=>h.id===m);v&&(v.lastServiceDate=y.checkDate,v.status=y.status,v.updatedAt=f),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),l&&l.parentNode&&l.remove(),this.refreshCurrentTab().catch(h=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0628\u0648\u064A\u0628:",h)}),Notification.success(s?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0641\u062D\u0635":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0641\u062D\u0635 \u0628\u0646\u062C\u0627\u062D"),(async()=>{try{if(GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled){const h=await GoogleIntegration.sendRequest({action:s?"updateFireEquipmentInspection":"addFireEquipmentInspection",data:y});if(!h.success)throw new Error(h.message||"\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0641\u062D\u0635");Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A Backend:",y.id),v&&(await GoogleIntegration.sendRequest({action:"saveOrUpdateFireEquipmentAsset",data:v}),Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u062D\u0627\u0644\u0629 \u0627\u0644\u062C\u0647\u0627\u0632:",v.id)),this.refreshCurrentTab().catch(g=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0628\u0648\u064A\u0628 \u0628\u0639\u062F \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629:",g)})}}catch(h){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0641\u062D\u0635:",h)}})(),c=!1,d&&(d.disabled=!1,d.innerHTML=p)}catch(f){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u062A\u0648\u0642\u0639 \u0641\u064A \u0627\u0644\u0646\u0645\u0648\u0630\u062C:",f),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u062A\u0648\u0642\u0639: "+(f.message||f)),c=!1,d&&(d.disabled=!1,d.innerHTML=p)}})},showMobileInspectionForm(e=null,a=null){if(!a&&!e?.assetId){Notification.warning("\u064A\u062C\u0628 \u0645\u0633\u062D QR Code \u0623\u0648\u0644\u0627\u064B \u0644\u0628\u062F\u0621 \u0627\u0644\u0641\u062D\u0635 \u0627\u0644\u0634\u0647\u0631\u064A");return}const s=!!e,t=e?.id||Utils.generateId("FEI"),i=e?.assetId||a,n=this.getAssets().find(u=>u.id===i);if(!n){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062C\u0647\u0627\u0632");return}const r=e?.checkDate?new Date(e.checkDate).toISOString().slice(0,10):new Date().toISOString().slice(0,10),l=document.createElement("div");l.className="modal-overlay fire-modal",l.innerHTML=`
            <style>
        ...
        `,document.body.appendChild(l);const o=l.querySelector("#mobile-inspection-form");if(!o){Utils.safeError("\u274C \u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0646\u0645\u0648\u0630\u062C #mobile-inspection-form");return}let c=!1;o.addEventListener("submit",async u=>{if(u.preventDefault(),u.stopPropagation(),c){Utils.safeWarn("\u26A0\uFE0F \u0627\u0644\u0646\u0645\u0648\u0630\u062C \u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629 \u0628\u0627\u0644\u0641\u0639\u0644");return}c=!0;const d=l.querySelector('button[type="submit"]'),p=d?d.innerHTML:"";try{d&&(d.disabled=!0,d.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i>\u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const f=new Date().toISOString(),b=v=>{const h=document.getElementById(v);return h?h.value.trim():""},w=document.getElementById("mobile-inspection-asset"),A=(w?w.value:"")||i;if(!A){Notification.error("\u062E\u0637\u0623: DeviceID \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F"),c=!1,d&&(d.disabled=!1,d.innerHTML=p);return}if(!s){const v=this.checkMonthlyInspectionAllowed(A);if(!v.allowed){Notification.warning(v.reason||"\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u062C\u0631\u0627\u0621 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A \u0647\u0630\u0627 \u0627\u0644\u0648\u0642\u062A"),c=!1,d&&(d.disabled=!1,d.innerHTML=p);return}}const m={id:t,assetId:A,checkDate:(()=>{const v=document.getElementById("mobile-inspection-date");return v&&this.toISODate(v.value)||f})(),inspector:b("mobile-inspection-inspector"),status:b("mobile-inspection-status"),gaugeReading:b("mobile-inspection-gauge"),sealIntact:(()=>{const v=document.getElementById("mobile-inspection-seal");if(!v)return null;const h=v.value;return h==="true"?!0:h==="false"?!1:null})(),remarks:b("mobile-inspection-remarks"),actions:b("mobile-inspection-actions"),createdAt:e?.createdAt||f,updatedAt:f};AppState.appData.fireEquipmentInspections||(AppState.appData.fireEquipmentInspections=[]);const y=AppState.appData.fireEquipmentInspections,S=y.findIndex(v=>v.id===t);S>-1?y[S]={...y[S],...m}:y.push(m);const x=this.getAssets().find(v=>v.id===A);x&&(x.lastServiceDate=m.checkDate,x.status=m.status,x.updatedAt=f),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),l&&l.parentNode&&l.remove(),this.refreshCurrentTab().catch(v=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0628\u0648\u064A\u0628:",v)}),Notification.success(s?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0641\u062D\u0635":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0641\u062D\u0635 \u0628\u0646\u062C\u0627\u062D"),(async()=>{try{if(GoogleIntegration&&AppState.googleConfig?.appsScript?.enabled){const v=await GoogleIntegration.sendRequest({action:s?"updateFireEquipmentInspection":"addFireEquipmentInspection",data:m});if(!v.success)throw new Error(v.message||"\u0641\u0634\u0644 \u062D\u0641\u0638 \u0627\u0644\u0641\u062D\u0635");Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0641\u062D\u0635 \u0641\u064A Backend:",m.id),x&&(await GoogleIntegration.sendRequest({action:"saveOrUpdateFireEquipmentAsset",data:x}),Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u062D\u0627\u0644\u0629 \u0627\u0644\u062C\u0647\u0627\u0632:",x.id)),this.refreshCurrentTab().catch(h=>{Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0628\u0648\u064A\u0628 \u0628\u0639\u062F \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629:",h)})}}catch(v){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0641\u062D\u0635:",v)}})(),c=!1,d&&(d.disabled=!1,d.innerHTML=p)}catch(f){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u062A\u0648\u0642\u0639 \u0641\u064A \u0627\u0644\u0646\u0645\u0648\u0630\u062C:",f),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u062A\u0648\u0642\u0639: "+(f.message||f)),c=!1,d&&(d.disabled=!1,d.innerHTML=p)}})},viewAsset(e){const a=this.getAssets().find(l=>l.id===e);if(!a){Notification.error("\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062C\u0647\u0627\u0632.");return}const s=this.getInspectionsByAsset(e),t=typeof QRCode<"u"?QRCode.generate(a.qrCodeData||this.generateQrData(a.id),200):null,i=JSON.stringify(a).replace(/"/g,"&quot;"),n=document.createElement("div");n.className="modal-overlay fire-modal",n.innerHTML=`
        ...
        `),i.document.close()},toISODate(e){if(!e)return"";try{const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toISOString()}catch{return""}},showManageTypesModal(){const e=document.createElement("div");e.className="modal-overlay fire-modal",e.innerHTML=`
...
\u0633\u064A\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0648\u062C\u0645\u064A\u0639 \u0627\u0644\u0641\u062D\u0648\u0635\u0627\u062A \u0627\u0644\u0645\u0631\u062A\u0628\u0637\u0629 \u0628\u0647 \u0646\u0647\u0627\u0626\u064A\u0627\u064B.`)){Loading.show();try{let t=!1;if(typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest)try{const o=await GoogleIntegration.sendRequest({action:"deleteFireEquipment",data:{assetId:e}});if(o&&o.success)t=!0,Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u0646 Backend \u0628\u0646\u062C\u0627\u062D");else{const c=o?.message||"\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u0646 Backend";Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u0646 Backend:",c)}}catch(o){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u0646 Backend:",o)}else t=!0;const i=this.getAssets(),n=i.findIndex(o=>o.id===e);n>-1&&i.splice(n,1);const r=this.getInspections();if(r.filter(o=>o.assetId===e).forEach(o=>{const c=r.findIndex(u=>u.id===o.id);c>-1&&r.splice(c,1)}),AppState.appData&&AppState.appData.fireEquipmentApprovalRequests){const o=AppState.appData.fireEquipmentApprovalRequests;o.filter(u=>u.assetId===e).forEach(u=>{const d=o.findIndex(p=>p.id===u.id);d>-1&&o.splice(d,1)})}AppState.appData||(AppState.appData={}),AppState.appData.fireEquipmentAssets=i,AppState.appData.fireEquipmentInspections=r,typeof DataManager<"u"&&DataManager.save?DataManager.save():(localStorage.setItem("fire_equipment_assets",JSON.stringify(i)),localStorage.setItem("fire_equipment_inspections",JSON.stringify(r))),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0645\u062D\u0644\u064A\u0627\u064B"),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632 \u0628\u0646\u062C\u0627\u062D"),await this.refreshCurrentTab(!0),this.state.currentTab==="database"?(this.refreshFilterOptions(),this.renderSummary()):this.state.currentTab==="register"&&this.updateRegisterStatisticsCards()}catch(t){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632:",t),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u062C\u0647\u0627\u0632")}finally{Loading.hide()}}},async renderAnalyticsTab(){return this.isAdmin()?`
            <div class="space-y-6">
        ...
        `:'<div class="empty-state"><p class="text-gray-500">\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0647\u0630\u0627 \u0627\u0644\u0642\u0633\u0645</p></div>'},getAnalyticsData(e={}){const a=this.getAssets(),s=this.getInspections();let t=s;(e.dateFrom||e.dateTo)&&(t=s.filter(p=>{const f=new Date(p.checkDate||p.createdAt);if(e.dateFrom&&f<new Date(e.dateFrom))return!1;if(e.dateTo){const b=new Date(e.dateTo);if(b.setHours(23,59,59,999),f>b)return!1}return!0}));let i=a;e.type&&e.type!=="all"&&(i=i.filter(p=>p.type===e.type)),e.location&&e.location!=="all"&&(i=i.filter(p=>p.location===e.location));const n={total:i.length,active:i.filter(p=>p.status==="\u0635\u0627\u0644\u062D").length,needsMaintenance:i.filter(p=>p.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629").length,outOfService:i.filter(p=>p.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length},r={total:t.length,completed:t.filter(p=>p.status==="\u0635\u0627\u0644\u062D").length,needsMaintenance:t.filter(p=>p.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629").length,outOfService:t.filter(p=>p.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length,completionRate:t.length>0?(t.filter(p=>p.status==="\u0635\u0627\u0644\u062D").length/t.length*100).toFixed(1):0},l={};i.forEach(p=>{const f=p.type||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";l[f]||(l[f]={total:0,active:0,needsMaintenance:0,outOfService:0}),l[f].total++,p.status==="\u0635\u0627\u0644\u062D"?l[f].active++:p.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629"?l[f].needsMaintenance++:p.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"&&l[f].outOfService++});const o={};i.forEach(p=>{const f=p.location||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";o[f]||(o[f]={total:0,active:0,needsMaintenance:0,outOfService:0}),o[f].total++,p.status==="\u0635\u0627\u0644\u062D"?o[f].active++:p.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629"?o[f].needsMaintenance++:p.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"&&o[f].outOfService++});const c={};t.forEach(p=>{const f=new Date(p.checkDate||p.createdAt),b=`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}`,w=f.toLocaleDateString("ar-SA",{year:"numeric",month:"long"});c[b]||(c[b]={label:w,total:0,completed:0,needsMaintenance:0,outOfService:0}),c[b].total++,p.status==="\u0635\u0627\u0644\u062D"?c[b].completed++:p.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629"?c[b].needsMaintenance++:p.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"&&c[b].outOfService++});const u={};t.forEach(p=>{const f=p.inspector||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";u[f]||(u[f]={total:0,completed:0,needsMaintenance:0,outOfService:0}),u[f].total++,p.status==="\u0635\u0627\u0644\u062D"?u[f].completed++:p.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629"?u[f].needsMaintenance++:p.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"&&u[f].outOfService++});const d={\u0635\u0627\u0644\u062D:t.filter(p=>p.status==="\u0635\u0627\u0644\u062D").length,"\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629":t.filter(p=>p.status==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629").length,"\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629":t.filter(p=>p.status==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629").length};return{assetStats:n,inspectionStats:r,byType:l,byLocation:o,byMonth:c,byInspector:u,byStatus:d}},renderAnalyticsData(){if(!this.isAdmin()||!document.getElementById("fire-tab-content")||this.state.currentTab!=="analytics")return;const a=document.getElementById("analytics-date-from")?.value||"",s=document.getElementById("analytics-date-to")?.value||"",t=document.getElementById("analytics-type-filter")?.value||"all",i=document.getElementById("analytics-location-filter")?.value||"all",n={dateFrom:a,dateTo:s,type:t,location:i},r=this.getAnalyticsData(n),l=document.getElementById("analytics-total-assets");l&&(l.textContent=r.assetStats.total);const o=document.getElementById("analytics-active-assets");o&&(o.textContent=r.assetStats.active);const c=document.getElementById("analytics-maintenance-assets");c&&(c.textContent=r.assetStats.needsMaintenance);const u=document.getElementById("analytics-out-service-assets");u&&(u.textContent=r.assetStats.outOfService);const d=document.getElementById("analytics-total-inspections");d&&(d.textContent=r.inspectionStats.total);const p=document.getElementById("analytics-completed-inspections");p&&(p.textContent=r.inspectionStats.completed);const f=document.getElementById("analytics-maintenance-inspections");f&&(f.textContent=r.inspectionStats.needsMaintenance);const b=document.getElementById("analytics-completion-rate");b&&(b.textContent=r.inspectionStats.completionRate+"%");const w=document.getElementById("analytics-by-type-table");if(w){const x=this.renderAnalyticsTable(r.byType,["\u0627\u0644\u0646\u0648\u0639","\u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A","\u0635\u0627\u0644\u062D","\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629","\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"]);w.innerHTML=x}const A=document.getElementById("analytics-by-location-table");if(A){const x=this.renderAnalyticsTable(r.byLocation,["\u0627\u0644\u0645\u0648\u0642\u0639","\u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A","\u0635\u0627\u0644\u062D","\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629","\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"]);A.innerHTML=x}const m=document.getElementById("analytics-timeline-table");if(m){const x=this.renderTimelineTable(r.byMonth);m.innerHTML=x}const y=document.getElementById("analytics-by-inspector-table");if(y){const x=this.renderAnalyticsTable(r.byInspector,["\u0627\u0644\u0645\u0641\u062A\u0634","\u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A","\u0645\u0643\u062A\u0645\u0644","\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629","\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"],["total","completed","needsMaintenance","outOfService"]);y.innerHTML=x}const S=document.getElementById("analytics-by-status-table");if(S){const x=this.renderStatusTable(r.byStatus);S.innerHTML=x}},renderAnalyticsTable(e,a,s=["total","active","needsMaintenance","outOfService"]){if(!e||Object.keys(e).length===0)return'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0644\u0639\u0631\u0636</p></div>';const t=Object.entries(e).sort((i,n)=>n[1].total-i[1].total).map(([i,n])=>`
                    <tr>
        ...
        `},renderStatusTable(e){if(!e||Object.keys(e).length===0)return'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0644\u0639\u0631\u0636</p></div>';const a=Object.values(e).reduce((t,i)=>t+i,0);return`
            <div class="table-wrapper" style="width: 100%; max-width: 100%; overflow-x: auto;">
                <table class="data-table table-header-red" style="width: 100%; min-width: 100%; table-layout: auto;">
                    ...
                    <tbody>
                        ${Object.entries(e).map(([t,i])=>{const n=a>0?(i/a*100).toFixed(1):0;let r="badge-info";return t==="\u0635\u0627\u0644\u062D"?r="badge-success":t==="\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629"?r="badge-warning":t==="\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629"&&(r="badge-danger"),`
                    <tr>
                        <td><span class="badge ${r}">${Utils.escapeHTML(t)}</span></td>
        ...
        `},setupAnalyticsEventListeners(){const e=this.getAssets(),a=document.getElementById("analytics-type-filter"),s=document.getElementById("analytics-location-filter");if(a){const r=Array.from(new Set(e.map(l=>l.type).filter(Boolean)));a.innerHTML='<option value="all">\u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0646\u0648\u0627\u0639</option>'+r.map(l=>`<option value="${Utils.escapeHTML(l)}">${Utils.escapeHTML(l)}</option>`).join("")}if(s){const r=Array.from(new Set(e.map(l=>l.location).filter(Boolean)));s.innerHTML='<option value="all">\u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0648\u0627\u0642\u0639</option>'+r.map(l=>`<option value="${Utils.escapeHTML(l)}">${Utils.escapeHTML(l)}</option>`).join("")}const t=document.getElementById("analytics-apply-filters");if(t){const r=t.cloneNode(!0);t.parentNode.replaceChild(r,t),r.addEventListener("click",()=>{this.renderAnalyticsData()})}const i=document.getElementById("analytics-reset-filters");if(i){const r=i.cloneNode(!0);i.parentNode.replaceChild(r,i),r.addEventListener("click",()=>{document.getElementById("analytics-date-from").value="",document.getElementById("analytics-date-to").value="",document.getElementById("analytics-type-filter").value="all",document.getElementById("analytics-location-filter").value="all",this.renderAnalyticsData()})}const n=document.getElementById("analytics-export-data");if(n){const r=n.cloneNode(!0);n.parentNode.replaceChild(r,n),r.addEventListener("click",()=>{this.exportAnalyticsData()})}this.renderAnalyticsData()},exportAnalyticsData(){try{const e=document.getElementById("analytics-date-from")?.value||"",a=document.getElementById("analytics-date-to")?.value||"",s=document.getElementById("analytics-type-filter")?.value||"all",t=document.getElementById("analytics-location-filter")?.value||"all",i={dateFrom:e,dateTo:a,type:s,location:t},n=this.getAnalyticsData(i),r=this.getAssets(),l=this.getInspections();let o=`\u062A\u062D\u0644\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0639\u062F\u0627\u062A \u0627\u0644\u062D\u0631\u064A\u0642
...
`,Object.entries(n.byType).sort((p,f)=>f[1].total-p[1].total).forEach(([p,f])=>{o+=`${p},${f.total},${f.active},${f.needsMaintenance},${f.outOfService}
`}),o+=`
`,o+=`\u062A\u062D\u0644\u064A\u0644 \u062D\u0633\u0628 \u0627\u0644\u0645\u0648\u0642\u0639
`,o+=`\u0627\u0644\u0645\u0648\u0642\u0639,\u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A,\u0635\u0627\u0644\u062D,\u064A\u062D\u062A\u0627\u062C \u0635\u064A\u0627\u0646\u0629,\u062E\u0627\u0631\u062C \u0627\u0644\u062E\u062F\u0645\u0629
`,Object.entries(n.byLocation).sort((p,f)=>f[1].total-p[1].total).forEach(([p,f])=>{o+=`${p},${f.total},${f.active},${f.needsMaintenance},${f.outOfService}
`});const c=new Blob(["\uFEFF"+o],{type:"text/csv;charset=utf-8;"}),u=document.createElement("a"),d=URL.createObjectURL(c);u.setAttribute("href",d),u.setAttribute("download",`\u062A\u062D\u0644\u064A\u0644_\u0645\u0639\u062F\u0627\u062A_\u0627\u0644\u062D\u0631\u064A\u0642_${new Date().toISOString().slice(0,10)}.csv`),u.style.visibility="hidden",document.body.appendChild(u),u.click(),document.body.removeChild(u),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}catch(e){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A: "+e.message)}},async renderApprovalRequestsTab(){if(!this.isAdmin())return'<div class="empty-state"><p class="text-gray-500">\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0647\u0630\u0627 \u0627\u0644\u0642\u0633\u0645. \u064A\u062C\u0628 \u0623\u0646 \u062A\u0643\u0648\u0646 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645.</p></div>';this.ensureData();try{const t=await this.loadApprovalRequestsFromBackend();t&&t.length>0&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${t.length} \u0637\u0644\u0628 \u0645\u0648\u0627\u0641\u0642\u0629 \u0645\u0646 Backend`)}catch(t){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0637\u0644\u0628\u0627\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629:",t)}const e=this.getApprovalRequests();if(!e||!Array.isArray(e))return Utils.safeWarn("\u26A0\uFE0F \u0644\u0627 \u062A\u0648\u062C\u062F \u0637\u0644\u0628\u0627\u062A \u0645\u0648\u0627\u0641\u0642\u0629 \u0645\u062A\u0627\u062D\u0629"),'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0637\u0644\u0628\u0627\u062A \u0645\u0648\u0627\u0641\u0642\u0629 \u062D\u0627\u0644\u064A\u0627\u064B</p></div>';const s=[...e].sort((t,i)=>{const n={pending:1,approved:2,rejected:3},r=n[t.status]||99,l=n[i.status]||99;if(r!==l)return r-l;const o=new Date(t.requestedAt||0);return new Date(i.requestedAt||0)-o}).map(t=>{const i=t.status==="approved"?'<span class="badge badge-success"><i class="fas fa-check-circle ml-1"></i>\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647</span>':t.status==="rejected"?'<span class="badge badge-danger"><i class="fas fa-times-circle ml-1"></i>\u0645\u0631\u0641\u0648\u0636</span>':'<span class="badge badge-warning"><i class="fas fa-clock ml-1"></i>\u0642\u064A\u062F \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631</span>',n=t.type==="inspection"?'<i class="fas fa-clipboard-check ml-1"></i>\u0641\u062D\u0635 \u0634\u0647\u0631\u064A':t.type==="add"?'<i class="fas fa-plus-circle ml-1"></i>\u0625\u0636\u0627\u0641\u0629 \u062C\u0647\u0627\u0632':t.type==="edit"?'<i class="fas fa-edit ml-1"></i>\u062A\u0639\u062F\u064A\u0644 \u062C\u0647\u0627\u0632':t.type==="delete"?'<i class="fas fa-trash ml-1"></i>\u062D\u0630\u0641 \u062C\u0647\u0627\u0632':'<i class="fas fa-question-circle ml-1"></i>\u0637\u0644\u0628 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F',r=this.getAssets().find(o=>o.id===t.assetId||o.number===t.assetNumber),l=r?`${r.number||r.id} - ${r.location||""}`:t.assetNumber||t.assetId||"-";return`
