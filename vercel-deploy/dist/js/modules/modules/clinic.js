...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&c()})},editSickLeave(e){const t=this.getSickLeaves().find(a=>a.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629");return}this.showSickLeaveForm(t)},printSickLeaveRecord(e){const t=this.getSickLeaves().find(c=>c.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const a=t.employeeName||t.personName||"",s=t.employeeDepartment||"\u2014",n=t.treatingDoctor||"\u2014",i=t.daysCount??this.calculateSickLeaveDays(t.startDate,t.endDate),o=`
        ...
        <div id="clinic-analytics-root" style="font-family:inherit;">
            ...
            <div class="content-card" style="padding:0;overflow:hidden;">
        ...
        </div>`,this.applyModuleI18n(e),setTimeout(()=>{this.updateClinicAnalyticsDashboard(),this._clinicBindAnalyticsEvents()},80))},bindDataAnalysisTabEvents(e){},async updateClinicAnalyticsDashboard(){const e=document.getElementById("clinic-analytics-root");if(!e)return;try{this.ensureData()}catch{}const t=parseInt(this._clinicPeriod||"0",10),a=AppState.appData?.clinicVisits||[],s=AppState.appData?.clinicMedications||[],n=AppState.appData?.sickLeave||[],i=AppState.appData?.injuries||[],o=AppState.appData?.clinicSupplyRequests||[],l=t>0?(()=>{const A=new Date;return A.setDate(A.getDate()-t),A})():null,r=(A,H)=>l?A.filter(W=>{const Q=new Date(W[H]||W.createdAt||"");return!isNaN(Q.getTime())&&Q>=l}):A,c=r(a,"visitDate"),d=r(n,"startDate"),m=r(i,"injuryDate");this._clinicPopulateFilters(c);const p=this._clinicApplyFilters(c),u=p.length,f=document.getElementById("clinic-filter-count");f&&(f.textContent=`${u} \u0632\u064A\u0627\u0631\u0629`);const y=p.filter(A=>String(A.personType||"").toLowerCase()!=="contractor"),g=p.filter(A=>String(A.personType||"").toLowerCase()==="contractor"),b=new Date,v=p.filter(A=>{const H=new Date(A.visitDate||A.createdAt||"");return H.getFullYear()===b.getFullYear()&&H.getMonth()===b.getMonth()}).length,w=s.filter(A=>A.status==="\u0645\u0646\u062A\u0647\u064A").length,$=s.filter(A=>A.status==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621").length,L=d.filter(A=>!A.status||A.status==="\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629").length,h=new Set(p.map(A=>{const H=new Date(A.visitDate||A.createdAt||"");return isNaN(H.getTime())?null:`${H.getFullYear()}-${H.getMonth()}`}).filter(Boolean)).size,S=h>0?(u/h).toFixed(1):0,D=this.analyzeDispensedMedications_(p,s),M=document.getElementById("clinic-kpi-strip");if(M){const A=(W,Q)=>Q>0?Math.round(W/Q*100):0,H=[{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0632\u064A\u0627\u0631\u0627\u062A",value:u,icon:"fas fa-hospital-user",color:"#1d4ed8",grad:"linear-gradient(135deg,#3b82f6,#1d4ed8)",sub:"\u0643\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A",pct:100},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646",value:y.length,icon:"fas fa-user-tie",color:"#1e40af",grad:"linear-gradient(135deg,#2563eb,#1e40af)",sub:`${A(y.length,u)}% \u0645\u0646 \u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A`,pct:A(y.length,u)},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646",value:g.length,icon:"fas fa-hard-hat",color:"#ea580c",grad:"linear-gradient(135deg,#f59e0b,#ea580c)",sub:`${A(g.length,u)}% \u0645\u0646 \u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A`,pct:A(g.length,u)},{label:"\u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0631\u0636\u064A\u0629",value:d.length,icon:"fas fa-notes-medical",color:"#d97706",grad:"linear-gradient(135deg,#fbbf24,#d97706)",sub:"\u0637\u0644\u0628\u0627\u062A \u0645\u0633\u062C\u0644\u0629",pct:0},{label:"\u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A",value:m.length,icon:"fas fa-user-injured",color:"#dc2626",grad:"linear-gradient(135deg,#ef4444,#b91c1c)",sub:"\u0633\u062C\u0644 \u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A",pct:0},{label:"\u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u062A\u0647\u064A\u0629",value:w,icon:"fas fa-pills",color:"#dc2626",grad:"linear-gradient(135deg,#f87171,#b91c1c)",sub:"\u0641\u064A \u0627\u0644\u0645\u062E\u0632\u0648\u0646",pct:0},{label:"\u0642\u0631\u064A\u0628\u0629 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621",value:$,icon:"fas fa-exclamation",color:"#b45309",grad:"linear-gradient(135deg,#f59e0b,#b45309)",sub:"\u062E\u0644\u0627\u0644 90 \u064A\u0648\u0645",pct:0},{label:"\u0625\u062C\u0627\u0632\u0627\u062A \u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629",value:L,icon:"fas fa-clock",color:"#4f46e5",grad:"linear-gradient(135deg,#6366f1,#4338ca)",sub:"\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629",pct:0},{label:"\u0645\u062A\u0648\u0633\u0637 \u0634\u0647\u0631\u064A",value:S,icon:"fas fa-calendar-check",color:"#4338ca",grad:"linear-gradient(135deg,#818cf8,#4338ca)",sub:h>0?`${h} \u0634\u0647\u0631`:"\u2014",pct:0}];M.innerHTML=H.map(W=>`
                ...
                </div>`).join("")}const k=document.getElementById("clinic-med-analysis-summary");k&&(k.textContent=D.totalDispensedQty>0?`${D.uniqueMedicines} \u062F\u0648\u0627\u0621 \u0645\u062E\u062A\u0644\u0641 \u2022 ${D.dispenseLines} \u0639\u0645\u0644\u064A\u0629 \u0635\u0631\u0641 \u2022 ${D.visitsWithMedications} \u0632\u064A\u0627\u0631\u0629 \u0628\u062F\u0648\u0627\u0621`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629 \u0636\u0645\u0646 \u0627\u0644\u0641\u0644\u0627\u062A\u0631 \u0627\u0644\u062D\u0627\u0644\u064A\u0629");const U=document.getElementById("clinic-med-kpi-strip");if(U){const A=Number(D.totalDispensedQty)||0,H=Q=>A>0?Math.round(Q/A*100):0,W=[{label:"\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629",value:D.totalDispensedQty,icon:"fas fa-prescription-bottle-alt",color:"#15803d",grad:"linear-gradient(135deg,#22c55e,#15803d)",sub:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0645\u0646\u0635\u0631\u0641",pct:100},{label:"\u0623\u062F\u0648\u064A\u0629 \u0645\u062E\u062A\u0644\u0641\u0629",value:D.uniqueMedicines,icon:"fas fa-pills",color:"#1e40af",grad:"linear-gradient(135deg,#3b82f6,#1e40af)",sub:`${H(D.uniqueMedicines)}% \u0645\u0646 \u0627\u0644\u0645\u0646\u0635\u0631\u0641`,pct:H(D.uniqueMedicines)},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0628\u0635\u0631\u0641 \u062F\u0648\u0627\u0621",value:D.visitsWithMedications,icon:"fas fa-capsules",color:"#2563eb",grad:"linear-gradient(135deg,#2563eb,#1d4ed8)",sub:"\u0636\u0645\u0646 \u0627\u0644\u0641\u0644\u0627\u062A\u0631",pct:0},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0628\u062F\u0648\u0646 \u062F\u0648\u0627\u0621",value:D.visitsWithoutMedications,icon:"fas fa-hospital",color:"#64748b",grad:"linear-gradient(135deg,#94a3b8,#64748b)",sub:"\u0636\u0645\u0646 \u0627\u0644\u0641\u0644\u0627\u062A\u0631",pct:0},{label:"\u0639\u0645\u0644\u064A\u0627\u062A \u0635\u0631\u0641",value:D.dispenseLines,icon:"fas fa-hand-holding-medical",color:"#0284c7",grad:"linear-gradient(135deg,#0ea5e9,#0369a1)",sub:`${H(D.dispenseLines)}% \u0645\u0646 \u0627\u0644\u0645\u0646\u0635\u0631\u0641`,pct:H(D.dispenseLines)}];U.innerHTML=W.map(Q=>`
                <div class="clinic-stat clinic-stat--med">
                    ...
                    </tr>`}).join(""));const ee=document.getElementById("clinic-med-low-stock-alert"),se=document.getElementById("clinic-med-low-stock-list");ee&&se&&(D.lowStockHighDemand.length>0?(ee.style.display="block",se.innerHTML=D.lowStockHighDemand.map(A=>`<li><strong>${Utils.escapeHTML(A.name)}</strong>: \u0645\u0646\u0635\u0631\u0641 ${A.totalQty} \u2014 \u0645\u062E\u0632\u0648\u0646 ${A.stockRemaining??"\u2014"}</li>`).join("")):(ee.style.display="none",se.innerHTML=""));const Y={};p.forEach(A=>{const H=A.contractorWorkerName||A.employeeName||A.externalName||A.personName||A.name||"",W=String(H).trim(),Q=String(A.contractorName||"").trim(),G=W||(Q?Q+" (\u0628\u062F\u0648\u0646 \u0627\u0633\u0645 \u0639\u0627\u0645\u0644)":"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F");Y[G]||(Y[G]={count:0,dept:"",loc:""}),Y[G].count++,Y[G].dept||(Y[G].dept=A.employeeDepartment||A.department||A.contractorName||A.contractorPosition||"\u2014"),Y[G].loc||(Y[G].loc=A.employeeLocation||A.workArea||A.factoryName||A.factory||"\u2014")});const ae=Object.entries(Y).sort((A,H)=>H[1].count-A[1].count).slice(0,15),oe=document.getElementById("clinic-top-visitors-count"),re=document.getElementById("clinic-top-visitors-tbody");oe&&(oe.textContent=`${ae.length} \u0634\u062E\u0635`),re&&(re.innerHTML=ae.length===0?'<tr><td colspan="5" style="padding:24px;text-align:center;color:#94a3b8;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0632\u064A\u0627\u0631\u0627\u062A</td></tr>':ae.map(([A,H],W)=>{const Q=W%2===0?"#fff":"#fafafa",G=H.count>=5?"#dc2626":H.count>=3?"#f59e0b":"#2563eb";return`<tr style="border-bottom:1px solid #f8fafc;background:${Q};" onmouseover="this.style.background='#eff6ff'" onmouseout="this.style.background='${Q}'">
