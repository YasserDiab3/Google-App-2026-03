...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629\u061F`))return;Loading.show();try{const n={medicationId:e,medicationData:t,requestedBy:{id:AppState.currentUser?.id||"",name:AppState.currentUser?.name||"",email:AppState.currentUser?.email||"",role:AppState.currentUser?.role||""},requestedById:AppState.currentUser?.id||"",reason:"\u0637\u0644\u0628 \u062D\u0630\u0641 \u062F\u0648\u0627\u0621"},s=await GoogleIntegration.sendRequest({action:"addMedicationDeletionRequest",data:n});if(s&&s.success)Loading.hide(),Notification.success("\u062A\u0645 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641 \u0625\u0644\u0649 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645 \u0644\u0644\u0645\u0648\u0627\u0641\u0642\u0629"),this.notifyAdminAboutDeletionRequest(t),this.state.activeTab==="approvals"&&setTimeout(()=>{this.renderApprovalsTab()},500),this.renderMedicationsTab();else throw new Error(s.message||"\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0627\u0644\u0637\u0644\u0628")}catch(n){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641:",n),Notification.error("\u062A\u0639\u0630\u0631 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641: "+(n.message||"\u062D\u062F\u062B \u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641"))}}},isCurrentUserAdmin(){if(typeof Permissions<"u"&&typeof Permissions.isCurrentUserAdmin=="function")return Permissions.isCurrentUserAdmin();const e=(AppState.currentUser?.role||"").toLowerCase();return e==="admin"||e==="system_admin"||AppState.currentUser?.role==="\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"||e==="\u0645\u062F\u064A\u0631"},_isUsersSheetAdminRecord(e){if(!e)return!1;if(typeof Permissions<"u"){if(typeof Permissions.isAdminRole=="function"&&Permissions.isAdminRole(e.role))return!0;const a=typeof Permissions.normalizePermissions=="function"?Permissions.normalizePermissions(e.permissions):e.permissions;if(a&&typeof a=="object"&&!Array.isArray(a)&&(Permissions.isAdminRole&&Permissions.isAdminRole(a.role)||a.admin===!0||a.isAdmin===!0||a["manage-modules"]===!0))return!0}const t=String(e.role||"").trim().toLowerCase();return t==="admin"||t==="system_admin"||e.role==="\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645"||e.role==="\u0645\u062F\u064A\u0631"},_invalidateApprovalsCache(){this._approvalsBackendFetchOk=!1;try{localStorage.removeItem("clinic_approvals_last_sync")}catch{}},_isApprovalTimeOffRequest(e){if(!e)return!1;if(e.approvalKind==="timeoff")return!0;const t=String(e.requestType||"").trim().toLowerCase();return t==="leave"||t==="permission"||t==="overtime"},_approvalRequestMatchesTypeFilter(e,t){return!e||!t||t==="all"?!0:t==="timeoff"?this._isApprovalTimeOffRequest(e):(e.approvalKind||e.requestType)===t},prefetchClinicAttendanceForAdminIfNeeded(e){return!this.isCurrentUserAdmin()||typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest?Promise.resolve():this._adminAttendancePrefetchPromise&&!e?this._adminAttendancePrefetchPromise:(this._adminAttendancePrefetchPromise=(async()=>{try{await this._ensureClinicStaffLoadedForAttendance(),await this.loadClinicAttendanceData(!!e)&&(this._attendanceDataFetchedInSession=!0),this._leaveBalancesFetchedInSession=!1,await this.loadClinicStaffLeaveBalances(!!e),this._leaveBalancesFetchedInSession=!0,this._updatePendingApprovalsBadgeFromLocal_(),typeof UI<"u"&&typeof UI.updateNotificationsBadge=="function"&&UI.updateNotificationsBadge(),this.state?.activeTab==="attendance"&&this.renderAttendanceTab({force:!0})}catch{}})().finally(()=>{this._adminAttendancePrefetchPromise=null}),this._adminAttendancePrefetchPromise)},prefetchClinicTimeOffApprovalsForAdminIfNeeded(){return this.prefetchClinicAttendanceForAdminIfNeeded(!1)},_updatePendingApprovalsBadgeFromLocal_(){const e=document.getElementById("pending-approvals-badge");if(!e)return;const t=Array.isArray(AppState.appData?.clinicMedicationDeletionRequests)?AppState.appData.clinicMedicationDeletionRequests:[],a=Array.isArray(AppState.appData?.clinicSupplyRequests)?AppState.appData.clinicSupplyRequests:[],i=Array.isArray(AppState.appData?.clinicVisitDeletionRequests)?AppState.appData.clinicVisitDeletionRequests:[],n=Array.isArray(AppState.appData?.clinicStaffTimeOffRequests)?AppState.appData.clinicStaffTimeOffRequests:[],s=[...t,...a,...i,...n].filter(o=>o&&String(o.status)==="pending").length;s>0?(e.textContent=String(s),e.style.display="inline-block"):e.style.display="none"},getClinicStaffLeaveBalancesList(){return Array.isArray(AppState.appData?.clinicStaffLeaveBalances)?AppState.appData.clinicStaffLeaveBalances:[]},_getLeaveBalancePeriodDefaults(){const e=this._getTodayLocalKey();return this.state=this.state||{},this.state.leaveBalanceMonth||(this.state.leaveBalanceMonth=e.substring(0,7)),this.state.leaveBalanceYear||(this.state.leaveBalanceYear=e.substring(0,4)),{month:this.state.leaveBalanceMonth,year:this.state.leaveBalanceYear}},_scheduleLeaveBalancesLoadIfNeeded(e){this.canAccessAttendanceTab()&&(this._leaveBalancesLoadPromise&&!e||!e&&this._leaveBalancesFetchedInSession||(this._leaveBalancesLoadPromise=this.loadClinicStaffLeaveBalances(!!e).then(()=>{this._leaveBalancesFetchedInSession=!0,this.state?.activeTab==="attendance"&&this.renderAttendanceTab({force:!0})}).catch(()=>{}).finally(()=>{this._leaveBalancesLoadPromise=null})))},_isLeaveBalancesLoading(){return!!this._leaveBalancesLoadPromise},async loadClinicStaffLeaveBalances(e){if(typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return!1;const t=this._getLeaveBalancePeriodDefaults(),a=this.canViewAllAttendanceData();try{a&&await this._ensureClinicStaffLoadedForAttendance();const[i,n]=await Promise.all([GoogleIntegration.sendRequest({action:"getClinicStaffLeaveBalances",data:{month:t.month,year:t.year,skipCache:!!e}}),GoogleIntegration.sendRequest({action:"getClinicStaffTimeOffRequests",data:e?{skipCache:!0}:{}})]);if(n?.success&&Array.isArray(n.data)&&(AppState.appData.clinicStaffTimeOffRequests=n.data),i?.success&&Array.isArray(i.data)?(AppState.appData.clinicStaffLeaveBalances=this._enrichLeaveBalancesFromLocal_(i.data,t),i.meta&&(this.state.leaveBalanceMonth=i.meta.month||t.month,this.state.leaveBalanceYear=i.meta.year||t.year)):a&&(AppState.appData.clinicStaffLeaveBalances=this._buildLeaveBalancesFromStaffAndRequests_(t)),AppState.appData.clinicStaffLeaveBalances&&typeof window.DataManager<"u"&&window.DataManager.save)try{window.DataManager.save()}catch{}return!!(i?.success||a&&(AppState.appData.clinicStaffLeaveBalances||[]).length)}catch{return a?(AppState.appData.clinicStaffLeaveBalances=this._buildLeaveBalancesFromStaffAndRequests_(t),(AppState.appData.clinicStaffLeaveBalances||[]).length>0):!1}},_buildLeaveBalancePeriodFromItems_(e,t,a,i,n){const s=a.filter(c=>String(c.requestType).toLowerCase()==="leave").reduce((c,d)=>c+this._countLeaveDaysInPeriod_(d,e,t),0),o=a.filter(c=>String(c.requestType).toLowerCase()==="permission").length,l=i??0,r=n??0;return{periodType:e,periodKey:t,leaveEntitled:l,leaveConsumed:Math.round(s*100)/100,leaveRemaining:Math.max(0,Math.round((l-s)*100)/100),permissionEntitled:r,permissionConsumed:o,permissionRemaining:Math.max(0,r-o),approvedItems:a}},_buildLeaveBalancesFromStaffAndRequests_(e){const t=e?.month||"",a=e?.year||"",i=this.getClinicStaffLeaveBalancesList(),n=new Map(i.map(s=>[String(s.staffId),s]));return(this.getClinicStaffList()||[]).map(s=>{const o={id:s.id,staffId:s.id,userId:s.userId,userEmail:s.userEmail},l=n.get(String(s.id))||{},r=this._collectLocalApprovedTimeOffItems(o,"month",t),c=this._collectLocalApprovedTimeOffItems(o,"year",a);return{staffId:s.id,userId:s.userId||"",userName:s.userName||"",userEmail:s.userEmail||"",staffRole:s.staffRole||"",isActive:s.isActive,month:this._buildLeaveBalancePeriodFromItems_("month",t,r,l.month?.leaveEntitled,l.month?.permissionEntitled),year:this._buildLeaveBalancePeriodFromItems_("year",a,c,l.year?.leaveEntitled,l.year?.permissionEntitled)}})},_collectAllApprovedTimeOffForMonth_(e,t){const a=[],i=new Set,n=(s,o,l)=>{const r=String(s?.id||`${o}_${s?.dateFrom}_${s?.requestType}`).trim();r&&i.has(r)||(r&&i.add(r),a.push({...s,userName:o||s.userName||"\u2014",staffRole:l||s.staffRole}))};if((t||[]).forEach(s=>{(s.month?.approvedItems||[]).forEach(o=>{n(o,s.userName,s.staffRole)})}),this.canViewAllAttendanceData()){const s=new Map((this.getClinicStaffList()||[]).map(o=>[String(o.id),o]));this.getClinicStaffTimeOffRequestsList().forEach(o=>{if(!this._isTimeOffApprovedStatus(o.status)||!this._requestOverlapsPeriod(o,"month",e))return;const l=s.get(String(o.staffId))||{};n(o,o.userName||l.userName,l.staffRole)})}return a.sort((s,o)=>new Date(o.reviewedAt||o.requestedAt||o.createdAt)-new Date(s.reviewedAt||s.requestedAt||s.createdAt))},_isTimeOffApprovedStatus(e){const t=String(e||"").trim().toLowerCase();return t==="approved"||t==="\u0645\u0639\u062A\u0645\u062F"||t==="\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647"||t==="\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647\u0627"},_timeOffRequestMatchesStaffRow(e,t){if(!e||!t)return!1;if(t.staffId&&e.staffId&&String(t.staffId)===String(e.staffId)||t.id&&e.staffId&&String(t.id)===String(e.staffId))return!0;const a=String(t.userId||"").trim(),i=String(t.userEmail||"").trim().toLowerCase();return!!(a&&String(e.userId||"").trim()===a||i&&String(e.userEmail||"").trim().toLowerCase()===i)},_dateKeyInPeriod(e,t,a){const i=this._attendanceDayKey(e);return!i||!a?!1:t==="year"?i.substring(0,4)===String(a):i.substring(0,7)===String(a)},_requestOverlapsPeriod(e,t,a){if(!e||!a)return!1;const i=this._attendanceDayKey(e.dateFrom),n=this._attendanceDayKey(e.dateTo||e.dateFrom),s=i||this._attendanceDayKey(e.requestedAt||e.createdAt);if(!s)return!1;if(this._dateKeyInPeriod(s,t,a)||n&&this._dateKeyInPeriod(n,t,a))return!0;try{let o=new Date(s);const l=new Date(n||s);if(Number.isNaN(o.getTime()))return!1;let r=0;for(;o<=l&&r<400;){if(this._dateKeyInPeriod(o,t,a))return!0;o.setDate(o.getDate()+1),r++}}catch{}return!1},_countLeaveDaysInPeriod_(e,t,a){const i=this._attendanceDayKey(e.dateFrom),n=this._attendanceDayKey(e.dateTo||e.dateFrom);if(!i){const s=parseFloat(e.durationDays);return!isNaN(s)&&s>0?s:0}try{let s=new Date(i);const o=new Date(n||i);if(Number.isNaN(s.getTime()))return parseFloat(e.durationDays)||0;let l=0,r=0;for(;s<=o&&r<400;)this._dateKeyInPeriod(s,t,a)&&(l+=1),s.setDate(s.getDate()+1),r++;return l||parseFloat(e.durationDays)||0}catch{return parseFloat(e.durationDays)||0}},_collectLocalApprovedTimeOffItems(e,t,a){return(Array.isArray(AppState.appData?.clinicStaffTimeOffRequests)?AppState.appData.clinicStaffTimeOffRequests:[]).filter(n=>!this._isTimeOffApprovedStatus(n.status)||!this._timeOffRequestMatchesStaffRow(n,e)?!1:this._requestOverlapsPeriod(n,t,a))},_enrichLeaveBalancesFromLocal_(e,t){const a=t?.month||"",i=t?.year||"";return(e||[]).map(n=>{const s={id:n.staffId,staffId:n.staffId,userId:n.userId,userEmail:n.userEmail},o=[...Array.isArray(n.month?.approvedItems)?n.month.approvedItems:[],...this._collectLocalApprovedTimeOffItems(s,"month",a)],l=[...Array.isArray(n.year?.approvedItems)?n.year.approvedItems:[],...this._collectLocalApprovedTimeOffItems(s,"year",i)],r=v=>{const b=new Map;return v.forEach(x=>{x?.id&&b.set(String(x.id),x)}),Array.from(b.values())},c=r(o),d=r(l),f=c.filter(v=>String(v.requestType).toLowerCase()==="leave").reduce((v,b)=>v+this._countLeaveDaysInPeriod_(b,"month",a),0),p=c.filter(v=>String(v.requestType).toLowerCase()==="permission").length,u=d.filter(v=>String(v.requestType).toLowerCase()==="leave").reduce((v,b)=>v+this._countLeaveDaysInPeriod_(b,"year",i),0),m=d.filter(v=>String(v.requestType).toLowerCase()==="permission").length,g={...n.month||{}},y={...n.year||{}};return c.length&&(g.leaveConsumed=Math.max(g.leaveConsumed||0,Math.round(f*100)/100),g.permissionConsumed=Math.max(g.permissionConsumed||0,p),g.leaveRemaining=Math.max(0,Math.round(((g.leaveEntitled||0)-g.leaveConsumed)*100)/100),g.permissionRemaining=Math.max(0,(g.permissionEntitled||0)-g.permissionConsumed),g.approvedItems=c),d.length&&(y.leaveConsumed=Math.max(y.leaveConsumed||0,Math.round(u*100)/100),y.permissionConsumed=Math.max(y.permissionConsumed||0,m),y.leaveRemaining=Math.max(0,Math.round(((y.leaveEntitled||0)-y.leaveConsumed)*100)/100),y.permissionRemaining=Math.max(0,(y.permissionEntitled||0)-y.permissionConsumed),y.approvedItems=d),{...n,month:g,year:y}})},renderApprovedTimeOffRequestsSection(e,t){const a=this._collectAllApprovedTimeOffForMonth_(t,e),i=a.length?a.map(n=>`
        ...
        `,document.body.appendChild(t),n(),t.querySelector("#clinic-injury-body-parts-add-row").addEventListener("click",()=>{i.push({id:"ib-"+Date.now()+"-"+i.length,text:""}),n()}),t.querySelector("#clinic-injury-body-parts-reset").addEventListener("click",()=>{i=a(this.DEFAULT_INJURY_BODY_PARTS||[]),n()}),t.querySelector("#clinic-injury-body-parts-save").addEventListener("click",()=>{t.querySelectorAll("#clinic-injury-body-parts-list input").forEach(o=>{const l=o.getAttribute("data-id"),r=i.find(c=>c.id===l);r&&(r.text=o.value.trim())});const s=i.map(o=>o.text).filter(Boolean);if(s.length===0){Notification?.warning?.("\u0623\u0636\u0641 \u0628\u0646\u062F\u0627\u064B \u0648\u0627\u062D\u062F\u0627\u064B \u0639\u0644\u0649 \u0627\u0644\u0623\u0642\u0644 \u0623\u0648 \u0627\u0633\u062A\u0639\u062F \u0627\u0644\u0627\u0641\u062A\u0631\u0627\u0636\u064A");return}AppState.appData||(AppState.appData={}),AppState.appData.clinicInjuryBodyParts=s,typeof DataManager<"u"&&DataManager.save&&DataManager.save(),Notification?.success?.("\u062A\u0645 \u062D\u0641\u0638 \u0642\u0627\u0626\u0645\u0629 \u0623\u0645\u0627\u0643\u0646 \u0627\u0644\u0625\u0635\u0627\u0628\u0629 \u0628\u0627\u0644\u062C\u0633\u0645"),this.state.activeTab==="injuries"&&this.renderInjuriesTab(),t.remove()}),t.querySelectorAll(".modal-close, .modal-close-btn").forEach(s=>{s.addEventListener("click",()=>t.remove())})},async notifyAdminsAboutHighClinicVisits(e,t){try{const a=await GoogleIntegration.sendRequest({action:"readFromSheet",data:{sheetName:"Users"}});if(!a||!a.success||!Array.isArray(a.data))return;const i=a.data.filter(r=>{const c=(r.role||"").toLowerCase();return c==="admin"||c==="\u0645\u062F\u064A\u0631"}),n=this.getMonthlyVisitsAlertThreshold(),s=(e.personType||"").toString().toLowerCase()==="employee"?e.employeeName||e.employeeCode||"\u0645\u0648\u0638\u0641":e.contractorWorkerName||e.contractorName||e.externalName||"\u0645\u0642\u0627\u0648\u0644/\u0639\u0627\u0645\u0644",o="\u062A\u0646\u0628\u064A\u0647: \u062A\u0631\u062F\u062F \u0639\u0627\u0644\u064D \u0639\u0644\u0649 \u0627\u0644\u0639\u064A\u0627\u062F\u0629",l=`\u0627\u0644\u0645\u0648\u0638\u0641/\u0627\u0644\u0645\u0642\u0627\u0648\u0644 "${s}" \u0628\u0644\u063A \u0639\u062F\u062F \u0632\u064A\u0627\u0631\u0627\u062A\u0647 \u0644\u0644\u0639\u064A\u0627\u062F\u0629 \u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631 ${t} \u0632\u064A\u0627\u0631\u0629 (\u0627\u0644\u062D\u062F ${n}).`;for(const r of i)if(r.id||r.email)try{await GoogleIntegration.sendRequest({action:"addNotification",data:{userId:r.id||r.email,title:o,message:l,type:"clinic_high_visits",priority:"high",link:"#clinic",data:{module:"clinic",action:"high_monthly_visits",personType:e.personType,monthlyCount:t,personLabel:s}}})}catch(c){Utils.safeWarn("\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0625\u0634\u0639\u0627\u0631 \u062A\u0631\u062F\u062F \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0644\u0644\u0645\u062F\u064A\u0631:",c)}}catch(a){Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0625\u0634\u0639\u0627\u0631\u0627\u062A \u062A\u0631\u062F\u062F \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0644\u0644\u0645\u062F\u064A\u0631\u064A\u0646:",a)}},exportMedicationsToExcel(){const e=this.getFilteredMedications();if(e.length===0){Notification?.info?.("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u062A\u0635\u062F\u064A\u0631\u0647\u0627");return}if(typeof XLSX>"u"){Notification?.error?.("\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629");return}const t=e.map(s=>{const o=s.quantityAdded??s.quantity??0,l=s.remainingQuantity??s.quantity??0,r=Math.max(0,o-l);return{"\u0627\u0633\u0645 \u0627\u0644\u062F\u0648\u0627\u0621":s.name||"","\u0646\u0648\u0639 \u0627\u0644\u062F\u0648\u0627\u0621":s.type||"",\u0627\u0644\u0627\u0633\u062A\u062E\u062F\u0627\u0645:s.usage||s.notes||"","\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0634\u0631\u0627\u0621":s.purchaseDate?this.formatDate(s.purchaseDate):"","\u062A\u0627\u0631\u064A\u062E \u0627\u0646\u062A\u0647\u0627\u0621 \u0627\u0644\u0635\u0644\u0627\u062D\u064A\u0629":s.expiryDate?this.formatDate(s.expiryDate):"",\u0627\u0644\u062D\u0627\u0644\u0629:s.status||"\u0633\u0627\u0631\u064A","\u0639\u062F\u062F \u0627\u0644\u0623\u064A\u0627\u0645 \u0627\u0644\u0645\u062A\u0628\u0642\u064A\u0629":s.daysRemaining??"",\u0627\u0644\u0643\u0645\u064A\u0629:o,\u0627\u0644\u0645\u0646\u0635\u0631\u0641:r,\u0627\u0644\u0631\u0635\u064A\u062F:l}}),a=XLSX.utils.book_new(),i=XLSX.utils.json_to_sheet(t);XLSX.utils.book_append_sheet(a,i,"Medications");const n=`Clinic_Medications_${new Date().toISOString().slice(0,10)}.xlsx`;XLSX.writeFile(a,n)},async exportMedicationsToPDF(){const e=this.getFilteredMedications();if(e.length===0){Notification?.info?.("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u062A\u0635\u062F\u064A\u0631\u0647\u0627");return}try{Notification?.info?.("\u062C\u0627\u0631\u064A \u0625\u0646\u0634\u0627\u0621 \u0627\u0644\u062A\u0642\u0631\u064A\u0631...");const{success:t,doc:a}=await this._createClinicPdfWithFont({orientation:"landscape",format:"a4",fontUrl:"https://fonts.gstatic.com/s/amiri/v30/J7aRnpd8CGxBHqUp.ttf",fontFamily:"Amiri"});if(!t||!a)throw new Error("\u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0645\u0643\u062A\u0628\u0629 PDF \u0623\u0648 \u0627\u0644\u062E\u0637 \u0627\u0644\u0639\u0631\u0628\u064A");const i=8,n=a.internal.pageSize.getWidth(),s=a.internal.pageSize.getHeight(),o=n/2,l=AppState?.companySettings?.name||AppState?.companySettings?.companyName||"\u0634\u0631\u0643\u0629",r=AppState?.companySettings?.secondaryName||"",c=AppState?.companySettings?.address||"",d=AppState?.companySettings?.phone||"",f=AppState?.companySettings?.email||"",p=AppState?.companySettings?.formVersion||"1.0",u=AppState?.companyLogo||"",m=`CLINIC-MED-${new Date().toISOString().slice(0,10)}`,g=new Date().toLocaleDateString("ar-SA");let y=8;if(u)try{a.addImage(u,"PNG",i,y-1,15,10)}catch{}const v=i+(u?18:0);a.setFontSize(10),a.setTextColor(15,23,42),a.text(l,v,y+3),r&&(a.setFontSize(7),a.setTextColor(107,114,128),a.text(r,v,y+9));const b=[c,d,f].filter(Boolean).join(" | ");b&&(a.setFontSize(5),a.setTextColor(148,163,184),a.text(b,v,r?y+15:y+9)),a.setFontSize(12),a.setTextColor(0,56,101),a.text("\u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629",n-i,y+3,{align:"right"}),a.setFontSize(5),a.setTextColor(148,163,184),a.text(m,n-i,y+9,{align:"right"});const x=b?r?y+21:y+15:r?y+15:y+9;a.setDrawColor(0,56,101),a.setLineWidth(.6),a.line(i,x,n-i,x),y=x+4,a.setFillColor(0,56,101),a.rect(0,y,n,8,"F"),a.setFontSize(7),a.setTextColor(255),a.text(l,i,y+5.5),a.text("\u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629",o,y+5.5,{align:"center"}),y+=12,a.setFontSize(14),a.setTextColor(0,56,101),a.text("\u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629",o,y,{align:"center"}),a.setFontSize(7),a.setTextColor(100),a.text(`\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062A\u0642\u0631\u064A\u0631: ${g}`,i,y+7),a.text(`\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0633\u062C\u0644\u0627\u062A: ${e.length}`,n-i,y+7,{align:"right"}),y+=11;const L=e.filter(w=>w.status==="\u0633\u0627\u0631\u064A").length,D=e.filter(w=>w.status==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621").length,j=e.filter(w=>w.status==="\u0645\u0646\u062A\u0647\u064A").length,h=e.length,$=[{label:"\u0633\u0627\u0631\u064A",value:L,bg:[232,245,233],accent:[46,125,50],tc:[27,94,32]},{label:"\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621",value:D,bg:[255,243,224],accent:[245,124,0],tc:[230,81,0]},{label:"\u0645\u0646\u062A\u0647\u064A",value:j,bg:[251,233,231],accent:[211,47,47],tc:[183,28,28]},{label:"\u0625\u062C\u0645\u0627\u0644\u064A",value:h,bg:[227,242,253],accent:[21,101,192],tc:[13,71,161]}],U=(n-2*i-9)/4,_=13;$.forEach((w,A)=>{const M=i+A*(U+3);a.setFillColor(w.bg[0],w.bg[1],w.bg[2]),a.setDrawColor(220),a.setLineWidth(.3),a.roundedRect(M,y,U,_,2,2,"FD"),a.setFillColor(w.accent[0],w.accent[1],w.accent[2]),a.rect(M,y,1.5,_,"F"),a.setFontSize(6),a.setTextColor(w.accent[0],w.accent[1],w.accent[2]),a.text(w.label,M+4,y+4.5),a.setFontSize(11),a.setTextColor(w.tc[0],w.tc[1],w.tc[2]),a.text(String(w.value),M+U-4,y+_-2.5,{align:"right"})}),y+=_+9;const C={\u0633\u0627\u0631\u064A:[46,125,50],"\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621":[255,152,0],\u0645\u0646\u062A\u0647\u064A:[198,40,40]};a.autoTable({startY:y,head:[["#","\u0627\u0633\u0645 \u0627\u0644\u062F\u0648\u0627\u0621","\u0627\u0644\u0646\u0648\u0639","\u0627\u0644\u0627\u0633\u062A\u062E\u062F\u0627\u0645","\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0634\u0631\u0627\u0621","\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621","\u0627\u0644\u062D\u0627\u0644\u0629","\u0627\u0644\u0623\u064A\u0627\u0645","\u0627\u0644\u0643\u0645\u064A\u0629","\u0627\u0644\u0645\u0646\u0635\u0631\u0641","\u0627\u0644\u0631\u0635\u064A\u062F"]],body:e.map((w,A)=>{const M=w.quantityAdded??w.quantity??0,I=w.remainingQuantity??w.quantity??0,q=Math.max(0,M-I);return[A+1,w.name||"",w.type||"",w.usage||w.notes||"\u2014",this.formatDate(w.purchaseDate),w.expiryDate?this.formatDate(w.expiryDate):"\u2014",{content:w.status||"\u0633\u0627\u0631\u064A",styles:{textColor:C[w.status]||[0,0,0]}},w.daysRemaining??"\u2014",M,q,I]}),styles:{font:"Amiri",fontSize:6.5,cellPadding:1.5,halign:"right"},headStyles:{fillColor:[0,56,101],textColor:255,fontSize:7,halign:"center"},alternateRowStyles:{fillColor:[245,247,250]},columnStyles:{0:{halign:"center",cellWidth:8},6:{halign:"center"},7:{halign:"center"},8:{halign:"center",cellWidth:10},9:{halign:"center",cellWidth:10},10:{halign:"center",cellWidth:10}},margin:{left:i,right:i},didDrawPage:function(w){const A=a.internal.getNumberOfPages();a.setFillColor(0,56,101),a.rect(0,0,n,6,"F"),a.setFontSize(6),a.setTextColor(255),a.text("\u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629",o,4.5,{align:"center"}),a.setDrawColor(0,56,101),a.setLineWidth(.3),a.line(i,s-9,n-i,s-9),a.setFontSize(5.5),a.setTextColor(148,163,184),a.text(`\u0627\u0644\u0625\u0635\u062F\u0627\u0631: ${p}`,i,s-5),a.text(m,o,s-5,{align:"center"}),a.text(`${g} | \u0635\u0641\u062D\u0629 ${A}`,n-i,s-5,{align:"right"})}});const N=`\u0633\u062C\u0644_\u0627\u0644\u0623\u062F\u0648\u064A\u0629_${new Date().toISOString().slice(0,10)}.pdf`;a.save(N),Notification?.success?.(`\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u062A\u0642\u0631\u064A\u0631 (${e.length} \u0633\u062C\u0644)`)}catch(t){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0627\u0644\u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0645\u0628\u0627\u0634\u0631\u060C \u062A\u062C\u0631\u0628\u0629 \u0637\u0631\u064A\u0642\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629:",t),this._fallbackPrintMedicationsPDF(e)}},_fallbackPrintMedicationsPDF(e){const a=`<table><thead><tr>
            ...
            </tr>`}).join("")}</tbody></table>`,i=`CLINIC-MED-${new Date().toISOString().slice(0,10)}`,n=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(i,"\u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629",a,!1,!0):`<html><body>${a}</body></html>`;try{const s=new Blob([n],{type:"text/html;charset=utf-8"}),o=URL.createObjectURL(s),l=window.open(o,"_blank");l?l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>URL.revokeObjectURL(o),1e3)},400)}:Notification?.error?.("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF")}catch(s){Utils.safeError("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 \u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629:",s),Notification?.error?.("\u062A\u0639\u0630\u0631 \u062A\u0635\u062F\u064A\u0631 \u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629")}},async _createClinicPdfWithFont({orientation:e="portrait",format:t="a4",fontUrl:a,fontFamily:i}={}){const n=typeof Utils<"u"&&Utils.PdfExport?Utils.PdfExport.getJsPdfConstructor():window.jspdf?.jsPDF||window.jsPDF?.jsPDF||window.jsPDF||null;if(!n)return{success:!1};const s=[a,"https://fonts.gstatic.com/s/amiri/v30/J7aRnpd8CGxBHqUp.ttf","https://fonts.googleapis.com/css2?family=Amiri&display=swap"].filter(Boolean);try{if(!this._arabicFontBase64){let l=!1;for(const r of s)try{const c=await fetch(r,{cache:"force-cache"});if(!c.ok)continue;if(c.headers.get("content-type")?.includes("text/css")){const f=(await c.text()).match(/url\(([^)]+\.ttf)\)/);if(!f)continue;const p=await fetch(f[1],{cache:"force-cache"});if(!p.ok)continue;this._arabicFontBase64=await p.blob().then(u=>new Promise(m=>{const g=new FileReader;g.onload=()=>m(g.result.split(",")[1]),g.readAsDataURL(u)}))}else{const d=await c.blob();this._arabicFontBase64=await new Promise(f=>{const p=new FileReader;p.onload=()=>f(p.result.split(",")[1]),p.readAsDataURL(d)})}l=!0;break}catch{continue}if(!l)return{success:!1}}const o=new n(e,"mm",t);return o.addFileToVFS(i+".ttf",this._arabicFontBase64),o.addFont(i+".ttf",i,"normal"),o.setFont(i),{success:!0,doc:o}}catch(o){return Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0625\u0646\u0634\u0627\u0621 PDF:",o),{success:!1,error:o}}},renderSickLeaveTab(){const e=document.querySelector('.clinic-tab-panel[data-tab-panel="sickLeave"]');if(!e)return;const t=this.state.filters.sickLeave||{},a=this.getSickLeaves(),i=this.getFilteredSickLeaves(),n=this.getClinicDepartments(),s=["search","department","dateFrom","dateTo"].filter(f=>String(t[f]||"").trim()).length,o=i.reduce((f,p)=>{const u=p.daysCount??this.calculateSickLeaveDays(p.startDate,p.endDate);return f+(parseInt(u,10)||0)},0),l=i.length?(o/i.length).toFixed(1):"0",r=new Set(i.map(f=>f.employeeDepartment).filter(Boolean)).size,c=i.map((f,p)=>{const u=f.employeeName||f.personName||"",m=f.employeeDepartment||"\u2014",g=this.formatDate(f.startDate),y=this.formatDate(f.endDate),v=f.daysCount??this.calculateSickLeaveDays(f.startDate,f.endDate),b=f.treatingDoctor||"\u2014",x=f.employeeCode||f.employeeNumber||"",L=String(u||"\u061F").trim().charAt(0)||"\u061F";return`
                <tr>
                    <td class="sl-serial-cell"><span>${p+1}</span></td>
                    <td>
                    ...
                    <td class="text-center sl-actions-cell">
                        <div class="sl-row-actions">
                            <button type="button" class="btn-icon btn-icon-primary" data-action="view-sick-leave" data-id="${Utils.escapeHTML(f.id||"")}" title="\u0639\u0631\u0636 \u062A\u0641\u0627\u0635\u064A\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0629" aria-label="\u0639\u0631\u0636 \u062A\u0641\u0627\u0635\u064A\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0629">
                                <i class="fas fa-eye"></i>
                            </button>
                            <button type="button" class="btn-icon btn-icon-warning" data-action="edit-sick-leave" data-id="${Utils.escapeHTML(f.id||"")}" title="\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0629" aria-label="\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0629">
                                <i class="fas fa-edit"></i>
                            </button>
                        </div>
                    </td>
            ...
            <div id="clinic-sick-leave-root">
                ...
                <section class="sl-filter-shell" aria-label="\u0641\u0644\u0627\u062A\u0631 \u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0631\u0636\u064A\u0629">
                    ...
                    <div class="sl-filter-grid">
                        ...
                        <div class="sl-field"><label for="sick-leave-department"><i class="fas fa-sitemap"></i>\u0627\u0644\u0642\u0633\u0645 / \u0627\u0644\u0625\u062F\u0627\u0631\u0629</label><select id="sick-leave-department" class="sl-filter-control"><option value="">\u062C\u0645\u064A\u0639 \u0627\u0644\u0625\u062F\u0627\u0631\u0627\u062A</option>${n.map(f=>`<option value="${Utils.escapeHTML(f)}" ${t.department===f?"selected":""}>${Utils.escapeHTML(f)}</option>`).join("")}</select></div>
        ...
        `,this.applyModuleI18n(e),this.bindSickLeaveTabEvents(e),setTimeout(()=>{const f=e.querySelector(".clinic-table-wrapper");f&&this.setupTableScrollListeners(f)},100)},bindSickLeaveTabEvents(e){const t=e.querySelector("#sick-leave-search"),a=e.querySelector("#sick-leave-department"),i=e.querySelector("#sick-leave-date-from"),n=e.querySelector("#sick-leave-date-to"),s=e.querySelector("#sick-leave-add-btn"),o=e.querySelector("#sick-leave-export-pdf-btn"),l=e.querySelector("#sick-leave-export-excel-btn"),r=e.querySelector("#sick-leave-reset-filters"),c=e.querySelector("#sick-leave-empty-reset"),d=()=>{this.state.filters.sickLeave={search:"",department:"",dateFrom:"",dateTo:""},this.renderSickLeaveTab()};t&&t.addEventListener("input",f=>{const p=f.target.value;clearTimeout(this._sickLeaveSearchTimer),this._sickLeaveSearchTimer=setTimeout(()=>{this.state.filters.sickLeave.search=p.trim(),this.renderSickLeaveTab(),requestAnimationFrame(()=>{const u=e.querySelector("#sick-leave-search");if(!u)return;u.focus({preventScroll:!0});const m=u.value.length;u.setSelectionRange?.(m,m)})},180)}),a&&a.addEventListener("change",f=>{this.state.filters.sickLeave.department=f.target.value,this.renderSickLeaveTab()}),i&&i.addEventListener("change",f=>{this.state.filters.sickLeave.dateFrom=f.target.value,this.renderSickLeaveTab()}),n&&n.addEventListener("change",f=>{this.state.filters.sickLeave.dateTo=f.target.value,this.renderSickLeaveTab()}),s?.addEventListener("click",()=>this.showSickLeaveForm()),o?.addEventListener("click",()=>this.exportSickLeaveToPDF()),l?.addEventListener("click",()=>this.exportSickLeaveToExcel()),r?.addEventListener("click",d),c?.addEventListener("click",d),e.querySelectorAll('[data-action="view-sick-leave"]').forEach(f=>{f.addEventListener("click",()=>this.viewSickLeaveRecord(f.getAttribute("data-id")))}),e.querySelectorAll('[data-action="edit-sick-leave"]').forEach(f=>{f.addEventListener("click",()=>this.editSickLeave(f.getAttribute("data-id")))})},viewSickLeaveRecord(e){const t=this.getSickLeaves().find(d=>d.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629");return}const a=t.employeeName||t.personName||"",i=t.employeeDepartment||"\u2014",n=this.formatDate(t.startDate),s=this.formatDate(t.endDate),o=t.daysCount??this.calculateSickLeaveDays(t.startDate,t.endDate),l=t.treatingDoctor||"\u2014",r=document.createElement("div");r.className="modal-overlay",r.innerHTML=`
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&c()})},editSickLeave(e){const t=this.getSickLeaves().find(a=>a.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629");return}this.showSickLeaveForm(t)},printSickLeaveRecord(e){const t=this.getSickLeaves().find(c=>c.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const a=t.employeeName||t.personName||"",i=t.employeeDepartment||"\u2014",n=t.treatingDoctor||"\u2014",s=t.daysCount??this.calculateSickLeaveDays(t.startDate,t.endDate),o=`
                ...
                <div class="filters-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 12px; align-items: end;">
                    ...
                    <div class="filter-field">
                        ...
                        <select id="injuries-type-filter" class="form-input filter-input">
                            ...
                            ${s.map(p=>`
                                <option value="${Utils.escapeHTML(p)}" ${(t.injuryType||"all")===p?"selected":""}>${Utils.escapeHTML(p)}</option>
                            `).join("")}
                        </select>
                    </div>
                    <div class="filter-field">
                        ...
                        <select id="injuries-body-part-filter" class="form-input filter-input">
                            ...
                            ${o.map(p=>`
                                <option value="${Utils.escapeHTML(p)}" ${(t.injuryBodyPart||"all")===p?"selected":""}>${Utils.escapeHTML(p)}</option>
                            `).join("")}
                        </select>
                    </div>
                    <div class="filter-field">
                        ...
                        <select id="injuries-department" class="form-input filter-input">
                            ...
                            ${n.map(p=>`
                                <option value="${Utils.escapeHTML(p)}" ${t.department===p?"selected":""}>${Utils.escapeHTML(p)}</option>
                            `).join("")}
                        </select>
                    </div>
                    <div class="filter-field">
        ...
        `,i=`CLINIC-ANALYTICS-${new Date().toISOString().slice(0,10)}`,n=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(i,"\u062A\u062D\u0644\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062A\u0631\u062F\u062F\u064A\u0646 \u0639\u0644\u0649 \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0637\u0628\u064A\u0629",a,!1,!0):`<html><body>${a}</body></html>`;try{const s=new Blob([n],{type:"text/html;charset=utf-8"}),o=URL.createObjectURL(s),l=window.open(o,"_blank");l?(l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>URL.revokeObjectURL(o),1e3)},400)},Notification?.success?.("\u062C\u0627\u0631\u064A \u062A\u062D\u0636\u064A\u0631 \u0645\u0644\u0641 PDF \u0644\u0644\u0637\u0628\u0627\u0639\u0629...")):Notification?.error?.("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF")}catch(s){Utils.safeError("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 \u062A\u062D\u0644\u064A\u0644\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629:",s),Notification?.error?.("\u062A\u0639\u0630\u0631 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644\u0627\u062A")}},analyzeAllClinicData(){try{this.ensureData()}catch(f){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A ensureData:",f)}const e=AppState.appData?.clinicVisits||[],t=AppState.appData?.clinicMedications||[],a=AppState.appData?.sickLeave||[],i=AppState.appData?.injuries||[],n=AppState.appData?.clinicSupplyRequests||[],s={total:t.length,byStatus:{},byType:{},expired:0,expiringSoon:0,totalQuantity:0,totalDispensed:0,byLocation:{}};t.forEach(f=>{const p=f.status||"\u0633\u0627\u0631\u064A",u=f.type||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",m=f.location||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";s.byStatus[p]=(s.byStatus[p]||0)+1,s.byType[u]=(s.byType[u]||0)+1,s.byLocation[m]=(s.byLocation[m]||0)+1,p==="\u0645\u0646\u062A\u0647\u064A"&&s.expired++,p==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621"&&s.expiringSoon++;const g=f.remainingQuantity??f.quantity??0,y=f.quantityAdded??f.quantity??0;s.totalQuantity+=g,s.totalDispensed+=Math.max(0,y-g)});const o={total:e.length,byMonth:{},byReason:{},byPersonType:{\u0645\u0648\u0638\u0641:0,\u0645\u0642\u0627\u0648\u0644:0,\u062E\u0627\u0631\u062C\u064A:0},byDepartment:{},byLocation:{},averagePerMonth:0};e.forEach(f=>{try{const v=f.visitDate||f.createdAt;if(!v)return;const b=new Date(v);if(isNaN(b.getTime()))return;const x=`${b.getFullYear()}-${String(b.getMonth()+1).padStart(2,"0")}`;o.byMonth[x]=(o.byMonth[x]||0)+1}catch{}const p=f.reason||f.diagnosis||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";o.byReason[p]=(o.byReason[p]||0)+1;const u=String(f.personType||"").toLowerCase().trim(),m=u==="contractor"||u==="external"?"\u0645\u0642\u0627\u0648\u0644":"\u0645\u0648\u0638\u0641";o.byPersonType[m]=(o.byPersonType[m]||0)+1;const g=f.employeeDepartment||f.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";o.byDepartment[g]=(o.byDepartment[g]||0)+1;const y=f.employeeLocation||f.workArea||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";o.byLocation[y]=(o.byLocation[y]||0)+1});const l=Object.keys(o.byMonth).length;o.averagePerMonth=l>0?(o.total/l).toFixed(1):0;const r={total:a.length,byMonth:{},byStatus:{},byPersonType:{\u0645\u0648\u0638\u0641:0,\u0645\u0642\u0627\u0648\u0644:0},byDepartment:{},totalDays:0,averageDays:0};a.forEach(f=>{try{const g=f.startDate||f.createdAt;if(!g)return;const y=new Date(g);if(isNaN(y.getTime()))return;const v=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`;r.byMonth[v]=(r.byMonth[v]||0)+1}catch{}const p=f.status||"\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629";r.byStatus[p]=(r.byStatus[p]||0)+1;const u=f.personType==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0645\u0648\u0638\u0641";r.byPersonType[u]=(r.byPersonType[u]||0)+1;const m=f.employeeDepartment||f.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";if(r.byDepartment[m]=(r.byDepartment[m]||0)+1,f.startDate&&f.endDate){const g=new Date(f.startDate),y=new Date(f.endDate),v=Math.ceil((y-g)/(1e3*60*60*24))+1;r.totalDays+=v}}),r.averageDays=r.total>0?(r.totalDays/r.total).toFixed(1):0;const c={total:i.length,byMonth:{},byType:{},byLocation:{},byPersonType:{\u0645\u0648\u0638\u0641:0,\u0645\u0642\u0627\u0648\u0644:0},byDepartment:{},byStatus:{}};i.forEach(f=>{try{const v=f.injuryDate||f.createdAt;if(!v)return;const b=new Date(v);if(isNaN(b.getTime()))return;const x=`${b.getFullYear()}-${String(b.getMonth()+1).padStart(2,"0")}`;c.byMonth[x]=(c.byMonth[x]||0)+1}catch{}const p=f.injuryType||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";c.byType[p]=(c.byType[p]||0)+1;const u=f.injuryLocation||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";c.byLocation[u]=(c.byLocation[u]||0)+1;const m=f.personType==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0645\u0648\u0638\u0641";c.byPersonType[m]=(c.byPersonType[m]||0)+1;const g=f.employeeDepartment||f.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";c.byDepartment[g]=(c.byDepartment[g]||0)+1;const y=f.status||"\u0642\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629";c.byStatus[y]=(c.byStatus[y]||0)+1});const d={total:n.length,byStatus:{},byType:{},byPriority:{},byMonth:{},pending:0,approved:0,rejected:0,fulfilled:0};return n.forEach(f=>{try{const p=f.status||"pending";d.byStatus[p]=(d.byStatus[p]||0)+1,p==="pending"&&d.pending++,p==="approved"&&d.approved++,p==="rejected"&&d.rejected++,p==="fulfilled"&&d.fulfilled++;const u=f.type||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";d.byType[u]=(d.byType[u]||0)+1;const m=f.priority||"normal";d.byPriority[m]=(d.byPriority[m]||0)+1;const g=f.createdAt||f.requestDate;if(g){const y=new Date(g);if(!isNaN(y.getTime())){const v=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`;d.byMonth[v]=(d.byMonth[v]||0)+1}}}catch{}}),{medications:s,visits:o,sickLeaves:r,injuries:c,supplyRequests:d,summary:{totalRecords:e.length+a.length+i.length,totalMedications:t.length,totalSupplyRequests:n.length,totalVisits:e.length,totalSickLeaves:a.length,totalInjuries:i.length}}},renderDataAnalysisTab(){const e=document.querySelector('.clinic-tab-panel[data-tab-panel="data-analysis"]');e&&(this.ensureChartJSLoaded().catch(()=>{}),e.innerHTML=`
        <div id="clinic-analytics-root" style="font-family:inherit;">
            ...
            <div class="content-card" style="padding:0;overflow:hidden;">
                ...
                <div style="background:${H.bg};border:1px solid ${H.border};border-radius:12px;padding:11px 12px;text-align:center;">
                ...
                </div>`).join("")}if(!await this.ensureChartJSLoaded()||typeof Chart>"u"){e.insertAdjacentHTML("afterbegin",'<div style="background:#fffbeb;border:1px solid #fde68a;border-radius:10px;padding:14px 18px;margin-bottom:16px;display:flex;align-items:center;gap:10px;"><i class="fas fa-exclamation-triangle" style="color:#d97706;"></i><span style="font-size:0.85rem;color:#92400e;">\u062A\u0639\u0630\u0651\u0631 \u062A\u062D\u0645\u064A\u0644 \u0645\u0643\u062A\u0628\u0629 \u0627\u0644\u0631\u0633\u0648\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u064A\u0629.</span></div>');return}const w={};p.forEach(k=>{const H=String(k.personType||"").toLowerCase()==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0645\u0648\u0638\u0641";w[H]=(w[H]||0)+1}),this._cDoughnut("clinic-chart-ptype",Object.keys(w),Object.values(w),["rgba(59,130,246,0.85)","rgba(249,115,22,0.85)"]),this._cTrend("clinic-chart-trend",a,"visitDate");const A=this._cGroupBy(p,k=>k.reason||k.diagnosis||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",10);this._cHBar("clinic-chart-reason",A.labels,A.data,"rgba(13,148,136,0.75)");const M=this._cGroupBy(p,k=>k.employeeLocation||k.workArea||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",10),I=document.getElementById("clinic-locs-list");I&&(u===0||M.labels.length===0?I.innerHTML='<div style="text-align:center;color:#94a3b8;font-size:0.85rem;padding:40px 0;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</div>':I.innerHTML=M.labels.map((k,H)=>{const W=M.data[H],Q=Math.round(W/u*100);return`
                    ...
                    `}).join(""));const q=this._cGroupBy(p,k=>k.employeeDepartment||k.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",10),B=document.getElementById("clinic-depts-list");B&&(u===0||q.labels.length===0?B.innerHTML='<div style="text-align:center;color:#94a3b8;font-size:0.85rem;padding:40px 0;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</div>':B.innerHTML=q.labels.map((k,H)=>{const W=q.data[H],Q=Math.round(W/u*100);return`
                    ...
                    `}).join(""));const P=document.getElementById("clinic-factories-cards");if(P)if(u===0)P.innerHTML='<div style="text-align:center;color:#94a3b8;font-size:0.85rem;padding:40px 0;grid-column:1/-1;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</div>';else{const k=new Set(c.map(W=>String(W.factoryName||W.factory||"").trim()).filter(W=>W&&W!=="\u063A\u064A\u0631 \u0645\u062D\u062F\u062F")),H=Array.from(k).sort();H.length===0?P.innerHTML='<div style="text-align:center;color:#94a3b8;font-size:0.85rem;padding:40px 0;grid-column:1/-1;">\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0635\u0627\u0646\u0639</div>':P.innerHTML=H.map((W,Q)=>{const J=p.filter(pe=>(pe.factoryName||pe.factory||"").trim()===W).length,ce=u>0?Math.round(J/u*100):0,de=[{primary:"#0284c7",light:"#e0f2fe",progress:"linear-gradient(90deg, #38bdf8 0%, #0284c7 100%)"},{primary:"#059669",light:"#ecfdf5",progress:"linear-gradient(90deg, #34d399 0%, #059669 100%)"},{primary:"#7c3aed",light:"#f5f3ff",progress:"linear-gradient(90deg, #a78bfa 0%, #7c3aed 100%)"},{primary:"#ea580c",light:"#fff7ed",progress:"linear-gradient(90deg, #fb923c 0%, #ea580c 100%)"},{primary:"#db2777",light:"#fdf2f8",progress:"linear-gradient(90deg, #f472b6 0%, #db2777 100%)"}],le=de[Q%de.length];return`
        ...
        `,i=`CLINIC-DATA-ANALYSIS-${new Date().toISOString().slice(0,10)}`,n=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(i,"\u062A\u062D\u0644\u064A\u0644 \u0634\u0627\u0645\u0644 \u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0637\u0628\u064A\u0629",a,!1,!0):`<html><body>${a}</body></html>`;try{const s=new Blob([n],{type:"text/html;charset=utf-8"}),o=URL.createObjectURL(s),l=window.open(o,"_blank");l?(l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>URL.revokeObjectURL(o),1e3)},400)},Notification?.success?.("\u062C\u0627\u0631\u064A \u062A\u062D\u0636\u064A\u0631 \u0645\u0644\u0641 PDF \u0644\u0644\u0637\u0628\u0627\u0639\u0629...")):Notification?.error?.("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF")}catch(s){Utils.safeError("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 \u062A\u062D\u0644\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",s),Notification?.error?.("\u062A\u0639\u0630\u0631 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u062A\u062D\u0644\u064A\u0644")}},scheduleVisitsTabRender(e=!1,t=0){this._visitsRenderTimer&&(clearTimeout(this._visitsRenderTimer),this._visitsRenderTimer=null);const a=()=>{this._visitsRenderTimer=null,requestAnimationFrame(()=>{this.renderVisitsTab(e)})};this._visitsRenderTimer=setTimeout(a,Math.max(0,t))},scheduleAttendanceTabRender(e=0){this._attendanceRenderTimer&&(clearTimeout(this._attendanceRenderTimer),this._attendanceRenderTimer=null);const t=()=>{this._attendanceRenderTimer=null,requestAnimationFrame(()=>{this.renderAttendanceTab()})};this._attendanceRenderTimer=setTimeout(t,Math.max(0,e))},scheduleMedicationsTabRender(e=0){this._medicationsRenderTimer&&(clearTimeout(this._medicationsRenderTimer),this._medicationsRenderTimer=null);const t=()=>{this._medicationsRenderTimer=null,requestAnimationFrame(()=>{this.renderMedicationsTab()})};this._medicationsRenderTimer=setTimeout(t,Math.max(0,e))},async renderVisitsTab(e=!1){try{const t=document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]');if(!t){Utils.safeWarn("\u26A0\uFE0F \u0644\u0648\u062D\u0629 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}this.ensureData(),this.ensureFilterDefaults();const a=this.shouldFetchClinicVisitsFromBackend({forceRefresh:e});if(this.renderVisitsTabContent(t),a&&typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest){if((Array.isArray(AppState.appData?.clinicVisits)?AppState.appData.clinicVisits.length:0)===0&&!t.querySelector(".clinic-visits-sync-banner")){const n=document.createElement("div");n.className="clinic-visits-sync-banner",n.setAttribute("role","status"),n.innerHTML='<i class="fas fa-sync fa-spin" aria-hidden="true"></i><span>\u062C\u0627\u0631\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645\u2026</span>',t.insertBefore(n,t.firstChild)}this.loadVisitsDataFromBackend().then(()=>{const n=document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]');n&&this.state&&this.state.activeTab==="visits"&&(this.ensureData(),this.renderVisitsTabContent(n)),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0628\u0639\u062F \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 \u0627\u0644\u062E\u0627\u062F\u0645 (\u0628\u062F\u0648\u0646 \u062D\u062C\u0628 \u0627\u0644\u0648\u0627\u062C\u0647\u0629)")}).catch(n=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645:",n&&n.message)})}}catch(t){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u0639\u0631\u0636 \u062A\u0628\u0648\u064A\u0628 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F:",t);const a=document.querySelector('.clinic-tab-panel[data-tab-panel="visits"]');a&&(a.innerHTML=`
                ...
                `)}},mergeClinicVisitsWithLocalOnly(e,t){const a=Array.isArray(e)?e:[],i=Array.isArray(t)?t:[],n=new Set,s=new Set,o=new Set,l=new Set;a.forEach(d=>{if(d&&d.id!=null&&String(d.id).trim()!==""&&n.add(String(d.id)),!d)return;const f=String(d.visitDate||"");if((d.personType||(this.isContractorVisit_(d)?"contractor":"employee"))==="employee"){const u=String(d.employeeCode||d.employeeNumber||"").trim();u&&s.add(u+"|"+f);const m=Clinic.normalizeArabicText(d.employeeName);m&&o.add(m+"|"+f)}else{const u=Clinic.normalizeArabicText(d.contractorName||d.externalName),m=Clinic.normalizeArabicText(d.contractorWorkerName);l.add(u+"|"+m+"|"+f)}});const r=[];if(i.forEach(d=>{if(!d||d.id==null||String(d.id).trim()==="")return;const f=String(d.id);if(!n.has(f)){const p=String(d.visitDate||""),u=d.personType||(this.isContractorVisit_(d)?"contractor":"employee");let m=!1;if(u==="employee"){const g=String(d.employeeCode||d.employeeNumber||"").trim();if(g&&s.has(g+"|"+p))m=!0;else{const y=Clinic.normalizeArabicText(d.employeeName);y&&o.has(y+"|"+p)&&(m=!0)}}else{const g=Clinic.normalizeArabicText(d.contractorName||d.externalName),y=Clinic.normalizeArabicText(d.contractorWorkerName);l.has(g+"|"+y+"|"+p)&&(m=!0)}if(!m){const g=new Date(d.createdAt||d.visitDate).getTime(),y=new Date().getTime();(!isNaN(g)&&y-g<72e5||isNaN(g)&&(d._pendingSync||d._localOnly||d._offlineCreated))&&(n.add(f),r.push(d))}}}),r.length===0)return a.slice();AppState.debugMode&&r.length>0&&Utils.safeLog(`\u{1F4DD} [CLINIC] \u062F\u0645\u062C ${r.length} \u0633\u062C\u0644\u0627\u062A \u0645\u062D\u0644\u064A\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629 \u0641\u064A \u0631\u062F \u0627\u0644\u062E\u0627\u062F\u0645 (\u0642\u062F \u064A\u0643\u0648\u0646 \u0643\u0627\u0634 \u0642\u062F\u064A\u0645)`);const c=a.concat(r);return c.sort((d,f)=>{const p=new Date(d.visitDate||d.createdAt||0).getTime();return new Date(f.visitDate||f.createdAt||0).getTime()-p}),c},assertClinicVisitRpcResult(e){if(!e||e.success!==!0){const t=e&&e.message?e.message:"\u0644\u0645 \u064A\u064F\u0624\u0643\u062F \u0627\u0644\u062E\u0627\u062F\u0645 \u062D\u0641\u0638 \u0627\u0644\u0632\u064A\u0627\u0631\u0629";throw new Error(t)}},applyClinicVisitIdFromServer(e,t){if(!e||!t||!t.visitId)return;const a=String(t.visitId).trim();if(!a||String(e.id)===a)return;const i=e.id;e.id=a;const n=AppState.appData.clinicVisits;if(!Array.isArray(n))return;const s=n.findIndex(o=>o&&o.id===i);s!==-1&&(n[s]={...n[s],id:a})},shouldFetchClinicVisitsFromBackend(e={}){if(e&&e.forceRefresh===!0||typeof AppState>"u"||!AppState||!AppState.appData)return!0;if(this._visitsBackendFetchOk===!0)return!1;const t=AppState.appData.clinicVisits;if(Array.isArray(t)&&t.length>0){const a=localStorage.getItem("clinic_last_sync");if(a){const i=Date.now()-parseInt(a,10),n=600*1e3;if(!isNaN(i)&&i<n)return!1}}return!0},shouldRefreshClinicVisitsForRealtime(){if(this._clinicVisitsLoadPromise)return!1;if(typeof AppState>"u"||!AppState?.appData)return!0;const e=AppState.appData.clinicVisits;if(!Array.isArray(e)||e.length===0)return!0;const t=parseInt(localStorage.getItem("clinic_last_sync")||"0",10),a=180*1e3;return!t||isNaN(t)?!0:Date.now()-t>=a},isClinicVisitsHighPriorityContext(){try{const e=typeof AppState<"u"&&AppState.currentSection?String(AppState.currentSection):"";return e==="clinic"||e==="dashboard"}catch{return!1}},getClinicVisitsFetchFilters(){const t=new Date;t.setMonth(t.getMonth()-18);const a=t.getFullYear(),i=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0");return{startDate:`${a}-${i}-${n}`,limit:8e3}},async loadVisitsDataFromBackend(e={}){const t=!!(e&&e.forceRefresh===!0);if(this._clinicVisitsLoadPromise){if(!t)return this._clinicVisitsLoadPromise;try{await this._clinicVisitsLoadPromise}catch{}}if(this._clinicVisitsLoadPromise)return this._clinicVisitsLoadPromise;t&&(this._visitsBackendFetchOk=!1);const a=Array.isArray(AppState.appData.clinicVisits)?AppState.appData.clinicVisits.slice():[];return this._clinicVisitsLoadPromise=(async()=>{try{AppState.debugMode&&Utils.safeLog("\u{1F504} \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0645\u0646 Backend...");const i=await Utils.promiseWithTimeout(GoogleIntegration.sendRequest({action:"getAllClinicVisits",data:{filters:this.getClinicVisitsFetchFilters(),__timeoutMs:12e4,__highPriority:this.isClinicVisitsHighPriorityContext()}}),12e4,"\u0627\u0646\u062A\u0647\u062A \u0645\u0647\u0644\u0629 \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F");if(i&&i.success&&Array.isArray(i.data)){if(i.data.length===0&&a.length>0){Utils.safeWarn(`\u26A0\uFE0F \u062A\u062C\u0627\u0647\u0644 \u0633\u062C\u0644 \u062A\u0631\u062F\u062F \u0641\u0627\u0631\u063A \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645 \u2014 \u0627\u0644\u0625\u0628\u0642\u0627\u0621 \u0639\u0644\u0649 ${a.length} \u0632\u064A\u0627\u0631\u0629 \u0645\u062D\u0644\u064A\u0629 (\u0644\u0627 \u064A\u064F\u062D\u062F\u0651\u064E\u062B clinic_last_sync)`);return}const n=AppState.appData.users||[],s=new Map,o=new Map;for(let c=0;c<n.length;c++){const d=n[c];if(!d)continue;const f=(d.email||"").toString().toLowerCase().trim(),p=(d.id||"").toString().trim();f&&s.set(f,d),p&&o.set(p,d)}const l=new Array(i.data.length);for(let c=0;c<i.data.length;c++){let d=i.data[c];if(!d||typeof d!="object"){l[c]=d,(c+1)%200===0&&await new Promise(p=>setTimeout(p,0));continue}this.isContractorVisit_(d)?d.personType="contractor":d.personType||(d.personType="employee");let f=[];if(d.medications&&(f=this.normalizeVisitMedications(d.medications),AppState.debugMode&&f.length>0&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${f.length} \u062F\u0648\u0627\u0621 \u0645\u0646 medications \u0644\u0632\u064A\u0627\u0631\u0629 ${d.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}`)),(!f||f.length===0)&&d.medicationsDispensed){const p=this.normalizeVisitMedications(d.medicationsDispensed);p&&p.length>0&&(f=p,AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0648\u064A\u0644 medicationsDispensed \u0644\u0632\u064A\u0627\u0631\u0629 ${d.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,p.length,"\u062F\u0648\u0627\u0621"))}if(d.medications=f&&f.length>0?f:[],d.visitDate)try{if(d.visitDate instanceof Date)isNaN(d.visitDate.getTime())?d.visitDate=null:d.visitDate=d.visitDate.toISOString();else{const p=String(d.visitDate).trim();if(p.includes("T")&&(p.includes("Z")||p.includes("+")||p.includes("-"))){const u=new Date(p);isNaN(u.getTime())?d.visitDate=null:d.visitDate=u.toISOString()}else if(p.length===10&&p.match(/^\d{4}-\d{2}-\d{2}$/)){const u=new Date(p+"T00:00:00");isNaN(u.getTime())?d.visitDate=null:d.visitDate=u.toISOString()}else{const u=new Date(p);isNaN(u.getTime())?(AppState.debugMode&&Utils.safeWarn(`\u26A0\uFE0F \u0644\u0627 \u064A\u0645\u0643\u0646 \u062A\u062D\u0648\u064A\u0644 visitDate: ${p}`),d.visitDate=null):d.visitDate=u.toISOString()}}}catch(p){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0639 visitDate:",p),d.visitDate=null}if(d.exitDate)try{if(d.exitDate instanceof Date)isNaN(d.exitDate.getTime())?d.exitDate=null:d.exitDate=d.exitDate.toISOString();else{const p=String(d.exitDate).trim();if(p.includes("T")&&(p.includes("Z")||p.includes("+")||p.includes("-"))){const u=new Date(p);isNaN(u.getTime())?d.exitDate=null:d.exitDate=u.toISOString()}else if(p.length===10&&p.match(/^\d{4}-\d{2}-\d{2}$/)){const u=new Date(p+"T00:00:00");isNaN(u.getTime())?d.exitDate=null:d.exitDate=u.toISOString()}else{const u=new Date(p);isNaN(u.getTime())?(AppState.debugMode&&Utils.safeWarn(`\u26A0\uFE0F \u0644\u0627 \u064A\u0645\u0643\u0646 \u062A\u062D\u0648\u064A\u0644 exitDate: ${p}`),d.exitDate=null):d.exitDate=u.toISOString()}}}catch(p){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0639 exitDate:",p),d.exitDate=null}if(d.createdBy){if(typeof d.createdBy=="string"){const p=d.createdBy.trim();if(p&&p!==""&&p!=="\u0627\u0644\u0646\u0638\u0627\u0645")d.createdBy=p;else if(p==="\u0627\u0644\u0646\u0638\u0627\u0645"){const u=(d.email||"").toString().trim(),m=(d.userId||"").toString().trim();if(u||m){const g=u&&s.get(u.toLowerCase().trim())||m&&o.get(m)||null;if(g){const y=(g.name||g.displayName||"").toString().trim();y&&y!=="\u0627\u0644\u0646\u0638\u0627\u0645"&&y!==""?(d.createdBy=y,AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0627\u0633\u062A\u0628\u062F\u0627\u0644 "\u0627\u0644\u0646\u0638\u0627\u0645" \u0628\u0640 \u0627\u0633\u0645 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645 \u0644\u0632\u064A\u0627\u0631\u0629 ${d.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}: ${y}`)):d.createdBy="\u0645\u0633\u062A\u062E\u062F\u0645"}else d.createdBy="\u0645\u0633\u062A\u062E\u062F\u0645"}else d.createdBy="\u0645\u0633\u062A\u062E\u062F\u0645"}else d.createdBy=null}else if(typeof d.createdBy=="object"){const u=(d.createdBy.name||""||"\u0645\u0633\u062A\u062E\u062F\u0645").trim();d.createdBy=u}}else d.createdBy="\u0645\u0633\u062A\u062E\u062F\u0645";if(d.updatedBy){if(typeof d.updatedBy=="string")d.updatedBy=d.updatedBy.trim()||null;else if(typeof d.updatedBy=="object"){const p=d.updatedBy.name||"";d.updatedBy=(p||"\u0645\u0633\u062A\u062E\u062F\u0645").trim()}}else d.updatedBy="\u0645\u0633\u062A\u062E\u062F\u0645";d.medications.length===0&&d.medicationsDispensedQty&&d.medicationsDispensedQty>0&&AppState.debugMode&&Utils.safeWarn(`\u26A0\uFE0F \u0632\u064A\u0627\u0631\u0629 ${d.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"} \u0644\u062F\u064A\u0647\u0627 medicationsDispensedQty=${d.medicationsDispensedQty} \u0648\u0644\u0643\u0646 \u0644\u0627 \u062A\u0648\u062C\u062F \u0642\u0627\u0626\u0645\u0629 \u0623\u062F\u0648\u064A\u0629. medicationsDispensed:`,d.medicationsDispensed),l[c]=d,(c+1)%200===0&&await new Promise(p=>setTimeout(p,0))}AppState.appData.clinicVisits=this.mergeClinicVisitsWithLocalOnly(l,a),AppState.appData.clinicContractorVisits=AppState.appData.clinicVisits.filter(c=>c&&c.personType==="contractor");const r=()=>{try{this.ensureData()}catch{}};if(typeof requestIdleCallback=="function"?requestIdleCallback(r,{timeout:2500}):setTimeout(r,0),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),localStorage.setItem("clinic_last_sync",Date.now().toString()),this._visitsBackendFetchOk=!0,AppState.debugMode){const c=AppState.appData.clinicVisits,d=c.filter(p=>{const u=this.normalizeVisitMedications(p.medications);if(u&&u.length>0)return!0;if(p.medicationsDispensed){const m=this.normalizeVisitMedications(p.medicationsDispensed);return m&&m.length>0}return!1}),f=c.reduce((p,u)=>{const m=this.normalizeVisitMedications(u.medications);if(m&&m.length>0)return p+m.length;if(u.medicationsDispensed){const g=this.normalizeVisitMedications(u.medicationsDispensed);if(g&&g.length>0)return p+g.length}return p},0);Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${l.length} \u0632\u064A\u0627\u0631\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645\u061B \u0628\u0639\u062F \u0627\u0644\u062F\u0645\u062C \u0645\u0639 \u0627\u0644\u0645\u062D\u0644\u064A: ${c.length}`),Utils.safeLog(`   - ${c.filter(p=>p.personType==="employee"||!p.personType).length} \u0645\u0648\u0638\u0641`),Utils.safeLog(`   - ${c.filter(p=>p.personType==="contractor").length} \u0645\u0642\u0627\u0648\u0644`),Utils.safeLog(`   - ${d.length} \u0632\u064A\u0627\u0631\u0629 \u062A\u062D\u062A\u0648\u064A \u0639\u0644\u0649 \u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629`),Utils.safeLog(`   - \u0625\u062C\u0645\u0627\u0644\u064A ${f} \u062F\u0648\u0627\u0621 \u0645\u0646\u0635\u0631\u0641`)}}}catch(i){throw AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645:",i.message),AppState.appData.clinicVisits||(AppState.appData.clinicVisits=[]),i}})().finally(()=>{this._clinicVisitsLoadPromise=null}),this._clinicVisitsLoadPromise},refreshClinicVisitsFromServerAfterSave(){AppState.debugMode&&Utils.safeLog("\u{1F504} [CLINIC] \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645 \u0628\u0639\u062F \u0627\u0644\u062D\u0641\u0638..."),this._visitsBackendFetchOk=!1,this.loadVisitsDataFromBackend({forceRefresh:!0}).then(()=>{try{this.updateClinicAnalysisResults(),this.calculateClinicCardValues(),document.dispatchEvent(new CustomEvent("clinic-data-refreshed"))}catch(e){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0625\u062D\u0635\u0627\u0626\u064A\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0628\u0639\u062F \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629:",e)}if(typeof window.DataManager<"u"&&window.DataManager.save)try{window.DataManager.save()}catch{}if(this.state&&(this.state.activeTab==="visits"||this.state.activeTab==="dashboard")){const e=document.querySelector('.clinic-tab-panel[data-tab-panel="'+this.state.activeTab+'"]');if(e)try{this.ensureData(),this.state.activeTab==="visits"?this.renderVisitsTabContent(e):this.renderDashboardTab()}catch{}}}).catch(e=>{Utils.safeWarn("\u062A\u0639\u0630\u0631 \u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645 \u0628\u0639\u062F \u0627\u0644\u062D\u0641\u0638:",e)})},renderVisitsTabContent(e){try{if(!e){Utils.safeWarn("\u26A0\uFE0F panel \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A renderVisitsTabContent");return}if(typeof AppState>"u"||!AppState.appData){Utils.safeWarn("\u26A0\uFE0F AppState \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631 \u0641\u064A renderVisitsTabContent"),e.innerHTML='<div class="empty-state"><p class="text-gray-500">'+this.getTranslations().t("skeleton.loadingData","\u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A...")+"</p></div>";return}let t,a;try{const h=this.getTranslations();t=h.t,a=h.isRTL}catch(h){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0627\u0644\u062A\u0631\u062C\u0645\u0627\u062A:",h),t=$=>$,a=!0}const i=this.state&&this.state.activeVisitType?this.state.activeVisitType:"employees",n=i==="contractors",s=this.state&&this.state.filters&&this.state.filters.visits?this.state.filters.visits:{search:"",factory:"",position:"",workplace:""},o=(s.search||"").trim(),l=o.toLowerCase(),r=(s.factory||"").trim(),c=(s.position||"").trim(),d=(s.workplace||"").trim();this.ensureData();const f=this.getActualClinicVisits_(AppState.appData.clinicVisits).slice();f.sort((h,$)=>{const U=new Date(h.visitDate||h.createdAt||0).getTime();return new Date($.visitDate||$.createdAt||0).getTime()-U});const p=[],u=[];f.forEach(h=>{this.isEmployeeVisit_(h)?p.push(h):this.isContractorVisit_(h)&&u.push(h)});const m=i==="employees"?p:u,y=!!(l||r||c||d)?m.filter(h=>{if(r)try{const $=this.getVisitFactoryDisplayName(h);if(String($||"").trim()!==r)return!1}catch{return!1}if(c){const $=n?h.contractorPosition||h.employeePosition||"":h.employeePosition||"";if(String($||"").trim()!==c)return!1}if(d){const $=n?h.workArea||h.employeeLocation||"":h.employeeLocation||h.workArea||"";if(String($||"").trim()!==d)return!1}if(l){const $=String(n?h.contractorName||h.employeeName||h.externalName||"":h.employeeCode||h.employeeNumber||""),U=String(n?h.contractorWorkerName||"":h.employeeName||""),_=String(n?h.contractorPosition||h.employeePosition||"":h.employeePosition||"");let C="-";try{C=this.getVisitFactoryDisplayName(h)}catch{C=h.factoryName||h.factory||"-"}const N=String(n?h.workArea||h.employeeLocation||"":h.employeeLocation||h.workArea||"");let w="-",A="";try{if(h.visitDate){let S=h.visitDate;S instanceof Date?S=S.toISOString():typeof S=="string"&&!S.includes("T")&&S.match(/^\d{4}-\d{2}-\d{2}$/)&&(S=S+"T00:00:00Z"),w=Utils.formatDateTime?Utils.formatDateTime(S):String(S)}if(h.exitDate){let S=h.exitDate;S instanceof Date?S=S.toISOString():typeof S=="string"&&!S.includes("T")&&S.match(/^\d{4}-\d{2}-\d{2}$/)&&(S=S+"T00:00:00Z"),A=Utils.formatDateTime?Utils.formatDateTime(S):String(S)}}catch{w=h.visitDate?String(h.visitDate):"-",A=h.exitDate?String(h.exitDate):""}const M=String(h.reason||""),I=String(h.diagnosis||"");let q=[];if(h.medications)try{q=this.normalizeVisitMedications(h.medications)}catch{q=[]}const B=q&&q.length>0?q.map(S=>{try{let F="";return S&&S.medicationName?F=typeof S.medicationName=="string"?S.medicationName:S.medicationName.name||String(S.medicationName)||"":S&&S.name&&(F=typeof S.name=="string"?S.name:S.name.name||String(S.name)||""),F}catch{return""}}).filter(Boolean).join(" "):"";let P="";try{h.createdBy&&(typeof h.createdBy=="object"?P=String(h.createdBy.name||"\u0645\u0633\u062A\u062E\u062F\u0645"):P=String(h.createdBy||""))}catch{P=""}if(![$,U,_,C,N,w,A,M,I,B,P].join(" ").toLowerCase().includes(l))return!1}return!0}):m,v=h=>{const $=n?h.contractorName||h.employeeName||h.externalName||"-":h.employeeCode||h.employeeNumber||"-",U=n?h.contractorWorkerName||"-":h.employeeName||"-",_=n?h.contractorPosition||h.employeePosition||"-":h.employeePosition||"-";let C="-";try{C=this.getVisitFactoryDisplayName(h)}catch{C=h.factoryName||h.factory||"-"}const N=n?h.workArea||h.employeeLocation||"-":h.employeeLocation||h.workArea||"-";let w="-",A=`<span class="text-xs text-gray-500">${t("table.notRecorded")}</span>`;try{if(h.visitDate){let T=h.visitDate;T instanceof Date?T=T.toISOString():typeof T=="string"&&!T.includes("T")&&T.match(/^\d{4}-\d{2}-\d{2}$/)&&(T=T+"T00:00:00Z"),w=Utils.formatDateTime?Utils.formatDateTime(T):String(T)}if(h.exitDate){let T=h.exitDate;T instanceof Date?T=T.toISOString():typeof T=="string"&&!T.includes("T")&&T.match(/^\d{4}-\d{2}-\d{2}$/)&&(T=T+"T00:00:00Z"),A=Utils.formatDateTime?Utils.formatDateTime(T):`<span class="text-xs text-gray-500">${t("table.notRecorded")}</span>`}}catch(T){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0639\u0631\u0636 \u0627\u0644\u062A\u0627\u0631\u064A\u062E \u0648\u0627\u0644\u0648\u0642\u062A:",T),w=h.visitDate?String(h.visitDate):"-",A=h.exitDate?String(h.exitDate):`<span class="text-xs text-gray-500">${t("table.notRecorded")}</span>`}let M="-";try{M=this.calculateTotalTime(h.visitDate,h.exitDate)}catch{M="-"}const I=h.reason||"",q=h.diagnosis||"";let B=[];if(h.medications)try{B=this.normalizeVisitMedications(h.medications),AppState.debugMode&&B.length>0&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${B.length} \u062F\u0648\u0627\u0621 \u0645\u0646 medications \u0644\u0632\u064A\u0627\u0631\u0629 ${h.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}`)}catch(T){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A normalizeVisitMedications:",T),B=[]}if((!B||B.length===0)&&h.medicationsDispensed)try{const T=this.normalizeVisitMedications(h.medicationsDispensed);T&&T.length>0&&(B=T,AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0648\u064A\u0644 medicationsDispensed \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u0639\u0631\u0636 \u0644\u0632\u064A\u0627\u0631\u0629 ${h.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,B.length,"\u062F\u0648\u0627\u0621"))}catch(T){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A normalizeVisitMedications \u0645\u0646 medicationsDispensed:",T)}(!B||B.length===0)&&h.medicationsDispensedQty&&h.medicationsDispensedQty>0&&AppState.debugMode&&Utils.safeWarn(`\u26A0\uFE0F \u0632\u064A\u0627\u0631\u0629 ${h.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"} \u0644\u062F\u064A\u0647\u0627 medicationsDispensedQty=${h.medicationsDispensedQty} \u0648\u0644\u0643\u0646 \u0644\u0627 \u062A\u0648\u062C\u062F \u0642\u0627\u0626\u0645\u0629 \u0623\u062F\u0648\u064A\u0629`);const P=B&&B.length>0?B.map(T=>{try{if(!T||typeof T!="object")return null;let z="";if(T.medicationName?z=typeof T.medicationName=="string"?T.medicationName.trim():(T.medicationName.name||String(T.medicationName)||"").trim():T.name&&(z=typeof T.name=="string"?T.name.trim():(T.name.name||String(T.name)||"").trim()),!z)return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062F\u0648\u0627\u0621 \u0628\u062F\u0648\u0646 \u0627\u0633\u0645:",T),null;const E=parseInt(T.quantity,10)||1;return`${Utils.escapeHTML(z)} (${E})`}catch(z){return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u062F\u0648\u0627\u0621:",z,T),null}}).filter(Boolean).join(a?"\u060C ":", "):"-",O=B&&B.length>0?B.reduce((T,z)=>{try{const E=parseInt(z.quantity,10)||0;return T+E}catch{return T}},0):0,S=Utils.escapeHTML(this.getUserDisplayName(h.createdBy)),F=a?"right":"left";return`
                <tr>
                ...
                <div class="module-tabs-wrapper">
                    <div class="module-tabs-container">
                        <button type="button" 
                            ...
                            ${t("tab.employees")}
                            <span class="badge ${i==="employees"?"badge-primary":"badge-secondary"} ${L}">${p.length}</span>
                        </button>
                        <button type="button" 
                            ...
                            ${t("tab.contractors")}
                            <span class="badge ${i==="contractors"?"badge-primary":"badge-secondary"} ${L}">${u.length}</span>
                        </button>
                        </div>
                </div>
            </div>
...
\u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647.`,"\u062D\u0630\u0641","\u0625\u0644\u063A\u0627\u0621")){Loading.show("\u062C\u0627\u0631\u064A \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629...");try{if(AppState.googleConfig?.appsScript?.enabled){const s=await GoogleIntegration.sendRequest({action:"deleteClinicVisit",data:{visitId:e}});if(!s||s.success!==!0)throw new Error(s?.message||"\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645")}AppState.appData.clinicVisits=(AppState.appData.clinicVisits||[]).filter(s=>s.id!==e),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0628\u0646\u062C\u0627\u062D"),this.renderVisitsTab()}catch(s){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629: "+s.message),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",s)}}},async requestVisitDeletion(e){try{if(!e){Notification.error("\u0645\u0639\u0631\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D");return}const t=(AppState.appData.clinicVisits||[]).find(s=>s.id===e);if(!t){Notification.error("\u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}if(!(AppState?.googleConfig?.appsScript?.enabled&&AppState?.googleConfig?.appsScript?.scriptUrl)||typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest){Notification.error("\u062A\u0639\u0630\u0631 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641 (\u0627\u0644\u062E\u0627\u062F\u0645 \u063A\u064A\u0631 \u0645\u062A\u0627\u062D)");return}const i={id:AppState.currentUser?.id||"",name:AppState.currentUser?.name||"",email:AppState.currentUser?.email||"",role:AppState.currentUser?.role||""};Loading.show("\u062C\u0627\u0631\u064A \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629...");const n=await GoogleIntegration.sendRequest({action:"addClinicVisitDeletionRequest",data:{visitId:e,visitData:t,requestedBy:i}});if(Loading.hide(),!n||n.success!==!0)throw new Error(n?.message||"\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641");try{AppState.appData.clinicVisitDeletionRequests=Array.isArray(AppState.appData.clinicVisitDeletionRequests)?AppState.appData.clinicVisitDeletionRequests:[],n.data&&AppState.appData.clinicVisitDeletionRequests.unshift({...n.data,requestType:"visit"}),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save()}catch{}Notification.success("\u062A\u0645 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0625\u0644\u0649 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645")}catch(t){try{Loading.hide()}catch{}Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",t),Notification.error("\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641: "+(t.message||"\u062D\u062F\u062B \u062E\u0637\u0623"))}},getMedicationRowClass(e){return e==="\u0645\u0646\u062A\u0647\u064A"?"bg-red-50":e==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621"?"bg-yellow-50":"bg-green-50"},ensureData(){if(typeof AppState>"u")return;AppState.appData=AppState.appData||{};const e=AppState.appData;Array.isArray(e.clinicVisits)||(e.clinicVisits=[]),Array.isArray(e.medications)||(e.medications=[]),Array.isArray(e.clinicMedications)||(e.clinicMedications=[]),Array.isArray(e.clinicInventory)||(e.clinicInventory=[]);const t=e.medications.length>0?e.medications:e.clinicMedications.length>0?e.clinicMedications:e.clinicInventory.length>0?e.clinicInventory:[];e.medications.length===0&&t.length>0&&(e.medications=[...t]),e.clinicMedications.length===0&&t.length>0&&(e.clinicMedications=[...t]),e.clinicInventory.length===0&&t.length>0&&(e.clinicInventory=[...t]),Array.isArray(e.sickLeave)||(e.sickLeave=[]),Array.isArray(e.injuries)||(e.injuries=[]),Array.isArray(e.clinicSupplyRequests)||(e.clinicSupplyRequests=[]),Array.isArray(e.clinicStaff)||(e.clinicStaff=[]),Array.isArray(e.clinicStaffAttendance)||(e.clinicStaffAttendance=[]),Array.isArray(e.clinicStaffTimeOffRequests)||(e.clinicStaffTimeOffRequests=[]),Array.isArray(e.clinicStaffLeaveBalances)||(e.clinicStaffLeaveBalances=[]),Array.isArray(e.clinicStaffSystemActivities)||(e.clinicStaffSystemActivities=[]);let a=!1;if(Array.isArray(e.clinicContractorVisits)&&e.clinicContractorVisits.length>0){const n=new Set(e.clinicVisits.map(o=>o&&o.id).filter(Boolean));let s=0;e.clinicContractorVisits.forEach(o=>{o&&o.id&&!n.has(o.id)&&(o.personType="contractor",e.clinicVisits.push(o),n.add(o.id),a=!0,s++)}),s>0&&AppState.debugMode&&Utils.safeLog(`\u{1F517} [CLINIC] \u062A\u0645 \u062F\u0645\u062C ${s} \u0632\u064A\u0627\u0631\u0629 \u0645\u0642\u0627\u0648\u0644 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B \u0641\u064A ensureData`)}e.clinicVisits=e.clinicVisits.map(n=>{if(!n||typeof n!="object")return n;let s=String(n.personType||"").toLowerCase().trim();s==="external"||s==="\u062E\u0627\u0631\u062C\u064A"||s==="\u0645\u0642\u0627\u0648\u0644"||s==="contractor"?s="contractor":(s==="\u0645\u0648\u0638\u0641"||s==="staff"||s==="employee"||!s)&&(n.contractorName||n.contractorWorkerName?s="contractor":s="employee"),n.personType!==s&&(n.personType=s,a=!0);let o=[];if(n.medications&&(o=this.normalizeVisitMedications(n.medications)),(!o||o.length===0)&&n.medicationsDispensed){const d=this.normalizeVisitMedications(n.medicationsDispensed);d&&d.length>0&&(o=d,AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0648\u064A\u0644 medicationsDispensed \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,d.length,"\u062F\u0648\u0627\u0621"))}if((!o||o.length===0)&&n.medicationsDispensedQty&&n.medicationsDispensedQty>0){const d=parseInt(n.medicationsDispensedQty,10)||0;d>0&&(o=[{medicationName:n.medicationsDispensed||"\u062F\u0648\u0627\u0621 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F",quantity:d,unit:"\u0648\u062D\u062F\u0629",notes:""}],AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0646\u0634\u0627\u0621 \u0633\u062C\u0644 \u062F\u0648\u0627\u0621 \u0645\u0646 medicationsDispensedQty \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,d))}o||(o=[]);const l=Array.isArray(n.medications)?n.medications:[],r=JSON.stringify(l.sort((d,f)=>(d.medicationName||"").localeCompare(f.medicationName||""))),c=JSON.stringify(o.sort((d,f)=>(d.medicationName||"").localeCompare(f.medicationName||"")));if(r!==c&&(n.medications=o,a=!0,AppState.debugMode&&o.length>0&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B medications \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,o.length,"\u062F\u0648\u0627\u0621")),n.visitDate){const d=String(n.visitDate).trim();if(d.length===10&&d.match(/^\d{4}-\d{2}-\d{2}$/)){const f=new Date(d+"T00:00:00");n.visitDate=f.toISOString(),a=!0}else if(!d.includes("T")&&!d.includes("Z"))try{const f=new Date(d);isNaN(f.getTime())||(n.visitDate=f.toISOString(),a=!0)}catch{}}if(n.exitDate){const d=String(n.exitDate).trim();if(d.length===10&&d.match(/^\d{4}-\d{2}-\d{2}$/)){const f=new Date(d+"T00:00:00");n.exitDate=f.toISOString(),a=!0}else if(!d.includes("T")&&!d.includes("Z"))try{const f=new Date(d);isNaN(f.getTime())||(n.exitDate=f.toISOString(),a=!0)}catch{}}return n});let i=!1;if(e.clinicMedications=e.clinicMedications.map(n=>{const s=this.normalizeMedicationRecord(n),o=this.calculateMedicationStatus(s),l=n&&(n.quantityAdded!==s.quantityAdded||n.remainingQuantity!==s.remainingQuantity)||typeof n?.quantityAdded!="number"||typeof n?.remainingQuantity!="number";return(s.status!==o.status||s.daysRemaining!==o.daysRemaining||l)&&(i=!0,s.status=o.status,s.daysRemaining=o.daysRemaining),s}),e.clinicInventory=e.clinicMedications,e.sickLeave=e.sickLeave.map(n=>this.normalizeSickLeaveRecord(n)),e.injuries=e.injuries.map(n=>this.normalizeInjuryRecord(n)),AppState.appData=e,typeof window.DataManager<"u"&&window.DataManager.save)try{window.DataManager.save(),AppState.debugMode&&(i||a)&&Utils.safeLog(`\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u064A ensureData (medicationsChanged: ${i}, visitsChanged: ${a})`)}catch(n){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u064A ensureData:",n.message)}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},ensureFilterDefaults(){this.state||(this.state={activeTab:"medications",filters:{}}),this.state.activeTab||(this.state.activeTab="medications");const e={medications:{search:"",status:"all",dateFrom:"",dateTo:""},visits:{search:"",factory:"",position:"",workplace:""},sickLeave:{search:"",department:"",dateFrom:"",dateTo:""},injuries:{search:"",status:"all",department:"",dateFrom:"",dateTo:""},attendance:{search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"}};this.state.filters=this.state.filters||{},Object.keys(e).forEach(t=>{const a=this.state.filters[t]||{};this.state.filters[t]=Object.assign({},e[t],a)}),Array.isArray(this.state.currentInjuryAttachments)||(this.state.currentInjuryAttachments=[])},getCurrentUserSummary(e=null){if(e&&typeof e=="object"&&(e.name||e.id))return e;if(!AppState.currentUser)return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F AppState.currentUser \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F - \u0625\u0631\u062C\u0627\u0639 \u0627\u0644\u0646\u0638\u0627\u0645"),{id:"",name:"\u0627\u0644\u0646\u0638\u0627\u0645",email:"",role:""};const t=(AppState.currentUser.name||AppState.currentUser.displayName||"").toString().trim(),a=(AppState.currentUser.email||"").toString().trim(),i=(AppState.currentUser.id||"").toString().trim();AppState.debugMode&&Utils.safeLog("\u{1F50D} getCurrentUserSummary - name:",t,"email:",a,"id:",i);const n=t||a||i||"\u0627\u0644\u0646\u0638\u0627\u0645";return AppState.debugMode&&n==="\u0627\u0644\u0646\u0638\u0627\u0645"&&Utils.safeWarn('\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: getCurrentUserSummary \u064A\u0639\u064A\u062F "\u0627\u0644\u0646\u0638\u0627\u0645" - AppState.currentUser:',AppState.currentUser),{id:i,name:n,email:a,role:(AppState.currentUser.role||"").toString().trim()}},getMonthlyVisits(){const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),1);return AppState.appData.clinicVisits.filter(a=>new Date(a.visitDate||a.createdAt)>=t).length},calculateTotalTime(e,t){if(!e||!t)return"-";try{const a=e instanceof Date?e:new Date(e),i=t instanceof Date?t:new Date(t);if(isNaN(a.getTime())||isNaN(i.getTime()))return"-";const n=i.getTime()-a.getTime();if(n<0)return"-";const s=Math.floor(n/(1e3*60)),o=Math.floor(s/60),l=s%60;return o>0&&l>0?`${o} \u0633\u0627\u0639\u0629 ${l} \u062F\u0642\u064A\u0642\u0629`:o>0?`${o} \u0633\u0627\u0639\u0629`:l>0?`${l} \u062F\u0642\u064A\u0642\u0629`:"\u0623\u0642\u0644 \u0645\u0646 \u062F\u0642\u064A\u0642\u0629"}catch(a){return Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0633\u0627\u0628 \u0627\u0644\u0648\u0642\u062A:",a,{visitDate:e,exitDate:t}),"-"}},async renderVisitsList(){const e=AppState.appData.clinicVisits.slice(-10).reverse();return e.length===0?'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0645\u0633\u062C\u0644\u0629</p></div>':`
            ...
            <div class="overflow-x-auto">
                <table class="data-table">
                    ...
                    <tbody>
                        ${e.map(t=>{const a=t.employeeCode||t.employeeNumber||"-",i=t.employeeName||t.contractorName||t.externalName||"",n=t.contractorWorkerName?` (${Utils.escapeHTML(t.contractorWorkerName)})`:"",s=t.employeePosition||"-",o=t.employeeLocation||t.workArea||"-",l=t.visitDate?Utils.escapeHTML(Utils.formatDateTime(t.visitDate)):"-",r=t.exitDate?Utils.escapeHTML(Utils.formatDateTime(t.exitDate)):'<span class="text-xs text-gray-500">\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647</span>',c=Clinic.calculateTotalTime(t.visitDate,t.exitDate),d=Utils.escapeHTML(t.reason||""),f=Utils.escapeHTML(t.diagnosis||""),p=Utils.escapeHTML(t.treatment||"");return`
                                <tr>
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&a.remove()})},async showInjuryForm(e=null){Utils.safeLog("\u{1F537} \u062A\u0645 \u0627\u0633\u062A\u062F\u0639\u0627\u0621 showInjuryForm - \u0628\u062F\u0621 \u0641\u062A\u062D \u0627\u0644\u0646\u0645\u0648\u0630\u062C..."),this.ensureData();const t=!!e,a=this;this.state.currentInjuryAttachments=Array.isArray(e?.attachments)?e.attachments.map(T=>this.normalizeAttachment(T)).filter(Boolean):[];const i=document.createElement("div");i.className="modal-overlay";const n=e?.personType||"employee",s=e?.injuryDate?Utils.toDateTimeLocalString(e.injuryDate):"",o=e?.employeeName||e?.personName||"",l=e?.contractorName||"",r=e?.employeeCode||e?.employeeNumber||"",c=e?.employeePosition||e?.contractorPosition||"",d=e?.employeeDepartment||e?.department||"",f=e?.factory||"",p=e?.subLocation||e?.subLocationName||"",u=e?.status||"\u0642\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629",m=this.getInjuryTypeOptions(),g=this.getSiteOptions();i.innerHTML=`
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4" style="background: linear-gradient(135deg, #f8fafc 0%, #eef2ff 100%); padding: 16px; border-radius: 12px;">
                            ...
                            <div>
                                ...
                                <select id="injury-factory" class="form-input">
                                    ...
                                    ${g.map(T=>`<option value="${Utils.escapeHTML(T.id)}" ${f===T.id||f===T.name?"selected":""}>${Utils.escapeHTML(T.name)}</option>`).join("")}
                                </select>
                            </div>
                            <div>
        ...
        `,document.body.appendChild(i);const y=i.querySelector("#injury-form"),v=y.querySelector("#injury-person-type"),b=y.querySelector("#injury-name"),x=y.querySelector("#injury-employee-code"),L=y.querySelector("#injury-code-container"),D=y.querySelector("#injury-contractor-container"),j=y.querySelector("#injury-contractor-name-select"),h=y.querySelector("#injury-employee-name-container"),$=y.querySelector("#injury-contractor-worker-container"),U=y.querySelector("#injury-contractor-worker-name"),_=y.querySelector("#injury-name-label"),C=y.querySelector("#injury-position"),N=y.querySelector("#injury-factory"),w=y.querySelector("#injury-sub-location"),A=y.querySelector("#injury-department"),M=y.querySelector("#injury-dropdown"),I=y.querySelector("#injury-attachments-input"),q=i.querySelector(".modal-close"),B=y.querySelector("#injury-cancel-btn"),P=T=>{if(T){if(b&&(b.value=T.name||""),x){const z=EmployeeHelper.getPrimaryCode(T);z&&(x.value=z)}A&&(A.value=T.department||T.unit||T.section||A.value),C&&(C.value=T.position||T.job||"")}},O=()=>{!x||!b||typeof EmployeeHelper>"u"||(EmployeeHelper.setupEmployeeCodeSearch("injury-employee-code","injury-name",T=>{T&&P(T)}),EmployeeHelper.setupAutocomplete("injury-name",T=>{T&&P(T)}))},S=(T,z=!1)=>{const E=T==="employee",R=T==="contractor",V=T==="external";L&&(L.style.display=E?"block":"none"),D&&(D.style.display=R?"block":"none"),h&&(h.style.display=E?"block":"none"),$&&($.style.display=R||V?"block":"none"),x&&(x.required=E,x.disabled=!E,x.placeholder=E?"\u0623\u062F\u062E\u0644 \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A":"\u0631\u0642\u0645 \u0627\u0644\u062A\u0639\u0631\u064A\u0641 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)",!E&&z&&(x.value="")),_&&(_.textContent=`\u0627\u0633\u0645 ${E?"\u0627\u0644\u0645\u0648\u0638\u0641":T==="contractor"?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"} *`),b&&(b.readOnly=E,b.disabled=!E,b.required=E,b.placeholder=E?"\u0633\u064A\u062A\u0645 \u062A\u0639\u0628\u0626\u0629 \u0627\u0644\u0627\u0633\u0645 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B":`\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 ${T==="contractor"?"\u0627\u0644\u0645\u0648\u0638\u0641 \u0627\u0644\u062A\u0627\u0628\u0639 \u0644\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"}`,z&&!E&&(b.value="")),j&&(j.required=R,j.disabled=!R,R?this.loadContractorsIntoSelect(j):z&&(j.value="")),U&&(U.required=R||V,U.disabled=!(R||V),z&&E&&(U.value=""),V?U.placeholder="\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 \u0627\u0644\u0639\u0627\u0645\u0644 \u0627\u0644\u062E\u0627\u0631\u062C\u064A":R?U.placeholder="\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 \u0627\u0644\u0645\u0635\u0627\u0628 \u0627\u0644\u062A\u0627\u0628\u0639 \u0644\u0644\u0645\u0642\u0627\u0648\u0644":U.placeholder=""),!E&&z&&A&&(A.value=""),!E&&z&&C&&(C.value=""),M&&(M.classList.add("hidden"),M.innerHTML=""),E&&O()};if(S(n,!1),n==="employee"&&typeof EmployeeHelper<"u"&&r){const T=EmployeeHelper.findByTerm(r);T&&P(T)}v.addEventListener("change",()=>{S(v.value,!0)}),j?.addEventListener("input",()=>{v.value!=="contractor"||!(j.value||"").trim()||b.value.trim()||b.focus()}),typeof this.setupClinicWorkplaceDatalist=="function"&&this.setupClinicWorkplaceDatalist("injury-factory","injury-sub-location","injury-sub-location-datalist",{includeFallbackNameMatch:!0}),I?.addEventListener("change",async T=>{await a.handleInjuryAttachmentsChange(T.target.files)}),typeof a.renderInjuryAttachmentsPreview=="function"?a.renderInjuryAttachmentsPreview():Utils.safeWarn("\u26A0\uFE0F renderInjuryAttachmentsPreview \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");const F=()=>{a.state.currentInjuryAttachments=[],i.remove()};q?.addEventListener("click",F),B?.addEventListener("click",F),Utils.safeLog("\u{1F537} \u062A\u0645 \u0625\u0636\u0627\u0641\u0629 event listener \u0644\u0644\u0646\u0645\u0648\u0630\u062C..."),y.addEventListener("submit",async T=>{Utils.safeLog("\u{1F534} \u062A\u0645 \u0627\u0644\u0636\u063A\u0637 \u0639\u0644\u0649 \u0632\u0631 \u0627\u0644\u062D\u0641\u0638! \u0628\u062F\u0621 \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629...");try{T.preventDefault(),T.stopPropagation(),T.stopImmediatePropagation(),Utils.safeLog("\u{1F504} \u0628\u062F\u0621 \u0645\u0639\u0627\u0644\u062C\u0629 \u0646\u0645\u0648\u0630\u062C \u0627\u0644\u0625\u0635\u0627\u0628\u0629...");const z=v.value,E=z==="employee",R=y.querySelector("#injury-date");if(!R.value){Notification.warning("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}const V=Utils.dateTimeLocalToISO(R.value)||new Date().toISOString(),X=e?.createdAt||new Date().toISOString(),K=e?.createdBy||a.getCurrentUserSummary(),ae=a.getCurrentUserSummary(),Z=A?.value.trim()||"",oe=C?.value.trim()||"",ee=j?.value?.trim()||"",te=E?b?.value?.trim()||"":U?.value?.trim()||b?.value?.trim()||"",se=y.querySelector("#injury-type")?.value||"",Y=y.querySelector("#injury-body-part")?.value||"",ne=y.querySelector("#injury-location")?.value?.trim()||"",re=y.querySelector("#injury-description")?.value?.trim()||"",ie=N?.value?.trim()||"",k=w?.value?.trim()||"";if(E&&!te){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644/\u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641");return}if(z==="contractor"&&j){const G=(()=>{try{return JSON.parse(j.dataset.allowedValues||"[]")}catch{return[]}})();if(!ee||!G.includes(ee.toLowerCase().trim())){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644 \u0645\u0646 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0641\u0642\u0637");return}if(!te){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0633\u0645 \u0627\u0644\u0645\u0635\u0627\u0628 \u0627\u0644\u062A\u0627\u0628\u0639 \u0644\u0644\u0645\u0642\u0627\u0648\u0644");return}}if(z==="external"&&!te){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0627\u0633\u0645 \u0627\u0644\u0639\u0627\u0645\u0644 \u0627\u0644\u062E\u0627\u0631\u062C\u064A");return}if(!se){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0646\u0648\u0639 \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}if(!Y){Notification.warning("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0645\u0643\u0627\u0646 \u0627\u0644\u0625\u0635\u0627\u0628\u0629 (\u0628\u0627\u0644\u062C\u0633\u0645)");return}if(!ne){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0645\u0643\u0627\u0646 \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}if(!re){Notification.warning("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0648\u0635\u0641 \u0627\u0644\u0625\u0635\u0627\u0628\u0629");return}let H="";ie&&(H=g.find(J=>J.id===ie||J.name===ie)?.name||"");const W=a.normalizeInjuryRecord({id:e?.id||Utils.generateId("INJURY"),personType:z,employeeName:E?b.value.trim():null,employeeCode:E?x?.value.trim()||"":null,employeeNumber:E?x?.value.trim()||"":null,personName:E?null:te,contractorName:z==="contractor"?ee:null,employeePosition:oe,contractorPosition:E?null:oe,employeeDepartment:Z,department:Z,factory:ie||null,factoryName:H||null,subLocation:k||null,subLocationName:k||null,injuryDate:V,injuryType:se,injuryBodyPart:Y,injuryLocation:ne,injuryDescription:re,actionsTaken:y.querySelector("#injury-actions").value.trim(),treatment:y.querySelector("#injury-treatment").value.trim(),status:y.querySelector("#injury-status").value,attachments:a.state.currentInjuryAttachments.map(G=>({...G})),createdAt:X,createdBy:K,createdById:K?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:ae});Utils.safeLog("\u2705 \u062A\u0645 \u0625\u0646\u0634\u0627\u0621 payload \u0628\u0646\u062C\u0627\u062D:",W),Loading.show();const Q=AppState.appData.injuries||[];if(t){const G=Q.findIndex(J=>J.id===W.id);G!==-1?Q[G]=W:Q.push(W)}else Q.push(W);AppState.appData.injuries=Q;try{a.calculateClinicCardValues(),a.updateClinicAnalysisResults()}catch(G){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0643\u0631\u0648\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 (\u0625\u0635\u0627\u0628\u0629):",G)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B"),Loading.hide(),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0625\u0635\u0627\u0628\u0629 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0625\u0635\u0627\u0628\u0629 \u0628\u0646\u062C\u0627\u062D"),F(),Utils.safeLog("\u2705 \u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C \u0628\u0646\u062C\u0627\u062D"),setTimeout(()=>{try{Utils.safeLog("\u2705 \u0645\u062D\u0627\u0648\u0644\u0629 \u062A\u062D\u062F\u064A\u062B \u0648\u0627\u062C\u0647\u0629 \u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A..."),document.querySelector('.clinic-tab-panel[data-tab-panel="injuries"]')&&a.state.activeTab==="injuries"&&(Utils.safeLog("\u2705 \u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 panel\u060C \u0633\u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062B\u0647"),a.renderInjuriesTab());const J=document.querySelector("#total-injuries");J&&(J.textContent=Q.length)}catch(G){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0648\u0627\u062C\u0647\u0629 \u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A:",G)}},100),(async()=>{try{t?(await GoogleIntegration.sendRequest({action:"updateInjury",data:{injuryId:W.id,updateData:W}}),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A Google Sheets (\u062A\u062D\u062F\u064A\u062B)")):(await GoogleIntegration.sendRequest({action:"addInjury",data:W}),Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A Google Sheets (\u0625\u0636\u0627\u0641\u0629)"))}catch(G){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 Google Sheets:",G)}})()}catch(z){Loading.hide(),Utils.safeError("\u274C \u062E\u0637\u0623 \u0639\u0627\u0645 \u0641\u064A \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0625\u0635\u0627\u0628\u0629:",z),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0625\u0635\u0627\u0628\u0629: "+z.message)}}),i.addEventListener("click",T=>{if(T.target===i){if(!confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`))return;a.state.currentInjuryAttachments=[],i.remove()}})},showVisitForm(e=null,t=null){const a=!!e;if(!document.getElementById("clinic-section")){t&&(t.disabled=!1);return}try{this.ensureData()}catch(o){t&&(t.disabled=!1),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0636\u064A\u0631 \u0646\u0645\u0648\u0630\u062C \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",o);return}typeof Permissions<"u"&&Permissions.ensureFormSettingsState&&Permissions.ensureFormSettingsState().catch(()=>{});const n=document.createElement("div");if(n.className="modal-overlay",n.innerHTML=`
        ...
        `,document.body.appendChild(n),t){const o=new MutationObserver(()=>{document.body.contains(n)||(t.disabled=!1,o.disconnect())});o.observe(document.body,{childList:!0,subtree:!0})}setTimeout(()=>{const o=document.getElementById("visit-person-type"),l=document.getElementById("visit-employee-code"),r=document.getElementById("visit-history-tbody"),c=()=>{if(!r)return;const w=o?.value||"employee",A=l?.value.trim();if(w!=="employee"||!A){r.innerHTML='<tr><td colspan="6" class="text-center text-gray-500 py-4">\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A</td></tr>';return}const M=(AppState.appData.clinicVisits||[]).filter(I=>I.personType==="employee"&&(I.employeeCode===A||I.employeeNumber===A)).sort((I,q)=>new Date(q.visitDate||q.createdAt)-new Date(I.visitDate||I.createdAt)).slice(0,10);M.length===0?r.innerHTML='<tr><td colspan="6" class="text-center text-gray-500 py-4">\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0633\u0627\u0628\u0642\u0629</td></tr>':r.innerHTML=M.map(I=>`
                    ...
                    `).join("")};if(l&&r&&(l.addEventListener("blur",c),l.addEventListener("input",()=>{l.value.trim().length>=3&&c()})),o&&o.addEventListener("change",()=>{const w=document.querySelector("#visit-history-table")?.closest(".mt-6");w&&(w.style.display=o.value==="employee"?"block":"none"),o.value==="employee"&&c()}),e&&e.employeeCode&&c(),e?.personType==="contractor"){const w=document.getElementById("visit-contractor-name-select");w&&(Clinic.loadContractorsIntoSelect(w),(e.employeeName||e.contractorName)&&(w.value=e.employeeName||e.contractorName||""))}typeof Clinic.handlePersonTypeChange=="function"&&Clinic.handlePersonTypeChange(),typeof Clinic.setupClinicWorkplaceDatalist=="function"&&(Clinic.setupClinicWorkplaceDatalist("visit-factory","visit-employee-location","visit-employee-location-datalist"),Clinic.setupClinicWorkplaceDatalist("visit-contractor-factory","visit-work-area","visit-work-area-datalist"));const d=()=>Clinic.refreshVisitReasonSuggestions_(e?.id||"");let f=null;const p=()=>{clearTimeout(f),f=setTimeout(d,180)};["visit-person-type","visit-type","visit-contractor-name-select"].forEach(w=>{document.getElementById(w)?.addEventListener("change",d)}),["visit-employee-code","visit-contractor-worker"].forEach(w=>{const A=document.getElementById(w);A?.addEventListener("input",p),A?.addEventListener("blur",d)}),d();const u=document.getElementById("visit-medication-select"),m=document.getElementById("visit-medications-list"),g=document.getElementById("visit-add-medication-btn"),y=document.getElementById("visit-medication-quantity"),v=document.getElementById("visit-medications-datalist"),b=document.getElementById("visit-type"),x=document.getElementById("visit-treatment"),L=document.getElementById("visit-treatment-medication-mode"),D=document.getElementById("visit-treatment-medication-select"),j=document.getElementById("visit-treatment-medications-datalist");let h=e?.medications&&Array.isArray(e.medications)?[...e.medications]:[];const $=()=>this.getMedications().filter(w=>(parseInt(w.remainingQuantity??w.quantity??0,10)||0)>0),U=()=>{if(!D||!j)return;const w={};j.innerHTML=$().map(A=>{const M=parseInt(A.remainingQuantity??A.quantity??0,10)||0,I=String(A.name||A.medicationName||"").trim();if(!I)return"";const q=`${I} (\u0645\u062A\u0648\u0641\u0631: ${M})`;return w[this.normalizeArabicText(I)]={id:A.id||"",name:I,label:q},`<option value="${Utils.escapeHTML(q)}"></option>`}).join(""),D.dataset.medicationMap=JSON.stringify(w)},_=()=>{const w=this.isMedicationDispenseVisitType_(b?.value||"");x&&(x.style.display=w?"none":"block"),L&&(L.style.display=w?"block":"none"),w&&(U(),D&&h.length>0&&(D.value=h.map(A=>A.medicationName).filter(Boolean).join("\u060C ")))},C=()=>{if(!u||!v)return;const w=this.getMedications().filter(M=>(M.remainingQuantity??M.quantity??0)<=0?!1:!h.some(B=>B.medicationId===M.id)),A={};v.innerHTML=w.map(M=>{const I=M.remainingQuantity??M.quantity??0,q=String(M.name||M.medicationName||"").trim(),B=`${q} (\u0645\u062A\u0648\u0641\u0631: ${I})`,P=q.toLowerCase().trim();return P&&(A[P]=M.id),`<option value="${Utils.escapeHTML(B)}"></option>`}).join(""),u.dataset.nameToId=JSON.stringify(A),u.dataset.selectedId=""},N=()=>{if(m){if(h.length===0){m.innerHTML="",this.isMedicationDispenseVisitType_(b?.value||"")&&x&&(x.value="");return}m.innerHTML=h.map((w,A)=>{const M=this.getMedications().find(I=>I.id===w.medicationId);return`
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&a.remove()})},async viewVisit(e){this.ensureData();const t=AppState.appData.clinicVisits.find(f=>f.id===e);if(!t)return;t.createdBy||(t.createdBy=null),t.updatedBy||(t.updatedBy=null);const a=t.personType==="employee"?"\u0645\u0648\u0638\u0641":t.personType==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0639\u0645\u0627\u0644\u0629 \u062E\u0627\u0631\u062C\u064A\u0629",i=t.personType==="employee"?"\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0638\u0641":t.personType==="contractor"?"\u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0633\u0645 \u0627\u0644\u062C\u0647\u0629",n=t.employeeName||t.contractorName||t.externalName||"",s=(t.personType==="contractor"||t.personType==="external")&&t.contractorWorkerName?`
                        ...
                        <div class="form-section" style="background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%); padding: 25px; border-radius: 15px; box-shadow: 0 8px 16px rgba(0,0,0,0.1);">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div style="background: white; padding: 15px; border-radius: 10px; border: 2px solid #fc6c85;">
                                    ...
                                    <p style="color: #1e293b; font-size: 16px; font-weight: 600; margin: 0;">${(()=>{if(!t.createdBy)return"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F";if(typeof t.createdBy=="object")return Utils.escapeHTML(t.createdBy.name||t.createdBy.email||t.createdBy.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F");const f=String(t.createdBy).trim();if(f==="\u0627\u0644\u0646\u0638\u0627\u0645"||f===""){const p=(t.email||"").toString().trim();if(p&&p!=="")return Utils.escapeHTML(p);const u=(AppState.currentUser?.email||"").toString().trim();return u&&u!==""?Utils.escapeHTML(u):"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}return Utils.escapeHTML(f)})()}</p>
                                </div>
                            </div>
                        </div>
        ...
        `,document.body.appendChild(d),typeof EmailDispatch<"u"&&EmailDispatch.bindFooterButtons(d,{moduleKey:"clinic.visit",record:t,recordId:t.id||""}),d.addEventListener("click",f=>{f.target===d&&confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0627\u0641\u0630\u0629.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&d.remove()})},printVisitsList(){const e=AppState.appData.clinicVisits.slice().reverse();if(e.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const a=`
            ...
            <body>
                ...
                <table>
                    ...
                    <tbody>
                        ${e.map(n=>{const s=n.employeeCode||n.employeeNumber||"-",o=n.employeeName||n.contractorName||n.externalName||"",l=n.contractorWorkerName?` (${n.contractorWorkerName})`:"",r=n.employeePosition||"-",c=n.employeeLocation||n.workArea||"-",d=n.visitDate?Utils.formatDateTime(n.visitDate):"-",f=n.exitDate?Utils.formatDateTime(n.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",p=Clinic.calculateTotalTime(n.visitDate,n.exitDate),u=n.reason||"",m=n.diagnosis||"",g=n.treatment||"";return`
                <tr>
                    <td>${s}</td>
                    <td>${o}${l}</td>
                    <td>${r}</td>
        ...
        `,i=window.open("","_blank");i&&(i.document.write(a),i.document.close(),i.onload=()=>{setTimeout(()=>{i.print(),Notification.success("\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u0633\u062C\u0644\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629")},250)})},exportVisitsToExcel(){this.ensureData();const e=this.state.activeVisitType||"employees",t=e==="contractors",a=(AppState.appData.clinicVisits||[]).slice().reverse(),i=a.filter(o=>this.isEmployeeVisit_(o)),n=a.filter(o=>this.isContractorVisit_(o)),s=e==="employees"?i:n;if(s.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}if(typeof XLSX>"u"){Notification.error("\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629");return}try{const o=s.map(d=>{const f=t?d.contractorName||d.employeeName||d.externalName||"-":d.employeeCode||d.employeeNumber||"-",p=t?d.contractorWorkerName||"-":d.employeeName||"-",u=d.employeePosition||d.contractorPosition||"-",m=this.getVisitFactoryDisplayName(d),g=t?d.workArea||d.employeeLocation||"-":d.employeeLocation||d.workArea||"-",y=d.visitDate?Utils.formatDateTime(d.visitDate):"-",v=d.exitDate?Utils.formatDateTime(d.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",b=this.calculateTotalTime(d.visitDate,d.exitDate),x=d.reason||"",L=d.diagnosis||"",D=this.normalizeVisitMedications(d.medications),j=D.length>0?D.map(U=>`${U.medicationName||""} (${U.quantity||1})`).join("\u060C "):"-",h=D.length>0?D.reduce((U,_)=>U+(parseInt(_.quantity,10)||0),0):0,$={};return $[t?"\u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A"]=f,$.\u0627\u0644\u0627\u0633\u0645=p,$.\u0627\u0644\u0648\u0638\u064A\u0641\u0629=u,$.\u0627\u0644\u0645\u0635\u0646\u0639=m,$["\u0645\u0643\u0627\u0646 \u0627\u0644\u0639\u0645\u0644"]=g,$["\u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644"]=y,$["\u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C"]=v,$["\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0648\u0642\u062A"]=b,$["\u0633\u0628\u0628 \u0627\u0644\u0632\u064A\u0627\u0631\u0629"]=x,$.\u0627\u0644\u062A\u0634\u062E\u064A\u0635=L,$["\u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629"]=j,$["\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629"]=h,$}),l=XLSX.utils.book_new(),r=XLSX.utils.json_to_sheet(o);r["!cols"]=[{wch:18},{wch:25},{wch:20},{wch:16},{wch:20},{wch:20},{wch:20},{wch:15},{wch:25},{wch:25},{wch:30},{wch:14}],XLSX.utils.book_append_sheet(l,r,`\u0633\u062C\u0644\u0627\u062A_${t?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646":"\u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646"}`);const c=`\u0633\u062C\u0644\u0627\u062A_\u0627\u0644\u0632\u064A\u0627\u0631\u0629_${t?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646":"\u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646"}_\u0627\u0644\u0639\u064A\u0627\u062F\u0629_\u0627\u0644\u0637\u0628\u064A\u0629_${new Date().toISOString().slice(0,10)}.xlsx`;XLSX.writeFile(l,c),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0633\u062C\u0644\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0625\u0644\u0649 Excel \u0628\u0646\u062C\u0627\u062D")}catch(o){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 Excel:",o),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 Excel: "+o.message)}},async exportVisitsToPDF(){this.ensureData();const e=this.state.activeVisitType||"employees",t=e==="contractors",a=(AppState.appData.clinicVisits||[]).slice().reverse(),i=a.filter(o=>this.isEmployeeVisit_(o)),n=a.filter(o=>this.isContractorVisit_(o)),s=e==="employees"?i:n;if(s.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}try{const o=s.map(m=>{const g=t?m.contractorName||m.employeeName||m.externalName||"-":m.employeeCode||m.employeeNumber||"-",y=t?m.contractorWorkerName||"-":m.employeeName||"-",v=t?m.contractorPosition||m.employeePosition||"-":m.employeePosition||"-",b=this.getVisitFactoryDisplayName(m),x=t?m.workArea||m.employeeLocation||"-":m.employeeLocation||m.workArea||"-",L=m.visitDate?Utils.formatDateTime(m.visitDate):"-",D=m.exitDate?Utils.formatDateTime(m.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",j=Clinic.calculateTotalTime(m.visitDate,m.exitDate),h=m.reason||"",$=m.diagnosis||"",U=this.normalizeVisitMedications(m.medications),_=U.length>0?U.map(N=>`${Utils.escapeHTML(N.medicationName||"")} (${N.quantity||1})`).join("\u060C "):"-",C=U.length>0?U.reduce((N,w)=>N+(parseInt(w.quantity,10)||0),0):0;return`
            ...
            `,d=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(l,r,c,!1,!0,{source:"ClinicVisits"},new Date().toISOString(),new Date().toISOString()):`<html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>${r}</title></head><body>${c}</body></html>`,f=new Blob([d],{type:"text/html;charset=utf-8"}),p=URL.createObjectURL(f),u=window.open(p,"_blank");u?u.onload=()=>{setTimeout(()=>{u.print(),setTimeout(()=>{URL.revokeObjectURL(p)},1e3),Notification.success("\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u0633\u062C\u0644\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629/\u0627\u0644\u062D\u0641\u0638 \u0643\u0640 PDF")},250)}:(URL.revokeObjectURL(p),Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF"))}catch(o){URL.revokeObjectURL(url),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF:",o),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF: "+o.message)}},async exportVisitToPDF(e){if(!e){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}try{const t=e.personType==="employee"?"\u0645\u0648\u0638\u0641":e.personType==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0639\u0645\u0627\u0644\u0629 \u062E\u0627\u0631\u062C\u064A\u0629",a=e.employeeCode||e.employeeNumber||"-",i=e.employeeName||e.contractorName||e.externalName||"",n=e.contractorWorkerName?` (${e.contractorWorkerName})`:"",s=e.employeePosition||e.contractorPosition||"-",o=e.employeeLocation||e.workArea||"-",l=e.visitDate?Utils.formatDateTime(e.visitDate):"-",r=e.exitDate?Utils.formatDateTime(e.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",c=this.calculateTotalTime(e.visitDate,e.exitDate),d=e.reason||"",f=e.diagnosis||"",p=e.treatment||"",u=e.medications&&Array.isArray(e.medications)&&e.medications.length>0?e.medications.map(D=>`${Utils.escapeHTML(D.medicationName||"")} (${D.quantity||1})`).join("\u060C "):"\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629",m=`CLINIC-VISIT-${e.id||new Date().toISOString().slice(0,10)}`,g="\u062A\u0642\u0631\u064A\u0631 \u0632\u064A\u0627\u0631\u0629 \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0637\u0628\u064A\u0629",y=`
                <div style="margin-bottom: 20px;">
            ...
            `,v=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(m,g,y,!1,!0,{source:"ClinicVisit"},e.visitDate||e.createdAt||new Date().toISOString(),e.updatedAt||e.createdAt||new Date().toISOString()):`<html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>${g}</title></head><body>${y}</body></html>`,b=new Blob([v],{type:"text/html;charset=utf-8"}),x=URL.createObjectURL(b),L=window.open(x,"_blank");L?L.onload=()=>{setTimeout(()=>{L.print(),setTimeout(()=>{URL.revokeObjectURL(x)},1e3),Notification.success("\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u062A\u0642\u0631\u064A\u0631 \u0644\u0644\u0637\u0628\u0627\u0639\u0629/\u0627\u0644\u062D\u0641\u0638 \u0643\u0640 PDF")},250)}:(URL.revokeObjectURL(x),Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF"))}catch(t){URL.revokeObjectURL(url),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 \u062A\u0642\u0631\u064A\u0631 \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",t),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u062A\u0642\u0631\u064A\u0631: "+t.message)}},getClinicWorkflowStyles_(){return`<style>
            ...
            <div class="cw-table-scroll clinic-table-wrapper">
                <table class="cw-table">
                    ...
                    <tbody>
                        ${e.map((a,i)=>{const n=a.approvalKind||a.requestType||"deletion",s=n==="deletion",o=n==="supply",l=n==="visit",r=this._isApprovalTimeOffRequest(a);let c="-",d="-",f="";if(s){const y=a.medicationData||{};c=y.name||"-",d=y.type||"-",f=`\u0627\u0644\u062F\u0648\u0627\u0621: ${c}`}else if(o){c=a.itemName||"-";const y={medication:"\u0623\u062F\u0648\u064A\u0629",equipment:"\u0623\u062C\u0647\u0632\u0629 \u0637\u0628\u064A\u0629",supplies:"\u0645\u0633\u062A\u0644\u0632\u0645\u0627\u062A \u0637\u0628\u064A\u0629",other:"\u0623\u062E\u0631\u0649"}[a.type]||a.type||"-";d=y,f=`${y}: ${c} (${a.quantity||""} ${a.unit||""})`,a.type==="medication"&&a.currentBalanceAtRequest!==null&&a.currentBalanceAtRequest!==void 0&&(f+=` \u2022 \u0627\u0644\u0631\u0635\u064A\u062F \u0648\u0642\u062A \u0627\u0644\u0637\u0644\u0628: ${a.currentBalanceAtRequest} ${a.unit||"\u0648\u062D\u062F\u0629"}`)}else if(l){const y=a.visitData||{},v=y.employeeName||y.contractorWorkerName||y.contractorName||y.externalName||"-",b=y.personType==="employee"?"\u0645\u0648\u0638\u0641":y.personType==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0639\u0645\u0627\u0644\u0629 \u062E\u0627\u0631\u062C\u064A\u0629";c=v,d=b,f=`\u0632\u064A\u0627\u0631\u0629: ${v} (${b})`}else r&&(c=a.userName||a.userEmail||"-",d=this.getTimeOffRequestTypeLabel(a.requestType),f=`${d}: ${this.formatTimeOffRequestDetails(a)}`);const p=r?{name:a.userName||a.userEmail||"-"}:a.requestedBy||{},u=this.getApprovalStatusBadge(a.status),m=a.status==="pending",g=s?'<span class="badge badge-info">\u062D\u0630\u0641 \u062F\u0648\u0627\u0621</span>':o?'<span class="badge badge-primary">\u0637\u0644\u0628 \u0627\u062D\u062A\u064A\u0627\u062C</span>':r?'<span class="badge badge-success">\u0625\u062C\u0627\u0632\u0629/\u0625\u0630\u0646/\u0625\u0636\u0627\u0641\u064A</span>':'<span class="badge badge-warning">\u062D\u0630\u0641 \u0632\u064A\u0627\u0631\u0629</span>';return`
                <tr>
                    <td class="text-center"><span class="cw-serial">${i+1}</span></td>
                    <td>${g}</td>
                    <td><div class="cw-main-cell"><span class="cw-cell-icon"><i class="${o?"fas fa-box-open":r?"fas fa-user-clock":l?"fas fa-user-minus":"fas fa-pills"}"></i></span><div><strong>${Utils.escapeHTML(c)}</strong><small>${Utils.escapeHTML(f)}</small></div></div></td>
...
\u0633\u064A\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F.`)){Loading.show();try{const r={id:AppState.currentUser?.id||"",name:AppState.currentUser?.name||"",email:AppState.currentUser?.email||"",role:AppState.currentUser?.role||""};let c;if(a?c=await GoogleIntegration.sendRequest({action:"approveMedicationDeletion",data:{requestId:e,approverData:r}}):i?c=await GoogleIntegration.sendRequest({action:"approveSupplyRequest",data:{requestId:e,approverData:r,__timeoutMs:this._supplyRequestActionTimeoutMs}}):n?c=await GoogleIntegration.sendRequest({action:"approveClinicVisitDeletion",data:{requestId:e,approverData:r}}):s&&(c=await GoogleIntegration.sendRequest({action:"approveClinicStaffTimeOffRequest",data:{requestId:e,notes:""}})),c&&c.success){if(Loading.hide(),i&&Array.isArray(AppState.appData.clinicSupplyRequests)){const f=AppState.appData.clinicSupplyRequests.find(p=>String(p.id)===String(e));f&&Object.assign(f,{status:"approved",approvedBy:r,approvedById:r.id||r.email||"",approvedAt:new Date().toISOString()})}const d=a?"\u062A\u0645\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628 \u0648\u062D\u0630\u0641 \u0627\u0644\u062F\u0648\u0627\u0621 \u0628\u0646\u062C\u0627\u062D":i?"\u062A\u0645\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628 \u0628\u0646\u062C\u0627\u062D":s?"\u062A\u0645\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0637\u0644\u0628 \u0627\u0644\u0625\u062C\u0627\u0632\u0629/\u0627\u0644\u0625\u0630\u0646/\u0627\u0644\u0625\u0636\u0627\u0641\u064A":"\u062A\u0645\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0628\u0646\u062C\u0627\u062D";if(Notification.success(d),s)try{const f=await GoogleIntegration.sendRequest({action:"getClinicStaffTimeOffRequests",data:{}});f?.success&&Array.isArray(f.data)&&(AppState.appData.clinicStaffTimeOffRequests=f.data),this._leaveBalancesFetchedInSession=!1,await this.loadClinicStaffLeaveBalances(!0),this._leaveBalancesFetchedInSession=!0}catch{}(i||s)&&typeof UI<"u"&&typeof UI.updateNotificationsBadge=="function"&&UI.updateNotificationsBadge(),setTimeout(()=>{this.renderApprovalsTab()},100),a&&(async()=>{try{const f=await GoogleIntegration.sendRequest({action:"getAllMedications",data:{}});if(f&&f.success&&Array.isArray(f.data)){const p=Array.isArray(AppState.appData.clinicMedications)&&AppState.appData.clinicMedications.length?AppState.appData.clinicMedications:Array.isArray(AppState.appData.medications)?AppState.appData.medications:[];f.data.length===0&&p.length>0?Utils.safeWarn("\u26A0\uFE0F \u062A\u062C\u0627\u0647\u0644 \u0642\u0627\u0626\u0645\u0629 \u0623\u062F\u0648\u064A\u0629 \u0641\u0627\u0631\u063A\u0629 \u0628\u0639\u062F \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u2014 \u0627\u0644\u0625\u0628\u0642\u0627\u0621 \u0639\u0644\u0649 \u0627\u0644\u0645\u062D\u0644\u064A"):(AppState.appData.medications=f.data,AppState.appData.clinicMedications=f.data,AppState.appData.clinicInventory=f.data,typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save())}}catch(f){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",f)}})()}else throw new Error(c.message||"\u0641\u0634\u0644\u062A \u0627\u0644\u0639\u0645\u0644\u064A\u0629")}catch(r){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629 \u0639\u0644\u0649 \u0627\u0644\u0637\u0644\u0628:",r),Notification.error("\u0641\u0634\u0644\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629: "+(r.message||"\u062D\u062F\u062B \u062E\u0637\u0623"))}}},async rejectRequest(e,t="deletion"){const a=prompt("\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0633\u0628\u0628 \u0627\u0644\u0631\u0641\u0636 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A):");if(a!==null){Loading.show();try{const i={id:AppState.currentUser?.id||"",name:AppState.currentUser?.name||"",email:AppState.currentUser?.email||"",role:AppState.currentUser?.role||""};let n;if(t==="deletion"?n=await GoogleIntegration.sendRequest({action:"rejectMedicationDeletion",data:{requestId:e,rejectorData:i,reason:a||"\u0644\u0645 \u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062F \u0633\u0628\u0628"}}):t==="supply"?n=await GoogleIntegration.sendRequest({action:"rejectSupplyRequest",data:{requestId:e,rejectorData:i,__timeoutMs:this._supplyRequestActionTimeoutMs,reason:a||"\u0644\u0645 \u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062F \u0633\u0628\u0628"}}):t==="visit"?n=await GoogleIntegration.sendRequest({action:"rejectClinicVisitDeletion",data:{requestId:e,rejectorData:i,reason:a||"\u0644\u0645 \u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062F \u0633\u0628\u0628"}}):t==="timeoff"&&(n=await GoogleIntegration.sendRequest({action:"rejectClinicStaffTimeOffRequest",data:{requestId:e,reason:a||"\u0644\u0645 \u064A\u062A\u0645 \u062A\u062D\u062F\u064A\u062F \u0633\u0628\u0628"}})),n&&n.success){if(Loading.hide(),t==="supply"&&Array.isArray(AppState.appData.clinicSupplyRequests)){const s=AppState.appData.clinicSupplyRequests.find(o=>String(o.id)===String(e));s&&Object.assign(s,{status:"rejected",rejectedBy:i,rejectedById:i.id||i.email||"",rejectedAt:new Date().toISOString(),rejectionReason:a||""})}if(Notification.success("\u062A\u0645 \u0631\u0641\u0636 \u0627\u0644\u0637\u0644\u0628 \u0628\u0646\u062C\u0627\u062D"),t==="timeoff")try{const s=await GoogleIntegration.sendRequest({action:"getClinicStaffTimeOffRequests",data:{}});s?.success&&Array.isArray(s.data)&&(AppState.appData.clinicStaffTimeOffRequests=s.data)}catch{}(t==="supply"||t==="timeoff")&&typeof UI<"u"&&typeof UI.updateNotificationsBadge=="function"&&UI.updateNotificationsBadge(),setTimeout(()=>{this.renderApprovalsTab()},100)}else throw new Error(n.message||"\u0641\u0634\u0644\u062A \u0627\u0644\u0639\u0645\u0644\u064A\u0629")}catch(i){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0631\u0641\u0636 \u0627\u0644\u0637\u0644\u0628:",i),Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0631\u0641\u0636: "+(i.message||"\u062D\u062F\u062B \u062E\u0637\u0623"))}}},async viewRequestDetails(e,t="deletion"){try{let a;if(t==="deletion"?a=await GoogleIntegration.sendRequest({action:"getAllMedicationDeletionRequests",data:{filters:{}}}):t==="supply"?a=await GoogleIntegration.sendRequest({action:"getAllSupplyRequests",data:{filters:{}}}):t==="visit"?a=await GoogleIntegration.sendRequest({action:"getAllClinicVisitDeletionRequests",data:{filters:{}}}):t==="timeoff"&&(a=await GoogleIntegration.sendRequest({action:"getClinicStaffTimeOffRequests",data:{filters:{}}})),!a||!a.success){Notification.error("\u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u062A\u0641\u0627\u0635\u064A\u0644 \u0627\u0644\u0637\u0644\u0628");return}const i=a.data.find(y=>y.id===e);if(!i){Notification.error("\u0627\u0644\u0637\u0644\u0628 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}const n=t==="deletion",s=t==="visit",o=t==="timeoff",l=o?{name:i.userName||i.userEmail||"-"}:i.requestedBy||{},r=i.approvedBy||{},c=i.rejectedBy||{};let d="";if(n){const y=i.medicationData||{};d=`
                ...
                `}else if(s){const y=i.visitData||{},v=y.employeeName||y.contractorWorkerName||y.contractorName||y.externalName||"-",b=y.personType==="employee"?"\u0645\u0648\u0638\u0641":y.personType==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0639\u0645\u0627\u0644\u0629 \u062E\u0627\u0631\u062C\u064A\u0629",x=y.visitDate?Utils.formatDateTime(y.visitDate):"-",L=y.exitDate?Utils.formatDateTime(y.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647";d=`
                    <div>
                ...
                `}const f=n?"\u0637\u0644\u0628 \u062D\u0630\u0641 \u062F\u0648\u0627\u0621":s?"\u0637\u0644\u0628 \u062D\u0630\u0641 \u0632\u064A\u0627\u0631\u0629":o?`\u0637\u0644\u0628 ${this.getTimeOffRequestTypeLabel(i.requestType)}`:"\u0637\u0644\u0628 \u0627\u062D\u062A\u064A\u0627\u062C\u0627\u062A \u0637\u0628\u064A\u0629",p=String(i.status||"pending").toLowerCase(),u={pending:"\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629",approved:"\u062A\u0645\u062A \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629",rejected:"\u0645\u0631\u0641\u0648\u0636",fulfilled:"\u062A\u0645 \u0627\u0644\u062A\u0646\u0641\u064A\u0630"}[p]||i.status||"\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629",m=i.id||i.requestId||"-",g=document.createElement("div");g.className="modal-overlay",g.innerHTML=`
                <style>
                    ...
                    <header class="cad-header">
                        <div class="cad-head-main">
                            <div class="cad-title-wrap">
                                ...
                                <div><p class="cad-eyebrow">\u0633\u062C\u0644 \u0627\u0644\u0627\u0639\u062A\u0645\u0627\u062F \u0627\u0644\u0637\u0628\u064A</p><h2 id="clinic-approval-detail-title" class="cad-title">\u062A\u0641\u0627\u0635\u064A\u0644 \u0637\u0644\u0628 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629</h2><p class="cad-subtitle">${Utils.escapeHTML(f)} \xB7 \u0631\u0642\u0645 ${Utils.escapeHTML(String(m))}</p></div>
                            </div>
                            <button class="cad-close modal-close" type="button" aria-label="\u0625\u063A\u0644\u0627\u0642"><i class="fas fa-times"></i></button>
                        </div>
                        <div class="cad-meta"><span class="cad-chip cad-status--${Utils.escapeHTML(p)}"><i class="fas fa-circle-check"></i>${Utils.escapeHTML(u)}</span><span class="cad-chip"><i class="far fa-calendar-alt"></i>${Utils.escapeHTML(this.formatDate(i.createdAt||i.requestDate,!0))}</span></div>
                    </header>
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&g.remove()})}catch(a){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0639\u0631\u0636 \u062A\u0641\u0627\u0635\u064A\u0644 \u0627\u0644\u0637\u0644\u0628:",a),Notification.error("\u0641\u0634\u0644 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u062A\u0641\u0627\u0635\u064A\u0644")}},refreshOnLanguageChange(){if(this.state&&this.state.initialized)try{this.renderActiveTabContent()}catch(e){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u0625\u0639\u0627\u062F\u0629 \u0639\u0631\u0636 \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0639\u0646\u062F \u062A\u063A\u064A\u064A\u0631 \u0627\u0644\u0644\u063A\u0629:",e)}},async load(){typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u{1F504} \u062A\u062D\u0645\u064A\u0644 \u0645\u062F\u064A\u0648\u0644 \u0627\u0644\u0639\u064A\u0627\u062F\u0629...");const e=document.getElementById("clinic-section");if(!e){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u0642\u0633\u0645 clinic-section \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A \u0627\u0644\u0635\u0641\u062D\u0629");return}if(typeof AppState>"u"){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C AppState \u063A\u064A\u0631 \u0645\u0639\u0631\u0651\u0641 - \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629"),e.innerHTML='<div class="content-card"><div class="card-body"><p class="text-red-600">\u0644\u0645 \u064A\u062A\u0645 \u062A\u0647\u064A\u0626\u0629 \u0627\u0644\u062A\u0637\u0628\u064A\u0642 \u0628\u0634\u0643\u0644 \u0635\u062D\u064A\u062D. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629.</p></div></div>';return}if(AppState.appData||(AppState.appData={}),typeof Permissions<"u"&&typeof Permissions.ensureFormSettingsState=="function")try{Permissions.ensureFormSettingsState().catch(()=>{})}catch{}this.injectTableScrollbarStyles(),this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{typeof AppState<"u"&&AppState._languageRefresh||this.refreshOnLanguageChange()}),window.addEventListener("storage",t=>{t.key==="language"&&t.newValue!==t.oldValue&&this.refreshOnLanguageChange()}),this._languageChangeListenerAdded=!0),this._syncCompletedListenerAdded||(window.addEventListener("syncDataCompleted",t=>{const{sheets:a}=t.detail||{};a&&(a.includes("ClinicVisits")||a.includes("ClinicContractorVisits")||a.includes("clinicVisits"))&&(this.ensureData(),this.state&&this.state.activeTab==="visits"&&(this.scheduleVisitsTabRender(!1,0),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B \u0628\u0639\u062F \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629")))}),this._syncCompletedListenerAdded=!0);try{this.ensureData();const t=localStorage.getItem("clinic_last_sync"),a=t?Date.now()-parseInt(t):1/0,i=600*1e3,n=this.hasValidLocalData(),s=!this.state.initialized;this.renderUI(),this._userNeedsClinicStaffForAttendance()&&!this.isActiveClinicStaffMember()&&this._ensureClinicStaffLoadedForAttendance().then(r=>{r&&this._refreshAttendanceTabNavAfterStaffLoad()}).catch(()=>{}),this.isCurrentUserAdmin()&&this.prefetchClinicAttendanceForAdminIfNeeded(!1).catch(()=>{});const o=s||!n||a>=i,l=typeof AppState<"u"&&AppState._languageRefresh===!0;o&&!l?(Utils.safeLog("\u{1F504} \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A (\u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629)..."),Utils.promiseWithTimeout(this.syncDataFromServer(),13e4,"\u0627\u0646\u062A\u0647\u062A \u0645\u0647\u0644\u0629 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A").then(()=>{if(this.ensureData(),this.renderUI(),this.state&&this.state.activeTab==="visits"&&this.scheduleVisitsTabRender(!1,0),this.state?.activeTab==="attendance"&&this.canAccessAttendanceTab()&&this.scheduleAttendanceTabRender(0),typeof Utils<"u"&&Utils.safeLog&&AppState.appData){const r=(AppState.appData.clinicVisits||[]).length,c=(AppState.appData.clinicMedications||AppState.appData.medications||[]).length;Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0645\u062F\u064A\u0648\u0644 \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0628\u0646\u062C\u0627\u062D: ${r} \u0632\u064A\u0627\u0631\u0629\u060C ${c} \u062F\u0648\u0627\u0621`)}}).catch(r=>{typeof Utils<"u"&&Utils.safeWarn&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0628\u0639\u0636 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",r&&r.message)}).finally(()=>{this.state.initialized=!0})):l?(Utils.safeLog("\u{1F310} \u062A\u062D\u062F\u064A\u062B \u0648\u0627\u062C\u0647\u0629 \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0628\u0639\u062F \u062A\u063A\u064A\u064A\u0631 \u0627\u0644\u0644\u063A\u0629 (\u0628\u062F\u0648\u0646 \u0645\u0632\u0627\u0645\u0646\u0629 \u0634\u0628\u0643\u0629)"),this.ensureData(),this.renderUI(),this.state.initialized=!0):(Utils.safeLog("\u2705 \u0639\u0631\u0636 \u0627\u0644\u0648\u0627\u062C\u0647\u0629 \u0628\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0641\u0648\u0638\u0629 \u0645\u062D\u0644\u064A\u0627\u064B - \u062A\u062D\u062F\u064A\u062B \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629"),this.syncDataInBackground(),this.state.initialized=!0)}catch(t){Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0645\u062F\u064A\u0648\u0644 \u0627\u0644\u0639\u064A\u0627\u062F\u0629:",t),this.hasValidLocalData()&&(this.renderUI(),Utils.safeLog("\u2705 \u062A\u0645 \u0639\u0631\u0636 \u0627\u0644\u0648\u0627\u062C\u0647\u0629 \u0628\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629 \u0631\u063A\u0645 \u0648\u062C\u0648\u062F \u062E\u0637\u0623")),this.state.initialized||Notification?.error?.("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629")}finally{Loading.hide()}},hasValidLocalData(){const e=AppState.appData;if(!e)return!1;const t=e.medications||e.clinicMedications||[],a=e.sickLeave||[],i=e.injuries||[],n=e.clinicVisits||[];return t.length>0||a.length>0||i.length>0||n.length>0},async syncDataFromServer(){const e=[],i=(n,s,o)=>Utils.promiseWithTimeout(n,s,()=>new Error(`Request timeout for ${o}`));e.push(i(GoogleIntegration.sendRequest({action:"getAllMedications",data:{}}),45e3,"medications").then(n=>{if(n&&n.success&&Array.isArray(n.data)){const s=Array.isArray(AppState.appData.clinicMedications)&&AppState.appData.clinicMedications.length?AppState.appData.clinicMedications:Array.isArray(AppState.appData.medications)?AppState.appData.medications:[];if(n.data.length===0&&s.length>0){Utils.safeWarn("\u26A0\uFE0F \u062A\u062C\u0627\u0647\u0644 \u0642\u0627\u0626\u0645\u0629 \u0623\u062F\u0648\u064A\u0629 \u0641\u0627\u0631\u063A\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645 \u2014 \u0627\u0644\u0625\u0628\u0642\u0627\u0621 \u0639\u0644\u0649 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629");return}const o=n.data.map(l=>this.normalizeMedicationRecord(l));AppState.appData.medications=o,AppState.appData.clinicMedications=o,AppState.appData.clinicInventory=o,Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${n.data.length} \u062F\u0648\u0627\u0621`)}}).catch(n=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629:",n.message)})),e.push(i(GoogleIntegration.sendRequest({action:"getAllSickLeaves",data:{}}),45e3,"sickLeave").then(n=>{if(n&&n.success&&Array.isArray(n.data)){const s=Array.isArray(AppState.appData.sickLeave)?AppState.appData.sickLeave:[];if(n.data.length===0&&s.length>0){Utils.safeWarn("\u26A0\uFE0F \u062A\u062C\u0627\u0647\u0644 \u0625\u062C\u0627\u0632\u0627\u062A \u0645\u0631\u0636\u064A\u0629 \u0641\u0627\u0631\u063A\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645 \u2014 \u0627\u0644\u0625\u0628\u0642\u0627\u0621 \u0639\u0644\u0649 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629");return}AppState.appData.sickLeave=n.data,Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${n.data.length} \u0625\u062C\u0627\u0632\u0629 \u0645\u0631\u0636\u064A\u0629`)}}).catch(n=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0631\u0636\u064A\u0629:",n.message)})),e.push(i(GoogleIntegration.sendRequest({action:"getAllInjuries",data:{}}),45e3,"injuries").then(n=>{if(n&&n.success&&Array.isArray(n.data)){const s=Array.isArray(AppState.appData.injuries)?AppState.appData.injuries:[];if(n.data.length===0&&s.length>0){Utils.safeWarn("\u26A0\uFE0F \u062A\u062C\u0627\u0647\u0644 \u0625\u0635\u0627\u0628\u0627\u062A \u0641\u0627\u0631\u063A\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645 \u2014 \u0627\u0644\u0625\u0628\u0642\u0627\u0621 \u0639\u0644\u0649 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629");return}AppState.appData.injuries=n.data,Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${n.data.length} \u0625\u0635\u0627\u0628\u0629`)}}).catch(n=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A:",n.message)})),this.shouldFetchClinicVisitsFromBackend()?e.push(i(this.loadVisitsDataFromBackend(),12e4,"clinicVisits").then(()=>{const n=AppState.appData.clinicVisits||[];Utils.safeLog(`\u2705 \u0645\u0632\u0627\u0645\u0646\u0629 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F: ${n.length} \u0632\u064A\u0627\u0631\u0629 (${n.filter(s=>s.personType==="employee"||!s.personType).length} \u0645\u0648\u0638\u0641\u060C ${n.filter(s=>s.personType==="contractor").length} \u0645\u0642\u0627\u0648\u0644)`)}).catch(n=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F:",n.message)})):AppState.debugMode&&Utils.safeLog("\u2139\uFE0F \u062A\u062E\u0637\u064A \u062C\u0644\u0628 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F \u0641\u064A \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u2014 \u0628\u064A\u0627\u0646\u0627\u062A \u062D\u062F\u064A\u062B\u0629 \u0648\u0645\u0624\u0643\u062F\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645");try{await Promise.allSettled(e)}catch(n){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A:",n.message)}if(typeof window.DataManager<"u"&&window.DataManager.save)try{this.ensureData(),window.DataManager.save(),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u062C\u0645\u064A\u0639 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0645\u062D\u0644\u064A\u0627\u064B \u0628\u0639\u062F syncDataFromServer")}catch(n){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B:",n.message)}},async syncDataInBackground(){try{Utils.safeLog("\u{1F504} \u0645\u0632\u0627\u0645\u0646\u0629 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629..."),await Utils.promiseWithTimeout(this.syncDataFromServer(),13e4,()=>new Error("Background sync timeout")),this.ensureData(),this.hasValidLocalData()&&(this.renderUI(),this.state&&this.state.activeTab==="visits"&&this.scheduleVisitsTabRender(!1,0),this.state&&this.state.activeTab==="attendance"&&this.renderAttendanceTab(),Utils.safeLog("\u2705 \u062A\u0645\u062A \u0645\u0632\u0627\u0645\u0646\u0629 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629"))}catch(e){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",e.message),Utils.safeLog("\u2139\uFE0F \u062A\u0645 \u0627\u0644\u0627\u062D\u062A\u0641\u0627\u0638 \u0628\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629")}},async refresh(){Utils.safeLog("\u{1F504} \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629..."),Notification?.info?.("\u062C\u0627\u0631\u064A \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A..."),await this.load(),Notification?.success?.("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")},getClinicStaffList(){return this.ensureData(),Array.isArray(AppState.appData.clinicStaff)?AppState.appData.clinicStaff:[]},getClinicStaffAttendanceList(){this.ensureData();let e=Array.isArray(AppState.appData.clinicStaffAttendance)?AppState.appData.clinicStaffAttendance:[];return e=this._mergeAttendanceRowsByUserDay(e),this.canViewAllAttendanceData()||(e=e.filter(t=>this._attendanceRowBelongsToCurrentUser_(t))),e},getClinicStaffTimeOffRequestsList(){this.ensureData();let e=Array.isArray(AppState.appData.clinicStaffTimeOffRequests)?AppState.appData.clinicStaffTimeOffRequests:[];if(!this.canViewAllAttendanceData()){const t=AppState.currentUser,a=String(t?.id||"").trim(),i=String(t?.email||"").trim().toLowerCase();e=e.filter(n=>a&&String(n.userId||"")===a||i&&String(n.userEmail||"").trim().toLowerCase()===i)}return e},getClinicStaffSystemActivitiesList(){return this.ensureData(),Array.isArray(AppState.appData.clinicStaffSystemActivities)?AppState.appData.clinicStaffSystemActivities:[]},getFilteredClinicStaffActivities(){let e=this.getClinicStaffSystemActivitiesList().slice();const t=this.state.filters?.attendance||{},a=this._resolveAttendanceFilterDates(t);if(a.dateFrom&&(e=e.filter(i=>i.timestamp&&this._attendanceDayKey(i.timestamp)>=a.dateFrom)),a.dateTo&&(e=e.filter(i=>i.timestamp&&this._attendanceDayKey(i.timestamp)<=a.dateTo)),t.activityModule&&t.activityModule!=="all"&&(e=e.filter(i=>String(i.moduleKey)===String(t.activityModule))),this.canViewAllAttendanceData()&&t.staffId&&t.staffId!=="all"){const i=(this.getClinicStaffList()||[]).find(n=>String(n.id)===String(t.staffId));if(i){const n=String(i.userId||"").trim(),s=String(i.userEmail||"").trim().toLowerCase(),o=String(i.userName||"").trim().toLowerCase();e=e.filter(l=>n&&String(l.userId||"")===n||s&&String(l.userEmail||"").trim().toLowerCase()===s||o&&String(l.userName||"").trim().toLowerCase()===o)}}return e.sort((i,n)=>new Date(n.timestamp||0)-new Date(i.timestamp||0))},getClinicStaffActivityModuleIcon(e){return{ptw:"fa-id-card",clinic:"fa-clinic-medical",training:"fa-chalkboard-teacher",incidents:"fa-exclamation-triangle",nearmiss:"fa-exclamation-circle",observations:"fa-eye",violations:"fa-gavel",system:"fa-cogs"}[String(e||"").trim()]||"fa-circle"},renderClinicStaffActivitiesSection({showUserColumn:e=!1,activities:t=[],loading:a=!1,title:i="\u0646\u0634\u0627\u0637\u064A \u062F\u0627\u062E\u0644 \u0627\u0644\u0646\u0638\u0627\u0645"}={}){const n=[{value:"all",label:"\u0643\u0644 \u0627\u0644\u0623\u0646\u0634\u0637\u0629"},{value:"ptw",label:"\u062A\u0635\u0627\u0631\u064A\u062D \u0627\u0644\u0639\u0645\u0644"},{value:"clinic",label:"\u0627\u0644\u0639\u064A\u0627\u062F\u0629"},{value:"training",label:"\u0627\u0644\u062A\u062F\u0631\u064A\u0628"},{value:"incidents",label:"\u0627\u0644\u062D\u0648\u0627\u062F\u062B"},{value:"nearmiss",label:"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643"},{value:"observations",label:"\u0627\u0644\u0645\u0644\u0627\u062D\u0638\u0627\u062A"},{value:"violations",label:"\u0627\u0644\u0645\u062E\u0627\u0644\u0641\u0627\u062A"},{value:"system",label:"\u0627\u0644\u0646\u0638\u0627\u0645"}],s=this.state.filters?.attendance?.activityModule||"all",o=a?"\u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0646\u0634\u0627\u0637...":this._clinicStaffActivitiesFetched?"\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u0646\u0634\u0637\u0629 \u0645\u0633\u062C\u0651\u0644\u0629 \u0641\u064A \u0627\u0644\u0641\u062A\u0631\u0629 \u0627\u0644\u0645\u062D\u062F\u062F\u0629":'\u0627\u0636\u063A\u0637 \u0632\u0631 \u0627\u0644\u062A\u062D\u062F\u064A\u062B <i class="fas fa-sync-alt"></i> \u0644\u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0646\u0634\u0627\u0637 (\u0644\u0627 \u064A\u064F\u062D\u0645\u0651\u0644 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B \u062D\u0641\u0627\u0638\u0627\u064B \u0639\u0644\u0649 \u0633\u0631\u0639\u0629 \u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F)',l=t.length?t.map(r=>`
        ...
        `).join(""),r=t.map((d,f)=>{const p=f%2===0?"#ffffff":"#f8fafc",u=this.getAttendanceStatusLabel(d.status);return n?`<tr style="background:${p};">
...
<div class="att-report-doc" id="attendance-report-root">
    ...
    <div class="att-report-footer">${i} \u2014 \u062A\u0642\u0631\u064A\u0631 \u062D\u0636\u0648\u0631 \u0645\u0633\u0626\u0648\u0644\u064A \u0627\u0644\u0639\u064A\u0627\u062F\u0629</div>
            ...
            </div>`;document.body.insertAdjacentHTML("beforeend",l);const r=document.getElementById("clinic-attendance-report-modal");if(!r)return;const c=r.querySelector("#att-report-custom-filters"),d=r.querySelector("#att-report-use-current"),f=m=>{c&&(c.style.opacity=m?"1":"0.45",c.style.pointerEvents=m?"auto":"none")},p=()=>{const m=r.querySelector('input[name="att-report-date-scope"]:checked')?.value||"month";r.querySelector("#att-report-month-wrap").style.display=m==="month"?"block":"none",r.querySelector("#att-report-period-wrap").style.display=m==="period"?"block":"none",r.querySelectorAll("[data-date-opt]").forEach(g=>{const y=g.dataset.dateOpt===m;g.style.background=y?"#f0fdfa":"transparent",g.style.borderColor=y?"#99f6e4":"transparent"})};d?.addEventListener("change",()=>f(!d.checked)),r.querySelectorAll('input[name="att-report-date-scope"]').forEach(m=>{m.addEventListener("change",p)}),p(),f(!0);const u=()=>{if(d?.checked)return Object.assign({},this.state.filters.attendance||{});const m={search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"},g=r.querySelector('input[name="att-report-date-scope"]:checked')?.value||"month";if(g==="month"){const v=r.querySelector("#att-report-month")?.value||"";if(!v)return Notification?.warning?.("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0627\u0644\u0634\u0647\u0631"),null;m.month=v}else if(g==="period"){const v=r.querySelector("#att-report-from")?.value||"",b=r.querySelector("#att-report-to")?.value||"";if(!v&&!b)return Notification?.warning?.("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0628\u062F\u0627\u064A\u0629 \u0623\u0648 \u0627\u0644\u0646\u0647\u0627\u064A\u0629"),null;const x=this._normalizeAttendanceDateRange(v,b);m.dateFrom=x.dateFrom,m.dateTo=x.dateTo}const y=r.querySelector("#att-report-staff")?.value||"all";return y&&y!=="all"&&(m.staffId=y),m};r.querySelector("#att-report-export-btn")?.addEventListener("click",()=>{const m=r.querySelector('input[name="att-report-format"]:checked')?.value||"pdf",g=u();if(!g)return;if(!this._filterAttendanceRows(this.getClinicStaffAttendanceList(),g).length){Notification?.info?.("\u0644\u0627 \u062A\u0648\u062C\u062F \u0633\u062C\u0644\u0627\u062A \u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0646\u0637\u0627\u0642 \u0627\u0644\u062A\u0642\u0631\u064A\u0631");return}r.remove(),m==="excel"?(this.exportAttendanceToExcel(g),Notification?.success?.("\u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u062A\u0642\u0631\u064A\u0631 Excel")):this.exportAttendanceToPDF(g)})},showAddClinicStaffModal(){if(!this.isCurrentUserAdmin()){Notification?.error?.("\u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0645\u062A\u0627\u062D \u0644\u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645 \u0641\u0642\u0637");return}const e=this.getClinicStaffList(),t=new Set(e.map(s=>String(s.userId||s.userEmail||"").toLowerCase()).filter(Boolean)),n=`
            ...
            <tbody>${t}</tbody>
        </table>`)},renderAttendanceSelfTab(e){this._saveTimeOffFormDraftFromDom(),this._scheduleLeaveBalancesLoadIfNeeded(!1),this.ensureData();const t=this._isAttendanceDataLoading(),a=this._isLeaveBalancesLoading(),i=this._getLeaveBalancePeriodDefaults(),n=this.getClinicStaffLeaveBalancesList()[0]||{},s=n.month||{},o=n.year||{};this.state.filters=this.state.filters||{},this.state.filters.attendance=Object.assign({search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"},this.state.filters.attendance||{});const l=this.state.filters.attendance,r=this.getFilteredClinicAttendance(),c=this.getClinicStaffTimeOffRequestsList().sort((C,N)=>new Date(N.requestedAt||N.createdAt)-new Date(C.requestedAt||C.createdAt)),d=c.filter(C=>C.status==="pending").length,f=this._computeAttendanceReportStats(r),p=this.getCurrentUserStaffRecord(),u=this.getFilteredClinicStaffActivities(),m=!!this._clinicStaffActivitiesLoading,g=this._countActiveAttendanceFilters(l),y=this.state.attendanceFilterPanelOpen!==!1,v=l.period||"all",b={today:"\u0627\u0644\u064A\u0648\u0645",week:"7 \u0623\u064A\u0627\u0645",month:"30 \u064A\u0648\u0645",all:"\u0627\u0644\u0643\u0644"},L="min-width:0;box-sizing:border-box;width:100%;padding:8px 11px;border:1.5px solid #99f6e4;border-radius:8px;font-size:0.82rem;background:#fff;color:#374151;",D="font-size:0.72rem;font-weight:700;color:#64748b;display:block;margin-bottom:5px;",j=t&&r.length===0?this._renderAttendanceTableLoadingRow(5):r.length?r.map(C=>`
            <tr>
            ...
            <div id="clinic-attendance-self-root">
                ...
                <div style="padding:14px 18px;background:linear-gradient(135deg,#134e4a,#0d9488);border-radius:14px;color:#fff;margin-bottom:14px;display:flex;justify-content:space-between;flex-wrap:wrap;gap:10px;align-items:center;">
                    ...
                    <div style="display:flex;gap:6px;flex-wrap:wrap;">
                        ${["today","week","month","all"].map(C=>{const N=v===C;return`<button type="button" class="clinic-attendance-period-btn" data-period="${C}" style="padding:5px 10px;border-radius:8px;border:none;cursor:pointer;font-size:0.74rem;font-weight:600;background:${N?"#fff":"rgba(255,255,255,0.14)"};color:${N?"#134e4a":"#fff"};">${b[C]}</button>`}).join("")}
        ...
        `).join(""):'<tr><td colspan="10" class="text-center text-gray-500 py-8"><i class="fas fa-calendar-times ml-2 opacity-60"></i>\u0644\u0627 \u062A\u0648\u062C\u062F \u0633\u062C\u0644\u0627\u062A \u0645\u0637\u0627\u0628\u0642\u0629 \u0644\u0644\u0641\u0644\u0627\u062A\u0631</td></tr>',M=v?c.length?c.map(S=>{const F=String(S.isActive||"true").toLowerCase()!=="false";return`<tr>
            ...
            <div id="clinic-attendance-root" style="font-family:inherit;">
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(155px,1fr));gap:10px;margin-bottom:14px;">
                    ${[{label:"\u062D\u0627\u0636\u0631\u0648\u0646 \u0627\u0644\u064A\u0648\u0645",value:g,icon:"fa-user-check",color:"#059669",bg:"#ecfdf5"},{label:"\u0628\u062F\u0648\u0646 \u062A\u0633\u062C\u064A\u0644 \u062E\u0631\u0648\u062C",value:y,icon:"fa-door-open",color:"#d97706",bg:"#fffbeb"},{label:"\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0641\u0644\u062A\u0631",value:r.length,icon:"fa-filter",color:"#2563eb",bg:"#eff6ff"},{label:"\u0645\u0633\u0626\u0648\u0644\u0648\u0646 \u0646\u0634\u0637\u0648\u0646",value:f.length,icon:"fa-users",color:"#4f46e5",bg:"#eef2ff"}].map(S=>`
        ...
        `,this.applyModuleI18n(e),this.renderTabNavigation(),this.renderActiveTabContent(),this.bindTabEvents();const l=document.getElementById("clinic-refresh-btn");l&&l.addEventListener("click",()=>this.refresh());const r=document.getElementById("clinic-register-visit-btn");r&&r.addEventListener("click",()=>{r.disabled||(r.disabled=!0,this.showVisitForm(null,r))});const c=document.getElementById("clinic-visit-types-settings-btn");c&&c.addEventListener("click",()=>this.showVisitTypesSettingsModal());const d=document.getElementById("clinic-contractor-jobs-settings-btn");d&&d.addEventListener("click",()=>this.showContractorJobTitlesSettingsModal()),typeof UI<"u"&&UI.addNavigationIconsAfterRender?UI.addNavigationIconsAfterRender("clinic"):typeof UI<"u"&&UI.addNavigationIcons&&(setTimeout(()=>{UI.addNavigationIcons(e,"clinic")},0),setTimeout(()=>{UI.addNavigationIcons(e,"clinic")},100))},async renderDispensedMedicationsTab(){const e=document.querySelector('.clinic-tab-panel[data-tab-panel="dispensed-medications"]');if(!e){Utils.safeWarn("\u26A0\uFE0F \u0644\u0648\u062D\u0629 \u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}if(!this.isCurrentUserAdmin()){e.innerHTML='<div class="text-center py-8 text-gray-500">\u0647\u0630\u0627 \u0627\u0644\u0642\u0633\u0645 \u0645\u062A\u0627\u062D \u0644\u0644\u0645\u062F\u064A\u0631\u064A\u0646 \u0641\u0642\u0637</div>';return}const{t}=this.getTranslations();this.ensureData();const a=AppState.appData.clinicVisits&&AppState.appData.clinicVisits.length>0;if((!a||a&&AppState.appData.clinicVisits.some(p=>{const u=this.normalizeVisitMedications(p.medications);return(!u||u.length===0)&&(p.medicationsDispensed||p.medicationsDispensedQty&&p.medicationsDispensedQty>0)}))&&typeof GoogleIntegration<"u"&&GoogleIntegration.sendRequest){e.innerHTML='<div class="text-center py-8 text-gray-500"><div style="width: 300px; margin: 0 auto 16px;"><div style="width: 100%; height: 6px; background: rgba(59, 130, 246, 0.2); border-radius: 3px; overflow: hidden;"><div style="height: 100%; background: linear-gradient(90deg, #3b82f6, #2563eb, #3b82f6); background-size: 200% 100%; border-radius: 3px; animation: loadingProgress 1.5s ease-in-out infinite;"></div></div></div><p>'+this.getTranslations().t("skeleton.loadingData","\u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A...")+"</p></div>";try{await this.loadVisitsDataFromBackend(),this.ensureData(),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629")}catch(p){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629:",p.message),AppState.appData.clinicVisits||(AppState.appData.clinicVisits=[]),this.ensureData()}}const n=AppState.appData.clinicVisits||[],s=[];let o=!1;if(n.forEach(p=>{if(!p||typeof p!="object")return;let u=this.normalizeVisitMedications(p.medications);if((!u||u.length===0)&&p.medicationsDispensed&&(u=this.normalizeVisitMedications(p.medicationsDispensed),u&&u.length>0&&(p.medications=u,o=!0,AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0648\u064A\u0644 medicationsDispensed \u0641\u064A \u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0644\u0632\u064A\u0627\u0631\u0629 ${p.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,u.length,"\u062F\u0648\u0627\u0621"))),(!u||u.length===0)&&p.medicationsDispensedQty&&p.medicationsDispensedQty>0){const m=parseInt(p.medicationsDispensedQty,10)||0;m>0&&(u=[{medicationName:p.medicationsDispensed||"\u062F\u0648\u0627\u0621 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F",quantity:m,unit:"\u0648\u062D\u062F\u0629",notes:""}],p.medications=u,o=!0,AppState.debugMode&&Utils.safeWarn(`\u26A0\uFE0F \u0632\u064A\u0627\u0631\u0629 ${p.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"} \u0644\u062F\u064A\u0647\u0627 medicationsDispensedQty=${m} \u0648\u0644\u0643\u0646 \u0644\u0627 \u062A\u0648\u062C\u062F \u0642\u0627\u0626\u0645\u0629 \u0623\u062F\u0648\u064A\u0629. \u062A\u0645 \u0625\u0646\u0634\u0627\u0621 \u0633\u062C\u0644 \u0627\u0641\u062A\u0631\u0627\u0636\u064A.`))}u&&u.length>0&&u.forEach(m=>{if(m&&(m.medicationName||m.name)){const g=p.factoryName||this.getVisitFactoryDisplayName(p)||"-",y=p.employeeLocation||p.workArea||p.location||"-";s.push({visitId:p.id,visitDate:p.visitDate||p.createdAt,employeeName:p.employeeName||p.contractorName||p.contractorWorkerName||p.externalName||"",employeeCode:p.employeeCode||p.employeeNumber||"",employeeDepartment:p.employeeDepartment||p.department||"",factory:g,location:y,personType:p.personType||(p.contractorName||p.externalName?"contractor":"employee"),medicationName:m.medicationName||m.name||"",quantity:m.quantity!==null&&m.quantity!==void 0?parseInt(m.quantity,10):0,unit:m.unit||"\u0648\u062D\u062F\u0629",notes:m.notes||""})}})}),o&&typeof window.DataManager<"u"&&window.DataManager.save)try{window.DataManager.save(),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629 \u0645\u062D\u0644\u064A\u0627\u064B \u0628\u0639\u062F \u0627\u0644\u062A\u0637\u0628\u064A\u0639")}catch(p){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629 \u0645\u062D\u0644\u064A\u0627\u064B:",p.message)}if(AppState.debugMode){const p=s.filter(m=>m.personType==="employee"||!m.personType).length,u=s.filter(m=>m.personType==="contractor").length;Utils.safeLog(`\u2705 \u0633\u062C\u0644 \u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629: ${s.length} \u062F\u0648\u0627\u0621 \u0645\u0646 ${n.length} \u0632\u064A\u0627\u0631\u0629 (${p} \u0645\u0648\u0638\u0641\u060C ${u} \u0645\u0642\u0627\u0648\u0644)`)}s.sort((p,u)=>{const m=new Date(p.visitDate);return new Date(u.visitDate)-m});const l=s.map(p=>{let u=p.visitDate||p.createdAt||"";if(u)try{const D=new Date(u);isNaN(D.getTime())&&(u=p.createdAt||"")}catch{u=p.createdAt||""}const m=this.formatDate(u,!0),g=this.getMedications().find(D=>D.name===p.medicationName||D.name?.toLowerCase()===p.medicationName?.toLowerCase()),y=g?.type||"-",v=g?this.calculateMedicationStatus(g):null,b=v?`<span class="badge ${this.getMedicationStatusClasses(v.status)}">${v.status}</span>`:"-",x=v?.status||"\u0633\u0627\u0631\u064A";return`
        ...
        `,this.applyModuleI18n(e),e.querySelector("#supply-new-request-btn")?.addEventListener("click",()=>this.showSupplyRequestForm());const r=()=>{e.querySelectorAll('[data-action="view-request"]').forEach(y=>{y.addEventListener("click",()=>this.viewSupplyRequest(y.getAttribute("data-id")))}),e.querySelectorAll('[data-action="update-status"]').forEach(y=>{y.addEventListener("click",()=>this.updateSupplyRequestStatus(y.getAttribute("data-id"),y.getAttribute("data-status")))})},c=e.querySelector("#supply-search-filter"),d=e.querySelector("#supply-status-filter"),f=e.querySelector("#supply-type-filter"),p=e.querySelector("#supply-priority-filter"),u=e.querySelector("#supply-reset-filters"),m=e.querySelector("#supply-requests-list-container"),g=()=>{const y=this.normalizeArabicText(c?.value||""),v=d?.value||"all",b=f?.value||"all",x=p?.value||"all",L=i.filter(h=>!(v!=="all"&&(h.status||"pending")!==v||b!=="all"&&h.type!==b||x!=="all"&&(h.priority||"normal")!==x||y&&!this.normalizeArabicText([h.itemName,h.requestedBy?.name,h.requestedByName,h.notes,h.unit].filter(Boolean).join(" ")).includes(y)));m&&(m.innerHTML=this.renderSupplyRequestsList(L,a));const D=e.querySelector("#supply-filter-count"),j=e.querySelector("#supply-result-pill");D&&(D.textContent=`${L.length} \u0645\u0646 ${i.length}`),j&&(j.textContent=`${L.length} \u0637\u0644\u0628`),r()};[d,f,p].forEach(y=>y?.addEventListener("change",g)),c?.addEventListener("input",g),u?.addEventListener("click",()=>{c&&(c.value=""),d&&(d.value="all"),f&&(f.value="all"),p&&(p.value="all"),g()}),r(),setTimeout(()=>{const y=e.querySelector(".clinic-table-wrapper");y&&this.setupTableScrollListeners(y)},100)},renderSupplyRequestsList(e,t){return!e||e.length===0?'<div class="cw-empty"><i class="fas fa-box-open"></i><h3>\u0644\u0627 \u062A\u0648\u062C\u062F \u0637\u0644\u0628\u0627\u062A \u0645\u0637\u0627\u0628\u0642\u0629</h3><p>\u0633\u062A\u0638\u0647\u0631 \u0627\u0644\u0637\u0644\u0628\u0627\u062A \u0647\u0646\u0627 \u0628\u0639\u062F \u0625\u0631\u0633\u0627\u0644\u0647\u0627 \u0623\u0648 \u0639\u0646\u062F \u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0641\u0644\u0627\u062A\u0631.</p></div>':`
            <div class="cw-table-scroll clinic-table-wrapper">
                <table class="cw-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ${e.map((i,n)=>{const s=this.formatDate(i.createdAt||i.requestDate,!0),o=i.requestedBy?.name||i.requestedByName||"\u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641",l=i.status||"pending",r=i.priority||"normal",c={pending:'<span class="badge badge-warning">\u0642\u064A\u062F \u0627\u0644\u0627\u0646\u062A\u0638\u0627\u0631</span>',approved:'<span class="badge badge-success">\u0645\u0648\u0627\u0641\u0642 \u0639\u0644\u064A\u0647</span>',rejected:'<span class="badge badge-danger">\u0645\u0631\u0641\u0648\u0636</span>',fulfilled:'<span class="badge badge-info">\u062A\u0645 \u0627\u0644\u062A\u0646\u0641\u064A\u0630</span>'}[l]||'<span class="badge">\u063A\u064A\u0631 \u0645\u062D\u062F\u062F</span>',d={urgent:'<span class="badge badge-danger">\u0639\u0627\u062C\u0644\u0629</span>',high:'<span class="badge badge-warning">\u0639\u0627\u0644\u064A\u0629</span>',normal:'<span class="badge badge-info">\u0639\u0627\u062F\u064A\u0629</span>'}[r]||'<span class="badge">\u0639\u0627\u062F\u064A\u0629</span>',f={medication:"\u0623\u062F\u0648\u064A\u0629",equipment:"\u0623\u062C\u0647\u0632\u0629 \u0637\u0628\u064A\u0629",supplies:"\u0645\u0633\u062A\u0644\u0632\u0645\u0627\u062A \u0637\u0628\u064A\u0629",other:"\u0623\u062E\u0631\u0649"}[i.type]||i.type||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F",p={medication:"fas fa-pills",equipment:"fas fa-stethoscope",supplies:"fas fa-briefcase-medical",other:"fas fa-box"}[i.type]||"fas fa-box",u=[i.type==="medication"&&i.currentBalanceAtRequest!==null&&i.currentBalanceAtRequest!==void 0?`\u0627\u0644\u0631\u0635\u064A\u062F \u0639\u0646\u062F \u0627\u0644\u0637\u0644\u0628: ${i.currentBalanceAtRequest} ${i.unit||"\u0648\u062D\u062F\u0629"}`:"",i.notes||""].filter(Boolean).join(" \u2022 ")||"\u0644\u0627 \u062A\u0648\u062C\u062F \u0645\u0644\u0627\u062D\u0638\u0627\u062A";return`
                <tr>
                    <td class="text-center"><span class="cw-serial">${n+1}</span></td>
                    <td>${s}</td>
                    <td>${Utils.escapeHTML(o)}</td>
                    <td>${Utils.escapeHTML(f)}</td>
                    <td><div class="cw-main-cell"><span class="cw-cell-icon"><i class="${p}"></i></span><div><strong>${Utils.escapeHTML(i.itemName||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F")}</strong><small>${Utils.escapeHTML(u)}</small></div></div></td>
