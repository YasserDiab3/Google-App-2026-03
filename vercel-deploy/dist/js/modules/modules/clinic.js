...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&d.remove()})},printVisitsList(){const e=AppState.appData.clinicVisits.slice().reverse();if(e.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const a=`
        ...
        `,i=window.open("","_blank");i&&(i.document.write(a),i.document.close(),i.onload=()=>{setTimeout(()=>{i.print(),Notification.success("\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u0633\u062C\u0644\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629")},250)})},exportVisitsToExcel(){this.ensureData();const e=this.state.activeVisitType||"employees",t=e==="contractors",a=(AppState.appData.clinicVisits||[]).slice().reverse(),i=a.filter(o=>this.isEmployeeVisit_(o)),n=a.filter(o=>this.isContractorVisit_(o)),s=e==="employees"?i:n;if(s.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}if(typeof XLSX>"u"){Notification.error("\u0645\u0643\u062A\u0628\u0629 Excel \u063A\u064A\u0631 \u0645\u062A\u0648\u0641\u0631\u0629");return}try{const o=s.map(d=>{const p=t?d.contractorName||d.employeeName||d.externalName||"-":d.employeeCode||d.employeeNumber||"-",f=t?d.contractorWorkerName||"-":d.employeeName||"-",m=d.employeePosition||d.contractorPosition||"-",u=this.getVisitFactoryDisplayName(d),g=t?d.workArea||d.employeeLocation||"-":d.employeeLocation||d.workArea||"-",y=d.visitDate?Utils.formatDateTime(d.visitDate):"-",v=d.exitDate?Utils.formatDateTime(d.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",h=this.calculateTotalTime(d.visitDate,d.exitDate),w=d.reason||"",L=d.diagnosis||"",A=this.normalizeVisitMedications(d.medications),b=A.length>0?A.map(R=>`${R.medicationName||""} (${R.quantity||1})`).join("\u060C "):"-",k=A.length>0?A.reduce((R,q)=>R+(parseInt(q.quantity,10)||0),0):0,E={};return E[t?"\u0627\u0633\u0645 \u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A"]=p,E.\u0627\u0644\u0627\u0633\u0645=f,E.\u0627\u0644\u0648\u0638\u064A\u0641\u0629=m,E.\u0627\u0644\u0645\u0635\u0646\u0639=u,E["\u0645\u0643\u0627\u0646 \u0627\u0644\u0639\u0645\u0644"]=g,E["\u0648\u0642\u062A \u0627\u0644\u062F\u062E\u0648\u0644"]=y,E["\u0648\u0642\u062A \u0627\u0644\u062E\u0631\u0648\u062C"]=v,E["\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0648\u0642\u062A"]=h,E["\u0633\u0628\u0628 \u0627\u0644\u0632\u064A\u0627\u0631\u0629"]=w,E.\u0627\u0644\u062A\u0634\u062E\u064A\u0635=L,E["\u0627\u0644\u0623\u062F\u0648\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629"]=b,E["\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u0646\u0635\u0631\u0641\u0629"]=k,E}),l=XLSX.utils.book_new(),r=XLSX.utils.json_to_sheet(o);r["!cols"]=[{wch:18},{wch:25},{wch:20},{wch:16},{wch:20},{wch:20},{wch:20},{wch:15},{wch:25},{wch:25},{wch:30},{wch:14}],XLSX.utils.book_append_sheet(l,r,`\u0633\u062C\u0644\u0627\u062A_${t?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646":"\u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646"}`);const c=`\u0633\u062C\u0644\u0627\u062A_\u0627\u0644\u0632\u064A\u0627\u0631\u0629_${t?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646":"\u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646"}_\u0627\u0644\u0639\u064A\u0627\u062F\u0629_\u0627\u0644\u0637\u0628\u064A\u0629_${new Date().toISOString().slice(0,10)}.xlsx`;XLSX.writeFile(l,c),Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0633\u062C\u0644\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0625\u0644\u0649 Excel \u0628\u0646\u062C\u0627\u062D")}catch(o){Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 Excel:",o),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 Excel: "+o.message)}},async exportVisitsToPDF(){this.ensureData();const e=this.state.activeVisitType||"employees",t=e==="contractors",a=(AppState.appData.clinicVisits||[]).slice().reverse(),i=a.filter(o=>this.isEmployeeVisit_(o)),n=a.filter(o=>this.isContractorVisit_(o)),s=e==="employees"?i:n;if(s.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}try{const o=s.map(u=>{const g=t?u.contractorName||u.employeeName||u.externalName||"-":u.employeeCode||u.employeeNumber||"-",y=t?u.contractorWorkerName||"-":u.employeeName||"-",v=t?u.contractorPosition||u.employeePosition||"-":u.employeePosition||"-",h=this.getVisitFactoryDisplayName(u),w=t?u.workArea||u.employeeLocation||"-":u.employeeLocation||u.workArea||"-",L=u.visitDate?Utils.formatDateTime(u.visitDate):"-",A=u.exitDate?Utils.formatDateTime(u.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",b=Clinic.calculateTotalTime(u.visitDate,u.exitDate),k=u.reason||"",E=u.diagnosis||"",R=this.normalizeVisitMedications(u.medications),q=R.length>0?R.map(j=>`${Utils.escapeHTML(j.medicationName||"")} (${j.quantity||1})`).join("\u060C "):"-",U=R.length>0?R.reduce((j,x)=>j+(parseInt(x.quantity,10)||0),0):0;return`
            ...
            `,d=typeof FormHeader<"u"&&FormHeader.generatePDFHTML?FormHeader.generatePDFHTML(l,r,c,!1,!0,{source:"ClinicVisits"},new Date().toISOString(),new Date().toISOString()):`<html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>${r}</title></head><body>${c}</body></html>`,p=new Blob([d],{type:"text/html;charset=utf-8"}),f=URL.createObjectURL(p),m=window.open(f,"_blank");m?m.onload=()=>{setTimeout(()=>{m.print(),setTimeout(()=>{URL.revokeObjectURL(f)},1e3),Notification.success("\u062A\u0645 \u062A\u062D\u0636\u064A\u0631 \u0627\u0644\u0633\u062C\u0644\u0627\u062A \u0644\u0644\u0637\u0628\u0627\u0639\u0629/\u0627\u0644\u062D\u0641\u0638 \u0643\u0640 PDF")},250)}:(URL.revokeObjectURL(f),Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u062A\u0635\u062F\u064A\u0631 PDF"))}catch(o){URL.revokeObjectURL(url),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF:",o),Notification.error("\u0641\u0634\u0644 \u062A\u0635\u062F\u064A\u0631 PDF: "+o.message)}},async exportVisitToPDF(e){if(!e){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}try{const t=e.personType==="employee"?"\u0645\u0648\u0638\u0641":e.personType==="contractor"?"\u0645\u0642\u0627\u0648\u0644":"\u0639\u0645\u0627\u0644\u0629 \u062E\u0627\u0631\u062C\u064A\u0629",a=e.employeeCode||e.employeeNumber||"-",i=e.employeeName||e.contractorName||e.externalName||"",n=e.contractorWorkerName?` (${e.contractorWorkerName})`:"",s=e.employeePosition||e.contractorPosition||"-",o=e.employeeLocation||e.workArea||"-",l=e.visitDate?Utils.formatDateTime(e.visitDate):"-",r=e.exitDate?Utils.formatDateTime(e.exitDate):"\u0644\u0645 \u064A\u062A\u0645 \u062A\u0633\u062C\u064A\u0644\u0647",c=this.calculateTotalTime(e.visitDate,e.exitDate),d=e.reason||"",p=e.diagnosis||"",f=e.treatment||"",m=e.medications&&Array.isArray(e.medications)&&e.medications.length>0?e.medications.map(A=>`${Utils.escapeHTML(A.medicationName||"")} (${A.quantity||1})`).join("\u060C "):"\u0644\u0627 \u062A\u0648\u062C\u062F \u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u0635\u0631\u0641\u0629",u=`CLINIC-VISIT-${e.id||new Date().toISOString().slice(0,10)}`,g="\u062A\u0642\u0631\u064A\u0631 \u0632\u064A\u0627\u0631\u0629 \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0637\u0628\u064A\u0629",y=`
                <div style="margin-bottom: 20px;">
