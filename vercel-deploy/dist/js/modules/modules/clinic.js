            ...
            <div id="clinic-attendance-self-root">
                ...
                <div style="padding:14px 18px;background:linear-gradient(135deg,#134e4a,#0d9488);border-radius:14px;color:#fff;margin-bottom:14px;display:flex;justify-content:space-between;flex-wrap:wrap;gap:10px;align-items:center;">
                    ...
                    <div style="display:flex;gap:6px;flex-wrap:wrap;">
                        ${["today","week","month","all"].map(S=>{const D=g===S;return`<button type="button" class="clinic-attendance-period-btn" data-period="${S}" style="padding:5px 10px;border-radius:8px;border:none;cursor:pointer;font-size:0.74rem;font-weight:600;background:${D?"#fff":"rgba(255,255,255,0.14)"};color:${D?"#134e4a":"#fff"};">${b[S]}</button>`}).join("")}
            ...
            <div id="clinic-attendance-root" style="font-family:inherit;">
                ...
                <div id="clinic-attendance-filter-panel" style="display:${L?"block":"none"};margin-bottom:14px;">
                    ...
                    <div style="margin-top:12px;padding-top:10px;border-top:1px dashed #99f6e4;display:flex;flex-wrap:wrap;gap:6px;align-items:center;">
                        ...
                        ${l.staffId&&l.staffId!=="all"?`<span style="background:#fff;border:1px solid #99f6e4;color:#0f766e;padding:3px 8px;border-radius:999px;font-size:0.72rem;">${Utils.escapeHTML((d.find(x=>String(x.id)===String(l.staffId))||{}).name||l.staffId)}</span>`:""}
