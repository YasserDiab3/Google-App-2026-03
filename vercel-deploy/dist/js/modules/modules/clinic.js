...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0625\u063A\u0644\u0627\u0642\u061F`)&&c()})},editSickLeave(e){const t=this.getSickLeaves().find(a=>a.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629");return}this.showSickLeaveForm(t)},printSickLeaveRecord(e){const t=this.getSickLeaves().find(c=>c.id===e);if(!t){Notification?.error?.("\u062A\u0639\u0630\u0631 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const a=t.employeeName||t.personName||"",s=t.employeeDepartment||"\u2014",n=t.treatingDoctor||"\u2014",i=t.daysCount??this.calculateSickLeaveDays(t.startDate,t.endDate),o=`
        ...
        </div>`,this.applyModuleI18n(e),setTimeout(()=>{this.updateClinicAnalyticsDashboard(),this._clinicBindAnalyticsEvents()},80))},bindDataAnalysisTabEvents(e){},async updateClinicAnalyticsDashboard(){const e=document.getElementById("clinic-analytics-root");if(!e)return;try{this.ensureData()}catch{}const t=parseInt(this._clinicPeriod||"0",10),a=AppState.appData?.clinicVisits||[],s=AppState.appData?.clinicMedications||[],n=AppState.appData?.sickLeave||[],i=AppState.appData?.injuries||[],o=AppState.appData?.clinicSupplyRequests||[],l=t>0?(()=>{const A=new Date;return A.setDate(A.getDate()-t),A})():null,r=(A,H)=>l?A.filter(W=>{const Q=new Date(W[H]||W.createdAt||"");return!isNaN(Q.getTime())&&Q>=l}):A,c=r(a,"visitDate"),d=r(n,"startDate"),m=r(i,"injuryDate");this._clinicPopulateFilters(c);const p=this._clinicApplyFilters(c),u=p.length,f=document.getElementById("clinic-filter-count");f&&(f.textContent=`${u} \u0632\u064A\u0627\u0631\u0629`);const y=p.filter(A=>String(A.personType||"").toLowerCase()!=="contractor"),g=p.filter(A=>String(A.personType||"").toLowerCase()==="contractor"),b=new Date,v=p.filter(A=>{const H=new Date(A.visitDate||A.createdAt||"");return H.getFullYear()===b.getFullYear()&&H.getMonth()===b.getMonth()}).length,w=s.filter(A=>A.status==="\u0645\u0646\u062A\u0647\u064A").length,$=s.filter(A=>A.status==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621").length,L=d.filter(A=>!A.status||A.status==="\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629").length,h=new Set(p.map(A=>{const H=new Date(A.visitDate||A.createdAt||"");return isNaN(H.getTime())?null:`${H.getFullYear()}-${H.getMonth()}`}).filter(Boolean)).size,S=h>0?(u/h).toFixed(1):0,D=this.analyzeDispensedMedications_(p,s),C=document.getElementById("clinic-kpi-strip");if(C){const A=(W,Q)=>Q>0?Math.round(W/Q*100):0,H=[{label:"\u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0632\u064A\u0627\u0631\u0627\u062A",value:u,icon:"fas fa-hospital-user",color:"#1d4ed8",grad:"linear-gradient(135deg,#3b82f6,#1d4ed8)",sub:"\u0643\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A",pct:100},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646",value:y.length,icon:"fas fa-user-tie",color:"#1e40af",grad:"linear-gradient(135deg,#2563eb,#1e40af)",sub:`${A(y.length,u)}% \u0645\u0646 \u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A`,pct:A(y.length,u)},{label:"\u0632\u064A\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u0642\u0627\u0648\u0644\u064A\u0646",value:g.length,icon:"fas fa-hard-hat",color:"#ea580c",grad:"linear-gradient(135deg,#f59e0b,#ea580c)",sub:`${A(g.length,u)}% \u0645\u0646 \u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A`,pct:A(g.length,u)},{label:"\u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0631\u0636\u064A\u0629",value:d.length,icon:"fas fa-notes-medical",color:"#d97706",grad:"linear-gradient(135deg,#fbbf24,#d97706)",sub:"\u0637\u0644\u0628\u0627\u062A \u0645\u0633\u062C\u0644\u0629",pct:0},{label:"\u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A",value:m.length,icon:"fas fa-user-injured",color:"#dc2626",grad:"linear-gradient(135deg,#ef4444,#b91c1c)",sub:"\u0633\u062C\u0644 \u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A",pct:0},{label:"\u0623\u062F\u0648\u064A\u0629 \u0645\u0646\u062A\u0647\u064A\u0629",value:w,icon:"fas fa-pills",color:"#dc2626",grad:"linear-gradient(135deg,#f87171,#b91c1c)",sub:"\u0641\u064A \u0627\u0644\u0645\u062E\u0632\u0648\u0646",pct:0},{label:"\u0642\u0631\u064A\u0628\u0629 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621",value:$,icon:"fas fa-exclamation",color:"#b45309",grad:"linear-gradient(135deg,#f59e0b,#b45309)",sub:"\u062E\u0644\u0627\u0644 90 \u064A\u0648\u0645",pct:0},{label:"\u0625\u062C\u0627\u0632\u0627\u062A \u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629",value:L,icon:"fas fa-clock",color:"#4f46e5",grad:"linear-gradient(135deg,#6366f1,#4338ca)",sub:"\u0642\u064A\u062F \u0627\u0644\u0645\u0639\u0627\u0644\u062C\u0629",pct:0},{label:"\u0645\u062A\u0648\u0633\u0637 \u0634\u0647\u0631\u064A",value:S,icon:"fas fa-calendar-check",color:"#4338ca",grad:"linear-gradient(135deg,#818cf8,#4338ca)",sub:h>0?`${h} \u0634\u0647\u0631`:"\u2014",pct:0}];C.innerHTML=H.map(W=>`
...
\u0647\u0630\u0627 \u0627\u0644\u0625\u062C\u0631\u0627\u0621 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647.`,"\u062D\u0630\u0641","\u0625\u0644\u063A\u0627\u0621")){Loading.show("\u062C\u0627\u0631\u064A \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629...");try{if(AppState.googleConfig?.appsScript?.enabled){const i=await GoogleIntegration.sendRequest({action:"deleteClinicVisit",data:{visitId:e}});if(!i||i.success!==!0)throw new Error(i?.message||"\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0645\u0646 \u0627\u0644\u062E\u0627\u062F\u0645")}AppState.appData.clinicVisits=(AppState.appData.clinicVisits||[]).filter(i=>i.id!==e),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0628\u0646\u062C\u0627\u062D"),this.renderVisitsTab()}catch(i){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629: "+i.message),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",i)}}},async requestVisitDeletion(e){try{if(!e){Notification.error("\u0645\u0639\u0631\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D");return}const t=(AppState.appData.clinicVisits||[]).find(i=>i.id===e);if(!t){Notification.error("\u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}if(!(AppState?.googleConfig?.appsScript?.enabled&&AppState?.googleConfig?.appsScript?.scriptUrl)||typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest){Notification.error("\u062A\u0639\u0630\u0631 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641 (\u0627\u0644\u062E\u0627\u062F\u0645 \u063A\u064A\u0631 \u0645\u062A\u0627\u062D)");return}const s={id:AppState.currentUser?.id||"",name:AppState.currentUser?.name||"",email:AppState.currentUser?.email||"",role:AppState.currentUser?.role||""};Loading.show("\u062C\u0627\u0631\u064A \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629...");const n=await GoogleIntegration.sendRequest({action:"addClinicVisitDeletionRequest",data:{visitId:e,visitData:t,requestedBy:s}});if(Loading.hide(),!n||n.success!==!0)throw new Error(n?.message||"\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641");try{AppState.appData.clinicVisitDeletionRequests=Array.isArray(AppState.appData.clinicVisitDeletionRequests)?AppState.appData.clinicVisitDeletionRequests:[],n.data&&AppState.appData.clinicVisitDeletionRequests.unshift({...n.data,requestType:"visit"}),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save()}catch{}Notification.success("\u062A\u0645 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629 \u0625\u0644\u0649 \u0645\u062F\u064A\u0631 \u0627\u0644\u0646\u0638\u0627\u0645")}catch(t){try{Loading.hide()}catch{}Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u062D\u0630\u0641 \u0627\u0644\u0632\u064A\u0627\u0631\u0629:",t),Notification.error("\u0641\u0634\u0644 \u0625\u0631\u0633\u0627\u0644 \u0637\u0644\u0628 \u0627\u0644\u062D\u0630\u0641: "+(t.message||"\u062D\u062F\u062B \u062E\u0637\u0623"))}},getMedicationRowClass(e){return e==="\u0645\u0646\u062A\u0647\u064A"?"bg-red-50":e==="\u0642\u0631\u064A\u0628 \u0627\u0644\u0627\u0646\u062A\u0647\u0627\u0621"?"bg-yellow-50":"bg-green-50"},ensureData(){if(typeof AppState>"u")return;AppState.appData=AppState.appData||{};const e=AppState.appData;Array.isArray(e.clinicVisits)||(e.clinicVisits=[]),Array.isArray(e.medications)||(e.medications=[]),Array.isArray(e.clinicMedications)||(e.clinicMedications=[]),Array.isArray(e.clinicInventory)||(e.clinicInventory=[]);const t=e.medications.length>0?e.medications:e.clinicMedications.length>0?e.clinicMedications:e.clinicInventory.length>0?e.clinicInventory:[];e.medications.length===0&&t.length>0&&(e.medications=[...t]),e.clinicMedications.length===0&&t.length>0&&(e.clinicMedications=[...t]),e.clinicInventory.length===0&&t.length>0&&(e.clinicInventory=[...t]),Array.isArray(e.sickLeave)||(e.sickLeave=[]),Array.isArray(e.injuries)||(e.injuries=[]),Array.isArray(e.clinicSupplyRequests)||(e.clinicSupplyRequests=[]),Array.isArray(e.clinicStaff)||(e.clinicStaff=[]),Array.isArray(e.clinicStaffAttendance)||(e.clinicStaffAttendance=[]),Array.isArray(e.clinicStaffTimeOffRequests)||(e.clinicStaffTimeOffRequests=[]),Array.isArray(e.clinicStaffLeaveBalances)||(e.clinicStaffLeaveBalances=[]),Array.isArray(e.clinicStaffSystemActivities)||(e.clinicStaffSystemActivities=[]);let a=!1;if(Array.isArray(e.clinicContractorVisits)&&e.clinicContractorVisits.length>0){const n=new Set(e.clinicVisits.map(o=>o&&o.id).filter(Boolean));let i=0;e.clinicContractorVisits.forEach(o=>{o&&o.id&&!n.has(o.id)&&(o.personType="contractor",e.clinicVisits.push(o),n.add(o.id),a=!0,i++)}),i>0&&AppState.debugMode&&Utils.safeLog(`\u{1F517} [CLINIC] \u062A\u0645 \u062F\u0645\u062C ${i} \u0632\u064A\u0627\u0631\u0629 \u0645\u0642\u0627\u0648\u0644 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B \u0641\u064A ensureData`)}e.clinicVisits=e.clinicVisits.map(n=>{if(!n||typeof n!="object")return n;let i=String(n.personType||"").toLowerCase().trim();i==="external"||i==="\u062E\u0627\u0631\u062C\u064A"||i==="\u0645\u0642\u0627\u0648\u0644"||i==="contractor"?i="contractor":(i==="\u0645\u0648\u0638\u0641"||i==="staff"||i==="employee"||!i)&&(n.contractorName||n.contractorWorkerName?i="contractor":i="employee"),n.personType!==i&&(n.personType=i,a=!0);let o=[];if(n.medications&&(o=this.normalizeVisitMedications(n.medications)),(!o||o.length===0)&&n.medicationsDispensed){const d=this.normalizeVisitMedications(n.medicationsDispensed);d&&d.length>0&&(o=d,AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0648\u064A\u0644 medicationsDispensed \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,d.length,"\u062F\u0648\u0627\u0621"))}if((!o||o.length===0)&&n.medicationsDispensedQty&&n.medicationsDispensedQty>0){const d=parseInt(n.medicationsDispensedQty,10)||0;d>0&&(o=[{medicationName:n.medicationsDispensed||"\u062F\u0648\u0627\u0621 \u063A\u064A\u0631 \u0645\u062D\u062F\u062F",quantity:d,unit:"\u0648\u062D\u062F\u0629",notes:""}],AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0646\u0634\u0627\u0621 \u0633\u062C\u0644 \u062F\u0648\u0627\u0621 \u0645\u0646 medicationsDispensedQty \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,d))}o||(o=[]);const l=Array.isArray(n.medications)?n.medications:[],r=JSON.stringify(l.sort((d,m)=>(d.medicationName||"").localeCompare(m.medicationName||""))),c=JSON.stringify(o.sort((d,m)=>(d.medicationName||"").localeCompare(m.medicationName||"")));if(r!==c&&(n.medications=o,a=!0,AppState.debugMode&&o.length>0&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u062F\u064A\u062B medications \u0641\u064A ensureData \u0644\u0632\u064A\u0627\u0631\u0629 ${n.id||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F"}:`,o.length,"\u062F\u0648\u0627\u0621")),n.visitDate){const d=String(n.visitDate).trim();if(d.length===10&&d.match(/^\d{4}-\d{2}-\d{2}$/)){const m=new Date(d+"T00:00:00");n.visitDate=m.toISOString(),a=!0}else if(!d.includes("T")&&!d.includes("Z"))try{const m=new Date(d);isNaN(m.getTime())||(n.visitDate=m.toISOString(),a=!0)}catch{}}if(n.exitDate){const d=String(n.exitDate).trim();if(d.length===10&&d.match(/^\d{4}-\d{2}-\d{2}$/)){const m=new Date(d+"T00:00:00");n.exitDate=m.toISOString(),a=!0}else if(!d.includes("T")&&!d.includes("Z"))try{const m=new Date(d);isNaN(m.getTime())||(n.exitDate=m.toISOString(),a=!0)}catch{}}return n});let s=!1;if(e.clinicMedications=e.clinicMedications.map(n=>{const i=this.normalizeMedicationRecord(n),o=this.calculateMedicationStatus(i),l=n&&(n.quantityAdded!==i.quantityAdded||n.remainingQuantity!==i.remainingQuantity)||typeof n?.quantityAdded!="number"||typeof n?.remainingQuantity!="number";return(i.status!==o.status||i.daysRemaining!==o.daysRemaining||l)&&(s=!0,i.status=o.status,i.daysRemaining=o.daysRemaining),i}),e.clinicInventory=e.clinicMedications,e.sickLeave=e.sickLeave.map(n=>this.normalizeSickLeaveRecord(n)),e.injuries=e.injuries.map(n=>this.normalizeInjuryRecord(n)),AppState.appData=e,typeof window.DataManager<"u"&&window.DataManager.save)try{window.DataManager.save(),AppState.debugMode&&(s||a)&&Utils.safeLog(`\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u064A ensureData (medicationsChanged: ${s}, visitsChanged: ${a})`)}catch(n){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062A\u0639\u0630\u0631 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0627\u064B \u0641\u064A ensureData:",n.message)}else AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},ensureFilterDefaults(){this.state||(this.state={activeTab:"medications",filters:{}}),this.state.activeTab||(this.state.activeTab="medications");const e={medications:{search:"",status:"all",dateFrom:"",dateTo:""},visits:{search:"",factory:"",position:"",workplace:""},sickLeave:{search:"",department:"",dateFrom:"",dateTo:""},injuries:{search:"",status:"all",department:"",dateFrom:"",dateTo:""},attendance:{search:"",staffRole:"all",status:"all",staffId:"all",month:"",dateFrom:"",dateTo:"",period:"all"}};this.state.filters=this.state.filters||{},Object.keys(e).forEach(t=>{const a=this.state.filters[t]||{};this.state.filters[t]=Object.assign({},e[t],a)}),Array.isArray(this.state.currentInjuryAttachments)||(this.state.currentInjuryAttachments=[])},getCurrentUserSummary(e=null){if(e&&typeof e=="object"&&(e.name||e.id))return e;if(!AppState.currentUser)return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F AppState.currentUser \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F - \u0625\u0631\u062C\u0627\u0639 \u0627\u0644\u0646\u0638\u0627\u0645"),{id:"",name:"\u0627\u0644\u0646\u0638\u0627\u0645",email:"",role:""};const t=(AppState.currentUser.name||AppState.currentUser.displayName||"").toString().trim(),a=(AppState.currentUser.email||"").toString().trim(),s=(AppState.currentUser.id||"").toString().trim();AppState.debugMode&&Utils.safeLog("\u{1F50D} getCurrentUserSummary - name:",t,"email:",a,"id:",s);const n=t||a||s||"\u0627\u0644\u0646\u0638\u0627\u0645";return AppState.debugMode&&n==="\u0627\u0644\u0646\u0638\u0627\u0645"&&Utils.safeWarn('\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: getCurrentUserSummary \u064A\u0639\u064A\u062F "\u0627\u0644\u0646\u0638\u0627\u0645" - AppState.currentUser:',AppState.currentUser),{id:s,name:n,email:a,role:(AppState.currentUser.role||"").toString().trim()}},getMonthlyVisits(){const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),1);return AppState.appData.clinicVisits.filter(a=>new Date(a.visitDate||a.createdAt)>=t).length},calculateTotalTime(e,t){if(!e||!t)return"-";try{const a=e instanceof Date?e:new Date(e),s=t instanceof Date?t:new Date(t);if(isNaN(a.getTime())||isNaN(s.getTime()))return"-";const n=s.getTime()-a.getTime();if(n<0)return"-";const i=Math.floor(n/(1e3*60)),o=Math.floor(i/60),l=i%60;return o>0&&l>0?`${o} \u0633\u0627\u0639\u0629 ${l} \u062F\u0642\u064A\u0642\u0629`:o>0?`${o} \u0633\u0627\u0639\u0629`:l>0?`${l} \u062F\u0642\u064A\u0642\u0629`:"\u0623\u0642\u0644 \u0645\u0646 \u062F\u0642\u064A\u0642\u0629"}catch(a){return Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062D\u0633\u0627\u0628 \u0627\u0644\u0648\u0642\u062A:",a,{visitDate:e,exitDate:t}),"-"}},async renderVisitsList(){const e=AppState.appData.clinicVisits.slice(-10).reverse();return e.length===0?'<div class="empty-state"><p class="text-gray-500">\u0644\u0627 \u062A\u0648\u062C\u062F \u0632\u064A\u0627\u0631\u0627\u062A \u0645\u0633\u062C\u0644\u0629</p></div>':`
        ...
        `,document.body.appendChild(a);const d=a.querySelector("#sick-leave-form"),m=d.querySelector("#sick-leave-person-type"),p=d.querySelector("#sick-leave-employee-code"),u=d.querySelector("#sick-leave-name"),f=d.querySelector("#sick-leave-position"),y=d.querySelector("#sick-leave-department"),g=d.querySelector("#sick-leave-position-container"),b=d.querySelector("#sick-leave-department-container"),v=d.querySelector("#sick-leave-code-container"),w=d.querySelector("#sick-leave-name-label"),$=d.querySelector("#sick-leave-dropdown"),L=d.querySelector("#sick-leave-start-date"),h=d.querySelector("#sick-leave-end-date"),S=d.querySelector("#sick-leave-days"),D=()=>{if(!L.value||!h.value){S.textContent="\u2014";return}const T=new Date(L.value).toISOString(),_=new Date(h.value).toISOString(),M=this.calculateSickLeaveDays(T,_);S.textContent=`${M} \u064A\u0648\u0645`};L.addEventListener("change",D),h.addEventListener("change",D),L.value&&h.value&&D();const C=()=>{u&&(u.value=""),f&&(f.value=""),y&&(y.value=""),p&&(p.value="")},k=T=>{if(!T){C();return}const _=EmployeeHelper.getPrimaryCode(T);p&&_&&(p.value=_),u&&(u.value=T.name||""),f&&(f.value=T.position||T.jobTitle||""),y&&(y.value=T.department||T.unit||T.section||"")},U=()=>{!p||!u||typeof EmployeeHelper>"u"||(EmployeeHelper.setupEmployeeCodeSearch("sick-leave-employee-code","sick-leave-name",T=>{T?k(T):C()}),EmployeeHelper.setupAutocomplete("sick-leave-name",T=>{T&&k(T)}))},B=(T,_=!1)=>{const M=T==="employee";v&&(v.style.display=M?"block":"none"),g&&(g.style.display=M?"block":"none"),b&&(b.style.display=M?"block":"none"),w&&(w.textContent=`\u0627\u0633\u0645 ${M?"\u0627\u0644\u0645\u0648\u0638\u0641":T==="contractor"?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"} *`),p&&(p.disabled=!M,p.required=M,p.placeholder=M?"\u0623\u062F\u062E\u0644 \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A":"\u0631\u0642\u0645 \u0627\u0644\u062A\u0639\u0631\u064A\u0641 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)",!M&&_&&(p.value="")),u&&(u.readOnly=M,u.placeholder=M?"\u0633\u064A\u062A\u0645 \u062A\u0639\u0628\u0626\u0629 \u0627\u0644\u0627\u0633\u0645 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B":`\u0623\u062F\u062E\u0644 \u0627\u0633\u0645 ${T==="contractor"?"\u0627\u0644\u0645\u0642\u0627\u0648\u0644":"\u0627\u0644\u0639\u0627\u0645\u0644"}`,M&&_&&(u.value="")),!M&&_&&(f&&(f.value=""),y&&(y.value="")),$&&($.classList.add("hidden"),$.innerHTML=""),M&&U()};if(B(s,!1),s==="employee"&&typeof EmployeeHelper<"u"&&c){const T=EmployeeHelper.findByTerm(c);T&&k(T)}m.addEventListener("change",()=>{B(m.value,!0),m.value==="employee"&&p&&p.focus()}),d.addEventListener("submit",async T=>{T.preventDefault();const _=m.value,M=_==="employee";if(!L.value||!h.value){Notification.warning("\u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062F \u062A\u0627\u0631\u064A\u062E \u0628\u062F\u0627\u064A\u0629 \u0648\u0646\u0647\u0627\u064A\u0629 \u0627\u0644\u0625\u062C\u0627\u0632\u0629");return}const x=new Date(L.value).toISOString(),N=new Date(h.value).toISOString(),F=this.calculateSickLeaveDays(x,N),P=e?.createdAt||new Date().toISOString(),q=e?.createdBy||this.getCurrentUserSummary(),z=this.getCurrentUserSummary(),E=this.normalizeSickLeaveRecord({id:e?.id||Utils.generateId("SICK_LEAVE"),personType:_,employeeName:M?u.value.trim():null,employeeCode:M?p?.value.trim()||"":null,employeeNumber:M?p?.value.trim()||"":null,employeePosition:M?f?.value.trim()||"":null,employeeDepartment:M?y?.value.trim()||"":null,personName:M?null:u.value.trim(),startDate:x,endDate:N,daysCount:F,reason:d.querySelector("#sick-leave-reason").value.trim(),medicalNotes:d.querySelector("#sick-leave-notes").value.trim(),treatingDoctor:d.querySelector("#sick-leave-doctor").value.trim(),createdAt:P,createdBy:q,createdById:q?.id||AppState.currentUser?.id||"",updatedAt:new Date().toISOString(),updatedBy:z});Loading.show();try{const I=AppState.appData.sickLeave||[];if(t){const O=I.findIndex(j=>j.id===E.id);O!==-1?I[O]=E:I.push(E)}else I.push(E);AppState.appData.sickLeave=I;try{this.calculateClinicCardValues(),this.updateClinicAnalysisResults()}catch(O){Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u062D\u062F\u064A\u062B \u0643\u0631\u0648\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 (\u0625\u062C\u0627\u0632\u0629 \u0645\u0631\u0636\u064A\u0629):",O)}typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Loading.hide(),Notification.success(t?"\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0628\u0646\u062C\u0627\u062D":"\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629 \u0628\u0646\u062C\u0627\u062D"),a.remove(),setTimeout(()=>{document.querySelector('.clinic-tab-panel[data-tab-panel="sickLeave"]')&&this.state.activeTab==="sickLeave"&&this.renderSickLeaveTab();const j=document.querySelector("#total-sick-leave");j&&(j.textContent=I.length)},100),(async()=>{try{t?await GoogleIntegration.sendRequest({action:"updateSickLeave",data:{leaveId:E.id,updateData:E}}):await GoogleIntegration.sendRequest({action:"addSickLeave",data:E})}catch(O){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u0627\u0644\u0645\u0632\u0627\u0645\u0646\u0629 \u0645\u0639 Google Sheets:",O)}})()}catch(I){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u062D\u0641\u0638 \u0627\u0644\u0625\u062C\u0627\u0632\u0629 \u0627\u0644\u0645\u0631\u0636\u064A\u0629: "+I.message)}}),a.addEventListener("click",T=>{T.target===a&&confirm(`\u062A\u0646\u0628\u064A\u0647: \u0633\u064A\u062A\u0645 \u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0646\u0645\u0648\u0630\u062C.
\u0642\u062F \u062A\u0641\u0642\u062F \u0623\u064A \u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0645\u062D\u0641\u0648\u0638\u0629.
...
<div class="att-report-doc" id="attendance-report-root">
    ...
    <div class="att-report-footer">${s} \u2014 \u062A\u0642\u0631\u064A\u0631 \u062D\u0636\u0648\u0631 \u0645\u0633\u0626\u0648\u0644\u064A \u0627\u0644\u0639\u064A\u0627\u062F\u0629</div>
        ...
        `,document.head.appendChild(e)},renderUI(){const e=document.getElementById("clinic-section");if(!e){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u0642\u0633\u0645 clinic-section \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F!");return}this._injectClinicIdentityStyles();const t=AppState.appData;if(!t){e.innerHTML='<div class="content-card"><div class="card-body"><p class="text-gray-600">\u062C\u0627\u0631\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A...</p></div></div>';return}const a=this.getMedications().length,s=this.getSickLeaves().length,n=this.getInjuries().length,i=(t.clinicVisits||[]).length,o=this.isCurrentUserAdmin(),l=Math.max(1,i,a,s,n),r=u=>u>0?Math.min(100,Math.round(u/l*100)):0,c=[{label:"\u0633\u062C\u0644 \u0627\u0644\u062A\u0631\u062F\u062F",value:i,icon:"fas fa-hospital",iconCls:"blue",valueColor:"#1d4ed8",barColor:"#2563eb",pct:r(i)},{label:"\u0627\u0644\u0623\u062F\u0648\u064A\u0629",value:a,icon:"fas fa-pills",iconCls:"green",valueColor:"#15803d",barColor:"#22c55e",pct:r(a)},{label:"\u0627\u0644\u0625\u062C\u0627\u0632\u0627\u062A \u0627\u0644\u0645\u0631\u0636\u064A\u0629",value:s,icon:"fas fa-calendar-times",iconCls:"amber",valueColor:"#c2410c",barColor:"#f59e0b",pct:r(s)},{label:"\u0627\u0644\u0625\u0635\u0627\u0628\u0627\u062A",value:n,icon:"fas fa-user-injured",iconCls:"red",valueColor:"#b91c1c",barColor:"#ef4444",pct:r(n)}].map(u=>`
                <div class="pinsp-stat">
                    <div class="pinsp-stat__icon pinsp-stat__icon${u.iconCls}"><i class="${u.icon}"></i></div>
                    <div class="pinsp-stat__body">
                        <p class="pinsp-stat__label">${u.label}</p>
                        <p class="pinsp-stat__value" style="color:${u.valueColor};">${u.value}</p>
                        <div class="pinsp-stat__bar"><span style="width:${u.pct}%; background:${u.barColor};"></span></div>
                    </div>
                    <span class="pinsp-stat__pct">${u.pct}%</span>
                </div>
            `).join("");e.innerHTML=`
