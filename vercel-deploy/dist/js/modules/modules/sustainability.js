  ...
  <div style="padding:16px 24px;background:#fff;border-top:1.5px solid #e5e7eb;
    ...
    <button id="save-res-${t}"
      ...
      ${e?"\u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644\u0627\u062A":"\u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0633\u062C\u0644"}
        ...
        `,document.body.appendChild(l),l.addEventListener("click",r=>{r.target===l&&l.remove()})},editResourceRecord(t,a){if(!this.canEdit()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0633\u062C\u0644\u0627\u062A");return}this.showResourceForm(t,a)},async deleteResourceRecord(t,a){if(!this.canDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062D\u0630\u0641 \u0627\u0644\u0633\u062C\u0644\u0627\u062A");return}if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0633\u062C\u0644\u061F")){Loading.show();try{const e=Array.isArray(AppState.appData.resourceConsumption[t])?[...AppState.appData.resourceConsumption[t]]:[];AppState.appData.resourceConsumption[t]=AppState.appData.resourceConsumption[t].filter(i=>i.id!==a),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save();const s=await this.saveResourceConsumptionToSheets();if(!s.success){AppState.appData.resourceConsumption[t]=e,typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),Notification.error("\u0641\u0634\u0644 \u062D\u0630\u0641 \u0627\u0644\u0633\u062C\u0644 \u0641\u064A \u0627\u0644\u062E\u0627\u062F\u0645: "+(s.message||s.error||""));return}Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0633\u062C\u0644 \u0628\u0646\u062C\u0627\u062D"),this.load()}catch(e){Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+e.message)}finally{Loading.hide()}}},renderSettings(){return this.canManageSettings()?`
            <div class="content-card">
                <div class="card-header">
                    <h2 class="card-title">
