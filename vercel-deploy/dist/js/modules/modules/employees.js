const Employees={cache:{data:null,lastLoad:null,lastUpdate:null,isUpdating:!1},config:{cacheTimeout:3e5,backgroundUpdateInterval:6e5,backgroundUpdateTimer:null,_refreshedOnceForInactive:!1},activeTab:"employees-list",externalWorkforceYear:new Date().getFullYear(),_externalWorkforceLoaded:!1,_externalWorkforceLoadPromise:null,_externalWorkforceCache:new Map,_empAnalyticsCharts:{},_empAnalyticsDetailTab:"department",_empAnalyticsEventsBound:!1,_getI18nCore(){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n:window.I18n&&typeof window.I18n.t=="function"?window.I18n:null},t(e,t){const a=this._getI18nCore();return a?a.t(e,null,t||e):t||e},applyModuleI18n(e){const t=this._getI18nCore();if(!t)return;const a=e||document.getElementById("employees-section")||document;typeof t.applyI18n=="function"&&t.applyI18n(a),typeof t.applyLiteralTranslations=="function"&&t.applyLiteralTranslations(a)},_photoFailKey(e){return`hse_emp_photo_failed_${String(e||"").trim()}`},_getDriveIdFromUrl(e){try{const t=String(e||"").trim();if(!t)return"";const a=t.match(/[?&]id=([^&]+)/)||t.match(/\/file\/d\/([^/]+)/);return a?String(a[1]||"").trim():""}catch{return""}},_normalizeEmployeePhotoUrl(e,t=""){try{const a=typeof Utils<"u"&&typeof Utils.extractImageSourceCandidate=="function"?String(Utils.extractImageSourceCandidate(e)||"").trim():String(e||"").trim();if(!a)return"";let i=a;typeof Utils<"u"&&typeof Utils.normalizeImageSource=="function"?i=Utils.normalizeImageSource(a)||a:typeof window<"u"&&typeof window.__convertGoogleDriveUrl=="function"&&(i=window.__convertGoogleDriveUrl(a)||a);const n=this._getDriveIdFromUrl(i)||t||i;return sessionStorage.getItem(this._photoFailKey(n))?"":i}catch{return""}},_setupEmployeePhotoFallbacks(e){try{const a=(e||document).querySelectorAll('img[data-emp-photo="1"]');if(!a||a.length===0)return;a.forEach(i=>{if(!i||i.dataset._fallbackBound==="1")return;i.dataset._fallbackBound="1";const o=(i.dataset.photoKey||"").trim();i.addEventListener("error",()=>{try{o&&sessionStorage.setItem(this._photoFailKey(o),Date.now().toString())}catch{}try{const n=i.parentElement;n&&(n.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}},{passive:!0})})}catch{}},canEditOrDelete(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},canAddOrImport(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},getEmployeesDetailedPermissionsState(){try{if(typeof Permissions<"u"&&typeof Permissions.getEffectivePermissions=="function"){const a=Permissions.getEffectivePermissions()?.employeesPermissions;if(a&&typeof a=="object"&&!Array.isArray(a))return a}}catch{}const e=AppState.currentUser?.permissions?.employeesPermissions;return e&&typeof e=="object"&&!Array.isArray(e)?e:null},canViewEmployeesRegistryTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["employees-list"]!==!1:!0},canViewExternalWorkforceTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["external-workforce"]===!0:!0},canViewEmployeesAnalysisTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["data-analysis"]!==!1:!0},canManageExternalWorkforceTab(){return this.canAddOrImport()},isValidDate(e){if(!e)return!1;try{const t=new Date(e);return t instanceof Date&&!isNaN(t.getTime())}catch{return!1}},normalizeDateOnly(e){if(e==null||e==="")return"";if(e instanceof Date&&!isNaN(e.getTime())){const n=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),c=String(e.getDate()).padStart(2,"0");return`${n}-${s}-${c}`}if(typeof e=="number"&&isFinite(e))try{if(typeof XLSX<"u"&&XLSX?.SSF?.parse_date_code){const n=XLSX.SSF.parse_date_code(e);if(n&&n.y&&n.m&&n.d){const s=String(n.y).padStart(4,"0"),c=String(n.m).padStart(2,"0"),d=String(n.d).padStart(2,"0");return`${s}-${c}-${d}`}}}catch{}let t=String(e).trim();if(!t)return"";if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const n=JSON.parse(t);typeof n=="string"?t=n.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return""}const a=t.match(/^(\d{4}-\d{2}-\d{2})/);if(a)return a[1];const i=t.match(/^(\d{1,2})[\/\-](\d{1,2})[\/\-](\d{2,4})$/);if(i){const n=String(i[1]).padStart(2,"0"),s=String(i[2]).padStart(2,"0");return`${i[3].length===2?`20${i[3]}`:String(i[3]).padStart(4,"0")}-${s}-${n}`}const o=t.match(/^(\d{4})[\/\-](\d{1,2})[\/\-](\d{1,2})$/);if(o){const n=String(o[1]).padStart(4,"0"),s=String(o[2]).padStart(2,"0"),c=String(o[3]).padStart(2,"0");return`${n}-${s}-${c}`}try{const n=new Date(t);if(!isNaN(n.getTime())){const s=n.getFullYear(),c=String(n.getMonth()+1).padStart(2,"0"),d=String(n.getDate()).padStart(2,"0");return`${s}-${c}-${d}`}}catch{}return""},parseLocalDate(e){if(!e)return null;if(e instanceof Date&&!isNaN(e.getTime()))return e;let t=String(e).trim();if(!t)return null;if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const o=JSON.parse(t);typeof o=="string"?t=o.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return null}const a=t.match(/^(\d{4})-(\d{2})-(\d{2})/);if(a){const o=Number(a[1]),n=Number(a[2])-1,s=Number(a[3]),c=new Date(o,n,s);return isNaN(c.getTime())?null:c}const i=new Date(t);return isNaN(i.getTime())?null:i},formatDateSafe(e){return this.normalizeDateOnly(e)},calculateAge(e){if(!e)return"";try{const t=this.parseLocalDate(e);if(!t)return"";const a=new Date;let i=a.getFullYear()-t.getFullYear();const o=a.getMonth()-t.getMonth();return(o<0||o===0&&a.getDate()<t.getDate())&&i--,i>=0?i:""}catch{return""}},async load(){if(this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{typeof AppState<"u"&&AppState._languageRefresh||this.load()}),this._languageChangeListenerAdded=!0),typeof Utils>"u")return;if(typeof AppState>"u"){const t=document.getElementById("employees-section");t&&(t.innerHTML=`
            ...
            `,this.applyModuleI18n(e),setTimeout(async()=>{try{const a=document.getElementById("employees-content");if(!a)return;const i=await this.renderList().catch(o=>(Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629:",o),`
                ...
                `,this.applyModuleI18n(e))}},isEmployeeInactive(e){if(!e)return!1;const t=e.status!=null&&e.status!==""?String(e.status).trim():"";return!!((e.resignationDate!=null&&e.resignationDate!==""?String(e.resignationDate).trim():"")||t==="inactive"||t.toLowerCase()==="inactive"||t==="\u063A\u064A\u0631 \u0646\u0634\u0637")},calculateStatistics(){const e=AppState.appData.employees||[];if(e.length===0)return{total:0,averageAge:0,genderStats:{male:0,female:0},averageExperience:0,inactiveCount:0};const t=e.filter(u=>!this.isEmployeeInactive(u)),a=t.length;let i=0,o=0;t.forEach(u=>{const m=this.calculateAge(u.birthDate);m&&m>0&&(i+=m,o++)});const n=o>0?Math.round(i/o):0;let s=0,c=0,d=0;const p=u=>{if(!u)return"";let m=String(u).trim().replace(/\s+/g," ").trim();return m=m.replace(/[\u200B-\u200D\uFEFF]/g,""),m},r=u=>{const m=p(u);if(!m)return{isMale:!1,isFemale:!1};const b=m.toLowerCase(),y=m.length===1?m.toUpperCase():"",f=["\u0630\u0643\u0631","male","m","M","\u0630\u0643\u0631 "," \u0630\u0643\u0631"],w=["\u0623\u0646\u062B\u0649","female","f","F","\u0623\u0646\u062B\u0649 "," \u0623\u0646\u062B\u0649"],k=m==="\u0630\u0643\u0631"||b==="male"||y==="M"||f.some($=>p($)===m),E=m==="\u0623\u0646\u062B\u0649"||b==="female"||y==="F"||w.some($=>p($)===m);return{isMale:k,isFemale:E,normalized:m}};t.forEach(u=>{const m=r(u.gender);m.isMale?s++:m.isFemale?c++:d++}),d>0&&typeof AppState<"u"&&AppState.debugMode&&typeof console<"u";let l=0,h=0;const v=new Date;t.forEach(u=>{if(u.hireDate)try{const m=this.parseLocalDate(u.hireDate);if(m){const b=v.getFullYear()-m.getFullYear(),y=v.getMonth()-m.getMonth(),f=v.getDate()-m.getDate();let w=b;(y<0||y===0&&f<0)&&w--,w>=0&&(l+=w,h++)}}catch{}});const x=h>0?(l/h).toFixed(1):0,g=e.filter(u=>this.isEmployeeInactive(u)).length;return{total:a,averageAge:n,genderStats:{male:s,female:c},averageExperience:parseFloat(x),inactiveCount:g}},ensureEmployeesStatsCardsStyles(){const e="employees-stats-cards-styles-v2";if(document.getElementById(e))return;document.getElementById("employees-stats-cards-styles")?.remove();const a=document.createElement("style");a.id=e,a.textContent=`
        ...
        `,s=c=>{const d=c.maleCount||0,p=c.femaleCount||0,r=d+p,l=r>0?Math.round(d/r*100):0,h=r>0?100-l:0;return`
                <div class="employee-stat-card employee-stat-card--gender"
                    ...
                    ${r>0?`
                        <div class="employee-stat-gender-row">
                            ...
                            <div class="employee-stat-gender-item employee-stat-gender-item--female" title="${o}: ${p}">
                                <span class="employee-stat-gender-num">${p.toLocaleString("en-US")}</span>
        ...
        `).join("")},_empRenderAnalyticsBreadcrumb(e){const t=document.getElementById("emp-analytics-breadcrumb");if(!t)return;const a=[this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")];e.department&&a.push(e.department),e.job&&a.push(e.job),t.innerHTML=a.map((i,o)=>{const n=o===a.length-1;return`<span class="emp-analytics-crumb${n?" emp-analytics-crumb--active":""}">${Utils.escapeHTML(i)}</span>${n?"":'<span class="emp-analytics-crumb-sep">\u203A</span>'}`}).join("")},_empPopulateAnalyticsFilterOptions(e){const t=Array.isArray(e)?e:[],a=n=>[...new Set(t.map(s=>this._empAnalyticsLabel(s[n])).filter(Boolean))].sort((s,c)=>s.localeCompare(c,"ar")),i=(n,s,c)=>{const d=document.getElementById(n);if(!d)return;const p=c||d.value;d.innerHTML=`<option value="">${this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")}</option>`+s.map(r=>`<option value="${Utils.escapeHTML(r)}"${r===p?" selected":""}>${Utils.escapeHTML(r)}</option>`).join("")},o=this._empGetAnalyticsFiltersFromDom();i("emp-af-department",a("department"),o.department),i("emp-af-job",a("job"),o.job),i("emp-af-branch",a("branch"),o.branch),i("emp-af-location",a("location"),o.location),i("emp-af-position",a("position"),o.position)},_empRenderAnalyticsHeatmap(e){const t=document.getElementById("emp-analytics-heatmap");if(!t)return;const a=e.departmentJobMatrix||{},i=Object.entries(a).map(([p,r])=>{const[l,h]=p.split("|||");return{dept:l,job:h,count:r}}).sort((p,r)=>r.count-p.count);if(!i.length){t.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const o=[...new Set(i.slice(0,12).map(p=>p.dept))],n=[...new Set(i.slice(0,12).map(p=>p.job))],s=Math.max(...i.map(p=>p.count),1),c={};i.forEach(p=>{c[p.dept+"|||"+p.job]=p.count});let d='<table class="emp-analytics-heatmap-table"><thead><tr><th></th>';n.forEach(p=>{d+=`<th title="${Utils.escapeHTML(p)}">${Utils.escapeHTML(p.length>14?p.slice(0,14)+"\u2026":p)}</th>`}),d+="</tr></thead><tbody>",o.forEach(p=>{d+=`<tr><th title="${Utils.escapeHTML(p)}">${Utils.escapeHTML(p.length>16?p.slice(0,16)+"\u2026":p)}</th>`,n.forEach(r=>{const l=c[p+"|||"+r]||0,h=l>0?.15+l/s*.85:0,v=l>0?`rgba(29, 78, 216, ${h})`:"#f8fafc",x=h>.5?"#fff":"#334155";d+=`<td class="emp-analytics-heatmap-cell" data-dept="${Utils.escapeHTML(p)}" data-job="${Utils.escapeHTML(r)}" style="background:${v};color:${x};" title="${Utils.escapeHTML(p)} / ${Utils.escapeHTML(r)}: ${l}">${l||""}</td>`}),d+="</tr>"}),d+="</tbody></table>",t.innerHTML=d,t.querySelectorAll(".emp-analytics-heatmap-cell").forEach(p=>{p.addEventListener("click",()=>{const r=p.getAttribute("data-dept")||"",l=p.getAttribute("data-job")||"";!r&&!l||(this._empApplyAnalyticsFilter("department",r,{skipUpdate:!0}),this._empApplyAnalyticsFilter("job",l))})})},_empRenderAnalyticsDetailTable(e){const t=document.getElementById("emp-analytics-detail-table");if(!t)return;const a=this._empAnalyticsDetailTab||"department",i=a==="job"?e.byJob:e.byDepartment,o=a==="job"?this.t("module.employees.job","\u0627\u0644\u0648\u0638\u064A\u0641\u0629"):this.t("module.employees.department","\u0627\u0644\u0642\u0633\u0645"),n=a==="job"?"job":"department";if(!i.length){t.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const c=this._empGetAnalyticsFiltersFromDom()[n];t.innerHTML=`
        ...
        `;const p=document.createElement("tbody");a.forEach(r=>{const l=this.formatDateSafe(r.birthDate),h=this.formatDateSafe(r.hireDate),v=this.calculateAge(r.birthDate),x=this.isEmployeeInactive(r),g=x?"opacity: 0.7; background-color: #f8f9fa;":"",u=document.createElement("tr");x&&(u.style.cssText=g);const b=(this._getDriveIdFromUrl(r.photo||"")||r.id||r.employeeNumber||r.name||"").toString(),y=this._normalizeEmployeePhotoUrl(r.photo,r.id),f=y&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(y):{canonical:y||"",displaySrc:y||"",needsProxy:!1,proxyFileId:""},w=f.canonical?f.displaySrc:"",k=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(f):"";u.innerHTML=`
                <td style="word-wrap: break-word;">
                    ${y?`<img data-emp-photo="1" data-photo-key="${Utils.escapeHTML(b)}" src="${Utils.escapeHTML(w)}" alt="${Utils.escapeHTML(r.name||"")}"${k} class="w-12 h-12 rounded-full object-cover" loading="lazy" decoding="async" referrerpolicy="no-referrer">`:'<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>'}
                </td>
        ...
        `,this.applyModuleI18n(a),document.body.appendChild(a);const i=a.querySelector("#employee-excel-file-input"),o=a.querySelector("#employee-import-confirm-btn");let n=[],s=this.buildEmployeeImportExistingKeySet(),c=null;const d=()=>this.renderEmployeeImportReview(a,n);i.addEventListener("change",async p=>{const r=p.target.files[0];if(r){Loading.show("\u062C\u0627\u0631\u064A \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641...");try{await this.yieldEmployeeImportUi_();const l=await r.arrayBuffer();Loading.show("\u062C\u0627\u0631\u064A \u062A\u062D\u0644\u064A\u0644 Excel..."),await this.yieldEmployeeImportUi_();const h=XLSX.read(l,{type:"array",cellDates:!0}),v=h.SheetNames[0],x=h.Sheets[v],g=XLSX.utils.sheet_to_json(x,{header:1,defval:"",raw:!1});if(g.length<2){Notification.error(this.t("module.employees.invalidFile","\u0627\u0644\u0645\u0644\u0641 \u0641\u0627\u0631\u063A \u0623\u0648 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D")),n=[],d(),Loading.hide();return}const u=g[0].map(w=>String(w||"").trim()),m=g.slice(1).map(w=>{const k={};return u.forEach((E,$)=>{const D=w[$];k[E]=D??""}),k}).filter(w=>u.some(k=>String(w[k]||"").trim()!==""));s=this.buildEmployeeImportExistingKeySet();const b=new Set,y=Date.now();n=new Array(m.length);const f=400;for(let w=0;w<m.length;w+=f){const k=Math.min(w+f,m.length);Loading.show(`\u062C\u0627\u0631\u064A \u0645\u0637\u0627\u0628\u0642\u0629 \u0627\u0644\u0635\u0641\u0648\u0641... ${k} / ${m.length}`);for(let E=w;E<k;E++){const $=this.parseEmployeeImportRow(m[E],`imp-${E}-${y}`);n[E]=this.classifyEmployeeImportDraft($,b,s)}await this.yieldEmployeeImportUi_()}Loading.show("\u062C\u0627\u0631\u064A \u062A\u062C\u0647\u064A\u0632 \u0634\u0627\u0634\u0629 \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629..."),await this.yieldEmployeeImportUi_(),d(),Loading.hide()}catch(l){Loading.hide(),Notification.error(this.t("module.employees.readFileFailed","\u0641\u0634\u0644 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641")+": "+l.message)}}}),a.addEventListener("change",p=>{const r=p.target.closest(".emp-imp-field");if(!r)return;const l=r.closest("tr[data-import-uid]");if(!l)return;const h=l.getAttribute("data-import-uid"),v=n.find(g=>g.uid===h);if(!v)return;const x=r.getAttribute("data-field");x&&(v[x]=r.value,c&&clearTimeout(c),c=setTimeout(()=>{this.reclassifyAllEmployeeImportDrafts(n,s),d()},180))}),a.addEventListener("click",p=>{const r=p.target.closest(".emp-imp-remove");if(r){const l=r.closest("tr[data-import-uid]");if(!l)return;const h=l.getAttribute("data-import-uid");n=n.filter(v=>v.uid!==h),this.reclassifyAllEmployeeImportDrafts(n,s),d();return}p.target===a&&a.remove()}),o.addEventListener("click",async()=>{const p=n.filter(v=>v.status==="new");if(p.length===0){Notification.warning("\u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0648\u0638\u0641\u0648\u0646 \u062C\u062F\u062F \u0644\u0644\u0625\u0636\u0627\u0641\u0629");return}const r=this.getEmployeeImportCounts(n),l=this.getEmployeeImportHireWindowLabel();if(window.confirm(`\u0633\u064A\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 ${p.length} \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F \u0641\u0642\u0637.
...
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629\u061F`)){Loading.show(`\u062C\u0627\u0631\u064A \u0625\u0636\u0627\u0641\u0629 ${p.length} \u0645\u0648\u0638\u0641...`);try{let v=0,x=0;const g=[],u=s instanceof Set?new Set(s):this.buildEmployeeImportExistingKeySet(),m=300;for(let y=0;y<p.length;y+=m){const f=Math.min(y+m,p.length);for(let w=y;w<f;w++){const k=p[w];try{if(this.employeeImportKeysMatchExisting(k.employeeNumber,k.sapId,u)){x++;continue}const E=this.buildEmployeeFromImportDraft(k);if(!E){x++;continue}if(this.employeeImportKeysMatchExisting(E.employeeNumber,E.sapId,u)){x++;continue}AppState.appData.employees.push(E),g.push(E);const $=this.normalizeEmployeeImportKey(E.employeeNumber),D=this.normalizeEmployeeImportKey(E.sapId),A=this.normalizeEmployeeImportKey(E.id);$&&u.add($),D&&u.add(D),A&&u.add(A),v++}catch{x++}}Loading.show(`\u062C\u0627\u0631\u064A \u0627\u0644\u0625\u0636\u0627\u0641\u0629... ${f} / ${p.length}`),await this.yieldEmployeeImportUi_()}typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),s=u,Loading.hide(),Notification.success(`\u0623\u064F\u0636\u064A\u0641 ${v} \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F \u0645\u062D\u0644\u064A\u0627\u064B`+(r.existsCount>0?` \u2014 \u062A\u064F\u062E\u0637\u064A \u0645\u0648\u062C\u0648\u062F ${r.existsCount}`:"")+(r.hireDateRejectedCount>0?` \u2014 \u062A\u0639\u064A\u064A\u0646 \u062E\u0627\u0631\u062C ${this.getEmployeeImportHireWindowLabel()} ${r.hireDateRejectedCount}`:"")+(r.invalidCount>r.hireDateRejectedCount?` \u2014 \u0646\u0627\u0642\u0635 ${r.invalidCount-r.hireDateRejectedCount}`:"")+(x>0?` \u2014 \u0627\u0633\u062A\u064F\u0628\u0639\u062F \u0639\u0646\u062F \u0627\u0644\u062D\u0641\u0638 ${x}`:"")+(g.length>0?" \u2014 \u062C\u0627\u0631\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062C\u062F\u062F \u0645\u0639 \u0627\u0644\u0633\u062D\u0627\u0628\u0629 \u0628\u0627\u0644\u062E\u0644\u0641\u064A\u0629":"")),a.remove(),this.renderStatsCards();const b=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(b),requestAnimationFrame(()=>{this.applyFilters()}),g.length>0&&this.syncImportedEmployeesToCloud_(g)}catch(v){Loading.hide(),Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+v.message)}}})},async syncImportedEmployeesToCloud_(e){const t=Array.isArray(e)?e.filter(Boolean):[];if(!t.length||typeof GoogleIntegration>"u")return;if(typeof GoogleIntegration._isBackendRpcConfigured=="function"&&!GoogleIntegration._isBackendRpcConfigured()){Notification?.warning?.("\u062D\u064F\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B \u2014 \u0627\u0644\u062E\u0627\u062F\u0645 \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644 \u0644\u0644\u0645\u0632\u0627\u0645\u0646\u0629");return}const a=s=>({id:s.id,name:s.name,employeeNumber:s.employeeNumber,sapId:s.sapId,hireDate:s.hireDate,job:s.job||s.position||"",position:s.position||s.job||"",department:s.department||"",branch:s.branch||"",location:s.location||"",gender:s.gender||"",nationalId:s.nationalId||"",birthDate:s.birthDate||"",email:s.email||"",phone:s.phone||"",insuranceNumber:s.insuranceNumber||"",photo:"",status:s.status||"active",resignationDate:s.resignationDate||"",createdAt:s.createdAt||new Date().toISOString(),updatedAt:s.updatedAt||new Date().toISOString()}),i=40;let o=0,n=0;for(let s=0;s<t.length;s+=i){const c=t.slice(s,s+i).map(a);try{const d=typeof GoogleIntegration.sendRequest=="function"?GoogleIntegration.sendRequest({action:"appendToSheet",data:{sheetName:"Employees",data:c,__timeoutMs:9e4,userData:AppState.currentUser||{}}}):GoogleIntegration.sendToAppsScript("appendToSheet",{sheetName:"Employees",data:c,__timeoutMs:9e4,userData:AppState.currentUser||{}}),p=typeof Utils<"u"&&Utils.promiseWithTimeout?await Utils.promiseWithTimeout(d,95e3,"\u0627\u0646\u062A\u0647\u062A \u0645\u0647\u0644\u0629 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646"):await d;p&&p.success?o+=c.length:(n+=c.length,Utils.safeWarn?.("\u26A0\uFE0F \u0641\u0634\u0644 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646:",p?.message))}catch(d){n+=c.length,Utils.safeWarn?.("\u26A0\uFE0F \u062E\u0637\u0623 \u0645\u0632\u0627\u0645\u0646\u0629 \u062F\u0641\u0639\u0629 \u0645\u0648\u0638\u0641\u064A\u0646:",d?.message||d)}await this.yieldEmployeeImportUi_()}o>0&&n===0?Notification?.success?.(`\u062A\u0645\u062A \u0645\u0632\u0627\u0645\u0646\u0629 ${o} \u0645\u0648\u0638\u0641\u0627\u064B \u062C\u062F\u064A\u062F\u0627\u064B \u0645\u0639 \u0627\u0644\u0633\u062D\u0627\u0628\u0629`):o>0&&n>0?Notification?.warning?.(`\u062A\u0645\u062A \u0645\u0632\u0627\u0645\u0646\u0629 ${o} \u2014 \u062A\u0639\u0630\u0651\u0631 ${n}. \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0641\u0648\u0638\u0629 \u0645\u062D\u0644\u064A\u0627\u064B.`):n>0&&Notification?.warning?.(`\u062D\u064F\u0641\u0638 \u0645\u062D\u0644\u064A\u0627\u064B \u2014 \u062A\u0639\u0630\u0651\u0631\u062A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0633\u062D\u0627\u0628\u0629 (${n}). \u0623\u0639\u062F \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0644\u0627\u062D\u0642\u0627\u064B \u0623\u0648 \u0645\u0646 \u0632\u0631 \u0627\u0644\u062A\u062D\u062F\u064A\u062B.`)},async handleSubmit(e){e.preventDefault();const t=e.target?.querySelector('button[type="submit"]')||document.querySelector('#employee-form button[type="submit"]');if(t&&t.disabled)return;let a="";t&&(a=t.innerHTML,t.disabled=!0,t.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const i=this.currentEditId?AppState.appData.employees.find(A=>A.id===this.currentEditId):null;let o=i?.photo||"";const n=document.getElementById("employee-photo-input");if(n&&n.files.length>0){const A=n.files[0];if(A.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 \u0647\u0648 2MB"),t&&(t.disabled=!1,t.innerHTML=a);return}o=await this.convertImageToBase64(A)}const s=document.getElementById("employee-name"),c=document.getElementById("employee-number"),d=document.getElementById("employee-sap-id"),p=document.getElementById("employee-hire-date"),r=document.getElementById("employee-birth-date"),l=document.getElementById("employee-department"),h=document.getElementById("employee-position"),v=document.getElementById("employee-branch"),x=document.getElementById("employee-location"),g=document.getElementById("employee-gender"),u=document.getElementById("employee-national-id"),m=document.getElementById("employee-email"),b=document.getElementById("employee-phone"),y=document.getElementById("employee-insurance-number");if(!s||!c||!d||!l||!h||!v||!x||!g||!m||!b){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649.");return}const f=!!this.currentEditId,w=f&&i?.hireDate||"",k=f&&i?.birthDate||"",E={id:c.value.trim()||this.currentEditId||Utils.generateId("EMP"),name:s.value.trim(),employeeNumber:c.value.trim(),sapId:d.value.trim(),hireDate:p?.value?this.normalizeDateOnly(p.value):f?this.normalizeDateOnly(w):this.normalizeDateOnly(new Date),birthDate:r?.value?this.normalizeDateOnly(r.value):f?this.normalizeDateOnly(k):"",department:l.value.trim(),job:h.value.trim(),position:h.value.trim(),branch:v.value.trim(),location:x.value.trim(),gender:g.value,nationalId:u?.value.trim()||"",email:m.value.trim(),phone:b.value.trim(),insuranceNumber:y?.value.trim()||"",photo:o,status:f&&i?.status||"active",resignationDate:f&&i?.resignationDate||"",createdAt:this.currentEditId?i?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};if(!E.name||!E.sapId||!E.employeeNumber||!E.department||!E.position){Notification.error("\u064A\u0631\u062C\u0649 \u0645\u0644\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 (\u0627\u0644\u0627\u0633\u0645\u060C \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0642\u0633\u0645\u060C \u0627\u0644\u0645\u0646\u0635\u0628)"),t&&(t.disabled=!1,t.innerHTML=a);return}const $=String(E.id||"").trim();if(!$){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D (\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u0646\u0634\u0627\u0621 id \u0641\u0627\u0631\u063A)"),t&&(t.disabled=!1,t.innerHTML=a);return}if(AppState.appData.employees.some(A=>{const M=String(A?.id||"").trim();return!M||this.currentEditId&&M===String(this.currentEditId).trim()?!1:M===$})){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u0645\u0633\u062A\u062E\u062F\u0645 \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0631\u0642\u0645 \u0622\u062E\u0631."),t&&(t.disabled=!1,t.innerHTML=a);return}Loading.show();try{if(this.currentEditId){const A=AppState.appData.employees.findIndex(M=>M.id===this.currentEditId);A!==-1&&(AppState.appData.employees[A]=E,this.currentEditId=$),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D")}else AppState.appData.employees.push(E),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D");typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("Employees",AppState.appData.employees),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),t&&(t.disabled=!1,t.innerHTML=a),this.renderStatsCards(),this.showList()}catch(A){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+A.message),t&&(t.disabled=!1,t.innerHTML=a)}},async convertImageToBase64(e){return new Promise((t,a)=>{const i=new FileReader;i.onload=()=>t(i.result),i.onerror=a,i.readAsDataURL(e)})},async showList(){this.currentEditId=null,!this.canViewEmployeesRegistryTab()&&this.canViewEmployeesAnalysisTab()?this.activeTab="data-analysis":!this.canViewEmployeesRegistryTab()&&this.canViewExternalWorkforceTab()?this.activeTab="external-workforce":!this.canViewExternalWorkforceTab()&&!this.canViewEmployeesAnalysisTab()&&(this.activeTab="employees-list");const e=document.getElementById("employees-content");e&&(e.innerHTML=await this.renderList(),this.applyModuleI18n(e),requestAnimationFrame(()=>{this.setupEventListeners(),this.canViewEmployeesRegistryTab()&&this.activeTab==="employees-list"?this.loadEmployeesList():this.activeTab==="data-analysis"&&this.canViewEmployeesAnalysisTab()?this.loadEmployeesAnalysis().catch(()=>{}):this.canViewExternalWorkforceTab()&&(this.populateExternalWorkforceYearSelector(),this.ensureExternalWorkforceDataLoaded().then(()=>this.renderExternalWorkforceTable()).catch(()=>{})),this.activeTab==="employees-list"&&this.scrollToSearchField()}))},async editEmployee(e){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const t=AppState.appData.employees.find(a=>a.id===e);t&&await this.showForm(t)},async printEmployee(e){const t=AppState.appData.employees.find(a=>a.id===e);if(!t){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}try{Loading.show();let a="";const i=this._normalizeEmployeePhotoUrl(t.photo,t.id);if(i&&typeof Utils.resolveDriveAwareImgDisplay=="function"){const m=Utils.resolveDriveAwareImgDisplay(i);if(m.needsProxy&&typeof Utils.fetchDriveImageDataUri=="function")try{a=await Utils.fetchDriveImageDataUri(m.proxyFileId)||""}catch{a=""}a||(a=m.canonical||i)}else i&&(a=i);const o=this.formatDateSafe(t.birthDate),n=this.formatDateSafe(t.hireDate),s=this.calculateAge(t.birthDate),c=m=>{if(!m)return"-";try{const b=new Date(m),y=b.getFullYear(),f=b.getMonth()+1,w=b.getDate(),k=["\u0660","\u0661","\u0662","\u0663","\u0664","\u0665","\u0666","\u0667","\u0668","\u0669"],E=$=>String($).split("").map(D=>k[parseInt(D)]||D).join("");return`${E(y)}/${E(f)}/${E(w)}`}catch{return m}},d=new Date,p=c(d.toISOString().split("T")[0]),r=d.toLocaleTimeString("ar-SA",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}),l=AppState?.companySettings?.name||AppState?.appData?.companyName||"\u0627\u0644\u0634\u0631\u0643\u0629",h=`
                <style>
                ...
                <div class="employee-card">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="print-date">\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0637\u0628\u0627\u0639\u0629: ${p} - ${r}</div>
                    </div>
                </div>
            `,v=`<!DOCTYPE html>
...
</html>`,x=new Blob([v],{type:"text/html;charset=utf-8"}),g=URL.createObjectURL(x),u=window.open(g,"_blank");u?u.onload=()=>{const m=u.document.querySelectorAll("img");let b=0;const y=m.length;if(y===0)setTimeout(()=>{u.print(),setTimeout(()=>{URL.revokeObjectURL(g),Loading.hide()},800)},300);else{const f=()=>{b>=y&&setTimeout(()=>{u.print(),setTimeout(()=>{URL.revokeObjectURL(g),Loading.hide()},800)},300)};m.forEach(w=>{w.complete?(b++,f()):(w.onload=()=>{b++,f()},w.onerror=()=>{b++,f()})}),setTimeout(()=>{b<y&&(u.print(),setTimeout(()=>{URL.revokeObjectURL(g),Loading.hide()},800))},3e3)}}:(URL.revokeObjectURL(g),Loading.hide(),Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0639\u0631\u0636 \u0627\u0644\u062A\u0642\u0631\u064A\u0631"))}catch(a){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0637\u0628\u0627\u0639\u0629 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641:",a),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u0637\u0628\u0627\u0639\u0629: "+a.message)}},async viewEmployee(e){const t=AppState.appData.employees.find(s=>s.id===e);if(!t)return;const a=this.formatDateSafe(t.birthDate),i=this.formatDateSafe(t.hireDate),o=this.calculateAge(t.birthDate),n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
...
\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: \u0647\u0630\u0647 \u0627\u0644\u0639\u0645\u0644\u064A\u0629 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647\u0627!`)){Loading.show();try{AppState.appData.employees=(AppState.appData.employees||[]).filter(a=>a.id!==e),setTimeout(()=>{typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},50),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D"),this.renderStatsCards();const t=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(t),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(a){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",a)}}),AppState.googleConfig?.appsScript?.enabled&&GoogleIntegration.sendToAppsScript("deleteEmployee",{employeeId:e}).then(a=>{!a||!a.success?Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 Google Sheets:",a?.message):Utils.safeLog("\u2705 \u062A\u0645 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}).catch(a=>Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062D\u0630\u0641 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",a))}catch(t){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}}},scrollToSearchField(){setTimeout(()=>{const e=document.getElementById("employees-search");if(e){const t=window.scrollY||document.documentElement.scrollTop,a=Math.max(0,(e.offsetTop||0)-20),i=t+window.innerHeight;(a<t||a>i-100)&&window.scrollTo({top:a,behavior:"smooth"})}},0)},getFilterValues(){return{search:document.getElementById("employees-search-filter")?.value||document.getElementById("employees-search")?.value||"",department:document.getElementById("employee-filter-department")?.value||"",branch:document.getElementById("employee-filter-branch")?.value||"",location:document.getElementById("employee-filter-location")?.value||"",job:document.getElementById("employee-filter-job")?.value||"",position:document.getElementById("employee-filter-position")?.value||"",gender:document.getElementById("employee-filter-gender")?.value||"",showInactive:document.getElementById("show-inactive-employees")?.checked||!1}},async filterEmployees(e="",t=!1,a=null){try{if(a)t=a.showInactive!==void 0&&a.showInactive!==null?a.showInactive:t;else{const r=this.getFilterValues();e=e||r.search,t=t??(r.showInactive||!1),a=r,a.showInactive=t}const i=document.getElementById("employees-table-container");if(!i){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}let o=i.querySelector("tbody");if(!o&&(await this.loadEmployeesList(t),o=i.querySelector("tbody"),!o)){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F tbody \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0628\u0639\u062F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629");return}let n=AppState.appData.employees||[];t||(n=n.filter(r=>!this.isEmployeeInactive(r)));let s=n;const c=this.canEditOrDelete();if(e&&e.trim()){const r=e.trim().toLowerCase();s=s.filter(l=>l.name&&l.name.toLowerCase().includes(r)||l.employeeNumber&&String(l.employeeNumber).toLowerCase().includes(r)||l.sapId&&String(l.sapId).toLowerCase().includes(r)||l.department&&l.department.toLowerCase().includes(r)||l.position&&l.position.toLowerCase().includes(r)||l.job&&l.job.toLowerCase().includes(r)||l.branch&&l.branch.toLowerCase().includes(r)||l.location&&l.location.toLowerCase().includes(r)||l.nationalId&&l.nationalId.toLowerCase().includes(r)||l.phone&&l.phone.toLowerCase().includes(r)||l.insuranceNumber&&l.insuranceNumber.toLowerCase().includes(r)||l.email&&l.email.toLowerCase().includes(r)||l.gender&&l.gender.toLowerCase().includes(r))}a.department&&(s=s.filter(r=>String(r.department||"").trim()===String(a.department).trim())),a.branch&&(s=s.filter(r=>String(r.branch||"").trim()===String(a.branch).trim())),a.location&&(s=s.filter(r=>String(r.location||"").trim()===String(a.location).trim())),a.job&&(s=s.filter(r=>String(r.job||"").trim()===String(a.job).trim())),a.position&&(s=s.filter(r=>String(r.position||"").trim()===String(a.position).trim())),a.gender&&(s=s.filter(r=>String(r.gender||"").trim()===String(a.gender).trim()));const d=document.createDocumentFragment(),p=13;if(s.length===0){const r=document.createElement("tr");r.innerHTML=`<td colspan="${p}" class="text-center text-gray-500 py-8">\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C</td>`,d.appendChild(r)}else s.forEach(r=>{const l=this.formatDateSafe(r.birthDate),h=this.formatDateSafe(r.hireDate),v=this.calculateAge(r.birthDate),x=this.isEmployeeInactive(r),g=x?"opacity: 0.7; background-color: #f8f9fa;":"",u=document.createElement("tr");x&&(u.style.cssText=g);const m=this._normalizeEmployeePhotoUrl(r.photo,r.id),y=(this._getDriveIdFromUrl(r.photo||"")||r.id||r.employeeNumber||r.name||"").toString(),f=m&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(m):{canonical:m||"",displaySrc:m||"",needsProxy:!1,proxyFileId:""},w=f.canonical?f.displaySrc:"",k=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(f):"";u.innerHTML=`
                    ...
                    `}
                `,d.appendChild(u)});o.innerHTML="",o.appendChild(d),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(o,{onFetchFail:r=>{try{const l=(r.dataset.photoKey||"").trim();l&&sessionStorage.setItem(this._photoFailKey(l),Date.now().toString())}catch{}try{const l=r.parentElement;l&&(l.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}}),this.updateFilterBadges(n,s,a),AppState.debugMode&&e&&Utils.safeLog(`\u{1F50D} \u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0628\u062D\u062B: ${s.length} \u0645\u0646 ${n.length} \u0645\u0648\u0638\u0641`)}catch(i){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A filterEmployees:",i)}},updateFilterBadges(e,t,a){try{if(!a){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F updateFilterBadges: filters \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}const i=(o,n,s)=>{try{const c=document.getElementById(o);if(!c){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: ${o} \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F`);return}const d=c.closest(".filter-field");if(!d){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-field \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const p=d.querySelector(".filter-label");if(!p){AppState.debugMode&&n&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-label \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const r=p.querySelector(".filter-count-badge");if(r&&r.remove(),n&&n.trim()!==""){const l=document.createElement("span");l.className="filter-count-badge",l.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",l.textContent=s;const h=p.querySelector("i");h?h.insertAdjacentElement("afterend",l):p.insertBefore(l,p.firstChild),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0639\u062F\u062F (${s}) \u0644\u0640 ${o}`)}}catch(c){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0641\u0644\u062A\u0631:",c)}};if(a.department?i("employee-filter-department",a.department,t.length):i("employee-filter-department","",0),a.branch?i("employee-filter-branch",a.branch,t.length):i("employee-filter-branch","",0),a.location?i("employee-filter-location",a.location,t.length):i("employee-filter-location","",0),a.job?i("employee-filter-job",a.job,t.length):i("employee-filter-job","",0),a.position?i("employee-filter-position",a.position,t.length):i("employee-filter-position","",0),a.gender?i("employee-filter-gender",a.gender,t.length):i("employee-filter-gender","",0),a.search&&a.search.trim())try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const n=o.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const c=s.querySelector(".filter-count-badge");c&&c.remove();const d=document.createElement("span");d.className="filter-count-badge",d.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",d.textContent=t.length;const p=s.querySelector("i");p?p.insertAdjacentElement("afterend",d):s.insertBefore(d,s.firstChild)}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}else try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const n=o.closest(".filter-field");if(n){const s=n.querySelector(".filter-label");if(s){const c=s.querySelector(".filter-count-badge");c&&c.remove()}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0625\u0632\u0627\u0644\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}}catch(i){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A updateFilterBadges:",i)}},async applyFilters(){try{const e=this.getFilterValues();await this.filterEmployees(e.search,e.showInactive,e),this.updateInactiveCount()}catch(e){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A applyFilters:",e)}finally{this.updateInactiveCount()}},async resetFilters(){const e=document.getElementById("employees-search"),t=document.getElementById("employees-search-filter");e&&(e.value=""),t&&(t.value=""),["employee-filter-department","employee-filter-branch","employee-filter-location","employee-filter-job","employee-filter-position","employee-filter-gender"].forEach(n=>{const s=document.getElementById(n);s&&(s.value="")});const i=document.getElementById("show-inactive-employees");i&&(i.checked=!1);const o=document.getElementById("show-inactive-employees-container");o&&(o.style.background="linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)",o.style.borderColor="#dee2e6",o.style.boxShadow="none"),await this.applyFilters(),this.updateInactiveCount()},updateInactiveCount(e=0){const i=()=>{try{const n=(AppState.appData.employees||[]).filter(c=>this.isEmployeeInactive(c)).length,s=document.getElementById("inactive-employees-count");if(s){s.textContent=n;const c=n===0,d=c?"#6b7280":"#dc2626",p=c?"0 2px 4px rgba(107, 114, 128, 0.3)":"0 2px 4px rgba(220, 38, 38, 0.3)";s.style.cssText=`
    ...
    `,d=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${e.year}`,o,c,!1,!0,{version:"1.0",releaseDate:n,revisionDate:n,includeQRCode:!0},n,n):`<!DOCTYPE html><html lang="${i.lang}" dir="${i.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${i.dir};padding:20px;">${c}</body></html>`,p=new Blob(["\uFEFF"+d],{type:"text/html;charset=utf-8"}),r=URL.createObjectURL(p),l=window.open(r,"_blank");if(!l){URL.revokeObjectURL(r),Notification.error("\u062A\u0639\u0630\u0631 \u0641\u062A\u062D \u0646\u0627\u0641\u0630\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629");return}l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>URL.revokeObjectURL(r),1e3)},400)}},(function(){"use strict";try{typeof window<"u"&&typeof Employees<"u"&&(window.Employees=Employees,typeof AppState<"u"&&AppState.debugMode&&typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u2705 Employees module loaded and available on window.Employees"),typeof AppState<"u"&&AppState.currentUser&&setTimeout(()=>{window.Employees&&window.Employees.init&&window.Employees.init().catch(e=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u0647\u064A\u0626\u0629 \u0645\u0648\u062F\u064A\u0648\u0644 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",e)})},2e3))}catch{if(typeof window<"u"&&typeof Employees<"u")try{window.Employees=Employees}catch{}}})();
