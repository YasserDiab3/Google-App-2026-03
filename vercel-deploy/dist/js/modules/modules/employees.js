const Employees={cache:{data:null,lastLoad:null,lastUpdate:null,isUpdating:!1},config:{cacheTimeout:3e5,backgroundUpdateInterval:6e5,backgroundUpdateTimer:null,_refreshedOnceForInactive:!1},activeTab:"employees-list",externalWorkforceYear:new Date().getFullYear(),_externalWorkforceLoaded:!1,_externalWorkforceLoadPromise:null,_externalWorkforceCache:new Map,_empAnalyticsCharts:{},_empAnalyticsDetailTab:"department",_empAnalyticsEventsBound:!1,_getI18nCore(){return window.AppI18n&&typeof window.AppI18n.t=="function"?window.AppI18n:window.I18n&&typeof window.I18n.t=="function"?window.I18n:null},t(e,t){const a=this._getI18nCore();return a?a.t(e,null,t||e):t||e},applyModuleI18n(e){const t=this._getI18nCore();if(!t)return;const a=e||document.getElementById("employees-section")||document;typeof t.applyI18n=="function"&&t.applyI18n(a),typeof t.applyLiteralTranslations=="function"&&t.applyLiteralTranslations(a)},_photoFailKey(e){return`hse_emp_photo_failed_${String(e||"").trim()}`},_getDriveIdFromUrl(e){try{const t=String(e||"").trim();if(!t)return"";const a=t.match(/[?&]id=([^&]+)/)||t.match(/\/file\/d\/([^/]+)/);return a?String(a[1]||"").trim():""}catch{return""}},_normalizeEmployeePhotoUrl(e,t=""){try{const a=typeof Utils<"u"&&typeof Utils.extractImageSourceCandidate=="function"?String(Utils.extractImageSourceCandidate(e)||"").trim():String(e||"").trim();if(!a)return"";let i=a;typeof Utils<"u"&&typeof Utils.normalizeImageSource=="function"?i=Utils.normalizeImageSource(a)||a:typeof window<"u"&&typeof window.__convertGoogleDriveUrl=="function"&&(i=window.__convertGoogleDriveUrl(a)||a);const s=this._getDriveIdFromUrl(i)||t||i;return sessionStorage.getItem(this._photoFailKey(s))?"":i}catch{return""}},_setupEmployeePhotoFallbacks(e){try{const a=(e||document).querySelectorAll('img[data-emp-photo="1"]');if(!a||a.length===0)return;a.forEach(i=>{if(!i||i.dataset._fallbackBound==="1")return;i.dataset._fallbackBound="1";const o=(i.dataset.photoKey||"").trim();i.addEventListener("error",()=>{try{o&&sessionStorage.setItem(this._photoFailKey(o),Date.now().toString())}catch{}try{const s=i.parentElement;s&&(s.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}},{passive:!0})})}catch{}},canEditOrDelete(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},canAddOrImport(){const e=AppState.currentUser;return e?(e.role||"").toLowerCase()==="admin":!1},getEmployeesDetailedPermissionsState(){try{if(typeof Permissions<"u"&&typeof Permissions.getEffectivePermissions=="function"){const a=Permissions.getEffectivePermissions()?.employeesPermissions;if(a&&typeof a=="object"&&!Array.isArray(a))return a}}catch{}const e=AppState.currentUser?.permissions?.employeesPermissions;return e&&typeof e=="object"&&!Array.isArray(e)?e:null},canViewEmployeesRegistryTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["employees-list"]!==!1:!0},canViewExternalWorkforceTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["external-workforce"]===!0:!0},canViewEmployeesAnalysisTab(){if(this.canAddOrImport())return!0;if(typeof Permissions<"u"&&typeof Permissions.hasAccess=="function"&&!Permissions.hasAccess("employees"))return!1;const e=this.getEmployeesDetailedPermissionsState();return e?e["data-analysis"]!==!1:!0},canManageExternalWorkforceTab(){return this.canAddOrImport()},isValidDate(e){if(!e)return!1;try{const t=new Date(e);return t instanceof Date&&!isNaN(t.getTime())}catch{return!1}},normalizeDateOnly(e){if(e==null||e==="")return"";if(e instanceof Date&&!isNaN(e.getTime())){const s=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),c=String(e.getDate()).padStart(2,"0");return`${s}-${n}-${c}`}if(typeof e=="number"&&isFinite(e))try{if(typeof XLSX<"u"&&XLSX?.SSF?.parse_date_code){const s=XLSX.SSF.parse_date_code(e);if(s&&s.y&&s.m&&s.d){const n=String(s.y).padStart(4,"0"),c=String(s.m).padStart(2,"0"),d=String(s.d).padStart(2,"0");return`${n}-${c}-${d}`}}}catch{}let t=String(e).trim();if(!t)return"";if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const s=JSON.parse(t);typeof s=="string"?t=s.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return""}const a=t.match(/^(\d{4}-\d{2}-\d{2})/);if(a)return a[1];const i=t.match(/^(\d{1,2})[\/\-](\d{1,2})[\/\-](\d{2,4})$/);if(i){const s=String(i[1]).padStart(2,"0"),n=String(i[2]).padStart(2,"0");return`${i[3].length===2?`20${i[3]}`:String(i[3]).padStart(4,"0")}-${n}-${s}`}const o=t.match(/^(\d{4})[\/\-](\d{1,2})[\/\-](\d{1,2})$/);if(o){const s=String(o[1]).padStart(4,"0"),n=String(o[2]).padStart(2,"0"),c=String(o[3]).padStart(2,"0");return`${s}-${n}-${c}`}try{const s=new Date(t);if(!isNaN(s.getTime())){const n=s.getFullYear(),c=String(s.getMonth()+1).padStart(2,"0"),d=String(s.getDate()).padStart(2,"0");return`${n}-${c}-${d}`}}catch{}return""},parseLocalDate(e){if(!e)return null;if(e instanceof Date&&!isNaN(e.getTime()))return e;let t=String(e).trim();if(!t)return null;if(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'")){try{const o=JSON.parse(t);typeof o=="string"?t=o.trim():t=t.substring(1,t.length-1).trim()}catch{t=t.substring(1,t.length-1).trim()}if(!t)return null}const a=t.match(/^(\d{4})-(\d{2})-(\d{2})/);if(a){const o=Number(a[1]),s=Number(a[2])-1,n=Number(a[3]),c=new Date(o,s,n);return isNaN(c.getTime())?null:c}const i=new Date(t);return isNaN(i.getTime())?null:i},formatDateSafe(e){return this.normalizeDateOnly(e)},calculateAge(e){if(!e)return"";try{const t=this.parseLocalDate(e);if(!t)return"";const a=new Date;let i=a.getFullYear()-t.getFullYear();const o=a.getMonth()-t.getMonth();return(o<0||o===0&&a.getDate()<t.getDate())&&i--,i>=0?i:""}catch{return""}},async load(){if(this._languageChangeListenerAdded||(document.addEventListener("language-changed",()=>{typeof AppState<"u"&&AppState._languageRefresh||this.load()}),this._languageChangeListenerAdded=!0),typeof Utils>"u")return;if(typeof AppState>"u"){const t=document.getElementById("employees-section");t&&(t.innerHTML=`
            ...
            `,this.applyModuleI18n(e),setTimeout(async()=>{try{const a=document.getElementById("employees-content");if(!a)return;const i=await this.renderList().catch(o=>(Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629:",o),`
                ...
                `,this.applyModuleI18n(e))}},isEmployeeInactive(e){if(!e)return!1;const t=e.status!=null&&e.status!==""?String(e.status).trim():"";return!!((e.resignationDate!=null&&e.resignationDate!==""?String(e.resignationDate).trim():"")||t==="inactive"||t.toLowerCase()==="inactive"||t==="\u063A\u064A\u0631 \u0646\u0634\u0637")},calculateStatistics(){const e=AppState.appData.employees||[];if(e.length===0)return{total:0,averageAge:0,genderStats:{male:0,female:0},averageExperience:0,inactiveCount:0};const t=e.filter(u=>!this.isEmployeeInactive(u)),a=t.length;let i=0,o=0;t.forEach(u=>{const p=this.calculateAge(u.birthDate);p&&p>0&&(i+=p,o++)});const s=o>0?Math.round(i/o):0;let n=0,c=0,d=0;const m=u=>{if(!u)return"";let p=String(u).trim().replace(/\s+/g," ").trim();return p=p.replace(/[\u200B-\u200D\uFEFF]/g,""),p},r=u=>{const p=m(u);if(!p)return{isMale:!1,isFemale:!1};const g=p.toLowerCase(),b=p.length===1?p.toUpperCase():"",f=["\u0630\u0643\u0631","male","m","M","\u0630\u0643\u0631 "," \u0630\u0643\u0631"],w=["\u0623\u0646\u062B\u0649","female","f","F","\u0623\u0646\u062B\u0649 "," \u0623\u0646\u062B\u0649"],E=p==="\u0630\u0643\u0631"||g==="male"||b==="M"||f.some($=>m($)===p),k=p==="\u0623\u0646\u062B\u0649"||g==="female"||b==="F"||w.some($=>m($)===p);return{isMale:E,isFemale:k,normalized:p}};t.forEach(u=>{const p=r(u.gender);p.isMale?n++:p.isFemale?c++:d++}),d>0&&typeof AppState<"u"&&AppState.debugMode&&typeof console<"u";let l=0,h=0;const v=new Date;t.forEach(u=>{if(u.hireDate)try{const p=this.parseLocalDate(u.hireDate);if(p){const g=v.getFullYear()-p.getFullYear(),b=v.getMonth()-p.getMonth(),f=v.getDate()-p.getDate();let w=g;(b<0||b===0&&f<0)&&w--,w>=0&&(l+=w,h++)}}catch{}});const x=h>0?(l/h).toFixed(1):0,y=e.filter(u=>this.isEmployeeInactive(u)).length;return{total:a,averageAge:s,genderStats:{male:n,female:c},averageExperience:parseFloat(x),inactiveCount:y}},ensureEmployeesStatsCardsStyles(){const e="employees-stats-cards-styles-v2";if(document.getElementById(e))return;document.getElementById("employees-stats-cards-styles")?.remove();const a=document.createElement("style");a.id=e,a.textContent=`
        ...
        `,n=c=>{const d=c.maleCount||0,m=c.femaleCount||0,r=d+m,l=r>0?Math.round(d/r*100):0,h=r>0?100-l:0;return`
        ...
        `,d=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${e.year}`,o,c,!1,!0,{version:"1.0",source:"ExternalWorkforceMonthly",reportYear:e.year,releaseDate:s,revisionDate:s},s,s):`<!DOCTYPE html><html lang="${i.lang}" dir="${i.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${i.dir};padding:20px;">${c}</body></html>`,m=new Blob(["\uFEFF"+d],{type:"text/html;charset=utf-8"}),r=URL.createObjectURL(m),l=window.open(r,"_blank");if(!l){URL.revokeObjectURL(r),Notification.error("Unable to open print window");return}l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>URL.revokeObjectURL(r),1e3)},400)}},async importExternalWorkforceExcelFile(e){if(!(!e||!this.canManageExternalWorkforceTab())){if(typeof XLSX>"u"){Notification.error("XLSX library is not available");return}Loading.show();try{const t=await e.arrayBuffer(),a=XLSX.read(t,{type:"array",cellDates:!0}),i=a.Sheets[a.SheetNames[0]],o=XLSX.utils.sheet_to_json(i,{header:1,defval:"",raw:!1});if(!Array.isArray(o)||o.length<2)throw new Error("File is empty");const s=o[0].map(y=>String(y||"").trim().toLowerCase()),n=this.getAvailableContractorsForExternalWorkforce(),c=Number(this.externalWorkforceYear),d={jan:0,january:0,feb:1,february:1,mar:2,march:2,apr:3,april:3,may:4,jun:5,june:5,jul:6,july:6,aug:7,august:7,sep:8,sept:8,september:8,oct:9,october:9,nov:10,november:10,dec:11,december:11,\u064A\u0646\u0627\u064A\u0631:0,\u0641\u0628\u0631\u0627\u064A\u0631:1,\u0645\u0627\u0631\u0633:2,\u0623\u0628\u0631\u064A\u0644:3,\u0627\u0628\u0631\u064A\u0644:3,\u0645\u0627\u064A\u0648:4,\u064A\u0648\u0646\u064A\u0648:5,\u064A\u0648\u0644\u064A\u0648:6,\u0623\u063A\u0633\u0637\u0633:7,\u0627\u063A\u0633\u0637\u0633:7,\u0633\u0628\u062A\u0645\u0628\u0631:8,\u0623\u0643\u062A\u0648\u0628\u0631:9,\u0627\u0643\u062A\u0648\u0628\u0631:9,\u0646\u0648\u0641\u0645\u0628\u0631:10,\u062F\u064A\u0633\u0645\u0628\u0631:11},m=this.getExternalWorkforceMonths().map(y=>y.key),r=s.findIndex(y=>y.includes("contractor")||y.includes("company")||y.includes("\u0627\u0644\u0634\u0631\u0643\u0629")||y.includes("\u0627\u0644\u0645\u0642\u0627\u0648\u0644")),l=s.findIndex(y=>y==="code"||y.includes("contractor code")||y.includes("\u0627\u0644\u0643\u0648\u062F")),h={};s.forEach((y,u)=>{const p=y.replace(/\./g,"").trim();d[p]!==void 0&&(h[m[d[p]]]=u)});const v=this.getExternalWorkforceRecords();let x=0;o.slice(1).forEach(y=>{const u=r>=0?String(y[r]||"").trim():"",p=l>=0?String(y[l]||"").trim():"";if(!u&&!p)return;const g=n.find(f=>p&&(f.contractorCode||"").trim().toLowerCase()===p.toLowerCase()||u&&f.contractorName.trim().toLowerCase()===u.toLowerCase());if(!g)return;let b=this.getExternalWorkforceRecord(c,g.stableKey);b||(b={id:`EWM-${c}-${g.stableKey}`,year:c,contractorId:g.contractorId||"",contractorCode:g.contractorCode||"",contractorName:g.contractorName||"",createdAt:new Date().toISOString()},v.push(b)),m.forEach(f=>{const w=h[f];w!==void 0&&(b[f]=Math.max(0,parseInt(y[w]||"0",10)||0))}),b.total=m.reduce((f,w)=>f+(parseInt(b[w]||"0",10)||0),0),b.updatedAt=new Date().toISOString(),b.updatedBy=AppState.currentUser?.name||AppState.currentUser?.email||"admin",x+=1}),this._externalWorkforceCache.clear(),this.renderExternalWorkforceTable(),typeof DataManager<"u"&&typeof DataManager.save=="function"&&DataManager.save(),typeof GoogleIntegration<"u"&&typeof GoogleIntegration.autoSave=="function"&&await GoogleIntegration.autoSave("ExternalWorkforceMonthly",v).catch(()=>{}),window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{externalWorkforce:!0,year:c}})),Notification.success(`Imported ${x} rows successfully`)}catch(t){Notification.error(`Failed to import file: ${t.message}`)}finally{Loading.hide()}}},renderExternalWorkforceTable(){const e=document.getElementById("external-workforce-table-container");if(!e)return;const t=this.buildExternalWorkforceModel(this.externalWorkforceYear),a=this.getExternalWorkforceViewState(),{dir:i,stickySide:o,textAlign:s,labels:n}=a;this.renderExternalWorkforceSummary(t);const c=this.canManageExternalWorkforceTab(),d=t.months.map(f=>`<th style="min-width: 74px;">${f.label}</th>`).join(""),m=t.rows.map((f,w)=>{const E=t.months.map((k,$)=>{const A=f.values[$]||0;return`<td style="background:#dceaf6;">${c?`<input type="number" min="0" step="1" class="form-input external-workforce-input" style="min-width:70px;text-align:center;padding:6px 8px;" value="${A}" data-row="${w}" data-contractor-key="${f.stableKey}" data-month="${k.key}" />`:`<span class="font-semibold text-slate-700">${A}</span>`}</td>`}).join("");return`
                <tr>
        ...
        `).join("")},_empRenderAnalyticsBreadcrumb(e){const t=document.getElementById("emp-analytics-breadcrumb");if(!t)return;const a=[this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")];e.department&&a.push(e.department),e.job&&a.push(e.job),t.innerHTML=a.map((i,o)=>{const s=o===a.length-1;return`<span class="emp-analytics-crumb${s?" emp-analytics-crumb--active":""}">${Utils.escapeHTML(i)}</span>${s?"":'<span class="emp-analytics-crumb-sep">\u203A</span>'}`}).join("")},_empPopulateAnalyticsFilterOptions(e){const t=Array.isArray(e)?e:[],a=s=>[...new Set(t.map(n=>this._empAnalyticsLabel(n[s])).filter(Boolean))].sort((n,c)=>n.localeCompare(c,"ar")),i=(s,n,c)=>{const d=document.getElementById(s);if(!d)return;const m=c||d.value;d.innerHTML=`<option value="">${this.t("module.employees.analytics.all","\u0627\u0644\u0643\u0644")}</option>`+n.map(r=>`<option value="${Utils.escapeHTML(r)}"${r===m?" selected":""}>${Utils.escapeHTML(r)}</option>`).join("")},o=this._empGetAnalyticsFiltersFromDom();i("emp-af-department",a("department"),o.department),i("emp-af-job",a("job"),o.job),i("emp-af-branch",a("branch"),o.branch),i("emp-af-location",a("location"),o.location),i("emp-af-position",a("position"),o.position)},_empRenderAnalyticsHeatmap(e){const t=document.getElementById("emp-analytics-heatmap");if(!t)return;const a=e.departmentJobMatrix||{},i=Object.entries(a).map(([m,r])=>{const[l,h]=m.split("|||");return{dept:l,job:h,count:r}}).sort((m,r)=>r.count-m.count);if(!i.length){t.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const o=[...new Set(i.slice(0,12).map(m=>m.dept))],s=[...new Set(i.slice(0,12).map(m=>m.job))],n=Math.max(...i.map(m=>m.count),1),c={};i.forEach(m=>{c[m.dept+"|||"+m.job]=m.count});let d='<table class="emp-analytics-heatmap-table"><thead><tr><th></th>';s.forEach(m=>{d+=`<th title="${Utils.escapeHTML(m)}">${Utils.escapeHTML(m.length>14?m.slice(0,14)+"\u2026":m)}</th>`}),d+="</tr></thead><tbody>",o.forEach(m=>{d+=`<tr><th title="${Utils.escapeHTML(m)}">${Utils.escapeHTML(m.length>16?m.slice(0,16)+"\u2026":m)}</th>`,s.forEach(r=>{const l=c[m+"|||"+r]||0,h=l>0?.15+l/n*.85:0,v=l>0?`rgba(29, 78, 216, ${h})`:"#f8fafc",x=h>.5?"#fff":"#334155";d+=`<td class="emp-analytics-heatmap-cell" data-dept="${Utils.escapeHTML(m)}" data-job="${Utils.escapeHTML(r)}" style="background:${v};color:${x};" title="${Utils.escapeHTML(m)} / ${Utils.escapeHTML(r)}: ${l}">${l||""}</td>`}),d+="</tr>"}),d+="</tbody></table>",t.innerHTML=d,t.querySelectorAll(".emp-analytics-heatmap-cell").forEach(m=>{m.addEventListener("click",()=>{const r=m.getAttribute("data-dept")||"",l=m.getAttribute("data-job")||"";!r&&!l||(this._empApplyAnalyticsFilter("department",r,{skipUpdate:!0}),this._empApplyAnalyticsFilter("job",l))})})},_empRenderAnalyticsDetailTable(e){const t=document.getElementById("emp-analytics-detail-table");if(!t)return;const a=this._empAnalyticsDetailTab||"department",i=a==="job"?e.byJob:e.byDepartment,o=a==="job"?this.t("module.employees.job","\u0627\u0644\u0648\u0638\u064A\u0641\u0629"):this.t("module.employees.department","\u0627\u0644\u0642\u0633\u0645"),s=a==="job"?"job":"department";if(!i.length){t.innerHTML=`<div class="emp-analytics-empty">${this.t("module.employees.analytics.noData","\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A")}</div>`;return}const c=this._empGetAnalyticsFiltersFromDom()[s];t.innerHTML=`
            <table class="emp-analytics-detail-table">
                ...
                <tbody>
                    ${i.map(d=>`
                        <tr class="emp-analytics-detail-row${c===d.label?" emp-analytics-detail-row--selected":""}" data-filter-key="${s}" data-filter-value="${Utils.escapeHTML(d.label)}">
        ...
        `},async ensureEmployeesLoaded(e=!1){if(this.cache.isUpdating&&!e){for(;this.cache.isUpdating;)await new Promise(i=>setTimeout(i,50));if(AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0)return!0}const t=AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0,a=this.cache.data&&this.cache.lastLoad&&Date.now()-this.cache.lastLoad<this.config.cacheTimeout&&!e;return t&&a?(AppState.debugMode&&Utils.safeLog(`\u2705 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 Cache (${this.cache.data.length} \u0645\u0648\u0638\u0641)`),this.cache.data&&this.cache.data.length>0&&(AppState.appData.employees=this.cache.data),!this.config._refreshedOnceForInactive&&AppState.appData.employees.length>0&&AppState.googleConfig?.appsScript?.enabled&&(AppState.appData.employees||[]).filter(o=>this.isEmployeeInactive(o)).length===0&&(this.config._refreshedOnceForInactive=!0,this.loadEmployeesFromBackend(!0).then(()=>{window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{}}))}).catch(()=>{})),!0):t&&!a&&!e?(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),this.updateEmployeesInBackground(),!0):await this.loadEmployeesFromBackend(e)},async loadEmployeesFromBackend(e=!1){if(this.cache.isUpdating&&!e){for(AppState.debugMode&&Utils.safeLog("\u26A0\uFE0F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0642\u064A\u062F \u0627\u0644\u062A\u0646\u0641\u064A\u0630 \u0628\u0627\u0644\u0641\u0639\u0644\u060C \u0627\u0646\u062A\u0638\u0627\u0631...");this.cache.isUpdating;)await new Promise(t=>setTimeout(t,50));if(AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&AppState.appData.employees.length>0)return!0}this.cache.isUpdating=!0;try{if(!AppState.googleConfig?.appsScript?.enabled||!AppState.googleConfig?.appsScript?.scriptUrl)return AppState.debugMode&&Utils.safeLog("\u26A0\uFE0F Google Apps Script \u063A\u064A\u0631 \u0645\u0641\u0639\u0651\u0644 - \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u062D\u0644\u064A\u0629 \u0641\u0642\u0637"),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1;if(typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F GoogleIntegration \u063A\u064A\u0631 \u0645\u062A\u0627\u062D"),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1;try{const t=await GoogleIntegration.sendRequest({action:"getAllEmployees",data:{filters:{includeInactive:!0}}});if(t&&t.success&&Array.isArray(t.data))return AppState.appData.employees=t.data,this.cache.data=t.data,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${t.data.length} \u0645\u0648\u0638\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A`),this.cache.isUpdating=!1,!0;{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F getAllEmployees \u0641\u0634\u0644\u060C \u062C\u0627\u0631\u064A \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0628\u0640 readFromSheet...");const a=await GoogleIntegration.sendRequest({action:"readFromSheet",data:{sheetName:"Employees",spreadsheetId:AppState.googleConfig.sheets.spreadsheetId}});if(a&&a.success&&Array.isArray(a.data))return AppState.appData.employees=a.data,this.cache.data=a.data,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u062A\u062D\u0645\u064A\u0644 ${a.data.length} \u0645\u0648\u0638\u0641 \u0645\u0646 Google Sheets`),this.cache.isUpdating=!1,!0}}catch(t){return AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0645\u0646 Backend:",t),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1}return this.cache.isUpdating=!1,!1}catch(t){return AppState.debugMode&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A loadEmployeesFromBackend:",t),AppState.appData.employees&&Array.isArray(AppState.appData.employees)&&(this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now()),this.cache.isUpdating=!1,!1}},async updateEmployeesInBackground(){if(!this.cache.isUpdating){this.cache.isUpdating=!0;try{if(!AppState.googleConfig?.appsScript?.enabled||!AppState.googleConfig?.appsScript?.scriptUrl||typeof GoogleIntegration>"u"||!GoogleIntegration.sendRequest)return;const e=await GoogleIntegration.sendRequest({action:"getAllEmployees",data:{filters:{includeInactive:!0}}});if(e&&e.success&&Array.isArray(e.data)){const t=AppState.appData.employees?.length||0,a=e.data.length;(t!==a||JSON.stringify(AppState.appData.employees)!==JSON.stringify(e.data))&&(AppState.appData.employees=e.data,this.cache.data=e.data,this.cache.lastUpdate=Date.now(),typeof window.DataManager<"u"&&window.DataManager.save&&window.DataManager.save(),AppState.debugMode&&Utils.safeLog(`\u{1F504} \u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629 (${e.data.length} \u0645\u0648\u0638\u0641)`),window.dispatchEvent(new CustomEvent("employeesDataUpdated",{detail:{count:e.data.length}})))}}catch(e){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",e)}finally{this.cache.isUpdating=!1}}},startBackgroundUpdate(){this.config.backgroundUpdateTimer&&clearInterval(this.config.backgroundUpdateTimer),this.config.backgroundUpdateTimer=setInterval(()=>{this.updateEmployeesInBackground()},this.config.backgroundUpdateInterval),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0628\u062F\u0621 \u0627\u0644\u062A\u062D\u062F\u064A\u062B \u0627\u0644\u062A\u0644\u0642\u0627\u0626\u064A \u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 (\u0643\u0644 ${this.config.backgroundUpdateInterval/6e4} \u062F\u0642\u064A\u0642\u0629)`)},stopBackgroundUpdate(){this.config.backgroundUpdateTimer&&(clearInterval(this.config.backgroundUpdateTimer),this.config.backgroundUpdateTimer=null)},cleanup(){try{AppState.debugMode&&Utils.safeLog("\u{1F9F9} \u062A\u0646\u0638\u064A\u0641 \u0645\u0648\u0627\u0631\u062F Employees module..."),this.stopBackgroundUpdate(),this.handleDataUpdate&&(window.removeEventListener("employeesDataUpdated",this.handleDataUpdate),this.handleDataUpdate=null),AppState.debugMode&&Utils.safeLog("\u2705 \u062A\u0645 \u062A\u0646\u0638\u064A\u0641 \u0645\u0648\u0627\u0631\u062F Employees module")}catch(e){Utils.safeWarn("\u26A0\uFE0F \u062E\u0637\u0623 \u0641\u064A \u062A\u0646\u0638\u064A\u0641 Employees module:",e)}},async loadEmployeesList(e=!1){const t=document.getElementById("employees-table-container");if(!t){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0641\u064A loadEmployeesList");return}let a=AppState.appData.employees||[];if(AppState.debugMode&&Utils.safeLog(`\u{1F4CA} loadEmployeesList: \u0625\u062C\u0645\u0627\u0644\u064A \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 = ${a.length}, showInactive = ${e}`),e)AppState.debugMode&&Utils.safeLog(`\u{1F4CA} \u0639\u0631\u0636 \u062C\u0645\u064A\u0639 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646 (\u0628\u0645\u0627 \u0641\u064A \u0630\u0644\u0643 \u063A\u064A\u0631 \u0627\u0644\u0646\u0634\u0637\u064A\u0646): ${a.length}`);else{const r=a.length;a=a.filter(l=>!this.isEmployeeInactive(l)),AppState.debugMode&&Utils.safeLog(`\u{1F4CA} \u0628\u0639\u062F \u0627\u0644\u062A\u0635\u0641\u064A\u0629 (\u0646\u0634\u0637\u064A\u0646 \u0641\u0642\u0637): ${a.length} \u0645\u0646 ${r}`)}this.renderStatsCards(),this.updateInactiveCount();const i=this.canAddOrImport(),o=this.canEditOrDelete(),s=document.createDocumentFragment();if(a.length===0){const r=document.createElement("div");r.className="empty-state",r.innerHTML=`
                ...
                `:""}
            `,s.appendChild(r),t.innerHTML="",t.appendChild(s),requestAnimationFrame(()=>{const l=document.getElementById("add-employee-empty-btn");l&&this.canAddOrImport()&&l.addEventListener("click",()=>this.showForm())});return}const n=document.createElement("div");n.className="table-wrapper",n.style.cssText="width: 100%; max-width: 100%; overflow-x: auto;";const c=document.createElement("table");c.className="data-table table-header-blue",c.style.cssText="width: 100%; min-width: 100%; table-layout: auto;";const d=document.createElement("thead");d.innerHTML=`
            <tr>
        ...
        `;const m=document.createElement("tbody");a.forEach(r=>{const l=this.formatDateSafe(r.birthDate),h=this.formatDateSafe(r.hireDate),v=this.calculateAge(r.birthDate),x=this.isEmployeeInactive(r),y=x?"opacity: 0.7; background-color: #f8f9fa;":"",u=document.createElement("tr");x&&(u.style.cssText=y);const g=(this._getDriveIdFromUrl(r.photo||"")||r.id||r.employeeNumber||r.name||"").toString(),b=this._normalizeEmployeePhotoUrl(r.photo,r.id),f=b&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(b):{canonical:b||"",displaySrc:b||"",needsProxy:!1,proxyFileId:""},w=f.canonical?f.displaySrc:"",E=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(f):"";u.innerHTML=`
                <td style="word-wrap: break-word;">
                    ${b?`<img data-emp-photo="1" data-photo-key="${Utils.escapeHTML(g)}" src="${Utils.escapeHTML(w)}" alt="${Utils.escapeHTML(r.name||"")}"${E} class="w-12 h-12 rounded-full object-cover" loading="lazy" decoding="async" referrerpolicy="no-referrer">`:'<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>'}
                </td>
        ...
        `,c.length===0)o.innerHTML=`
            ...
            `;else{const r=c.slice(0,200),l=c.length-r.length;o.innerHTML=r.map(h=>`
                <tr data-import-uid="${Utils.escapeHTML(h.uid)}">
                    <td><input type="text" class="form-input emp-imp-field" data-field="employeeNumber" value="${Utils.escapeHTML(h.employeeNumber||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="sapId" value="${Utils.escapeHTML(h.sapId||"")}" style="min-width:80px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="name" value="${Utils.escapeHTML(h.name||"")}" style="min-width:120px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="department" value="${Utils.escapeHTML(h.department||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="job" value="${Utils.escapeHTML(h.job||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="branch" value="${Utils.escapeHTML(h.branch||"")}" style="min-width:80px;padding:4px 6px;font-size:12px;"></td>
                    <td><input type="text" class="form-input emp-imp-field" data-field="hireDate" value="${Utils.escapeHTML(h.hireDate||"")}" style="min-width:90px;padding:4px 6px;font-size:12px;"></td>
        ...
        `,this.applyModuleI18n(a),document.body.appendChild(a);const i=a.querySelector("#employee-excel-file-input"),o=a.querySelector("#employee-import-confirm-btn");let s=[],n=this.buildEmployeeImportExistingKeySet(),c=null;const d=()=>this.renderEmployeeImportReview(a,s);i.addEventListener("change",async m=>{const r=m.target.files[0];if(r){Loading.show("\u062C\u0627\u0631\u064A \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641...");try{await this.yieldEmployeeImportUi_();const l=await r.arrayBuffer();Loading.show("\u062C\u0627\u0631\u064A \u062A\u062D\u0644\u064A\u0644 Excel..."),await this.yieldEmployeeImportUi_();const h=XLSX.read(l,{type:"array",cellDates:!0}),v=h.SheetNames[0],x=h.Sheets[v],y=XLSX.utils.sheet_to_json(x,{header:1,defval:"",raw:!1});if(y.length<2){Notification.error(this.t("module.employees.invalidFile","\u0627\u0644\u0645\u0644\u0641 \u0641\u0627\u0631\u063A \u0623\u0648 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D")),s=[],d(),Loading.hide();return}const u=y[0].map(w=>String(w||"").trim()),p=y.slice(1).map(w=>{const E={};return u.forEach((k,$)=>{const A=w[$];E[k]=A??""}),E}).filter(w=>u.some(E=>String(w[E]||"").trim()!==""));n=this.buildEmployeeImportExistingKeySet();const g=new Set,b=Date.now();s=new Array(p.length);const f=400;for(let w=0;w<p.length;w+=f){const E=Math.min(w+f,p.length);Loading.show(`\u062C\u0627\u0631\u064A \u0645\u0637\u0627\u0628\u0642\u0629 \u0627\u0644\u0635\u0641\u0648\u0641... ${E} / ${p.length}`);for(let k=w;k<E;k++){const $=this.parseEmployeeImportRow(p[k],`imp-${k}-${b}`);s[k]=this.classifyEmployeeImportDraft($,g,n)}await this.yieldEmployeeImportUi_()}Loading.show("\u062C\u0627\u0631\u064A \u062A\u062C\u0647\u064A\u0632 \u0634\u0627\u0634\u0629 \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629..."),await this.yieldEmployeeImportUi_(),d(),Loading.hide()}catch(l){Loading.hide(),Notification.error(this.t("module.employees.readFileFailed","\u0641\u0634\u0644 \u0642\u0631\u0627\u0621\u0629 \u0627\u0644\u0645\u0644\u0641")+": "+l.message)}}}),a.addEventListener("change",m=>{const r=m.target.closest(".emp-imp-field");if(!r)return;const l=r.closest("tr[data-import-uid]");if(!l)return;const h=l.getAttribute("data-import-uid"),v=s.find(y=>y.uid===h);if(!v)return;const x=r.getAttribute("data-field");x&&(v[x]=r.value,c&&clearTimeout(c),c=setTimeout(()=>{this.reclassifyAllEmployeeImportDrafts(s,n),d()},180))}),a.addEventListener("click",m=>{const r=m.target.closest(".emp-imp-remove");if(r){const l=r.closest("tr[data-import-uid]");if(!l)return;const h=l.getAttribute("data-import-uid");s=s.filter(v=>v.uid!==h),this.reclassifyAllEmployeeImportDrafts(s,n),d();return}m.target===a&&a.remove()}),o.addEventListener("click",async()=>{const m=s.filter(v=>v.status==="new");if(m.length===0){Notification.warning("\u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0648\u0638\u0641\u0648\u0646 \u062C\u062F\u062F \u0644\u0644\u0625\u0636\u0627\u0641\u0629");return}const r=this.getEmployeeImportCounts(s),l=this.getEmployeeImportHireWindowLabel();if(window.confirm(`\u0633\u064A\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 ${m.length} \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F \u0641\u0642\u0637.
\u062A\u062E\u0637\u0651\u064A \u0645\u0648\u062C\u0648\u062F \u0645\u0633\u0628\u0642\u0627\u064B: ${r.existsCount}
\u0646\u0627\u0642\u0635/\u063A\u064A\u0631 \u0635\u0627\u0644\u062D: ${r.invalidCount}
\u062A\u0639\u064A\u064A\u0646 \u062E\u0627\u0631\u062C ${l}: ${r.hireDateRejectedCount}

\u0627\u0644\u0645\u0648\u062C\u0648\u062F\u0648\u0646 \u0648\u0627\u0644\u0645\u0633\u062A\u0642\u064A\u0644\u0648\u0646 \u0644\u0646 \u064A\u064F\u0639\u062F\u0651\u064E\u0644\u0648\u0627 \u0648\u0644\u0646 \u064A\u064F\u062D\u0630\u0641\u0648\u0627.
\u0647\u0644 \u062A\u0631\u064A\u062F \u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629\u061F`)){Loading.show(`\u062C\u0627\u0631\u064A \u0625\u0636\u0627\u0641\u0629 ${m.length} \u0645\u0648\u0638\u0641...`);try{let v=0,x=0;const y=n instanceof Set?new Set(n):this.buildEmployeeImportExistingKeySet(),u=300;for(let g=0;g<m.length;g+=u){const b=Math.min(g+u,m.length);for(let f=g;f<b;f++){const w=m[f];try{if(this.employeeImportKeysMatchExisting(w.employeeNumber,w.sapId,y)){x++;continue}const E=this.buildEmployeeFromImportDraft(w);if(!E){x++;continue}if(this.employeeImportKeysMatchExisting(E.employeeNumber,E.sapId,y)){x++;continue}AppState.appData.employees.push(E);const k=this.normalizeEmployeeImportKey(E.employeeNumber),$=this.normalizeEmployeeImportKey(E.sapId),A=this.normalizeEmployeeImportKey(E.id);k&&y.add(k),$&&y.add($),A&&y.add(A),v++}catch{x++}}Loading.show(`\u062C\u0627\u0631\u064A \u0627\u0644\u0625\u0636\u0627\u0641\u0629... ${b} / ${m.length}`),await this.yieldEmployeeImportUi_()}typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),Loading.show("\u062C\u0627\u0631\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u0633\u062D\u0627\u0628\u0629..."),await this.yieldEmployeeImportUi_(),await GoogleIntegration.autoSave("Employees",AppState.appData.employees),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),n=y,Loading.hide(),Notification.success(`\u0623\u064F\u0636\u064A\u0641 ${v} \u0645\u0648\u0638\u0641 \u062C\u062F\u064A\u062F`+(r.existsCount>0?` \u2014 \u062A\u064F\u062E\u0637\u064A \u0645\u0648\u062C\u0648\u062F ${r.existsCount}`:"")+(r.hireDateRejectedCount>0?` \u2014 \u062A\u0639\u064A\u064A\u0646 \u062E\u0627\u0631\u062C ${this.getEmployeeImportHireWindowLabel()} ${r.hireDateRejectedCount}`:"")+(r.invalidCount>r.hireDateRejectedCount?` \u2014 \u0646\u0627\u0642\u0635 ${r.invalidCount-r.hireDateRejectedCount}`:"")+(x>0?` \u2014 \u0627\u0633\u062A\u064F\u0628\u0639\u062F \u0639\u0646\u062F \u0627\u0644\u062D\u0641\u0638 ${x}`:"")),a.remove(),this.renderStatsCards();const p=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(p),requestAnimationFrame(()=>{this.applyFilters()})}catch(v){Loading.hide(),Notification.error("\u0641\u0634\u0644 \u0627\u0644\u0627\u0633\u062A\u064A\u0631\u0627\u062F: "+v.message)}}})},async handleSubmit(e){e.preventDefault();const t=e.target?.querySelector('button[type="submit"]')||document.querySelector('#employee-form button[type="submit"]');if(t&&t.disabled)return;let a="";t&&(a=t.innerHTML,t.disabled=!0,t.innerHTML='<i class="fas fa-spinner fa-spin ml-2"></i> \u062C\u0627\u0631\u064A \u0627\u0644\u062D\u0641\u0638...');const i=this.currentEditId?AppState.appData.employees.find(D=>D.id===this.currentEditId):null;let o=i?.photo||"";const s=document.getElementById("employee-photo-input");if(s&&s.files.length>0){const D=s.files[0];if(D.size>2097152){Notification.error("\u062D\u062C\u0645 \u0627\u0644\u0635\u0648\u0631\u0629 \u0643\u0628\u064A\u0631 \u062C\u062F\u0627\u064B. \u0627\u0644\u062D\u062F \u0627\u0644\u0623\u0642\u0635\u0649 \u0647\u0648 2MB"),t&&(t.disabled=!1,t.innerHTML=a);return}o=await this.convertImageToBase64(D)}const n=document.getElementById("employee-name"),c=document.getElementById("employee-number"),d=document.getElementById("employee-sap-id"),m=document.getElementById("employee-hire-date"),r=document.getElementById("employee-birth-date"),l=document.getElementById("employee-department"),h=document.getElementById("employee-position"),v=document.getElementById("employee-branch"),x=document.getElementById("employee-location"),y=document.getElementById("employee-gender"),u=document.getElementById("employee-national-id"),p=document.getElementById("employee-email"),g=document.getElementById("employee-phone"),b=document.getElementById("employee-insurance-number");if(!n||!c||!d||!l||!h||!v||!x||!y||!p||!g){Notification.error("\u0628\u0639\u0636 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629. \u064A\u0631\u062C\u0649 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0635\u0641\u062D\u0629 \u0648\u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649.");return}const f=!!this.currentEditId,w=f&&i?.hireDate||"",E=f&&i?.birthDate||"",k={id:c.value.trim()||this.currentEditId||Utils.generateId("EMP"),name:n.value.trim(),employeeNumber:c.value.trim(),sapId:d.value.trim(),hireDate:m?.value?this.normalizeDateOnly(m.value):f?this.normalizeDateOnly(w):this.normalizeDateOnly(new Date),birthDate:r?.value?this.normalizeDateOnly(r.value):f?this.normalizeDateOnly(E):"",department:l.value.trim(),job:h.value.trim(),position:h.value.trim(),branch:v.value.trim(),location:x.value.trim(),gender:y.value,nationalId:u?.value.trim()||"",email:p.value.trim(),phone:g.value.trim(),insuranceNumber:b?.value.trim()||"",photo:o,status:f&&i?.status||"active",resignationDate:f&&i?.resignationDate||"",createdAt:this.currentEditId?i?.createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};if(!k.name||!k.sapId||!k.employeeNumber||!k.department||!k.position){Notification.error("\u064A\u0631\u062C\u0649 \u0645\u0644\u0621 \u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629 (\u0627\u0644\u0627\u0633\u0645\u060C \u0627\u0644\u0643\u0648\u062F \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0648\u0638\u064A\u0641\u064A\u060C \u0627\u0644\u0642\u0633\u0645\u060C \u0627\u0644\u0645\u0646\u0635\u0628)"),t&&(t.disabled=!1,t.innerHTML=a);return}const $=String(k.id||"").trim();if(!$){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D (\u0644\u0627 \u064A\u0645\u0643\u0646 \u0625\u0646\u0634\u0627\u0621 id \u0641\u0627\u0631\u063A)"),t&&(t.disabled=!1,t.innerHTML=a);return}if(AppState.appData.employees.some(D=>{const M=String(D?.id||"").trim();return!M||this.currentEditId&&M===String(this.currentEditId).trim()?!1:M===$})){Notification.error("\u0631\u0642\u0645 \u0627\u0644\u0645\u0648\u0638\u0641 \u0645\u0633\u062A\u062E\u062F\u0645 \u0628\u0627\u0644\u0641\u0639\u0644. \u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u0631\u0642\u0645 \u0622\u062E\u0631."),t&&(t.disabled=!1,t.innerHTML=a);return}Loading.show();try{if(this.currentEditId){const D=AppState.appData.employees.findIndex(M=>M.id===this.currentEditId);D!==-1&&(AppState.appData.employees[D]=k,this.currentEditId=$),Notification.success("\u062A\u0645 \u062A\u062D\u062F\u064A\u062B \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D")}else AppState.appData.employees.push(k),Notification.success("\u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D");typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A"),await GoogleIntegration.autoSave("Employees",AppState.appData.employees),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),t&&(t.disabled=!1,t.innerHTML=a),this.renderStatsCards(),this.showList()}catch(D){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+D.message),t&&(t.disabled=!1,t.innerHTML=a)}},async convertImageToBase64(e){return new Promise((t,a)=>{const i=new FileReader;i.onload=()=>t(i.result),i.onerror=a,i.readAsDataURL(e)})},async showList(){this.currentEditId=null,!this.canViewEmployeesRegistryTab()&&this.canViewEmployeesAnalysisTab()?this.activeTab="data-analysis":!this.canViewEmployeesRegistryTab()&&this.canViewExternalWorkforceTab()?this.activeTab="external-workforce":!this.canViewExternalWorkforceTab()&&!this.canViewEmployeesAnalysisTab()&&(this.activeTab="employees-list");const e=document.getElementById("employees-content");e&&(e.innerHTML=await this.renderList(),this.applyModuleI18n(e),requestAnimationFrame(()=>{this.setupEventListeners(),this.canViewEmployeesRegistryTab()&&this.activeTab==="employees-list"?this.loadEmployeesList():this.activeTab==="data-analysis"&&this.canViewEmployeesAnalysisTab()?this.loadEmployeesAnalysis().catch(()=>{}):this.canViewExternalWorkforceTab()&&(this.populateExternalWorkforceYearSelector(),this.ensureExternalWorkforceDataLoaded().then(()=>this.renderExternalWorkforceTable()).catch(()=>{})),this.activeTab==="employees-list"&&this.scrollToSearchField()}))},async editEmployee(e){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const t=AppState.appData.employees.find(a=>a.id===e);t&&await this.showForm(t)},async printEmployee(e){const t=AppState.appData.employees.find(a=>a.id===e);if(!t){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}try{Loading.show();let a="";const i=this._normalizeEmployeePhotoUrl(t.photo,t.id);if(i&&typeof Utils.resolveDriveAwareImgDisplay=="function"){const p=Utils.resolveDriveAwareImgDisplay(i);if(p.needsProxy&&typeof Utils.fetchDriveImageDataUri=="function")try{a=await Utils.fetchDriveImageDataUri(p.proxyFileId)||""}catch{a=""}a||(a=p.canonical||i)}else i&&(a=i);const o=this.formatDateSafe(t.birthDate),s=this.formatDateSafe(t.hireDate),n=this.calculateAge(t.birthDate),c=p=>{if(!p)return"-";try{const g=new Date(p),b=g.getFullYear(),f=g.getMonth()+1,w=g.getDate(),E=["\u0660","\u0661","\u0662","\u0663","\u0664","\u0665","\u0666","\u0667","\u0668","\u0669"],k=$=>String($).split("").map(A=>E[parseInt(A)]||A).join("");return`${k(b)}/${k(f)}/${k(w)}`}catch{return p}},d=new Date,m=c(d.toISOString().split("T")[0]),r=d.toLocaleTimeString("ar-SA",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}),l=AppState?.companySettings?.name||AppState?.appData?.companyName||"\u0627\u0644\u0634\u0631\u0643\u0629",h=`
                <style>
                ...
                <div class="employee-card">
                    ...
                    <div class="employee-details">
                        ...
                        <div class="detail-field">
                            ...
                            <div class="detail-value">${c(s)}</div>
                        </div>
                        <div class="detail-field">
...
<body>
    ${h}
...
</html>`,x=new Blob([v],{type:"text/html;charset=utf-8"}),y=URL.createObjectURL(x),u=window.open(y,"_blank");u?u.onload=()=>{const p=u.document.querySelectorAll("img");let g=0;const b=p.length;if(b===0)setTimeout(()=>{u.print(),setTimeout(()=>{URL.revokeObjectURL(y),Loading.hide()},800)},300);else{const f=()=>{g>=b&&setTimeout(()=>{u.print(),setTimeout(()=>{URL.revokeObjectURL(y),Loading.hide()},800)},300)};p.forEach(w=>{w.complete?(g++,f()):(w.onload=()=>{g++,f()},w.onerror=()=>{g++,f()})}),setTimeout(()=>{g<b&&(u.print(),setTimeout(()=>{URL.revokeObjectURL(y),Loading.hide()},800))},3e3)}}:(URL.revokeObjectURL(y),Loading.hide(),Notification.error("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0644\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0639\u0631\u0636 \u0627\u0644\u062A\u0642\u0631\u064A\u0631"))}catch(a){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u0637\u0628\u0627\u0639\u0629 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0648\u0638\u0641:",a),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623 \u0623\u062B\u0646\u0627\u0621 \u0627\u0644\u0637\u0628\u0627\u0639\u0629: "+a.message)}},async viewEmployee(e){const t=AppState.appData.employees.find(n=>n.id===e);if(!t)return;const a=this.formatDateSafe(t.birthDate),i=this.formatDateSafe(t.hireDate),o=this.calculateAge(t.birthDate),s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
                ...
                <div class="modal-body">
                    <div class="space-y-4">
                        <div class="text-center mb-4">
                            ${(()=>{const n=this._normalizeEmployeePhotoUrl(t.photo,t.id);if(!n)return'<div class="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center mx-auto"><i class="fas fa-user text-5xl text-gray-400"></i></div>';const c=typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(n):{canonical:n,displaySrc:n,needsProxy:!1,proxyFileId:""},d=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(c):"";return`<img src="${Utils.escapeHTML(c.displaySrc)}" alt="${Utils.escapeHTML(t.name||"")}"${d} class="emp-detail-photo w-32 h-32 rounded-full object-cover mx-auto border-4 border-gray-200">`})()}
                        </div>
        ...
        `,this.applyModuleI18n(s),document.body.appendChild(s),typeof EmailDispatch<"u"&&EmailDispatch.bindFooterButtons(s,{moduleKey:"employees",record:t,recordId:t.id||t.employeeNumber||t.isoCode||""}),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(s,{onFetchFail:n=>{try{const c=document.createElement("div");c.className="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center mx-auto",c.innerHTML='<i class="fas fa-user text-5xl text-gray-400"></i>',n.replaceWith(c)}catch{}}}),s.addEventListener("click",n=>{n.target===s&&s.remove()})},async deactivateEmployee(e){if(!this.canEditOrDelete()){Notification.error("\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0644\u0625\u0644\u063A\u0627\u0621 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641");return}const t=AppState.appData.employees.find(a=>a.id===e);if(!t){Notification.error("\u0627\u0644\u0645\u0648\u0638\u0641 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}if(confirm(`\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u0625\u0644\u063A\u0627\u0621 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0645\u0648\u0638\u0641 "${t.name}"\u061F
...
\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631: \u0647\u0630\u0647 \u0627\u0644\u0639\u0645\u0644\u064A\u0629 \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u062A\u0631\u0627\u062C\u0639 \u0639\u0646\u0647\u0627!`)){Loading.show();try{AppState.appData.employees=(AppState.appData.employees||[]).filter(a=>a.id!==e),setTimeout(()=>{typeof window.DataManager<"u"&&window.DataManager.save?window.DataManager.save():Utils.safeWarn("\u26A0\uFE0F DataManager \u063A\u064A\u0631 \u0645\u062A\u0627\u062D - \u0644\u0645 \u064A\u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A")},50),this.cache.data=AppState.appData.employees,this.cache.lastLoad=Date.now(),this.cache.lastUpdate=Date.now(),Loading.hide(),Notification.success("\u062A\u0645 \u062D\u0630\u0641 \u0627\u0644\u0645\u0648\u0638\u0641 \u0628\u0646\u062C\u0627\u062D"),this.renderStatsCards();const t=document.getElementById("show-inactive-employees")?.checked||!1;this.loadEmployeesList(t),requestAnimationFrame(async()=>{try{await this.applyFilters()}catch(a){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0641\u0644\u0627\u062A\u0631:",a)}}),AppState.googleConfig?.appsScript?.enabled&&GoogleIntegration.sendToAppsScript("deleteEmployee",{employeeId:e}).then(a=>{!a||!a.success?Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 Google Sheets:",a?.message):Utils.safeLog("\u2705 \u062A\u0645 \u0627\u0644\u062D\u0630\u0641 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}).catch(a=>Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0645\u0632\u0627\u0645\u0646\u0629 \u0627\u0644\u062D\u0630\u0641 \u0641\u064A \u0627\u0644\u062E\u0644\u0641\u064A\u0629:",a))}catch(t){Loading.hide(),Notification.error("\u062D\u062F\u062B \u062E\u0637\u0623: "+t.message)}}},scrollToSearchField(){setTimeout(()=>{const e=document.getElementById("employees-search");if(e){const t=window.scrollY||document.documentElement.scrollTop,a=Math.max(0,(e.offsetTop||0)-20),i=t+window.innerHeight;(a<t||a>i-100)&&window.scrollTo({top:a,behavior:"smooth"})}},0)},getFilterValues(){return{search:document.getElementById("employees-search-filter")?.value||document.getElementById("employees-search")?.value||"",department:document.getElementById("employee-filter-department")?.value||"",branch:document.getElementById("employee-filter-branch")?.value||"",location:document.getElementById("employee-filter-location")?.value||"",job:document.getElementById("employee-filter-job")?.value||"",position:document.getElementById("employee-filter-position")?.value||"",gender:document.getElementById("employee-filter-gender")?.value||"",showInactive:document.getElementById("show-inactive-employees")?.checked||!1}},async filterEmployees(e="",t=!1,a=null){try{if(a)t=a.showInactive!==void 0&&a.showInactive!==null?a.showInactive:t;else{const r=this.getFilterValues();e=e||r.search,t=t??(r.showInactive||!1),a=r,a.showInactive=t}const i=document.getElementById("employees-table-container");if(!i){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F employees-table-container \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F");return}let o=i.querySelector("tbody");if(!o&&(await this.loadEmployeesList(t),o=i.querySelector("tbody"),!o)){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F tbody \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0628\u0639\u062F \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0642\u0627\u0626\u0645\u0629");return}let s=AppState.appData.employees||[];t||(s=s.filter(r=>!this.isEmployeeInactive(r)));let n=s;const c=this.canEditOrDelete();if(e&&e.trim()){const r=e.trim().toLowerCase();n=n.filter(l=>l.name&&l.name.toLowerCase().includes(r)||l.employeeNumber&&String(l.employeeNumber).toLowerCase().includes(r)||l.sapId&&String(l.sapId).toLowerCase().includes(r)||l.department&&l.department.toLowerCase().includes(r)||l.position&&l.position.toLowerCase().includes(r)||l.job&&l.job.toLowerCase().includes(r)||l.branch&&l.branch.toLowerCase().includes(r)||l.location&&l.location.toLowerCase().includes(r)||l.nationalId&&l.nationalId.toLowerCase().includes(r)||l.phone&&l.phone.toLowerCase().includes(r)||l.insuranceNumber&&l.insuranceNumber.toLowerCase().includes(r)||l.email&&l.email.toLowerCase().includes(r)||l.gender&&l.gender.toLowerCase().includes(r))}a.department&&(n=n.filter(r=>String(r.department||"").trim()===String(a.department).trim())),a.branch&&(n=n.filter(r=>String(r.branch||"").trim()===String(a.branch).trim())),a.location&&(n=n.filter(r=>String(r.location||"").trim()===String(a.location).trim())),a.job&&(n=n.filter(r=>String(r.job||"").trim()===String(a.job).trim())),a.position&&(n=n.filter(r=>String(r.position||"").trim()===String(a.position).trim())),a.gender&&(n=n.filter(r=>String(r.gender||"").trim()===String(a.gender).trim()));const d=document.createDocumentFragment(),m=13;if(n.length===0){const r=document.createElement("tr");r.innerHTML=`<td colspan="${m}" class="text-center text-gray-500 py-8">\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C</td>`,d.appendChild(r)}else n.forEach(r=>{const l=this.formatDateSafe(r.birthDate),h=this.formatDateSafe(r.hireDate),v=this.calculateAge(r.birthDate),x=this.isEmployeeInactive(r),y=x?"opacity: 0.7; background-color: #f8f9fa;":"",u=document.createElement("tr");x&&(u.style.cssText=y);const p=this._normalizeEmployeePhotoUrl(r.photo,r.id),b=(this._getDriveIdFromUrl(r.photo||"")||r.id||r.employeeNumber||r.name||"").toString(),f=p&&typeof Utils.resolveDriveAwareImgDisplay=="function"?Utils.resolveDriveAwareImgDisplay(p):{canonical:p||"",displaySrc:p||"",needsProxy:!1,proxyFileId:""},w=f.canonical?f.displaySrc:"",E=typeof Utils.driveProxyImgAttrs=="function"?Utils.driveProxyImgAttrs(f):"";u.innerHTML=`
                    ...
                    `}
                `,d.appendChild(u)});o.innerHTML="",o.appendChild(d),typeof Utils.hydrateDriveProxyImages=="function"&&Utils.hydrateDriveProxyImages(o,{onFetchFail:r=>{try{const l=(r.dataset.photoKey||"").trim();l&&sessionStorage.setItem(this._photoFailKey(l),Date.now().toString())}catch{}try{const l=r.parentElement;l&&(l.innerHTML='<div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center"><i class="fas fa-user text-gray-400"></i></div>')}catch{}}}),this.updateFilterBadges(s,n,a),AppState.debugMode&&e&&Utils.safeLog(`\u{1F50D} \u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0628\u062D\u062B: ${n.length} \u0645\u0646 ${s.length} \u0645\u0648\u0638\u0641`)}catch(i){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A filterEmployees:",i)}},updateFilterBadges(e,t,a){try{if(!a){AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F updateFilterBadges: filters \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}const i=(o,s,n)=>{try{const c=document.getElementById(o);if(!c){AppState.debugMode&&s&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: ${o} \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F`);return}const d=c.closest(".filter-field");if(!d){AppState.debugMode&&s&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-field \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const m=d.querySelector(".filter-label");if(!m){AppState.debugMode&&s&&Utils.safeWarn(`\u26A0\uFE0F updateFilterLabel: filter-label \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F \u0644\u0640 ${o}`);return}const r=m.querySelector(".filter-count-badge");if(r&&r.remove(),s&&s.trim()!==""){const l=document.createElement("span");l.className="filter-count-badge",l.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",l.textContent=n;const h=m.querySelector("i");h?h.insertAdjacentElement("afterend",l):m.insertBefore(l,m.firstChild),AppState.debugMode&&Utils.safeLog(`\u2705 \u062A\u0645 \u0625\u0636\u0627\u0641\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0639\u062F\u062F (${n}) \u0644\u0640 ${o}`)}}catch(c){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0641\u0644\u062A\u0631:",c)}};if(a.department?i("employee-filter-department",a.department,t.length):i("employee-filter-department","",0),a.branch?i("employee-filter-branch",a.branch,t.length):i("employee-filter-branch","",0),a.location?i("employee-filter-location",a.location,t.length):i("employee-filter-location","",0),a.job?i("employee-filter-job",a.job,t.length):i("employee-filter-job","",0),a.position?i("employee-filter-position",a.position,t.length):i("employee-filter-position","",0),a.gender?i("employee-filter-gender",a.gender,t.length):i("employee-filter-gender","",0),a.search&&a.search.trim())try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const s=o.closest(".filter-field");if(s){const n=s.querySelector(".filter-label");if(n){const c=n.querySelector(".filter-count-badge");c&&c.remove();const d=document.createElement("span");d.className="filter-count-badge",d.title="\u0639\u062F\u062F \u0627\u0644\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0645\u0641\u0644\u062A\u0631\u0629",d.textContent=t.length;const m=n.querySelector("i");m?m.insertAdjacentElement("afterend",d):n.insertBefore(d,n.firstChild)}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u062F\u064A\u062B \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}else try{const o=document.getElementById("employees-search-filter")||document.getElementById("employees-search");if(o){const s=o.closest(".filter-field");if(s){const n=s.querySelector(".filter-label");if(n){const c=n.querySelector(".filter-count-badge");c&&c.remove()}}}}catch(o){AppState.debugMode&&Utils.safeWarn("\u062E\u0637\u0623 \u0641\u064A \u0625\u0632\u0627\u0644\u0629 \u0634\u0627\u0631\u0629 \u0627\u0644\u0628\u062D\u062B:",o)}}catch(i){AppState.debugMode&&Utils.safeError("\u062E\u0637\u0623 \u0641\u064A updateFilterBadges:",i)}},async applyFilters(){try{const e=this.getFilterValues();await this.filterEmployees(e.search,e.showInactive,e),this.updateInactiveCount()}catch(e){typeof Utils<"u"&&Utils.safeError&&Utils.safeError("\u274C \u062E\u0637\u0623 \u0641\u064A applyFilters:",e)}finally{this.updateInactiveCount()}},async resetFilters(){const e=document.getElementById("employees-search"),t=document.getElementById("employees-search-filter");e&&(e.value=""),t&&(t.value=""),["employee-filter-department","employee-filter-branch","employee-filter-location","employee-filter-job","employee-filter-position","employee-filter-gender"].forEach(s=>{const n=document.getElementById(s);n&&(n.value="")});const i=document.getElementById("show-inactive-employees");i&&(i.checked=!1);const o=document.getElementById("show-inactive-employees-container");o&&(o.style.background="linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)",o.style.borderColor="#dee2e6",o.style.boxShadow="none"),await this.applyFilters(),this.updateInactiveCount()},updateInactiveCount(e=0){const i=()=>{try{const s=(AppState.appData.employees||[]).filter(c=>this.isEmployeeInactive(c)).length,n=document.getElementById("inactive-employees-count");if(n){n.textContent=s;const c=s===0,d=c?"#6b7280":"#dc2626",m=c?"0 2px 4px rgba(107, 114, 128, 0.3)":"0 2px 4px rgba(220, 38, 38, 0.3)";n.style.cssText=`
    ...
    `,d=typeof FormHeader<"u"&&typeof FormHeader.generatePDFHTML=="function"?FormHeader.generatePDFHTML(`EXT-WORKFORCE-${e.year}`,o,c,!1,!0,{version:"1.0",releaseDate:s,revisionDate:s,includeQRCode:!0},s,s):`<!DOCTYPE html><html lang="${i.lang}" dir="${i.dir}"><head><meta charset="UTF-8"><title>${Utils.escapeHTML(o)}</title></head><body style="font-family:'Cairo','Segoe UI',Tahoma,Arial,sans-serif;direction:${i.dir};padding:20px;">${c}</body></html>`,m=new Blob(["\uFEFF"+d],{type:"text/html;charset=utf-8"}),r=URL.createObjectURL(m),l=window.open(r,"_blank");if(!l){URL.revokeObjectURL(r),Notification.error("\u062A\u0639\u0630\u0631 \u0641\u062A\u062D \u0646\u0627\u0641\u0630\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629");return}l.onload=()=>{setTimeout(()=>{l.print(),setTimeout(()=>URL.revokeObjectURL(r),1e3)},400)}},(function(){"use strict";try{typeof window<"u"&&typeof Employees<"u"&&(window.Employees=Employees,typeof AppState<"u"&&AppState.debugMode&&typeof Utils<"u"&&Utils.safeLog&&Utils.safeLog("\u2705 Employees module loaded and available on window.Employees"),typeof AppState<"u"&&AppState.currentUser&&setTimeout(()=>{window.Employees&&window.Employees.init&&window.Employees.init().catch(e=>{AppState.debugMode&&Utils.safeWarn("\u26A0\uFE0F \u0641\u0634\u0644 \u062A\u0647\u064A\u0626\u0629 \u0645\u0648\u062F\u064A\u0648\u0644 \u0627\u0644\u0645\u0648\u0638\u0641\u064A\u0646:",e)})},2e3))}catch{if(typeof window<"u"&&typeof Employees<"u")try{window.Employees=Employees}catch{}}})();
