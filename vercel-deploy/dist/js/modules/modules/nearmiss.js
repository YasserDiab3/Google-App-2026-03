const NearMiss={TYPES:[{value:"\u0633\u0642\u0648\u0637 \u0623\u0634\u064A\u0627\u0621 / \u0623\u062D\u0645\u0627\u0644",label:"\u0633\u0642\u0648\u0637 \u0623\u0634\u064A\u0627\u0621 / \u0623\u062D\u0645\u0627\u0644",icon:"fa-arrow-down"},{value:"\u062A\u0639\u062B\u0631 / \u0627\u0646\u0632\u0644\u0627\u0642",label:"\u062A\u0639\u062B\u0631 / \u0627\u0646\u0632\u0644\u0627\u0642",icon:"fa-walking"},{value:"\u0627\u0642\u062A\u0631\u0627\u0628 \u0645\u0639\u062F\u0627\u062A / \u0641\u0648\u0631\u0643\u0644\u0641\u062A",label:"\u0627\u0642\u062A\u0631\u0627\u0628 \u0645\u0639\u062F\u0627\u062A / \u0641\u0648\u0631\u0643\u0644\u0641\u062A",icon:"fa-truck-pickup"},{value:"\u062E\u0637\u0631 \u0643\u0647\u0631\u0628\u0627\u0626\u064A \u0648\u0634\u064A\u0643",label:"\u062E\u0637\u0631 \u0643\u0647\u0631\u0628\u0627\u0626\u064A \u0648\u0634\u064A\u0643",icon:"fa-bolt"},{value:"\u062A\u0633\u0631\u064A\u0628 \u0645\u0648\u0627\u062F \u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629 / \u063A\u0627\u0632",label:"\u062A\u0633\u0631\u064A\u0628 \u0645\u0648\u0627\u062F \u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629 / \u063A\u0627\u0632",icon:"fa-flask"},{value:"\u062D\u0631\u064A\u0642 \u0648\u0634\u064A\u0643",label:"\u062D\u0631\u064A\u0642 \u0648\u0634\u064A\u0643",icon:"fa-fire"},{value:"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643",label:"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643 \u0639\u0627\u0645",icon:"fa-exclamation-triangle"},{value:"\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0622\u0645\u0646",label:"\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0622\u0645\u0646",icon:"fa-user-times"},{value:"\u0648\u0636\u0639 \u063A\u064A\u0631 \u0622\u0645\u0646",label:"\u0648\u0636\u0639 \u063A\u064A\u0631 \u0622\u0645\u0646",icon:"fa-ban"},{value:"\u0645\u0642\u062A\u0631\u062D",label:"\u0645\u0642\u062A\u0631\u062D \u062A\u062D\u0633\u064A\u0646",icon:"fa-lightbulb"}],state:{activeTab:"register",filters:{search:"",type:"",department:"",startDate:"",endDate:"",period:"365"},currentAttachments:[],editingId:null},_charts:{},applyModuleI18n(e){const t=e||document,i=window.AppI18n&&typeof window.AppI18n.applyI18n=="function"?window.AppI18n:window.I18n&&typeof window.I18n.applyI18n=="function"?window.I18n:null;i&&(typeof i.applyI18n=="function"&&i.applyI18n(t),typeof i.applyLiteralTranslations=="function"&&i.applyLiteralTranslations(t))},ensureI18nObservers(e){},async fetchLiveNearMisses(){try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.callApi){const e=await GoogleIntegration.callApi("getAllNearMisses");e&&e.success&&Array.isArray(e.data)&&(AppState.appData.nearmiss=e.data.map(t=>this.normalizeRecord(t)),this.renderKpiStrip(),this.renderActiveTabContent())}}catch{}},async load(){try{const e=document.getElementById("nearmiss-section");if(!e)return;this.ensureDataIntegrity(),this.renderMainLayout(e),this.fetchLiveNearMisses()}catch{}},ensureDataIntegrity(){let e=AppState.appData.nearmiss||AppState.appData.NearMiss||[];Array.isArray(e)||(e=[]),AppState.appData.nearmiss=e.map(t=>this.normalizeRecord(t))},normalizeRecord(e={}){const t=this.TYPES[0].value,i=e.id||(typeof Utils<"u"&&Utils.generateId?Utils.generateId("NEARMISS"):"NRM-"+Math.floor(Math.random()*1e5));let a;try{a=e.date?new Date(e.date).toISOString():new Date().toISOString()}catch{a=new Date().toISOString()}let d=[];if(Array.isArray(e.attachments))d=e.attachments.map(r=>this.normalizeAttachment(r)).filter(Boolean);else if(typeof e.attachments=="string"&&e.attachments.trim().startsWith("["))try{const r=JSON.parse(e.attachments);Array.isArray(r)&&(d=r.map(s=>this.normalizeAttachment(s)).filter(Boolean))}catch{}const o=e.correctiveProposed===!0||e.correctiveProposed==="\u0646\u0639\u0645"||!!(e.correctiveDescription||e.correctiveAction);return{id:i,isoCode:e.isoCode||e.id||i,type:e.type||t,severity:e.severity||"\u0645\u062A\u0648\u0633\u0637",date:a,observerName:e.observerName||e.reportedBy||"\u0641\u0627\u0639\u0644 \u062E\u064A\u0631 (\u0633\u0631\u064A)",phone:e.phone||"",location:e.location||e.place||"",department:e.department||e.departmentName||"",description:e.description||e.details||"",correctiveProposed:o,correctiveDescription:e.correctiveDescription||e.correctiveProposed||e.correctiveAction||"",attachments:d,status:e.status||(o?"\u0645\u0641\u062A\u0648\u062D":"\u0645\u063A\u0644\u0642"),createdAt:e.createdAt||a,updatedAt:e.updatedAt||a}},normalizeAttachment(e){return e?typeof e=="string"?{id:"att-"+Math.random(),name:"\u0645\u0631\u0641\u0642",url:e,data:e,type:"image/jpeg"}:{id:e.id||"att-"+Math.random(),name:e.name||"\u0645\u0631\u0641\u0642",type:e.type||"image/jpeg",url:e.url||e.data||"",data:e.data||e.url||"",size:e.size||0}:null},renderMainLayout(e){e.innerHTML=`
        ...
        `,this.renderKpiStrip(),this.renderActiveTabContent(),this.bindEvents()},renderKpiStrip(){const e=document.getElementById("nearmiss-kpi-strip");if(!e)return;const t=AppState.appData.nearmiss||[],i=t.length,a=t.filter(p=>p.correctiveProposed).length,d=t.filter(p=>{const l=(p.severity||"").toLowerCase();return l.includes("\u0639\u0627\u0644\u064A")||l.includes("high")||l.includes("\u0643\u0627\u0631\u062B\u064A")||l.includes("critical")||l.includes("\u0648\u0634\u064A\u0643")}).length,o=new Date,r=t.filter(p=>{const l=new Date(p.date);return l.getFullYear()===o.getFullYear()&&l.getMonth()===o.getMonth()}).length,s={};t.forEach(p=>{const l=(p.department||"").trim();l&&(s[l]=(s[l]||0)+1)});const n=Object.entries(s).sort((p,l)=>l[1]-p[1])[0],c=n?`${n[0]} (${n[1]})`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0639\u062F";e.innerHTML=`
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div style="background:#fff; border-radius:16px; padding:18px 20px; border:1px solid #fee2e2; box-shadow:0 4px 15px rgba(0,0,0,0.03); display:flex; align-items:center; gap:16px;">
                    ...
                    <div>
                        ...
                        <div style="font-size:1.6rem; font-weight:800; color:#b91c1c; line-height:1.2;">${d}</div>
                ...
                <div id="nrm-filter-body" class="nrm-filter-body ${this.state._filtersExpanded===!1?"collapsed":""}">
                    ...
                    <div class="nrm-filter-group">
                        ...
                        <select id="nearmiss-filter-severity" class="${t.severity?"has-value":""}">
                            ${a.map(d=>`<option value="${d.value}" ${(t.severity||"")===d.value?"selected":""}>${d.label}</option>`).join("")}
                        </select>
                    </div>
                    <div class="nrm-filter-group">
        ...
        `,setTimeout(()=>this.drawAnalyticsCharts(t),100)},drawAnalyticsCharts(e){if(typeof Chart>"u")return;["types","severity","locations","departments"].forEach(l=>{if(this._charts[l])try{this._charts[l].destroy()}catch{}});const t={};e.forEach(l=>{const f=l.type||"\u0623\u062E\u0631\u0649";t[f]=(t[f]||0)+1});const i=document.getElementById("nrm-chart-types");i&&(this._charts.types=new Chart(i,{type:"doughnut",data:{labels:Object.keys(t),datasets:[{data:Object.values(t),backgroundColor:["#4f46e5","#f59e0b","#10b981","#ef4444","#06b6d4","#8b5cf6","#ec4899"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"}}}}));const a={\u0645\u0646\u062E\u0641\u0636:0,\u0645\u062A\u0648\u0633\u0637:0,\u0639\u0627\u0644\u064A:0,"\u0643\u0627\u0631\u062B\u064A / \u0648\u0634\u064A\u0643":0};e.forEach(l=>{const f=l.severity||"\u0645\u062A\u0648\u0633\u0637";f.includes("\u0645\u0646\u062E\u0641\u0636")?a.\u0645\u0646\u062E\u0641\u0636++:f.includes("\u0639\u0627\u0644\u064A")||f.includes("high")?a.\u0639\u0627\u0644\u064A++:f.includes("\u0643\u0627\u0631\u062B\u064A")||f.includes("\u0648\u0634\u064A\u0643")?a["\u0643\u0627\u0631\u062B\u064A / \u0648\u0634\u064A\u0643"]++:a.\u0645\u062A\u0648\u0633\u0637++});const d=document.getElementById("nrm-chart-severity");d&&(this._charts.severity=new Chart(d,{type:"pie",data:{labels:Object.keys(a),datasets:[{data:Object.values(a),backgroundColor:["#10b981","#f59e0b","#ef4444","#991b1b"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"}}}}));const o={};e.forEach(l=>{const f=(l.location||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").split("\u2014")[0].trim();o[f]=(o[f]||0)+1});const r=Object.entries(o).sort((l,f)=>f[1]-l[1]).slice(0,6),s=document.getElementById("nrm-chart-locations");s&&(this._charts.locations=new Chart(s,{type:"bar",data:{labels:r.map(l=>l[0]),datasets:[{label:"\u0639\u062F\u062F \u0627\u0644\u0628\u0644\u0627\u063A\u0627\u062A",data:r.map(l=>l[1]),backgroundColor:"#6366f1",borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}}}));const n={};e.forEach(l=>{const f=(l.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").trim();n[f]=(n[f]||0)+1});const c=Object.entries(n).sort((l,f)=>f[1]-l[1]).slice(0,6),p=document.getElementById("nrm-chart-departments");p&&(this._charts.departments=new Chart(p,{type:"bar",data:{labels:c.map(l=>l[0]),datasets:[{label:"\u0639\u062F\u062F \u0627\u0644\u0628\u0644\u0627\u063A\u0627\u062A",data:c.map(l=>l[1]),backgroundColor:"#10b981",borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}}}))},bindEvents(){document.querySelectorAll(".nrm-nav-tab").forEach(a=>{a.addEventListener("click",()=>{const d=a.getAttribute("data-tab");d&&(this.state.activeTab=d,document.querySelectorAll(".nrm-nav-tab").forEach(o=>{const r=o.getAttribute("data-tab")===d;o.style.background=r?"#fff":"rgba(255,255,255,0.12)",o.style.color=r?"#1e1b4b":"#fff"}),this.renderActiveTabContent())})});const e=document.getElementById("nearmiss-public-qr-btn");e&&e.addEventListener("click",()=>this.openPublicQrModal());const t=document.getElementById("nearmiss-print-badges-btn");t&&t.addEventListener("click",()=>this.printLocationQrBadges());const i=document.getElementById("nearmiss-create-new-btn");i&&i.addEventListener("click",()=>this.showForm())},bindFilterEvents(){const e=document.getElementById("nrm-filter-toggle-btn");e&&e.addEventListener("click",()=>{const c=document.getElementById("nrm-filter-body"),p=e.querySelector(".nrm-chevron");if(c){const l=c.classList.toggle("collapsed");this.state._filtersExpanded=!l,p&&p.classList.toggle("open",!l)}});const t=document.getElementById("nearmiss-filter-search");if(t){let c;t.addEventListener("input",p=>{clearTimeout(c),c=setTimeout(()=>{this.handleFilterChange("search",p.target.value)},250)})}const i=document.getElementById("nearmiss-filter-type");i&&i.addEventListener("change",c=>this.handleFilterChange("type",c.target.value));const a=document.getElementById("nearmiss-filter-severity");a&&a.addEventListener("change",c=>this.handleFilterChange("severity",c.target.value));const d=document.getElementById("nearmiss-filter-department");d&&d.addEventListener("change",c=>this.handleFilterChange("department",c.target.value));const o=document.getElementById("nearmiss-filter-start");o&&o.addEventListener("change",c=>this.handleFilterChange("startDate",c.target.value));const r=document.getElementById("nearmiss-filter-end");r&&r.addEventListener("change",c=>this.handleFilterChange("endDate",c.target.value));const s=document.getElementById("nearmiss-reset-filters");s&&s.addEventListener("click",()=>this.resetFilters());const n=document.getElementById("nrm-active-tags");n&&n.addEventListener("click",c=>{const p=c.target.closest("[data-clear-filter]");if(p){const l=p.getAttribute("data-clear-filter");this.handleFilterChange(l,"")}})},handleFilterChange(e,t){this.state.filters[e]=t,this._refreshFilterUI(),this.renderTable()},resetFilters(){this.state.filters={search:"",type:"",severity:"",department:"",startDate:"",endDate:"",period:"365"},this.renderRegisterTab(document.getElementById("nearmiss-tab-content"))},_getActiveFilterCount(){const e=this.state.filters;let t=0;return e.search&&t++,e.type&&t++,e.severity&&t++,e.department&&t++,e.startDate&&t++,e.endDate&&t++,t},_renderActiveFilterTags(){const e=this.state.filters,t=[],i={search:{icon:"fa-search",prefix:"\u0628\u062D\u062B"},type:{icon:"fa-tag",prefix:"\u0627\u0644\u0646\u0648\u0639"},severity:{icon:"fa-exclamation-circle",prefix:"\u0627\u0644\u062E\u0637\u0648\u0631\u0629"},department:{icon:"fa-building",prefix:"\u0627\u0644\u0625\u062F\u0627\u0631\u0629"},startDate:{icon:"fa-calendar",prefix:"\u0645\u0646"},endDate:{icon:"fa-calendar-check",prefix:"\u0625\u0644\u0649"}};for(const[a,d]of Object.entries(i))e[a]&&t.push(`<span class="nrm-tag"><i class="fas ${d.icon}" style="font-size:.6rem;opacity:.7;"></i> ${d.prefix}: ${Utils.escapeHTML(e[a])}<button data-clear-filter="${a}" title="\u0625\u0632\u0627\u0644\u0629"><i class="fas fa-times"></i></button></span>`);return t.join("")},_refreshFilterUI(){const e=document.getElementById("nrm-active-tags");e&&(e.innerHTML=this._renderActiveFilterTags());const t=this._getActiveFilterCount(),i=document.getElementById("nrm-filter-toggle-btn");if(i){const r=i.querySelector(".nrm-filter-badge");if(t)if(r)r.textContent=t;else{const s=document.createElement("span");s.className="nrm-filter-badge",s.textContent=t;const n=i.querySelector(".nrm-chevron");i.insertBefore(s,n)}else r&&r.remove()}const a=document.querySelector(".nrm-filter-actions");if(a){const r=a.querySelector(".nrm-filter-reset");if(t&&!r){const s=document.createElement("button");s.id="nearmiss-reset-filters",s.className="nrm-filter-reset",s.type="button",s.innerHTML='<i class="fas fa-undo" style="font-size:.65rem;"></i> \u0645\u0633\u062D \u0627\u0644\u0643\u0644',s.addEventListener("click",()=>this.resetFilters()),a.insertBefore(s,a.firstChild)}else!t&&r&&r.remove()}["nearmiss-filter-search","nearmiss-filter-type","nearmiss-filter-severity","nearmiss-filter-department","nearmiss-filter-start","nearmiss-filter-end"].forEach(r=>{const s=document.getElementById(r);s&&(s.value?s.classList.add("has-value"):s.classList.remove("has-value"))});const d=this.state.filters,o={"nearmiss-filter-search":"search","nearmiss-filter-type":"type","nearmiss-filter-severity":"severity","nearmiss-filter-department":"department","nearmiss-filter-start":"startDate","nearmiss-filter-end":"endDate"};for(const[r,s]of Object.entries(o)){const n=document.getElementById(r);n&&n.value!==d[s]&&(n.value=d[s])}},getFilteredItems(){const{search:e,type:t,severity:i,department:a,startDate:d,endDate:o}=this.state.filters;let r=(AppState.appData.nearmiss||[]).filter(s=>!!s);if(t&&(r=r.filter(s=>(s.type||"").toLowerCase()===t.toLowerCase())),a&&(r=r.filter(s=>(s.department||"").toLowerCase()===a.toLowerCase())),i&&(r=r.filter(s=>{const n=String(s.severity||"").toLowerCase(),c=i.toLowerCase();return c==="\u0643\u0627\u0631\u062B\u064A"?n.includes("\u0643\u0627\u0631\u062B\u064A")||n.includes("\u0648\u0634\u064A\u0643")||n.includes("critical"):n.includes(c)})),d){const s=new Date(d);s.setHours(0,0,0,0),r=r.filter(n=>new Date(n.date)>=s)}if(o){const s=new Date(o);s.setHours(23,59,59,999),r=r.filter(n=>new Date(n.date)<=s)}if(e){const s=e.toLowerCase();r=r.filter(n=>[n.type,n.location,n.department,n.observerName,n.phone,n.description,n.correctiveDescription,n.isoCode].some(c=>c&&String(c).toLowerCase().includes(s)))}return r.sort((s,n)=>new Date(n.date)-new Date(s.date))},renderTable(){const e=document.getElementById("nearmiss-table-container");if(!e)return;const t=this.getFilteredItems(),i=document.getElementById("nearmiss-result-count");if(i&&(i.textContent=t.length?`${t.length} \u0628\u0644\u0627\u063A`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C"),!t.length){e.innerHTML=`
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <datalist id="nearmiss-departments-list">
                                        ${i.map(o=>`<option value="${Utils.escapeHTML(o)}"></option>`).join("")}
                                    </datalist>
                                </div>
                                <div>
        ...
        `,d},bindFormEvents(e,t){const i=e.querySelector("#nearmiss-form");i&&i.addEventListener("submit",async d=>{d.preventDefault(),await this.handleSubmit(i,t),e.remove()});const a=e.querySelector("#nearmiss-attachments");a&&a.addEventListener("change",async d=>{const o=d.target.files;if(!(!o||!o.length))for(let r=0;r<o.length;r++){const s=o[r],n=new FileReader;n.onload=c=>{this.state.currentAttachments.push({id:"att-"+Date.now()+"-"+r,name:s.name,type:s.type,data:c.target.result,url:c.target.result}),this.renderAttachmentsPreview(e)},n.readAsDataURL(s)}})},renderAttachmentsPreview(e){const t=e.querySelector("#nearmiss-attachments-preview");if(t){if(!this.state.currentAttachments.length){t.innerHTML="";return}t.innerHTML=this.state.currentAttachments.map((i,a)=>`
            ...
            <div style="background:#fff; border-radius:24px; max-width:520px; width:100%; overflow:hidden; box-shadow:0 25px 50px -12px rgba(0,0,0,0.4); border:1px solid #e0e7ff; animation:fadeIn 0.2s ease;">
                ...
                <div style="padding:24px; text-align:center;">
                    ...
                    <div style="display:inline-block; padding:16px; background:#fff; border-radius:20px; box-shadow:0 6px 20px rgba(0,0,0,0.06); border:2px solid #e0e7ff; margin-bottom:18px;">
                        <img src="${a}" alt="QR Code" style="width:220px; height:220px; border-radius:12px; display:block; margin:0 auto;" />
                    </div>
        ...
        `,document.body.appendChild(i)},printLocationQrBadges(){const e=this.getPublicUrl();let t=[];try{typeof DailyObservations<"u"&&DailyObservations.getAllSites?t=DailyObservations.getAllSites():Array.isArray(AppState.appData.observationSites)&&(t=AppState.appData.observationSites)}catch{}(!t||t.length===0)&&(t=["ICAPP-1","ICAPP-2","ICAPP-3","ICAPP-4","\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0639\u0627\u0645"]);const i=[];t.forEach(o=>{const r=typeof o=="string"?o:o.name||o.siteName||"";(o&&Array.isArray(o.places)&&o.places.length>0?o.places:["\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0639\u0627\u0645"]).forEach(n=>{const c=typeof n=="string"?n:n.name||n.placeName||"";i.push({site:r,place:c})})});const a=window.open("","_blank");if(!a){alert("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const d=i.map((o,r)=>{const s=`${e}?factory=${encodeURIComponent(o.site)}&place=${encodeURIComponent(o.place)}`;return`
                <div style="border: 2px solid #312e81; border-radius: 12px; padding: 12px; background: #fff; text-align: right; break-inside: avoid; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 2px 6px rgba(0,0,0,0.06);">
                    ...
                    <div style="display:flex; align-items:center; gap:10px;">
                        <img src="${"https://api.qrserver.com/v1/create-qr-code/?size=160x160&data="+encodeURIComponent(s)}" style="width:90px; height:90px; border-radius:6px; border:1px solid #e2e8f0;" />
                        <div style="flex:1;">
                            <div style="font-size:0.95rem; font-weight:800; color:#1e1b4b;">${o.site}</div>
                            <div style="font-size:0.8rem; color:#4338ca; font-weight:600; margin-top:2px;">${o.place}</div>
