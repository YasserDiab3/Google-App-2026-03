const NearMiss={TYPES:[{value:"\u0633\u0642\u0648\u0637 \u0623\u0634\u064A\u0627\u0621 / \u0623\u062D\u0645\u0627\u0644",label:"\u0633\u0642\u0648\u0637 \u0623\u0634\u064A\u0627\u0621 / \u0623\u062D\u0645\u0627\u0644",icon:"fa-arrow-down"},{value:"\u062A\u0639\u062B\u0631 / \u0627\u0646\u0632\u0644\u0627\u0642",label:"\u062A\u0639\u062B\u0631 / \u0627\u0646\u0632\u0644\u0627\u0642",icon:"fa-walking"},{value:"\u0627\u0642\u062A\u0631\u0627\u0628 \u0645\u0639\u062F\u0627\u062A / \u0641\u0648\u0631\u0643\u0644\u0641\u062A",label:"\u0627\u0642\u062A\u0631\u0627\u0628 \u0645\u0639\u062F\u0627\u062A / \u0641\u0648\u0631\u0643\u0644\u0641\u062A",icon:"fa-truck-pickup"},{value:"\u062E\u0637\u0631 \u0643\u0647\u0631\u0628\u0627\u0626\u064A \u0648\u0634\u064A\u0643",label:"\u062E\u0637\u0631 \u0643\u0647\u0631\u0628\u0627\u0626\u064A \u0648\u0634\u064A\u0643",icon:"fa-bolt"},{value:"\u062A\u0633\u0631\u064A\u0628 \u0645\u0648\u0627\u062F \u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629 / \u063A\u0627\u0632",label:"\u062A\u0633\u0631\u064A\u0628 \u0645\u0648\u0627\u062F \u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629 / \u063A\u0627\u0632",icon:"fa-flask"},{value:"\u062D\u0631\u064A\u0642 \u0648\u0634\u064A\u0643",label:"\u062D\u0631\u064A\u0642 \u0648\u0634\u064A\u0643",icon:"fa-fire"},{value:"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643",label:"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643 \u0639\u0627\u0645",icon:"fa-exclamation-triangle"},{value:"\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0622\u0645\u0646",label:"\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0622\u0645\u0646",icon:"fa-user-times"},{value:"\u0648\u0636\u0639 \u063A\u064A\u0631 \u0622\u0645\u0646",label:"\u0648\u0636\u0639 \u063A\u064A\u0631 \u0622\u0645\u0646",icon:"fa-ban"},{value:"\u0645\u0642\u062A\u0631\u062D",label:"\u0645\u0642\u062A\u0631\u062D \u062A\u062D\u0633\u064A\u0646",icon:"fa-lightbulb"}],state:{activeTab:"register",filters:{search:"",type:"",department:"",startDate:"",endDate:"",period:"365"},currentAttachments:[],editingId:null},_charts:{},applyModuleI18n(e){const t=e||document,i=window.AppI18n&&typeof window.AppI18n.applyI18n=="function"?window.AppI18n:window.I18n&&typeof window.I18n.applyI18n=="function"?window.I18n:null;i&&(typeof i.applyI18n=="function"&&i.applyI18n(t),typeof i.applyLiteralTranslations=="function"&&i.applyLiteralTranslations(t))},ensureI18nObservers(e){},async load(){try{const e=document.getElementById("nearmiss-section");if(!e)return;this.ensureDataIntegrity(),this.renderMainLayout(e)}catch{}},ensureDataIntegrity(){let e=AppState.appData.nearmiss||AppState.appData.NearMiss||[];Array.isArray(e)||(e=[]),AppState.appData.nearmiss=e.map(t=>this.normalizeRecord(t))},normalizeRecord(e={}){const t=this.TYPES[0].value,i=e.id||(typeof Utils<"u"&&Utils.generateId?Utils.generateId("NEARMISS"):"NRM-"+Math.floor(Math.random()*1e5));let a;try{a=e.date?new Date(e.date).toISOString():new Date().toISOString()}catch{a=new Date().toISOString()}let d=[];if(Array.isArray(e.attachments))d=e.attachments.map(r=>this.normalizeAttachment(r)).filter(Boolean);else if(typeof e.attachments=="string"&&e.attachments.trim().startsWith("["))try{const r=JSON.parse(e.attachments);Array.isArray(r)&&(d=r.map(o=>this.normalizeAttachment(o)).filter(Boolean))}catch{}const s=e.correctiveProposed===!0||e.correctiveProposed==="\u0646\u0639\u0645"||!!(e.correctiveDescription||e.correctiveAction);return{id:i,isoCode:e.isoCode||e.id||i,type:e.type||t,severity:e.severity||"\u0645\u062A\u0648\u0633\u0637",date:a,observerName:e.observerName||e.reportedBy||"\u0641\u0627\u0639\u0644 \u062E\u064A\u0631 (\u0633\u0631\u064A)",phone:e.phone||"",location:e.location||e.place||"",department:e.department||e.departmentName||"",description:e.description||e.details||"",correctiveProposed:s,correctiveDescription:e.correctiveDescription||e.correctiveProposed||e.correctiveAction||"",attachments:d,status:e.status||(s?"\u0645\u0641\u062A\u0648\u062D":"\u0645\u063A\u0644\u0642"),createdAt:e.createdAt||a,updatedAt:e.updatedAt||a}},normalizeAttachment(e){return e?typeof e=="string"?{id:"att-"+Math.random(),name:"\u0645\u0631\u0641\u0642",url:e,data:e,type:"image/jpeg"}:{id:e.id||"att-"+Math.random(),name:e.name||"\u0645\u0631\u0641\u0642",type:e.type||"image/jpeg",url:e.url||e.data||"",data:e.data||e.url||"",size:e.size||0}:null},renderMainLayout(e){e.innerHTML=`
        ...
        `,this.renderKpiStrip(),this.renderActiveTabContent(),this.bindEvents()},renderKpiStrip(){const e=document.getElementById("nearmiss-kpi-strip");if(!e)return;const t=AppState.appData.nearmiss||[],i=t.length,a=t.filter(c=>c.correctiveProposed).length,d=t.filter(c=>{const n=(c.severity||"").toLowerCase();return n.includes("\u0639\u0627\u0644\u064A")||n.includes("high")||n.includes("\u0643\u0627\u0631\u062B\u064A")||n.includes("critical")||n.includes("\u0648\u0634\u064A\u0643")}).length,s=new Date,r=t.filter(c=>{const n=new Date(c.date);return n.getFullYear()===s.getFullYear()&&n.getMonth()===s.getMonth()}).length,o={};t.forEach(c=>{const n=(c.department||"").trim();n&&(o[n]=(o[n]||0)+1)});const l=Object.entries(o).sort((c,n)=>n[1]-c[1])[0],f=l?`${l[0]} (${l[1]})`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0639\u062F";e.innerHTML=`
        ...
        `,setTimeout(()=>this.drawAnalyticsCharts(t),100)},drawAnalyticsCharts(e){if(typeof Chart>"u")return;["types","severity","locations","departments"].forEach(n=>{if(this._charts[n])try{this._charts[n].destroy()}catch{}});const t={};e.forEach(n=>{const p=n.type||"\u0623\u062E\u0631\u0649";t[p]=(t[p]||0)+1});const i=document.getElementById("nrm-chart-types");i&&(this._charts.types=new Chart(i,{type:"doughnut",data:{labels:Object.keys(t),datasets:[{data:Object.values(t),backgroundColor:["#4f46e5","#f59e0b","#10b981","#ef4444","#06b6d4","#8b5cf6","#ec4899"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"}}}}));const a={\u0645\u0646\u062E\u0641\u0636:0,\u0645\u062A\u0648\u0633\u0637:0,\u0639\u0627\u0644\u064A:0,"\u0643\u0627\u0631\u062B\u064A / \u0648\u0634\u064A\u0643":0};e.forEach(n=>{const p=n.severity||"\u0645\u062A\u0648\u0633\u0637";p.includes("\u0645\u0646\u062E\u0641\u0636")?a.\u0645\u0646\u062E\u0641\u0636++:p.includes("\u0639\u0627\u0644\u064A")||p.includes("high")?a.\u0639\u0627\u0644\u064A++:p.includes("\u0643\u0627\u0631\u062B\u064A")||p.includes("\u0648\u0634\u064A\u0643")?a["\u0643\u0627\u0631\u062B\u064A / \u0648\u0634\u064A\u0643"]++:a.\u0645\u062A\u0648\u0633\u0637++});const d=document.getElementById("nrm-chart-severity");d&&(this._charts.severity=new Chart(d,{type:"pie",data:{labels:Object.keys(a),datasets:[{data:Object.values(a),backgroundColor:["#10b981","#f59e0b","#ef4444","#991b1b"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"}}}}));const s={};e.forEach(n=>{const p=(n.location||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").split("\u2014")[0].trim();s[p]=(s[p]||0)+1});const r=Object.entries(s).sort((n,p)=>p[1]-n[1]).slice(0,6),o=document.getElementById("nrm-chart-locations");o&&(this._charts.locations=new Chart(o,{type:"bar",data:{labels:r.map(n=>n[0]),datasets:[{label:"\u0639\u062F\u062F \u0627\u0644\u0628\u0644\u0627\u063A\u0627\u062A",data:r.map(n=>n[1]),backgroundColor:"#6366f1",borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}}}));const l={};e.forEach(n=>{const p=(n.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").trim();l[p]=(l[p]||0)+1});const f=Object.entries(l).sort((n,p)=>p[1]-n[1]).slice(0,6),c=document.getElementById("nrm-chart-departments");c&&(this._charts.departments=new Chart(c,{type:"bar",data:{labels:f.map(n=>n[0]),datasets:[{label:"\u0639\u062F\u062F \u0627\u0644\u0628\u0644\u0627\u063A\u0627\u062A",data:f.map(n=>n[1]),backgroundColor:"#10b981",borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}}}))},bindEvents(){document.querySelectorAll(".nrm-nav-tab").forEach(a=>{a.addEventListener("click",()=>{const d=a.getAttribute("data-tab");d&&(this.state.activeTab=d,document.querySelectorAll(".nrm-nav-tab").forEach(s=>{const r=s.getAttribute("data-tab")===d;s.style.background=r?"#fff":"rgba(255,255,255,0.12)",s.style.color=r?"#1e1b4b":"#fff"}),this.renderActiveTabContent())})});const e=document.getElementById("nearmiss-public-qr-btn");e&&e.addEventListener("click",()=>this.openPublicQrModal());const t=document.getElementById("nearmiss-print-badges-btn");t&&t.addEventListener("click",()=>this.printLocationQrBadges());const i=document.getElementById("nearmiss-create-new-btn");i&&i.addEventListener("click",()=>this.showForm())},bindFilterEvents(){const e=document.getElementById("nearmiss-filter-search");e&&e.addEventListener("input",r=>this.handleFilterChange("search",r.target.value));const t=document.getElementById("nearmiss-filter-type");t&&t.addEventListener("change",r=>this.handleFilterChange("type",r.target.value));const i=document.getElementById("nearmiss-filter-department");i&&i.addEventListener("change",r=>this.handleFilterChange("department",r.target.value));const a=document.getElementById("nearmiss-filter-start");a&&a.addEventListener("change",r=>this.handleFilterChange("startDate",r.target.value));const d=document.getElementById("nearmiss-filter-end");d&&d.addEventListener("change",r=>this.handleFilterChange("endDate",r.target.value));const s=document.getElementById("nearmiss-reset-filters");s&&s.addEventListener("click",()=>this.resetFilters())},handleFilterChange(e,t){this.state.filters[e]=t,this.renderTable()},resetFilters(){this.state.filters={search:"",type:"",department:"",startDate:"",endDate:"",period:"365"},this.renderRegisterTab(document.getElementById("nearmiss-tab-content"))},getFilteredItems(){const{search:e,type:t,department:i,startDate:a,endDate:d}=this.state.filters;let s=(AppState.appData.nearmiss||[]).filter(r=>!!r);if(t&&(s=s.filter(r=>(r.type||"").toLowerCase()===t.toLowerCase())),i&&(s=s.filter(r=>(r.department||"").toLowerCase()===i.toLowerCase())),a){const r=new Date(a);r.setHours(0,0,0,0),s=s.filter(o=>new Date(o.date)>=r)}if(d){const r=new Date(d);r.setHours(23,59,59,999),s=s.filter(o=>new Date(o.date)<=r)}if(e){const r=e.toLowerCase();s=s.filter(o=>[o.type,o.location,o.department,o.observerName,o.phone,o.description,o.correctiveDescription,o.isoCode].some(l=>l&&String(l).toLowerCase().includes(r)))}return s.sort((r,o)=>new Date(o.date)-new Date(r.date))},renderTable(){const e=document.getElementById("nearmiss-table-container");if(!e)return;const t=this.getFilteredItems(),i=document.getElementById("nearmiss-result-count");if(i&&(i.textContent=t.length?`${t.length} \u0628\u0644\u0627\u063A`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C"),!t.length){e.innerHTML=`
        ...
        `,d},bindFormEvents(e,t){const i=e.querySelector("#nearmiss-form");i&&i.addEventListener("submit",async d=>{d.preventDefault(),await this.handleSubmit(i,t),e.remove()});const a=e.querySelector("#nearmiss-attachments");a&&a.addEventListener("change",async d=>{const s=d.target.files;if(!(!s||!s.length))for(let r=0;r<s.length;r++){const o=s[r],l=new FileReader;l.onload=f=>{this.state.currentAttachments.push({id:"att-"+Date.now()+"-"+r,name:o.name,type:o.type,data:f.target.result,url:f.target.result}),this.renderAttachmentsPreview(e)},l.readAsDataURL(o)}})},renderAttachmentsPreview(e){const t=e.querySelector("#nearmiss-attachments-preview");if(t){if(!this.state.currentAttachments.length){t.innerHTML="";return}t.innerHTML=this.state.currentAttachments.map((i,a)=>`
        ...
        `).join("")}},async handleSubmit(e,t){const i=document.getElementById("nearmiss-type")?.value||"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643",a=document.getElementById("nearmiss-severity")?.value||"\u0645\u062A\u0648\u0633\u0637",d=document.getElementById("nearmiss-location")?.value||"",s=document.getElementById("nearmiss-department")?.value||"",r=document.getElementById("nearmiss-date")?.value||new Date().toISOString(),o=document.getElementById("nearmiss-observer")?.value||"\u0641\u0627\u0639\u0644 \u062E\u064A\u0631",l=document.getElementById("nearmiss-description")?.value||"",f=document.getElementById("nearmiss-corrective-check")?.checked||!1,c=document.getElementById("nearmiss-corrective-description")?.value||"",n=t?.id||"NRM-"+Date.now(),p=t?.isoCode||"NM-"+new Date().getFullYear()+"-"+Math.floor(1e3+Math.random()*9e3),g={id:n,isoCode:p,type:i,severity:a,location:d,department:s,date:new Date(r).toISOString(),observerName:o,description:l,correctiveProposed:f,correctiveDescription:f?c:"",attachments:this.state.currentAttachments,status:f?"\u0645\u0641\u062A\u0648\u062D":"\u0645\u063A\u0644\u0642",updatedAt:new Date().toISOString()};if(t){const b=AppState.appData.nearmiss.findIndex(m=>m.id===t.id);b!==-1&&(AppState.appData.nearmiss[b]=g)}else g.createdAt=new Date().toISOString(),AppState.appData.nearmiss.unshift(g);try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.callApi){const b=t?"updateNearMiss":"addNearMiss";GoogleIntegration.callApi(b,g)}}catch{}this.renderKpiStrip(),this.renderTable(),alert("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u0644\u0627\u063A \u0628\u0646\u062C\u0627\u062D!")},editNearMiss(e){const t=(AppState.appData.nearmiss||[]).find(i=>i.id===e);t&&this.showForm(t)},deleteNearMiss(e){if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0628\u0644\u0627\u063A\u061F")){AppState.appData.nearmiss=(AppState.appData.nearmiss||[]).filter(t=>t.id!==e);try{typeof GoogleIntegration<"u"&&GoogleIntegration.callApi&&GoogleIntegration.callApi("deleteNearMiss",{nearMissId:e})}catch{}this.renderKpiStrip(),this.renderTable()}},getPublicUrl(){try{const e=window.location;let t=e.origin+e.pathname;return t.endsWith(".html")?t=t.substring(0,t.lastIndexOf("/")+1):t.endsWith("/")||(t=t+"/"),t+"public-near-miss.html"}catch{return window.location.href.split("?")[0].split("#")[0].replace(/[^/]*$/,"")+"public-near-miss.html"}},openPublicQrModal(){const e=this.getPublicUrl(),t=document.getElementById("nrm-public-qr-modal");t&&t.remove();const i=document.createElement("div");i.id="nrm-public-qr-modal",i.style.cssText='position:fixed; inset:0; z-index:999999; background:rgba(0,0,0,0.75); display:flex; align-items:center; justify-content:center; padding:16px; backdrop-filter:blur(6px); direction:rtl; font-family:"Segoe UI", Tahoma, sans-serif;';const a="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data="+encodeURIComponent(e);i.innerHTML=`
        ...
        `,document.body.appendChild(i)},printLocationQrBadges(){const e=this.getPublicUrl();let t=[];try{typeof DailyObservations<"u"&&DailyObservations.getAllSites?t=DailyObservations.getAllSites():Array.isArray(AppState.appData.observationSites)&&(t=AppState.appData.observationSites)}catch{}(!t||t.length===0)&&(t=["ICAPP-1","ICAPP-2","ICAPP-3","ICAPP-4","\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0639\u0627\u0645"]);const i=[];t.forEach(s=>{const r=typeof s=="string"?s:s.name||s.siteName||"";(s&&Array.isArray(s.places)&&s.places.length>0?s.places:["\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0639\u0627\u0645"]).forEach(l=>{const f=typeof l=="string"?l:l.name||l.placeName||"";i.push({site:r,place:f})})});const a=window.open("","_blank");if(!a){alert("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const d=i.map((s,r)=>{const o=`${e}?factory=${encodeURIComponent(s.site)}&place=${encodeURIComponent(s.place)}`;return`
                <div style="border: 2px solid #312e81; border-radius: 12px; padding: 12px; background: #fff; text-align: right; break-inside: avoid; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 2px 6px rgba(0,0,0,0.06);">
                    ...
                    <div style="display:flex; align-items:center; gap:10px;">
                        <img src="${"https://api.qrserver.com/v1/create-qr-code/?size=160x160&data="+encodeURIComponent(o)}" style="width:90px; height:90px; border-radius:6px; border:1px solid #e2e8f0;" />
                        <div style="flex:1;">
