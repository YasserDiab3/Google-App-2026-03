const NearMiss={TYPES:[{value:"\u0633\u0642\u0648\u0637 \u0623\u0634\u064A\u0627\u0621 / \u0623\u062D\u0645\u0627\u0644",label:"\u0633\u0642\u0648\u0637 \u0623\u0634\u064A\u0627\u0621 / \u0623\u062D\u0645\u0627\u0644",icon:"fa-arrow-down"},{value:"\u062A\u0639\u062B\u0631 / \u0627\u0646\u0632\u0644\u0627\u0642",label:"\u062A\u0639\u062B\u0631 / \u0627\u0646\u0632\u0644\u0627\u0642",icon:"fa-walking"},{value:"\u0627\u0642\u062A\u0631\u0627\u0628 \u0645\u0639\u062F\u0627\u062A / \u0641\u0648\u0631\u0643\u0644\u0641\u062A",label:"\u0627\u0642\u062A\u0631\u0627\u0628 \u0645\u0639\u062F\u0627\u062A / \u0641\u0648\u0631\u0643\u0644\u0641\u062A",icon:"fa-truck-pickup"},{value:"\u062E\u0637\u0631 \u0643\u0647\u0631\u0628\u0627\u0626\u064A \u0648\u0634\u064A\u0643",label:"\u062E\u0637\u0631 \u0643\u0647\u0631\u0628\u0627\u0626\u064A \u0648\u0634\u064A\u0643",icon:"fa-bolt"},{value:"\u062A\u0633\u0631\u064A\u0628 \u0645\u0648\u0627\u062F \u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629 / \u063A\u0627\u0632",label:"\u062A\u0633\u0631\u064A\u0628 \u0645\u0648\u0627\u062F \u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629 / \u063A\u0627\u0632",icon:"fa-flask"},{value:"\u062D\u0631\u064A\u0642 \u0648\u0634\u064A\u0643",label:"\u062D\u0631\u064A\u0642 \u0648\u0634\u064A\u0643",icon:"fa-fire"},{value:"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643",label:"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643 \u0639\u0627\u0645",icon:"fa-exclamation-triangle"},{value:"\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0622\u0645\u0646",label:"\u062A\u0635\u0631\u0641 \u063A\u064A\u0631 \u0622\u0645\u0646",icon:"fa-user-times"},{value:"\u0648\u0636\u0639 \u063A\u064A\u0631 \u0622\u0645\u0646",label:"\u0648\u0636\u0639 \u063A\u064A\u0631 \u0622\u0645\u0646",icon:"fa-ban"},{value:"\u0645\u0642\u062A\u0631\u062D",label:"\u0645\u0642\u062A\u0631\u062D \u062A\u062D\u0633\u064A\u0646",icon:"fa-lightbulb"}],state:{activeTab:"register",filters:{search:"",type:"",department:"",startDate:"",endDate:"",period:"365"},currentAttachments:[],editingId:null},_charts:{},applyModuleI18n(e){const t=e||document,i=window.AppI18n&&typeof window.AppI18n.applyI18n=="function"?window.AppI18n:window.I18n&&typeof window.I18n.applyI18n=="function"?window.I18n:null;i&&(typeof i.applyI18n=="function"&&i.applyI18n(t),typeof i.applyLiteralTranslations=="function"&&i.applyLiteralTranslations(t))},ensureI18nObservers(e){},async fetchLiveNearMisses(){try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.callApi){const e=await GoogleIntegration.callApi("getAllNearMisses");e&&e.success&&Array.isArray(e.data)&&(AppState.appData.nearmiss=e.data.map(t=>this.normalizeRecord(t)),this.renderKpiStrip(),this.renderActiveTabContent())}}catch{}},async load(){try{const e=document.getElementById("nearmiss-section");if(!e)return;this.ensureDataIntegrity(),this.renderMainLayout(e),this.fetchLiveNearMisses()}catch{}},ensureDataIntegrity(){let e=AppState.appData.nearmiss||AppState.appData.NearMiss||[];Array.isArray(e)||(e=[]),AppState.appData.nearmiss=e.map(t=>this.normalizeRecord(t))},normalizeRecord(e={}){const t=this.TYPES[0].value,i=e.id||(typeof Utils<"u"&&Utils.generateId?Utils.generateId("NEARMISS"):"NRM-"+Math.floor(Math.random()*1e5));let a;try{a=e.date?new Date(e.date).toISOString():new Date().toISOString()}catch{a=new Date().toISOString()}let o=[];if(Array.isArray(e.attachments))o=e.attachments.map(s=>this.normalizeAttachment(s)).filter(Boolean);else if(typeof e.attachments=="string"&&e.attachments.trim().startsWith("["))try{const s=JSON.parse(e.attachments);Array.isArray(s)&&(o=s.map(r=>this.normalizeAttachment(r)).filter(Boolean))}catch{}const l=e.correctiveProposed===!0||e.correctiveProposed==="\u0646\u0639\u0645"||!!(e.correctiveDescription||e.correctiveAction);return{id:i,isoCode:e.isoCode||e.id||i,type:e.type||t,severity:e.severity||"\u0645\u062A\u0648\u0633\u0637",date:a,observerName:e.observerName||e.reportedBy||"\u0641\u0627\u0639\u0644 \u062E\u064A\u0631 (\u0633\u0631\u064A)",phone:e.phone||"",location:e.location||e.place||"",department:e.department||e.departmentName||"",description:e.description||e.details||"",correctiveProposed:l,correctiveDescription:e.correctiveDescription||e.correctiveProposed||e.correctiveAction||"",attachments:o,status:e.status||(l?"\u0645\u0641\u062A\u0648\u062D":"\u0645\u063A\u0644\u0642"),createdAt:e.createdAt||a,updatedAt:e.updatedAt||a}},normalizeAttachment(e){return e?typeof e=="string"?{id:"att-"+Math.random(),name:"\u0645\u0631\u0641\u0642",url:e,data:e,type:"image/jpeg"}:{id:e.id||"att-"+Math.random(),name:e.name||"\u0645\u0631\u0641\u0642",type:e.type||"image/jpeg",url:e.url||e.data||"",data:e.data||e.url||"",size:e.size||0}:null},renderMainLayout(e){e.innerHTML=`
        ...
        `,this.renderKpiStrip(),this.renderActiveTabContent(),this.bindEvents()},renderKpiStrip(){const e=document.getElementById("nearmiss-kpi-strip");if(!e)return;const t=AppState.appData.nearmiss||[],i=t.length,a=t.filter(p=>p.correctiveProposed).length,o=t.filter(p=>{const d=(p.severity||"").toLowerCase();return d.includes("\u0639\u0627\u0644\u064A")||d.includes("high")||d.includes("\u0643\u0627\u0631\u062B\u064A")||d.includes("critical")||d.includes("\u0648\u0634\u064A\u0643")}).length,l=new Date,s=t.filter(p=>{const d=new Date(p.date);return d.getFullYear()===l.getFullYear()&&d.getMonth()===l.getMonth()}).length,r={};t.forEach(p=>{const d=(p.department||"").trim();d&&(r[d]=(r[d]||0)+1)});const n=Object.entries(r).sort((p,d)=>d[1]-p[1])[0],c=n?`${n[0]} (${n[1]})`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0639\u062F";e.innerHTML=`
                ...
                <div id="nrm-filter-body" class="nrm-filter-body ${this.state._filtersExpanded===!1?"collapsed":""}">
                    ...
                    <div class="nrm-filter-group">
                        ...
                        <select id="nearmiss-filter-severity" class="${t.severity?"has-value":""}">
                            ${a.map(o=>`<option value="${o.value}" ${(t.severity||"")===o.value?"selected":""}>${o.label}</option>`).join("")}
                        </select>
                    </div>
                    <div class="nrm-filter-group">
        ...
        `,setTimeout(()=>this.drawAnalyticsCharts(t),100)},drawAnalyticsCharts(e){if(typeof Chart>"u")return;["types","severity","locations","departments"].forEach(d=>{if(this._charts[d])try{this._charts[d].destroy()}catch{}});const t={};e.forEach(d=>{const f=d.type||"\u0623\u062E\u0631\u0649";t[f]=(t[f]||0)+1});const i=document.getElementById("nrm-chart-types");i&&(this._charts.types=new Chart(i,{type:"doughnut",data:{labels:Object.keys(t),datasets:[{data:Object.values(t),backgroundColor:["#4f46e5","#f59e0b","#10b981","#ef4444","#06b6d4","#8b5cf6","#ec4899"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"}}}}));const a={\u0645\u0646\u062E\u0641\u0636:0,\u0645\u062A\u0648\u0633\u0637:0,\u0639\u0627\u0644\u064A:0,"\u0643\u0627\u0631\u062B\u064A / \u0648\u0634\u064A\u0643":0};e.forEach(d=>{const f=d.severity||"\u0645\u062A\u0648\u0633\u0637";f.includes("\u0645\u0646\u062E\u0641\u0636")?a.\u0645\u0646\u062E\u0641\u0636++:f.includes("\u0639\u0627\u0644\u064A")||f.includes("high")?a.\u0639\u0627\u0644\u064A++:f.includes("\u0643\u0627\u0631\u062B\u064A")||f.includes("\u0648\u0634\u064A\u0643")?a["\u0643\u0627\u0631\u062B\u064A / \u0648\u0634\u064A\u0643"]++:a.\u0645\u062A\u0648\u0633\u0637++});const o=document.getElementById("nrm-chart-severity");o&&(this._charts.severity=new Chart(o,{type:"pie",data:{labels:Object.keys(a),datasets:[{data:Object.values(a),backgroundColor:["#10b981","#f59e0b","#ef4444","#991b1b"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom"}}}}));const l={};e.forEach(d=>{const f=(d.location||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").split("\u2014")[0].trim();l[f]=(l[f]||0)+1});const s=Object.entries(l).sort((d,f)=>f[1]-d[1]).slice(0,6),r=document.getElementById("nrm-chart-locations");r&&(this._charts.locations=new Chart(r,{type:"bar",data:{labels:s.map(d=>d[0]),datasets:[{label:"\u0639\u062F\u062F \u0627\u0644\u0628\u0644\u0627\u063A\u0627\u062A",data:s.map(d=>d[1]),backgroundColor:"#6366f1",borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}}}));const n={};e.forEach(d=>{const f=(d.department||"\u063A\u064A\u0631 \u0645\u062D\u062F\u062F").trim();n[f]=(n[f]||0)+1});const c=Object.entries(n).sort((d,f)=>f[1]-d[1]).slice(0,6),p=document.getElementById("nrm-chart-departments");p&&(this._charts.departments=new Chart(p,{type:"bar",data:{labels:c.map(d=>d[0]),datasets:[{label:"\u0639\u062F\u062F \u0627\u0644\u0628\u0644\u0627\u063A\u0627\u062A",data:c.map(d=>d[1]),backgroundColor:"#10b981",borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}}}}))},bindEvents(){document.querySelectorAll(".nrm-nav-tab").forEach(a=>{a.addEventListener("click",()=>{const o=a.getAttribute("data-tab");o&&(this.state.activeTab=o,document.querySelectorAll(".nrm-nav-tab").forEach(l=>{const s=l.getAttribute("data-tab")===o;l.style.background=s?"#fff":"rgba(255,255,255,0.12)",l.style.color=s?"#1e1b4b":"#fff"}),this.renderActiveTabContent())})});const e=document.getElementById("nearmiss-public-qr-btn");e&&e.addEventListener("click",()=>this.openPublicQrModal());const t=document.getElementById("nearmiss-print-badges-btn");t&&t.addEventListener("click",()=>this.printLocationQrBadges());const i=document.getElementById("nearmiss-create-new-btn");i&&i.addEventListener("click",()=>this.showForm())},bindFilterEvents(){const e=document.getElementById("nrm-filter-toggle-btn");e&&e.addEventListener("click",()=>{const c=document.getElementById("nrm-filter-body"),p=e.querySelector(".nrm-chevron");if(c){const d=c.classList.toggle("collapsed");this.state._filtersExpanded=!d,p&&p.classList.toggle("open",!d)}});const t=document.getElementById("nearmiss-filter-search");if(t){let c;t.addEventListener("input",p=>{clearTimeout(c),c=setTimeout(()=>{this.handleFilterChange("search",p.target.value)},250)})}const i=document.getElementById("nearmiss-filter-type");i&&i.addEventListener("change",c=>this.handleFilterChange("type",c.target.value));const a=document.getElementById("nearmiss-filter-severity");a&&a.addEventListener("change",c=>this.handleFilterChange("severity",c.target.value));const o=document.getElementById("nearmiss-filter-department");o&&o.addEventListener("change",c=>this.handleFilterChange("department",c.target.value));const l=document.getElementById("nearmiss-filter-start");l&&l.addEventListener("change",c=>this.handleFilterChange("startDate",c.target.value));const s=document.getElementById("nearmiss-filter-end");s&&s.addEventListener("change",c=>this.handleFilterChange("endDate",c.target.value));const r=document.getElementById("nearmiss-reset-filters");r&&r.addEventListener("click",()=>this.resetFilters());const n=document.getElementById("nrm-active-tags");n&&n.addEventListener("click",c=>{const p=c.target.closest("[data-clear-filter]");if(p){const d=p.getAttribute("data-clear-filter");this.handleFilterChange(d,"")}})},handleFilterChange(e,t){this.state.filters[e]=t,this._refreshFilterUI(),this.renderTable()},resetFilters(){this.state.filters={search:"",type:"",severity:"",department:"",startDate:"",endDate:"",period:"365"},this.renderRegisterTab(document.getElementById("nearmiss-tab-content"))},_getActiveFilterCount(){const e=this.state.filters;let t=0;return e.search&&t++,e.type&&t++,e.severity&&t++,e.department&&t++,e.startDate&&t++,e.endDate&&t++,t},_renderActiveFilterTags(){const e=this.state.filters,t=[],i={search:{icon:"fa-search",prefix:"\u0628\u062D\u062B"},type:{icon:"fa-tag",prefix:"\u0627\u0644\u0646\u0648\u0639"},severity:{icon:"fa-exclamation-circle",prefix:"\u0627\u0644\u062E\u0637\u0648\u0631\u0629"},department:{icon:"fa-building",prefix:"\u0627\u0644\u0625\u062F\u0627\u0631\u0629"},startDate:{icon:"fa-calendar",prefix:"\u0645\u0646"},endDate:{icon:"fa-calendar-check",prefix:"\u0625\u0644\u0649"}};for(const[a,o]of Object.entries(i))e[a]&&t.push(`<span class="nrm-tag"><i class="fas ${o.icon}" style="font-size:.6rem;opacity:.7;"></i> ${o.prefix}: ${Utils.escapeHTML(e[a])}<button data-clear-filter="${a}" title="\u0625\u0632\u0627\u0644\u0629"><i class="fas fa-times"></i></button></span>`);return t.join("")},_refreshFilterUI(){const e=document.getElementById("nrm-active-tags");e&&(e.innerHTML=this._renderActiveFilterTags());const t=this._getActiveFilterCount(),i=document.getElementById("nrm-filter-toggle-btn");if(i){const s=i.querySelector(".nrm-filter-badge");if(t)if(s)s.textContent=t;else{const r=document.createElement("span");r.className="nrm-filter-badge",r.textContent=t;const n=i.querySelector(".nrm-chevron");i.insertBefore(r,n)}else s&&s.remove()}const a=document.querySelector(".nrm-filter-actions");if(a){const s=a.querySelector(".nrm-filter-reset");if(t&&!s){const r=document.createElement("button");r.id="nearmiss-reset-filters",r.className="nrm-filter-reset",r.type="button",r.innerHTML='<i class="fas fa-undo" style="font-size:.65rem;"></i> \u0645\u0633\u062D \u0627\u0644\u0643\u0644',r.addEventListener("click",()=>this.resetFilters()),a.insertBefore(r,a.firstChild)}else!t&&s&&s.remove()}["nearmiss-filter-search","nearmiss-filter-type","nearmiss-filter-severity","nearmiss-filter-department","nearmiss-filter-start","nearmiss-filter-end"].forEach(s=>{const r=document.getElementById(s);r&&(r.value?r.classList.add("has-value"):r.classList.remove("has-value"))});const o=this.state.filters,l={"nearmiss-filter-search":"search","nearmiss-filter-type":"type","nearmiss-filter-severity":"severity","nearmiss-filter-department":"department","nearmiss-filter-start":"startDate","nearmiss-filter-end":"endDate"};for(const[s,r]of Object.entries(l)){const n=document.getElementById(s);n&&n.value!==o[r]&&(n.value=o[r])}},getFilteredItems(){const{search:e,type:t,severity:i,department:a,startDate:o,endDate:l}=this.state.filters;let s=(AppState.appData.nearmiss||[]).filter(r=>!!r);if(t&&(s=s.filter(r=>(r.type||"").toLowerCase()===t.toLowerCase())),a&&(s=s.filter(r=>(r.department||"").toLowerCase()===a.toLowerCase())),i&&(s=s.filter(r=>{const n=String(r.severity||"").toLowerCase(),c=i.toLowerCase();return c==="\u0643\u0627\u0631\u062B\u064A"?n.includes("\u0643\u0627\u0631\u062B\u064A")||n.includes("\u0648\u0634\u064A\u0643")||n.includes("critical"):n.includes(c)})),o){const r=new Date(o);r.setHours(0,0,0,0),s=s.filter(n=>new Date(n.date)>=r)}if(l){const r=new Date(l);r.setHours(23,59,59,999),s=s.filter(n=>new Date(n.date)<=r)}if(e){const r=e.toLowerCase();s=s.filter(n=>[n.type,n.location,n.department,n.observerName,n.phone,n.description,n.correctiveDescription,n.isoCode].some(c=>c&&String(c).toLowerCase().includes(r)))}return s.sort((r,n)=>new Date(n.date)-new Date(r.date))},renderTable(){const e=document.getElementById("nearmiss-table-container");if(!e)return;const t=this.getFilteredItems(),i=document.getElementById("nearmiss-result-count");if(i&&(i.textContent=t.length?`${t.length} \u0628\u0644\u0627\u063A`:"\u0644\u0627 \u062A\u0648\u062C\u062F \u0646\u062A\u0627\u0626\u062C"),!t.length){e.innerHTML=`
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <datalist id="nearmiss-departments-list">
                                        ${i.map(l=>`<option value="${Utils.escapeHTML(l)}"></option>`).join("")}
                                    </datalist>
                                </div>
                                <div>
        ...
        `,o},bindFormEvents(e,t){const i=e.querySelector("#nearmiss-form");i&&i.addEventListener("submit",async o=>{o.preventDefault(),await this.handleSubmit(i,t),e.remove()});const a=e.querySelector("#nearmiss-attachments");a&&a.addEventListener("change",async o=>{const l=o.target.files;if(!(!l||!l.length))for(let s=0;s<l.length;s++){const r=l[s],n=new FileReader;n.onload=c=>{this.state.currentAttachments.push({id:"att-"+Date.now()+"-"+s,name:r.name,type:r.type,data:c.target.result,url:c.target.result}),this.renderAttachmentsPreview(e)},n.readAsDataURL(r)}})},renderAttachmentsPreview(e){const t=e.querySelector("#nearmiss-attachments-preview");if(t){if(!this.state.currentAttachments.length){t.innerHTML="";return}t.innerHTML=this.state.currentAttachments.map((i,a)=>`
        ...
        `).join("")}},async handleSubmit(e,t){const i=document.getElementById("nearmiss-type")?.value||"\u062D\u0627\u062F\u062B \u0648\u0634\u064A\u0643",a=document.getElementById("nearmiss-severity")?.value||"\u0645\u062A\u0648\u0633\u0637",o=document.getElementById("nearmiss-location")?.value||"",l=document.getElementById("nearmiss-department")?.value||"",s=document.getElementById("nearmiss-date")?.value||new Date().toISOString(),r=document.getElementById("nearmiss-observer")?.value||"\u0641\u0627\u0639\u0644 \u062E\u064A\u0631",n=document.getElementById("nearmiss-description")?.value||"",c=document.getElementById("nearmiss-corrective-check")?.checked||!1,p=document.getElementById("nearmiss-corrective-description")?.value||"",d=t?.id||"NRM-"+Date.now(),f=t?.isoCode||"NM-"+new Date().getFullYear()+"-"+Math.floor(1e3+Math.random()*9e3),g={id:d,isoCode:f,type:i,severity:a,location:o,department:l,date:new Date(s).toISOString(),observerName:r,description:n,correctiveProposed:c,correctiveDescription:c?p:"",attachments:this.state.currentAttachments,status:c?"\u0645\u0641\u062A\u0648\u062D":"\u0645\u063A\u0644\u0642",updatedAt:new Date().toISOString()};if(t){const m=AppState.appData.nearmiss.findIndex(b=>b.id===t.id);m!==-1&&(AppState.appData.nearmiss[m]=g)}else g.createdAt=new Date().toISOString(),AppState.appData.nearmiss.unshift(g);try{if(typeof GoogleIntegration<"u"&&GoogleIntegration.callApi){const m=t?"updateNearMiss":"addNearMiss";GoogleIntegration.callApi(m,g)}}catch{}this.renderKpiStrip(),this.renderTable(),alert("\u2705 \u062A\u0645 \u062D\u0641\u0638 \u0627\u0644\u0628\u0644\u0627\u063A \u0628\u0646\u062C\u0627\u062D!")},editNearMiss(e){const t=(AppState.appData.nearmiss||[]).find(i=>i.id===e);t&&this.showForm(t)},deleteNearMiss(e){if(confirm("\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u062D\u0630\u0641 \u0647\u0630\u0627 \u0627\u0644\u0628\u0644\u0627\u063A\u061F")){AppState.appData.nearmiss=(AppState.appData.nearmiss||[]).filter(t=>t.id!==e);try{typeof GoogleIntegration<"u"&&GoogleIntegration.callApi&&GoogleIntegration.callApi("deleteNearMiss",{nearMissId:e})}catch{}this.renderKpiStrip(),this.renderTable()}},getPublicUrl(){try{const e=window.location;let t=e.origin+e.pathname;return t.endsWith(".html")?t=t.substring(0,t.lastIndexOf("/")+1):t.endsWith("/")||(t=t+"/"),t+"public-near-miss.html"}catch{return window.location.href.split("?")[0].split("#")[0].replace(/[^/]*$/,"")+"public-near-miss.html"}},generateQrDataUrl(e,t=250){try{if(typeof qrcode=="function"){const i=qrcode(0,"M");i.addData(String(e)),i.make();const a=typeof i.getModuleCount=="function"?i.getModuleCount():0,o=a?Math.max(1,Math.floor(t/a)):Math.max(2,Math.floor(t/25));return i.createDataURL(o,2)}}catch{}try{if(typeof window<"u"&&window.QRCode&&typeof window.QRCode.generate=="function"){const i=window.QRCode.generate(e,t);if(i)return i}}catch{}return`https://api.qrserver.com/v1/create-qr-code/?size=${t}x${t}&data=${encodeURIComponent(e)}`},openPublicQrModal(){const e=this.getPublicUrl(),t=document.getElementById("nrm-public-qr-modal");t&&t.remove();const i=document.createElement("div");i.id="nrm-public-qr-modal",i.style.cssText='position:fixed; inset:0; z-index:999999; background:rgba(0,0,0,0.75); display:flex; align-items:center; justify-content:center; padding:16px; backdrop-filter:blur(6px); direction:rtl; font-family:"Segoe UI", Tahoma, sans-serif;';const a=this.generateQrDataUrl(e,250),o=encodeURIComponent(e);i.innerHTML=`
            <div style="background:#fff; border-radius:24px; max-width:520px; width:100%; overflow:hidden; box-shadow:0 25px 50px -12px rgba(0,0,0,0.4); border:1px solid #e0e7ff; animation:fadeIn 0.2s ease;">
                ...
                <div style="padding:24px; text-align:center;">
                    ...
                    <div style="display:inline-block; padding:16px; background:#fff; border-radius:20px; box-shadow:0 6px 20px rgba(0,0,0,0.06); border:2px solid #e0e7ff; margin-bottom:18px;">
                        <img src="${a}" alt="QR Code" style="width:220px; height:220px; border-radius:12px; display:block; margin:0 auto;" onerror="if(!this.dataset.errCount){this.dataset.errCount=1;this.src='https://quickchart.io/qr?size=250&text=${o}';}else if(this.dataset.errCount=='1'){this.dataset.errCount=2;this.src='https://chart.googleapis.com/chart?cht=qr&chs=250x250&chl=${o}';}" />
                    </div>
        ...
        `,document.body.appendChild(i)},printLocationQrBadges(){const e=this.getPublicUrl();let t=[];try{typeof DailyObservations<"u"&&DailyObservations.getAllSites?t=DailyObservations.getAllSites():Array.isArray(AppState.appData.observationSites)&&(t=AppState.appData.observationSites)}catch{}(!t||t.length===0)&&(t=["ICAPP-1","ICAPP-2","ICAPP-3","ICAPP-4","\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0639\u0627\u0645"]);const i=[];t.forEach(l=>{const s=typeof l=="string"?l:l.name||l.siteName||"";(l&&Array.isArray(l.places)&&l.places.length>0?l.places:["\u0627\u0644\u0645\u0648\u0642\u0639 \u0627\u0644\u0639\u0627\u0645"]).forEach(n=>{const c=typeof n=="string"?n:n.name||n.placeName||"";i.push({site:s,place:c})})});const a=window.open("","_blank");if(!a){alert("\u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0644\u0637\u0628\u0627\u0639\u0629");return}const o=i.map((l,s)=>{const r=`${e}?factory=${encodeURIComponent(l.site)}&place=${encodeURIComponent(l.place)}`,n=this.generateQrDataUrl(r,160),c=encodeURIComponent(r);return`
                <div style="border: 2px solid #312e81; border-radius: 12px; padding: 12px; background: #fff; text-align: right; break-inside: avoid; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 2px 6px rgba(0,0,0,0.06);">
                    ...
                    <div style="display:flex; align-items:center; gap:10px;">
                        <img src="${n}" style="width:90px; height:90px; border-radius:6px; border:1px solid #e2e8f0;" onerror="if(!this.dataset.errCount){this.dataset.errCount=1;this.src='https://quickchart.io/qr?size=160&text=${c}';}" />
                        <div style="flex:1;">
                            <div style="font-size:0.95rem; font-weight:800; color:#1e1b4b;">${l.site}</div>
                            <div style="font-size:0.8rem; color:#4338ca; font-weight:600; margin-top:2px;">${l.place}</div>
