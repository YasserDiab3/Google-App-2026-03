const PHYSICAL_SHAPES=["Powder","Flakes","Pellets","Liquid","Lubricant","Oil","Gel","Gas","Spray"],PURPOSE_OF_USE_OPTIONS=["Electrical panels cleaners","CIP","Water Treatment","Conveyors lubricants","Data Coding","Boilers additives","BW Recovery","BW additives","Cleaning Agent","Pesticide","Lubricants","Fuels","Lab chemicals","Microbiology Media","Cooling Gases","Ingredients","Stationary"],LOCAL_IMPORT_OPTIONS=["Local","Import"],GHS_PICTOGRAMS=[{key:"environment",labelAr:"\u062E\u0637\u0631 \u0639\u0644\u0649 \u0627\u0644\u0628\u064A\u0626\u0629",svg:`
        ...
        `,document.body.appendChild(t),t.querySelector("#save-chemical-btn").addEventListener("click",()=>this.handleSubmit(t));const m=t.querySelector("#msds-arabic"),x=t.querySelector("#msds-english");m&&m.addEventListener("change",o=>{this.msdsFiles.arabic=o.target.files[0]}),x&&x.addEventListener("change",o=>{this.msdsFiles.english=o.target.files[0]});const b=t.querySelector("#purpose-dropdown-btn"),u=t.querySelector("#purpose-dropdown-menu");b&&u&&(b.addEventListener("click",o=>{o.stopPropagation(),u.classList.toggle("hidden");const d=b.querySelector("i");d&&(d.classList.toggle("fa-chevron-down"),d.classList.toggle("fa-chevron-up"))}),document.addEventListener("click",function(d){if(!u.contains(d.target)&&!b.contains(d.target)){u.classList.add("hidden");const f=b.querySelector("i");f&&(f.classList.remove("fa-chevron-up"),f.classList.add("fa-chevron-down"))}}));const v=t.querySelectorAll(".tab-btn"),L=t.querySelectorAll(".tab-content"),S=t.querySelector("#prev-tab-btn"),C=t.querySelector("#next-tab-btn"),w=["basic-info","documents","manufacturer","container","hazards","location","sds"],A=()=>{const o=t.querySelector(".tab-btn.active");if(!o)return;const d=w.indexOf(o.getAttribute("data-tab"));S.disabled=d===0,C.disabled=d===w.length-1};v.forEach(o=>{o.addEventListener("click",()=>{const d=o.getAttribute("data-tab");v.forEach(r=>r.classList.remove("active")),L.forEach(r=>r.classList.remove("active")),o.classList.add("active");const f=t.querySelector(`#tab-${d}`);f&&f.classList.add("active"),A()})}),S&&S.addEventListener("click",()=>{const o=t.querySelector(".tab-btn.active");if(!o)return;const d=w.indexOf(o.getAttribute("data-tab"));if(d>0){const f=w[d-1],r=t.querySelector(`[data-tab="${f}"]`);r&&r.click()}}),C&&C.addEventListener("click",()=>{const o=t.querySelector(".tab-btn.active");if(!o)return;const d=w.indexOf(o.getAttribute("data-tab"));if(d<w.length-1){const f=w[d+1],r=t.querySelector(`[data-tab="${f}"]`);r&&r.click()}}),A(),(()=>{const o=["rm-name","physical-shape","purpose-of-use","department"];let d=!1;const f=()=>{const r=t.querySelector(".tab-btn.active");if(!r||r.getAttribute("data-tab")!=="basic-info")return;let y=0;o.forEach(T=>{const k=t.querySelector(`#${T}`);if(k){let $=!1;k.tagName==="SELECT"?$=k.value&&k.value!=="":(k.type,$=k.value&&k.value.trim()!==""),$&&y++}}),y===o.length&&!d&&(d=!0,setTimeout(()=>{C&&!C.disabled&&C.click()},500))};o.forEach(r=>{const y=t.querySelector(`#${r}`);y&&(y.addEventListener("input",f),y.addEventListener("change",f))}),v.forEach(r=>{r.addEventListener("click",()=>{r.getAttribute("data-tab")==="basic-info"&&(d=!1)})})})(),(()=>{if(this.currentEditId)return;const o=c=>t.querySelector(`#${c}`),d=c=>(o(c)?.value||"").trim(),f=o("sds-company-branch"),r=o("sds-scientific-name"),y=o("sds-trade-name"),T=o("sds-chemical-properties"),k=o("sds-physical-properties"),$=o("sds-other-requirements"),P=[f,r,y,T,k,$].filter(Boolean),U=c=>{c&&(c.dataset.sdsUserEdited="1")};P.forEach(c=>{c.addEventListener("input",()=>U(c)),c.addEventListener("change",()=>U(c))});const j=(c,h)=>{if(!c||c.dataset.sdsUserEdited==="1")return;const D=(h||"").trim();if(c.value!==D){c.value=D,c.dataset.sdsAutofilled="1";try{c.dispatchEvent(new Event("input",{bubbles:!0}))}catch{}}},B=()=>{const c=(AppState?.companySettings?.name||AppState?.companyName||"").trim(),h=d("department");return c&&h?`${c} - ${h}`:c||h},N=()=>{const c=d("hazard-class"),h=d("hazard-description"),D=[];return c&&D.push(`\u062A\u0635\u0646\u064A\u0641 \u0627\u0644\u062E\u0637\u0648\u0631\u0629: ${c}`),h&&D.push(`\u0648\u0635\u0641 \u0627\u0644\u062E\u0637\u0648\u0631\u0629: ${h}`),D.join(`
`)},z=()=>{const c=d("physical-shape"),h=d("qty-year"),D=d("location-store"),M=[];return c&&M.push(`\u0627\u0644\u0634\u0643\u0644 \u0627\u0644\u0641\u064A\u0632\u064A\u0627\u0626\u064A: ${c}`),D&&M.push(`\u0645\u0648\u0642\u0639 \u0627\u0644\u062A\u062E\u0632\u064A\u0646: ${D}`),h&&M.push(`\u0627\u0644\u0643\u0645\u064A\u0629 \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645\u0629 \u0633\u0646\u0648\u064A\u0627\u064B: ${h}`),M.join(`
`)},R=()=>{const c=d("local-import"),h=d("manufacturer"),D=d("agent-egypt"),M=(t.querySelector("#nfpa-health-dropdown")?.value||"").trim(),_=(t.querySelector("#nfpa-fire-dropdown")?.value||"").trim(),O=(t.querySelector("#nfpa-reactivity-dropdown")?.value||"").trim(),q=(t.querySelector("#nfpa-special-dropdown")?.value||"").trim(),W=[M||"0",_||"0",O||"0",q||""].join("-"),H=[];return c&&H.push(`\u0645\u062D\u0644\u064A/\u0645\u0633\u062A\u0648\u0631\u062F: ${c}`),h&&H.push(`\u0627\u0644\u0634\u0631\u0643\u0629 \u0627\u0644\u0645\u0635\u0646\u0639\u0629: ${h}`),D&&H.push(`\u0627\u0644\u0648\u0643\u064A\u0644 \u0641\u064A \u0645\u0635\u0631: ${D}`),H.push(`NFPA: ${W}`),H.filter(Boolean).join(`
`)},I=()=>{const c=d("rm-name");j(r,c),j(y,c),j(f,B()),j(T,N()),j(k,z()),j($,R())};["rm-name","department","local-import","manufacturer","agent-egypt","hazard-class","hazard-description","physical-shape","location-store","qty-year"].forEach(c=>{const h=o(c);h&&(h.addEventListener("input",I),h.addEventListener("change",I))}),["nfpa-health-dropdown","nfpa-fire-dropdown","nfpa-reactivity-dropdown","nfpa-special-dropdown"].forEach(c=>{const h=o(c);h&&h.addEventListener("change",I)}),I()})(),t.addEventListener("click",o=>{o.target===t&&t.remove()})},togglePurposeOption(e,t){const a=document.getElementById("purpose-selected-tags"),l=document.getElementById("purpose-of-use");if(!a||!l)return;if(t){const n=document.createElement("span");n.className="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold purpose-tag",n.setAttribute("data-value",e),n.innerHTML=`
                ${Utils.escapeHTML(e)}
                <button type="button" onclick="ChemicalSafety.removePurposeTag('${Utils.escapeHTML(e)}')" 
                    class="ml-1 hover:bg-blue-200 rounded-full p-0.5 transition-colors">
                    <i class="fas fa-times text-xs"></i>
                </button>
            `,a.innerHTML=a.innerHTML.replace('<span class="text-gray-400 text-sm">\u0644\u0645 \u064A\u062A\u0645 \u0627\u062E\u062A\u064A\u0627\u0631 \u0623\u064A \u063A\u0631\u0636</span>',""),a.appendChild(n)}else{const n=a.querySelector(`[data-value="${Utils.escapeHTML(e)}"]`);n&&n.remove();const i=document.querySelector(`.purpose-checkbox[value="${Utils.escapeHTML(e)}"]`);i&&(i.checked=!1)}const s=Array.from(a.querySelectorAll(".purpose-tag")).map(n=>n.getAttribute("data-value"));l.value=s.join(","),s.length===0?(a.innerHTML='<span class="text-gray-400 text-sm">\u0644\u0645 \u064A\u062A\u0645 \u0627\u062E\u062A\u064A\u0627\u0631 \u0623\u064A \u063A\u0631\u0636</span>',l.setCustomValidity("\u064A\u0631\u062C\u0649 \u0627\u062E\u062A\u064A\u0627\u0631 \u063A\u0631\u0636 \u0648\u0627\u062D\u062F \u0639\u0644\u0649 \u0627\u0644\u0623\u0642\u0644")):l.setCustomValidity("");try{l.dispatchEvent(new Event("change",{bubbles:!0}))}catch{}},removePurposeTag(e){const t=document.querySelector(`.purpose-checkbox[value="${Utils.escapeHTML(e)}"]`);t&&(t.checked=!1,this.togglePurposeOption(e,!1))},renderNFPADiamond(e,t="normal"){const a=e.health||0,l=e.flammability||0,s=e.instability||0,n=String(e.special||"").trim().toUpperCase(),i=t==="compact",g=a>0||l>0||s>0||n,p=i?280:320,m=i?56:64,b=(d=>{const r=String(d||"").length;return r<=1?i?32:36:r===2?i?28:32:r===3?i?24:28:r===4?i?20:24:i?18:20})(n),u=Utils.escapeHTML(n),v=i?4:5,L=i?"0":"30px",S=i?"0":"30px",C=!i,w=(d,f)=>f==="health"?"#0066CC":f==="flammability"?"#FF0000":f==="instability"?"#FFCC00":"#F5F5F5",A=(d,f)=>f==="health"||f==="flammability"||f==="instability"?"#FFFFFF":"#000000",F=d=>({0:"Normal Material",1:"Slightly Hazardous",2:"Hazardous",3:"Extreme Danger",4:"Deadly"})[d]||"",E=d=>({0:"Will Not Burn",1:"Above 200\xB0F",2:"Below 200\xB0F",3:"Below 100\xB0F",4:"Below 73\xB0F"})[d]||"",o=d=>({0:"Stable",1:"Unstable if Heated",2:"Violent Chemical Change",3:"Shock and Heat May Detonate",4:"May Detonate"})[d]||"";return`
            <style>
            ...
            <div class="nfpa-diamond-main">
                <svg width="${p}" height="${p}" viewBox="-6 -6 232 232" preserveAspectRatio="xMidYMid meet" style="filter: drop-shadow(0 2px 6px rgba(0,0,0,0.15));">
                    ...
                    <!-- Divider lines -->
                    <path d="M 55 55 L 165 165" stroke="#000000" stroke-width="${v}" stroke-linejoin="miter" stroke-miterlimit="10"/>
                    <path d="M 165 55 L 55 165" stroke="#000000" stroke-width="${v}" stroke-linejoin="miter" stroke-miterlimit="10"/>
            ...
            <div class="nfpa-compact-values">
                ...
                <div class="nfpa-compact-value-item protection">
                    ...
                    <span class="nfpa-compact-value-number">${u||"-"}</span>
                </div>
            </div>
            `:`
        ...
        `},async exportPDF(e){const t=AppState.appData.chemicalRegister.find(a=>a.id===e);if(!t){Notification.error("\u0627\u0644\u0645\u0627\u062F\u0629 \u063A\u064A\u0631 \u0645\u0648\u062C\u0648\u062F\u0629");return}try{Loading.show("\u062C\u0627\u0631\u064A \u0625\u0646\u0634\u0627\u0621 PDF...");const a=t.serialNumber||`CHEM-${t.id?.substring(0,8)||"UNKNOWN"}`,l=this.generateSDSPrintContent(t),s="\u062A\u0639\u0644\u064A\u0645\u0627\u062A \u0627\u0644\u0633\u0644\u0627\u0645\u0629 \u0644\u0644\u0645\u0648\u0627\u062F \u0627\u0644\u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629 (SDS)",n={type:"ChemicalSDS",id:t.id,code:a,url:`${window.location.origin}/chemical/${t.id}`},i=l+`
            ...
            `,document.body.appendChild(a);const m=a.querySelector("img");m&&!m.complete&&await new Promise(r=>{m.onload=r,m.onerror=r,setTimeout(r,2e3)});const x=await window.html2canvas(a,{scale:2,useCORS:!0,allowTaint:!1,backgroundColor:"#ffffff",logging:!1,scrollX:0,scrollY:0,windowWidth:a.scrollWidth,windowHeight:a.scrollHeight}),{jsPDF:b}=window.jspdf,u=new b({orientation:"portrait",unit:"mm",format:"a4"}),v=u.internal.pageSize.getWidth(),L=u.internal.pageSize.getHeight(),S=8,C=v-S*2,w=L-S*2,A=x.width/x.height;let F=C,E=F/A;E>w&&(E=w,F=E*A);const o=(v-F)/2,d=S;u.addImage(x.toDataURL("image/jpeg",.92),"JPEG",o,d,F,E),u.setDrawColor(220,38,38),u.setLineWidth(.3),u.line(S,L-7,v-S,L-7),u.setTextColor(120,120,120),u.setFontSize(8),u.text(`${s}`,S,L-3,{align:"left"}),u.text(`${new Date().toISOString().slice(0,10)}`,v/2,L-3,{align:"center"}),u.text("1 / 1",v-S,L-3,{align:"right"});const f=(t.materialName||t.tradeName||s).toString().replace(/[\/\\:*?"<>|]/g,"_").substring(0,60);u.save(`SDS_${f}_${s}.pdf`),Loading.hide(),typeof Notification<"u"&&Notification.success&&Notification.success("\u062A\u0645 \u062A\u0635\u062F\u064A\u0631 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0628\u0646\u062C\u0627\u062D")}catch(l){Loading.hide(),Utils.safeError("\u062E\u0637\u0623 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 PDF \u0644\u0644\u0645\u0627\u062F\u0629 \u0627\u0644\u0643\u064A\u0645\u064A\u0627\u0626\u064A\u0629:",l),Notification.error("\u0641\u0634\u0644 \u0641\u064A \u062A\u0635\u062F\u064A\u0631 PDF: "+(l?.message||"\u062E\u0637\u0623 \u063A\u064A\u0631 \u0645\u0639\u0631\u0648\u0641"))}finally{a&&a.parentNode&&a.parentNode.removeChild(a)}},async exportToPDF(){const e=this.getFilteredChemicals(AppState.appData.chemicalRegister||[]);if(e.length===0){Notification.warning("\u0644\u0627 \u062A\u0648\u062C\u062F \u0628\u064A\u0627\u0646\u0627\u062A \u0644\u0644\u062A\u0635\u062F\u064A\u0631");return}Loading.show("\u062C\u0627\u0631\u064A \u0625\u0646\u0634\u0627\u0621 PDF...");try{const t=e.map(b=>{const u=b.hazardClass&&(b.hazardClass.toLowerCase().includes("hazard")||b.hazardClass.toLowerCase().includes("\u062E\u0637")||b.hazardClass.toLowerCase().includes("danger"));return`
                    <tr class="${u?"hazardous-row":""}">
                        <td>${Utils.escapeHTML(b.serialNumber||"")}</td>
                        <td><strong>${Utils.escapeHTML(b.rmName||"")}</strong>${u?" \u26A0\uFE0F":""}</td>
                        ...
                        <td>${u?'<strong style="color: #dc2626;">\u062E\u0637\u064A\u0631</strong>':'<span style="color: #16a34a;">\u0622\u0645\u0646</span>'}</td>
                    </tr>
